...
#ifndef VNSMARTCAMPRINT_H
#define VNSMARTCAMPRINT_H
...
-(id)initWithData:(*void)arg0 elementCount:(NSUInteger)arg1 elementType:(NSUInteger)arg2 lengthInBytes:(NSUInteger)arg3 labelsAndConfidence:(id)arg4 originatingRequestSpecifier:(id)arg5 ;
