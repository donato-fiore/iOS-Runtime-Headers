...
@property (readonly, nonatomic) VNPixelBufferObservation *instanceSegmentationMask; // ivar: _instanceSegmentationMask
...
-(id)vn_cloneObject;
-(struct CGRect )boundingBoxInTopLeftOrigin:(BOOL)arg0 orientation:(unsigned int)arg1 ;
