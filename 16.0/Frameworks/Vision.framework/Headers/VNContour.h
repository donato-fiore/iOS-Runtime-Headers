...
-(*id)normalizedPointsInTopLeftOrigin:(unsigned int)arg0 orientation;
-(BOOL)isEqual:(id)arg0 ;
-(float)aspectRatioInOrientation:(unsigned int)arg0 ;
...
-(struct CGPath *)normalizedPathInTopLeftOrigin:(BOOL)arg0 orientation:(unsigned int)arg1 ;
