...
-(id)_createMRCDecoderOptionsForRevision:(NSUInteger)arg0 error:(*id)arg1 ;
-(id)_machineReadableCodesDetectedInImageBuffer:(id)arg0 originatingRequestSpecifier:(id)arg1 inContext:(id)arg2 mrcDetector:(id)arg3 error:(*id)arg4 ;
