...
+(BOOL)createSingleNetworkPlanFromResourceName:(id)arg0 usingProcessingDevice:(id)arg1 lowPriorityMode:(BOOL)arg2 inputBlobNames:(id)arg3 outputBlobNames:(id)arg4 networkConfiguration:(id)arg5 explicitNetworkLayersStorageType:(int)arg6 memoryPoolId:(NSUInteger)arg7 espressoResources:(*id)arg8 error:(*id)arg9 ;
+(BOOL)createSingleNetworkPlanFromResourceName:(id)arg0 usingProcessingDevice:(id)arg1 lowPriorityMode:(BOOL)arg2 inputBlobNames:(id)arg3 outputBlobNames:(id)arg4 networkConfiguration:(id)arg5 memoryPoolId:(NSUInteger)arg6 espressoResources:(*id)arg7 error:(*id)arg8 ;
...
+(BOOL)getWidth:(*NSUInteger)arg0 height:(*NSUInteger)arg1 ofBlobNamed:(id)arg2 forNetworkModelFileWithPath:(id)arg3 error:(*id)arg4 ;
...
+(id)_alternatePathForEspressoResource:(id)arg0 ofType:(id)arg1 error:(*id)arg2 ;
