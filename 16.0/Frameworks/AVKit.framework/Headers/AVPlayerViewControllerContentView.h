...
@protocol AVScrollingObserverDelegate, AVPlayerViewControllerContentViewDelegate_Gen1, AVPlayerViewControllerContentViewDelegate;
...
@interface AVPlayerViewControllerContentView : UIView <AVScrollingObserverDelegate>
