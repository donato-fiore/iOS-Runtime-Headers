...
-(BOOL)isInUseForAnyOtherCategory:(unsigned int)arg0 ;
-(BOOL)isInUseForCategory:(unsigned int)arg0 ;
-(BOOL)isSysMemOnly;
...
-(void)decrementUseCountForCategory:(unsigned int)arg0 ;
-(void)encodeWithCoder:(id)arg0 ;
-(void)incrementUseCount;
-(void)incrementUseCountForCategory:(unsigned int)arg0 ;
