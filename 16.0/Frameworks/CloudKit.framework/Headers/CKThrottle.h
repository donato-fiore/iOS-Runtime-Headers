...
@property (retain, nonatomic) NSNumber *currentRequestWindowIndex; // ivar: _currentRequestWindowIndex
...
@property (retain, nonatomic) NSNumber *sentRequestCount; // ivar: _sentRequestCount
@property (copy, nonatomic) NSString *serviceName; // ivar: _serviceName
@property (copy, nonatomic) NSNumber *throttleID; // ivar: _throttleID
