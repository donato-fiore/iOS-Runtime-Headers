...
@property (nonatomic) NSUInteger allowedParticipantAccessOptions; // ivar: _allowedParticipantAccessOptions
@property (nonatomic) NSUInteger allowedParticipantPermissionOptions; // ivar: _allowedParticipantPermissionOptions
...
@property (nonatomic) BOOL supportAllowingAddedParticipantsToInviteOthers; // ivar: _supportAllowingAddedParticipantsToInviteOthers
