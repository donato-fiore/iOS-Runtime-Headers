...
@property (copy, nonatomic) NSString *testDeviceID; // ivar: _testDeviceID
@property (copy, nonatomic) NSString *testServerName; // ivar: _testServerName
@property (copy, nonatomic) NSURL *testServerURL; // ivar: _testServerURL
