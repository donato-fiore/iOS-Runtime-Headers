...
@property (nonatomic) BOOL useEarliestStartDateForSchedulerActivitiesInPast; // ivar: _useEarliestStartDateForSchedulerActivitiesInPast
...
-(BOOL)allowFetchAndModifyConcurrentlyForContainerIdentifier:(id)arg0 ;
