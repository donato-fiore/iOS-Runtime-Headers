...
@property (copy, nonatomic) NSArray *deltaIdentifiersToReplace; // ivar: _deltaIdentifiersToReplace
@property (readonly, copy) NSString *description;
@property (readonly) NSUInteger hash;
@property (copy, nonatomic) NSArray *replacementDeltas; // ivar: _replacementDeltas
@property (nonatomic) BOOL replacementDeltasContainNewData; // ivar: _replacementDeltasContainNewData
