...
@class NSHashTable, NSData, NSString, NSNumber;
...
-(BOOL)verifyFileVaultUser:(id)arg0 volumeUuid:(id)arg1 options:(NSUInteger)arg2 error:(*id)arg3 ;
-(NSUInteger)hash;
...
-(void)_evaluatePolicy:(NSInteger)arg0 options:(id)arg1 synchronous:(BOOL)arg2 reply:(id)arg3 ;
...
-(void)addContextObserver:(id)arg0 ;
-(void)authMethodWithReply:(id)arg0 ;
-(void)authorizeOperation:(NSInteger)arg0 protectedBy:(struct __SecAccessControl *)arg1 options:(id)arg2 reply:(id)arg3 ;
-(void)bootstrapServiceType:(id)arg0 completionHandler:(id)arg1 ;
-(void)checkCanEvaluateRight:(id)arg0 reply:(id)arg1 ;
...
-(void)evaluateRight:(id)arg0 localizedReason:(id)arg1 reply:(id)arg2 ;
...
-(void)removeContextObserver:(id)arg0 ;
...
-(void)setOptionPresentationContext:(id)arg0 ;
-(void)setOptionPresentationStyle:(id)arg0 ;
-(void)setOptionPresentingEmbeddedUI:(id)arg0 ;
...
-(void)setOptionSkipDoublePress:(id)arg0 ;
...
-(void)setOptionUseModernUI:(id)arg0 ;
