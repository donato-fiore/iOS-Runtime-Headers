...
@property (copy, nonatomic) MPSectionedCollection *musicKitPlaylistEntries; // ivar: _musicKitPlaylistEntries
...
// -(id)newSDKOperationWithLocalPersistenceResponseHandler:(id)arg0 completeResponseHandler:(unk)arg1  ;
