...
@class GEOAutomobileOptions, GEOCyclingOptions, NSMutableDictionary, GEOTransitOptions, GEOWalkingOptions;
...
@property (copy, nonatomic) GEOWalkingOptions *walkingOptions; // ivar: _walkingOptions
