...
+(id)_lookupPolicyForExtensionWithContainingAppIdentifiers:(id)arg0 supportsIntentClassNames:(id)arg1 ;
...
+(id)lookupPolicyForRestaurantReservationExtensionWithContainingAppIdentifiers:(id)arg0 ;
