...
-(id)_createCredentialOfKind:(NSUInteger)arg0 withOptions:(id)arg1 authenticatedLAContext:(id)arg2 delegate:(id)arg3 webFrameIdentifier:(id)arg4 ;
-(id)_newOperationWithRelyingPartyIdentifier:(id)arg0 delegate:(id)arg1 sourceApplicationIdentifier:(id)arg2 webFrameIdentifier:(id)arg3 ;
...
-(id)beginAssertionsWithOptions:(id)arg0 forProcessWithApplicationIdentifier:(id)arg1 delegate:(id)arg2 requestStyle:(NSInteger)arg3 webFrameIdentifier:(id)arg4 ;
-(id)beginCreatingNewSecurityKeyCredentialIfAvailableWithOptions:(id)arg0 delegate:(id)arg1 webFrameIdentifier:(id)arg2 ;
-(id)createNewPlatformCredentialWithOptions:(id)arg0 authenticatedContext:(id)arg1 delegate:(id)arg2 webFrameIdentifier:(id)arg3 ;
