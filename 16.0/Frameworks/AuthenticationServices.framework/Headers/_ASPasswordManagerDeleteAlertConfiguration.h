...
+(id)_configurationForAlertToDeletePasskeyFromSavedAccount:(id)arg0 ;
+(id)_configurationForAlertToDeletePasswordFromSavedAccount:(id)arg0 ;
+(id)_configurationForAlertToDeleteVerificationCodeFromSavedAccount:(id)arg0 ;
...
+(id)_subtitleStringForAlertToDeletePasskeyFromSavedAccount:(id)arg0 ;
+(id)_subtitleStringForAlertToDeletePasswordFromSavedAccount:(id)arg0 ;
+(id)_subtitleStringForAlertToDeleteVerificationCodeFromSavedAccount:(id)arg0 ;
