...
@property (readonly) NSDictionary *currentCatalystSDKDictionary; // ivar: _currentCatalystSDKDictionary
...
@property (readonly) NSDictionary *currentNativeSDKDictionary; // ivar: _currentNativeSDKDictionary
