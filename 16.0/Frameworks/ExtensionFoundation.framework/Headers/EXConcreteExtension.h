...
@class NSExtension, NSString, NSDictionary, NSSet, NSBundle, NSMutableDictionary, NSArray, NSUUID;
@protocol PKPlugIn;
...
@property (readonly) NSArray *_internalPersonas; // ivar: __internalPersonas
