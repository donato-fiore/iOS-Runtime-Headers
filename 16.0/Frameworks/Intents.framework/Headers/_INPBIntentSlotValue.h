...
@property (copy, nonatomic) NSArray *payloadCalendarEvents; // ivar: _payloadCalendarEvents
@property (readonly, nonatomic) NSUInteger payloadCalendarEventsCount;
...
@property (readonly, nonatomic) NSUInteger payloadEventAttributesCount;
...
@property (copy, nonatomic) NSArray *payloadEventParticipants; // ivar: _payloadEventParticipants
@property (readonly, nonatomic) NSUInteger payloadEventParticipantsCount;
...
-(id)payloadCalendarEventAtIndex:(NSUInteger)arg0 ;
...
-(id)payloadEventAttributesAsString:(int)arg0 ;
-(id)payloadEventListAtIndex:(NSUInteger)arg0 ;
-(id)payloadEventParticipantAtIndex:(NSUInteger)arg0 ;
...
-(int)StringAsPayloadEventAttributes:(id)arg0 ;
...
-(int)payloadEventAttributeAtIndex:(NSUInteger)arg0 ;
...
-(void)addPayloadCalendarEvent:(id)arg0 ;
...
-(void)addPayloadEventAttribute:(int)arg0 ;
-(void)addPayloadEventList:(id)arg0 ;
-(void)addPayloadEventParticipant:(id)arg0 ;
