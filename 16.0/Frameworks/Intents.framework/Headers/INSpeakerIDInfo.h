...
#ifndef INSPEAKERIDINFO_H
#define INSPEAKERIDINFO_H
...
@property (readonly, nonatomic) NSInteger speakerIDConfidence; // ivar: _speakerIDConfidence
...
-(id)initWithSharedUserID:(id)arg0 speakerIDConfidence:(NSInteger)arg1 ;
