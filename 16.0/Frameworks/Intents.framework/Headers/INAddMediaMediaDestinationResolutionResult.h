...
#ifndef INADDMEDIAMEDIADESTINATIONRESOLUTIONRESULT_H
#define INADDMEDIAMEDIADESTINATIONRESOLUTIONRESULT_H
...
-(id)initWithMediaDestinationResolutionResult:(id)arg0 ;
