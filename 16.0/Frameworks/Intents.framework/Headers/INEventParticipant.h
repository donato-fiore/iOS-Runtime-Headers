...
@property (readonly) NSUInteger hash;
@property (readonly, copy, nonatomic) NSNumber *isEventOrganizer; // ivar: _isEventOrganizer
@property (readonly, copy, nonatomic) NSNumber *isUser; // ivar: _isUser
...
-(id)initWithPerson:(id)arg0 status:(NSInteger)arg1 isUser:(id)arg2 isEventOrganizer:(id)arg3 ;
