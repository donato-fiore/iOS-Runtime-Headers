...
#ifndef INRELATIVESETTINGRESOLUTIONRESULT_H
#define INRELATIVESETTINGRESOLUTIONRESULT_H
...
+(id)confirmationRequiredWithRelativeSettingToConfirm:(NSInteger)arg0 ;
+(id)confirmationRequiredWithValueToConfirm:(NSInteger)arg0 ;
+(id)successWithResolvedRelativeSetting:(NSInteger)arg0 ;
