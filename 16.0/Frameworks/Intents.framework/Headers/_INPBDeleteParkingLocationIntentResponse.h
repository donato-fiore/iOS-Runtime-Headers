...
#ifndef _INPBDELETEPARKINGLOCATIONINTENTRESPONSE_H
#define _INPBDELETEPARKINGLOCATIONINTENTRESPONSE_H

@class PBCodable, NSString;
@protocol _INPBDeleteParkingLocationIntentResponse, NSSecureCoding, NSCopying;
