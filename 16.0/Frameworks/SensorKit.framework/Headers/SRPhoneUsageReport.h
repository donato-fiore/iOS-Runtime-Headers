...
@property NSInteger totalIncomingCalls; // ivar: _totalIncomingCalls
@property NSInteger totalOutgoingCalls; // ivar: _totalOutgoingCalls
@property CGFloat totalPhoneCallDuration; // ivar: _totalPhoneCallDuration
