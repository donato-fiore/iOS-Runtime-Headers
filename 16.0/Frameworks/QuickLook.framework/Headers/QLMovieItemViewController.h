...
@protocol AVPictureInPictureControllerDelegate, AVEditBehaviorDelegate, AVPlayerViewControllerDelegatePrivate;
...
-(void)playerViewControllerWillPerformAnalysisCalloutAction:(id)arg0 ;
