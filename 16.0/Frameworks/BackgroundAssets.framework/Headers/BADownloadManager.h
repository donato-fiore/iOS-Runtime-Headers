...
-(void)downloadIdentifierDidFinish:(id)arg0 clientStagedURL:(id)arg1 sandboxExtensionToken:(id)arg2 wasHandled:(id)arg3 ;
...
-(void)performWithExclusiveControlBeforeDate:(id)arg0 completion:(id)arg1 ;
