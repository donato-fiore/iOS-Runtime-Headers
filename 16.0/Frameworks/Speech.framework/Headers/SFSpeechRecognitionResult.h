...
-(id)_initWithBestTranscription:(id)arg0 final:(BOOL)arg1 ;
-(id)_initWithBestTranscription:(id)arg0 rawTranscription:(id)arg1 final:(BOOL)arg2 ;
...
-(id)expandTranscription:(id)arg0 ;
