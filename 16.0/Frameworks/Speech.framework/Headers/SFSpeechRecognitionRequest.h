...
@property (nonatomic) BOOL addsPunctuation; // ivar: _addsPunctuation
...
-(id)_requestParametersWithTaskHint:(NSInteger)arg0 requestIdentifier:(id)arg1 taskIdentifier:(id)arg2 narrowband:(BOOL)arg3 language:(id)arg4 ;
-(id)_sandboxExtensionsWithError:(*id)arg0 ;
