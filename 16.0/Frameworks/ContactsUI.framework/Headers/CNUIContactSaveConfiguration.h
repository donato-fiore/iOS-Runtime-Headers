...
@property (readonly, nonatomic) CNUIGroupContext *groupContext; // ivar: _groupContext
...
-(id)initWithContact:(id)arg0 mutableContact:(id)arg1 editingLinkedContacts:(id)arg2 contactStore:(id)arg3 ignoresParentalRestrictions:(BOOL)arg4 saveWasAuthorized:(BOOL)arg5 ;
-(id)initWithContact:(id)arg0 mutableContact:(id)arg1 shadowCopyOfReadonlyContact:(id)arg2 editingLinkedContacts:(id)arg3 contactStore:(id)arg4 parentGroup:(id)arg5 parentContainer:(id)arg6 containerContext:(id)arg7 groupContext:(id)arg8 ignoresParentalRestrictions:(BOOL)arg9 saveWasAuthorized:(BOOL)arg10 ;
