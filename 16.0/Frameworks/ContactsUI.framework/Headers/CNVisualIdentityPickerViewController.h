...
@class UIViewController, NSString, UICollectionView, NSArray, NSData;
...
@property (retain, nonatomic) NSArray *pendingInjectedSuggestionItems; // ivar: _pendingInjectedSuggestionItems
...
@property (retain, nonatomic) NSData *proposedImageData; // ivar: _proposedImageData
...
-(void)insertNewItemIntoSuggestions:(id)arg0 ;
...
-(void)updateVisualIdentityWithProposedImageData:(id)arg0 ;
