...
-(id)transformStrokes:(id)arg0 paths:(id)arg1 masks:(id)arg2 ;
...
-(void)performSearchQuery:(id)arg0 fullWordsOnly:(BOOL)arg1 caseMatchingOnly:(BOOL)arg2 withBlock:(id)arg3 ;
...
-(void)transformStrokes:(id)arg0 withTransforms:(id)arg1 concat:(BOOL)arg2 ;
