...
@property (readonly, nonatomic) NSArray *strokeTransforms; // ivar: _strokeTransforms
...
+(id)commandForTransforming:(id)arg0 drawing:(id)arg1 strokeTransforms:(id)arg2 ;
-(id)description;
-(id)initWithStrokes:(id)arg0 drawingUUID:(id)arg1 actionName:(id)arg2 strokeTransform:(struct CGAffineTransform )arg3 ;
-(id)initWithStrokes:(id)arg0 drawingUUID:(id)arg1 actionName:(id)arg2 strokeTransforms:(id)arg3 ;
