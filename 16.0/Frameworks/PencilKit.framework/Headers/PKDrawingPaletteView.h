...
@class NSUndoManager, MTMaterialView, UIView, NSLayoutConstraint, NSString, NSArray, UIViewController, UIPencilInteraction, UIMenu, UIWindowScene;
...
@property (retain, nonatomic) UIView *floatingLabel; // ivar: _floatingLabel
...
-(void)showFloatingLabel:(id)arg0 atRect:(struct CGRect )arg1 edge:(NSUInteger)arg2 offset:(CGFloat)arg3 ;
