...
@protocol PKDrawingGestureRecognizerDelegate, PKDrawingGestureTarget, PKShapeDrawingControllerDelegate, MTLDevice, PKPaintAreaViewDelegate;
...
@property (nonatomic) BOOL drawingDisabled; // ivar: _drawingDisabled
...
-(BOOL)beginDrawingAtPoint:(struct ? )arg0 surface:(id)arg1 locationInView:(struct CGPoint )arg2 inputType:(NSInteger)arg3 ;
-(BOOL)canAddStroke;
...
-(void)_commonInit;
-(void)_drawingBegan:(struct ? )arg0 locationInView:(struct CGPoint )arg1 inputType:(NSInteger)arg2 ;
...
-(void)drawingMovedToPoint:(struct ? )arg0 locationInView:(struct CGPoint )arg1 ;
