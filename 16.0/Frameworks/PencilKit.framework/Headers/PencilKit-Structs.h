...
typedef struct __compressed_pair<PKStroke *__strong *, std::allocator<PKStroke *>> {
    id __value_;
} __compressed_pair<PKStroke *__strong *, std::allocator<PKStroke *>>;

typedef struct vector<PKStroke *, std::allocator<PKStroke *>> {
    id __begin_;
    id __end_;
    __compressed_pair<PKStroke *__strong *, std::allocator<PKStroke *>> __end_cap_;
} vector<PKStroke *, std::allocator<PKStroke *>>;
