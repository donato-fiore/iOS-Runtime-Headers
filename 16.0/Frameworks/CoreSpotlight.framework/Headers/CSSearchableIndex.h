...
-(void)_photosLibraryDeleted:(id)arg0 completionHandler:(id)arg1 ;
-(void)_setFPAttributes:(id)arg0 ;
-(void)_setMailMessageAttributes:(id)arg0 ;
-(void)_setUser:(unsigned int)arg0 ;
...
-(void)fetchDataForBundleIdentifier:(id)arg0 itemIdentifier:(id)arg1 contentType:(id)arg2 completionHandler:(id)arg3 ;
