...
@class NSKnownKeysMappingStrategy, NSMutableArray, NSArray, NSMapTable, NSString;
@protocol MDSearchQueryResultProcessor, OS_dispatch_group, OS_dispatch_queue;
...
-(id)copyResultsFromPlist:(id)arg0 protectionClass:(id)arg1 ;
-(id)debugDescription;
-(id)description;
-(id)init;
...
-(void)addSuggestionCountQuery:(id)arg0 ;
-(void)cancel;
-(void)commonInitWithQueryString:(id)arg0 queryContext:(id)arg1 ;
-(void)dealloc;
...
-(void)filterZKWPeopleSuggestions:(id)arg0 completionHandler:(id)arg1 ;
...
-(void)populateSuggestionCount:(id)arg0 completionHandler:(id)arg1 ;
-(void)prepareSearch;
...
-(void)removeSuggestionCountQuery:(id)arg0 ;
-(void)setBundleIDs:(id)arg0 ;
-(void)setScopes:(id)arg0 ;
-(void)setupFetchAttributesForSearch;
-(void)start;
-(void)updateQueryString:(id)arg0 queryContext:(id)arg1 ;
