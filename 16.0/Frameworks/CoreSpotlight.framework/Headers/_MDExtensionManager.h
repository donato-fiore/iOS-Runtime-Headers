...
@property (retain, nonatomic) id *fileProviderMonitorToken; // ivar: _fileProviderMonitorToken
...
@property (retain, nonatomic) NSDictionary *providerDomainsByID; // ivar: _providerDomainsByID
...
-(id)extensions;
-(id)getProviderIDFromFileProvider:(id)arg0 ;
