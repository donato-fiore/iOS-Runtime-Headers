...
-(void)configureWithHomeIdentifier:(id)arg0 accessoryIdentifier:(id)arg1 accesoryInfoTypes:(NSUInteger)arg2 dataProviderDelegate:(id)arg3 completionHandler:(id)arg4 ;
