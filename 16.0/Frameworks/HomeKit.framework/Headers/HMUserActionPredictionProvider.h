...
@protocol HMFMessageReceiver, HMFLogging, HMDarwinNotificationProvider, HMUserActionPredictionProviderDataSource, OS_dispatch_queue;
...
+(id)logCategory;
-(id)initWithWorkQueue:(id)arg0 messageDispatcher:(id)arg1 UUID:(id)arg2 dataSource:(id)arg3 duetDataSource:(id)arg4 predictionTransformer:(id)arg5 darwinNotificationProvider:(id)arg6 ;
