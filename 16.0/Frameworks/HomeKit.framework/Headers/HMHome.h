...
@protocol HMSiriEndpointProfilesMessengerFactory, HMFLogging, HMMediaGroupsControllerDataSource, HMMediaGroupSettingsControllerDataSource, HMMutableApplicationData, HMObjectMerge, HMFMessageReceiver, NSSecureCoding, HMHomeDelegate, OS_dispatch_queue;

#import <Foundation/Foundation.h>

#import "HMApplicationData.h"
#import "HMMediaGroupsController.h"
#import "_HMContext.h"
...
@interface HMHome : NSObject <HMSiriEndpointProfilesMessengerFactory, HMFLogging, HMMediaGroupsControllerDataSource, HMMediaGroupSettingsControllerDataSource, HMMutableApplicationData, HMObjectMerge, HMFMessageReceiver, NSSecureCoding>
...
@property (retain) HMMediaGroupsController *audioGroupsController; // ivar: _audioGroupsController
...
-(NSUInteger)_mergeCurrentHomeAudioGroupsControllerWithNewHome:(id)arg0 ;
...
-(id)administrator;
-(id)availableDestinationsForMediaGroupsController:(id)arg0 ;
...
-(id)createMediaGroupSettingsController;
...
-(id)mediaGroupsController:(id)arg0 internalDestinationWithIdentifier:(id)arg1 ;
...
-(id)updateTargetIdentierFromGroupDestinationIdentifiers:(id)arg0 ;
...
-(void)_notifyDelegateOfAudioGroupsControllerUpdate;
...
-(void)notifyDelegateOfAudioGroupsControllerUpdate;
