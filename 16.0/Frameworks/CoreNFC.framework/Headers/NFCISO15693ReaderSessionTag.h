...
#ifndef NFCISO15693READERSESSIONTAG_H
#define NFCISO15693READERSESSIONTAG_H
...
+(BOOL)decodeIdentifier:(id)arg0 manufacturerCode:(*NSUInteger)arg1 serialNumber:(*id)arg2 ;
+(id)reverseByteOrder:(id)arg0 ;
-(BOOL)_transceiveWithData:(id)arg0 receivedData:(*id)arg1 commandConfig:(id)arg2 error:(*id)arg3 ;
-(NSUInteger)_parseResponseErrorWithData:(id)arg0 ;
-(id)_parseResponseData:(id)arg0 outError:(*id)arg1 ;
