...
@interface _MTLIndirectArgumentEncoder : MTLObjectWithLabel <MTLArgumentEncoder>
...
@property (readonly, nonatomic) _MTLIndirectArgumentBufferLayout *layout; // ivar: _layout
@property (readonly) Class superclass;


-(*void)constantDataAtIndex:(NSUInteger)arg0 ;
-(id)initWithLayout:(id)arg0 device:(id)arg1 ;
