...
@property (copy, nonatomic) NSArray *meshAdditionalBinaryFunctions; // ivar: _meshAdditionalBinaryFunctions
@property (copy, nonatomic) NSArray *objectAdditionalBinaryFunctions; // ivar: _objectAdditionalBinaryFunctions
