...
@class MTLHeap, MTLIOAccelDevice<MTLDevice>, NSString;
@protocol MTLDevice;


#import "MTLIOAccelResource.h"

@interface MTLIOAccelHeap : MTLHeap {
...
@property (readonly, nonatomic) NSUInteger protectionOptions;
...
-(id)initWithDevice:(id)arg0 size:(NSUInteger)arg1 options:(NSUInteger)arg2 args:(struct IOAccelNewResourceArgs *)arg3 argsSize:(unsigned int)arg4 ;
-(id)initWithDevice:(id)arg0 size:(NSUInteger)arg1 options:(NSUInteger)arg2 args:(struct IOAccelNewResourceArgs *)arg3 argsSize:(unsigned int)arg4 desc:(id)arg5 ;
