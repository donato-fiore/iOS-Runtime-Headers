...
typedef struct MTLMeshRenderPipelineDescriptorPrivate {
    ...
    NSUInteger binaryArchives;
    id NSArray;
    unsigned int pipelineLibrary;
...
typedef struct MTLRenderPipelineDescriptorPrivate {
    ...
    void meshBuffers;
    id MTLPipelineBufferDescriptorArrayInternal;
    BOOL maxTotalThreadsPerObjectThreadgroup;
    unsigned int maxTotalThreadsPerMeshThreadgroup;
    id vertexBuffers;
    id MTLPipelineBufferDescriptorArrayInternal;
    id fragmentBuffers;
    id MTLPipelineBufferDescriptorArrayInternal;
    ...
    NSUInteger binaryArchives;
    BOOL NSArray;
    BOOL vertexLinkedFunctions;
    id MTLLinkedFunctions;
    unsigned int fragmentLinkedFunctions;
