...
@interface MTLEmulationIndirectArgumentBufferLayout : MTLIndirectArgumentBufferLayout {
    ...
    *void _instanceAccelerationStructureIndices;
    ...
    NSUInteger _visibleFunctionTableOffset;
    NSUInteger _intersectionFunctionTableOffset;
    NSUInteger _primitiveAccelerationStructureOffset;
    NSUInteger _instanceAccelerationStructureOffset;
}
...
-(NSUInteger)offsetForInstanceAccelerationStructure:(NSUInteger)arg0 ;
-(NSUInteger)offsetForIntersectionFunctionTable:(NSUInteger)arg0 ;
-(NSUInteger)offsetForPrimitiveAccelerationStructure:(NSUInteger)arg0 ;
-(NSUInteger)offsetForSampler:(NSUInteger)arg0 ;
-(NSUInteger)offsetForTexture:(NSUInteger)arg0 ;
-(NSUInteger)offsetForVisibleFunctionTable:(NSUInteger)arg0 ;
