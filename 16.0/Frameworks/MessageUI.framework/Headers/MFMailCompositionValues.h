...
@class NSArray, NSString, CKContainerSetupInfo, CKShare, NSMutableArray, NSURL, NSDate, NSData;
...
@property (copy, nonatomic) CKContainerSetupInfo *ckContainerSetupInfo; // ivar: _ckContainerSetupInfo
@property (copy, nonatomic) CKShare *ckShare; // ivar: _ckShare
@property (nonatomic) BOOL ckShareAllowOthersToInvite; // ivar: _ckShareAllowOthersToInvite
@property (nonatomic) NSInteger ckSharePermissionType; // ivar: _ckSharePermissionType
...
@property (copy, nonatomic) NSString *hideMyEmailFrom; // ivar: _hideMyEmailFrom
...
@property (nonatomic) NSUInteger sendLaterContext; // ivar: _sendLaterContext
