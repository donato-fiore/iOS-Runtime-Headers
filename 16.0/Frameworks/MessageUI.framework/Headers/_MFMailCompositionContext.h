...
@class MFAttachmentComposeManager, EMMessageList, NSArray, MFAttachmentCompositionContext, MFAttachmentManager, NSString, CKContainerSetupInfo, CKShare, NSMutableArray, MFMailMessage, MFMessageLoadingContext, NSURL, EMMessage, EFFuture, NSDate, NSData;
...
@property (nonatomic) NSInteger ckSharePermissionType;
...
@property (nonatomic) NSUInteger sendLaterContext;
