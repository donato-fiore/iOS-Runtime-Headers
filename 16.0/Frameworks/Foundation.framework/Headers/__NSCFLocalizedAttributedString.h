...
+(struct __CFString *)copyStringWithMarkdown:(struct __CFString *)arg0 formatConfiguration:(struct __CFDictionary *)arg1 bundle:(struct __CFBundle *)arg2 tableURL:(struct __CFURL *)arg3 ;
...
-(id)initWithAttributedStringMarkdown:(id)arg0 formatConfiguration:(id)arg1 bundle:(struct __CFBundle *)arg2 tableURL:(id)arg3 ;
