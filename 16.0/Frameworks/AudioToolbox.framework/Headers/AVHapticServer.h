...
-(void)decrementRunningCountAndStopAudio:(BOOL)arg0 stopHaptics:(BOOL)arg1 clientID:(NSUInteger)arg2 category:(int)arg3 ;
-(void)displayRunningProcessEntriesWithOnTime:(NSUInteger)arg0 ;
-(void)doStopPrewarm:(struct shared_ptr<ClientEntry> )arg0 audio:(BOOL)arg1 haptics:(BOOL)arg2 ;
-(void)doStopRunning:(struct shared_ptr<ClientEntry> )arg0 audio:(BOOL)arg1 haptics:(BOOL)arg2 ;
-(void)doStopRunningForInterrupt:(struct shared_ptr<ClientEntry> )arg0 audio:(BOOL)arg1 haptics:(BOOL)arg2 ;
...
-(void)incrementRunningCountForAudio:(BOOL)arg0 haptics:(BOOL)arg1 clientID:(NSUInteger)arg2 category:(int)arg3 ;
