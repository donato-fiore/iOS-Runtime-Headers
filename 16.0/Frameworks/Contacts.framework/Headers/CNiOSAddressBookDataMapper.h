...
@interface CNiOSAddressBookDataMapper : NSObject <CNDataMapper>

 {
    ...
    NSInteger _contactIdentifierAuditMode;
}
...
// +(id)encodedPeopleFetcherForForFetchRequest:(id)arg0 addressBook:(*void)arg1 managedConfiguration:(id)arg2 addressBookCompletionHandler:(id)arg3 cursorCompletionHandler:(unk)arg4 environment:(id)arg5 identifierAuditMode:(unk)arg6  ;
+(void)initialize;
