...
+(id)stickerConfigurationForAvatarRecord:(id)arg0 stickerName:(id)arg1 pose:(id)arg2 ;
+(id)stickerConfigurationForAvatarRecord:(id)arg0 stickerName:(id)arg1 stickerPack:(id)arg2 ;
