...
+(void)gatherLocalizedStringsForCFBundle:(struct __CFBundle *)arg0 infoDictionary:(id)arg1 domains:(unsigned int)arg2 ;
+(void)gatherLocalizedStringsForCFBundle:(struct __CFBundle *)arg0 infoDictionary:(id)arg1 domains:(unsigned int)arg2 delegatesMightBeMainBundle:(BOOL)arg3 ;
