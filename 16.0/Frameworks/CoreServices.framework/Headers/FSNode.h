...
+(BOOL)canAccessURL:(id)arg0 withAuditToken:(struct ? *)arg1 operation:(char *)arg2 ;
+(BOOL)canReadMetadataOfURL:(id)arg0 fromSandboxWithAuditToken:(struct ? *)arg1 ;
+(BOOL)canReadMetadataOfURL:(id)arg0 withAuditToken:(struct ? *)arg1 ;
+(BOOL)canReadURL:(id)arg0 fromSandboxWithAuditToken:(struct ? *)arg1 ;
+(BOOL)canReadURL:(id)arg0 withAuditToken:(struct ? *)arg1 ;
+(BOOL)canWriteURL:(id)arg0 fromSandboxWithAuditToken:(struct ? *)arg1 ;
+(BOOL)canWriteURL:(id)arg0 withAuditToken:(struct ? *)arg1 ;
...
-(BOOL)canReadMetadataWithAuditToken:(struct ? *)arg0 ;
-(BOOL)canReadWithAuditToken:(struct ? *)arg0 ;
-(BOOL)canWriteFromSandboxWithAuditToken:(struct ? *)arg0 ;
-(BOOL)canWriteWithAuditToken:(struct ? *)arg0 ;
