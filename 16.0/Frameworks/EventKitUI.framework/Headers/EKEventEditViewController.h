...
@protocol UIAdaptivePresentationControllerDelegate, EKCalendarItemEditorDelegate, EKUIManagedViewController, EKEventEditViewDelegate;
...
-(id)editorForCalendarItemEditor:(id)arg0 ;
-(id)initWithNibName:(id)arg0 bundle:(id)arg1 ;
-(id)pasteboardManagerForCalendarItemEditor:(id)arg0 ;
