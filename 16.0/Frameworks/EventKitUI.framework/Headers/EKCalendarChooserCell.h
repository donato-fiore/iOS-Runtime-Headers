...
@property (retain, nonatomic) NSString *selectionCheckmarkCheckedSystemImageName; // ivar: _selectionCheckmarkCheckedSystemImageName
@property (retain, nonatomic) UIColor *selectionCheckmarkColor; // ivar: _selectionCheckmarkColor
@property (retain, nonatomic) NSString *selectionCheckmarkUncheckedSystemImageName; // ivar: _selectionCheckmarkUncheckedSystemImageName
