...
+(id)calendarsLimitedToSource:(id)arg0 writability:(NSInteger)arg1 onlyUnmanagedAccounts:(BOOL)arg2 forEvent:(id)arg3 inEventStore:(id)arg4 ;
+(id)calendarsLimitedToSource:(id)arg0 writability:(NSInteger)arg1 onlyUnmanagedAccounts:(BOOL)arg2 forEvents:(id)arg3 inEventStore:(id)arg4 ;
