...
@protocol BlockableScrollViewDelegate, EKDayOccurrenceViewDelegate, EKUIPasteboardManagerPasteDelegate, EKUIPasteboardManagerCutDelegate, EKUIRightClickEmptySpaceInteractionDelegate, EKDayViewDataSource, EKDayViewDelegate, EKEventGestureControllerDelegate, UIScrollViewDelegate, OS_dispatch_queue, EKDayViewControllerDataSource, EKDayViewControllerDelegate;
...
@interface EKDayViewController : UIViewController <BlockableScrollViewDelegate, EKDayOccurrenceViewDelegate, EKUIPasteboardManagerPasteDelegate, EKUIPasteboardManagerCutDelegate, EKUIRightClickEmptySpaceInteractionDelegate, EKDayViewDataSource, EKDayViewDelegate, EKEventGestureControllerDelegate, UIScrollViewDelegate>
