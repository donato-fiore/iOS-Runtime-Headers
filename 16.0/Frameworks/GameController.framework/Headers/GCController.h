...
@class NSString, NSMutableArray, NSArray, GCPhysicalInputProfile<GCNamedProfile>, GCSProfile;
...
+(BOOL)_settingsSupportedForBLEDevice:(id)arg0 settingsStore:(id)arg1 ;
+(BOOL)_settingsSupportedForBTClassicDevice:(id)arg0 settingsStore:(id)arg1 ;
+(BOOL)settingsSupportedForCBDevice:(id)arg0 ;
...
+(id)controllers;
+(id)current;
+(id)snapshotWithProfile:(id)arg0 ;
...
+(void)__open__;
+(void)_startWirelessControllerDiscoveryWithBTClassic:(BOOL)arg0 btle:(BOOL)arg1 completionHandler:(id)arg2 ;
