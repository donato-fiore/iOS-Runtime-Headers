...
-(BOOL)doScheduleParamCurveWithMemoryReserve:(NSUInteger)arg0 atTime:(CGFloat)arg1 channel:(NSUInteger)arg2 memoryReserve:(struct HapticSharedMemoryAddressReserve *)arg3 paramCurve:(id)arg4 error:(*id)arg5 ;
-(BOOL)doSendEvents:(id)arg0 withImmediateParameters:(id)arg1 atTime:(CGFloat)arg2 channel:(NSUInteger)arg3 sorted:(BOOL)arg4 outToken:(*NSUInteger)arg5 error:(*id)arg6 ;
...
-(BOOL)sendEvents:(id)arg0 withImmediateParameters:(id)arg1 atTime:(CGFloat)arg2 channel:(NSUInteger)arg3 outToken:(*NSUInteger)arg4 error:(*id)arg5 ;
-(BOOL)sendUnduckAudioCommand:(NSUInteger)arg0 atTime:(CGFloat)arg1 ;
