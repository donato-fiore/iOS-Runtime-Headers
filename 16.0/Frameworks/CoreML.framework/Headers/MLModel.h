...
@interface MLModel : NSObject <MLModeling>
 ...
 {
    atomic<bool> _emittedDetailsToInstruments;
}
...
@property (readonly) NSObject<MLProgram> *program;
...
+(void)compileModelAtURL:(id)arg0 completionHandler:(id)arg1 ;
+(void)loadContentsOfURL:(id)arg0 configuration:(id)arg1 completionHandler:(id)arg2 ;
+(void)loadModelAsset:(id)arg0 configuration:(id)arg1 completionHandler:(id)arg2 ;
