...
@property (copy, nonatomic) NSNumber *modelProgramParsingError; // ivar: _modelProgramParsingError
@property (copy, nonatomic) NSNumber *modelProgramValidationError; // ivar: _modelProgramValidationError
