...
@property (readonly, copy, nonatomic) NSArray *prerequisiteFeatureIdentifiers; // ivar: _prerequisiteFeatureIdentifiers
...
-(id)initWithPrerequisiteFeatureIdentifiers:(id)arg0 ;
