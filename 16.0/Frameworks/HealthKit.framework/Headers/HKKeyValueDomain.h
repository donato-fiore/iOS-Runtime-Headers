...
+(id)clientInterface;
+(id)emergencyDefaultsDomainWithHealthStore:(id)arg0 ;
...
+(id)safetyDefaultsLocalDomainWithHealthStore:(id)arg0 ;
+(id)serverInterface;
...
-(id)hkhr_electrocardiogramRecordingFirstOnboardingCompletedDateWithError:(*id)arg0 ;
