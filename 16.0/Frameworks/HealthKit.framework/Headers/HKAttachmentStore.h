...
-(id)initWithHealthStore:(id)arg0 schemaProviderIdentifier:(id)arg1 ;
-(id)remoteInterface;
...
-(void)addAttachmentWithName:(id)arg0 contentType:(id)arg1 URL:(id)arg2 toObjectWithIdentifier:(id)arg3 attachmentMetadata:(id)arg4 referenceMetadata:(id)arg5 completion:(id)arg6 ;
...
-(void)attachmentReferencesForObjectIdentifier:(id)arg0 completion:(id)arg1 ;
...
-(void)removeReference:(id)arg0 completion:(id)arg1 ;
