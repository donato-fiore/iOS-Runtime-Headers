...
@property (readonly, copy) NSArray *sourceTypes; // ivar: _sourceTypes
...
-(id)initWithRecordTypes:(id)arg0 sourceTypes:(id)arg1 predicate:(id)arg2 resultsHandler:(id)arg3 ;
