...
-(id)initWithCountryBitmasks:(id)arg0 compatibilityVersion:(NSInteger)arg1 contentVersion:(NSInteger)arg2 provenance:(NSInteger)arg3 ;
-(id)initWithDictionaryRepresentation:(id)arg0 provenance:(NSInteger)arg1 ;
-(id)initWithSupportedCountryCodes:(id)arg0 contentVersion:(NSInteger)arg1 ;
-(id)initWithSupportedCountryCodes:(id)arg0 contentVersion:(NSInteger)arg1 provenance:(NSInteger)arg2 ;
