...
@property (copy, nonatomic) id *scanCompletion; // ivar: _scanCompletion
...
-(id)createCBPeripheralsFromIDs:(id)arg0 ;
...
-(unsigned short)retrieveMaxConnectionForUsecase:(unsigned int)arg0 ;
-(void)HandleBluetoothUsageEventMsg:(id)arg0 ;
-(void)HandleControllerBTClockUpdateMsg:(id)arg0 ;
-(void)HandleRssiDetectionUpdateMsg:(id)arg0 ;
-(void)_scanForPeripheralsWithServices:(id)arg0 options:(id)arg1 ;
-(void)activateWhbCnxForCBPeripheral:(id)arg0 infoDict:(id)arg1 completion:(id)arg2 ;
...
-(void)connectWhbCBPeripheral:(id)arg0 withCompletion:(id)arg1 ;
...
-(void)handleFindMyDevicesUpdated:(id)arg0 ;
...
-(void)handleScanComplete:(id)arg0 ;
-(void)handleScanFailedToStartWithError:(id)arg0 ;
-(void)handleScanParamsUpdated:(id)arg0 ;
-(void)handleSupportedFeatures:(id)arg0 ;
-(void)handleUpdateUsageNotificationForPeripheral:(id)arg0 ;
...
-(void)retrievePeripheralsWithFindMyIds:(id)arg0 completion:(id)arg1 ;
-(void)retrievePeripheralsWithFindMySerialNumberStrings:(id)arg0 completion:(id)arg1 ;
-(void)retrievePeripheralsWithFindMySerialNumbers:(id)arg0 completion:(id)arg1 ;
...
-(void)scanForPeripheralsWithServices:(id)arg0 options:(id)arg1 completion:(id)arg2 ;
-(void)sendData:(id)arg0 toPeripheral:(id)arg1 ;
-(void)setBluetoothUsageNotifications:(id)arg0 options:(id)arg1 ;
...
-(void)setDesiredConnectionLatency:(NSInteger)arg0 forPeripheral:(id)arg1 completion:(id)arg2 ;
...
-(void)setLePowerControl:(id)arg0 options:(id)arg1 completion:(id)arg2 ;
...
-(void)updatePeripheral:(id)arg0 options:(id)arg1 ;
