...
-(id)_managedAssetFromPrimaryResourceData:(id)arg0 withUUID:(id)arg1 photoLibrary:(id)arg2 mainFileMetadata:(*id)arg3 getImageSource:(struct CGImageSource **)arg4 imageData:(*id)arg5 ;
