...
-(id)initWithLibraryScopeIdentifier:(id)arg0 filterContactIDs:(id)arg1 homeLocations:(id)arg2 frequentLocations:(id)arg3 ;
-(id)initWithLibraryScopeIdentifier:(id)arg0 filterContactIDs:(id)arg1 homeLocations:(id)arg2 isOnTrip:(BOOL)arg3 ;
-(id)initWithLibraryScopeIdentifier:(id)arg0 identities:(id)arg1 homeLocations:(id)arg2 frequentLocations:(id)arg3 ;
