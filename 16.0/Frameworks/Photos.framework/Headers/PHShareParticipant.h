...
@property (readonly, nonatomic) short exitState; // ivar: _exitState
...
+(id)entityKeyMap;
+(id)fetchContributorsForAsset:(id)arg0 options:(id)arg1 ;
+(id)fetchContributorsForAssets:(id)arg0 options:(id)arg1 ;
+(id)fetchParticipantsInShare:(id)arg0 options:(id)arg1 ;
+(id)fetchParticipantsWithLocalIdentifiers:(id)arg0 options:(id)arg1 ;
+(id)fetchShareParticipantForPerson:(id)arg0 options:(id)arg1 ;
+(id)fetchType;
+(id)identifierCode;
