...
+(id)entityKeyMap;
+(id)fetchLocalMomentShareFromShareURL:(id)arg0 error:(*id)arg1 options:(id)arg2 ;
...
+(void)fetchMomentShareFromShareURL:(id)arg0 options:(id)arg1 completionHandler:(id)arg2 ;
