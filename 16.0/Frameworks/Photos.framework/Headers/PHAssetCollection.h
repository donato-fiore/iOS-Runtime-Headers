...
@property (readonly, nonatomic) NSInteger privacyState; // ivar: _privacyState
...
+(id)assetCollectionDuplicateTypeMappingForAssetCollectionUUIDs:(id)arg0 photoLibrary:(id)arg1 error:(*id)arg2 ;
