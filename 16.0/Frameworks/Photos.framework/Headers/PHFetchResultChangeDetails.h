...
@class NSArray, NSIndexSet, PLSortedChangedObjects;
...
-(id)initWithFetchResult:(id)arg0 currentFetchResult:(id)arg1 sortedChangedIdentifiers:(id)arg2 unknownMergeEvent:(BOOL)arg3 ;
