...
+(void)readAttributeCapabilityMinimaWithAttributeCache:(id)arg0 endpoint:(id)arg1 queue:(id)arg2 completionHandler:(id)arg3 ;
+(void)readAttributeClusterRevisionWithAttributeCache:(id)arg0 endpoint:(id)arg1 queue:(id)arg2 completionHandler:(id)arg3 ;
+(void)readAttributeDataModelRevisionWithAttributeCache:(id)arg0 endpoint:(id)arg1 queue:(id)arg2 completionHandler:(id)arg3 ;
...
+(void)readAttributeLocalConfigDisabledWithAttributeCache:(id)arg0 endpoint:(id)arg1 queue:(id)arg2 completionHandler:(id)arg3 ;
+(void)readAttributeLocationWithAttributeCache:(id)arg0 endpoint:(id)arg1 queue:(id)arg2 completionHandler:(id)arg3 ;
...
-(void)dealloc;
-(void)mfgSpecificPingWithCompletionHandler:(id)arg0 ;
-(void)mfgSpecificPingWithParams:(id)arg0 completionHandler:(id)arg1 ;
-(void)readAttributeAcceptedCommandListWithCompletionHandler:(id)arg0 ;
-(void)readAttributeAttributeListWithCompletionHandler:(id)arg0 ;
-(void)readAttributeCapabilityMinimaWithCompletionHandler:(id)arg0 ;
-(void)readAttributeClusterRevisionWithCompletionHandler:(id)arg0 ;
-(void)readAttributeDataModelRevisionWithCompletionHandler:(id)arg0 ;
...
-(void)readAttributeLocalConfigDisabledWithCompletionHandler:(id)arg0 ;
-(void)readAttributeLocationWithCompletionHandler:(id)arg0 ;
...
// -(void)subscribeAttributeCapabilityMinimaWithMinInterval:(id)arg0 maxInterval:(id)arg1 params:(id)arg2 subscriptionEstablished:(id)arg3 reportHandler:(unk)arg4  ;
// -(void)subscribeAttributeClusterRevisionWithMinInterval:(id)arg0 maxInterval:(id)arg1 params:(id)arg2 subscriptionEstablished:(id)arg3 reportHandler:(unk)arg4  ;
// -(void)subscribeAttributeDataModelRevisionWithMinInterval:(id)arg0 maxInterval:(id)arg1 params:(id)arg2 subscriptionEstablished:(id)arg3 reportHandler:(unk)arg4  ;
...
// -(void)subscribeAttributeLocalConfigDisabledWithMinInterval:(id)arg0 maxInterval:(id)arg1 params:(id)arg2 subscriptionEstablished:(id)arg3 reportHandler:(unk)arg4  ;
// -(void)subscribeAttributeLocationWithMinInterval:(id)arg0 maxInterval:(id)arg1 params:(id)arg2 subscriptionEstablished:(id)arg3 reportHandler:(unk)arg4  ;
...
-(void)writeAttributeLocalConfigDisabledWithValue:(id)arg0 completionHandler:(id)arg1 ;
-(void)writeAttributeLocalConfigDisabledWithValue:(id)arg0 params:(id)arg1 completionHandler:(id)arg2 ;
-(void)writeAttributeLocationWithValue:(id)arg0 completionHandler:(id)arg1 ;
-(void)writeAttributeLocationWithValue:(id)arg0 params:(id)arg1 completionHandler:(id)arg2 ;
