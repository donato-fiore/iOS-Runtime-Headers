...
+(id)camera;
+(id)cameraWithCameraRef:(struct __C3DCamera *)arg0 ;
...
-(id)identifier;
-(id)init;
-(id)initPresentationCameraWithCameraRef:(struct __C3DCamera *)arg0 ;
-(id)initWithCameraRef:(struct __C3DCamera *)arg0 ;
