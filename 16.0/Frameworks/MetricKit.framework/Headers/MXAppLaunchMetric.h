...
@property (readonly) MXHistogram *histogrammedExtendedLaunch; // ivar: _histogrammedExtendedLaunch
...
-(id)initWithLaunchTimeData:(id)arg0 withResumeTimeData:(id)arg1 withActivationTimeData:(id)arg2 withExtendedLaunchTimeData:(id)arg3 ;
-(id)toDictionary;
