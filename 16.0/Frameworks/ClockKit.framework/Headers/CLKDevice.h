...
@property (readonly, nonatomic) BOOL supportsVictoryFaces; // ivar: _supportsVictoryFaces
...
+(CGFloat)screenCornerRadiusForSizeClass:(NSUInteger)arg0 ;
+(CGFloat)screenScaleForSizeClass:(NSUInteger)arg0 ;
...
+(struct CGRect )screenBoundsForSizeClass:(NSUInteger)arg0 ;
