...
#ifndef MPSGRAPHHAMMINGDISTANCEOP_H
#define MPSGRAPHHAMMINGDISTANCEOP_H
...
-(id)initWithGraph:(id)arg0 inputTensors:(id)arg1 controlDependencies:(id)arg2 resultDataType:(unsigned int)arg3 name:(id)arg4 ;
