...
#ifndef MPSGRAPHCONCATOP_H
#define MPSGRAPHCONCATOP_H
...
-(id)initWithGraph:(id)arg0 inputTensors:(id)arg1 controlDependencies:(id)arg2 dimension:(NSInteger)arg3 interleave:(BOOL)arg4 name:(id)arg5 ;
