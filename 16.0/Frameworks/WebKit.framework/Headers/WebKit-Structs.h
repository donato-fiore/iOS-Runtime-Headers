...
typedef struct WeakPtr<WebPushD::ApplePushServiceConnection, WTF::EmptyCounter> {
    RefPtr<WTF::WeakPtrImpl<>, WTF::RawPtrTraits<WTF::WeakPtrImpl<>>, WTF::DefaultRefDerefTraits<WTF::WeakPtrImpl<>>> m_impl;
} WeakPtr<WebPushD::ApplePushServiceConnection, WTF::EmptyCounter>;

typedef struct WeakPtr<WebPushD::ICAppBundle, WTF::EmptyCounter> {
    RefPtr<WTF::WeakPtrImpl<>, WTF::RawPtrTraits<WTF::WeakPtrImpl<>>, WTF::DefaultRefDerefTraits<WTF::WeakPtrImpl<>>> m_impl;
} WeakPtr<WebPushD::ICAppBundle, WTF::EmptyCounter>;
...
typedef struct Vector<WTF::RetainPtr<WKUserDefaults>, 0UL, WTF::CrashOnOverflow, 16UL, WTF::FastMalloc> {
    void m_buffer;
    unsigned int m_capacity;
    unsigned int m_size;
} Vector<WTF::RetainPtr<WKUserDefaults>, 0UL, WTF::CrashOnOverflow, 16UL, WTF::FastMalloc>;
...
typedef struct ObjectIdentifier<WebKit::DataTaskIdentifierType> {
    NSUInteger m_identifier;
} ObjectIdentifier<WebKit::DataTaskIdentifierType>;
...
typedef struct RetainPtr<PKShippingMethods> {
    void m_ptr;
} RetainPtr<PKShippingMethods>;
...
typedef struct OpaqueWKNotificationManager {
} // Error Processing Struct Fields
...
typedef struct WebPagePreferencesCaptivePortalModeObserver {
} // Error Processing Struct Fields

typedef struct __compressed_pair<WebKit::WebPagePreferencesCaptivePortalModeObserver *, std::default_delete<WebKit::WebPagePreferencesCaptivePortalModeObserver>> {
    WebPagePreferencesCaptivePortalModeObserver __value_;
} __compressed_pair<WebKit::WebPagePreferencesCaptivePortalModeObserver *, std::default_delete<WebKit::WebPagePreferencesCaptivePortalModeObserver>>;

typedef struct unique_ptr<WebKit::WebPagePreferencesCaptivePortalModeObserver, std::default_delete<WebKit::WebPagePreferencesCaptivePortalModeObserver>> {
    __compressed_pair<WebKit::WebPagePreferencesCaptivePortalModeObserver *, std::default_delete<WebKit::WebPagePreferencesCaptivePortalModeObserver>> __ptr_;
} unique_ptr<WebKit::WebPagePreferencesCaptivePortalModeObserver, std::default_delete<WebKit::WebPagePreferencesCaptivePortalModeObserver>>;
...
typedef struct RefPtr<const API::Attachment, WTF::RawPtrTraits<const API::Attachment>, WTF::DefaultRefDerefTraits<const API::Attachment>> {
    Attachment m_ptr;
} RefPtr<const API::Attachment, WTF::RawPtrTraits<const API::Attachment>, WTF::DefaultRefDerefTraits<const API::Attachment>>;
...
typedef struct ObjectStorage<API::DataTask> {
    type data;
} ObjectStorage<API::DataTask>;

typedef struct RetainPtr<id<_WKDataTaskDelegate>> {
    void m_ptr;
} RetainPtr<id<_WKDataTaskDelegate>>;
...
} OptionSet<WebCore::ModalContainerControlType>;
...
typedef struct Vector<WebKit::BackForwardListItemState, 0UL, WTF::CrashOnOverflow, 16UL, WTF::FastMalloc> {
    BackForwardListItemState m_buffer;
    unsigned int m_capacity;
    unsigned int m_size;
} Vector<WebKit::BackForwardListItemState, 0UL, WTF::CrashOnOverflow, 16UL, WTF::FastMalloc>;
...
typedef struct BackForwardListState {
    Vector<WebKit::BackForwardListItemState, 0UL, WTF::CrashOnOverflow, 16UL, WTF::FastMalloc> items;
...
typedef struct ElementContext {
    ...
    ProcessQualified<WTF::UUID> documentIdentifier;
...
typedef struct RpEntity {
    String field0;
    String field1;
    optional<WTF::String> field2;
} RpEntity;

typedef struct ArrayBufferView {
} // Error Processing Struct Fields

typedef struct RefPtr<JSC::ArrayBufferView, WTF::RawPtrTraits<JSC::ArrayBufferView>, WTF::DefaultRefDerefTraits<JSC::ArrayBufferView>> {
    ArrayBufferView field0;
} RefPtr<JSC::ArrayBufferView, WTF::RawPtrTraits<JSC::ArrayBufferView>, WTF::DefaultRefDerefTraits<JSC::ArrayBufferView>>;

typedef struct __alt<0UL, WTF::RefPtr<JSC::ArrayBufferView>> {
    RefPtr<JSC::ArrayBufferView, WTF::RawPtrTraits<JSC::ArrayBufferView>, WTF::DefaultRefDerefTraits<JSC::ArrayBufferView>> field0;
} __alt<0UL, WTF::RefPtr<JSC::ArrayBufferView>>;

typedef struct ArrayBuffer {
} // Error Processing Struct Fields

typedef struct RefPtr<JSC::ArrayBuffer, WTF::RawPtrTraits<JSC::ArrayBuffer>, WTF::DefaultRefDerefTraits<JSC::ArrayBuffer>> {
    ArrayBuffer field0;
} RefPtr<JSC::ArrayBuffer, WTF::RawPtrTraits<JSC::ArrayBuffer>, WTF::DefaultRefDerefTraits<JSC::ArrayBuffer>>;

typedef struct __alt<1UL, WTF::RefPtr<JSC::ArrayBuffer>> {
    RefPtr<JSC::ArrayBuffer, WTF::RawPtrTraits<JSC::ArrayBuffer>, WTF::DefaultRefDerefTraits<JSC::ArrayBuffer>> field0;
} __alt<1UL, WTF::RefPtr<JSC::ArrayBuffer>>;

typedef struct __impl<WTF::RefPtr<JSC::ArrayBufferView>, WTF::RefPtr<JSC::ArrayBuffer>> {
    int field0;
    short field1;
    CGFloat field2;
    SEL field3;
    ...
    float field47;
    char field48;
    __alt<0UL, WTF::RefPtr<JSC::ArrayBufferView>> field49;
    int field50;
    short field51;
    CGFloat field52;
    SEL field53;
    ...
    BOOL field70;
    long field71;
    unsigned long field72;
    unk field73;
    SEL field74;
    SEL field75;
    float field76;
    unsigned short field77;
    ...
    float field84;
    char field85;
    __alt<1UL, WTF::RefPtr<JSC::ArrayBuffer>> field86;
    int field87;
    short field88;
    CGFloat field89;
    SEL field90;
    ...
    BOOL field107;
    long field108;
    unsigned long field109;
    unsigned int field110;
} __impl<WTF::RefPtr<JSC::ArrayBufferView>, WTF::RefPtr<JSC::ArrayBuffer>>;

typedef struct variant<WTF::RefPtr<JSC::ArrayBufferView>, WTF::RefPtr<JSC::ArrayBuffer>> {
    __impl<WTF::RefPtr<JSC::ArrayBufferView>, WTF::RefPtr<JSC::ArrayBuffer>> field0;
...
typedef struct Vector<WebCore::PublicKeyCredentialCreationOptions::Parameters, 0UL, WTF::CrashOnOverflow, 16UL, WTF::FastMalloc> {
    Parameters field0;
    unsigned int field1;
    unsigned int field2;
} Vector<WebCore::PublicKeyCredentialCreationOptions::Parameters, 0UL, WTF::CrashOnOverflow, 16UL, WTF::FastMalloc>;

typedef struct PublicKeyCredentialDescriptor {
} // Error Processing Struct Fields

typedef struct Vector<WebCore::PublicKeyCredentialDescriptor, 0UL, WTF::CrashOnOverflow, 16UL, WTF::FastMalloc> {
    PublicKeyCredentialDescriptor field0;
    unsigned int field1;
    unsigned int field2;
} Vector<WebCore::PublicKeyCredentialDescriptor, 0UL, WTF::CrashOnOverflow, 16UL, WTF::FastMalloc>;
...
typedef struct optional<WebCore::ResidentKeyRequirement> {
    unk field0;
    char field1;
    unsigned char field2;
    BOOL field3;
} optional<WebCore::ResidentKeyRequirement>;

typedef struct AuthenticatorSelectionCriteria {
    optional<WebCore::AuthenticatorAttachment> field0;
    optional<WebCore::ResidentKeyRequirement> field1;
    BOOL field2;
    int field3;
...
typedef struct PublicKeyCredentialCreationOptions {
    ...
    UserEntity field1;
    BufferSource field2;
    Vector<WebCore::PublicKeyCredentialCreationOptions::Parameters, 0UL, WTF::CrashOnOverflow, 16UL, WTF::FastMalloc> field3;
    optional<unsigned int> field4;
    Vector<WebCore::PublicKeyCredentialDescriptor, 0UL, WTF::CrashOnOverflow, 16UL, WTF::FastMalloc> field5;
...
typedef struct PublicKeyCredentialRequestOptions {
    ...
    String field2;
    Vector<WebCore::PublicKeyCredentialDescriptor, 0UL, WTF::CrashOnOverflow, 16UL, WTF::FastMalloc> field3;
    int field4;
...
typedef struct Vector<WTF::RetainPtr<WKModalContainerClassifierInput>, 0UL, WTF::CrashOnOverflow, 16UL, WTF::FastMalloc> {
    void m_buffer;
    unsigned int m_capacity;
    unsigned int m_size;
} Vector<WTF::RetainPtr<WKModalContainerClassifierInput>, 0UL, WTF::CrashOnOverflow, 16UL, WTF::FastMalloc>;
...
typedef struct Vector<WebCore::ContactProperty, 0UL, WTF::CrashOnOverflow, 16UL, WTF::FastMalloc> {
    unsigned char m_buffer;
    unsigned int m_capacity;
    unsigned int m_size;
} Vector<WebCore::ContactProperty, 0UL, WTF::CrashOnOverflow, 16UL, WTF::FastMalloc>;
...
typedef struct Vector<WebCore::FloatQuad, 0UL, WTF::CrashOnOverflow, 16UL, WTF::FastMalloc> {
    FloatQuad m_buffer;
    unsigned int m_capacity;
    unsigned int m_size;
} Vector<WebCore::FloatQuad, 0UL, WTF::CrashOnOverflow, 16UL, WTF::FastMalloc>;

typedef struct GridHighlightOverlay {
} // Error Processing Struct Fields

typedef struct Vector<WebCore::InspectorOverlay::Highlight::GridHighlightOverlay, 0UL, WTF::CrashOnOverflow, 16UL, WTF::FastMalloc> {
    GridHighlightOverlay m_buffer;
    unsigned int m_capacity;
    unsigned int m_size;
} Vector<WebCore::InspectorOverlay::Highlight::GridHighlightOverlay, 0UL, WTF::CrashOnOverflow, 16UL, WTF::FastMalloc>;

typedef struct FlexHighlightOverlay {
} // Error Processing Struct Fields

typedef struct Vector<WebCore::InspectorOverlay::Highlight::FlexHighlightOverlay, 0UL, WTF::CrashOnOverflow, 16UL, WTF::FastMalloc> {
    FlexHighlightOverlay m_buffer;
    unsigned int m_capacity;
    unsigned int m_size;
} Vector<WebCore::InspectorOverlay::Highlight::FlexHighlightOverlay, 0UL, WTF::CrashOnOverflow, 16UL, WTF::FastMalloc>;
...
typedef struct Highlight {
    ...
    Color marginColor;
    int type;
    Vector<WebCore::FloatQuad, 0UL, WTF::CrashOnOverflow, 16UL, WTF::FastMalloc> quads;
    Vector<WebCore::InspectorOverlay::Highlight::GridHighlightOverlay, 0UL, WTF::CrashOnOverflow, 16UL, WTF::FastMalloc> gridHighlightOverlays;
    Vector<WebCore::InspectorOverlay::Highlight::FlexHighlightOverlay, 0UL, WTF::CrashOnOverflow, 16UL, WTF::FastMalloc> flexHighlightOverlays;
    BOOL usePageCoordinates;
} Highlight;

typedef struct optional<WebCore::InspectorOverlay::Highlight> {
    unk ;
    char __null_state_;
    Highlight __val_;
    BOOL __engaged_;
} optional<WebCore::InspectorOverlay::Highlight>;
...
typedef struct WeakPtr<WebKit::CcidService, WTF::EmptyCounter> {
    RefPtr<WTF::WeakPtrImpl<>, WTF::RawPtrTraits<WTF::WeakPtrImpl<>>, WTF::DefaultRefDerefTraits<WTF::WeakPtrImpl<>>> m_impl;
} WeakPtr<WebKit::CcidService, WTF::EmptyCounter>;

typedef struct RetainPtr<TKSmartCardSlot> {
    void m_ptr;
} RetainPtr<TKSmartCardSlot>;
...
typedef struct WeakPtr<WebKit::MockCcidService, WTF::EmptyCounter> {
    RefPtr<WTF::WeakPtrImpl<>, WTF::RawPtrTraits<WTF::WeakPtrImpl<>>, WTF::DefaultRefDerefTraits<WTF::WeakPtrImpl<>>> m_impl;
} WeakPtr<WebKit::MockCcidService, WTF::EmptyCounter>;
...
typedef struct WeakHashSet<WebKit::ProcessAndUIAssertion, WTF::EmptyCounter, WTF::EnableWeakPtrThreadingAssertions::Yes> {
...
} WeakHashSet<WebKit::ProcessAndUIAssertion, WTF::EmptyCounter, WTF::EnableWeakPtrThreadingAssertions::Yes>;

typedef struct ProcessStateMonitor {
} // Error Processing Struct Fields

typedef struct __compressed_pair<WebKit::ProcessStateMonitor *, std::default_delete<WebKit::ProcessStateMonitor>> {
    ProcessStateMonitor __value_;
} __compressed_pair<WebKit::ProcessStateMonitor *, std::default_delete<WebKit::ProcessStateMonitor>>;

typedef struct unique_ptr<WebKit::ProcessStateMonitor, std::default_delete<WebKit::ProcessStateMonitor>> {
    __compressed_pair<WebKit::ProcessStateMonitor *, std::default_delete<WebKit::ProcessStateMonitor>> __ptr_;
} unique_ptr<WebKit::ProcessStateMonitor, std::default_delete<WebKit::ProcessStateMonitor>>;
...
typedef struct Vector<WebCore::FloatRect, 0UL, WTF::CrashOnOverflow, 16UL, WTF::FastMalloc> {
} // Error Processing Struct Fields
...
typedef struct InteractionInformationAtPosition {
    ...
    optional<WebCore::ElementContext> hostImageOrVideoElementContext;
...
typedef struct VectorBuffer<GeolocationRequestData, 0UL, WTF::FastMalloc> {
    GeolocationRequestData m_buffer;
    unsigned int m_capacity;
    unsigned int m_size;
} VectorBuffer<GeolocationRequestData, 0UL, WTF::FastMalloc>;

typedef struct Deque<GeolocationRequestData, 0UL> {
    NSUInteger m_start;
    NSUInteger m_end;
    VectorBuffer<GeolocationRequestData, 0UL, WTF::FastMalloc> m_buffer;
} Deque<GeolocationRequestData, 0UL>;
...
typedef struct array<bool, 4UL> {
    BOOL field0;
} array<bool, 4UL>;

typedef struct RectEdges<bool> {
    array<bool, 4UL> field0;
} RectEdges<bool>;
...
typedef struct RetainPtr<id<UITextSearchAggregator>> {
    void m_ptr;
} RetainPtr<id<UITextSearchAggregator>>;
...
typedef struct Vector<WebCore::DataListSuggestion, 0UL, WTF::CrashOnOverflow, 16UL, WTF::FastMalloc> {
    DataListSuggestion m_buffer;
    unsigned int m_capacity;
    unsigned int m_size;
} Vector<WebCore::DataListSuggestion, 0UL, WTF::CrashOnOverflow, 16UL, WTF::FastMalloc>;
...
typedef struct __compressed_pair<WTF::Detail::CallableWrapperBase<void, NSArray<_WKFileUploadItem *> *> *, std::default_delete<WTF::Detail::CallableWrapperBase<void, NSArray<_WKFileUploadItem *> *>>> {
    void __value_;
} __compressed_pair<WTF::Detail::CallableWrapperBase<void, NSArray<_WKFileUploadItem *> *> *, std::default_delete<WTF::Detail::CallableWrapperBase<void, NSArray<_WKFileUploadItem *> *>>>;
...
typedef struct unique_ptr<WTF::Detail::CallableWrapperBase<void, NSArray<_WKFileUploadItem *> *>, std::default_delete<WTF::Detail::CallableWrapperBase<void, NSArray<_WKFileUploadItem *> *>>> {
    __compressed_pair<WTF::Detail::CallableWrapperBase<void, NSArray<_WKFileUploadItem *> *> *, std::default_delete<WTF::Detail::CallableWrapperBase<void, NSArray<_WKFileUploadItem *> *>>> __ptr_;
...
typedef struct RetainPtr<UIStackView> {
    void m_ptr;
} RetainPtr<UIStackView>;
...
typedef struct __compressed_pair<WTF::Observer<void (bool)> *, std::default_delete<WTF::Observer<void (bool)>>> {
    void __value_;
} __compressed_pair<WTF::Observer<void (bool)> *, std::default_delete<WTF::Observer<void (bool)>>>;

typedef struct unique_ptr<WTF::Observer<void (bool)>, std::default_delete<WTF::Observer<void (bool)>>> {
    __compressed_pair<WTF::Observer<void (bool)> *, std::default_delete<WTF::Observer<void (bool)>>> __ptr_;
...
typedef struct ObjectStorage<WebKit::InjectedBundleCSSStyleDeclarationHandle> {
    type data;
} ObjectStorage<WebKit::InjectedBundleCSSStyleDeclarationHandle>;
...
typedef struct Vector<unsigned short, 0UL, WTF::CrashOnOverflow, 16UL, WTF::FastMalloc> {
    unsigned short m_buffer;
    unsigned int m_capacity;
    unsigned int m_size;
} Vector<unsigned short, 0UL, WTF::CrashOnOverflow, 16UL, WTF::FastMalloc>;
...
typedef struct ObjectIdentifier<WebKit::TapIdentifierType> {
    NSUInteger m_identifier;
} ObjectIdentifier<WebKit::TapIdentifierType>;
...
typedef struct RetainPtr<VKCImageAnalyzerRequest> {
    void field0;
} RetainPtr<VKCImageAnalyzerRequest>;
...
typedef struct HashTable<WTF::RetainPtr<WKDeferringGestureRecognizer>, WTF::RetainPtr<WKDeferringGestureRecognizer>, WTF::IdentityExtractor, WTF::DefaultHash<WTF::RetainPtr<WKDeferringGestureRecognizer>>, WTF::HashTraits<WTF::RetainPtr<WKDeferringGestureRecognizer>>, WTF::HashTraits<WTF::RetainPtr<WKDeferringGestureRecognizer>>> {
    ...
    void m_table;
    unsigned int m_tableForLLDB;
} HashTable<WTF::RetainPtr<WKDeferringGestureRecognizer>, WTF::RetainPtr<WKDeferringGestureRecognizer>, WTF::IdentityExtractor, WTF::DefaultHash<WTF::RetainPtr<WKDeferringGestureRecognizer>>, WTF::HashTraits<WTF::RetainPtr<WKDeferringGestureRecognizer>>, WTF::HashTraits<WTF::RetainPtr<WKDeferringGestureRecognizer>>>;

typedef struct HashSet<WTF::RetainPtr<WKDeferringGestureRecognizer>, WTF::DefaultHash<WTF::RetainPtr<WKDeferringGestureRecognizer>>, WTF::HashTraits<WTF::RetainPtr<WKDeferringGestureRecognizer>>, WTF::HashTableTraits> {
    HashTable<WTF::RetainPtr<WKDeferringGestureRecognizer>, WTF::RetainPtr<WKDeferringGestureRecognizer>, WTF::IdentityExtractor, WTF::DefaultHash<WTF::RetainPtr<WKDeferringGestureRecognizer>>, WTF::HashTraits<WTF::RetainPtr<WKDeferringGestureRecognizer>>, WTF::HashTraits<WTF::RetainPtr<WKDeferringGestureRecognizer>>> m_impl;
} HashSet<WTF::RetainPtr<WKDeferringGestureRecognizer>, WTF::DefaultHash<WTF::RetainPtr<WKDeferringGestureRecognizer>>, WTF::HashTraits<WTF::RetainPtr<WKDeferringGestureRecognizer>>, WTF::HashTableTraits>;

typedef struct optional<WTF::HashSet<WTF::RetainPtr<WKDeferringGestureRecognizer>>> {
    unk ;
    char __null_state_;
    HashSet<WTF::RetainPtr<WKDeferringGestureRecognizer>, WTF::DefaultHash<WTF::RetainPtr<WKDeferringGestureRecognizer>>, WTF::HashTraits<WTF::RetainPtr<WKDeferringGestureRecognizer>>, WTF::HashTableTraits> __val_;
    BOOL __engaged_;
} optional<WTF::HashSet<WTF::RetainPtr<WKDeferringGestureRecognizer>>>;
...
typedef struct Vector<WebCore::HTTPHeaderMap::CommonHeader, 0UL, WTF::CrashOnOverflow, 6UL, WTF::FastMalloc> {
    CommonHeader m_buffer;
    unsigned int m_capacity;
    unsigned int m_size;
} Vector<WebCore::HTTPHeaderMap::CommonHeader, 0UL, WTF::CrashOnOverflow, 6UL, WTF::FastMalloc>;

typedef struct UncommonHeader {
} // Error Processing Struct Fields

typedef struct Vector<WebCore::HTTPHeaderMap::UncommonHeader, 0UL, WTF::CrashOnOverflow, 0UL, WTF::FastMalloc> {
    UncommonHeader m_buffer;
    unsigned int m_capacity;
    unsigned int m_size;
} Vector<WebCore::HTTPHeaderMap::UncommonHeader, 0UL, WTF::CrashOnOverflow, 0UL, WTF::FastMalloc>;

typedef struct HTTPHeaderMap {
    Vector<WebCore::HTTPHeaderMap::CommonHeader, 0UL, WTF::CrashOnOverflow, 6UL, WTF::FastMalloc> m_commonHeaders;
    Vector<WebCore::HTTPHeaderMap::UncommonHeader, 0UL, WTF::CrashOnOverflow, 0UL, WTF::FastMalloc> m_uncommonHeaders;
} HTTPHeaderMap;
...
typedef struct Vector<bool, 0UL, WTF::CrashOnOverflow, 16UL, WTF::FastMalloc> {
    BOOL m_buffer;
    unsigned int m_capacity;
    unsigned int m_size;
} Vector<bool, 0UL, WTF::CrashOnOverflow, 16UL, WTF::FastMalloc>;
...
typedef struct Vector<WebKit::OptionItem, 0UL, WTF::CrashOnOverflow, 16UL, WTF::FastMalloc> {
    OptionItem m_buffer;
    unsigned int m_capacity;
    unsigned int m_size;
} Vector<WebKit::OptionItem, 0UL, WTF::CrashOnOverflow, 16UL, WTF::FastMalloc>;

typedef struct Vector<WebCore::Color, 0UL, WTF::CrashOnOverflow, 16UL, WTF::FastMalloc> {
} // Error Processing Struct Fields

typedef struct MonotonicObjectIdentifier<WebKit::FocusedElementInformationIdentifierType> {
    NSUInteger m_identifier;
} MonotonicObjectIdentifier<WebKit::FocusedElementInformationIdentifierType>;
...
typedef struct FocusedElementInformation {
    ...
    String formAction;
    Vector<WebKit::OptionItem, 0UL, WTF::CrashOnOverflow, 16UL, WTF::FastMalloc> selectOptions;
    int selectedIndex;
    String value;
    ...
    Color colorValue;
    Vector<WebCore::Color, 0UL, WTF::CrashOnOverflow, 16UL, WTF::FastMalloc> suggestedColors;
    ...
    BOOL preventScroll;
    MonotonicObjectIdentifier<WebKit::FocusedElementInformationIdentifierType> identifier;
    NSUInteger containerScrollingNodeID;
...
typedef struct Vector<WebCore::SelectionGeometry, 0UL, WTF::CrashOnOverflow, 16UL, WTF::FastMalloc> {
} // Error Processing Struct Fields
...
typedef struct WKSelectionDrawingInfo {
    ...
    IntRect caretRect;
    Color caretColor;
    Vector<WebCore::SelectionGeometry, 0UL, WTF::CrashOnOverflow, 16UL, WTF::FastMalloc> selectionGeometries;
...
typedef struct Vector<std::optional<std::pair<WebKit::InteractionInformationRequest, WTF::BlockPtr<void (WebKit::InteractionInformationAtPosition)>>>, 0UL, WTF::CrashOnOverflow, 16UL, WTF::FastMalloc> {
    void m_buffer;
    unsigned int m_capacity;
    unsigned int m_size;
} Vector<std::optional<std::pair<WebKit::InteractionInformationRequest, WTF::BlockPtr<void (WebKit::InteractionInformationAtPosition)>>>, 0UL, WTF::CrashOnOverflow, 16UL, WTF::FastMalloc>;
...
typedef struct optional<WebCore::DOMPasteAccessCategory> {
    unk ;
    char __null_state_;
    unsigned char __val_;
    BOOL __engaged_;
} optional<WebCore::DOMPasteAccessCategory>;
...
typedef struct Vector<WebKit::DragSourceState, 0UL, WTF::CrashOnOverflow, 16UL, WTF::FastMalloc> {
} // Error Processing Struct Fields

typedef struct ItemAndPreviewProvider {
} // Error Processing Struct Fields

typedef struct Vector<WebKit::ItemAndPreviewProvider, 0UL, WTF::CrashOnOverflow, 16UL, WTF::FastMalloc> {
    ItemAndPreviewProvider m_buffer;
    unsigned int m_capacity;
    unsigned int m_size;
} Vector<WebKit::ItemAndPreviewProvider, 0UL, WTF::CrashOnOverflow, 16UL, WTF::FastMalloc>;

typedef struct ItemAndPreview {
} // Error Processing Struct Fields

typedef struct Vector<WebKit::ItemAndPreview, 0UL, WTF::CrashOnOverflow, 16UL, WTF::FastMalloc> {
    ItemAndPreview m_buffer;
    unsigned int m_capacity;
    unsigned int m_size;
} Vector<WebKit::ItemAndPreview, 0UL, WTF::CrashOnOverflow, 16UL, WTF::FastMalloc>;
...
typedef struct DragDropInteractionState {
    ...
    Vector<WebKit::DragSourceState, 0UL, WTF::CrashOnOverflow, 16UL, WTF::FastMalloc> m_activeDragSources;
    Vector<WebKit::ItemAndPreviewProvider, 0UL, WTF::CrashOnOverflow, 16UL, WTF::FastMalloc> m_delayedItemPreviewProviders;
    Vector<WebKit::ItemAndPreview, 0UL, WTF::CrashOnOverflow, 16UL, WTF::FastMalloc> m_defaultDropPreviews;
...
typedef struct Vector<WTF::BlockPtr<void (WebKit::ProceedWithTextSelectionInImage)>, 0UL, WTF::CrashOnOverflow, 16UL, WTF::FastMalloc> {
    void m_buffer;
    unsigned int m_capacity;
    unsigned int m_size;
} Vector<WTF::BlockPtr<void (WebKit::ProceedWithTextSelectionInImage)>, 0UL, WTF::CrashOnOverflow, 16UL, WTF::FastMalloc>;

typedef struct RetainPtr<VKCImageAnalyzer> {
    void m_ptr;
} RetainPtr<VKCImageAnalyzer>;

typedef struct RetainPtr<QLPreviewController> {
    void m_ptr;
} RetainPtr<QLPreviewController>;

typedef struct ImageAnalysisContextMenuActionData {
    BOOL hasSelectableText;
    BOOL hasVisualSearchResults;
    RetainPtr<CGImage *> copySubjectResult;
    RetainPtr<UIMenu> machineReadableCodeMenu;
} ImageAnalysisContextMenuActionData;

typedef struct optional<WebKit::ImageAnalysisContextMenuActionData> {
    unk ;
    char __null_state_;
    ImageAnalysisContextMenuActionData __val_;
    BOOL __engaged_;
} optional<WebKit::ImageAnalysisContextMenuActionData>;

typedef struct RetainPtr<VKCImageAnalysisInteraction> {
    void m_ptr;
} RetainPtr<VKCImageAnalysisInteraction>;

typedef struct RetainPtr<NSMutableSet<UIButton *>> {
    void m_ptr;
} RetainPtr<NSMutableSet<UIButton *>>;

typedef struct RemoveBackgroundData {
    ElementContext element;
    RetainPtr<CGImage *> image;
    String preferredMIMEType;
} RemoveBackgroundData;

typedef struct optional<WebKit::RemoveBackgroundData> {
    unk ;
    char __null_state_;
    RemoveBackgroundData __val_;
    BOOL __engaged_;
} optional<WebKit::RemoveBackgroundData>;
...
typedef struct Vector<WTF::RetainPtr<NSURL>, 0UL, WTF::CrashOnOverflow, 16UL, WTF::FastMalloc> {
    void m_buffer;
    unsigned int m_capacity;
    unsigned int m_size;
} Vector<WTF::RetainPtr<NSURL>, 0UL, WTF::CrashOnOverflow, 16UL, WTF::FastMalloc>;
...
typedef struct WebFoundTextRange {
    NSUInteger field0;
    NSUInteger field1;
    AtomString field2;
    NSUInteger field3;
...
typedef struct __compressed_pair<WTF::Detail::CallableWrapperBase<void, std::variant<WebKit::ContinueUnsafeLoad, WTF::URL> &&> *, std::default_delete<WTF::Detail::CallableWrapperBase<void, std::variant<WebKit::ContinueUnsafeLoad, WTF::URL> &&>>> {
    void __value_;
} __compressed_pair<WTF::Detail::CallableWrapperBase<void, std::variant<WebKit::ContinueUnsafeLoad, WTF::URL> &&> *, std::default_delete<WTF::Detail::CallableWrapperBase<void, std::variant<WebKit::ContinueUnsafeLoad, WTF::URL> &&>>>;

typedef struct unique_ptr<WTF::Detail::CallableWrapperBase<void, std::variant<WebKit::ContinueUnsafeLoad, WTF::URL> &&>, std::default_delete<WTF::Detail::CallableWrapperBase<void, std::variant<WebKit::ContinueUnsafeLoad, WTF::URL> &&>>> {
    __compressed_pair<WTF::Detail::CallableWrapperBase<void, std::variant<WebKit::ContinueUnsafeLoad, WTF::URL> &&> *, std::default_delete<WTF::Detail::CallableWrapperBase<void, std::variant<WebKit::ContinueUnsafeLoad, WTF::URL> &&>>> __ptr_;
} unique_ptr<WTF::Detail::CallableWrapperBase<void, std::variant<WebKit::ContinueUnsafeLoad, WTF::URL> &&>, std::default_delete<WTF::Detail::CallableWrapperBase<void, std::variant<WebKit::ContinueUnsafeLoad, WTF::URL> &&>>>;

typedef struct Function<void (std::variant<WebKit::ContinueUnsafeLoad, WTF::URL> &&)> {
    unique_ptr<WTF::Detail::CallableWrapperBase<void, std::variant<WebKit::ContinueUnsafeLoad, WTF::URL> &&>, std::default_delete<WTF::Detail::CallableWrapperBase<void, std::variant<WebKit::ContinueUnsafeLoad, WTF::URL> &&>>> m_callableWrapper;
} Function<void (std::variant<WebKit::ContinueUnsafeLoad, WTF::URL> &&)>;

typedef struct CompletionHandler<void (std::variant<WebKit::ContinueUnsafeLoad, WTF::URL> &&)> {
    Function<void (std::variant<WebKit::ContinueUnsafeLoad, WTF::URL> &&)> m_function;
} CompletionHandler<void (std::variant<WebKit::ContinueUnsafeLoad, WTF::URL> &&)>;
