...
@property (retain, nonatomic) NSDictionary *additionalMeltedObjects; // ivar: _additionalMeltedObjects
...
+(id)_array:(id)arg0 intersectedWithSet:(id)arg1 minusSet:(id)arg2 ;
...
+(id)duplicatedPersistentObjectForObject:(id)arg0 alreadyCopiedObjects:(id)arg1 ;
...
+(id)knownSummaryKeys;
+(id)objectsIDsExistingInStoreFromObjects:(id)arg0 eventStore:(id)arg1 ;
+(id)propertiesUnavailableForPartialObjects;
// +(void)_addChangesFromObject:(id)arg0 toObjects:(id)arg1 passingTest:(id)arg2 copyingBackingObjects:(unk)arg3  ;
...
+(void)addChangesFromObject:(id)arg0 toObjects:(id)arg1 passingTest:(id)arg2 ;
...
-(BOOL)revert;
-(BOOL)shouldLoadRelationshipForValidation:(id)arg0 ;
...
-(id)_readWriteLock;
// -(id)_recursiveSnapshotCopyWithPropertyAccessor:(id)arg0 propertyKeysToCopy:(unk)arg1 propertyKeysToSkip:(id)arg2 recurseOnWeakRelations:(id)arg3  ;
...
// -(void)_addChangesFromObject:(id)arg0 passingTest:(id)arg1 ignoreRelations:(unk)arg2 copyingBackingObjects:(id)arg3  ;
...
-(void)augmentMeltedObjectCache:(id)arg0 ;
