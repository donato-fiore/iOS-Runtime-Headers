...
+(id)EKObjectIDsFromData:(id)arg0 databaseID:(int)arg1 ;
+(id)EKObjectIDsFromData:(id)arg0 range:(struct _NSRange )arg1 databaseID:(int)arg2 ;
+(id)objectIDWithCADObjectID:(id)arg0 ;
+(id)objectIDWithEntityType:(int)arg0 rowID:(int)arg1 ;
+(id)objectIDWithEntityType:(int)arg0 rowID:(int)arg1 databaseID:(int)arg2 ;
...
-(id)initWithEntityType:(int)arg0 rowID:(int)arg1 databaseID:(int)arg2 temporary:(BOOL)arg3 ;
