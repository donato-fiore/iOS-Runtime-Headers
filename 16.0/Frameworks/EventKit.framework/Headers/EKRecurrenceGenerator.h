...
+(BOOL)_isLunarBirthdayRecurrenceRule:(id)arg0 lunarCalendarString:(id)arg1 ;
+(NSUInteger)_weekStartFromICSRule:(id)arg0 ;
+(id)_copyDatesForLunarBirthdayFromDate:(id)arg0 toDate:(id)arg1 inTimeZone:(id)arg2 lunarCalendarString:(id)arg3 ;
+(id)_daysOfWeekFromICSRule:(id)arg0 ;
+(id)datesByExpandingRule:(id)arg0 fromDate:(id)arg1 toDate:(id)arg2 inTimezone:(id)arg3 isAllDay:(BOOL)arg4 lunarCalendarString:(id)arg5 ;
...
-(id)adjustedExceptionDatesFromDates:(id)arg0 fromGMTToTimeZone:(id)arg1 ;
...
-(id)copyOccurrenceDatesWithEKEvent:(id)arg0 recurrenceRule:(id)arg1 startDate:(id)arg2 endDate:(id)arg3 timeZone:(id)arg4 exceptionDates:(id)arg5 limit:(NSInteger)arg6 adjustDatesForAllDayEvents:(BOOL)arg7 ;
...
-(id)copyOccurrenceDatesWithEKEvent:(id)arg0 startDate:(id)arg1 endDate:(id)arg2 timeZone:(id)arg3 exceptionDates:(id)arg4 limit:(NSInteger)arg5 adjustDatesForAllDayEvents:(BOOL)arg6 ;
...
-(id)nextOccurrenceDateWithEKRecurrences:(id)arg0 forCalendarItem:(id)arg1 exceptionDates:(id)arg2 initialDate:(id)arg3 afterDate:(id)arg4 inclusive:(BOOL)arg5 ;
-(id)nextOccurrenceDateWithEKRecurrences:(id)arg0 forCalendarItem:(id)arg1 initialDate:(id)arg2 afterDate:(id)arg3 ;
-(id)nextOccurrenceDateWithEKRecurrences:(id)arg0 forCalendarItem:(id)arg1 initialDate:(id)arg2 afterDate:(id)arg3 inclusive:(BOOL)arg4 ;
