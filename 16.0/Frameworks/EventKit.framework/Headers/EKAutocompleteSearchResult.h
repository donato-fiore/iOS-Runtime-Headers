...
@property (retain, nonatomic) NSArray *pasteboardResults; // ivar: _pasteboardResults
...
@property (retain, nonatomic) EKStructuredLocation *travelStartLocation; // ivar: _travelStartLocation
...
-(NSUInteger)hash;
-(id)_attendeesForSuggestedEventFromAttendees:(id)arg0 ;
