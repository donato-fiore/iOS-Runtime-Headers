...
@class NSArray, NSString, NSDate, NSNumber, NSMutableArray, NSTimeZone, NSURL;
...
@property (retain, nonatomic) NSNumber *isNew; // ivar: _isNew
...
@property (retain, nonatomic) EKSerializableParticipant *selfAttendee; // ivar: _selfAttendee
...
-(void)_initAttendees:(id)arg0 selfAttendee:(id)arg1 ;
