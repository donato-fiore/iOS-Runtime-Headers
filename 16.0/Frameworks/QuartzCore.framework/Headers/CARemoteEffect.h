...
@property (readonly, nonatomic) NSDictionary *animations; // ivar: _animations
@property (copy) NSString *baseState; // ivar: _baseState
@property CGFloat blendFactor; // ivar: _blendFactor
@property (readonly, nonatomic) NSUInteger effectID; // ivar: _effectID
@property (readonly, nonatomic) NSUInteger layerRenderID; // ivar: _layerRenderID
