...
@class UIView, WBSFormMetadata, NSDictionary, NSString, NSArray, WBSFormAutoFillMetadataCorrector, _ASPasswordCredentialAuthenticationViewController, WBSHideMyEmailRecord, WBSAuthenticationServicesAgentProxy, WBSMultiRoundAutoFillManager, WBSFormControlMetadata;
