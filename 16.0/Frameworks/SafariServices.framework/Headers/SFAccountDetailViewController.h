...
@interface SFAccountDetailViewController : UITableViewController <SFAccountOtpauthQRCodeScannerViewControllerDelegate, _ASAccountAuthenticationModificationExtensionManagerObserver, ASAccountAuthenticationModificationControllerDelegate, ASAccountAuthenticationModificationControllerPresentationContextProviding, UITextFieldDelegate, _SFTableViewDiffableDataSourceDelegate, SFAccountNoteTableViewCellDelegate, UIEditMenuInteractionDelegate, SFSecurityRecommendationInfoCellDelegate, PSStateRestoration, _SFAccountManagerLockableContentContainer, _SFTableLinkableFooterViewDelegate>
