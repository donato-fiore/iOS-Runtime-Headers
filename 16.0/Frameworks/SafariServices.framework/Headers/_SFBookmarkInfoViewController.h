...
@class SFPopoverSizingTableViewController, WebBookmarkCollection, WebBookmark, NSArray, _SFSiteIconView, UITextField, UIBarButtonItem, NSString;
...
-(id)_iconForViewCellGivenBookmark:(id)arg0 syntheticFolder:(id)arg1 ;
-(id)_titleCell;
...
-(void)saveChanges;
-(void)saveKeyPressed;
-(void)setParent:(id)arg0 syntheticParentFolder:(id)arg1 ;
