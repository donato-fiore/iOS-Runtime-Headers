...
-(void)setHTMLInputElementAutoFilledAndObscured:(BOOL)arg0 ;
-(void)setHTMLInputElementAutoFilledAndViewable:(BOOL)arg0 ;
-(void)setHTMLInputElementAutoFilledWithAutomaticStrongPassword:(BOOL)arg0 ;
-(void)setHTMLInputElementAutofilled:(BOOL)arg0 ;
-(void)setSpinnerVisibilityOnHTMLInputElement:(BOOL)arg0 ;
