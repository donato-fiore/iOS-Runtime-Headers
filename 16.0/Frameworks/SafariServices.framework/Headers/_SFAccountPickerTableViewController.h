...
@class SFAccountTableViewController, NSMutableArray, NSArray, WBSPasskeyAutoFillFromNearbyDeviceOptions, WBSAuthenticationServicesAgentProxy, NSIndexPath, UIBarButtonItem, LAContext, NSString, WBSSavedAccount;
