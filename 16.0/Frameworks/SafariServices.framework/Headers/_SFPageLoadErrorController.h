...
@class WKWebView, NSTimer, WBSSecIdentitiesCache, _WKRemoteObjectInterface, NSURL, UINavigationController, WBSCertificateWarningPageContext, NSString, NSURLRequest;
@protocol WBSCertificateWarningPageHandler, OS_dispatch_queue, WBSCertificateWarningPagePresenter, _SFPageLoadErrorControllerDelegate, SFDialogPresenting;
