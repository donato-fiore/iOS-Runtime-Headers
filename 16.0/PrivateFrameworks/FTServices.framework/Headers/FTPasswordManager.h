...
-(id)_findAccountOfType:(id)arg0 InStore:(id)arg1 withCriteria:(id)arg2 ;
-(id)_findGameCenterAccountInStore:(id)arg0 withCriteria:(id)arg1 ;
-(id)_findIDSAccountInStore:(id)arg0 withCriteria:(id)arg1 ;
-(id)_findIDSAccountsInStore:(id)arg0 withCriteria:(id)arg1 ;
-(id)_gameCenterAccountWithUsername:(id)arg0 ;
...
-(id)gameCenterPropertiesFromAccountWithUsername:(id)arg0 ;
-(id)init;
