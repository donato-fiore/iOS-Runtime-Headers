...
-(id)_initAsRegistrationChoice:(BOOL)arg0 withName:(id)arg1 displayName:(id)arg2 identifier:(id)arg3 relyingPartyIdentifier:(id)arg4 publicKeyCredentialOperationUUID:(id)arg5 ;
-(id)initRegistrationChoiceWithOptions:(id)arg0 ;
-(id)initWithCoder:(id)arg0 ;
-(id)initWithName:(id)arg0 displayName:(id)arg1 identifier:(id)arg2 relyingPartyIdentifier:(id)arg3 publicKeyCredentialOperationUUID:(id)arg4 ;
