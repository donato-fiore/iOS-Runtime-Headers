...
@class NSDate, NSString, TUCallCenter, NSMutableArray, FKFriendsManager, CLLocation, _MKLocationShifter;
@protocol SOSInternalServerProtocol, SOSPersistentTimerLocationManagerDelegate, SOSServerProtocol, NSXPCListenerDelegate, OS_dispatch_queue, SOSCoreAnalyticsReporting, SOSFlowManagerCoexProtocol;
