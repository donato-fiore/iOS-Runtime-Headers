...
@protocol BKHIDEventDispatcher, BKHIDEventProcessorRegistering, BKIOHIDServiceMatcherDataProviding, BKHIDSystemInterfacing;
...
@property (retain, nonatomic) NSObject<BKHIDEventDispatcher> *eventDispatcher; // ivar: _eventDispatcher
