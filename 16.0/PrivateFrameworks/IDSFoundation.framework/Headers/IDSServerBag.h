...
@class NSDictionary, NSNumber, NSString, NSData, IMConnectionMonitor, NSDate, NSMutableURLRequest, NSURL, NSMutableDictionary, CUTDeferredTaskQueue, NSArray;
...
@property (readonly, nonatomic) CUTDeferredTaskQueue *saveCacheToPrefsTask; // ivar: _saveCacheToPrefsTask
...
-(void)_invalidate;
-(void)_loadFromCache;
-(void)_processBagResultData:(id)arg0 response:(id)arg1 ;
