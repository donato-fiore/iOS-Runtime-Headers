...
-(BOOL)_createIndicationConnection:(id)arg0 ;
...
-(BOOL)_peelOffQUICConnection:(id)arg0 type:(NSUInteger)arg1 readyHandler:(id)arg2 ;
-(BOOL)_recentQRServerListEmptyOrContains:(id)arg0 anotherRemoteEndpoint:(id)arg1 ;
-(BOOL)_setParameters:(id)arg0 NWLinkConnection:(id)arg1 sharePortWithListener:(BOOL)arg2 isTCP:(BOOL)arg3 ;
-(BOOL)connect:(int)arg0 localAddress:(struct sockaddr *)arg1 remoteAddress:(struct sockaddr *)arg2 clientUUID:(unsigned char)arg3 sessionID:(id)arg4 relaySessionToken:(id)arg5 relaySessionKey:(id)arg6 randomSalt:(id)arg7 newLocalPort:(*unsigned short)arg8 disconnectAfterUse:(BOOL)arg9 readyHandler:(id)arg10 ;
-(BOOL)connectTCP:(int)arg0 localAddress:(struct sockaddr *)arg1 remoteAddress:(struct sockaddr *)arg2 clientUUID:(unsigned char)arg3 sessionID:(id)arg4 relaySessionToken:(id)arg5 relaySessionKey:(id)arg6 randomSalt:(id)arg7 newLocalPort:(*unsigned short)arg8 readyHandler:(id)arg9 ;
...
-(id)copyChildConnectionIDForLocalAddress:(struct sockaddr *)arg0 remoteAddress:(struct sockaddr *)arg1 clientUniquePID:(NSUInteger)arg2 sessionID:(id)arg3 isRelay:(BOOL)arg4 ;
...
-(void)cleanup;
-(void)dealloc;
-(void)disconnectWithSessionID:(id)arg0 localAddress:(struct sockaddr *)arg1 remoteAddress:(struct sockaddr *)arg2 waitTime:(CGFloat)arg3 ;
-(void)invalidate;
