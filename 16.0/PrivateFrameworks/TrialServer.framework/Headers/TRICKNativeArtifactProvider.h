...
// -(id)queryOperationForRecordType:(id)arg0 predicate:(id)arg1 desiredKeys:(id)arg2 options:(id)arg3 recordMatchedBlock:(id)arg4 queryCompletionBlock:(unk)arg5  ;
// -(id)queryOperationForRecordType:(id)arg0 predicate:(id)arg1 sortDescriptors:(id)arg2 desiredKeys:(id)arg3 options:(id)arg4 recordMatchedBlock:(id)arg5 queryCompletionBlock:(unk)arg6  ;
// -(id)queryOperationWithCursor:(id)arg0 desiredKeys:(id)arg1 options:(id)arg2 recordMatchedBlock:(id)arg3 queryCompletionBlock:(unk)arg4  ;
