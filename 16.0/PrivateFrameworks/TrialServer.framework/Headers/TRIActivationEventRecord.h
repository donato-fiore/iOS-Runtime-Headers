...
+(id)recordWithParentId:(id)arg0 factorPackSetId:(id)arg1 deploymentId:(int)arg2 osBuild:(id)arg3 languageCode:(id)arg4 regionCode:(id)arg5 carrierBundleIdentifier:(id)arg6 carrierCountryIsoCode:(id)arg7 ;
...
-(id)description;
-(id)init;
-(id)initWithParentId:(id)arg0 factorPackSetId:(id)arg1 deploymentId:(int)arg2 osBuild:(id)arg3 languageCode:(id)arg4 regionCode:(id)arg5 carrierBundleIdentifier:(id)arg6 carrierCountryIsoCode:(id)arg7 ;
