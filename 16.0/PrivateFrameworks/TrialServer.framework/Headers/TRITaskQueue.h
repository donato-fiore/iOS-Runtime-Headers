...
-(id)_createOperationWithTask:(id)arg0 withId:(id)arg1 dependencies:(id)arg2 taskMap:(id)arg3 xpcActivities:(id)arg4 ;
...
-(struct ? )_addTask:(id)arg0 options:(id)arg1 guardedData:(id)arg2 taskId:(*id)arg3 tryRunningEligibleTasksImmediately:(BOOL)arg4 ;
-(struct ? )_addTask:(id)arg0 options:(id)arg1 guardedData:(id)arg2 taskIdOut:(*id)arg3 accumulatedNewTaskRecords:(id)arg4 ;
-(struct ? )_addTask:(id)arg0 options:(id)arg1 taskId:(*id)arg2 tryRunningEligibleTasksImmediately:(BOOL)arg3 ;
...
-(void)_scheduleFutureRecurrentRollbackActivityWithGuardedData:(id)arg0 ;
...
-(void)resumeWithXPCActivityDescriptor:(id)arg0 executeWhenSuspended:(id)arg1 ;
