...
@protocol TRIXPCInternalSystemServiceProtocol, TRITrialInternalSystemEntitled, TRIAssetStoreOperations;
...
-(void)collectGarbageOlderThanNumScans:(unsigned int)arg0 deletedAssetSize:(*NSUInteger)arg1 ignoreRecentlyCreatedAssets:(BOOL)arg2 dryRun:(BOOL)arg3 linkTargetsToIgnoreByAssetId:(id)arg4 completion:(id)arg5 ;
