...
@protocol UIScrollViewDelegate, CEKSliderTickMarksDelegate, CEKAbstractSlider, CEKDiscreteSliderDelegate, CEKTickMarksConfiguration;
...
@property (weak, nonatomic) NSObject<CEKDiscreteSliderDelegate> *delegate; // ivar: _delegate
