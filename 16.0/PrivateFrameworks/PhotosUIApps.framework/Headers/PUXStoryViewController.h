...
@protocol PXStoryViewController, PXTapToRadarDiagnosticProvider, PXStoryPlayerTestElement, PXStoryViewActionPerformer, PXStoryViewControllerTransitionEndPoint, PXAssetCollectionActionPerformerDelegate, PXUserInterfaceFeatureViewController, PXStoryViewControllerDismissalDelegate, PXStoryExportActivityHelper, PXStoryViewControllerNavigationItemHelper, PXStoryViewControllerShareActionDelegate, PXStoryViewEnvironmentActionPerformer;



@interface PUXStoryViewController : UIViewController <PXStoryViewController, PXTapToRadarDiagnosticProvider, PXStoryPlayerTestElement, PXStoryViewActionPerformer, PXStoryViewControllerTransitionEndPoint, PXAssetCollectionActionPerformerDelegate, PXUserInterfaceFeatureViewController>

 {
    ...
    ? exportHelper;
    ? exportActivityCount;
    ? exportConfigurationCompletionBlock;
    ? assetPicker;
...
@property (nonatomic, readonly) NSObject<PXStoryExportActivityHelper> *exportActivityHelper;
...
@property (nonatomic, readonly) NSInteger userInterfaceFeature;
@property (nonatomic, retain) NSObject<PXStoryViewEnvironmentActionPerformer> *viewEnvironmentActionPerformer; // ivar: viewEnvironmentActionPerformer
...
-(void)willDismissWithoutTransitionToEndPoint:(id)arg0 ;
