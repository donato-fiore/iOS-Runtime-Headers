...
#ifndef PUXPHOTOSDETAILSVISUALLOOKUPWIDGET_H
#define PUXPHOTOSDETAILSVISUALLOOKUPWIDGET_H
...
@interface PUXPhotosDetailsVisualLookupWidget : TtC12PhotosUIApps19PhotosDetailsWidget {
    ? contextObservation;
}
