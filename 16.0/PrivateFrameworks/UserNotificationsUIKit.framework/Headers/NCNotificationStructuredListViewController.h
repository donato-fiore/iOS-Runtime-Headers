...
-(void)_resetCellWithRevealedActionsAnimated:(BOOL)arg0 ;
...
-(void)notificationListBaseComponent:(id)arg0 didTransitionActionsForNotificationCell:(id)arg1 revealed:(BOOL)arg2 ;
