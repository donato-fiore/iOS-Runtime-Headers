...
@class UIViewController, NSHashTable, UIView<PLContentSizeManaging>, UIView<PLPlatter><NCNotificationStaticContentAccepting><PLContentSizeCategoryAdjusting><NCNotificationListDimmable>, UIView, UIPanGestureRecognizer, UIViewController<NCNotificationCustomContent>, NSString, NCNotificationRequest;
@protocol NCNotificationRequestInlineActionsProviderDelegate, NCNotificationCustomContentDelegate, PLExpandedPlatterPresentationControllerDelegate, NCNotificationListDimmable, NCMaterialDisplaying, PLContentSizeCategoryAdjusting, UIViewControllerTransitionCoordinator, NCAuxiliaryOptionsProviding, NCNotificationCustomContentProviding, NCNotificationViewControllerDelegate, NCNotificationStaticContentProviding;
...
@property (readonly, nonatomic) NSInteger materialRecipe;
