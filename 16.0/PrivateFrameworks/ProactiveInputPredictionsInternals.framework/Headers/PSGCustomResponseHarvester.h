...
+(void)runHarvestSkipMessageCollection:(BOOL)arg0 clearCheckpoint:(BOOL)arg1 reportMetrics:(BOOL)arg2 modelConfigPath:(id)arg3 modelFilePath:(id)arg4 storeDirectory:(id)arg5 evalFraction:(id)arg6 ;
...
-(id)initWithActivityManager:(id)arg0 modelConfigPath:(id)arg1 modelFilePath:(id)arg2 storeDirectory:(id)arg3 ;
