...
+(BOOL)_visitedLocations:(id)arg0 onlyDuringMoments:(id)arg1 locationHelper:(id)arg2 ;
+(id)_filteredCityNodesByNameForCityNodes:(id)arg0 ;
+(void)_aoiTitleWithLocationNodes:(id)arg0 momentNodes:(id)arg1 allowLongAOI:(BOOL)arg2 graph:(id)arg3 locationHelper:(id)arg4 result:(id)arg5 ;
