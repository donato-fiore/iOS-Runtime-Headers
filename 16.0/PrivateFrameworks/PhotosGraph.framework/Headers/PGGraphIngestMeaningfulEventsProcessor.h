...
+(void)regenerateMeaningsWithGraphBuilder:(id)arg0 progressReporter:(id)arg1 ;
...
-(void)processMeaningfulEventsWithMomentNodes:(id)arg0 graph:(id)arg1 progressBlock:(id)arg2 ;
