...
@property (readonly) CGFloat mergeCandidateConfidenceThreshold; // ivar: _mergeCandidateConfidenceThreshold
...
@property (readonly) NSUInteger sharedLibraryCameraLibrarySwitchAlgorithmsVersion; // ivar: _sharedLibraryCameraLibrarySwitchAlgorithmsVersion
@property (readonly) NSUInteger sharedLibraryStartAlgorithmsVersion; // ivar: _sharedLibraryStartAlgorithmsVersion
@property (readonly) NSUInteger sharedLibrarySuggestionsAlgorithmsVersion; // ivar: _sharedLibrarySuggestionsAlgorithmsVersion
...
@property (readonly) NSUInteger wallpaperAlgorithmsVersion; // ivar: _wallpaperAlgorithmsVersion
