...
#ifndef PGMEANINGFULEVENTLOOSEREQUIREDCRITERIAFACTORY_H
#define PGMEANINGFULEVENTLOOSEREQUIREDCRITERIAFACTORY_H
...
+(id)_requiredCriteriaForIdentifiers:(id)arg0 graph:(id)arg1 sceneTaxonomy:(id)arg2 ;
...
+(id)requiredCriteriaForIdentifiers:(id)arg0 graph:(id)arg1 sceneTaxonomy:(id)arg2 ;
