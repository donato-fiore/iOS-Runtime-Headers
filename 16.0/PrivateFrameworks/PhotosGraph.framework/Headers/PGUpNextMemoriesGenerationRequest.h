...
-(id)ephemeralMemoriesByUniqueMemoryIdentifiersWithWorkingContext:(id)arg0 ;
-(id)fetchMemoryLocalIdentifiersWithWorkingContext:(id)arg0 musicCurationOptions:(id)arg1 error:(*id)arg2 ;
-(id)initWithRootMemoryLocalIdentifier:(id)arg0 momentUUIDs:(id)arg1 memoryLocalIdentifiersToAvoid:(id)arg2 targetUpNextMemoryCount:(NSUInteger)arg3 customVectors:(id)arg4 wantsVerboseDebugInfo:(BOOL)arg5 sharingFilter:(unsigned short)arg6 ;
-(id)initWithRootMemoryLocalIdentifier:(id)arg0 momentUUIDs:(id)arg1 memoryLocalIdentifiersToAvoid:(id)arg2 targetUpNextMemoryCount:(NSUInteger)arg3 sharingFilter:(unsigned short)arg4 ;
