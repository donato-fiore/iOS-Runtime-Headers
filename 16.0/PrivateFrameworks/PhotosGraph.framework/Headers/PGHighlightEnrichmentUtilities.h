...
+(BOOL)canUseSharingComposition:(unsigned short)arg0 forHighlightFilter:(unsigned short)arg1 ;
...
+(id)filteredAssetsInAssets:(id)arg0 withSharingComposition:(unsigned short)arg1 forHighlightFilter:(unsigned short)arg2 ;
+(id)filteredHighlightNodesWithHighlightNodes:(id)arg0 forHighlightFilter:(unsigned short)arg1 ;
+(id)filteredMomentNodesWithHighlightNode:(id)arg0 forHighlightFilter:(unsigned short)arg1 ;
