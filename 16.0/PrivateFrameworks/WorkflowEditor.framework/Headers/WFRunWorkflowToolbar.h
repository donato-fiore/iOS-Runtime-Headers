...
@property (retain, nonatomic) UIBarButtonItem *settingsItem; // ivar: _settingsItem
...
@property (nonatomic) BOOL showsSettingsButton; // ivar: _showsSettingsButton
...
-(id)initWithShowsSettingsButton:(BOOL)arg0 ;
-(id)runItemsWithSpacer:(BOOL)arg0 ;
-(id)undoRedoItemsWithSpacer:(BOOL)arg0 ;
-(void)layoutSubviews;
-(void)playTapped;
-(void)redoTapped;
-(void)settingsTapped;
