...
@protocol WFSlotTemplateViewDelegate, WFModuleSummaryEditorDelegate, WFVariableDelegate, WFVariableUIDelegate, WFEditorAuxiliaryViewPresenter, WFModuleSummaryCoordinatorDelegate, WFVariableProvider;
...
@interface WFModuleSummaryCoordinator : NSObject <WFSlotTemplateViewDelegate, WFModuleSummaryEditorDelegate, WFVariableDelegate, WFVariableUIDelegate>
