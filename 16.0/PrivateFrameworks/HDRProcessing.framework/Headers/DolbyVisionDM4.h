...
-(?)createToneCurve:(?)arg0 srcMaxPQ:(?)arg1 tgtMinPQ:(?)arg2 tgtMaxPQ:(?)arg3 srcCrushPQ:(?)arg4 srcMidPQ:(?)arg5 srcClipPQ:(?)arg6 targetMaxLinear:(?)arg7 DM_MetaDatausePseudoTrim;
-(?)debugDMMetaData2;
-(?)debugDMMetaData8;
-(?)debugTrimData2;
-(?)debugTrimData8;
