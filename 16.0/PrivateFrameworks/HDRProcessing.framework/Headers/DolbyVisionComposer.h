...
-(NSInteger)checkInputFormats:(unsigned int)arg0 returnInput1:(*BOOL)arg1 returnInput2:(*BOOL)arg2 returnInput3:(*BOOL)arg3 returnInput4:(*BOOL)arg4 outputFormat:(unsigned int)arg5 returnOutput1:(*BOOL)arg6 returnOutput2:(*BOOL)arg7 returnOutput3:(*BOOL)arg8 returnOutput4:(*BOOL)arg9 ;
