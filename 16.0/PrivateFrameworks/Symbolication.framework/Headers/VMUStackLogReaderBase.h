...
-(BOOL)shouldIgnoreSymbolWithName:(id)arg0 binaryPath:(id)arg1 ;
...
-(id)_allocationTypeNameForStackID:(NSUInteger)arg0 returnedBinaryPath:(*id)arg1 ;
...
-(void)identifyNonObjectsUsingStackBacktraces:(id)arg0 classInfoMap:(id)arg1 classInfoSetterBlock:(id)arg2 ;
