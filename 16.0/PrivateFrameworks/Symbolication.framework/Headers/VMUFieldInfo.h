...
-(id)_getFieldAtOffset:(unsigned int)arg0 ;
-(id)description;
...
-(id)initWithObjcIvar:(struct objc_ivar *)arg0 size:(unsigned int)arg1 isARC:(BOOL)arg2 is64Bit:(BOOL)arg3 ;
...
-(id)mutableCopy;
-(void)dealloc;
-(void)enumerateSublayoutsForSize:(unsigned int)arg0 parentOffset:(unsigned int)arg1 remotePointerSize:(unsigned int)arg2 withBlock:(id)arg3 ;
