...
@property (readonly, nonatomic) VMUMutableClassInfo *sideTableLayoutWithScannableOwnerPointer; // ivar: _sideTableLayoutWithScannableOwnerPointer
@property (readonly, nonatomic) VMUMutableClassInfo *sideTableLayoutWithUnscannableOwnerPointer; // ivar: _sideTableLayoutWithUnscannableOwnerPointer
