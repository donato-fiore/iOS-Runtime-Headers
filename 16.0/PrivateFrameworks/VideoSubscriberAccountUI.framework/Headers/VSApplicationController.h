...
@class NSString, JSValue, VSAuditToken, NSError, NSURL, VSIdentityProvider, VSPreferences, NSOperationQueue, VSStateMachine, NSArray;
...
@property (retain, nonatomic) NSArray *userAccounts; // ivar: _userAccounts
