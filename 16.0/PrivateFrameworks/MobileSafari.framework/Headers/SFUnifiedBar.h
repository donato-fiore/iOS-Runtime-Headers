...
@property (readonly, nonatomic) CGPoint _inlineContentSquishAnchorPoint;
...
-(CGFloat)_squishedInlineContentTopOverflow;
-(CGFloat)_themeColorVisibility;
-(id)initWithFrame:(struct CGRect )arg0 ;
-(struct CGPoint )_squishAnchorPointForStandaloneContentViewAtIndex:(NSUInteger)arg0 ;
