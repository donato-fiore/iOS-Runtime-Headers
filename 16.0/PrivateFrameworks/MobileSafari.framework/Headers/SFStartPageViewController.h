...
@protocol UISearchControllerDelegate, UISearchResultsUpdating, SFStartPageCollectionDataSource, SFStartPageCollectionDelegate, SFStartPagePreviewProviding, UINavigationControllerDelegate, UIGestureRecognizerDelegate, _UIScrollViewScrollObserver, SFStartPageVisualStyleProviding, WBSUserDefaultObservation, SFStartPageCustomizationDataSource, SFStartPageDataSource, SFStartPageDelegate, SFStartPageScrollObserver;


#import "SFStartPageCollectionViewController.h"

@interface SFStartPageViewController : UIViewController <UISearchControllerDelegate, UISearchResultsUpdating, SFStartPageCollectionDataSource, SFStartPageCollectionDelegate, SFStartPagePreviewProviding, UINavigationControllerDelegate, UIGestureRecognizerDelegate, _UIScrollViewScrollObserver>
