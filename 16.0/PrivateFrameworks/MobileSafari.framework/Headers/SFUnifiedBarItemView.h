...
@class UIButton, _UIVisualEffectBackdropView, UIView, UIVisualEffectView, NSArray, NSString, UIDragPreviewParameters;
...
@property (nonatomic) BOOL needsEraserBasedCutoutBorder; // ivar: _needsEraserBasedCutoutBorder
...
-(void)_setShowsCutoutBorderEffects:(BOOL)arg0 ;
-(void)_setShowsCutoutBorderEraser:(BOOL)arg0 ;
-(void)_setShowsPlatter:(BOOL)arg0 ;
