...
@class CIFilter, NSNumber, NUCVPixelBuffer, CIImage, PTGlobalRenderingMetadata;
...
@property (retain, nonatomic) NUCVPixelBuffer *inputColorPixelBuffer; // ivar: _inputColorPixelBuffer
@property (retain, nonatomic) CIImage *inputDisparityImage; // ivar: _inputDisparityImage
@property (retain, nonatomic) NUCVPixelBuffer *inputDisparityPixelBuffer; // ivar: _inputDisparityPixelBuffer
