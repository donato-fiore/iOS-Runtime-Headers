...
@property (retain, nonatomic) CAShapeLayer *originCrosshairLayer; // ivar: _originCrosshairLayer
@property (retain, nonatomic) CAShapeLayer *outputROILayer; // ivar: _outputROILayer
@property (retain, nonatomic) CAShapeLayer *overlayCenterLayer; // ivar: _overlayCenterLayer
...
-(void)updateCrosshairLayer:(id)arg0 center:(struct CGPoint )arg1 color:(id)arg2 size:(struct CGSize )arg3 thickness:(struct CGSize )arg4 ;
...
-(void)updateFilledCircleLayer:(id)arg0 center:(struct CGPoint )arg1 radius:(CGFloat)arg2 fillColor:(id)arg3 ;
