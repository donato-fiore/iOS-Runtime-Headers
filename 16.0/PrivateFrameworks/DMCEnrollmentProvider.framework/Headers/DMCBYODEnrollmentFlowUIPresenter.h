...
@property (copy, nonatomic) id *ESSOApplicationInstallationCompletionHandler; // ivar: _ESSOApplicationInstallationCompletionHandler
...
@property (retain, nonatomic) DMCInstallProfileQuestionViewController *questionsController; // ivar: _questionsController
...
-(void)ESSOApplicationDisclosurViewController:(id)arg0 didReceiveUserAction:(BOOL)arg1 error:(id)arg2 ;
-(void)_handleApplicationInstallationViewControllerDelegate:(id)arg0 didReceiveUserAction:(BOOL)arg1 error:(id)arg2 ;
...
-(void)debuggingApplicationInstallationViewController:(id)arg0 didReceiveUserAction:(BOOL)arg1 ;
-(void)dismissEnrollmentScene;
-(void)displayManagementDetailsOverviewWithProfileData:(id)arg0 managedAppleID:(id)arg1 completionHandler:(id)arg2 ;
...
-(void)managementDetailsOverviewViewController:(id)arg0 didReceiveUserAction:(BOOL)arg1 ;
-(void)questionsController:(id)arg0 didFinishWithResponses:(id)arg1 ;
-(void)requestDebuggingApplicationsInstallation:(id)arg0 requiredEntitlements:(id)arg1 completionHandler:(id)arg2 ;
-(void)requestDevicePasscodeWithCompletionHandler:(id)arg0 ;
-(void)requestESSOApplicationInstallationWithITunesItemID:(id)arg0 requiredEntitlements:(id)arg1 completionHandler:(id)arg2 ;
...
-(void)requestWebAuthenticationWithWebAuthURL:(id)arg0 authenticator:(id)arg1 authParams:(id)arg2 completionHandler:(id)arg3 ;
