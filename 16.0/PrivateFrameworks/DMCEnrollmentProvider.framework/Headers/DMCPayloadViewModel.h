...
@class NSDate, NSArray, NSString, MDMBook;
...
@property (retain, nonatomic) MDMBook *managedBook; // ivar: _managedBook
...
+(NSInteger)payloadTypeForPayloadClass:(Class)arg0 ;
+(id)accountPayloadClasses;
+(id)managedAppClasses;
+(id)payloadViewModelsFromPayload:(id)arg0 ;
+(id)removeDuplicatesFromRestrictionPayloadViewModels:(id)arg0 ;
