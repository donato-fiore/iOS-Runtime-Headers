...
-(id)description;
-(id)initWithContentKeySession:(id)arg0 contentKeyBoss:(struct CMBaseObject *)arg1 keySpecifier:(struct FigContentKeySpecifier *)arg2 initializationData:(id)arg3 keyIDFromInitializationData:(id)arg4 contentIdentifier:(id)arg5 isRenewalRequest:(BOOL)arg6 requestID:(NSInteger)arg7 providesPersistableKey:(BOOL)arg8 preloadingRequestOptions:(id)arg9 identifier:(id)arg10 ;
