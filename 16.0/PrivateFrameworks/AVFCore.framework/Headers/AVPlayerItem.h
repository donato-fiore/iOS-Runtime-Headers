...
-(BOOL)_selectMediaOption:(id)arg0 inMediaSelectionGroup:(id)arg1 ;
...
-(struct ? )maximumTimePlayedToDuringOverlappedPlayback;
-(struct ? )maximumTimePlayedToSinceLastSeek;
...
-(struct OpaqueFigPlaybackItem *)_copyFigPlaybackItemLocked:(BOOL)arg0 ;
...
-(void)_addInterstitialEventCollectorLocked:(BOOL)arg0 ;
-(void)_addLegibleOutput:(id)arg0 ;
-(void)_addMetadataCollector:(id)arg0 ;
-(void)_addMetadataCollector:(id)arg0 locked:(BOOL)arg1 ;
...
-(void)_cancelPendingSeekAndRegisterSeekID:(int)arg0 withCompletionHandler:(id)arg1 ;
...
-(void)_getVideoComposition:(*id)arg0 customVideoCompositorSession:(*id)arg1 figVideoCompositor:(struct OpaqueFigVideoCompositor **)arg2 ;
...
-(void)_postSeekCompletionNotificationWithSeekID:(int)arg0 andResult:(BOOL)arg1 ;
...
-(void)_seekToTime:(struct ? )arg0 toleranceBefore:(struct ? )arg1 toleranceAfter:(struct ? )arg2 seekID:(int)arg3 completionHandler:(id)arg4 ;
...
-(void)_unregisterInvokeAndReleasePendingSeekCompletionHandlerForSeekID:(int)arg0 finished:(BOOL)arg1 ;
...
-(void)addMediaDataCollector:(id)arg0 locked:(BOOL)arg1 ;
-(void)addObserver:(id)arg0 forKeyPath:(id)arg1 options:(NSUInteger)arg2 context:(*void)arg3 ;
-(void)addOutput:(id)arg0 ;
-(void)cancelPendingSeeks;
-(void)dealloc;
-(void)dispatchIVarWrite:(BOOL)arg0 locked:(BOOL)arg1 block:(id)arg2 ;
-(void)removeMediaDataCollector:(id)arg0 ;
-(void)removeMediaDataCollector:(id)arg0 locked:(BOOL)arg1 ;
...
-(void)seekToTime:(struct ? )arg0 toleranceBefore:(struct ? )arg1 toleranceAfter:(struct ? )arg2 seekID:(int)arg3 ;
...
-(void)setMaximumTimePlayedToDuringOverlappedPlayback:(struct ? )arg0 ;
...
-(void)setRefreshesClosedCaptionsImmediatelyAfterSeeking:(BOOL)arg0 ;
