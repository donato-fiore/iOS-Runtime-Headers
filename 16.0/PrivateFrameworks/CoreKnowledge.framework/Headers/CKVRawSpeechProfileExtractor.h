...
+(id)_convertItemsFromEntities:(id)arg0 categoryName:(id)arg1 categoryMetadata:(id)arg2 converter:(id)arg3 error:(*id)arg4 ;
...
+(id)extractItemsFromRawSpeechProfile:(id)arg0 metadata:(id)arg1 converter:(id)arg2 error:(*id)arg3 ;
