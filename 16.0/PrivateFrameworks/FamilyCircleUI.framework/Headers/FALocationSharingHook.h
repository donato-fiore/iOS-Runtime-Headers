...
@class UIViewController, NSString, RUIObjectModel, RUIServerHookResponse;
...
-(id)getFamilyCircle;
-(id)getLocationSharedServiceWithUrl:(id)arg0 ;
-(id)getLocationSharingViewControllerDependencies;
-(id)getSharedSubscriptionsRequestURL;
-(id)handleResponse:(id)arg0 ;
