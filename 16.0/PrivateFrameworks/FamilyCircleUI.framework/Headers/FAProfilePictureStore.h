...
@class FAFamilyCircle, NSMutableDictionary, CNContactStore, NSArray, NSDictionary;
...
@property (readonly, copy, nonatomic) NSDictionary *recommendedMembersImages; // ivar: _recommendedMembersImages
...
-(id)profilePictureForRecommendedFamilyMember:(id)arg0 ;
...
-(void)fetchProfilePicturesForRecommendedFamilyMembers:(id)arg0 ;
