...
@class UITableViewCell, UIImageView, UILabel, UILayoutGuide, NSLayoutConstraint, UIImage;
...
@property (retain, nonatomic) UIImage *scopeImage; // ivar: _scopeImage
@property (retain, nonatomic) UIImageView *scopeImageView; // ivar: _scopeImageView
