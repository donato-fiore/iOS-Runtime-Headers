...
@class NSDictionary;
@protocol MTLDevice, MTLCommandQueue, MTLLibrary, MTLComputePipelineState, OS_dispatch_queue;
...
-(id)compileFunction:(id)arg0 ;
-(id)compileFunction:(id)arg0 constantValues:(id)arg1 ;
...
-(id)uintTexture:(struct __CVBuffer *)arg0 forPlane:(int)arg1 withAttributes:(id)arg2 ;
-(id)unormTexture:(struct __CVBuffer *)arg0 forPlane:(int)arg1 withAttributes:(id)arg2 ;
...
-(int)copySubframe:(struct __CVBuffer *)arg0 toFrame:(struct __CVBuffer *)arg1 atOffset:(struct ? )arg2 ;
-(int)selectGPUForFrame:(struct __CVBuffer *)arg0 ;
-(int)subframeDeblock:(struct __CVBuffer *)arg0 withOffsetsY:(*unsigned int)arg1 numEdges:(int)arg2 ;
...
-(void)compileDeblockForFrame:(struct __CVBuffer *)arg0 ;
