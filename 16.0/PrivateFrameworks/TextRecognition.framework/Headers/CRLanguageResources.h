...
@property (readonly, nonatomic) *void wordTokenizer; // ivar: _wordTokenizer


+(*void)createCharacterModel:(id)arg0 ;
+(*void)createWordLanguageModel:(id)arg0 type:(NSInteger)arg1 ;
+(BOOL)isCharLMForLanguageAvailableInTextRecognition:(id)arg0 ;
...
-(id)cvnlpLanguageResourceBundle:(id)arg0 lmConfig:(id)arg1 ;
