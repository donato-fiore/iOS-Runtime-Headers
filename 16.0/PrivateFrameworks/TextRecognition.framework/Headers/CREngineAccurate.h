...
@protocol CREngine, CRLineWrapping;
...
@property (retain) NSObject<CRLineWrapping> *lineWrapper; // ivar: _lineWrapper
@property (retain) CRPerformanceStatistics *lineWrappingStats; // ivar: _lineWrappingStats
