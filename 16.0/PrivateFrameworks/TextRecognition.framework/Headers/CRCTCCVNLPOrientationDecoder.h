...
@property (readonly) BOOL decodeWithCombinedOrientationScriptModel; // ivar: _decodeWithCombinedOrientationScriptModel
...
-(BOOL)_decodeFeaturesWithInfo:(id)arg0 activations:(id)arg1 shouldDecodeScriptResult:(BOOL)arg2 shouldDecodeOrientationResult:(BOOL)arg3 ;
-(BOOL)decodeOutput:(id)arg0 imageSize:(struct CGSize )arg1 error:(*id)arg2 ;
-(BOOL)decodeOutput:(id)arg0 imageSize:(struct CGSize )arg1 shouldDecodeScriptResult:(BOOL)arg2 shouldDecodeOrientationResult:(BOOL)arg3 error:(*id)arg4 ;
