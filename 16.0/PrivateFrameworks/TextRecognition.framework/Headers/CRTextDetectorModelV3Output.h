...
@property (retain, nonatomic) MLMultiArray *script_feature; // ivar: _script_feature
@property (retain, nonatomic) MLMultiArray *script_score; // ivar: _script_score


-(id)featureValueForName:(id)arg0 ;
-(id)initWithRegion_score:(id)arg0 affinity_score:(id)arg1 script_feature:(id)arg2 link_score:(id)arg3 ;
