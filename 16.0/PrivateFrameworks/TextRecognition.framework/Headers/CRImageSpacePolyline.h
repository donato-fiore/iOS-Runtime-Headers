...
@property ObjectRef<const CGPath *> _pathRef; // ivar: __pathRef
...
-(id)simplified;
-(struct CGSize )estimatedLineSizeForPairedPointPolygon;
-(struct ObjectRef<const CGPath *> )createPathWithTransformer:(id)arg0 ;
