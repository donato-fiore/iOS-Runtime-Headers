...
@class HAPAccessoryServerBrowser, MTRDeviceController, NSString, NSMutableSet, NSDictionary;
...
@property (readonly) MTRDeviceController *chipController; // ivar: _chipController
...
-(void)rePairAccessoryServer:(id)arg0 newFabricWithIndex:(id)arg1 ;
