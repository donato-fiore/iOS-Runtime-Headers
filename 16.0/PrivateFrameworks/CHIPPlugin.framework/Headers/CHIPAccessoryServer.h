...
@class HAPAccessoryServer, MTRAttributeCacheContainer, NSOperationQueue, MTRDeviceController, NSString, NSNumber, NSData, HMFTimer, HAPAccessory;
@protocol MTRDevicePairingDelegate, HMFLogging, HMFTimerDelegate, CHIPAccessoryServerDelegate;
...
@property (retain, nonatomic) MTRAttributeCacheContainer *attributeCacheContainer; // ivar: _attributeCacheContainer
...
@property (retain, nonatomic) MTRDeviceController *chipDeviceController; // ivar: _chipDeviceController
...
@property (retain, nonatomic) NSData *latestSubscriptionToken; // ivar: _latestSubscriptionToken
