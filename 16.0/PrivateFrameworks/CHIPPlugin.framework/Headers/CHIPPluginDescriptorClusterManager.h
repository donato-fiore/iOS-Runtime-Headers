...
-(void)_verifyHAPCharacteristicSupportAtCHIPEndpoint:(id)arg0 device:(id)arg1 callbackQueue:(id)arg2 clusterClassToQueryForFeatureMap:(id)arg3 hapServicesToCheckForFeatureMap:(id)arg4 deviceTopology:(id)arg5 lastError:(id)arg6 completionHandler:(id)arg7 ;
