...
@property (readonly) NSInteger recoverableMessagesWrittenCount; // ivar: _recoverableMessagesWrittenCount
...
-(void)addNewRecoverableMessagesSyncedCount:(NSInteger)arg0 ;
-(void)clearSyncCounts;
-(void)postCoreAutomationNotificationFinishedPeriodicSyncNotificationWithStartTime:(id)arg0 chatsDidsync:(BOOL)arg1 messagesDidSync:(BOOL)arg2 attachmentsDidSync:(BOOL)arg3 recoverableMessagesDidSync:(BOOL)arg4 ;
