...
@class NSArray, NSDictionary, NSAttributedString, NSData, NSDate, NSString, NSIndexSet, TUConversationActivity;
...
-(id)sender;
-(void)_clearBodyData;
-(void)_enumerateBodyByPartsWithIndexesDeleted:(id)arg0 rangesDeletedMap:(id)arg1 block:(id)arg2 ;
