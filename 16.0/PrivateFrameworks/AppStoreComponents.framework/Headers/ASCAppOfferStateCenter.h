...
-(id)performActionOfOffer:(id)arg0 withActivity:(id)arg1 inContext:(id)arg2 ;
-(id)performActionOfOffer:(id)arg0 withActivity:(id)arg1 inContext:(id)arg2 usingService:(id)arg3 ;
