...
#ifndef NWSQUICSNAPSHOT_H
#define NWSQUICSNAPSHOT_H
...
@property (readonly) CGFloat rttAverage; // ivar: _rttAverage
@property (readonly) CGFloat rttMinimum; // ivar: _rttMinimum
@property (readonly) CGFloat rttVariation; // ivar: _rttVariation
...
-(id)fuuid;
-(id)initWithCounts:(struct nstat_counts *)arg0 QUICDescriptor:(struct nstat_tcp_descriptor *)arg1 sourceIdent:(NSUInteger)arg2 events:(NSUInteger)arg3 seqno:(NSUInteger)arg4 provider:(unsigned int)arg5 ;
-(id)localAddress;
-(id)processName;
-(id)provider;
-(id)remoteAddress;
