...
-(struct CGRect )keylineFrameForCornerComplicationSlot:(id)arg0 selected:(BOOL)arg1 faceView:(id)arg2 ;
...
-(void)_configureOverridesForLayout:(id)arg0 withNormalSize:(struct CGSize )arg1 editingSize:(struct CGSize )arg2 variant:(BOOL)arg3 addCircleOverrides:(BOOL)arg4 makeRuleBlock:(id)arg5 ;
