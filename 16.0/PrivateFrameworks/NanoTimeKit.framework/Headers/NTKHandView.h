...
@class UIView, CALayer, UIImageView, UIColor, NSString, CLKDevice, UIImage, CLKUIColoringImageView;
...
@property (readonly, nonatomic) CLKUIColoringImageView *handImageView; // ivar: _handImageView
