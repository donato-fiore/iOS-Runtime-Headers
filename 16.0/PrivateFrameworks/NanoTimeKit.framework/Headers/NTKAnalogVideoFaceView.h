...
@protocol NTKColorCircularUtilitarianFaceViewComplicationFactoryDelegate, NTKVideoPlayerViewFaceDelegate, NTKEditOptionTransitioningViewDelegate;
...
@property (retain, nonatomic) NTKFaceViewTapControl *faceTapControl; // ivar: _faceTapControl
