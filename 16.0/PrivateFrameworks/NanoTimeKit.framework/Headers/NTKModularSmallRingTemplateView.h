...
@class UIView<CDComplicationImageView>, CLKProgressProvider, NSNumber, CLKUIColoringLabel, CLKUIColoringImageView;
...
@property (retain, nonatomic) CLKUIColoringImageView *stateRing; // ivar: _stateRing
