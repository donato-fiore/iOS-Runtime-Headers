...
@property (copy, nonatomic) NSString *complicationCollectionIdentifier; // ivar: _complicationCollectionIdentifier
...
+(id)messageOfType:(NSInteger)arg0 withCollectionIdentifier:(id)arg1 clientId:(id)arg2 ;
+(id)messageOfType:(NSInteger)arg0 withCollectionIdentifier:(id)arg1 clientId:(id)arg2 descriptor:(id)arg3 family:(id)arg4 ;
+(id)messageOfType:(NSInteger)arg0 withFaceUUID:(id)arg1 ;
+(id)messageTypeDescription:(NSInteger)arg0 ;
