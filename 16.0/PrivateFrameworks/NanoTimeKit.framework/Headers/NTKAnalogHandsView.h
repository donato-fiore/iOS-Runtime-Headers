...
@class UIView, CLKUIColoringImageView, NSNumber, NSTimer, CALayer, NSCalendar, NSString, CLKDevice, UIColor, NSDate, NSTimeZone;
...
@property (retain, nonatomic) NTKHandView *hourHandViewAlt; // ivar: _hourHandViewAlt
...
@property (retain, nonatomic) NTKHandView *minuteHandViewAlt; // ivar: _minuteHandViewAlt
...
@property (retain, nonatomic) NTKHandView *secondHandViewAlt; // ivar: _secondHandViewAlt
...
-(void)_installAltViewsHour:(id)arg0 minute:(id)arg1 second:(id)arg2 ;
-(void)_removeColorTransitionViews;
-(void)_removeHourMinuteHandsTransitionLayers;
-(void)_repointDebugHandsToCurrentTime;
-(void)_setAltHandsAlpha:(CGFloat)arg0 ;
-(void)_setHandsAlpha:(CGFloat)arg0 ;
