...
@class BPSWelcomeOptinViewController, UICollectionView, UICollectionViewFlowLayout, UIImage, NSString;
...
-(void)_notifyDelegateOfActionEventWatchFaceSelected:(id)arg0 ;
...
-(void)handleWatchFaceSelectedAtIndex:(NSInteger)arg0 ;
-(void)handleWatchFaceSelectedWithError:(id)arg0 ;
