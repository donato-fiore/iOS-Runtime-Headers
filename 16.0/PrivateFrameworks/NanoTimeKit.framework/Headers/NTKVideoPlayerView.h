...
@protocol CLKVideoPlayerViewDelegate, NTKVideoPlayerViewFaceDelegate;
...
@property (weak, nonatomic) NSObject<NTKVideoPlayerViewFaceDelegate> *delegate; // ivar: _delegate
