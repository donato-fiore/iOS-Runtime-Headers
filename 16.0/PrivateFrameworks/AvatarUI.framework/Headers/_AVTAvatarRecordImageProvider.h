...
-(id)_providerForAvatar:(SEL)arg0 forRecord:(id)arg1 scope:(id)arg2 usingCache:(id)arg3 usingService:(BOOL)arg4 ;
...
-(id)providerForRecord:(SEL)arg0 scope:(id)arg1 usingService:(id)arg2 ;
