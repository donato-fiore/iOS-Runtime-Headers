...
-(id)configurationsForEditorPresentationContext:(NSUInteger)arg0 ;
...
-(id)initWithEnvironment:(id)arg0 avatarRecord:(id)arg1 editorPresentationContext:(NSUInteger)arg2 ;
-(id)initWithEnvironment:(id)arg0 initialAVTViewLayout:(id)arg1 avatarRecord:(id)arg2 editorPresentationContext:(NSUInteger)arg3 ;
