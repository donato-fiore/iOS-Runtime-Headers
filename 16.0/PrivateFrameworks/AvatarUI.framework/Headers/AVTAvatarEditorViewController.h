...
@protocol AVTSplashScreenViewControllerDelegate, AVTAvatarAttributeEditorViewControllerDelegate, UIAdaptivePresentationControllerDelegate, AVTToolBarDelegate, AVTUIControllerPresentationDelegate, AVTAvatarEditorViewControllerDelegate, AVTUILogger, AVTAvatarStoreInternal;
...
@property (nonatomic) NSUInteger editorPresentationContext; // ivar: _editorPresentationContext
