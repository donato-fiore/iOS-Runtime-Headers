...
+(id)attributionSetWithAttributions:(id)arg0 shouldReduceAttributions:(BOOL)arg1 ;
+(id)attributionSetWithOrigin:(id)arg0 disclosureLevel:(NSUInteger)arg1 ;
+(id)attributionSetWithOrigin:(id)arg0 disclosureLevel:(NSUInteger)arg1 disclosureWarnings:(id)arg2 originalItemIdentifier:(id)arg3 ;
...
-(id)allOrigins;
-(id)attributionSetByFilteringNeighborsOfContentItem:(id)arg0 ;
