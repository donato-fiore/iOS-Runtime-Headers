...
@property (readonly, copy, nonatomic) NSNumber *poiMuid; // ivar: _poiMuid
...
-(id)heroDataForLocation:(id)arg0 ;
-(id)init;
-(id)initWithAdamId:(NSUInteger)arg0 urlHash:(id)arg1 location:(struct CLLocationCoordinate2D )arg2 radiusInMeters:(NSUInteger)arg3 rank:(NSUInteger)arg4 isTouristApp:(BOOL)arg5 poiCategory:(id)arg6 poiMuid:(id)arg7 ;
