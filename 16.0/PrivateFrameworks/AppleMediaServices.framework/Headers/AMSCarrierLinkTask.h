...
-(id)initWithAccount:(id)arg0 bag:(id)arg1 engagementHandler:(id)arg2 guid:(id)arg3 linkParams:(id)arg4 metrics:(id)arg5 msisdn:(id)arg6 pacTokenPromise:(id)arg7 productCode:(id)arg8 requestEncoder:(id)arg9 urlSession:(id)arg10 ;
