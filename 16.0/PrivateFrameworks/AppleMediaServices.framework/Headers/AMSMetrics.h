...
@protocol AMSBagConsumer, AMSBagProtocol, AMSMetricsBagContract, OS_dispatch_queue, AMSMetricsFlushStrategy;
...
@property (nonatomic) os_unfair_lock_s flushingDisabledLock; // ivar: _flushingDisabledLock
