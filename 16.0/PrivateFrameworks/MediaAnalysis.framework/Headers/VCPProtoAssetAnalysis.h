...
@property (retain, nonatomic) NSMutableArray *movieAudioQualityResults; // ivar: _movieAudioQualityResults
...
-(id)movieAudioQualityResultsAtIndex:(NSUInteger)arg0 ;
...
-(void)addMovieAudioQualityResults:(id)arg0 ;
