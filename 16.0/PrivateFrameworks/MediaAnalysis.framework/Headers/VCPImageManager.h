...
@interface VCPImageManager : NSObject {
    *CMPhotoCompressionSession _encodeSession;
...
-(?)convertPixelBuffer:(?)arg0 toPixelFormatflushCache;
...
-(id)init;
-(int)compressCVPixelBuffer:(struct __CVBuffer *)arg0 toJPEGData:(*id)arg1 targetBitStreamLength:(NSUInteger)arg2 padding:(BOOL)arg3 ;
...
-(struct __CVBuffer *)imageForResource:(id)arg0 pixelFormat:(int)arg1 maxDimension:(NSUInteger)arg2 orientation:(*unsigned int)arg3 ;
...
-(struct __CVBuffer *)pixelBufferWithFormat:(int)arg0 andMaxDimension:(NSUInteger)arg1 fromImageURL:(id)arg2 flushCache:(BOOL)arg3 orientation:(*unsigned int)arg4 ;
