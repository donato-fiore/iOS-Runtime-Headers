...
+(id)faceFromFaceObservation:(id)arg0 humanObservation:(id)arg1 sourceWidth:(NSUInteger)arg2 sourceHeight:(NSUInteger)arg3 visionRequests:(id)arg4 processingVersion:(int)arg5 force:(BOOL)arg6 andError:(*id)arg7 ;
+(id)faceFromPHFace:(id)arg0 copyOption:(NSInteger)arg1 ;
+(id)faceWithLocalIdentifier:(id)arg0 ;
+(id)facesFromFaceObservations:(id)arg0 humanObservations:(id)arg1 animalObservations:(id)arg2 sourceWidth:(NSUInteger)arg3 sourceHeight:(NSUInteger)arg4 visionRequests:(id)arg5 blurScorePerFace:(id)arg6 exposureScorePerFace:(id)arg7 tooSmallFaceObservations:(id)arg8 processingVersion:(int)arg9 ;
+(id)facesFromPHFetchResult:(id)arg0 copyOption:(NSInteger)arg1 ;
...
-(NSInteger)qualityMeasureWithCountOfFacesOnAsset:(NSUInteger)arg0 ;
-(id)gist;
