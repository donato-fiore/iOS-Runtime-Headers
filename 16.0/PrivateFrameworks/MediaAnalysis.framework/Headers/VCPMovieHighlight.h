...
@property (nonatomic) float autoplayScore; // ivar: _autoplayScore
...
@property (nonatomic) float exposureChangeScore; // ivar: _exposureChangeScore
...
@property (nonatomic) BOOL isSettlingOK; // ivar: _isSettlingOK
...
@property (nonatomic) float motionScore; // ivar: _motionScore
@property (nonatomic) float qualityScore; // ivar: _qualityScore
@property (nonatomic) float score; // ivar: _score
@property (nonatomic) float subjectScore; // ivar: _subjectScore
