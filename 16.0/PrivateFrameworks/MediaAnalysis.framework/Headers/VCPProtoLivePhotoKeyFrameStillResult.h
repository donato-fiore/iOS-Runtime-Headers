...
#ifndef VCPPROTOLIVEPHOTOKEYFRAMESTILLRESULT_H
#define VCPPROTOLIVEPHOTOKEYFRAMESTILLRESULT_H
...
@property (nonatomic) BOOL hasFlash; // ivar: _hasFlash
@property (nonatomic) float sharpness; // ivar: _sharpness
@property (nonatomic) float stillTime; // ivar: _stillTime
@property (nonatomic) float textureness; // ivar: _textureness
