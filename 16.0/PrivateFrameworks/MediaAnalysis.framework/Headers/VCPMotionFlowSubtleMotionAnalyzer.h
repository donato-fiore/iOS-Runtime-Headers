...
-(id)init;
-(int)analyzePixelBuffer:(struct __CVBuffer *)arg0 withFrame:(*void)arg1 withTimestamp:(struct ? )arg2 andDuration:(struct ? )arg3 hasSubtleScene:(int)arg4 cancel:(id)arg5 ;
