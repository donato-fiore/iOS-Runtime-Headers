...
typedef struct Matrix<float, 12U, 1U, false> {
    float m_data;
} Matrix<float, 12U, 1U, false>;

typedef struct Matrix<float, 12U, 12U, false> {
    float m_data;
} Matrix<float, 12U, 12U, false>;

typedef struct layout<double, 6L, 1L, dlib::memory_manager_stateless_kernel_1<char>, 1> {
    CGFloat field0;
} layout<double, 6L, 1L, dlib::memory_manager_stateless_kernel_1<char>, 1>;

typedef struct matrix<double, 6L, 1L, dlib::memory_manager_stateless_kernel_1<char>, dlib::row_major_layout> {
    layout<double, 6L, 1L, dlib::memory_manager_stateless_kernel_1<char>, 1> field0;
} matrix<double, 6L, 1L, dlib::memory_manager_stateless_kernel_1<char>, dlib::row_major_layout>;
