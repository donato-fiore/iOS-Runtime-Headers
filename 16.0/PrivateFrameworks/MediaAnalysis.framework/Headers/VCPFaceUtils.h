...
+(int)configureVNRequest:(*id)arg0 withClass:(Class)arg1 andVisionRevision:(NSUInteger)arg2 ;
+(struct CGRect )faceRectFromNormalizedCenterX:(CGFloat)arg0 normalizedCenterY:(CGFloat)arg1 normalizedSize:(CGFloat)arg2 sourceWidth:(CGFloat)arg3 sourceHeight:(CGFloat)arg4 ;
