...
@property (readonly, nonatomic) BOOL isHighResDecoded; // ivar: _isHighResDecoded
...
+(id)assetWithImageData:(id)arg0 uniformTypeIdentifier:(id)arg1 identifier:(id)arg2 clientBundleID:(id)arg3 clientTeamID:(id)arg4 ;
...
-(id)vcp_annotationWithTypes:(NSUInteger)arg0 ;
