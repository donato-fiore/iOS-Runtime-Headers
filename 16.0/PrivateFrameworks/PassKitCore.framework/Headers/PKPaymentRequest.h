...
@class NSString, AKAppleIDAuthenticationContext, NSData, NSArray, NSDictionary, NSURL, NSDate, NSTimeZone, NSSet;
...
@property (nonatomic) NSInteger APIType; // ivar: _APIType
...
@property (copy, nonatomic) NSDictionary *clientAnalyticsParameters; // ivar: _clientAnalyticsParameters
@property (nonatomic) CGFloat clientCallbackTimeout; // ivar: _clientCallbackTimeout
@property (copy, nonatomic) NSString *clientViewSourceIdentifier; // ivar: _clientViewSourceIdentifier
@property (copy, nonatomic) NSDictionary *clientViewSourceParameter; // ivar: _clientViewSourceParameter
...
@property (nonatomic) BOOL disablePasscodeFallback; // ivar: _disablePasscodeFallback
...
@property (copy, nonatomic) NSString *localizedBiometricRetryMessage; // ivar: _localizedBiometricRetryMessage
...
@property (copy, nonatomic) NSString *localizedUnboundBiometricMessage; // ivar: _localizedUnboundBiometricMessage
...
@property (nonatomic) NSInteger requestorDeviceType; // ivar: _requestorDeviceType
