...
+(id)_bnplFinancingOptionsDictionaryWithRelevantDates:(BOOL)arg0 ;
+(id)_bnplFinancingPlan1WithRelevantDates:(BOOL)arg0 ;
+(id)_bnplPreliminaryAssessmentDictionary;
+(id)_bnplProductAssessmentDictionary;
+(id)_bnplProductAssessmentDictionary2;
+(id)_dateFormatter;
+(id)_loanFinancingOptionDictionaryWithRelevantDates:(BOOL)arg0 ;
