...
-(void)_downloadRemoteAssetsWithScreenScale:(CGFloat)arg0 suffix:(id)arg1 cloudStoreCoordinatorDelegate:(id)arg2 requireRequiredAssets:(BOOL)arg3 completion:(id)arg4 ;
...
-(void)downloadRemoteAssetsWithScreenScale:(CGFloat)arg0 suffix:(id)arg1 cloudStoreCoordinatorDelegate:(id)arg2 ignoreRequiredAssetDownloadFailures:(BOOL)arg3 completion:(id)arg4 ;
