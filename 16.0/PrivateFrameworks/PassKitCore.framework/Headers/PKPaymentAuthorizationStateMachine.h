...
-(void)_performSendClientUpdateWithShippingMethods:(id)arg0 paymentSummaryItems:(id)arg1 multiTokenContexts:(id)arg2 recurringPaymentRequest:(id)arg3 automaticReloadPaymentRequest:(id)arg4 paymentApplication:(id)arg5 status:(NSInteger)arg6 ;
...
-(void)_updateModelWithShippingMethods:(id)arg0 paymentSummaryItems:(id)arg1 multiTokenContexts:(id)arg2 recurringPaymentRequest:(id)arg3 automaticReloadPaymentRequest:(id)arg4 contentItems:(id)arg5 ;
