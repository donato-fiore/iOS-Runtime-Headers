...
-(void)accountBalancesForAccountIdentifier:(id)arg0 startDate:(id)arg1 endDate:(id)arg2 type:(NSUInteger)arg3 completion:(id)arg4 ;
...
-(void)countOfFinancingPlansForAccountIdentifier:(id)arg0 financingPlanStates:(id)arg1 completion:(id)arg2 ;
...
-(void)financingPlansForAccountIdentifier:(id)arg0 completion:(id)arg1 ;
-(void)financingPlansForAccountIdentifier:(id)arg0 financingPlanStates:(id)arg1 completion:(id)arg2 ;
-(void)financingPlansForAccountIdentifier:(id)arg0 states:(id)arg1 transactionStartDate:(id)arg2 transactionEndDate:(id)arg3 limit:(NSInteger)arg4 completion:(id)arg5 ;
-(void)financingPlansForAccountIdentifier:(id)arg0 withInstallmentsDueDateStart:(id)arg1 endDueDate:(id)arg2 financingPlanStates:(id)arg3 completion:(id)arg4 ;
...
-(void)updateAccountEnhancedMerchantsForAccountWithIdentifier:(id)arg0 forceUpdate:(BOOL)arg1 observeCooldownPeriod:(BOOL)arg2 completion:(id)arg3 ;
-(void)updateAccountEnhancedMerchantsForAccountWithIdentifier:(id)arg0 observeCooldownPeriod:(BOOL)arg1 completion:(id)arg2 ;
-(void)updateAccountPromotionsForAccountWithIdentifier:(id)arg0 completion:(id)arg1 ;
-(void)updateAccountPromotionsForAccountWithIdentifier:(id)arg0 forceUpdate:(BOOL)arg1 observeCooldownPeriod:(BOOL)arg2 completion:(id)arg3 ;
