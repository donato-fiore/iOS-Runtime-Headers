...
-(NSUInteger)_performAccountRequest:(id)arg0 account:(id)arg1 taskID:(NSUInteger)arg2 responseClass:(Class)arg3 completion:(id)arg4 ;
...
-(void)_addVerificationRequestRecord:(id)arg0 ;
...
-(void)_forceFetchWebServiceContextWithCompletion:(id)arg0 ;
...
-(void)_updateSharedWebServiceContextWithCompletion:(id)arg0 ;
...
-(void)dealloc;
-(void)fetchWebServiceContextWithCompletion:(id)arg0 ;
