...
@class NADelegateDispatcher, NAFuture, NSMutableArray, NSString, HMHome, HMHomeManager, NSMutableDictionary;
@protocol HFHomeAppInstallStateArbiterObserver, HFHomeManagerCreatorDelegate, HFLocationSensingCoordinatorDelegate, HFStateRestorationSettingsObserver;
...
#import "HFHomeKitMediaGroupsController.h"
...
@property (retain, nonatomic) NADelegateDispatcher *accessorySoftwareUpdateControllerV2ObserverDispatcher; // ivar: _accessorySoftwareUpdateControllerV2ObserverDispatcher
...
@property (readonly, nonatomic) HFHomeKitMediaGroupsController *mediaGroupsController; // ivar: _mediaGroupsController
...
@property (readonly, nonatomic) HFSoftwareUpdateManager *softwareUpdateManager; // ivar: _softwareUpdateManager
...
-(void)_setSoftwareUpateControllerV2ObservationEnabled:(BOOL)arg0 ;
...
-(void)addAccessorySoftwareUpdateControllerV2Observer:(id)arg0 ;
...
// -(void)dispatchAccessorySoftwareUpdateControllerV2Message:(id)arg0 sender:(unk)arg1  ;
...
-(void)removeAccessorySoftwareUpdateControllerV2Observer:(id)arg0 ;
