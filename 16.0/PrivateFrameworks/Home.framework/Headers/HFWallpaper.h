...
@property (nonatomic) BOOL isCustomType; // ivar: _isCustomType
@property (retain, nonatomic) HFWallpaper *lastUserSelectedWallpaper; // ivar: _lastUserSelectedWallpaper
