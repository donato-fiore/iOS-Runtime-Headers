...
@protocol HFAccessoryRepresentableItem, HFMediaAccessoryProtocol, HFMediaAccessoryLikeItem, HFActionBuilderFactory, HFHomeKitMediaGroupsControllerDelegate, HFAccessoryRepresentable, HFHomeKitObject, HFHomeKitSettingsVendor, HFMediaProfileContainer, HFMediaValueSource, HFCharacteristicValueSource;


#import "HFItem.h"
#import "HFMediaAccessoryCommonSettingsManager.h"

@interface HFMediaAccessoryItem : HFItem <HFAccessoryRepresentableItem, HFMediaAccessoryProtocol, HFMediaAccessoryLikeItem, HFActionBuilderFactory, HFHomeKitMediaGroupsControllerDelegate>
...
-(BOOL)isContainedWithinPermanentSpeakerGroup;
-(BOOL)isDoorbellChimeEnabled;
-(BOOL)isHomePod;
-(BOOL)isHomePodAndIsInMediaSystem;
-(BOOL)isHomePodMediaSystem;
-(BOOL)isPermanentSpeakerGroup;
-(BOOL)isSingleHomePodInPermanentSpeakerGroup;
-(BOOL)isSiriDisabled;
...
-(void)didReceiveMediaGroup:(id)arg0 ;
