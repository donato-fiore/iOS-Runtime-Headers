...
@class NSOperation, NSMutableDictionary, NSArray, NSError, NSMutableArray, PHPhotoLibrary, CSSearchableIndex;
...
@property (readonly, nonatomic) NSObject<OS_dispatch_queue> *imageProcessingQueue;
...
-(void)main;
-(void)processItems;
-(void)requestImageProcessingFoSearchableImageItems:(id)arg0 ;
