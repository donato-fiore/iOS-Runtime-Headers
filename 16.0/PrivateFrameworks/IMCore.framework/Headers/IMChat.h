...
@class NSMutableSet, NSSet, NSArray, NSDate, NSDictionary, IMBrand, NSString, IMScheduledUpdater, NSMutableDictionary, NSNumber, IMDaemonController<IMDaemonProtocol>, NSData, IMMessageItem, NSMutableArray, IMTimingCollection;
...
-(void)hasKnownParticipantsWithCompletion:(id)arg0 ;
...
-(void)validatePeerStatus:(id)arg0 ;
