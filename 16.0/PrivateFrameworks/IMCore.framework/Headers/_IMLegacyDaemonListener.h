...
@class NSMutableDictionary, NSArray, NSString, NSMutableArray, NSDate, NSData, NSProtocolChecker;
@protocol IMDaemonListening, IMDaemonListening_Internal;
...
@property (retain, nonatomic) NSMutableArray *deferredChatMessages; // ivar: _deferredChatMessages
@property (readonly, copy) NSString *description;
@property (retain, nonatomic) NSMutableArray *handlers; // ivar: _handlers
@property (nonatomic) BOOL hasPendingProcessChange; // ivar: _hasPendingProcessChange
...
@property (retain, nonatomic) NSString *myNowPlayingString; // ivar: _myNowPlayingString
@property (retain, nonatomic) NSData *myPicture; // ivar: _myPicture
...
@property (retain, nonatomic) NSMutableDictionary *persistentProperties; // ivar: _persistentProperties
...
@property (readonly, nonatomic, getter=isSetupComplete) BOOL setupComplete; // ivar: _setupComplete
