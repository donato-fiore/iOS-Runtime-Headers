...
-(id)_existingChannelsForPresenceIdentifier:(id)arg0 databaseContext:(id)arg1 ;
...
-(id)createPresenceChannelForPresenceIdentifier:(id)arg0 channelIdentifier:(id)arg1 channelToken:(id)arg2 peerKey:(id)arg3 serverKey:(id)arg4 membershipKey:(id)arg5 databaseContext:(id)arg6 ;
...
-(id)existingChannelForPresenceIdentifier:(id)arg0 databaseContext:(id)arg1 ;
