...
@class UIImageView, UIViewController, NSString, UIView, NSArray, MKUGCCallToActionViewAppearance;
@protocol MUPlaceTilesViewDelegate, MUPlacePhotoGalleryViewControllerDelegate, UIViewControllerTransitioningDelegate, MUPhotoGalleryTransitionAnimator, MUScrollAnalyticActionObserving, MUPlaceSectionControlling, GEOAnnotatedItemList, MUInfoCardAnalyticsDelegate, MUPlacePictureItemSectionControllerDelegate;
