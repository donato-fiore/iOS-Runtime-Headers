...
-(void)placeCardActionControllerDidSelectDirections:(id)arg0 options:(id)arg1 ;
...
-(void)presentAddPhotosWithPresentationOptions:(id)arg0 entryPoint:(NSInteger)arg1 ;
...
-(void)updateUserSubmissionWithPhotoURL:(id)arg0 numberOfPhotos:(NSInteger)arg1 ;
