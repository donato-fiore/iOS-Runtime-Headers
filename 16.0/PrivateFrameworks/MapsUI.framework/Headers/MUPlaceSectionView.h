...
+(id)cardShadowSectionViewForContentView:(id)arg0 sectionHeaderViewModel:(id)arg1 sectionFooterViewModel:(id)arg2 alwaysInsetContentView:(BOOL)arg3 ;
...
-(void)setHeaderAXIdentifierWithBaseString:(id)arg0 ;
