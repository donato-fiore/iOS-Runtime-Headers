...
@protocol UIViewControllerAnimatedTransitioning, MUPhotoGalleryTransitionAnimator;
...
@property (weak, nonatomic) NSObject<MUPhotoGalleryTransitionAnimator> *delegate; // ivar: _delegate
