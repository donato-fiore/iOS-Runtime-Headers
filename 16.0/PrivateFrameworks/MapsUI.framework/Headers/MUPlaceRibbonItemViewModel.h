...
@property (copy, nonatomic) NSString *preferredAccessibilityValue; // ivar: _preferredAccessibilityValue
...
@property (retain, nonatomic) NSString *typeStringForAX; // ivar: _typeStringForAX
