...
@class NSString, CPSClipMetadata, NSNumber;
...
@property (retain, nonatomic) NSNumber *poiMuid; // ivar: _poiMuid
...
-(id)initWithPredictedAdamId:(NSUInteger)arg0 bundleId:(id)arg1 latitude:(CGFloat)arg2 longitude:(CGFloat)arg3 radiusInMeters:(NSUInteger)arg4 rank:(NSUInteger)arg5 isTouristApp:(BOOL)arg6 score:(CGFloat)arg7 urlHash:(id)arg8 clipMetadata:(id)arg9 poiCategory:(id)arg10 poiMuid:(id)arg11 ;
