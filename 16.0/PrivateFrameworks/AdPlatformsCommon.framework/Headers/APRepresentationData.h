...
@class NSString, NSDictionary, NSArray, NSError, NSUUID, APOdmlServerResponse, NSURL;
...
@property (retain, nonatomic) NSDictionary *appMetadata; // ivar: _appMetadata
...
@property (retain, nonatomic) NSArray *cppIds; // ivar: _cppIds
...
@property (retain, nonatomic) NSDictionary *positionInformation; // ivar: _positionInformation
...
@property (nonatomic) NSInteger slotNumber; // ivar: _slotNumber
...
@property (readonly) NSString *targetingExpressionId; // ivar: _targetingExpressionId
