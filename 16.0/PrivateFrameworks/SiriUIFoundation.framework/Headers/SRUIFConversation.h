...
@property (weak, nonatomic) NSObject<SRUIFConversationDelegate> *delegate; // ivar: _delegate
...
@property (retain, nonatomic, setter=_setLastRestoredItem:) NSObject<SRUIFConversationStorable> *lastRestoredItem; // ivar: _lastRestoredItem
@property (retain, nonatomic, getter=_rootNode, setter=_setRootNode:) SRUIFTreeNode *rootNode; // ivar: _rootNode
...
-(id)itemsRelatedToIdentifier:(id)arg0 ;
-(id)lastItem;
