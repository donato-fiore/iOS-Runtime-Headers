...
-(BOOL)_languageCodeHasChanged:(id)arg0 ;
...
-(void)_loadOnDiskRules:(id)arg0 ;
-(void)_loadVoiceResource:(id)arg0 voiceResource:(id)arg1 ;
...
-(void)processMarker:(NSInteger)arg0 withByteOffset:(unsigned int)arg1 markerPosition:(unsigned int)arg2 markerLength:(unsigned int)arg3 context:(id)arg4 currentTime:(NSUInteger)arg5 secondPass:(BOOL)arg6 ;
