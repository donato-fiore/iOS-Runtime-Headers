...
@class NSAttributedString, NSArray, TTSSpeechRequest, NSString, NSURL, TTSVoiceResourceAsset;
...
@property (retain, nonatomic) NSArray *rulesetRangeAdjustments; // ivar: _rulesetRangeAdjustments
