...
#ifndef MCMXPCMESSAGEWITHLINKBASE_H
#define MCMXPCMESSAGEWITHLINKBASE_H

@class NSString;
@protocol MCMXPCMessage, MCMParametersWithLink, OS_xpc_object;


#import "MCMXPCMessageBase.h"
#import "MCMResolvedLink.h"

@interface MCMXPCMessageWithLinkBase : MCMXPCMessageBase <MCMXPCMessage, MCMParametersWithLink>
