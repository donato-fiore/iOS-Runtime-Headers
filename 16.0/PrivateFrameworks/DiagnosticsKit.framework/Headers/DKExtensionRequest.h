...
@class NSString, RBSAssertion, UIViewController;
...
@property (retain, nonatomic) NSString *allowListContactMessage; // ivar: _allowListContactMessage
...
@property (nonatomic) BOOL isAllowListed; // ivar: _isAllowListed
@property (retain, nonatomic) id *payload; // ivar: _payload
@property (retain, nonatomic) RBSAssertion *rbprocessAssertion; // ivar: _rbprocessAssertion
...
-(void)interrupt;
-(void)setNotAllowListedWithContactMessage:(id)arg0 ;
