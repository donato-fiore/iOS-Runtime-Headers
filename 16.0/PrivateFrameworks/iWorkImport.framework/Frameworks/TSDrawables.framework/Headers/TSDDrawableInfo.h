...
@class TSPObject, TSPLazyReference, TSSPropertySetChangeDetails, NSArray, NSString, NSSet, NSUUID, NSURL, TSPObject<TSDOwningAttachment>, TSDDrawableInfo<TSDTitlePlacementProviding>;
@protocol TSDChangeableInfo, TSDLockableInfo, TSKDocumentObject, TSKTransformableObject, TSKSearchable, TSDScrollingAwareChangeSource, TSKAnnotationParent, TSDInfo;
