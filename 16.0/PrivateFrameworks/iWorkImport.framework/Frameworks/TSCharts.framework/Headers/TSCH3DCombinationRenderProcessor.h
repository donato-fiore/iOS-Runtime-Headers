...
@interface TSCH3DCombinationRenderProcessor : TSCH3DRetargetRenderProcessor {
    NSIndexSet *_enabled;
    StateStack<glm::detail::tmat4x4<float>, 8L> _transformStack;
    tmat4x4<float> _projection;
    StateStack<TSCH3D::ObjectState, 6L> _objectStateStack;
    StateStack<TSCH3D::RenderState, 10L> _renderStateStack;
