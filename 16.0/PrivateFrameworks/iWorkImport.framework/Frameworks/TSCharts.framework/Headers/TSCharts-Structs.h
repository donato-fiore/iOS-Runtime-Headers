...
typedef struct array<bool, 8UL> {
    BOOL __elems_;
} array<bool, 8UL>;

typedef struct EnableClipDistances {
    array<bool, 8UL> states;
} EnableClipDistances;
...
typedef struct StateStack<glm::detail::tmat4x4<float>, 8L> {
    NSUInteger _index;
    tmat4x4<float> _current;
    tmat4x4<float> _stack;
} StateStack<glm::detail::tmat4x4<float>, 8L>;
...
typedef struct StateStack<TSCH3D::ObjectState, 6L> {
    NSUInteger _index;
    ObjectState _current;
    ObjectState _stack;
} StateStack<TSCH3D::ObjectState, 6L>;

typedef struct StateStack<TSCH3D::RenderState, 10L> {
    NSUInteger _index;
    RenderState _current;
    RenderState _stack;
} StateStack<TSCH3D::RenderState, 10L>;
...
typedef struct array<TSCH3D::BarExtrusionDetails, 2UL> {
    BarExtrusionDetails __elems_;
} array<TSCH3D::BarExtrusionDetails, 2UL>;
...
typedef struct array<TSCH3DShaderVariableScopeType, 2UL> {
    TSCH3DShaderVariableScopeType __elems_;
} array<TSCH3DShaderVariableScopeType, 2UL>;

typedef struct TSCH3DShaderVariableScopes {
    array<TSCH3DShaderVariableScopeType, 2UL> _scopes;
...
typedef struct array<glm::detail::tmat4x4<float>, 2UL> {
    tmat4x4<float> __elems_;
} array<glm::detail::tmat4x4<float>, 2UL>;

typedef struct LightingPackageShaderEffectState {
    array<glm::detail::tmat4x4<float>, 2UL> transforms;
