...
@class TSPObject, TSUPointerKeyDictionary, NSMutableDictionary, NSArray, NSMutableArray;
@protocol NSCopying;
...
@property (retain, nonatomic) TSUPointerKeyDictionary *formatsAdded; // ivar: _formatsAdded
...
+(?)cellListWithContext:(?)arg0 cellUIDRange:(?)arg1 repeatCellVectorPatternpatternDirection;
...
-(void)addCell:(id)arg0 atIndex:(NSUInteger)arg1 ;
...
-(void)p_enumerateCellsAddedAndRemovedOfType:(NSUInteger)arg0 usingBlock:(id)arg1 ;
-(void)p_enumerateCellsAddedOfType:(NSUInteger)arg0 usingBlock:(id)arg1 ;
...
-(void)p_pruneToBaseWithBaseMap:(id)arg0 viewMap:(id)arg1 ;
