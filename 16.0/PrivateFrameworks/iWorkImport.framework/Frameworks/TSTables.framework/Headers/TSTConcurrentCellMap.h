...
@property (readonly, nonatomic) BOOL affectsCellBorders; // ivar: _affectsCellBorders
...
+(?)concurrentCellMapWithContext:(?)arg0 cellUIDRange:(?)arg1 repeatCellVectorPattern:(?)arg2 patternDirection:(?)arg3 uidBasedaffectsCellBorders;
...
-(id)initWithContext:(id)arg0 affectsCellBorders:(BOOL)arg1 ;
-(id)initWithContext:(id)arg0 uidBased:(BOOL)arg1 affectsCellBorders:(BOOL)arg2 ;
// -(void)accumulateBordersConcurrentlyUsingBlock:(id)arg0 accumulateCellsConcurrentlyUsingBlock:(unk)arg1  ;
...
-(void)enumerateCellsAddedAndRemovedOfType:(NSUInteger)arg0 withOptions:(NSUInteger)arg1 usingBlock:(id)arg2 ;
-(void)enumerateCellsAddedOfType:(NSUInteger)arg0 withOptions:(NSUInteger)arg1 usingBlock:(id)arg2 ;
...
-(void)willApplyToTableModel:(id)arg0 ;
