...
+(?)equationWithXMLDoc:(?)arg0 node:(?)arg1 environmenterror;
+(BOOL)isEquationInPDFData:(id)arg0 ;
+(id)equationSourceFromDataProvider:(struct CGDataProvider *)arg0 ;
+(id)equationSourceFromPDFData:(id)arg0 ;
+(id)equationSourceFromXMLMetadata:(id)arg0 ;
...
+(id)xmlMetadataFromEquationSource:(id)arg0 ;
...
-(id)newLayout;
-(id)pdfDataWithLayout:(id)arg0 layoutContext:(id)arg1 sourceString:(id)arg2 tightFit:(BOOL)arg3 ;
-(id)pdfDataWithLayoutContext:(id)arg0 baselineOffset:(*CGFloat)arg1 sourceString:(id)arg2 ;
-(void)dealloc;
