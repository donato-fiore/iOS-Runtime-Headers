...
@protocol TSPStyleObjectDataContainer, TSPRemoteDataStorageDelegate, OS_dispatch_queue, TSPDataStorage;
...
@property (readonly, nonatomic) NSUInteger creationVersion;
...
-(BOOL)materializeFromPartiallyDownloadedDocumentWithContentsOfURL:(id)arg0 canMove:(BOOL)arg1 error:(*id)arg2 ;
...
-(NSUInteger)creationVersionWithDocumentMetadata:(id)arg0 ;
-(id)AVAsset;
...
// -(id)temporaryDataStorageForReplacingDataContentsWithDecryptionInfo:(id)arg0 writer:(id)arg1 error:(unk)arg2  ;
