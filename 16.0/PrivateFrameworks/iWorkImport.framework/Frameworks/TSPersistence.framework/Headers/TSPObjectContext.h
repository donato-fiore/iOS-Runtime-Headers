...
-(BOOL)updateDocumentUUIDPreserveOriginalDocumentSupport:(BOOL)arg0 preserveShareUUID:(BOOL)arg1 preserveStableDocumentUUID:(BOOL)arg2 error:(*id)arg3 ;
...
-(id)initForSpotlightWithURL:(id)arg0 delegate:(id)arg1 registry:(id)arg2 passphrase:(id)arg3 error:(*id)arg4 ;
