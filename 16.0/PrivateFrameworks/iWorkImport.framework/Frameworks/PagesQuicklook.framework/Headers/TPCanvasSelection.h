...
-(id)initWithType:(NSInteger)arg0 range:(struct _NSRange )arg1 styleInsertionBehavior:(NSInteger)arg2 caretAffinity:(NSInteger)arg3 smartFieldRange:(struct _NSRange )arg4 leadingEdge:(BOOL)arg5 leadingCharIndex:(NSUInteger)arg6 infos:(id)arg7 excludedInfos:(id)arg8 additionalInfos:(id)arg9 ;
...
-(id)initWithType:(NSInteger)arg0 ranges:(id)arg1 validVisualRanges:(BOOL)arg2 styleInsertionBehavior:(NSInteger)arg3 caretAffinity:(NSInteger)arg4 smartFieldRange:(struct _NSRange )arg5 leadingEdge:(BOOL)arg6 leadingCharIndex:(NSUInteger)arg7 headCharIndex:(NSUInteger)arg8 tailCharIndex:(NSUInteger)arg9 infos:(id)arg10 excludedInfos:(id)arg11 additionalInfos:(id)arg12 ;
