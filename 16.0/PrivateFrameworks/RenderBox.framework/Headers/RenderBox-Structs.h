...
typedef struct InlineHeap<256UL> {
...
typedef struct vector<RBStrokeElement, 0UL, unsigned long> {
    unsigned char _p;
    NSUInteger _size;
    NSUInteger _capacity;
} vector<RBStrokeElement, 0UL, unsigned long>;

typedef struct vector<float, 0UL, unsigned long> {
    float _p;
    NSUInteger _size;
    NSUInteger _capacity;
} vector<float, 0UL, unsigned long>;
...
typedef struct vector<RB::Transition::EffectOrArg, 4UL, unsigned int> {
    unsigned char _p;
    float _p;
    float _size;
    char _capacity;
    ...
    unsigned int field5;
    unsigned int field6;
} vector<RB::Transition::EffectOrArg, 4UL, unsigned int>;
...
typedef struct Transition {
    ...
    vector<RB::Transition::EffectOrArg, 4UL, unsigned int> effects_and_args;
} Transition;
...
typedef struct vector<std::pair<RB::cf_ptr<CGContext *>, RB::ContextDelegate *>, 1UL, unsigned long> {
    unsigned char _p;
    void _p;
    NSUInteger _size;
    NSUInteger _capacity;
} vector<std::pair<RB::cf_ptr<CGContext *>, RB::ContextDelegate *>, 1UL, unsigned long>;

typedef struct objc_ptr<void (^)(_RBDrawingState *, unsigned long)> {
    id _p;
    unk field1;
} objc_ptr<void (^)(_RBDrawingState *, unsigned long)>;

typedef struct Term {
} // Error Processing Struct Fields

typedef struct vector<RB::DisplayListPredicate::Term, 1UL, unsigned int> {
    unsigned char _p;
    Term _p;
    unsigned int _size;
    unsigned int _capacity;
} vector<RB::DisplayListPredicate::Term, 1UL, unsigned int>;

typedef struct DisplayListPredicate {
    vector<RB::DisplayListPredicate::Term, 1UL, unsigned int> _terms;
...
typedef struct vector<RB::DisplayListTransform::Term, 1UL, unsigned int> {
    unsigned char _p;
    Term _p;
    unsigned int _size;
    unsigned int _capacity;
} vector<RB::DisplayListTransform::Term, 1UL, unsigned int>;

typedef struct DisplayListTransform {
    vector<RB::DisplayListTransform::Term, 1UL, unsigned int> _terms;
} DisplayListTransform;

typedef struct Op {
} // Error Processing Struct Fields

typedef struct vector<RB::DisplayListInterpolator::Op, 4UL, unsigned int> {
    unsigned char _p;
    Op _p;
    unsigned int _size;
    unsigned int _capacity;
} vector<RB::DisplayListInterpolator::Op, 4UL, unsigned int>;

typedef struct Rect {
} // Error Processing Struct Fields

typedef struct vector<RB::Rect, 2UL, unsigned int> {
    unsigned char _p;
    Rect _p;
    unsigned int _size;
    unsigned int _capacity;
} vector<RB::Rect, 2UL, unsigned int>;

typedef struct DisplayListInterpolator {
    Transition default_transition;
    vector<RB::DisplayListInterpolator::Op, 4UL, unsigned int> ops;
    unsigned char ops_types;
    vector<RB::Rect, 2UL, unsigned int> rects;
    BOOL valid;
    BOOL has_identity;
    BOOL non_fade_effects;
} DisplayListInterpolator;

typedef struct objc_ptr<id<RBDisplayListContents>> {
    id _p;
} objc_ptr<id<RBDisplayListContents>>;

typedef struct objc_ptr<NSDictionary *> {
    id _p;
} objc_ptr<NSDictionary *>;

typedef struct objc_ptr<RBDisplayListInterpolator *> {
    id _p;
} objc_ptr<RBDisplayListInterpolator *>;
...
typedef struct objc_ptr<id<MTLEvent>> {
    id _p;
} objc_ptr<id<MTLEvent>>;
...
typedef struct InlineHeap<64UL> {
} // Error Processing Struct Fields
...
typedef struct __cxx_atomic_impl<_opaque_pthread_t *, std::__cxx_atomic_base_impl<_opaque_pthread_t *>> {
    uint8_t __a_value;
    _opaque_pthread_t field1;
} __cxx_atomic_impl<_opaque_pthread_t *, std::__cxx_atomic_base_impl<_opaque_pthread_t *>>;

typedef struct atomic<_opaque_pthread_t *> {
    __cxx_atomic_impl<_opaque_pthread_t *, std::__cxx_atomic_base_impl<_opaque_pthread_t *>> __a_;
