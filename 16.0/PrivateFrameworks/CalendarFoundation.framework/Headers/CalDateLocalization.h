...
+(id)dateFormatters;
+(id)dateStringRepresentationForEventCompontentsStartDate:(id)arg0 endDate:(id)arg1 allDay:(BOOL)arg2 timeZone:(id)arg3 ;
+(id)formatKeyForHourString;
+(id)longStringForDateAndTime:(id)arg0 inTimeZone:(id)arg1 ;
