...
@protocol SBFTraitsArbiterUpdateContextBuilding, BSDescriptionProviding, SBFTraitsSettingsActuationContextProviding, SBFTraitsArbiterDrawingDataSource;
...
@property (weak, nonatomic, setter=_setDrawingConfigurationProvider:) NSObject<SBFTraitsArbiterDrawingDataSource> *_drawingConfigProvider; // ivar: __drawingConfigProvider
