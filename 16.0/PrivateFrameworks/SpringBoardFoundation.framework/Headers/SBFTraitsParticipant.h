...
@class NSString;
@protocol SBFTraitsPreferencesUpdating, SBFTraitsSettingsUpdating, SBFTraitsSettingsActuationContextProviding, SBFTraitsPreferencesProviding, SBFTraitsResolutionPoliciesProviding, NSCopying, BSInvalidatable, BSDescriptionProviding, SBFTraitsSettingsProviding, SBFTraitsParticipantDelegate;
...
-(CGFloat)currentZOrderLevel;
-(CGFloat)previousZOrderLevel;
-(NSInteger)currentDeviceOrientation;
-(NSInteger)currentOrientation;
-(NSInteger)previousDeviceOrientation;
