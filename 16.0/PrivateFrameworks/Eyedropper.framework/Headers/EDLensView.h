...
@property (readonly, nonatomic) BOOL isMovingWithPan;
...
-(void)tappedCenter:(id)arg0 ;
-(void)updateCenterOffsetAtTouchDown:(struct CGPoint )arg0 ;
-(void)updateLensState:(NSInteger)arg0 ;
-(void)updateLensViewWithEvent:(id)arg0 ;
-(void)updateLocation:(struct CGPoint )arg0 ;
