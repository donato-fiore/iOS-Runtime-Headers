...
#ifndef WFAIRPLANEMODETRIGGERCONFIGURATIONVIEWCONTROLLER_H
#define WFAIRPLANEMODETRIGGERCONFIGURATIONVIEWCONTROLLER_H

@class WFTriggerConfigurationViewController, NSString, NSArray, UITableView;
@protocol UITableViewDataSource, WFTriggerMultiSelectCellDelegate;
