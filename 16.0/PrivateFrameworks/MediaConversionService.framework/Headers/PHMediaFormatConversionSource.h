...
@property BOOL didCheckForVideoWithFormatEligibleForTranscoding; // ivar: _didCheckForVideoWithFormatEligibleForTranscoding
@property unsigned int firstVideoTrackCodec; // ivar: _firstVideoTrackCodec
...
-(void)markContainsVideoEligibleForTranscodingAsCheckedWithValue:(BOOL)arg0 codec:(unsigned int)arg1 ;
