...
-(void)_handlePotentiallyFinalPhotoRequestCallbackWithPayload:(id)arg0 forRequest:(id)arg1 ;
-(void)_handlePreparationCompleteNotificationWithPayload:(id)arg0 settingsID:(NSInteger)arg1 ;
-(void)_handleReadyForResponsiveRequestWithPayload:(id)arg0 forRequest:(id)arg1 ;
...
-(void)_updateMaxPhotoDimensionsForDevice:(id)arg0 ;
...
-(void)setFigCaptureSessionSectionProperty:(struct __CFString *)arg0 withHostTime:(struct ? )arg1 ;
-(void)setFigCaptureSessionSectionProperty:(struct __CFString *)arg0 withValue:(*void)arg1 ;
...
-(void)setPrivatePhotoDimensionsEnabled:(BOOL)arg0 ;
