...
typedef struct vector<TTSSynthesizer::Marker, std::allocator<TTSSynthesizer::Marker>> {
} // Error Processing Struct Fields

typedef struct TTSSynthesizer {
} // Error Processing Struct Fields

typedef struct __compressed_pair<TTSSynthesizer *, std::default_delete<TTSSynthesizer>> {
    TTSSynthesizer __value_;
} __compressed_pair<TTSSynthesizer *, std::default_delete<TTSSynthesizer>>;

typedef struct unique_ptr<TTSSynthesizer, std::default_delete<TTSSynthesizer>> {
    __compressed_pair<TTSSynthesizer *, std::default_delete<TTSSynthesizer>> __ptr_;
} unique_ptr<TTSSynthesizer, std::default_delete<TTSSynthesizer>>;
