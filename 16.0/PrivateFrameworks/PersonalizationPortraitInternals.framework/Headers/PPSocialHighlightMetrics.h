...
+(id)logExpiredLinkStatsWithHighlights:(id)arg0 shouldContinueBlock:(id)arg1 ;
...
+(void)logConsumptionByClientWithShouldContinueBlock:(id)arg0 ;
+(void)logFeedbackForAttribution:(id)arg0 type:(NSUInteger)arg1 client:(id)arg2 ;
+(void)logFeedbackForHighlight:(id)arg0 type:(NSUInteger)arg1 client:(id)arg2 ;
+(void)logLinkExpiredMetricsForHighlight:(id)arg0 feedbackCountsByClient:(id)arg1 forTVOS:(BOOL)arg2 ;
+(void)logMatchedFeedbackForHighlightMatches:(id)arg0 batchSize:(NSUInteger)arg1 type:(int)arg2 client:(id)arg3 ;
+(void)logMetricsForExpiringFeedback:(id)arg0 ;
