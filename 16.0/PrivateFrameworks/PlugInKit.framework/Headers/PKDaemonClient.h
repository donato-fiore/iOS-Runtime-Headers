...
-(id)initWithConnection:(id)arg0 queue:(id)arg1 user:(unsigned int)arg2 ;
...
-(void)readyPlugIns:(id)arg0 synchronously:(BOOL)arg1 flags:(NSUInteger)arg2 environment:(id)arg3 languages:(id)arg4 persona:(id)arg5 sandbox:(id)arg6 reply:(id)arg7 ;
