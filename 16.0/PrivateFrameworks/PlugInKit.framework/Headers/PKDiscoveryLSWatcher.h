...
@class NSString;
@protocol PKApplicationWorkspaceObserverProtocol, PKApplicationWorkspaceProxy;
...
@property (retain) NSObject<PKApplicationWorkspaceProxy> *workspace; // ivar: _workspace
