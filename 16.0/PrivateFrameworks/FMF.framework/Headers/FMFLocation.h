...
@protocol NSCopying, NSSecureCoding, FMAnnotation;
...
@property (retain, nonatomic) UIImage *largeAnnotationIcon; // ivar: _largeAnnotationIcon
@property (retain, nonatomic) UIImage *largeOverlayIcon; // ivar: _largeOverlayIcon
...
@property (retain, nonatomic) FMAccuracyOverlay *overlay; // ivar: _overlay
...
@property (retain, nonatomic) UIImage *smallAnnotationIcon; // ivar: _smallAnnotationIcon
@property (retain, nonatomic) UIImage *smallOverlayIcon; // ivar: _smallOverlayIcon
