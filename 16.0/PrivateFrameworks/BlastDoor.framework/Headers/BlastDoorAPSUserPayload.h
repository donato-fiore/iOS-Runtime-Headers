...
@property (nonatomic, readonly) NSInteger deliveryMinimumTime;
@property (nonatomic, readonly) BOOL deliveryStatus;
@property (nonatomic, readonly) NSInteger deliveryStatusFlags;
@property (nonatomic, readonly) NSInteger deliveryTime;
...
@property (nonatomic, readonly) NSInteger ipPreference;
...
@property (nonatomic, readonly) NSInteger relayHighPriorityPort;
...
@property (nonatomic, readonly) NSInteger sendMode;
