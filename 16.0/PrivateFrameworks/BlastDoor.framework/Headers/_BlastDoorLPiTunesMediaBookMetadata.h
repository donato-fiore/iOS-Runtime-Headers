...
#ifndef _BLASTDOORLPITUNESMEDIABOOKMETADATA_H
#define _BLASTDOORLPITUNESMEDIABOOKMETADATA_H
...
@interface _BlastDoorLPiTunesMediaBookMetadata : BlastDoorLPSpecializationMetadata
...
@property (nonatomic) BOOL hasSpineOnRight; // ivar: _hasSpineOnRight
