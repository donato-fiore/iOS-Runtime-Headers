...
#ifndef _BLASTDOORLPITUNESMEDIAMUSICVIDEOMETADATA_H
#define _BLASTDOORLPITUNESMEDIAMUSICVIDEOMETADATA_H
...
@interface _BlastDoorLPiTunesMediaMusicVideoMetadata : BlastDoorLPSpecializationMetadata
