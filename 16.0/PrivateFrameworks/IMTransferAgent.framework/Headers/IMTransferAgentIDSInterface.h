...
+(id)sharedInstance;
-(BOOL)_sendIDSMessage:(id)arg0 fileName:(id)arg1 ;
...
-(void)_sendUploadResponse:(id)arg0 success:(BOOL)arg1 error:(id)arg2 ownerID:(id)arg3 signature:(id)arg4 requestURLString:(id)arg5 transferID:(id)arg6 ;
-(void)dealloc;
