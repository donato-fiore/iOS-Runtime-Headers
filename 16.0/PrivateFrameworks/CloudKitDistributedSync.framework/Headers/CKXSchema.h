...
@interface CKXSchema : NSObject <NSCopying>

 {
    ...
    unordered_map<unsigned long long, CKXStructProperties, std::hash<unsigned long long>, std::equal_to<unsigned long long>, std::allocator<std::pair<const unsigned long long, CKXStructProperties>>> structTokenToStructProperties;
    unordered_map<unsigned long long, std::vector<unsigned long long>, std::hash<unsigned long long>, std::equal_to<unsigned long long>, std::allocator<std::pair<const unsigned long long, std::vector<unsigned long long>>>> structTokenToFieldTokens;
    unordered_map<unsigned long long, CKXFieldProperties, std::hash<unsigned long long>, std::equal_to<unsigned long long>, std::allocator<std::pair<const unsigned long long, CKXFieldProperties>>> fieldTokenToFieldProperties;
}
...
-(NSUInteger)defineValueListReferenceWithEncoding:(char *)arg0 forStruct:(NSUInteger)arg1 ;
