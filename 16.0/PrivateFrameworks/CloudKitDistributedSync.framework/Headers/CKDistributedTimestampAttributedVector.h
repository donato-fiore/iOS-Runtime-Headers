...
@property (retain, nonatomic) NSMutableDictionary *mutableAttributeToSparseVector; // ivar: _mutableAttributeToSparseVector
...
-(NSUInteger)timestampCountForAtomState:(unsigned char)arg0 ;
...
-(unsigned short)attributeForTimestamp:(id)arg0 ;
