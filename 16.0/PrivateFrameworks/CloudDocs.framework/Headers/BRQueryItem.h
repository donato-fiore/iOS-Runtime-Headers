...
@class NSString, NSNumber, NSURL, NSMutableDictionary, NSDictionary, NSArray, NSDate, UTType, NSData, NSError, NSPersonNameComponents, NSSet, NSFileProviderItemVersion;
