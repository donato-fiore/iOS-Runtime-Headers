...
@class NSMutableArray, NSMutableDictionary, NSPredicate, NSString, NSArray, NSOperationQueue, NSMetadataQuery;
@protocol BRNotificationReceiverDelegate, BRItemCollectionGathererDelegate;
...
-(void)itemCollectionGathererReloadedItems:(id)arg0 ;
