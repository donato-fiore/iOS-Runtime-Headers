...
@property (readonly, nonatomic) NSMutableArray *_activeVisualizationIDs; // ivar: __activeVisualizationIDs
@property (readonly, nonatomic) NSMutableDictionary *_activeVisualizationsByID; // ivar: __activeVisualizationsByID
@property (readonly, nonatomic) NSMutableSet *_enabledVisualizationIDs; // ivar: __enabledVisualizationIDs
...
@property (readonly, nonatomic) NSMutableDictionary *_strokeGroupIndexByAncestorID; // ivar: __strokeGroupIndexByAncestorID
