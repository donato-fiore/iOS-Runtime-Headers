...
+(BOOL)lexiconHasEntryForString:(id)arg0 withLexicon:(struct _LXLexicon *)arg1 ;
...
+(id)tokensRangesForString:(id)arg0 outTokenIDs:(*id)arg1 wordLanguageModel:(*void)arg2 ;
+(id)transformCyrillicToLatin:(id)arg0 ;
+(id)transformLatinToCyrillic:(id)arg0 ;
+(id)transformString:(id)arg0 usingConfusions:(id)arg1 ;
+(id)transliterateStringUsingICUTransliterator:(id)arg0 _icuTransliterator:(**void)arg1 ;
+(unsigned int)normalizeLMTokenIDForWord:(id)arg0 tokenID:(unsigned int)arg1 isFromPattern:(BOOL)arg2 score:(*CGFloat)arg3 wordLanguageModel:(*void)arg4 ;
