...
@property (nonatomic) BOOL caseMatchingOnly; // ivar: _caseMatchingOnly
@property (copy, nonatomic, setter=_setFoundItems:) NSArray *foundItems; // ivar: _foundItems
@property (nonatomic) BOOL fullWordsOnly; // ivar: _fullWordsOnly
...
-(BOOL)_isMatchStringForToken:(id)arg0 queryString:(id)arg1 fromIndex:(NSInteger)arg2 matchedLength:(*NSInteger)arg3 ;
-(id)debugName;
