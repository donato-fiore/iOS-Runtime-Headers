...
-(id)_tokenizedTextResultFromTextDecodingResult:(id)arg0 options:(id)arg1 strokeEndings:(struct vector<long, std::allocator<long>> )arg2 drawing:(id)arg3 firstTokenHasPrecedingSpacePreference:(BOOL)arg4 ;
