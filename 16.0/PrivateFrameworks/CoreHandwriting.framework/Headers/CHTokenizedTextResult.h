...
+(id)_strokeIndexSetsFromTokenRow:(id)arg0 ;
+(id)compressResult:(id)arg0 atColumnIndexes:(id)arg1 ;
...
+(id)resultRestoringRawPathInResult:(id)arg0 ;
+(id)resultsBySwapping:(id)arg0 swappableColumns:(id)arg1 topLocaleIndex:(NSInteger)arg2 topLocale:(id)arg3 ;
+(id)swappableColumnIndexesInResults:(id)arg0 locales:(id)arg1 topLocaleIndex:(NSInteger)arg2 swappableIndex:(NSInteger)arg3 ;
+(id)tokenizedTextResultFromResults:(id)arg0 shouldPerformStrictFiltering:(BOOL)arg1 doesTopLocaleRequireSpecialHandling:(BOOL)arg2 hasSwap:(BOOL)arg3 ;
...
-(BOOL)hasTextReplacementsInColumnRange:(struct _NSRange )arg0 ;
-(BOOL)isEqual:(id)arg0 ;
-(BOOL)isEqualToTokenizedTextResult:(id)arg0 ;
-(BOOL)isPathOriginal:(id)arg0 ;
-(BOOL)isValid;
...
-(CGFloat)averageTokenRecognitionScoreForColumnRange:(struct _NSRange )arg0 ;
-(CGFloat)heuristicTextScoreForColumnRange:(struct _NSRange )arg0 ;
...
-(id)_rawPath;
-(id)changeableColumnCountUpdatedResultWithHistory:(id)arg0 phraseLexicon:(struct _LXLexicon *)arg1 maxPhraseLength:(NSInteger)arg2 ;
-(id)commonTopStrokeSetsWithResult:(id)arg0 ;
...
-(id)strokeIndexSetsInPath:(id)arg0 columnRange:(struct _NSRange )arg1 ;
-(id)strokeIndexesForColumnsInRange:(struct _NSRange )arg0 ;
-(id)subResultWithColumnRange:(struct _NSRange )arg0 ;
-(id)textRecognitionResultArray;
-(id)textRecognitionResultArrayGivenHistory:(id)arg0 ;
