...
typedef struct PREditingTitledButtonMetrics {
    CGFloat field0;
    CGFloat field1;
    CGFloat field2;
    CGFloat field3;
} PREditingTitledButtonMetrics;
...
typedef struct PREditingSceneViewControllerTopButtonLayout {
    CGRect leadingTopButtonFrame;
    CGRect trailingTopButtonFrame;
} PREditingSceneViewControllerTopButtonLayout;
