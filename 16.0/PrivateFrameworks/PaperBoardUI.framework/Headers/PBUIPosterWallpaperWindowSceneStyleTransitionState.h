...
#ifndef PBUIPOSTERWALLPAPERWINDOWSCENESTYLETRANSITIONSTATE_H
#define PBUIPOSTERWALLPAPERWINDOWSCENESTYLETRANSITIONSTATE_H
...
// -(void)diffFromPosterWallpaperWindowSceneStyleTransitionState:(id)arg0 updateHandler:(id)arg1 removeHandler:(unk)arg2  ;
