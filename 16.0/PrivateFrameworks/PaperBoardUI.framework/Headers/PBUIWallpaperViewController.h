...
@class UIViewController, UIView, NSHashTable, NSMutableSet, NSString, UITraitCollection;
@protocol PBUIWallpaperConfigurationManagerDelegate, PBUILegibilitySettingsProviderDelegate, PBUIWallpaperViewInternalObserver, PTSettingsKeyObserver, BSDescriptionProviding, PBUIWallpaperViewDelegate, PBUILegacyWallpaperPresenting, PBUIWallpaperLegibilityProviding, BSInvalidatable, BSDefaultObserver, PBUIIrisWallpaperPlaying, PBUIWallpaperReachabilityCoordinating, PBUIWallpaperPresentingDelegate;
...
@property (nonatomic) BOOL colorSamplingDisabled; // ivar: _colorSamplingDisabled
...
@property (readonly, nonatomic) PBUIWallpaperStyleInfo *homescreenStyleInfo; // ivar: _homescreenStyleInfo
@property (readonly, nonatomic) CGFloat homescreenWallpaperScale;
@property (retain, nonatomic) PBUIWallpaperView *homescreenWallpaperView; // ivar: _homescreenWallpaperView
@property (readonly, nonatomic) NSObject<PBUIIrisWallpaperPlaying> *irisWallpaperPlayer;
@property (readonly, nonatomic) PBUIWallpaperStyleInfo *lockscreenStyleInfo; // ivar: _lockscreenStyleInfo
@property (readonly, nonatomic) CGFloat lockscreenWallpaperScale;
@property (retain, nonatomic) PBUIWallpaperView *lockscreenWallpaperView; // ivar: _lockscreenWallpaperView
...
@property (retain, nonatomic) PBUIWallpaperView *sharedWallpaperView; // ivar: _sharedWallpaperView
...
-(id)wallpaperViewForVariant:(NSInteger)arg0 ;
