...
@protocol BSServiceConnectionListenerDelegate, PBUIWallpaperClientToServerInterface, OS_dispatch_queue, PBUIWallpaperServerDelegate;
...
@property (weak, nonatomic) NSObject<PBUIWallpaperServerDelegate> *delegate; // ivar: _delegate
