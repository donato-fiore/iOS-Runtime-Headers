...
@protocol FBSceneDelegate, BSDescriptionProviding, PBUIPosterUpdating, PBUIPosterComponent, PBUISessionReconnectPolicy, BSInvalidatable, PBUIPosterComponentDelegate, BSPathProviding;
...
@interface PBUIPosterViewController : UIViewController <FBSceneDelegate, BSDescriptionProviding, PBUIPosterUpdating, PBUIPosterComponent>
