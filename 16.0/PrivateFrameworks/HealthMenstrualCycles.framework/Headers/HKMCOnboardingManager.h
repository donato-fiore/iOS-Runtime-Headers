...
@class HKHealthStore, HKObserverSet, HKKeyValueDomain, HKFeatureAvailabilityStore, NSString, HKQuantity;
...
-(void)isAnyOnboardingVersionCompletedWithCompletion:(id)arg0 ;
-(void)removeObserver:(id)arg0 ;
-(void)resetOnboarding:(id)arg0 ;
-(void)setOnboardingCompletedWithInfo:(id)arg0 completion:(id)arg1 ;
