...
-(id)initWithExecutableIdentity:(id)arg0 website:(id)arg1 systemService:(BOOL)arg2 bundleIdentifier:(id)arg3 localizedDisplayName:(id)arg4 localizedExecutableDisplayName:(id)arg5 ;
