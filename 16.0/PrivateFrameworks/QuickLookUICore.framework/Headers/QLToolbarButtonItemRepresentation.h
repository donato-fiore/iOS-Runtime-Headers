...
@class UIBarButtonItem, NSString, UILongPressGestureRecognizer, UIViewController<QLToolbarButtonDelegate>;
...
@property (weak) UIViewController<QLToolbarButtonDelegate> *presentingViewController; // ivar: _presentingViewController
