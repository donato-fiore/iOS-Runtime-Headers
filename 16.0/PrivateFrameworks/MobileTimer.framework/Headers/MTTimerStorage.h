...
@protocol MTTimerSchedulerDelegate, MTApplicationWorkspaceObserverProtocol, MTAgentDiagnosticDelegate, MTTimerStorage, MTPersistence, NAScheduler;
...
-(void)_removeTimerDataIfNecessary:(id)arg0 ;
