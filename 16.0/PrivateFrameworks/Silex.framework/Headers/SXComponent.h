...
@property (retain, nonatomic) SXComponentAnimation *backingAnimation; // ivar: backingAnimation
@property (readonly, nonatomic) SXJSONArray *behaviors;
@property (readonly, nonatomic) SXComponentClassification *classification; // ivar: _classification
...
@property (readonly, nonatomic) BOOL requiresLinkedContent; // ivar: requiresLinkedContent
...
-(NSUInteger)contentRelevanceWithValue:(id)arg0 withType:(int)arg1 ;
-(id)animationWithValue:(id)arg0 withType:(int)arg1 ;
