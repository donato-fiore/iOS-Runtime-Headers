...
@class NSString;
@protocol SXLayoutCoordinatorDelegate, SXPresentationAttributesObserver, SXSubscriptionStatusObserving, SXDebugLayoutOptionsObserving, SXNewsletterSubscriptionStatusObserving, SXOfferUpsellScenarioObserving, SXSubscriptionActivationEligibilityObserving, SXFormatInteractor, SXDebugLayoutOptionsProviding, SXFormatInteractorDelegate, SXLayoutCoordinator, SXLayoutOptionsFactory, SXNewsletterSubscriptionStatusProviding, SXOfferUpsellScenarioProviding, SXPresentationAttributesProvider, SXPresentationEnvironment, SXSubscriptionActivationEligibilityProviding, SXSubscriptionStatusProviding;
...
@property (readonly, nonatomic) NSObject<SXOfferUpsellScenarioProviding> *offerUpsellScenarioProvider; // ivar: _offerUpsellScenarioProvider
...
@property (readonly, nonatomic) NSObject<SXSubscriptionActivationEligibilityProviding> *subscriptionActivationEligibilityProvider; // ivar: _subscriptionActivationEligibilityProvider
...
-(id)initWithLayoutCoordinator:(id)arg0 layoutOptionsFactory:(id)arg1 presentationAttributesProvider:(id)arg2 subscriptionStatusProvider:(id)arg3 debugLayoutOptionsProvider:(id)arg4 newsletterSubscriptionStatusProvider:(id)arg5 offerUpsellScenarioProvider:(id)arg6 subscriptionActivationEligibilityProvider:(id)arg7 ;
...
-(void)offerUpsellScenarioDidChangeFromScenario:(NSInteger)arg0 ;
-(void)presentationAttributesDidChangeFrom:(id)arg0 toAttributes:(id)arg1 ;
-(void)subscriptionActivationEligibilityDidChangeFromEligibility:(NSInteger)arg0 to:(NSInteger)arg1 ;
