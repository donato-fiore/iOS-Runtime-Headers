...
@class UIView, NSMutableArray, NSString, LAUIPearlGlyphView, CAShapeLayer, LAUICheckmarkLayer, CALayer, PKMicaLayer, UIColor;
...
-(void)_layoutContentLayer:(id)arg0 ringFrame:(struct CGRect )arg1 ;
