...
@class UIViewController, ICAccount, NSArray, UIBarButtonItem, NSString, UITextField, UIView, UILabel, NSLayoutConstraint, UIScrollView;
...
@property (nonatomic) BOOL didAuthenticateWithBiometrics; // ivar: _didAuthenticateWithBiometrics
...
-(void)setUpForChangePasswordWithAccount:(id)arg0 didAuthenticateWithBiometrics:(BOOL)arg1 ;
