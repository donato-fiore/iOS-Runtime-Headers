...
@class NSMutableSet, NSMutableDictionary, NSString, NSMapTable, NSMutableOrderedSet;
@protocol ICProgressIndicatorTrackerDelegate, ICAttachmentPreviewGenerating, OS_dispatch_queue, ICProgressIndicatorTracking;
...
@property (retain, nonatomic) NSObject<ICProgressIndicatorTracking> *progressTracker; // ivar: _progressTracker
