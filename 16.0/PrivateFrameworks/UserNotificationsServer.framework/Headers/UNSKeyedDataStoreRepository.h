...
-(id)allKeys;
-(id)directoryPath;
-(id)initWithDirectory:(id)arg0 fileName:(id)arg1 pathExtension:(id)arg2 librarian:(id)arg3 repositoryProtectionStrategy:(id)arg4 objectIdentifierKey:(id)arg5 maxObjectsPerKey:(NSInteger)arg6 ;
