...
-(NSInteger)_queue_globalNotificationListDisplayStyleSetting;
...
-(NSInteger)globalNotificationListDisplayStyleSetting;
...
-(void)_queue_setGlobalNotificationListDisplayStyleSetting:(NSInteger)arg0 ;
...
-(void)setGlobalNotificationListDisplayStyleSetting:(NSInteger)arg0 ;
