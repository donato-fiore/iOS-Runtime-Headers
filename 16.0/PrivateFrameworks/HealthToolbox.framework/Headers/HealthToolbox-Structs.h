...
typedef struct WDElectrocardiogramOverviewSectionInfo {
    NSInteger field0;
    NSInteger field1;
    NSInteger field2;
    NSInteger field3;
    ...
    NSInteger field6;
    NSInteger field7;
} WDElectrocardiogramOverviewSectionInfo;

typedef struct WDElectrocardiogramOverviewUserConfigurationRowInfo {
    NSInteger field0;
    NSInteger field1;
    NSInteger field2;
} WDElectrocardiogramOverviewUserConfigurationRowInfo;
