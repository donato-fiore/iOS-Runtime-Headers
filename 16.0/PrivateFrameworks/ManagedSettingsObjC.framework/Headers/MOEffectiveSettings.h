...
#import "MOEffectiveDeviceActivitySettings.h"
#import "MOEffectiveGameCenterSettings.h"
#import "MOEffectiveManagedSettingsSettings.h"
...
@property (readonly) MOEffectiveDeviceActivitySettings *deviceActivity; // ivar: _deviceActivity
@property (readonly) MOEffectiveGameCenterSettings *gameCenter; // ivar: _gameCenter
@property (readonly) MOEffectiveManagedSettingsSettings *managedSettings; // ivar: _managedSettings
...
@property (readonly) MOEffectiveUserSettings *user; // ivar: _user
...
+(id)effectiveDataForKey:(id)arg0 withDefault:(id)arg1 ;
