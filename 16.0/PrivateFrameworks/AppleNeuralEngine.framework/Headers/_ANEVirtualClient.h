...
-(void)copyModel:(id)arg0 options:(id)arg1 vmData:(struct VMData *)arg2 ;
-(void)copyModelOptionFiles:(id)arg0 options:(id)arg1 vmData:(struct VMData *)arg2 ;
-(void)dealloc;
