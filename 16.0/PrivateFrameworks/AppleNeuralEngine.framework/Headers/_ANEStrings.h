...
+(id)testing_cacheDirectoryWithSuffix:(id)arg0 ;
+(id)testing_cacheDirectoryWithSuffix:(id)arg0 buildVersion:(id)arg1 ;
+(id)testing_cloneDirectory:(id)arg0 ;
...
+(id)testing_modelDirectory:(id)arg0 ;
+(id)testing_modelNames;
+(id)testing_tempDirectory:(id)arg0 ;
