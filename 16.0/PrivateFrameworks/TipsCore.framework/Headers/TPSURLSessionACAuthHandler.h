...
-(id)_authenticationTokenForHost:(id)arg0 error:(*id)arg1 ;
-(id)customHeaderFields;
-(id)initWithAuthenticationContext:(id)arg0 ;
-(void)_authenticateWithAppleConnect:(id)arg0 ;
-(void)authenticateForURLResponse:(id)arg0 completion:(id)arg1 ;
