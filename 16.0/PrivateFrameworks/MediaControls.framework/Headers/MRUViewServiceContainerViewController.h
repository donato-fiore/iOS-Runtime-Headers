...
@property (copy, nonatomic) id *customRowTappedBlock; // ivar: _customRowTappedBlock
...
-(void)viewServiceRoutingViewControllerDidDismiss:(id)arg0 withCustomRowTapped:(id)arg1 ;
