...
#ifndef MRUSESSIONNOWPLAYINGVIEWCONTROLLER_H
#define MRUSESSIONNOWPLAYINGVIEWCONTROLLER_H

@class UIViewController, NSString, MSVTimer, UIColor, NSURL, UIView<SBUISystemApertureAccessoryView>, MPMediaControls, UIViewController<SBUISystemApertureElement>;
@protocol MRUNowPlayingControllerObserver, MRUNowPlayingTransportControlsViewDelegate, SBUISystemApertureElement, SBUISystemApertureElementProviding, BSInvalidatable;


#import "MRUNowPlayingController.h"
#import "MRUSessionNowPlayingView.h"
...
@property (retain, nonatomic) MRUSessionNowPlayingView *view;
@property (retain, nonatomic) MRUSessionNowPlayingView *viewIfLoaded;
