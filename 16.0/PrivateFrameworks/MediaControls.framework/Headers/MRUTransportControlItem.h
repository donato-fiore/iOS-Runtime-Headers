...
-(id)initWithIdentifier:(id)arg0 symbolName:(id)arg1 mainAction:(id)arg2 ;
// -(id)initWithIdentifier:(id)arg0 symbolName:(id)arg1 mainAction:(id)arg2 holdBeganAction:(unk)arg3 holdEndAction:(id)arg4  ;
