...
@protocol MRUVolumeControllerDelegate, MPVolumeDisplaying, MRUStepperDelegate, MRUVisualStylingProviderObserver;
...
@interface MRUNowPlayingVolumeControlsView : UIView <MRUVolumeControllerDelegate, MPVolumeDisplaying, MRUStepperDelegate, MRUVisualStylingProviderObserver>
