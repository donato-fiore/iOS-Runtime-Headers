...
-(id)_resourcesWithType:(NSUInteger)arg0 subType:(NSUInteger)arg1 languageCode:(id)arg2 waitForInstalledAssets:(BOOL)arg3 ;
-(id)allLanguagesForVoices:(BOOL)arg0 waitForInstalledAssets:(BOOL)arg1 ;
-(id)allVoices:(BOOL)arg0 ;
-(id)allVoices:(BOOL)arg0 waitForInstalledAssets:(BOOL)arg1 ;
...
-(id)resources;
-(id)resources:(BOOL)arg0 ;
-(id)resourcesWithLanguage:(id)arg0 type:(NSUInteger)arg1 ;
-(id)resourcesWithType:(NSUInteger)arg0 subType:(NSUInteger)arg1 ;
-(id)resourcesWithType:(NSUInteger)arg0 subType:(NSUInteger)arg1 waitForInstalledAssets:(BOOL)arg2 ;
