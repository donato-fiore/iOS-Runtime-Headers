...
@property (nonatomic) CGFloat additionalJindoPadding; // ivar: _additionalJindoPadding
@property (nonatomic) CGFloat additionalJindoPaddingAuthed; // ivar: _additionalJindoPaddingAuthed
