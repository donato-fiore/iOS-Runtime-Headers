...
@class NSMutableArray, NSHashTable, BSAbsoluteMachTimer, BCBatteryDeviceController, NSArray, UITapGestureRecognizer, UILongPressGestureRecognizer, UINotificationFeedbackGenerator, UIView<BSInvalidatable><PBUIWallpaperPositioning>, SBLockScreenDefaults, NSMutableSet, SBFLockScreenDateSubtitleView, NSString, NSDate, SBUIPhoneUnlockWithWatchController, NSSet, SBFLockScreenActionContext, SBFLockScreenDateViewController, BSUIVibrancyConfiguration, UIStatusBar, CHUISWidgetHostViewController, _UILegibilitySettings, SBSearchGesture, SBSpotlightTransientOverlayInteractiveGestureTransaction, UIView, SBWallpaperAggdLogger, UIGestureRecognizer;
...
@property (retain, nonatomic) CHUISWidgetHostViewController *inlineComplicationHostViewController; // ivar: _inlineComplicationHostViewController
...
-(id)_hostViewControllerForWidgetDescriptor:(id)arg0 ;
