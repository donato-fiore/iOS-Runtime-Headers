...
@class UIView, UIVisualEffectView, SBFStatusBarLegibilityView, SBFView, SBLockScreenDefaults, SBUIBackgroundView, NSString, SBFLockScreenDateView, UIGestureRecognizer, _UILegibilitySettings, NSArray, UITapGestureRecognizer, UIColor, SBFPagedScrollView, SBSearchGesture, UIView<CSWallpaperView>;
...
#import "SBFPropertyAnimatingPassThroughView.h"
...
@interface CSCoverSheetView : UIView <CSScrollViewDelegate, PTSettingsKeyObserver, CSCoverSheetViewTransitionSource, CSScrollableView>

 {
    ...
    SBFView *_fakeStatusBarWrapperView;
    SBFPropertyAnimatingPassThroughView *_proudLockContainerWrapperView;
...
-(void)_orderSubviews;
-(void)_prepareBlursForView:(id)arg0 ;
