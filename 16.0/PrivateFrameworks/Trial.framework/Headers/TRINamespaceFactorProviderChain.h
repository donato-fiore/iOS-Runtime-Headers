...
-(void)computeTreatmentAssetIndexes:(*id)arg0 withAssociatedExperimentIds:(*id)arg1 andFactorPackAssetIds:(*id)arg2 withAssociatedRolloutDeployments:(*id)arg3 withExperimentFactorNames:(*id)arg4 andRolloutFactorNames:(*id)arg5 forFactors:(id)arg6 alwaysIncludingRolloutLayer:(BOOL)arg7 usingFilter:(id)arg8 ;
-(void)dispose;
