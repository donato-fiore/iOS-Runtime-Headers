...
-(id)_createSessionForPlayer_Legacy:(id)arg0 ;
...
-(id)_trackerWithBaseEventDataForSession_Legacy:(id)arg0 ;
...
-(void)_playerCurrentMediaItemWillSeek_Legacy:(id)arg0 ;
-(void)_reportForSession:(id)arg0 state:(id)arg1 reason:(id)arg2 ;
-(void)_reportForSession_Legacy:(id)arg0 state:(id)arg1 reason:(id)arg2 ;
-(void)_reportSeekStopAtTimeInMS:(NSUInteger)arg0 playbackDate:(id)arg1 session:(id)arg2 tracker:(id)arg3 player:(id)arg4 ;
-(void)_reportSeekStopAtTimeInMS_Legacy:(NSUInteger)arg0 playbackDate:(id)arg1 session:(id)arg2 tracker:(id)arg3 player:(id)arg4 ;
