...
@class AVPlayerViewController, NSString, UIAlertController, NSDate, UIViewController<VUIPlaybackContainerViewController>, NSNumber, UIImage, NSDictionary, NSLayoutConstraint, UIButton, TVPStateMachine;
@protocol AVPlayerViewControllerDelegatePrivate, VideosExtrasContextDelegate, VUINowPlayingFeatureMonitorDelegate, VUIPostPlayViewDelegate, VUIPlaybackContainerViewControllerDelegate, OS_dispatch_queue, TVPMediaItem, VUIControllerPresenter;
...
-(void)playbackContainerVieControllerDidAutoPlay:(id)arg0 ;
