...
+(id)indexPathsOfRowsForSectionTitle:(id)arg0 needsCard:(BOOL)arg1 forTestingViewController:(id)arg2 ;
...
-(void)performScrollOnResultsView:(id)arg0 testName:(id)arg1 completion:(id)arg2 ;
...
-(void)resultViewController:(id)arg0 finishedGettingAllResults:(id)arg1 ;
