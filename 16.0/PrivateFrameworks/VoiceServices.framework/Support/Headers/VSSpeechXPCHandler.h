...
@protocol VSSpeechXPCServiceProtocol, VSSpeechServiceDelegate, OS_dispatch_queue, OS_os_transaction;
...
@property (retain, nonatomic) NSObject<OS_os_transaction> *synthesizerTransaction; // ivar: _synthesizerTransaction
...
-(void)updateWithConnectionIdentifier:(id)arg0 keepActive:(BOOL)arg1 ;
