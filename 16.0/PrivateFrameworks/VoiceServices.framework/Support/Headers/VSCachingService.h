...
-(void)_enqueueCacheWithHash:(id)arg0 audioObject:(id)arg1 timingInfo:(id)arg2 voiceKey:(id)arg3 voiceResourceKey:(id)arg4 completion:(id)arg5 ;
-(void)enqueueCacheWithHash:(id)arg0 audio:(id)arg1 timingInfo:(id)arg2 voiceKey:(id)arg3 voiceResourceKey:(id)arg4 completion:(id)arg5 ;
-(void)enqueueCacheWithHash:(id)arg0 streamAudio:(id)arg1 timingInfo:(id)arg2 voiceKey:(id)arg3 voiceResourceKey:(id)arg4 completion:(id)arg5 ;
-(void)enqueueShortTermCacheWithHash:(id)arg0 audio:(id)arg1 timingInfo:(id)arg2 voiceKey:(id)arg3 voiceResourceKey:(id)arg4 completion:(id)arg5 ;
