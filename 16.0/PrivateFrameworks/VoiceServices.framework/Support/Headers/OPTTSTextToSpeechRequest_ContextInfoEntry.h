...
#ifndef OPTTSTEXTTOSPEECHREQUEST_CONTEXTINFOENTRY_H
#define OPTTSTEXTTOSPEECHREQUEST_CONTEXTINFOENTRY_H
...
-(struct Offset<siri::speech::schema_fb::TextToSpeechRequest_::ContextInfoEntry> )addObjectToBuffer:(*void)arg0 ;
