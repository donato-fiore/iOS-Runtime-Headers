...
+(id)resolutionTokenKeyForChangedKeyInREMReminderChangeItemOfREMCDReminder:(id)arg0 ;
+(id)resolutionTokenKeyForChangedKeyInREMReminderChangeItemOfREMCDSavedReminder:(id)arg0 ;
+(void)initialize;
-(BOOL)isSubtask;
-(BOOL)isUnsupported;
