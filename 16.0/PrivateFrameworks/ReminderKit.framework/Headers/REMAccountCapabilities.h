...
@property (readonly, nonatomic) BOOL supportsDeletionByTTL; // ivar: _supportsDeletionByTTL
...
@property (readonly, nonatomic) BOOL supportsPinnedLists; // ivar: _supportsPinnedLists
...
@property (readonly, nonatomic) BOOL supportsTemplates; // ivar: _supportsTemplates
@property (readonly, nonatomic) BOOL supportsTextStyling; // ivar: _supportsTextStyling
