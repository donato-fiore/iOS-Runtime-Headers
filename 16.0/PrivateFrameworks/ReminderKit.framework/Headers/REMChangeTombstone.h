...
@property (readonly, nonatomic) NSUUID *hashtagLabelUUIDForChangeTracking; // ivar: _hashtagLabelUUIDForChangeTracking
...
@property (readonly, nonatomic) NSUUID *remObjectIdentifier; // ivar: _remObjectIdentifier
...
@property (readonly, nonatomic) NSUUID *syncActivityUUIDForChangeTracking; // ivar: _syncActivityUUIDForChangeTracking
