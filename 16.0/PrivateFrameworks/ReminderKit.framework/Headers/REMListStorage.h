...
@class NSOrderedSet, NSString, NSArray, NSSet, NSDictionary, NSDate, NSUUID, NSData;
...
@property (retain, nonatomic) NSUUID *mostRecentTargetTemplateIdentifier; // ivar: _mostRecentTargetTemplateIdentifier
...
@property (copy, nonatomic) NSDate *pinnedDate; // ivar: _pinnedDate
...
@property (retain, nonatomic) REMObjectID *templateID; // ivar: _templateID
