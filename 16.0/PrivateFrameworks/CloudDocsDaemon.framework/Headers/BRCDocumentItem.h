...
@class NSDictionary, NSNumber, NSSet, NSData, NSString, NSError;
...
@property (readonly, nonatomic) NSString *syncPausedByBundleID; // ivar: _syncPausedByBundleID
@property (readonly, nonatomic) NSNumber *syncPausedExpireTS; // ivar: _syncPausedExpireTS
...
+(id)nextPausedDocumentBatchEnumeratorWithBundleID:(id)arg0 fromRowID:(NSUInteger)arg1 batchSize:(unsigned int)arg2 session:(id)arg3 db:(id)arg4 ;
...
+(void)autoResumeSyncPausedDocumentsOnTimeoutWithSession:(id)arg0 ;
...
-(BOOL)pauseFromSyncWithTimeout:(CGFloat)arg0 forBundleID:(id)arg1 error:(*id)arg2 ;
-(BOOL)resumeSyncForBundleID:(id)arg0 dropLocalChanges:(BOOL)arg1 error:(*id)arg2 ;
