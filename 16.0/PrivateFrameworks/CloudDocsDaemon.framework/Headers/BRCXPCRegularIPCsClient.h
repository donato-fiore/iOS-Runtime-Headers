...
@class NSString;
@protocol BRProtocolLegacy, BRProtocolShared, BRCForegroundClient;
...
-(void)_t_dropReaderJobAtURL:(id)arg0 reply:(id)arg1 ;
...
-(void)_t_getReaderStateAtURL:(id)arg0 reply:(id)arg1 ;
