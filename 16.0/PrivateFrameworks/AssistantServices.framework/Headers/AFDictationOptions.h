...
@property (nonatomic) BOOL emojiRecognition; // ivar: _emojiRecognition
...
@property (nonatomic) BOOL shouldClassifyIntent; // ivar: _shouldClassifyIntent
@property (nonatomic) BOOL shouldHandleCapitalization; // ivar: _shouldHandleCapitalization
@property (nonatomic) BOOL shouldRecognizeCommands; // ivar: _shouldRecognizeCommands
