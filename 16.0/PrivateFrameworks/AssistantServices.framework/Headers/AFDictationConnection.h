...
-(void)_tellSpeechDelegateDidRecognizeSpeechPhrases:(id)arg0 utterances:(id)arg1 nluResult:(id)arg2 languageModel:(id)arg3 correctionIdentifier:(id)arg4 audioAnalytics:(id)arg5 ;
