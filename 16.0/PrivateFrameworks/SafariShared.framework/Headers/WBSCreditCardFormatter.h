...
+(id)_formattedStringForNormalizedNumber:(id)arg0 showCreditCardNumber:(BOOL)arg1 showLastFourDigits:(BOOL)arg2 isVirtualCard:(BOOL)arg3 ;
+(id)formattedStringForNormalizedNumber:(id)arg0 showCreditCardNumber:(BOOL)arg1 ;
