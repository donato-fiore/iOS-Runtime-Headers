...
@class UIViewController, SRUIFDelayedActionCommandCache, SiriUIConfiguration, NSString, SiriUIKeyboardView, NSDictionary, FBSDisplayConfiguration, SASRequestOptions, UIView, NSNumber, SiriUIAudioRoutePickerController, UIStatusBar, UIView<AFUISiriRemoteViewHosting>;
