...
@class SRUIFStateMachine, AFSpeechSynthesisRecord, NSMutableSet, AFConnection, AFSettingsConnection, AFSiriClientStateManager, AFModesConfiguration, NSString, NSArray, AFAnalyticsTurnBasedInstrumentationContext, SRUIFSiriSessionInfo, SRUIFWatchAuthenticationManager;
...
-(void)_performTransitionForEvent:(NSInteger)arg0 eventTimeStamp:(CGFloat)arg1 ;
