...
@class NSMutableSet, TPSEventsProviderManager, NSMutableDictionary, NSDictionary, NSString, TPSTipStatusController;
...
@property (retain, nonatomic) NSObject<OS_dispatch_queue> *contextualInfoQueue; // ivar: _contextualInfoQueue
...
-(BOOL)_updateTriggerConditionForObserverIdentifiers:(id)arg0 ;
...
-(void)removeContextualInfoForIdentifiers:(id)arg0 ;
...
-(void)updateIdentifier:(id)arg0 withContextualInfo:(id)arg1 ;
