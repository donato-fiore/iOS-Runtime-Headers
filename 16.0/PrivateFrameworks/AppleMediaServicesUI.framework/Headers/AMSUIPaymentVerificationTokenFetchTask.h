...
+(id)performIDCardTask:(id)arg0 ;
+(id)performRemoteDisabledFeatureWithBag:(id)arg0 featureKey:(id)arg1 featureBlock:(id)arg2 ;
...
-(id)performIDCardTaskWithFeatureFlag:(BOOL)arg0 ;
-(id)performTask;
