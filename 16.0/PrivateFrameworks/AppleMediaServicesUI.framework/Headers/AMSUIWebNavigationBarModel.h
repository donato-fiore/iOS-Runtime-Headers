...
@property (retain, nonatomic) AMSUIWebButtonModel *accessoryButton; // ivar: _accessoryButton
...
@property (retain, nonatomic) AMSUIWebButtonModel *otherButton; // ivar: _otherButton
@property (retain, nonatomic) NSArray *otherButtons; // ivar: _otherButtons
...
+(id)_buttonWithJSObject:(id)arg0 context:(id)arg1 ;
+(id)_conditionalButtonsWithJSObject:(id)arg0 context:(id)arg1 ;
