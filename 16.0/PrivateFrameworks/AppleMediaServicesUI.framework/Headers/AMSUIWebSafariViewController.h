...
@class NSString, NSURL, UIViewController, UIToolbar, UIBarButtonItem;
...
-(void)_handleDismiss;
-(void)_pop;
-(void)_presentActivityViewControllerWithActivityItems:(id)arg0 ;
...
-(void)receiveCallbackURL:(id)arg0 ;
