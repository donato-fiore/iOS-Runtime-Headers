...
@class NSString, AMSURLSession, ACAccount, NSDictionary, AMSSnapshotBag, AMSProcessInfo, AMSMescalAccountPrimeSession, AMSMetrics;
...
@property (weak, nonatomic) NSString *URL; // ivar: _URL
...
@property (nonatomic) BOOL bootstrapComplete; // ivar: _bootstrapComplete
