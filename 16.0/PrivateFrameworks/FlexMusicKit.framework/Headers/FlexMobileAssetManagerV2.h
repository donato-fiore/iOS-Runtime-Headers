...
@class NSString, NSMutableOrderedSet, NSMutableSet, NSMapTable, NSCache;
...
-(id)_mobileAssetsForAssetTypes:(id)arg0 ;
...
-(void)_rebuildMobileAssetCaches:(id)arg0 ;
