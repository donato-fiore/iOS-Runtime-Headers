...
+(id)contactShadowWithOffset:(CGFloat)arg0 height:(CGFloat)arg1 radius:(CGFloat)arg2 opacity:(CGFloat)arg3 color:(struct CGColor *)arg4 enabled:(BOOL)arg5 ;
...
-(id)initWithOffset:(CGFloat)arg0 height:(CGFloat)arg1 radius:(CGFloat)arg2 opacity:(CGFloat)arg3 color:(struct CGColor *)arg4 enabled:(BOOL)arg5 ;
