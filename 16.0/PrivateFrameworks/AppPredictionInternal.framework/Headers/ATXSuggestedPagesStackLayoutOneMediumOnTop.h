...
#ifndef ATXSUGGESTEDPAGESSTACKLAYOUTONEMEDIUMONTOP_H
#define ATXSUGGESTEDPAGESSTACKLAYOUTONEMEDIUMONTOP_H
...
@interface ATXSuggestedPagesStackLayoutOneMediumOnTop : NSObject <ATXSuggestedPagesStackLayout>
