...
#ifndef ATXSUGGESTEDPAGESSTACKLAYOUTTWOLARGETWOSMALLONEMEDIUM_H
#define ATXSUGGESTEDPAGESSTACKLAYOUTTWOLARGETWOSMALLONEMEDIUM_H
...
@interface ATXSuggestedPagesStackLayoutTwoLargeTwoSmallOneMedium : NSObject <ATXSuggestedPagesStackLayout>
