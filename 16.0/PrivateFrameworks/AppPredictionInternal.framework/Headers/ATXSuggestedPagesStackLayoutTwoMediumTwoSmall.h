...
#ifndef ATXSUGGESTEDPAGESSTACKLAYOUTTWOMEDIUMTWOSMALL_H
#define ATXSUGGESTEDPAGESSTACKLAYOUTTWOMEDIUMTWOSMALL_H
...
@interface ATXSuggestedPagesStackLayoutTwoMediumTwoSmall : NSObject <ATXSuggestedPagesStackLayout>
