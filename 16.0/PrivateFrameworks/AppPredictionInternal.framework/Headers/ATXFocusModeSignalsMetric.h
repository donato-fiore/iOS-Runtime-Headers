...
@property (retain, nonatomic) NSNumber *globalIgnoranceRateForEntity; // ivar: _globalIgnoranceRateForEntity
...
@property (retain, nonatomic) NSNumber *localIgnoranceRateForEntity; // ivar: _localIgnoranceRateForEntity
