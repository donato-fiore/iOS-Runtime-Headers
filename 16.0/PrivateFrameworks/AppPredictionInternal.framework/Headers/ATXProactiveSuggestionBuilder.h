...
+(NSUInteger)_actionPredictionReasonsForActionResult:(id)arg0 reasons:(id)arg1 ;
+(NSUInteger)predictionReasonsForAnchorModelPrediction:(id)arg0 ;
...
+(id)_proactiveSuggestionForSpotlightPOIFromHeroAppPrediction:(id)arg0 clientModelSpec:(id)arg1 ;
...
+(id)_uiSpecForAppWithBundleId:(id)arg0 scoreSpec:(id)arg1 predictionReason:(id)arg2 allowedOnHomescreen:(BOOL)arg3 ;
+(id)_uiSpecForHeroAppPrediction:(id)arg0 scoreSpec:(id)arg1 predictionReason:(id)arg2 ;
+(id)_uiSpecForMMAppWithBundleId:(id)arg0 scoreSpec:(id)arg1 predictionReasonString:(id)arg2 anchor:(NSInteger)arg3 predictionReasons:(NSUInteger)arg4 ;
+(id)_uiSpecForScoredAction:(id)arg0 scoreSpec:(id)arg1 clientModelSpec:(id)arg2 predictionReason:(id)arg3 ;
+(id)_uiSpecForScoredAction:(id)arg0 scoreSpec:(id)arg1 clientModelSpec:(id)arg2 predictionReason:(id)arg3 allowedOnLockscreen:(BOOL)arg4 allowedOnHomescreen:(BOOL)arg5 ;
+(id)_uiSpecForScoredAction:(id)arg0 scoreSpec:(id)arg1 clientModelSpec:(id)arg2 predictionReason:(id)arg3 allowedOnLockscreen:(BOOL)arg4 allowedOnHomescreen:(BOOL)arg5 predictionReasons:(NSUInteger)arg6 ;
+(id)_uiSpecForScoredAction:(id)arg0 scoreSpec:(id)arg1 clientModelSpec:(id)arg2 predictionReason:(id)arg3 allowedOnLockscreen:(BOOL)arg4 predictionReasons:(NSUInteger)arg5 ;
...
+(id)_uiSpecForScoredAction:(id)arg0 scoreSpec:(id)arg1 clientModelSpec:(id)arg2 predictionReason:(id)arg3 shouldClearOnEngagement:(BOOL)arg4 allowedOnLockscreen:(BOOL)arg5 allowedOnHomescreen:(BOOL)arg6 predictionReasons:(NSUInteger)arg7 ;
+(id)_uiSpecForSpotlightPOIPrediction:(id)arg0 predictionReasons:(NSUInteger)arg1 ;
+(id)cachedTitleAndSubtitleForAction:(id)arg0 ;
+(id)executableIdForAction:(id)arg0 ;
...
+(id)proactiveSuggestionForAppWithAnchorModelPrediction:(id)arg0 clientModelSpec:(id)arg1 mediumThreshold:(CGFloat)arg2 highThreshold:(CGFloat)arg3 allowedOnHomescreen:(BOOL)arg4 ;
+(id)proactiveSuggestionForAppWithBundleId:(id)arg0 score:(CGFloat)arg1 clientModelSpec:(id)arg2 mediumThreshold:(CGFloat)arg3 highThreshold:(CGFloat)arg4 predictionReason:(id)arg5 allowedOnHomescreen:(BOOL)arg6 ;
+(id)proactiveSuggestionForLinkActionPrediction:(id)arg0 score:(CGFloat)arg1 clientModelSpec:(id)arg2 mediumThreshold:(CGFloat)arg3 highThreshold:(CGFloat)arg4 predictionReason:(id)arg5 allowedOnHomescreen:(BOOL)arg6 ;
+(id)proactiveSuggestionForLockscreenAction:(id)arg0 clientModelSpec:(id)arg1 ;
+(id)proactiveSuggestionsForAnchorModelFromScoredActionWithReason:(id)arg0 clientModelSpec:(id)arg1 mediumThreshold:(CGFloat)arg2 highThreshold:(CGFloat)arg3 allowedOnHomescreen:(BOOL)arg4 predictionReasons:(NSUInteger)arg5 ;
...
+(id)proactiveSuggestionsForSpotlightPOIWithHeroAppPredictions:(id)arg0 clientModelSpec:(id)arg1 ;
...
+(id)proactiveSuggestionsFromScoredAction:(id)arg0 clientModelSpec:(id)arg1 mediumThreshold:(CGFloat)arg2 highThreshold:(CGFloat)arg3 predictionReason:(id)arg4 allowedOnHomescreen:(BOOL)arg5 predictionReasons:(NSUInteger)arg6 ;
