...
@protocol ATXPosterDescriptorCacheObserver, ATXPosterConfigurationCacheObserver, ATXDNDModeConfigurationClientObserver, ATXFaceGalleryLayoutGeneratorComplicationProviding, ATXFaceGalleryLayoutGeneratorComplicationDescriptorProviding, ATXFaceSuggestionParameters, OS_dispatch_queue, ATXFaceSuggestionGeneratorDelegate;
...
@interface ATXFaceSuggestionGenerator : NSObject <ATXPosterDescriptorCacheObserver, ATXPosterConfigurationCacheObserver, ATXDNDModeConfigurationClientObserver>
...
-(void)configuredModesDidChange:(id)arg0 ;
-(void)dealloc;
