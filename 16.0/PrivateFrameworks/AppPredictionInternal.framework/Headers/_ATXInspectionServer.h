...
-(void)allHistogramsBySize:(id)arg0 ;
...
-(void)fetchPosterDescriptorsWithReply:(id)arg0 ;
...
-(void)generateSerializedAppGroupedNotificationDigestFromSource:(id)arg0 digestTimeString:(id)arg1 startDate:(id)arg2 endDate:(id)arg3 inferMessages:(BOOL)arg4 reply:(id)arg5 ;
-(void)generateSerializedMissedNotificationBundleFromFileData:(id)arg0 modeString:(id)arg1 reply:(id)arg2 ;
-(void)generateSerializedMissedNotificationBundleFromSource:(id)arg0 modeString:(id)arg1 startDate:(id)arg2 endDate:(id)arg3 inferMessages:(BOOL)arg4 reply:(id)arg5 ;
-(void)generateSerializedNotificationDigestFromFileData:(id)arg0 digestTimeString:(id)arg1 reply:(id)arg2 ;
-(void)generateSerializedNotificationDigestFromSource:(id)arg0 digestTimeString:(id)arg1 startDate:(id)arg2 endDate:(id)arg3 inferMessages:(BOOL)arg4 reply:(id)arg5 ;
...
-(void)histogramsInMemory:(id)arg0 ;
-(void)histogramsInMemoryBySize:(id)arg0 ;
