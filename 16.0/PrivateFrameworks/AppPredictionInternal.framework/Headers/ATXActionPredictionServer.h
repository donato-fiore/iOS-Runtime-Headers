...
@protocol NSXPCListenerDelegate, ATXActionPredictionInterface, ATXProactiveSuggestionRealTimeProviderDelegateProtocol;
...
-(id)behavioralModelSuggestionsForRequest:(id)arg0 ;
-(id)filteredCachedIntentSuggestionsForClientModelId:(id)arg0 request:(id)arg1 ;
-(id)init;
...
-(void)registerForRealTimeRequestsWithBlendingLayerServer:(id)arg0 ;
...
-(void)suggestionsForIntentSuggestionRequest:(id)arg0 clientModelId:(id)arg1 reply:(id)arg2 ;
