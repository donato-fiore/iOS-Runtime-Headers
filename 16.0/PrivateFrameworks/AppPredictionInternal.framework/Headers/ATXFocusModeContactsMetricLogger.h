...
@class NSMutableDictionary, ATXDNDModeConfigurationClient, ATXModeEntityTrialClientWrapper, ATXTrainDenyListWithDenyListModels, NSSet;
...
-(BOOL)isVIPContactGivenVIPs:(id)arg0 contactId:(id)arg1 ;
