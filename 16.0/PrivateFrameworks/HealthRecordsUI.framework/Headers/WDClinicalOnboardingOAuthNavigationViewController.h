...
@protocol HRClinicalSharingOnboardingDelegate, ClinicalSharingOnboardingDelegate;
...
@property (weak, nonatomic) NSObject<ClinicalSharingOnboardingDelegate> *onboardingDelegate; // ivar: _onboardingDelegate
