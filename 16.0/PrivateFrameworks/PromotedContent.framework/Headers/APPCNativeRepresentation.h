...
-(id)initWithIdentifier:(id)arg0 adType:(NSInteger)arg1 desiredPosition:(NSInteger)arg2 privacyMarkerPosition:(NSInteger)arg3 articleID:(id)arg4 articleTitle:(id)arg5 adSponsor:(id)arg6 campaignData:(id)arg7 adSize:(struct CGSize )arg8 adPolicyData:(id)arg9 ;
