...
@protocol UINavigationControllerDelegate, ICQPageDelegate, RemoteUIControllerDelegate, ICQServerHookDelegate, ICQLiftUIPresenterDelegate, ICQUpgradeFlowManagerDelegate;
...
@interface ICQUpgradeFlowManager : NSObject <UINavigationControllerDelegate, ICQPageDelegate, RemoteUIControllerDelegate, ICQServerHookDelegate, ICQLiftUIPresenterDelegate>
