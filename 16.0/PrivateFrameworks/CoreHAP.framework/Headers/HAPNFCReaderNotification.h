...
+(void)start;
-(id)_initializeNFCStream:(id)arg0 withSource:(NSUInteger)arg1 workQueue:(id)arg2 backgroundReadingSuported:(BOOL)arg3 ;
-(id)init;
-(id)setupNotificationDictionaryWithNFCData:(id)arg0 ;
-(void)_initializeHomeKitNFCStreamWithQueue:(id)arg0 backgroundReadingSupported:(BOOL)arg1 ;
-(void)_initializeProxCardStreamWithQueue:(id)arg0 backgroundReadingSuported:(BOOL)arg1 ;
