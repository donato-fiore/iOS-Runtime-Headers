...
@class UIViewController, VKCImageAnalysisInteraction, NSString, UIImage, UIImageView, UIScrollView;
...
@property (retain, nonatomic) VKCImageAnalysisInteraction *analysisInteraction; // ivar: _analysisInteraction
