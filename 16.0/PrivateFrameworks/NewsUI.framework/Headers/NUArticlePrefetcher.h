...
@class NSMutableDictionary, NSString, NSMutableSet, NSCountedSet, FCKeyedOperationQueue, NSTimer;
...
@property (retain, nonatomic) NSMutableSet *failedArticleIDs; // ivar: _failedArticleIDs
