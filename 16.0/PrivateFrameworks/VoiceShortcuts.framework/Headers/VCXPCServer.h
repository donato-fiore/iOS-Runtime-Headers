...
-(id)initWithDatabaseProvider:(id)arg0 triggerRegistrar:(id)arg1 syncCoordinator:(id)arg2 syncDataEndpoint:(id)arg3 runCoordinator:(id)arg4 eventHandler:(id)arg5 ;
-(id)initWithUnsecuredAnonymousListenerAndDatabaseProvider:(id)arg0 ;
-(id)initWithXPCListener:(id)arg0 databaseProvider:(id)arg1 triggerRegistrar:(id)arg2 syncCoordinator:(id)arg3 syncDataEndpoint:(id)arg4 runCoordinator:(id)arg5 eventHandler:(id)arg6 ;
