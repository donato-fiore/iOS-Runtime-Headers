...
@class WFDatabase, NSString, NSMutableDictionary, CKRecordZoneID, CKSyncEngine;
...
@property (readonly, nonatomic) NSMutableDictionary *filesReferencedUntilSaved; // ivar: _filesReferencedUntilSaved
...
-(id)autoShortcutsPreferencesRecordForRecordID:(id)arg0 ;
-(id)autoShortcutsPreferencesWithCloudKitAutoShortcutsPreferences:(id)arg0 ;
...
-(void)handleFetchedDeletionOfAutoShortcutsPreferencesWithRecordID:(id)arg0 ;
...
-(void)handleFetchedOrSavedAutoShortcutsPreferencesFromRecord:(id)arg0 ;
...
-(void)handleSendAutoShortcutsPreferencesConflictWithClientRecord:(id)arg0 serverRecord:(id)arg1 ancestorRecord:(id)arg2 ;
...
-(void)updateLocalAutoShortcutsPreferencesIfRemoteModificationDateNewerOnRecord:(id)arg0 ;
