...
@property (readonly, nonatomic) WFTriggerNotificationScheduler *notificationScheduler; // ivar: _notificationScheduler
...
-(id)initWithDatabaseProvider:(id)arg0 runCoordinator:(id)arg1 notificationManager:(id)arg2 notificationScheduler:(id)arg3 triggerBootManager:(id)arg4 ;
...
-(void)notificationManager:(id)arg0 didRequestDisablementOfTriggersWithIdentifiers:(id)arg1 ;
