...
-(void)queue_getAppShortcutSearchableItemsWithCompletionHandler:(id)arg0 ;
-(void)queue_getFocusModeSearchableItemsWithCompletionHandler:(id)arg0 ;
-(void)queue_getStaticSearchableItemsWithCompletionHandler:(id)arg0 ;
