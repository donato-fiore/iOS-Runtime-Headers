...
@class UIViewController, UIView, UIScrollView, UIStackView, OBHeaderView, UILabel, OBTrayButton, UIVisualEffectView, UIImageView, CEKSubjectIndicatorView, NSTimer, HRTFEnrollmentSession, NSMutableData, UIActivityIndicatorView, BluetoothManager, CIContext, CIDetector, NSString;
...
-(BOOL)isEarTooClose;
-(BOOL)isEarTooFar;
-(BOOL)isLeftEarInRange:(id)arg0 currentYaw:(CGFloat)arg1 ;
-(BOOL)isPresentingWrongEar;
-(BOOL)isRightEarInRange:(id)arg0 currentYaw:(CGFloat)arg1 ;
