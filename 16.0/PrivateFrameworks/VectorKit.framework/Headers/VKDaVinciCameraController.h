...
-(CGFloat)earthRadiusAt:(struct Unit<geo::RadianUnitDescription, double> )arg0 ;
-(CGFloat)geocAngleBetween:(struct Coordinate2D<geo::Radians, double> )arg0 andCoordinate:(struct Coordinate2D<geo::Radians, double> )arg1 ;
-(CGFloat)heading;
-(CGFloat)maxPitch;
...
-(struct Coordinate2D<geo::Radians, double> )_centerCoordinateForMapRegion:(id)arg0 ;
-(struct Coordinate2D<geo::Radians, double> )centerCoordinateRad;
-(struct Unit<geo::RadianUnitDescription, double> )greatCircleMidPointLatitude:(struct Unit<geo::RadianUnitDescription, double> )arg0 fromLongitude:(struct Unit<geo::RadianUnitDescription, double> )arg1 toLongitude:(struct Unit<geo::RadianUnitDescription, double> )arg2 ;
-(struct Unit<geo::RadianUnitDescription, double> )widestLatitudeForMapRegion:(id)arg0 ;
-(struct vector<geo::Coordinate2D<geo::Radians, double>, std::allocator<geo::Coordinate2D<geo::Radians, double>>> )_getVisibleArea;
...
-(void)enter3DMode;
-(void)exit3DMode;
// -(void)moveTo:(struct Coordinate2D<geo::Radians, double> )arg0 height:(CGFloat)arg1 useHeight:(BOOL)arg2 zoom:(CGFloat)arg3 rotation:(CGFloat)arg4 tilt:(CGFloat)arg5 duration:(CGFloat)arg6 timingCurve:(id)arg7 completion:(unk)arg8  ;
// -(void)moveTo:(struct Coordinate2D<geo::Radians, double> )arg0 zoom:(CGFloat)arg1 rotation:(CGFloat)arg2 tilt:(CGFloat)arg3 duration:(CGFloat)arg4 timingCurve:(id)arg5 completion:(unk)arg6  ;
// -(void)moveToZoomOutZoomInTransition:(struct Coordinate2D<geo::Radians, double> )arg0 height:(CGFloat)arg1 useHeight:(BOOL)arg2 zoom:(CGFloat)arg3 rotation:(CGFloat)arg4 tilt:(CGFloat)arg5 duration:(CGFloat)arg6 timingCurve:(id)arg7 completion:(unk)arg8  ;
