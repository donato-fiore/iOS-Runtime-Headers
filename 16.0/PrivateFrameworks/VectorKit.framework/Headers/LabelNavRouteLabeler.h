...
@interface LabelNavRouteLabeler : NSObject {
    ...
    range_map<geo::Unit<geo::RadianUnitDescription, float>, md::OrientationAction, std::less<geo::Unit<geo::RadianUnitDescription, float>>, std::allocator<std::pair<const gm::Range<geo::Unit<geo::RadianUnitDescription, float>>, md::OrientationAction>>> _leftTurnOrientations;
    range_map<geo::Unit<geo::RadianUnitDescription, float>, md::OrientationAction, std::less<geo::Unit<geo::RadianUnitDescription, float>>, std::allocator<std::pair<const gm::Range<geo::Unit<geo::RadianUnitDescription, float>>, md::OrientationAction>>> _rightTurnOrientations;
}
...
-(BOOL)needsDebugDraw;
-(id)init;
-(struct RoadSignOrientationResolver )createRoadSignOrientationResolver:(id)arg0 navContext:(struct NavContext *)arg1 ;
...
-(void)setStyleManager:(struct shared_ptr<gss::StylesheetManager<gss::PropertyID>> )arg0 ;
