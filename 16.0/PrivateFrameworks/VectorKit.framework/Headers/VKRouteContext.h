...
@class NSHashTable, NSString, NSArray, GEOComposedWaypoint;
...
@property (readonly, nonatomic) GEOComposedWaypoint *currentWaypoint; // ivar: _currentWaypoint
@property (readonly, nonatomic) unsigned char currentWaypointProximity; // ivar: _currentWaypointProximity
