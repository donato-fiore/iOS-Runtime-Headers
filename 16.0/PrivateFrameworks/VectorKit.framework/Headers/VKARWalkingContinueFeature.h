...
@interface VKARWalkingContinueFeature : VKARWalkingFeature {
    _retain_ptr<GEOComposedRoute *, geo::_retain_objc_arc, geo::_release_objc_arc, geo::_hash_objc, geo::_equal_objc> _route;
...
-(id)initWithRoute:(id)arg0 range:(struct GEOPolylineCoordinateRange )arg1 displayText:(id)arg2 continuePriority:(NSUInteger)arg3 ;
