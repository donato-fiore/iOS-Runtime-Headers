...
+(id)displayAODNotificationWithOperator:(id)arg0 withBlock:(id)arg1 ;
+(id)displayOffNotificationWithOperator:(id)arg0 withBlock:(id)arg1 ;
+(id)displayOffOrAODNotificationWithOperator:(id)arg0 withBlock:(id)arg1 ;
+(id)displayOnNotificationWithOperator:(id)arg0 withBlock:(id)arg1 ;
+(id)displayOnOrAODNotificationWithOperator:(id)arg0 withBlock:(id)arg1 ;
+(id)displayStateChangeNotificationWithOperator:(id)arg0 withBlock:(id)arg1 ;
