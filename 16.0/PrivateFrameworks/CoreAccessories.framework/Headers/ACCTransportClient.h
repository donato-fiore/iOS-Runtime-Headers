...
@protocol ACCTransportXPCClientProtocol, ACCTransportClientDelegate, OS_dispatch_queue;
...
@property (retain, nonatomic) NSObject<OS_dispatch_queue> *endpointEventHandlerQueue; // ivar: _endpointEventHandlerQueue
