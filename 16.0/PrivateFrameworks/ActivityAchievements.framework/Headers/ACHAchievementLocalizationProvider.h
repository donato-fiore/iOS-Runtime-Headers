...
@class NSDate, NSLocale, NSCalendar, NSString, FIUnitManager;
...
@property (retain, nonatomic) NSLocale *currentLocaleOverride; // ivar: _currentLocaleOverride
@property (retain, nonatomic) NSCalendar *gregorianCalendar; // ivar: _gregorianCalendar
@property (retain, nonatomic) NSString *name; // ivar: _name
@property (retain, nonatomic) FIUnitManager *unitManager; // ivar: _unitManager
...
-(id)_formatValue:(id)arg0 forPlaceholder:(id)arg1 usingFormatterNamed:(id)arg2 template:(id)arg3 ;
-(id)_formatValue:(id)arg0 usingFormatterNamed:(id)arg1 template:(id)arg2 forCanonicalUnit:(id)arg3 ;
