...
-(id)clusterHeadlinesByTopic:(id)arg0 subscribedTags:(id)arg1 favoritesPersonalizer:(id)arg2 personalizer:(id)arg3 rules:(id)arg4 translationProvider:(id)arg5 unpaidHeadlineIDs:(id)arg6 ignoreTagIDs:(id)arg7 ;
