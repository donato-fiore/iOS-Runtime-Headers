...
@property (readonly, nonatomic) FCShortcutList *shortcutList; // ivar: _shortcutList
...
@property (readonly, nonatomic) FCUserEventHistory *userEventHistory; // ivar: _userEventHistory
