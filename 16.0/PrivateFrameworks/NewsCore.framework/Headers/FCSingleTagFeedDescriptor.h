...
-(id)initWithContext:(id)arg0 tag:(id)arg1 sortMethod:(NSInteger)arg2 filterOptions:(NSInteger)arg3 personalizationConfigurationSet:(NSInteger)arg4 paidAccessChecker:(id)arg5 feedConfiguration:(NSUInteger)arg6 ;
