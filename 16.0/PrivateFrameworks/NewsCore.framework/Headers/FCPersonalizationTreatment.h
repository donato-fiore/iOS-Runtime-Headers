...
@property (readonly, nonatomic) FCPersonalizationOntologyLevelConfig *sportsFeedForYouOntologyLevelConfig; // ivar: _sportsFeedForYouOntologyLevelConfig
@property (readonly, nonatomic) FCPersonalizationScoringConfig *sportsFeedForYouPaidScoringConfig; // ivar: _sportsFeedForYouPaidScoringConfig
@property (readonly, nonatomic) FCPersonalizationScoringConfig *sportsFeedForYouScoringConfig; // ivar: _sportsFeedForYouScoringConfig
@property (readonly, nonatomic) FCPersonalizationTopicsConfig *sportsFeedForYouTopicsConfig; // ivar: _sportsFeedForYouTopicsConfig
@property (readonly, nonatomic) FCPersonalizationOntologyLevelConfig *sportsFeedOntologyLevelConfig; // ivar: _sportsFeedOntologyLevelConfig
@property (readonly, nonatomic) FCPersonalizationScoringConfig *sportsFeedPaidScoringConfig; // ivar: _sportsFeedPaidScoringConfig
