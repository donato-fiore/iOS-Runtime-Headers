...
@class CKRecord, NSString, COMAPPLEFELDSPARPROTOCOLLIVERPOOLArticleScores, COMAPPLEFELDSPARPROTOCOLLIVERPOOLArticleConversionStats, COMAPPLEFELDSPARPROTOCOLLIVERPOOLArticleContentExpiration, COMAPPLEFELDSPARPROTOCOLLIVERPOOLCohortList, COMAPPLEFELDSPARPROTOCOLLIVERPOOLConversionStats, NSArray, COMAPPLEFELDSPARPROTOCOLVersionedPersonalizationVector, NSDate, COMAPPLEFELDSPARPROTOCOLLIVERPOOLTagMetadata;
