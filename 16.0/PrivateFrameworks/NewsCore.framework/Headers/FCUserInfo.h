...
@property (nonatomic) NSInteger shortcutsOnboardingState;
@property (readonly, nonatomic) NSDate *shortcutsOnboardingStateCompletedDate; // ivar: _shortcutsOnboardingStateCompletedDate
@property (readonly, nonatomic) BOOL shouldShowDefaultForYou;
@property (readonly, nonatomic) NSDate *sportsOnboardingCompletedDate;
@property (nonatomic) NSInteger sportsOnboardingState;
@property (nonatomic) NSInteger sportsSyncState;
@property (readonly, nonatomic) NSDate *sportsSyncStateLastSavedDate; // ivar: _sportsSyncStateLastSavedDate
