...
@class NSString, NSURL, NSDate, NSArray, NSDictionary, NSNumber, COMAPPLEFELDSPARPROTOCOLLIVERPOOLArticleContentExpiration, NSData, COMAPPLEFELDSPARPROTOCOLLIVERPOOLCohortList, COMAPPLEFELDSPARPROTOCOLLIVERPOOLConversionStats, COMAPPLEFELDSPARPROTOCOLVersionedPersonalizationVector, COMAPPLEFELDSPARPROTOCOLLIVERPOOLTagMetadata;
