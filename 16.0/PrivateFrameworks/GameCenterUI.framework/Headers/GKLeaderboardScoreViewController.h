...
@class UIView, NSLayoutConstraint, UICollectionView, CAGradientLayer, GKLeaderboard, NSString, UIImageView, UIStackView, GKLeaderboardEntry, UIScrollView, UISegmentedControl, UICollectionViewCell, UILabel;
