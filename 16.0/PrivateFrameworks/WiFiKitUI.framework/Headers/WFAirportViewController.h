...
@class NSArray, NSSet, NSString, NSMutableArray, UIBarButtonItem, NSOrderedSet;
@protocol UITableViewDataSource, UITableViewDelegate, WFNetworkListing, WFKnownNetworksViewProvider, WFNetworkListRecord, OS_dispatch_queue, WFAirportViewControllerDelegate;


#import "WFInsetTableViewController.h"
#import "WFTableViewHeaderView.h"
...
@property (retain, nonatomic) WFTableViewHeaderView *chooseNetworkHeader; // ivar: _chooseNetworkHeader
...
@property (retain, nonatomic) NSMutableArray *editableKnownNetworks; // ivar: _editableKnownNetworks
...
@property (retain, nonatomic) NSArray *managedKnownNetworks; // ivar: _managedKnownNetworks
@property (nonatomic) BOOL networkResultsChangedWhileUIUpdates; // ivar: _networkResultsChangedWhileUIUpdates
@property (retain, nonatomic) NSArray *networksToBeDeleted; // ivar: _networksToBeDeleted
@property (retain, nonatomic) UIBarButtonItem *originalBackButtonItem; // ivar: _originalBackButtonItem
...
@property (retain) NSOrderedSet *previousSections; // ivar: _previousSections
...
-(BOOL)_compatibilityModeShouldBeVisible;
-(BOOL)_isChinaDevice;
...
-(id)_passcodePromptForViewingKnownNetworksIsChinaDevice:(BOOL)arg0 ;
-(id)_sectionNameAtIndex:(NSUInteger)arg0 ;
-(id)_sortedProfilesFromSet:(id)arg0 ;
-(id)_tableCellForKnownNetwork:(id)arg0 tableView:(id)arg1 indexPath:(id)arg2 extraLeadingPadding:(BOOL)arg3 ;
-(id)_tableCellForNetwork:(id)arg0 tableView:(id)arg1 indexPath:(id)arg2 ;
-(id)_touchIDPromptForKnownNetworksIsChinaDevice:(BOOL)arg0 ;
-(id)_wifiKnownNetworkContextOptionsIsChinaDevice:(BOOL)arg0 ;
-(id)headerIdentifierForSectionType:(NSUInteger)arg0 ;
-(id)init;
...
-(void)_compabilitySwitchChanged:(id)arg0 ;
-(void)_dumpSections;
...
-(void)refresh;
-(void)refreshKnownNetworksUpdateTableView:(BOOL)arg0 ;
...
-(void)setCompatibilityModeEnabled:(BOOL)arg0 ;
