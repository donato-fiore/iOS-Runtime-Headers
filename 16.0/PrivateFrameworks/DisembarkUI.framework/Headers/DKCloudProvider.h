...
@class NSProgress, NSArray, NSMutableDictionary, BYBuddyDaemonCloudSyncClient, NSString, NWPathEvaluator;
...
@property (retain, nonatomic) NSMutableDictionary *backupResultByAltDSID; // ivar: _backupResultByAltDSID
