...
+(id)_containersForIdentifier:(id)arg0 groupContainerIdentifier:(id)arg1 ofContentClass:(NSUInteger)arg2 forPersona:(id)arg3 error:(*id)arg4 ;
...
+(struct container_object_s *)_containerForIdentifier:(id)arg0 ofContentClass:(NSUInteger)arg1 forPersona:(id)arg2 transient:(BOOL)arg3 create:(BOOL)arg4 created:(*BOOL)arg5 error:(*id)arg6 ;
