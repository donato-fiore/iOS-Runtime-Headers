...
-(void)vcSession:(id)arg0 participantID:(id)arg1 mediaStateDidChange:(unsigned int)arg2 forMediaType:(unsigned int)arg3 didSucceed:(BOOL)arg4 error:(id)arg5 ;
...
-(void)vcSession:(id)arg0 participantID:(id)arg1 remoteMediaStateDidChange:(unsigned int)arg2 forMediaType:(unsigned int)arg3 ;
