...
-(void)calculateWiFiNonAVCTxBitrateWithStatistics:(struct ? )arg0 ;
...
-(void)configureVCRateControlAlgorithmWithConfiguration:(struct VCRateControlAlgorithmConfig )arg0 ;
