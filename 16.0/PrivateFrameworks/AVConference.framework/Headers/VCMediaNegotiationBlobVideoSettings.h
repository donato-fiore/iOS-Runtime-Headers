...
@property (nonatomic) unsigned int hdrModesSupported; // ivar: _hdrModesSupported
...
+(unsigned int)hdrModesBitmapWithSupportedModes:(id)arg0 ;
...
-(id)initWithSSRC:(unsigned int)arg0 allowRTCPFB:(BOOL)arg1 videoRuleCollections:(id)arg2 featureStrings:(id)arg3 isCellular16x9Capable:(BOOL)arg4 tilesPerFrame:(unsigned int)arg5 ltrpEnabled:(BOOL)arg6 ;
-(id)initWithScreenSSRC:(unsigned int)arg0 allowRTCPFB:(BOOL)arg1 videoRuleCollections:(id)arg2 featureStrings:(id)arg3 isCellular16x9Capable:(BOOL)arg4 customVideoWidth:(unsigned int)arg5 customVideoHeight:(unsigned int)arg6 tilesPerFrame:(unsigned int)arg7 ltrpEnabled:(BOOL)arg8 pixelFormats:(id)arg9 hdrModesSupported:(id)arg10 ;
