...
+(BOOL)createNWPathEvaluator:(*id)arg0 withIPAddress:(id)arg1 localPort:(*int)arg2 remotePort:(int)arg3 shouldRunInProcess:(BOOL)arg4 useBackingSocket:(BOOL)arg5 ;
