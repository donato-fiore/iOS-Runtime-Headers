...
typedef struct tagRTCPPACKET {
    ...
    tagVCRTCPXR field18;
    tagRTCP_CUSTOM_SR field19;
    tagRTCP_CUSTOM_RR field20;
    tagRTCP_CUSTOM_RCTL field21;
} tagRTCPPACKET;
...
typedef struct _VCSessionParticipantLocalOneToOneSettings {
    ...
    id audioStreamInfo;
    id VCSessionParticipantMediaStreamInfo;
    unsigned int videoStreamInfo;
    unsigned int VCSessionParticipantMediaStreamInfo;
    BOOL screenStreamInfo;
