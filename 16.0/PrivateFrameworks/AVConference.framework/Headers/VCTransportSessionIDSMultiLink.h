...
-(id)initWithCallID:(unsigned int)arg0 requireEncryptionInfo:(BOOL)arg1 reportingAgent:(id)arg2 notificationQueue:(id)arg3 isMultiwaySession:(BOOL)arg4 dataPath:(int)arg5 ;
-(int)onStart;
