...
-(struct __CVBuffer *)copyBuffer:(struct opaqueCMSampleBuffer *)arg0 ;
...
-(void)updateCaptureSizesWithFirstFrame:(struct opaqueCMSampleBuffer *)arg0 ;
-(void)updateRemoteScreenAttributes:(id)arg0 ;
-(void)updateResizeFlag;
-(void)updateVideoBuffer:(struct __CVBuffer *)arg0 withPresentationTime:(struct ? )arg1 sampleBufferCopy:(struct opaqueCMSampleBuffer *)arg2 cameraStatusBits:(unsigned char)arg3 timestamp:(unsigned int)arg4 retainPixelBuffer:(BOOL)arg5 ;
