...
+(unsigned int)maxCameraNetworkBitrateForVideoQuality:(unsigned char)arg0 isLocalOnWiFi:(BOOL)arg1 isRedundancyRequested:(BOOL)arg2 ;
...
+(unsigned int)maxNetworkBitrateForStreamGroupID:(unsigned int)arg0 videoQuality:(unsigned char)arg1 isLocalOnWiFi:(BOOL)arg2 isRedundancyRequested:(BOOL)arg3 ;
