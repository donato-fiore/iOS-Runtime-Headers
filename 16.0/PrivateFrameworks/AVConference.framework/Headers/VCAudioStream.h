...
@protocol VCMediaStreamSyncSource, VCAudioIOSink, VCAudioIODelegate, VCTelephonyInterfaceDelegate, OS_dispatch_source, VCMediaStreamSyncSourceDelegate;
...
-(int)getRatTypeForStreamMode:(NSInteger)arg0 ;
...
-(void)reportInputHostTimeJumpWithSize:(CGFloat)arg0 ;
