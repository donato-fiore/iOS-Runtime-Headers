...
-(BOOL)configureInProcess:(id)arg0 error:(*id)arg1 ;
-(BOOL)configureOutOfProcess:(id)arg0 error:(*id)arg1 ;
-(BOOL)setupAudioStreamInProcessWithClientArgs:(id)arg0 networkSockets:(id)arg1 error:(*id)arg2 ;
-(BOOL)setupAudioStreamOutOfProcessWithClientArgs:(id)arg0 networkSockets:(id)arg1 error:(*id)arg2 ;
-(BOOL)shouldRunInProcessWithOptions:(id)arg0 ;
...
-(id)initWithLocalAddress:(id)arg0 networkSockets:(id)arg1 IDSDestination:(id)arg2 rtpConnectionClientID:(id)arg3 rtcpConnectionClientID:(id)arg4 callID:(id)arg5 options:(id)arg6 error:(*id)arg7 ;
...
-(id)initWithRTPNWConnectionClientID:(id)arg0 rtcpNWConnectionClientID:(id)arg1 options:(id)arg2 error:(*id)arg3 ;
