...
@property (nonatomic) char * os_variant_diagnostic_subsystem; // ivar: _os_variant_diagnostic_subsystem
...
+(id)eventPublisherWithStreamName:(char *)arg0 delegate:(id)arg1 queue:(id)arg2 log:(id)arg3 os_variant_diagnostic_subsystem:(char *)arg4 ;
-(id)initWithStreamName:(id)arg0 delegate:(id)arg1 queue:(id)arg2 log:(id)arg3 os_variant_diagnostic_subsystem:(char *)arg4 ;
