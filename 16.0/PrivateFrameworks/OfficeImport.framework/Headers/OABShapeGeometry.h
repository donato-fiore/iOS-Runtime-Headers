...
+(?)readAdjustValuesFromShapePropertiestoGeometry;
+(?)readGeometryCoordSpaceFromShapePropertiestoGeometry;
...
+(void)writeAdjustValuesFromGeometry:(id)arg0 toShapeProperties:(struct EshShapeProperties *)arg1 ;
