...
@protocol ACHTemplateSourceDelegate, ACHTemplateAssetSourceDelegate, ACHTemplateAssetRegistryDelegate, OS_dispatch_queue;
...
@property (retain, nonatomic) NSMutableDictionary *templateAssetSourcesByIdentifier; // ivar: _templateAssetSourcesByIdentifier
...
-(void)deregisterTemplateAssetSource:(id)arg0 ;
-(void)deregisterTemplateSource:(id)arg0 ;
-(void)populateResourcePropertiesForAchievement:(id)arg0 ;
-(void)registerTemplateAssetSource:(id)arg0 ;
-(void)registerTemplateSource:(id)arg0 ;
-(void)templateAssetSourceDidUpdateAssets:(id)arg0 ;
