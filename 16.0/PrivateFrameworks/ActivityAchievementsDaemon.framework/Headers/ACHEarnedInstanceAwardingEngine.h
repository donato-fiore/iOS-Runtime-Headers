...
@class ACHAwardsClient, ACHDatabaseAssertionClient, HDProfile, NSMutableDictionary, NSCalendar, NSDate, NSString;
...
-(id)initWithClient:(id)arg0 assertionClient:(id)arg1 dataStore:(id)arg2 earnedInstanceStore:(id)arg3 historicalEvaluationPolicy:(struct ? )arg4 ;
-(id)initWithProfile:(id)arg0 dataStore:(id)arg1 earnedInstanceStore:(id)arg2 historicalEvaluationPolicy:(struct ? )arg3 ;
-(void)_client_requestHistoricalEvaluationForAllSourcesWithCompletion:(id)arg0 ;
-(void)_client_requestIncrementalEvaluationForSource:(id)arg0 evaluationBlock:(id)arg1 ;
-(void)_daemon_requestHistoricalEvaluationForAllSourcesWithCompletion:(id)arg0 ;
-(void)_daemon_requestIncrementalEvaluationForSource:(id)arg0 evaluationBlock:(id)arg1 ;
-(void)_queue_evaluateHistoryForSource:(id)arg0 completion:(id)arg1 ;
...
-(void)_requestHistoricalEvaluationForAllSourcesWithCompletion:(id)arg0 ;
