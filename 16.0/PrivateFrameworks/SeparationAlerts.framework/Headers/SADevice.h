...
-(id)initWithDeviceUUID:(id)arg0 groupIdentifier:(id)arg1 macAddress:(id)arg2 name:(id)arg3 model:(id)arg4 systemVersion:(id)arg5 vendorId:(NSInteger)arg6 productId:(NSInteger)arg7 deviceType:(NSUInteger)arg8 notifyEnabled:(BOOL)arg9 date:(id)arg10 ;
-(id)initWithDeviceUUID:(id)arg0 groupIdentifier:(id)arg1 macAddress:(id)arg2 partIdentifier:(NSInteger)arg3 name:(id)arg4 model:(id)arg5 systemVersion:(id)arg6 vendorId:(NSInteger)arg7 productId:(NSInteger)arg8 deviceType:(NSUInteger)arg9 notifyEnabled:(BOOL)arg10 date:(id)arg11 ;
