...
-(CGFloat)minimumTimeSinceScenarioTransitionForAlertForDevice:(id)arg0 alertType:(NSUInteger)arg1 ;
-(CGFloat)timeDelayForRetryScanForAlertForDevice:(id)arg0 alertType:(NSUInteger)arg1 ;
