...
#ifndef _TTC8MAPSSYNC34MAPSSYNCCOLLECTIONTRANSITITEMQUERY_H
#define _TTC8MAPSSYNC34MAPSSYNCCOLLECTIONTRANSITITEMQUERY_H

@class TtC8MapsSync17MapsSyncBaseQuery;



@interface _TtC8MapsSync34MapsSyncCollectionTransitItemQuery : TtC8MapsSync17MapsSyncBaseQuery {
    ? _specifiedQuery;
}
