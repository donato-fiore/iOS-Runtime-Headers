...
-(NSUInteger)lastUtteranceIndexForMe:(BOOL)arg0 isTranscription:(BOOL)arg1 ;
-(NSUInteger)utteranceCountForMe:(BOOL)arg0 ;
-(id)addTranscriptionFromOtherContactPath:(id)arg0 ;
...
-(id)lastUtteranceForMe:(BOOL)arg0 isTranscription:(BOOL)arg1 ;
-(id)mergeUtterancesIfPossible;
-(id)otherContactPath;
-(id)processBackspaceForMe:(BOOL)arg0 ;
-(id)updateTranscriptionFromOtherContactPath:(id)arg0 ;
