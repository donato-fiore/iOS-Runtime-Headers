...
#ifndef SKUIVERTICALINFOLISTCOLLECTIONVIEWCELL_H
#define SKUIVERTICALINFOLISTCOLLECTIONVIEWCELL_H
...
-(void)reloadWithViewElements:(id)arg0 width:(CGFloat)arg1 context:(id)arg2 ;
