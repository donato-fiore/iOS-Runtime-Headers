...
@class NSMutableOrderedSet, FBSSceneClientSettings, NSString, FBSSceneDefinition, FBSSceneIdentity, FBSSceneIdentityToken, FBSSceneParameters, FBSSceneSettings, FBSSceneSpecification;
