...
-(id)initWithCategory:(id)arg0 accessibilityContrast:(NSUInteger)arg1 displayScale:(unsigned char)arg2 layoutDirection:(NSUInteger)arg3 legibilityWeight:(NSUInteger)arg4 localization:(id)arg5 preferredContentSizeCategory:(NSUInteger)arg6 userInterfaceIdiom:(NSUInteger)arg7 ;
