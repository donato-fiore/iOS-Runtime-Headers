...
+(id)contentWithDrawing:(id)arg0 style:(id)arg1 ;
+(id)contentWithImage:(struct CGImage *)arg0 scale:(unsigned char)arg1 ;
-(id)image;
-(id)initWithDrawing:(id)arg0 scale:(unsigned char)arg1 range:(NSUInteger)arg2 ;
-(id)initWithImage:(struct CGImage *)arg0 scale:(unsigned char)arg1 ;
-(void)dealloc;
