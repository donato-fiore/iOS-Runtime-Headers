...
-(id)newTouchAuthenticationSpecificationWithAuthenticationMessageContext:(NSUInteger)arg0 hitTestInformationMask:(NSUInteger)arg1 secureName:(unsigned int)arg2 ;
