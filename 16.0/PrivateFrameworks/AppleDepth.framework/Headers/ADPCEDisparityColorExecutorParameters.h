...
@property (nonatomic) BOOL disparityPostprocessingActive; // ivar: _disparityPostprocessingActive
...
-(id)initForPipelineParameters:(id)arg0 inputSource:(NSUInteger)arg1 ;
