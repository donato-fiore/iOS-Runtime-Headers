...
@class NSString, CRCarPlayAppPolicyEvaluator, DBClusterControlChannel, FBSDisplayConfiguration, FBSDisplayIdentity, FBSDisplayLayoutPublisher, CARObserverHashTable, CRPairedVehicleManager, NSMutableDictionary, UIScreen, CARSession, UITraitCollection, CRVehicle, NSMapTable, CRSUIWallpaperPreferences;
...
-(id)initWithDisplayConfiguration:(id)arg0 layoutPublisher:(id)arg1 iconBadgeController:(id)arg2 appPolicyEvaluator:(id)arg3 session:(id)arg4 navigationStateProvider:(id)arg5 ;
