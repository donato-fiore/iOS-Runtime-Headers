...
@class UISystemShellApplication, FBSApplicationLibrary, FBSALOToken, CRSAppHistoryService, CRCarPlayAppPolicyEvaluator, NSString, NSMutableDictionary, CRSIconLayoutService, CRSSessionService;
@protocol CRSAppHistoryDataProviding, CRSAppHistoryServiceDelegate, CRSIconLayoutServiceDelegate, FBSystemServiceDelegate, OS_dispatch_source, BSInvalidatable;


#import "DBAppHistory.h"
#import "DBDisplayManager.h"

@interface DashBoard : UISystemShellApplication <CRSAppHistoryDataProviding, CRSAppHistoryServiceDelegate, CRSIconLayoutServiceDelegate, FBSystemServiceDelegate>
...
-(id)appHistoryDataProviderForService:(id)arg0 ;
