...
@class NSString, UIViewController, UIView, UIWindow, FBSDisplayConfiguration, FBSDisplayIdentity, NSMutableDictionary, NSHashTable, UIScreen, SiriActivityAssertion, SiriLongPressButtonSource, SiriDirectActionSource, FBScene, RBSProcessMonitor, UIWindowScene;
