...
@class NSMutableArray, NSDate, NSMutableDictionary, NSString, ATAsset, NSMutableSet, NSDictionary, ATSession;
...
@interface ATLegacyDeviceSyncManager : ATDeviceSyncManager <ICEnvironmentMonitorObserver, ATSessionObserver, ATLegacyAssetLinkProgressDelegate>

 {
    ...
    *CacheDeleteToken _cacheDeleteToken;
    ...
    CGFloat _lastDiskUsageUpdateTime;
}
...
-(void)_reset;
-(void)_sendDiskUsage;
-(void)_sendDiskUsageWithUpdatedDataClasses:(id)arg0 ;
