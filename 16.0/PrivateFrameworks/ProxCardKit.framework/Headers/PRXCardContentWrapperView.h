...
@class UIView, NSArray, NSString, UIScrollView, NSLayoutConstraint, UILabel;
@protocol PRXCardContentViewDelegate, PRXCardBottomTrayDelegate, UIScrollViewDelegate;
...
@property (readonly, nonatomic) NSLayoutConstraint *scrollViewBottomConstraint; // ivar: _scrollViewBottomConstraint
...
-(void)didChangeContentsOfBottomTray:(id)arg0 ;
-(void)layoutSubviews;
