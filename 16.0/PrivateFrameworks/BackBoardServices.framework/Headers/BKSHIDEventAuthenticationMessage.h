...
@protocol BSDescriptionStreamable, NSSecureCoding, NSCopying, BSProtobufSerializable, BSXPCCoding, BSXPCSecureCoding;
...
@property (readonly, nonatomic) NSInteger secureNameStatus; // ivar: _secureNameStatus
