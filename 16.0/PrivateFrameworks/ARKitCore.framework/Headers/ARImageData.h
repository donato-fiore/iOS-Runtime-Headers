...
@class ADCameraCalibration, AVCameraCalibrationData, NSString, NSDate, AVCaptureDevice, AVDepthData, NSDictionary, NSMutableDictionary;
...
@property (copy, nonatomic) NSDictionary *exifData; // ivar: _exifData
...
@property (nonatomic, getter=isHighResolution) BOOL highResolution; // ivar: _highResolution
...
@property (readonly, copy, nonatomic) NSDictionary *tiffData; // ivar: _tiffData
...
-(id)initWithPixelBuffer:(struct __CVBuffer *)arg0 captureFramePerSecond:(NSInteger)arg1 captureDevice:(id)arg2 captureSession:(id)arg3 timestamp:(struct ? )arg4 intrinsics:(struct ? )arg5 exif:(id)arg6 tiff:(id)arg7 ;
