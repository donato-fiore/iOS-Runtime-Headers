...
@property (nonatomic) CGFloat firstRequestResultTimestamp; // ivar: _firstRequestResultTimestamp
...
@property (nonatomic) BOOL hasReturnedAvailabilityCheck; // ivar: _hasReturnedAvailabilityCheck
@property (nonatomic) BOOL hasReturnedLocalization; // ivar: _hasReturnedLocalization
@property (nonatomic) BOOL hasStartedAvailabilityCheck; // ivar: _hasStartedAvailabilityCheck
@property (nonatomic) BOOL hasStartedLocalization; // ivar: _hasStartedLocalization
