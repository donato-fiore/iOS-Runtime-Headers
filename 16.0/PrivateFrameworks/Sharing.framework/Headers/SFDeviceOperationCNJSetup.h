...
@class SKSetupCaptiveNetworkJoinClient, SKEventCaptiveNetworkPresent, WSWebSheetViewController, UIViewController;
...
@property (copy, nonatomic) id *promptForConfirmationHandler; // ivar: _promptForConfirmationHandler
@property (retain, nonatomic) SFSession *sfSession; // ivar: _sfSession


-(void)_complete:(id)arg0 ;
-(void)_handleCaptiveNetworkPresentEvent:(id)arg0 ;
