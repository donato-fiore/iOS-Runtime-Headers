...
@class UIViewController, NSArray, CKContainerSetupInfo, NSString, NSURL, CKShare;
@protocol CSAddParticipantsPublicController, CSAddParticipantsViewControllerDelegate;
