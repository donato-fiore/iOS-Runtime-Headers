...
-(id)emojiAlternativesForText:(id)arg0 matchedString:(*id)arg1 ;
-(id)emojiAppendCandidates:(id)arg0 ;
-(id)emojiReplacementCandidates:(id)arg0 ;
-(id)emojiReplacementCandidates:(id)arg0 matchedString:(*id)arg1 ;
-(id)emojiReplacementCandidatesForKeyboardState:(id)arg0 ;
-(id)emojiReplacementCandidatesForText:(id)arg0 ;
-(id)enumerateForEmojiAlternativesInText:(id)arg0 forEmojiLocaleData:(struct __EmojiLocaleDataWrapper *)arg1 matchedString:(*id)arg2 ;
...
-(id)enumerateForEmojiCandidatesIn:(id)arg0 forEmojiLocaleData:(struct __EmojiLocaleDataWrapper *)arg1 asReplacementCandidate:(BOOL)arg2 matchedString:(*id)arg3 ;
...
-(void)dealloc;
-(void)emojiAlternativesForText:(id)arg0 completionHandler:(id)arg1 ;
-(void)emojiReplacementCandidatesForText:(id)arg0 completionHandler:(id)arg1 ;
...
-(void)updateEmojiStatusForKeyboardType:(NSUInteger)arg0 appIdentifier:(id)arg1 ;
