...
-(id)init;
-(id)lastWord;
-(id)matchingLeftContextToWordMapKey:(id)arg0 ;
-(id)preferredLeftContextToWordMapKeyForLeftContext:(id)arg0 andMatchingLeftContext:(id)arg1 ;
...
-(void)replaceLeftContextToWordMapKey:(id)arg0 withNewKey:(id)arg1 ;
