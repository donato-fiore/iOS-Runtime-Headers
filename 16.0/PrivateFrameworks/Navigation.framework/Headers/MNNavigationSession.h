...
@class GEONavigationGuidanceState, NSString, GEOResourceManifestUpdateAssertion, GEOProbeCrumbs, GEOApplicationAuditToken, GEOComposedWaypoint, GEOMotionContext;
...
-(void)_startLocationTrackingWithInitialLocation:(id)arg0 ;
