...
@class GEOETATrafficUpdateResponse, GEOComposedETARoute, GEOComposedRoute, NSUUID, NSDate, GEOComposedRouteTraffic, GEOTransitRouteUpdateRequest;
...
@property (retain, nonatomic) MNBatteryChargeInfo *batteryChargeInfo; // ivar: _batteryChargeInfo
...
@property (retain, nonatomic) NSDate *serverDisplayETA; // ivar: _serverDisplayETA
