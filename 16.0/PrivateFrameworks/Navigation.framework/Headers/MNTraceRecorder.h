...
-(void)_recordNavigationUpdate:(NSInteger)arg0 parameters:(id)arg1 ;
...
-(void)recordDepartWaypoint:(id)arg0 legIndex:(NSUInteger)arg1 departureReason:(NSUInteger)arg2 ;
...
-(void)recordRouteChangeWithIndex:(NSUInteger)arg0 directionsResponseID:(id)arg1 etauResponseID:(id)arg2 rerouteReason:(NSUInteger)arg3 ;
