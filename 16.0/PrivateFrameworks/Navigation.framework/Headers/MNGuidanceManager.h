...
@class NSMutableDictionary, NSMutableSet, GEOComposedRoute, NSMutableArray, NSDictionary, GEOComposedGuidanceEvent, NSArray, GEOComposedWaypoint, NSString;
...
-(void)updateForReroute:(id)arg0 rerouteReason:(NSUInteger)arg1 ;
