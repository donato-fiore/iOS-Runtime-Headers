...
+(BOOL)createDatabaseRecordIfMissingIn:(id)arg0 key:(id)arg1 balance:(NSInteger)arg2 cohortAggregateBalance:(CGFloat)arg3 ;
+(BOOL)credit:(NSUInteger)arg0 budgetWithName:(id)arg1 ;
+(BOOL)creditCohortAggregate:(CGFloat)arg0 budgetWithName:(id)arg1 ;
+(BOOL)debit:(NSUInteger)arg0 budgetWithName:(id)arg1 ;
+(BOOL)debitCohortAggregate:(CGFloat)arg0 budgetWithName:(id)arg1 ;
+(BOOL)isMultiDayIntervalBudgetWithName:(id)arg0 ;
+(CGFloat)balanceForCohortAggregateBudgetWithName:(id)arg0 ;
+(NSInteger)balanceForBudgetWithName:(id)arg0 ;
+(id)budgetWithName:(id)arg0 ;
+(id)enforceBudgetForRecords:(id)arg0 withKey:(id)arg1 inDatabase:(id)arg2 ;
+(id)enforceEnhancedBudgetForRecords:(id)arg0 withKey:(id)arg1 inDatabase:(id)arg2 ;
+(id)enforceSimpleBudgetForRecords:(id)arg0 withKey:(id)arg1 inDatabase:(id)arg2 ;
...
+(void)resetAllBudgetRecordsIn:(id)arg0 ;
+(void)resetLastUpdateDateForName:(id)arg0 ;
+(void)updateAllBudgetsIn:(id)arg0 ;
+(void)updateAllBudgetsUnsafeIn:(id)arg0 ;
+(void)updateBudgetForRecords:(id)arg0 withKey:(id)arg1 inDatabase:(id)arg2 ;
+(void)updateEnhancedBudgetForRecords:(id)arg0 withKey:(id)arg1 inDatabase:(id)arg2 ;
+(void)updateSimpleBudgetForRecords:(id)arg0 withKey:(id)arg1 inDatabase:(id)arg2 ;
