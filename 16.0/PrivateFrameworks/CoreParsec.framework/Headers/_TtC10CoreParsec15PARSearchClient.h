...
-(void)clearEngagedResults:(id)arg0 with:(id)arg1 completion:(id)arg2 ;
-(void)clearEngagementsFrom:(id)arg0 to:(id)arg1 ;
-(void)clearEngagementsWith:(id)arg0 type:(id)arg1 ;
-(void)dealloc;
