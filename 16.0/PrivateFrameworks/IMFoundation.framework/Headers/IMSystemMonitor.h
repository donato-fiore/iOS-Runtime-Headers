...
@class NSHashTable, NSDate, CUTDeferredTaskQueue, NSString;
...
@property (readonly, nonatomic) CUTDeferredTaskQueue *_postScreenLockedTask; // ivar: __postScreenLockedTask
@property (readonly, nonatomic) CUTDeferredTaskQueue *_postScreenSaverStartedTask; // ivar: __postScreenSaverStartedTask
@property (retain, nonatomic) IMDispatchTimer *_timer; // ivar: _timer
