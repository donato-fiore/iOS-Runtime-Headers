...
typedef struct opaqueVTHDRImageStatisticsGenerationSession {
} // Error Processing Struct Fields
...
typedef struct __compressed_pair<NU::Histogram<long, double> *, std::default_delete<NU::Histogram<long, double>>> {
    void __value_;
} __compressed_pair<NU::Histogram<long, double> *, std::default_delete<NU::Histogram<long, double>>>;

typedef struct unique_ptr<NU::Histogram<long, double>, std::default_delete<NU::Histogram<long, double>>> {
    __compressed_pair<NU::Histogram<long, double> *, std::default_delete<NU::Histogram<long, double>>> __ptr_;
} unique_ptr<NU::Histogram<long, double>, std::default_delete<NU::Histogram<long, double>>>;
