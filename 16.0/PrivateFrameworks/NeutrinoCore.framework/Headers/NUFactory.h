...
@class NSString, CIFilter, VNSession;
...
@property (retain, nonatomic) NURenderResultCache *renderResultCache; // ivar: _renderResultCache
...
@property (retain, nonatomic) VNSession *visionSession; // ivar: _visionSession


+(BOOL)hasSharedFactory;
+(id)sharedFactory;
+(void)freeAllResources:(BOOL)arg0 ;
