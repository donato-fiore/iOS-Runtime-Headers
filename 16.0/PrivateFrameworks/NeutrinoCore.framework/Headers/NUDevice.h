...
-(id)_lowPriorityLowMemoryRendererWithoutIntermediateCaching:(*id)arg0 ;
-(id)_lowPriorityRenderer:(*id)arg0 ;
-(id)_lowPriorityRendererWithoutIntermediateCaching:(*id)arg0 ;
-(id)_metalCommandQueue;
-(id)_newLowPriorityLowMemoryRendererWithoutIntermediateCaching:(*id)arg0 ;
...
-(id)lowPriorityLowMemoryRendererWithoutIntermediateCaching:(*id)arg0 ;
