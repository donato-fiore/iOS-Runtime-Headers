...
@class SFBrowserController, SFSiriLinkCoordinator, WKBackForwardListItem, _SFBrowserConfiguration, _SFMailContentProvider, NSMutableSet, NSNumber, _SFPageFormatMenuController, NSTimer, _SFDownload, NSDate, _SFSaveToFilesOperation, UIScrollView, NSString, UIView, NSMapTable, WKWebpagePreferences, SFToastViewController, NSMutableArray, NSLayoutConstraint, NSUUID, _SFBarManager, WBSDigitalHealthManager, _SFPageZoomPreferenceManager, _SFPerSitePreferencesVendor, _SFActivityViewController, SKStoreProductViewController, WKProcessPool, _SFBrowserSavedState, WBSavedStateManager, UIWindowScene, WBTabCollection, NSArray, WBTabGroupManager, UIPinchGestureRecognizer, UITextRange, UIViewController, _SFWebView, UIWindow, WBWindowState, _SFBrowserWindowStateData, WKPreferences;
@protocol ActionPanelDelegate, AddBookmarkActivityDelegate, BookmarksBarViewDelegate, BookmarksNavigationControllerDelegate, BrowserRootViewControllerDelegate, CatalogViewControllerDelegate, ContinuousReadingViewControllerDelegate, DownloadOpenHandler, LibraryItemOpenHandler, LinkPreviewProvider, QLPreviewControllerDelegate, SFBrowserControllerProxy, SKStoreProductViewControllerDelegate, TabBarManagerObserving, TabControllerDocumentObserving, TabOverviewPresentationObserving, TabSnapshotGeneratorDelegate, UIGestureRecognizerDelegatePrivate, UIScreenshotServiceDelegate, UIScrollViewDelegate, UITextFieldDelegate, WBSDigitalHealthManagerDelegate, _SFBarManagerDelegate, _SFDigitalHealthViewControllerDelegate, _SFDynamicBarAnimatorDelegate, _SFMailContentProviderDataSource, _SFSaveToFilesOperationDelegate, _SFSingleBookmarkNavigationControllerDelegate, UIAdaptivePresentationControllerDelegate, UIActivityItemsConfigurationProviding, SFToastViewControllerDelegate, CloudTabsViewControllerDelegate, SFOverlayProviderDelegate, WBTabGroupSyncAgentSyncObserver, UICloudSharingControllerDelegate, WBSWebExtensionCommandHandling, SFSiriLinkActionPerformer, WBSUnifiedBarAnalyticsProviding, CompletionDetailViewControllerDelegate, SFBrowserKeyCommandSafariMethods, StartPageDataSource, TabDocumentDelegate, UIWindowSceneDelegate, _SFBrowserContentController, _SFNavigationBarDelegate, _SFNavigationIntentHandling, BrowserControllerUIDelegate, _SFBrowserDocument, WBSWebExtensionTab, WBSWebExtensionWindow, UIActivityItemsConfigurationReading, LoadProgressObserver, TabGroupProvider;
...
@property (readonly, nonatomic) BOOL shouldUseRegularWidthTabViewAppearance;
...
-(void)participantsDidUpdateInTabGroupWithUUID:(id)arg0 ;
...
-(void)tabControllerDidSwitchTabGroups:(id)arg0 ;
