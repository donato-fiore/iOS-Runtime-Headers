...
#ifndef URLCOMPLETIONMATCHBOOKMARKDATA_H
#define URLCOMPLETIONMATCHBOOKMARKDATA_H
...
@property (readonly, nonatomic) BOOL shouldPreload; // ivar: _shouldPreload
...
-(float)_topSitesScoreAtTime:(CGFloat)arg0 ;
...
-(id)initWithBookmark:(id)arg0 shouldPreload:(BOOL)arg1 ;
