...
@class SFBrowserApplication, NSMutableSet, NSMutableArray, WBDatabaseLockAcquisitor, WBSCyclerConnectionManager, WBTabGroupManager, WBSForYouRecentParsecResultsManager, WBSFormAutoFillCorrectionsHistoryObserver, WBSavedStateManager, WBTabCollection, WBSBrowserTabCompletionProvider, SBSAssertion, NSString, WBSParsecABGroupManager, WBSPhishingClassifierController, WBSAllowedLegacyTLSHostManager, WBSUnifiedBarAnalyticsRecorder, WebBookmarkCollection, NSArray, UIScene;
