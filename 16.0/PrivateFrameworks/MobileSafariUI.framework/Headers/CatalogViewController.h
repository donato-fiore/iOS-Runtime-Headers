...
@class UIViewController, UIButton, NSMutableSet, NSTimer, SFStartPageViewController, NSString, UIView, UIPopoverPresentationController, UIColor, UIImage;
@protocol SFStartPageDelegate, CompletionItemActionHandler, CompletionListDelegate, UITableViewDataSource, UITableViewDelegate, UnifiedFieldDelegate, SKStoreProductViewControllerDelegatePrivate, UIPopoverPresentationControllerDelegate, UniversalSearchFeedbackDelegate, UniversalSearchFirstTimeExperienceViewControllerDelegate, TabSnapshotContentProvider, CatalogViewControllerDelegate, CompletionItem, LoadProgressObserver, _SFNavigationBarCommon, SFStartPageScrollObserver;
...
@property (readonly, nonatomic) UIView *favoritesView; // ivar: _favoritesView
