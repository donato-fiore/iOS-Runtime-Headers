...
@class NSTimer, NSUUID, NSArray, NSMapTable, NSHashTable, NSString, CKContextCompleter, NSMutableArray, WBTabGroup, NSSet, UIImage, UIMenu, _SFBrowserSavedState, UIView<TabCollectionView>, WBTabGroupManager, WBSTabOrderManager, _SWCollaborationButtonView, UIView<TabThumbnailCollectionView>, NSUndoManager, WBWindowState;
@protocol TabBarDelegate, TabBarManagerObserving, TabOverviewDelegate, TabSnapshotCacheDelegate, UITextFieldDelegate, WBSTabGroupConfirmationAlertDelegate, WBTabGroupSyncAgentSyncObserver, SFTabHoverPreviewControllerDelegate, PinnedTabsObserving, TabDocumentDragDropDataSource, TabGroupProvider, WBTabGroupManagerObserver, WBSTabOrderProvider, WBSOrderedTab;
...
-(BOOL)tabOverviewShouldReserveSpaceForSidebarButton:(id)arg0 ;
...
-(id)tabGroupsMenuElementsWithOptions:(NSUInteger)arg0 newTabGroupName:(id)arg1 hostTitle:(id)arg2 descendantCount:(NSInteger)arg3 movingSelectedTab:(id)arg4 actionHandler:(id)arg5 ;
...
-(void)moveTab:(id)arg0 fromTabGroup:(id)arg1 toTabGroup:(id)arg2 overTab:(id)arg3 ;
...
-(void)tabGroupManager:(id)arg0 didPerformBlockUpdatesForTabGroup:(id)arg1 ;
...
-(void)tabGroupManager:(id)arg0 didUpdateTabGroup:(id)arg1 ;
-(void)tabGroupManager:(id)arg0 didUpdateTabsInTabGroup:(id)arg1 ;
-(void)tabGroupManager:(id)arg0 willPerformBlockUpdatesForTabGroup:(id)arg1 ;
