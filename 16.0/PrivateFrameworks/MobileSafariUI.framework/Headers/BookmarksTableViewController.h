...
@class SFPopoverSizingTableViewController, WebBookmarkList, WebBookmark, SFSyntheticBookmarkFolder, NSArray, UISearchBar, NSString, WebBookmarkCollection;
...
-(BOOL)_bookmarkAtIndexPathIsFolder:(id)arg0 ;
-(BOOL)_inRootFolder;
...
-(id)_newViewControllerForFolder:(id)arg0 syntheticFolder:(id)arg1 showAllSyntheticFolders:(BOOL)arg2 ;
-(id)_syntheticFolderAtIndexPath:(id)arg0 ;
-(id)_tableViewCellForBookmark:(id)arg0 syntheticFolder:(id)arg1 ;
...
-(id)initWithFolder:(id)arg0 inCollection:(id)arg1 activeSyntheticFolder:(id)arg2 showAllSyntheticFolders:(BOOL)arg3 skipOffset:(unsigned int)arg4 ;
...
-(void)_handleBookmarkItemDeleted:(BOOL)arg0 atIndexPath:(id)arg1 bookmarkCountBeforeDeletion:(NSUInteger)arg2 lockedDatabase:(BOOL)arg3 ;
