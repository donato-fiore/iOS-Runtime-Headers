...
#ifndef QUICKWEBSITESEARCHCOMPLETIONITEM_H
#define QUICKWEBSITESEARCHCOMPLETIONITEM_H

@class NSString, WBSQuickWebsiteSearchProvider, SFSearchResult, WBSQuerySuggestion;
@protocol CompletionItem, CompletionItemActionHandler;

#import <Foundation/Foundation.h>

#import "QuickWebsiteSearchQuery.h"
...
@property (readonly, nonatomic) WBSQuickWebsiteSearchProvider *searchProvider; // ivar: _searchProvider
@property (readonly, nonatomic) QuickWebsiteSearchQuery *searchQuery; // ivar: _searchQuery
...
-(id)initWithProvider:(id)arg0 query:(id)arg1 forQueryID:(NSInteger)arg2 ;
