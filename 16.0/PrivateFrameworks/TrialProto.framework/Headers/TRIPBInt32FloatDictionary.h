...
#ifndef TRIPBINT32FLOATDICTIONARY_H
#define TRIPBINT32FLOATDICTIONARY_H
...
-(BOOL)getFloat:(*float)arg0 forKey:(int)arg1 ;
...
-(id)initWithFloats:(*float)arg0 forKeys:(*int)arg1 count:(NSUInteger)arg2 ;
-(void)addEntriesFromDictionary:(id)arg0 ;
-(void)dealloc;
-(void)enumerateForTextFormat:(id)arg0 ;
-(void)enumerateKeysAndFloatsUsingBlock:(id)arg0 ;
-(void)removeAll;
-(void)removeFloatForKey:(int)arg0 ;
-(void)setFloat:(float)arg0 forKey:(int)arg1 ;
