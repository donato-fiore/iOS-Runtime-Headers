...
@class NSString, EFCancelationToken, EFStoppableScheduler<EFAssertableScheduler>, NSMutableSet, NSMutableArray, EFStoppableScheduler<EFSuspendableScheduler><EFAssertableScheduler>, EFStoppableScheduler, EFLazyCache, NSDate, EFFuture, EFObservable, CSSearchableIndex;
