...
@protocol EFLoggable, EDIndexableItem, EDBaseMessage;
...
@property (readonly, nonatomic) NSObject<EDBaseMessage> *message; // ivar: _message
...
+(id)log;
+(id)peopleFromCommentedAddresses:(id)arg0 ;
...
-(void)addDataDetectionAttributesToAttributeSet:(id)arg0 ;
