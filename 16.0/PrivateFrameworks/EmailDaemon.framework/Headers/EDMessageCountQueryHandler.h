...
@class NSMutableDictionary, NSMutableSet, EMObjectID, EFQuery, EFMutableInt64Set, EFStoppableScheduler<EFAssertableScheduler>, NSPredicate, EMMailboxScope, EFCancelationToken, EFListStateCapturer, EFDebouncer, NSString;
...
-(id)initWithQuery:(id)arg0 serverCountMailboxScope:(id)arg1 messagePersistence:(id)arg2 hookRegistry:(id)arg3 observer:(id)arg4 refireDebounceInterval:(CGFloat)arg5 ;
