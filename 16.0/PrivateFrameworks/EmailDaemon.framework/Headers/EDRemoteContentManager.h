...
@class NSBackgroundActivityScheduler, EFCancelationToken, EFLocked, NSLock, NSDate, EMRemoteContentURLSession;
...
-(void)_addRemoteContentLinks:(id)arg0 andVerify:(BOOL)arg1 WithParsedLinks:(id)arg2 defaultCharsetName:(id)arg3 ;
...
-(void)addRemoteContentLinks:(id)arg0 andVerifyWithParsedLinks:(id)arg1 defaultCharsetName:(id)arg2 ;
-(void)addRemoteContentLinks:(id)arg0 requiredParsing:(BOOL)arg1 ;
