...
+(id)_dictionarySuitableForLogging:(id)arg0 ;
+(id)sharedConnection;
+(void)_logRequestID:(id)arg0 forRequestAttributes:(id)arg1 associatedContext:(id)arg2 ;
...
-(void)_holidayCalendarFetchFinished:(id)arg0 ;
-(void)_holidayCalendarFetchReturnedResults:(id)arg0 ;
...
-(void)_sendXPCMessageSynchronous:(BOOL)arg0 withParameters:(id)arg1 handlerBlock:(id)arg2 ;
-(void)_serverContactsSearchQueryFinished:(id)arg0 ;
-(void)_serverDiedWithReason:(id)arg0 ;
-(void)_shareResponseFinished:(id)arg0 ;
-(void)_subscriptionCalendarJunkCheckFinished:(id)arg0 ;
-(void)_tearDownInFlightObjects;
-(void)_updateGrantedDelegatePermissionRequestFinished:(id)arg0 ;
-(void)addExchangeDelegateWithName:(id)arg0 emailAddress:(id)arg1 toAccountWithID:(id)arg2 completion:(id)arg3 ;
...
-(void)checkSubscriptionCalendarIsJunk:(id)arg0 queue:(id)arg1 completionBlock:(id)arg2 ;
-(void)dealloc;
-(void)endCalDAVServerSimulationWithHostname:(id)arg0 ;
// -(void)fetchAvailableHolidayCalendarsWithResultsBlock:(id)arg0 completionBlock:(unk)arg1 queue:(id)arg2  ;
...
-(void)removeExchangeDelegateWithSourceID:(id)arg0 fromParentAccountWithID:(id)arg1 completion:(id)arg2 ;
