...
@class SBSSystemApertureLayoutMonitor, NSMutableDictionary, NSString, UIWindowScene, NSMutableArray, SBSAccessibilityWindowHostingController;
...
@property (retain, nonatomic) UIWindowScene *externalScene; // ivar: _externalScene
@property (readonly) NSUInteger hash;
@property (retain, nonatomic) UIWindowScene *mainScene; // ivar: _mainScene
...
@property (retain, nonatomic) NSMutableArray *queuedAddContentViewControllerBlocks; // ivar: _queuedAddContentViewControllerBlocks
...
-(id)_windowWithUserInteractionEnabled:(BOOL)arg0 windowLevel:(CGFloat)arg1 createIfNeeded:(BOOL)arg2 purposeIdentifier:(id)arg3 userInterfaceStyle:(NSInteger)arg4 allowSystemAppHosting:(BOOL)arg5 windowScene:(id)arg6 ;
...
-(void)_activeInterfaceOrientationDidChange:(NSInteger)arg0 duration:(CGFloat)arg1 ;
...
-(void)_externalDisplaySceneConnected:(id)arg0 ;
-(void)_externalDisplaySceneDisconnected:(id)arg0 ;
...
-(void)_rotateWindow:(id)arg0 toInterfaceOrientation:(NSInteger)arg1 duration:(CGFloat)arg2 force:(BOOL)arg3 ;
...
-(void)_windowSceneConnected:(id)arg0 ;
-(void)_windowSceneDisconnected:(id)arg0 ;
