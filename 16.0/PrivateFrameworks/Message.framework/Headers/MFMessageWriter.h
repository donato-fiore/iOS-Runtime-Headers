...
-(id)createMessageWithHTMLStringAndMIMECharset:(id)arg0 plainTextAlternative:(id)arg1 otherHtmlStringsAndAttachments:(id)arg2 headers:(id)arg3 ;
...
-(id)newDataForMimePart:(id)arg0 withPartData:(id)arg1 ;
-(void)appendDataForMimePart:(id)arg0 toData:(id)arg1 withPartData:(id)arg2 ;
-(void)appendHeadersForMimePart:(id)arg0 toHeaders:(id)arg1 ;
