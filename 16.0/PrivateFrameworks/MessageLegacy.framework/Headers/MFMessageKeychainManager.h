...
+(int)_actionForCertificate:(struct __SecCertificate *)arg0 policy:(struct __SecPolicy *)arg1 uncommentedAddress:(id)arg2 ;
+(int)actionForEncryptionCertificate:(struct __SecCertificate *)arg0 address:(id)arg1 ;
+(int)actionForSigningIdentity:(struct __SecIdentity *)arg0 address:(id)arg1 ;
