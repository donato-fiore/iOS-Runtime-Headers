...
@protocol UIGestureRecognizerDelegate, SiriSharedUIPanDismissalGestureRecognizerDelegate;
...
@property (weak, nonatomic) NSObject<SiriSharedUIPanDismissalGestureRecognizerDelegate> *dismissalDelegate; // ivar: _dismissalDelegate
...
-(void)_runAnimationsWithPrefferedStyle:(id)arg0 ;
