...
@class AXDispatchTimer, NSMutableArray, NSString, ADAMAudioDataReceiver;
...
@property (retain, nonatomic) NSMutableArray *automationSampleData; // ivar: _automationSampleData
...
-(void)_automationStartPlayingSampleData:(id)arg0 ;
