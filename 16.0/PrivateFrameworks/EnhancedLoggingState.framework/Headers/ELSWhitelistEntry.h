...
@property (readonly, nonatomic) NSArray *platformAvailability; // ivar: _platformAvailability
...
-(id)initWithBundleIdentifier:(id)arg0 parameterName:(id)arg1 baseLocalizationKey:(id)arg2 needsWAPIKeys:(BOOL)arg3 requiresFollowup:(BOOL)arg4 retry:(BOOL)arg5 platforms:(id)arg6 ;
-(id)initWithBundleIdentifier:(id)arg0 parameterName:(id)arg1 displayNameLocalizationKey:(id)arg2 descriptionLocalizationKey:(id)arg3 sensitiveInformationLocalizationKey:(id)arg4 needsWAPIKeys:(BOOL)arg5 requiresFollowup:(BOOL)arg6 retry:(BOOL)arg7 platforms:(id)arg8 ;
