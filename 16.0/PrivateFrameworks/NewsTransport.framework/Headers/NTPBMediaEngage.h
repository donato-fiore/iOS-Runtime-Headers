...
@property (nonatomic) int mediaPauseLocation; // ivar: _mediaPauseLocation
@property (nonatomic) int mediaPauseMethod; // ivar: _mediaPauseMethod
@property (nonatomic) NSInteger mediaPausePosition; // ivar: _mediaPausePosition
@property (nonatomic) int mediaPlayLocation; // ivar: _mediaPlayLocation
@property (nonatomic) int mediaPlayMethod; // ivar: _mediaPlayMethod
@property (nonatomic) int mediaResumeMethod; // ivar: _mediaResumeMethod
@property (nonatomic) NSInteger mediaResumePosition; // ivar: _mediaResumePosition
@property (nonatomic) NSInteger mediaResumeTimePlayed; // ivar: _mediaResumeTimePlayed
...
@property (nonatomic) int muteButtonState; // ivar: _muteButtonState
...
@property (nonatomic) float osVolumeLevel; // ivar: _osVolumeLevel
