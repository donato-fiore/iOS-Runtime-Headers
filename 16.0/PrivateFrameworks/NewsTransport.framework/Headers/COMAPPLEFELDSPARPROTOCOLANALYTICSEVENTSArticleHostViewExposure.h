...
@property (retain, nonatomic) COMAPPLEFELDSPARPROTOCOLANALYTICSEVENTSAlternateHeadline *alternateHeadline; // ivar: _alternateHeadline
...
@property (retain, nonatomic) COMAPPLEFELDSPARPROTOCOLANALYTICSEVENTSChannelData *channelData; // ivar: _channelData
...
@property (retain, nonatomic) COMAPPLEFELDSPARPROTOCOLANALYTICSEVENTSIssueData *issueData; // ivar: _issueData
@property (retain, nonatomic) COMAPPLEFELDSPARPROTOCOLANALYTICSEVENTSIssueExposureData *issueExposureData; // ivar: _issueExposureData
@property (retain, nonatomic) COMAPPLEFELDSPARPROTOCOLANALYTICSEVENTSIssueViewContextData *issueViewContextData; // ivar: _issueViewContextData
@property (retain, nonatomic) COMAPPLEFELDSPARPROTOCOLANALYTICSEVENTSIssueViewData *issueViewData; // ivar: _issueViewData
...
@property (retain, nonatomic) COMAPPLEFELDSPARPROTOCOLANALYTICSEVENTSWidgetEngagement *widgetEngagement; // ivar: _widgetEngagement
...
-(NSUInteger)hash;
-(id)articleHostViewTypeAsString:(int)arg0 ;
-(id)articleSuggestionOriginAsString:(int)arg0 ;
-(id)articleTypeAsString:(int)arg0 ;
-(id)articleViewPresentationReasonAsString:(int)arg0 ;
-(id)copyWithZone:(struct _NSZone *)arg0 ;
-(id)coverArticleFeatureTypeAsString:(int)arg0 ;
...
-(id)heroArticleTypeAsString:(int)arg0 ;
-(id)loadFailureReasonAsString:(int)arg0 ;
...
-(id)previousArticleHostViewTypeIfSwipeAsString:(int)arg0 ;
...
-(int)StringAsArticleHostViewType:(id)arg0 ;
-(int)StringAsArticleSuggestionOrigin:(id)arg0 ;
-(int)StringAsArticleType:(id)arg0 ;
-(int)StringAsArticleViewPresentationReason:(id)arg0 ;
-(int)StringAsCoverArticleFeatureType:(id)arg0 ;
...
-(int)StringAsHeroArticleType:(id)arg0 ;
-(int)StringAsLoadFailureReason:(id)arg0 ;
...
-(int)StringAsPreviousArticleHostViewTypeIfSwipe:(id)arg0 ;
