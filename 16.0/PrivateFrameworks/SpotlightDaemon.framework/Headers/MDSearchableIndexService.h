...
@property (nonatomic) BOOL allowMail; // ivar: _allowMail
@property (nonatomic) BOOL allowPhotosLibraryDeletion; // ivar: _allowPhotosLibraryDeletion
...
-(BOOL)photosLibraryDeleted:(id)arg0 ;
...
-(void)_runLibraryDeletedCommand:(id)arg0 ;
...
-(void)fetchAttributes:(id)arg0 protectionClass:(id)arg1 bundleID:(id)arg2 identifiers:(id)arg3 includeParents:(BOOL)arg4 qos:(unsigned int)arg5 reply:(id)arg6 completionHandler:(id)arg7 ;
