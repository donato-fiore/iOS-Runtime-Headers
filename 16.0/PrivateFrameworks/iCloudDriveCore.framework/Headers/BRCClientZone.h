...
-(BOOL)existsByParentID:(id)arg0 andCaseInsensitiveLogicalName:(id)arg1 excludingItemID:(id)arg2 ;
-(BOOL)existsByParentID:(id)arg0 andCaseInsensitiveLogicalName:(id)arg1 excludingItemID:(id)arg2 db:(id)arg3 ;
...
-(id)itemEnumeratorByParentID:(id)arg0 andCaseInsensitiveLogicalName:(id)arg1 ;
