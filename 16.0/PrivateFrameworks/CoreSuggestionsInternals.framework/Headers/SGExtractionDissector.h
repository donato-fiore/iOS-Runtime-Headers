...
-(id)_ensureHtmlIsString:(id)arg0 ;
...
-(id)enrichmentsFromSchemas:(id)arg0 inTextMessage:(id)arg1 parentEntity:(id)arg2 ;
...
-(id)eventActivitiesForReservationWithSchema:(id)arg0 enrichment:(id)arg1 ;
...
-(id)getFlightReferencesAndReservationId:(id)arg0 ;
-(id)init;
