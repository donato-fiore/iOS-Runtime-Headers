...
#ifndef TRIGGERVALUERESOLUTIONRESULT_H
#define TRIGGERVALUERESOLUTIONRESULT_H
...
+(id)confirmationRequiredWithTriggerValueToConfirm:(id)arg0 ;
+(id)disambiguationWithObjectsToDisambiguate:(id)arg0 ;
+(id)disambiguationWithTriggerValuesToDisambiguate:(id)arg0 ;
+(id)successWithResolvedObject:(id)arg0 ;
+(id)successWithResolvedTriggerValue:(id)arg0 ;
