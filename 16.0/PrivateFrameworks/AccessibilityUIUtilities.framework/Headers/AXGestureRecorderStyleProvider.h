...
-(CGFloat)dynamicFingerLineDropDownShadowOpacity;
-(CGFloat)dynamicFingerLineDropDownShadowRadius;
-(CGFloat)dynamicFingerLineOuterBevelWidth;
-(CGFloat)fingerLineDropDownShadowOpacity;
-(CGFloat)fingerLineDropDownShadowRadius;
-(CGFloat)fingerLineOuterBevelWidth;
-(CGFloat)instructionsLabelHorizontalInset;
-(CGFloat)maximumFingerLineWidth;
-(CGFloat)minimumFingerLineWidth;
