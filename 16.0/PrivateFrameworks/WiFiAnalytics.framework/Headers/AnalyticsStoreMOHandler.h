...
-(BOOL)setBssManagedObjectPropertyValueForKeyWithoutSave:(id)arg0 forKey:(id)arg1 withValue:(id)arg2 ;
-(BOOL)setNetworkManagedObjectPropertyValueForKeyWithoutSave:(id)arg0 forKey:(id)arg1 withValue:(id)arg2 ;
