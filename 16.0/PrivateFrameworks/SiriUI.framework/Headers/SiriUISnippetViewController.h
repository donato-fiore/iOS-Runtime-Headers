...
@class UICollectionReusableView<SiriUIReusableView>, NSAttributedString, UIView, SAUIAppPunchOut, NSString, SAUIConfirmationOptions, NSArray, UIColor;
...
-(void)configureForConversationStorable:(id)arg0 ;
