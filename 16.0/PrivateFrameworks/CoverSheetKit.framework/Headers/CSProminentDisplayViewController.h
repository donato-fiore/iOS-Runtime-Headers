...
@property (nonatomic) NSUInteger visibleElements; // ivar: _visibleElements


+(Class)viewClass;
-(BOOL)_canShowWhileLocked;
-(BOOL)_elements:(NSUInteger)arg0 containElement:(NSUInteger)arg1 ;
-(BOOL)_isShowingAnySubtitle;
-(BOOL)_isShowingComplicationRow;
-(BOOL)_isShowingElement:(NSUInteger)arg0 ;
