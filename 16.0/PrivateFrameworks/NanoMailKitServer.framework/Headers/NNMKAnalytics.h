...
-(id)stringForAttachmentType:(NSUInteger)arg0 ;
-(id)stringForCompositionSource:(NSInteger)arg0 ;
-(id)stringForDeviceMode:(NSUInteger)arg0 ;
-(id)stringForDeviceSource:(NSUInteger)arg0 ;
-(id)stringForFetchType:(NSUInteger)arg0 ;
-(id)stringForMailboxFilterType:(NSUInteger)arg0 ;
-(id)stringForMailboxType:(NSUInteger)arg0 ;
-(id)stringForMessageType:(NSUInteger)arg0 ;
...
-(void)reportAttachmentDataReceivedWithType:(NSUInteger)arg0 sizeInBytes:(NSUInteger)arg1 mode:(NSUInteger)arg2 ;
-(void)reportAttachmentDisplayedWithType:(NSUInteger)arg0 actionable:(BOOL)arg1 source:(NSUInteger)arg2 ;
-(void)reportAttachmentDownloadFailedInMode:(NSUInteger)arg0 ;
-(void)reportAttachmentTappedWithType:(NSUInteger)arg0 actionable:(BOOL)arg1 source:(NSUInteger)arg2 ;
-(void)reportCannedReplyUsed:(id)arg0 sendingType:(NSUInteger)arg1 ;
...
-(void)reportDisplayingMessageWithType:(NSUInteger)arg0 isNotification:(BOOL)arg1 ;
-(void)reportFailedFetchWithType:(NSUInteger)arg0 inMode:(NSUInteger)arg1 ;
-(void)reportFetch:(NSUInteger)arg0 inMode:(NSUInteger)arg1 accountType:(id)arg2 ;
...
-(void)reportMessageSentFrom:(NSInteger)arg0 sendingType:(NSUInteger)arg1 attachmentCount:(NSUInteger)arg2 sizeInBytes:(NSUInteger)arg3 ;
...
-(void)reportNotificationReceivedInMode:(NSUInteger)arg0 accountType:(id)arg1 ;
-(void)reportNotificationReceivedInMode:(NSUInteger)arg0 isPCC:(BOOL)arg1 accountType:(id)arg2 ;
-(void)reportOpenedMailboxWithFilter:(id)arg0 mailboxType:(NSUInteger)arg1 accountType:(id)arg2 ;
-(void)reportOriginalMessageContentSizeInBytes:(NSUInteger)arg0 source:(NSUInteger)arg1 ;
-(void)reportReachedActionButtonsWithSource:(NSUInteger)arg0 ;
...
-(void)reportSubscribedToNotificationForAccountType:(id)arg0 isPCC:(BOOL)arg1 ;
-(void)reportThreadViewedWithMessageCount:(NSInteger)arg0 ;
