...
-(void)handleEndpointResolution:(id)arg0 client:(id)arg1 player:(id)arg2 source:(id)arg3 error:(id)arg4 ;
...
-(void)onQueue_retrieveEndpointForContextUID:(id)arg0 completion:(id)arg1 ;
...
-(void)resolveForOutputContextUID:(id)arg0 client:(id)arg1 player:(id)arg2 ;
