...
-(id)registerDiscoveryTokenForConfiguration:(id)arg0 ;
...
-(void)notifyDiscoveryOutputDevicesChanged:(id)arg0 forConfiguration:(id)arg1 ;
...
-(void)setDiscoveryMode:(unsigned int)arg0 forToken:(id)arg1 ;
// -(void)setDiscoveryOutputDevicesChangedCallback:(id)arg0 forToken:(unk)arg1  ;
...
-(void)unpair;
-(void)unregisterDiscoveryToken:(id)arg0 ;
