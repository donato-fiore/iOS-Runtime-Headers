...
-(void)_sendButtonEvent:(unsigned int)arg0 postHIDEventDirectly:(BOOL)arg1 ;
...
-(void)turnDigitalCrown:(NSInteger)arg0 ;
-(void)turnDigitalCrownFullRevolution:(BOOL)arg0 ;
-(void)warm;
