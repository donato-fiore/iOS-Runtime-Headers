...
@property (weak) NSObject<MBManagerDelegate> *delegate; // ivar: _delegate
...
-(id)restoreFilesForDomain:(id)arg0 error:(*id)arg1 ;
-(id)restoreFilesForDomain:(id)arg0 relativePath:(id)arg1 pendingOnly:(BOOL)arg2 error:(*id)arg3 ;
...
-(void)rebootDevice;
-(void)restoreFileWithPath:(id)arg0 ;
...
-(void)startRestoreForBackupUDID:(id)arg0 snapshotID:(NSUInteger)arg1 ;
