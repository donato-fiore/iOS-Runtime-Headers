...
@class NSString;
@protocol MBConnectionDelegate, OS_dispatch_queue, OS_xpc_object;
...
@property (weak) NSObject<MBConnectionDelegate> *delegate; // ivar: _delegate
...
-(id)initWithServiceName:(id)arg0 delegate:(id)arg1 delegateQueue:(id)arg2 ;
-(id)initWithXPCConnection:(id)arg0 delegate:(id)arg1 delegateQueue:(id)arg2 ;
