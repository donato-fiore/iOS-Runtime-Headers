...
+(CGFloat)doubleFromStringValueForKey:(id)arg0 plist:(id)arg1 ;
...
-(BOOL)_loadSystemDomain:(id)arg0 plist:(id)arg1 accountType:(NSInteger)arg2 volumeMountPoint:(id)arg3 ;
-(BOOL)isEqual:(id)arg0 ;
-(BOOL)isEqualToDomain:(id)arg0 ;
-(BOOL)shoudBackUpAnyChildOfRelativePath:(id)arg0 ;
-(NSInteger)compare:(id)arg0 ;
-(NSUInteger)hash;
-(id)description;
-(id)initWithName:(id)arg0 plist:(id)arg1 ;
-(id)initWithName:(id)arg0 plist:(id)arg1 accountType:(NSInteger)arg2 volumeMountPoint:(id)arg3 ;
