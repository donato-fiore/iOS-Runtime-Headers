...
@property (readonly) NSUInteger backupOnCellularSupport;
@property (copy, nonatomic) id *backupOnCellularSupportUpdateHandler; // ivar: _backupOnCellularSupportUpdateHandler
...
-(void)_handleCellularStateChange:(struct ? )arg0 backupOnCellularSupport:(NSUInteger)arg1 ;
