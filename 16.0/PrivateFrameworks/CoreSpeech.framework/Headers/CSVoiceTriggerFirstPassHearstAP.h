...
@protocol CSAudioStreamProvidingDelegate, CSVoiceTriggerEnabledMonitorDelegate, CSSiriClientBehaviorMonitorDelegate, CSOpportuneSpeakEventMonitorDelegate, CSVoiceTriggerDelegate, OS_dispatch_queue, OS_dispatch_group;
