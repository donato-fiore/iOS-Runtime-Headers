...
@class NSString, CSAudioTimeConverter, CSAsset, CSPolicy, NSHashTable, CSContinuousVoiceTriggerConfig;
@protocol CSAudioStreamProvidingDelegate, CSSiriClientBehaviorMonitorDelegate, CSAudioServerCrashMonitorDelegate, OS_dispatch_queue;
