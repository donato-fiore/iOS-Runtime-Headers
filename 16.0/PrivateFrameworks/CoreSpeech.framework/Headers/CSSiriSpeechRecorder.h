...
@class NSFileHandle, NSUUID, NSString, NSXPCConnection, AFWatchdogTimer, NSArray, AFSpeechSynthesisRecord, AFClientConfiguration, NSMutableDictionary, AFBluetoothWirelessSplitterSessionStateObserver, AFExperimentContext;
