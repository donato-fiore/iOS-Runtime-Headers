...
+(BOOL)validVisitSources:(id)arg0 ;
...
-(id)initWithDate:(id)arg0 type:(NSInteger)arg1 location:(id)arg2 entry:(id)arg3 exit:(id)arg4 dataPointCount:(NSInteger)arg5 confidence:(CGFloat)arg6 placeInference:(id)arg7 source:(NSInteger)arg8 ;
