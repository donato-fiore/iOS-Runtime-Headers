...
-(void)_setMutableAttributedAlertString:(id)arg0 timeout:(CGFloat)arg1 priority:(int)arg2 ;
...
-(void)setAttributedAlertString:(id)arg0 timeout:(CGFloat)arg1 priority:(int)arg2 ;
-(void)setAttributedAnnouncementString:(id)arg0 ;
