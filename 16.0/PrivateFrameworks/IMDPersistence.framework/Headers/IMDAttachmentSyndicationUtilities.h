...
+(BOOL)_attachmentGUIDIsSyndicatable:(id)arg0 syndicationIdentifier:(id)arg1 attachmentUTI:(id)arg2 attributedBody:(id)arg3 encodedSyndicationRanges:(id)arg4 verbose:(BOOL)arg5 ;
