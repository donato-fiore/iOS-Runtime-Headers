...
-(id)initWithSerializedRepresentation:(id)arg0 variableProvider:(id)arg1 parameter:(id)arg2 contentItemClass:(Class)arg3 linkValueTypes:(id)arg4 ;
-(id)serializedRepresentation;
-(id)stateByAddingRow:(id)arg0 ;
-(id)stateByInsertingRow:(id)arg0 atIndex:(NSUInteger)arg1 ;
