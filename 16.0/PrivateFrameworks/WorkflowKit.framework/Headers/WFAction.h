...
@class NSString, NSArray, NSSet, NSDictionary, INAppDescriptor, NSAttributedString, NSMutableDictionary, NSDate, NSHashTable, WFIcon, WFColor, WFImage, WFContentCollection, NSProgress;
@protocol WFAppInstalledResourceDelegate, WFUUIDProvider, WFParameterEventObserver, NSCopying, NSSecureCoding, WFVariableProvider, WFActionRemoteUserInterface, OS_dispatch_queue, WFActionExtendedOperation, WFActionRunningDelegate, WFActionSandboxExtensionProvider, WFUserInterfaceHost, WFVariableDataSource;
...
-(id)subsequentWebRequestsAvailabilityBlock:(SEL)arg0 ;
