...
#ifndef WFPBGALLERYSESSIONBROWSECATEGORYEVENT_H
#define WFPBGALLERYSESSIONBROWSECATEGORYEVENT_H
...
@property (retain, nonatomic) NSString *galleryCategoryIdentifier; // ivar: _galleryCategoryIdentifier
