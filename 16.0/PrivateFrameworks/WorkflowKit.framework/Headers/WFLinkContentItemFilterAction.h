...
-(id)initWithIdentifier:(id)arg0 queryMetadata:(id)arg1 entityMetadata:(id)arg2 definition:(id)arg3 serializedParameters:(id)arg4 outputMetadata:(id)arg5 appIntentDescriptor:(id)arg6 ;
-(id)linkValueTypes;
-(id)metadataProvider;
-(id)name;
-(id)outputDictionary;
