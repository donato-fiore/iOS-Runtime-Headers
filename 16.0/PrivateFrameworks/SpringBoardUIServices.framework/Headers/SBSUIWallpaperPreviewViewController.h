...
@class UIViewController, NSTimer, PBUIWallpaperConfigurationManager, PBUIWallpaperConfiguration, NSDictionary, NSString, AVURLAsset, PBUIWallpaperOptions, SBFWallpaperCoreAnalyticsLogger, _UILegibilitySettings, UIImage, SBFWallpaperOptions;
