...
@class UIButton, UILayoutGuide, UILabel, NSLayoutConstraint, NSString, PKGlyphView;
...
@property (retain, nonatomic) UILayoutGuide *cancelButtonLayoutGuide; // ivar: _cancelButtonLayoutGuide
...
@property (retain, nonatomic) UILayoutGuide *touchIDGlyphLayoutGuide; // ivar: _touchIDGlyphLayoutGuide
