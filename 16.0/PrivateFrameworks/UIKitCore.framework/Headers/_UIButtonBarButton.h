...
@property (readonly, nonatomic, getter=isBreadcrumb) BOOL breadcrumb; // ivar: _breadcrumb
...
-(void)_configureFromBarItem:(id)arg0 appearanceDelegate:(id)arg1 isBackButton:(BOOL)arg2 useBreadcrumbStyle:(BOOL)arg3 ;
...
-(void)configureBreadcrumbBackButtonFromBarItem:(id)arg0 withAppearanceDelegate:(id)arg1 ;
