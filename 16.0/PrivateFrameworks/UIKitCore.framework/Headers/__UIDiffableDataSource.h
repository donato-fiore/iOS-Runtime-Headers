...
@class NSMapTable, NSHashTable, NSMutableArray, NSString, NSArray;
...
@property (retain, nonatomic) NSMutableArray *completionHandlersForBatchApply; // ivar: _completionHandlersForBatchApply
