...
@property (readonly, nonatomic) _UIFocusDebugWindow *debugWindow; // ivar: _debugWindow
...
-(void)_windowHostingScene:(id)arg0 willMoveFromScreen:(id)arg1 toScreen:(id)arg2 ;
