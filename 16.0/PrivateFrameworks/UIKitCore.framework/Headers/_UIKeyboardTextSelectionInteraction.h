...
-(void)beginTwoFingerPanWithTranslation:(struct CGPoint )arg0 isShiftKeyBeingHeld:(BOOL)arg1 executionContext:(id)arg2 ;
...
-(void)forwardIndirectGestureWithType:(NSInteger)arg0 state:(NSInteger)arg1 translation:(struct CGPoint )arg2 flickDirection:(NSUInteger)arg3 touchCount:(NSUInteger)arg4 ;
...
-(void)indirectPanGestureWithState:(NSInteger)arg0 withTranslation:(struct CGPoint )arg1 withFlickDirection:(NSUInteger)arg2 isShiftKeyBeingHeld:(BOOL)arg3 ;
