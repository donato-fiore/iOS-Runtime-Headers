...
@property (nonatomic) BOOL ignoreSpeechRecognitionResults; // ivar: _ignoreSpeechRecognitionResults
...
+(BOOL)hasSpeechRecognitionPauseAckPhrases:(id)arg0 ;
...
-(id)_dictationSerializedResultWithPhrases:(id)arg0 languageModel:(id)arg1 ;
...
-(void)dictationConnection:(id)arg0 didRecognizeFinalResultCandidatePackage:(id)arg1 ;
-(void)dictationConnection:(id)arg0 didRecognizeMultilingualSpeech:(id)arg1 ;
-(void)dictationConnection:(id)arg0 didRecognizePackage:(id)arg1 nluResult:(id)arg2 ;
...
-(void)dictationConnectionDidPauseRecognition:(id)arg0 ;
