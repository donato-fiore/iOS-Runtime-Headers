...
@property (nonatomic) NSUInteger lastSelectedKeyIndex; // ivar: _lastSelectedKeyIndex
@property (nonatomic) BOOL overrideInitialKey; // ivar: _overrideInitialKey
...
@property (nonatomic) BOOL shouldConfigureFloatingContentView; // ivar: _shouldConfigureFloatingContentView
@property (nonatomic) BOOL shouldToggleLetterCaseNext; // ivar: _shouldToggleLetterCaseNext
@property (readonly, nonatomic, getter=isSlimLinearKeyboardTV) BOOL slimLinearKeyboardTV;
@property (readonly) Class superclass;
@property (nonatomic) BOOL suppressOperations; // ivar: _suppressOperations
...
-(BOOL)refreshSelectedCellIfNecessaryForKey:(id)arg0 animated:(BOOL)arg1 ;
...
-(BOOL)supportsEmoji;
-(BOOL)usesAutoShift;
-(CGFloat)defaultCursorAdjustDistance;
