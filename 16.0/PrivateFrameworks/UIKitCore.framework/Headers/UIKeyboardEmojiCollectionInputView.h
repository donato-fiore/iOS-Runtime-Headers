...
@property (weak) UIKeyboardEmojiCategory *category; // ivar: _category
...
@property (weak, nonatomic) UIResponder<UIKBEmojiHitTestResponder> *hitTestResponder; // ivar: _hitTestResponder
...
@property (weak, nonatomic) NSIndexPath *tappedSkinToneEmoji; // ivar: _tappedSkinToneEmoji
...
-(NSInteger)emojiCategoryTypeForSection:(NSInteger)arg0 ;
