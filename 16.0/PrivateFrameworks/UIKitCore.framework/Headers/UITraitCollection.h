...
@property (readonly, nonatomic) NSInteger toolbarItemPresentationSize;
...
+(id)_overrideTraitCollectionWithBuiltinTraitStorageBuilder:(id)arg0 ;
+(id)_traitCollectionForSidebarAppearance;
+(id)_traitCollectionWithBackgroundLevel:(NSInteger)arg0 ;
+(id)_traitCollectionWithBacklightLuminance:(NSInteger)arg0 ;
...
+(id)_traitCollectionWithUserInterfaceRenderingMode:(NSInteger)arg0 ;
...
+(id)traitCollectionWithToolbarItemPresentationSize:(NSInteger)arg0 ;
