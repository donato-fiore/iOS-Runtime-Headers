...
@protocol UIScribbleInteractionDelegate, UITextInputTraits_Private, _UIBarPositioningInternal, _UINavigationBarAugmentedTitleView, UIBarPositioning, UITextInputTraits, _UISearchBarSearchContainerLayoutCustomizationDelegate, UISearchBarDelegate;
...
@interface UISearchBar : UIView <UIScribbleInteractionDelegate, UITextInputTraits_Private, _UIBarPositioningInternal, _UINavigationBarAugmentedTitleView, UIBarPositioning, UITextInputTraits>
...
@property (readonly, nonatomic) NSInteger _layoutState;
@property (readonly, retain, nonatomic) UIButton *_leftButton;
@property (nonatomic, setter=_setLeftInsetForInlineSearch:) CGFloat _leftInsetForInlineSearch;
...
@property (nonatomic, setter=_setRightInsetForInlineSearch:) CGFloat _rightInsetForInlineSearch;
...
@property (readonly, nonatomic) _UISearchBarVisualProviderBase *_visualProvider; // ivar: _visualProvider
...
-(CGFloat)_idealInlineWidthForLayoutState:(NSInteger)arg0 ;
-(CGFloat)_scopeBarHeight;
-(CGFloat)_widthForButtonBarItemLayout;
...
-(void)_scopeIndexChanged:(NSInteger)arg0 ;
-(void)_searchButtonAction:(id)arg0 ;
...
-(void)_setDeferredAutomaticShowsScopeBarInNavigationBar:(id)arg0 ;
...
-(void)_updateForNewSearchFieldText:(id)arg0 ;
