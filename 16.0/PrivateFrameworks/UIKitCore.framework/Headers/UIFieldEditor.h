...
@class NSAttributedString, NSDictionary, NSTextContainer, _UITextLayoutControllerBase<_UITextLayoutController>, NSTimer, UIView<_UITextCanvas>, NSIndexSet, RTIInputSystemSourceSession, NSString, NSLayoutManager, NSTextStorage;
...
-(void)_handleObscuredTextInputIfNecessaryWithEditingBlock:(id)arg0 ;
