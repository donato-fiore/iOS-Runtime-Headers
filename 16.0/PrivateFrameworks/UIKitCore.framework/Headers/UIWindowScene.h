...
-(void)_computeMetricsAndCrossFadeInLiveResize:(BOOL)arg0 ;
-(void)_computeMetricsAndForceDelegateCallback:(BOOL)arg0 withAction:(id)arg1 ;
...
-(void)_endIgnoringInteractionEvents;
