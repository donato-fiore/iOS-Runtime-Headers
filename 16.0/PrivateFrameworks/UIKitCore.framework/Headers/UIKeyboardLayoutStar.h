...
@class NSMutableDictionary, NSMutableSet, CADisplayLink, NSString, NSTimer, NSMutableArray, NSNumber, NSDate, NSLayoutConstraint, NSArray, TUIKeyplaneView;
@protocol UIKBEmojiHitTestResponder, UIKBResizingKeyplaneCoordinatorCoordinatorDelegate, UIKeyboardPinchGestureRecognizerDelegate, UIKeyboardTypingStyleEstimatorDelegate, UIKBKeyplaneViewDelegate, UIKeyboardKeyplaneTransitionDelegate, UITextCursorAssertion, UIKeyboardLayoutStarDelegate;
...
@property (weak, nonatomic) NSObject<UIKeyboardKeyplaneTransitionDelegate> *splitKeyplaneTransitionDelegate; // ivar: _splitKeyplaneTransitionDelegate
...
-(void)accessibilitySensitivityChanged;
-(void)addContinuousPathPoint:(struct CGPoint )arg0 withTimestamp:(CGFloat)arg1 updateIdleDetection:(BOOL)arg2 ;
...
-(void)createLayoutFromName:(id)arg0 ;
...
-(void)playKeyFeedbackIfNecessaryForTouchDownOnKey:(id)arg0 touchInfo:(id)arg1 ;
...
-(void)setTrackpadMode:(BOOL)arg0 animated:(BOOL)arg1 ;
...
-(void)updateStateForKey:(id)arg0 ;
