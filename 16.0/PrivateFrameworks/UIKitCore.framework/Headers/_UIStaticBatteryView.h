...
+(id)_lowBatteryBodyImageWithSize:(struct CGSize )arg0 forScale:(CGFloat)arg1 batteryRect:(struct CGRect )arg2 cornerRadius:(CGFloat)arg3 lineWidth:(CGFloat)arg4 ;
