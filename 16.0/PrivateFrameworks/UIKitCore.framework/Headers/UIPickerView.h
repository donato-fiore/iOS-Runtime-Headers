...
@protocol UIPickerViewScrollTesting, UITableViewDelegate, UIPickerTableViewContainerDelegate, UITableViewDataSource, NSCoding, UIPickerViewDataSource, UIPickerViewDelegate;
...
@property (readonly, nonatomic, getter=_style) _UIPickerViewStyle *style; // ivar: _style
