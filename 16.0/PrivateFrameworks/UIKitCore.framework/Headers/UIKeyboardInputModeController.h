...
@property (weak, nonatomic) NSObject<UIKeyboardInputModeControllerDelegate> *delegate; // ivar: _delegate
@property (nonatomic) BOOL delegateImplementsDictationHandlingMethods; // ivar: _delegateImplementsDictationHandlingMethods
@property (nonatomic) BOOL delegateImplementsLegacyDictationHandlingMethods; // ivar: _delegateImplementsLegacyDictationHandlingMethods
...
-(BOOL)toggleDictationForResponder:(id)arg0 withOption:(id)arg1 firstResponderSetupCompletion:(id)arg2 ;
-(BOOL)verifyKeyboardExtensionsWithApp;
-(NSUInteger)reasonType:(id)arg0 ;
...
-(void)toggleDictationForResponder:(id)arg0 WithOptions:(id)arg1 ;
