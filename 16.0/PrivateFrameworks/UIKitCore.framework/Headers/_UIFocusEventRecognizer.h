...
-(void)_arrowButtonGesturesUpdateForcingRemoval:(BOOL)arg0 studyLogData:(id)arg1 ;
...
-(void)_pageButtonGesturesUpdateForcingRemoval:(BOOL)arg0 studyLogData:(id)arg1 ;
