...
@class NSString;
@protocol _UIPassthroughGestureDelegate, UIInteraction, _UIPassthroughScrollInteractionDelegate;
...
@property (nonatomic) BOOL configuredForInactiveInteractionEventsOnly; // ivar: _configuredForInactiveInteractionEventsOnly
...
-(BOOL)_passthroughGestureRecognizer:(id)arg0 shouldInteractAtLocation:(struct CGPoint )arg1 withEvent:(id)arg2 ;
-(BOOL)_passthroughScrollGestureRecognizerShouldRequireFailureOfGestureRecognizer:(id)arg0 ;
