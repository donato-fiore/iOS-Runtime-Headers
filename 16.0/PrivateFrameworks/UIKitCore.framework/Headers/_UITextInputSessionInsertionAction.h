...
@property (nonatomic) NSUInteger emojiCount; // ivar: _emojiCount
@property (nonatomic) NSUInteger options; // ivar: _options
@property (nonatomic) NSUInteger punctuationCount; // ivar: _punctuationCount
@property (nonatomic) NSUInteger textLength; // ivar: _textLength
@property (nonatomic) NSUInteger withAlternativesCount; // ivar: _withAlternativesCount
