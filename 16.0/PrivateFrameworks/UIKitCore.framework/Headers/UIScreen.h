...
@protocol _UIOrientationDebugDescriptionProviding, _UIFallbackEnvironment, UICoordinateSpace, BSDebugDescriptionProviding, _UITraitEnvironmentInternal, _UIFocusEnvironmentInternal, _UIFocusRegionContainer, UIFocusItemContainer, _UIFocusEnvironmentPrivate, UITraitEnvironment, _UIDisplayInfoProviding, UIFocusItem, UIFocusEnvironment;
...
@interface UIScreen : NSObject <_UIOrientationDebugDescriptionProviding, _UIFallbackEnvironment, UICoordinateSpace, BSDebugDescriptionProviding, _UITraitEnvironmentInternal, _UIFocusEnvironmentInternal, _UIFocusRegionContainer, UIFocusItemContainer, _UIFocusEnvironmentPrivate, UITraitEnvironment>

 {
    ...
    NSInteger _foregroundSceneCount;
...
@property (readonly, nonatomic) CGFloat _displayCornerRadiusIgnoringZoom;
...
@property (readonly, nonatomic) CGFloat currentEDRHeadroom;
...
@property (readonly, nonatomic) CGFloat potentialEDRHeadroom;
...
@property (readonly, nonatomic) NSInteger referenceDisplayModeStatus; // ivar: _referenceDisplayModeStatus
...
-(void)_connectScreen;
-(void)_decrementForegroundSceneCount;
...
-(void)_incrementForegroundSceneCountForScene:(id)arg0 ;
-(void)_invalidate;
...
-(void)_referenceDisplayModeStatusUpdatedWithApplicationSceneSettings:(id)arg0 ;
