...
@property (nonatomic) CGFloat expandedShadowIntensity; // ivar: _expandedShadowIntensity
...
-(CGFloat)_collapsedCornerRadius:(*BOOL)arg0 maskedCorners:(*NSUInteger)arg1 ;
-(CGFloat)_collapsedShadowAlphaForExpansionProgress:(CGFloat)arg0 ;
-(CGFloat)_expandedCornerRadius:(*BOOL)arg0 maskedCorners:(*NSUInteger)arg1 ignoreLiftScale:(BOOL)arg2 ;
