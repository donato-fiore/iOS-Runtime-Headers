...
@property (nonatomic) CGFloat leftContentInsetForInlineSearch; // ivar: _leftContentInsetForInlineSearch
@property (readonly, nonatomic) CGFloat naturalPromptContainerHeight;
@property (readonly, nonatomic) CGFloat naturalScopeContainerHeight;
@property (readonly, nonatomic) CGFloat naturalSearchFieldContainerHeight;
...
@property (readonly, nonatomic) CGFloat prescribedSearchContainerWidth;
...
@property (nonatomic) CGFloat rightContentInsetForInlineSearch; // ivar: _rightContentInsetForInlineSearch
