...
-(id)initWithPersistedIdentifiers:(id)arg0 preferredAnimationType:(NSUInteger)arg1 forDestroyingSession:(BOOL)arg2 userOriginatedRequest:(BOOL)arg3 callbackQueue:(id)arg4 completion:(id)arg5 ;
