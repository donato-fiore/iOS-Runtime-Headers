...
@property (nonatomic) NSDirectionalEdgeInsets contentMargins; // ivar: _contentMargins
...
@property (retain, nonatomic) UIBezierPath *hoverZone; // ivar: _hoverZone
...
@property (nonatomic) NSUInteger parentHierarchyStyle; // ivar: _parentHierarchyStyle
...
-(BOOL)pointIsInsideHoverZone:(struct CGPoint )arg0 ;
...
-(void)_configureCell:(id)arg0 forElement:(id)arg1 section:(id)arg2 size:(NSInteger)arg3 ;
...
-(void)updateHoverZoneWithParentElementRect:(struct CGRect )arg0 ;
