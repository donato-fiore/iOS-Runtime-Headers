...
@protocol NSCopying, TUICandidateViewStyle;
...
@property (nonatomic) BOOL dragGestureDisabled; // ivar: _dragGestureDisabled
...
@property (readonly, nonatomic) UIImage *transliterationCandidateBackgroundImage; // ivar: _transliterationCandidateBackgroundImage


+(BOOL)resolveInstanceMethod:(SEL)arg0 ;
+(id)darkKeyboardStyle;
+(id)darkKeyboardStyleForDisambiguation;
+(id)disambiguationStyleForDarkKeyboard:(BOOL)arg0 ;
+(id)lightKeyboardStyle;
+(id)lightKeyboardStyleForDisambiguation;
+(id)styleForDarkKeyboard:(BOOL)arg0 ;
+(id)tvGridStyleForDarkKeyboard:(BOOL)arg0 ;
+(id)tvLinearStyleForDarkKeyboard:(BOOL)arg0 ;
