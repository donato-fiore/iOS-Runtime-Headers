...
@property (nonatomic, setter=_dci_setIndicator:) NSInteger _dci_indicator;
@property (copy, nonatomic, setter=_dci_setIndicatorColorTransformer:) id *_dci_indicatorColorTransformer;
...
@property (copy, nonatomic) id *indicatorColorTransformer; // ivar: _indicatorColorTransformer
...
-(CGFloat)_resolvedActivityIndicatorSize;
-(CGFloat)_resolvedImageReservation;
-(CGFloat)_resolvedIndicatorPadding;
