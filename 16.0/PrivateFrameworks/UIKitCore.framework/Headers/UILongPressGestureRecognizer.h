...
@property (nonatomic) BOOL _prefersNotToBePreventedByCompetingLongPressGestureRecognizers; // ivar: __prefersNotToBePreventedByCompetingLongPressGestureRecognizers
