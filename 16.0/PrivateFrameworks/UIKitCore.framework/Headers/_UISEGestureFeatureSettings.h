...
@property (nonatomic) CGFloat backProjectTime; // ivar: _backProjectTime
...
@property (nonatomic) CGFloat maximumBackProjectTimeFactor; // ivar: _maximumBackProjectTimeFactor
