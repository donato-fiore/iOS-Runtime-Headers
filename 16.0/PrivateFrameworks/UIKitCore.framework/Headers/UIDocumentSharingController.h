...
@class UIActivityViewController, NSString, NSURL;
...
@property (weak, nonatomic, getter=_privateDelegate, setter=_setPrivateDelegate:) NSObject<_UIDocumentSharingControllerDelegate_Private> *_privateDelegate;
...
@property (retain, nonatomic) NSURL *rootFolderURL; // ivar: _rootFolderURL
...
-(void)_addResizingChildViewController:(id)arg0 ;
