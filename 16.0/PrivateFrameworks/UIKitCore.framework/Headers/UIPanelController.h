...
@protocol UILayoutContainerViewDelegate, UIPanelControllerDelegate, UIViewControllerTransitionCoordinator;
...
@property (retain, nonatomic, setter=_setMaterialThemesCaptureView:) _UIMTCaptureView *_captureView; // ivar: __captureView
