...
-(void)_rebaseFocusedItemWithUpdateItems:(id)arg0 indexPathMapping:(id)arg1 ;
...
-(void)_resignOrRebaseFirstResponderViewWithUpdateItems:(id)arg0 indexPathMapping:(id)arg1 ;
