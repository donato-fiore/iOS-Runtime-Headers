...
@protocol NSCoding, UIGestureRecognizerDelegate, _UIScrollViewScrollObserver_Internal, UIViewControllerTransitioningDelegate, UIViewControllerAnimatedTransitioning, UISearchControllerDelegate, UISearchResultsUpdating, UISearchResultsUpdatingPrivate, UISearchSuggestion;
...
@property (weak, nonatomic, setter=_setNavigationItemCurrentlyDisplayingSearchController:) UINavigationItem *_navigationItemCurrentlyDisplayingSearchController; // ivar: __navigationItemCurrentlyDisplayingSearchController
...
@property (retain, nonatomic, setter=_setSuggestionController:) _UISearchSuggestionController *_suggestionController; // ivar: _suggestionController
@property (readonly, nonatomic) UICollectionView *_suggestionView; // ivar: __suggestionView
@property (readonly, nonatomic) _UISearchSuggestionsListViewController *_suggestionsListViewController; // ivar: _suggestionsListViewController
...
@property (nonatomic) NSInteger scopeBarActivation;
...
@property (retain, nonatomic) NSObject<UISearchSuggestion> *selectedSuggestion;
...
-(void)_ios_searchBar:(id)arg0 textDidChange:(id)arg1 programatically:(BOOL)arg2 ;
...
-(void)_searchBarSearchTextFieldRequirementDidChange:(id)arg0 ;
-(void)_searchBarTextDidBeginEditing:(id)arg0 ;
-(void)_searchBarTextFieldDidSelectSearchSuggestion:(id)arg0 ;
...
-(void)_tvos_searchBar:(id)arg0 textDidChange:(id)arg1 programatically:(BOOL)arg2 ;
...
-(void)_updateHasPendingSuggestionMenuRefreshFlagForReason:(NSInteger)arg0 ;
-(void)_updateKeyboardFocusGuidesForAnimator:(id)arg0 ;
...
-(void)_updateSearchSuggestionsListVisibilityShouldRequestNavigationControllerObservingUpdate:(BOOL)arg0 ;
