...
+(id)registeredFontsInfoForIdentifier:(id)arg0 enabled:(BOOL)arg1 appInfo:(id)arg2 ;
...
+(void)installFonts:(id)arg0 forIdentifier:(id)arg1 enabled:(BOOL)arg2 appInfo:(id)arg3 completionHandler:(id)arg4 ;
+(void)reset;
...
+(void)uninstallFonts:(id)arg0 forIdentifier:(id)arg1 appInfo:(id)arg2 completionHandler:(id)arg3 ;
+(void)unregisterAndRemoveFontFilesForIdentifier:(id)arg0 completionHandler:(id)arg1 ;
+(void)updateAppInfo:(id)arg0 forIdentifier:(id)arg1 ;
