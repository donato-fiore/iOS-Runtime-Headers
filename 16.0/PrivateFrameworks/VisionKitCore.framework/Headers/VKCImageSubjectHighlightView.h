...
@class NSDate, CALayer, UIImageView, NSString, UIDragInteraction, UISelectionFeedbackGenerator, UILongPressGestureRecognizer, UITapGestureRecognizer;
...
@property (nonatomic) NSUInteger glowLayerIndex; // ivar: _glowLayerIndex
