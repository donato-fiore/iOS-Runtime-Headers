...
@class UIButton, UIView, UIVisualEffectView, CABasicAnimation, UIColor, UIFont;
...
@property (retain, nonatomic) UIFont *customSymbolFont; // ivar: _customSymbolFont
...
@property (nonatomic) BOOL supportsDynamicType; // ivar: _supportsDynamicType
