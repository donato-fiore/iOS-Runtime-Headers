...
-(id)initWithRollingWindow:(id)arg0 WithIsInvoluntary:(BOOL)arg1 AndLinkChangeReason:(NSInteger)arg2 AndLinkChangeSubreason:(NSInteger)arg3 AndDuration:(NSUInteger)arg4 andActiveCall:(BOOL)arg5 AndTimestamp:(id)arg6 onQueue:(id)arg7 ;
