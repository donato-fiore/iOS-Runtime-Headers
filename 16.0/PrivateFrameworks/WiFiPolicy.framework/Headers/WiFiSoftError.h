...
@class SDRDiagnosticReporter, NSMutableArray, NSString, NSNumber, NSMutableString;
...
@property (retain, nonatomic) NSNumber *lastTimestamp; // ivar: _lastTimestamp
...
-(BOOL)askToLaunchTapToRadarWithMessage:(id)arg0 completionHandler:(id)arg1 ;
...
-(void)_addConfigurationData:(id)arg0 ;
