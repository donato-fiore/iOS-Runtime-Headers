...
#ifndef TBNETWORKFETCHREQUEST_H
#define TBNETWORKFETCHREQUEST_H
...
@property (retain, nonatomic) TBNetworkFetchRequestDescriptor *descriptor; // ivar: _descriptor
...
+(id)fetchRequestWithDescriptor:(id)arg0 sourcePolicy:(NSUInteger)arg1 ;
