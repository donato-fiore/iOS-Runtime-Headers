...
#ifndef SNUIDEPENDENCYGESTURERECOGNIZER_H
#define SNUIDEPENDENCYGESTURERECOGNIZER_H
...
@interface SNUIDependencyGestureRecognizer : UIGestureRecognizer <UIGestureRecognizerDelegate>
