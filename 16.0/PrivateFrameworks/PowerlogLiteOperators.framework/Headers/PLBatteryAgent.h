...
@class PLAgent, PLTimer, NSNumber, PLXPCListenerOperatorComposition, AVSystemController, PLXPCResponderOperatorComposition, PLEntryNotificationOperatorComposition, PLSemaphore, PLIOKitOperatorComposition, NSString, PLCFNotificationOperatorComposition, NSDate, PLEntry, NSDictionary, NSMutableDictionary, PLMonotonicTimer, PLNSNotificationOperatorComposition, NSMutableArray;
