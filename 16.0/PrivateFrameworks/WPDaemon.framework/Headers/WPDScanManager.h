...
@class CBController, CBCentralManager, NSMutableDictionary, NSIndexSet, NSString, NSMutableSet, NSDictionary, NSSet, NSNumber;
...
@property (retain) NSNumber *scanRetainDuplicates; // ivar: _scanRetainDuplicates
