...
@property (readonly, copy, nonatomic) NSString *errorCorrectionLevel; // ivar: _errorCorrectionLevel
...
-(id)initWithType:(id)arg0 stringValue:(id)arg1 errorCorrectionLevel:(id)arg2 ;
