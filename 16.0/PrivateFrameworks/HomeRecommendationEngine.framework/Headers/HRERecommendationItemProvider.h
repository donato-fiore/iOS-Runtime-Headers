...
@class HFItemProvider, HFAccessoryTypeGroup, HMHome, NSMutableSet, NSArray;
...
@property (readonly, nonatomic) HFAccessoryTypeGroup *accessoryTypeGroup; // ivar: _accessoryTypeGroup
...
-(id)init;
-(id)initWithHome:(id)arg0 andAccessoryTypeGroup:(id)arg1 ;
