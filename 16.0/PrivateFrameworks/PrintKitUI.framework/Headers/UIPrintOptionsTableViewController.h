...
@class UITableViewController, UIViewController<UIPrintAppExtensionProtocol>, NSString, NSArray;
...
@property (retain, nonatomic) UIPrintLayoutSection *layoutSection; // ivar: _layoutSection
...
@property (nonatomic) BOOL showingGatheringPrinterInfo; // ivar: _showingGatheringPrinterInfo
