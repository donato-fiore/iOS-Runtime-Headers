...
-(id)_createGraphViewWithDateZoom:(NSInteger)arg0 previousDateZoom:(NSInteger)arg1 previousXAxisSpace:(CGFloat)arg2 currentCalendar:(id)arg3 customDateAxis:(id)arg4 ;
-(id)_dateAxisStyle;
-(id)_xAxisLabelFont;
...
-(id)initWithDateZoom:(NSInteger)arg0 previousDateZoom:(NSInteger)arg1 previousXAxisSpace:(CGFloat)arg2 currentCalendar:(id)arg3 customDateAxis:(id)arg4 ;
