...
@property (readonly, nonatomic) BOOL chartsRelativeData; // ivar: _chartsRelativeData
...
@property (readonly, nonatomic) NSInteger preferredCalendarDayAlignment; // ivar: _preferredCalendarDayAlignment
...
@property (readonly, nonatomic) BOOL showAppDataHierarchically; // ivar: _showAppDataHierarchically
@property (readonly, nonatomic) NSUInteger statisticsMergeStrategy; // ivar: _statisticsMergeStrategy
@property (readonly, nonatomic) NSString *summary;
@property (readonly, nonatomic) BOOL summaryAttributionForPrimaryProfileOnly; // ivar: _summaryAttributionForPrimaryProfileOnly
...
-(BOOL)hk_supportsMinMaxOverlayForChartSizeClass:(NSInteger)arg0 ;
...
-(id)_aFibBurdenDataSourceWithHealthStore:(id)arg0 quantityType:(id)arg1 dataSourceType:(NSInteger)arg2 unitController:(id)arg3 ;
-(id)_audioLevelDataSourceForTypeIdentfier:(id)arg0 withHealthStore:(id)arg1 attenuatesExposureData:(BOOL)arg2 unitController:(id)arg3 ;
-(id)_audioLevelDataSourceForTypeIdentifier:(id)arg0 withHealthStore:(id)arg1 unitController:(id)arg2 ;
...
-(id)_generateAFibBurdenLineSeriesWithColor:(id)arg0 ;
-(id)_generateBarSeriesWithFillStyle:(id)arg0 ;
-(id)_generateBloodPressureSeriesWithColor:(id)arg0 ;
-(id)_generateGraphSeriesForTimeScope:(NSInteger)arg0 displayCategory:(id)arg1 unitController:(id)arg2 standardAxisConfiguration:(id)arg3 externalAxisConfigurationOverrides:(id)arg4 chartSizeClass:(NSInteger)arg5 ;
...
-(id)_generateLevelCategorySeriesWithColor:(id)arg0 numericAxisConfigurationOverrides:(id)arg1 ;
-(id)_generateMinMaxSeriesWithColor:(id)arg0 opacity:(CGFloat)arg1 unselectedPointStyle:(NSInteger)arg2 selectedPointStyle:(NSInteger)arg3 ;
-(id)_generateRelativeLineSeriesWithColor:(id)arg0 timeScope:(NSInteger)arg1 valueAxisAnnotationFormatter:(id)arg2 chartSizeClass:(NSInteger)arg3 ;
-(id)_generateSingleLineSeriesWithColor:(id)arg0 timeScope:(NSInteger)arg1 numericAxisConfigurationOverrides:(id)arg2 ;
-(id)_generateStackedSeriesWithColor:(id)arg0 numericAxisConfigurationOverrides:(id)arg1 ;
...
-(id)_preprocessingHandlerForUnderwaterDepth:(SEL)arg0 ;
...
-(id)_sleepingWristTemperatureDataSourceForTimeScope:(NSInteger)arg0 unitController:(id)arg1 healthStore:(id)arg2 ;
...
-(id)description;
-(id)generateDistributionSeriesWithColor:(id)arg0 numberFormatter:(id)arg1 hasMinMaxOverlay:(BOOL)arg2 ;
-(id)generateDistributionSeriesWithColor:(id)arg0 numberFormatter:(id)arg1 lineWidth:(CGFloat)arg2 hasMinMaxOverlay:(BOOL)arg3 ;
-(id)generateLineSeriesWithColor:(id)arg0 timeScope:(NSInteger)arg1 ;
-(id)generateLineSeriesWithColor:(id)arg0 timeScope:(NSInteger)arg1 valueAxisAnnotationFormatter:(id)arg2 ;
-(id)generateScatterPlotSeriesWithColor:(id)arg0 ;
-(id)hk_axisScalingRuleForChartSizeClass:(NSInteger)arg0 unitController:(id)arg1 ;
...
-(id)hk_defaultChartAxisBoundStringFromValue:(id)arg0 defaultNumberFormatter:(id)arg1 unitController:(id)arg2 ;
...
-(id)hk_standardSeriesForTimeScope:(NSInteger)arg0 displayCategory:(id)arg1 unitController:(id)arg2 dataCacheController:(id)arg3 displayCategoryController:(id)arg4 numericAxisConfigurationOverrides:(id)arg5 ;
-(id)hk_standardSeriesForTimeScope:(NSInteger)arg0 displayCategory:(id)arg1 unitController:(id)arg2 dataCacheController:(id)arg3 displayCategoryController:(id)arg4 numericAxisConfigurationOverrides:(id)arg5 chartSizeClass:(NSInteger)arg6 ;
...
-(id)hk_standardSeriesForTimeScope:(NSInteger)arg0 graphSeriesDataSource:(id)arg1 displayCategory:(id)arg2 unitController:(id)arg3 dataCacheController:(id)arg4 displayCategoryController:(id)arg5 numericAxisConfigurationOverrides:(id)arg6 ;
-(id)hk_standardSeriesForTimeScope:(NSInteger)arg0 graphSeriesDataSource:(id)arg1 displayCategory:(id)arg2 unitController:(id)arg3 dataCacheController:(id)arg4 displayCategoryController:(id)arg5 numericAxisConfigurationOverrides:(id)arg6 chartSizeClass:(NSInteger)arg7 ;
...
-(id)unattenuatedAudioLevelDataSourceForTypeIdentifier:(id)arg0 withHealthStore:(id)arg1 unitController:(id)arg2 ;
...
-(void)_assignAFibBurdenAxisForSeries:(id)arg0 standardAxisConfiguration:(id)arg1 externalAxisConfigurationOverrides:(id)arg2 ;
