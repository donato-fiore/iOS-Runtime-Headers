...
@property (retain, nonatomic) NSDictionary *horizontalLineStylesStorage; // ivar: _horizontalLineStylesStorage
@property (readonly, nonatomic) NSLock *seriesMutableStateLock; // ivar: _seriesMutableStateLock
@property (nonatomic) CGFloat valueOutlineWidth;
@property (nonatomic) CGFloat valueOutlineWidthStorage; // ivar: _valueOutlineWidthStorage
...
-(id)init;
-(struct CGRect )_boundsForString:(id)arg0 coordinate:(id)arg1 valueAttributes:(id)arg2 rectsToAvoid:(id)arg3 ;
