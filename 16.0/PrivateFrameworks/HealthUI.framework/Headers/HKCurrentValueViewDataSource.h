...
@class NSMutableArray, NSString, UILabel, HKHealthStore, UIFont, NSArray, UIColor;
...
@property (retain, nonatomic) NSMutableArray *annotationLabels; // ivar: _annotationLabels
...
-(void)_updateAnnotationLabels:(id)arg0 fromRangeData:(id)arg1 displayType:(id)arg2 ;
