...
-(struct CGSize )drawText:(id)arg0 atPoint:(struct CGPoint )arg1 spaceAvailable:(id)arg2 horizontalAlignment:(NSInteger)arg3 verticalAlignment:(NSInteger)arg4 hyphenationFactor:(id)arg5 textColor:(id)arg6 font:(id)arg7 clipToAxis:(BOOL)arg8 exclusion:(id)arg9 ;
