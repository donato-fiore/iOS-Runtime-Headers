...
@property (weak, nonatomic) NSObject<HKCurrentOverlayLocationProviding> *currentOverlayLocationProvider; // ivar: _currentOverlayLocationProvider
...
@property (weak, nonatomic) NSObject<HKTrendAccessibilityDelegate> *trendAccessibilityDelegate; // ivar: _trendAccessibilityDelegate
...
-(id)_trendCoordinateDescriptionForStartX:(CGFloat)arg0 endX:(CGFloat)arg1 timeScope:(NSInteger)arg2 graphView:(id)arg3 ;
...
-(id)dateForXCoordinate:(CGFloat)arg0 graphView:(id)arg1 ;
...
-(void)replaceCurrentDisplayTypesWithTypes:(id)arg0 stackOffset:(NSInteger)arg1 resetDateRange:(BOOL)arg2 automaticAutoScale:(BOOL)arg3 ;
