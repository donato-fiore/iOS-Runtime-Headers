...
-(id)initWithDisplayTypeController:(id)arg0 unitController:(id)arg1 wheelchairUseCharacteristicCache:(id)arg2 currentValueViewContext:(BOOL)arg3 firstWeekday:(NSInteger)arg4 activityOptions:(NSUInteger)arg5 currentValueViewCallbacks:(id)arg6 ;
