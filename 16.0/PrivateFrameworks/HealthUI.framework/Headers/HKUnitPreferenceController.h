...
+(id)_localizedHealthUIStringForDisplayType:(id)arg0 unit:(id)arg1 key:(id)arg2 value:(id)arg3 ;
+(id)localizedUnitStringForObjectType:(id)arg0 unit:(id)arg1 value:(id)arg2 wheelchairUse:(NSInteger)arg3 ;
...
-(id)unitForChartingDisplayType:(id)arg0 ;
