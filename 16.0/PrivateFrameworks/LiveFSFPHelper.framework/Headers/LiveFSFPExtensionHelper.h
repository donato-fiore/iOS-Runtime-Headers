...
@class NSFileProviderExtension, NSString, NSMapTable, LiveFSLRUCache, NSXPCConnection, NSURL, LiveFSClient, LiveFSVolumeClient;
...
@property (readonly) NSObject<OS_dispatch_queue> *enumeratorHelperQueue; // ivar: _enumeratorHelperQueue
...
@property (readonly, nonatomic) LiveFSVolumeClient *serviceClient; // ivar: _serviceClient
