...
@class NSString, NSDate, NSMutableDictionary, NSData, NSNumber, NSArray, UTType, NSError, NSDictionary, NSURL, NSPersonNameComponents, NSSet, NSMapTable, NSFileProviderItemVersion;
