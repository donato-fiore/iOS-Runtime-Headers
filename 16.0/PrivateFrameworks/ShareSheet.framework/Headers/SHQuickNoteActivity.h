...
@class NSString, NSArray, UIViewController<ICSystemPaperExtensionHostViewController>;
...
@property (copy, nonatomic) NSString *_activityTitle; // ivar: __activityTitle
...
-(void)_didExecuteQueryWithResults:(id)arg0 ;
