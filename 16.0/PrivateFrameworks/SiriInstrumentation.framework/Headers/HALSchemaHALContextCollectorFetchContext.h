...
@property (retain, nonatomic) HALSchemaHALContextCollectorFetchEnded *ended; // ivar: _ended
@property (retain, nonatomic) HALSchemaHALContextCollectorFetchFailed *failed; // ivar: _failed
...
@property (retain, nonatomic) HALSchemaHALContextCollectorFetchStarted *startedOrChanged; // ivar: _startedOrChanged
