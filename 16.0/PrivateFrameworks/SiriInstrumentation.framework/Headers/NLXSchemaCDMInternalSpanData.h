...
@property (retain, nonatomic) NLXSchemaContextualSpanData *contextualSpanData; // ivar: _contextualSpanData
@property (nonatomic) BOOL hasContextualSpanData; // ivar: _hasContextualSpanData
