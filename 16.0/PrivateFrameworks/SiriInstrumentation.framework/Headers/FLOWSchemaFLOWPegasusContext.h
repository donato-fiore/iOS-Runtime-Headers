...
@property (nonatomic) BOOL hasMapsExecution; // ivar: _hasMapsExecution
...
@property (retain, nonatomic) FLOWSchemaFLOWMapsExecution *mapsExecution; // ivar: _mapsExecution
