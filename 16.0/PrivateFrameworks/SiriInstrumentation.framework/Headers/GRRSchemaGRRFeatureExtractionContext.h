...
#ifndef GRRSCHEMAGRRFEATUREEXTRACTIONCONTEXT_H
#define GRRSCHEMAGRRFEATUREEXTRACTIONCONTEXT_H
...
@property (retain, nonatomic) GRRSchemaGRRFeatureExtracted *ended; // ivar: _ended
...
@property (retain, nonatomic) GRRSchemaGRRFeatureExtractionStarted *startedOrChanged; // ivar: _startedOrChanged
