...
#ifndef NLXSCHEMAMARRSCONTEXTUALSPANMATCHERENDED_H
#define NLXSCHEMAMARRSCONTEXTUALSPANMATCHERENDED_H
...
@property (copy, nonatomic) NSArray *contextualSpans; // ivar: _contextualSpans
