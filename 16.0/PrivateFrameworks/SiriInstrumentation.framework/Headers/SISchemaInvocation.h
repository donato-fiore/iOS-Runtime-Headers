...
@property (retain, nonatomic) SISchemaHardwareButtonInvocationContext *hardwareButtonInvocationContext; // ivar: _hardwareButtonInvocationContext
...
@property (nonatomic) BOOL hasHardwareButtonInvocationContext; // ivar: _hasHardwareButtonInvocationContext
