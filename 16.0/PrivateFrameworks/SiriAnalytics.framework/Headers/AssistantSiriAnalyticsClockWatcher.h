...
-(id)init;
-(id)initWithInternalTelemetry:(id)arg0 sensitiveConditionsObservers:(id)arg1 clientMessageStream:(id)arg2 preprocessor:(id)arg3 ;
...
-(void)whiteRose:(id)arg0 rootClockDestroyed:(id)arg1 completion:(id)arg2 ;
