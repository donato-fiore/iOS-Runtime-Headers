...
@class NSString, NSData, WBSCRDTField, WBSCRDTGeneration, NSNumber, NSDate, NSDictionary, NSArray, WBSCRDTPosition;
...
-(id)initFolderWithParentID:(int)arg0 deviceIdentifier:(id)arg1 ;
-(id)initFolderWithParentID:(int)arg0 subtype:(NSInteger)arg1 deviceIdentifier:(id)arg2 ;
...
-(id)initWithSQLiteStatement:(struct sqlite3_stmt *)arg0 deviceIdentifier:(id)arg1 ;
-(id)initWithSQLiteStatement:(struct sqlite3_stmt *)arg0 deviceIdentifier:(id)arg1 hasIcon:(BOOL)arg2 ;
-(id)initWithTitle:(id)arg0 address:(id)arg1 ;
-(id)initWithTitle:(id)arg0 address:(id)arg1 parentID:(int)arg2 ;
-(id)initWithTitle:(id)arg0 address:(id)arg1 parentID:(int)arg2 deviceIdentifier:(id)arg3 ;
-(id)initWithTitle:(id)arg0 address:(id)arg1 parentID:(int)arg2 folder:(BOOL)arg3 deviceIdentifier:(id)arg4 ;
-(id)initWithTitle:(id)arg0 address:(id)arg1 parentID:(int)arg2 subtype:(NSInteger)arg3 deviceIdentifier:(id)arg4 ;
...
-(void)_mergeFields:(id)arg0 withFields:(id)arg1 forBookmark:(id)arg2 ;
