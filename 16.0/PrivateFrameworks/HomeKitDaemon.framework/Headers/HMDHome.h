...
#import "HMDMediaGroupsController.h"
...
#import "HMDMediaGroupSettingsController.h"
...
@property (readonly, copy) NSArray *audioGroups; // ivar: _audioGroups
@property (retain) HMDMediaGroupsController *audioGroupsController; // ivar: _audioGroupsController
@property (readonly, copy) NSArray *audioGroupsWithoutMediaSystems;
...
@property (retain) HMDMediaGroupSettingsController *mediaGroupSettingsController; // ivar: _mediaGroupSettingsController
...
-(id)_removeUserFromNewlyPairedAcccessoryServer:(id)arg0 user:(id)arg1 ;
...
-(id)destinationManagersForMediaGroupsController:(id)arg0 ;
...
-(id)mediaGroupsController:(id)arg0 targetAccessoriesForDestinationIdentifiers:(id)arg1 ;
-(id)mediaPassword;
...
-(id)roomForAllAccessoryUUIDs:(id)arg0 ;
...
-(id)routerForMediaGroupsMessageHandler:(id)arg0 ;
...
-(void)__handleAcceptedOutgoingInvitationResponse:(id)arg0 destinationAddress:(id)arg1 publicKey:(id)arg2 username:(id)arg3 reverseShare:(id)arg4 presenceAuthStatus:(id)arg5 completionHandler:(id)arg6 ;
...
-(void)_handleUpdateRequestForHomeInvitation:(id)arg0 controllerPublicKey:(id)arg1 controllerUsername:(id)arg2 invitationState:(NSInteger)arg3 presenceAuthStatus:(id)arg4 preferredUserID:(id)arg5 fromHandle:(id)arg6 fromAddress:(id)arg7 reverseShareURL:(id)arg8 reverseShareToken:(id)arg9 message:(id)arg10 messageResponseHandler:(id)arg11 ;
...
-(void)_updateOwnerSettingDependants:(id)arg0 keyPath:(id)arg1 value:(id)arg2 ;
...
-(void)configureAudioGroupsController;
...
-(void)handleAcceptRequestForIDSInvitationWithIdentifier:(id)arg0 payload:(id)arg1 fromAddress:(id)arg2 ;
