...
-(id)initWithThreshold:(NSUInteger)arg0 windowSize:(NSUInteger)arg1 counterName:(id)arg2 ;
-(id)initWithThreshold:(NSUInteger)arg0 windowSize:(NSUInteger)arg1 counterName:(id)arg2 uploadImmediately:(BOOL)arg3 ;
// -(id)initWithThreshold:(NSUInteger)arg0 windowSize:(NSUInteger)arg1 counterName:(id)arg2 uploadImmediately:(BOOL)arg3 timeSourceBlock:(id)arg4 loggingBlock:(unk)arg5  ;
-(void)dealloc;
