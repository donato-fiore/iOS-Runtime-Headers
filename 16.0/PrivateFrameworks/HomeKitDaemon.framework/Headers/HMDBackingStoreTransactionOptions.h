...
+(id)optionsWithSource:(NSUInteger)arg0 destination:(NSUInteger)arg1 mustReplay:(BOOL)arg2 mustPush:(BOOL)arg3 mustSaveArchiveAtomically:(BOOL)arg4 cdTransactionAuthor:(NSUInteger)arg5 ;
