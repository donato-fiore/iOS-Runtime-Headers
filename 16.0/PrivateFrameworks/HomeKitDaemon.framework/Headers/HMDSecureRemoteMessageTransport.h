...
@protocol HMDSecureRemoteSessionDelegate, HMFLogging, HMFMessageTransportDelegate, HMFDumpState, OS_dispatch_queue, HMDSecureRemoteMessageTransportDataSource, HMDUserDeviceCapabilitiesRequestManager;
