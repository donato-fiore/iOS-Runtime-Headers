...
-(id)init;
-(id)initWithMigratorRecord:(id)arg0 coreData:(id)arg1 cloudTransform:(id)arg2 backgroundOperationManager:(id)arg3 defaultDatabase:(id)arg4 cameraClipsDatabase:(id)arg5 ;
...
-(void)_saveSharedUserAccessCodeOnOutgoingInvitation:(id)arg0 context:(id)arg1 ;
