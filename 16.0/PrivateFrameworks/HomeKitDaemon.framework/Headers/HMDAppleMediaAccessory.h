...
@class HMMediaDestination, HMMediaDestinationControllerData, HMAccessoryCapabilities, NSString, NSData, HMFPairingIdentity, HMFWiFiNetworkInfo, NSNotificationCenter, HMFActivity, HMFSoftwareVersion, NSArray, HMFWiFiManager;
...
#import "HMDAppleMediaAccessorySupportedStereoPairVersionsMigrator.h"
...
@property (readonly) HMDAppleMediaAccessorySupportedStereoPairVersionsMigrator *supportedStereoPairVersionsMigrator; // ivar: _supportedStereoPairVersionsMigrator
...
-(id)initalizeSupportedStereoPairVersionsMigrator;
...
-(void)configureSupportedStereoPairVersionsMigrator;
