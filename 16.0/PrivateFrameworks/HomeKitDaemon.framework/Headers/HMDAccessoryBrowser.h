...
@class HMFObject, NSMutableSet, NSHashTable, NSMutableArray, NSArray, HAPAccessoryServerBrowserBTLE, CHIPAccessoryServerBrowser, NSString, HAPAccessoryServerBrowser, HAPAccessoryServerBrowserIP, HMFMessageDispatcher, NSUUID, HMFTimer, NSData;
...
@property (nonatomic) BOOL unitTestEnableWHB; // ivar: _unitTestEnableWHB
...
-(void)updateRemoteAccessoryBrowsing:(BOOL)arg0 whbScan:(BOOL)arg1 ;
