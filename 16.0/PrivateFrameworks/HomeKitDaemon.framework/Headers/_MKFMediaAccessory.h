...
@class MKFAccessory, NSNumber, NSArray, NSString, NSUUID, NSData, NSDate;
@protocol HMDNSManagedObjectBackingStoreModelObjectRepresentable, MKFMediaAccessory, MKFMediaAccessoryPrivateExtensions, MKFApplicationData, MKFHome, MKFAccessory, MKFRoom, MKFSoftwareUpdate;
