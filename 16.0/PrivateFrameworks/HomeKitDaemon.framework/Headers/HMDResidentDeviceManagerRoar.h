...
@property (retain) HMFFuture *primaryDiscoveryResultFuture; // ivar: _primaryDiscoveryResultFuture
...
-(void)_handleCurrentResidentDeviceRemoved:(id)arg0 currentPrimary:(id)arg1 ;
...
-(void)_handleUpdatedPrimaryResidentDevice:(id)arg0 previousPrimaryResident:(id)arg1 ;
-(void)_joinLocalMesh;
...
-(void)_setPrimaryResident:(id)arg0 reachable:(BOOL)arg1 andNotify:(BOOL)arg2 ;
...
-(void)handlePrimaryResidentDiscovered:(id)arg0 ;
-(void)invalidate;
...
-(void)primaryResidentDiscoveryManager:(id)arg0 didDiscoverPrimaryResident:(id)arg1 ;
