...
+(id)logCategory;
-(id)initWithHome:(id)arg0 notificationCenter:(id)arg1 persistence:(id)arg2 ;
-(id)initWithHome:(id)arg0 notificationCenter:(id)arg1 persistence:(id)arg2 isResidentCapable:(BOOL)arg3 ;
-(id)logIdentifier;
