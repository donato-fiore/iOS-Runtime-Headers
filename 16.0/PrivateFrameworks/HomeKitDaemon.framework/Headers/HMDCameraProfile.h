...
-(id)initWithAccessory:(id)arg0 services:(id)arg1 recordingManagementService:(id)arg2 msgDispatcher:(id)arg3 settingsManager:(id)arg4 workQueue:(id)arg5 uniqueIdentifier:(id)arg6 clipManager:(id)arg7 clipUserNotificationCenter:(id)arg8 reachabilityEventManager:(id)arg9 networkMonitor:(id)arg10 streamSnapshotHandler:(id)arg11 snapshotManager:(id)arg12 cameraStreamManagers:(id)arg13 notificationCenter:(id)arg14 ;
-(id)initWithAccessory:(id)arg0 services:(id)arg1 recordingManagementService:(id)arg2 msgDispatcher:(id)arg3 settingsManager:(id)arg4 workQueue:(id)arg5 uniqueIdentifier:(id)arg6 clipManager:(id)arg7 clipUserNotificationCenter:(id)arg8 reachabilityEventManager:(id)arg9 networkMonitor:(id)arg10 streamSnapshotHandler:(id)arg11 snapshotManager:(id)arg12 cameraStreamManagers:(id)arg13 notificationCenter:(id)arg14 significantEventFilter:(id)arg15 ;
...
-(void)addIncomingSignificantEventNotificationWithUUID:(id)arg0 date:(id)arg1 ;
...
-(void)notificationManager:(id)arg0 didReceiveNotificationForCameraSignificantEventIdentifier:(id)arg1 ;
