...
@class MKFModel, NSArray, NSSet, NSNumber, NSString, NSUUID, NSDictionary, HAPPairingIdentity, NSDate, CKRecordID;
@protocol HMDNSManagedObjectBackingStoreModelObjectRepresentable, MKFUser, MKFUserPrivateExtensions, MKFUserAccessCode, MKFHome, MKFPresenceEvent;
...
@property (retain, nonatomic) NSSet *accessCodeChangedBy_;
