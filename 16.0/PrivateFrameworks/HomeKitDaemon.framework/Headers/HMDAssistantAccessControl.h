...
@protocol HMFLogging, HMFObject, NSSecureCoding, HMDBackingStoreObjectProtocol, OS_dispatch_queue, HMDUserAccessorySettingsDataController;
...
@property (weak, nonatomic) NSObject<HMDUserAccessorySettingsDataController> *settingsController; // ivar: _settingsController
...
+(id)accessControlWithMessage:(id)arg0 user:(id)arg1 currentAccessories:(id)arg2 error:(*id)arg3 ;
+(id)logCategory;
...
-(void)configureWithSettingsController:(id)arg0 ;
-(void)dealloc;
