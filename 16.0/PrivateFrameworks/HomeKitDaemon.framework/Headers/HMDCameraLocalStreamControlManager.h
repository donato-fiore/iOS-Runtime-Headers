...
-(id)initWithSessionID:(id)arg0 workQueue:(id)arg1 streamSnapshotHandler:(id)arg2 reachabilityPath:(NSUInteger)arg3 device:(id)arg4 delegate:(id)arg5 delegateQueue:(id)arg6 accessory:(id)arg7 streamManagementService:(id)arg8 localNetworkConfig:(id)arg9 remoteCapabilities:(id)arg10 supportedConfigCache:(id)arg11 streamPreference:(id)arg12 ;
