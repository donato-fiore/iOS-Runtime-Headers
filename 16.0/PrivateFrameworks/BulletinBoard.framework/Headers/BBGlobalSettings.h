...
@property (nonatomic) NSInteger globalNotificationListDisplayStyleSetting; // ivar: _globalNotificationListDisplayStyleSetting
...
-(id)initWithContentPreviewSetting:(NSInteger)arg0 announceSetting:(NSInteger)arg1 announceHeadphonesSetting:(NSInteger)arg2 announceCarPlaySetting:(NSInteger)arg3 scheduledDeliverySetting:(NSInteger)arg4 scheduledDeliveryTimes:(id)arg5 scheduledDeliveryShowNextSummarySetting:(NSInteger)arg6 notificationListDisplayStyleSetting:(NSInteger)arg7 ;
