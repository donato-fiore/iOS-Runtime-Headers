...
-(void)resignActive;
-(void)sdk_addItemWithSagaID:(NSInteger)arg0 toPlaylistWithPersistentID:(NSInteger)arg1 completionHandler:(id)arg2 ;
...
-(void)sdk_setPlaylistProperties:(id)arg0 trackList:(id)arg1 forPlaylistPersistentID:(NSInteger)arg2 completionHandler:(id)arg3 ;
