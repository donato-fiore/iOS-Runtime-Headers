...
-(void)generateSubscriptionLeaseRequestWithAccountUniqueID:(NSUInteger)arg0 transactionType:(unsigned int)arg1 certificateData:(id)arg2 assetIDData:(id)arg3 completionHandler:(id)arg4 ;
