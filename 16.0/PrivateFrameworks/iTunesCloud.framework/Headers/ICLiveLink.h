...
@property (nonatomic) BOOL expectingToJoinAsInitiator; // ivar: _expectingToJoinAsInitiator
@property (copy, nonatomic) NSString *expectingToJoinStartItemIdentifier; // ivar: _expectingToJoinStartItemIdentifier
...
-(void)_didReceiveCurrentItemTransitionAction:(id)arg0 completion:(id)arg1 ;
...
-(void)_didReceiveQueueSyncAction:(id)arg0 completion:(id)arg1 ;
...
-(void)_handleUpdatedQueue:(id)arg0 playbackControlSettings:(id)arg1 serverQueueContext:(id)arg2 ;
...
-(void)_updatePlaybackControlSettingsWithReason:(id)arg0 completion:(id)arg1 ;
...
-(void)expectingToJoinWithStartItem:(id)arg0 asInitiator:(BOOL)arg1 ;
-(void)fetchPlaybackSyncStateForMediumWithCompletion:(id)arg0 ;
