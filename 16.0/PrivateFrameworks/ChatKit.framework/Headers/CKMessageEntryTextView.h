...
@class EMKTextView, NSAttributedString, NSString, UIColor, UILabel, UIKeyboardInputMode, UIScribbleInteraction;
@protocol UIScribbleInteractionDelegate, UIGestureRecognizerDelegate;
