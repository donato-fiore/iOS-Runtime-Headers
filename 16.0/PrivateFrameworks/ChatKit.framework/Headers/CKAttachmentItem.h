...
@property (readonly, nonatomic) NSURL *appendedBundleURL; // ivar: _appendedBundleURL
...
-(id)getIrisVideoPath;
-(id)imageData;
-(id)initWithFileURL:(id)arg0 size:(struct CGSize )arg1 transferGUID:(id)arg2 guid:(id)arg3 createdDate:(id)arg4 shareURL:(id)arg5 ;
-(id)pasteboardItem;
