...
-(id)summaryAttributedStringForContentScale:(NSInteger)arg0 userInterfaceStyle:(NSInteger)arg1 ;
-(id)summaryLabelFontForContentScale:(NSInteger)arg0 ;
-(id)summaryLabelTextColorForUserInterfaceStyle:(NSInteger)arg0 ;
