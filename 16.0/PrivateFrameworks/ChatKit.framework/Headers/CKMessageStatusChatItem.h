...
-(id)_styledStatusTextWithStatusText:(id)arg0 orientation:(char)arg1 dateSubText:(id)arg2 buttonSubText:(id)arg3 errorSubText:(id)arg4 overrideTextColor:(id)arg5 shouldReplaceWarningIcon:(BOOL)arg6 ;
