...
@class UIScrollView, NSDictionary, UIButton, NSArray, _SWCollaborationShareOptions, NSString, UIFont, UIView, UIViewController<CKPluginEntryViewController>, IMPluginPayload;
