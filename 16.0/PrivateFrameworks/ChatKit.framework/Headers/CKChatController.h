...
@class UIToolbar, CKAudioTrimViewController, IMScheduledUpdater, NSArray, UIViewController, UINavigationController, CNContactPickerViewController, STConversationContext, NSString, UIViewController<CKEffectPickerViewControllerProtocol>, UIWindow, IMPluginPayload, SGFoundInSuggestionPresenter, UIImagePickerController, UIView, UIMenu, UIKeyboardInputMode, SGSuggestionPresenter, CADisplayLink, NSLayoutConstraint, UIView<SGBannerProtocol>, UITapGestureRecognizer, TPKContent, TPKContentController, TPKContentPopoverViewController, NSNumber, UIContextMenuInteraction;
...
-(BOOL)_throwAnimationUsesAnimatedReloadForMessages:(id)arg0 ;
...
-(id)_collaborationMetadataForURL:(id)arg0 forChatGUID:(id)arg1 ;
...
-(id)_messageGUIDForShareURL:(id)arg0 forChatGUID:(id)arg1 ;
...
-(id)updateCollaborationMetadata:(id)arg0 fromCKShare:(id)arg1 ckAppBundleIDs:(id)arg2 ;
-(id)updateCollaborationMetadata:(id)arg0 withTitle:(id)arg1 contentType:(id)arg2 ckAppBundleIDs:(id)arg3 ;
...
-(void)_keyCommandDeleteConversation:(id)arg0 ;
-(void)_kickPhotoKit;
...
-(void)_updateAndSendCompositionForFileProvider:(id)arg0 share:(id)arg1 completion:(id)arg2 ;
...
-(void)sendCompositionForFileProvider3rdParty:(id)arg0 shelfPluginPayload:(id)arg1 completion:(id)arg2 ;
