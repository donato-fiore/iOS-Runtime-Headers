...
+(id)tapBackBubblePathForSize:(struct CGSize )arg0 tapbackBalloonFrame:(struct CGRect )arg1 flipHorizontally:(BOOL)arg2 flipVertically:(BOOL)arg3 ;
+(struct CGRect )largeTailBalloonFrameForSize:(struct CGSize )arg0 flipHorizontally:(BOOL)arg1 flipVertically:(BOOL)arg2 ;
+(struct CGRect )smallTailBalloonFrameForSize:(struct CGSize )arg0 flipHorizontally:(BOOL)arg1 flipVertically:(BOOL)arg2 ;
+(struct CGRect )tapbackBalloonFrameForSize:(struct CGSize )arg0 flipHorizontally:(BOOL)arg1 flipVertically:(BOOL)arg2 ;
+(struct CGSize )largeTailBalloonSizeForSize:(struct CGSize )arg0 ;
+(struct CGSize )sizeThatFits:(struct CGSize )arg0 flipHorizontally:(BOOL)arg1 flipVertically:(BOOL)arg2 ;
