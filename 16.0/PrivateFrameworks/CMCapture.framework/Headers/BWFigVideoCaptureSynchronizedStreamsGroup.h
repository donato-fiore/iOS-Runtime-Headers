...
-(id)initWithSynchronizedStreamsGroup:(id)arg0 activeStreams:(id)arg1 readOnly:(BOOL)arg2 baseZoomFactorOverrides:(id)arg3 clientBaseZoomFactorsByPortType:(id)arg4 error:(*int)arg5 ;
