...
-(id)bindPixelBufferToMTL2DTexture:(struct __CVBuffer *)arg0 pixelFormat:(NSUInteger)arg1 usage:(NSUInteger)arg2 plane:(NSUInteger)arg3 widthAlignmentFactor:(NSUInteger)arg4 heightAlignmentFactor:(NSUInteger)arg5 ;
...
-(id)bindPixelBufferToMTLBuffer:(struct __CVBuffer *)arg0 ;
-(id)computePipelineStateFor:(id)arg0 constants:(id)arg1 ;
-(id)create2DTextureFromBuffer:(id)arg0 offset:(NSUInteger)arg1 stride:(NSUInteger)arg2 width:(int)arg3 height:(int)arg4 format:(NSUInteger)arg5 usage:(NSUInteger)arg6 ;
...
-(id)initWithoutLibraryUsingOptionalCommandQueue:(id)arg0 ;
