...
@property (retain, nonatomic) CLPLOGENTRYVISIONVIOEstimation *vioEstimation; // ivar: _vioEstimation
@property (retain, nonatomic) CLPLOGENTRYVISIONVLLocalizationResult *vlLocalizationResult; // ivar: _vlLocalizationResult
@property (retain, nonatomic) CLPIndoorWifiScan *wifiScan; // ivar: _wifiScan
@property (retain, nonatomic) CLPWorkoutUpdateMotionActivity *workoutUpdateMotionActivity; // ivar: _workoutUpdateMotionActivity
