...
@class UIViewController, NSString, NSLayoutConstraint, UIView, UIColor, NSURL, BNBannerSourceLayoutDescription, UIView<SBUISystemApertureAccessoryView>, UIViewController<SBUISystemApertureElement>;
...
+(id)_bundleID;
-(id)initWithContentHeight:(CGFloat)arg0 enrollView:(id)arg1 destination:(NSInteger)arg2 ;
