...
@class BiometricKitIdentity, NSDate, NSTimer, NSString, UIView, UILabel, BiometricKit, BKDeviceTouchID, BKEnrollTouchIDOperation, BKExtendEnrollTouchIDOperation, BKIdentity;
