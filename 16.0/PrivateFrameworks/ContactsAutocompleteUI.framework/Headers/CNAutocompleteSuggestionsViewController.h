...
@property (nonatomic) NSDirectionalEdgeInsets additionalContentInsets; // ivar: _additionalContentInsets
...
-(void)setAdditionalContentInset:(struct NSDirectionalEdgeInsets )arg0 ;
