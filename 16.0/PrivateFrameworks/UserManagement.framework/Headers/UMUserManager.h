...
@protocol UMUserManagement, UMUserSwitchManagement, UMUserPersonaManagement, UMUserPersonaAttributesList, UMUserPersonaLoginSessionManagement, UMUserSessionProvisioning, UMUserVolumeMigration, UMUserListUpdateObserver, UMUserPersonaUpdateObserver;
...
-(BOOL)migrateSharedAndPrimaryUserVolumeWithError:(*id)arg0 ;
