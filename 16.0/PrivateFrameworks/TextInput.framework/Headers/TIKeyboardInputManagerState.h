...
@property (nonatomic) BOOL hasSupplementalPrefix; // ivar: _hasSupplementalPrefix
...
@property (copy, nonatomic) TICharacterSetDescription *supplementalLexiconWordExtraCharacters; // ivar: _supplementalLexiconWordExtraCharacters
