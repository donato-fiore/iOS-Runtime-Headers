...
typedef struct CPPDFGraphicState {
} // Error Processing Struct Fields

typedef struct CPPDFContext {
} // Error Processing Struct Fields

typedef struct CPPDFClipSequence {
} // Error Processing Struct Fields
