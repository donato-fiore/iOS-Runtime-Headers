...
@property (readonly, retain) IMDAttachmentStore *attachmentStore; // ivar: _attachmentStore
...
+(void)addLockdownCommandHandlersToRegistry:(id)arg0 ;
+(void)addStandardCommandHandlersToRegistry:(id)arg0 ;
-(id)broadcaster;
-(id)init;
-(id)initWithiMessageService:(id)arg0 bizChatService:(id)arg1 incomingMessageHandler:(id)arg2 messageStore:(id)arg3 chatRegistry:(id)arg4 accountController:(id)arg5 messageSuppressionController:(id)arg6 storageController:(id)arg7 recentsController:(id)arg8 attachmentStore:(id)arg9 ;
