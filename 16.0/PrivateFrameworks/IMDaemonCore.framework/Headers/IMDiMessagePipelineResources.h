...
-(id)initWithIMDAccount:(id)arg0 service:(id)arg1 messageStore:(id)arg2 storageController:(id)arg3 broadcaster:(id)arg4 messageSuppressionController:(id)arg5 recentsController:(id)arg6 chatRegistry:(id)arg7 attachmentStore:(id)arg8 ;
