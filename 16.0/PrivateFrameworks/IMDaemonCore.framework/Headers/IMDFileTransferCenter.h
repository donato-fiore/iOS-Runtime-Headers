...
-(BOOL)_shouldDownloadAssetForTransferCK:(id)arg0 forMessageItem:(id)arg1 ;
-(BOOL)_shouldUpdateSyncStats:(id)arg0 originalSyncState:(NSInteger)arg1 ;
-(BOOL)_shouldUpdateSyncStatsCK:(id)arg0 originalSyncState:(NSInteger)arg1 ;
...
-(id)updateTransfersWithCKRecordCK:(id)arg0 recordWasFetched:(BOOL)arg1 downloadAsset:(*BOOL)arg2 ;
...
-(void)_updateSyncStatsForAttachmentsCK:(id)arg0 incrementTotalAttachmentCount:(NSUInteger)arg1 ;
...
-(void)markTransferAsNotSuccessfullyDownloadedFromCloudCK:(id)arg0 ;
-(void)markTransferAsNotSyncedSuccessfully:(id)arg0 ;
-(void)markTransferAsNotSyncedSuccessfullyCK:(id)arg0 ;
...
-(void)resetSyncStateForRecordCK:(id)arg0 toState:(NSInteger)arg1 ;
