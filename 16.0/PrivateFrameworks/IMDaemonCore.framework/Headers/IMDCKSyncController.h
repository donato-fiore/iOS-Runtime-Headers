...
-(void)_clearTombstonesWithActivity:(id)arg0 ;
...
// -(void)_syncRecoverableMessagesToCloudKitWithActivity:(id)arg0 syncAttemptCount:(NSUInteger)arg1 startTime:(id)arg2 syncCompletionBlock:(id)arg3 retryCompletionBock:(unk)arg4  ;
-(void)_writeDownSyncDate;
-(void)beginChatSyncPeriodic:(BOOL)arg0 activity:(id)arg1 ;
-(void)beginComingBackOnlineSyncWithActivity:(id)arg0 ;
-(void)beginInitialSyncAttemptCount:(NSUInteger)arg0 withActivity:(id)arg1 ;
-(void)beginInitialSyncWithActivity:(id)arg0 ;
...
-(void)syncDeletesToCloudKitWithActivity:(id)arg0 completion:(id)arg1 ;
