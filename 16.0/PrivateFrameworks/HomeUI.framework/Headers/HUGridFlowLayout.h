...
@class UICollectionViewFlowLayout, HFWallpaperSlice, NSHashTable, NSString, NSMutableDictionary;
...
@property (weak, nonatomic) HUWallpaperView_legacy *legacyWallpaperView; // ivar: _legacyWallpaperView
