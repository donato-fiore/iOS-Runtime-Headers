...
#ifndef HUDASHBOARDCONTEXT_LEGACY_H
#define HUDASHBOARDCONTEXT_LEGACY_H
...
@property (readonly, nonatomic) BOOL shouldHideRightNavigationAddButton;
...
-(BOOL)_shouldHideMultiRoomMediaGroup:(id)arg0 ;
