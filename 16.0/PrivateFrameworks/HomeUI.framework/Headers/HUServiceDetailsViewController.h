...
@protocol HUControlPanelControllerDelegate, HUPresentationDelegate, HUServiceDetailsItemManagerDelegate, HUSwitchCellDelegate, HUServiceGroupEditorViewControllerDelegate, HUContainedAccessoryElementsGridViewControllerDelegate, HUMediaSystemEditorViewControllerDelegate, HUServiceGroupEditorViewControllerDelegate_legacy, HUContainedServiceGridViewControllerDelegate_legacy, HUEditRoomViewControllerPresentationDelegate, HUTriggerEditorDelegate, HUControlPanelControllerDelegate, HFAccessoryObserver, UIGestureRecognizerDelegate, HUAccessorySettingsItemModuleControllerDelegate, HUSoftwareUpdateItemModuleControllerDelegate, HUMediaSystemEditorViewControllerDelegate_legacy, HUContainedMediaAccessoriesGridViewControllerDelegate_legacy, HUMediaGroupEditorViewControllerDelegate, HUChildServiceModuleControllerDelegate, HFHomeObserver, HUPickerCellDelegate, HUHomeAssistantDeviceSplitAccountActionDelegate, UINavigationControllerDelegate, HUHomeKitAccessorySettingsItemModuleControllerDelegate, HUDetailsPresentationDelegateHost, HUServiceLikeItemDetailsViewControllerProtocol;
...
-(id)_commitBuilder;
-(id)_commitBuilderFor:(id)arg0 with:(id)arg1 ;
...
-(void)_presentPermanentSpeakerGroupPicker;
...
-(void)legacyServiceGroupEditor:(id)arg0 didCreateServiceGroup:(id)arg1 ;
-(void)mediaGroupEditor:(id)arg0 didCreate:(id)arg1 ;
-(void)mediaSystemEditor:(id)arg0 didAbortDueTo:(id)arg1 ;
-(void)mediaSystemEditor:(id)arg0 didAbortMediaSystemCreationDueToAccessoryNeedingUpdate:(id)arg1 ;
-(void)mediaSystemEditor:(id)arg0 didCreate:(id)arg1 ;
