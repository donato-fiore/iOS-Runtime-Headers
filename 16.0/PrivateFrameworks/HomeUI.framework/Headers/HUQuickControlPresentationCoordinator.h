...
@class NSString, UITapGestureRecognizer, UIImpactFeedbackGenerator, NSMutableSet, _UIClickPresentationInteraction, UIViewController, NSMapTable, UIView<HUQuickControlPresentationTransitionDelegate>, UIView, UINavigationController, UITraitCollection, UIVisualEffectView, UILabel;
@protocol HUQuickControlContainerViewControllerDelegate, HUPresentationDelegate, UIGestureRecognizerDelegate, HUCardViewControllerDelegate, UIPresentationControllerDelegatePrivate, _UIClickPresentationInteractionDelegate, UIViewControllerTransitioningDelegate, _UISheetPresentationControllerDelegate, UINavigationControllerDelegate, HUHomeStatusDetailsViewControllerDelegate_legacy, HFItemManagerDelegate, UITraitEnvironment, HUQuickControlPresentationCoordinatorDelegate, NACancelable;
...
@property (retain, nonatomic) UIView<HUQuickControlPresentationTransitionDelegate> *pressedTile; // ivar: _pressedTile
...
@property (retain, nonatomic) HUGridServiceCell *pressedTile_legacy; // ivar: _pressedTile_legacy
...
@property (retain, nonatomic) UIViewController *statusDetailsViewController; // ivar: _statusDetailsViewController
@property (readonly) Class superclass;
@property (readonly, weak, nonatomic) UIView *targetView; // ivar: _targetView
@property (retain, nonatomic) HUTouchGestureRecognizer *touchGestureRecognizer; // ivar: _touchGestureRecognizer
@property (readonly, nonatomic) UITraitCollection *traitCollection;
@property (retain, nonatomic) UIView *transitionBackgroundView; // ivar: _transitionBackgroundView
@property (retain, nonatomic) HUBaseIconView *transitionBaseIconView; // ivar: _transitionBaseIconView
...
@property (retain, nonatomic) UILabel *transitionPrefixLabel; // ivar: _transitionPrefixLabel
...
-(id)_animationControllerForDismissedController:(id)arg0 ;
-(id)_animationControllerForPresentedController:(id)arg0 presentingController:(id)arg1 sourceController:(id)arg2 ;
...
-(id)_legacyAnimationControllerForDismissedController:(id)arg0 ;
-(id)_legacyAnimationControllerForPresentedController:(id)arg0 presentingController:(id)arg1 sourceController:(id)arg2 ;
...
-(id)initWithTargetView:(id)arg0 delegate:(id)arg1 cornerRadius:(CGFloat)arg2 ;
...
-(struct CGRect )baseIconFrameInNavigationBar;
...
-(void)statusDetailsViewControllerDidFinish:(id)arg0 ;
