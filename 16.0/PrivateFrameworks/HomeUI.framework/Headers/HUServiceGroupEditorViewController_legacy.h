...
#ifndef HUSERVICEGROUPEDITORVIEWCONTROLLER_LEGACY_H
#define HUSERVICEGROUPEDITORVIEWCONTROLLER_LEGACY_H

@class NSString;
@protocol HUNameAndIconEditorCellDelegate, HUServiceGroupEditorGridViewControllerDelegate, HUPresentationDelegateHost, HUPresentationDelegate, HUServiceGroupEditorViewControllerDelegate_legacy;
...
@interface HUServiceGroupEditorViewController_legacy : HUItemTableViewController <HUNameAndIconEditorCellDelegate, HUServiceGroupEditorGridViewControllerDelegate, HUPresentationDelegateHost>
...
@property (weak, nonatomic) NSObject<HUServiceGroupEditorViewControllerDelegate_legacy> *serviceGroupEditorDelegate; // ivar: _serviceGroupEditorDelegate
