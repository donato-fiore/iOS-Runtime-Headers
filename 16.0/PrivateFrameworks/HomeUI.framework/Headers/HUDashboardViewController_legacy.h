...
#ifndef HUDASHBOARDVIEWCONTROLLER_LEGACY_H
#define HUDASHBOARDVIEWCONTROLLER_LEGACY_H
...
@protocol HFAccessoryObserver, HUDashboardItemManagerDelegate_legacy, HUDashboardScrollingAnimationControllerDelegate, HUGridEmptyHomeViewDelegate, HUPrototypeLayoutOptionsEditorViewControllerDelegate, UIDropInteractionDelegate, UIViewControllerTransitioningDelegate, HFHomeObserver, HUBannerViewDelegate, HFHomeManagerObserver, HFUserObserver, HUSoftwareUpdateUIPresentationDelegate, PRXCardContentProviding, PRXFlowDelegate, HFMediaServiceManagerObserver, HUPresentationDelegate, HUHomeKitObjectPresenting, HUDashboardMenuNavigationActionDelegate, HUGridActionSetListViewControllerDelegate, HUDashboardNavigator, HUDashboardViewControllerDelegate_legacy;
...
#import "HUDashboardItemManager_legacy.h"
...
@property (readonly, nonatomic) HUDashboardContext_legacy *context;
@property (weak, nonatomic) HUDashboardItemManager_legacy *dashboardItemManager; // ivar: _dashboardItemManager
...
@property (weak, nonatomic) NSObject<HUDashboardViewControllerDelegate_legacy> *delegate; // ivar: _delegate
...
@property (nonatomic) CGSize layoutOptionViewSize; // ivar: _layoutOptionViewSize
@property (retain, nonatomic) HUGridLayoutOptions *layoutOptions;
@property (retain, nonatomic) HUWallpaperView_legacy *legacyWallpaperView; // ivar: _legacyWallpaperView
@property (retain, nonatomic) AMSUIUpdateMultiUserTokenTask *multiUserTokenFixTask; // ivar: _multiUserTokenFixTask
@property (retain, nonatomic) HUDashboardNavigationButton_legacy *navigationAddButton; // ivar: _navigationAddButton
@property (retain, nonatomic) HUDashboardNavigationButton_legacy *navigationAnnounceButton; // ivar: _navigationAnnounceButton
@property (retain, nonatomic) HUDashboardNavigationButton_legacy *navigationEditDoneButton; // ivar: _navigationEditDoneButton
@property (retain, nonatomic) HUDashboardNavigationButton_legacy *navigationHomesAndRoomsButton; // ivar: _navigationHomesAndRoomsButton
