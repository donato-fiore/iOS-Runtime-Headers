...
#ifndef HUNEARBYACCESSORIESVIEWCONTROLLER_LEGACY_H
#define HUNEARBYACCESSORIESVIEWCONTROLLER_LEGACY_H

@class HMAccessory, NSString, NSArray, UILabel, _UIContentUnavailableView;
@protocol HUPresentationDelegateHost, HUNearbyAccessoriesViewControllerDelegate_legacy, HUPresentationDelegate;
...
@property (weak, nonatomic) NSObject<HUNearbyAccessoriesViewControllerDelegate_legacy> *nearbyAccessoriesDelegate; // ivar: _nearbyAccessoriesDelegate
