...
@protocol HUHomeTheaterAudioItemModuleAlertDelegate, HFMediaProfileContainer, HUHomeTheaterAudioItemModuleOnboardingDelegate;
...
@property (weak, nonatomic) NSObject<HUHomeTheaterAudioItemModuleAlertDelegate> *alertDelegate; // ivar: _alertDelegate
...
@property (weak, nonatomic) NSObject<HUHomeTheaterAudioItemModuleOnboardingDelegate> *onboardingDelegate; // ivar: _onboardingDelegate
...
-(void)_handleBelongsInMediaGroupForItem:(id)arg0 ;
-(void)_notifyMovingFromMediaGroupToHomeTheaterForItem:(id)arg0 ;
-(void)_selectItem:(id)arg0 ;
