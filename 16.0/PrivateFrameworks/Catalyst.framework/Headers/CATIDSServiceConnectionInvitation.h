...
-(id)initWithConnectionIdentifier:(id)arg0 senderAppleID:(id)arg1 senderAddress:(id)arg2 assertion:(id)arg3 messagingVersion:(NSUInteger)arg4 userInfo:(id)arg5 ;
-(id)initWithSenderAppleID:(id)arg0 senderAddress:(id)arg1 assertion:(id)arg2 messagingVersion:(NSUInteger)arg3 userInfo:(id)arg4 ;
