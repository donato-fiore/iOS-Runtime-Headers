...
-(id)_responseToPauseTimerIntent:(id)arg0 withPausedTimers:(id)arg1 error:(id)arg2 ;
-(id)_responseToResumeTimerIntent:(id)arg0 withResumedTimers:(id)arg1 error:(id)arg2 ;
-(void)_handlePauseTimer:(id)arg0 completion:(id)arg1 ;
-(void)_handleResumeTimer:(id)arg0 completion:(id)arg1 ;
