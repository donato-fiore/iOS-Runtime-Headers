...
-(id)_responseToSetTimerAttributeIntent:(id)arg0 withUpdatedTimer:(id)arg1 error:(id)arg2 ;
-(void)_updateTimer:(id)arg0 endpoint:(id)arg1 toDuration:(CGFloat)arg2 toLabel:(id)arg3 completion:(id)arg4 ;
