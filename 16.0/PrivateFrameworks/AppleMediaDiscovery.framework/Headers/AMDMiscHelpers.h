...
+(id)logAndCreateError:(NSInteger)arg0 errorMessage:(id)arg1 ;
+(id)sortArrayElements:(id)arg0 inDescendingOrder:(BOOL)arg1 withComparisonKey:(id)arg2 isKeyString:(BOOL)arg3 ;
+(void)AMDInitialize:(id)arg0 ;
