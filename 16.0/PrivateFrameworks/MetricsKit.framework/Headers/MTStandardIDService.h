...
@property (retain, nonatomic) MTIDConfig *cachedConfig; // ivar: _cachedConfig
@property (retain, nonatomic) MTPromise *configDictPromise; // ivar: _configDictPromise
...
-(id)initWithConfigDictPromise:(id)arg0 bag:(id)arg1 ;
