...
@class UIViewController, UIImageView, NSMutableDictionary, NSPointerArray, NSMapTable, SAAutomaticallyInvalidatingAssertion, NSHashTable, NSString, NSMutableSet, UIView, NSArray;
@protocol SAElementHosting, SAActivityHostingPrivate, SAUILayoutHosting, SAUILayoutSpecifyingPrivate, SAUILayoutSpecifyingOverridingParticipant, SAActivityHosting, SAAlertHosting, SAUIElementViewControlling, SAUILayoutSpecifying, SAUIContentTransitioning, SAUITransitionTracking, SAAutomaticallyInvalidatable, SAElementViewProviding, SAUILayoutModePreferring;
...
@property (readonly, nonatomic, getter=_contentsTransitionShadowView) UIView *contentsTransitionShadowView;
