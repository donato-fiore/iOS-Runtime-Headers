...
@protocol SAElementHosting, SAAlertingConfiguring, SAUIElementConsideringDelegate, SAUILayoutHostingPrivate, SAUILayoutSpecifyingOverridingParticipant, SAUIElementViewControllingObserving, SAElementRegistering, SAElementConsidering, SAUISystemApertureManagerDelegate;

#import <Foundation/Foundation.h>


@interface SAUISystemApertureManager : NSObject <SAElementHosting, SAAlertingConfiguring, SAUIElementConsideringDelegate, SAUILayoutHostingPrivate, SAUILayoutSpecifyingOverridingParticipant, SAUIElementViewControllingObserving, SAElementRegistering>
...
+(void)initialize;
-(BOOL)isActivityElementAlerting:(id)arg0 ;
-(BOOL)isElementExpandedDueToUserInteraction:(id)arg0 ;
-(CGFloat)alertingDurationForHost:(id)arg0 ;
-(CGFloat)concentricPaddingForProvidedView:(id)arg0 fromViewProvider:(id)arg1 ;
-(NSInteger)preferredLayoutModeForElement:(id)arg0 ;
-(NSInteger)preferredLayoutModeForElement:(id)arg0 fromUserAction:(*BOOL)arg1 ;
