...
+(id)resourceObjectWithData:(id)arg0 sourceURL:(id)arg1 FHIRVersion:(id)arg2 receivedDate:(id)arg3 firstSeenDate:(id)arg4 extractionHints:(NSUInteger)arg5 originVersion:(struct ? )arg6 originBuild:(id)arg7 country:(id)arg8 existingROWID:(id)arg9 error:(*id)arg10 ;
...
-(NSUInteger)hash;
-(id)_initWithResourceIdentifier:(id)arg0 JSONObject:(id)arg1 sourceURL:(id)arg2 FHIRVersion:(id)arg3 receivedDate:(id)arg4 firstSeenDate:(id)arg5 extractionHints:(NSUInteger)arg6 originInformation:(id)arg7 existingROWID:(id)arg8 country:(id)arg9 ;
