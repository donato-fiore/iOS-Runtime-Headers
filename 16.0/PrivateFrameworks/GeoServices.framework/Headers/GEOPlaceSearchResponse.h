...
@property (nonatomic) CGFloat turnaroundTime;
...
-(id)namedFeaturesAtIndex:(NSUInteger)arg0 ;
-(id)placeResultAtIndex:(NSUInteger)arg0 ;
-(id)statusAsString:(int)arg0 ;
-(id)statusCodeInfoAsString:(int)arg0 ;
-(id)suggestionEntryListsAtIndex:(NSUInteger)arg0 ;
-(int)StringAsStatus:(id)arg0 ;
-(int)StringAsStatusCodeInfo:(id)arg0 ;
-(void)addNamedFeatures:(id)arg0 ;
-(void)addPlaceResult:(id)arg0 ;
