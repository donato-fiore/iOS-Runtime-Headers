...
-(id)suggestedChargerPlugAtIndex:(NSUInteger)arg0 ;
-(id)supportedChargerPlugAtIndex:(NSUInteger)arg0 ;
-(void)addSuggestedChargerPlug:(id)arg0 ;
-(void)addSupportedChargerPlug:(id)arg0 ;
