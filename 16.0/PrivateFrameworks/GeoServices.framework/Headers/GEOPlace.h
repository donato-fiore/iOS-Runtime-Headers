...
+(id)_placesFromDirectionsAction:(id)arg0 currentLocationIndices:(*id)arg1 options:(*id)arg2 ;
...
+(id)_placesFromShowAction:(id)arg0 currentLocationIndices:(*id)arg1 options:(*id)arg2 ;
+(id)_placesFromShowAction:(id)arg0 hasCurrentLocation:(*BOOL)arg1 currentLocationIndex:(*NSUInteger)arg2 options:(*id)arg3 ;
+(id)_placesFromURL:(id)arg0 currentLocationIndices:(*id)arg1 options:(*id)arg2 ;
...
+(id)_urlForDirectionsWithWaypoints:(id)arg0 options:(id)arg1 ;
