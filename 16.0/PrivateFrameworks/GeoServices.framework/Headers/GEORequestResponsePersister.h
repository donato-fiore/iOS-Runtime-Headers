...
-(BOOL)_checkDbIsWriteable:(*id)arg0 ;
-(BOOL)_pruneDBToDefaultAge:(*id)arg0 ;
-(BOOL)_pruneDBToDefaultSize:(*id)arg0 ;
-(BOOL)_pruneDBToSize:(NSUInteger)arg0 error:(*id)arg1 ;
-(BOOL)_pruneEntriesOlderThan:(id)arg0 error:(*id)arg1 ;
-(BOOL)_runAllPruners:(*id)arg0 ;
-(BOOL)pruneDBToDefaultAge:(*id)arg0 ;
-(BOOL)pruneDBToDefaultSize:(*id)arg0 ;
-(BOOL)pruneDBToSize:(NSUInteger)arg0 error:(*id)arg1 ;
-(BOOL)pruneEntriesOlderThan:(id)arg0 error:(*id)arg1 ;
-(BOOL)runAllPruners:(*id)arg0 ;
