...
-(id)mapsSearchResultAtIndex:(NSUInteger)arg0 ;
-(id)suggestionEntryMetadataDisplayedAtIndex:(NSUInteger)arg0 ;
-(void)addMapsSearchResult:(id)arg0 ;
-(void)addSuggestionEntryMetadataDisplayed:(id)arg0 ;
