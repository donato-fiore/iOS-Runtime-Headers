...
@interface _GEOReverseGeocodeRequestTicket : GEOPlaceRequestTicket <GEOMapServiceSearchTicket>
...
-(id)initWithRequest:(id)arg0 shiftLocationsIfNeeded:(BOOL)arg1 traits:(id)arg2 ;
