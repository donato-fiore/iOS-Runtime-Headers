...
#ifndef GEOMAPSUBSCRIPTIONSTATESTARTOBSERVINGREQUEST_H
#define GEOMAPSUBSCRIPTIONSTATESTARTOBSERVINGREQUEST_H
...
@property (nonatomic) BOOL sendInitialUpdate; // ivar: _sendInitialUpdate
