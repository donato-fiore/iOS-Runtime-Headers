...
-(void)placeCacheGetCounts:(NSUInteger)arg0 forApp:(id)arg1 inTimeRange:(id)arg2 ofType:(int)arg3 handler:(id)arg4 ;
-(void)placeCacheRegisterCacheResult:(unsigned char)arg0 forApp:(id)arg1 requestType:(int)arg2 timestamp:(id)arg3 ;
