...
+(BOOL)deleteAllDBFilesFor:(id)arg0 ;
+(BOOL)deleteAllDBFilesForURL:(id)arg0 ;
+(BOOL)migrateAllDBFilesFrom:(id)arg0 to:(id)arg1 ;
...
-(BOOL)bindUUIDParameter:(char *)arg0 toValue:(id)arg1 inStatement:(struct sqlite3_stmt *)arg2 error:(*id)arg3 ;
-(BOOL)bindZeroBlobParameter:(char *)arg0 length:(NSUInteger)arg1 inStatement:(struct sqlite3_stmt *)arg2 error:(*id)arg3 ;
-(BOOL)createIndex:(char *)arg0 ;
...
// -(id)initWithQueueName:(char *)arg0 log:(id)arg1 databaseFileURL:(id)arg2 sqliteFlags:(int)arg3 pragmas:(id)arg4 setupBlock:(id)arg5 tearDownBlock:(unk)arg6  ;
...
// -(id)initWithQueueName:(char *)arg0 logFacility:(char *)arg1 dbFilePath:(id)arg2 sqliteFlags:(int)arg3 pragmas:(id)arg4 setupBlock:(id)arg5 tearDownBlock:(unk)arg6  ;
