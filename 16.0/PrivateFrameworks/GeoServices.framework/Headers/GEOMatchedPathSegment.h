...
@property (readonly, nonatomic) ? endLocationCoordinate;
...
@property (readonly, nonatomic) GEOPolylineCoordinateRange range;
...
@property (readonly, nonatomic) ? startLocationCoordinate;
...
-(struct ? )locationCoordinateForRouteCoordinate:(struct PolylineCoordinate )arg0 ;
-(struct PolylineCoordinate )_roadPolylineCoordinateForCoordinate:(struct ? )arg0 segmentCoordinateIndex:(NSUInteger)arg1 trimRange:(struct GEOPolylineCoordinateRange )arg2 ;
