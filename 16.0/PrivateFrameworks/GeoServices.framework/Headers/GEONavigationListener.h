...
-(void)didResumeNavigatingFromWaypoint:(id)arg0 endOfLegIndex:(NSUInteger)arg1 ;
-(void)didUpdateETA:(id)arg0 ;
-(void)didUpdateLocation:(id)arg0 routeMatchedCoordinate:(struct ? )arg1 ;
-(void)didUpdateRoute:(id)arg0 ;
-(void)didUpdateTrafficForCurrentRoute:(id)arg0 ;
-(void)navigationStateChanged:(NSUInteger)arg0 transportType:(int)arg1 isResumingMultipointRoute:(BOOL)arg2 ;
