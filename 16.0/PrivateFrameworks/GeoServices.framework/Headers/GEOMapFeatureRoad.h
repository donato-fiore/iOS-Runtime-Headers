...
@property (readonly, nonatomic) NSUInteger _diagnosticsOnly_forwardSpeedLimit;
@property (readonly, nonatomic) NSUInteger _diagnosticsOnly_reverseSpeedLimit;
...
@property (readonly, nonatomic) ? firstCoordinate;
...
@property (readonly, nonatomic) NSInteger signedMuid;
