...
-(struct RoadNetworkPath<GEOPathMatcherRoadKey> )_decodePathForRoute:(id)arg0 start:(struct PolylineCoordinate )arg1 end:(struct PolylineCoordinate )arg2 roadNetwork:(*void)arg3 internalInfo:(id)arg4 ;
