...
@class NSMutableArray, PEAutoAdjustmentController, PICompositionController, NSString, PEValuesCalculator;
...
@property (retain, nonatomic) PEAutoAdjustmentController *autoEnhanceController; // ivar: _autoEnhanceController
...
-(void)_enableNonAutoAdjustments:(BOOL)arg0 ;
