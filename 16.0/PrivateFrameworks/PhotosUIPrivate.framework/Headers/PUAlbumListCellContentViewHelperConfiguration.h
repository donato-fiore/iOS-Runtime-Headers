...
@property (copy, nonatomic) NSString *nameOfEmptyPeopleAlbumPlaceholderImage; // ivar: _nameOfEmptyPeopleAlbumPlaceholderImage
...
@property (nonatomic) UIEdgeInsets previewInsets; // ivar: _previewInsets
