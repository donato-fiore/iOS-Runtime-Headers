...
@class UIView, NSString, UIImpactFeedbackGenerator, PXImageModulationManager, PHLivePhotoView, PXLivePhotoViewModulator, NSArray, ISWrappedAVPlayer;
...
-(id)loadView;
-(void)_handleLoadedSRLCompensationAmount:(id)arg0 forAsset:(id)arg1 ;
