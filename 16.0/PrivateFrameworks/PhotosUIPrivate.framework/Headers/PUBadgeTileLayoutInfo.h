...
-(id)initWithTileIdentifier:(id)arg0 center:(struct CGPoint )arg1 size:(struct CGSize )arg2 alpha:(CGFloat)arg3 transform:(struct CGAffineTransform )arg4 zPosition:(CGFloat)arg5 hitTestOutset:(struct UIEdgeInsets )arg6 coordinateSystem:(id)arg7 isOverContent:(BOOL)arg8 contentWidth:(CGFloat)arg9 ;
