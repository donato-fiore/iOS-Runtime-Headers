...
#import "PUOneUpLinkController.h"
...
@property (readonly, nonatomic) PUOneUpLinkController *_linkController; // ivar: __linkController
...
@property (nonatomic, setter=_setNeedsUpdateLinkController:) BOOL _needsUpdateLinkController; // ivar: __needsUpdateLinkController
...
@property (nonatomic, setter=_setShouldShowActionsMenuPhotoTip:) BOOL _shouldShowActionsMenuPhotoTip; // ivar: __shouldShowActionsMenuPhotoTip
...
@property (copy, nonatomic) NSArray *assetUUIDsAllowedToHighlightText; // ivar: _assetUUIDsAllowedToHighlightText
...
@property (retain, nonatomic) PUDisplayLocationProvider *lastLivePhotoGestureLocationProvider; // ivar: _lastLivePhotoGestureLocationProvider
@property (readonly, nonatomic) PULoadingIndicatorController *loadingIndicatorController; // ivar: _loadingIndicatorController
@property (readonly, nonatomic) PUMenuActionController *menuActionController; // ivar: _menuActionController
...
@property (copy, nonatomic) NSArray *textsToHighlight; // ivar: _textsToHighlight
...
@property (nonatomic) NSUInteger touchingGestureRecognizerStateBeginID; // ivar: _touchingGestureRecognizerStateBeginID
...
@property (retain, nonatomic) NSString *uuidOfAssetPresentedInFloatingInfoPanel; // ivar: _uuidOfAssetPresentedInFloatingInfoPanel
...
@property (readonly, nonatomic) BOOL wantsActionsMenu; // ivar: _wantsActionsMenu
@property (readonly, nonatomic) BOOL wantsDocumentMenu; // ivar: _wantsDocumentMenu
...
-(BOOL)_isLocationFromProviderOverActionInfoItem:(id)arg0 ;
-(BOOL)_isLocationFromProviderOverControl:(id)arg0 ;
-(BOOL)_isLocationFromProviderOverImageSubject:(id)arg0 ;
-(BOOL)_isLocationFromProviderOverInteractableItem:(id)arg0 ;
-(BOOL)_isLocationFromProviderOverInteractableItemExcludeImageSubject:(id)arg0 ;
...
-(BOOL)_vkImageOverlayHasSubjectAnalysisAvailableOrFailedFromProvider:(id)arg0 ;
...
-(BOOL)menuActionControllerPreventRevealInMomentAction:(id)arg0 ;
...
-(BOOL)oneUpBarsController:(id)arg0 isDetailsAccessoryAvailableForAssetReference:(id)arg1 ;
...
-(BOOL)oneUpBarsControllerWantsActionsMenu:(id)arg0 ;
-(BOOL)oneUpBarsControllerWantsDocumentMenu:(id)arg0 ;
...
-(CGFloat)livePhotoVideoPlaybackTileViewControllerExtraMinimumTouchDuration:(id)arg0 locationProvider:(id)arg1 ;
...
-(id)backItemTitleForOneUpBarsController:(id)arg0 ;
...
-(id)menuActionControllerRemoveFromFeaturedPhotosAction:(id)arg0 ;
-(id)oneUpBarsController:(id)arg0 createMenuActionControllerForManagerIfNeeded:(id)arg1 ;
-(id)oneUpGestureRecognizerCoordinatorViewHostingTouchingGesture:(id)arg0 ;
-(id)oneUpLinkControllerInteractionView:(id)arg0 ;
...
-(id)userTransformTileViewControllerPresentingTileView:(id)arg0 ;
-(id)userTransformTileViewControllerPresentingViewController:(id)arg0 ;
-(id)userTransformTileViewControllerTextsToHighlight:(id)arg0 ;
...
-(void)_beginVKSubjectAnalyzingWithGestureRecognizer:(id)arg0 beginID:(NSUInteger)arg1 ;
...
-(void)_setNeedsVisualImageAnalsis:(BOOL)arg0 forAssetViewModel:(id)arg1 ;
...
-(void)_updateLinkControllerIfNeeded;
...
-(void)addAssetsToLastUsedAlbum:(id)arg0 ;
...
-(void)createMenuActionControllerForManagerIfNeeded:(id)arg0 withPresentingViewController:(id)arg1 regionOfInterestProvider:(id)arg2 ;
-(void)dealloc;
...
-(void)menuActionController:(id)arg0 actionType:(id)arg1 actionStartedFromActionsMenu:(BOOL)arg2 ;
...
-(void)oneUpBarsControllerWillPresentActionsMenu:(id)arg0 ;
...
-(void)ppt_notifyWhenVKAnalysisIsReadyWithTimeout:(CGFloat)arg0 handler:(id)arg1 ;
...
-(void)revertAdjustments:(id)arg0 ;
