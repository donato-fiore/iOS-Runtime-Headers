...
@property (readonly, nonatomic) NSInteger albumDeletionWarningStyle; // ivar: _albumDeletionWarningStyle
...
+(id)emptyPlaceholderImageForSystemImageNamed:(id)arg0 scale:(NSInteger)arg1 ;
+(id)padSpec;
+(id)phoneSpec;
