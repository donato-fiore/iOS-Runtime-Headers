...
-(void)_createStreamsPickerContainerWithExisting:(BOOL)arg0 assets:(id)arg1 ;
-(void)_handleDismissWithSuccess:(BOOL)arg0 ;
-(void)_performPresentationOnViewController:(id)arg0 completion:(id)arg1 ;
-(void)_prepareToPost:(id)arg0 albumName:(id)arg1 recipients:(id)arg2 comments:(id)arg3 assets:(id)arg4 ;
...
-(void)prepareWithAssets:(id)arg0 ;
