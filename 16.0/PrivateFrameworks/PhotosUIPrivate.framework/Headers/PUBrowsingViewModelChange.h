...
@property (nonatomic, setter=_setContentPrivacyStateDidChange:) BOOL contentPrivacyStateDidChange; // ivar: _contentPrivacyStateDidChange
...
@property (nonatomic, setter=_setIsInSelectionModeDidChange:) BOOL isInSelectionModeDidChange; // ivar: _isInSelectionModeDidChange
...
@property (nonatomic) BOOL livePhotoShouldPlayDidChange; // ivar: _livePhotoShouldPlayDidChange
...
@property (nonatomic, setter=_setSystemAuthenticationTypeDidChange:) BOOL systemAuthenticationTypeDidChange; // ivar: _systemAuthenticationTypeDidChange
...
@property (nonatomic, setter=_setWantsContentUnavailableUnlockButtonVisibleDidChange:) BOOL wantsContentUnavailableUnlockButtonVisibleDidChange; // ivar: _wantsContentUnavailableUnlockButtonVisibleDidChange
