...
@protocol PEValuesCalculatorSettings;
...
@property (nonatomic) BOOL allowSynchronousBatchRendering; // ivar: _allowSynchronousBatchRendering
...
@property (nonatomic) BOOL crossPlatformRevertEnabled; // ivar: _crossPlatformRevertEnabled
@property (nonatomic) BOOL crossPlatformSerializationEnabled; // ivar: _crossPlatformSerializationEnabled
@property (readonly, copy) NSString *debugDescription;
@property (nonatomic) BOOL debugTrackerMask; // ivar: _debugTrackerMask
...
@property (nonatomic) BOOL enableDynamicVideoScaling; // ivar: _enableDynamicVideoScaling
...
@property (nonatomic) BOOL enableLiveVideoRenderAtSetSize; // ivar: _enableLiveVideoRenderAtSetSize
...
@property (nonatomic) CGFloat mainToolbarShadowLength; // ivar: _mainToolbarShadowLength
@property (nonatomic) BOOL maintainCropAspectLockState; // ivar: _maintainCropAspectLockState
@property (nonatomic) BOOL mediaViewDebugMode; // ivar: _mediaViewDebugMode
...
@property (nonatomic) CGFloat secondaryToolbarShadowLength; // ivar: _secondaryToolbarShadowLength
@property (nonatomic) CGFloat selectionRingStrokeWidth; // ivar: _selectionRingStrokeWidth
@property (nonatomic) BOOL showCopyAndPaste; // ivar: _showCopyAndPaste
...
@property (nonatomic) BOOL showRevertEdits; // ivar: _showRevertEdits
...
@property (nonatomic) BOOL toolbarShadowsEnabled; // ivar: _toolbarShadowsEnabled
...
@property (nonatomic) BOOL useEditToastProgress; // ivar: _useEditToastProgress
