...
+(void)_prepareAssets:(id)arg0 forActivityType:(id)arg1 window:(id)arg2 completion:(id)arg3 ;
...
-(void)ensureRenderingForAssetsWithDeferredProcessingInCollection:(id)arg0 completion:(id)arg1 ;
