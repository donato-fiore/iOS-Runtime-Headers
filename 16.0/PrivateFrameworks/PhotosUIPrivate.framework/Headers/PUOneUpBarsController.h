...
@property (retain, nonatomic, setter=_setCenterNavBarButtonIdentifiers:) NSMutableIndexSet *_centerNavBarButtonIdentifiers; // ivar: __centerNavBarButtonIdentifiers
@property (retain, nonatomic, setter=_setCenterNavBarButtonItemCollection:) PUBarButtonItemCollection *_centerNavBarButtonItemCollection; // ivar: __centerNavBarButtonItemCollection
...
@property (nonatomic) BOOL actionStartedFromActionsMenu; // ivar: _actionStartedFromActionsMenu
...
@property (nonatomic) BOOL isInCompactLayoutStyle; // ivar: _isInCompactLayoutStyle
...
-(BOOL)_dismissViewController:(id)arg0 completionHandler:(id)arg1 ;
...
-(id)_barButtonItemForIdentifier:(NSInteger)arg0 ;
...
-(id)_createMultiLineButtonWithTitle:(id)arg0 ;
...
-(id)_subtitleTextColorForTitleViewController:(BOOL)arg0 ;
-(id)_textColorForTitleViewController:(BOOL)arg0 ;
-(id)_titleTextColorForTitleViewController:(BOOL)arg0 ;
...
-(void)_handlePresentActionsMenu:(id)arg0 ;
...
-(void)_performPasteAdjustmentsActivityWithAssetsByAssetCollection:(id)arg0 ;
...
-(void)_performRevertAdjustmentsActivityWithAssetsByAssetCollection:(id)arg0 ;
-(void)_performShareAction;
-(void)_performShowInLibraryAction;
-(void)_performSimpleActionType:(NSUInteger)arg0 ;
-(void)_performSimpleActionType:(NSUInteger)arg0 withCompletionHandler:(id)arg1 ;
...
-(void)_toggleSelectionMode:(BOOL)arg0 ;
