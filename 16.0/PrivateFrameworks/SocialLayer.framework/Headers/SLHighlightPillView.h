...
@class NSArray, NSString, UIVisualEffectView, UIVisualEffect, NSSet, UIAction, UIImageView, UILabel, UIPointerInteraction, UIColor;
@protocol UIPointerInteractionDelegate, SLHighlightPillViewCrossPlatform, SLHighlightPillViewDelegate;
...
@property (retain, nonatomic) NSArray *contextMenuItems; // ivar: _contextMenuItems
