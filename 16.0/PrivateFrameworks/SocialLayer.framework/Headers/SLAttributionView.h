...
@class UIView, NSString, UIButton, NSLayoutConstraint, UIColor, UIMenu;
...
@property (retain, nonatomic) NSString *hideMenuItemTitle; // ivar: _hideMenuItemTitle
...
+(void)presentTranscriptForAttributionIdentifier:(id)arg0 presentingViewController:(id)arg1 ;
