...
@class NSMutableArray, AVCapturePhotoOutput, NSMutableDictionary, AVCaptureDeviceInput, AVCaptureMetadataOutput, AVCVideoStream, AVCStreamInput, AVCMediaStreamNegotiator, NSData, NSString, NSArray, AVCaptureDevice;
