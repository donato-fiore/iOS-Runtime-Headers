...
+(id)groupedSenderMessageListForMailboxes:(id)arg0 senderBuckets:(id)arg1 includeVIPs:(BOOL)arg2 limitDate:(id)arg3 withRepository:(id)arg4 ;
+(id)log;
+(id)simpleMessageListForMailboxes:(id)arg0 withRepository:(id)arg1 shouldTrackOldestItems:(BOOL)arg2 shouldUpdateDisplayDate:(BOOL)arg3 ;
// +(id)simpleMessageListForMailboxes:(id)arg0 withRepository:(id)arg1 shouldTrackOldestItems:(BOOL)arg2 shouldUpdateDisplayDate:(BOOL)arg3 orderByDisplayDate:(BOOL)arg4 transformPredicate:(id)arg5 ignoreMessageAdditionsPredicate:(unk)arg6  ;
+(id)threadedMessageListForMailboxes:(id)arg0 withRepository:(id)arg1 shouldTrackOldestItems:(BOOL)arg2 shouldUpdateDisplayDate:(BOOL)arg3 ;
// +(id)threadedMessageListForMailboxes:(id)arg0 withRepository:(id)arg1 shouldTrackOldestItems:(BOOL)arg2 shouldUpdateDisplayDate:(BOOL)arg3 orderByDisplayDate:(BOOL)arg4 transformPredicate:(id)arg5 ignoreMessageAdditionsPredicate:(unk)arg6  ;
...
-(id)_hintsByObjectIDFromExtraInfo:(id)arg0 ;
-(id)_nextThreadItemIDAfterThreadItemID:(id)arg0 ;
-(id)_unreadItemIDsFromExtraInfo:(id)arg0 ;
-(id)ef_publicDescription;
-(id)filteredMessageListWithPredicate:(id)arg0 ignoredMessagesPredicate:(id)arg1 ;
// -(id)initWithMailboxes:(id)arg0 repository:(id)arg1 orderByDisplayDate:(BOOL)arg2 transformPredicate:(id)arg3 ignoreMessageAdditionsPredicate:(unk)arg4 targetClass:(id)arg5 shouldTrackOldestItems:(Class)arg6 shouldUpdateDisplayDate:(BOOL)arg7 labelPrefix:(BOOL)arg8  ;
