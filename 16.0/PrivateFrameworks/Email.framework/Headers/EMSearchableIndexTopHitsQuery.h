...
+(id)log;
-(id)initWithSearchString:(id)arg0 filterQueries:(id)arg1 bundleID:(id)arg2 keyboardLanguage:(id)arg3 updatedSuggestion:(id)arg4 generateSuggestions:(BOOL)arg5 logDescription:(id)arg6 resultLimit:(NSUInteger)arg7 suggestionLimit:(NSUInteger)arg8 ;
