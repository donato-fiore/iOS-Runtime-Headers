...
@protocol ICAttachmentPreviewImageUI, ICAttachmentPreviewImageCryptoStrategy, OS_dispatch_queue;
...
@property (readonly) NSObject<ICAttachmentPreviewImageCryptoStrategy> *cryptoStrategy;
