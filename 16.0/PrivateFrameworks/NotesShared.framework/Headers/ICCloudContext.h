...
-(void)_processPendingCloudObjectsWithCompletionHandler:(id)arg0 ;
...
-(void)fetchOperation:(id)arg0 progressChangedWithRecordID:(id)arg1 progress:(CGFloat)arg2 ;
...
-(void)finishOperationsForRecordID:(id)arg0 qualityOfService:(NSInteger)arg1 completionHandler:(id)arg2 ;
