...
-(void)didFailToSaveUserSpecificRecordWithID:(id)arg0 accountID:(id)arg1 error:(id)arg2 ;
...
-(void)objectFailedToBePushedToCloudWithOperation:(id)arg0 recordID:(id)arg1 error:(id)arg2 ;
