...
@class NSString, ICAccountUtilities, ICManagedObjectContextUpdater, ICFolderCustomNoteSortType, NSError, NSManagedObjectContext, ICPersistentContainer, NSDictionary, NSData, NSTimer, NSArray;
