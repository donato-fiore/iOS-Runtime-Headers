...
@property (readonly, nonatomic) NSArray *appDigests; // ivar: _appDigests
...
+(id)getFlattenedGroupsFromAppDigests:(id)arg0 ;
...
-(id)initWithAppDigests:(id)arg0 highlightedGroups:(id)arg1 messageGroups:(id)arg2 rankerId:(id)arg3 ;
