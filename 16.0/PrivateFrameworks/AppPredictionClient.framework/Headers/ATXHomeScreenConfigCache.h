...
-(id)loadHomeScreenAndTodayPageConfigurationsIncludingHidden:(BOOL)arg0 error:(*id)arg1 ;
-(id)loadHomeScreenAndTodayPageConfigurationsWithError:(*id)arg0 ;
-(id)loadHomeScreenPageConfigurationsIncludingHidden:(BOOL)arg0 error:(*id)arg1 ;
