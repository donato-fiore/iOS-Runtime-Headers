...
@interface FTNlShortcutFuzzyMatchMessage : NSObject <FLTBFBufferAccessor, NSCopying>

 {
    ...
    NSData *_data;
    *NlShortcutFuzzyMatchMessage _root;
}
...
-(id)initWithFlatbuffData:(id)arg0 root:(struct NlShortcutFuzzyMatchMessage *)arg1 ;
-(id)initWithFlatbuffData:(id)arg0 root:(struct NlShortcutFuzzyMatchMessage *)arg1 verify:(BOOL)arg2 ;
-(struct Offset<siri::speech::qss_fb::NlShortcutFuzzyMatchMessage> )addObjectToBuffer:(*void)arg0 ;
