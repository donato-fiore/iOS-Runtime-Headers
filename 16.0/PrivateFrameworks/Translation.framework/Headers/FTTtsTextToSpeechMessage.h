...
#ifndef FTTTSTEXTTOSPEECHMESSAGE_H
#define FTTTSTEXTTOSPEECHMESSAGE_H
...
-(id)initWithFlatbuffData:(id)arg0 root:(struct TtsTextToSpeechMessage *)arg1 ;
-(id)initWithFlatbuffData:(id)arg0 root:(struct TtsTextToSpeechMessage *)arg1 verify:(BOOL)arg2 ;
-(struct Offset<siri::speech::qss_fb::TtsTextToSpeechMessage> )addObjectToBuffer:(*void)arg0 ;
