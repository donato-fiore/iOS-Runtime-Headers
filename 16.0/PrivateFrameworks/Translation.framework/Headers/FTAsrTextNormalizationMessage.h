...
@interface FTAsrTextNormalizationMessage : NSObject <FLTBFBufferAccessor, NSCopying>

 {
    ...
    NSData *_data;
    *AsrTextNormalizationMessage _root;
}
...
-(id)initWithFlatbuffData:(id)arg0 root:(struct AsrTextNormalizationMessage *)arg1 ;
-(id)initWithFlatbuffData:(id)arg0 root:(struct AsrTextNormalizationMessage *)arg1 verify:(BOOL)arg2 ;
-(struct Offset<siri::speech::qss_fb::AsrTextNormalizationMessage> )addObjectToBuffer:(*void)arg0 ;
