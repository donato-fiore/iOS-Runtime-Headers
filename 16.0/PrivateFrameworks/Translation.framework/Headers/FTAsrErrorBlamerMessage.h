...
-(id)initWithFlatbuffData:(id)arg0 root:(struct AsrErrorBlamerMessage *)arg1 ;
-(id)initWithFlatbuffData:(id)arg0 root:(struct AsrErrorBlamerMessage *)arg1 verify:(BOOL)arg2 ;
-(struct Offset<siri::speech::qss_fb::AsrErrorBlamerMessage> )addObjectToBuffer:(*void)arg0 ;
