...
#ifndef FTMTSTREAMINGTRANSLATIONMESSAGE_H
#define FTMTSTREAMINGTRANSLATIONMESSAGE_H
...
@interface FTMtStreamingTranslationMessage : NSObject <FLTBFBufferAccessor, NSCopying>

 {
    ...
    NSData *_data;
    *MtStreamingTranslationMessage _root;
}
...
-(id)initWithFlatbuffData:(id)arg0 root:(struct MtStreamingTranslationMessage *)arg1 ;
-(id)initWithFlatbuffData:(id)arg0 root:(struct MtStreamingTranslationMessage *)arg1 verify:(BOOL)arg2 ;
-(struct Offset<siri::speech::qss_fb::MtStreamingTranslationMessage> )addObjectToBuffer:(*void)arg0 ;
