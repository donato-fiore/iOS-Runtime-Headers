...
@class AVPlayer, NSString, AVPlayerItem, NSError, AVVideoComposition, NSMutableDictionary;
...
-(void)_avPlayerQueue_registerChangeObserver:(id)arg0 context:(*void)arg1 ;
-(void)_avPlayerQueue_unregisterChangeObserver:(id)arg0 context:(*void)arg1 ;
