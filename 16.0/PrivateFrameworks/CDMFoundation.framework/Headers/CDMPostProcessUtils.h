...
+(id)getFederatedParses:(id)arg0 parsesNLv4:(id)arg1 parsesCATI:(id)arg2 parsesUaaP:(id)arg3 parsesPSC:(id)arg4 parsesAutoShortcuts:(id)arg5 parsesAppendOverrides:(id)arg6 addDebugInfo:(id)arg7 ;
...
+(id)getPostProcessUserParses:(id)arg0 parsesNLv4:(id)arg1 parsesCATI:(id)arg2 parsesUaaP:(id)arg3 parsesPSC:(id)arg4 parsesAutoShortcuts:(id)arg5 parsesAppendOverrides:(id)arg6 addDebugInfo:(id)arg7 ;
...
+(id)selectParsesFromUserParsesUaaP:(id)arg0 userParsesShortcut:(id)arg1 userParsesReplaceOverrides:(id)arg2 userParsesAppendOverrides:(id)arg3 userParsesSNLC:(id)arg4 userParsesNLv4:(id)arg5 userParsesCATI:(id)arg6 userParsesPSC:(id)arg7 userParsesAutoShortcuts:(id)arg8 addDebugInfo:(id)arg9 ;
