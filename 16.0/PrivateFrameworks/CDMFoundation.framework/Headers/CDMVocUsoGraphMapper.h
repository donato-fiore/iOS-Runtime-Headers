...
+(id)buildEmergencyPhonePersonUSOGraphWithIdentifier:(id)arg0 withSemantic:(id)arg1 withInput:(id)arg2 withStartCharIndex:(unsigned int)arg3 withEndCharIndex:(unsigned int)arg4 ;
...
+(id)buildRootUSOGraphWithStartCharIndex:(unsigned int)arg0 withEndCharIndex:(unsigned int)arg1 ;
