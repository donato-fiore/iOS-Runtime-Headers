...
#ifndef AAUIOBINHERITANCEINVITEMESSAGEVIEWMODEL_H
#define AAUIOBINHERITANCEINVITEMESSAGEVIEWMODEL_H

@class AAOBInheritanceInviteMessageModel, UIView, AACustodianshipInfo, NSString, UIImage;
