...
@class UIViewController, UITableView, UITableViewCell, UITableViewHeaderFooterView, NSArray, UMUserPersona, UMUserPersonaContext, UIColor, NSString, UIImageView, UILabel;
