...
@property (retain, nonatomic) NSString *GDIdentifier; // ivar: _GDIdentifier
...
@property (retain, nonatomic) NSString *shareParticipantLocalIdentifier; // ivar: _shareParticipantLocalIdentifier
...
+(id)personWithGDIdentifier:(id)arg0 ;
