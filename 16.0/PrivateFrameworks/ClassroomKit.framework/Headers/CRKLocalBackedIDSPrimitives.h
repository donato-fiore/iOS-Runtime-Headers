...
@protocol CRKIDSPrimitives, CRKIDSLocalPrimitives, CRKIDSReadinessEvaluating;
...
@property (readonly, nonatomic) NSObject<CRKIDSReadinessEvaluating> *IDSReadinessEvaluator; // ivar: _IDSReadinessEvaluator
...
-(id)initWithIDSLocalPrimitives:(id)arg0 IDSReadinessEvaluator:(id)arg1 ;
-(id)initWithIDSLocalPrimitives:(id)arg0 IDSReadinessEvaluator:(id)arg1 operationQueue:(id)arg2 ;
