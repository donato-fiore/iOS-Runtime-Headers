...
@property (readonly, nonatomic) NSObject<CRKOSTransactionPrimitives> *osTransactionPrimitives; // ivar: _osTransactionPrimitives
...
@property (readonly, nonatomic) CGFloat transactionReleaseDelay; // ivar: _transactionReleaseDelay
...
-(id)initWithUserCommonNamePrefix:(id)arg0 trustedUserCommonNamePrefix:(id)arg1 rosterRequirements:(id)arg2 credentialStore:(id)arg3 maxCourseUsersCount:(NSInteger)arg4 maxCourseTrustedUsersCount:(NSInteger)arg5 rosterMutationTimeout:(CGFloat)arg6 userCachingEnabled:(BOOL)arg7 osTransactionPrimitives:(id)arg8 transactionReleaseDelay:(CGFloat)arg9 ;
