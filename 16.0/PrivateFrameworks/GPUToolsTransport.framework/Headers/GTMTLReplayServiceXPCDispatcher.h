...
-(void)accelerationStructureData:(id)arg0 replyConnection:(id)arg1 ;
-(void)addBatchFilteringRequest_completionHandler_:(id)arg0 replyConnection:(id)arg1 ;
-(void)beginAccelerationStructureSession:(id)arg0 replyConnection:(id)arg1 ;
...
-(void)teardownAccelerationStructureSession:(id)arg0 replyConnection:(id)arg1 ;
