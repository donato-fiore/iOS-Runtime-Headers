...
@class NSString, NSArray, NSData, NSURL, FCCoverArt, NSDate, FCHeadlineExperimentalTitleMetadata, COMAPPLEFELDSPARPROTOCOLLIVERPOOLArticleContentExpiration, COMAPPLEFELDSPARPROTOCOLLIVERPOOLCohortList, COMAPPLEFELDSPARPROTOCOLLIVERPOOLConversionStats, FCIssue, FCArticleAudioTrack, COMAPPLEFELDSPARPROTOCOLVersionedPersonalizationVector, COMAPPLEFELDSPARPROTOCOLLIVERPOOLTagMetadata, FCFeedPersonalizedItemScoreProfile, FCTopStoriesStyleConfiguration, NSSet, FCHeadlineThumbnail, FCColor, FCAssetHandle;
