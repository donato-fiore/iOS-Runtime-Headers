...
@class NSOperationQueue, NSDictionary, NSString, CMMotionActivityManager, PRRoseSolution, NSTimer, NSUUID, PRRemoteDevice, PRCompanionRangingSession, NSMutableArray;
