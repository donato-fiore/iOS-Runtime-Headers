...
-(void)applyToAllMaterialsOfNode:(id)arg0 options:(id)arg1 reversionContext:(id)arg2 ;
-(void)applyToMaterial:(id)arg0 options:(id)arg1 reversionContext:(id)arg2 ;
-(void)applyToMaterialsOfMatchedNodesInHierarchy:(id)arg0 options:(id)arg1 reversionContext:(id)arg2 ;
