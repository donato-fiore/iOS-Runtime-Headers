...
} shared_ptr<skitbridge::Tokenizer>;
...
typedef struct shared_ptr<skitbridge::Analyzer> {
} // Error Processing Struct Fields
...
typedef struct Indexer {
    ...
    basic_string<char16_t, std::char_traits<char16_t>, std::allocator<char16_t>> index_locale_id;
    shared_ptr<skitbridge::Tokenizer> tokenizer;
    shared_ptr<skitbridge::Analyzer> analyzer;
    Alias alias;
} Indexer;
