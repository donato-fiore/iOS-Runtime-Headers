...
@class NSString, DMCInstallProfileQuestionViewController;
@protocol UIScrollViewDelegate, MCProfileTitlePageViewModelDelegate, MCUISignInViewControllerDelegate, DMCProfileQuestionsControllerDelegate, DevicePINControllerDelegate, DMCEnrollmentFlowRestoreViewControllerDelegate, MCUIDismissalAwareViewController;
...
-(void)presentRestoreFailedAlertWithError:(id)arg0 completionHandler:(id)arg1 ;
-(void)presentSpinnerViewController;
-(void)promptForManagedRestoreWithManagedAppleID:(id)arg0 snapshot:(id)arg1 conflictingApps:(id)arg2 completionHandler:(id)arg3 ;
