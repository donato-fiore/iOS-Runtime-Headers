...
@property (nonatomic) NSUInteger numberOfWiFiScanAttemptsRemaining; // ivar: _numberOfWiFiScanAttemptsRemaining
@property (retain, nonatomic) BYAnalyticsEventRecommendedLocale *recommendedLocaleAnalyticsEvent; // ivar: _recommendedLocaleAnalyticsEvent
...
-(void)_startWifiScan;
-(void)configureForAnalytics:(id)arg0 ;
-(void)dealloc;
-(void)reset;
