...
-(void)updateInterVisitMetric:(id)arg0 store:(id)arg1 withUpdatedTime:(id)arg2 andCloseSnapshot:(BOOL)arg3 ;
-(void)updateWithInterVisitMetricsSnapshot:(id)arg0 store:(id)arg1 ;
-(void)visitEntryDelayCorrection:(id)arg0 store:(id)arg1 ;
