...
@class NSMutableDictionary, NSMutableArray, NSHashTable;
...
@property (readonly, nonatomic) NSUInteger lastStateTransition; // ivar: _lastStateTransition
@property (retain, nonatomic) NSMutableArray *nextPredictedLOIs; // ivar: _nextPredictedLOIs
...
-(BOOL)shouldCreateNewVisitSnapshotFromUnknownState:(id)arg0 ;
-(NSUInteger)evaluateLatestVisitSnapshotAndRecoverIfNecessaryWithStore:(id)arg0 andAppendOutgoingRequestsTo:(id)arg1 ;
...
-(void)closeLatestInterVisitSnapshotWithStore:(id)arg0 arrivalVisit:(id)arg1 ;
...
-(void)openInterVisitSnapshotWithStore:(id)arg0 departureVisit:(id)arg1 ;
