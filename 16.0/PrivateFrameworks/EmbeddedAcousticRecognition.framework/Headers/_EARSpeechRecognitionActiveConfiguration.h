...
@property (copy, nonatomic) NSSet *aneContextFilter; // ivar: _aneContextFilter
@property (copy, nonatomic) NSSet *bluetoothDeviceIdFilter; // ivar: _bluetoothDeviceIdFilter
@property (copy, nonatomic) NSSet *cpuContextFilter; // ivar: _cpuContextFilter
...
@property (copy, nonatomic) NSSet *gpuContextFilter; // ivar: _gpuContextFilter
