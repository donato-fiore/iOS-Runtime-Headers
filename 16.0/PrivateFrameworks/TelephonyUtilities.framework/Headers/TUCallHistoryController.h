...
@protocol TUCallProviderManagerDelegate, TUCallHistoryControllerDataSource;
...
@property (readonly, nonatomic) NSObject<TUCallHistoryControllerDataSource> *dataSource; // ivar: _dataSource
...
-(id)init;
-(id)initWithCoalescingStrategy:(NSUInteger)arg0 options:(NSUInteger)arg1 dataSource:(id)arg2 ;
