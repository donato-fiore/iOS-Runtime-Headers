...
@protocol NSCopying, NSSecureCoding, TUFeatureFlags;
...
@property (retain, nonatomic) id *conversationFailureContext; // ivar: _conversationFailureContext
...
@property (retain, nonatomic) TUConversationHandoffEligibility *handoffEligibility; // ivar: _handoffEligibility
...
@property (retain, nonatomic) TUConversationParticipantAssociation *localParticipantAssociation; // ivar: _localParticipantAssociation
...
@property (retain, nonatomic) TUConversationProvider *provider; // ivar: _provider
...
@property (copy, nonatomic) TUConversationActivitySession *stagedActivitySession; // ivar: _stagedActivitySession
