...
-(BOOL)_selectionColorShouldOverrideColor:(id)arg0 ;
...
-(void)enumerateTextSegmentBoundsInTextRange:(id)arg0 withTextElementProvider:(id)arg1 baseLocation:(id)arg2 usingBlock:(id)arg3 ;
