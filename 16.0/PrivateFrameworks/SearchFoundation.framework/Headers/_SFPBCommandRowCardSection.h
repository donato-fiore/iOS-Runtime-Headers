...
#ifndef _SFPBCOMMANDROWCARDSECTION_H
#define _SFPBCOMMANDROWCARDSECTION_H

@class PBCodable, NSString, NSData, NSArray;
@protocol _SFPBCommandRowCardSection, NSSecureCoding;
...
@property (retain, nonatomic) _SFPBImage *toggledImage; // ivar: _toggledImage
@property (retain, nonatomic) _SFPBRichText *toggledTitle; // ivar: _toggledTitle
