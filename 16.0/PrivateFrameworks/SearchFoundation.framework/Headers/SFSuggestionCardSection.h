...
#ifndef SFSUGGESTIONCARDSECTION_H
#define SFSUGGESTIONCARDSECTION_H

@class NSString, NSArray, NSDictionary, NSData;
@protocol SFSuggestionCardSection, NSSecureCoding, NSCopying;
...
@property (retain, nonatomic) SFRichText *detailText; // ivar: _detailText
...
@property (retain, nonatomic) SFRichText *suggestionText; // ivar: _suggestionText
