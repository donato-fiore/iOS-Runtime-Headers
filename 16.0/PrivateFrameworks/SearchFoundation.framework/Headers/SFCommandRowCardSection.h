...
#ifndef SFCOMMANDROWCARDSECTION_H
#define SFCOMMANDROWCARDSECTION_H

@class NSString, NSArray, NSDictionary, NSData;
@protocol SFCommandRowCardSection, NSSecureCoding, NSCopying;
...
@property (retain, nonatomic) SFImage *toggledImage; // ivar: _toggledImage
@property (retain, nonatomic) SFRichText *toggledTitle; // ivar: _toggledTitle
