...
#ifndef SFPRODUCTCARDSECTION_H
#define SFPRODUCTCARDSECTION_H

@class NSString, NSArray, NSDictionary, NSData;
@protocol SFProductCardSection, NSSecureCoding, NSCopying;
...
@property (copy, nonatomic) NSData *productJSON; // ivar: _productJSON
