...
#ifndef SFSECTIONHEADERCARDSECTION_H
#define SFSECTIONHEADERCARDSECTION_H

@class NSString, NSArray, NSDictionary, NSData;
@protocol SFSectionHeaderCardSection, NSSecureCoding, NSCopying;
...
@property (retain, nonatomic) SFRichText *text; // ivar: _text
