...
#ifndef SFWORLDMAPCARDSECTION_H
#define SFWORLDMAPCARDSECTION_H

@class NSString, NSArray, NSDictionary, NSData;
@protocol SFWorldMapCardSection, NSSecureCoding, NSCopying;
...
@property (retain, nonatomic) SFLatLng *pinLocation; // ivar: _pinLocation
