...
#ifndef _SFPBATTRIBUTIONFOOTERCARDSECTION_H
#define _SFPBATTRIBUTIONFOOTERCARDSECTION_H

@class PBCodable, NSString, NSData, NSArray;
@protocol _SFPBAttributionFooterCardSection, NSSecureCoding;
...
@property (retain, nonatomic) _SFPBRichText *leadingAttribution; // ivar: _leadingAttribution
@property (retain, nonatomic) _SFPBPunchout *leadingAttributionPunchout; // ivar: _leadingAttributionPunchout
...
@property (retain, nonatomic) _SFPBRichText *trailingAttribution; // ivar: _trailingAttribution
@property (retain, nonatomic) _SFPBPunchout *trailingAttributionPunchout; // ivar: _trailingAttributionPunchout
