...
#ifndef SFATTRIBUTIONFOOTERCARDSECTION_H
#define SFATTRIBUTIONFOOTERCARDSECTION_H

@class NSString, NSArray, NSDictionary, NSData;
@protocol SFAttributionFooterCardSection, NSSecureCoding, NSCopying;
...
@property (retain, nonatomic) SFRichText *leadingAttribution; // ivar: _leadingAttribution
@property (retain, nonatomic) SFPunchout *leadingAttributionPunchout; // ivar: _leadingAttributionPunchout
...
@property (retain, nonatomic) SFRichText *trailingAttribution; // ivar: _trailingAttribution
@property (retain, nonatomic) SFPunchout *trailingAttributionPunchout; // ivar: _trailingAttributionPunchout
