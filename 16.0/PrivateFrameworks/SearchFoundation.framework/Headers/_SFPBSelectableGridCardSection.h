...
#ifndef _SFPBSELECTABLEGRIDCARDSECTION_H
#define _SFPBSELECTABLEGRIDCARDSECTION_H

@class PBCodable, NSString, NSArray, NSData;
@protocol _SFPBSelectableGridCardSection, NSSecureCoding;
...
@property (nonatomic) int initialSelectedIndex; // ivar: _initialSelectedIndex
