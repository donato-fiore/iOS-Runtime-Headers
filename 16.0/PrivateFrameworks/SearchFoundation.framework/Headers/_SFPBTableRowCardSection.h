...
@protocol _SFPBTableRowCardSection, NSSecureCoding;
...
@property (copy, nonatomic) NSArray *richDatas; // ivar: _richDatas
...
-(id)richDataAtIndex:(NSUInteger)arg0 ;
-(void)addData:(id)arg0 ;
-(void)addPunchoutOptions:(id)arg0 ;
-(void)addRichData:(id)arg0 ;
-(void)clearData;
-(void)clearPunchoutOptions;
-(void)clearRichData;
-(void)setData:(id)arg0 ;
-(void)setRichData:(id)arg0 ;
