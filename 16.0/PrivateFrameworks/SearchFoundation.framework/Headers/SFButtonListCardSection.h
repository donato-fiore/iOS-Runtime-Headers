...
#ifndef SFBUTTONLISTCARDSECTION_H
#define SFBUTTONLISTCARDSECTION_H

@class NSString, NSArray, NSDictionary, NSData;
@protocol SFButtonListCardSection, NSSecureCoding, NSCopying;
...
@property (copy, nonatomic) NSString *showMoreButtonTitle; // ivar: _showMoreButtonTitle
