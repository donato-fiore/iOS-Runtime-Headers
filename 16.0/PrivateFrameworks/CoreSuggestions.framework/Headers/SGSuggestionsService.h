...
-(BOOL)preventUnsubscriptionOpportunitiesSuggestionsForField:(NSInteger)arg0 toValues:(id)arg1 error:(*id)arg2 ;
...
-(id)identifyComposeWarningsFromSubject:(id)arg0 content:(id)arg1 attributes:(id)arg2 toRecipients:(id)arg3 ccRecipients:(id)arg4 bccRecipients:(id)arg5 originalToRecipients:(id)arg6 originalCcRecipients:(id)arg7 attachments:(id)arg8 error:(*id)arg9 ;
-(id)identifyComposeWarningsFromSubject:(id)arg0 content:(id)arg1 toRecipients:(id)arg2 ccRecipients:(id)arg3 bccRecipients:(id)arg4 originalToRecipients:(id)arg5 originalCcRecipients:(id)arg6 attachments:(id)arg7 error:(*id)arg8 ;
-(id)identifyFollowUpWarningFromSubject:(id)arg0 body:(id)arg1 date:(id)arg2 error:(*id)arg3 ;
-(id)identifyFollowUpWarningFromSubject:(id)arg0 content:(id)arg1 error:(*id)arg2 ;
-(id)identifyWarningsFromSubject:(id)arg0 content:(id)arg1 toRecipients:(id)arg2 ccRecipients:(id)arg3 bccRecipients:(id)arg4 attachments:(id)arg5 error:(*id)arg6 ;
-(id)identifyWarningsFromSubject:(id)arg0 content:(id)arg1 toRecipients:(id)arg2 ccRecipients:(id)arg3 bccRecipients:(id)arg4 originalToRecipients:(id)arg5 originalCcRecipients:(id)arg6 attachments:(id)arg7 error:(*id)arg8 ;
...
-(id)lastFollowUpWarningResultsWithLimit:(NSUInteger)arg0 includingResultsFromPreviousCall:(BOOL)arg1 error:(*id)arg2 ;
...
-(id)reportMailIntelligenceFollowUpUserEngagement:(NSInteger)arg0 forNSDataFromFollowUpWarning:(id)arg1 error:(*id)arg2 ;
-(id)reportMailIntelligenceFollowUpUserEngagement:(NSInteger)arg0 forStringFromFollowUpWarning:(id)arg1 error:(*id)arg2 ;
-(id)reportUserEngagement:(BOOL)arg0 forWarning:(id)arg1 error:(*id)arg2 ;
-(id)reportValue:(BOOL)arg0 forFeatureSetting:(NSInteger)arg1 error:(*id)arg2 ;
-(id)saliencyFromEmailHeaders:(id)arg0 error:(*id)arg1 ;
-(id)saliencyFromRFC822Data:(id)arg0 error:(*id)arg1 ;
-(id)sortedSaliencyResultsRestrictedToMailboxTypes:(id)arg0 mailboxIds:(id)arg1 receivedOnOrAfter:(id)arg2 ascending:(BOOL)arg3 limit:(NSUInteger)arg4 error:(*id)arg5 ;
-(id)sortedUnsubscriptionOpportunitiesForField:(NSInteger)arg0 limit:(NSUInteger)arg1 error:(*id)arg2 ;
-(id)sortedUnsubscriptionOpportunitiesForField:(NSInteger)arg0 minCount:(NSUInteger)arg1 minScore:(CGFloat)arg2 limit:(NSUInteger)arg3 error:(*id)arg4 ;
...
-(void)identifyWarningsFromSubject:(id)arg0 content:(id)arg1 toRecipients:(id)arg2 ccRecipients:(id)arg3 bccRecipients:(id)arg4 attachments:(id)arg5 withCompletion:(id)arg6 ;
