...
@class NSMutableDictionary, NSString, NSURL, NSSet, AKAppleIDSession, NSArray, NSDictionary, NSMutableSet, NSDateComponents, NSNumber;
...
@property (retain, nonatomic) NSSet *addedCalendars; // ivar: _addedCalendars
@property (nonatomic) BOOL alarmsDirty; // ivar: _alarmsDirty
@property (retain, nonatomic) AKAppleIDSession *appleIDSession; // ivar: _appleIDSession
@property (retain, nonatomic) NSArray *calendarChangesToClear; // ivar: _calendarChangesToClear
...
@property (nonatomic) BOOL isManuallyConfigured; // ivar: _isManuallyConfigured
...
@property (retain, nonatomic) NSSet *modifiedCalendars; // ivar: _modifiedCalendars
@property (nonatomic) BOOL needsDefaultAllDayAlarmUpdate; // ivar: _needsDefaultAllDayAlarmUpdate
@property (nonatomic) BOOL needsDefaultTimedAlarmUpdate; // ivar: _needsDefaultTimedAlarmUpdate
...
+(id)alarmICSStringFromOffset:(NSInteger)arg0 ;
...
-(void)removePreferredCalendarUserAddressesForCalendarWithIdentifier:(id)arg0 ;
-(void)removecalendarWithURL:(id)arg0 ;
-(void)updateAddedOrModifiedSubscribedCalendars:(id)arg0 ;
-(void)updatePropertiesFromCalStore:(*void)arg0 ;
