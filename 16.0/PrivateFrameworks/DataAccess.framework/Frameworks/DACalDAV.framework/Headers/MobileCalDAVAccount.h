...
-(BOOL)_updateCalendarStoreWithAlreadyOpenDBShouldCreate:(BOOL)arg0 syncingThisAccount:(BOOL)arg1 ;
...
-(id)portListByInsertingUserEnteredPort:(id)arg0 ;
-(id)preferredAddress;
-(id)principalPath;
...
-(void)setUseKerberos:(BOOL)arg0 ;
-(void)syncEndedWithError:(id)arg0 ;
-(void)syncStarted;
