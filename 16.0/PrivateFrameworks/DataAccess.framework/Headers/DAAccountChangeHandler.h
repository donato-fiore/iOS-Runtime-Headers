...
+(BOOL)_sanityCheckCalDAVAccount:(id)arg0 accountChangeInfo:(id)arg1 ;
+(BOOL)_sanityCheckChildAccountOfType:(id)arg0 withParent:(id)arg1 accountChangeInfo:(id)arg2 inStore:(id)arg3 updater:(id)arg4 ;
+(BOOL)_sanityCheckChildDAVAccount:(id)arg0 withParent:(id)arg1 accountChangeInfo:(id)arg2 ;
...
+(void)_performBlockWithGenericClientDBForAccount:(id)arg0 block:(id)arg1 ;
