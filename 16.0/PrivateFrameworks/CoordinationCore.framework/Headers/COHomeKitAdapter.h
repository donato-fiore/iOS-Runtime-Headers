...
@class NSCondition, NSString, HMHomeManager, MGDaemon, NSDictionary;
@protocol HMHomeManagerDelegate, HMHomeDelegatePrivate, _COHomeKitMediaGroupsListenerDelegate;

#import <Foundation/Foundation.h>


@interface COHomeKitAdapter : NSObject <HMHomeManagerDelegate, HMHomeDelegatePrivate, _COHomeKitMediaGroupsListenerDelegate>
...
@property (copy, nonatomic) NSDictionary *mediaGroupsListeners; // ivar: _mediaGroupsListeners
...
-(void)home:(id)arg0 didAddMediaGroup:(id)arg1 ;
...
-(void)home:(id)arg0 didRemoveMediaGroup:(id)arg1 ;
