...
@class NSSet, CNContactStore, NSArray, _CDInteractionStore, _CDInteractionCache, NSNumber, NSUserDefaults, PPContactStore, NSDictionary, PPTopicStore, TRIClient, NSString, TRITrackingId;
