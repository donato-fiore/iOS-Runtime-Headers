...
@class AVPlayerPlaybackCoordinator, MPSectionedIdentifierListPosition, MPSectionedIdentifierList, NSMutableDictionary, MPAVItem, NSString, MPShuffleableSectionedIdentifierList, MPIdentifierSet, NSArray;
@protocol MPShuffleableSectionedIdentifierListDelegate, MPSectionedIdentifierListAnnotationDelegate, MPCContinueListeningRadioQueueProviding, MPCPlaybackEngineEventObserving, MPArtworkDataSource, MPStartItemInfoProviding, MPCQueueItemProviding, MSVSegmentedCoding, MPCQueueControllerCommandInterposingHost, MPCQueueControllerCommandInterposing, MPCQueueControllerDelegate, MPCQueueCoordinating;
...
@property (readonly, nonatomic) NSObject<MPCQueueControllerCommandInterposing> *commandInterposingDataSource;
...
@property (copy, nonatomic) NSString *currentStartItemIdentifier; // ivar: _currentStartItemIdentifier
...
@property (retain, nonatomic) NSObject<MPCQueueCoordinating> *queueCoordinator; // ivar: _queueCoordinator
...
-(BOOL)canNextTrackForItem:(id)arg0 reason:(*id)arg1 ;
-(BOOL)canPreviousTrackForItem:(id)arg0 reason:(*id)arg1 ;
...
-(void)_loadItemsForAutoplaySessionWithDeletedItemsCount:(NSInteger)arg0 ;
...
-(void)autoPlayEnabledDidChange:(BOOL)arg0 ;
-(void)cancelLoadingRepresentationForArtworkCatalog:(id)arg0 ;
-(void)clearUpNext;
-(void)currentItemDidChangeFromItem:(id)arg0 toItem:(id)arg1 ;
-(void)dealloc;
