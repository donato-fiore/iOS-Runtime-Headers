...
@protocol MFPlaybackStackControllerDelegate, MPCQueueControllerDelegate, MPCAssetLoaderDelegate, MPCPlaybackEngineImplementation, MFAssetLoading, MPCPlaybackEngineEventStreamDeferralAssertion, MFPlaybackStackController><MFQueueManagement;
...
@property (retain, nonatomic) MPCPlayPerfAnalytics *playPerfAnalytics; // ivar: _playPerfAnalytics
