...
@property (nonatomic) CGFloat networkingTime; // ivar: _networkingTime
@property (readonly) Class superclass;


-(id)equivalencySourceStoreAdamIDForLocalStoreAdamID:(NSInteger)arg0 ;
-(id)initWithRequest:(id)arg0 personalizationResponse:(id)arg1 results:(id)arg2 networkingTime:(CGFloat)arg3 ;
