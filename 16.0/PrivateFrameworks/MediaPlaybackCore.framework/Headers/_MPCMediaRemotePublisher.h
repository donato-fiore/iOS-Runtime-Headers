...
@property (retain, nonatomic) MPCPlayPerfMetrics *lastPerformanceMetrics; // ivar: _lastPerformanceMetrics
...
-(id)_homeAccessorySettingsPrivateListeningOverride:(id)arg0 ;
