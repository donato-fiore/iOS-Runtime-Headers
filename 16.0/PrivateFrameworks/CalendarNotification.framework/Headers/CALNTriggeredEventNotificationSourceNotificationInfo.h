...
-(id)description;
-(id)initWithTitle:(id)arg0 location:(id)arg1 locationWithoutPrediction:(id)arg2 preferredLocation:(id)arg3 startDate:(id)arg4 endDate:(id)arg5 isAllDay:(BOOL)arg6 isTimeSensitive:(BOOL)arg7 launchURL:(id)arg8 isLocationEvent:(BOOL)arg9 eventID:(id)arg10 eventObjectID:(id)arg11 calendarIdentifier:(id)arg12 eventRepresentationDictionary:(id)arg13 legacyIdentifier:(id)arg14 mapItemURL:(id)arg15 conferenceURL:(id)arg16 mailtoURL:(id)arg17 hasSuggestedLocation:(BOOL)arg18 eventHasAlarms:(BOOL)arg19 alarmID:(id)arg20 isOffsetFromTravelTimeStart:(BOOL)arg21 lastFireTimeOfAlertOffsetFromTravelTime:(id)arg22 allowsLocationAlerts:(BOOL)arg23 hypothesis:(id)arg24 travelAdvisoryTimelinessPeriod:(NSUInteger)arg25 forceDisplayOfNewTravelAdvisoryHypotheses:(BOOL)arg26 ;
