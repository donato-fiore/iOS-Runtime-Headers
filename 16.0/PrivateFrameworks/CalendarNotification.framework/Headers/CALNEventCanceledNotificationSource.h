...
@protocol CALNNotificationSource, CALNEventCanceledNotificationDataSource, CalDateProvider, CALNCalendarIconIdentifierProvider, CALNNotificationManager;
...
@property (readonly, nonatomic) NSObject<CALNEventCanceledNotificationDataSource> *dataSource; // ivar: _dataSource
