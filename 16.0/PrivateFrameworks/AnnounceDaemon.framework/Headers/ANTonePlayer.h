...
@property (nonatomic) unsigned int proxyAudioSessionID; // ivar: _proxyAudioSessionID
@property (nonatomic) BOOL usingProxyAudioSession; // ivar: _usingProxyAudioSession


-(BOOL)_activateAudioSessionForPlayer:(id)arg0 error:(*id)arg1 ;
-(id)initWithAudioSessionID:(unsigned int)arg0 endpointUUID:(id)arg1 ;
