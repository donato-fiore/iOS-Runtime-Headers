...
#ifndef _TTC19APPSTOREKITINTERNAL16OFFERALERTACTION_H
#define _TTC19APPSTOREKITINTERNAL16OFFERALERTACTION_H

@class TtC19AppStoreKitInternal6Action;



@interface _TtC19AppStoreKitInternal16OfferAlertAction : TtC19AppStoreKitInternal6Action {
    ? message;
    ? footerMessage;
    ? isCancelable;
