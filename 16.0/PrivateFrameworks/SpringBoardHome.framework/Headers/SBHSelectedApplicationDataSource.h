...
@interface SBHSelectedApplicationDataSource : NSObject <LSApplicationWorkspaceObserverProtocol, SBHIconModelApplicationDataSource, BSDescriptionProviding>

 {
    ...
    os_unfair_lock_s _installProgressBundleIdentifiersLock;
}
...
-(void)_lock_beginObservingInstallProgress:(id)arg0 forBundleIdentifier:(id)arg1 ;
-(void)_lock_endObservingInstallProgress:(id)arg0 ;
