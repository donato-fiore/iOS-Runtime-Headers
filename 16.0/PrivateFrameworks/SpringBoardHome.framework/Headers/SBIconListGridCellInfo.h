...
-(NSUInteger)indexOfFirstUsedGridCellInGridRange:(struct SBHIconGridRange )arg0 ;
...
-(NSUInteger)numberOfUsedGridCellsInGridRange:(struct SBHIconGridRange )arg0 ;
...
-(void)setIconIndex:(NSUInteger)arg0 inGridRange:(struct SBHIconGridRange )arg1 ;
