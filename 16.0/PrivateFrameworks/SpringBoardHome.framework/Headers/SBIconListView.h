...
@class UIView, NSMutableSet, NSMapTable, NSHashTable, NSMutableDictionary, NSMutableArray, NSString, NSArray, _UILegibilitySettings, NSLayoutConstraint;
@protocol SBIconObserver, PTSettingsKeyObserver, SBIconListModelObserver, SBIconViewQuerying, SBHVisibleContentPresenter, BSDescriptionProviding, SBIconListViewDragDelegate, SBIconViewProviding, SBIconListLayout, SBIconListLayoutDelegate, SBIconListLayoutProvider, SBIconWidgetIntroductionDelegate;
...
-(NSInteger)dragHitRegionForPoint:(struct CGPoint )arg0 icon:(id)arg1 ;
...
-(struct SBIconCoordinate )coordinateAtPoint:(struct CGPoint )arg0 metrics:(id)arg1 ;
...
-(void)_getOverlappingRegionRect:(struct CGRect *)arg0 beforeRegionRect:(struct CGRect *)arg1 afterRegionRect:(struct CGRect *)arg2 aboveRegionRect:(struct CGRect *)arg3 belowRegionRect:(struct CGRect *)arg4 forIconView:(id)arg5 ;
