...
@class UIView, NSString, NSMutableDictionary, UIImageView;
...
@property (readonly, nonatomic) NSMutableDictionary *shadowImages; // ivar: _shadowImages
...
-(id)_shadowImageForMetrics:(id)arg0 previousMetrics:(id)arg1 ;
-(id)_shadowImageViewForMetrics:(id)arg0 previousMetrics:(id)arg1 ;
