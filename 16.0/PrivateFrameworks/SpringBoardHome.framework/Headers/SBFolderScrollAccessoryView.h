...
@class UIView, SBFFluidBehaviorSettings, UIPageControl, UIViewFloatAnimatableProperty, _UIPortalView;
...
@property (retain, nonatomic) _UIPortalView *pageControlPortalView; // ivar: _pageControlPortalView
...
-(void)_applyMatchingAnimationsForBackgroundMatchingContentView:(id)arg0 backgroundView:(id)arg1 ;
