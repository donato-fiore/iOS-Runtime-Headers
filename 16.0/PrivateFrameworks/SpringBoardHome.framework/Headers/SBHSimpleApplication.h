...
@property (nonatomic, getter=isProgressPaused) BOOL progressPaused; // ivar: _progressPaused
@property (nonatomic) CGFloat progressPercent; // ivar: _progressPercent
@property (nonatomic) NSInteger progressState; // ivar: _progressState
...
-(void)updateProgressState:(NSInteger)arg0 progressPercent:(CGFloat)arg1 progressPaused:(BOOL)arg2 ;
