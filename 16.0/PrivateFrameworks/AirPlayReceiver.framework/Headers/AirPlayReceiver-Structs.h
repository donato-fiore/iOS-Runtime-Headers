...
typedef struct OpaqueAPReceiverSystemInfo {
} // Error Processing Struct Fields
...
typedef struct ? {
    id playerPath;
    void MRPlayerPath;
    OpaqueFigCFWeakReferenceHolder commandHandlerToken;
} ?;
...
typedef struct OpaqueAPAdvertiser {
} // Error Processing Struct Fields

typedef struct OpaqueAPConnectivityHelper {
} // Error Processing Struct Fields

typedef struct HTTPServerPrivate {
} // Error Processing Struct Fields

typedef struct __CFSet {
} // Error Processing Struct Fields

typedef struct OpaqueAPAdvertiserInfo {
} // Error Processing Struct Fields
...
typedef struct OpaqueAPAdvertiserBTLEManager {
    __CFRuntimeBase field0;
    id field1;
} OpaqueAPAdvertiserBTLEManager;
