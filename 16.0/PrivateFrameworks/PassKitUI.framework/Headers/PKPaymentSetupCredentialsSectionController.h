...
@class PKPaymentProvisioningController, NSString, NSMutableArray, PKPaymentSetupProduct, NSHashTable;
@protocol PKPaymentProvisioningControllerDelegate, PKPaymentSetupCredentialsSectionControllerDelegate;
...
-(void)_promptToDeleteItem:(id)arg0 completion:(id)arg1 ;
