...
-(id)_indexPathForItemIdentifier:(id)arg0 ;
...
-(id)_supplementaryRegistrationForSection:(id)arg0 sectionIdentifier:(id)arg1 elementKind:(id)arg2 ;
...
-(void)_reloadSectionMapForSections:(id)arg0 animated:(BOOL)arg1 ;
-(void)collectionView:(id)arg0 didSelectItemAtIndexPath:(id)arg1 ;
-(void)collectionView:(id)arg0 willDisplayCell:(id)arg1 forItemAtIndexPath:(id)arg2 ;
-(void)deselectCells;
-(void)loadView;
-(void)reconfigureHeaderAndFooterForSectionIdentifier:(id)arg0 ;
-(void)reloadDataAnimated:(BOOL)arg0 ;
-(void)reloadDataForSection:(id)arg0 animated:(BOOL)arg1 ;
...
-(void)scrollToItem:(id)arg0 atScrollPosition:(NSUInteger)arg1 animated:(BOOL)arg2 ;
