...
@class PKPeerPaymentWebService, PKPeerPaymentController, PKPaymentPass, PKPaymentTransaction, NSArray, PKAccount, PKTransactionReceipt, NSString, PKCoarseLocationMonitor, PKFamilyMemberCollection, PKAccountUserCollection, NSSet, PKPaymentWebService, PKRetrieveMerchantTokensResponse, PKDashboardTransactionFetcher, NSURL, PKContactResolver, UIImage, PKPeerPaymentStatusResponse, NSTimeZone, NSDateFormatter, PKTransactionSourceCollection;
