...
@class PKPaymentService, PKAuthenticator, PKContactlessInterfaceSession, PKPeerPaymentService, PKContactResolver, LAUIPhysicalButtonView, LANotificationUIAppearance, UIView<PKPaymentDashboardCellActionHandleable>, UIView, NSString, PKPassLibrary, UIButton, NSData, NSMutableArray, UIViewController, NSNumber, PKTransitBalanceModel, NSArray, PKAssertion, PKPaymentTransaction, UITextView, PKMerchant, NFDCKAssertion;
@protocol PKPaymentServiceDelegate, PKAuthenticatorDelegate, PKPassPaymentPayStateViewDelegate, PKPassPaymentApplicationViewDelegate, PKContactlessInterfaceSessionDelegate, PKForegroundActiveArbiterObserver, PKUIForegroundActiveArbiterDeactivationObserver, PKPassTileGroupViewDelegate, PKTransactionAuthenticationPasscodeViewControllerDelegate, PKLinkedApplicationObserver, UITextViewDelegate, PKDataReleaseViewControllerDelegate, PKCompactNavigationContainerControllerDelegate, LANotificationObserver, OS_dispatch_queue, UICoordinateSpace, OS_dispatch_source;
...
@interface PKPassPaymentContainerView : PKPassFooterContentView <PKPaymentServiceDelegate, PKAuthenticatorDelegate, PKPassPaymentPayStateViewDelegate, PKPassPaymentApplicationViewDelegate, PKContactlessInterfaceSessionDelegate, PKForegroundActiveArbiterObserver, PKUIForegroundActiveArbiterDeactivationObserver, PKPassTileGroupViewDelegate, PKTransactionAuthenticationPasscodeViewControllerDelegate, PKLinkedApplicationObserver, UITextViewDelegate, PKDataReleaseViewControllerDelegate, PKCompactNavigationContainerControllerDelegate, LANotificationObserver>

 {
    ...
    LANotificationUIAppearance *_systemApertureNotification;
    BOOL _systemAperturePresented;
...
-(void)notification:(id)arg0 completionHandler:(id)arg1 ;
