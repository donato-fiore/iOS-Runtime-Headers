...
@class PKPaymentPass, PKPaymentApplication, PKPeerPaymentAccount, PKPassLibraryDefaultDataProvider, PKExpressPassController, PKPaymentDefaultDataProvider, NSArray, NSString;
@protocol PKPaymentPassDetailTableViewSectionController, PKPassDetailsCardInfoSectionControllerDelegate;
...
+(BOOL)_showExpressDetailsForPass:(id)arg0 expressMode:(BOOL)arg1 ;
