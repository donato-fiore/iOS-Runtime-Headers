...
@class BKPresenceDetectOperation, NSMutableArray, PKPaymentPass, UIButton, PKAccountService, NSArray, NFDCKAssertion, LANotificationUIAppearance, NSString, PKPass;
@protocol PKForegroundActiveArbiterObserver, _PKUIKVisibilityBackdropViewDelegate, PKDashboardPassTilesItemPresenterDelegate, PKAccountServiceObserver, PKDashboardMoreMenuFactoryDelegate, BKOperationDelegate, LANotificationObserver, PKInvalidatable, OS_dispatch_source, OS_dispatch_queue, PKDashboardPassViewControllerDelegate><PKDashboardDelegate;
...
@interface PKDashboardPassViewController : PKDashboardViewController <PKForegroundActiveArbiterObserver, _PKUIKVisibilityBackdropViewDelegate, PKDashboardPassTilesItemPresenterDelegate, PKAccountServiceObserver, PKDashboardMoreMenuFactoryDelegate, BKOperationDelegate, LANotificationObserver, PKInvalidatable>
