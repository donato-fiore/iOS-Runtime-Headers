...
@class PKGroup, NSArray, NSDate, PKContactResolver, PKTransitBalanceModel, PKPaymentDefaultDataProvider, PKSecureElement, NSOrderedSet, NSDateFormatter, NSMutableArray, PKAccountService, PKCreditAccountStatement, PKSpendingSummary, NSError, NSMutableSet, NSMutableDictionary, NSString, UIImage, PKAMPEnrollmentManager, AMSEngagement, AMSPromise, PKAccount, PKAccountUserCollection, PKFamilyMemberCollection, NSDictionary, PKCurrencyAmount, PKPaymentPass, PKPayLaterPaymentIntentController, PKPeerPaymentAccount, PKPeerPaymentWebService, NSSet, PKPayLaterFinancingPlansFetcher, PKSpendingSummaryFetcher, PKDashboardTransactionFetcher, PKTransactionSourceCollection;
@protocol PKSecureElementObserver, PKPaymentDataProviderDelegate, PKPaymentVerificationControllerDelegate, PKPeerPaymentAccountResolutionControllerDelegate, PKForegroundActiveArbiterObserver, PKSpendingSummaryFetcherObserver, PKAccountServiceAccountResolutionControllerDelegate, PKDiscoveryObserver, PKPaymentSetupViewControllerDelegate, PKAccountServiceObserver, PKLinkedApplicationObserver, PKInboxDataSourceDelegate, PKSecureElementPassContactIssuerHelperDelegate, PKPeerPaymentServiceObserver, AMSEngagementObserver, PKVirtualCardEnrollmentViewControllerDelegate, PKPayLaterDashboardMessageComposerDelegate, PKDashboardPassDataSource, PKDashboardTransactionFetcherDelegate, OS_dispatch_source, PKDashboardDataSourceDelegate;
...
-(id)_processUpcomingInstallmentsWithFinancingPlans:(id)arg0 sectionsToReload:(id)arg1 changedIndexPaths:(id)arg2 dueNext30Days:(*id)arg3 totalPending:(*id)arg4 ;
...
-(void)_AMPEngagementRequestsWithCompletion:(id)arg0 ;
...
-(void)_processUpdatedCompletedFinancingPlans:(id)arg0 sectionsToReload:(id)arg1 changedIndexPaths:(id)arg2 ;
-(void)_processUpdatedFinancingPlans:(id)arg0 sectionsToReload:(id)arg1 changedIndexPaths:(id)arg2 ;
-(void)_reloadMessages;
-(void)_replaceDashboardMessagePlaceholders:(id)arg0 ;
