...
-(id)_autoPayAvailableMessageForSharedCacheKey:(id)arg0 identifierKey:(id)arg1 productType:(NSUInteger)arg2 messageString:(id)arg3 ;
-(id)_flagImage;
...
-(id)_turnOnNotificationsMessage;
-(id)_warningImage;
...
-(void)_presentBusinessChatForApplePayLaterAccount;
