...
@class UIViewController, UIActivityIndicatorView, NSLayoutConstraint, PKPaymentAuthorizationCoordinator, UIImage, NSDecimalNumber, NSString, UIImageView, PKPaymentSetupProduct, PKPaymentProvisioningController, PKPaymentProvisioningMethodMetadata, PKServiceProviderPurchase, RemoteUIController, UILabel;
@protocol PKPaymentSetupPurchaseAmountViewDelegate, PKPaymentAuthorizationCoordinatorDelegate, PKPaymentAuthorizationCoordinatorPrivateDelegate, PKPaymentSetupViewControllerDelegate, PKPaymentSetupPurchaseControllerDelegate, RemoteUIControllerDelegate, PKPaymentSetupDelegate, PKViewControllerPreflightable;
