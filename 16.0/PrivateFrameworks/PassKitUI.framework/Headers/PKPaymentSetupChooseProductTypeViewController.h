...
@protocol PKViewControllerPreflightable, PKPaymentSetupChooseProductListSectionControllerDelegate, PKPaymentSetupViewControllerDelegate;
...
-(void)didSelectPKPaymentSetupChooseProductListItem:(id)arg0 ;
