...
typedef struct WeakHashSet<WebCore::MotionManagerClient, WTF::EmptyCounter, WTF::EnableWeakPtrThreadingAssertions::Yes> {
...
} WeakHashSet<WebCore::MotionManagerClient, WTF::EmptyCounter, WTF::EnableWeakPtrThreadingAssertions::Yes>;
