...
@property (readonly) HMIVideoFrameSampler *frameSampler; // ivar: _frameSampler
@property (readonly) NSUInteger hash;
@property (readonly) Class superclass;


+(id)logCategory;
-(BOOL)handleSampleBuffer:(struct opaqueCMSampleBuffer *)arg0 background:(struct opaqueCMSampleBuffer *)arg1 motionDetections:(id)arg2 tracks:(id)arg3 ;
