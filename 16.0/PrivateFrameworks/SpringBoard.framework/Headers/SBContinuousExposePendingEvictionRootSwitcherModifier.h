...
#ifndef SBCONTINUOUSEXPOSEPENDINGEVICTIONROOTSWITCHERMODIFIER_H
#define SBCONTINUOUSEXPOSEPENDINGEVICTIONROOTSWITCHERMODIFIER_H
...
@interface SBContinuousExposePendingEvictionRootSwitcherModifier : SBGestureRootSwitcherModifier
