...
@class UIViewController, NSSet, BBObserver, NSMutableSet, NSIndexPath, BSEventQueue, NSMutableArray, NSMapTable, SBHIconImageCache, NSMutableDictionary, SBHLibraryCategoryMapProvider, NSHashTable, SBHIconEditingSettings, SBHWidgetSettings, UILongPressGestureRecognizer, UITapGestureRecognizer, NSNumber, UIView, NSDate, UIWindow, SBFolderController, NSString, NSTimer, DNDModeConfigurationService, DNDStateService, SBIconDragManager, SBHIconManager, _UILegibilitySettings, PTSingleTestRecipe, SBHLibraryViewController, SBRootFolder, SBRootFolderController, SBHRootFolderSettings, UIView<SBHLegibility>, SBHHomePullToSearchSettings, PTDoubleTestRecipe, NSArray;
...
-(id)initWithMainDisplayWindowScene:(id)arg0 applicationController:(id)arg1 applicationPlaceholderController:(id)arg2 userInterfaceController:(id)arg3 policyAggregator:(id)arg4 alertItemsController:(id)arg5 assistantController:(id)arg6 powerLogAggregator:(id)arg7 ;
