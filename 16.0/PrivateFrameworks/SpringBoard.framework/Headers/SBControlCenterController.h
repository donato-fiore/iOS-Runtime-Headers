...
@class NSString, NSSet, BSSimpleAssertion, CCUIStatusBarStyleSnapshot, _UILegibilitySettings, NSHashTable, PTSingleTestRecipe, NSArray, UIApplicationSceneDeactivationAssertion, UIPanGestureRecognizer, NSMutableDictionary, CCUIModularControlCenterOverlayViewController;
@protocol CCUIModularControlCenterOverlayViewControllerDelegate, SBGrabberTongueDelegate, CSExternalBehaviorProviding, CSExternalPresentationProviding, CSExternalAppearanceProviding, UIGestureRecognizerDelegate, SBSystemGestureRecognizerDelegate, SBBarSwipeAffordanceObserver, SBBarSwipeAffordanceDelegate, SBFIdleTimerBehaviorProviding, CCUIHostStatusBarStyleProvider, SBReachabilityObserver, SBFSensorActivityObserver, SBIndirectPanGestureRecognizerOrientationProviding, SBHomeGrabberPointerClickDelegate, SBWindowLevelAssertionManagerDelegate, SBIdleTimerProviding, CSCoverSheetOverlaying, SBWindowLevelAssertionProviding, BSInvalidatable, SBIdleTimerCoordinating, UICoordinateSpace, SBFSensorActivityDataProvider;
...
@property (retain, nonatomic) SBWindowSceneStatusBarSettingsAssertion *statusBarAssertion; // ivar: _statusBarAssertion
...
@property (retain, nonatomic) NSMutableDictionary *systemApertureAssertionForRestrictionType; // ivar: _systemApertureAssertionForRestrictionType
...
@property (retain, nonatomic) SBWindowLevelAssertionManager *windowLevelAssertionManager; // ivar: _windowLevelAssertionManager
...
-(id)_newSystemApertureRestrictionAssertionForType:(NSUInteger)arg0 withReason:(id)arg1 ;
...
-(void)_updateWindowForScene:(id)arg0 ;
...
-(void)invalidateSystemApertureAssertionForType:(NSUInteger)arg0 withReason:(id)arg1 ;
-(void)presentAnimated:(BOOL)arg0 ;
-(void)presentAnimated:(BOOL)arg0 completion:(id)arg1 ;
-(void)removeObserver:(id)arg0 ;
-(void)restrictSystemApertureToType:(NSUInteger)arg0 withReason:(id)arg1 ;
