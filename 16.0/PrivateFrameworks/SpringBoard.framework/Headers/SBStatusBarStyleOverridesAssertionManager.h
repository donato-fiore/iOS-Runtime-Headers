...
@protocol NSXPCListenerDelegate, SBWindowSceneStatusBarAssertionManagerObserver, SBStatusBarStyleOverridesAssertionServer, BSDescriptionProviding, OS_dispatch_source, OS_dispatch_queue;
...
@property (retain, nonatomic) SBWindowSceneStatusBarAssertionManager *appStatusBarAssertionManager; // ivar: _appStatusBarAssertionManager
