...
-(id)initWithSceneHandle:(id)arg0 screen:(id)arg1 sceneManager:(id)arg2 workspace:(id)arg3 bannerManager:(id)arg4 lockScreenManager:(id)arg5 deactivationManager:(id)arg6 mainSwitcherCoordinator:(id)arg7 windowScene:(id)arg8 backlightController:(id)arg9 keyboardFocusController:(id)arg10 springBoard:(id)arg11 setupManager:(id)arg12 uiController:(id)arg13 pipCoordinator:(id)arg14 ;
