...
@property (retain, nonatomic) SBCornerFingerPanGestureSettings *fingerGestureSettings; // ivar: _fingerGestureSettings
...
@property (retain, nonatomic) SBCornerPencilPanGestureSettings *pencilGestureSettings; // ivar: _pencilGestureSettings
