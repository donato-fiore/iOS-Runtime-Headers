...
+(id)initialLayoutStateWithDisplayOrdinal:(NSInteger)arg0 ;
...
-(id)_mostRecentAppLayoutMatchingAnyUniqueIdentifier:(id)arg0 ;
...
-(id)defaultSceneIdentifierForBundleIdentifier:(id)arg0 targetContentIdentifier:(id)arg1 allowCanMatches:(BOOL)arg2 preferNewScene:(BOOL)arg3 visibleSceneIdentifiers:(id)arg4 excludingSceneIdentifiers:(id)arg5 sceneSessionRole:(id)arg6 preferedDisplay:(id)arg7 ;
