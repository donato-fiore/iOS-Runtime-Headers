...
@class BSEventQueue, SBFAuthenticationAssertion, NSHashTable, SiriPresentationSpringBoardMainScreenViewController, NSSet, NSString;
...
-(void)_systemApertureEdgeInsetsDidChange:(id)arg0 ;
