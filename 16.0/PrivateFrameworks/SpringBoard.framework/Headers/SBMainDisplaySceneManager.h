...
@class UIApplicationSceneClientSettingsDiffInspector, FBSSceneClientSettingsDiffInspector, NSHashTable, NSMutableDictionary, NSMapTable, UIView, UIWindow, NSString;
...
@property (readonly, nonatomic) UIView *_inputUIContainerView;
@property (readonly, nonatomic, getter=_isKeyboardVisibleForSpringBoard) BOOL _isKeyboardVisibleForSpringBoard;
@property (readonly, nonatomic, getter=_isUsingInputUI) BOOL _isUsingInputUI;
