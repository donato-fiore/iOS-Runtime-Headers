...
-(id)_closestWindowSceneToPoint:(struct CGPoint )arg0 inCoordinatesOfWindowScene:(id)arg1 ;
...
-(void)_updateOffScreenHyperregionComposers;
-(void)_updateOffScreenHyperregionComposersForContext:(id)arg0 ;
-(void)_updateOffScreenHyperregionComposersForContext:(id)arg0 interactionController:(id)arg1 dataSource:(id)arg2 ;
