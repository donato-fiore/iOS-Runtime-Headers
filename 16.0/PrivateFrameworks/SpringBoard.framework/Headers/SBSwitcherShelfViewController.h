...
-(id)initWithSwitcherController:(id)arg0 shelf:(id)arg1 delegate:(id)arg2 ;
...
-(void)_performNewWindowRequestForBundleIdentifier:(id)arg0 ;
-(void)_performSwitcherTransitionRequest:(id)arg0 ;
