...
@protocol UIGestureRecognizerDelegate, SBPIPSystemGestureRecognizerDelegate, PTSettingsKeyPathObserver, SBPIPPositionHyperregionComposerDelegate, SBPIPInteractionControllerDelegate, BSInvalidatable, SBPIPInteractionControllerDataSource;
...
-(void)reloadData;
-(void)setContainerSize:(struct CGSize )arg0 withOrientation:(NSInteger)arg1 ;
