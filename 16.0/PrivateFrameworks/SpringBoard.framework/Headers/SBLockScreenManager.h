...
@class SBFAuthenticationAssertion, SBSRemoteAlertHandle, SBFMouseButtonDownGestureRecognizer, NSMutableDictionary, NSMutableSet, UINotificationFeedbackGenerator, NSString, CSCoverSheetViewController, SBFUserAuthenticationController;
