...
@class SBPIPContainerViewController<SBPIPContainerViewControllerAdapterContextProviding>, UIButton, NSArray, NSString, PGPictureInPictureViewController;
...
-(void)offScreenHyperregionComposersDidChange:(id)arg0 ;
