...
@class SBStatusBarDefaults, NSHashTable, NSTimer, NSDateFormatter, NSString, NSMutableArray, CBCentralManager, SBSStatusBarStyleOverridesAssertion, NSMutableDictionary, STAirPlayStatusDomain, STBatteryStatusDomain, STCallingStatusDomain, STFocusStatusDomain, STPlaygroundsStatusDomain, NSArray, STTelephonyStatusDomainDataProvider, STTelephonyStatusDomain, STVoiceControlStatusDomain, STWifiStatusDomain;
