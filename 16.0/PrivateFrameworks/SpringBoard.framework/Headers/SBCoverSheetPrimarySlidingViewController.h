...
@protocol SBGrabberTongueDelegate, SBReachabilityObserver, SBCoverSheetGrabberDelegate, PBUIWallpaperAnimatedInvalidating;
...
@property (retain, nonatomic) SBCoverSheetBlurView *behindCoverSheetBlurView; // ivar: _behindCoverSheetBlurView
...
@property (nonatomic) BOOL hasCommittedCurrentTransition; // ivar: _hasCommittedCurrentTransition
@property (readonly) NSUInteger hash;
@property (retain, nonatomic) NSObject<PBUIWallpaperAnimatedInvalidating> *homescreenWallpaperScaleAssertion; // ivar: _homescreenWallpaperScaleAssertion
@property (retain, nonatomic) NSObject<PBUIWallpaperAnimatedInvalidating> *lockscreenWallpaperScaleAssertion; // ivar: _lockscreenWallpaperScaleAssertion
...
@property (nonatomic) CGFloat presentationProgressAtCommit; // ivar: _presentationProgressAtCommit
...
-(void)_controlCenterWindowSceneDidConnect:(id)arg0 ;
...
-(void)_updateWallpaperScaled:(BOOL)arg0 animated:(BOOL)arg1 ;
