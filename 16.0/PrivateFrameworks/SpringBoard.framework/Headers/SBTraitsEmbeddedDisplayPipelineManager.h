...
@protocol SBFTraitsArbiterInputsDataSource, BKSAccelerometerDelegate, SBBacklightControllerObserver, SBLayoutStateTransitionObserver, SBFTraitsParticipantDelegate, SBControlCenterObserver, SBFTraitsArbiterObserver;
...
@interface SBTraitsEmbeddedDisplayPipelineManager : SBTraitsPipelineManager <SBFTraitsArbiterInputsDataSource, BKSAccelerometerDelegate, SBBacklightControllerObserver, SBLayoutStateTransitionObserver, SBFTraitsParticipantDelegate, SBControlCenterObserver, SBFTraitsArbiterObserver>
...
@property (weak, nonatomic) SBControlCenterController *controlCenter; // ivar: _controlCenter
