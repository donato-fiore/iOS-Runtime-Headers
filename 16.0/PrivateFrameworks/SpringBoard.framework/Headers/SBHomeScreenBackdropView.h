...
@class MTMaterialView, UIImage, UIImageView, UIViewFloatAnimatableProperty, NSString;
...
@property (copy, nonatomic) NSString *materialRecipeName; // ivar: _materialRecipeName
