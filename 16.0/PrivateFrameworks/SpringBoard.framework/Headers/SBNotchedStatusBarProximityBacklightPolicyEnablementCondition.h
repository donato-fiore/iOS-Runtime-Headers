...
@protocol SBWindowSceneStatusBarAssertionManagerObserver, SBMainDisplaySceneManagerObserver, SBDeviceApplicationSceneHandleObserver, UIStatusBarServerClient, SBUIActiveOrientationObserver, BSInvalidatable, SBNotchedStatusBarProximityBacklightPolicyEnablementConditionDelegate;
...
-(id)init;
-(id)initWithMainDisplaySceneManager:(id)arg0 windowSceneStatusBarManager:(id)arg1 statusBarServer:(id)arg2 orientationProvider:(id)arg3 ;
