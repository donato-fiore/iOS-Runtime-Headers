...
-(NSInteger)sizingPolicyForDisplayItem:(id)arg0 contentOrientation:(NSInteger)arg1 containerOrientation:(NSInteger)arg2 proposedSizingPolicy:(NSInteger)arg3 ;
...
-(struct CGRect )initialStageFrameForAppLayout:(id)arg0 containerOrientation:(NSInteger)arg1 chamoisLayoutAttributes:(id)arg2 floatingDockHeight:(CGFloat)arg3 screenScale:(CGFloat)arg4 bounds:(struct CGRect )arg5 prefersStripHidden:(BOOL)arg6 prefersDockHidden:(BOOL)arg7 ;
