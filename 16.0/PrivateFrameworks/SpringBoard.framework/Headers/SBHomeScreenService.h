...
@property (readonly, nonatomic) FBServiceClientAuthenticator *addApplicationIconAuthenticator; // ivar: _addApplicationIconAuthenticator
...
@property (readonly, nonatomic) FBServiceClientAuthenticator *addSuggestedPageAuthenticator; // ivar: _addSuggestedPageAuthenticator
...
@property (readonly, nonatomic) FBServiceClientAuthenticator *showsHomeScreenSearchAffordanceAuthenticator; // ivar: _showsHomeScreenSearchAffordanceAuthenticator
@property (copy, nonatomic) NSNumber *showsHomeScreenSearchAffordanceValue;
@property (readonly, nonatomic) FBServiceClientAuthenticator *silhouetteAuthenticator; // ivar: _silhouetteAuthenticator
...
-(id)silhouetteLayoutForPageAtIndex:(id)arg0 ;
-(void)_requestAppLibraryUpdate:(id)arg0 categoryMapProvider:(id)arg1 reason:(id)arg2 optionalCompletionHandler:(id)arg3 ;
...
-(void)randomizeAllIconsAcrossPagesWithPageCount:(id)arg0 ;
