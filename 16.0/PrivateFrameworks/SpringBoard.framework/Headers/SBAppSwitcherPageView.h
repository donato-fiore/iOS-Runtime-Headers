...
@property (nonatomic, getter=isOccludedInCenterStage) BOOL occludedInCenterStage;
...
-(NSUInteger)_hoveringOverEdgeToAxis:(NSUInteger)arg0 ;
-(id)_fancyResizePointerShape;
