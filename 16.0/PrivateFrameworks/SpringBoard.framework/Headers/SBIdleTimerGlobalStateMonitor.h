...
@protocol SBPocketStateMonitorObserver, _SBIdleTimerGlobalSettingMonitorDelegate, SBIdleTimerServiceDelegate, SBFThermalConditionObserver, SBBacklightControllerObserver, SBFThermalBlockProvider, BSInvalidatable;
...
-(id)_init;
-(id)_initWithLocalDefaults:(id)arg0 profileConnection:(id)arg1 pocketStateMonitor:(id)arg2 uiController:(id)arg3 idleTimerService:(id)arg4 thermalBlockProvider:(id)arg5 backlightController:(id)arg6 ;
