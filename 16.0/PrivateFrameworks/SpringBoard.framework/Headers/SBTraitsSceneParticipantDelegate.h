...
@interface SBTraitsSceneParticipantDelegate : NSObject <FBSceneObserver, SBSceneHandleObserver, BSInvalidatable, SBFTraitsParticipantDelegate, SBTraitsSceneSettingsUpdater>
 ...
 {
    BOOL _isAlterEgoSetupUpdate;
    NSInteger _alterEgoInitialDeviceOrientation;
...
-(void)_checkAlterEgoValidityForUpdateReasons:(NSInteger)arg0 ;
-(void)_evaluateOrientationTransitionContext:(id)arg0 ;
-(void)_performCoalescedBroadcastArbitrationUpdateWithReason:(id)arg0 ;
-(void)_resetAlterEgoState;
-(void)_resetToInitialState;
-(void)_startAlterEgoWithDesiredOrientations:(NSUInteger)arg0 error:(*id)arg1 ;
