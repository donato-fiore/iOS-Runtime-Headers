...
@class NSString, NSSet, NSMutableSet, CSCoverSheetFlyInSettings, _UILegibilitySettings, CSLockScreenSettings, BSEventQueue, BSCompoundAssertion, UIImpactFeedbackGenerator, CSCoverSheetTransitionSettings, UIView<BSInvalidatable>, UIView, SBFZStackParticipant;
