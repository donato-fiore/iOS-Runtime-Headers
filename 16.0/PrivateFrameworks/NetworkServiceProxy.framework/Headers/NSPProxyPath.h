...
@class NSString, NSUUID, NSMutableDictionary, NSArray;
...
-(id)initWithDelegate:(id)arg0 ingressProxy:(id)arg1 egressProxy:(id)arg2 proxyPathWeight:(NSUInteger)arg3 obliviousConfigs:(id)arg4 allowFallback:(BOOL)arg5 fallbackToQUIC:(BOOL)arg6 forceFallback:(BOOL)arg7 allowFailOpen:(BOOL)arg8 geohashSharingEnabled:(BOOL)arg9 networkCharacteristics:(id)arg10 ;
