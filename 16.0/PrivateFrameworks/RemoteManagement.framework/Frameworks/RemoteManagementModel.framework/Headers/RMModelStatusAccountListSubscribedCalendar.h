...
#ifndef RMMODELSTATUSACCOUNTLISTSUBSCRIBEDCALENDAR_H
#define RMMODELSTATUSACCOUNTLISTSUBSCRIBEDCALENDAR_H
...
@property (copy, nonatomic) NSString *statusCalendarUrl; // ivar: _statusCalendarUrl
...
@property (copy, nonatomic) NSNumber *statusIsEnabled; // ivar: _statusIsEnabled
...
+(id)buildWithIdentifier:(id)arg0 declarationIdentifier:(id)arg1 visibleName:(id)arg2 calendarUrl:(id)arg3 username:(id)arg4 isEnabled:(id)arg5 ;
