...
+(id)buildWithIdentifier:(id)arg0 declarationIdentifier:(id)arg1 visibleName:(id)arg2 hostname:(id)arg3 port:(id)arg4 username:(id)arg5 areCalendarsEnabled:(id)arg6 areRemindersEnabled:(id)arg7 ;
