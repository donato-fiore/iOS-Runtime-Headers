...
+(id)debounceTimerWithMinimumInterval:(CGFloat)arg0 maximumInterval:(CGFloat)arg1 delegate:(id)arg2 identifier:(id)arg3 ;
-(id)initWithMinimumInterval:(CGFloat)arg0 maximumInterval:(CGFloat)arg1 delegate:(id)arg2 identifier:(id)arg3 ;
-(void)_timerDidFire;
-(void)dealloc;
-(void)trigger;
