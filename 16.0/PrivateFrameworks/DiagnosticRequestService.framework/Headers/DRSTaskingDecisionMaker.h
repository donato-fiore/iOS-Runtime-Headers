...
-(id)initWithTimezone:(id)arg0 limitingParameters:(id)arg1 dbWorkingDirectoryPath:(id)arg2 cloudKitHelper:(id)arg3 enforceDate:(BOOL)arg4 enforceBuild:(BOOL)arg5 enforceSampling:(BOOL)arg6 enforceTeamHysteresis:(BOOL)arg7 enforceGlobalHysteresisAndCap:(BOOL)arg8 errorOut:(*id)arg9 ;
