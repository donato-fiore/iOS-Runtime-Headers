...
#ifndef TVRMSBONJOURSERVICEPROVIDER_H
#define TVRMSBONJOURSERVICEPROVIDER_H

@class NSMutableDictionary, NSString, NSNetServiceBrowser;
@protocol TVRMSServiceProvider, NSNetServiceBrowserDelegate, NSNetServiceDelegate, TVRMSServiceProviderDelegate;
...
@property (weak, nonatomic) NSObject<TVRMSServiceProviderDelegate> *delegate; // ivar: _delegate
