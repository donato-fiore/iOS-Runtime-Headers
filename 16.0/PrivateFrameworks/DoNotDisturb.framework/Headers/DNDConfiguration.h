...
-(id)_initWithSuppressionType:(NSUInteger)arg0 allowedApplicationIdentifiers:(id)arg1 deniedApplicationIdentifiers:(id)arg2 senderConfiguration:(id)arg3 minimumBreakthroughUrgency:(NSUInteger)arg4 hideApplicationBadges:(NSUInteger)arg5 compatibilityVersion:(NSInteger)arg6 applicationConfigurationType:(NSUInteger)arg7 senderConfigurationType:(NSUInteger)arg8 ;
