...
-(id)_initWithIdentifier:(id)arg0 bundleIdentifier:(id)arg1 type:(NSUInteger)arg2 urgency:(NSUInteger)arg3 sender:(id)arg4 threadIdentifier:(id)arg5 filterCriteria:(id)arg6 notifyAnyway:(BOOL)arg7 behavior:(NSUInteger)arg8 ;
