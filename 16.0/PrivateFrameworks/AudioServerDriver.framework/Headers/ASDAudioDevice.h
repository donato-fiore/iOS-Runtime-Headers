...
@property (nonatomic) BOOL allowAutoRoute; // ivar: _allowAutoRoute
...
-(unsigned int)calculateIOBufferFrameSize:(unsigned int)arg0 ;
...
-(void)abortConfigurationChange:(*void)arg0 ;
