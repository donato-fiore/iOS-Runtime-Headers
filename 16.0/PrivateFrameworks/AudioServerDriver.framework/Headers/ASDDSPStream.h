...
-(BOOL)enableBasicDSPCaptureOnGraph:(id)arg0 withLevel:(id)arg1 andDebugType:(NSInteger)arg2 andMode:(NSInteger)arg3 ;
...
-(NSInteger)getAudioCaptureRingBufferModeWithDict:(id)arg0 ;
