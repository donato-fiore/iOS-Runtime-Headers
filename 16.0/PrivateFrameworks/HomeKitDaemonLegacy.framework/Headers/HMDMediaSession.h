...
@protocol HMFTimerDelegate, HMDHomeMessageReceiver, HMFDumpState, HMFLogging, NSSecureCoding, OS_dispatch_queue;
...
+(id)sessionForCurrentAccessoryWithSessionIdentifier:(id)arg0 mediaProfile:(id)arg1 ;
