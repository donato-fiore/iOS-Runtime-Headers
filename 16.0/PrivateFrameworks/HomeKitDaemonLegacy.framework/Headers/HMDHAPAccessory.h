...
@class NSMutableArray, NSMutableDictionary, HMFTimer, NSNumber, NSMutableSet, NSDictionary, NSArray, NSData, HMCameraUserNotificationSettings, NSSet, NSString, NSDate, HMFPairingIdentity, HMSupportedAccessoryDiagnostics;
@protocol HMDSiriEndpointProfileMetricsDispatcherDataSource, HMDSiriEndpointProfileMetricsDispatcherFactory, CHIPAccessoryServerDelegate, HMDAccessoryMinimumUserPrivilegeCapable, HMDServiceOwner, HAPAccessoryDelegate, HMFTimerDelegate, HAPAccessoryServerNotification, HMDAccessoryUserManagement, HMDDataStreamSocketController, HMDMessageRouter;
...
-(void)_handleUpdateCharacteristicAuthorizationDataMessage:(id)arg0 ;
