...
@protocol HMFLogging, OS_dispatch_queue, HMDRapportMessagingClientFactory, HMDRapportMessagingReachabilityDelegate;
...
@property (weak, nonatomic) NSObject<HMDRapportMessagingReachabilityDelegate> *reachabilityDelegate; // ivar: _reachabilityDelegate
...
-(void)_updateDevice:(id)arg0 reachable:(BOOL)arg1 ;
