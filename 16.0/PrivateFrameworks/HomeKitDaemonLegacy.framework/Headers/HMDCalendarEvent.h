...
@property (retain) NSDateComponents *fireDateComponents; // ivar: _fireDateComponents
...
+(id)logCategory;
-(BOOL)areMonthDayNotMatching:(id)arg0 ;
-(id)_nextRecurrentFireDateAfterDate:(id)arg0 ;
-(id)_nextRecurrentFireDateAfterDate:(id)arg0 recurrences:(id)arg1 ;
-(id)_nextTimerDate;
-(id)_nextTimerDateAfterDate:(id)arg0 timeZone:(id)arg1 ;
