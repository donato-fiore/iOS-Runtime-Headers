...
@property (copy) NSUUID *userSupportsAutomaticHH2MigrationModelID; // ivar: _userSupportsAutomaticHH2MigrationModelID
@property (weak) NSObject<HMDUserSupportsAutomaticHH2MigrationModelUpdateReceiver> *userSupportsAutomaticHH2MigrationModelUpdateReceiver; // ivar: _userSupportsAutomaticHH2MigrationModelUpdateReceiver
...
-(id)loadUserSettings;
-(id)loadUserSupportsAutomaticHH2MigrationModelWithModelID:(id)arg0 error:(*id)arg1 ;
...
-(void)registerForUserSupportsAutomaticHH2MigrationModelUpdates:(id)arg0 modelID:(id)arg1 ;
