...
@class NSString, NSSet, NSUUID, NSDateComponents;
...
@property (retain) NSDateComponents *offset; // ivar: _offset
@property (retain) NSString *significantEvent; // ivar: _significantEvent
@property (readonly) Class superclass;


+(BOOL)supportsSecureCoding;
+(id)logCategory;
+(id)nextTimerDateFromHomeLocation:(id)arg0 signifiantEvent:(id)arg1 offset:(id)arg2 loggingObject:(id)arg3 ;
-(id)_nextTimerDate;
