...
@property (readonly) NSObject<HMDIDSService> *modernService; // ivar: _modernService
...
+(id)sharedManager;
-(id)initWithDefaults;
-(id)initWithMainService:(id)arg0 modernService:(id)arg1 proxyService:(id)arg2 streamService:(id)arg3 notificationCenter:(id)arg4 ;
