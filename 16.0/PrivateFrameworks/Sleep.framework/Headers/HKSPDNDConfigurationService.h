...
-(void)_fetchUpdatedSleepFocusConfigurationWithCompletion:(id)arg0 ;
...
-(void)updateCachedMirrorsFocusModes:(BOOL)arg0 ;
-(void)updateCachedUUID:(id)arg0 ;
