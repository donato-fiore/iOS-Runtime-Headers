...
@protocol HKSPFeatureSettingsModel, BSDescriptionProviding, HKSPXPCObject, HKSPObject, HKSPDictionarySerializable, NAEquatable, NAHashable, NSMutableCopying, HKSPSyncAnchor;
...
@property (readonly, nonatomic) BOOL shareAcrossDevices; // ivar: _shareAcrossDevices
...
@property (readonly, nonatomic) BOOL springBoardSuggestedPageCreated; // ivar: _springBoardSuggestedPageCreated
