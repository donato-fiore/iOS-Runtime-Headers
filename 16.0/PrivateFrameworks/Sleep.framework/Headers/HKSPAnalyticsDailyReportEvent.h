...
@property (nonatomic) CGFloat sleepDurationLastNight; // ivar: _sleepDurationLastNight
@property (nonatomic) CGFloat sleepGoal; // ivar: _sleepGoal
@property (nonatomic) CGFloat sleepStagePercentAwakeLastNight; // ivar: _sleepStagePercentAwakeLastNight
@property (nonatomic) CGFloat sleepStagePercentCoreLastNight; // ivar: _sleepStagePercentCoreLastNight
@property (nonatomic) CGFloat sleepStagePercentDeepLastNight; // ivar: _sleepStagePercentDeepLastNight
@property (nonatomic) CGFloat sleepStagePercentRemLastNight; // ivar: _sleepStagePercentRemLastNight
