...
@property (copy, nonatomic) NSString *HS20OperatorName; // ivar: _HS20OperatorName
...
@property (nonatomic, getter=wasAddedFromWiFiPasswordSharing) BOOL addedFromWiFiPasswordSharing; // ivar: _addedFromWiFiPasswordSharing
...
@property (readonly, nonatomic) NSUInteger originator; // ivar: _originator
...
@property (nonatomic, getter=isProfileBased) BOOL profileBased; // ivar: _profileBased
