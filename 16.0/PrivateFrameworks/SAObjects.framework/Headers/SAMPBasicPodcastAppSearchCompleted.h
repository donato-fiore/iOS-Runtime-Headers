...
#ifndef SAMPBASICPODCASTAPPSEARCHCOMPLETED_H
#define SAMPBASICPODCASTAPPSEARCHCOMPLETED_H
...
+(id)basicPodcastAppSearchCompletedWithDictionary:(id)arg0 context:(id)arg1 ;
