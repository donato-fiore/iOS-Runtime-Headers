...
#ifndef SAINTENTGROUPRESOLVEINTENTSLOTCOMPLETED_H
#define SAINTENTGROUPRESOLVEINTENTSLOTCOMPLETED_H
...
+(id)resolveIntentSlotCompletedWithDictionary:(id)arg0 context:(id)arg1 ;
