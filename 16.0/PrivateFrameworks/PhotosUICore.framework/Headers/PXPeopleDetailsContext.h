...
-(id)initWithPeople:(id)arg0 parentContext:(id)arg1 assetCollectionsFetch:(id)arg2 ignoreSharedLibraryFilters:(BOOL)arg3 ;
-(id)initWithPeople:(id)arg0 parentContext:(id)arg1 ignoreSharedLibraryFilters:(BOOL)arg2 ;
