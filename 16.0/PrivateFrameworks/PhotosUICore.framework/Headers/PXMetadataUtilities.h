...
+(id)cameraCaptureDeviceDisplayStringForItem:(id)arg0 ;
...
+(id)megaPixelsDisplayStringForItem:(id)arg0 isAccessibility:(BOOL)arg1 ;
...
+(id)resolutionDisplayStringForItem:(id)arg0 isAccessibility:(BOOL)arg1 ;
...
+(void)videoHDRBadgeTitleForAsset:(id)arg0 completion:(id)arg1 ;
