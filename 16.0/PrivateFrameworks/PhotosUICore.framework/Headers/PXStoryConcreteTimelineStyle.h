...
@class NSArray, NSMutableDictionary, PFStoryAutoEditConfiguration;
...
@property (readonly, nonatomic) PXStoryMultipartPanoramaParameters *defaultHorizontalMultipartPanoramaParameters; // ivar: _defaultHorizontalMultipartPanoramaParameters
@property (readonly, nonatomic) PXStoryMultipartPanoramaParameters *defaultVerticalMultipartPanoramaParameters; // ivar: _defaultVerticalMultipartPanoramaParameters
...
-(struct ? )_durationInfoForClip:(id)arg0 startTime:(struct ? )arg1 ;
-(struct ? )_kenBurnsMotionParametersForDuration:(CGFloat)arg0 ;
-(struct ? )_transitionInfoForClip:(id)arg0 isKeyAsset:(BOOL)arg1 ;
...
-(void)_getOneUpKenBurnsParameters:(struct ? *)arg0 forMotionInfo:(struct ? *)arg1 motionParameters:(struct ? *)arg2 factory:(id)arg3 ;
