...
#ifndef PXAPPLEMUSICARTWORKASSET_H
#define PXAPPLEMUSICARTWORKASSET_H
...
@property (readonly, nonatomic) PXAppleMusicAsset *musicAsset; // ivar: _musicAsset
