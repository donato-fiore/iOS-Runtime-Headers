...
@protocol PXGReusableView, PXActionableSectionHeaderViewDelegate, NSCopying;
...
@property (nonatomic) BOOL avoidsTintedButtonsAtHighSpeed; // ivar: _avoidsTintedButtonsAtHighSpeed
...
@property (weak, nonatomic) NSObject<PXActionableSectionHeaderViewDelegate> *delegate; // ivar: _delegate
...
@property (nonatomic) NSInteger speedRegime; // ivar: _speedRegime
...
-(void)layoutSubviews;
-(void)performChangesToGroupedBackgroundPropertiesAnimated:(BOOL)arg0 withBlock:(id)arg1 ;
