...
@class NSMutableDictionary, NSHashTable, PHFetchResult, NSDictionary, NSString, NSArray, PHPhotoLibrary;
...
-(id)initWithPhotoLibrary:(id)arg0 changeObserver:(id)arg1 ;
-(id)initWithPhotoLibrary:(id)arg0 changeObserver:(id)arg1 registerForPhotoLibraryChanges:(BOOL)arg2 ;
