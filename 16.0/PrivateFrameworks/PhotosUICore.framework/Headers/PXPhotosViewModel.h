...
@class NSMutableSet, NSMutableOrderedSet, NSArray, NSString, NSSet, NSNumber, NSOrderedSet;
@protocol PXAssetsDataSourceManagerObserver, PXMutablePhotosViewModel, PXSectionedSelectionManagerSnapshotValidator, NSObject, PXAssetImportStatusManager, PXBrowserSelectionSnapshot, PXPhotosGridOptionsController, PXPhotosPreferredAssetCropDelegate, PXTapbackStatusManager, PXPhotosViewDelegate;
...
@property (readonly, nonatomic) BOOL allowsAccessoriesContextMenuCustomization; // ivar: _allowsAccessoriesContextMenuCustomization
...
@property (readonly, nonatomic) BOOL allowsCaptionsInSquareBehavior; // ivar: _allowsCaptionsInSquareBehavior
...
@property (readonly, nonatomic) BOOL allowsDragOutOnly; // ivar: _allowsDragOutOnly
...
@property (readonly, nonatomic) BOOL allowsHoverBehavior; // ivar: _allowsHoverBehavior
...
@property (readonly, nonatomic) BOOL allowsLinkInteractions; // ivar: _allowsLinkInteractions
@property (readonly, nonatomic) BOOL allowsMacStyleSelection; // ivar: _allowsMacStyleSelection
@property (readonly, nonatomic) BOOL allowsMergeDuplicatesAction; // ivar: _allowsMergeDuplicatesAction
@property (readonly, nonatomic) BOOL allowsMoveToLibraryAction; // ivar: _allowsMoveToLibraryAction
@property (readonly, nonatomic) BOOL allowsMoveToPersonalLibraryAction; // ivar: _allowsMoveToPersonalLibraryAction
@property (readonly, nonatomic) BOOL allowsMoveToSharedLibraryAction; // ivar: _allowsMoveToSharedLibraryAction
@property (readonly, nonatomic) BOOL allowsMultiSelectMenu; // ivar: _allowsMultiSelectMenu
...
@property (readonly, nonatomic) BOOL allowsPopOnEmptyBehavior; // ivar: _allowsPopOnEmptyBehavior
...
@property (readonly, nonatomic) BOOL allowsSwitchLibraryAction; // ivar: _allowsSwitchLibraryAction
...
@property (readonly, nonatomic) BOOL alwaysIncludeSharedWithYouAssets; // ivar: _alwaysIncludeSharedWithYouAssets
...
@property (readonly, nonatomic) NSArray *assetUUIDsAllowedToHighlightOCRText; // ivar: _assetUUIDsAllowedToHighlightOCRText
@property (readonly, nonatomic) id *badgesModifier; // ivar: _badgesModifier
@property (readonly, nonatomic) NSObject<PXBrowserSelectionSnapshot> *browserSelectionSnapshot;
...
@property (nonatomic) NSInteger contentPrivacyState; // ivar: _contentPrivacyState
...
@property (readonly, nonatomic) BOOL ignoreContentFilterStateWhenNotFiltering; // ivar: _ignoreContentFilterStateWhenNotFiltering
...
@property (readonly, nonatomic) BOOL isInitializing; // ivar: _isInitializing
...
@property (readonly, nonatomic) NSArray *ocrTextToHighlight; // ivar: _ocrTextToHighlight
...
@property (readonly, nonatomic) NSInteger selectionContext; // ivar: _selectionContext
...
@property (readonly, nonatomic) BOOL showLoadingPlaceholderWhenEmpty; // ivar: _showLoadingPlaceholderWhenEmpty
@property (readonly, nonatomic, getter=isShowingAlternateContent) BOOL showingAlternateContent; // ivar: _showingAlternateContent
@property (nonatomic) BOOL showsOnlySelectedItemsInOneUp; // ivar: _showsOnlySelectedItemsInOneUp
...
@property (nonatomic) NSInteger systemAuthenticationType; // ivar: _systemAuthenticationType
...
@property (readonly, nonatomic) BOOL wantsContentUnavailableUnlockButtonVisible; // ivar: _wantsContentUnavailableUnlockButtonVisible
...
@property (readonly, nonatomic) BOOL wantsFooterVisibleImmediately; // ivar: _wantsFooterVisibleImmediately
...
@property (readonly, nonatomic) BOOL wantsTopBadgesWithViewBasedDecorations; // ivar: _wantsTopBadgesWithViewBasedDecorations
...
-(id)_initialLibraryFilterStateForConfiguration:(id)arg0 ;
-(id)init;
