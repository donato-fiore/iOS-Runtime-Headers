...
@protocol PXOneUpPresentationDelegate, PXSearchTapToRadarSectionProviderDelegate, UICollectionViewDelegate, UIScrollViewDelegate, UISearchBarDelegate, ParsecReportingDelegate, UISearchResultsUpdating;


#import "PXSearchCPAnalyticsSession.h"
...
@property (retain, nonatomic) PXSearchCPAnalyticsSession *analyticsSession; // ivar: _analyticsSession
...
@property (copy, nonatomic) id *searchDidEndHandler; // ivar: _searchDidEndHandler
...
-(void)_didSelectAlbumSearchResult:(id)arg0 matchedQueryStrings:(id)arg1 matchedOCRAssetUUIDs:(id)arg2 ;
...
-(void)_didSelectTopAssetsSeeAllButtonForSection:(id)arg0 allAssetResultUUIDs:(id)arg1 title:(id)arg2 matchedQueryStrings:(id)arg3 matchedOCRAssetUUIDs:(id)arg4 ;
...
-(void)_reportVisibleSearchResultsToParsec:(id)arg0 ;
...
-(void)didSelectAssetAggregationSearchResult:(id)arg0 matchedQueryStrings:(id)arg1 matchedOCRAssetUUIDs:(id)arg2 ;
-(void)didSelectAssetSearchResult:(id)arg0 matchedQueryStrings:(id)arg1 matchedOCRAssetUUIDs:(id)arg2 ;
-(void)didSelectCollectionSearchResult:(id)arg0 matchedQueryStrings:(id)arg1 matchedOCRAssetUUIDs:(id)arg2 ;
-(void)didSelectPersonSearchResult:(id)arg0 ;
-(void)didSelectSeeAllForAssetUUIDs:(id)arg0 title:(id)arg1 matchedQueryStrings:(id)arg2 matchedOCRAssetUUIDs:(id)arg3 ;
...
-(void)showOneUpForAssetSearchResult:(id)arg0 matchedQueryStrings:(id)arg1 assetUUIDsAllowedToHighlightText:(id)arg2 ;
