...
@protocol UIGestureRecognizerDelegate, UIContextMenuInteractionDelegate, PXPhotosViewLinkControllerDelegate, PXOneUpPresentationDelegate, PXScrollViewControllerObserver, PXAssetCollectionActionPerformerDelegate, PXAssetsDataSourceManagerObserver, PXSwipeSelectionManagerDelegate, PXPhotosDragControllerDelegate, UIViewControllerInteractiveTransitioning;
...
@interface PXPhotosViewUIInteraction : PXPhotosViewInteraction <UIGestureRecognizerDelegate, UIContextMenuInteractionDelegate, PXPhotosViewLinkControllerDelegate, PXOneUpPresentationDelegate, PXScrollViewControllerObserver, PXAssetCollectionActionPerformerDelegate, PXAssetsDataSourceManagerObserver, PXSwipeSelectionManagerDelegate, PXPhotosDragControllerDelegate>
