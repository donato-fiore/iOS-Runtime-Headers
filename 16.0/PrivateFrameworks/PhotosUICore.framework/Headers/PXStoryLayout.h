...
@property (retain, nonatomic) PXGLayout *diagnosticOverlayLayout; // ivar: _diagnosticOverlayLayout
@property (readonly, nonatomic) NSInteger diagnosticOverlayLayoutIndex; // ivar: _diagnosticOverlayLayoutIndex
