...
@class UIViewController, NSString, UIBarButtonItem, UIButton, NSLayoutConstraint, UIHoverGestureRecognizer, UIPanGestureRecognizer, PHPhotoLibrary, UIPinchGestureRecognizer, UITapGestureRecognizer;
@protocol PXActionManagerProvider, PXChangeObserver, PXCuratedLibraryActionPerformerDelegate, PXCuratedLibraryFooterControllerDelegate, PXCuratedLibrarySkimmingControllerDelegate, PXCuratedLibraryZoomLevelControlDelegate, PXGAXResponder, PXOneUpPresentationDelegate, PXPhotosPointerControllerDelegate, PXPhotosDragControllerDelegate, PXPhotosGlobalFooterViewDelegate, PXScrollViewControllerObserver, PXStatusControllerDelegate, PXCuratedLibraryFilterTipControllerDelegate, PXPhotosViewLinkControllerDelegate, PXSwipeSelectionManagerDelegate, PXTouchingUIGestureRecognizerDelegate, PXUserInterfaceFeatureViewController, UIGestureRecognizerDelegate, PXSplitViewControllerChangeObserver, PXSelectionContainerProvider, PXBannerViewDelegate, PXBarsControllerDelegate, PXCuratedLibraryViewDelegate;
...
#import "PXPhotosViewLinkController.h"
...
@property (readonly, nonatomic) PXBannerView *bannerView; // ivar: _bannerView
@property (readonly, nonatomic) PXCuratedLibraryBarsController *barsController; // ivar: _barsController
@property (nonatomic) BOOL canShowFooter; // ivar: _canShowFooter
@property (retain, nonatomic) PXCPLUIStatusProvider *cplUIStatusProvider; // ivar: _cplUIStatusProvider
@property (readonly, copy) NSString *debugDescription;
@property (weak, nonatomic) NSObject<PXCuratedLibraryViewDelegate> *delegate; // ivar: _delegate
...
@property (retain, nonatomic) PXStatusController *emptyPlaceholderStatusController; // ivar: _emptyPlaceholderStatusController
@property (retain, nonatomic) UIBarButtonItem *emptyPlaceholderSwitchLibraryBarButtonItem; // ivar: _emptyPlaceholderSwitchLibraryBarButtonItem
@property (retain, nonatomic) UIButton *emptyPlaceholderSwitchLibraryButton; // ivar: _emptyPlaceholderSwitchLibraryButton
@property (retain, nonatomic) NSLayoutConstraint *emptyPlaceholderSwitchLibraryButtonBottomConstraint; // ivar: _emptyPlaceholderSwitchLibraryButtonBottomConstraint
@property (retain, nonatomic) NSLayoutConstraint *emptyPlaceholderSwitchLibraryButtonTrailingConstraint; // ivar: _emptyPlaceholderSwitchLibraryButtonTrailingConstraint
...
@property (readonly, nonatomic) PXPhotosViewLinkController *linkController; // ivar: _linkController
...
-(CGFloat)_emptyPlaceholderswitchLibraryButtonTrailingInset;
-(CGFloat)_emptyPlaceholderswitchLibraryButtonVerticalSpacing;
...
-(id)_emptyPlaceholderMessageTextAttributesFromTextProperties:(id)arg0 ;
...
-(id)assetReferenceForIndexPath:(id)arg0 ;
...
-(id)interactionViewForPhotosViewLinkController:(id)arg0 ;
...
-(id)presentationEnvironmentForBannerView:(id)arg0 actionIdentifier:(id)arg1 ;
...
-(id)undoManagerForPhotosViewLinkController:(id)arg0 ;
...
-(void)_hideNavigationBarItems:(BOOL)arg0 ;
...
-(void)curatedLibraryActionPerformer:(id)arg0 libraryFilterStateChanged:(id)arg1 ;
...
-(void)didDismissTipForController:(id)arg0 ;
...
-(void)statusController:(id)arg0 configurationDidChange:(id)arg1 ;
-(void)statusController:(id)arg0 dismissViewController:(id)arg1 ;
-(void)statusController:(id)arg0 presentViewController:(id)arg1 ;
