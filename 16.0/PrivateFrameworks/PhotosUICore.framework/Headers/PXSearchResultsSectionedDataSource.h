...
@class NSCalendar, PLSearchIndexDateFormatter, NSDateIntervalFormatter, NSDateComponents, NSString, NSDictionary, PHFetchResult, NSArray, PLPhotoLibrary, PSIQuery, PSIDatabase, PLSearchProcessor;
...
@property (readonly, nonatomic) NSArray *matchedOCRAssetUUIDs; // ivar: _matchedOCRAssetUUIDs
@property (readonly, nonatomic) NSArray *matchedQueryStrings; // ivar: _matchedQueryStrings
...
-(void)setSearchString:(id)arg0 representedObjects:(id)arg1 maxSuggestionCount:(NSUInteger)arg2 priorityAssetUUID:(id)arg3 libraryScope:(NSUInteger)arg4 ;
