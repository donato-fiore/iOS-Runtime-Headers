...
-(id)pointReferenceAtPoint:(struct CGPoint )arg0 inCoordinateSpace:(id)arg1 ;
...
-(id)undoManagerForPhotosInteraction:(id)arg0 ;
-(struct CGPoint )pointForPointReference:(id)arg0 inCoordinateSpace:(id)arg1 ;
