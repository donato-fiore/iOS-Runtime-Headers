...
@property (readonly, nonatomic) NSString *associatedSubtitleString; // ivar: _associatedSubtitleString
@property (readonly, nonatomic) NSAttributedString *attributedString; // ivar: _lock_attributedString
@property (readonly, nonatomic) CGFloat boundingRectPadding;
@property (readonly, nonatomic) CGSize boundingSize; // ivar: _lock_boundingSize
@property (readonly, nonatomic) NSStringDrawingContext *drawingContext; // ivar: _lock_drawingContext
...
@property (readonly, nonatomic) NSInteger layoutScheme; // ivar: _layoutScheme
@property (readonly, nonatomic) CGPoint origin; // ivar: _lock_origin
@property (readonly, nonatomic) NSString *string; // ivar: _string
@property (readonly, nonatomic) NSInteger textAlignment; // ivar: _lock_textAlignment
...
+(id)_titlePrimaryAttributesForStylePairing:(NSInteger)arg0 scale:(CGFloat)arg1 kind:(NSUInteger)arg2 layoutScheme:(NSInteger)arg3 allowHyphenation:(BOOL)arg4 ;
...
-(id)initWithString:(id)arg0 associatedSubtitleString:(id)arg1 type:(NSInteger)arg2 layoutScheme:(NSInteger)arg3 ;
