...
@property (readonly, nonatomic) PXPhotosResultRecord *resultRecordAfterChanges; // ivar: _resultRecordAfterChanges
@property (readonly, nonatomic) PXPhotosResultRecord *resultRecordBeforeChanges; // ivar: _resultRecordBeforeChanges
