...
@interface PXPeopleFaceCropManager : NSObject <PXPhotoLibraryUIChangeObserver>

 {
    ...
    os_unfair_lock_s _peopleWithoutKeyFacesLock;
}
...
-(int)requestFaceCropImageForPerson:(id)arg0 targetSize:(struct CGSize )arg1 displayScale:(CGFloat)arg2 completionHandler:(id)arg3 ;
...
-(void)_invalidateCacheForLocalIdentifiers:(id)arg0 wantsNotificationPosted:(BOOL)arg1 ;
