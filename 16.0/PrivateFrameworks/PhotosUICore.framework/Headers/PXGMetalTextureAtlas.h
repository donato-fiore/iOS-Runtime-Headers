...
@protocol PXGMetalSpriteTexture, OS_dispatch_queue, MTLTexture, PXGMetalTextureAtlasDelegate;
...
-(id)init;
-(id)initWithThumbnailSize:(struct CGSize )arg0 pixelFormat:(NSUInteger)arg1 capacity:(unsigned int)arg2 colorProgram:(id)arg3 context:(id)arg4 layoutQueue:(id)arg5 ;
