...
@interface PXStoryMemoryFeedItemExtendedTraitCollection : PXStoryExtendedTraitCollection {
    ...
    CGFloat _bottomTitleContentOffset;
}
...
-(CGFloat)bottomTitleContentOffset;
-(CGFloat)viewportCornerRadius;
-(NSInteger)userInterfaceFeature;
-(id)initWithSpecManager:(id)arg0 initialReferenceSize:(struct CGSize )arg1 isFullscreen:(BOOL)arg2 ;
-(id)viewportShadow;
