...
@property (nonatomic) NSInteger numberOfAssetsCopied; // ivar: _numberOfAssetsCopied
...
@property (nonatomic) NSInteger pauseResolutionActionType; // ivar: _pauseResolutionActionType
