...
@property (readonly, nonatomic) UIColor *badgeColor; // ivar: _badgeColor
@property (readonly, nonatomic) UIFont *badgeFont; // ivar: _badgeFont
@property (readonly, nonatomic) UIColor *buttonColor; // ivar: _buttonColor
@property (readonly, nonatomic) UIFont *buttonFont; // ivar: _buttonFont
@property (readonly, nonatomic) CGFloat buttonSpacing; // ivar: _buttonSpacing
