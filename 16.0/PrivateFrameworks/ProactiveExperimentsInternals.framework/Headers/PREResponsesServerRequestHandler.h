...
-(void)preResponseItemsForMessage:(id)arg0 maximumResponses:(NSUInteger)arg1 conversationHistory:(id)arg2 forContext:(id)arg3 time:(id)arg4 language:(id)arg5 recipientHandles:(id)arg6 modelFilePath:(id)arg7 modelConfigPath:(id)arg8 espressoBinFilePath:(id)arg9 vocabFilePath:(id)arg10 registerDisplayed:(BOOL)arg11 includeCustomResponses:(BOOL)arg12 includeResponsesToRobots:(BOOL)arg13 completion:(id)arg14 ;
