...
@class UIView, NSLayoutConstraint, UILabel, NSArray, UIImageView, UIStackView;


#import "OBBulletedListItemLinkButton.h"
...
@property (retain, nonatomic) OBBulletedListItemLinkButton *linkButton; // ivar: _linkButton
