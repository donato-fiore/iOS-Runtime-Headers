...
@class ICRequestOperation, AVContentKeySession, ICStoreRequestContext, NSData, NSString, NSURL, MPMediaItem;
...
-(void)_createSPCData;
-(void)_fetchCKCDataUsingSPC:(id)arg0 forKeyRequest:(id)arg1 ;
