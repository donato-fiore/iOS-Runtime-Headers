...
@property (nonatomic) BOOL allowPlatformSSOAuthFallback; // ivar: _allowPlatformSSOAuthFallback
...
@property (nonatomic) BOOL performKerberosOnly; // ivar: _performKerberosOnly
...
@property (nonatomic) BOOL usePlatformSSOTGT; // ivar: _usePlatformSSOTGT
