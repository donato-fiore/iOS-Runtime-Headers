...
-(id)copyDefaultPowerProfileForClient:(NSInteger)arg0 error:(*id)arg1 ;
-(id)copyPowerBudgetForRequest:(id)arg0 forClient:(NSInteger)arg1 error:(*id)arg2 ;
-(id)copyPowerBudgetForRequest:(id)arg0 forClient:(NSInteger)arg1 withPowerProfile:(id)arg2 error:(*id)arg3 ;
-(id)init;
