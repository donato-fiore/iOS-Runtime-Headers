...
-(id)initWithTransferPlan:(id)arg0 isPhysical:(BOOL)arg1 isIneligible:(BOOL)arg2 inBuddy:(BOOL)arg3 confirmCellularPlanTransfer:(BOOL)arg4 showOtherOptions:(BOOL)arg5 isStandaloneProximityFlow:(BOOL)arg6 ;
