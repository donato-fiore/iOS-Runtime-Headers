...
+(id)_loadProfilesFromURL:(id)arg0 logFileError:(BOOL)arg1 ;
+(id)defaultManager;
+(id)maskRegistrationTokenInConfigurationData:(id)arg0 ;
+(id)maskRegistrationTokenInProfileList:(id)arg0 ;
-(BOOL)_initDataVaultIfNeededWithError:(*id)arg0 ;
-(BOOL)_isConfigFileAvailable;
-(BOOL)_saveConfigToFile:(id)arg0 error:(*id)arg1 ;
-(BOOL)hasAnyMDMProfileForExtension:(id)arg0 ;
