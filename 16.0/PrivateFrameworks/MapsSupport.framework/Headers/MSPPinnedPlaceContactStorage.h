...
@property (retain, nonatomic) NSString *handleValue; // ivar: _handleValue
...
@property (retain, nonatomic) NSString *labeledValueIdentifier; // ivar: _labeledValueIdentifier
