...
@protocol GEONavigationListenerPrivateDelegate, OS_os_transaction, MSPNavigationListenerDelegate;
...
-(BOOL)_updateArrivalTimeAndDistance:(id)arg0 ;
-(BOOL)_updateLocation:(id)arg0 withRouteMatchedCoordinate:(struct ? )arg1 ;
-(BOOL)_updateTraffic:(id)arg0 ;
-(BOOL)_updateWaypointsIfNeeded:(id)arg0 ;
-(id)init;
...
-(void)_initPendingStateIfNeededWithTransportType:(int)arg0 isResumingMultipointRoute:(BOOL)arg1 ;
-(void)_performDelegateNotificationBlockIfReady:(id)arg0 ;
-(void)_updateCurrentWaypointIndexFromArrivalTimeInfo:(id)arg0 ;
...
-(void)navigationListener:(id)arg0 didResumeNavigatingFromWaypoint:(id)arg1 endOfLegIndex:(NSUInteger)arg2 ;
-(void)navigationListener:(id)arg0 didUpdateETA:(id)arg1 ;
-(void)navigationListener:(id)arg0 didUpdateGuidanceState:(id)arg1 ;
-(void)navigationListener:(id)arg0 didUpdateLocation:(id)arg1 routeMatchedCoordinate:(struct ? )arg2 ;
