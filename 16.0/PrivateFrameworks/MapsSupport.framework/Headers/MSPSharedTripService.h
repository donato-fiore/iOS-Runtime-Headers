...
@class NSXPCConnection, NSDate, GEOObserverHashTable, NSMutableArray, NSMutableDictionary, NSData, NSString, NSArray;
...
-(id)contactsFromArchivedTripSharingState:(id)arg0 ;
-(id)init;
...
-(void)_fetchArchivedSharingStateWithCompletion:(id)arg0 ;
...
-(void)fetchArchivedSharingStateWithCompletion:(id)arg0 ;
