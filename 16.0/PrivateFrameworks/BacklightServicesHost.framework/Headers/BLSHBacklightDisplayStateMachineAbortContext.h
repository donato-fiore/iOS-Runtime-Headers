...
-(id)initWithDisplayMode:(NSInteger)arg0 transitioningToDisplayMode:(NSInteger)arg1 lastSteadyStateDisplayMode:(NSInteger)arg2 isFlipbookEnabled:(BOOL)arg3 showingBlankingWindow:(BOOL)arg4 backlightFactor:(NSInteger)arg5 isCABlanked:(BOOL)arg6 displayIsOff:(BOOL)arg7 ;
