...
@class NSMutableDictionary, PKAccountService, NSString, NSHashTable, NSSet, PKPaymentService;
@protocol PKPaymentServiceDelegate, PKAccountServiceObserver, OS_dispatch_queue;
...
@property (retain, nonatomic) NSMutableDictionary *passUniqueIDsByAccountIdentifier; // ivar: _passUniqueIDsByAccountIdentifier
...
-(BOOL)_isPassWithAccountBalanceForPass:(id)arg0 ;
-(BOOL)_shouldUseBalanceForAccount:(id)arg0 ;
...
-(id)init;
-(id)initWithPaymentService:(id)arg0 accountService:(id)arg1 ;
-(id)passInfoForPassWithUniqueID:(id)arg0 ;
-(void)_fetchMostRecentAccountBalanceForPass:(id)arg0 ;
...
-(void)_handleReceivedAccountUpdateWithAccount:(id)arg0 ;
-(void)_internalQueue_processReceivedAccountUpdateWithAccount:(id)arg0 ;
...
-(void)_processAccountBalancesForPassWithUniqueID:(id)arg0 withAccount:(id)arg1 ;
