...
+(id)insertOrLookupContributorEntityForNoContributorWithTransaction:(id)arg0 error:(*id)arg1 ;
+(id)insertPrimaryUserWithAppleID:(id)arg0 callerID:(id)arg1 database:(id)arg2 error:(*id)arg3 ;
+(id)insertWithUUID:(id)arg0 appleID:(id)arg1 callerID:(id)arg2 primaryUser:(BOOL)arg3 profile:(id)arg4 error:(*id)arg5 ;
+(id)insertWithUUID:(id)arg0 appleID:(id)arg1 callerID:(id)arg2 primaryUser:(BOOL)arg3 syncProvenance:(NSInteger)arg4 transaction:(id)arg5 error:(*id)arg6 ;
