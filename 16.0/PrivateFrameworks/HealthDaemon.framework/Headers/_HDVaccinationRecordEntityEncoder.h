...
#ifndef _HDVACCINATIONRECORDENTITYENCODER_H
#define _HDVACCINATIONRECORDENTITYENCODER_H

@class HDMedicalRecordEntityEncoder;



@interface _HDVaccinationRecordEntityEncoder : HDMedicalRecordEntityEncoder
