...
@class NSString, NSUUID, NSLock, HKObserverSet, NSMutableArray, NSDate, HDXPCGatedActivity, NSMutableDictionary, NSHashTable, HDAssertionManager, NSConditionLock, NSMutableSet, NSOperationQueue, NSDictionary, HKProfileIdentifier;
...
@interface HDDatabase : NSObject <HDAssertionObserver, HDContentProtectionObserver, HDDiagnosticObject, HDSQLiteDatabaseDelegate, HDSQLiteDatabasePoolDelegate, HDSQLiteDatabaseProvider, HDDatabaseJournalDelegate, HDDatabaseMigrationTransactionDelegate, HDProfileReadyObserver, HDHealthDaemonReadyObserver, HDAnalyticsSubmissionCoordinatorDelegate, HDDatabaseCorruptionEventStoreDelegate, HDHealthDatabase>

 {
    ...
    os_unfair_lock_s _protectedDataLock;
    HKObserverSet *_protectedDataObservers;
    NSInteger _protectedDataState;
    NSInteger _protectedDataLock_observedContentProtectionState;
    ...
    os_unfair_lock_s _transactionStartLock;
    ...
    NSUInteger _journalMergeEpoch;
    NSUInteger _mergedJournalEpoch;
    uint8_t _hasPendingSecondaryJournalMerge;
    uint8_t _shouldPerformHFDVerificationAfterSecondaryJournalMerge;
    HDXPCGatedActivity *_secondaryJournalMergeActivity;
    uint8_t _hasCompletedFirstJournalMergeCleanup;
...
-(id)_newTTRPromptControllerWithProfile:(id)arg0 domainName:(id)arg1 loggingCategory:(id)arg2 ;
...
-(void)migrationTransaction:(id)arg0 reportHFDMigrationStatus:(NSInteger)arg1 schemaVersion:(NSInteger)arg2 error:(id)arg3 ;
...
-(void)performInFirstProtectedWriteTransaction:(id)arg0 ;
-(void)performInFirstUnprotectedWriteTransaction:(id)arg0 ;
