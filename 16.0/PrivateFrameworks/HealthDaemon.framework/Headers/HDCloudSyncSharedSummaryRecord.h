...
+(id)recordType;
-(id)description;
-(id)initInZone:(id)arg0 UUID:(id)arg1 package:(id)arg2 name:(id)arg3 version:(id)arg4 compatibilityVersion:(id)arg5 objectTypes:(id)arg6 authorizationIdentifiers:(id)arg7 summaryData:(id)arg8 ;
