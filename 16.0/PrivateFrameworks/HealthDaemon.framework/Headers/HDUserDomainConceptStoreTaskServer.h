...
-(id)remoteInterface;
-(void)dealloc;
-(void)remote_createAndStoreUserDomainConceptWithConceptIdentifier:(id)arg0 additionalProperties:(id)arg1 userDomainConceptTypeIdentifier:(id)arg2 completion:(id)arg3 ;
