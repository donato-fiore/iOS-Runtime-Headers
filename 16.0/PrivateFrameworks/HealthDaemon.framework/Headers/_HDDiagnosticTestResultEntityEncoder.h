...
#ifndef _HDDIAGNOSTICTESTRESULTENTITYENCODER_H
#define _HDDIAGNOSTICTESTRESULTENTITYENCODER_H

@class HDMedicalRecordEntityEncoder;



@interface _HDDiagnosticTestResultEntityEncoder : HDMedicalRecordEntityEncoder
