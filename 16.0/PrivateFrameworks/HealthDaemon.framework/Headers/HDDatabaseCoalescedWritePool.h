...
@class NSString, _HKDelayedOperation, NSMutableArray;
@protocol OS_os_log, OS_dispatch_queue;

#import <Foundation/Foundation.h>

#import "HDProfile.h"
#import "HDDatabaseCoalescedWritePoolQuota.h"
...
@property (copy, nonatomic) HDDatabaseCoalescedWritePoolQuota *quota; // ivar: _quota
