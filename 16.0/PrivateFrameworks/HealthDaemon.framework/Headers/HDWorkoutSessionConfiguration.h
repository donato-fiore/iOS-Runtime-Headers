...
@class NSArray, NSString, NSUUID, HKWorkoutConfiguration;
...
@property (retain, nonatomic) NSArray *activityConfigurations; // ivar: _activityConfigurations
...
@property (readonly, nonatomic) BOOL enableWorkoutChangeDetection; // ivar: _enableWorkoutChangeDetection
...
-(id)initWithSessionIdentifier:(id)arg0 workoutConfiguration:(id)arg1 client:(id)arg2 processBundleIdentifier:(id)arg3 applicationIdentifier:(id)arg4 requiresCoreLocationAssertion:(BOOL)arg5 supportsAppRelaunchForRecovery:(BOOL)arg6 supports3rdPartyAOT:(BOOL)arg7 enableWorkoutChangeDetection:(BOOL)arg8 activityConfigurations:(id)arg9 ;
