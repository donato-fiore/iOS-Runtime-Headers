...
@protocol HDCloudSyncManagerTaskQueueDelegate, HDDiagnosticObject, HDPeriodicActivityDelegate, HDHealthDaemonReadyObserver, HDDatabaseJournalMergeObserver, HDProfileReadyObserver, APSConnectionDelegate, OS_dispatch_source, OS_dispatch_queue;
