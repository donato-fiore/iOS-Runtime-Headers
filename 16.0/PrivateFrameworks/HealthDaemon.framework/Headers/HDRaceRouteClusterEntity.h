...
+(id)foreignKeys;
+(id)insertCodableCluster:(id)arg0 syncProvenance:(NSInteger)arg1 transaction:(id)arg2 error:(*id)arg3 ;
+(id)insertOrUpdateRacingCluster:(id)arg0 routeSnapshot:(id)arg1 transaction:(id)arg2 error:(*id)arg3 ;
