...
@class HKObserverSet, HDAssertion, NSCountedSet, _HKDelayedOperation, NSString;
@protocol HDDataObserver, HDDatabaseProtectedDataObserver, HDProfileReadyObserver, HDHealthRecordsAccountExistenceObserver, HDOntologyDatabaseAvailabilityObserver, HDOntologyShardImporterObserver, OS_dispatch_queue;
...
@property (copy, nonatomic) id *unitTesting_scheduledConceptIndexWorkDidFailAndClearState; // ivar: _unitTesting_scheduledConceptIndexWorkDidFailAndClearState
...
-(void)unitTest_setHasScheduledIndexing:(BOOL)arg0 ;
