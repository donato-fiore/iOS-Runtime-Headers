...
-(id)firewallCollaboratorWithErrorHandler:(id)arg0 ;
-(id)groupSessionKeyValueDeliveryProviderCollaboratorWithErrorHandler:(id)arg0 ;
...
-(id)keyTransparencyCollaboratorWithErrorHandler:(id)arg0 ;
