...
-(void)connection:(id)arg0 account:(id)arg1 receivedGroupSessionParticipantUpdate:(id)arg2 context:(id)arg3 ;
...
-(void)finishedSigningForRequest:(id)arg0 signedData:(id)arg1 error:(id)arg2 ;
-(void)finishedVerifyingSignedDataForRequest:(id)arg0 success:(BOOL)arg1 error:(id)arg2 ;
