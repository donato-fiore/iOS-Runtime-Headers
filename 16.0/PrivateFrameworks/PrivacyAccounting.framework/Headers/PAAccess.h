...
@property (readonly, nonatomic) NSUInteger eventCount; // ivar: _eventCount
...
@property (readonly, nonatomic) NSInteger visibilityState; // ivar: _visibilityState
...
-(id)asIntervalEndEventWithTimestampAdjustment:(CGFloat)arg0 ;
