...
@class NSHashTable, NSMutableDictionary, NSMapTable, _WKRemoteObjectInterface, WBSDispatchSourceTimer, NSDictionary, NSString, WBSCoreAnalyticsExtensionsStatistics;
@protocol WBSCloudExtensionStateProvider, WBSWebExtensionsControllerDelegate, WBSWebExtensionWindow;
