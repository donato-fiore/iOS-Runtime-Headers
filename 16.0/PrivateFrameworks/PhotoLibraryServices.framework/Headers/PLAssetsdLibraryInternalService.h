...
-(void)assetsArePendingForDuplicateMergeProcessing:(id)arg0 reply:(id)arg1 ;
...
-(void)getSearchIndexRebuildInfoWithReply:(id)arg0 ;
...
-(void)mergeDuplicateAssetUuidSelection:(id)arg0 reply:(id)arg1 ;
-(void)metricsForLibraryAtURL:(id)arg0 reply:(id)arg1 ;
-(void)processIdenticalDuplicatesWithProcessingType:(NSUInteger)arg0 reply:(id)arg1 ;
