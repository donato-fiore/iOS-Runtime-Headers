...
-(BOOL)_consolidateResource:(id)arg0 assetUUID:(id)arg1 bundleScope:(unsigned short)arg2 error:(*id)arg3 ;
...
-(void)asynchronousAdjustmentDataForAsset:(id)arg0 networkAccessAllowed:(BOOL)arg1 reply:(id)arg2 ;
