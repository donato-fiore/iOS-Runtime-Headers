...
+(BOOL)_removeCrashRecoveryMarkerFileWithPathManager:(id)arg0 ;
+(BOOL)_writeCrashRecoveryMarkerFileForTargetAssetUUID:(id)arg0 pathManager:(id)arg1 ;
+(BOOL)mergeAssets:(id)arg0 targetAssetOID:(id)arg1 photolibrary:(id)arg2 error:(*id)arg3 ;
+(id)_crashRecoveryMarkerFileURLWithPathManager:(id)arg0 ;
+(void)processCrashRecoveryMarkerFileIfNeededWithPathManager:(id)arg0 ;
