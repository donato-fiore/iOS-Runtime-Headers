...
+(id)entityName;
+(id)fetchDuplicatePersonUUIDsInManagedObjectContext:(id)arg0 error:(*id)arg1 ;
...
+(id)personsWithPersonUris:(id)arg0 inManagedObjectContext:(id)arg1 ;
...
-(void)_triggerPersonSyncUpdateWithLibraryServicesManager:(id)arg0 ;
