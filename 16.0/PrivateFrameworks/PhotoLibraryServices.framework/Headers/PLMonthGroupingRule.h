...
-(BOOL)highlightItemHasMinimumRequirementToBePromoted:(id)arg0 withSharingConsideration:(NSInteger)arg1 ;
...
-(id)fallbackHighlightItemFromAllHighlightItems:(id)arg0 withSharingConsideration:(NSInteger)arg1 ;
-(id)highlightItemsSortedByImportance:(id)arg0 withSharingConsideration:(NSInteger)arg1 ;
-(id)init;
