...
@interface PLNotification : NSObject {
    ...
    NSUInteger _trashedAssetPhotoCount;
    NSUInteger _trashedAssetVideoCount;
    NSUInteger _trashedAssetItemCount;
    short _exitType;
    NSInteger _exitRetentionPolicy;
}
...
-(id)initForSharedLibraryExitInitatedByOwnerWithType:(short)arg0 retentionPolicy:(NSInteger)arg1 ownerName:(id)arg2 ;
-(id)initForSharedLibraryParticipantAssetTrashNotificationWithTrashedPhotoCount:(NSUInteger)arg0 videoCount:(NSUInteger)arg1 itemCount:(NSUInteger)arg2 ;
-(id)initForSharedLibraryScopeAcceptWithLibraryScopeIdentifier:(id)arg0 participantName:(id)arg1 ;
