...
-(id)_usedElsewhereWarningTextForAssetCount:(NSInteger)arg0 inLibraryScopeCount:(NSInteger)arg1 inPhotoStreamCount:(NSInteger)arg2 iniPhotoCount:(NSInteger)arg3 inSomeAlbumCount:(NSInteger)arg4 affectedLocalAlbumsCount:(NSInteger)arg5 assetType:(short)arg6 actualDeletionCount:(NSInteger)arg7 syndicationAssetCount:(NSInteger)arg8 ;
...
-(void)_getExpungeWarningMessage:(*id)arg0 buttonTitle:(*id)arg1 forAssetCount:(NSInteger)arg2 assetType:(short)arg3 iCPLEnabled:(BOOL)arg4 deviceModelName:(id)arg5 ;
