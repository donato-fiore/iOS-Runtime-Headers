...
-(id)transferAssetsWithUuids:(id)arg0 fromLibraryURL:(id)arg1 transferOptions:(id)arg2 reply:(id)arg3 ;
-(id)transferPersonsWithUuids:(id)arg0 fromLibraryURL:(id)arg1 transferOptions:(id)arg2 reply:(id)arg3 ;
