...
+(BOOL)includesHiddenAssetsInQuery:(id)arg0 ;
+(BOOL)includesHiddenAssetsKeyInQuery:(id)arg0 ;
+(NSUInteger)_comparatorToOperatorType:(int)arg0 ;
+(id)_assetsPredicateForPersonPredicate:(id)arg0 assetObjectIDs:(*id)arg1 additionalAssetPredicate:(id)arg2 invert:(BOOL)arg3 inLibrary:(id)arg4 ;
...
+(id)_predicateForPersonUUIDinMomentForSharedLibraryQuery:(id)arg0 inLibrary:(id)arg1 changeDetectionCriteria:(id)arg2 ;
...
+(id)_singleQueryInQuery:(id)arg0 passingTest:(id)arg1 ;
