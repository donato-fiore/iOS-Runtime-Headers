...
@class PFStateCaptureHandler, PLLazyObject, NSMutableDictionary, PLLibraryServicesStateNode, NSString, NSError, NSURL, NSMutableArray, PLPhotoLibraryPathManager, NSPersistentStoreCoordinator, NSProgress, PLTrackableRequestManager;
