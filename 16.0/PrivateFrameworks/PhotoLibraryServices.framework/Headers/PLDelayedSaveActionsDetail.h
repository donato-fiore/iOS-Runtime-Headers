...
@property (copy, nonatomic) NSSet *libraryScopeParticipantsForUpdate; // ivar: _libraryScopeParticipantsForUpdate
@property (nonatomic) BOOL libraryScopeRulesUpdated; // ivar: _libraryScopeRulesUpdated
...
@property (copy, nonatomic) NSDictionary *sharedAssetContainerIncrementalChangesByAssetID; // ivar: _sharedAssetContainerIncrementalChangesByAssetID
...
@property (copy, nonatomic) NSSet *wallpaperSuggestionReloadUUIDs; // ivar: _wallpaperSuggestionReloadUUIDs


+(BOOL)supportsSecureCoding;
+(id)_decodeMomentDeletes:(id)arg0 urlToObjectID:(id)arg1 ;
+(id)_decodeSharedAssetContainerIncrementalChanges:(id)arg0 urlToObjectID:(id)arg1 ;
