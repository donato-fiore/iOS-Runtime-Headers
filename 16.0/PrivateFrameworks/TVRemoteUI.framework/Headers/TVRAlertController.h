...
@protocol TVRAlertViewDelegate, TVRKeyboardViewDelegate, UIViewControllerTransitioningDelegate, TVRAlertControllerDelegate;


#import "TVRAlertView.h"
#import "TVRKeyboardView.h"
...
@property (retain, nonatomic) TVRAlertView *alertView; // ivar: _alertView
@property (readonly, copy) NSString *debugDescription;
@property (weak, nonatomic) NSObject<TVRAlertControllerDelegate> *delegate; // ivar: _delegate
...
@property (retain, nonatomic) TVRKeyboardView *keyboardView; // ivar: _keyboardView
