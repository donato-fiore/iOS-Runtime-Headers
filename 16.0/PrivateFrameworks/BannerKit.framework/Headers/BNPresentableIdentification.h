...
@protocol BNPresentableIdentifying, BNPresentableUniquelyIdentifying, BSXPCSecureCoding;

#import <Foundation/Foundation.h>


@interface BNPresentableIdentification : NSObject <BNPresentableIdentifying, BNPresentableUniquelyIdentifying, BSXPCSecureCoding>
