...
@property (readonly, nonatomic) NSMutableDictionary *_analyticsEventsByIdentifier; // ivar: __analyticsEventsByIdentifier
...
-(id)startBurstCaptureWithAnalyticsEvent:(id)arg0 ;
