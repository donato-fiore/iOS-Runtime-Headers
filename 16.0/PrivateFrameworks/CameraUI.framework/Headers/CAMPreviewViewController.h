...
@property (readonly, nonatomic) BOOL _disableDelayedFadeOutForFaces; // ivar: __disableDelayedFadeOutForFaces
@property (readonly, nonatomic) BOOL _disableIndicatorGeometryAnimations; // ivar: __disableIndicatorGeometryAnimations
...
-(BOOL)_focusOnPoint:(struct CGPoint )arg0 shouldShowFocusAndExposureIndicator:(BOOL)arg1 ;
...
-(BOOL)_setCinematicFocusForMetadataObject:(id)arg0 atPoint:(struct CGPoint )arg1 useFixedOpticalFocus:(BOOL)arg2 useHardFocus:(BOOL)arg3 ;
...
-(struct ? )_geometryAnimationParametersForViewType:(id)arg0 ;
...
// -(void)_animateIfNeededWithParameters:(struct ? )arg0 animations:(id)arg1 completion:(unk)arg2  ;
...
-(void)_handleFocusTapForPointInPreviewView:(struct CGPoint )arg0 ;
...
// -(void)_updateIndicatorsForMetadataObjectResults:(id)arg0 allowNewAndReappearingIndicators:(BOOL)arg1 viewType:(id)arg2 viewClass:(Class)arg3 geometryCallback:(id)arg4 minimumAreaChangeThreshold:(unk)arg5 minimumAreaFractionChangeThreshold:(CGFloat)arg6  ;
