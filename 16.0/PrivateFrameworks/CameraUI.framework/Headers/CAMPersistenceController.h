...
-(BOOL)writePrivateMetadataFileToURL:(id)arg0 withPrivateClientMetadata:(id)arg1 sharedLibraryMode:(NSInteger)arg2 contactIDsInProximity:(id)arg3 sharedLibraryDiagnostics:(id)arg4 ;
...
-(id)_persistenceErrorForWriteStream:(struct __CFWriteStream *)arg0 url:(id)arg1 code:(NSInteger)arg2 ;
...
-(struct __CFWriteStream *)_createOpenWriteStreamWithURL:(id)arg0 forBurst:(BOOL)arg1 error:(*id)arg2 ;
