...
@class UIView, NSMutableDictionary, UIScrollView, CEKApertureSlider, NSString, CAMControlDrawerButton<CAMControlDrawerExpandableButton>, CEKWheelScrubberView, CEKSlider, NSArray;
...
@property (retain, nonatomic, setter=_setExpandedControl:) CAMControlDrawerButton<CAMControlDrawerExpandableButton> *expandedControl; // ivar: _expandedControl
