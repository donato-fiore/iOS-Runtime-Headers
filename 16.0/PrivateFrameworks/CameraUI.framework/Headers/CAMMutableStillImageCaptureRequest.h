...
@class NSString, NSURL, NSArray, CLHeading, CLLocation, NSDictionary;
@protocol CAMMutableCaptureRequestPersistence, CAMMutableCaptureRequestLocation, CAMMutableCaptureRequestPower, CAMMutableCaptureRequestOrigin, CAMMutableCaptureRequestEncodingBehavior, CAMMutableCaptureRequestLibrarySelection, CAMStillImageCaptureRequestDelegate;
...
@property (nonatomic) NSInteger maximumPhotoResolution;
