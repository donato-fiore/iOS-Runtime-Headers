...
@protocol ProxyAnalyticsDelegate, NWUsageManagerDelegate, FlowImmediateRefreshDelegate, CellThroughputAdviserDelegate, ManagedEventInfoProtocol, OS_dispatch_source;
...
-(void)_updateLiveUsage:(id)arg0 wifiIn:(NSInteger)arg1 wifiOut:(NSInteger)arg2 cellIn:(NSInteger)arg3 cellOut:(NSInteger)arg4 wiredIn:(NSInteger)arg5 wiredOut:(NSInteger)arg6 xIn:(NSInteger)arg7 xOut:(NSInteger)arg8 isJumboFlow:(BOOL)arg9 isExpensive:(BOOL)arg10 closing:(BOOL)arg11 ;
...
-(void)requestDetailedCellFlowMonitoring:(BOOL)arg0 ;
-(void)requestDetailedWiFiFlowMonitoring:(BOOL)arg0 ;
