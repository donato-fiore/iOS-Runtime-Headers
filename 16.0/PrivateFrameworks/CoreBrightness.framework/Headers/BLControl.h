...
@class NSMutableDictionary, NSMutableArray, HIDManager, SWSystemSleepMonitor, NSString;
@protocol SWSystemSleepObserver, OS_dispatch_queue, OS_os_log, OS_dispatch_source;
...
-(BOOL)findBacklight;
-(BOOL)findDisplays;
-(BOOL)handleDisplayModeUpdatePropertyHandler:(id)arg0 ;
