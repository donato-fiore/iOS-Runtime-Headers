...
@class NSString;
@protocol HMELastEventStoreWriter, HMETopicRouterDelegate, HMESynchronousSubscriptionProviding, HMEEventForwarder, HMESubscriptionProviding, HMEEventConsumer, OS_os_log, HMEMemoryEventBusDataSource, HMEMemoryEventBusDelegate, HMELastEventStoreReadHandle, HMELastEventStoreWriteHandle, OS_dispatch_queue;
...
@property (weak) NSObject<HMEMemoryEventBusDataSource> *dataSource; // ivar: _dataSource
