...
-(float)mergeConfidenceBetweenPersonLocalIdentifier:(id)arg0 andCandidateLocalIdentifiers:(id)arg1 ;
...
-(void)updateConfidenceCacheBetweenPersonLocalIdentifier:(id)arg0 andOtherPersonLocalIdentifier:(id)arg1 withDistance:(CGFloat)arg2 ;
