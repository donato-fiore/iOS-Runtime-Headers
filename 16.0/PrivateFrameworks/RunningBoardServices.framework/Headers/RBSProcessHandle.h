...
-(id)initWithInstance:(id)arg0 auditToken:(id)arg1 bundleData:(id)arg2 manageFlags:(unsigned char)arg3 beforeTranslocationBundlePath:(id)arg4 cache:(BOOL)arg5 ;
