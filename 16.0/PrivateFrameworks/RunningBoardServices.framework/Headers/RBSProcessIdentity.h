...
+(id)extensionIdentityForBundleIdentifier:(id)arg0 persona:(id)arg1 instanceUUID:(id)arg2 hostIdentifier:(id)arg3 validationToken:(id)arg4 ;
+(id)extensionIdentityForPlugInKitIdentifier:(id)arg0 bundledURL:(id)arg1 hostIdentifier:(id)arg2 UUID:(id)arg3 ;
...
+(id)identityForDextWithServerName:(id)arg0 tagString:(id)arg1 containingAppBundleID:(id)arg2 ;
...
+(id)identityForLSApplicationIdentity:(id)arg0 LSApplicationRecord:(id)arg1 ;
+(id)identityForLaunchdJobLabel:(id)arg0 isMultiInstance:(BOOL)arg1 pid:(int)arg2 auid:(unsigned int)arg3 ;
+(id)identityForMacApplicationJobLabel:(id)arg0 appID:(id)arg1 bundleID:(id)arg2 platform:(int)arg3 ;
...
+(id)identityForUnknownServiceWithJobLabel:(id)arg0 ;
...
+(id)identityForXPCServiceIdentifier:(id)arg0 hostInstance:(id)arg1 UUID:(id)arg2 persona:(id)arg3 validationToken:(id)arg4 variant:(NSInteger)arg5 ;
+(id)identityForXPCServiceIdentifier:(id)arg0 hostInstance:(id)arg1 UUID:(id)arg2 variant:(NSInteger)arg3 ;
