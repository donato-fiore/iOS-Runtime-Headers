...
@property (nonatomic) BOOL applyRenderTransformAfterEffect; // ivar: _applyRenderTransformAfterEffect
...
-(void)buildEffectInputMap:(*void)arg0 forTime:(struct ? )arg1 trackInputs:(*void)arg2 renderer:(*void)arg3 igContext:(struct HGRef<PVInstructionGraphContext> )arg4 ;
