...
-(struct HGRef<HGNode> )applyGainMapToGraph:(struct HGRef<HGNode> )arg0 gainMap:(struct HGRef<HGBitmap> )arg1 withHeadroom:(float)arg2 ;
...
-(void)setHDRGainMapHeadroom:(float)arg0 ;
