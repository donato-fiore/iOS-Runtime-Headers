...
-(BOOL)dynamicPluginRequestedProtocolArray:(*id)arg0 groupArray:(*id)arg1 plugInArray:(*id)arg2 actuallyLoad:(BOOL)arg3 ;
-(BOOL)isDeferred;
...
-(id)initWithBundle:(id)arg0 actuallyLoad:(BOOL)arg1 ;
...
-(void)dealloc;
-(void)finishRegisteringPlugIns:(BOOL)arg0 ;
...
-(void)registerAndLoadPlugIns:(BOOL)arg0 ;
