...
typedef struct PCCFRef<CGColorSpace *> {
} // Error Processing Struct Fields

typedef struct FxColorDescription {
    PCCFRef<CGColorSpace *> _colorSpaceRef;
    int _type;
    BOOL _isPremultiplied;
} FxColorDescription;

typedef struct __compressed_pair<std::__tree_end_node<std::__tree_node_base<void *> *>, std::allocator<std::__tree_node<std::__value_type<_opaque_pthread_t *, std::stack<OZFxPlugRenderContext *>>, void *>>> {
    __tree_end_node<std::__tree_node_base<void *> *> __value_;
} __compressed_pair<std::__tree_end_node<std::__tree_node_base<void *> *>, std::allocator<std::__tree_node<std::__value_type<_opaque_pthread_t *, std::stack<OZFxPlugRenderContext *>>, void *>>>;

typedef struct __compressed_pair<unsigned long, std::__map_value_compare<_opaque_pthread_t *, std::__value_type<_opaque_pthread_t *, std::stack<OZFxPlugRenderContext *>>, std::less<_opaque_pthread_t *>, true>> {
    NSUInteger __value_;
} __compressed_pair<unsigned long, std::__map_value_compare<_opaque_pthread_t *, std::__value_type<_opaque_pthread_t *, std::stack<OZFxPlugRenderContext *>>, std::less<_opaque_pthread_t *>, true>>;

typedef struct __tree<std::__value_type<_opaque_pthread_t *, std::stack<OZFxPlugRenderContext *>>, std::__map_value_compare<_opaque_pthread_t *, std::__value_type<_opaque_pthread_t *, std::stack<OZFxPlugRenderContext *>>, std::less<_opaque_pthread_t *>, true>, std::allocator<std::__value_type<_opaque_pthread_t *, std::stack<OZFxPlugRenderContext *>>>> {
    void __begin_node_;
    __compressed_pair<std::__tree_end_node<std::__tree_node_base<void *> *>, std::allocator<std::__tree_node<std::__value_type<_opaque_pthread_t *, std::stack<OZFxPlugRenderContext *>>, void *>>> __pair1_;
    __compressed_pair<unsigned long, std::__map_value_compare<_opaque_pthread_t *, std::__value_type<_opaque_pthread_t *, std::stack<OZFxPlugRenderContext *>>, std::less<_opaque_pthread_t *>, true>> __pair3_;
} __tree<std::__value_type<_opaque_pthread_t *, std::stack<OZFxPlugRenderContext *>>, std::__map_value_compare<_opaque_pthread_t *, std::__value_type<_opaque_pthread_t *, std::stack<OZFxPlugRenderContext *>>, std::less<_opaque_pthread_t *>, true>, std::allocator<std::__value_type<_opaque_pthread_t *, std::stack<OZFxPlugRenderContext *>>>>;

typedef struct map<_opaque_pthread_t *, std::stack<OZFxPlugRenderContext *>, std::less<_opaque_pthread_t *>, std::allocator<std::pair<_opaque_pthread_t *const, std::stack<OZFxPlugRenderContext *>>>> {
    __tree<std::__value_type<_opaque_pthread_t *, std::stack<OZFxPlugRenderContext *>>, std::__map_value_compare<_opaque_pthread_t *, std::__value_type<_opaque_pthread_t *, std::stack<OZFxPlugRenderContext *>>, std::less<_opaque_pthread_t *>, true>, std::allocator<std::__value_type<_opaque_pthread_t *, std::stack<OZFxPlugRenderContext *>>>> __tree_;
} map<_opaque_pthread_t *, std::stack<OZFxPlugRenderContext *>, std::less<_opaque_pthread_t *>, std::allocator<std::pair<_opaque_pthread_t *const, std::stack<OZFxPlugRenderContext *>>>>;
...
typedef struct OZFxPlugRenderContextManager {
    unk _vptr$OZFxPlugRenderContextManager;
    FxColorDescription _workingColorDescription;
    float _blendingGamma;
    map<_opaque_pthread_t *, std::stack<OZFxPlugRenderContext *>, std::less<_opaque_pthread_t *>, std::allocator<std::pair<_opaque_pthread_t *const, std::stack<OZFxPlugRenderContext *>>>> _contexts;
...
typedef struct stack<bool, std::deque<bool>> {
    deque<bool, std::allocator<bool>> c;
} stack<bool, std::deque<bool>>;
