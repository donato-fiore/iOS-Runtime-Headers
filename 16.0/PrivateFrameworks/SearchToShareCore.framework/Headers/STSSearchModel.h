...
@property (retain, nonatomic) NSMutableDictionary *reportConcernStore; // ivar: _reportConcernStore
...
-(NSUInteger)numberOfReportedResults;
-(id)createQuerySession;
-(id)defaultCategoryList;
-(id)init;
-(id)mockQuerySuggestions;
-(id)removeOutdatedReportedResults:(id)arg0 ;
-(id)resultsWithReportedImagesRemoved:(id)arg0 ;
...
-(void)addSearchResultToReportConcernStore:(id)arg0 ;
...
-(void)removeResultAtIndexPath:(id)arg0 ;
