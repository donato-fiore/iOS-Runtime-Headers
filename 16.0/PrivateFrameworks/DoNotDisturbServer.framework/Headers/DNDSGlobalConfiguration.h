...
@property (readonly, nonatomic) NSUInteger modesCanImpactAvailability; // ivar: _modesCanImpactAvailability
...
-(id)init;
-(id)initWithPreventAutoReply:(NSUInteger)arg0 bypassSettings:(id)arg1 modesCanImpactAvailability:(NSUInteger)arg2 lastModified:(id)arg3 automaticallyGenerated:(BOOL)arg4 ;
