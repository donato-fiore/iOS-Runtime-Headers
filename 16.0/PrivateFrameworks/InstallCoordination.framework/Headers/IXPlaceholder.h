...
+(id)_placeholderForBundle:(id)arg0 client:(NSUInteger)arg1 withParent:(id)arg2 installType:(NSUInteger)arg3 metadata:(id)arg4 placeholderType:(NSUInteger)arg5 error:(*id)arg6 ;
...
-(BOOL)_doInitWithBundleName:(id)arg0 bundleID:(id)arg1 installType:(NSUInteger)arg2 placeholderType:(NSUInteger)arg3 ;
-(BOOL)_internalInitAppExtensionPlaceholderWithBundleName:(id)arg0 bundleID:(id)arg1 parentPlaceholder:(id)arg2 placeholderType:(NSUInteger)arg3 client:(NSUInteger)arg4 ;
