...
-(BOOL)meetsEnergyCriteriaForQualifier:(int)arg0 forEnergyEntry:(id)arg1 withQualifierEnergyKey:(id)arg2 ;
-(BOOL)shouldShowBreakdown:(id)arg0 ;
-(CGFloat)getDataDurationFromRange:(struct _PLTimeIntervalRange )arg0 ;
-(CGFloat)getEnergyRemovedBySlopAdjustment:(id)arg0 withEnergyKey:(id)arg1 forBucket:(id)arg2 ;
