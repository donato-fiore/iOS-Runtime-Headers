...
@property (readonly, nonatomic) CGFloat cellCornerRadius; // ivar: cellCornerRadius
...
@property (readonly, nonatomic) BOOL dragGestureDisabled; // ivar: dragGestureDisabled
...
@property (readonly, nonatomic) CGFloat minimumInterItemSpacing; // ivar: minimumInterItemSpacing
