...
@property (retain, nonatomic) NSDictionary *networkEndpoint; // ivar: _networkEndpoint
@property (retain, nonatomic) NSDictionary *networkParameters; // ivar: _networkParameters
