...
@class SUManagerClient, NSString, SUDescriptor, NSError, NSArray, SDDevice, SUDownload, SUMutableDownloadMetadata, UIViewController, SUInstallPolicy, RUIStyle;
...
@property (nonatomic) BOOL isDeviceBetaEnrolled; // ivar: _isDeviceBetaEnrolled
