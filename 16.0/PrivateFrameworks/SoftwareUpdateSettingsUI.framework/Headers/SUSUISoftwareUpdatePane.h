...
-(BOOL)shouldShowRollbackButtonForState:(int)arg0 ;
-(BOOL)shouldShowRollbackGroupForState:(int)arg0 ;
...
-(id)_betaUpdatesButtonSpecifierForState:(int)arg0 ;
...
-(id)_rollbackButtonSpecifierForState:(int)arg0 ;
-(id)_rollbackGroupSpecifierForState:(int)arg0 ;
...
-(id)_setRollbackButtonSpecifierState:(id)arg0 ;
...
-(void)betaUpdatesEnabledToggled:(id)arg0 forSpecifier:(id)arg1 ;
...
-(void)clearRollbackButton:(id)arg0 ;
...
-(void)rollbackUpdateTapped:(id)arg0 ;
-(void)setInstallButtonDeleted:(id)arg0 ;
-(void)setInstallButtonDownloadAndInstall:(id)arg0 ;
-(void)setInstallButtonDownloadAndInstall:(id)arg0 shouldRemove:(*BOOL)arg1 ;
...
-(void)setInstallButtonInstalled:(id)arg0 ;
-(void)setInstallButtonInstalledForSpecifier:(id)arg0 ;
...
-(void)setupRollbackButton:(id)arg0 shouldRemove:(*BOOL)arg1 ;
