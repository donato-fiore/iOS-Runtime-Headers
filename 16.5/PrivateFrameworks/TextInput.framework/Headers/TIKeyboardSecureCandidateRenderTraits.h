...
@property (nonatomic) BOOL disableHideMyEmail; // ivar: _disableHideMyEmail
...
@property (copy, nonatomic) NSString *hideMyEmailLocalizedText; // ivar: _hideMyEmailLocalizedText
...
@property (nonatomic) BOOL shouldOfferHideMyEmail; // ivar: _shouldOfferHideMyEmail
