...
@property (retain, nonatomic) TIActionWhenIdle *actionWhenIdle; // ivar: _actionWhenIdle
...
-(void)_configureKey:(id)arg0 domain:(id)arg1 defaultValue:(id)arg2 fallbackKey:(id)arg3 isAnalyzed:(BOOL)arg4 isCloudSetting:(BOOL)arg5 ;
-(void)_configureKey:(id)arg0 domain:(id)arg1 defaultValue:(id)arg2 fallbackKey:(id)arg3 isAnalyzed:(BOOL)arg4 isCloudSetting:(BOOL)arg5 isWatchSync:(BOOL)arg6 ;
-(void)_configureKey:(id)arg0 domain:(id)arg1 defaultValue:(id)arg2 isCloudSetting:(BOOL)arg3 ;
-(void)_configureKey:(id)arg0 domain:(id)arg1 fallbackKey:(id)arg2 ;
-(void)_configureKey:(id)arg0 domain:(id)arg1 fallbackKey:(id)arg2 isCloudSetting:(BOOL)arg3 ;
...
-(void)updateCompactAssistantBarPersistentLocation:(NSUInteger)arg0 ;
-(void)updateDictationAutoPunctuation:(id)arg0 ;
-(void)updateDictationTipDisplayCount:(id)arg0 dictationTipKey:(id)arg1 ;
-(void)updateDictationTipLastShownDate:(id)arg0 ;
