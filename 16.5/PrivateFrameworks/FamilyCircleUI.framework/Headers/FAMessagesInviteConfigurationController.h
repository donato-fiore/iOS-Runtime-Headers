...
@class MFMessageComposeViewController, LPLinkMetadata, UIViewController, NSArray, NSString, FAInviteContext;
...
-(id)initWithInviteContext:(id)arg0 presentingController:(id)arg1 familySuggestionHandle:(id)arg2 ;
