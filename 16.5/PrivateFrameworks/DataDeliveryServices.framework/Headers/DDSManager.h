...
@protocol DDSAssetProvidingDelegate, DDSAssetTrackingDelegate, DDSRemoteSyncStateDelegate, DDSAssetObservingDelegate, DDSManaging, DDSAssetObserving, DDSManagingDelegate, DDSAssetProviding, DDSAssetTracking, OS_dispatch_queue;
...
@property (weak) NSObject<DDSManagingDelegate> *delegate; // ivar: _delegate
