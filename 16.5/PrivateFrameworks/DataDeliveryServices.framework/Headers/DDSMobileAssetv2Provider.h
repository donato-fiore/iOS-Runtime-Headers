...
@protocol DDSAssetProviding, DDSAssetProvidingDelegate;
...
@property (readonly, nonatomic) DDSAssetQueryResultCache *assetQueryResultsCache; // ivar: _assetQueryResultsCache
@property (readonly, copy) NSString *debugDescription;
@property (retain, nonatomic) NSObject<DDSAssetProvidingDelegate> *delegate; // ivar: delegate
@property (readonly, copy) NSString *description;
@property (readonly, nonatomic) NSMutableDictionary *downloadStateByAssetID; // ivar: _downloadStateByAssetID
