...
@property (readonly, retain, nonatomic) SUInstallOptions *installOptions; // ivar: _installOptions
...
-(id)initWithDownload:(id)arg0 andInstallOptions:(id)arg1 ;
-(id)initWithDownload:(id)arg0 installOptions:(id)arg1 queue:(id)arg2 constraints:(id)arg3 ;
