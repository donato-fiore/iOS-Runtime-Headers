...
-(BOOL)isInstallationKeybagRequiredForDescriptor:(id)arg0 ;
-(BOOL)isSplatOnlyUpdateInstalled;
-(BOOL)isSplatOnlyUpdateRollbackAllowed:(*id)arg0 ;
-(BOOL)isSplatOnlyUpdateRollbackSuggested;
-(BOOL)securityResponseRollbackSuggested:(id)arg0 error:(*id)arg1 ;
-(BOOL)setLastRollbackDescriptor:(id)arg0 ;
...
-(id)getDocumentationDataForInstalledUpdateType:(int)arg0 error:(*id)arg1 ;
-(id)init;
...
-(void)cancelDownloadWithOptions:(id)arg0 withResult:(id)arg1 ;
-(void)clearingSpaceForDownload:(id)arg0 clearing:(BOOL)arg1 ;
...
-(void)deviceBootedAfterRollback:(id)arg0 ;
...
-(void)eligibleRollbackWithOptions:(id)arg0 withResult:(id)arg1 ;
...
-(void)presentingRecommendedUpdate:(id)arg0 shouldPresent:(BOOL)arg1 ;
-(void)previousRollbackWithOptions:(id)arg0 withResult:(id)arg1 ;
-(void)purgeDownload:(id)arg0 ;
-(void)purgeDownloadWithOptions:(id)arg0 withResult:(id)arg1 ;
-(void)recordSUAnalyticsEvent:(id)arg0 ;
-(void)registerCSInstallPredicatesOnDate:(id)arg0 ;
-(void)resumeDownload:(id)arg0 ;
-(void)rollbackDidFail:(id)arg0 withError:(id)arg1 ;
-(void)rollbackDidFinish:(id)arg0 ;
-(void)rollbackDidStart:(id)arg0 ;
-(void)rollbackReadyForReboot:(id)arg0 ;
-(void)rollbackReadyToStart:(id)arg0 options:(id)arg1 completion:(id)arg2 ;
-(void)rollbackSuggested:(id)arg0 info:(id)arg1 ;
-(void)rollbackUpdateWithOptions:(id)arg0 withResult:(id)arg1 ;
...
-(void)scheduleRollbackRebootForLater:(id)arg0 ;
