...
@class SUCorePersistedState, SUCoreDescriptor, NSDate, NSString, NSArray, NSNumber, NSDictionary, NSMutableArray;
...
@property (retain, nonatomic) NSDate *lastAutoDownloadDate; // ivar: _lastAutoDownloadDate
...
@property (retain, nonatomic) NSDate *lastRecommendedUpdateDiscoveryDate; // ivar: _lastRecommendedUpdateDiscoveryDate
@property (retain, nonatomic) NSNumber *lastRecommendedUpdateInterval; // ivar: _lastRecommendedUpdateInterval
@property (retain, nonatomic) NSString *lastRecommendedUpdateVersion; // ivar: _lastRecommendedUpdateVersion
@property (retain, nonatomic) NSString *lastReleaseType; // ivar: _lastReleaseType
@property (retain, nonatomic) SURollbackDescriptor *lastRollbackDescriptor; // ivar: _lastRollbackDescriptor
@property (retain, nonatomic) NSString *lastRollbackRecommendedBuildVersion; // ivar: _lastRollbackRecommendedBuildVersion
...
@property (retain, nonatomic) NSDate *lastSentOTAPostponedDate; // ivar: _lastSentOTAPostponedDate
@property (retain, nonatomic) NSString *lastSplatRestoreVersion; // ivar: _lastSplatRestoreVersion
...
@property (readonly, retain, nonatomic) NSMutableArray *rolledBackBuildVersions; // ivar: _rolledBackBuildVersions
...
-(void)addRolledBackBuildVersion:(id)arg0 ;
-(void)load;
...
-(void)queue_addRolledBackBuildVersion:(id)arg0 ;
