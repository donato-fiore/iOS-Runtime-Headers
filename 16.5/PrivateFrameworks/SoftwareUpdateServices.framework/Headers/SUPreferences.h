...
@property (readonly, nonatomic) BOOL buddyInitiatedScan;
@property (retain, nonatomic) NSMutableDictionary *cachedPreferences; // ivar: _cachedPreferences
@property (readonly, nonatomic) BOOL customerPowerPolicies;
...
@property (readonly, nonatomic) BOOL skipApply;
@property (readonly, nonatomic) BOOL skipDownload;
...
-(void)dealloc;
-(void)enableAutoInstallSecurityResponse:(BOOL)arg0 ;
-(void)enableAutoInstallSystemAndDataFiles:(BOOL)arg0 ;
-(void)enableAutomaticDownload:(BOOL)arg0 ;
-(void)enableAutomaticUpdateV2:(BOOL)arg0 ;
-(void)enablePreviousUserSpecifiedAutoInstallSecurityResponse:(BOOL)arg0 ;
-(void)enablePreviousUserSpecifiedAutomaticUpdateV2:(BOOL)arg0 ;
-(void)reload;
