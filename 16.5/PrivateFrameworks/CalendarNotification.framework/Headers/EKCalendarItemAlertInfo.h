...
@class NSString, NSUserActivity, NSDate, NSURL, NSTimeZone, EKTravelEngineHypothesis, NSData;
@protocol NSCopying;
...
@property (readonly, nonatomic) int databaseID; // ivar: _databaseID
...
-(id)description;
-(id)initWithTitle:(id)arg0 location:(id)arg1 date:(id)arg2 endDate:(id)arg3 timeZone:(id)arg4 allDay:(BOOL)arg5 tentative:(BOOL)arg6 publisherBulletinID:(id)arg7 entityID:(id)arg8 appLink:(id)arg9 proximity:(NSInteger)arg10 externalID:(id)arg11 databaseID:(int)arg12 acknowledged:(BOOL)arg13 dismissalID:(id)arg14 alarmID:(id)arg15 isOffsetFromTravelTimeStart:(BOOL)arg16 refiring:(BOOL)arg17 pseudoEvent:(BOOL)arg18 ;
