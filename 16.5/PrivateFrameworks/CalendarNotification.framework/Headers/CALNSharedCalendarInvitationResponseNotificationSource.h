...
#ifndef CALNSHAREDCALENDARINVITATIONRESPONSENOTIFICATIONSOURCE_H
#define CALNSHAREDCALENDARINVITATIONRESPONSENOTIFICATIONSOURCE_H

@class NSArray, NSString;
@protocol CALNNotificationSource, CALNSharedCalendarInvitationResponseNotificationDataSource, CALNCalendarIconIdentifierProvider, CALNNotificationManager, CALNSourceEventRepresentationProvider;
...
@property (readonly, nonatomic) NSObject<CALNSharedCalendarInvitationResponseNotificationDataSource> *dataSource; // ivar: _dataSource
