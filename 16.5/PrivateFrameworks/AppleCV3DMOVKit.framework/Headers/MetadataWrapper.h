...
+(id)decodeDeviceMotion:(id)arg0 ;
+(id)decodeDictionary:(id)arg0 ;
+(id)decodeGyro:(id)arg0 ;
+(id)decodeIMU:(id)arg0 ;
...
+(id)deviceMotionTrackName:(*NSInteger)arg0 prefix:(id)arg1 ;
...
+(id)encodeIMUData:(id)arg0 ;
+(id)encodeMotionData:(id)arg0 ;
...
+(id)imuTrackName:(*NSInteger)arg0 prefix:(id)arg1 ;
+(id)locationTrackName:(*NSInteger)arg0 prefix:(id)arg1 ;
+(id)motionTrackName:(*NSInteger)arg0 prefix:(id)arg1 ;
+(id)trackNameFromPrefix:(*NSInteger)arg0 prefix:(id)arg1 defaultValue:(id)arg2 ;
+(id)version;
