...
@class NSHashTable, NSString, NSMutableArray, NSURL, NSMutableDictionary, NSSet, NSDate, NSArray;
...
@property (readonly, nonatomic) CPLEngineIgnoredRecords *ignoredRecords; // ivar: _ignoredRecords
...
@property (readonly, nonatomic) CPLEnginePendingRecordChecks *pendingRecordChecks; // ivar: _pendingRecordChecks
...
@property (readonly, nonatomic) CPLEngineRemappedRecords *remappedRecords; // ivar: _remappedRecords
@property (readonly, nonatomic) CPLEngineResourceStorage *resourceStorage; // ivar: _resourceStorage
@property (readonly, nonatomic) CPLEngineRevertRecords *revertRecords; // ivar: _revertRecords
...
@property (readonly, nonatomic) CPLTransportScopeMapping *transactionTransportScopeMapping; // ivar: _transactionTransportScopeMapping
...
+(id)storageNames;
+(void)setDontBatchTransactions:(BOOL)arg0 ;
-(BOOL)_applyAndDiscardPendingUpdate:(id)arg0 error:(*id)arg1 ;
-(BOOL)_applyPendingUpdate:(id)arg0 error:(*id)arg1 ;
-(BOOL)_canHaveActivatedScope:(id)arg0 libraryOptions:(NSUInteger)arg1 error:(*id)arg2 ;
-(BOOL)_canRead;
-(BOOL)_canWrite;
...
-(BOOL)addPushPullGatekeeper:(id)arg0 error:(*id)arg1 ;
...
-(BOOL)canActivateScope:(id)arg0 error:(*id)arg1 ;
-(BOOL)checkExpectedLibraryVersion:(id)arg0 error:(*id)arg1 ;
-(BOOL)clearAllPushPullGatekeepersWithError:(*id)arg0 ;
...
-(void)dealloc;
-(void)dropSharingScopeIdentifier:(id)arg0 ;
...
-(void)startVacuum;
-(void)stopVacuum;
-(void)storeSharingScopeIdentifier:(id)arg0 ;
