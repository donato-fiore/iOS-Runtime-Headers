...
@protocol CPLStatusDelegate, CPLAbstractObject, OS_dispatch_queue, OS_dispatch_source, CPLEngineLibraryOwner, CPLEngineLibrarySupervisor;
...
@property (nonatomic) NSInteger serverFeatureCompatibleVersion;
@property (readonly, nonatomic) CPLEngineStore *store; // ivar: _store
@property (readonly) Class superclass;
@property (retain, nonatomic) NSObject<CPLEngineLibrarySupervisor> *supervisor; // ivar: _supervisor
...
-(void)blockEngineWithReason:(id)arg0 onlyIfBlocked:(BOOL)arg1 block:(id)arg2 ;
...
-(void)updateBlockedMetrics:(BOOL)arg0 ;
