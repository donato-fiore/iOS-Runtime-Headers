...
@property (readonly, nonatomic) NSInteger activityState;
...
@property (readonly, nonatomic) NSDate *proposedRescheduleDate; // ivar: _proposedRescheduleDate
...
-(void)requestSyncStateAtEndOfSyncSession:(NSUInteger)arg0 reschedule:(BOOL)arg1 proposedRescheduleDate:(id)arg2 ;
-(void)sessionIsDone;
