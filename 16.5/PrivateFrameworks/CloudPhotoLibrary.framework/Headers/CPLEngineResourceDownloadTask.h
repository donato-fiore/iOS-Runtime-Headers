...
@property (readonly, nonatomic) CPLRecordTarget *target; // ivar: _target
...
@property (retain, nonatomic) CPLTransportScopeMapping *transportScopeMapping; // ivar: _transportScopeMapping
...
+(void)initialize;
// -(id)initWithResource:(id)arg0 taskIdentifier:(id)arg1 target:(id)arg2 launchHandler:(id)arg3 cancelHandler:(unk)arg4 didStartHandler:(id)arg5 progressHandler:(unk)arg6 completionHandler:(id)arg7  ;
