...
@class NSMutableArray, NSError, NSCountedSet, NSArray, NSString;
...
@interface CPLEngineSyncManager : NSObject <CPLAbstractObject, CPLEngineComponent, CPLEngineSyncTaskDelegate, CPLEngineForceSyncTaskDelegate>

 {
    ...
    os_unfair_lock_s _brokenScopesLock;
...
-(void)cancelAndBlockAllSyncSessionsWithReason:(id)arg0 block:(id)arg1 ;
...
-(void)removeBrokenScope:(id)arg0 ;
...
-(void)unblockSyncSessionWithReason:(id)arg0 ;
