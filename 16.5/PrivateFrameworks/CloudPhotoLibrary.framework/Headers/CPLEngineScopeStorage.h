...
@class NSMutableArray, NSDictionary, NSCountedSet, NSString;
...
-(BOOL)_activateSharedScopeIfPresentWithError:(*id)arg0 ;
-(BOOL)_doesScopeContributeToAssetCounts:(id)arg0 ;
-(BOOL)_dropSharingScopeIdentifier:(id)arg0 error:(*id)arg1 ;
...
-(BOOL)_setSharingScopeIdentifier:(id)arg0 error:(*id)arg1 ;
-(BOOL)activateScope:(id)arg0 error:(*id)arg1 ;
-(BOOL)addCleanupTasksForScope:(id)arg0 error:(*id)arg1 ;
-(BOOL)addRewindSyncAnchor:(id)arg0 forScope:(id)arg1 error:(*id)arg2 ;
-(BOOL)clearAllQuotaFlagsForMainScopeWithReason:(id)arg0 error:(*id)arg1 ;
-(BOOL)clearTransportGroupsForScope:(id)arg0 error:(*id)arg1 ;
-(BOOL)clientAcknowledgedScopeChanges:(id)arg0 error:(*id)arg1 ;
...
-(BOOL)storeBusyState:(NSInteger)arg0 forScope:(id)arg1 error:(*id)arg2 ;
...
-(BOOL)storeRewindSyncAnchors:(id)arg0 forScope:(id)arg1 error:(*id)arg2 ;
-(BOOL)storeScopeChange:(id)arg0 forScope:(id)arg1 error:(*id)arg2 ;
-(BOOL)storeScopeListSyncAnchor:(id)arg0 error:(*id)arg1 ;
-(BOOL)storeSupervisorInfo:(id)arg0 forScope:(id)arg1 error:(*id)arg2 ;
...
-(NSInteger)busyStateForScope:(id)arg0 ;
...
-(id)_realScopeIdentifiersFromScopeIdentifiers:(id)arg0 ;
...
-(id)sharingScopeForScope:(id)arg0 ;
-(id)stagingScopeForScope:(id)arg0 ;
-(id)status;
-(id)statusDictionaryForScope:(id)arg0 ;
-(id)supervisorInfoForScope:(id)arg0 ;
...
-(void)_removeBrokenScope:(id)arg0 ;
-(void)_resetGlobalsForMainScope;
-(void)_updateAssetCountsWithScopeChange:(id)arg0 forScope:(id)arg1 ;
-(void)beginCreatingScopeWithIdentifier:(id)arg0 ;
-(void)endCreatingScopeWithIdentifier:(id)arg0 ;
