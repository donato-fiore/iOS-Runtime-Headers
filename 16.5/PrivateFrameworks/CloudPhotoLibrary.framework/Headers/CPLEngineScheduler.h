...
@class NSDate, NSString, NSCountedSet, NSMutableDictionary, NSMutableSet, NSArray;
...
-(void)_keepSessionInformation:(id)arg0 ;
-(void)_noteServerIsUnavailableWithErrorLocked:(id)arg0 reason:(id)arg1 ;
-(void)_noteSyncSessionNeededFromState:(NSUInteger)arg0 proposedScheduleDate:(id)arg1 ;
...
-(void)blockAllSyncSessionsWithReason:(id)arg0 onlyIfBlocked:(BOOL)arg1 block:(id)arg2 ;
-(void)blockEngineElement:(id)arg0 ;
-(void)closeAndDeactivate:(BOOL)arg0 completionHandler:(id)arg1 ;
-(void)disableMingling;
-(void)disableSynchronizationIfBlockedWithReason:(id)arg0 completionHandler:(id)arg1 ;
