...
+(BOOL)_shouldDeletePrivateRecordWithNaturalPrivateScopedIdentifier:(id)arg0 correctPrivateScopedIdentifier:(id)arg1 cloudCache:(id)arg2 transientPullRepository:(id)arg3 ;
// +(BOOL)applyShareRemapFixUpTasks:(id)arg0 scope:(id)arg1 store:(id)arg2 onPutBatchInPullQueue:(id)arg3 error:(unk)arg4  ;
