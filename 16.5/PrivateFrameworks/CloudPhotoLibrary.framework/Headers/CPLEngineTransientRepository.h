...
-(BOOL)hasOnlyMingledRecordsWithScopeIdentifier:(id)arg0 ;
-(BOOL)hasRecordWithScopedIdentifier:(id)arg0 ;
-(BOOL)hasStashedChangesForScopeWithIdentifier:(id)arg0 ;
-(BOOL)hasStashedRecordWithScopedIdentifier:(id)arg0 ;
-(BOOL)hasUnmingledChangesForScope:(id)arg0 ;
-(BOOL)hasUnmingledNonStashedRecordsForScopeWithIdentifier:(id)arg0 ;
-(BOOL)hasUnmingledOrStashedRecordsWithScopeFilter:(id)arg0 ;
...
-(BOOL)stashChangeWithScopedIdentifier:(id)arg0 error:(*id)arg1 ;
-(BOOL)unstashRecordsForScopeWithIdentifier:(id)arg0 maxCount:(NSUInteger)arg1 hasMore:(*BOOL)arg2 error:(*id)arg3 ;
