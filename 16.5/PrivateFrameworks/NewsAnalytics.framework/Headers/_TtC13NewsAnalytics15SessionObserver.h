...
@class NSString;
@protocol FCBundleSubscriptionChangeObserver, FCCoreConfigurationObserving, FCUserInfoObserving, FCNewsletterSubscriptionObserver, FCSubscriptionObserving, FCShortcutListObserving;

#import <Foundation/Foundation.h>


@interface _TtC13NewsAnalytics15SessionObserver : NSObject <FCBundleSubscriptionChangeObserver, FCCoreConfigurationObserving, FCUserInfoObserving, FCNewsletterSubscriptionObserver, FCSubscriptionObserving, FCShortcutListObserving>
...
-(void)pushSessionDataWithRegionIDs:(id)arg0 notificationSettings:(id)arg1 isSportsOnboarded:(BOOL)arg2 ;
-(void)pushUserSubscriptionContextData;
-(void)shortcutList:(id)arg0 didAddShortcuts:(id)arg1 changedShortcuts:(id)arg2 removedShortcuts:(id)arg3 ;
