...
@class NSString, NSArray, NSMutableArray, NSURL, NSData;
...
@property (copy, nonatomic) NSString *correctedTextV2; // ivar: _correctedTextV2
...
@property (copy, nonatomic) NSString *postITNRecognizedText; // ivar: _postITNRecognizedText
