...
-(BOOL)_setAssetsPurgeability:(BOOL)arg0 languages:(id)arg1 invertLanguageSet:(BOOL)arg2 assetType:(NSUInteger)arg3 ;
...
-(BOOL)setAssetsPurgeability:(BOOL)arg0 exceptLanguages:(id)arg1 assetType:(NSUInteger)arg2 ;
-(BOOL)setAssetsPurgeability:(BOOL)arg0 forLanguages:(id)arg1 assetType:(NSUInteger)arg2 ;
...
-(id)_overrideAssetPath:(id)arg0 ;
-(id)_overrideAssetQualityString:(id)arg0 ;
-(id)_overrideAssetStatus:(id)arg0 ;
-(id)_overrideAssetStatusString:(id)arg0 ;
...
-(void)replaceCorruptAssetWithConfig:(id)arg0 ;
