...
-(void)preheatSpeechRecognitionWithAssetConfig:(id)arg0 preheatSource:(id)arg1 modelOverrideURL:(id)arg2 ;
...
-(void)redecodeWithAudioDatas:(id)arg0 language:(id)arg1 task:(id)arg2 samplingRate:(NSUInteger)arg3 completion:(id)arg4 ;
...
-(void)speechServiceDidRecognizeFinalResultCandidatePackage:(id)arg0 ;
-(void)speechServiceDidRecognizePackage:(id)arg0 ;
-(void)speechServiceDidRecognizePackage:(id)arg0 withMetadata:(id)arg1 ;
-(void)speechServiceDidRecognizeRawEagerRecognitionCandidate:(id)arg0 ;
-(void)speechServiceDidRecognizeTokens:(id)arg0 ;
-(void)speechServiceDidRecognizeTokens:(id)arg0 withMetadata:(id)arg1 ;
...
-(void)writeDESRecord;
-(void)writeUaapOovsForLanguage:(id)arg0 bundleId:(id)arg1 customProns:(id)arg2 newOovs:(id)arg3 completion:(id)arg4 ;
