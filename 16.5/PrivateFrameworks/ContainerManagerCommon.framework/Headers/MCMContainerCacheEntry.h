...
-(BOOL)verify;
-(id)_fabricateMetadataForContainerPath:(id)arg0 identifier:(id)arg1 uuid:(id)arg2 schemaVersion:(id)arg3 userIdentityCache:(id)arg4 ;
-(id)_findUserManagedAssetsDirectoryAtContainerRootURL:(id)arg0 ;
-(id)_identifierForContainerPath:(id)arg0 ;
-(id)_metadataFromContainerPath:(id)arg0 identifier:(id)arg1 uuid:(id)arg2 schemaVersion:(id)arg3 userIdentityCache:(id)arg4 ;
-(id)_readMetadataForIdentifier:(id)arg0 containerPath:(id)arg1 error:(*id)arg2 ;
-(id)containerIdentity;
-(id)copyWithZone:(struct _NSZone *)arg0 ;
-(id)fullDescription;
-(id)initFromContainerPath:(id)arg0 identifier:(id)arg1 uuid:(id)arg2 schemaVersion:(id)arg3 userIdentityCache:(id)arg4 ;
