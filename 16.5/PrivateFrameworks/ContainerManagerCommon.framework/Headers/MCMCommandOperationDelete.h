...
+(BOOL)deleteContainerRootURL:(id)arg0 userIdentity:(id)arg1 containerClass:(NSUInteger)arg2 containerPathIdentifier:(id)arg3 preferDirectDelete:(BOOL)arg4 error:(*id)arg5 ;
