...
@class AVOutputDeviceDiscoverySession, NSString, NSArray, NSSet;
...
@property (retain, nonatomic) NSSet *lastReportedClientIdentifiers; // ivar: _lastReportedClientIdentifiers
...
-(void)setDiscoveryMode:(unsigned int)arg0 forClientIdentifiers:(id)arg1 ;
