...
-(BOOL)containsOutputDevice:(id)arg0 ;
-(BOOL)containsOutputDeviceUID:(id)arg0 ;
-(id)outputDeviceForUID:(id)arg0 ;
-(void)_compareOutputDeviceList:(id)arg0 withNewOutputDeviceList:(id)arg1 ;
-(void)_notfiyOutputDeviceRemoved:(id)arg0 ;
-(void)_notifyChangesInOutputDevicesWithAdded:(id)arg0 removed:(id)arg1 updated:(id)arg2 previous:(id)arg3 newDevices:(id)arg4 ;
-(void)_notifyOutputDeviceAdded:(id)arg0 ;
-(void)_notifyOutputDeviceChanged:(id)arg0 ;
