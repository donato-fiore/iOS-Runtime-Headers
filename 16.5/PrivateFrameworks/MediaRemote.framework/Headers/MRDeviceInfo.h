...
@property (copy, nonatomic) NSArray *allClusteredDevices; // ivar: _allClusteredDevices
...
@property (copy, nonatomic) NSArray *clusteredDevices; // ivar: _clusteredDevices
...
@property (nonatomic) BOOL hasGroupContainsDiscoverableGroupLeader; // ivar: _hasGroupContainsDiscoverableGroupLeader
...
@property (nonatomic) BOOL hasParentGroupContainsDiscoverableGroupLeader; // ivar: _hasParentGroupContainsDiscoverableGroupLeader
...
@property (nonatomic) BOOL supportsOutputContextSync; // ivar: _supportsOutputContextSync
...
-(BOOL)isAwareOfCluster:(unsigned int)arg0 ;
...
-(id)initWithOutputDeviceDescription:(id)arg0 ;
