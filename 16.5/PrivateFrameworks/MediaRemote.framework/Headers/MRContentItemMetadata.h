...
@property (copy, nonatomic) NSString *classicalWork; // ivar: _classicalWork
...
@property (copy, nonatomic) NSString *durationStringLocalizationKey; // ivar: _durationStringLocalizationKey
...
@property (nonatomic) BOOL hasITunesStoreAlbumArtistIdentifier; // ivar: _hasITunesStoreAlbumArtistIdentifier
...
@property (nonatomic) BOOL hasLyricsAdamID; // ivar: _hasLyricsAdamID
...
@property (nonatomic) BOOL hasReportingAdamID; // ivar: _hasReportingAdamID
...
@property (nonatomic) NSInteger iTunesStoreAlbumArtistIdentifier; // ivar: _iTunesStoreAlbumArtistIdentifier
...
@property (copy, nonatomic) NSString *participantIdentifier; // ivar: _participantIdentifier
@property (copy, nonatomic) NSString *participantName; // ivar: _participantName
