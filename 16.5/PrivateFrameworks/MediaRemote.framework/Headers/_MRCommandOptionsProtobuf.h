...
@property (nonatomic) BOOL prepareForSetQueueIsProactive; // ivar: _prepareForSetQueueIsProactive
@property (retain, nonatomic) NSString *prepareForSetQueueProactiveReason; // ivar: _prepareForSetQueueProactiveReason
@property (nonatomic) int prepareForSetQueueProactiveReasonType; // ivar: _prepareForSetQueueProactiveReasonType
...
-(id)prepareForSetQueueProactiveReasonTypeAsString:(int)arg0 ;
...
-(int)StringAsPrepareForSetQueueProactiveReasonType:(id)arg0 ;
