...
@class HKOnboardingBaseViewController, NSNumber, HKAnalyticsEventSubmissionManager, UILabel, NSLayoutConstraint, NSString, UIView, UIButton, NSArray;
...
@property (retain, nonatomic) HKAnalyticsEventSubmissionManager *analyticsEventSubmissionManager; // ivar: _analyticsEventSubmissionManager
...
-(void)_submitOnboardingUIErrorEventWithCountryCode:(id)arg0 onboardingEligibility:(id)arg1 ;
