...
#ifndef CIDVRGBCAPTURERESULT_H
#define CIDVRGBCAPTURERESULT_H
...
@interface CIDVRGBCaptureResult : NSObject
...
@property (retain, nonatomic) NSData *flags; // ivar: _flags
...
@property (retain, nonatomic) NSArray *luxValues; // ivar: _luxValues
