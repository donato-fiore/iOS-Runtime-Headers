...
@protocol CKXPCContainerScopedDaemonAPI, CKDContainerScopedUserIDProvider, NSObject, OS_dispatch_queue, CKDTestServer;
...
@property (retain, nonatomic) NSObject<CKDTestServer> *testServer; // ivar: _testServer
...
-(void)performDeclineSharesOperation:(id)arg0 clientOperationCallbackProxy:(id)arg1 withBlock:(id)arg2 ;
