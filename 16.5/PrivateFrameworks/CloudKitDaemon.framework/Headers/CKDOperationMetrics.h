...
@property NSUInteger bytesFulfilledLocally; // ivar: _bytesFulfilledLocally
@property NSUInteger bytesResumed; // ivar: _bytesResumed
...
@property NSUInteger perRecordKeysRolled; // ivar: _perRecordKeysRolled
...
@property NSUInteger shareKeysRolled; // ivar: _shareKeysRolled
...
@property BOOL walrusEnabled; // ivar: _walrusEnabled
@property NSUInteger zoneKeysRolled; // ivar: _zoneKeysRolled
@property NSUInteger zoneishKeysRolled; // ivar: _zoneishKeysRolled
