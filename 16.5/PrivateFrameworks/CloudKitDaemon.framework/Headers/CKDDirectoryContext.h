...
@property (readonly, nonatomic) NSURL *daemonDatabaseDirectory; // ivar: _daemonDatabaseDirectory
@property (readonly, nonatomic) NSString *dataSeparationHash; // ivar: _dataSeparationHash
