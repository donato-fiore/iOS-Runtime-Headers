...
@class NSData, NSString, NSDictionary, NSMutableDictionary, NSDate, NSError, NSURL, NSNumber, NSMutableArray, NSURLRequest, NSInputStream, NSArray, C2RequestOptions, NSHTTPURLResponse, NSMutableSet, CKTapToRadarRequest, CKSignpost, NSURLSession, NSURLSessionDataTask;
...
@property (retain) C2RequestOptions *requestOptions; // ivar: _requestOptions
...
-(id)_parseErrorDictionaryForJson:(id)arg0 ;
...
-(void)_fetchDeviceID;
-(void)_finalizeRequestOperations:(id)arg0 request:(id)arg1 ;
...
-(void)performRequest;
-(void)prepareRequestOperationsForRequest:(id)arg0 ;
