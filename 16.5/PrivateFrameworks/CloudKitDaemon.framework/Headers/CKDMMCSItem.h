...
-(id)_openInfo;
-(id)clonedFileURLInDestinationDirectory:(id)arg0 ;
-(id)description;
...
-(void)setupForGetChunkKeysWithPackageAsset:(id)arg0 sourceDatabaseScope:(NSInteger)arg1 sourceZoneID:(id)arg2 destinationDatabaseScope:(NSInteger)arg3 ;
