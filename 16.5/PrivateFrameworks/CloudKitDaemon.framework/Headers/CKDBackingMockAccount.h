...
@property (readonly, nonatomic) NSObject<CKDTestAccount> *testAccount; // ivar: _testAccount
@property (readonly, nonatomic) NSObject<CKDTestDevice> *testDevice; // ivar: _testDevice
