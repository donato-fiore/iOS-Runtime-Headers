...
@property (readonly, nonatomic) NSMutableDictionary *callbackBlocks; // ivar: _callbackBlocks
@property (readonly, nonatomic) NSMutableDictionary *callbackTimers; // ivar: _callbackTimers
...
@property (readonly, nonatomic) NSMutableDictionary *unitTestingPushTokens; // ivar: _unitTestingPushTokens
