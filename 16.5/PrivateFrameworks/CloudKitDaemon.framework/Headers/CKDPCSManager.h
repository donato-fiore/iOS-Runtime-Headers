...
-(BOOL)isRemindersZoneThatNeedsUpdate:(struct _OpaquePCSShareProtection *)arg0 ;
...
-(BOOL)zonePCSNeedsKeyRolled:(struct _OpaquePCSShareProtection *)arg0 isZoneishZone:(BOOL)arg1 bypassAllowlistedContainers:(BOOL)arg2 ;
-(BOOL)zonePCSNeedsUpdate:(struct _OpaquePCSShareProtection *)arg0 ;
-(NSInteger)keyrollingErrorCodeForPCSOfType:(NSUInteger)arg0 ;
...
-(id)keyRollForZoneWideShareRecordPCS:(id)arg0 sharedZonePCS:(id)arg1 sharePCS:(id)arg2 forOperation:(id)arg3 ;
-(id)keyRollForZoneWideShareWithZonePCS:(id)arg0 sharePCS:(id)arg1 forOperation:(id)arg2 ;
-(id)keyRollIfNeededForPerRecordPCS:(id)arg0 forOperation:(id)arg1 didRoll:(*BOOL)arg2 ;
...
-(id)rollIdentityForSharePCS:(struct _OpaquePCSShareProtection *)arg0 ofType:(NSUInteger)arg1 removeAllExistingPrivateKeys:(BOOL)arg2 error:(*id)arg3 ;
-(id)rollMasterKeyForRecordPCS:(struct _OpaquePCSShareProtection *)arg0 forOperation:(id)arg1 ;
-(id)rollMasterKeyForRecordPCS:(struct _OpaquePCSShareProtection *)arg0 isZoneishRecord:(BOOL)arg1 bypassAllowlistedContainers:(BOOL)arg2 forOperation:(id)arg3 ;
...
-(id)updateIdentityAndRollKeyForZonePCS:(struct _OpaquePCSShareProtection *)arg0 usingServiceIdentityWithType:(NSUInteger)arg1 forOperation:(id)arg2 ;
-(id)updateServiceIdentityOnZonePCS:(struct _OpaquePCSShareProtection *)arg0 ;
-(id)updateZoneIdentityForRecordPCS:(struct _OpaquePCSShareProtection *)arg0 usingZonePCS:(struct _OpaquePCSShareProtection *)arg1 isZoneishRecord:(BOOL)arg2 bypassAllowlistedContainers:(BOOL)arg3 ;
...
-(struct _OpaquePCSShareProtection *)_copyShareProtectionFromExportedData:(id)arg0 ofType:(NSUInteger)arg1 identities:(struct _PCSIdentitySetData *)arg2 error:(struct __CFError **)arg3 ;
...
-(void)_createPCSFromData:(id)arg0 ofType:(NSUInteger)arg1 usingPCSServiceType:(NSUInteger)arg2 tryDecryptingWithOtherServices:(BOOL)arg3 withSyncKeyRegistryRetry:(BOOL)arg4 lastModifiedDate:(id)arg5 completionHandler:(id)arg6 ;
-(void)_lockedBoundaryKeyDataWithCompletionHandler:(id)arg0 ;
-(void)_locked_checkIdentitiesForService:(NSUInteger)arg0 withSyncKeyRegistryRetry:(BOOL)arg1 keySyncAnalytics:(id)arg2 completionHandler:(id)arg3 ;
-(void)_locked_createPCSFromData:(id)arg0 ofType:(NSUInteger)arg1 usingPCSServiceType:(NSUInteger)arg2 tryDecryptingWithOtherServices:(BOOL)arg3 withSyncKeyRegistryRetry:(BOOL)arg4 lastModifiedDate:(id)arg5 keySyncAnalytics:(id)arg6 completionHandler:(id)arg7 ;
-(void)_locked_createZonePCSWithSyncKeyRegistryRetry:(BOOL)arg0 keySyncAnalytics:(id)arg1 completionHandler:(id)arg2 ;
-(void)_locked_decryptCurrentPerParticipantPCSDataOnSharePCS:(id)arg0 shareModificationDate:(id)arg1 completionHandler:(id)arg2 ;
-(void)_locked_decryptPCSDataOnSharePCS:(id)arg0 shareModificationDate:(id)arg1 withPublicSharingKey:(id)arg2 completionHandler:(id)arg3 ;
...
-(void)checkIdentitiesForService:(NSUInteger)arg0 withSyncKeyRegistryRetry:(BOOL)arg1 completionHandler:(id)arg2 ;
-(void)createIngestedPPPCSDataFromInvitationData:(id)arg0 shareModificationDate:(id)arg1 completionHandler:(id)arg2 ;
...
-(void)dealloc;
-(void)decryptPCSDataOnSharePCS:(id)arg0 shareModificationDate:(id)arg1 completionHandler:(id)arg2 ;
