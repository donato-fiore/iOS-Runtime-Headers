...
@property (readonly, weak, nonatomic) CKDContainer *container; // ivar: _container
@property (readonly, nonatomic) NSObject<OS_dispatch_queue> *synchronizeQueue; // ivar: _synchronizeQueue
