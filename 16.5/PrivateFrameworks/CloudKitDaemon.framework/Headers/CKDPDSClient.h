...
@property (readonly, nonatomic) PDSRegistrar *registrar; // ivar: _registrar
@property (readonly, nonatomic) NSMutableDictionary *registrationsByDSID; // ivar: _registrationsByDSID
