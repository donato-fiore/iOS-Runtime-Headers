...
-(void)getKeySyncEligibilityForService:(id)arg0 isManatee:(BOOL)arg1 account:(id)arg2 lastModifiedDate:(id)arg3 testOverrideProvider:(id)arg4 completionHandler:(id)arg5 ;
