...
@class UIViewController, PUReviewDataSource, PUReviewAssetsDataSourceManager, PUReviewAssetsMediaProvider, UIColor, PXAssetsScene, PXScrollViewController, PXBasicUIViewTileAnimator, NSMutableSet, PXTilingController, PUAssetExplorerAnalytics, NSString, PUAssetExplorerReviewScreenViewController;
...
@property (retain, nonatomic) PUAssetExplorerAnalytics *assetExplorerAnalytics; // ivar: _assetExplorerAnalytics
