...
@property (nonatomic, getter=isAuthenticatedForExpandedModulePresentation) BOOL authenticatedForExpandedModulePresentation; // ivar: _authenticatedForExpandedModulePresentation
