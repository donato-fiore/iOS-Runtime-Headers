...
@protocol SBSImplementerInternal, NSXPCListenerDelegate, SBSImplementer, SBSCaptiveNetworkSupportImplementer, SBSHomePodControlsImplementer, SBSDebugInfoImplementer, SBSPowerMonitorImplementer, SBSProfilesImplementer, SBSProximityHandoffUIImplementer, SBSStereoLeaderRoleImplementer, SBSSysdiagnoseImplementer, SBSSystemImplementer;
...
-(void)handoffStartWithArtworkColorsInternal:(id)arg0 ;
...
-(void)setHomeUpdateStateInternal:(NSInteger)arg0 ;
