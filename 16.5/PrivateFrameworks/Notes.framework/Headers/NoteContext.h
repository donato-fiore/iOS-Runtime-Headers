...
@class NSManagedObjectContext, ICExclusiveLock, NSNumber, NSMutableDictionary, ICSelectorDelayer, ICManagedObjectContextUpdater, NSPersistentStoreCoordinator;
