...
@protocol CDMServiceObserver, OS_dispatch_queue, OS_os_transaction;
...
-(BOOL)handleOverridesAssetUpdateEvent:(id)arg0 ;
-(BOOL)handleXPCEvent:(id)arg0 fromStream:(id)arg1 withRegister:(id)arg2 ;
-(BOOL)isServiceNotReady:(id)arg0 withServiceStateMap:(id)arg1 ;
-(BOOL)promoteAssetsForServices:(id)arg0 withServiceState:(id)arg1 ;
-(BOOL)registerWithAssetsDelegate:(id)arg0 ;
-(BOOL)setAssetsProvisionalForServices:(id)arg0 ;
-(BOOL)shouldCDMAssetManagerReSetup;
-(id)extractEnabledServiceNames:(id)arg0 ;
-(id)extractEnabledServices:(id)arg0 ;
-(id)getAssetPaths;
...
-(void)initWithConfig:(id)arg0 ;
-(void)logAssetsInformation;
-(void)mergeConfig:(id)arg0 ;
-(void)setupAssetsForServices:(id)arg0 withError:(*id)arg1 ;
-(void)setupAssetsForServices:(id)arg0 withError:(*id)arg1 andSelfMetadata:(id)arg2 ;
-(void)setupCDMAssetManagerWithError:(*id)arg0 ;
-(void)setupEmbeddingConfigsWithError:(*id)arg0 ;
