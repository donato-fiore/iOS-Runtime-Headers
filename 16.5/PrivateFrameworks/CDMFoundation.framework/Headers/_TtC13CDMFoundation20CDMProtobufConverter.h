...
+(id)serializeSSURequestWithRequest:(id)arg0 formatType:(id)arg1 ;
+(id)serializeSSUResponseWithResponse:(id)arg0 formatType:(id)arg1 ;
...
+(id)serializeUaaPParserRequestWithRequest:(id)arg0 formatType:(id)arg1 ;
+(id)serializeUaaPParserResponseWithResponse:(id)arg0 formatType:(id)arg1 ;
