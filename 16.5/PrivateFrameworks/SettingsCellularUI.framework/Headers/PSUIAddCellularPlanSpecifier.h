...
@class PSSpecifier, CTCellularPlanManager, UIActivityIndicatorView, NSString, UIViewController, TSSIMSetupFlow, PSListController;
...
@property (weak) UIViewController *firstViewController; // ivar: _firstViewController
...
@property BOOL isEmbeddedInCarrierList; // ivar: _isEmbeddedInCarrierList
@property BOOL isRequestingFirstViewController; // ivar: _isRequestingFirstViewController
