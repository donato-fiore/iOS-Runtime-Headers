...
+(id)_badgeImagesForPresentationOptions:(NSUInteger)arg0 iconOrder:(*NSUInteger)arg1 orderingLength:(NSUInteger)arg2 tintColor:(id)arg3 large:(BOOL)arg4 variant:(int)arg5 selected:(BOOL)arg6 ;
...
-(void)updateDisplayForInvalidAddressForSelectedState:(BOOL)arg0 ;
