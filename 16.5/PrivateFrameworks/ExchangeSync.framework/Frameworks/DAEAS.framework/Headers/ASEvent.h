...
@protocol NSSecureCoding, ESDataElement;
...
-(BOOL)fillOutMissingExternalIdsForAccountID:(id)arg0 ;
-(BOOL)isEqualToEvent:(id)arg0 ;
-(BOOL)loadCalRecordForAccount:(id)arg0 ;
-(BOOL)loadLocalItemWithAccount:(id)arg0 ;
-(BOOL)purgeAttendeesPendingDeletionForAccountID:(id)arg0 ;
...
-(BOOL)verifyExternalIdsForAccountID:(id)arg0 ;
-(NSInteger)dataclass;
...
-(id)uidGeneratedIfNecessaryWithLocalEvent:(*void)arg0 forAccount:(id)arg1 ;
...
-(void)_loadAttachmentsChangesForEvent:(*void)arg0 account:(id)arg1 ;
...
-(void)updateAttachmentsForAccountID:(id)arg0 ;
