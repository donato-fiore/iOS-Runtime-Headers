...
+(NSUInteger)charIndexForPointWithPinning:(struct CGPoint )arg0 isTail:(BOOL)arg1 selectionType:(NSInteger)arg2 inLayoutTarget:(id)arg3 ;
...
+(id)pathForHighlightWithRange:(struct _NSRange )arg0 columnArray:(id)arg1 pathStyle:(NSUInteger)arg2 ;
...
-(BOOL)hasPartitionedAttachmentContinuationAt:(int)arg0 ;
...
-(id)pMutableRectsForSelectionRanges:(id)arg0 selectionType:(NSInteger)arg1 includeSpaceAfter:(BOOL)arg2 includeSpaceBefore:(BOOL)arg3 includeLeading:(BOOL)arg4 forParagraphMode:(BOOL)arg5 includeRuby:(BOOL)arg6 includePaginatedAttachments:(BOOL)arg7 outranges:(*id)arg8 ;
...
-(id)rectsForSelectionRange:(struct _NSRange )arg0 selectionType:(NSInteger)arg1 forParagraphMode:(BOOL)arg2 includeRuby:(BOOL)arg3 includePaginatedAttachments:(BOOL)arg4 ;
-(id)rectsForSelectionRanges:(id)arg0 selectionType:(NSInteger)arg1 ;
...
-(struct CGRect )boundsIncludingDropCapRectsForSelectionType:(NSInteger)arg0 ;
