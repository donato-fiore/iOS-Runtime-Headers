...
-(NSInteger)setCell:(id)arg0 atIndex:(unsigned short)arg1 ;
...
-(struct TSTCellStorage *)p_preBNCStorageRefAtIndex:(unsigned short)arg0 ;
...
-(void)_insertCell:(id)arg0 atIndex:(unsigned short)arg1 ;
-(void)_removeCellAtIndex:(unsigned short)arg0 ;
-(void)_replaceCellAtIndex:(unsigned short)arg0 withCell:(id)arg1 ;
