...
@interface TSCECellDirtier : NSObject {
    ...
    unordered_map<TSCEInternalCellReference, std::vector<TSCEInternalCellReference>, std::hash<TSCEInternalCellReference>, std::equal_to<TSCEInternalCellReference>, std::allocator<std::pair<const TSCEInternalCellReference, std::vector<TSCEInternalCellReference>>>> _dependentsToDirtyByFromRef;
}
