...
@property (nonatomic) BOOL cachedAllAnnotations; // ivar: _cachedAllAnnotations
...
@property (readonly, nonatomic) TSTTableModel *pivotDataModel; // ivar: _pivotDataModel
@property (readonly, nonatomic) NSUInteger pivotDataModelSizeClass;
...
@property (readonly, nonatomic) NSUInteger pivotSizeClass;
...
-(id)applyConcurrentCellMapToBaseTable:(id)arg0 options:(NSUInteger)arg1 requestInverseMap:(BOOL)arg2 requestPruneMap:(BOOL)arg3 stylesContainer:(id)arg4 migrationHelper:(id)arg5 ;
...
-(id)commentHostingAtCellID:(struct TSUCellCoord )arg0 forCommentStorage:(id)arg1 updateCommentMaps:(BOOL)arg2 ;
-(id)compatibilityCheckerForData:(id)arg0 associatedHint:(id)arg1 ;
-(id)concurrentCellMapForRegion:(id)arg0 suppressMergeContent:(BOOL)arg1 gatherCellBorders:(BOOL)arg2 ;
...
-(id)performActionReturningInverse:(id)arg0 formulaReplacer:(id)arg1 ;
-(id)pivotDataLocalizedColumnNameAtDataColumnIndex:(struct TSUModelColumnIndex )arg0 ;
...
-(void)defaultStyleHandlesForCellID:(struct TSUCellCoord )arg0 useSoftDefault:(BOOL)arg1 styleDefaultsCache:(id)arg2 outCellStyleHandle:(*id)arg3 outTextStyleHandle:(*id)arg4 ;
...
-(void)getTextPropertiesWithCell:(id)arg0 cellID:(struct TSUCellCoord )arg1 wraps:(*BOOL)arg2 alignment:(*NSInteger)arg3 verticalAlignment:(*int)arg4 padding:(*id)arg5 ;
...
-(void)modifiedTextPropertiesForCategoryOrPivotCellAtCellID:(struct TSUCellCoord )arg0 wraps:(*BOOL)arg1 padding:(*id)arg2 alignment:(*NSInteger)arg3 ;
