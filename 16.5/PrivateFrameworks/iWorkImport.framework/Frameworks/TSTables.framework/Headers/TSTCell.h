...
@class TSWPParagraphStyle, NSString, TSKFormat, TSDFill, TSDCommentStorage, NSDate, TSWPStorage, TSULocale;
@protocol NSCopying;
...
@property (readonly, nonatomic) TSUDecimal _rawValueForDecimalCoercion;
...
@property (readonly, nonatomic) TSTCellStyleHandle *cellStyleHandle; // ivar: _cellStyleHandle
...
@property (nonatomic) TSULocale *locale; // ivar: _locale
...
@property (readonly, nonatomic) TSTTextStyleHandle *textStyleHandle; // ivar: _textStyleHandle
...
+(unsigned char)cellFormatKindForValueType:(unsigned char)arg0 ;
-(BOOL)_coerceEmptyCellToFormat:(unsigned int)arg0 ;
-(BOOL)_coerceTextCellToBestNumberFormatUsingLimitedParsing:(BOOL)arg0 allowFractions:(BOOL)arg1 ;
...
-(BOOL)_coerceToCustomNumberishFormat:(unsigned int)arg0 ;
...
-(BOOL)_coerceToNumberFormatWithSeparatorFixing:(unsigned int)arg0 ;
-(BOOL)_coerceToPercentageFormat;
-(BOOL)_coerceToRatingFormat;
-(BOOL)_coerceToScientificFormat;
-(BOOL)_coerceToTextFormat;
-(BOOL)_parseFormulaFromString:(id)arg0 tableInfo:(id)arg1 cellID:(struct TSUCellCoord )arg2 ;
...
-(BOOL)coerceToFormatType:(unsigned int)arg0 usingSpares:(BOOL)arg1 ;
...
-(BOOL)removeCustomFormatsWithIDs:(id)arg0 ;
...
-(id)p_formatOfCellFormatKind:(unsigned char)arg0 create:(BOOL)arg1 returnFormat:(BOOL)arg2 outCreated:(*BOOL)arg3 ;
...
-(void)inflateFromStorageRef:(struct TSTCellStorage *)arg0 dataStore:(id)arg1 cache:(id)arg2 ;
-(void)inflateFromStorageRef:(struct TSTCellStorage *)arg0 dataStore:(id)arg1 cache:(id)arg2 suppressingTransmutation:(BOOL)arg3 ;
...
-(void)parseContentFromString:(id)arg0 flags:(NSUInteger)arg1 ;
-(void)parseContentOrFormulaFromString:(id)arg0 tableInfo:(id)arg1 cellID:(struct TSUCellCoord )arg2 flags:(NSUInteger)arg3 ;
