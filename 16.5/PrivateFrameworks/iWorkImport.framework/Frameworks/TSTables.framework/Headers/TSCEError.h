...
+(void)raiseInvalidDecimalNumberErrorForArgument:(int)arg0 argIndex2:(int)arg1 argIndex3:(int)arg2 functionName:(id)arg3 ;
+(void)raiseInvalidDecimalNumberErrorForArgument:(int)arg0 argIndex2:(int)arg1 functionName:(id)arg2 ;
+(void)raiseInvalidDecimalNumberErrorForArgument:(int)arg0 functionName:(id)arg1 ;
