...
@property (readonly) BOOL containsColons;
...
-(id)copyByMakingAllCategoryRefsIndirect:(struct TSCEFormulaRewriteContext *)arg0 ;
...
-(id)copyByRemappingHostCellAgnosticOwnerUIDs:(*void)arg0 rewriteContext:(struct TSCEFormulaRewriteContext *)arg1 outError:(*BOOL)arg2 ;
-(id)copyByRemappingOwnerUIDs:(*void)arg0 rewriteContext:(struct TSCEFormulaRewriteContext *)arg1 outBadRefFound:(*BOOL)arg2 ;
...
-(id)copyByRepairingBadReferences:(struct TSCEFormulaRewriteContext *)arg0 clearUidHistory:(BOOL)arg1 ;
