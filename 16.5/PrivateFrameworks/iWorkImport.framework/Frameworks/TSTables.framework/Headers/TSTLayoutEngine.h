...
@class TSDFill, NSMutableArray, TSKChangeNotifier, NSMutableSet, NSString, TSWPColumnStyle, TSUColor, TSDInfoGeometry, NSCountedSet, TSDLayoutGeometry, NSPointerArray, NSIndexSet, TSUWidthLimitedQueue, NSMutableDictionary;
...
@interface TSTLayoutEngine : NSObject <TSTTableHiddenRowColumnProviding, TSTTableInternalGeometryProviding, TSTTableMergeRangeProviding>
 ...
 {
    vector<TSTStrokeLayerStack *, std::allocator<TSTStrokeLayerStack *>> _topRowStrokes;
    vector<TSTStrokeLayerStack *, std::allocator<TSTStrokeLayerStack *>> _bottomRowStrokes;
    vector<TSTStrokeLayerStack *, std::allocator<TSTStrokeLayerStack *>> _leftColumnStrokes;
    vector<TSTStrokeLayerStack *, std::allocator<TSTStrokeLayerStack *>> _rightColumnStrokes;
    vector<double, std::allocator<double>> _tableDefaultFontHeightForArea;
...
@property (retain, nonatomic) TSTTextStyleToFontHeightCache *paraStyleToHeightCache; // ivar: _paraStyleToHeightCache
...
-(id)p_strokesForValidationOfGridRow:(unsigned int)arg0 isTop:(BOOL)arg1 ;
...
-(void)p_validateStrokeWidthCachesForGridColumn:(unsigned int)arg0 ;
-(void)p_validateStrokeWidthCachesForGridRow:(unsigned int)arg0 ;
...
-(void)queueCellForValidation:(struct TSUCellRect )arg0 cell:(id)arg1 textStyleHandle:(id)arg2 modelMergeRange:(struct TSUCellRect )arg3 wrap:(BOOL)arg4 verticalAlignment:(int)arg5 padding:(id)arg6 prop:(BOOL)arg7 layoutCacheFlags:(int)arg8 validationBundle:(id)arg9 layoutTask:(id)arg10 ;
...
-(void)validateFittingInfoForCell:(id)arg0 cellID:(struct TSUCellCoord )arg1 mergeRange:(struct TSUCellRect )arg2 setFitting:(BOOL)arg3 layoutTask:(id)arg4 widthHeightCollection:(id)arg5 validationBundle:(id)arg6 styleDefaultsCache:(id)arg7 ;
