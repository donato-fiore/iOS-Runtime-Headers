...
-(id)p_growReturningInverseForAction:(id)arg0 formulaReplacer:(id)arg1 ;
-(id)p_shrinkMergesAtIndexes:(id)arg0 intersectedByBaseRegion:(id)arg1 formulaReplacer:(id)arg2 ;
-(id)p_shrinkReturningInverseForAction:(id)arg0 formulaReplacer:(id)arg1 ;
...
-(id)shrinkReturningInverseForBaseCellRegion:(id)arg0 formulaReplacer:(id)arg1 ;
