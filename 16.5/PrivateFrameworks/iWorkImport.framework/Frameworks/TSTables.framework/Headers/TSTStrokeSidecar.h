...
-(id)unretainedStrokeLayerForBottomOfRow:(unsigned int)arg0 ;
-(id)unretainedStrokeLayerForLeftSideOfColumn:(unsigned short)arg0 ;
-(id)unretainedStrokeLayerForRightSideOfColumn:(unsigned short)arg0 ;
-(id)unretainedStrokeLayerForTopOfRow:(unsigned int)arg0 ;
-(struct TSUCellRect )p_strokeRect;
-(struct vector<TSTCellBorder *, std::allocator<TSTCellBorder *>> )accumulateCellBordersConcurrentlyInRow:(struct TSUModelRowIndex )arg0 atColumns:(*void)arg1 ;
