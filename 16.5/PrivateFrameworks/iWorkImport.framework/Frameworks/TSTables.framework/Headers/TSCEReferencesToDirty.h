...
@interface TSCEReferencesToDirty : TSPObject {
    ...
    TSCEInternalCellRefSet _toUpdateDirtyPrecedentCountCellRefs;
...
-(void)_flushUpdatePrecedentsCellRefSetWithDepTracker:(*void)arg0 startTime:(id)arg1 timeout:(CGFloat)arg2 ;
...
-(void)dirtyInternalCellRefsVector:(*void)arg0 ;
...
-(void)updatePrecedentCountForCellRef:(struct TSCEInternalCellReference *)arg0 ;
-(void)willClose;
