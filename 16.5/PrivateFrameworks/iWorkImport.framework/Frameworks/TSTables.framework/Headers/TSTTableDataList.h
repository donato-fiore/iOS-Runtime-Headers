...
@property (readonly, nonatomic) BOOL mightHaveCustomFormats; // ivar: _mightHaveCustomFormats
...
-(id)stringForKey:(unsigned int)arg0 outShouldWrap:(*BOOL)arg1 outIsShared:(*BOOL)arg2 ;
...
-(void)enumerateLegacyCustomFormatsUsingBlock:(id)arg0 ;
-(void)loadFromUnarchiver:(id)arg0 ;
-(void)p_addInitialSegment;
-(void)p_clearReverseMapForObject:(id)arg0 atKey:(unsigned int)arg1 ;
-(void)p_replaceCustomFormatsWithBlock:(id)arg0 ;
...
-(void)replaceFormatsUsingBlock:(id)arg0 ;
-(void)replaceFormulaErrorsUsingBlock:(id)arg0 ;
-(void)replaceFormulasUsingBlock:(id)arg0 ;
-(void)replaceRichTextUsingBlock:(id)arg0 ;
