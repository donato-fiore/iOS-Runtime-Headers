...
-(id)copyByRemappingHostCellAgnosticOwnerUIDsWithMap:(*void)arg0 rewriteContext:(struct TSCEFormulaRewriteContext *)arg1 error:(*BOOL)arg2 ;
-(id)copyByRemappingOwnerUIDsWithMap:(*void)arg0 rewriteContext:(struct TSCEFormulaRewriteContext *)arg1 error:(*BOOL)arg2 ;
...
-(void)remapOwnerUIDsWithMap:(*void)arg0 rewriteContext:(struct TSCEFormulaRewriteContext *)arg1 error:(*BOOL)arg2 ;
