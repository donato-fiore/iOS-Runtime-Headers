...
-(id)commentHostingAtCellID:(struct TSUViewCellCoord )arg0 forCommentStorage:(id)arg1 updateCommentMaps:(BOOL)arg2 ;
...
-(void)p_defaultStyleHandlesOfSummaryOrLabelRowAtLevel:(unsigned char)arg0 isLabel:(BOOL)arg1 styleDefaultsCache:(id)arg2 outCellStyleHandle:(*id)arg3 outTextStyleHandle:(*id)arg4 ;
-(void)p_defaultStylesOfSummaryOrLabelRowAtLevel:(unsigned char)arg0 isLabel:(BOOL)arg1 outCellStyle:(*id)arg2 outTextStyle:(*id)arg3 ;
