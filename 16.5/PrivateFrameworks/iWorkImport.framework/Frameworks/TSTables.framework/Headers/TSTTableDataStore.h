...
@class TSPContainedObject, TSPLazyReference;
...
@property (nonatomic) BOOL lazyReferencesAreLoaded; // ivar: _lazyReferencesAreLoaded
...
-(NSUInteger)defaultStyleHandlesOfColumnAtIndex:(unsigned short)arg0 outCellStyleHandle:(*id)arg1 outTextStyleHandle:(*id)arg2 ;
-(NSUInteger)defaultStyleHandlesOfRowAtIndex:(unsigned int)arg0 outCellStyleHandle:(*id)arg1 outTextStyleHandle:(*id)arg2 ;
...
-(id)_loadDatalist:(*id)arg0 forLazyReference:(id)arg1 completionBlock:(id)arg2 ;
-(id)addPasteboardCustomFormatsToDocumentAndTableReturningBadIDs;
-(id)allRichTextStorages;
-(id)cellMapForRepairingPasteboardCustomFormats:(id)arg0 ;
...
-(id)i_cellStyleHandleForDataListKey:(unsigned int)arg0 ;
-(id)i_formatForDataListKey:(unsigned int)arg0 ;
-(id)i_rowInfoAtIndex:(unsigned int)arg0 ;
-(id)i_stringForDataListKey:(unsigned int)arg0 outShouldWrap:(*BOOL)arg1 outIsShared:(*BOOL)arg2 ;
-(id)i_textStyleHandleForDataListKey:(unsigned int)arg0 ;
...
-(id)metadataForColumnIndex:(unsigned short)arg0 hidingAction:(unsigned char)arg1 uuid:(struct TSKUIDStruct )arg2 ;
...
-(void)adoptStylesheet:(id)arg0 withMapper:(id)arg1 ownerUID:(struct TSKUIDStruct *)arg2 conditionalStyleOwner:(id)arg3 ;
...
-(void)enumerateCellStoragesRowByRowToMaxID:(struct TSUCellCoord )arg0 withBlock:(id)arg1 ;
...
-(void)p_enumerateCellStoragesRowByRowToMaxID:(struct TSUCellCoord )arg0 getPreBNC:(BOOL)arg1 withBlock:(id)arg2 ;
...
-(void)replaceCommentStoragesUsingBlock:(id)arg0 ;
