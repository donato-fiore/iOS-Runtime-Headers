...
@property (nonatomic) CGFloat activityOrAnnotationWidth; // ivar: _activityOrAnnotationWidth
...
@property (nonatomic) BOOL showsActivityStream; // ivar: _showsActivityStream
...
@property (nonatomic) CGFloat tocOrPageNavWidth; // ivar: _tocOrPageNavWidth
