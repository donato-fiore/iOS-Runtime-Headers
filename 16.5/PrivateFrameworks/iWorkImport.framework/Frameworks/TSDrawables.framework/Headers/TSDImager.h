...
@property (nonatomic) BOOL prefersThumbnailImagesToRender; // ivar: mPrefersThumbnailImagesToRender
...
@property (nonatomic) BOOL verticalTextAllowed; // ivar: mVerticalTextAllowed
...
-(BOOL)prefersThumbnailImagesToRenderForCanvas:(id)arg0 ;
