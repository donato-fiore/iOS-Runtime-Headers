...
@property (nonatomic) int childRepByGlyphStyle; // ivar: _childRepByGlyphStyle
...
@property (nonatomic) BOOL shouldAddVideoBackgroundFill; // ivar: _shouldAddVideoBackgroundFill
