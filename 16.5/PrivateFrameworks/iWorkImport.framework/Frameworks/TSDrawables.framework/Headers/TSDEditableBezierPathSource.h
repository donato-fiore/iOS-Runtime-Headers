...
-(struct CGPoint )p_calculateNewStartPointLocationFromOffsetDistance:(CGFloat)arg0 startPoint:(struct CGPoint )arg1 endPoint:(struct CGPoint )arg2 ;
...
-(void)cutAtSelectedNodesWithOffset:(BOOL)arg0 ;
