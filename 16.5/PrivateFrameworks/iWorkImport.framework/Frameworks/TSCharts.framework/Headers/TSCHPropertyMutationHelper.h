...
+(BOOL)anyPropertiesChanged:(id)arg0 forStyleOwner:(id)arg1 ;
+(BOOL)propertyChanged:(int)arg0 forStyleOwner:(id)arg1 newValue:(id)arg2 ;
...
+(id)transformedTuplesWithStyleOwner:(id)arg0 mutations:(id)arg1 ;
