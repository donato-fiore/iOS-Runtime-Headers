...
@property (nonatomic) NSUInteger maxSegmentCost; // ivar: _maxSegmentCost
...
-(BOOL)mergeSegmentIfNeededAtIndex:(NSUInteger)arg0 ;
-(BOOL)shouldBisectForCount:(NSUInteger)arg0 byteSize:(NSUInteger)arg1 cost:(NSUInteger)arg2 ;
-(NSUInteger)countByEnumeratingWithState:(struct ? *)arg0 objects:(*id)arg1 count:(NSUInteger)arg2 ;
-(NSUInteger)elementCount;
-(NSUInteger)estimatedByteSizeOfElementAtIndex:(NSUInteger)arg0 ;
...
-(void)p_removeObjectsFromSegmentAtSegmentIndex:(NSUInteger)arg0 atIndexes:(id)arg1 ;
-(void)push:(id)arg0 ;
