...
@property (readonly, nonatomic) BOOL activityStreamWasShown; // ivar: _activityStreamWasShown
...
@property (readonly, nonatomic, getter=isShowingActivityStream) BOOL showingActivityStream; // ivar: _showingActivityStream
