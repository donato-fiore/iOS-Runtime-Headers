...
@property (readonly, nonatomic) CGFloat bottomTextVerticalPosition;
@property (readonly, nonatomic) CGFloat bottomTextVerticalSpace;
...
-(BOOL)drawImageForSlideNode:(id)arg0 event:(NSUInteger)arg1 slideSize:(struct CGSize )arg2 intoRect:(struct CGRect )arg3 annotationFlagsScale:(CGFloat)arg4 context:(struct CGContext *)arg5 ;
-(BOOL)drawMonoPageExtraContentInContext:(struct CGContext *)arg0 scaledClipRect:(struct CGRect )arg1 ;
-(BOOL)drawMonoPageInContext:(struct CGContext *)arg0 viewScale:(CGFloat)arg1 unscaledClipRect:(struct CGRect )arg2 createPage:(BOOL)arg3 helper:(id)arg4 ;
...
-(struct CGRect )beginPageInContext:(struct CGContext *)arg0 viewScale:(CGFloat)arg1 unscaledClipRect:(struct CGRect )arg2 createPage:(BOOL)arg3 ;
-(struct CGRect )boundsRect;
-(struct CGRect )monoSlideRectFromScaledClipRect:(struct CGRect )arg0 outScaledClipRect:(struct CGRect *)arg1 ;
-(struct CGRect )rectBySubtractingDefaultPageMarginsFromRect:(struct CGRect )arg0 ;
-(struct CGRect )scaledClipRectForPageCount;
-(struct CGRect )scaledClipRectMinusBottomSpace:(struct CGRect )arg0 ;
...
-(void)endPageInContext:(struct CGContext *)arg0 createPage:(BOOL)arg1 ;
