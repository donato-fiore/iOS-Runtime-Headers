...
@class TSPObject, TSULocale, NSMutableArray, TSKActivityStream, TSKActivityStreamTransformationManager, NSDictionary, TSKChangeNotifier, NSString, TSKDocumentSupport, TSKPasteboardController;
...
@property (readonly, nonatomic) TSKActivityStream *activityStream; // ivar: _activityStream
@property (readonly, nonatomic) TSKActivityStreamTransformationManager *activityStreamTransformationManager; // ivar: _activityStreamTransformationManager
