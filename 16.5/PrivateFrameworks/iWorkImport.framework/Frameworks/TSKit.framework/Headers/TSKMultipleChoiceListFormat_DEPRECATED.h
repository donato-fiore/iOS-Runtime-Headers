...
@protocol NSCopying, NSObject><TSUMultipleChoiceListChoiceProviding;
...
@property (readonly, nonatomic) char initialValue; // ivar: _initialValue
@property (readonly, nonatomic) unsigned int multipleChoiceListFormatID; // ivar: _multipleChoiceListFormatID
@property (readonly, nonatomic) NSObject<NSObject><TSUMultipleChoiceListChoiceProviding> *popupModel; // ivar: _popupModel


-(BOOL)isEqual:(id)arg0 ;
-(NSUInteger)hash;
-(id)asMultipleChoiceListFormat;
-(id)initWithInitialValue:(char)arg0 multipleChoiceListFormatID:(unsigned int)arg1 popupModel:(id)arg2 ;
