...
@property (copy, nonatomic) NSString *personInPhoto; // ivar: _personInPhoto
@property (retain) NSString *photoLocalIdentifier; // ivar: _photoLocalIdentifier
@property (copy, nonatomic) NSString *photoSceneDescriptor; // ivar: _photoSceneDescriptor
...
-(id)initWithIdentifier:(id)arg0 cloudIdentifier:(id)arg1 photoLocalIdentifier:(id)arg2 type:(id)arg3 sizeInBytes:(id)arg4 creationDate:(id)arg5 contentURL:(id)arg6 contentText:(id)arg7 photoSceneDescriptor:(id)arg8 personInPhoto:(id)arg9 ;
