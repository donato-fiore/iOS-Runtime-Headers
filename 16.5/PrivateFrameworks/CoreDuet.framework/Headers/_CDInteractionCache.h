...
@class NSDate, NSCountedSet, NSArray, NSMutableOrderedSet, NSPredicate;
...
-(void)_countConversationIDsForInteraction:(id)arg0 deleted:(BOOL)arg1 ;
-(void)_deleteInteractions:(id)arg0 ;
-(void)_refetch;
-(void)debounceRefetch;
-(void)interactionsDeleted:(id)arg0 ;
