...
+(id)storeWithDirectory:(id)arg0 knowledgeStore:(id)arg1 readOnly:(BOOL)arg2 ;
...
-(NSUInteger)deleteInteractionsWithBundleId:(id)arg0 domainIdentifiers:(id)arg1 error:(*id)arg2 ;
...
-(id)initWithDirectory:(id)arg0 knowledgeStore:(id)arg1 readOnly:(BOOL)arg2 ;
-(id)interactionCountPerMechanism;
-(id)kMostRecentConversationsWithLimit:(NSUInteger)arg0 ;
...
-(void)anonymizeAttachmentsWithSalt:(id)arg0 ;
...
-(void)deleteInteractionsWithBundleId:(id)arg0 domainIdentifiers:(id)arg1 completionHandler:(id)arg2 ;
