...
@class NSMutableArray, NSMutableDictionary, _PASBloomFilterForWriting, BMIntentStream, NSString;
...
-(id)initWithInteractionRecorder:(id)arg0 knowledgeStore:(id)arg1 deletionManager:(id)arg2 ;
