...
-(BOOL)isStageManagerSwitcherVisibleWithServerInstance:(id)arg0 ;
...
-(id)displayIdentifierForSceneIdentifier:(id)arg0 serverInstance:(id)arg1 ;
...
-(id)jindoAppBundleIndentifiersWithServerInstance:(id)arg0 ;
