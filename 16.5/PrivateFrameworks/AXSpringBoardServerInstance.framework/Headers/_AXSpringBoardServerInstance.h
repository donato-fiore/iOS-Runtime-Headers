...
@class AXIPCServer, AXIPCClient, NSMutableArray, NSMapTable, RBSProcessMonitor, NSTimer, _AXAssertionServer, NSString, NSMutableDictionary;
@protocol NSObject, AXIDSServicesClient, FBSceneDelegate, OS_dispatch_queue, AXSpringBoardServerInstanceDelegate;
...
-(id)_handleDisplayIdentifierForSceneIdentifier:(id)arg0 ;
-(id)_handleFreezeClarityUILoadingScreen:(id)arg0 ;
-(id)_handleGetFocusedAppPID:(id)arg0 ;
-(id)_handleGetFocusedApps:(id)arg0 ;
-(id)_handleGetFocusedOccludedAppScenes:(id)arg0 ;
...
-(id)_handlePresentNearbyDeviceControlPicker:(id)arg0 ;
...
-(id)_jindoAppIdentifiers:(id)arg0 ;
...
-(id)_toggleDetectionMode:(id)arg0 ;
-(id)_toggleDock:(id)arg0 ;
-(id)_toggleHearingControl:(id)arg0 ;
-(id)_toggleLiveTranscription:(id)arg0 ;
...
-(void)_biomeDonationLargeTextDidChange:(id)arg0 ;
...
-(void)_rampUpCallVolumeFromVolume:(float)arg0 toVolume:(float)arg1 totalDuration:(float)arg2 progress:(float)arg3 ;
...
-(void)_setAVCallRoute:(id)arg0 rampUp:(BOOL)arg1 ;
-(void)_setCallRoute:(int)arg0 ifCurrentlyRoutedTo:(id)arg1 rampUp:(BOOL)arg2 ;
-(void)_setCallRoute:(int)arg0 ifCurrentlyRoutedTo:(id)arg1 withRoutes:(id)arg2 rampUp:(BOOL)arg3 ;
...
-(void)bluetoothPairingDidChange:(id)arg0 ;
-(void)dealloc;
