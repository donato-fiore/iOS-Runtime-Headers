...
@property (readonly, nonatomic) BOOL isKVSMetric; // ivar: _isKVSMetric
@property (readonly, nonatomic) NSUInteger keyTransparencyVersion; // ivar: _keyTransparencyVersion
@property (readonly, nonatomic) NSInteger kvsErrorCode; // ivar: _kvsErrorCode
@property (readonly, nonatomic) NSString *kvsErrorDomain; // ivar: _kvsErrorDomain
@property (readonly, nonatomic) BOOL kvsSuccess; // ivar: _kvsSuccess
@property (readonly, nonatomic) CGFloat kvsSyncTimeInterval; // ivar: _kvsSyncTimeInterval
@property (readonly, nonatomic) NSInteger kvsUnderlyingErrorCode; // ivar: _kvsUnderlyingErrorCode
@property (readonly, nonatomic) NSString *kvsUnderlyingErrorDomain; // ivar: _kvsUnderlyingErrorDomain
...
-(id)initWithKeyTransparencyVersion:(NSUInteger)arg0 kvsSuccess:(BOOL)arg1 kvsErrorDomain:(id)arg2 kvsErrorCode:(NSInteger)arg3 kvsSyncTimeInterval:(CGFloat)arg4 kvsUnderlyingErrorDomain:(id)arg5 kvsUnderlyingErrorCode:(NSInteger)arg6 ;
