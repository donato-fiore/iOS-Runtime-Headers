...
@class NSData, NSMapTable, NSMutableSet, NSRecursiveLock, APSConnection, NSString;
...
-(void)addListener:(id)arg0 wakingTopics:(id)arg1 opportunisticTopics:(id)arg2 nonWakingTopics:(id)arg3 commands:(id)arg4 queue:(id)arg5 ;
...
-(void)setWakingTopics:(id)arg0 opportunisticTopics:(id)arg1 nonWakingTopics:(id)arg2 forListener:(id)arg3 ;
