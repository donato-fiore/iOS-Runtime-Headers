...
@property (readonly, nonatomic) BOOL isUserDrivenRealTime; // ivar: _isUserDrivenRealTime
@property (readonly, nonatomic) unsigned short ktRegistrationDataIndex; // ivar: _ktRegistrationDataIndex
...
@property (retain, nonatomic) NSArray *queryLinkedServiceNames; // ivar: _queryLinkedServiceNames
