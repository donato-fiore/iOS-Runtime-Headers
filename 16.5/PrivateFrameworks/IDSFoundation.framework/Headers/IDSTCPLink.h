...
-(struct sockaddr *)connect:(int)arg0 localAddress:(struct sockaddr *)arg1 portRange:(unsigned short)arg2 remoteAddress:(struct sockaddr *)arg3 clientUUID:(unsigned char)arg4 completionHandler:(id)arg5 ;
-(void)dealloc;
-(void)invalidate;
