...
@protocol WKNavigationDelegate, WKUIDelegate, WKScriptMessageHandler, UIGestureRecognizerDelegate, UIScrollViewDelegate, SXViewportChangeListener, _WKFullscreenDelegate, SXComponentActionHandler, SXAnalyticsReporting, SXEmbedType, SXEmbedDataProvider, SXLayoutInvalidator, SXProxyAuthenticationHandler, SWReachabilityProvider, SXSceneStateMonitor;
...
@property (retain, nonatomic) SXWebContentLoadEvent *loadEvent; // ivar: _loadEvent
...
-(void)renderContents;
-(void)reportLoadEventWithError:(id)arg0 ;
