...
#ifndef SXSCALABLEIMAGECOMPONENTVIEWFACTORY_H
#define SXSCALABLEIMAGECOMPONENTVIEWFACTORY_H
...
-(id)initWithDOMObjectProvider:(id)arg0 viewport:(id)arg1 presentationDelegateProvider:(id)arg2 componentStyleRendererFactory:(id)arg3 analyticsReportingProvider:(id)arg4 appStateMonitor:(id)arg5 imageViewFactory:(id)arg6 canvasControllerFactory:(id)arg7 mediaSharingPolicyProvider:(id)arg8 ;
-(id)type;
-(int)role;
