...
@protocol SVVideoAdProviding, SXAnalyticsReporting, SVVideoAdViewControllerProviding, SVVideoMetadata, SXVisibilityMonitoring;
...
@property (readonly, nonatomic) NSObject<SVVideoAdViewControllerProviding> *fullscreenViewControllerProvider; // ivar: _fullscreenViewControllerProvider
