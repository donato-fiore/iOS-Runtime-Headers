...
@property (retain, nonatomic) NSObject<SXComponentViewEngine> *componentViewEngine; // ivar: _componentViewEngine
...
-(id)initWithViewport:(id)arg0 DOMObjectProvider:(id)arg1 ;
