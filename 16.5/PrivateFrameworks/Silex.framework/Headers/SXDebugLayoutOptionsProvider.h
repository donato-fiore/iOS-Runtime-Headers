...
@property (nonatomic) NSInteger subscriptionActivationEligibility; // ivar: _subscriptionActivationEligibility
...
-(NSInteger)overrideSubscriptionActivationEligibility:(NSInteger)arg0 ;
