...
@class NSMutableArray, NSString, NSInputStream, NSError, NSMutableDictionary, NSData;
...
-(id)_translatedLyrics:(id)arg0 forLanguage:(id)arg1 ;
...
-(void)_stripParenthesesFromBackgroundVocalWord:(id)arg0 backgroundVocalText:(id)arg1 ;
