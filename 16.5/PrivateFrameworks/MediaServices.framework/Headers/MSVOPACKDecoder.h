...
@class NSCoder, NSMutableArray, NSString, NSMapTable, NSArray, NSDictionary;
@protocol MSVSegmentedSubDecoder, MSVOPACKDecoderDelegate;
...
@property (readonly, nonatomic) NSMutableArray *allowedClassesStack; // ivar: _allowedClassesStack
@property (readonly, copy) NSString *debugDescription;
@property (weak, nonatomic) NSObject<MSVOPACKDecoderDelegate> *delegate; // ivar: _delegate
