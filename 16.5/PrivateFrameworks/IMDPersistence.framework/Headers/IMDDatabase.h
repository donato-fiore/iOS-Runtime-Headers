...
+(id)_newSyndicationRangeForCMMMessageItem:(id)arg0 syndicationIdentifier:(id)arg1 shouldHideFromSyndication:(BOOL)arg2 ;
+(id)sharedDatabase;
...
-(id)_chatGUIDsForChatsWithJunkMessagesOlderThanDate:(id)arg0 operation:(struct IMDSqlOperation *)arg1 ;
...
-(id)_mostRecentJunkMessageDateForChatWithGUID:(id)arg0 operation:(struct IMDSqlOperation *)arg1 ;
...
-(void)_permanentlyDeleteJunkMessagesBeforeDate:(id)arg0 ;
