...
@property (copy, nonatomic) id *accessoryDiscoveryFinishedCallback; // ivar: _accessoryDiscoveryFinishedCallback
...
-(void)startDiscoveryWithScanRate:(NSInteger)arg0 timeout:(CGFloat)arg1 completion:(id)arg2 ;
-(void)stop;
