...
@class NSSet, NSMutableDictionary, NSString, NSDate, NSDictionary, NSOperationQueue, FMQueueSynchronizer, FMXPCServiceDescription, FMXPCSession, FMTokenBucket;
...
@property (retain, nonatomic) SPBeaconManagerSimpleBeaconUpdateInterface *simpleBeaconUpdateInterface; // ivar: _simpleBeaconUpdateInterface
...
-(void)connectUsingMACAddress:(id)arg0 longTermKey:(id)arg1 completion:(id)arg2 ;
-(void)connectionExpiryTimerFired;
-(void)dealloc;
-(void)didDetectUnauthorizedTrackingWithCompletion:(id)arg0 completion:(id)arg1 ;
-(void)didObserveUnauthorizedTrackingWithCompletion:(id)arg0 completion:(id)arg1 ;
...
-(void)disconnectFromMACAddress:(id)arg0 completion:(id)arg1 ;
...
-(void)readRawAISMetadataFromBeaconIdentifier:(id)arg0 completion:(id)arg1 ;
-(void)readRawAISMetadataFromMACAddress:(id)arg0 useOwnerControlPoint:(BOOL)arg1 completion:(id)arg2 ;
...
-(void)standaloneBeaconsForUUIDs:(id)arg0 completion:(id)arg1 ;
...
// -(void)startUpdatingApplicationBeaconsWithContext:(id)arg0 collectionDifference:(id)arg1 completion:(unk)arg2  ;
...
-(void)stopUpdatingApplicationBeaconsWithCompletion:(id)arg0 ;
