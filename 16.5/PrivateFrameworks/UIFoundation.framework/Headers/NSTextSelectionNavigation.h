...
-(CGFloat)_anchorPositionOffsetForLocation:(id)arg0 textSelection:(id)arg1 affinity:(NSInteger)arg2 ;
...
-(id)_lineFragmentInfoForPoint:(struct CGPoint )arg0 inContainerAtLocation:(id)arg1 bounds:(struct CGRect )arg2 layoutOrientation:(NSInteger)arg3 beforeLineFragment:(*BOOL)arg4 afterLineFragment:(*BOOL)arg5 lineFragmentRange:(*id)arg6 ;
