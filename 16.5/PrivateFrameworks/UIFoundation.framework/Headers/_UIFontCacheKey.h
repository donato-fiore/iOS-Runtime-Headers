...
+(id)newSystemFontCacheKeyWithDesign:(id)arg0 weight:(CGFloat)arg1 width:(id)arg2 pointSize:(CGFloat)arg3 monospacedDigits:(BOOL)arg4 ;
+(id)newSystemFontCacheKeyWithTraits:(int)arg0 pointSize:(CGFloat)arg1 ;
+(id)newSystemFontCacheKeyWithTraits:(int)arg0 pointSize:(CGFloat)arg1 width:(id)arg2 ;
