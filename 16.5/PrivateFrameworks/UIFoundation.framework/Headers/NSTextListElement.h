...
@interface NSTextListElement : NSTextParagraph {
    ...
    NSInteger _contentsLocationOffset;
    BOOL _contentsOnly;
}


@property (readonly) NSInteger _contentsLocationOffset;
...
+(id)_createChildElementsFromAttributedString:(id)arg0 inRange:(struct _NSRange )arg1 indentLevel:(NSInteger)arg2 effectiveRange:(struct _NSRange *)arg3 textListElementInstantiationCallback:(id)arg4 ;
+(id)_createElementWithChildElements:(id)arg0 textList:(id)arg1 nestingLevel:(NSInteger)arg2 ;
+(id)_createTextListElementFromAttributedString:(id)arg0 inRange:(struct _NSRange )arg1 indentLevel:(NSInteger)arg2 effectiveRange:(struct _NSRange *)arg3 textListElementInstantiationCallback:(id)arg4 ;
...
-(void)dealloc;
-(void)setParagraphContentRange:(id)arg0 ;
