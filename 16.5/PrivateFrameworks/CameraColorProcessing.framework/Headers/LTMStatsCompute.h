...
@protocol LTMAlgorithmBase, MTLComputePipelineState;
...
-(int)computeInputParametersForImageWidth:(id)arg0 calcGlobalHistOnROI:(BOOL)arg1 with:(struct sRefDriverInputs *)arg2 to:(struct ? *)arg3 ;
