...
@property (readonly, nonatomic) NSUInteger stingButtonColor; // ivar: _stingButtonColor
...
+(id)stingMaterialDescription:(NSUInteger)arg0 ;
+(unsigned short)sizeFromInternalSize:(NSUInteger)arg0 ;
-(NSUInteger)fallbackMaterialForSize:(NSUInteger)arg0 ;
-(id)attributesDescription;
-(id)getGestaltDmin;
-(id)init;
-(id)resourceString:(id)arg0 forAttributes:(NSUInteger)arg1 ;
-(void)_populateMaterialDetailsWithDMinProperties:(id)arg0 ;
