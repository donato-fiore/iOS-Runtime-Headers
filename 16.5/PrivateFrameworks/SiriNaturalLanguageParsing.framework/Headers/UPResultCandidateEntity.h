...
@class NSNumber, NSString, SIRINLUEXTERNALUsoGraph;
...
@property (readonly) SIRINLUEXTERNALUsoGraph *sharedEntityGraph; // ivar: _sharedEntityGraph
@property (readonly) NSString *text; // ivar: _text


-(id)_indexedLabelRepresentation;
-(id)annotatedEntityFragmentString;
-(id)initWithRange:(struct _NSRange )arg0 label:(id)arg1 text:(id)arg2 groupId:(id)arg3 semanticValue:(id)arg4 sharedEntityGraph:(id)arg5 ;
