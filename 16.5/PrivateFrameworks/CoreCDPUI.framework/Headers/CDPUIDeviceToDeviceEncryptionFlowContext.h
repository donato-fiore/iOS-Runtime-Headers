...
@property (nonatomic) BOOL isDemoDevice; // ivar: _isDemoDevice
...
@property (nonatomic) BOOL shouldSuppressPasscodeCreationCancelPrompt; // ivar: _shouldSuppressPasscodeCreationCancelPrompt
