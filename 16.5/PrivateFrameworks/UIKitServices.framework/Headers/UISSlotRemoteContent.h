...
-(id)newTouchAuthenticationSpecificationWithAuthenticationMessageContext:(NSUInteger)arg0 backgroundStatisticsRegion:(struct ? )arg1 backgroundStatisticsForeground:(float)arg2 backgroundStatisticsPassingContrast:(float)arg3 backgroundStatisticsFailingContrast:(float)arg4 hitTestInformationMask:(NSUInteger)arg5 secureName:(unsigned int)arg6 ;
