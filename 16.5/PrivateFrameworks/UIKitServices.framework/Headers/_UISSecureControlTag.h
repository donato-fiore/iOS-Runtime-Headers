...
@property (readonly, nonatomic) NSUInteger imagePlacement; // ivar: _imagePlacement
...
-(id)initWithCategory:(id)arg0 cornerStyle:(NSInteger)arg1 cornerRadius:(CGFloat)arg2 baseForegroundColor:(struct CGColor *)arg3 baseBackgroundColor:(struct CGColor *)arg4 imagePlacement:(NSUInteger)arg5 size:(struct CGSize )arg6 ;
