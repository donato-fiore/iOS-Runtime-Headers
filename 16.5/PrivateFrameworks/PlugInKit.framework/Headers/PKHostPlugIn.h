...
@class NSDictionary, NSDate, NSURL, NSString, NSUserDefaults, NSUUID, NSBundle, NSArray, NSXPCConnection, Protocol, NSMutableSet;
...
@property (copy) NSString *sandboxProfile; // ivar: _sandboxProfile
...
-(id)initWithForm:(id)arg0 host:(id)arg1 ;
...
-(void)updateFromForm:(id)arg0 host:(id)arg1 ;
