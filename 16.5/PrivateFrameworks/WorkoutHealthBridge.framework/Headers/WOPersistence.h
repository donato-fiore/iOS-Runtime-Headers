...
@class NSString, NSDictionary, NSDate, NSData, NSUUID;
...
@property (copy, nonatomic) NSDate *objectModificationDate; // ivar: _objectModificationDate
@property (nonatomic) NSUInteger objectState; // ivar: _objectState
...
-(id)initWithVersion:(NSInteger)arg0 type:(NSUInteger)arg1 uuid:(id)arg2 persistedData:(id)arg3 objectState:(NSUInteger)arg4 objectModificationDate:(id)arg5 ;
