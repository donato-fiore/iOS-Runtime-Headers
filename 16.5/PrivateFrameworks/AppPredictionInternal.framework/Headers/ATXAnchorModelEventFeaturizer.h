...
-(id)featurizeAppLaunchEvents:(id)arg0 anchorOccurrenceDate:(id)arg1 ;
-(id)featurizeAppLaunchForActionEvent:(id)arg0 anchorOccurrenceDate:(id)arg1 ;
-(id)featurizeLinkActionEvent:(id)arg0 anchorOccurrenceDate:(id)arg1 ;
...
-(id)historyForAppLaunchDuetEvents:(id)arg0 anchorOccurrenceDate:(id)arg1 ;
-(id)historyForLinkActionChangeEvent:(id)arg0 anchorOccurrenceDate:(id)arg1 ;
...
-(id)numEventsForEventIds:(id)arg0 dateBuckets:(id)arg1 biomePublisher:(id)arg2 ;
