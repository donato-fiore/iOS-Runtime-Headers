...
-(CGFloat)maxRatioOfAppleAppsForFirstPageSorting;
-(CGFloat)minScoreForModeAffinityContactsWidgetSuggestions;
-(CGFloat)suggestedPagesModeAffinityAppDataSourceScoreThreshold;
-(id)init;
