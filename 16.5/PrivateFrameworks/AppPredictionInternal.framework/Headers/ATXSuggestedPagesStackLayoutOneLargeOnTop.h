...
#ifndef ATXSUGGESTEDPAGESSTACKLAYOUTONELARGEONTOP_H
#define ATXSUGGESTEDPAGESSTACKLAYOUTONELARGEONTOP_H
...
@interface ATXSuggestedPagesStackLayoutOneLargeOnTop : NSObject <ATXSuggestedPagesStackLayout>
