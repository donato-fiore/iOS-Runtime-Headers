...
-(void)approvedSiriKitIntentsWithReply:(id)arg0 ;
-(void)dealloc;
...
-(void)shouldPredictAppBundleId:(id)arg0 reply:(id)arg1 ;
-(void)shouldPredictBundleIdForShortcuts:(id)arg0 action:(id)arg1 forPrimaryShortcuts:(BOOL)arg2 reply:(id)arg3 ;
