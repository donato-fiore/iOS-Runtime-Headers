...
@property (readonly, nonatomic) ATXModeEntityStore *modeEntityStore; // ivar: _modeEntityStore
...
+(id)coalesceSessions:(id)arg0 modeEntityStore:(id)arg1 ;
...
-(NSUInteger)topMode;
-(id)_initFromStartTime:(CGFloat)arg0 endTime:(CGFloat)arg1 modeEntityStore:(id)arg2 appLaunches:(id)arg3 sessionAffinityVector:(id)arg4 ;
-(id)_weightForLaunch:(id)arg0 ;
-(id)initFromStartTime:(CGFloat)arg0 endTime:(CGFloat)arg1 modeEntityStore:(id)arg2 ;
