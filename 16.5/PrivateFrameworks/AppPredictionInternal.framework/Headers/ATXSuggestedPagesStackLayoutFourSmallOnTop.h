...
#ifndef ATXSUGGESTEDPAGESSTACKLAYOUTFOURSMALLONTOP_H
#define ATXSUGGESTEDPAGESSTACKLAYOUTFOURSMALLONTOP_H
...
@interface ATXSuggestedPagesStackLayoutFourSmallOnTop : NSObject <ATXSuggestedPagesStackLayout>
