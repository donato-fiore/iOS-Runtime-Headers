...
-(NSInteger)addFeaturizedLinkActionToDatabase:(id)arg0 featurizedAction:(id)arg1 actionOccurred:(BOOL)arg2 actionEngaged:(BOOL)arg3 anchorEvent:(id)arg4 anchor:(id)arg5 ;
...
-(NSInteger)addLinkActionEventsToDatabaseAfterAnchorEvent:(id)arg0 anchor:(id)arg1 ;
...
-(id)candidateIdSetFromLinkActionEvents:(id)arg0 ;
...
-(id)featurizeLinkActionEvent:(id)arg0 anchorOccurrenceDate:(id)arg1 eventFeaturizer:(id)arg2 ;
...
-(id)fetchNegativeLinkActionEventsAfterAnchorDate:(id)arg0 anchor:(id)arg1 positiveLinkActionEvents:(id)arg2 ;
...
-(id)fetchPositiveLinkActionEventsAfterAnchorDate:(id)arg0 durationOfAnchorEvent:(CGFloat)arg1 anchor:(id)arg2 ;
...
-(id)initWithXPCActivity:(id)arg0 dataStoreWrapper:(id)arg1 harvester:(id)arg2 ;
-(id)linkActionCandidateIdsToTargetForAnchor:(id)arg0 excludeCandidateIdsFromLinkActions:(id)arg1 ;
...
-(id)targetedNegativeLinkActionSamplesForAnchor:(id)arg0 anchorOccurrenceDate:(id)arg1 eventsToExclude:(id)arg2 ;
