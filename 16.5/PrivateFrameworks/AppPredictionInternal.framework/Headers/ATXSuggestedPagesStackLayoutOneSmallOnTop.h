...
#ifndef ATXSUGGESTEDPAGESSTACKLAYOUTONESMALLONTOP_H
#define ATXSUGGESTEDPAGESSTACKLAYOUTONESMALLONTOP_H
...
@interface ATXSuggestedPagesStackLayoutOneSmallOnTop : NSObject <ATXSuggestedPagesStackLayout>
