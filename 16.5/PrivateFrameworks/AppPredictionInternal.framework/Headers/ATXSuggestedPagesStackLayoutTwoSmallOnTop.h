...
#ifndef ATXSUGGESTEDPAGESSTACKLAYOUTTWOSMALLONTOP_H
#define ATXSUGGESTEDPAGESSTACKLAYOUTTWOSMALLONTOP_H
...
@interface ATXSuggestedPagesStackLayoutTwoSmallOnTop : NSObject <ATXSuggestedPagesStackLayout>
