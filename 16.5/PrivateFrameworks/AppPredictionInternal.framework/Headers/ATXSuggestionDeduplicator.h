...
-(BOOL)suggestionsAreDuplicateActionAndLinkAction:(id)arg0 otherSuggestion:(id)arg1 ;
-(BOOL)suggestionsAreDuplicateAppAndAction:(id)arg0 otherSuggestion:(id)arg1 ;
-(BOOL)suggestionsAreDuplicateAppAndLinkAction:(id)arg0 otherSuggestion:(id)arg1 ;
