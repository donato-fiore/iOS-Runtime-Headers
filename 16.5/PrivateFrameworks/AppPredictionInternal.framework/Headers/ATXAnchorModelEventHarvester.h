...
-(id)fetchAppLaunchEventsAfterAnchorOccurrenceDate:(id)arg0 limit:(NSUInteger)arg1 maxSecondsBeforeAnchor:(NSInteger)arg2 maxSecondsAfterAnchor:(NSInteger)arg3 isIncluded:(id)arg4 ;
