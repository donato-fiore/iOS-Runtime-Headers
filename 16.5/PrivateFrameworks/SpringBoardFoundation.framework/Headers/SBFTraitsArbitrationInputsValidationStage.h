...
@property (readonly, nonatomic) NSNumber *validatorOrder; // ivar: validatorOrder
...
-(void)addInputsValidator:(id)arg0 update:(BOOL)arg1 ;
-(void)dealloc;
-(void)removeInputsValidator:(id)arg0 ;
-(void)removeInputsValidator:(id)arg0 update:(BOOL)arg1 ;
