...
-(id)_initWithType:(NSUInteger)arg0 source:(NSInteger)arg1 passcode:(id)arg2 skipSEKeepUserDataOperation:(BOOL)arg3 handler:(id)arg4 ;
-(id)description;
...
-(id)initForPasscode:(id)arg0 source:(NSInteger)arg1 skipSEKeepUserDataOperation:(BOOL)arg2 handler:(id)arg3 ;
