...
-(id)initWithSecret:(id)arg0 context:(NSUInteger)arg1 as:(BOOL)arg2 altDSID:(id)arg3 pairingUUID:(id)arg4 piggybackingVersion:(NSUInteger)arg5 epoch:(NSUInteger)arg6 ;
-(void)dealloc;
