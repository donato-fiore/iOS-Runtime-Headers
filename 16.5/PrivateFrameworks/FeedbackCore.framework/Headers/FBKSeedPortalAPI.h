...
-(id)bugFormURLForID:(id)arg0 requestPlugIns:(id)arg1 appToken:(id)arg2 ;
...
-(id)createResponseURLForBugFormID:(id)arg0 appToken:(id)arg1 ;
...
// -(void)createFormResponseForBugForm:(id)arg0 inTeam:(id)arg1 appToken:(id)arg2 success:(id)arg3 error:(unk)arg4  ;
...
// -(void)fetchBugFormWithID:(id)arg0 forTeamID:(id)arg1 requestPlugIns:(id)arg2 appToken:(id)arg3 success:(id)arg4 error:(unk)arg5  ;
...
-(void)logOutServerSideWithCompletion:(id)arg0 ;
