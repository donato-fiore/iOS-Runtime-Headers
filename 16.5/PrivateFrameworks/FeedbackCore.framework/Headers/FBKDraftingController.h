...
-(void)_loadNewResponseForBugForm:(id)arg0 orBugFormStub:(id)arg1 withTeam:(id)arg2 requestPlugIns:(id)arg3 appToken:(id)arg4 ;
...
-(void)loadNewResponseForBugFormStub:(id)arg0 requestPlugIns:(id)arg1 appToken:(id)arg2 ;
