...
@class UITableViewController, UITableViewCell, NSString, UIBarButtonItem, NSPredicate, NSMutableDictionary, NSSet, NSDictionary, NSArray;
...
@property (retain, nonatomic) NSString *appToken; // ivar: _appToken
...
@property (retain, nonatomic) NSArray *requestedPlugIns; // ivar: _requestedPlugIns
