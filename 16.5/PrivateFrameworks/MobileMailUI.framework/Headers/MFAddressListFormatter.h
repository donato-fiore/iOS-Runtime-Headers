...
@property (retain, nonatomic) EFLazyCache *attributedAddressCache; // ivar: _attributedAddressCache
...
-(id)_attributedAddressCommentForAddressList:(id)arg0 ;
-(id)attributedStringFromEmailAddressList:(id)arg0 ;
-(id)init;
