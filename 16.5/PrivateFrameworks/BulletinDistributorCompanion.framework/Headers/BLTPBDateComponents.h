...
@property (nonatomic) int hour; // ivar: _hour
@property (nonatomic) int minute; // ivar: _minute
@property (nonatomic) int second; // ivar: _second
@property (nonatomic) int weekday; // ivar: _weekday
