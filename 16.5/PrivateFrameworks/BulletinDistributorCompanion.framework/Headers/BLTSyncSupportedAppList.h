...
@protocol LSApplicationWorkspaceObserverProtocol, OS_dispatch_queue, BLTSyncSupportedAppListDelegate;
...
@property (weak, nonatomic) NSObject<BLTSyncSupportedAppListDelegate> *delegate; // ivar: _delegate
