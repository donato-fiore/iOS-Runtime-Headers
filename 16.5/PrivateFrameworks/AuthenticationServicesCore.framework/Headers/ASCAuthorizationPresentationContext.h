...
@property (readonly, nonatomic) NSString *overrideNoCredentialsErrorMessage; // ivar: _overrideNoCredentialsErrorMessage
@property (readonly, nonatomic) NSString *overrideNoCredentialsErrorTitle; // ivar: _overrideNoCredentialsErrorTitle
...
@property (readonly, nonatomic) BOOL shouldAllowSecurityKeysFromCABLEView; // ivar: _shouldAllowSecurityKeysFromCABLEView
@property (readonly, nonatomic) BOOL shouldRequireCABLEAuthenticatorConsent; // ivar: _shouldRequireCABLEAuthenticatorConsent
@property (readonly, nonatomic) BOOL shouldUseFallbackPasskeyUI; // ivar: _shouldUseFallbackPasskeyUI
@property (readonly, copy, nonatomic) NSString *teamIdentifier; // ivar: _teamIdentifier
@property (readonly, nonatomic) BOOL useAlternativeSecurityKeysIcon; // ivar: _useAlternativeSecurityKeysIcon
@property (readonly, nonatomic) NSString *windowSceneIdentifier; // ivar: _windowSceneIdentifier
