...
@class ACMonitoredAccountStore, OTClique, NSString, WBSAutoFillQuirksManager;
...
-(BOOL)isClientEntitledForInternalTestingWithAuditToken:(struct ? )arg0 ;
-(BOOL)shouldUseFallbackUIForRelyingParty:(id)arg0 ;
-(id)init;
