...
@property (nonatomic) NSString *buildPrefix; // ivar: _buildPrefix
...
+(id)betaProgramWithID:(NSInteger)arg0 title:(id)arg1 program:(id)arg2 catalog:(id)arg3 assetUpdate:(id)arg4 assetBrain:(id)arg5 assetAudience:(id)arg6 legalDocs:(id)arg7 platform:(NSUInteger)arg8 buildPrefix:(id)arg9 ;
+(id)betaProgramWithJSON:(id)arg0 ;
+(id)nilIfNSNull:(id)arg0 ;
-(id)debugDescription;
-(id)description;
-(id)initWithCoder:(id)arg0 ;
-(id)initWithID:(NSInteger)arg0 title:(id)arg1 program:(id)arg2 catalog:(id)arg3 assetUpdate:(id)arg4 assetBrain:(id)arg5 assetAudience:(id)arg6 legalDocs:(id)arg7 platform:(NSUInteger)arg8 buildPrefix:(id)arg9 ;
