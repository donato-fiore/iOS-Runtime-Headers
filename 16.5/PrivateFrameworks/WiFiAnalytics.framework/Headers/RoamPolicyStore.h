...
+(id)bandFromChInfo:(id)arg0 ;
+(id)cleanChannelFlagsIn:(id)arg0 ;
+(id)convertChannelList:(id)arg0 log:(BOOL)arg1 For:(char *)arg2 ;
+(id)extractChannelList:(id)arg0 channelKeyPath:(id)arg1 channelFlagsKeyPath:(id)arg2 logFor:(char *)arg3 ;
+(id)makeChanInfoFromChannel:(NSInteger)arg0 andFlags:(NSInteger)arg1 ;
+(id)neighborChannelsAsArray:(id)arg0 log:(BOOL)arg1 For:(char *)arg2 ;
...
-(void)updateNeighborChannelsFromRoamTargetsChannels:(id)arg0 bssid:(id)arg1 ssid:(id)arg2 ;
-(void)updateNeighborChannelsInCoreDataWith:(id)arg0 bssid:(id)arg1 ssid:(id)arg2 ;
