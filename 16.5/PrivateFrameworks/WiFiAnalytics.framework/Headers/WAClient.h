...
// -(void)_getUsageStatsandReply:(id)arg0 queuedInvocation:(unk)arg1  ;
// -(void)_ingestMessage:(id)arg0 andReply:(id)arg1 queuedInvocation:(unk)arg2  ;
// -(void)_issueIOReportManagementCommand:(NSUInteger)arg0 andReply:(id)arg1 queuedInvocation:(unk)arg2  ;
