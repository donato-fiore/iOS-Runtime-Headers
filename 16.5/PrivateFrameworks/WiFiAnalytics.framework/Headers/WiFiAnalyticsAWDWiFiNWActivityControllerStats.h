...
@property (retain, nonatomic) WiFiAnalyticsAWDWiFiNWActivityOMI *omi; // ivar: _omi
...
@property (retain, nonatomic) WiFiAnalyticsAWDWiFiNWActivityRuUsage *ruUsage; // ivar: _ruUsage
