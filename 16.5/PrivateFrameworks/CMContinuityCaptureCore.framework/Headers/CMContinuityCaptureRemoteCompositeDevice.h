...
@class AVCaptureVideoPreviewLayer, NSMutableDictionary, NSUUID, AVCaptureDeviceInput, NSMutableArray, NSMutableSet, NSSet, AVCaptureSession, NSArray, NSString;
...
@property (readonly) CMContinuityCapturePongSoundManager *pongSoundManager; // ivar: _pongSoundManager
...
-(void)postStreamInterruptionForDevice:(id)arg0 ;
