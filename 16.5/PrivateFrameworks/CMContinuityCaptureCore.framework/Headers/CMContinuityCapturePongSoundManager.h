...
@class NSString;
@protocol CMContinuityCaptureProximityMonitorDelegate, OS_dispatch_source, OS_dispatch_semaphore;
...
@property (readonly, nonatomic) NSObject<OS_dispatch_semaphore> *audioPlayingResourceSemaphore; // ivar: _audioPlayingResourceSemaphore
