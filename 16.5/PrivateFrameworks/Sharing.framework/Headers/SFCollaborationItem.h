...
@property (retain, nonatomic) NSNumber *canAddPeople; // ivar: _canAddPeople
...
@property (nonatomic) BOOL isLoadingCanAddPeople; // ivar: _isLoadingCanAddPeople
...
@property (nonatomic) BOOL isLoadingSendCopyRepresentation; // ivar: _isLoadingSendCopyRepresentation
...
@property (retain, nonatomic) NSError *metadataLoadError; // ivar: _metadataLoadError
...
@property (retain, nonatomic) id *sendCopyRepresentation; // ivar: _sendCopyRepresentation
@property (copy, nonatomic) SFCollaborationShareOptions *shareOptions; // ivar: _shareOptions
@property (readonly) Class superclass;
@property (nonatomic) NSInteger type; // ivar: _type


+(id)collaborationItemForFileURL:(id)arg0 itemProvider:(id)arg1 activityItem:(id)arg2 defaultCollaboration:(BOOL)arg3 managedFileURL:(id)arg4 ;
...
-(void)_didLoadSendCopyRepresentation:(id)arg0 ;
