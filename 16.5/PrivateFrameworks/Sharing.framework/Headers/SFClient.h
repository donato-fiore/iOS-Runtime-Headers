...
@protocol SFXPCInterface, OS_dispatch_queue;
...
@property (copy, nonatomic) id *wristStateMonitorCompletionHandler; // ivar: _wristStateMonitorCompletionHandler
...
-(void)getPairedWatchWristStateWithCompletionHandler:(id)arg0 ;
-(void)getPeopleSuggestions:(id)arg0 completion:(id)arg1 ;
-(void)hashManagerControl:(id)arg0 completion:(id)arg1 ;
-(void)invalidate;
-(void)monitorPairedWatchWristStateWithCompletionHandler:(id)arg0 ;
-(void)openSetupURL:(id)arg0 completion:(id)arg1 ;
-(void)pairedWatchWristStateChanged:(NSInteger)arg0 ;
