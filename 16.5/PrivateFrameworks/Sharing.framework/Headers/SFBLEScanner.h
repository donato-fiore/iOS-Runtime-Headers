...
@property (copy, nonatomic) NSSet *useCases; // ivar: _useCases
...
-(id)_useCasesToString:(id)arg0 ;
-(id)initWithType:(NSInteger)arg0 ;
-(id)modelWithProductID:(unsigned short)arg0 ;
-(id)pairingParsePayload:(id)arg0 identifier:(id)arg1 bleDevice:(id)arg2 peerInfo:(id)arg3 ;
...
-(void)pairingParseAccessoryStatusPayloadPtr:(char *)arg0 end:(char *)arg1 fields:(id)arg2 ;
