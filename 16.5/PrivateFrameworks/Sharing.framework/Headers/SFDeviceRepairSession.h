...
@class NSString, TRSession, NSMutableArray, TROperationQueue, UIViewController;
...
@property (nonatomic) BOOL disableSilentAuth; // ivar: _disableSilentAuth
