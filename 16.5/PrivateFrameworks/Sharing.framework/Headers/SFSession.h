...
@class NSMutableData, NSMutableDictionary, CUMessageSessionServer, CUPairingSession, NSXPCConnection, NSString, NSUUID, CUMessageSession, CUAppleIDClient, NSDictionary, CUPairedPeer, SDStatusMonitor, NSXPCListenerEndpoint, TRSession;
