...
@property (nonatomic) unsigned char decryptedActivityLevel; // ivar: _decryptedActivityLevel
...
@property (nonatomic) NSUInteger proxPairingTicks; // ivar: _proxPairingTicks
