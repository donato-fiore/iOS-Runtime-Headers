...
@property (copy, nonatomic) SFAuthenticateAccountsServiceConfiguration *configuration; // ivar: _configuration
...
-(id)_configurationExistingAccountWithType:(unsigned int)arg0 ;
-(id)init;
...
-(void)_validateiCloudCredentialsWithRequest:(id)arg0 unvalidatedResponse:(id)arg1 completionHandler:(id)arg2 ;
-(void)activate;
-(void)invalidate;
