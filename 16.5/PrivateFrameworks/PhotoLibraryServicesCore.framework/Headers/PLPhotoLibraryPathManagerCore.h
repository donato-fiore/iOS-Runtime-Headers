...
@interface PLPhotoLibraryPathManagerCore : NSObject <PLPhotoLibraryPathManager>

 {
    ...
    NSUInteger _photoDirectoriesExists;
    NSUInteger _privateSubDirectoriesExists;
    NSUInteger _privateCacheSubDirectoriesExists;
    NSUInteger _externalDirectoriesExists;
    NSUInteger _internalDirectoriesExists;
...
@property (readonly) PLFileSystemCapabilities *capabilities; // ivar: _capabilities
...
-(BOOL)createDirectoryOnceWithPath:(id)arg0 mask:(unsigned char)arg1 pathType:(unsigned char)arg2 error:(*id)arg3 ;
...
-(BOOL)path:(id)arg0 isSubpathOfPhotoDirectoryWithType:(unsigned char)arg1 ;
-(BOOL)pathRelativeToBundle:(id)arg0 isSubpathOfPhotoDirectoryWithType:(unsigned char)arg1 ;
-(BOOL)shouldUseFileIdentifierForBundleScope:(unsigned short)arg0 ;
-(BOOL)updateExclusionAttributeWithPath:(id)arg0 mask:(unsigned char)arg1 pathType:(unsigned char)arg2 error:(*id)arg3 ;
...
-(id)privateCacheDirectoryWithSubType:(unsigned char)arg0 leafType:(unsigned char)arg1 additionalPathComponents:(id)arg2 ;
-(id)privateCacheDirectoryWithSubType:(unsigned char)arg0 leafType:(unsigned char)arg1 additionalPathComponents:(id)arg2 createIfNeeded:(BOOL)arg3 error:(*id)arg4 ;
