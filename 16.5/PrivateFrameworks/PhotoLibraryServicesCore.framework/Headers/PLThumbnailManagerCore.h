...
+(NSInteger)allocatedFileSizeOfThumbnailTablesWithPathManager:(id)arg0 ;
...
+(void)enumerateThumbnailTablesWithPathManager:(id)arg0 fileManager:(id)arg1 handler:(id)arg2 ;
...
+(void)removeThumbnailTablesUnsupportedOnly:(BOOL)arg0 withPathManager:(id)arg1 fileManagerDelegate:(id)arg2 ;
...
-(id)thumbManagerForFormatID:(unsigned short)arg0 thumbFileManagerClass:(Class)arg1 readOnly:(BOOL)arg2 ;
-(void)dealloc;
