...
@property (readonly, copy, nonatomic) NSArray *defaultSecondPlatterMetrics; // ivar: _defaultSecondPlatterMetrics
...
-(id)_defaultEnabledSecondPlatterMetricsForActivityType:(id)arg0 metricsVersion:(NSInteger)arg1 ;
...
-(id)removeUnsupportedFitnessJuniorMetricsFrom:(id)arg0 ;
