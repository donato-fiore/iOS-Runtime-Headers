...
@class HKQuantity, NSDictionary, NSUUID, NSString, FIWorkoutActivityType;
...
@property (readonly, nonatomic) NSUInteger auxiliaryTypeIdentifier;
...
@property (readonly, nonatomic) FIWorkoutActivityType *workoutActivityType; // ivar: _workoutActivityType
...
-(id)initWithWorkoutActivityType:(id)arg0 ;
-(id)localizedName;
