...
-(void)fetchBioBindingDetailsWithCompletion:(id)arg0 ;
-(void)fetchBiomeFedStatsUIWithCompletion:(id)arg0 ;
...
-(void)proofIdentity:(id)arg0 totalUploadAssetsFileSizeInBytes:(NSInteger)arg3 completion:(id)arg4 ;
-(void)proofIdentityUsing:(id)arg0 proofingOptions:(NSUInteger)arg1 completion:(id)arg2 ;
...
-(void)saveIdentityProofingBiomeDataSharingUserConsent:(BOOL)arg0 state:(id)arg1 proofingOptions:(NSUInteger)arg2 completion:(id)arg3 ;
...
-(void)triggerAssetsUploadWithProofingOptions:(NSUInteger)arg0 canUploadOnExpensiveNetwork:(BOOL)arg1 completion:(id)arg2 ;
-(void)uploadLivenessVideoWithLivenessVideoURL:(id)arg0 shouldScheduleUploads:(BOOL)arg1 withCompletion:(id)arg2 ;
