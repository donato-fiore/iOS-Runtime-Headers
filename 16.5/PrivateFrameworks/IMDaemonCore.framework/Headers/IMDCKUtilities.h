...
@class NSString, FTDeviceSupport, IMDefaults, IMLockdownManager, IDSServerBag, IMDSyncTelemetryReporter;
...
@property (retain, nonatomic) IMDSyncTelemetryReporter *telemetryReporter; // ivar: _telemetryReporter
...
-(BOOL)readServerBagBoolForKey:(id)arg0 defaultValue:(BOOL)arg1 ;
...
-(void)isFirstSyncWithActivity:(id)arg0 completion:(id)arg1 ;
-(void)keyRollPendingStateDidChange;
-(void)logCloudKitSyncToPowerLogForSyncType:(NSInteger)arg0 isCoreDuetSync:(BOOL)arg1 didCompleteChatSync:(BOOL)arg2 didSucceedSyncingChats:(BOOL)arg3 didCompleteMessageSync:(BOOL)arg4 didSucceedSyncingMessages:(BOOL)arg5 didCompleteAttachmentSync:(BOOL)arg6 didSucceedSyncingAttachments:(BOOL)arg7 didCompleteRecoverableMessageSync:(BOOL)arg8 didSucceedSyncingRecoverableMessageSync:(BOOL)arg9 syncAttemptCount:(NSUInteger)arg10 ;
...
-(void)postSyncStateToRTC:(id)arg0 category:(NSInteger)arg1 reportDictionary:(id)arg2 ;
