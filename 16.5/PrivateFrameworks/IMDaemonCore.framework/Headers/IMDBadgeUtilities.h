...
@property (nonatomic) BOOL addedObserverForUnexpectedlyLoggedOut; // ivar: _addedObserverForUnexpectedlyLoggedOut
...
@property (nonatomic, getter=isShowingFailure) BOOL showingFailure; // ivar: _showingFailure
@property (nonatomic, getter=isUnexpectedlyLoggedOut) BOOL unexpectedlyLoggedOut; // ivar: _unexpectedlyLoggedOut
