...
-(id)initWithServiceSession:(id)arg0 idsTrustedData:(id)arg1 account:(id)arg2 messageContext:(id)arg3 idsService:(id)arg4 ;
-(id)runIndividuallyWithInput:(id)arg0 ;
-(void)_updateChatForInput:(id)arg0 hadChat:(BOOL)arg1 ;
