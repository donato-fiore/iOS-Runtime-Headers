...
@protocol IMFindChatProcessingParameter, IMTextMessageProcessingParameter, IMMessageLegacyProcessingParameter, IMMessageFromStorageParameter, IMMessageMomentShareProcessingParameter, IMJunkMessagePipelineParameter, IMFamilyMessagePipelineParameter;
...
@property (retain, nonatomic) NSString *availabilityVerificationRecipientEncryptionValidationToken; // ivar: _availabilityVerificationRecipientEncryptionValidationToken
...
@property (nonatomic) BOOL hadChat; // ivar: _hadChat
...
@property (nonatomic) BOOL wasDetonated; // ivar: _wasDetonated


+(BOOL)isAutoReplyWithBlastDoorMessage:(id)arg0 ;
+(id)_fileTransferMatchingAttribute:(id)arg0 inExistingTransfersForMessage:(id)arg1 ;
...
+(id)availabilityVerificationRecipientEncryptionValidationTokenWithBlastDoorTextMessage:(id)arg0 ;
+(id)convertAttributionInfoToArray:(id)arg0 ;
+(id)convertBlastdoorTypedAttributesToNativeTypesInAttributedString:(id)arg0 supportingStickerAttributes:(BOOL)arg1 existingFileTransfersForMessage:(id)arg2 ;
+(id)encryptionTypeWithMessage:(id)arg0 ;
+(id)fileTransferForBlastDoorFileTransferAttribute:(id)arg0 fileTransferGUIDs:(id)arg1 supportingStickerAttributes:(BOOL)arg2 ;
+(id)messageSummaryInfoDictionaryWithBlastDoorBasicMessage:(id)arg0 ;
+(id)messageSummaryInfoDictionaryWithBlastDoorMessage:(id)arg0 ;
+(id)nicknameDictionaryWithBlastDoorMessage:(id)arg0 ;
+(id)participantDestinationIdentifierWithBasicMessage:(id)arg0 ;
+(id)participantDestinationIdentifierWithMessage:(id)arg0 ;
+(id)plainTextBodyWithBlastDoorBasicMessage:(id)arg0 ;
+(id)plainTextBodyWithBlastDoorMessage:(id)arg0 ;
+(id)plainTextSubjectWithBlastDoorBasicMessage:(id)arg0 ;
+(id)plainTextSubjectWithBlastDoorMessage:(id)arg0 ;
+(id)richBodyWithBlastDoorBasicMessage:(id)arg0 ;
