...
-(id)broadcaster;
-(id)init;
-(id)initWithiMessageService:(id)arg0 bizChatService:(id)arg1 incomingMessageHandler:(id)arg2 messageStore:(id)arg3 chatRegistry:(id)arg4 accountController:(id)arg5 storageController:(id)arg6 recentsController:(id)arg7 attachmentStore:(id)arg8 ;
