...
-(id)_copyAttachmentRecord:(id)arg0 ;
-(id)_fileTransfersToDelete:(id)arg0 ;
-(id)_fileTransfersToValidate:(id)arg0 ;
...
-(void)_fetchTransfersFromCloudKit:(id)arg0 indexOfTransfers:(NSUInteger)arg1 numberOfBatchesToFetch:(NSUInteger)arg2 activity:(id)arg3 withCompletion:(id)arg4 ;
-(void)_fetchTransfersFromCloudKit:(id)arg0 withActivity:(id)arg1 ;
-(void)_postTransferInfoOfDeletedTransfers:(id)arg0 ;
-(void)metricAttachmentsToPurge:(NSInteger)arg0 withActivity:(id)arg1 ;
