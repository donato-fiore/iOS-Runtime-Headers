...
@class NSNumber, NSTimer, NSString, IMStateCaptureAssistant;
@protocol IMStateLoggable, IMSystemMonitorListener, IMFocusStateManagerDelegate;
...
-(id)_fileTransferGUIDsInMessageBody:(id)arg0 ;
-(id)_handlesForChat:(id)arg0 ;
-(id)_itemsForMessageRecords:(id)arg0 handleID:(id)arg1 useAttachmentCache:(BOOL)arg2 shouldLoadAttachments:(BOOL)arg3 reverseOrder:(BOOL)arg4 ;
-(id)_itemsWithAssociatedGUID:(id)arg0 shouldLoadAttachments:(BOOL)arg1 ;
-(id)_itemsWithGUIDs:(id)arg0 ;
-(id)_itemsWithHandles:(id)arg0 onServices:(id)arg1 messageGUID:(id)arg2 threadIdentifier:(id)arg3 limit:(NSUInteger)arg4 onlyMessages:(BOOL)arg5 ;
-(id)_itemsWithHandlesBeforeAndAfterGUID:(id)arg0 handles:(id)arg1 onServices:(id)arg2 numberOfMessagesBefore:(NSUInteger)arg3 numberOfMessagesAfter:(NSUInteger)arg4 threadIdentifier:(id)arg5 hasMessagesBefore:(*BOOL)arg6 hasMessagesAfter:(*BOOL)arg7 ;
-(id)_itemsWithRoomNames:(id)arg0 onServices:(id)arg1 messageGUID:(id)arg2 threadIdentifier:(id)arg3 limit:(NSUInteger)arg4 onlyMessages:(BOOL)arg5 ;
-(id)_logAllUnreadMessages;
-(id)_messageItemsForMessageRecords:(id)arg0 handleID:(id)arg1 useAttachmentCache:(BOOL)arg2 shouldLoadAttachments:(BOOL)arg3 reverseOrder:(BOOL)arg4 ;
...
-(id)_updateAssociatedMessageItemsFromMessage:(id)arg0 toMessage:(id)arg1 ;
...
-(id)existingChatForMessageGUID:(id)arg0 ;
...
-(id)itemsWithHandles:(id)arg0 onServices:(id)arg1 limit:(NSUInteger)arg2 ;
-(id)itemsWithHandles:(id)arg0 onServices:(id)arg1 messageGUID:(id)arg2 limit:(NSUInteger)arg3 ;
-(id)itemsWithHandles:(id)arg0 onServices:(id)arg1 messageGUID:(id)arg2 numberOfMessagesBefore:(NSUInteger)arg3 numberOfMessagesAfter:(NSUInteger)arg4 threadIdentifier:(id)arg5 hasMessagesBefore:(*BOOL)arg6 hasMessagesAfter:(*BOOL)arg7 ;
-(id)itemsWithHandles:(id)arg0 onServices:(id)arg1 messageGUID:(id)arg2 threadIdentifier:(id)arg3 limit:(NSUInteger)arg4 ;
-(id)itemsWithRoomNames:(id)arg0 onServices:(id)arg1 limit:(NSUInteger)arg2 ;
-(id)itemsWithRoomNames:(id)arg0 onServices:(id)arg1 messageGUID:(id)arg2 limit:(NSUInteger)arg3 ;
-(id)itemsWithRoomNames:(id)arg0 onServices:(id)arg1 messageGUID:(id)arg2 threadIdentifier:(id)arg3 limit:(NSUInteger)arg4 ;
...
-(id)lastTUConversationItemForChat:(id)arg0 ;
...
-(id)storeEditedMessage:(id)arg0 editedPartIndex:(NSInteger)arg1 editType:(NSUInteger)arg2 previousMessage:(id)arg3 chat:(id)arg4 updatedAssociatedMessageItems:(*id)arg5 ;
...
-(id)updatedMessagesForMessages:(id)arg0 ;
...
-(void)_postDBUpdate;
-(void)_signalUnreadChangeForHandle:(id)arg0 ;
...
-(void)dealloc;
-(void)deleteMessageFromSpotlightWithGUID:(id)arg0 ;
...
-(void)retractPostedNotificationsForMessagesMatchingChatGUIDs:(id)arg0 ;
-(void)setSuppressDatabaseUpdates:(BOOL)arg0 ;
-(void)updateFileTransfer:(id)arg0 ;
-(void)updatePostedNotificationsForMessageGUIDs:(id)arg0 ;
-(void)updateStamp;
