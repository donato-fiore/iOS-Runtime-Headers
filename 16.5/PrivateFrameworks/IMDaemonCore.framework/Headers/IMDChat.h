...
@class NSRecursiveLock, NSString, NSDictionary, NSArray, IMMessageItem, NSMutableDictionary, NSDate, NSNumber, IMSharedEmergencyInfo;
...
@property (readonly) BOOL isRecovered; // ivar: _isRecovered
...
-(BOOL)_otherChatExistsWithChatGUID:(id)arg0 ;
...
-(void)_resetGUIDToExpectedGUID:(id)arg0 ;
...
-(void)updateEmergencyTranscriptSharingStateChatProperty:(int)arg0 ;
...
-(void)updateIsRecovered:(BOOL)arg0 ;
