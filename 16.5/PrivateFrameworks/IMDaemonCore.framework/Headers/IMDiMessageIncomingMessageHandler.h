...
-(void)handleChatSessionCloseWithPipeline:(id)arg0 input:(id)arg1 completionBlock:(id)arg2 ;
-(void)handleEditMessageCommandWithPipeline:(id)arg0 input:(id)arg1 completionBlock:(id)arg2 ;
...
-(void)handleMessageMarkUnreadRequestWithPipeline:(id)arg0 input:(id)arg1 completionBlock:(id)arg2 ;
...
-(void)handleRecoverJunkCommandWithPipeline:(id)arg0 input:(id)arg1 completionBlock:(id)arg2 ;
