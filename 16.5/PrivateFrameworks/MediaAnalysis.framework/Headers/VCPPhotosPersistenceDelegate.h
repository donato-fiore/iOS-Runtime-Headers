...
// -(BOOL)persistChangesToAlgorithmicFaceGroups:(id)arg0 l1ClustersByFaceCSNRepresentingFaceGroup:(id)arg1 l0ClustersByFaceCSNRepresentingFaceGroup:(id)arg2 faceCSNByLocalIdentifierForNewlyClusteredFaces:(id)arg3 faceCSNsOfUnclusteredFaces:(id)arg4 localIdentifiersOfUnclusteredFaces:(id)arg5 persistenceCompletionBlock:(id)arg6 cancelOrExtendTimeoutBlock:(unk)arg7 error:(id)arg8  ;
...
// -(id)_updatedFaceGroupByFGLocalIdentifierFromClusterCSNs:(id)arg0 fetchLimit:(unk)arg1  ;
...
-(id)identifyConflictingL0Clusters:(id)arg0 csnToRejectedPersonForNewlyClusteredFaces:(id)arg1 csnToConfirmedPersonForNewlyClusteredFaces:(id)arg2 ;
...
-(void)_adjustConfirmingAndRejectionWithFaces:(id)arg0 faceCrops:(id)arg1 cancelOrExtendTimeoutBlock:(id)arg2 ;
...
-(void)_detectDuplicationInExistingFaceCrops:(id)arg0 withFetchedFaces:(id)arg1 faceCropFaceIdentifiersToEvaluate:(id)arg2 duplicationResults:(*id)arg3 cancelOrExtendTimeoutBlock:(id)arg4 ;
...
-(void)_processNewlyClusteredFaceCropsInFaceGroups:(id)arg0 cancelOrExtendTimeoutBlock:(id)arg1 ;
