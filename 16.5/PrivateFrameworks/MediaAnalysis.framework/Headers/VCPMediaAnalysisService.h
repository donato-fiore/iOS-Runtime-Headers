...
// -(int)requestAnalysisTypes:(NSUInteger)arg0 forAssets:(id)arg1 withOptions:(id)arg2 progressHandler:(id)arg3 andCompletionHandler:(unk)arg4  ;
...
-(int)requestWallpaperUpgradeAtURL:(id)arg0 toDestinationURL:(id)arg1 withOptions:(id)arg2 andCompletionHandler:(id)arg3 ;
