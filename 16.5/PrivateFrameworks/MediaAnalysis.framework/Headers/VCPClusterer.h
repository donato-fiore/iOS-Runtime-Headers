...
// -(BOOL)_performAndPersistClustersWithFaceTorsoprintsToAdd:(id)arg0 groupingIdentifiersToAdd:(id)arg1 faceTorsoprintsToRemove:(id)arg2 updatedFaces:(id)arg3 cancelOrExtendTimeoutBlock:(id)arg4 error:(unk)arg5  ;
...
// -(BOOL)_processingQueueGetVisionClusters:(id)arg0 minimumClusterSize:(NSUInteger)arg1 returnClusterAsCountedSet:(BOOL)arg2 excludedL0ClustersByL1ClusterId:(*id)arg3 cancelOrExtendTimeoutBlock:(id)arg4 error:(unk)arg5  ;
-(BOOL)_processingQueuePerformForcedFaceClustering:(BOOL)arg0 cancelOrExtendTimeoutBlock:(id)arg1 ;
-(BOOL)_processingQueueResetClusterCache:(*id)arg0 ;
// -(BOOL)_processingQueueRestoreClusterCacheAndSyncWithLibrary:(BOOL)arg0 cancelOrExtendTimeoutBlock:(id)arg1 error:(unk)arg2  ;
...
// -(BOOL)getClusters:(*id)arg0 threshold:(*CGFloat)arg1 utilizingGPU:(*BOOL)arg2 cancelOrExtendTimeoutBlock:(id)arg3 error:(unk)arg4  ;
-(NSUInteger)clusterCount;
-(NSUInteger)clusteredFaceCount;
-(NSUInteger)numberOfAccumulatedClusterChanges;
// -(NSUInteger)restoreClusterCacheAndSyncWithLibrary:(BOOL)arg0 cancelOrExtendTimeoutBlock:(id)arg1 error:(unk)arg2  ;
-(id)_bringUpStateDescription:(NSUInteger)arg0 ;
...
-(id)_resolveConflictingL0ClustersFromVNClusters:(id)arg0 excludedL0ClustersByL1ClusterId:(*id)arg1 cancelOrExtendTimeoutBlock:(id)arg2 ;
...
-(id)differencesBetweenClusterCacheAndLibrary:(*id)arg0 excludedL0ClustersByL1ClusterId:(*id)arg1 cancelOrExtendTimeoutBlock:(id)arg2 ;
...
-(void)_processingQueueQuickSyncClustererWithPhotoLibraryUsingFacesInClusterCache:(id)arg0 visionClusters:(*id)arg1 cancelOrExtendTimeoutBlock:(id)arg2 ;
-(void)_processingQueueSyncClustererWithPhotoLibraryUsingFacesInClusterCache:(id)arg0 cancelOrExtendTimeoutBlock:(id)arg1 ;
...
-(void)clusterAndWaitWithCancelOrExtendTimeoutBlock:(id)arg0 ;
-(void)clusterIfNecessaryAndWaitWithCancelOrExtendTimeoutBlock:(id)arg0 ;
