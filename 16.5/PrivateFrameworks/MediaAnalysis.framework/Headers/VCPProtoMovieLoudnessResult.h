...
#ifndef VCPPROTOMOVIELOUDNESSRESULT_H
#define VCPPROTOMOVIELOUDNESSRESULT_H
...
@property (nonatomic) CGFloat energy; // ivar: _energy
@property (nonatomic) CGFloat peak; // ivar: _peak
