...
@protocol VSJSMessagePortDelegate, IKDOMFeature, VSMessagePortFeatureDelegate;
...
@property (weak, nonatomic) NSObject<VSMessagePortFeatureDelegate> *delegate; // ivar: _delegate
