...
@property (nonatomic) BOOL chamoisPrefersStripHidden; // ivar: _chamoisPrefersStripHidden
...
-(id)deserializedStringArrayForKey:(char *)arg0 fromPayload:(id)arg1 ;
...
-(void)setChamoisHideStripsEnabled:(BOOL)arg0 ;
