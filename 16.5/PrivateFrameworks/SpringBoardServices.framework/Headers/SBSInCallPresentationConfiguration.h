...
@property (nonatomic) BOOL shouldPreventBannersWhenPresentedAsOverlay; // ivar: _shouldPreventBannersWhenPresentedAsOverlay
@property (nonatomic) BOOL supportsSystemAperture; // ivar: _supportsSystemAperture
