...
@property (nonatomic) BOOL allowsForegroundAppLaunchWhileInCarPlay; // ivar: _allowsForegroundAppLaunchWhileInCarPlay
@property (nonatomic) NSInteger openApplicationPriority; // ivar: _openApplicationPriority
