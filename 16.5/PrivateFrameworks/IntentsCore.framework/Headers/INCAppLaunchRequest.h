...
@property (readonly, nonatomic) BOOL retainsSiri; // ivar: _retainsSiri
...
+(id)specialElementIdentifierForBundleIdentifier:(id)arg0 ;
+(void)initialize;
...
-(id)initWithBundleIdentifier:(id)arg0 options:(id)arg1 URL:(id)arg2 userActivity:(id)arg3 retainsSiri:(BOOL)arg4 ;
-(id)initWithIntent:(id)arg0 userActivity:(id)arg1 inBackground:(BOOL)arg2 error:(*id)arg3 ;
-(id)initWithIntent:(id)arg0 userActivity:(id)arg1 inBackground:(BOOL)arg2 retainsSiri:(BOOL)arg3 error:(*id)arg4 ;
-(id)initWithInteraction:(id)arg0 userActivity:(id)arg1 inBackground:(BOOL)arg2 error:(*id)arg3 ;
-(id)initWithInteraction:(id)arg0 userActivity:(id)arg1 inBackground:(BOOL)arg2 retainsSiri:(BOOL)arg3 error:(*id)arg4 ;
...
-(void)performWithService:(id)arg0 retainsSiri:(BOOL)arg1 completionHandler:(id)arg2 ;
