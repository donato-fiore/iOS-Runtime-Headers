...
-(BOOL)getMainGlobalProperty:(unsigned int)arg0 withData:(*void)arg1 ofSize:(*unsigned int)arg2 withQualifier:(*void)arg3 ofSize:(unsigned int)arg4 ;
-(BOOL)getMainInputProperty:(unsigned int)arg0 withData:(*void)arg1 ofSize:(*unsigned int)arg2 withQualifier:(*void)arg3 ofSize:(unsigned int)arg4 ;
-(BOOL)getMainOutputProperty:(unsigned int)arg0 withData:(*void)arg1 ofSize:(*unsigned int)arg2 withQualifier:(*void)arg3 ofSize:(unsigned int)arg4 ;
...
-(BOOL)hasMainGlobalProperty:(unsigned int)arg0 ;
-(BOOL)hasMainInputProperty:(unsigned int)arg0 ;
-(BOOL)hasMainOutputProperty:(unsigned int)arg0 ;
...
-(BOOL)isMainGlobalPropertySettable:(unsigned int)arg0 ;
-(BOOL)isMainInputPropertySettable:(unsigned int)arg0 ;
-(BOOL)isMainOutputPropertySettable:(unsigned int)arg0 ;
...
-(BOOL)onQueue:(id)arg0 forMainGlobalProperty:(unsigned int)arg1 addListener:(id)arg2 ;
-(BOOL)onQueue:(id)arg0 forMainGlobalProperty:(unsigned int)arg1 removeListener:(id)arg2 ;
-(BOOL)onQueue:(id)arg0 forMainInputProperty:(unsigned int)arg1 addListener:(id)arg2 ;
-(BOOL)onQueue:(id)arg0 forMainInputProperty:(unsigned int)arg1 removeListener:(id)arg2 ;
-(BOOL)onQueue:(id)arg0 forMainOutputProperty:(unsigned int)arg1 addListener:(id)arg2 ;
-(BOOL)onQueue:(id)arg0 forMainOutputProperty:(unsigned int)arg1 removeListener:(id)arg2 ;
...
-(BOOL)setMainGlobalProperty:(unsigned int)arg0 withData:(*void)arg1 ofSize:(unsigned int)arg2 withQualifier:(*void)arg3 ofSize:(unsigned int)arg4 ;
-(BOOL)setMainInputProperty:(unsigned int)arg0 withData:(*void)arg1 ofSize:(unsigned int)arg2 withQualifier:(*void)arg3 ofSize:(unsigned int)arg4 ;
-(BOOL)setMainOutputProperty:(unsigned int)arg0 withData:(*void)arg1 ofSize:(unsigned int)arg2 withQualifier:(*void)arg3 ofSize:(unsigned int)arg4 ;
...
-(unsigned int)sizeOfMainGlobalProperty:(unsigned int)arg0 withQualifier:(*void)arg1 ofSize:(unsigned int)arg2 ;
-(unsigned int)sizeOfMainInputProperty:(unsigned int)arg0 withQualifier:(*void)arg1 ofSize:(unsigned int)arg2 ;
-(unsigned int)sizeOfMainOutputProperty:(unsigned int)arg0 withQualifier:(*void)arg1 ofSize:(unsigned int)arg2 ;
