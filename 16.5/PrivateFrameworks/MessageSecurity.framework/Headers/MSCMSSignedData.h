...
-(BOOL)verifySignaturesAndSignersWithPolicies:(id)arg0 verifyTime:(id)arg1 anchorCertificates:(id)arg2 error:(*id)arg3 ;
...
-(void)addCounterSignerCertificates:(id)arg0 mode:(NSUInteger)arg1 error:(*id)arg2 ;
