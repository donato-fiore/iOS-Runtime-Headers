...
@class NSLock, NSString, NSArray, NSNumber, NSAttributedString, NSDictionary, NSURL;
@protocol NSCopying;
...
@property (copy) NSNumber *designVersion; // ivar: _designVersion
...
@property (copy) NSArray *styles; // ivar: _styles
