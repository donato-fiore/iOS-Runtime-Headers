...
-(BOOL)_parseComponent:(id)arg0 ;
-(BOOL)createPropertyType:(int)arg0 component:(id)arg1 withName:(id)arg2 fatalError:(*BOOL)arg3 ;
-(BOOL)parseParameter:(id)arg0 fatalError:(*BOOL)arg1 ;
-(BOOL)parseProperty:(id)arg0 fatalError:(*BOOL)arg1 ;
