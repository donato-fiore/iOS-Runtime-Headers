...
#ifndef NPKPROTOSTANDALONEPAYMENTPROVISIONINGFLOWCHOOSEFLOWREQUEST_H
#define NPKPROTOSTANDALONEPAYMENTPROVISIONINGFLOWCHOOSEFLOWREQUEST_H
...
@property (retain, nonatomic) NSString *chosenFlowPickerItemIdentifier; // ivar: _chosenFlowPickerItemIdentifier
