...
+(id)watchProvisioningURLForPaymentPasses:(id)arg0 ;
...
-(NSUInteger)_isApplePaySupportedInCurrentRegion;
...
-(void)beginPairedWatchInstallationOfWalletWithCompletion:(id)arg0 ;
-(void)beginProvisioningFromWatchOfferForPaymentPass:(id)arg0 withCompletion:(id)arg1 ;
-(void)beginProvisioningFromWatchOfferForPaymentPasses:(id)arg0 withCompletion:(id)arg1 ;
...
-(void)countOfPassesSynchronous:(BOOL)arg0 completion:(id)arg1 ;
...
-(void)deviceIDSIdentifierSynchronous:(BOOL)arg0 completion:(id)arg1 ;
...
-(void)passesSynchronous:(BOOL)arg0 completion:(id)arg1 ;
-(void)paymentPassUniqueIDs:(id)arg0 ;
-(void)paymentPassUniqueIDsSynchronous:(BOOL)arg0 excludingDeactivated:(BOOL)arg1 reply:(id)arg2 ;
...
-(void)shouldShowWatchOfferForPaymentPasses:(id)arg0 withCompletion:(id)arg1 ;
