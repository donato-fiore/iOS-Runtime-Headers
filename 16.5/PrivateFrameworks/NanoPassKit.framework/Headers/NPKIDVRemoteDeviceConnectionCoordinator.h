...
-(void)_sendEstablishPrearmTrustRequest:(id)arg0 item:(id)arg1 ;
...
-(void)establishPrearmTrustV2Response:(id)arg0 ;
...
-(void)generatePresentmentKeysForCredential:(id)arg0 numKeys:(NSInteger)arg1 withConfiguredPartitions:(id)arg2 completion:(id)arg3 ;
-(void)generatePresentmentKeysForCredentialResponse:(id)arg0 ;
-(void)getCASDCertificateResponse:(id)arg0 ;
