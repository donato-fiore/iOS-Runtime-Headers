...
@protocol NSXPCListenerDelegate, NPKIDVRemoteDeviceServiceServerDelegate, OS_dispatch_queue, NPKIDVRemoteDeviceServiceDelegate;
...
@property (weak, nonatomic) NSObject<NPKIDVRemoteDeviceServiceDelegate> *delegate; // ivar: _delegate
