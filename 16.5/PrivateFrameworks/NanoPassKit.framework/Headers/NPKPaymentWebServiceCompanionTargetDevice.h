...
@protocol IDSServiceDelegate, NPKCompanionPasscodeChangeCoordinatorDelegate, PKPaymentWebServiceTargetDeviceProtocol, PKPaymentWebServiceArchiver, NPKPaymentWebServiceCompanionTargetDeviceDelegate, OS_dispatch_queue, NPKCompanionPasscodeChangeCoordinatorProtocol;
...
@property (retain, nonatomic) NSObject<NPKCompanionPasscodeChangeCoordinatorProtocol> *passcodeChangeCoordinator; // ivar: _passcodeChangeCoordinator
...
-(NSUInteger)currentPassbookState;
...
-(id)_currentExpressPassStateForExpressPassInformation:(id)arg0 otherPaymentPasses:(id)arg1 ;
-(id)_deviceSupportedFeatureIdentifiers;
-(id)_dummyExpressPassInformationForPass:(id)arg0 fromUpgradeRequest:(id)arg1 ;
-(id)_expressModesFromExpressPassesInformation:(id)arg0 ;
-(id)_expressPassInformationForPaymentPass:(id)arg0 outPassUpgradeRequest:(*id)arg1 ;
...
-(id)_upgradeExpressAutomaticSelectionCriteriaRequestsForPass:(id)arg0 ;
-(id)_upgradeExpressAutomaticSelectionCriteriaRequestsForPass:(id)arg0 deviceClass:(id)arg1 OSVersion:(id)arg2 SEID:(id)arg3 ;
...
-(id)upgradeRequestForPass:(id)arg0 ;
-(void)_acquireAssertionOfType:(NSUInteger)arg0 ;
-(void)_canAddSecureElementPassWithConfiguration:(id)arg0 completion:(id)arg1 ;
-(void)_displayableEntitlementsForPassIdentifier:(id)arg0 completion:(id)arg1 ;
-(void)_displayableSharesForPassIdentifier:(id)arg0 completion:(id)arg1 ;
...
-(void)acceptCarKeyShareForMessageResponse:(id)arg0 ;
...
-(void)accountWithIdentifierResponse:(id)arg0 ;
...
-(void)checkInvitationStatusForMailboxAddressResponse:(id)arg0 ;
...
-(void)createShareForPartialShareInvitationResponse:(id)arg0 ;
...
-(void)dismissRemoteDevicePasscodeUpgradePromptWithCompletion:(id)arg0 ;
-(void)displayableEntitlementsForPassIdentifier:(id)arg0 completion:(id)arg1 ;
-(void)displayableEntitlementsForPassIdentifierResponse:(id)arg0 ;
-(void)displayableSharesForPassIdentifier:(id)arg0 completion:(id)arg1 ;
-(void)displayableSharesForPassIdentifierResponse:(id)arg0 ;
...
-(void)expressModeEnabledForPassIdentifier:(id)arg0 completion:(id)arg1 ;
...
-(void)fetchRemoteDevicePasscodeStateWithCompletion:(id)arg0 ;
...
-(void)handleAcceptSubcredentialProvisioningForMailboxAddressRequest:(id)arg0 ;
-(void)handleAcceptSubcredentialProvisioningRequest:(id)arg0 ;
-(void)handleApplyRestrictionsForPasscodeUpgradeFlowControllerResponse:(id)arg0 ;
...
-(void)handleEnforceUpgradedPasscodePolicyResponse:(id)arg0 ;
...
-(void)handleRemoteDevicePasscodeStateResponse:(id)arg0 ;
-(void)handleRemoteDevicePasscodeUpgradePresentationPromptResponse:(id)arg0 ;
...
-(void)hasActiveExternallySharedPassesResponse:(id)arg0 ;
-(void)hasActiveExternallySharedPassesWithCompletion:(id)arg0 ;
...
-(void)longTermPrivacyKeyForCredentialGroupIdentifierResponse:(id)arg0 ;
...
-(void)passSharesForCredentialIdentifierResponse:(id)arg0 ;
-(void)passcodeChangeCoordinator:(id)arg0 checkRemoteDeviceLockStateWithCompletion:(id)arg1 ;
-(void)passcodeChangeCoordinator:(id)arg0 remoteDeviceShouldCancelPasscodeChangeWithCompletion:(id)arg1 ;
-(void)passcodeChangeCoordinator:(id)arg0 remoteDeviceShouldInitiatePasscodeChangeForType:(NSUInteger)arg1 completion:(id)arg2 ;
-(void)paymentSetupFeaturesForConfiguration:(id)arg0 completion:(id)arg1 ;
-(void)paymentSetupFeaturesForConfigurationResponse:(id)arg0 ;
-(void)paymentWebService:(id)arg0 acceptSubcredentialInvitation:(id)arg1 completion:(id)arg2 ;
...
-(void)paymentWebServiceOwnershipTokenResponse:(id)arg0 ;
...
-(void)prepareProvisioningTargetResponse:(id)arg0 ;
-(void)presentRemoteDevicePasscodeUpgradePromptForChangeType:(NSUInteger)arg0 completion:(id)arg1 ;
...
-(void)prewarmCreateShareForPassIdentifierResponse:(id)arg0 ;
...
-(void)provisionPassForRemoteCredentialWithType:(NSInteger)arg0 andIdentifier:(id)arg1 completion:(id)arg2 ;
-(void)provisionPassForRemoteCredentialWithTypeAndIdentifierResponse:(id)arg0 ;
...
-(void)retrieveShareInvitationForMailboxAddressResponse:(id)arg0 ;
...
-(void)revokeShareForPassIdentifierResponse:(id)arg0 ;
...
-(void)serviceProviderDataForPassWithUniqueIdentifier:(id)arg0 encrypted:(BOOL)arg1 completion:(id)arg2 ;
...
-(void)updateShareForPassIdentifierResponse:(id)arg0 ;
