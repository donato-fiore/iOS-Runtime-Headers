...
@class UINavigationController, NSString, DDScannerResult, NSDictionary, RVQuery, RVItem, UITapGestureRecognizer, _UIRemoteViewController, NSArray;
...
@property (copy, nonatomic) id *reportAnIssueBlock; // ivar: _reportAnIssueBlock
@property (copy, nonatomic) id *reportAnIssueMetadataFetchingBlock; // ivar: _reportAnIssueMetadataFetchingBlock
...
-(id)initWithString:(id)arg0 range:(struct _NSRange )arg1 dictionaryOnly:(BOOL)arg2 ;
