...
@class NSString, NSDictionary, NSURL, UIImage, CNContact, UIView, UIViewController;
...
@property (weak, nonatomic) UIView *fallBackView; // ivar: _fallBackView
...
@property (nonatomic) BOOL treatAsMenu; // ivar: _treatAsMenu
...
-(id)localizedSubItemName:(BOOL)arg0 ;
-(id)menuIcon;
-(id)menuName;
...
-(void)updateSourceRect:(struct CGRect )arg0 ;
