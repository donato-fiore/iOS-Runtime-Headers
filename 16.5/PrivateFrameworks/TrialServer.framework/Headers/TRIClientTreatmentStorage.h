...
-(BOOL)_deleteOnDemandAssetsWithFactorNames:(id)arg0 treatment:(id)arg1 namespace:(id)arg2 forRollouts:(BOOL)arg3 inUseAssetDeletionBehavior:(unsigned char)arg4 ;
-(BOOL)_linkAssetsUpdatingTreatment:(id)arg0 ;
...
-(BOOL)removeUnreferencedTreatmentsWithRemovedCount:(*unsigned int)arg0 ;
...
-(id)updateSavedTreatmentWithTreatmentId:(id)arg0 deletingAssetsWithFactorNames:(id)arg1 forNamespaceName:(id)arg2 forRollouts:(BOOL)arg3 ;
-(id)updateSavedTreatmentWithTreatmentId:(id)arg0 deletingAssetsWithFactorNames:(id)arg1 forNamespaceName:(id)arg2 forRollouts:(BOOL)arg3 inUseAssetDeletionBehavior:(unsigned char)arg4 ;
