...
@protocol TRIRetryableTask, TRIMetricsProviding, OS_dispatch_queue, TRITaskQueueStateProviding;
...
-(BOOL)_cleanupUnusedContentWithContext:(id)arg0 nextTasks:(id)arg1 ;
-(id)_asPersistedTask;
-(id)_roundNumber:(id)arg0 ;
-(id)dimensions;
-(id)init;
