...
+(id)taskWithStartingFetchDateOverride:(id)arg0 namespaceNames:(id)arg1 taskAttributing:(id)arg2 rollbacksOnly:(BOOL)arg3 limitedCarryOnly:(BOOL)arg4 ;
-(BOOL)_checkIfAnyTreatmentPresent:(id)arg0 usingContext:(id)arg1 ;
-(BOOL)_processExperiment:(id)arg0 experimentDatabase:(id)arg1 namespaceDatabase:(id)arg2 taskQueue:(id)arg3 paths:(id)arg4 bmltBatchNotificationId:(id)arg5 ;
-(BOOL)isEqual:(id)arg0 ;
-(NSInteger)nextTaskCount;
-(NSUInteger)requiredCapabilities;
-(id)_asPersistedTask;
-(id)_categoricalValueForBMLTNotificationEvent:(NSUInteger)arg0 ;
-(id)_getNextTaskForExperiment:(id)arg0 database:(id)arg1 taskQueue:(id)arg2 bmltBatchNotificationId:(id)arg3 ;
...
-(id)initWithStartingFetchDateOverride:(id)arg0 namespaceNames:(id)arg1 taskAttributing:(id)arg2 rollbacksOnly:(BOOL)arg3 limitedCarryOnly:(BOOL)arg4 ;
-(id)metrics;
