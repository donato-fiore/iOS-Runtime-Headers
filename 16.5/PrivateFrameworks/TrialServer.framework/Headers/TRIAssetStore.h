...
@protocol TRIPaths, TRIAssetExtracting, TRIAssetPatching, OS_xpc_object, TRIStorageManagementProtocol, TRIAssetStoreOperations;
...
-(NSUInteger)removableAssetsSizeOlderThanNumScans:(unsigned int)arg0 ignoreRecentlyCreatedAssets:(BOOL)arg1 includedCacheDeletableAssetIds:(id)arg2 deleteableAssetIds:(*id)arg3 ;
-(NSUInteger)removableAssetsSizeOlderThanNumScans:(unsigned int)arg0 includedCacheDeletableAssetIds:(id)arg1 ;
-(id)_createTempDir;
-(id)init;
