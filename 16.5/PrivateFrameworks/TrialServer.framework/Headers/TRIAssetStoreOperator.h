...
-(BOOL)_removeUnreferencedAssetsWithFlockWitness:(struct TRIFlockWitness_ *)arg0 olderThanAge:(unsigned int)arg1 numRemoved:(*unsigned int)arg2 deletedAssetsSize:(*NSUInteger)arg3 ignoreRecentlyCreatedAssets:(BOOL)arg4 dryRun:(BOOL)arg5 includedCacheDeletableAssetIds:(id)arg6 deletedAssetIds:(*id)arg7 ;
...
-(id)_collectUnreferencedAssetsIncludingLinkTargetsForReferencedAssetIds:(id)arg0 ignoreRecentlyCreatedAssets:(BOOL)arg1 ;
