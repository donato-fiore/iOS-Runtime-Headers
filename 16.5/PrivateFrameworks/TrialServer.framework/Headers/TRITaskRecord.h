...
+(id)taskRecordWithTaskId:(id)arg0 task:(id)arg1 startDate:(id)arg2 dependencies:(id)arg3 capabilities:(NSUInteger)arg4 tags:(id)arg5 ;
+(void)load;
...
-(id)initWithTaskId:(id)arg0 task:(id)arg1 startDate:(id)arg2 dependencies:(id)arg3 capabilities:(NSUInteger)arg4 tags:(id)arg5 ;
