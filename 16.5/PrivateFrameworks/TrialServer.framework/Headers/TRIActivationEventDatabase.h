...
-(struct ? )addRecordWithParentId:(id)arg0 factorPackSetId:(id)arg1 deploymentId:(int)arg2 osBuild:(id)arg3 languageCode:(id)arg4 regionCode:(id)arg5 carrierBundleId:(id)arg6 carrierCountryCode:(id)arg7 diagnosticsUsageEnabled:(BOOL)arg8 hasAne:(BOOL)arg9 aneVersion:(id)arg10 transaction:(id)arg11 ;
