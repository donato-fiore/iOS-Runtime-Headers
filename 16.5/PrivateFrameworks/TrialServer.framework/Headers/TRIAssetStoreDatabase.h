...
-(BOOL)addReferenceToAutoAssetId:(id)arg0 forLifetimeOfPath:(id)arg1 ;
...
-(void)enumerateAssetIdsWithoutLiveReferencesUsingBlock:(id)arg0 ;
-(void)enumerateOnDiskMAReferencesWithoutCorrespondingDatabaseEntriesUsingBlock:(id)arg0 ;
