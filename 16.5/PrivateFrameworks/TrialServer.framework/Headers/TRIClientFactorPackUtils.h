...
+(id)unlinkedOnDemandAssetsWithFactorPack:(id)arg0 factorPackPath:(id)arg1 assetStore:(id)arg2 maProvider:(id)arg3 aliasToUnaliasMap:(id)arg4 unlinkedMAAssetsOnDisk:(*id)arg5 ;
