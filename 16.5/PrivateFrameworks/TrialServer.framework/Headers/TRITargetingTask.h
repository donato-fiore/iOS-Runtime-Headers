...
+(id)taskWithExperiment:(id)arg0 includeDependencies:(BOOL)arg1 taskAttribution:(id)arg2 bmltBatchNotificationId:(id)arg3 ;
...
-(id)initWithExperiment:(id)arg0 includeDependencies:(BOOL)arg1 taskAttribution:(id)arg2 bmltBatchNotificationId:(id)arg3 ;
-(id)metrics;
