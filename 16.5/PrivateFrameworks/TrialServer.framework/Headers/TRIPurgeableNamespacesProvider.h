...
-(void)partitionPurgeableNamespacesForPurgeabilityLevel:(int)arg0 namespaceNamesPurgeableAtNamespaceLevel:(*id)arg1 eagerPurgeableFactorsByNamespaceName:(*id)arg2 cacheDeleteableFactorsByNamespaceName:(*id)arg3 ;
