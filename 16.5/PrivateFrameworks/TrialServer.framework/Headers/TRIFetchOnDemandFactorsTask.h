...
+(id)taskWithAssetIndexesByTreatment:(id)arg0 experimentId:(id)arg1 assetIdsByFactorPack:(id)arg2 rolloutFactorNames:(id)arg3 rolloutDeployment:(id)arg4 namespaceName:(id)arg5 taskAttributing:(id)arg6 notificationKey:(id)arg7 capabilityModifier:(id)arg8 ;
-(BOOL)_updateFactorPacksByMergingAssets:(id)arg0 context:(id)arg1 ;
-(BOOL)isEqual:(id)arg0 ;
-(NSUInteger)_requiredDiskSpaceForPlan:(id)arg0 ;
-(NSUInteger)requiredCapabilities;
-(id)_asPersistedTask;
-(id)_assetIdsFromKeysInDictionary:(id)arg0 ;
-(id)_currentTaskStatus;
-(id)_fetchDiffsFromAssetDiffRecordsWithContext:(id)arg0 plan:(id)arg1 aggregateProgress:(id)arg2 downloadSize:(*NSUInteger)arg3 options:(id)arg4 ;
-(id)_fetchOptionsWithDownloadOptions:(id)arg0 paths:(id)arg1 ;
-(id)_planForFetchingAssetDiffsWithContext:(id)arg0 downloadOptions:(id)arg1 updatingAggregateProgress:(id)arg2 nonDiffableAssetIds:(*id)arg3 unlinkedMAAssetsOnDisk:(*id)arg4 ;
...
-(id)dimensions;
-(id)initWithAssetIndexesByTreatment:(id)arg0 experimentId:(id)arg1 assetIdsByFactorPack:(id)arg2 rolloutFactorNames:(id)arg3 rolloutDeployment:(id)arg4 namespaceName:(id)arg5 taskAttributing:(id)arg6 notificationKey:(id)arg7 capabilityModifier:(id)arg8 ;
-(id)initWithCoder:(id)arg0 ;
-(id)metrics;
-(id)runUsingContext:(id)arg0 withTaskQueue:(id)arg1 ;
-(id)serialize;
-(id)trialSystemTelemetry;
-(struct ? )_saveIndexedAssetURLs:(id)arg0 withTreatmentId:(id)arg1 usingAssetMetadata:(id)arg2 downloadOptions:(id)arg3 paths:(id)arg4 downloadSize:(*NSUInteger)arg5 error:(*id)arg6 ;
-(struct ? )_saveNamedAssetURLs:(id)arg0 usingAssetMetadata:(id)arg1 downloadOptions:(id)arg2 downloadSize:(*NSUInteger)arg3 paths:(id)arg4 error:(*id)arg5 ;
-(void)_addDimension:(id)arg0 ;
-(void)_addMetric:(id)arg0 ;
-(void)_addMetricForFetchOnDemandFactorsTaskError:(int)arg0 ;
...
-(void)_asyncFetchCKAssetsFromAssetRecordsWithContext:(id)arg0 plan:(id)arg1 aggregateProgress:(id)arg2 downloadSize:(*NSUInteger)arg3 options:(id)arg4 group:(id)arg5 ;
-(void)_asyncFetchMAAssetsFromFactorPacksWithContext:(id)arg0 plan:(id)arg1 aggregateProgress:(id)arg2 downloadSize:(*NSUInteger)arg3 options:(id)arg4 group:(id)arg5 ;
...
-(void)removeDownloadableFactorNames:(id)arg0 ;
