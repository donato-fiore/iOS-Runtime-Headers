...
@protocol AXUIMessageSenderDelegate, BSServiceConnectionListenerDelegate, AccessibilityBoardServices_ServerProtocol, AXUIServiceManagerDelegate;
...
@property (weak, nonatomic) NSObject<AXUIServiceManagerDelegate> *delegate; // ivar: _delegate
