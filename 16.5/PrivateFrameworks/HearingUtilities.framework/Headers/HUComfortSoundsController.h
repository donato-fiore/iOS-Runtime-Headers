...
@class AVAudioPlayerNode, NSString, AVAudioEngine, AVAudioSession;
...
@property (nonatomic) BOOL temporaryAirpodsDisconnect; // ivar: _temporaryAirpodsDisconnect
...
-(void)activeUseDidChange:(id)arg0 ;
...
-(void)systemLogoutStatusDidChange:(id)arg0 ;
