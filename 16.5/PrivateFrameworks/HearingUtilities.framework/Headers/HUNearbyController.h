...
@class NSArray, NSString, NSMutableDictionary, AXDispatchTimer, NSMutableArray, IDSService;
...
@property (nonatomic) BOOL hasPendingNearbyUpdates; // ivar: _hasPendingNearbyUpdates
...
@property (retain, nonatomic) AXDispatchTimer *nearbyHysteresisTimer; // ivar: _nearbyHysteresisTimer
...
@property (nonatomic) BOOL shouldPublishNearbyUpdates; // ivar: _shouldPublishNearbyUpdates
