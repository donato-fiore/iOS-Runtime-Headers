...
+(id)messageForPreventLockReason:(NSUInteger)arg0 ;
...
+(id)signIntoCloudAccountActionAlertWithAccount:(id)arg0 ;
...
+(void)markSwitchToDevicePasswordPromptPresentedForAccount:(id)arg0 ;
