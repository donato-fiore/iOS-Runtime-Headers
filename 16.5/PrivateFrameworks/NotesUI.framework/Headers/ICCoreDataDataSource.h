...
@class NSManagedObjectContext, NSDate, ICSelectorDelayer;
...
@property (retain, nonatomic) NSManagedObjectContext *applySnapshotLegacyManagedObjectContext; // ivar: _applySnapshotLegacyManagedObjectContext
@property (retain, nonatomic) NSManagedObjectContext *applySnapshotModernManagedObjectContext; // ivar: _applySnapshotModernManagedObjectContext
