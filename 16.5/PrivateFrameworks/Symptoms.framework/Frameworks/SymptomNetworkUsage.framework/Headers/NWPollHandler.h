...
@property (copy) id *flowDeliveryBlock; // ivar: _flowDeliveryBlock
@property (copy) id *genericDeliveryBlock; // ivar: _genericDeliveryBlock
@property (retain) NWUsageTargetSelector *itemSelector; // ivar: _itemSelector
