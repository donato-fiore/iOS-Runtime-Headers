...
@property (readonly, nonatomic) NSUInteger supportedColorSchemes; // ivar: _supportedColorSchemes
@property (readonly, nonatomic) NSUInteger supportedRenderingModes; // ivar: _supportedRenderingModes
