...
@property (nonatomic) NSUInteger maxBiometryFailures; // ivar: _maxBiometryFailures
...
@property (nonatomic) BOOL useLegacyAuthenticator; // ivar: _useLegacyAuthenticator
