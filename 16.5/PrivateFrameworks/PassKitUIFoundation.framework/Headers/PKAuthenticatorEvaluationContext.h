...
@class NSDictionary, PKBannerHandle, NSMutableArray, LAContext;
...
@property (readonly, nonatomic) BOOL forceSkipUserIntent; // ivar: _forceSkipUserIntent
...
-(BOOL)updateCompletedMechanismsForPushButtonEventParams:(id)arg0 ;
