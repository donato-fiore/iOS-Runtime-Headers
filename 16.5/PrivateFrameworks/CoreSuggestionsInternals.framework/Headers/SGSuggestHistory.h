...
@class _PASLock, NSUbiquitousKeyValueStore, NSString;
...
-(id)description;
-(id)hashesByAddingCompatibilityHashesToHashes:(id)arg0 forMatching:(BOOL)arg1 ;
...
-(id)init;
-(id)initWithKVS:(id)arg0 kvStoreIdentifier:(id)arg1 ;
...
-(id)legacyIOS13HashesForClassicHashes:(id)arg0 ;
...
-(void)migrateFromKVS:(id)arg0 withCompletion:(id)arg1 ;
...
-(void)setMigrateFromStore:(id)arg0 ;
