...
-(id)_callJSFunction:(id)arg0 withArguments:(id)arg1 ;
-(id)_diffSchemas:(id)arg0 withExpectedSchemas:(id)arg1 ;
-(id)_eventClassificationForEntity:(id)arg0 ;
-(id)_getFlightReferencesAndReservationId:(id)arg0 ;
...
-(id)preprocessPackedSGMessage:(id)arg0 ;
...
-(id)sfFlightsToDictionary:(id)arg0 ;
...
-(void)flightInformationWithAirlineCode:(id)arg0 flightNumber:(id)arg1 flightDate:(id)arg2 reply:(id)arg3 ;
-(void)freeJSContext;
-(void)getFlightReferencesAndReservationId:(id)arg0 reply:(id)arg1 ;
