...
@class NSString, _PASCachedResult, NSData, NSArray, SGSimpleNamedEmailAddress, HVHtmlParser, NSIndexSet;
...
@property (readonly, nonatomic) HVHtmlParser *htmlParser; // ivar: _htmlParser
@property (readonly, nonatomic) NSString *inReplyTo; // ivar: _inReplyTo
...
+(id)htmlFromPlainTextBody:(id)arg0 ;
...
-(id)initWithMailContentEvent:(id)arg0 contentProtection:(id)arg1 htmlParser:(id)arg2 ;
