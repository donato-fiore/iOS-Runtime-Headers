...
-(id)_descriptionForMessageEventDissectorExtractionStatus:(unsigned short)arg0 ;
...
-(void)logMLMessageEventExtractionForEntitySync:(id)arg0 interface:(unsigned short)arg1 actionType:(unsigned short)arg2 ;
-(void)logMLMessageEventExtractionForTemplateName:(id)arg0 extractionStatus:(unsigned short)arg1 outputInfo:(id)arg2 outputExceptions:(id)arg3 timingProcessing:(NSUInteger)arg4 ;
-(void)logMLMessageEventInteractionForEntity:(id)arg0 interface:(unsigned short)arg1 actionType:(unsigned short)arg2 ;
