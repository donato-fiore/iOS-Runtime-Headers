...
@class UIView, NSMutableArray, _UILumaTrackingBackdropView, NSArray;
...
@property (retain, nonatomic) NSArray *fingerModels; // ivar: _fingerModels
...
-(void)_updateFingerModelViews:(BOOL)arg0 startPointForAnimation:(struct CGPoint )arg1 ;
