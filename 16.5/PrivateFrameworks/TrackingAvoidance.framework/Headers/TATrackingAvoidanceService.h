...
@protocol TAStoreObserver, TATrackingAvoidanceServiceProtocol;
...
+(id)createRandomBytes:(NSUInteger)arg0 ;
...
-(void)debugForceSurfaceStagedDetections:(id)arg0 deviceType:(NSUInteger)arg1 ;
-(void)debugStageTADetection:(id)arg0 deviceType:(NSUInteger)arg1 ;
-(void)didRequestAIS:(id)arg0 ;
-(void)fetchTAUnknownBeacon:(id)arg0 withCompletion:(id)arg1 ;
-(void)filterAndStageDetectionResults:(id)arg0 ;
