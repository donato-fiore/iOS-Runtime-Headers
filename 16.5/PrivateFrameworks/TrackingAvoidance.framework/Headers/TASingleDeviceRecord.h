...
@class NSData, NSMutableDictionary, NSMutableSet, NSDate, NSMutableArray, NSUUID;
...
@property (nonatomic) NSUInteger AISFetchCount; // ivar: _AISFetchCount
@property (nonatomic) NSUInteger AISFetchState; // ivar: _AISFetchState
...
@property (readonly, nonatomic) NSDate *lastAISAttemptDate; // ivar: _lastAISAttemptDate
...
-(BOOL)_isKeepInStagingUntilComplete:(id)arg0 ;
...
-(id)prepareAISFetchTAOutgoingRequest:(id)arg0 lastAISFetchDate:(id)arg1 ;
...
-(void)processAISFetchEvent:(id)arg0 andAppendOutgoingRequestsTo:(id)arg1 ;
