...
@class NSMutableSet, NSSet, NSString, NSArray, NSDictionary, CSFileProviderDomainMonitor, NSURL;
...
@property (weak) CSFileProviderDomainMonitor *fileProviderMonitor; // ivar: _fileProviderMonitor
