...
@property (readonly, nonatomic) BOOL allowMail; // ivar: _allowMail
@property (readonly, nonatomic) BOOL allowPhotosEntitledAttributes; // ivar: _allowPhotosEntitledAttributes
@property (readonly, nonatomic) BOOL allowPhotosLibraryDeletion; // ivar: _allowPhotosLibraryDeletion
@property (readonly, nonatomic) BOOL allowSpotlightEntitledAttributes; // ivar: _allowSpotlightEntitledAttributes
