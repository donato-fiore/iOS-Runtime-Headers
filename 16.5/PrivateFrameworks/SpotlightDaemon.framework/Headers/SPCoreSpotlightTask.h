...
@class NSString, NSMutableArray, NSSet, CSSearchQueryContext;
...
@property (copy, nonatomic) NSSet *knownBundleIds; // ivar: _knownBundleIds
...
@property (nonatomic) ? queryID; // ivar: _queryID
...
@property BOOL wasCanceledByClient; // ivar: _wasCanceledByClient
