...
@property (retain, nonatomic) NSMutableArray *obliviousConfigs; // ivar: _obliviousConfigs
...
@property (nonatomic) unsigned int preferredPathEnabledPercentage; // ivar: _preferredPathEnabledPercentage
...
-(id)obliviousConfigsAtIndex:(NSUInteger)arg0 ;
...
-(void)addObliviousConfigs:(id)arg0 ;
