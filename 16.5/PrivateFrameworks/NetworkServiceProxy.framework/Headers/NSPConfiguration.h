...
@class NSString, NSNumber, NSArray, NSDate, NSDictionary, NSURLSession;
...
@property (copy) NSNumber *epoch; // ivar: _epoch
@property (copy) NSString *etag; // ivar: _etag
@property (retain, nonatomic) NSString *geohashOverride; // ivar: _geohashOverride
@property (retain, nonatomic) NSNumber *geohashSharingEnabledStatus; // ivar: _geohashSharingEnabledStatus
@property (copy) NSNumber *hasSubscriberTierResetDate; // ivar: _hasSubscriberTierResetDate
@property BOOL ignoreInvalidCerts; // ivar: _ignoreInvalidCerts
@property (readonly) BOOL isDead;
@property (copy) NSNumber *persistMetrics; // ivar: _persistMetrics
@property (retain, nonatomic) NSNumber *preferredPathRoutingEnabledStatus; // ivar: _preferredPathRoutingEnabledStatus
@property (retain, nonatomic) NSURLSession *privacyProxyURLSession; // ivar: _privacyProxyURLSession
@property (retain, nonatomic) NSNumber *privateAccessTokensAllowTools; // ivar: _privateAccessTokensAllowTools
@property (retain, nonatomic) NSNumber *privateAccessTokensEnabledStatus; // ivar: _privateAccessTokensEnabledStatus
...
@property (copy) NSDate *subscriberTierResetDate; // ivar: _subscriberTierResetDate
