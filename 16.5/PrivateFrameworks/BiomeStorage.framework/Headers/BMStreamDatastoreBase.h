...
@class NSString;
@protocol BMSegmentManagerDelegate, BMFileManagerDelegate, BMStreamDatastorePruningDelegate;
...
@property (weak, nonatomic) NSObject<BMStreamDatastorePruningDelegate> *delegate; // ivar: _delegate
...
-(void)segmentManager:(id)arg0 willDeleteSegmentName:(id)arg1 frameStore:(id)arg2 ;
