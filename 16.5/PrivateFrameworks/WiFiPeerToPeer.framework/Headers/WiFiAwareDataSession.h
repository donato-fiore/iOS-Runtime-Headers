...
-(void)datapathUpdatedPeerRSSI:(int)arg0 ;
-(void)datapathUpdatedServiceSpecificInfo:(id)arg0 ;
-(void)generateCurrentNetworkRecordForInternetSharingSession:(id)arg0 ;
-(void)generateStatisticsReportWithCompletionHandler:(id)arg0 ;
-(void)handleError:(NSInteger)arg0 ;
-(void)reportIssue:(id)arg0 ;
-(void)resetState;
-(void)setWantsPeerRSSIUpdates:(BOOL)arg0 withCompletionHandler:(id)arg1 ;
-(void)start;
