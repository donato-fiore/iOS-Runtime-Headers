...
@class NSOperationQueue, NSLock, NSDictionary, NSOperation, NSArray, SUDownload, NSString;
@protocol STMSizeCacheDelegate, LSApplicationWorkspaceObserverProtocol;
