...
+(id)containersWithClass:(NSUInteger)arg0 ;
+(id)listOfUsedPathsInOverrides:(id)arg0 ;
+(id)sharedAppSizer;
-(id)addContainer:(id)arg0 ;
-(id)addContainers:(id)arg0 ;
-(id)addURL:(id)arg0 ;
-(id)addURL:(id)arg0 usingFastSizingIfPossible:(BOOL)arg1 ;
-(id)addURLs:(id)arg0 ;
-(id)addURLs:(id)arg0 usingFastSizingIfPossible:(BOOL)arg1 ;
