...
-(void)sendFileAttachmentURLs:(id)arg0 chat:(id)arg1 executionContext:(NSInteger)arg2 expressiveSendStyleID:(id)arg3 idsIdentifier:(id)arg4 sourceApplicationID:(id)arg5 sentMessages:(id)arg6 completion:(id)arg7 ;
-(void)sendLocalFileAttachmentURLs:(id)arg0 chat:(id)arg1 executionContext:(NSInteger)arg2 expressiveSendStyleID:(id)arg3 idsIdentifier:(id)arg4 sourceApplicationID:(id)arg5 sentMessages:(id)arg6 completion:(id)arg7 ;
-(void)sendLocationMessageToChat:(id)arg0 sourceApplicationID:(id)arg1 sentMessages:(id)arg2 completion:(id)arg3 ;
...
-(void)sendPhotoAssetMessageToChat:(id)arg0 executionContext:(NSInteger)arg1 expressiveSendStyleID:(id)arg2 idsIdentifier:(id)arg3 phAsset:(id)arg4 sentMessages:(id)arg5 sourceApplicationID:(id)arg6 completion:(id)arg7 ;
