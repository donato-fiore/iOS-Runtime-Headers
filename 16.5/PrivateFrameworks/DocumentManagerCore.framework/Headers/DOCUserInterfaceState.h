...
@class NSMutableDictionary, NSDate, NSData, NSString, NSDictionary, NSNumber;
...
@property (retain, nonatomic) NSString *selectedTabIdentifier; // ivar: _selectedTabIdentifier
