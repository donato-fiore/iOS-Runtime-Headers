...
@class NSString, NSData, NSOrderedSet, NSSet;
...
+(BOOL)canCopyReminderLosslesslyFromAccountWithType:(NSInteger)arg0 toAccountWithType:(NSInteger)arg1 accountTypeHost:(id)arg2 ;
+(BOOL)isCloudBasedAccountType:(NSInteger)arg0 ;
