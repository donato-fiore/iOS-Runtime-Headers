...
+(id)predicateDescriptorForRemindersWithDisplayDateBetween:(id)arg0 and:(id)arg1 ;
+(id)predicateDescriptorForRemindersWithDisplayDateOnOrAfter:(id)arg0 ;
+(id)predicateDescriptorForRemindersWithDisplayDateOnOrBefore:(id)arg0 ;
