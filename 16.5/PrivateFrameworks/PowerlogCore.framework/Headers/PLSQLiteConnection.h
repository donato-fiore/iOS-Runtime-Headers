...
@property (retain) PLSQLStatement *metadataStmt; // ivar: _metadataStmt
@property BOOL metadataStmtCreated; // ivar: _metadataStmtCreated
...
-(void)createCompositeIndexOnTable:(id)arg0 forColumns:(id)arg1 ;
...
-(void)writeMetadata:(id)arg0 forFKID:(id)arg1 build:(id)arg2 name:(id)arg3 version:(CGFloat)arg4 ;
