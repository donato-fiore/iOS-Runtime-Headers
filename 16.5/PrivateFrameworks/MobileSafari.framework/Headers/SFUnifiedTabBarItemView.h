...
@class UIButton, NSTimer, WBSFluidProgressController, NSMutableArray, NSMutableSet, NSMutableDictionary, NSString, UIImage, NSDate, UIView, UITextField, NSArray;
@protocol _SFFluidProgressViewDelegate, PKScribbleInteractionDelegate, PKScribbleInteractionElementSource, WBSFluidProgressStateSource, SFUnifiedTabBarItemViewDelegate, SFMenuConfiguring;
...
#import "SFUnreadIndicator.h"
#import "SFAvatarStackView.h"
...
@property (weak, nonatomic) NSObject<SFMenuConfiguring> *formatMenuButtonConfigurator; // ivar: _formatMenuButtonConfigurator
...
@property (nonatomic) NSInteger lockIconEdge;
...
@property (nonatomic) BOOL showsPinnedIndicator; // ivar: _showsPinnedIndicator
...
-(CGFloat)_scaleForTransitioningAccessoryButtonOfType:(NSInteger)arg0 ;
-(CGFloat)_spacingBetweenAccessoryButtonOfType:(NSInteger)arg0 andButtonOfType:(NSInteger)arg1 ;
-(CGFloat)_squishedInsetToHideCloseButton;
-(CGFloat)_squishedInsetToHideTrailingButtons;
...
-(void)_updateExtensionButtonConfigurationShowingOverflow:(BOOL)arg0 activeExtensionCount:(NSUInteger)arg1 ;
...
-(void)setFluidProgressController:(id)arg0 withStateSource:(id)arg1 ;
