...
@property (copy, nonatomic) NSData *sessionStateData; // ivar: _sessionStateData
...
@property (copy, nonatomic) NSString *tabGroupUUID; // ivar: _tabGroupUUID
...
@property (copy, nonatomic) NSString *userVisibleURL; // ivar: _userVisibleURL
