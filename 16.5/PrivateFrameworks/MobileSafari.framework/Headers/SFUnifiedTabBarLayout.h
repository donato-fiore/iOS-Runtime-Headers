...
@property (readonly, nonatomic) UIEdgeInsets autoScrollTouchInsets;
...
@property (readonly, nonatomic) CGRect pinnedItemsSeparatorFrame;
@property (readonly, nonatomic) CGFloat pinnedItemsSeparatorOpacity;
@property (readonly, nonatomic) NSIndexSet *visibleItemIndexes;
@property (readonly, nonatomic) NSArray *visibleItems;


+(NSUInteger)pinnedItemLimitForItemArrangement:(id)arg0 tabBarWidth:(CGFloat)arg1 barMetrics:(id)arg2 ;
...
-(CGFloat)_maximumActiveItemWidthForCenteringExpandedItem;
...
-(CGFloat)_offsetForPinnedItemAtIndex:(NSUInteger)arg0 ;
-(CGFloat)_pinnedActiveItemOffsetSquishingActiveItem:(BOOL)arg0 activeItemFrame:(struct CGRect *)arg1 ;
-(CGFloat)_spacingAfterItem:(id)arg0 ;
-(CGFloat)_spacingBeforeItem:(id)arg0 ;
-(CGFloat)_widthForItem:(id)arg0 ;
-(CGFloat)_zPositionForItem:(id)arg0 ;
-(NSUInteger)_indexOfItemClosestToPoint:(struct CGPoint )arg0 passingTest:(id)arg1 ;
...
-(id)itemClosestToPoint:(struct CGPoint )arg0 passingTest:(id)arg1 ;
...
-(struct CGRect )frameForPreviewingItem:(id)arg0 pinned:(BOOL)arg1 ;
