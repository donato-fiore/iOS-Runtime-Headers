...
@interface SFStartPageCustomizationViewController : UIViewController <SFStartPageBackgroundImageCellDelegate, SFStartPageCustomizationCellDelegate, UICollectionViewDelegate, PHPickerViewControllerDelegate, SFStartPageDataSourceObserving>

 {
    ...
    NSUInteger _reloadDataSuppressionCount;
...
@property (nonatomic) NSUInteger preferredBackgroundImagesCollectionViewColumnCount; // ivar: _preferredBackgroundImagesCollectionViewColumnCount
...
-(id)identifierToCustomizationItemMapForItemVariant:(NSInteger)arg0 ;
...
-(void)dealloc;
-(void)didChangeCustomizationItemOrder:(id)arg0 forVariant:(NSInteger)arg1 ;
...
-(void)setCustomizationItemIdentifier:(id)arg0 inSection:(id)arg1 enabled:(BOOL)arg2 ;
