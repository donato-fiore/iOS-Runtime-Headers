...
@class UIView, NSTimer, UIVisualEffectView, NSString;
...
@property (nonatomic) BOOL allowsHighlight; // ivar: _allowsHighlight
@property (nonatomic) CGFloat backgroundCornerRadius; // ivar: _backgroundCornerRadius
@property (nonatomic) CGFloat backgroundHeight; // ivar: _backgroundHeight
...
@property (nonatomic) NSUInteger directionalCollapsedContentEdge; // ivar: _directionalCollapsedContentEdge
...
-(BOOL)_shouldFadeNonKeyContentForContentView:(id)arg0 withPreviousContentView:(id)arg1 ;
-(BOOL)_usesMinimizedTheme;
-(NSUInteger)_accessoryEdge;
-(NSUInteger)_collapsedContentInsetEdge;
...
-(void)allowsHighlight:(BOOL)arg0 ;
-(void)applyTheme;
-(void)layoutSubviews;
