...
@class UIViewController, WBSStartPageSection, UICollectionViewDiffableDataSource, UICollectionView, UIVisualEffectView, UIView, UITapGestureRecognizer, NSMapTable, NSString, UIScrollView;
@protocol UICollectionViewDelegate, UIGestureRecognizerDelegate, UICollectionViewDragDelegate_Private, UICollectionViewDropDelegate_Private, SFStartPageDataSourceObserving, SFStartPageVisualStyleProviding, SFStartPageCollectionDataSource, SFStartPageCollectionDelegate><WBSStartPagePreviewProviding;
...
@interface SFStartPageCollectionViewController : UIViewController <UICollectionViewDelegate, UIGestureRecognizerDelegate, UICollectionViewDragDelegate_Private, UICollectionViewDropDelegate_Private, SFStartPageDataSourceObserving>

 {
    ...
    NSInteger _lastLayoutOrientation;
...
@property (weak, nonatomic) NSObject<SFStartPageCollectionDelegate><WBSStartPagePreviewProviding> *delegate; // ivar: _delegate
