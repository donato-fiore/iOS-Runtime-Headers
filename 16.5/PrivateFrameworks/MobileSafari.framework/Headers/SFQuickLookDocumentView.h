...
@protocol UIDragInteractionDelegate, UIDragInteractionDelegate_Private, SFQuickLookDocumentViewDelegate;


#import "SFQuickLookDocumentInfoView.h"
...
@property (weak, nonatomic) NSObject<SFQuickLookDocumentViewDelegate> *quickLookDocumentViewDelegate; // ivar: _quickLookDocumentViewDelegate
