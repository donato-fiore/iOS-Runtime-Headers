...
@property (retain, nonatomic) NSMutableArray *badgeModelFilenames; // ivar: _badgeModelFilenames
...
@property (nonatomic) NSInteger earnedInstanceCount; // ivar: _earnedInstanceCount
...
@property (nonatomic) CGFloat glyphPositionOffsetX; // ivar: _glyphPositionOffsetX
@property (nonatomic) CGFloat glyphPositionOffsetY; // ivar: _glyphPositionOffsetY
@property (retain, nonatomic) NSString *glyphTextureFilename; // ivar: _glyphTextureFilename
...
@property (retain, nonatomic) ACHCodableEarnedInstance *relevantEarnedInstance; // ivar: _relevantEarnedInstance
...
@property (retain, nonatomic) NSMutableArray *textureFilenames; // ivar: _textureFilenames
...
-(NSUInteger)hash;
-(id)badgeModelFilenamesAtIndex:(NSUInteger)arg0 ;
...
-(id)textureFilenamesAtIndex:(NSUInteger)arg0 ;
-(void)addBadgeModelFilenames:(id)arg0 ;
-(void)addCustomPlaceholderValues:(id)arg0 ;
-(void)addEarnedInstances:(id)arg0 ;
-(void)addTextureFilenames:(id)arg0 ;
