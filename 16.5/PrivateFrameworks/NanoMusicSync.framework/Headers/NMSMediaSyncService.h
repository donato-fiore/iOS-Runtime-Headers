...
-(BOOL)_sendUrgentServiceResponseWithError:(id)arg0 idsMessageID:(id)arg1 timeout:(CGFloat)arg2 ;
-(BOOL)_sendUrgentServiceResultMessage:(id)arg0 idsMessageID:(id)arg1 timeout:(CGFloat)arg2 ;
...
-(id)_sendUrgentMessage:(id)arg0 messageType:(NSInteger)arg1 timeout:(CGFloat)arg2 completion:(id)arg3 ;
-(id)_sendUrgentProtoBufForMessage:(id)arg0 messageType:(NSInteger)arg1 timeout:(CGFloat)arg2 error:(*id)arg3 ;
-(id)init;
...
-(void)_callAndRemoveKeepLocalCompletionWithIDSMessageID:(id)arg0 error:(id)arg1 ;
-(void)_cleanupKeepLocalCompletionWithID:(id)arg0 ;
