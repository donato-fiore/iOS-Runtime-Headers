...
@protocol SCWOperationThrottlerDelegate, NSFilePresenter, SCWDatabaseStoreCoordinator, SCWDatabaseStore, OS_dispatch_queue, OS_dispatch_source, SCWOperationThrottler;
...
@property (retain, nonatomic) SCWDatabaseSchema *databaseSchema; // ivar: _databaseSchema
...
@property (retain, nonatomic) NSObject<SCWOperationThrottler> *saveThrottler; // ivar: _saveThrottler
...
-(id)initWithSchema:(id)arg0 fileURL:(id)arg1 allowedCommandClasses:(id)arg2 ;
-(id)initWithSchema:(id)arg0 parentDirectoryURL:(id)arg1 ;
-(id)initWithSchema:(id)arg0 parentDirectoryURL:(id)arg1 allowedCommandClasses:(id)arg2 ;
