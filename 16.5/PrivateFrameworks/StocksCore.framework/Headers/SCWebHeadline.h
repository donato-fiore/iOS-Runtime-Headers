...
@class NSString, NSArray, FCAssetHandle, NSData, NSURL, FCCoverArt, NSDate, FCHeadlineExperimentalTitleMetadata, COMAPPLEFELDSPARPROTOCOLLIVERPOOLArticleContentExpiration, COMAPPLEFELDSPARPROTOCOLLIVERPOOLCohortList, COMAPPLEFELDSPARPROTOCOLLIVERPOOLConversionStats, FCArticleAudioTrack, FCIssue, COMAPPLEFELDSPARPROTOCOLLIVERPOOLTagMetadata, FCFeedPersonalizedItemScoreProfile, FCTopStoriesStyleConfiguration, FCHeadlineThumbnail, FCColor;
