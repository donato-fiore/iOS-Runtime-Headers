...
@class NSString, WiFiAwarePublisher, WiFiAwareDataSession, WiFiAwarePublisherDataSessionHandle;
...
@property (readonly, nonatomic) WiFiAwareDataSession *wfaDataSessionClient; // ivar: _wfaDataSessionClient
