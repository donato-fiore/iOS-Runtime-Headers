...
-(BOOL)contentFilterOverriddenWhiteListContainsURL:(id)arg0 withAppleAllowList:(id)arg1 ;
...
-(id)contentFilterOverriddenWhiteListedSitesBufferWithAdditionalURLStrings:(id)arg0 ;
