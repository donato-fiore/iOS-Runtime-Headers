...
@property (readonly, nonatomic) BOOL isSplat; // ivar: _isSplat
...
@property (readonly, copy, nonatomic) NSString *supplementalBuild; // ivar: _supplementalBuild
@property (readonly, copy, nonatomic) NSString *supplementalVersionExtra; // ivar: _supplementalVersionExtra
...
-(id)initWithProductKey:(id)arg0 humanReadableName:(id)arg1 productName:(id)arg2 version:(id)arg3 build:(id)arg4 downloadSize:(NSUInteger)arg5 installSize:(NSUInteger)arg6 isCritical:(BOOL)arg7 restartRequired:(BOOL)arg8 allowsInstallLater:(BOOL)arg9 isSplat:(BOOL)arg10 supplementalBuild:(id)arg11 supplementalVersionExtra:(id)arg12 ;
