...
@class NSString, NSUUID, AFBulletin, NSArray, NSDictionary, AFApplicationContext, NSNumber, NSMutableArray, SASPronunciationContext, AFRequestInfo, NSURL, AFSpeechRequestOptions;
...
@property (copy, nonatomic) NSUUID *activationEventInstrumentationIdenifier; // ivar: _activationEventInstrumentationIdenifier
