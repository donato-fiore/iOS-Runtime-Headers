...
@class NSMutableSet, CXCallObserver, CARAutomaticDNDStatus, CARSessionStatus, NSArray, NSString, FBSDisplayLayoutMonitor, NSHashTable, AFNotifyObserver;
...
@property (nonatomic) BOOL liftToWakeDetected; // ivar: _liftToWakeDetected
...
@property (retain, nonatomic) AFNotifyObserver *remoteWebcamModeEnabled; // ivar: _remoteWebcamModeEnabled
...
-(BOOL)carDNDActive;
-(BOOL)carDNDActiveOrEyesFreeAndShouldHaveFullScreenPresentation:(BOOL)arg0 ;
