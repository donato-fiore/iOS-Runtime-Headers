...
#import "SASActivationInstrumentation.h"
...
-(void)buttonDownFromButtonIdentifier:(id)arg0 timestamp:(id)arg1 context:(id)arg2 ;
-(void)buttonLongPressFromButtonIdentifier:(id)arg0 context:(id)arg1 ;
-(void)buttonTapFromButtonIdentifier:(id)arg0 timestamp:(id)arg1 context:(id)arg2 ;
-(void)buttonUpFromButtonIdentifier:(id)arg0 deviceIdentifier:(id)arg1 timestamp:(id)arg2 context:(id)arg3 ;
