...
-(void)_presentationsLock_broadcastPresentationStateForIdentifier:(id)arg0 presentationState:(id)arg1 presentationIdentifiersToInform:(id)arg2 ;
...
-(void)presentationDidUpdateState:(id)arg0 ;
...
// -(void)sendButtonEventCompletionToPresentations:(id)arg0 forButtonEventType:(unk)arg1  ;
