...
-(?)applyL3:(?)arg0 srcCrushPQ:(?)arg1 srcMidPQsrcClipPQ;
-(?)applyL9;
-(?)createTmLutsEx:(?)arg0 tLutS:(?)arg1 sLutI:(?)arg2 sLutS:(?)arg3 tLutISize:(?)arg4 tLutSSize:(?)arg5 sLutISize:(?)arg6 sLutSSize:(?)arg7 config:(?)arg8 TmParam:(?)arg9 EdrAdaptationParam:(?)arg10 AmbAdaptationParam:(?)arg11 IsDoVi84HlgOOTFCombined;
-(?)createToneCurve:(?)arg0 srcMaxPQ:(?)arg1 tgtMinPQ:(?)arg2 tgtMaxPQ:(?)arg3 srcCrushPQ:(?)arg4 srcMidPQ:(?)arg5 srcClipPQ:(?)arg6 targetMaxLinear:(?)arg7 DM_MetaData:(?)arg8 tcCtrlusePseudoTrim;
-(?)debugDMMetaData2;
-(?)debugDMMetaData8;
-(?)debugTrimData2;
-(?)debugTrimData8;
...
-(BOOL)GetPrimaries:(unsigned int)arg0 Primaries:(*int)arg1 Count:(int)arg2 ;
-(float)applyL8Trim:(float)arg0 ;
...
-(void)initOutputColorPrimaries:(unsigned int)arg0 ;
-(void)initToneMapMatrices:(*float)arg0 tgtRgb2LmsTm:(*float)arg1 ;
-(void)initToneMapMatrices:(unsigned int)arg0 outbits:(unsigned int)arg1 srcRgb2LmsTm:(*float)arg2 tgtRgb2LmsTm:(*float)arg3 ;
