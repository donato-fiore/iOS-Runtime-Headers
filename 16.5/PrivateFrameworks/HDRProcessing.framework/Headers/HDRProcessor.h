...
@interface HDRProcessor : NSObject {
    ...
    *EDRMetaData_RBSP _parser;
    ? _edrMetaData;
    *HDR10PlusMetaData_RBSP _hdr10PlusMetaDataParser;
    ? _hdr10PlusMetaData;
    ...
    NSUInteger _numberOfComputedFrames;
...
+(?)parseHDR10PlusSEIMessageoutputMetadata;
+(?)parseHDR10PlusSEIWithInputSurfaceoutputMetadata;
+(?)parseHDR10PlusSEIoutputMetadata;
...
-(?)setHDRControl:(?)arg0 withTCControl:(?)arg1 withRPU:(?)arg2 withMMR:(?)arg3 withDmDatawithOperation;
...
-(NSInteger)updateDoVi81StateWithRPU:(BOOL)arg0 hasHDR10PlusSEIData:(BOOL)arg1 ;
