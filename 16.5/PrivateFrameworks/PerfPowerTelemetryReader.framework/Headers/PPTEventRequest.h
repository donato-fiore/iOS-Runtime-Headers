...
@property (readonly) NSUInteger readDirection; // ivar: _readDirection
...
-(id)initWithMetrics:(id)arg0 predicate:(id)arg1 timeFilter:(id)arg2 limitCount:(NSUInteger)arg3 offsetCount:(NSUInteger)arg4 readDirection:(NSUInteger)arg5 ;
