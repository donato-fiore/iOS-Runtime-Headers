...
+(BOOL)_canLoadMetadataForActivityItem:(id)arg0 ;
...
+(id)_loadMetadataForActivityItem:(id)arg0 activityViewController:(id)arg1 ;
+(id)_openURLAnnotationForActivityItem:(id)arg0 activityType:(id)arg1 ;
+(id)_originalActivityItemForActivityItem:(id)arg0 ;
