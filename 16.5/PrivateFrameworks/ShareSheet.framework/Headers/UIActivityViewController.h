...
@class UIViewController, NSArray, NSNumber, NSString, NSDictionary, NSURL, NSSet, LPLinkMetadata, NSUserDefaults;
@protocol SHSheetPresenterDelegate, UIActivityViewControllerAirDropDelegate, UIActivityItemsConfigurationReading, SHSheetPresenter, UIActivityViewControllerObjectManipulationDelegate, UIActivityViewControllerPhotosDelegate;
...
@property (retain, nonatomic) NSObject<UIActivityItemsConfigurationReading> *cachedActivityItemsConfiguration; // ivar: _cachedActivityItemsConfiguration
...
@property (nonatomic) CGFloat customViewControllerSectionHeight;
@property (retain, nonatomic) NSNumber *customViewControllerSectionHeightWrapper; // ivar: _customViewControllerSectionHeightWrapper
...
@property (readonly, nonatomic) NSObject<SHSheetPresenter> *mainPresenter; // ivar: _mainPresenter
...
-(id)initWithActivityItems:(id)arg0 applicationActivities:(id)arg1 peopleSuggestionBundleIds:(id)arg2 ;
