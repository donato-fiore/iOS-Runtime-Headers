...
@property (retain, nonatomic) NSArray *hostHiddenActivityConfigurations; // ivar: _hostHiddenActivityConfigurations
...
@property (nonatomic) BOOL useSlotsForPeopleSuggestions; // ivar: _useSlotsForPeopleSuggestions
