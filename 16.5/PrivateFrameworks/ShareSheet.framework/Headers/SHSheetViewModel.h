...
@class NSArray, NSDictionary, SLCollaborationFooterViewModel, NSString, UIColor, NSAttributedString, UIViewController, NSNumber;
...
@property (retain, nonatomic) NSString *collaborationModeTitle; // ivar: _collaborationModeTitle
...
-(id)_collaborationModeTitleForCollaborationItem:(id)arg0 ;
