...
+(BOOL)isLocaleDownloadSupported:(id)arg0 ;
+(BOOL)isLocaleEmbedded:(id)arg0 ;
+(BOOL)validateLanguageCode:(id)arg0 ;
+(NSInteger)deliveryMethodForLocale:(id)arg0 ;
...
+(id)SupportedLocales;
+(id)bcpStringForComponentArray:(id)arg0 ;
+(id)bcpStringForLocale:(id)arg0 ;
...
-(id)getMorphunDataPathForLocale:(id)arg0 withError:(*id)arg1 ;
-(id)init;
-(id)listSubscriptions;
-(id)processSubscriptions;
-(id)referenceCountsFromSubscriptionView;
-(void)downloadLocaleIfNeeded:(id)arg0 withCompletion:(id)arg1 ;
