...
#import "TVRMSPowerAssertion.h"
#import "TVRMSRunAssertion.h"

@interface _RMSSessionRecord : NSObject

@property (retain, nonatomic) TVRMSPowerAssertion *powerAssertion; // ivar: _powerAssertion
@property (nonatomic) int refreshCount; // ivar: _refreshCount
@property (retain, nonatomic) TVRMSRunAssertion *runAssertion; // ivar: _runAssertion
