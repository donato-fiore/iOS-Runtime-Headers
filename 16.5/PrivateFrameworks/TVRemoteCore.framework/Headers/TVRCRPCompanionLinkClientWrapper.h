...
@class NSDictionary, RPCompanionLinkClient, NSString, RPCompanionLinkDevice, RPHIDSession, RPHIDTouchSession, RPSiriSession, RPTextInputSession;
@protocol RPSiriSessionDelegate, _TVRCCompanionLinkClientWrapperDelegate;
...
@property (nonatomic) NSInteger attentionState; // ivar: _attentionState
...
@property (copy, nonatomic) id *invalidationCompletionBlock; // ivar: _invalidationCompletionBlock
@property (nonatomic) BOOL isInvalidating; // ivar: _isInvalidating
@property (retain, nonatomic) TVRCRapportMediaEventsManager *mediaManager; // ivar: _mediaManager
@property (readonly, copy, nonatomic) NSString *model;
@property (readonly, copy, nonatomic) NSString *name;
@property (nonatomic) BOOL pttFeatureSupported; // ivar: _pttFeatureSupported
...
-(void)_logError:(id)arg0 name:(id)arg1 ;
...
-(void)_updateAttentionState:(NSInteger)arg0 ;
