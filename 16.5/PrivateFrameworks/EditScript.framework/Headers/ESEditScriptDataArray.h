...
#ifndef ESEDITSCRIPTDATAARRAY_H
#define ESEDITSCRIPTDATAARRAY_H
...
-(NSInteger)indexOfFirstDifferenceWithOtherData:(id)arg0 shouldReverseIterate:(BOOL)arg1 fallsOnWordBoundary:(*BOOL)arg2 ;
-(NSInteger)length;
