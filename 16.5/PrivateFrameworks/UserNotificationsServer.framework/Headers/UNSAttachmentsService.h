...
-(id)_queue_resolveAttachmentsForRequest:(id)arg0 bundleIdentifier:(id)arg1 fromLocalClientConnection:(id)arg2 orFromServiceExtensionOfBundleProxy:(id)arg3 continueOnFailure:(BOOL)arg4 error:(*id)arg5 ;
-(id)_queue_resolvedFileURLForNotificationAttachment:(id)arg0 request:(id)arg1 bundleIdentifier:(id)arg2 fromLocalClientConnection:(id)arg3 orFromServiceExtensionOfBundleProxy:(id)arg4 error:(*id)arg5 ;
-(id)_queue_resolvedURLForNotificationAttachment:(id)arg0 request:(id)arg1 bundleIdentifier:(id)arg2 fromLocalClientConnection:(id)arg3 orFromServiceExtensionOfBundleProxy:(id)arg4 error:(*id)arg5 ;
-(id)_queue_validatedRepositoryURLForNotificationAttachment:(id)arg0 request:(id)arg1 bundleIdentifier:(id)arg2 fromLocalClientConnection:(id)arg3 orFromServiceExtensionOfBundleProxy:(id)arg4 error:(*id)arg5 ;
...
-(id)resolveAttachmentsForRequest:(id)arg0 bundleIdentifier:(id)arg1 fromLocalClientConnection:(id)arg2 error:(*id)arg3 ;
-(id)resolveAttachmentsSkippingErrorsForRequest:(id)arg0 bundleIdentifier:(id)arg1 fromBundleProxyForServiceExtension:(id)arg2 ;
