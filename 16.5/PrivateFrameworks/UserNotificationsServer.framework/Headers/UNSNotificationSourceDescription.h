...
@property (nonatomic) BOOL allowAlternateLaunchBundleIdentifiers; // ivar: _allowAlternateLaunchBundleIdentifiers
...
@property (nonatomic) BOOL supportsProvisionalAlerts; // ivar: _supportsProvisionalAlerts
