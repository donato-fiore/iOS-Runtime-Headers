...
@class UIImage, UIWindowScene, NSArray, NSString;
@protocol SAUILayoutObserving, BSDescriptionProviding, SAElementIdentifying, SAElement;
...
@property (readonly, nonatomic) NSObject<SAElement> *_existingSystemApertureElement;
...
@property (retain, nonatomic, setter=_setPreferredActivationWindowScene:) UIWindowScene *_preferredActivationWindowScene; // ivar: __preferredActivationWindowScene
@property (nonatomic, setter=_setPresentationState:) NSUInteger _presentationState; // ivar: _presentationState
@property (nonatomic) BOOL allowDuringTransitionAnimations; // ivar: _allowDuringTransitionAnimations
