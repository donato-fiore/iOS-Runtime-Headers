...
@property (retain, nonatomic) AXMBrailleEdgeDetectorOptions *brailleEdgeOptions; // ivar: _brailleEdgeOptions
...
@property (nonatomic) BOOL detectBrailleEdges; // ivar: _detectBrailleEdges
