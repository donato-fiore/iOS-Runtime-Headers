...
@property (copy, nonatomic) id *lookupContextFetchingBlock; // ivar: _lookupContextFetchingBlock
...
@property (copy, nonatomic) id *reportAnIssueExtendedBlock; // ivar: _reportAnIssueExtendedBlock
