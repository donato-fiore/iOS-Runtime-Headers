...
@property (copy, nonatomic) NSString *exactVersionString; // ivar: _exactVersionString
...
-(id)initWithStarting:(BOOL)arg0 bundleID:(id)arg1 absoluteTimeStamp:(CGFloat)arg2 duration:(CGFloat)arg3 launchReason:(id)arg4 launchType:(NSUInteger)arg5 parentBundleID:(id)arg6 extensionHostID:(id)arg7 shortVersionString:(id)arg8 exactBundleVersion:(id)arg9 ;
...
-(id)initWithStarting:(BOOL)arg0 bundleID:(id)arg1 absoluteTimeStamp:(CGFloat)arg2 launchReason:(id)arg3 launchType:(NSUInteger)arg4 parentBundleID:(id)arg5 extensionHostID:(id)arg6 shortVersionString:(id)arg7 exactBundleVersion:(id)arg8 ;
