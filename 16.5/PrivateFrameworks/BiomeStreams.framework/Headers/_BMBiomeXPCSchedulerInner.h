...
@property (retain, nonatomic) BMBookmarkStorage *bookmarkStorage; // ivar: _bookmarkStorage
...
-(void)switchToPublisherWithStreamIdentifier:(id)arg0 storeEvent:(id)arg1 ;
