...
@property (readonly, copy, nonatomic) NSString *interactionId; // ivar: _interactionId
...
-(id)initWithTaskID:(id)arg0 taskStep:(NSUInteger)arg1 statusReason:(id)arg2 slotValue:(id)arg3 intentName:(id)arg4 appBundleId:(id)arg5 interactionId:(id)arg6 ;
-(id)initWithTaskID:(id)arg0 taskStep:(NSUInteger)arg1 statusReason:(id)arg2 slotValue:(id)arg3 intentName:(id)arg4 appBundleId:(id)arg5 interactionId:(id)arg6 absoluteTimestamp:(CGFloat)arg7 ;
-(id)proto;
-(id)serialize;
