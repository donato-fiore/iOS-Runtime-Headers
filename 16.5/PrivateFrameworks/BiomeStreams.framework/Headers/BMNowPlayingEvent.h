...
@property (readonly, nonatomic) NSString *iTunesAlbumIdentifier; // ivar: _iTunesAlbumIdentifier
@property (readonly, nonatomic) NSString *iTunesArtistIdentifier; // ivar: _iTunesArtistIdentifier
...
@property (readonly, nonatomic) BOOL isRemoteControl; // ivar: _isRemoteControl
@property (readonly, nonatomic) int itemMediaSubtype; // ivar: _itemMediaSubtype
@property (readonly, nonatomic) int itemMediaType; // ivar: _itemMediaType
...
-(id)initWithDKEvent:(id)arg0 outputDevices:(id)arg1 iTunesArtistIdentifier:(id)arg2 iTunesAlbumIdentifier:(id)arg3 ;
-(id)initWithProto:(id)arg0 ;
-(id)initWithProtoData:(id)arg0 ;
-(id)initWithUniqueID:(id)arg0 bundleID:(id)arg1 absoluteTimestamp:(CGFloat)arg2 playbackState:(NSUInteger)arg3 album:(id)arg4 artist:(id)arg5 duration:(unsigned int)arg6 genre:(id)arg7 title:(id)arg8 elapsed:(unsigned int)arg9 mediaType:(id)arg10 iTunesStoreIdentifier:(id)arg11 iTunesSubscriptionIdentifier:(id)arg12 iTunesArtistIdentifier:(id)arg13 iTunesAlbumIdentifier:(id)arg14 isAirPlayVideo:(BOOL)arg15 outputDevices:(id)arg16 ;
-(id)initWithUniqueID:(id)arg0 bundleID:(id)arg1 absoluteTimestamp:(CGFloat)arg2 playbackState:(NSUInteger)arg3 album:(id)arg4 artist:(id)arg5 duration:(unsigned int)arg6 genre:(id)arg7 title:(id)arg8 elapsed:(unsigned int)arg9 mediaType:(id)arg10 iTunesStoreIdentifier:(id)arg11 iTunesSubscriptionIdentifier:(id)arg12 isAirPlayVideo:(BOOL)arg13 outputDevices:(id)arg14 ;
-(id)initWithUniqueID:(id)arg0 bundleID:(id)arg1 absoluteTimestamp:(CGFloat)arg2 playbackState:(NSUInteger)arg3 album:(id)arg4 artist:(id)arg5 duration:(unsigned int)arg6 genre:(id)arg7 title:(id)arg8 elapsed:(unsigned int)arg9 mediaType:(id)arg10 itemMediaType:(int)arg11 itemMediaSubtype:(int)arg12 iTunesStoreIdentifier:(id)arg13 iTunesSubscriptionIdentifier:(id)arg14 iTunesArtistIdentifier:(id)arg15 iTunesAlbumIdentifier:(id)arg16 groupIdentifier:(id)arg17 isAirPlayVideo:(BOOL)arg18 isRemoteControl:(BOOL)arg19 outputDevices:(id)arg20 ;
-(id)proto;
-(id)serialize;
