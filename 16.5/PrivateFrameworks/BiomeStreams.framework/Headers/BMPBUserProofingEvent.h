...
@property (retain, nonatomic) NSString *gestureAssessment; // ivar: _gestureAssessment
...
@property (retain, nonatomic) NSString *livenessAssessment; // ivar: _livenessAssessment
