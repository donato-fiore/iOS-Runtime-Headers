...
@property (nonatomic) BOOL rapidSecurityResponsePreReboot; // ivar: _rapidSecurityResponsePreReboot
@property (retain, nonatomic) NSString *supplementalBuild; // ivar: _supplementalBuild
