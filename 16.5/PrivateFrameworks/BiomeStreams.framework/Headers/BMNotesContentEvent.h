...
-(id)initWithUniqueId:(id)arg0 domainId:(id)arg1 absoluteTimestamp:(CGFloat)arg2 title:(id)arg3 content:(id)arg4 ;
-(id)initWithUniqueId:(id)arg0 domainId:(id)arg1 absoluteTimestamp:(CGFloat)arg2 title:(id)arg3 content:(id)arg4 contentProtection:(id)arg5 ;
-(id)json;
-(id)jsonDict;
-(id)proto;
-(id)serialize;
