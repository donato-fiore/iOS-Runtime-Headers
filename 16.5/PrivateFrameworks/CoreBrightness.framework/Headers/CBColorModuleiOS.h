...
@protocol CBContainerProtocol, CBHIDServiceProtocol, NightShiftSupportProtocol, CBStatusInfoProtocol, CBAODProtocol, OS_dispatch_source, CBBrightnessProxy;
...
-(BOOL)applySamples:(id)arg0 withinTimeout:(float)arg1 ;
...
-(BOOL)displayPresetHarmonyHandler:(id)arg0 ;
