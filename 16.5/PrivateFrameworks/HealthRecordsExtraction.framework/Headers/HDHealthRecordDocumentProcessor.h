...
-(id)compareExistingPatientResourceData:(id)arg0 incomingPatientResourceData:(id)arg1 error:(*id)arg2 ;
-(id)extractAttachmentContentFromFHIRResource:(id)arg0 error:(*id)arg1 ;
