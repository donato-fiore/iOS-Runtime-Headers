...
+(NSUInteger)_immediateNotificationAssetThresholdToUseWithPhotoLibrary:(id)arg0 ;
+(id)_computeCountOfContributedAssetsTrashedByOtherParticipantsSinceLastNotificationDateInLibraryScope:(id)arg0 outPhotoCount:(*NSUInteger)arg1 outVideoCount:(*NSUInteger)arg2 outItemCount:(*NSUInteger)arg3 ;
+(id)_libraryForEnumerationFromBundle:(id)arg0 withName:(char *)arg1 ;
+(id)_nearestDateSetToHour:(NSInteger)arg0 minute:(NSInteger)arg1 ;
...
+(void)informRapportToRemoveShareParticipantUUIDs:(id)arg0 photoLibraryBundle:(id)arg1 ;
...
-(BOOL)incrementallyDeleteAndSaveWithError:(*id)arg0 ;
-(BOOL)isSyncableChange;
-(BOOL)libraryScopeIsActive;
-(BOOL)removePeopleRulesForPersonUUID:(id)arg0 ;
...
-(id)cplFullRecord;
-(id)cplScopeChange;
-(id)markOnboardingPreviewAssetsByProcessingRulesWithExcludePersonUUIDs:(id)arg0 completionHandler:(id)arg1 ;
