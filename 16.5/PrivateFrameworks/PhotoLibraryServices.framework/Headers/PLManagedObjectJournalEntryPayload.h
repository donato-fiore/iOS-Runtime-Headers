...
@protocol PLManagedObjectJournalEntryPayloadClass, PLJournalEntryPayloadID;
...
-(id)encodedDataForUUIDStringArray:(id)arg0 ;
-(id)encodedDataForUUIDStringOrderedSet:(id)arg0 ;
-(id)encodedDataForUUIDStringSet:(id)arg0 ;
-(id)initWithInsertAdapter:(id)arg0 changedKeys:(id)arg1 ;
...
-(id)rawPayloadAttributeForKey:(id)arg0 ;
...
-(void)setRawPayloadAttribute:(id)arg0 forKey:(id)arg1 ;
-(void)setRawPayloadAttributes:(id)arg0 ;
-(void)updatePayloadAttributes:(id)arg0 andNilAttributes:(id)arg1 forPayloadProperty:(id)arg2 withUUIDStringData:(id)arg3 ;
