...
+(BOOL)_shouldRecordCloudDeletionForShare:(id)arg0 ;
+(BOOL)incrementallyDeleteAndSaveShares:(id)arg0 logMessagePrefix:(id)arg1 error:(*id)arg2 ;
...
+(BOOL)validateCPLScopeChange:(id)arg0 ;
...
+(id)shareWithScopeIdentifiers:(id)arg0 includeTrashed:(BOOL)arg1 inManagedObjectContext:(id)arg2 ;
...
+(void)deleteOldTrashedSharesInManagedObjectContext:(id)arg0 ;
