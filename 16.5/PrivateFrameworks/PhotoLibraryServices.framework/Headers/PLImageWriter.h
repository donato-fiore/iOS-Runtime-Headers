...
@interface PLImageWriter : NSObject {
    ...
    NSUInteger _crashRecoveryCounter;
    ...
    atomic_flag _isCrashRecoveryJobInProgress;
}
...
+(BOOL)_requiresCrashRecoveryForJobType:(id)arg0 ;
...
-(BOOL)_retryPairedVideoJob:(id)arg0 pairingType:(id)arg1 pairingIdentifier:(id)arg2 retryMax:(NSUInteger)arg3 ;
...
-(void)_copyJobContentsToHoldingDirectoryWithUUID:(id)arg0 incomingPath:(id)arg1 job:(id)arg2 ;
...
-(void)delayJob:(id)arg0 delay:(NSInteger)arg1 ;
