...
-(id)dumpPrefixStringsForAssetUUID:(id)arg0 indexCategories:(id)arg1 ;
-(id)dumpPrefixStringsWithIndexCategories:(id)arg0 ;
...
-(id)meNodeIdentifier;
-(id)newQueryWithSearchText:(id)arg0 queryTokens:(id)arg1 useWildcardSearchText:(BOOL)arg2 libraryScope:(NSUInteger)arg3 ;
...
-(void)performSyncOnDBQueue:(id)arg0 ;
