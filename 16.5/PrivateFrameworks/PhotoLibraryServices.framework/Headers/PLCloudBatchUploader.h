...
-(BOOL)_hasUnuploadedResourceForAsset:(id)arg0 resourceType:(NSUInteger)arg1 cloudMaster:(id)arg2 ;
...
-(void)_handleSharingChanges:(id)arg0 forUploadEvent:(id)arg1 inManagedObjectContext:(id)arg2 ;
