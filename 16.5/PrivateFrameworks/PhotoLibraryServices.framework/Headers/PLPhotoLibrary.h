...
+(void)_abortFromMocExecFail_NSMOC_SQLITE_ABORT_4_withCode:(int)arg0 ;
+(void)_abortFromMocExecFail_NSMOC_SQLITE_AUTH_23_withCode:(int)arg0 ;
+(void)_abortFromMocExecFail_NSMOC_SQLITE_BUSY_5_withCode:(int)arg0 ;
+(void)_abortFromMocExecFail_NSMOC_SQLITE_CANTOPEN_14_withCode:(int)arg0 ;
+(void)_abortFromMocExecFail_NSMOC_SQLITE_CONSTRAINT_19_withCode:(int)arg0 ;
+(void)_abortFromMocExecFail_NSMOC_SQLITE_CORRUPT_11_withCode:(int)arg0 ;
+(void)_abortFromMocExecFail_NSMOC_SQLITE_DONE_101_withCode:(int)arg0 ;
+(void)_abortFromMocExecFail_NSMOC_SQLITE_EMPTY_16_withCode:(int)arg0 ;
+(void)_abortFromMocExecFail_NSMOC_SQLITE_ERROR_1_SQLITE_ERROR_SNAPSHOT_769_withCode:(int)arg0 ;
+(void)_abortFromMocExecFail_NSMOC_SQLITE_ERROR_1_withCode:(int)arg0 ;
+(void)_abortFromMocExecFail_NSMOC_SQLITE_FORMAT_24_withCode:(int)arg0 ;
+(void)_abortFromMocExecFail_NSMOC_SQLITE_FULL_13_withCode:(int)arg0 ;
+(void)_abortFromMocExecFail_NSMOC_SQLITE_INTERNAL_2_withCode:(int)arg0 ;
+(void)_abortFromMocExecFail_NSMOC_SQLITE_INTERRUPT_9_withCode:(int)arg0 ;
+(void)_abortFromMocExecFail_NSMOC_SQLITE_IOERR_10_withCode:(int)arg0 ;
+(void)_abortFromMocExecFail_NSMOC_SQLITE_LOCKED_6_withCode:(int)arg0 ;
+(void)_abortFromMocExecFail_NSMOC_SQLITE_MISMATCH_20_withCode:(int)arg0 ;
+(void)_abortFromMocExecFail_NSMOC_SQLITE_MISUSE_21_withCode:(int)arg0 ;
+(void)_abortFromMocExecFail_NSMOC_SQLITE_NOLFS_22_withCode:(int)arg0 ;
+(void)_abortFromMocExecFail_NSMOC_SQLITE_NOMEM_7_withCode:(int)arg0 ;
+(void)_abortFromMocExecFail_NSMOC_SQLITE_NOTADB_26_withCode:(int)arg0 ;
+(void)_abortFromMocExecFail_NSMOC_SQLITE_NOTFOUND_12_withCode:(int)arg0 ;
+(void)_abortFromMocExecFail_NSMOC_SQLITE_NOTICE_27_withCode:(int)arg0 ;
+(void)_abortFromMocExecFail_NSMOC_SQLITE_OTHER_withCode:(int)arg0 ;
+(void)_abortFromMocExecFail_NSMOC_SQLITE_PERM_3_withCode:(int)arg0 ;
+(void)_abortFromMocExecFail_NSMOC_SQLITE_PROTOCOL_15_withCode:(int)arg0 ;
+(void)_abortFromMocExecFail_NSMOC_SQLITE_RANGE_25_withCode:(int)arg0 ;
+(void)_abortFromMocExecFail_NSMOC_SQLITE_READONLY_8_withCode:(int)arg0 ;
+(void)_abortFromMocExecFail_NSMOC_SQLITE_ROW_100_withCode:(int)arg0 ;
+(void)_abortFromMocExecFail_NSMOC_SQLITE_SCHEMA_17_withCode:(int)arg0 ;
+(void)_abortFromMocExecFail_NSMOC_SQLITE_TOOBIG_18_withCode:(int)arg0 ;
+(void)_abortFromMocExecFail_NSMOC_SQLITE_WARNING_28_withCode:(int)arg0 ;
...
+(void)_contextSaveFailedWithCocoaError:(id)arg0 message:(id)arg1 ;
+(void)_contextSaveFailedWithError:(id)arg0 ;
+(void)_contextSaveFailedWithNSManagedObjectConstraintValidationError:(id)arg0 ;
+(void)_contextSaveFailedWithNSManagedObjectContextRecursiveSaveError:(id)arg0 ;
+(void)_contextSaveFailedWithNSManagedObjectValidationError:(id)arg0 ;
+(void)_contextSaveFailedWithNSPersistentStoreSaveError:(id)arg0 ;
+(void)_contextSaveFailedWithNSPersistentStoreTimeoutError:(id)arg0 ;
+(void)_contextSaveFailedWithNSValidationDateTooLateError:(id)arg0 ;
+(void)_contextSaveFailedWithNSValidationDateTooSoonError:(id)arg0 ;
+(void)_contextSaveFailedWithNSValidationInvalidDateError:(id)arg0 ;
+(void)_contextSaveFailedWithNSValidationInvalidURIError:(id)arg0 ;
+(void)_contextSaveFailedWithNSValidationMissingMandatoryPropertyError:(id)arg0 ;
+(void)_contextSaveFailedWithNSValidationMultipleErrorsError:(id)arg0 ;
+(void)_contextSaveFailedWithNSValidationNumberTooLargeError:(id)arg0 ;
+(void)_contextSaveFailedWithNSValidationNumberTooSmallError:(id)arg0 ;
+(void)_contextSaveFailedWithNSValidationRelationshipDeniedDeleteError:(id)arg0 ;
+(void)_contextSaveFailedWithNSValidationRelationshipExceedsMaximumCountError:(id)arg0 ;
+(void)_contextSaveFailedWithNSValidationRelationshipLacksMinimumCountError:(id)arg0 ;
+(void)_contextSaveFailedWithNSValidationStringPatternMatchingError:(id)arg0 ;
+(void)_contextSaveFailedWithNSValidationStringTooLongError:(id)arg0 ;
+(void)_contextSaveFailedWithNSValidationStringTooShortError:(id)arg0 ;
+(void)_contextSaveFailedWithNoPersistentStores:(id)arg0 ;
+(void)_contextSaveFailedWithOtherCocoaError:(id)arg0 ;
...
+(void)contextExecuteFailedWithSQLiteResultCode:(int)arg0 ;
+(void)initialize;
...
-(void)_userApplyTrashedState:(short)arg0 toAssets:(id)arg1 localOnlyDelete:(BOOL)arg2 trashedReason:(unsigned short)arg3 ;
...
-(void)userTrashAssets:(id)arg0 withTrashedReason:(unsigned short)arg1 ;
