...
@property (copy) NSSet *excludedAttributeNames; // ivar: _excludedAttributeNames
@property (copy) NSSet *excludedEntityNames; // ivar: _excludedEntityNames
@property BOOL ignoreMissingSourceFileURLs; // ivar: _ignoreMissingSourceFileURLs
...
@property BOOL skipContextSave; // ivar: _skipContextSave
