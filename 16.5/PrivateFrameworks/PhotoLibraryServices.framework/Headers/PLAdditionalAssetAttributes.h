...
-(BOOL)containsDuplicateDetectorPerceptualProcessingState:(unsigned short)arg0 ;
...
-(void)addDuplicateDetectorPerceptualProcessingStates:(unsigned short)arg0 removeProcessingStates:(unsigned short)arg1 ;
-(void)appendLibraryScopeAssetContributorsToUpdate:(id)arg0 ;
-(void)correctOriginalOrientationIfRequired;
-(void)removeCloudRecoveryStateFlag:(NSUInteger)arg0 ;
-(void)setDuplicateMatchingData:(id)arg0 duplicateMatchingAlternateData:(id)arg1 processingSucceeded:(BOOL)arg2 ;
