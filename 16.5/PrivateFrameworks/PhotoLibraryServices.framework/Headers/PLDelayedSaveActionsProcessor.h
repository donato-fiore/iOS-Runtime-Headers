...
-(void)_processDelayedLibraryScopeParticipantsUpdate:(id)arg0 library:(id)arg1 transaction:(id)arg2 ;
-(void)_processDelayedLibraryScopeRulesUpdate:(BOOL)arg0 library:(id)arg1 transaction:(id)arg2 ;
...
-(void)_processDelayedWallpaperSuggestionReload:(id)arg0 library:(id)arg1 transaction:(id)arg2 ;
