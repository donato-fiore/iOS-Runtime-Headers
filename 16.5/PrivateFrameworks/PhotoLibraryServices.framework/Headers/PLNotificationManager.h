...
-(void)_postAsyncNotificationForAcceptedSharedLibraryWithScopeIdentifier:(id)arg0 participantName:(id)arg1 NotificationDeliveryDate:(id)arg2 transaction:(id)arg3 ;
-(void)_postAsyncNotificationForPhotosChallengeNewQuestionsWithNotificationDeliveryDate:(id)arg0 transaction:(id)arg1 ;
-(void)_postAsyncNotificationForPhotosChallengeSubmissionWithNotificationDeliveryDate:(id)arg0 transaction:(id)arg1 ;
-(void)_postAsyncNotificationForSharedLibraryParticipantAssetTrashWithTrashedAssetPhotoCount:(NSUInteger)arg0 videoCount:(NSUInteger)arg1 itemCount:(NSUInteger)arg2 withNotificationDeliveryDate:(id)arg3 transaction:(id)arg4 ;
-(void)_postAsyncNotificationForSharedLibrarySuggestionsWithNotificationDeliveryDate:(id)arg0 transaction:(id)arg1 ;
-(void)_postNotificationForSharedLibraryExitInitatedByOwnerWithTypeWithExitType:(short)arg0 retentionPolicy:(NSInteger)arg1 ownerName:(id)arg2 notificationDeliveryDate:(id)arg3 transaction:(id)arg4 ;
...
-(void)postNotificationForAcceptedSharedLibraryWithScopeIdentifier:(id)arg0 participantName:(id)arg1 library:(id)arg2 notificationDeliveryDate:(id)arg3 ;
...
-(void)postNotificationForPhotosChallengeNewQuestionsWithNotificationDeliveryDate:(id)arg0 ;
-(void)postNotificationForPhotosChallengeSubmissionWithNotificationDeliveryDate:(id)arg0 ;
-(void)postNotificationForSharedLibraryExitInitatedByOwnerWithTypeWithExitType:(short)arg0 retentionPolicy:(NSInteger)arg1 ownerName:(id)arg2 notificationDeliveryDate:(id)arg3 ;
-(void)postNotificationForSharedLibraryParticipantAssetTrashWithTrashedAssetPhotoCount:(NSUInteger)arg0 videoCount:(NSUInteger)arg1 itemCount:(NSUInteger)arg2 withNotificationDeliveryDate:(id)arg3 ;
-(void)postNotificationForSharedLibrarySuggestionsWithNotificationDeliveryDate:(id)arg0 ;
