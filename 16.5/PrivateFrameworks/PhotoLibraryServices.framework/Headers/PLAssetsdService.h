...
+(id)autoCreateWellKnownPhotoLibraryIfNeededWithURL:(id)arg0 wellKnownLibraryIdentifier:(*NSInteger)arg1 ;
...
-(void)photoLibraryDeletedAtURL:(id)arg0 reply:(id)arg1 ;
