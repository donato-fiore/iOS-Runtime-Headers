...
-(BOOL)evaluateAssetObjectIDs:(id)arg0 simulate:(BOOL)arg1 predicateToFetchAssetsToEvaluate:(id)arg2 withResultEnumerationBlock:(id)arg3 ;
...
-(id)_fetchAssetObjectIDsContainedInMomentObjectIDs:(id)arg0 excludingAssetObjectIDs:(id)arg1 inManagedObjectContext:(id)arg2 predicateToFetchAssetsToEvaluate:(id)arg3 ;
