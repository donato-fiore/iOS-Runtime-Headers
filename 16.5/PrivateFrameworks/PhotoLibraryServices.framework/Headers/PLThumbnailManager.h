...
-(NSInteger)removeAllThumbnailsInContext:(id)arg0 dryRun:(BOOL)arg1 count:(*NSUInteger)arg2 ;
...
-(void)_removeMasterThumbDirectoriesWithFileManagerDelegate:(id)arg0 ;
