...
+(BOOL)resetImageRequestHintsInContext:(id)arg0 resetThumbnailIndexes:(BOOL)arg1 ;
...
+(id)_validatedExternalResourceForComputeResourceAtPath:(id)arg0 recipe:(id)arg1 ;
...
+(id)generateAdjustedFullSizeRenderResourceForFilePath:(id)arg0 requireFileToBePresent:(BOOL)arg1 basedOnFullSizeWidth:(NSInteger)arg2 andHeight:(NSInteger)arg3 ;
...
+(id)onDemand_installExistingAdjustedResourceAtFilePath:(id)arg0 withType:(unsigned int)arg1 recipe:(id)arg2 forAsset:(id)arg3 error:(*id)arg4 ;
+(id)onDemand_installExistingComputeResourceAtFilePath:(id)arg0 recipe:(id)arg1 forAsset:(id)arg2 error:(*id)arg3 ;
...
+(void)_applyImageIOMetadataToExternalResource:(id)arg0 fromFileURL:(id)arg1 assumedWidth:(NSInteger)arg2 assumedHeight:(NSInteger)arg3 recipe:(id)arg4 assetKind:(short)arg5 ;
