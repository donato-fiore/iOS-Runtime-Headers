...
@property (readonly, nonatomic) BOOL calculateTokenCounts; // ivar: _calculateTokenCounts
...
@property (readonly, nonatomic) BOOL lastImplicitTokenAllowsWordEmbeddings; // ivar: _lastImplicitTokenAllowsWordEmbeddings
...
@property (readonly, nonatomic) BOOL usesPrefixBasedWordEmbedding; // ivar: _usesPrefixBasedWordEmbedding
...
+(id)_combineOCRGroups:(id)arg0 usingSearchTokens:(id)arg1 ;
...
-(id)initWithQueryTokens:(id)arg0 searchText:(id)arg1 useWildcardText:(BOOL)arg2 delegate:(id)arg3 libraryScope:(NSUInteger)arg4 ;
