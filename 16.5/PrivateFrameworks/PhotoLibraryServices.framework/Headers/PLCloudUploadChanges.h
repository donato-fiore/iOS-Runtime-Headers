...
@property (retain, nonatomic) NSMutableArray *libraryScopeChanges; // ivar: _libraryScopeChanges
...
@property (retain, nonatomic) NSMutableSet *sharingPropertyChangedAssetUuids; // ivar: _sharingPropertyChangedAssetUuids
