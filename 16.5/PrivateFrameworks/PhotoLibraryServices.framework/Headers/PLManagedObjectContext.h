...
@property (nonatomic, getter=isLocalOnlyDelete) BOOL localOnlyDelete; // ivar: _localOnlyDelete
...
@property (nonatomic) NSInteger resetCloudLibraryMode; // ivar: _resetCloudLibraryMode
...
+(BOOL)includesToManyRelationship:(id)arg0 entity:(id)arg1 ;
...
+(id)contextForUninitializedPhotoLibrary:(id)arg0 automaticallyMerges:(BOOL)arg1 automaticallyPinToFirstFetch:(BOOL)arg2 name:(char *)arg3 ;
...
+(void)_pl_megamoc_runWithPerformWarningsSuppressed:(id)arg0 ;
...
-(id)_pl_executeFetchRequest:(id)arg0 error:(*id)arg1 ;
...
-(void)_directPerformBlock:(id)arg0 ;
-(void)_directPerformBlockAndWait:(id)arg0 ;
