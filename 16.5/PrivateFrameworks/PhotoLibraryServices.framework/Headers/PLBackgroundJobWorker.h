...
-(void)_handleAllJobsCompleteInLibrary:(id)arg0 allowOutsideLimiter:(BOOL)arg1 ;
-(void)_processNextManagedObjectInLibrary:(id)arg0 continueRunning:(BOOL)arg1 allowOutsideLimiter:(BOOL)arg2 ;
