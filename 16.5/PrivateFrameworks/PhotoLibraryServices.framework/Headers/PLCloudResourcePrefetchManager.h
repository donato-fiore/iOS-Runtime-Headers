...
-(id)_volumeInfo;
-(id)init;
-(id)initWithCPLManager:(id)arg0 pruneManager:(id)arg1 libraryServicesManager:(id)arg2 ;
...
-(void)_incrementPrefetchCountForPrefetchPhase:(NSUInteger)arg0 resources:(id)arg1 photoLibrary:(id)arg2 ;
-(void)_prefetchResources:(id)arg0 photoLibrary:(id)arg1 prefetchPhase:(NSUInteger)arg2 shouldAutoPefetchNextBatch:(BOOL)arg3 ;
...
-(void)_resourcesToPrefetchWithPrefetchPhase:(NSUInteger)arg0 photoLibrary:(id)arg1 applyPerPrefetchLimit:(BOOL)arg2 completionHandler:(id)arg3 ;
-(void)_resourcesWithPredicate:(id)arg0 photoLibrary:(id)arg1 limit:(NSUInteger)arg2 completionHandler:(id)arg3 ;
...
-(void)invalidate;
-(void)prefetchResourcesWithPredicates:(id)arg0 photoLibrary:(id)arg1 prefetchPhase:(NSUInteger)arg2 completionHandler:(id)arg3 ;
