...
+(NSInteger)processAssetWithAction:(id)arg0 managedObjectContext:(id)arg1 fetchRequest:(id)arg2 useObjectIDResumeMarker:(BOOL)arg3 error:(*id)arg4 processingBlock:(id)arg5 ;
