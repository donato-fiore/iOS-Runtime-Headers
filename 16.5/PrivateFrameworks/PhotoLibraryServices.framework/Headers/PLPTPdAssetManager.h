...
@protocol PLManagedObjectContextPTPNotificationDelegate, PhotoLibraryPTPDelegate, OS_dispatch_queue, OS_dispatch_group;

#import <Foundation/Foundation.h>

#import "PLPTPdFormatConversionManager.h"
#import "PLPhotoLibrary.h"
#import "PLPTPAnalyticsData.h"
...
@interface PLPTPdAssetManager : NSObject <PLManagedObjectContextPTPNotificationDelegate>

 {
    ...
    os_unfair_lock_s _analyticsDataLock;
...
-(id)_createJPEGThumbnailImageDataFromFileWithPath:(id)arg0 sourceTypeHint:(id)arg1 formatID:(unsigned short)arg2 shouldTransform:(BOOL)arg3 maxPixelSize:(NSUInteger)arg4 ;
...
-(id)init;
-(id)initForUnitTestSupportWithPhotoLibrary:(id)arg0 ;
...
-(void)setHostCharacteristics:(id)arg0 ;
