...
+(id)_serverTransactionForPathManager:(id)arg0 isNew:(*BOOL)arg1 identifier:(char *)arg2 ;
+(id)_transactionTokenFromXPCDictionary:(id)arg0 ;
+(id)beginClientTransactionWithChangeScopes:(id)arg0 pathManager:(id)arg1 identifier:(char *)arg2 ;
+(id)beginServerTransactionWithClientTransactionFromXPCDictionary:(id)arg0 pathManager:(id)arg1 identifier:(char *)arg2 ;
+(id)beginServerTransactionWithToken:(id)arg0 changeScopes:(id)arg1 pathManager:(id)arg2 identifier:(char *)arg3 ;
