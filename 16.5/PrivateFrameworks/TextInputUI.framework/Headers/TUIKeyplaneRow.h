...
@property (retain, nonatomic) UILayoutGuide *keySizingGuide; // ivar: _keySizingGuide
...
-(id)constraintsForStringKeys:(id)arg0 inRowGuide:(id)arg1 matchingSizingGuide:(id)arg2 splitIndex:(NSInteger)arg3 ;
-(id)description;
-(id)init;
-(id)splitLayoutGuide;
