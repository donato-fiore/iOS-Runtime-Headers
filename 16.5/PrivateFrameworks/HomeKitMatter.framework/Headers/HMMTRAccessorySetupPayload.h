...
@property (nonatomic) BOOL supportsBLE; // ivar: _supportsBLE
@property (nonatomic) BOOL supportsIP; // ivar: _supportsIP
@property (nonatomic) BOOL supportsSoftAP; // ivar: _supportsSoftAP
...
-(id)initWithCHIPSetupPayload:(id)arg0 setupPayloadString:(id)arg1 ;
-(id)initWithCoder:(id)arg0 ;
-(id)initWithSetupCode:(id)arg0 discriminator:(id)arg1 ;
-(id)initWithSetupCode:(id)arg0 discriminator:(id)arg1 isShortDiscriminator:(BOOL)arg2 ;
