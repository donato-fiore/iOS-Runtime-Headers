...
@class NSString, NSUUID, NSDictionary, NSArray, NSDate, NSNumber, NSURL, NSData, NSNotificationCenter, NSSet;
...
@property (readonly, copy, nonatomic) TUParticipant *activeRemoteParticipant; // ivar: _activeRemoteParticipant
...
@property (weak, nonatomic) TUCallServicesInterface *callServicesInterface; // ivar: _callServicesInterface
...
@property (retain, nonatomic) TUProxyCall *comparativeCall; // ivar: _comparativeCall
...
@property (copy, nonatomic) id *contactsDataSourceCreationBlock; // ivar: _contactsDataSourceCreationBlock
...
@property (readonly, nonatomic) BOOL lockdownModeEnabled; // ivar: _lockdownModeEnabled
...
@property (copy, nonatomic) TUCallModel *model; // ivar: _model
...
@property (readonly, nonatomic) TUCallScreenShareAttributes *screenShareAttributes; // ivar: _screenShareAttributes
...
@property (retain, nonatomic) TUVideoCallAttributes *videoCallAttributes; // ivar: _videoCallAttributes
