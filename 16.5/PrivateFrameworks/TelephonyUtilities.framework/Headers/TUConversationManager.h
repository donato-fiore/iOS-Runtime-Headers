...
@class NSSet, NSDictionary, NSMutableSet, NSString, NSMapTable, NSNotificationCenter;
@protocol TUConversationManagerDataSourceDelegate, TUCollaborationManagerDelegate, TUConversationManagerDataSource, TUConversationMessagesGroupProviding, OS_dispatch_queue;
...
@property (retain, nonatomic) TUCollaborationManager *collaborationManager; // ivar: _collaborationManager
...
-(void)addDisclosedCollaborationInitiator:(id)arg0 toConversation:(id)arg1 ;
...
-(void)getNeedsDisclosureOfCollaborationInitiator:(id)arg0 forConversation:(id)arg1 completionHandler:(id)arg2 ;
