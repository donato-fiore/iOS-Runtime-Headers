...
-(BOOL)nearbyTVDevice:(id)arg0 isCapableOfHandoffForConversation:(id)arg1 ;
-(id)_findConversationForUUID:(id)arg0 ;
...
-(void)approveSplitSessionForConversation:(id)arg0 device:(id)arg1 pullContext:(NSInteger)arg2 completion:(id)arg3 ;
