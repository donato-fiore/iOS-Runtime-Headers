...
@property (copy, nonatomic) NSSet *invitedMemberHandles; // ivar: _invitedMemberHandles
...
@property (retain, nonatomic) TUHandle *originatorHandle; // ivar: _originatorHandle
...
-(id)initWithPseudonym:(id)arg0 publicKey:(id)arg1 groupUUID:(id)arg2 originatorHandle:(id)arg3 creationDate:(id)arg4 deletionDate:(id)arg5 expirationDate:(id)arg6 invitedMemberHandles:(id)arg7 locallyCreated:(BOOL)arg8 linkName:(id)arg9 linkLifetimeScope:(NSInteger)arg10 ;
