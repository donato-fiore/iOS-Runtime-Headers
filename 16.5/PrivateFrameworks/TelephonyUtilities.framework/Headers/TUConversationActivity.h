...
@property (nonatomic) BOOL startWhenStaged; // ivar: _startWhenStaged
...
@property (copy, nonatomic) TUHandle *trustedFromHandle; // ivar: _trustedFromHandle
...
-(BOOL)isEquivalentToActivity:(id)arg0 ;
...
-(id)initWithCreationRequest:(id)arg0 bundleIdentifier:(id)arg1 systemActivity:(BOOL)arg2 ;
