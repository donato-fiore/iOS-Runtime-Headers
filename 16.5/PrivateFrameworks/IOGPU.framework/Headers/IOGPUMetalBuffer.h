...
@property (readonly) *__IOSurface _aneIOSurface;
...
-(id)initWithDevice:(id)arg0 pointer:(*void)arg1 length:(NSUInteger)arg2 alignment:(unsigned int)arg3 options:(NSUInteger)arg4 sysMemSize:(NSUInteger)arg5 gpuAddress:(NSUInteger)arg6 args:(struct IOGPUNewResourceArgs *)arg7 argsSize:(unsigned int)arg8 deallocator:(id)arg9 ;
