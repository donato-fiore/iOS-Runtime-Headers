...
@property (copy, nonatomic) NSNumber *disableAssociationMACRandomization; // ivar: _disableAssociationMACRandomization
...
@property (copy, nonatomic) NSNumber *isFirstAutoJoinRestricted; // ivar: _isFirstAutoJoinRestricted
