...
// -(void)readFromNWConnection:(id)arg0 maximumDatagrams:(unsigned int)arg1 readHandler:(id)arg2 readHandlerWithOptions:(unk)arg3  ;
...
// -(void)readFromSocketDescriptorWithReadHandler:(id)arg0 readHandlerWithOptions:(unk)arg1  ;
-(void)readyToRead;
