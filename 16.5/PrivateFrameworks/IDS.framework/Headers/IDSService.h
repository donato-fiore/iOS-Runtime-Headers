...
-(BOOL)setWakingPushPriority:(NSInteger)arg0 error:(*id)arg1 ;
...
-(id)datagramChannelForSessionDestination:(id)arg0 options:(id)arg1 error:(*id)arg2 ;
...
-(id)pseudonymPropertiesWithFeatureID:(id)arg0 expiryDurationInSeconds:(CGFloat)arg1 ;
...
-(void)signData:(id)arg0 withAlgorithm:(NSInteger)arg1 completion:(id)arg2 ;
-(void)signData:(id)arg0 withAlgorithm:(NSInteger)arg1 options:(id)arg2 completion:(id)arg3 ;
-(void)startOTRTest:(NSInteger)arg0 ;
-(void)testCloudQRConnection;
-(void)updateSubServices:(id)arg0 ;
-(void)verifySignedData:(id)arg0 matchesExpectedData:(id)arg1 withTokenURI:(id)arg2 forAlgorithm:(NSInteger)arg3 completion:(id)arg4 ;
-(void)verifySignedData:(id)arg0 matchesExpectedData:(id)arg1 withTokenURI:(id)arg2 forAlgorithm:(NSInteger)arg3 options:(id)arg4 completion:(id)arg5 ;
