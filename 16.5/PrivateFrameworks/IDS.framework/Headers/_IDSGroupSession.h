...
-(void)leaveGroupSessionWithOptions:(id)arg0 ;
...
-(void)requestURIsForParticipantIDs:(id)arg0 completionHandler:(id)arg1 ;
...
-(void)session:(id)arg0 didReceiveData:(id)arg1 dataType:(unsigned short)arg2 forParticipant:(id)arg3 ;
-(void)session:(id)arg0 didReceiveDataBlob:(id)arg1 forParticipant:(id)arg2 ;
...
-(void)session:(id)arg0 didReceiveParticipantIDs:(id)arg1 withCode:(unsigned int)arg2 managementType:(unsigned short)arg3 ;
...
-(void)session:(id)arg0 didReceiveServerErrorCode:(unsigned int)arg1 ;
-(void)session:(id)arg0 didReceiveURIsForParticipantIDs:(id)arg1 withRequestID:(id)arg2 ;
...
-(void)sessionDidReceiveParticipantUpgrade:(id)arg0 participantType:(unsigned short)arg1 error:(id)arg2 ;
