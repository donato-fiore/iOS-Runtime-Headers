...
@protocol IDSDaemonListenerProtocol, OS_xpc_object, OS_dispatch_queue;
...
-(void)___oldDealloc;
-(void)_callDelegatesForService:(id)arg0 destinationToVerifierResult:(id)arg1 ;
...
-(void)dealloc;
-(void)ktPeerVerificationResultsUpdated:(id)arg0 forService:(id)arg1 ;
