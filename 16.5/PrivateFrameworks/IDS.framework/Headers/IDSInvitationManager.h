...
-(void)acceptInvitation:(id)arg0 withContext:(id)arg1 options:(id)arg2 serverAcknowledgedBlock:(id)arg3 ;
-(void)acceptInvitation:(id)arg0 withContext:(id)arg1 serverAcknowledgedBlock:(id)arg2 ;
-(void)cancelInvitation:(id)arg0 options:(id)arg1 serverAcknowledgedBlock:(id)arg2 ;
-(void)cancelInvitation:(id)arg0 serverAcknowledgedBlock:(id)arg1 ;
-(void)declineInvitation:(id)arg0 options:(id)arg1 serverAcknowledgedBlock:(id)arg2 ;
...
-(void)sendInvitationToDestination:(id)arg0 expirationDate:(id)arg1 context:(id)arg2 options:(id)arg3 serverAcknowledgedBlock:(id)arg4 ;
