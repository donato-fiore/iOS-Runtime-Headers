...
@class UIView, NSString, GKGame, GKMatchRequest, NSURL;
...
@property (retain, nonatomic) UIView *buttonHeaderView; // ivar: _buttonHeaderView
@property (nonatomic) BOOL canStartGroupActivities; // ivar: _canStartGroupActivities
...
@property (retain, nonatomic) GKMultiplayerDataSource *multiplayerDataSource; // ivar: _multiplayerDataSource
