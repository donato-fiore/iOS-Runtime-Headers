...
@property (nonatomic) os_unfair_lock_s automatchPlayerCountLock; // ivar: _automatchPlayerCountLock
...
@property (retain, nonatomic) GKMultiplayerParticipant *placeholderItem; // ivar: _placeholderItem
...
@property (nonatomic) BOOL sharePlayEnabled; // ivar: _sharePlayEnabled
...
-(void)prepopulateConversationParticipants:(id)arg0 complete:(id)arg1 ;
...
-(void)removePrepopulatedPlayersIfExisted:(id)arg0 completionHandler:(id)arg1 ;
-(void)replacePlayers:(id)arg0 withGKPlayers:(id)arg1 completionHandler:(id)arg2 ;
-(void)replacePrepopulatedPlayerWithNormalPlayer:(id)arg0 participantServerIdentifier:(id)arg1 completionHandler:(id)arg2 ;
