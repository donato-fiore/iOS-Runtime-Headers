...
@class NSString, UIView, NSLayoutConstraint, UICollectionView, CAGradientLayer, GKLeaderboard, UIImageView, UIStackView, GKLeaderboardEntry, UIScrollView, UISegmentedControl, UICollectionViewCell, UILabel;
...
@property (retain, nonatomic) NSString *autoScrollToPlayerId; // ivar: _autoScrollToPlayerId
...
@property (retain, nonatomic) UIImageView *gameIconImageView; // ivar: _gameIconImageView
