...
-(id)subtitleForPlayer:(id)arg0 isCoreRecent:(BOOL)arg1 matchedContactName:(id)arg2 onlyShowContactName:(BOOL)arg3 ;
-(void)awakeFromNib;
-(void)configureWithPlayer:(id)arg0 isCoreRecent:(BOOL)arg1 matchedContactName:(id)arg2 onlyShowContactName:(BOOL)arg3 ;
