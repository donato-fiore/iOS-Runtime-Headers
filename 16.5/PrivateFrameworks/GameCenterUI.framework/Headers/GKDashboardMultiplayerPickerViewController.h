...
@class UIVisualEffectView, UILabel, UIView, CNComposeRecipientTextView, NSLayoutConstraint, CNContactPickerViewController, UIButton, NSString, UIStackView, UITextField, NSMutableDictionary;
...
@property (weak, nonatomic) UIView *collapsedTitleContainer; // ivar: _collapsedTitleContainer
...
@property (weak, nonatomic) UIView *composeTextViewContainerBackground; // ivar: _composeTextViewContainerBackground
@property (weak, nonatomic) NSLayoutConstraint *composeTextViewContainerBackgroundHeightConstraint; // ivar: _composeTextViewContainerBackgroundHeightConstraint
