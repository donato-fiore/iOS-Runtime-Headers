...
@property (retain, nonatomic) NSArray *barButtonItemViews; // ivar: _barButtonItemViews
@property (nonatomic) BOOL compressTitleView; // ivar: _compressTitleView
@property (retain, nonatomic) TUNavigationBarCompressibleTitleView *compressibleTitleView; // ivar: _compressibleTitleView
...
@property (readonly, nonatomic) CGFloat topOffset; // ivar: topOffset
