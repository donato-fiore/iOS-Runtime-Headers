...
@class NSString, HKHealthStore, NSNumber, HDProfile, ACHCurrentActivitySummaryQuery, HKAnchoredObjectQuery;
...
@property (retain, nonatomic) ACHCurrentActivitySummaryQuery *summaryQuery; // ivar: _summaryQuery
...
-(id)initWithHealthStore:(id)arg0 awardingEngine:(id)arg1 templateStore:(id)arg2 earnedInstanceStore:(id)arg3 monthlyDataSource:(id)arg4 creatorDevice:(unsigned char)arg5 progressProvider:(id)arg6 ;
