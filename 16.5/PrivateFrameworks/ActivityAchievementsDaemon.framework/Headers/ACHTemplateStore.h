...
@class NSArray, ACHAwardsClient, ACHDatabaseAssertionClient, NSString, NSHashTable, HDProfile, NSMutableSet, NSMutableDictionary, NSDictionary;
...
@property (retain, nonatomic) ACHDatabaseAssertionClient *databaseAssertionClient; // ivar: _databaseAssertionClient
...
@property (nonatomic) int syncedTemplatesToken; // ivar: _syncedTemplatesToken
...
@property (retain, nonatomic) NSMutableDictionary *templatesBySource; // ivar: _templatesBySource
...
-(BOOL)_queue_client_addTemplatesToDatabase:(id)arg0 error:(*id)arg1 ;
-(BOOL)_queue_client_removeTemplatesFromDatabase:(id)arg0 error:(*id)arg1 ;
-(BOOL)_queue_daemon_addTemplatesToDatabase:(id)arg0 provenance:(NSInteger)arg1 databaseContext:(id)arg2 error:(*id)arg3 ;
-(BOOL)_queue_daemon_removeTemplatesFromDatabase:(id)arg0 error:(*id)arg1 ;
...
-(BOOL)removeTemplatesForSource:(id)arg0 error:(*id)arg1 ;
-(BOOL)removeTemplatesWithUniqueNames:(id)arg0 error:(*id)arg1 ;
-(id)_queue_orphanedTemplatesWithFetchedTemplates:(id)arg0 ;
-(id)_queue_templatesFilteredForDuplicates:(id)arg0 ;
-(id)_templatesWithUniqueNames:(id)arg0 ;
-(id)availableTemplatesForDateComponents:(id)arg0 countryCode:(id)arg1 ;
-(id)initWithClient:(id)arg0 assertionClient:(id)arg1 device:(unsigned char)arg2 ;
...
-(void)_queue_protectedDataAvailabilityChanged:(BOOL)arg0 ;
