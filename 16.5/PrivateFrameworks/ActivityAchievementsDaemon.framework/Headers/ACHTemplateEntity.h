...
+(BOOL)_insertTemplate:(id)arg0 provenance:(NSInteger)arg1 database:(id)arg2 error:(*id)arg3 ;
+(BOOL)_insertTemplates:(id)arg0 provenance:(NSInteger)arg1 profile:(id)arg2 databaseContext:(id)arg3 error:(*id)arg4 ;
+(BOOL)_journalTemplates:(id)arg0 provenance:(NSInteger)arg1 action:(NSInteger)arg2 profile:(id)arg3 error:(*id)arg4 ;
+(BOOL)_removeTemplateWithPersistentID:(NSInteger)arg0 database:(id)arg1 error:(*id)arg2 ;
...
+(id)_templateWithUniqueName:(id)arg0 profile:(id)arg1 transaction:(id)arg2 error:(*id)arg3 ;
