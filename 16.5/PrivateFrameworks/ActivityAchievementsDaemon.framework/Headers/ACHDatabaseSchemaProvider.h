...
-(void)_addTemplateRowIdBumpToMigrator:(id)arg0 ;
-(void)_addValidateEarnedInstanceRowStepToMigrator:(id)arg0 ;
-(void)_addVersion5MigratorToMigrator:(id)arg0 ;
-(void)_removeErroneousFitnessPlusTemplates:(id)arg0 ;
-(void)_removeErroneousWorkoutTemplates:(id)arg0 ;
-(void)_updateGoalFor31DaysSeptemberMonthlyChallenge:(id)arg0 ;
