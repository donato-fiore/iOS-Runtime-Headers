...
@class HDProfile, HKObserverSet<HDMedicationScheduleObserver>, NSMutableArray, HDXPCGatedActivity, HDAssertion, NSNumber;
...
@interface HDMedicationScheduleManager : NSObject <HDProfileReadyObserver>

 {
    ...
    NSMutableArray *_observersLock_pendingSchedules;
...
-(BOOL)enumerateMedicationSchedulesWithPredicate:(id)arg0 limit:(NSInteger)arg1 orderingTerms:(id)arg2 error:(*id)arg3 enumerationHandler:(id)arg4 ;
-(BOOL)insertMedicationSchedule:(id)arg0 error:(*id)arg1 ;
-(BOOL)insertMedicationSchedules:(id)arg0 error:(*id)arg1 ;
-(BOOL)insertMedicationSchedules:(id)arg0 syncProvenance:(NSInteger)arg1 syncIdentity:(NSInteger)arg2 error:(*id)arg3 ;
...
-(void)batchNotifyObserversOnCommitOfTransaction:(id)arg0 didAddOrModifySchedule:(id)arg1 ;
-(void)dealloc;
