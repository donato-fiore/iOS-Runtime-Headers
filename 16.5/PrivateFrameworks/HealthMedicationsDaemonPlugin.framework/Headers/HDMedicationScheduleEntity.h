...
+(BOOL)enumerateSchedulesWithPredicate:(id)arg0 limit:(NSUInteger)arg1 orderingTerms:(id)arg2 transaction:(id)arg3 error:(*id)arg4 enumerationHandler:(id)arg5 ;
+(BOOL)insertMedicationSchedule:(id)arg0 syncProvenance:(NSInteger)arg1 syncIdentity:(NSInteger)arg2 transaction:(id)arg3 error:(*id)arg4 ;
