...
-(NSInteger)_addCompatibilityVersionColumnsWithTransaction:(id)arg0 error:(*id)arg1 ;
-(NSInteger)_sydney_addSyncIdentityToMedicationScheduleEntityWithTransaction:(id)arg0 error:(*id)arg1 ;
