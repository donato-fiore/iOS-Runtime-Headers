...
@property (retain, nonatomic) HDCodableMedicationScheduleCompatibilityVersionRange *compatibilityVersionRange; // ivar: _compatibilityVersionRange
...
@property (nonatomic) BOOL duplicate; // ivar: _duplicate
