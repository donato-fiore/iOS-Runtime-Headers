...
@property (retain, nonatomic) NSMutableArray *accumulatedTopicMoves; // ivar: _accumulatedTopicMoves
...
@property (nonatomic) os_unfair_lock_s topicMoveLock; // ivar: _topicMoveLock
...
-(id)_removeURLTokenBlocksForInfo:(id)arg0 ;
...
-(void)_addTrackActivityPresenceToXPCMessage:(id)arg0 ;
...
-(void)_deliverToken:(id)arg0 forInfo:(id)arg1 ;
-(void)_deliverToken:(id)arg0 forTopic:(id)arg1 identifier:(id)arg2 ;
-(void)_deliverURLToken:(id)arg0 forInfo:(id)arg1 ;
-(void)_deliverURLTokenError:(id)arg0 forInfo:(id)arg1 ;
-(void)_disconnect;
...
// -(void)_insertURLTokenBlock:(id)arg0 forInfo:(unk)arg1  ;
...
-(void)calloutToDelegatesForURLTokenError:(id)arg0 forInfo:(id)arg1 completion:(id)arg2 ;
// -(void)calloutToInvalidateCompletion:(id)arg0 withSuccess:(unk)arg1 error:(BOOL)arg2  ;
-(void)cancelOutgoingMessage:(id)arg0 ;
-(void)confirmReceiptForMessage:(id)arg0 ;
-(void)currentTokenForInfo:(id)arg0 ;
-(void)currentURLTokenForInfo:(id)arg0 ;
-(void)dealloc;
...
-(void)invalidateTokenForInfo:(id)arg0 ;
-(void)invalidateTokenForTopic:(id)arg0 identifier:(id)arg1 ;
-(void)invalidateURLTokenForInfo:(id)arg0 ;
-(void)invalidateURLTokenForInfo:(id)arg0 completion:(id)arg1 ;
-(void)moveTopic:(id)arg0 fromList:(NSUInteger)arg1 toList:(NSUInteger)arg2 ;
-(void)moveTopics:(id)arg0 fromList:(NSUInteger)arg1 toList:(NSUInteger)arg2 ;
-(void)removeFromRunLoop;
-(void)requestKeepAlive;
-(void)requestTokenForInfo:(id)arg0 ;
-(void)requestTokenForTopic:(id)arg0 identifier:(id)arg1 ;
-(void)requestURLTokenForInfo:(id)arg0 ;
-(void)requestURLTokenForInfo:(id)arg0 completion:(id)arg1 ;
