...
-(BOOL)interpretsViewAsAdjunctContent:(id)arg0 ;
...
-(NSInteger)_uiBacklightLuminanceForBLSBacklightState:(NSInteger)arg0 ;
...
-(void)_updateStructuredListOverrideUserInterfaceStyleWithBacklightLuminance:(NSInteger)arg0 ;
...
-(void)notificationStructuredListViewController:(id)arg0 requestsCancelTouches:(BOOL)arg1 onSupplementaryViewController:(id)arg2 ;
