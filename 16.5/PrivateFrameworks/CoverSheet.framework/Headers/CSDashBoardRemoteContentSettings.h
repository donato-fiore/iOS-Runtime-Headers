...
@property (nonatomic) BOOL dismissesOnTapOverride; // ivar: _dismissesOnTapOverride
...
@property (nonatomic) BOOL prefersInlinePresentationOverride; // ivar: _prefersInlinePresentationOverride
