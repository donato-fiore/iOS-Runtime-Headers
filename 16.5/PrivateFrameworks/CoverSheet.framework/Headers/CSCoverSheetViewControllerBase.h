...
@class UIViewController, SBSDisplayLayoutElement, NSHashTable, NSString, NSSet, _UILegibilitySettings, NSArray;
@protocol SBSDisplayLayoutElementProviding, CSCoverSheetViewPresenting, BSDescriptionProviding, BSInvalidatable, UICoordinateSpace;
