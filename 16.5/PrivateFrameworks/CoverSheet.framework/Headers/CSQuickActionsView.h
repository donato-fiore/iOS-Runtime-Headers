...
@class SBFTouchPassThroughView, NSArray, NSString, _UILegibilitySettings;
@protocol PTSettingsKeyObserver, SBFCustomImplicitPropertyAnimating, CSQuickActionsDelegate;
...
-(BOOL)interpretsLocationAsContent:(struct CGPoint )arg0 inView:(id)arg1 ;
-(CGFloat)_insetX;
-(CGFloat)_insetY;
-(id)_buttonGroupName;
