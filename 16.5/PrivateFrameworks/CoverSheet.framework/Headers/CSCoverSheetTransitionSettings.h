...
@property (nonatomic) CGFloat fixedWallpaperPresentationProgress; // ivar: _fixedWallpaperPresentationProgress
...
@property (nonatomic) BOOL orientPanelWallpaper; // ivar: _orientPanelWallpaper
...
@property (nonatomic) BOOL usesFixedWallpaperPresentationProgress; // ivar: _usesFixedWallpaperPresentationProgress
