...
@class SBUILegibilityLabel, UIView, UIImageView, CABackdropLayer, NSString, _UILegibilitySettings, SBLockScreenDefaults, UIStatusBar;
...
@property (retain, nonatomic) CABackdropLayer *controlCenterGrabberBackdropLayer; // ivar: _controlCenterGrabberBackdropLayer
@property (retain, nonatomic) CSPropertyAnimatingTouchPassThroughView *controlCenterGrabberContainerView; // ivar: _controlCenterGrabberContainerView
...
-(struct CGPoint )_grabberCenterForContainerBounds:(struct CGRect )arg0 grabberTop:(CGFloat)arg1 grabberTopIsRelative:(BOOL)arg2 grabberSize:(struct CGSize )arg3 isSpaceConstrained:(*BOOL)arg4 ;
...
-(void)layoutSubviews;
-(void)statusBarManager:(id)arg0 didUpdateAvoidanceFrameForStatusBar:(id)arg1 withAnimationSettings:(id)arg2 ;
