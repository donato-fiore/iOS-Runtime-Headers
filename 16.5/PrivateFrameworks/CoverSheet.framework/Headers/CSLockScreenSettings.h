...
@property (retain) CSLookSettings *lookSettings; // ivar: _lookSettings
...
@property CGFloat unlockPasscodeThresholdForExternalDisplay; // ivar: _unlockPasscodeThresholdForExternalDisplay
...
@property (retain) CSVibrancySettings *vibrancySettings; // ivar: _vibrancySettings
