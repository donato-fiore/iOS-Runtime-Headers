...
@class NSMutableArray, NSHashTable, BSAbsoluteMachTimer, BCBatteryDeviceController, NSArray, UITapGestureRecognizer, UILongPressGestureRecognizer, UINotificationFeedbackGenerator, UIView<BSInvalidatable><PBUIWallpaperPositioning>, SBLockScreenDefaults, SBAlwaysOnDefaults, NSMutableSet, SBFLockScreenDateSubtitleView, NSString, NSDate, SBUIPhoneUnlockWithWatchController, ACActivityCenter, NSSet, SBFLockScreenActionContext, SBFLockScreenDateViewController, BSUIVibrancyConfiguration, UIStatusBar, _UILegibilitySettings, SBSearchGesture, SBSpotlightTransientOverlayInteractiveGestureTransaction, UIView, SBWallpaperAggdLogger, UIGestureRecognizer;
@protocol CSPersistentContentLayoutProviding, CSDateTimeLayoutAggregating, BCBatteryDeviceObserving, CSCoverSheetViewDelegate, UIGestureRecognizerDelegate, CSLegibilityProviderDelegate, SBLockScreenActionProvider, PBUIIrisWallpaperPlayerDelegate, CSCoverSheetViewTransitionSource, CSNotificationDestination, CSTimerViewControllerDelegate, _UISettingsKeyObserver, CSScrollGestureControllerDelegate, CSNotificationClearingTriggerDelegate, CSInterstitialTransitionDelegate, CSMainPageContentViewControllerMediaControlsObserver, CSPasscodeViewControllerDelegate, SBFOverlayObserving, SBFOverlayDismissalDelegate, FBSDisplayLayoutPublisherObserving, CSRemoteContentSessionHostDelegate, CSRemoteContentInlineProviding, CSEmbeddedContentActionManagerDelegate, CSMainPageContentViewControllerNotificationObserver, CSPresentationViewControllerDelegate, CAAnimationDelegate, CSProudLockViewControllerDelegate, SBUIPhoneUnlockWithWatchControllerDelegate, CSScrollablePageViewControllerDelegate, SBCoverSheetSpotlightPresenterDelegate, SBSearchGestureObserver, SBSearchGestureDelegate, CSActivityPickerViewControllerParentContainer, SBUIPhoneUnlockWithWatchControllerObserver, CSPosterSwitcherActivationSource, CSPosterSwitcherActivationManagerDelegate, CSPosterSwitcherTransitionDelegate, CSCombinedListViewControllerVisibleBreakthoughContentObserver, CSComplicationContainerViewControllerDelegate, CSBackgroundContentActionManagerDelegate, CSCoverSheetGestureHandling, CSActivityItemObserving, CSMagSafeAccessoryStatusDelegate, CSCoverSheetViewControllerProtocol, SBFDashBoardModalPresenterProtocol, SBFBacklightSceneHostEnvironmentProviding, BSInvalidatable, CSApplicationLaunching, CSCameraPrewarming, CSCoverSheetContextProviding, CSCoverSheetSpotlightPresenting, CSCoverSheetViewControllerDelegate, CSNotificationDispatcher, CSEmergencyCalling, CSIdleTimerControlling, PBUIIrisWallpaperPlaying, SBFScreenWakeAnimationTarget, CSLegibilityProviding, SBFLockOutStatusProvider, SBNotificationDestination, CSOrientationUpdateControlling, SBFOverlayControlling><CSExternalBehaviorProviding><CSExternalEventHandling, UICoordinateSpace, CSCoverSheetViewPresenting, SBFScreenWakeAnimationControlling, CSWallpaperColorProvider, SBSWidgetMetricsProviding, CSWidgetURLHandling;
...
#import "CSOverrideNotificationListDisplayStyleAssertion.h"
...
#import "CSBackgroundPresentationManager.h"
#import "CSBackgroundContentActionManager.h"
#import "CSBackgroundContentViewController.h"
#import "CSDismissableModalViewController.h"
#import "CSFocusActivityViewController.h"
#import "CSCoverSheetAppearanceResolver.h"
#import "CSMagSafeAccessoryStatusObserver.h"
#import "CSAppearance.h"
#import "CSBehavior.h"
#import "CSPresentation.h"
#import "CSComplicationContainerViewController.h"
...
@interface CSCoverSheetViewController : CSCoverSheetViewControllerBase <CSPersistentContentLayoutProviding, CSDateTimeLayoutAggregating, BCBatteryDeviceObserving, CSCoverSheetViewDelegate, UIGestureRecognizerDelegate, CSLegibilityProviderDelegate, SBLockScreenActionProvider, PBUIIrisWallpaperPlayerDelegate, CSCoverSheetViewTransitionSource, CSNotificationDestination, CSTimerViewControllerDelegate, _UISettingsKeyObserver, CSScrollGestureControllerDelegate, CSNotificationClearingTriggerDelegate, CSInterstitialTransitionDelegate, CSMainPageContentViewControllerMediaControlsObserver, CSPasscodeViewControllerDelegate, SBFOverlayObserving, SBFOverlayDismissalDelegate, FBSDisplayLayoutPublisherObserving, CSRemoteContentSessionHostDelegate, CSRemoteContentInlineProviding, CSEmbeddedContentActionManagerDelegate, CSMainPageContentViewControllerNotificationObserver, CSPresentationViewControllerDelegate, CAAnimationDelegate, CSProudLockViewControllerDelegate, SBUIPhoneUnlockWithWatchControllerDelegate, CSScrollablePageViewControllerDelegate, SBCoverSheetSpotlightPresenterDelegate, SBSearchGestureObserver, SBSearchGestureDelegate, CSActivityPickerViewControllerParentContainer, SBUIPhoneUnlockWithWatchControllerObserver, CSPosterSwitcherActivationSource, CSPosterSwitcherActivationManagerDelegate, CSPosterSwitcherTransitionDelegate, CSCombinedListViewControllerVisibleBreakthoughContentObserver, CSComplicationContainerViewControllerDelegate, CSBackgroundContentActionManagerDelegate, CSCoverSheetGestureHandling, CSActivityItemObserving, CSMagSafeAccessoryStatusDelegate, CSCoverSheetViewControllerProtocol, SBFDashBoardModalPresenterProtocol, SBFBacklightSceneHostEnvironmentProviding>

 {
    ...
    NSInteger _transitionContextMode;
    ...
    CGFloat _complicationContainerHeight;
    ...
    NSInteger _backlightTransitionGeneration;
...
@property (readonly, nonatomic) NSInteger backlightLuminance;
@property (retain, nonatomic) NSObject<CSCameraPrewarming> *cameraPrewarmer; // ivar: _cameraPrewarmer
@property (retain, nonatomic) CSComplicationContainerViewController *complicationContainerViewController; // ivar: _complicationContainerViewController
@property (readonly, copy, nonatomic) NSSet *components;
@property (readonly, nonatomic) BOOL contentOccludesBackground;
@property (readonly, nonatomic) NSObject<CSCoverSheetContextProviding> *coverSheetContext; // ivar: _coverSheetContext
...
@property (readonly, copy) NSString *description;
@property (nonatomic, setter=_setDidDismissSinceScreenOn:) BOOL didDismissSinceScreenOn; // ivar: _didDismissSinceScreenOn
@property (nonatomic, setter=_setDismissed:) BOOL dismissed; // ivar: _dismissed
...
@property (retain, nonatomic) BSUIVibrancyConfiguration *effectiveVibrancyConfiguration; // ivar: _effectiveVibrancyConfiguration
...
@property (nonatomic) BOOL hasPresentedForInterstitialTransitionSource; // ivar: _hasPresentedForInterstitialTransitionSource
...
@property (retain, nonatomic) CSComplicationContainerViewController *inlineComplicationContainerViewController; // ivar: _inlineComplicationContainerViewController
...
@property (retain, nonatomic) NSObject<PBUIIrisWallpaperPlaying> *irisWallpaperPlayer; // ivar: _irisWallpaperPlayer
@property (readonly, nonatomic) BOOL isAccessoryAnimationPresenting; // ivar: _isAccessoryAnimationPresenting
@property (retain, nonatomic) CSComplicationContainerViewController *landscapeInlineComplicationContainerViewController; // ivar: _landscapeInlineComplicationContainerViewController
...
@property (readonly, nonatomic) NSObject<SBFScreenWakeAnimationTarget> *legacyWallpaperWakeAnimator; // ivar: _legacyWallpaperWakeAnimator
...
@property (nonatomic, setter=_setLockOrientationWhileTransitioning:) BOOL lockOrientationWhileTransitioning; // ivar: _lockOrientationWhileTransitioning
...
@property (nonatomic) BOOL partiallyOnScreen; // ivar: _partiallyOnScreen
...
@property (retain, nonatomic) CSPosterSwitcherActivationManager *posterSwitcherActivationManager; // ivar: _posterSwitcherActivationManager
@property (retain, nonatomic) CSPosterSwitcherTransitionSource *posterSwitcherTransitionSource; // ivar: _posterSwitcherTransitionSource
@property (retain, nonatomic) CSPosterSwitcherViewController *posterSwitcherViewController; // ivar: _posterSwitcherViewController
...
@property (retain, nonatomic) BSUIVibrancyConfiguration *vibrancyConfigurationOverride; // ivar: _vibrancyConfigurationOverride
@property (readonly, nonatomic) NSArray *visibleViewsPreferringProminentPresentationAndDismissal;
...
@property (weak, nonatomic) NSObject<CSWidgetURLHandling> *widgetURLHandler; // ivar: _widgetURLHandler
...
-(BOOL)interpretsTouchLocationAsContentInListRestrictedRect:(struct CGPoint )arg0 ;
-(BOOL)isHostingAnApp;
...
-(BOOL)preventsLaunchFromWidgetWithAction:(id)arg0 ;
...
-(void)_addBackgroundContentOccludingViewsForAppearance:(id)arg0 ;
-(void)_addBackgroundContentViewControllerForAction:(id)arg0 ;
...
-(void)_animateView:(id)arg0 toWhitePointReduced:(BOOL)arg1 withDuration:(CGFloat)arg2 withDispatchGroup:(id)arg3 ;
...
-(void)_cleanupPosterSwitcherPresentationForCompleted:(BOOL)arg0 withActivatingTouches:(id)arg1 ;
-(void)_cleanupStaleRemoteContentWithCompletion:(id)arg0 ;
-(void)_clearChargingModalStateIfNecessary;
-(void)_complicationSelected:(id)arg0 ;
...
-(void)_dismissRemoteViewControllerForReason:(NSInteger)arg0 ;
-(void)_dismissRemoteViewControllerForReason:(NSInteger)arg0 completion:(id)arg1 ;
...
-(void)_handlePosterSwitcherActivation:(id)arg0 ;
...
-(void)_overrideNotificationDisplayStyleWithRemotePreference:(NSInteger)arg0 ;
-(void)_performLocalAppearanceUpdatesWithReason:(id)arg0 updates:(id)arg1 ;
...
-(void)_presentInlineViewController:(id)arg0 ;
...
-(void)_removeBackgroundContentOccludingViewsForAppearance:(id)arg0 ;
...
-(void)_setAppearanceForLandscape:(BOOL)arg0 ;
...
-(void)_showChargingSubtitleWithTimeout:(CGFloat)arg0 ;
...
-(void)_updateAppearanceForAODTransitionToInactive:(BOOL)arg0 ;
-(void)_updateBackground;
-(void)_updateBackgroundContentView;
-(void)_updateCoachingString;
-(void)_updateCoachingStringWithTimeout:(CGFloat)arg0 ;
...
-(void)_updatePosterSwitcherPresentationWithProgress:(CGFloat)arg0 ;
...
-(void)addRemoteContentInlineProvidingManager:(id)arg0 ;
-(void)animationDidStop:(id)arg0 finished:(BOOL)arg1 ;
-(void)attemptPhoneUnlockWithWatch;
-(void)backgroundContentActionManager:(id)arg0 addedAction:(id)arg1 ;
-(void)backgroundContentActionManager:(id)arg0 removedAction:(id)arg1 ;
-(void)cancelTransition;
-(void)cleanupInterstitialPresentationToPresented:(BOOL)arg0 inPlace:(BOOL)arg1 ;
-(void)cleanupRubberBandTransition;
-(void)combinedListViewController:(id)arg0 didChangeVisibleBreakthroughContent:(BOOL)arg1 ;
...
-(void)posterSwitcherActivationManager:(id)arg0 didChangeToCoachingText:(id)arg1 ;
...
-(void)proudLockDidChangeToCoachingText:(id)arg0 ;
...
-(void)removeRemoteContentInlineProvidingManager:(id)arg0 ;
...
-(void)setRestrictsTouchesForRemoteView:(BOOL)arg0 ;
...
-(void)spotlightPresenterAddContentView:(id)arg0 ;
-(void)spotlightPresenterRemoveContentView:(id)arg0 ;
...
-(void)timerControllerDidUpdateTimer:(id)arg0 ;
...
-(void)updateFont:(id)arg0 vibrancyConfiguration:(id)arg1 numberingSystem:(id)arg2 ;
-(void)updateInterstitialPresentationWithProgress:(CGFloat)arg0 ;
-(void)updateLeadingTopButtonFrame:(struct CGRect )arg0 trailingTopButtonFrame:(struct CGRect )arg1 ;
...
-(void)updateScaleViewWithScale:(CGFloat)arg0 withDuration:(CGFloat)arg1 ;
...
-(void)withTransition:(int)arg1 completion:(id)arg2 ;
