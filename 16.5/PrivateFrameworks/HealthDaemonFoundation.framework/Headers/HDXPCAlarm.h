...
@property (readonly, nonatomic) HDXPCAlarmScheduler *scheduler; // ivar: _scheduler
@property (copy, nonatomic) id *unitTest_schedulerObserver; // ivar: _unitTest_schedulerObserver


-(id)description;
-(id)initWithDaemon:(id)arg0 eventName:(id)arg1 eventHandlerQueue:(id)arg2 ;
-(id)initWithProfile:(id)arg0 eventName:(id)arg1 eventHandlerQueue:(id)arg2 ;
...
-(void)unitTest_fireEventImmediatelyWithDate:(id)arg0 isUserVisible:(BOOL)arg1 ;
-(void)unschedule;
