...
-(void)setCustomGlyphDilation:(struct CGSize )arg0 ;
...
-(void)setRBPath:(struct RBPath )arg0 transform:(struct CGAffineTransform )arg1 ;
...
-(void)setStrokedLineFromPoint:(struct CGPoint )arg0 toPoint:(struct CGPoint )arg1 lineWidth:(CGFloat)arg2 lineCap:(int)arg3 ;
...
-(void)setStrokedRBPath:(struct RBPath )arg0 transform:(struct CGAffineTransform )arg1 lineWidth:(CGFloat)arg2 lineCap:(int)arg3 lineJoin:(int)arg4 miterLimit:(CGFloat)arg5 dashPhase:(CGFloat)arg6 dashPattern:(*CGFloat)arg7 dashCount:(NSInteger)arg8 ;
