...
@interface RBDisplayList : NSObject <RBDisplayListContents>

 {
    ...
    vector<std::pair<RB::cf_ptr<CGContext *>, RB::ContextDelegate *>, 1UL, unsigned long> _contexts;
    NSUInteger _active_states;
    objc_ptr<void (^)(_RBDrawingState *, unsigned long)> _cgStyleHandler;
}


@property (copy, nonatomic) id *CGStyleHandler;
