...
@property (readonly, nonatomic) NSDictionary *featureValueConfig; // ivar: _featureValueConfig
...
@property (readonly, nonatomic) NSDictionary *modelOutputConfig; // ivar: _modelOutputConfig
...
-(id)initWithMLRTask:(id)arg0 ;
-(id)rangeBoundaryForFeature:(id)arg0 upperBound:(BOOL)arg1 ;
-(id)rangeBoundaryForOutput:(BOOL)arg0 ;
-(id)sentinelValuesForFeature:(id)arg0 ;
