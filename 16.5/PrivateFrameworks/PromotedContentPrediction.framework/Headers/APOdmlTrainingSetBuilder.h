...
@property (readonly, copy, nonatomic) NSArray *recordDictionaries; // ivar: _recordDictionaries
...
-(id)initWithRecipe:(id)arg0 recordDictionaries:(id)arg1 infos:(id)arg2 ;
-(id)metricsFromDESRecordWithClientPttr:(id)arg0 error:(*id)arg1 ;
-(id)translateFeatureKeyToDESKey:(id)arg0 ;
-(void)_preprocessDESRecordSet:(id)arg0 andAddInfoTo:(id)arg1 addUnarchivedDataTo:(id)arg2 ;
