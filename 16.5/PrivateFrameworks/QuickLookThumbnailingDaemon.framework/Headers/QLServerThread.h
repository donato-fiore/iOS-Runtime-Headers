...
@interface QLServerThread : NSObject {
    ...
    uint8_t _thumbnailDownloadsInFlight;
...
-(id)failedDownloadErrorForRequest:(id)arg0 underlyingError:(id)arg1 ;
-(id)genStoreThumbnailForRequest:(id)arg0 error:(*id)arg1 ;
...
-(void)_downloadThumbnailForRequest:(id)arg0 completionHandler:(id)arg1 ;
...
-(void)downloadThumbnailForRequest:(id)arg0 completionHandler:(id)arg1 ;
-(void)drainDownloadsQueueIfNeeded;
-(void)failedToCompleteThumbnailRequest:(id)arg0 error:(id)arg1 ;
-(void)findThumbnailInAddition:(id)arg0 request:(id)arg1 completionHandler:(id)arg2 ;
-(void)findUncachedThumbnailInExternalThumbnailCacheForRequest:(id)arg0 item:(id)arg1 URL:(id)arg2 completionHandler:(id)arg3 ;
-(void)findUncachedThumbnailInGenStoreForRequest:(id)arg0 completionHandler:(id)arg1 ;
-(void)findUncachedThumbnailInGenStoreOrDownload:(id)arg0 completionHandler:(id)arg1 ;
...
-(void)generateThumbnailForThumbnailRequest:(id)arg0 shouldUpdateGenstore:(BOOL)arg1 completionHandler:(id)arg2 ;
...
-(void)processLargeThumbnailData:(id)arg0 withContentType:(id)arg1 precacheThumbnails:(BOOL)arg2 forRequest:(id)arg3 completionHandler:(id)arg4 ;
