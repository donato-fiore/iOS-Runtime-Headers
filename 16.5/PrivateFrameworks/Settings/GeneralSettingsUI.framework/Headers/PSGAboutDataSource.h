...
@class PSSpecifierDataSource, NSMutableDictionary, PSSpecifier, NSString, NSTimer, NSLock, SUManagerClient, CoreTelephonyClient, NDOManager, NSArray, NDOACController, SystemHealthUI;
...
@property (retain, nonatomic) SystemHealthUI *systemHealthUIClient; // ivar: _systemHealthUIClient
...
-(void)_addLocalizedKey:(id)arg0 identifier:(id)arg1 isCopyable:(BOOL)arg2 allowMultilineTitle:(BOOL)arg3 ;
-(void)_getBootStrapIccid;
-(void)_loadMediaFinished:(id)arg0 ;
-(void)_loadValues;
-(void)_setValue:(id)arg0 forPropertyKey:(id)arg1 forSpecifierWithKey:(id)arg2 ;
