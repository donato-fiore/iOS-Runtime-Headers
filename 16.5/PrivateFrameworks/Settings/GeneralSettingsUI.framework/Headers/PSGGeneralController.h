...
@class PSListController, NSTimer, PSSpecifier, NSArray, NSUserDefaults, CRCarPlayPreferences, NSString;
...
@property (retain, nonatomic) PSSpecifier *carplayMatterGroup; // ivar: _carplayMatterGroup
@property (readonly, copy) NSString *debugDescription;
@property (readonly, copy) NSString *description;
@property (readonly) NSUInteger hash;
@property (nonatomic) BOOL launchHasCompleted; // ivar: _launchHasCompleted
@property (retain, nonatomic) PSSpecifier *matterSpecifier; // ivar: _matterSpecifier
...
-(void)updateMatterWithCompletion:(id)arg0 ;
