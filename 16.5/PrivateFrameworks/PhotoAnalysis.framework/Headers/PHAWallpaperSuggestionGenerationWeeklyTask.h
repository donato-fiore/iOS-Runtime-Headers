...
#ifndef PHAWALLPAPERSUGGESTIONGENERATIONWEEKLYTASK_H
#define PHAWALLPAPERSUGGESTIONGENERATIONWEEKLYTASK_H
...
+(void)sendWallpaperGenerationCompletedBiomeEvent:(id)arg0 ;
...
-(id)initWithTaskMode:(short)arg0 ;
