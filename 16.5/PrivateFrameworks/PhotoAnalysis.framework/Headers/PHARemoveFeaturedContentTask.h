...
#ifndef PHAREMOVEFEATUREDCONTENTTASK_H
#define PHAREMOVEFEATUREDCONTENTTASK_H
...
-(BOOL)clearAllFeaturedStateForMemoriesAndSuggestionsWithGraphManager:(id)arg0 error:(*id)arg1 ;
