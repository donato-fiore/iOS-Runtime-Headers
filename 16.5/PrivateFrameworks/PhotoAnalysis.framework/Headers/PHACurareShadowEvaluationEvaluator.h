...
-(id)getDefaultEvaluationResultForModelPath:(id)arg0 isPositiveData:(BOOL)arg1 ;
-(id)initWithModelInputName:(id)arg0 modelOutputName:(id)arg1 lossName:(id)arg2 ;
-(int)accuracyForProbability:(struct ? *)arg0 isPositiveData:(BOOL)arg1 atIndex:(int)arg2 andOperatingPoint:(float)arg3 ;
