...
@protocol PHPhotoLibraryAvailabilityObserver, PHAActivityDelegate, PHAServiceOperationHandling, NSXPCListenerDelegate, OS_dispatch_queue, OS_voucher, OS_xpc_object, OS_dispatch_source;
...
-(void)updatePropertiesOfXPCActivity:(id)arg0 ;
