...
@class UIView, UIViewPropertyAnimator, _UILegibilityLabel, UILabel, UIButton, SBFLockScreenDateView, NSString, PBUIWallpaperView;
@protocol PBUIIrisWallpaperPlayerDelegate, SBSUIWallpaperPreviewViewDelegate;
...
@property (readonly, nonatomic) PBUIWallpaperView *wallpaperView; // ivar: _wallpaperView
