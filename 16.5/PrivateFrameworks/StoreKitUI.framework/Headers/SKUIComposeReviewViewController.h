...
@protocol SKUIComposeReviewFormDelegate, SKUIComposeReviewNicknameDelegate, UITextFieldDelegate, SKUIComposeReviewDelegate;


#import "SKUIComposeReviewFormViewController.h"
#import "SKUIComposeReviewNicknameViewController.h"
...
-(void)composeReviewNicknameDidCancel:(id)arg0 ;
-(void)composeReviewNicknameDidConfirm:(id)arg0 nickname:(id)arg1 ;
-(void)dealloc;
