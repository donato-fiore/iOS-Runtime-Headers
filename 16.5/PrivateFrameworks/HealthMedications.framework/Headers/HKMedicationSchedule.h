...
@property (readonly, nonatomic) ? compatibilityRange; // ivar: _compatibilityRange
...
-(NSUInteger)hash;
-(id)_copyByReplacingCompatibilityVersionRange:(struct ? )arg0 ;
...
-(id)initWithUUID:(id)arg0 medicationUUID:(id)arg1 medicationIdentifier:(id)arg2 createdUTCOffset:(id)arg3 startDateTime:(id)arg4 endDateTime:(id)arg5 timeIntervals:(id)arg6 frequencyType:(NSInteger)arg7 cycleStartDateComponent:(id)arg8 note:(id)arg9 creationTimestamp:(CGFloat)arg10 deleted:(BOOL)arg11 compatibilityVersionRange:(struct ? )arg12 ;
