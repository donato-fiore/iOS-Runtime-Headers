...
+(id)templateForPhoneCallHeuristicFromSuggestionProxy:(id)arg0 ;
...
-(id)inPhoneCallHeuristicSuggestionProxiesWithBundleIds:(id)arg0 predictionContext:(id)arg1 ;
...
-(id)seedSuggestionsForChatGuidsAndTransports:(id)arg0 ;
