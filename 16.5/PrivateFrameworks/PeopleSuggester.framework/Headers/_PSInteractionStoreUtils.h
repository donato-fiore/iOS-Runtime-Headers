...
+(id)conversationIdFromInteraction:(id)arg0 ;
...
+(id)groupInteractionsContainingSearchStringInDisplayName:(id)arg0 excludingInteractionUUIDs:(id)arg1 account:(id)arg2 directions:(id)arg3 bundleIds:(id)arg4 excludedDomainIdentifiers:(id)arg5 startDate:(id)arg6 store:(id)arg7 fetchLimit:(NSUInteger)arg8 offset:(NSUInteger)arg9 ;
+(id)interactionCacheFromStore:(id)arg0 size:(NSUInteger)arg1 queryPredicate:(id)arg2 filterBlock:(id)arg3 ;
...
+(id)interactionsMatchingAnyHandlesOrContactIds:(id)arg0 identifiers:(id)arg1 account:(id)arg2 directions:(id)arg3 mechanisms:(id)arg4 bundleIds:(id)arg5 store:(id)arg6 fetchLimit:(NSUInteger)arg7 messageInteractionCache:(id)arg8 ;
...
+(id)interactionsMatchingAnyHandlesOrDomainIds:(id)arg0 account:(id)arg1 directions:(id)arg2 mechanisms:(id)arg3 bundleIds:(id)arg4 store:(id)arg5 fetchLimit:(NSUInteger)arg6 ;
...
+(id)mostRecentInteractionWithRecipientMatchingContactIdentifier:(id)arg0 bundleIds:(id)arg1 store:(id)arg2 singleRecipient:(BOOL)arg3 ;
