...
@class NSNumber, MLModelConfiguration, NSString, ODCurareEvaluationAndReportingModule, NSMutableDictionary, NSURL, NSUserDefaults, NSDictionary, NSMutableArray;
...
@property (nonatomic) BOOL evaluateIsInvokedOnce; // ivar: _evaluateIsInvokedOnce
...
-(id)initWithRecipe:(id)arg0 knowledgeStore:(id)arg1 shouldContinueBlock:(id)arg2 ;
-(id)loadAdaptableModelUnderDirectory:(id)arg0 ;
-(id)loadDefaultModel;
-(id)personalizeModel:(id)arg0 ;
-(id)processDataWithQuery:(id)arg0 balanceNeed:(BOOL)arg1 ;
