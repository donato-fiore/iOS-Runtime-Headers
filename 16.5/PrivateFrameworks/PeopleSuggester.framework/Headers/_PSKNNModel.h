...
@property (nonatomic) NSUInteger _PSKnnModelSameBundleIdPenalty; // ivar: __PSKnnModelSameBundleIdPenalty
...
@property (nonatomic) NSUInteger _PSKnnModelShareSheetSuggestionEngagedMinimumOccurenceRegularizer; // ivar: __PSKnnModelShareSheetSuggestionEngagedMinimumOccurenceRegularizer
...
-(CGFloat)distanceOfNeighbor:(id)arg0 fromReference:(id)arg1 ;
...
-(id)extractNearestNeighborLabelsForQueryResult:(id)arg0 andNeighbors:(id)arg1 frequencyOnly:(BOOL)arg2 rankerType:(NSInteger)arg3 contactsOnly:(BOOL)arg4 reason:(id)arg5 ;
...
-(id)initWithK:(NSUInteger)arg0 interactionStore:(id)arg1 filterByBundleIds:(id)arg2 knowledgeStore:(id)arg3 contactResolver:(id)arg4 messageInteractionCache:(id)arg5 shareInteractionCache:(id)arg6 ;
