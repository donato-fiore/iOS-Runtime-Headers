...
@property (nonatomic) BOOL isCollaborationAvailable; // ivar: _isCollaborationAvailable
@property (nonatomic) BOOL isSharePlayAvailable; // ivar: _isSharePlayAvailable
@property (copy, nonatomic) NSArray *linkMetadataFromClient; // ivar: _linkMetadataFromClient
...
@property (copy, nonatomic) NSArray *seedContactIdentifiers; // ivar: _seedContactIdentifiers
...
@property (copy, nonatomic) NSArray *suggestionsFilteredByBundleIds; // ivar: _suggestionsFilteredByBundleIds
