...
+(id)calculateNormalizedCallingFrequencyForContactGivenContactIdPredicate:(id)arg0 totalFrequency:(id)arg1 numberOfDaysToLookBack:(NSInteger)arg2 timeOfShareInteraction:(id)arg3 interactionStore:(id)arg4 direction:(id)arg5 ;
+(id)calculateNormalizedShareFrequencyForContactGivenContactIdPredicate:(id)arg0 totalFrequency:(id)arg1 numberOfDaysToLookBack:(NSInteger)arg2 timeOfShareInteraction:(id)arg3 interactionStore:(id)arg4 ;
+(id)calculateNormalizedTextingFrequencyForContactGivenContactIdPredicate:(id)arg0 totalFrequency:(id)arg1 numberOfDaysToLookBack:(NSInteger)arg2 timeOfShareInteraction:(id)arg3 interactionStore:(id)arg4 direction:(id)arg5 ;
...
+(void)extractFrequencyRecencyFeaturesIntoPETMessage:(id)arg0 recipientID:(id)arg1 interaction:(id)arg2 normConstants:(id)arg3 numberOfDaysToLookBack:(NSInteger)arg4 interactionStore:(id)arg5 timeOfShareInteraction:(id)arg6 contactPropertyCache:(id)arg7 interactionCache:(id)arg8 ;
