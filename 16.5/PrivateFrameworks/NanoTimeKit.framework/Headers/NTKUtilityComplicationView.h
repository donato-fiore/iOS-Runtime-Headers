...
@protocol CDTemplateComplicationDisplay, CDComplicationDisplay, NTKUtilityComplicationView, CDComplicationDisplayObserver, CLKMonochromeFilterProvider;
...
@property (nonatomic) BOOL useAlternativePunctuation; // ivar: _useAlternativePunctuation
...
-(CGFloat)_imageViewOriginYWithBaseImageSize:(struct CGSize )arg0 labelFrame:(struct CGRect )arg1 ;
