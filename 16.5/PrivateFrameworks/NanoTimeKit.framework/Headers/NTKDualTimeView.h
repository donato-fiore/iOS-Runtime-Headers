...
@class UIView, NSDate, NSCalendar, CLKClockTimerToken, UIColor, CAReplicatorLayer, NSArray, NSString, CLKDevice, CALayer;
...
@property (readonly, nonatomic) CALayer *digitalTicksContainer; // ivar: _digitalTicksContainer
@property (readonly, nonatomic) UIView *digitalTicksContainerView; // ivar: _digitalTicksContainerView
...
-(CGFloat)_cardinalSecondTickInset;
-(CGFloat)_hourTickInset;
-(CGFloat)_minuteTickInset;
-(CGFloat)_secondTickInset;
...
-(struct CGSize )_cardinalSecondTickSize;
