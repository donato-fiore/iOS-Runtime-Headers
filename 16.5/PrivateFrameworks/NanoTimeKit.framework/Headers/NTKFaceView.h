...
@class UIView, NSTimer, NSDate, NSMutableSet, NSMutableDictionary, CAFilter, UIColor, NSString, CLKDevice, UIImageView, UIView<NTKTimeView>;
@protocol PUICCrownInputSequencerDelegate, CLKUIQuadViewHierarchyObserver, NTKContainerViewLayoutDelegate, CLKMonochromeFilterProvider, NTKComplicationDisplayWrapperViewAnimationDelegate, NTKTimeView, NTKClockHardwareInput, NTKFaceViewComplicationFactory, NTKFaceViewDelegate;
...
@property (retain, nonatomic) UIColor *complicationBackgroundColor; // ivar: _complicationBackgroundColor
...
-(BOOL)_useAlternateComplicationColorForGraphicCircularComplication:(id)arg0 ;
-(BOOL)_useAlternateComplicationColorForGraphicCircularComplicationInSlot:(id)arg0 ;
-(BOOL)_useAlternateComplicationColorForGraphicCircularComplicationInView:(id)arg0 ;
...
-(struct CGAffineTransform )_displayContentTransformForComplicationSlot:(id)arg0 displayWrapper:(id)arg1 ;
-(struct CGAffineTransform )_displayEditingTransformForComplicationSlot:(id)arg0 displayWrapper:(id)arg1 ;
...
-(void)_prepareSwatchImagesForSelectedOptions:(id)arg0 ;
-(void)_prepareToZoom;
...
-(void)prepareSwatchImagesForSelectedOptions:(id)arg0 ;
-(void)prepareToZoom;
