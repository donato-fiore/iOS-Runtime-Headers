...
@property (nonatomic) BOOL forMigration; // ivar: _forMigration
...
+(void)greenfieldFaceWithJSONObjectRepresentation:(id)arg0 forDevice:(id)arg1 withCompletion:(id)arg2 ;
+(void)initialize;
-(BOOL)_allowsEditing;
-(BOOL)_applyConfiguration:(id)arg0 allowFailure:(BOOL)arg1 ;
-(BOOL)_applyConfiguration:(id)arg0 allowFailure:(BOOL)arg1 forMigration:(BOOL)arg2 ;
...
-(void)_notifyObserversComplicationDidChangeForSlot:(id)arg0 ;
