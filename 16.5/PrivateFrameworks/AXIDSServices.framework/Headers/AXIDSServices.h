...
@protocol AXUIClientDelegate, AXUIService, OS_dispatch_queue;
...
@property (retain, nonatomic) NSObject<OS_dispatch_queue> *localServiceQueue; // ivar: _localServiceQueue
