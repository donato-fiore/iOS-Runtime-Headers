...
+(id)clientWithChannelType:(NSUInteger)arg0 ;
...
-(NSUInteger)accessRights;
-(id)_deviceEnrollmentAuthenticationDict;
-(id)_userEnrollmentAuthenticationDictWithEnrollmentID:(id)arg0 ;
-(id)_userFieldsForResponse;
-(id)initWithChannelType:(NSUInteger)arg0 ;
-(id)initWithChannelType:(NSUInteger)arg0 dataProvider:(id)arg1 ;
-(id)pushToken;
