...
+(id)sessionConnectionFailedError:(id)arg0 connectionMode:(id)arg1 sessionType:(id)arg2 sessionState:(id)arg3 dormant:(BOOL)arg4 analysisInfo:(id)arg5 ;
...
+(int)providerFromString:(id)arg0 ;
...
-(void)_emitAllCachedMessagesFor:(id)arg0 ;
...
-(void)setIsConnectionActive:(BOOL)arg0 ;
-(void)setNetId:(id)arg0 ;
-(void)setNetIdAvailable:(BOOL)arg0 ;
-(void)setOrchestratorRequestId:(id)arg0 ;
