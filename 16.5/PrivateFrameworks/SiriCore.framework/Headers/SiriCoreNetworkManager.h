...
@class NSHashTable, CoreTelephonyClient, CTServiceDescriptor, NSString, NSNumber, WRM_iRATInterface;
...
-(NSInteger)_getConnectionTechnologyForCellularInterface;
...
-(void)_signalStrengthChange:(id)arg0 ;
...
-(void)proximityRecomendationWithCompletion:(id)arg0 ;
