...
-(BOOL)hasAssociatedNetworkWithRSSI:(*NSInteger)arg0 andSNR:(*NSInteger)arg1 andCCA:(*NSInteger)arg2 andPhyMode:(*id)arg3 andChannelInfo:(*id)arg4 isCaptive:(*BOOL)arg5 ;
