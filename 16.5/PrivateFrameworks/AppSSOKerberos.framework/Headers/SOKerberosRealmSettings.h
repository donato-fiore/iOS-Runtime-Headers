...
@property (retain, nonatomic) NSString *notificationName; // ivar: _notificationName
...
@property (readonly) NSObject<OS_dispatch_semaphore> *platformSSOLoginSemaphore; // ivar: _platformSSOLoginSemaphore
