...
@property (readonly, nonatomic) NSMutableArray *allClientDrawableIntervals; // ivar: _allClientDrawableIntervals
...
@property (readonly, nonatomic) NSMutableArray *allSystemwideClientDrawableIntervals; // ivar: _allSystemwideClientDrawableIntervals
...
@property (readonly, nonatomic) NSMutableArray *longClientDrawableIntervals; // ivar: _longClientDrawableIntervals
...
@property (readonly, nonatomic) NSMutableArray *longSystemwideClientDrawableIntervals; // ivar: _longSystemwideClientDrawableIntervals
...
-(void)_handleClientDrawableInterval:(id)arg0 isLong:(BOOL)arg1 isConcise:(BOOL)arg2 ;
