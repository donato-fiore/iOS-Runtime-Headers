...
+(BOOL)_filterPassesRequiredSCForFramerate:(id)arg0 includeMetal:(BOOL)arg1 ;
+(id)_framerateCalculationAllowlist:(BOOL)arg0 ;
...
-(id)_animationWithBegin:(id)arg0 endEvent:(id)arg1 firstFrameGraceTimeController:(id)arg2 ;
-(id)_matchingEventForEvent:(id)arg0 removeIfFound:(BOOL)arg1 ;
-(id)doneProcessing;
-(id)init;
-(id)matchingEventForEvent:(id)arg0 removeIfFound:(BOOL)arg1 ;
-(id)processEndEvent:(id)arg0 firstFrameGraceTimeController:(id)arg1 isAnimation:(*BOOL)arg2 ;
