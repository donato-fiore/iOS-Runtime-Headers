...
+(id)_generatedEventArrayForEvent:(id)arg0 ;
+(id)_generatedEventFromMetadata:(id)arg0 generatorEvent:(id)arg1 ;
...
-(id)initWithName:(id)arg0 beginMct:(NSUInteger)arg1 endMct:(NSUInteger)arg2 emitMct:(NSUInteger)arg3 signpostId:(NSUInteger)arg4 generatorEvent:(id)arg5 ;
