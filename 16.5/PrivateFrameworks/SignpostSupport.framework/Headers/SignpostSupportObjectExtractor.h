...
@property (readonly, nonatomic) SignpostSupportAnimationGraceTimeController *animationFirstFrameGraceTimeController; // ivar: _animationFirstFrameGraceTimeController
...
@property (nonatomic) BOOL disableGeneratorProcessing; // ivar: _disableGeneratorProcessing
...
@property (nonatomic) BOOL includeMetalAnalysis; // ivar: _includeMetalAnalysis
...
-(BOOL)_processInternalSignpostEvent:(id)arg0 shouldReport:(BOOL)arg1 ;
