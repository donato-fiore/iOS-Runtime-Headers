...
@interface SRCSCommandStringsTable : NSObject {
    ...
    *__CFStringTokenizer _wordUnitStringTokenizer;
...
-(id)mutableAttributedStringByReplacingPlaceholderAttribute:(id)arg0 withAttributeName:(id)arg1 inAttributedString:(id)arg2 withValueTable:(id)arg3 ;
-(id)mutableAttributedStringCommandDescriptionForCommandIdentifier:(id)arg0 calculateDisplayedAttributedStringWidthBlock:(id)arg1 ;
