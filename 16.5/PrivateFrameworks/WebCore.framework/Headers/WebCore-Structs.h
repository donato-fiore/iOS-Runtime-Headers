...
typedef struct DefaultWeakPtrImpl {
} // Error Processing Struct Fields

typedef struct RefPtr<WTF::DefaultWeakPtrImpl, WTF::RawPtrTraits<WTF::DefaultWeakPtrImpl>, WTF::DefaultRefDerefTraits<WTF::DefaultWeakPtrImpl>> {
    DefaultWeakPtrImpl m_ptr;
} RefPtr<WTF::DefaultWeakPtrImpl, WTF::RawPtrTraits<WTF::DefaultWeakPtrImpl>, WTF::DefaultRefDerefTraits<WTF::DefaultWeakPtrImpl>>;

typedef struct WeakPtr<WebCore::MediaCaptureStatusBarManager, WTF::DefaultWeakPtrImpl> {
    RefPtr<WTF::DefaultWeakPtrImpl, WTF::RawPtrTraits<WTF::DefaultWeakPtrImpl>, WTF::DefaultRefDerefTraits<WTF::DefaultWeakPtrImpl>> m_impl;
} WeakPtr<WebCore::MediaCaptureStatusBarManager, WTF::DefaultWeakPtrImpl>;

typedef struct RetainPtr<SBSStatusBarStyleOverridesAssertion> {
    void m_ptr;
} RetainPtr<SBSStatusBarStyleOverridesAssertion>;

typedef struct RetainPtr<SBSStatusBarStyleOverridesCoordinator> {
    void m_ptr;
} RetainPtr<SBSStatusBarStyleOverridesCoordinator>;
...
typedef struct WeakPtr<WebCore::MediaPlayerPrivateAVFoundationObjC, WTF::DefaultWeakPtrImpl> {
    RefPtr<WTF::DefaultWeakPtrImpl, WTF::RawPtrTraits<WTF::DefaultWeakPtrImpl>, WTF::DefaultRefDerefTraits<WTF::DefaultWeakPtrImpl>> m_impl;
} WeakPtr<WebCore::MediaPlayerPrivateAVFoundationObjC, WTF::DefaultWeakPtrImpl>;
...
typedef struct WeakPtr<WebCore::QueuedVideoOutput, WTF::DefaultWeakPtrImpl> {
    RefPtr<WTF::DefaultWeakPtrImpl, WTF::RawPtrTraits<WTF::DefaultWeakPtrImpl>, WTF::DefaultRefDerefTraits<WTF::DefaultWeakPtrImpl>> m_impl;
} WeakPtr<WebCore::QueuedVideoOutput, WTF::DefaultWeakPtrImpl>;

typedef struct WeakPtr<WebCore::ReplayKitCaptureSource, WTF::DefaultWeakPtrImpl> {
    RefPtr<WTF::DefaultWeakPtrImpl, WTF::RawPtrTraits<WTF::DefaultWeakPtrImpl>, WTF::DefaultRefDerefTraits<WTF::DefaultWeakPtrImpl>> m_impl;
} WeakPtr<WebCore::ReplayKitCaptureSource, WTF::DefaultWeakPtrImpl>;

typedef struct WeakPtr<WebCore::SourceBufferPrivateAVFObjC, WTF::DefaultWeakPtrImpl> {
    RefPtr<WTF::DefaultWeakPtrImpl, WTF::RawPtrTraits<WTF::DefaultWeakPtrImpl>, WTF::DefaultRefDerefTraits<WTF::DefaultWeakPtrImpl>> m_impl;
} WeakPtr<WebCore::SourceBufferPrivateAVFObjC, WTF::DefaultWeakPtrImpl>;
...
typedef struct WeakPtr<WebCore::CaptionUserPreferencesMediaAF, WTF::DefaultWeakPtrImpl> {
    RefPtr<WTF::DefaultWeakPtrImpl, WTF::RawPtrTraits<WTF::DefaultWeakPtrImpl>, WTF::DefaultRefDerefTraits<WTF::DefaultWeakPtrImpl>> m_impl;
} WeakPtr<WebCore::CaptionUserPreferencesMediaAF, WTF::DefaultWeakPtrImpl>;
...
typedef struct WeakPtr<WebCore::LocalSampleBufferDisplayLayer, WTF::DefaultWeakPtrImpl> {
    RefPtr<WTF::DefaultWeakPtrImpl, WTF::RawPtrTraits<WTF::DefaultWeakPtrImpl>, WTF::DefaultRefDerefTraits<WTF::DefaultWeakPtrImpl>> m_impl;
} WeakPtr<WebCore::LocalSampleBufferDisplayLayer, WTF::DefaultWeakPtrImpl>;
...
typedef struct WeakPtr<WebCore::PreviewPlatformDelegate, WTF::DefaultWeakPtrImpl> {
    RefPtr<WTF::DefaultWeakPtrImpl, WTF::RawPtrTraits<WTF::DefaultWeakPtrImpl>, WTF::DefaultRefDerefTraits<WTF::DefaultWeakPtrImpl>> m_impl;
} WeakPtr<WebCore::PreviewPlatformDelegate, WTF::DefaultWeakPtrImpl>;
...
typedef struct WeakPtr<WebCore::PlaybackSessionModel, WTF::DefaultWeakPtrImpl> {
    RefPtr<WTF::DefaultWeakPtrImpl, WTF::RawPtrTraits<WTF::DefaultWeakPtrImpl>, WTF::DefaultRefDerefTraits<WTF::DefaultWeakPtrImpl>> m_impl;
} WeakPtr<WebCore::PlaybackSessionModel, WTF::DefaultWeakPtrImpl>;

typedef struct WeakPtr<WebCore::PlaybackSessionInterfaceAVKit, WTF::DefaultWeakPtrImpl> {
    RefPtr<WTF::DefaultWeakPtrImpl, WTF::RawPtrTraits<WTF::DefaultWeakPtrImpl>, WTF::DefaultRefDerefTraits<WTF::DefaultWeakPtrImpl>> m_impl;
} WeakPtr<WebCore::PlaybackSessionInterfaceAVKit, WTF::DefaultWeakPtrImpl>;
...
typedef struct HashTable<WTF::Ref<WTF::DefaultWeakPtrImpl>, WTF::Ref<WTF::DefaultWeakPtrImpl>, WTF::IdentityExtractor, WTF::DefaultHash<WTF::Ref<WTF::DefaultWeakPtrImpl>>, WTF::HashTraits<WTF::Ref<WTF::DefaultWeakPtrImpl>>, WTF::HashTraits<WTF::Ref<WTF::DefaultWeakPtrImpl>>> {
    unk ;
    void m_table;
    unsigned int m_tableForLLDB;
} HashTable<WTF::Ref<WTF::DefaultWeakPtrImpl>, WTF::Ref<WTF::DefaultWeakPtrImpl>, WTF::IdentityExtractor, WTF::DefaultHash<WTF::Ref<WTF::DefaultWeakPtrImpl>>, WTF::HashTraits<WTF::Ref<WTF::DefaultWeakPtrImpl>>, WTF::HashTraits<WTF::Ref<WTF::DefaultWeakPtrImpl>>>;

typedef struct HashSet<WTF::Ref<WTF::DefaultWeakPtrImpl>, WTF::DefaultHash<WTF::Ref<WTF::DefaultWeakPtrImpl>>, WTF::HashTraits<WTF::Ref<WTF::DefaultWeakPtrImpl>>, WTF::HashTableTraits> {
    HashTable<WTF::Ref<WTF::DefaultWeakPtrImpl>, WTF::Ref<WTF::DefaultWeakPtrImpl>, WTF::IdentityExtractor, WTF::DefaultHash<WTF::Ref<WTF::DefaultWeakPtrImpl>>, WTF::HashTraits<WTF::Ref<WTF::DefaultWeakPtrImpl>>, WTF::HashTraits<WTF::Ref<WTF::DefaultWeakPtrImpl>>> m_impl;
} HashSet<WTF::Ref<WTF::DefaultWeakPtrImpl>, WTF::DefaultHash<WTF::Ref<WTF::DefaultWeakPtrImpl>>, WTF::HashTraits<WTF::Ref<WTF::DefaultWeakPtrImpl>>, WTF::HashTableTraits>;

typedef struct WeakHashSet<WebCore::MotionManagerClient, WTF::DefaultWeakPtrImpl, WTF::EnableWeakPtrThreadingAssertions::Yes> {
    HashSet<WTF::Ref<WTF::DefaultWeakPtrImpl>, WTF::DefaultHash<WTF::Ref<WTF::DefaultWeakPtrImpl>>, WTF::HashTraits<WTF::Ref<WTF::DefaultWeakPtrImpl>>, WTF::HashTableTraits> m_set;
    unsigned int m_operationCountSinceLastCleanup;
} WeakHashSet<WebCore::MotionManagerClient, WTF::DefaultWeakPtrImpl, WTF::EnableWeakPtrThreadingAssertions::Yes>;
...
typedef struct RefPtr<WTF::ThreadSafeWeakPtrControlBlock<WebCore::VideoFullscreenInterfaceAVKit>, WTF::RawPtrTraits<WTF::ThreadSafeWeakPtrControlBlock<WebCore::VideoFullscreenInterfaceAVKit>>, WTF::DefaultRefDerefTraits<WTF::ThreadSafeWeakPtrControlBlock<WebCore::VideoFullscreenInterfaceAVKit>>> {
    void m_ptr;
} RefPtr<WTF::ThreadSafeWeakPtrControlBlock<WebCore::VideoFullscreenInterfaceAVKit>, WTF::RawPtrTraits<WTF::ThreadSafeWeakPtrControlBlock<WebCore::VideoFullscreenInterfaceAVKit>>, WTF::DefaultRefDerefTraits<WTF::ThreadSafeWeakPtrControlBlock<WebCore::VideoFullscreenInterfaceAVKit>>>;

typedef struct ThreadSafeWeakPtr<WebCore::VideoFullscreenInterfaceAVKit> {
    RefPtr<WTF::ThreadSafeWeakPtrControlBlock<WebCore::VideoFullscreenInterfaceAVKit>, WTF::RawPtrTraits<WTF::ThreadSafeWeakPtrControlBlock<WebCore::VideoFullscreenInterfaceAVKit>>, WTF::DefaultRefDerefTraits<WTF::ThreadSafeWeakPtrControlBlock<WebCore::VideoFullscreenInterfaceAVKit>>> m_controlBlock;
} ThreadSafeWeakPtr<WebCore::VideoFullscreenInterfaceAVKit>;

typedef struct RetainPtr<AVPlayerViewController> {
    void m_ptr;
} RetainPtr<AVPlayerViewController>;

typedef struct WeakObjCPtr<WebAVPlayerViewControllerDelegate> {
    id m_weakReference;
} WeakObjCPtr<WebAVPlayerViewControllerDelegate>;
...
typedef struct HashTable<WTF::RefPtr<WebCore::SecurityOrigin>, WTF::RefPtr<WebCore::SecurityOrigin>, WTF::IdentityExtractor, WTF::DefaultHash<RefPtr<WebCore::SecurityOrigin>>, WTF::HashTraits<WTF::RefPtr<WebCore::SecurityOrigin>>, WTF::HashTraits<WTF::RefPtr<WebCore::SecurityOrigin>>> {
    unk ;
    void m_table;
    unsigned int m_tableForLLDB;
} HashTable<WTF::RefPtr<WebCore::SecurityOrigin>, WTF::RefPtr<WebCore::SecurityOrigin>, WTF::IdentityExtractor, WTF::DefaultHash<RefPtr<WebCore::SecurityOrigin>>, WTF::HashTraits<WTF::RefPtr<WebCore::SecurityOrigin>>, WTF::HashTraits<WTF::RefPtr<WebCore::SecurityOrigin>>>;

typedef struct HashSet<WTF::RefPtr<WebCore::SecurityOrigin>, WTF::DefaultHash<RefPtr<WebCore::SecurityOrigin>>, WTF::HashTraits<WTF::RefPtr<WebCore::SecurityOrigin>>, WTF::HashTableTraits> {
    HashTable<WTF::RefPtr<WebCore::SecurityOrigin>, WTF::RefPtr<WebCore::SecurityOrigin>, WTF::IdentityExtractor, WTF::DefaultHash<RefPtr<WebCore::SecurityOrigin>>, WTF::HashTraits<WTF::RefPtr<WebCore::SecurityOrigin>>, WTF::HashTraits<WTF::RefPtr<WebCore::SecurityOrigin>>> m_impl;
} HashSet<WTF::RefPtr<WebCore::SecurityOrigin>, WTF::DefaultHash<RefPtr<WebCore::SecurityOrigin>>, WTF::HashTraits<WTF::RefPtr<WebCore::SecurityOrigin>>, WTF::HashTableTraits>;
...
typedef struct RetainPtr<const opaqueCMFormatDescription *> {
    void m_ptr;
} RetainPtr<const opaqueCMFormatDescription *>;

typedef struct RetainPtr<OpaqueVTDecompressionSession *> {
    void m_ptr;
} RetainPtr<OpaqueVTDecompressionSession *>;

typedef struct BlockPtr<void (__CVBuffer *, long long, long long)> {
    id m_block;
    unk field1;
} BlockPtr<void (__CVBuffer *, long long, long long)>;
