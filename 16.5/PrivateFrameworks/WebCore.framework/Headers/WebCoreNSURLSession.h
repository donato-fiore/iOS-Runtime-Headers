...
@interface WebCoreNSURLSession : NSObject {
    ...
    HashSet<WTF::RefPtr<WebCore::SecurityOrigin>, WTF::DefaultHash<RefPtr<WebCore::SecurityOrigin>>, WTF::HashTraits<WTF::RefPtr<WebCore::SecurityOrigin>>, WTF::HashTableTraits> _origins;
    Lock _dataTasksLock;
    BOOL _invalidated;
    atomic<unsigned long long> _nextTaskIdentifier;
...
-(void)task:(id)arg0 addSecurityOrigin:(*void)arg1 ;
