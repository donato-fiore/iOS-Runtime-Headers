...
@interface WebAVPlayerController : NSObject {
    WeakPtr<WebCore::PlaybackSessionModel, WTF::DefaultWeakPtrImpl> _delegate;
    WeakPtr<WebCore::PlaybackSessionInterfaceAVKit, WTF::DefaultWeakPtrImpl> _playbackSessionInterface;
