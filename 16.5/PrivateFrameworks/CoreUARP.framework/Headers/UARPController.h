...
@protocol OS_os_log, OS_dispatch_queue, UARPControllerInternalDelegate, UARPControllerChipInfoDelegate, UARPControllerDelegateProtocol;
...
-(BOOL)disableTRMSystemAuthenticationForRegistryEntryID:(id)arg0 ;
...
-(BOOL)enableTRMSystemAuthenticationForRegistryEntryID:(id)arg0 ;
-(BOOL)getAttestationCertificates:(id)arg0 assetLocationType:(NSInteger)arg1 ;
-(BOOL)getAttestationCertificatesInternal:(id)arg0 assetID:(id)arg1 ;
...
-(BOOL)registerForAttestationCertificatesAvailability:(id)arg0 ;
...
-(void)accessoryTransportNeeded:(id)arg0 isNeeded:(BOOL)arg1 ;
...
-(void)availabilityNotificationForAttestationCertificatesPosted:(int)arg0 ;
...
-(void)handleReceivedAttestationCertificates:(id)arg0 forSubjectKeyIdentifier:(id)arg1 ;
...
-(void)queryCompleteForAccessory:(id)arg0 boardID:(NSUInteger)arg1 error:(id)arg2 ;
-(void)queryCompleteForAccessory:(id)arg0 chipID:(NSUInteger)arg1 error:(id)arg2 ;
-(void)queryCompleteForAccessory:(id)arg0 chipRevision:(NSUInteger)arg1 error:(id)arg2 ;
-(void)queryCompleteForAccessory:(id)arg0 ecid:(NSUInteger)arg1 error:(id)arg2 ;
-(void)queryCompleteForAccessory:(id)arg0 enableMixMatch:(BOOL)arg1 error:(id)arg2 ;
-(void)queryCompleteForAccessory:(id)arg0 epoch:(NSUInteger)arg1 error:(id)arg2 ;
-(void)queryCompleteForAccessory:(id)arg0 firmwareVersion:(id)arg1 error:(id)arg2 ;
-(void)queryCompleteForAccessory:(id)arg0 friendlyName:(id)arg1 error:(id)arg2 ;
...
-(void)queryCompleteForAccessory:(id)arg0 liveNonce:(BOOL)arg1 error:(id)arg2 ;
-(void)queryCompleteForAccessory:(id)arg0 manifestPrefix:(id)arg1 error:(id)arg2 ;
...
-(void)queryCompleteForAccessory:(id)arg0 prefixNeedsLUN:(BOOL)arg1 error:(id)arg2 ;
-(void)queryCompleteForAccessory:(id)arg0 productionMode:(NSUInteger)arg1 error:(id)arg2 ;
-(void)queryCompleteForAccessory:(id)arg0 securityDomain:(NSUInteger)arg1 error:(id)arg2 ;
-(void)queryCompleteForAccessory:(id)arg0 securityMode:(NSUInteger)arg1 error:(id)arg2 ;
...
-(void)queryCompleteForAccessory:(id)arg0 suffixNeedsLUN:(BOOL)arg1 error:(id)arg2 ;
...
-(void)setChipInfoDelegate:(id)arg0 ;
...
-(void)unregisterForAttestationCertificatesAvailability:(int)arg0 ;
