...
@protocol AFNotifyObserverDelegate, WPHeySiriProtocol, OS_dispatch_queue, OS_dispatch_source, AFArbitrationEventUpdatesDelegate;
...
-(id)_triggerTypeForArbitrationParticipationFrom:(NSInteger)arg0 ;
...
-(int)_myriadStateForSelf:(NSUInteger)arg0 ;
...
-(void)_forceLocalWinner:(id)arg0 ;
...
-(void)_unduck;
-(void)_updateArbitrationParticipationContextWithCompletion:(id)arg0 ;
...
-(void)setCurrentRequestId:(id)arg0 ;
