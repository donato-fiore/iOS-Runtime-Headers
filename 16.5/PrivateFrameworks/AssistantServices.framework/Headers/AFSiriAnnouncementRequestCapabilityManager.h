...
+(NSInteger)notificationAnnouncementTypeForNotificationFromApp:(id)arg0 withIntentIDs:(id)arg1 notificationContent:(id)arg2 onPlatform:(NSInteger)arg3 ;
+(id)_candidateAnnounceNotificationTypesFromApp:(id)arg0 withIntentIDs:(id)arg1 notificationContentType:(id)arg2 onPlatform:(NSInteger)arg3 ;
