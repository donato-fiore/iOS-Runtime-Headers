...
-(id)_localizedStringForKey:(id)arg0 tables:(id)arg1 localizations:(id)arg2 bundle:(id)arg3 ;
-(id)_relevantTablesForTableName:(id)arg0 tableExtension:(id)arg1 bundle:(id)arg2 ;
...
-(id)localizedUIUtteranceForKey:(id)arg0 languageCode:(id)arg1 ;
