...
-(void)_isDisablingDictationOnlySyncSupported:(id)arg0 ;
-(void)_isSiriVocabularyNotificationForAddressBookSyncSupported:(id)arg0 ;
-(void)_readSyncTokenForAceHost:(id)arg0 completion:(id)arg1 ;
-(void)_runServiceMaintenance;
-(void)_sendSyncTokenToPersonalRequestsEnabledAccessoriesWithCompletion:(id)arg0 ;
-(void)_setSyncNeededForReason:(id)arg0 ;
-(void)_setSyncToken:(id)arg0 forAceHost:(id)arg1 completion:(id)arg2 ;
...
-(void)_updateMultiUserInfoForUser:(id)arg0 score:(id)arg1 companionInfo:(id)arg2 reset:(BOOL)arg3 completion:(id)arg4 ;
...
-(void)addMultiUserUser:(id)arg0 sharedId:(id)arg1 loggableSharedId:(id)arg2 iCloudAltDSID:(id)arg3 enrollmentName:(id)arg4 isPrimary:(BOOL)arg5 completion:(id)arg6 ;
...
-(void)dismissUI;
-(void)dumpAssistantState:(id)arg0 ;
...
-(void)getActiveASRLanguagesWithCompletion:(id)arg0 ;
...
-(void)resetProfileNames:(BOOL)arg0 completion:(id)arg1 ;
-(void)saveAccount:(id)arg0 setActive:(BOOL)arg1 ;
-(void)sendMetricsToServerWithCompletion:(id)arg0 ;
-(void)sendSampledAudioToServerWithCompletion:(id)arg0 ;
...
-(void)setIsHomePodInHH2Mode:(BOOL)arg0 completion:(id)arg1 ;
...
-(void)setNanoAlwaysShowRecognizedSpeech:(BOOL)arg0 withCompletion:(id)arg1 ;
...
-(void)setNanoDictationAutoPunctuationEnabled:(BOOL)arg0 withCompletion:(id)arg1 ;
...
-(void)setNanoSiriResponseShouldAlwaysPrint:(BOOL)arg0 withCompletion:(id)arg1 ;
...
-(void)setRecognizeMyVoiceEnabled:(BOOL)arg0 ;
...
-(void)setSpeechProfileExternalOfflineModelRootPath:(id)arg0 completion:(id)arg1 ;
...
-(void)showHomeProfileNamesWithCompletion:(id)arg0 ;
-(void)showLocalProfileNamesWithCompletion:(id)arg0 ;
-(void)showMultiUserCompanionInfo:(id)arg0 ;
