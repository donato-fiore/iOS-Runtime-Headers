...
@property (nonatomic, getter=isHybridUODEnabled) BOOL hybridUODEnabled; // ivar: _hybridUODEnabled
...
@property (nonatomic) NSUInteger smartSiriVolumeTTSType; // ivar: _smartSiriVolumeTTSType
