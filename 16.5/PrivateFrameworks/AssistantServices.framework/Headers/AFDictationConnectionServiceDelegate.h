...
-(void)speechDidRecognizeFinalResultCandidatePackage:(id)arg0 ;
...
-(void)speechDidRecognizePhrases:(id)arg0 rawPhrases:(id)arg1 utterances:(id)arg2 rawUtterances:(id)arg3 nluResult:(id)arg4 usingSpeechModel:(id)arg5 correctionContext:(id)arg6 audioAnalytics:(id)arg7 ;
-(void)speechDidRecognizeTokens:(id)arg0 nluResult:(id)arg1 usingSpeechModel:(id)arg2 ;
