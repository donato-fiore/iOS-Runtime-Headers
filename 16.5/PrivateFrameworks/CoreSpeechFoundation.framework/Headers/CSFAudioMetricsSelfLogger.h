...
-(id)init;
-(int)_getMHBluetoothAudioDeviceCategoryFromString:(id)arg0 ;
-(int)_getSelfStopRecordingReasonWithADStopRecordingEvent:(unsigned short)arg0 ;
-(int)_getSpeechErrorTypeWithRecordingFailedReason:(NSInteger)arg0 ;
...
-(void)logMHASRAudioConfigureStartedWithMHUUID:(id)arg0 withAudioCodecString:(id)arg1 withAudioSkippedTimeInNs:(NSUInteger)arg2 ;
-(void)logMHApplicationPlaybackAttemptedWithMHUUID:(id)arg0 withAppBundleName:(id)arg1 withAppBundleVersion:(id)arg2 ;
-(void)logMHAssistantDaemonAudioBluetoothInfoWithMHUUID:(id)arg0 withWirelessSplitterSessionState:(int)arg1 withAudioDeviceCategory:(id)arg2 ;
...
-(void)logMHAssistantDaemonAudioRecordingFailedWithMHUUID:(id)arg0 withReason:(NSInteger)arg1 vendorId:(id)arg2 productId:(id)arg3 ;
