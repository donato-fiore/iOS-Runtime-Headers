...
@property (retain, nonatomic) FLSQLiteDatabaseConnection *dbConnection; // ivar: _dbConnection
...
@property (nonatomic) *sqlite3_stmt maxRowIdStatement; // ivar: _maxRowIdStatement
...
-(id)initWithStoreId:(id)arg0 dbConnection:(id)arg1 loggingContext:(id)arg2 ;
-(id)initWithStoreId:(id)arg0 loggingContext:(id)arg1 ;
-(id)metadataForBatch:(id)arg0 ;
-(id)persist:(id)arg0 ;
