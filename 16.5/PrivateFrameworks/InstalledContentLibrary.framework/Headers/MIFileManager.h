...
-(id)_realPathWhatExistsInPath:(id)arg0 isDirectory:(BOOL)arg1 ;
...
-(id)realPathForURL:(id)arg0 allowNonExistentPathComponents:(BOOL)arg1 isDirectory:(BOOL)arg2 error:(*id)arg3 ;
...
-(void)logAccessPermissionsForURL:(id)arg0 ;
