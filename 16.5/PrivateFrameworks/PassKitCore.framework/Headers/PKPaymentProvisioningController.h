...
@class NSMutableSet, NSTimer, NSString, NSHashTable, NSSet, CLLocationManager, NSData, NSMutableArray, NSArray, CIDVUIProofingFlowManager, NSOrderedSet, NSExtension;
@protocol CIDVUIProofingFlowManagerDelegate, CLLocationManagerDelegate, PKPaymentServiceDelegate, PKAccountServiceObserver, PKPaymentWebServiceDelegate, OS_dispatch_source, OS_dispatch_queue, PKCloudStoreCoordinatorDelegate;
...
@property (nonatomic) BOOL preventsFeatureApplications; // ivar: _preventsFeatureApplications
...
@property (readonly, nonatomic) NSOrderedSet *provisionedPasses; // ivar: _provisionedPasses
...
-(BOOL)hasPaymentPass;
-(BOOL)isWatchSupportedForProduct:(id)arg0 ;
-(BOOL)provisioningUserInterfaceIsVisible;
-(BOOL)willPassWithUniqueIdentifierAutomaticallyBecomeDefault:(id)arg0 ;
-(NSInteger)availableSecureElementPassSpaces;
-(id)_accountsForFeatureIdentifier:(NSUInteger)arg0 ;
...
-(void)_addOrUpdateProvisonedPassData:(id)arg0 ;
-(void)_applyIdentityConfiguration:(NSUInteger)arg0 activeConfigurations:(id)arg1 completion:(id)arg2 ;
...
-(void)_ingestProvisioningPassData:(id)arg0 completion:(id)arg1 ;
...
-(void)_updateRequirementsRequestForSEP:(id)arg0 completion:(id)arg1 ;
...
-(void)requestExternalizedAuthForWatchWithVisibleViewController:(id)arg0 completion:(id)arg1 ;
...
-(void)resolveLocalEligibilityRequirementsForAppleBalanceCredential:(id)arg0 withCompletion:(id)arg1 ;
