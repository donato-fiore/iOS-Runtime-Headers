...
+(id)_cloudRecordKeyForRewardsProperty:(NSUInteger)arg0 ;
...
-(NSUInteger)hash;
-(NSUInteger)itemType;
-(id)_rewardItemsFromRecord:(id)arg0 property:(NSUInteger)arg1 ;
-(id)copyWithZone:(struct _NSZone *)arg0 ;
-(id)description;
-(id)enhancedMerchantRewardsItems;
-(id)initWithCloudStoreCoder:(id)arg0 ;
-(id)initWithCloudStoreCoder:(id)arg0 property:(NSUInteger)arg1 ;
...
-(id)totalAmountForUnit:(NSUInteger)arg0 ;
-(id)totalEligibleValueForUnit:(NSUInteger)arg0 ;
-(void)_encodeServerDataWithCloudStoreCoder:(id)arg0 property:(NSUInteger)arg1 ;
-(void)applyPropertiesFromCloudStoreRecord:(id)arg0 ;
-(void)applyPropertiesFromCloudStoreRecord:(id)arg0 property:(NSUInteger)arg1 ;
-(void)encodeWithCloudStoreCoder:(id)arg0 codingType:(NSUInteger)arg1 ;
-(void)encodeWithCloudStoreCoder:(id)arg0 codingType:(NSUInteger)arg1 property:(NSUInteger)arg2 ;
