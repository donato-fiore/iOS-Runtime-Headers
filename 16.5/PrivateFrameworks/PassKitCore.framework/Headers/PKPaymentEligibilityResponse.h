...
@property (readonly, copy, nonatomic) NSString *credentialAuthorityIdentifier; // ivar: _credentialAuthorityIdentifier
...
@property (readonly, copy, nonatomic) NSString *fpanIdentifier; // ivar: _fpanIdentifier
...
@property (readonly, copy, nonatomic) NSString *sanitizedPrimaryAccountNumber; // ivar: _sanitizedPrimaryAccountNumber
...
@property (readonly, nonatomic) NSInteger supersededBy; // ivar: _supersededBy
@property (readonly, copy, nonatomic) PKPaymentEligibilitySupplementaryData *supplementaryData; // ivar: _supplementaryData
@property (readonly, nonatomic) BOOL supportsVirtualCardNumber; // ivar: _supportsVirtualCardNumber
