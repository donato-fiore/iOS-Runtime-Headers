...
-(void)deletePeerPaymentPendingRequestsForRequestTokens:(id)arg0 ;
...
-(void)insertOrUpdatePeerPaymentPendingRequests:(id)arg0 shouldScheduleNotifications:(BOOL)arg1 ;
-(void)peerPaymentPendingRequestsChanged;
-(void)peerPaymentPendingRequestsForPeerPaymentAccountWithCompletion:(id)arg0 ;
-(void)peerPaymentPendingRequestsForRequestTokens:(id)arg0 completion:(id)arg1 ;
...
-(void)presentRegistrationFlowWithAccount:(id)arg0 amount:(id)arg1 state:(NSUInteger)arg2 senderAddress:(id)arg3 orientation:(id)arg4 hostSceneIdentifier:(id)arg5 completion:(id)arg6 ;
-(void)presentRegistrationFlowWithAccount:(id)arg0 orientation:(id)arg1 hostSceneIdentifier:(id)arg2 completion:(id)arg3 ;
