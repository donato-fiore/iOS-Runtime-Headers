...
@property (copy, nonatomic) NSData *longTermPrivacyKey; // ivar: _longTermPrivacyKey
@property (copy, nonatomic) NSString *nonce; // ivar: _nonce
@property (copy, nonatomic) NSData *progenitorKeyCASDAttestation; // ivar: _progenitorKeyCASDAttestation
...
@property (copy, nonatomic) NSData *serverAttestedProvisioningData; // ivar: _serverAttestedProvisioningData
...
@property (copy, nonatomic) NSArray *transactionKeys; // ivar: _transactionKeys
