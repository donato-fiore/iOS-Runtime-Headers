...
@property (readonly, nonatomic, getter=isUserChoice) BOOL userChoice; // ivar: _userChoice


+(BOOL)extractApplicationIdentifier:(*id)arg0 subcredentialIdentifier:(*id)arg1 fromIdentifiers:(id)arg2 ;
+(BOOL)supportsSecureCoding;
-(BOOL)getAppletIdentifiers:(id)arg0 appletsToKeys:(id)arg1 includeKeyContainerAsApplet:(BOOL)arg2 ;
