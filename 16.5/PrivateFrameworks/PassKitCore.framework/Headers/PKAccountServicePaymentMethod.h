...
@property (nonatomic) NSUInteger selectedMethods; // ivar: _selectedMethods


+(BOOL)supportsSecureCoding;
-(id)initWithBankAccountInformation:(id)arg0 peerPaymentBalance:(id)arg1 deviceSupportsPeerPaymentAccountPayment:(BOOL)arg2 selectedMethods:(NSUInteger)arg3 ;
