...
@class NSString, CNContact, NSData, NSDate;
...
@property (copy, nonatomic) NSString *nameFromSafari; // ivar: _nameFromSafari
...
+(id)cardsForPaymentPass:(id)arg0 ;
+(id)cardsForPaymentPass:(id)arg0 accordingToWebService:(id)arg1 ;
...
-(void)setContactNameEnteredInSafari:(id)arg0 completion:(id)arg1 ;
