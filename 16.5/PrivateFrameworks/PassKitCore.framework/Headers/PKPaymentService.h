...
-(BOOL)isExpressModeEnabledForPassUniqueIdentifier:(id)arg0 ;
-(BOOL)isExpressModeEnabledForRemotePassUniqueIdentifier:(id)arg0 ;
...
-(void)addPassShare:(id)arg0 onCredentialWithIdentifier:(id)arg1 completion:(id)arg2 ;
...
-(void)applicationMessagesWithCompletion:(id)arg0 ;
...
-(void)augmentedProductForInstallmentConfiguration:(id)arg0 experimentDetails:(id)arg1 withCompletion:(id)arg2 ;
...
-(void)clearSafariCardImportNotificationHistoryWithCompletion:(id)arg0 ;
-(void)clearSafariCardImportNotificationsWithCompletion:(id)arg0 ;
...
-(void)createSingleUseShareURLWithMessage:(id)arg0 timeToLive:(NSUInteger)arg1 completion:(id)arg2 ;
...
-(void)deleteSharingMessage:(id)arg0 ;
-(void)deleteTransactionReceiptWithUniqueID:(id)arg0 completion:(id)arg1 ;
-(void)didReceiveActivationCodeFailureForCredentialIdentifier:(id)arg0 attemptsRemaining:(NSUInteger)arg1 completion:(id)arg2 ;
...
-(void)merchantForPassUniqueIdentifier:(id)arg0 withAuxiliaryPassInformationItem:(id)arg1 completion:(id)arg2 ;
-(void)messagesForPaymentPassWithUniqueIdentifier:(id)arg0 completion:(id)arg1 ;
-(void)notifyForSafariCardImportConsentWithCompletion:(id)arg0 ;
-(void)notifyForSafariCardImportWithCredentials:(id)arg0 withCompletion:(id)arg1 ;
-(void)passOwnershipTokenWithIdentifier:(id)arg0 completion:(id)arg1 ;
-(void)passSharesForCredentialIdentifier:(id)arg0 completion:(id)arg1 ;
...
-(void)paymentPassForVirtualCard:(id)arg0 completion:(id)arg1 ;
...
-(void)pendingShareActivationForShareIdentifier:(id)arg0 completion:(id)arg1 ;
...
-(void)processSharingCLICommands:(id)arg0 completion:(id)arg1 ;
...
-(void)provisionIdentityPassWithPassMetadata:(id)arg0 targetDeviceIdentifier:(id)arg1 credentialIdentifier:(id)arg2 attestations:(id)arg3 completion:(id)arg4 ;
-(void)pushProvisioningSharingIdentifiers:(id)arg0 ;
-(void)rangingSuspensionReasonForAppletSubcredential:(id)arg0 forPaymentApplicationID:(id)arg1 completion:(id)arg2 ;
...
-(void)regenerateVPANCardCredentialsForVirtualCard:(id)arg0 authorization:(id)arg1 completion:(id)arg2 ;
...
-(void)removeApplicationMessageWithKey:(id)arg0 ;
-(void)removeApplicationMessagesWithKeys:(id)arg0 completion:(id)arg1 ;
...
-(void)sendSharingMessageTo:(id)arg0 message:(id)arg1 completion:(id)arg2 ;
...
-(void)setNFCPayloadState:(NSUInteger)arg0 forPass:(id)arg1 ;
...
-(void)simulateEnableBiometricsForPass:(id)arg0 ;
-(void)simulateExpressTransactionForPassUniqueIdentifier:(id)arg0 ;
...
-(void)suggestPaymentSafariCredentialImport:(id)arg0 withCompletion:(id)arg1 ;
-(void)tappedApplicationMessageWithKey:(id)arg0 ;
...
-(void)transactionCountByPeriodForRequest:(id)arg0 calendar:(id)arg1 unit:(NSUInteger)arg2 includePurchaseTotal:(BOOL)arg3 completion:(id)arg4 ;
...
-(void)updateCardholderNameFromSafari:(id)arg0 forVirtualCard:(id)arg1 completion:(id)arg2 ;
-(void)updateDateLastUsedBySafari:(id)arg0 forVirtualCard:(id)arg1 completion:(id)arg2 ;
...
-(void)userNotificationActionPerformed:(NSUInteger)arg0 applicationMessageContentIdentifier:(id)arg1 completion:(id)arg2 ;
...
-(void)virtualCardsWithActiveVPAN:(id)arg0 ;
-(void)vpanCardCredentialsForVirtualCard:(id)arg0 authorization:(id)arg1 merchantHost:(id)arg2 completion:(id)arg3 ;
