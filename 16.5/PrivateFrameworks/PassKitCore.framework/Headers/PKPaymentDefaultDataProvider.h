...
-(void)cashbackByPeriodForTransactionSourceIdentifiers:(id)arg0 withStartDate:(id)arg1 endDate:(id)arg2 calendar:(id)arg3 calendarUnit:(NSUInteger)arg4 type:(NSUInteger)arg5 completion:(id)arg6 ;
...
-(void)installmentPlanTransactionsForTransactionSourceIdentifiers:(id)arg0 accountIdentifier:(id)arg1 redeemed:(BOOL)arg2 withRedemptionType:(NSUInteger)arg3 startDate:(id)arg4 endDate:(id)arg5 completion:(id)arg6 ;
...
-(void)setHidePayLaterOptions:(BOOL)arg0 ;
-(void)setOrderManagementDisabled:(BOOL)arg0 ;
-(void)setOrderManagementNotificationsDisabled:(BOOL)arg0 ;
-(void)setPaymentHandoffDisabled:(BOOL)arg0 ;
-(void)sharesDidUpdateWithPaymentPassWithUniqueIdentifier:(id)arg0 ;
-(void)sharingCapabilitiesForPassIdentifier:(id)arg0 outHasShares:(*BOOL)arg1 outHasShareableEntitlements:(*BOOL)arg2 ;
...
-(void)transactionCountByPeriodForRequest:(id)arg0 calendar:(id)arg1 calendarUnit:(NSUInteger)arg2 includePurchaseTotal:(BOOL)arg3 completion:(id)arg4 ;
...
-(void)transactionTagsForTransactionWithIdentifier:(id)arg0 completion:(id)arg1 ;
