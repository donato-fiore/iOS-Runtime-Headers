...
@class NSString, NSDecimalNumber, NSArray, NSSet, NSNumber, NSDate, NSData, CLLocation, NSDictionary, NSURL, NSUUID, NSOrderedSet, NSTimeZone;
...
@property (retain, nonatomic) NSArray *transfers; // ivar: _transfers
...
+(id)formattedBalanceAdjustmentForCurrencyAmount:(id)arg0 transactionType:(NSInteger)arg1 adjustmentType:(NSInteger)arg2 peerPaymentType:(NSInteger)arg3 featureIdentifier:(NSUInteger)arg4 pending:(BOOL)arg5 ;
+(id)formattedBalanceAdjustmentForTransactionAmount:(id)arg0 transactionType:(NSInteger)arg1 adjustmentType:(NSInteger)arg2 peerPaymentType:(NSInteger)arg3 featureIdentifier:(NSUInteger)arg4 ;
...
-(id)_formatBalanceAdjustmentTransactionAmount:(id)arg0 ;
