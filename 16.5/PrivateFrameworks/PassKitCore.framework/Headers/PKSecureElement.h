...
@protocol NFRemoteAdminEventListener, OS_dispatch_source, OS_dispatch_queue;
...
+(id)signChallenge:(id)arg0 signatureEntanglementMode:(NSUInteger)arg1 session:(id)arg2 signatureInfo:(*id)arg3 error:(*id)arg4 ;
...
-(id)_appletsForAIDs:(id)arg0 withSession:(id)arg1 ;
-(id)init;
-(void)SEPPairingInfoWithCompletion:(id)arg0 ;
-(void)_credentialsForAIDs:(id)arg0 session:(id)arg1 completion:(id)arg2 ;
...
-(void)appletCredentialsForAIDs:(id)arg0 completion:(id)arg1 ;
...
-(void)initializeSecureElementIfNecessaryWithHandler:(id)arg0 ;
...
-(void)longTermPrivacyKeysForCredentialGroupIdentifier:(id)arg0 privacyKeyIdentifier:(id)arg1 completion:(id)arg2 ;
...
-(void)verifySignedChallenge:(id)arg0 forRelyingParty:(id)arg1 relyingPartyAccountHash:(id)arg2 fidoKeyHash:(id)arg3 completion:(id)arg4 ;
