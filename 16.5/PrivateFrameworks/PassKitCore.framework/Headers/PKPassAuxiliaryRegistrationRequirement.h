...
@property (readonly, nonatomic) BOOL canLocallyInvalidateRegistrationState; // ivar: _canLocallyInvalidateRegistrationState
@property (retain, nonatomic) NSString *identifier; // ivar: _identifier
@property (readonly, nonatomic) NSInteger numberOfKeys; // ivar: _numberOfKeys
