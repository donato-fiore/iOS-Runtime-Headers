...
-(id)accountBalancesForAccountIdentifier:(id)arg0 startDate:(id)arg1 endDate:(id)arg2 type:(NSUInteger)arg3 ;
...
-(void)accountEnhancedMerchantBehaviorForAccountWithIdentifier:(id)arg0 completion:(id)arg1 ;
-(void)accountEnhancedMerchantsForAccountWithIdentifier:(id)arg0 completion:(id)arg1 ;
-(void)accountEntityOrderingsForAccountWithIdentifier:(id)arg0 entityType:(NSUInteger)arg1 completion:(id)arg2 ;
...
-(void)accountHoldsForAccountIdentifier:(id)arg0 completion:(id)arg1 ;
-(void)accountPendingFamilyMembersForAccountIdentifier:(id)arg0 completion:(id)arg1 ;
-(void)accountPromotionBehaviorForAccountWithIdentifier:(id)arg0 completion:(id)arg1 ;
-(void)accountPromotionsForAccountWithIdentifier:(id)arg0 completion:(id)arg1 ;
-(void)accountRemoved:(id)arg0 ;
-(void)accountStatementMetadataForAllAccountsWithCompletion:(id)arg0 ;
-(void)accountStatementMetadataForStatementIdentifier:(id)arg0 accountIdentifier:(id)arg1 completion:(id)arg2 ;
...
-(void)dailyCashEligibleDestinationsForAccountWithIdentifier:(id)arg0 completion:(id)arg1 ;
-(void)dealloc;
-(void)defaultAccountForFeature:(NSUInteger)arg0 completion:(id)arg1 ;
-(void)deleteAccountEnhancedMerchant:(id)arg0 forAccountWithIdentifier:(id)arg1 completion:(id)arg2 ;
-(void)deleteAccountPromotion:(id)arg0 forAccountWithIdentifier:(id)arg1 completion:(id)arg2 ;
...
-(void)deleteFinancingPlanWithIdentifier:(id)arg0 accountIdentifier:(id)arg1 completion:(id)arg2 ;
-(void)deleteFinancingPlansForAccountIdentifier:(id)arg0 completion:(id)arg1 ;
-(void)deleteFinancingPlansForAllAccountsWithCompletion:(id)arg0 ;
...
-(void)financingPlanForPlanIdentifier:(id)arg0 completion:(id)arg1 ;
-(void)financingPlanInstallmentsDueDateRangeForAccountIdentifier:(id)arg0 financingPlanStates:(id)arg1 completion:(id)arg2 ;
-(void)financingPlansForAllAccountsWithCompletion:(id)arg0 ;
-(void)financingPlansWithQueries:(id)arg0 completion:(id)arg1 ;
-(void)financingPlansWithQuery:(id)arg0 completion:(id)arg1 ;
...
-(void)insertOrUpdateAccountEnhancedMerchants:(id)arg0 accountIdentifier:(id)arg1 completion:(id)arg2 ;
-(void)insertOrUpdateAccountPromotions:(id)arg0 accountIdentifier:(id)arg1 completion:(id)arg2 ;
-(void)insertOrUpdateLocalAccount:(id)arg0 completion:(id)arg1 ;
-(void)insertOrUpdateLocalFinancingPlans:(id)arg0 accountIdentifier:(id)arg1 completion:(id)arg2 ;
-(void)insertSummaryNotificationForAccountIdentifier:(id)arg0 summaryType:(NSInteger)arg1 completion:(id)arg2 ;
-(void)lastRedemptionEventToDestination:(NSUInteger)arg0 forAccountIdentifier:(id)arg1 altDSID:(id)arg2 completion:(id)arg3 ;
...
-(void)payLaterCardMagnitudesForAccountIdentifier:(id)arg0 completion:(id)arg1 ;
...
-(void)resetAccountBalancesForAccountIdentifier:(id)arg0 completion:(id)arg1 ;
-(void)rewardsTierSummaryForTransactionSourceIdentifiers:(id)arg0 currencyCode:(id)arg1 startDate:(id)arg2 endDate:(id)arg3 completion:(id)arg4 ;
-(void)savingsStatementsForAccountIdentifier:(id)arg0 completion:(id)arg1 ;
...
-(void)taxFormsForAccountIdentifier:(id)arg0 completion:(id)arg1 ;
...
-(void)triggerStatementMetadataProcessingForAccountIdentifier:(id)arg0 completion:(id)arg1 ;
-(void)unregisterObserver:(id)arg0 ;
-(void)updateAccountBalancesForAccountIdentifier:(id)arg0 startDate:(id)arg1 endDate:(id)arg2 type:(NSUInteger)arg3 completion:(id)arg4 ;
-(void)updateAccountEnhancedMerchantsForAccountWithIdentifier:(id)arg0 completion:(id)arg1 ;
-(void)updateAccountEnhancedMerchantsForAccountWithIdentifier:(id)arg0 cooldownLevel:(NSUInteger)arg1 completion:(id)arg2 ;
-(void)updateAccountEnhancedMerchantsForAccountWithIdentifier:(id)arg0 ignoreErrorBackoff:(BOOL)arg1 cooldownLevel:(NSUInteger)arg2 completion:(id)arg3 ;
-(void)updateAccountPromotionsForAccountWithIdentifier:(id)arg0 completion:(id)arg1 ;
-(void)updateAccountPromotionsForAccountWithIdentifier:(id)arg0 ignoreErrorBackoff:(BOOL)arg1 observeCooldownPeriod:(BOOL)arg2 completion:(id)arg3 ;
-(void)updateAccountPromotionsForAccountWithIdentifier:(id)arg0 observeCooldownPeriod:(BOOL)arg1 completion:(id)arg2 ;
-(void)updateAccountStatementMetadataForStatementIdentifier:(id)arg0 accountIdentifier:(id)arg1 completion:(id)arg2 ;
...
-(void)updateCreditStatementsForAccountIdentifier:(id)arg0 completion:(id)arg1 ;
-(void)updateFinancingPlansForAccountWithIdentifier:(id)arg0 pageOffset:(NSUInteger)arg1 limit:(NSUInteger)arg2 ignoreLastUpdatedDate:(BOOL)arg3 forceFetch:(BOOL)arg4 completion:(id)arg5 ;
-(void)updateImpressionCount:(NSInteger)arg0 promotionProgramIdentifier:(id)arg1 accountIdentifier:(id)arg2 completion:(id)arg3 ;
-(void)updateImpressionCountsForPromotions:(id)arg0 accountIdentifier:(id)arg1 completion:(id)arg2 ;
...
-(void)updateSavingsStatementsForAccountIdentifier:(id)arg0 completion:(id)arg1 ;
...
-(void)updateTaxFormsForAccountIdentifier:(id)arg0 completion:(id)arg1 ;
