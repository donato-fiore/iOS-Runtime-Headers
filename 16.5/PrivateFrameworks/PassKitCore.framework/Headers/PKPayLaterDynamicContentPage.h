...
@property (copy, nonatomic) NSString *altHeaderSubtitle; // ivar: _altHeaderSubtitle
@property (nonatomic) NSInteger altHeaderSubtitleTimeInterval; // ivar: _altHeaderSubtitleTimeInterval
...
@property (retain, nonatomic) PKCurrencyAmount *maximumAmount; // ivar: _maximumAmount
