...
@property (copy, nonatomic) NSArray *autoTopUpFields; // ivar: _autoTopUpFields
@property (copy, nonatomic) NSArray *auxiliaryPassInformationSections; // ivar: _auxiliaryPassInformationSections
...
@property (retain, nonatomic) NSDictionary *issuerBindingInformation; // ivar: _issuerBindingInformation
