...
@property (readonly, nonatomic) BOOL isDeferredPayment; // ivar: _isDeferredPayment
...
-(id)initWithMerchantTokenId:(id)arg0 appleMerchantId:(id)arg1 merchantName:(id)arg2 merchantIconURL:(id)arg3 merchantTokenManagementURL:(id)arg4 tokenCategory:(id)arg5 isDeferredPayment:(BOOL)arg6 ;
