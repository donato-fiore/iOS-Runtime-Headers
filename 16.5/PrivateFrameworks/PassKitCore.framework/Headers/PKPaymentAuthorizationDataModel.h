...
@property (retain, nonatomic) PKPayLaterProductAssessmentCollection *assessmentCollection; // ivar: _assessmentCollection
...
@property (retain, nonatomic) PKPaymentOrderDetails *pendingOrderDetails; // ivar: _pendingOrderDetails
...
@property (retain, nonatomic) PKPayLaterFinancingOption *previouslySelectedFinancingOption; // ivar: _previouslySelectedFinancingOption
...
@property (nonatomic) BOOL supportsEmptyPass; // ivar: _supportsEmptyPass
...
-(id)_filterAndProcessPaymentApplicationsUsingConfiguration:(id)arg0 withPrimaryPaymentApplication:(id)arg1 passHasAssociatedPeerPaymentAccount:(BOOL)arg2 ;
...
-(id)enhancedMerchantInfoForPass:(id)arg0 ;
-(id)init;
...
-(void)refreshPaymentMethodsAndNotifyFinancingController:(BOOL)arg0 ;
-(void)setAutomaticReloadPaymentRequest:(id)arg0 ;
-(void)setDeferredPaymentRequest:(id)arg0 ;
-(void)setEnhancedMerchantInfo:(id)arg0 forPass:(id)arg1 ;
-(void)setMultiTokenContexts:(id)arg0 ;
-(void)setRecurringPaymentRequest:(id)arg0 ;
