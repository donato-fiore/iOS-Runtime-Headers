...
-(void)_sendAnalyticsForQuote:(id)arg0 withRequest:(id)arg1 ;
...
-(void)sendAuthorizedQuoteAnalyticsWithSuccess:(BOOL)arg0 authorizedQuote:(id)arg1 status:(NSInteger)arg2 ;
