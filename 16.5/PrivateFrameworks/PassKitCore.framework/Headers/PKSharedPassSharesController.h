...
-(NSInteger)_totalPendingCredentialShares;
-(NSInteger)_totalPendingShares;
-(NSUInteger)_numberOfSharesPartnerDoesNotKnowAbout;
-(id)_contactResolver;
-(id)_feature;
...
-(void)_immobilizerTokenCountWithCompletion:(id)arg0 ;
