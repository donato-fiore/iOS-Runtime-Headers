...
@property (readonly, nonatomic) NSData *progenitorKeyCASDAttestation; // ivar: _progenitorKeyCASDAttestation
@property (readonly, nonatomic) NSData *serverAttestedProvisioningData; // ivar: _serverAttestedProvisioningData
...
@property (readonly, nonatomic) NSArray *transactionKeys; // ivar: _transactionKeys


+(BOOL)supportsSecureCoding;
-(id)initWithAuthorizationKeyAttestation:(id)arg0 deviceEncryptionKeyAttestation:(id)arg1 deviceEncryptionKeyAuthorization:(id)arg2 progenitorKeyCASDAttestation:(id)arg3 transactionKeys:(id)arg4 serverAttestedProvisioningData:(id)arg5 ;
