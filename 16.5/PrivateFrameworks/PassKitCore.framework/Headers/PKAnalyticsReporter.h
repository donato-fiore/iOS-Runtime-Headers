...
@class NSData, RTCReporting, NSString;
...
+(id)analyticsErrorTextForError:(NSInteger)arg0 ;
...
+(id)virtualCardReferralSource:(NSUInteger)arg0 ;
...
+(void)reportAccountRewardsEventIfNecessary:(id)arg0 ;
...
+(void)updateIdentityEventToReportDashboardAnalytics:(id)arg0 forPass:(id)arg1 ;
