...
-(void)downloadAssetCatalog:(id)arg0 ;
-(void)dynamicAssetWithIdentifier:(id)arg0 mappedIdentifierPrefix:(id)arg1 parameters:(id)arg2 timeout:(NSUInteger)arg3 completion:(id)arg4 ;
-(void)dynamicAssetWithIdentifier:(id)arg0 parameters:(id)arg1 timeout:(NSUInteger)arg2 completion:(id)arg3 ;
-(void)dynamicAssetsIndex:(id)arg0 ;
-(void)dynamicStringWithIdentifier:(id)arg0 timeout:(NSUInteger)arg1 completion:(id)arg2 ;
...
-(void)schedulePrefetchDynamicAssetsWithInterval:(CGFloat)arg0 queue:(id)arg1 ;
