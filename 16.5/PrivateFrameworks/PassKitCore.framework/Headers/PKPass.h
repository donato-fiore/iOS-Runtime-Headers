...
-(BOOL)isUpdatable;
-(BOOL)linksToApp;
-(BOOL)supportsFeature:(NSUInteger)arg0 forDevice:(id)arg1 version:(id)arg2 ;
-(BOOL)supportsFeatureForCurrentDevice:(NSUInteger)arg0 ;
-(BOOL)supportsSharing;
-(BOOL)supportsSyncing;
-(BOOL)wasAchivedInCloudStoreWithIdentifier:(id)arg0 ;
-(NSUInteger)itemType;
...
-(id)stripImage;
-(id)systemFieldsDataForCloudStoreWithIdentifier:(id)arg0 ;
-(id)thumbnailImage;
...
-(void)setSystemFieldsMetata:(id)arg0 forCloudStoreWithIdentifier:(id)arg1 ;
