...
-(BOOL)hasPassesWithSupportedNetworks:(id)arg0 merchantCapabilities:(NSUInteger)arg1 issuerCountryCodes:(id)arg2 webDomain:(id)arg3 isMultiTokensRequest:(BOOL)arg4 ;
...
-(BOOL)sendRKEPassThroughMessage:(id)arg0 forSessionIdentifier:(id)arg1 error:(*id)arg2 ;
...
-(id)inAppPrivateLabelPaymentPassesForApplicationIdentifier:(id)arg0 issuerCountryCodes:(id)arg1 isMultiTokensRequest:(BOOL)arg2 ;
-(id)inAppPrivateLabelPaymentPassesForWebDomain:(id)arg0 issuerCountryCodes:(id)arg1 isMultiTokensRequest:(BOOL)arg2 ;
-(id)init;
-(id)initWithMachServiceName:(id)arg0 resumeNotificationName:(id)arg1 interfaceType:(NSUInteger)arg2 ;
-(id)manifestHashForPassWithUniqueID:(id)arg0 ;
-(id)passForProvisioningCredentialHash:(id)arg0 ;
-(id)passLocalizedStringForKey:(id)arg0 uniqueID:(id)arg1 ;
-(id)passUniqueIDsForAssociatedApplicationIdentifier:(id)arg0 ;
...
-(void)hasInAppPaymentPassesForNetworks:(id)arg0 capabilities:(NSUInteger)arg1 issuerCountryCodes:(id)arg2 isMultiTokensRequest:(BOOL)arg3 withHandler:(id)arg4 ;
...
-(void)hasInAppPrivateLabelPaymentPassesForApplicationIdentifier:(id)arg0 issuerCountryCodes:(id)arg1 isMultiTokensRequest:(BOOL)arg2 withHandler:(id)arg3 ;
-(void)hasInAppPrivateLabelPaymentPassesForWebDomain:(id)arg0 issuerCountryCodes:(id)arg1 isMultiTokensRequest:(BOOL)arg2 withHandler:(id)arg3 ;
-(void)introduceDatabaseIntegrityProblem;
-(void)invalidateVehicleConnectionSessionIdentifier:(id)arg0 ;
...
-(void)postUpgradesAvailableNotificationForMarket:(id)arg0 passUniqueID:(id)arg1 ;
-(void)prepareForBackupRestoreWithExistingPreferencesData:(id)arg0 ;
...
-(void)presentIssuerBindingFlowForIssuerData:(id)arg0 signature:(id)arg1 orientation:(id)arg2 ;
...
-(void)recoverPassWithUniqueID:(id)arg0 ;
...
-(void)requestIssuerBoundPassesWihBindingWithData:(id)arg0 automaticallyProvision:(BOOL)arg1 withCompletion:(id)arg2 ;
...
-(void)sortedTransitPassesForTransitNetworkIdentifiersWithCompletion:(id)arg0 ;
...
-(void)startVehicleConnectionSessionWithPassUniqueIdentifier:(id)arg0 completion:(id)arg1 ;
