...
-(BOOL)hasActiveVirtualCardAccordingToWebService:(id)arg0 ;
...
-(BOOL)isAutoTopUpBalance:(id)arg0 ;
-(BOOL)isCarKeyPass;
...
-(BOOL)supportsFeatureForCurrentDevice:(NSUInteger)arg0 ;
-(BOOL)supportsVirtualCardNumber;
-(BOOL)supportsVirtualCardNumberAccordingToWebService:(id)arg0 ;
...
-(id)eligibleExpressUpgradeRequestsForDeviceClass:(id)arg0 deviceSEIDs:(id)arg1 deviceVersion:(id)arg2 technologyTest:(id)arg3 ;
