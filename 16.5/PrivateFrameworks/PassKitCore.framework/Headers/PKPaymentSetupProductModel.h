...
-(id)allSections;
-(id)allSetupProducts;
-(id)availableProductsForFeatureIdentifier:(NSUInteger)arg0 ;
-(id)availableProductsForProductIdentifiers:(id)arg0 ;
-(id)description;
-(id)filteredPaymentSetupProductModel:(id)arg0 mobileCarrierRegion:(id)arg1 deviceRegion:(id)arg2 cardOnFiles:(id)arg3 ;
-(id)init;
