...
@interface _TtC22HomeAutomationInternal9HomeStore : NSObject <HMHomeManagerDelegatePrivate, HMHomeDelegatePrivate, HMAccessoryDelegatePrivate, HMMediaSystemDelegate>

 {
    ...
    ? _homeManager;
    ? cachedStableHomeGraphHash;
    ? isCachedStableHomeGraphHashValid;
}
