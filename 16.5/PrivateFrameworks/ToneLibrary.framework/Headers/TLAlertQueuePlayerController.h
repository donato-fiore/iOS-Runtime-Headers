...
+(BOOL)_prefersToPlayDuringWombatForAlert:(id)arg0 ;
...
+(id)_mediaExperienceAudioCategoryForAudioSessionCategory:(id)arg0 ;
...
-(void)_stopPlayingAlertForStateDescriptor:(id)arg0 withOptions:(id)arg1 playbackCompletionType:(NSInteger)arg2 ;
