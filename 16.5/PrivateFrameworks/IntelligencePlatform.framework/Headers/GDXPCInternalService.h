...
-(BOOL)behaviorUnderstandingTriggerEntityTaggingDataCollectionWithError:(*id)arg0 ;
...
-(id)behaviorUnderstandingEvaluateForBehaviorType:(id)arg0 modelName:(id)arg1 useTrial:(BOOL)arg2 error:(*id)arg3 ;
...
-(id)behaviorUnderstandingSampleEntityTaggingFeaturesForPersonID:(id)arg0 error:(*id)arg1 ;
-(id)behaviorUnderstandingStatusWithError:(*id)arg0 ;
-(id)init;
-(id)photosMetadataWithStartDate:(id)arg0 endDate:(id)arg1 maxEvents:(NSInteger)arg2 newestFirst:(BOOL)arg3 error:(*id)arg4 ;
