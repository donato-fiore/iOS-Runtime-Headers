...
-(id)initWithFidelityPolicy:(NSUInteger)arg0 locations:(id)arg1 accessPoints:(id)arg2 clientIdentifier:(id)arg3 ;
-(id)initWithFidelityPolicy:(NSUInteger)arg0 locations:(id)arg1 accessPoints:(id)arg2 distance:(CGFloat)arg3 location:(id)arg4 startDate:(id)arg5 endDate:(id)arg6 limit:(NSInteger)arg7 useBackground:(BOOL)arg8 clientIdentifier:(id)arg9 ;
-(id)initWithinDistance:(CGFloat)arg0 location:(id)arg1 startDate:(id)arg2 endDate:(id)arg3 ;
-(id)initWithinDistance:(CGFloat)arg0 location:(id)arg1 startDate:(id)arg2 endDate:(id)arg3 clientIdentifier:(id)arg4 ;
