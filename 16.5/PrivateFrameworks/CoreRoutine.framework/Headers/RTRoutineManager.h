...
-(BOOL)selectorIsAllowed:(SEL)arg0 ;
...
-(void)_enumerateStoredLocationsWithOptions:(id)arg0 usingBlock:(id)arg1 ;
...
-(void)fetchFamiliarityIndexResultsWithOptions:(id)arg0 handler:(id)arg1 ;
...
-(void)fetchLocationOfInterestForRegion:(id)arg0 withHandler:(id)arg1 ;
...
-(void)fetchLookbackWindowStartDateWithHandler:(id)arg0 ;
-(void)fetchLookbackWindowStartDateWithLocation:(id)arg0 handler:(id)arg1 ;
...
-(void)fetchPCountEventsHistory:(id)arg0 completionHandler:(id)arg1 ;
-(void)fetchPathToDiagnosticFilesWithOptions:(id)arg0 handler:(id)arg1 ;
...
-(void)fetchProximityHistoryFromEventIDs:(id)arg0 completionHandler:(id)arg1 ;
-(void)fetchProximityHistoryFromStartDate:(id)arg0 endDate:(id)arg1 completionHandler:(id)arg2 ;
...
-(void)setHintForRegionState:(NSInteger)arg0 significantRegion:(id)arg1 withHandler:(id)arg2 ;
