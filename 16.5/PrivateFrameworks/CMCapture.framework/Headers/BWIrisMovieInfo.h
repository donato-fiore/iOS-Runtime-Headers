...
@property (nonatomic) float transitionVitalityScoreV1; // ivar: _transitionVitalityScoreV1
@property (nonatomic, getter=isTransitionVitalityScoreValid) BOOL transitionVitalityScoreValid; // ivar: _transitionVitalityScoreValid
