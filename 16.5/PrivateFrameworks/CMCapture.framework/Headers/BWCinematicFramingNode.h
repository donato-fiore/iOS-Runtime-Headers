...
@protocol BWFigVideoCaptureDeviceCenterStageRectOfInterestChangedDelegate;
...
@interface BWCinematicFramingNode : BWNode <BWFigVideoCaptureDeviceCenterStageRectOfInterestChangedDelegate>

 {
    ...
    *OpaqueVTPixelTransferSession _stillImagePixelTransferSession;
    ...
    CGRect _outputFramingRectOfInterest;
}
...
+(void)initialize;
-(id)initWithOutputDimensions:(struct ? )arg0 cameraInfoByPortType:(id)arg1 horizontalSensorBinningFactor:(int)arg2 verticalSensorBinningFactor:(int)arg3 deviceOrientationCorrectionEnabled:(BOOL)arg4 stillImageCaptureEnabled:(BOOL)arg5 objectMetadataIdentifiers:(id)arg6 maxLossyCompressionLevel:(int)arg7 portType:(id)arg8 deviceModelName:(id)arg9 outputFramingRectOfInterest:(struct CGRect )arg10 ;
-(id)nodeSubType;
-(id)nodeType;
-(void)configurationWithID:(NSInteger)arg0 updatedFormat:(id)arg1 didBecomeLiveForInput:(id)arg2 ;
-(void)dealloc;
-(void)didChangeCenterStageRectOfInterest:(struct CGRect )arg0 ;
