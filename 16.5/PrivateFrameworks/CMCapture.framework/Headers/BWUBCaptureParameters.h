...
@property (readonly, nonatomic) CGFloat deepFusionEnhancedResolutionQuadraLongEffectiveIntegrationTimeThreshold; // ivar: _deepFusionEnhancedResolutionQuadraLongEffectiveIntegrationTimeThreshold
...
@property (readonly, nonatomic) float nightModeMinGainThreshold; // ivar: _nightModeMinGainThreshold
