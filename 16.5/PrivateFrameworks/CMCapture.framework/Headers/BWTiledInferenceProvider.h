...
#ifndef BWTILEDINFERENCEPROVIDER_H
#define BWTILEDINFERENCEPROVIDER_H

@class NSArray, FigMetalContext, NSString, NSSet;
...
-(id)newStorage;
-(int)createInputTileFor:(id)arg0 to:(id)arg1 withInputs:(id)arg2 atPosition:(id)arg3 encodeToCmdBuffer;
...
-(int)preProcessOutputTexture:(id)arg0 forMediaKey:(id)arg1 encodeToCmdBuffer:(id)arg2 ;
...
-(int)writeOutputFor:(id)arg0 to:(id)arg1 fromNetworkOutputTiles:(id)arg2 withAdditionalTextures:(id)arg3 withInputTileTextures:(id)arg4 withInputFullTextures:(id)arg5 atPosition:(id)arg6 encodeToCmdBuffer;
-(void)dealloc;
