...
@interface BWImageQueueSinkNode : BWSinkNode {
    ...
    *OpaqueBWPreviewSynchronizer _previewSynchronizer;
    ...
    NSUInteger _numFramesReceivedBeforeFirstDisplayTimeout;
    ...
    *OpaqueFigSimpleMutex _previewPTSHistoryMutex;
    ...
    NSInteger _firstOverCaptureFrameHostTime;
    ...
    FigCaptureVideoTransform _transform;
...
-(id)initWithHFRSupport:(BOOL)arg0 ispJitterCompensationEnabled:(BOOL)arg1 clientAuditToken:(struct ? )arg2 sinkID:(id)arg3 ;
-(id)nodeSubType;
...
-(struct FigCaptureVideoTransform )transform;
...
-(void)setTransform:(struct FigCaptureVideoTransform )arg0 ;
-(void)setVideoHDRImageStatisticsEnabled:(BOOL)arg0 ;
