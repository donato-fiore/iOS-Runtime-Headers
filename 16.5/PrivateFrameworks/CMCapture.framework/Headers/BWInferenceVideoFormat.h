...
@property (readonly, copy, nonatomic) id *histogramRequest; // ivar: _histogramRequest
...
-(id)description;
// -(id)initWithUnderlyingFormat:(id)arg0 isDeviceOriented:(BOOL)arg1 videoContentMode:(NSInteger)arg2 includesInvalidContent:(BOOL)arg3 cropDescriptor:(id)arg4 histogramRequest:(id)arg5 rotationDegrees:(unk)arg6  ;
