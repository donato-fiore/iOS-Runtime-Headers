...
@property (readonly, nonatomic) BOOL continuityCameraIsWired; // ivar: _continuityCameraIsWired
...
@property (readonly, nonatomic) BOOL useOfflineVISPipeline; // ivar: _useOfflineVISPipeline
