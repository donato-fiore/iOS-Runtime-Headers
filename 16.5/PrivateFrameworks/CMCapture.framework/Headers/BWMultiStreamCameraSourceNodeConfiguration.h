...
@property (nonatomic) unsigned int RGBIRStereoFusionFixedDepthThresholdMM; // ivar: _RGBIRStereoFusionFixedDepthThresholdMM
@property (nonatomic) unsigned int RGBIRStereoFusionFixedDepthValueMM; // ivar: _RGBIRStereoFusionFixedDepthValueMM
@property (nonatomic) unsigned int RGBIRStereoFusionMaxDepthThresholdMM; // ivar: _RGBIRStereoFusionMaxDepthThresholdMM
@property (nonatomic) unsigned int RGBIRStereoFusionMinDepthThresholdMM; // ivar: _RGBIRStereoFusionMinDepthThresholdMM
@property (retain, nonatomic) NSArray *activeStreamingNondisruptiveSwitchingFormatIndices; // ivar: _activeStreamingNondisruptiveSwitchingFormatIndices
@property (retain, nonatomic) NSArray *activeUltraHighResStillImageNondisruptiveSwitchingFormatIndices; // ivar: _activeUltraHighResStillImageNondisruptiveSwitchingFormatIndices
@property (nonatomic) float additionalVISOverscanReservedInZoom; // ivar: _additionalVISOverscanReservedInZoom
...
@property (nonatomic) BOOL applyPreviewShiftToStillImage; // ivar: _applyPreviewShiftToStillImage
...
@property (nonatomic) BOOL configureForSoftISPSupport; // ivar: _configureForSoftISPSupport
...
@property (nonatomic) BOOL continuityCameraIsWired; // ivar: _continuityCameraIsWired
...
@property (nonatomic) BOOL doingCMFaceTracking; // ivar: _doingCMFaceTracking
@property (nonatomic) BOOL dolbyVisionMetadataOnPreviewOutputEnabled; // ivar: _dolbyVisionMetadataOnPreviewOutputEnabled
@property (nonatomic) BOOL dolbyVisionMetadataOnVideoCaptureOutputEnabled; // ivar: _dolbyVisionMetadataOnVideoCaptureOutputEnabled
...
@property (nonatomic) BOOL graphContainsMultipleVideoSources; // ivar: _graphContainsMultipleVideoSources
...
@property (nonatomic) BOOL includeOverscanOnPreviewOutput; // ivar: _includeOverscanOnPreviewOutput
@property (nonatomic) BOOL includeOverscanOnStillImageOutput; // ivar: _includeOverscanOnStillImageOutput
@property (nonatomic) BOOL isAutoFocusAssistSourceNode; // ivar: _isAutoFocusAssistSourceNode
...
@property (nonatomic) BOOL sensorRawStillImageOutputEnabled; // ivar: _sensorRawStillImageOutputEnabled
@property (nonatomic) int sifrBinningFactorOverrideForNondisruptiveSwitching; // ivar: _sifrBinningFactorOverrideForNondisruptiveSwitching
...
@property (nonatomic) BOOL videoEncoderMetadataOnPreviewOutputEnabled; // ivar: _videoEncoderMetadataOnPreviewOutputEnabled
@property (nonatomic) BOOL videoEncoderMetadataOnVideoCaptureOutputEnabled; // ivar: _videoEncoderMetadataEnabledOnVideoCaptureOutput
...
@property (retain, nonatomic) NSArray *videoStabilizationMethods; // ivar: _videoStabilizationMethods
