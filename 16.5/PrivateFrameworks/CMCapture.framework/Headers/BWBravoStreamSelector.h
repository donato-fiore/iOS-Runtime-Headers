...
-(id)recommendMasterStreamUsingCurrentMasterStream:(id)arg0 frameStatisticsByPortType:(id)arg1 zoomFactor:(float)arg2 digitalFlashMode:(int)arg3 detectedObjects:(id)arg4 cameraControlsStatisticsMasterStream:(id)arg5 ;
-(void)dealloc;
