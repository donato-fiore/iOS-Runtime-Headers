...
+(id)audioSourceNodeWithAttributes:(id)arg0 sessionPreset:(id)arg1 clock:(struct OpaqueCMClock *)arg2 doConfigureAudio:(BOOL)arg3 CMSession:(struct opaqueCMSession *)arg4 doEndInterruption:(BOOL)arg5 clientAuditToken:(struct ? )arg6 clientOSVersionSupportsDecoupledIO:(BOOL)arg7 clientAudioClockDeviceUID:(id)arg8 audioCaptureConnectionConfigurations:(id)arg9 isConfiguredForContinuityCapture:(BOOL)arg10 isMultiCamSession:(BOOL)arg11 ;
+(void)initialize;
