...
@property (readonly, nonatomic) BWMemoryAnalyticsPayload *memoryAnalyticsPayload; // ivar: _memoryAnalyticsPayload
@property (nonatomic) BOOL memoryAnalyticsReportingEnabled; // ivar: _memoryAnalyticsReportingEnabled
