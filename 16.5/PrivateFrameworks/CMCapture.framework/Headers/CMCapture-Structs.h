...
typedef struct OpaqueFigVirtualCaptureCard {
} // Error Processing Struct Fields
...
typedef struct OpaqueVTHDRMetadataGenerationSession {
} // Error Processing Struct Fields
...
typedef struct BWContinuousDirectInputSettings {
    float exponentialSnapFraction;
    float exponentialRampDuration;
    float zoomOutDurationScale;
} BWContinuousDirectInputSettings;

typedef struct BWSpringSettings {
    float snapFraction;
    float tension;
    float friction;
} BWSpringSettings;

typedef struct BWContinuousIndirectInputSettings {
    float exponentialSnapFraction;
...
} BWContinuousIndirectInputSettings;

typedef struct BWZoomRampTuningSettings {
    BWContinuousDirectInputSettings continuousDirectPreview;
    BWContinuousDirectInputSettings continuousDirectRecording;
    BOOL continuousDirectEarlySwitchOverForZoomInEnabled;
    BOOL continuousDirectRecordingSpringRampsEnabled;
    BWSpringSettings continuousDirectRecordingZoomInSpring;
    BWSpringSettings continuousDirectRecordingZoomOutSpring;
    BWSpringSettings continuousDirectOverCaptureRecordingZoomInSpring;
    BWSpringSettings continuousDirectOverCaptureRecordingZoomOutSpring;
    BWContinuousIndirectInputSettings continuousIndirect;
    BWSpringSettings jumpZoomIn;
    BWSpringSettings jumpZoomOut;
    BWSpringSettings jumpFrontFacingZoomIn;
    BWSpringSettings jumpFrontFacingZoomOut;
    float earlySwitchOverScaleFactorForZoomIn;
    float allowableMinimumDigitalZoomFactorDuringZoomOut;
} BWZoomRampTuningSettings;
