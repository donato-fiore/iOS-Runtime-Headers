...
@interface BWFigVideoCaptureStream : NSObject <BWFigCaptureStreamStartStopDelegate>

 {
    ...
    os_unfair_lock_s _averageFrameRateCalculationLock;
    ? _firstValidPTS;
    ? _lastValidPTS;
...
@property (readonly, nonatomic) float averageFrameRate; // ivar: _averageFrameRate
...
@property (nonatomic) BOOL deskCamIsActive; // ivar: _deskCamIsActive
@property (copy, nonatomic) NSSet *detectedObjectTypes;
@property (nonatomic) BOOL digitalFlashEnabled; // ivar: _digitalFlashEnabled
...
@property (readonly, nonatomic) NSArray *nondisruptiveSwitchingZoomFactors; // ivar: _nondisruptiveSwitchingZoomFactors
...
-(void)serviceNondisruptiveSwitchingFormatForZoomFactor:(float)arg0 frameStatistics:(id)arg1 stillImageDigitalFlashMode:(int)arg2 isStationary:(BOOL)arg3 ;
