...
@class NSData, NSString, NSFileProviderDomainVersion, NSArray;
...
// -(void)fetchThumbnailsAtURL:(id)arg0 versions:(id)arg1 size:(struct CGSize )arg2 perThumbnailCompletionHandler:(id)arg3 completionHandler:(unk)arg4  ;
...
-(void)hierarchyForURL:(id)arg0 request:(id)arg1 completionHandler:(id)arg2 ;
-(void)invalidate;
