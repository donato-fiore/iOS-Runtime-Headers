...
+(id)instanceWithExtension:(id)arg0 queue:(id)arg1 server:(id)arg2 volumeManager:(id)arg3 ;
+(id)instanceWithExtension:(id)arg0 queue:(id)arg1 volumeManager:(id)arg2 ;
-(BOOL)isAppExtensionReachable;
-(BOOL)isEqual:(id)arg0 ;
-(id)asAppExtensionBackedProvider;
-(id)customPushTopics;
-(id)initWithExtension:(id)arg0 queue:(id)arg1 server:(id)arg2 volumeManager:(id)arg3 ;
-(void)_test_callFileProviderManagerAPIs:(id)arg0 ;
-(void)didReceiveMessage:(id)arg0 completionHandler:(id)arg1 ;
