...
-(id)stageLocation;
-(id)tryTransformItemIDAfterMigration:(id)arg0 ;
-(int)pid;
-(void)_checkEnumerationPermissionsForSettings:(id)arg0 completionHandler:(id)arg1 ;
...
-(void)_test_getRootSupportDirURLForDomainURL:(id)arg0 completionHandler:(id)arg1 ;
-(void)_test_queryDiskImportSchedulerLabel:(id)arg0 completionHandler:(id)arg1 ;
...
-(void)addDomain:(id)arg0 forProviderIdentifier:(id)arg1 byImportingDirectoryAtURL:(id)arg2 nonWrappedURL:(id)arg3 completionHandler:(id)arg4 ;
-(void)appHasNonUploadedFiles:(id)arg0 completionHandler:(id)arg1 ;
...
-(void)fetchPathComponentsForURL:(id)arg0 completionHandler:(id)arg1 ;
-(void)fetchProviderForShareURL:(id)arg0 fallbackIdentifier:(id)arg1 completionHandler:(id)arg2 ;
...
-(void)forceUpdateBlockedProcessNamesFromDomain:(id)arg0 completionHandler:(id)arg1 ;
...
-(void)importProgressForDomainWithID:(id)arg0 completionHandler:(id)arg1 ;
-(void)invalidate;
-(void)itemForURL:(id)arg0 completionHandler:(id)arg1 ;
-(void)listRemoteVersionsOfItemAtURL:(id)arg0 completionHandler:(id)arg1 ;
...
-(void)runFPCKForDomainWithID:(id)arg0 databasesBackupsPath:(id)arg1 url:(id)arg2 options:(NSUInteger)arg3 reason:(NSUInteger)arg4 completionHandler:(id)arg5 ;
...
-(void)setHiddenByUser:(BOOL)arg0 forDomainIdentifier:(id)arg1 providerIdentifier:(id)arg2 completionHandler:(id)arg3 ;
