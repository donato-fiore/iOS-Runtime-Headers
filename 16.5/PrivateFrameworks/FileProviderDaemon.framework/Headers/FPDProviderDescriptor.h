...
@property (nonatomic) BOOL allowsExternalVolumes; // ivar: _allowsExternalVolumes
...
@property (retain, nonatomic) NSString *bundleIdentifierForPushes; // ivar: _bundleIdentifierForPushes
...
@property (nonatomic) BOOL wantsBundleBitOnlyPackageDetection; // ivar: _wantsBundleBitOnlyPackageDetection
