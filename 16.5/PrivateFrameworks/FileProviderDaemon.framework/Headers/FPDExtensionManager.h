...
-(id)domainsForAppBundleIdentifier:(id)arg0 ;
...
-(void)garbageCollectDomainsExceptIdentifiers:(id)arg0 fromDirectory:(id)arg1 isUserData:(BOOL)arg2 ;
-(void)garbageCollectOnFirstLaunch;
-(void)loadProvidersAndMonitor;
-(void)migrateEnabledStateIfNecessary:(id)arg0 ;
-(void)providerUpdateOnVolume:(id)arg0 ;
-(void)purge:(id)arg0 ;
