...
@class NSSet, NSString, NSMutableDictionary, NSArray, NSURL, NSDictionary;
...
@property (readonly, nonatomic) NSURL *localDomainsPlistURL; // ivar: _localDomainsPlistURL
...
+(id)parseDomainProperties:(id)arg0 descriptor:(id)arg1 volume:(id)arg2 replicatedByDefault:(BOOL)arg3 ;
...
+(void)dumpXattrsForSyncRootDirectoryOfVolume:(id)arg0 dumper:(id)arg1 ;
+(void)dumpXattrsForSystemDirectoryOfVolume:(id)arg0 dumper:(id)arg1 ;
...
-(id)importDomainsFromLibrary:(id)arg0 updatePlist:(BOOL)arg1 ;
-(id)initWithDescriptor:(id)arg0 server:(id)arg1 ;
-(id)loggerForDomainWithIdentifier:(id)arg0 ;
-(id)newDomainFromNSDomain:(id)arg0 volumeManager:(id)arg1 ;
-(id)providerDomainForDomain:(id)arg0 ;
-(void)_setEnabledOrHiddenByUser:(BOOL)arg0 forDomainIdentifier:(id)arg1 newValue:(BOOL)arg2 request:(id)arg3 completionHandler:(id)arg4 ;
-(void)_startOrClearDomain:(id)arg0 reason:(id)arg1 completion:(id)arg2 ;
-(void)_writeDomainPropertiesIntoLibrary:(id)arg0 ifChangedFrom:(id)arg1 ;
-(void)addDomain:(id)arg0 byImportingDirectoryAtURL:(id)arg1 request:(id)arg2 completionHandler:(id)arg3 ;
-(void)addDomain:(id)arg0 byImportingDirectoryAtURL:(id)arg1 unableToStartup:(BOOL)arg2 needsReimport:(BOOL)arg3 reloadDomain:(BOOL)arg4 request:(id)arg5 completionHandler:(id)arg6 ;
...
-(void)invalidateSingleDomain:(id)arg0 reason:(id)arg1 ;
-(void)invalidateWithReason:(id)arg0 ;
-(void)materializeRootForDomain:(id)arg0 ;
-(void)reloadDomain:(id)arg0 unableToStartup:(BOOL)arg1 needsReimport:(BOOL)arg2 completionHandler:(id)arg3 ;
...
-(void)setHiddenByUser:(BOOL)arg0 forDomainIdentifier:(id)arg1 request:(id)arg2 completionHandler:(id)arg3 ;
-(void)startDomains:(id)arg0 completion:(id)arg1 ;
