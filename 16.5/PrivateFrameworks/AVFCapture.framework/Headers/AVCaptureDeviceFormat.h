...
-(BOOL)isVideoStabilizationStrengthSupported:(NSInteger)arg0 ;
...
-(BOOL)validateMaxPhotoDimensions:(struct ? )arg0 privateDimensionsEnabled:(BOOL)arg1 ;
...
-(id)_supportedMaxPhotoDimensionsPrivateDimensionsEnabled:(BOOL)arg0 ;
-(id)debugDescription;
-(id)description;
-(id)figCaptureSourceDepthDataFormat;
-(id)figCaptureSourceVideoFormat;
-(id)initWithFigCaptureSourceFormat:(id)arg0 fcSourceAttributes:(id)arg1 ;
...
-(struct ? )defaultPhotoDimensionsWithHighResolutionCaptureEnabled:(BOOL)arg0 ;
