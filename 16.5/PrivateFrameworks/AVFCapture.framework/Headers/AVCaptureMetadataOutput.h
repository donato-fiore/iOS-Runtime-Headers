...
-(id)_appClipCodesCollectionForSampleBuffer:(struct opaqueCMSampleBuffer *)arg0 input:(id)arg1 ;
-(id)_barcodeCollectionForSampleBuffer:(struct opaqueCMSampleBuffer *)arg0 input:(id)arg1 ;
-(id)_detectedObjectsCollectionForSampleBuffer:(struct opaqueCMSampleBuffer *)arg0 input:(id)arg1 facesArrayOut:(*id)arg2 ;
-(id)_legacyFaceCollectionForSampleBuffer:(struct opaqueCMSampleBuffer *)arg0 input:(id)arg1 ;
-(id)_lumaHistogramDataCollectionForSampleBuffer:(struct opaqueCMSampleBuffer *)arg0 input:(id)arg1 ;
-(id)_metadataIdentifiers;
-(id)_offlineVISMotionCollectionForSampleBuffer:(struct opaqueCMSampleBuffer *)arg0 input:(id)arg1 ;
-(id)_textRegionsCollectionForSampleBuffer:(struct opaqueCMSampleBuffer *)arg0 input:(id)arg1 ;
-(id)_trackedFacesCollectionForSampleBuffer:(struct opaqueCMSampleBuffer *)arg0 input:(id)arg1 ;
