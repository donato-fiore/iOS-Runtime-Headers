...
@protocol AVCaptureVideoDataOutputSampleBufferDelegate, AVCaptureAudioDataOutputSampleBufferDelegate, AVCaptureMetadataOutputObjectsDelegateInternal, AVCaptureDepthDataOutputDelegate, AVCaptureVisionDataOutputDelegate, AVCapturePointCloudDataOutputDelegate, AVCaptureCameraCalibrationDataOutputDelegate, AVCaptureDataOutputSynchronizerDelegate, OS_dispatch_queue;
...
+(void)initialize;
-(BOOL)_allFollowerSynchronizedDataOutputsContainTimestampEqualToOrGreaterThanLeaderTimestamp:(struct ? )arg0 ;
-(id)initWithDataOutputs:(id)arg0 ;
-(int)_computedLeaderSynchronizedDataQueueMaxDepthForDataOutputs:(id)arg0 ;
-(struct ? )_earliestFollowerSynchronizedDataQueueTimestamp;
...
-(void)captureOutput:(id)arg0 didOutputMetadataObjectCollections:(id)arg1 fromConnection:(id)arg2 ;
