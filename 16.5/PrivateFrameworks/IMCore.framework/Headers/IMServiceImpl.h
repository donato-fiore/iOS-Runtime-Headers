...
@property (retain, nonatomic) NSArray *abProperties; // ivar: _abProperties
...
@property (nonatomic) NSUInteger caseInsensitivityByHandleType; // ivar: _caseInsensitivityByHandleType
...
@property (nonatomic) BOOL handleIDInsensitivityIsCarrierBased; // ivar: _handleIDInsensitivityIsCarrierBased
