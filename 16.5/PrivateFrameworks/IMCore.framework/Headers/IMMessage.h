...
@class IMMessageItem, NSString, NSDictionary, NSData, NSDate, NSIndexSet, NSError, NSArray, TUConversationActivity, NSAttributedString, IMTapback;
@protocol NSCopying;
...
@property (retain, nonatomic, setter=_updatedDateEdited:) NSDate *dateEdited; // ivar: _dateEdited
...
+(id)editedMessageWithOriginalMessage:(id)arg0 editedPartIndex:(NSInteger)arg1 newPartText:(id)arg2 ;
+(id)editedMessageWithOriginalMessage:(id)arg0 retractedPartIndex:(NSInteger)arg1 shouldRetractSubject:(BOOL)arg2 ;
