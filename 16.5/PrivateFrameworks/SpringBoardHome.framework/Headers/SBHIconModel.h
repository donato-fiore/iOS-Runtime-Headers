...
@property (nonatomic) BOOL postsDidAddIconNotification; // ivar: _postsDidAddIconNotification
...
-(BOOL)_saveIconState:(id)arg0 error:(*id)arg1 ;
...
-(id)bookmarkIconForWebClipPlaceholderBundleIdentifier:(id)arg0 ;
