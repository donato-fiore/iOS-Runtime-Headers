...
-(void)configureFloatingDockConfiguration:(id)arg0 forScreenType:(NSUInteger)arg1 layoutOptions:(NSUInteger)arg2 ;
...
-(void)configureSidebarConfiguration:(id)arg0 forScreenType:(NSUInteger)arg1 layoutOptions:(NSUInteger)arg2 ;
