...
@protocol UIScrollViewDelegate, SBSearchScrollViewDelegate, BSDescriptionProviding, SBSearchGestureDelegate, SBHSearchPresenting;
...
-(CGFloat)_maxGestureOffset;
-(CGFloat)_progressThreshold;
-(id)descriptionBuilderWithMultilinePrefix:(id)arg0 ;
-(id)descriptionWithMultilinePrefix:(id)arg0 ;
-(id)init;
-(id)initWithSearchPresenter:(id)arg0 ;
