...
#import "SBHFeatureIntroductionManager.h"
#import "SBFloatingDockViewController.h"
#import "SBHFocusModeManager.h"
...
#import "SBHProactivePageSuggestionsManager.h"
...
#import "SBHWidgetIntroductionFeatureIntroductionItem.h"
...
@property (readonly, nonatomic) SBHFeatureIntroductionManager *featureIntroductionManager; // ivar: _featureIntroductionManager
...
@property (readonly, nonatomic) SBHFocusModeManager *focusModeManager; // ivar: _focusModeManager
...
@property (nonatomic, getter=isMainDisplayLibraryViewVisibilityTransitioning) BOOL mainDisplayLibraryViewVisibilityTransitioning; // ivar: _mainDisplayLibraryViewVisibilityTransitioning
@property (nonatomic, getter=isMainDisplayLibraryViewVisible) BOOL mainDisplayLibraryViewVisible; // ivar: _mainDisplayLibraryViewVisible
...
@property (nonatomic, getter=isOverlayTodayViewVisibilityTransitioning) BOOL overlayTodayViewVisibilityTransitioning; // ivar: _overlayTodayViewVisibilityTransitioning
...
@property (readonly, nonatomic) SBHProactivePageSuggestionsManager *proactivePageSuggestionsManager; // ivar: _proactivePageSuggestionsManager
...
@property (readonly, nonatomic, getter=isSidebarEffectivelyVisible) BOOL sidebarEffectivelyVisible; // ivar: _sidebarEffectivelyVisible
@property (readonly, nonatomic, getter=isSidebarVisibilityGestureActive) BOOL sidebarVisibilityGestureActive; // ivar: _sidebarVisibilityGestureActive
@property (readonly, nonatomic, getter=isSidebarVisible) BOOL sidebarVisible; // ivar: _sidebarVisible
...
@property (retain, nonatomic) SBHWidgetIntroductionFeatureIntroductionItem *widgetIntroductionItem; // ivar: _widgetIntroductionItem
...
-(BOOL)_shouldLibraryOverlayAllowSwipeToDismissGesture:(id)arg0 ;
...
-(NSUInteger)possibleInterfaceOrientations;
-(NSUInteger)supportedGridSizeClassesForIconView:(id)arg0 ;
-(NSUInteger)supportedMultitaskingShortcutActionsForIconView:(id)arg0 ;
...
-(id)floatingDockViewControllerForView:(id)arg0 ;
...
-(id)windowForIconDragPreviewsForIconDragManager:(id)arg0 forWindowScene:(id)arg1 ;
-(id)windowForStackConfigurationIconDragPreviewsForRootFolderController:(id)arg0 forWindowScene:(id)arg1 ;
...
-(void)_enumerateEditableViewController:(id)arg0 usingBlock:(id)arg1 ;
...
-(void)_scrollToLastIconPageIfNecessaryForLibraryOverlayDismissal:(id)arg0 ;
...
-(void)_updateMaximumEditingIconSizeForFloatingDockViewController:(id)arg0 ;
...
-(void)configureFloatingDockViewController:(id)arg0 ;
...
-(void)dismissLibraryForIconDragManager:(id)arg0 windowScene:(id)arg1 ;
...
-(void)displayFeatureIntroductionItemIfUnlocked:(id)arg0 ;
...
-(void)informUsageMonitorOfTodayViewVisibilityChange:(id)arg0 ;
...
-(void)presentLibraryForIconDragManager:(id)arg0 windowScene:(id)arg1 ;
...
-(void)pushExpandedIcon:(id)arg0 location:(id)arg1 context:(id)arg2 animated:(BOOL)arg3 completionHandler:(id)arg4 ;
...
-(void)rootFolderController:(id)arg0 viewDidTransitionToSize:(struct CGSize )arg1 ;
...
-(void)widgetHostViewControllerUsesSystemBackgroundMaterialDidChange:(id)arg0 ;
