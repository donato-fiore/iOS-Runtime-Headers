...
@class NSTimer, NSMutableSet, NSHashTable, NSMapTable, NSArray, UIWindow, UIView, NSIndexPath, NSString, UIColor, NSMutableDictionary, UIStatusBar, _UILegibilitySettings, NSSet;
...
@property (retain, nonatomic) NSMutableDictionary *extraAssertions; // ivar: _extraAssertions
...
-(NSUInteger)effectiveContentVisibilityFolderHasInnerFolder:(BOOL)arg0 ;
...
-(id)keepIconImageViewControllersSnapshotsOfType:(NSUInteger)arg0 inAllPagesExcluding:(id)arg1 forReason:(id)arg2 ;
-(id)keyCommands;
