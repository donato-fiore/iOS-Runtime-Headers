...
@class SBFTouchPassThroughViewController, _UILegibilitySettings, NSHashTable, UIWindow, UIView, NSMutableArray, NSString, NSArray, NSSet, SBFTouchPassThroughView, UIViewController<SBFloatingDockSuggestionsViewProviding>;
@protocol SBIconListViewDragDelegate, SBIconListModelObserver, SBFolderControllerDelegate, SBFolderPresentingViewControllerDelegate, SBScaleIconZoomAnimationContaining, SBIconViewDelegate, SBIconViewProviding, SBFloatingDockViewDelegate, SBHLibraryViewControllerObserver, SBHModalLibraryPresenterContextProviding, SBHLibraryIndicatorIconDropInteractionContextProviding, SBUICoronaAnimationControllerParticipant, SBIconViewQuerying, SBIconLocationPresenting, BSDescriptionProviding, SBFloatingDockViewControllerDelegate;
...
@interface SBFloatingDockViewController : SBFTouchPassThroughViewController <SBIconListViewDragDelegate, SBIconListModelObserver, SBFolderControllerDelegate, SBFolderPresentingViewControllerDelegate, SBScaleIconZoomAnimationContaining, SBIconViewDelegate, SBIconViewProviding, SBFloatingDockViewDelegate, SBHLibraryViewControllerObserver, SBHModalLibraryPresenterContextProviding, SBHLibraryIndicatorIconDropInteractionContextProviding, SBUICoronaAnimationControllerParticipant, SBIconViewQuerying, SBIconLocationPresenting, BSDescriptionProviding>
...
-(id)configureForPresentingLibraryViewController:(id)arg0 ;
