...
@class NSHashTable, NSMutableArray, NSCountedSet, NSTimer, MTMaterialView, UIView, UIViewController, NSString, UIPanGestureRecognizer, UIScrollView;
@protocol SBHModalLibraryPresentationContext, SBHViewControllerTransitionDelegate, UIGestureRecognizerDelegate, BSDescriptionProviding, SBHLibraryViewControllerPresenter, BSInvalidatable, SBHModalLibraryPresenterContextProviding, SBHModalLibraryPresentationDelegate;
...
@property (readonly, weak, nonatomic) UIViewController *containerViewController; // ivar: _containerViewController
