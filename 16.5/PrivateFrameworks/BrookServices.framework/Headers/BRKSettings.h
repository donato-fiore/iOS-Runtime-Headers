...
@class NPSManager, NPSDomainAccessor, NSSet, NRDevice, NSString, NSDate, CLLocationManager;
@protocol MCProfileConnectionObserver, CLLocationManagerDelegate, OS_dispatch_queue;
...
@property (nonatomic) BOOL locationManagerAuthorizationStatusHasChangedOnce; // ivar: _locationManagerAuthorizationStatusHasChangedOnce
@property (nonatomic) int locationManagerLastAuthorizationStatus; // ivar: _locationManagerLastAuthorizationStatus
...
-(void)dealloc;
-(void)isLocationAuthFlowEnabledWithCompletionHandler:(id)arg0 ;
