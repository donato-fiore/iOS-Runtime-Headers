...
@protocol HDSPSyncedUserDefaultsExternalChangeDelegate, HDSPNotificationObserver, HDSPDiagnosticsProvider, HDSPEnvironmentAware, HDSPSource;
...
@property (readonly, nonatomic) NSUInteger cloudStorageDataVersion;
...
@property (readonly, nonatomic) NSUInteger localDataVersion;
...
-(void)performInitialSyncWithCompletion:(id)arg0 ;
