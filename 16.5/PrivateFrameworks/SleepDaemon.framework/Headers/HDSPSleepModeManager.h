...
@protocol HDSPSleepModeStateMachineDelegate, HDSPSleepModeStateMachineInfoProvider, HDSPDiagnosticsProvider, HKSPSleepFocusModeBridgeDelegate, HDSPEnvironmentAware, HDSPSleepScheduleModelObserver, HDSPTimeChangeObserver, HDSPSleepScheduleStateObserver, NAScheduler, HDSPSleepFocusModeBridge, HDSPSleepProactiveBridge;
...
@property (readonly, nonatomic) NSObject<HDSPSleepProactiveBridge> *sleepProactiveBridge; // ivar: _sleepProactiveBridge
...
-(id)initWithEnvironment:(id)arg0 sleepFocusModeBridge:(id)arg1 sleepProactiveBridge:(id)arg2 ;
