...
@class NSString, NSSet, HKSPObserverSet, HKSPSleepEventRecord, HKSPSleepSchedule, HKSPSleepScheduleModel, HKSPSleepSettings;
...
-(void)observedApplicationDidInstall:(id)arg0 ;
-(void)observedApplicationDidUninstall:(id)arg0 ;
