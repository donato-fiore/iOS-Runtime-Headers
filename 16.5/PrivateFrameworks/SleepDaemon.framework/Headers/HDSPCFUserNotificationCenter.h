...
-(id)_confirmTextForForAlarmEnabled:(BOOL)arg0 sleepModeOn:(BOOL)arg1 ;
-(id)_ignoreTextForForAlarmEnabled:(BOOL)arg0 sleepModeOn:(BOOL)arg1 ;
...
-(void)_publishNotificationWithIdentifier:(id)arg0 title:(id)arg1 message:(id)arg2 defaultButtonTitle:(id)arg3 otherButtonTitle:(id)arg4 bypassDND:(BOOL)arg5 aboveLockScreen:(BOOL)arg6 actionHandler:(id)arg7 ;
