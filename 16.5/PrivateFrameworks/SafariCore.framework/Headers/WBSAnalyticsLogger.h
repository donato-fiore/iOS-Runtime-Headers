...
-(void)didChooseIntervalFromAutomaticTabClosingFirstTimeExperiencePrompt:(id)arg0 ;
...
-(void)didCloseTabsAutomaticallyWithCount:(NSUInteger)arg0 tabClosingInterval:(id)arg1 ;
...
-(void)didCreateTabGroupFromLocation:(NSInteger)arg0 prepopulatedWithTabs:(BOOL)arg1 ;
...
-(void)didInjectScriptForExtensionWithIdentifier:(id)arg0 ;
-(void)didInvokeToolbarButtonForExtensionWithIdentifier:(id)arg0 ;
-(void)didLoadTabContent:(NSInteger)arg0 ;
-(void)didManuallyMarkReadingListItemAsRead:(BOOL)arg0 ;
-(void)didModifyPerSitePreferencesWithPreferenceIdentifier:(id)arg0 modificationLevel:(NSInteger)arg1 type:(NSInteger)arg2 method:(NSInteger)arg3 ;
-(void)didMoveToBackgroundWithNumberOfOnGoingDownloads:(NSUInteger)arg0 ;
-(void)didOpenClearHistoryFromSource:(id)arg0 ;
-(void)didOpenCloudTabsItemWithPosition:(NSInteger)arg0 ;
...
-(void)didOpenPerSitePreferencesPopoverVia:(NSInteger)arg0 ;
-(void)didOpenReadingListItemWithPosition:(NSInteger)arg0 ;
-(void)didOpenReadingListItemWithReachableNetwork:(BOOL)arg0 isContinuousTransition:(BOOL)arg1 ;
-(void)didOpenRecentlyClosedTabsItemWithPosition:(NSInteger)arg0 ;
...
-(void)didPerformMoreMenuAction:(NSInteger)arg0 ;
...
-(void)didPrintPage;
-(void)didReceiveAnalyticsEventFromWebKitWithName:(id)arg0 description:(id)arg1 payload:(id)arg2 ;
-(void)didReceiveInvalidMessageFromWebProcess:(id)arg0 ;
-(void)didReloadEvent:(NSInteger)arg0 withReloadType:(NSInteger)arg1 withReloadProvenance:(NSInteger)arg2 withLayout:(NSInteger)arg3 ;
...
-(void)didSuggestUsernameInPromptAndUserKeptSuggestion:(BOOL)arg0 ;
-(void)didSwitchToSafari:(id)arg0 entryPoint:(id)arg1 ;
-(void)didSwitchToTabGroupFromLocation:(NSInteger)arg0 ;
...
-(void)didUseSidebarAction:(NSInteger)arg0 ;
...
-(void)reportAutomaticTabClosingInterval:(id)arg0 ;
...
-(void)reportIOSToolbarButtonUsage:(NSInteger)arg0 withLayout:(NSInteger)arg1 ;
-(void)reportInvalidMessageFromWebProcess:(id)arg0 ;
-(void)reportMacOSToolbarButtonUsage:(NSInteger)arg0 withLayout:(NSInteger)arg1 ;
...
-(void)reportSVCToolbarButtonUsage:(NSInteger)arg0 ;
...
-(void)reportUnifiedTabBarStatusWithLayout:(NSInteger)arg0 numberOfTabsInCurrentTabBar:(NSUInteger)arg1 tabBarIsCurrentlyScrollable:(BOOL)arg2 tabsShowOnlyIcons:(BOOL)arg3 backgroundColorInTabBarEnabled:(BOOL)arg4 ;
-(void)reportUserPreferencesOnLaunchForJavaScriptEnabled:(BOOL)arg0 safeBrowsingEnabled:(BOOL)arg1 siteSpecificSearchEnabled:(BOOL)arg2 trackingPolicy:(NSUInteger)arg3 ;
