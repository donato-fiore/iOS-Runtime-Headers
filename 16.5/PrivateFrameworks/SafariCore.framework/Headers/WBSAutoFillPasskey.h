...
@property (readonly, nonatomic) BOOL shouldRequireUserVerification; // ivar: _shouldRequireUserVerification
@property (readonly, nonatomic) NSString *username; // ivar: _username


+(BOOL)supportsSecureCoding;
-(id)initWithCoder:(id)arg0 ;
-(id)initWithUsername:(id)arg0 relyingPartyIdentifier:(id)arg1 identifier:(id)arg2 operationUUID:(id)arg3 shouldRequireUserVerification:(BOOL)arg4 ;
