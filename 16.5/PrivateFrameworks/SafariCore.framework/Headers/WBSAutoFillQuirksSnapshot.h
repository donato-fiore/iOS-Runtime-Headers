...
@property (readonly, copy, nonatomic) NSSet *domainsForPasskeyFallbackUI; // ivar: _domainsForPasskeyFallbackUI
@property (readonly, copy, nonatomic) NSSet *domainsIneligibleForAutomaticLogin; // ivar: _domainsIneligibleForAutomaticLogin
@property (readonly, copy, nonatomic) NSSet *domainsIneligibleForPasskeys; // ivar: _domainsIneligibleForPasskeys
...
-(id)_domainsSetFromAutoFillQuirks:(id)arg0 forKey:(id)arg1 error:(*id)arg2 ;
