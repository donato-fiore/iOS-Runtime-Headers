...
@class NSMutableDictionary, NSArray, NSTimer, NSSet;
...
@property (nonatomic) BOOL shouldWarmDataStoreAfterReset; // ivar: _shouldWarmDataStoreAfterReset
...
-(id)_saveAccountOnInternalQueueWithUser:(id)arg0 password:(id)arg1 forUserTypedSite:(id)arg2 ;
...
-(id)getSavedAccountWithPasskeyCredentialForUserHandle:(id)arg0 protectionSpace:(id)arg1 ;
-(id)initAndPrewarmSavedAccounts:(BOOL)arg0 ;
-(id)initWithAuthenticationServicesAgentProxy:(id)arg0 shouldPrewarmSavedAccounts:(BOOL)arg1 ;
...
-(id)saveUser:(id)arg0 password:(id)arg1 forUserTypedSite:(id)arg2 notesEntry:(id)arg3 ;
...
-(id)savedAccountForUserTypedSite:(id)arg0 userName:(id)arg1 ;
...
-(void)_matchSidecars:(id)arg0 toSavedAccountsWithPasskeysInDictionary:(id)arg1 unmatchedSidecars:(id)arg2 ;
-(void)_matchSidecars:(id)arg0 toSavedAccountsWithPasswordsInDictionary:(id)arg1 unmatchedSidecars:(id)arg2 ;
...
-(void)_performLegacySidecarModificationWithChangeRequest:(id)arg0 toSavedAccount:(id)arg1 ;
...
-(void)_removeCredentialTypes:(NSInteger)arg0 forSavedAccount:(id)arg1 ;
...
-(void)_warmDataStoreAfterResetTimerFired:(id)arg0 ;
...
-(void)performTaskEnsuringAllAccountSourcesAreLoadedOnQueue:(id)arg0 task:(id)arg1 ;
...
-(void)removeTOTPGeneratorForSavedAccount:(id)arg0 ;
-(void)reset;
