...
-(id)_thumbnailFallbackForNode:(id)arg0 descriptor:(id)arg1 currentThumbnail:(id)arg2 ;
-(id)_thumbnailForNode:(id)arg0 descriptor:(id)arg1 forceFetch:(BOOL)arg2 ;
-(id)iconForNode:(id)arg0 descriptor:(id)arg1 ;
-(id)iconForURL:(id)arg0 descriptor:(id)arg1 ;
-(id)init;
-(id)startBatching;
-(id)thumbnailForNode:(id)arg0 descriptor:(id)arg1 ;
-(id)thumbnailForNode:(id)arg0 descriptor:(id)arg1 forceFetch:(BOOL)arg2 ;
