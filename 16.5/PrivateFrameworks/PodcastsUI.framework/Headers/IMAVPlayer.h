...
@protocol AVAudioSessionDelegate, IMAVPlaybackCausalityObserver, IMAVPlayerDelegate, OS_dispatch_source;
...
@property (weak, nonatomic) NSObject<IMAVPlaybackCausalityObserver> *causalityObserver; // ivar: _causalityObserver
...
+(id)avPlaybackSpeedForSpeed:(NSUInteger)arg0 ;
+(id)availableSpeeds;
+(id)sharedPlayer;
...
-(BOOL)_stopWithReason:(NSUInteger)arg0 initiator:(NSUInteger)arg1 stopBlock:(id)arg2 ;
-(BOOL)_validatePlay;
-(BOOL)hasChapters;
-(BOOL)isAtEnd;
...
-(BOOL)nextRemote;
-(BOOL)pause;
-(BOOL)pauseWithInitiator:(NSUInteger)arg0 ;
-(BOOL)pauseWithInitiator:(NSUInteger)arg0 interruptionEvent:(BOOL)arg1 ;
-(BOOL)play;
-(BOOL)previousRemote;
-(BOOL)previousRemote:(BOOL)arg0 ;
-(BOOL)stop;
-(BOOL)stopWithReason:(NSUInteger)arg0 initiator:(NSUInteger)arg1 ;
