...
-(id)init;
-(id)initWithAttributedString:(id)arg0 baseParagraphStyle:(id)arg1 ;
-(id)initWithLanguageAwareString:(id)arg0 attributes:(id)arg1 ;
-(id)initWithString:(id)arg0 attributes:(id)arg1 baseParagraphStyle:(id)arg2 ;
-(id)initWithString:(id)arg0 baseParagraphStyle:(id)arg1 generateAttributedString:(BOOL)arg2 ;
