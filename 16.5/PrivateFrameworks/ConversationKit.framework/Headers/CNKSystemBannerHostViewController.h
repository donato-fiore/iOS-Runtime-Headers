...
@class UIViewController, NSString, BSAnimationSettings, UIView<SBUISystemApertureAccessoryView>, UIColor, UIViewController<SBUISystemApertureElement>;
...
-(void)handleSceneStateChangeNotification:(id)arg0 ;
