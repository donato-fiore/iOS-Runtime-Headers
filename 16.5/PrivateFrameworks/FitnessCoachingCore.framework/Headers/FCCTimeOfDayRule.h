...
@property (readonly, nonatomic) CGFloat secondsBeforeEndOfDay; // ivar: _secondsBeforeEndOfDay
@property (readonly) Class superclass;


-(id)initWithMinimumDayDuration:(CGFloat)arg0 secondsBeforeEndOfDay:(CGFloat)arg1 ;
