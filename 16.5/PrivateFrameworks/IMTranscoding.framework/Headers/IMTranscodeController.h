...
-(void)_generateSafeRender:(id)arg0 constraints:(struct IMPreviewConstraints )arg1 retries:(int)arg2 completionBlock:(id)arg3 ;
...
-(void)generateSafeRender:(id)arg0 completionBlock:(id)arg1 ;
