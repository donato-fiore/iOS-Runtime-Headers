...
@property (readonly) NSObject<CNAuthorizationContext> *authorizationContext; // ivar: _authorizationContext
...
@property (nonatomic, readonly) NSObject<_TtP18ContactsFoundation24CNKeychainFacadeProtocol_> *keychainFacade;
...
@property (readonly) NSObject<CNProbabilityUtility> *probabilityUtility; // ivar: _probabilityUtility
