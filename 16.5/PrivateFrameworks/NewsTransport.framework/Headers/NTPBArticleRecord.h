...
@property (retain, nonatomic) NSString *articleRecirculationConfigurationURL; // ivar: _articleRecirculationConfigurationURL
...
@property (retain, nonatomic) NSString *routeURL; // ivar: _routeURL
@property (nonatomic) NSInteger schemaFlags; // ivar: _schemaFlags
...
@property (retain, nonatomic) NSMutableArray *sportsEventIDs; // ivar: _sportsEventIDs
...
@property (retain, nonatomic) NSString *videoType; // ivar: _videoType
...
-(id)sportsEventIDsAtIndex:(NSUInteger)arg0 ;
...
-(void)addSportsEventIDs:(id)arg0 ;
