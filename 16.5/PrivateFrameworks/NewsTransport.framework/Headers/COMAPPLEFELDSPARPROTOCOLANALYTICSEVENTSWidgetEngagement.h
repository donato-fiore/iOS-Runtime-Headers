...
#ifndef COMAPPLEFELDSPARPROTOCOLANALYTICSEVENTSWIDGETENGAGEMENT_H
#define COMAPPLEFELDSPARPROTOCOLANALYTICSEVENTSWIDGETENGAGEMENT_H
...
-(id)widgetEngagementTypeAsString:(int)arg0 ;
...
-(int)StringAsWidgetEngagementType:(id)arg0 ;
