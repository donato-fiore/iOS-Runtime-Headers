...
@class HMFObject, NSString, HMFMessageDispatcher, NSUUID, HMSetupAccessoryDescription;
@protocol HMDSBSRemoteAlertHandleObserver, HMFLogging, HMFMessageReceiver, HMDSBSRemoteAlertHandle, OS_dispatch_queue;
...
@property (retain) HMSetupAccessoryDescription *pendingSetupAccessoryDescription; // ivar: _pendingSetupAccessoryDescription
...
-(id)initWithWorkQueue:(id)arg0 homeManager:(id)arg1 messageDispatcher:(id)arg2 alertHandleProvider:(id)arg3 ;
...
-(void)_launchHUISWithRequest:(id)arg0 connection:(id)arg1 completionHandler:(id)arg2 ;
-(void)_launchHUISWithSetupAccessoryDescription:(id)arg0 deviceSetupRequest:(id)arg1 resumeSetupUserInfo:(id)arg2 completionHandler:(id)arg3 ;
-(void)_updateAccessoryDescription:(id)arg0 usingConnection:(id)arg1 ;
-(void)configure;
-(void)handleHomeUIServiceXPCConnectionStateDidChangeNotification:(id)arg0 ;
-(void)handleNFCProxSetupNotification:(id)arg0 ;
-(void)launchAccessorySetupHostToPerformMatterDeviceSetupWithRequest:(id)arg0 clientProxy:(id)arg1 completionHandler:(id)arg2 ;
