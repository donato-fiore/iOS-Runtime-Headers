...
@class HMFObject, NSUUID, NSMutableSet, NSString, HMBLocalZoneLocalInput;
@protocol HMFLogging, HMDPersonDataSource;
...
@property (readonly) NSMutableSet *addedOrUpdatedPersons; // ivar: _addedOrUpdatedPersons
...
@property (readonly) NSMutableSet *removedPersonsUUIDs; // ivar: _removedPersonsUUIDs
