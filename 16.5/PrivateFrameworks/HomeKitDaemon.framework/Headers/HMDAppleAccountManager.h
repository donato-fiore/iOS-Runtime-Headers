...
@class HMFObject, HMFExponentialBackoffTimer, ACAccountStore, HMFFuture, HMFPromise, NSString, HMFTimer, NSUUID, NSNotificationCenter, NSData;
@protocol HMDAPSConnectionDelegate, HMDAccountManager, HMFLogging, HMFMessageReceiver, HMFTimerDelegate, IDSAccountDelegate, IDSAccountRegistrationDelegate, HMDIDSServiceDelegate, OS_dispatch_queue, HMDACAccountStore, HMDAPSConnection, HMDIDSService;
...
@property (readonly, nonatomic) HMFFuture *currentDeviceSettled; // ivar: _currentDeviceSettled
@property (readonly, nonatomic) HMFPromise *currentDeviceSettledPromise; // ivar: _currentDeviceSettledPromise
@property (readonly, copy) NSString *debugDescription;
@property (readonly, copy) NSString *description;
@property (readonly) HMDDevice *device;
@property (readonly, nonatomic) HMFFuture *deviceAccountSettled; // ivar: _deviceAccountSettled
@property (readonly, nonatomic) HMFPromise *deviceAccountSettledPromise; // ivar: _deviceAccountSettledPromise
@property (readonly, nonatomic) HMFTimer *devicesChangeBackoffTimer; // ivar: _devicesChangeBackoffTimer
@property (readonly) NSUInteger hash;
@property (readonly, nonatomic) HMFFuture *idsDevicesUpdated; // ivar: _idsDevicesUpdated
@property (readonly, nonatomic) HMFPromise *idsDevicesUpdatedPromise; // ivar: _idsDevicesUpdatedPromise
...
+(id)logCategory;
+(id)sharedManager;
-(BOOL)isCurrentDeviceDataOwnerForDevice:(id)arg0 ;
...
-(id)initWithIDSService:(id)arg0 activityBroadcaster:(id)arg1 dataSource:(id)arg2 ;
...
-(void)configureWithAccountRegistry:(id)arg0 ;
