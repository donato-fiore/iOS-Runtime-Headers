...
@property (readonly) HMDPersonCoreDataManager *coreDataManager; // ivar: _coreDataManager
...
-(id)initWithUUID:(id)arg0 zoneManager:(id)arg1 coreDataManager:(id)arg2 dataInterfaces:(id)arg3 workQueue:(id)arg4 ;
...
-(id)removeAllAssociatedDataDueToHomeGraphObjectRemoval:(BOOL)arg0 ;
