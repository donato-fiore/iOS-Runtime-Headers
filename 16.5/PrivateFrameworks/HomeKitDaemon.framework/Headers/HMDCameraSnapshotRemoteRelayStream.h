...
+(id)logCategory;
-(id)initWithSessionID:(id)arg0 workQueue:(id)arg1 sourceDevice:(id)arg2 remoteDevice:(id)arg3 accessory:(id)arg4 delegate:(id)arg5 delegateQueue:(id)arg6 uniqueIdentifier:(id)arg7 snapshotRequestHandler:(id)arg8 residentMessageHandler:(id)arg9 ;
-(id)logIdentifier;
