...
@property BOOL ownerHasUserSeenRMVNewLanguageNotification; // ivar: _ownerHasUserSeenRMVNewLanguageNotification
...
-(id)setHasUserSeenRMVNewLanguageNotification:(BOOL)arg0 ;
