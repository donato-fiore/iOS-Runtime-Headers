...
@class HMFObject, NSMutableArray, HMFTimer, NSArray, NSString, NSMutableSet, NSOperationQueue, NSMapTable, NSUUID, NSNotificationCenter;
@protocol HMFLogging, HMFTimerDelegate, HMDAccessorySettingGroupDataSource, HMDLegacyAccessorySettingsAdaptorDelegate, HMDAccessorySettingsBackingStoreTransactionReceiverDelegate, HMDAccessorySettingsMessageController, NSSecureCoding, OS_os_log, HMDAccessorySettingsControllerDataSource, HMDAccessorySettingsControllerDelegate, HMDAccessorySettingsControllerDependencyFactory, HMDLegacyAccessorySettingsAdaptor, HMMLogEventSubmitting, HMDAccessorySettingsMessageHandler, HMDBackingStoreObjectProtocol, OS_dispatch_queue;
...
@property (weak) NSObject<HMDAccessorySettingsControllerDataSource> *dataSource; // ivar: _dataSource
...
@property BOOL hasCreatedUnprocessedRootGroup; // ivar: _hasCreatedUnprocessedRootGroup
...
@property (retain, nonatomic) NSObject<HMDLegacyAccessorySettingsAdaptor> *legacySettingsAdaptor; // ivar: _legacySettingsAdaptor
...
@property (readonly, copy) NSUUID *parentUUID; // ivar: _parentUUID
...
+(id)logCategory;
-(BOOL)canUser:(id)arg0 editConstraintsForSettingWithKeyPath:(id)arg1 ;
-(BOOL)hasDependants;
-(BOOL)haveGroupWithUUID:(id)arg0 ;
-(BOOL)isProxy;
-(BOOL)shouldEncodeForNonAdminSharedUserForSetting:(id)arg0 ;
-(BOOL)shouldEncodeForXPCTransportForSetting:(id)arg0 ;
-(BOOL)shouldEncodeSetting:(id)arg0 withCoder:(id)arg1 forAccessorySettingGroup:(id)arg2 ;
-(id)_keyPathsForSettings;
-(id)groupForKeyPath:(id)arg0 ;
-(id)initWithCoder:(id)arg0 ;
-(id)initWithParentUUID:(id)arg0 codingKey:(id)arg1 ;
...
-(id)initWithQueue:(id)arg0 delegate:(id)arg1 dataSource:(id)arg2 parentUUID:(id)arg3 codingKey:(id)arg4 logEventSubmitter:(id)arg5 settingOwner:(BOOL)arg6 migrationOwner:(BOOL)arg7 factory:(id)arg8 rootGroup:(id)arg9 notificationCenter:(id)arg10 ;
...
-(void)_removeManagedConfigurationProfile:(id)arg0 completion:(id)arg1 ;
...
-(void)_runUpdateTransactionWithValue:(id)arg0 setting:(id)arg1 completion:(id)arg2 ;
...
-(void)boolSettingForKeyPath:(id)arg0 completion:(id)arg1 ;
-(void)configureIsSettingOwner:(BOOL)arg0 home:(id)arg1 ;
-(void)configureIsSettingOwner:(BOOL)arg0 home:(id)arg1 legacySettingsAdaptor:(id)arg2 ;
-(void)configureIsSettingOwner:(BOOL)arg0 migrationOwner:(BOOL)arg1 home:(id)arg2 legacySettingsAdaptor:(id)arg3 ;
...
-(void)legacySettingsAdaptor:(id)arg0 didLoadSettingKeyPath:(id)arg1 boolValue:(BOOL)arg2 ;
-(void)legacySettingsAdaptor:(id)arg0 didLoadSettingKeyPath:(id)arg1 numberValue:(id)arg2 ;
-(void)legacySettingsAdaptor:(id)arg0 didLoadSettingKeyPath:(id)arg1 selectedLanguageValue:(id)arg2 availableLanguageList:(id)arg3 ;
-(void)legacySettingsAdaptor:(id)arg0 didUpdateSettingKeyPath:(id)arg1 boolValue:(BOOL)arg2 ;
-(void)legacySettingsAdaptor:(id)arg0 didUpdateSettingKeyPath:(id)arg1 numberValue:(id)arg2 ;
-(void)legacySettingsAdaptor:(id)arg0 didUpdateSettingKeyPath:(id)arg1 selectedLanguageValue:(id)arg2 availableLanguageList:(id)arg3 ;
-(void)onMessageAddConstraint:(id)arg0 keyPath:(id)arg1 completion:(id)arg2 ;
-(void)onMessageRemoveConstraint:(id)arg0 keyPath:(id)arg1 completion:(id)arg2 ;
-(void)onMessageReplaceConstraintsWithAdditions:(id)arg0 constraintIdsToRemove:(id)arg1 keyPath:(id)arg2 senderProductClass:(NSInteger)arg3 isRemote:(BOOL)arg4 completion:(id)arg5 ;
-(void)onMessageReplaceConstraintsWithAdditions:(id)arg0 constraintIdsToRemove:(id)arg1 settingIdentifier:(id)arg2 senderProductClass:(NSInteger)arg3 isRemote:(BOOL)arg4 completion:(id)arg5 ;
-(void)onMessageUpdateConstraints:(id)arg0 keyPath:(id)arg1 completion:(id)arg2 ;
...
-(void)onMessageUpdateValue:(id)arg0 settingKeyPath:(id)arg1 senderVersion:(id)arg2 senderProductClass:(NSInteger)arg3 completion:(id)arg4 ;
...
-(void)setNestedGroupsDataSourcesWithGroup:(id)arg0 ;
