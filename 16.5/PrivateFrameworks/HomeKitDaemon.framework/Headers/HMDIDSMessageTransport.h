...
@class NSString, NSMutableDictionary, NSMutableArray, NSMutableOrderedSet, HMFOperationBudget;
@protocol HMDIDSServiceDelegate, HMDIDSService, OS_dispatch_queue;
...
@property (readonly, nonatomic, getter=isLegacyTransport) BOOL legacyTransport; // ivar: _legacyTransport
...
+(id)logCategory;
+(id)queueOneIdentifierWithMessageName:(id)arg0 target:(id)arg1 collapseID:(id)arg2 timeToLive:(CGFloat)arg3 now:(id)arg4 ;
+(struct _HMFRate )sendMessageRate;
-(BOOL)canSendMessage:(id)arg0 ;
-(BOOL)isSecure;
-(BOOL)isValidMessage:(id)arg0 ;
-(BOOL)shouldAcceptLegacyIDSMessage:(id)arg0 ;
-(NSInteger)qualityOfService;
-(id)deviceForSenderContext:(id)arg0 ;
-(id)initLegacyTransportWithAccountRegistry:(id)arg0 ;
-(id)initLegacyTransportWithAccountRegistry:(id)arg0 service:(id)arg1 appleAccountManager:(id)arg2 remoteAccountManager:(id)arg3 ;
