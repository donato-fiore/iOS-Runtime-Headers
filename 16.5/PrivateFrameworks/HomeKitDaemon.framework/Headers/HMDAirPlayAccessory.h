...
-(void)addUserPairingIdentity:(id)arg0 isOwner:(BOOL)arg1 completionHandler:(id)arg2 ;
-(void)configureWithHome:(id)arg0 msgDispatcher:(id)arg1 configurationTracker:(id)arg2 initialConfiguration:(BOOL)arg3 ;
-(void)disassociatePairingIdentity:(id)arg0 completionHandler:(id)arg1 ;
...
-(void)removeUserPairingIdentity:(id)arg0 isOwner:(BOOL)arg1 completionHandler:(id)arg2 ;
