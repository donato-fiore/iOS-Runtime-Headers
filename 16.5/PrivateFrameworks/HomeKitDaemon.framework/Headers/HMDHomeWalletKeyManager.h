...
@class HMFObject, NAFuture, NSUUID, NSString, HMFMessageDispatcher, NSNotificationCenter, NSMutableArray, HMFSystemInfo;
...
@property (retain) NSUUID *currentUserUUID; // ivar: _currentUserUUID
...
@property BOOL isHomeBeingRemoved; // ivar: _isHomeBeingRemoved
...
-(void)handleHomeManagerHomeDataLoadedNotification:(id)arg0 ;
...
-(void)removeDuplicateWalletKeysForUser:(id)arg0 ;
...
-(void)updateCurrentUserUUID:(id)arg0 ;
