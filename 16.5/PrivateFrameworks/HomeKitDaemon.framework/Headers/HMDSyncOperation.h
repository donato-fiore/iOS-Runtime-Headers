...
@class HMFObject, NSMutableArray, HMFTimer, NSUUID, NSArray, NSString;
...
// +(id)cloudOperation:(id)arg0 withBlock:(id)arg1 completion:(unk)arg2  ;
+(id)cloudPushSyncOperationWithBlock:(id)arg0 ;
+(id)cloudVerifyAccountSyncOperationWithBlock:(id)arg0 ;
// +(id)cloudZoneFetchSyncOperation:(id)arg0 cloudConflict:(BOOL)arg1 block:(id)arg2 completion:(unk)arg3  ;
...
// -(id)_initWithOptions:(id)arg0 syncBlock:(id)arg1 completion:(unk)arg2  ;
-(id)description;
-(void)removeAllOperationCompletions;
-(void)updateOperationCompletionsWithArray:(id)arg0 ;
