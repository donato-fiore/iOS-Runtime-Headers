...
@class HMFObject, NSString, NSMapTable, NSNotificationCenter, HMFWiFiManager;
...
-(id)_symptomsForRegisteredAccessory:(id)arg0 ;
-(id)init;
-(id)initWithQueue:(id)arg0 deviceDiscovery:(id)arg1 companionLinkClient:(id)arg2 wifiManager:(id)arg3 notificationCenter:(id)arg4 ;
