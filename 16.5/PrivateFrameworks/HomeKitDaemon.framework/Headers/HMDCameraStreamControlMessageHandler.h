...
@property (readonly) HMDCallObserver *callObserver; // ivar: _callObserver
...
-(id)initWithWorkQueue:(id)arg0 streamSnapshotHandler:(id)arg1 accessory:(id)arg2 streamManagementService:(id)arg3 profileUniqueIdentifier:(id)arg4 networkMonitor:(id)arg5 residentMessageHandler:(id)arg6 callObserver:(id)arg7 dataSource:(id)arg8 ;
-(id)logIdentifier;
...
-(void)handleActivePhoneCallDidEstablishNotification:(id)arg0 ;
