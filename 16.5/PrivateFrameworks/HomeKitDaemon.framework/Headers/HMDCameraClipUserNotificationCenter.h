...
-(id)initWithBulletinBoard:(id)arg0 workQueue:(id)arg1 logIdentifier:(id)arg2 ;
-(id)initWithBulletinBoard:(id)arg0 workQueue:(id)arg1 logIdentifier:(id)arg2 fileManager:(id)arg3 ;
