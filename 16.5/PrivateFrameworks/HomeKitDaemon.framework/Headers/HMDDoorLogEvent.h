...
-(id)initWithDoorStatus:(id)arg0 accessoryUUID:(id)arg1 characteristicUUID:(id)arg2 timeStamp:(id)arg3 homeUUID:(id)arg4 homePresence:(id)arg5 triggerSource:(id)arg6 bundleId:(id)arg7 userUUID:(id)arg8 ;
