...
-(void)insertAudioAnalysisEventNotification:(id)arg0 ;
-(void)insertBulletinForIncompatibleInvitationFromInviterName:(id)arg0 homeName:(id)arg1 ;
...
-(void)insertHH2DuplicateUserModelBulletinForHome:(id)arg0 user:(id)arg1 ;
-(void)insertHH2SoftwareUpdateCompleteEventBulletinForAccessory:(id)arg0 ;
...
-(void)updateAudioAnalysisEventNotification:(id)arg0 ;
