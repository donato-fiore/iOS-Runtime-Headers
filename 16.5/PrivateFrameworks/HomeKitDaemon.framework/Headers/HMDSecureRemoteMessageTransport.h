...
@protocol HMDSecureRemoteSessionDelegate, HMFLogging, HMDRemoteDeviceMonitorDeviceRegistrationClient, HMFMessageTransportDelegate, HMFDumpState, OS_dispatch_queue, HMDSecureRemoteMessageTransportDataSource, HMDRemoteHomeMessagingManager, HMDUserDeviceCapabilitiesRequestManager;
...
@property (readonly) HMDModernTransportDeviceReachabilityObserver *modernReachabilityObserver; // ivar: _modernReachabilityObserver
...
@property (retain) NSObject<HMDUserDeviceCapabilitiesRequestManager> *userDeviceCapabilitiesRequestManager; // ivar: _userDeviceCapabilitiesRequestManager
...
-(void)configureWithUserDeviceCapabilitiesRequestManager:(id)arg0 deviceResidencyProvider:(id)arg1 ;
...
-(void)registerHomeMessageDestinationHandler:(id)arg0 ;
-(void)reset;
