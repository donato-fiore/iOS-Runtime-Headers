...
@protocol HMDPersistentStore, HMFLogging;
...
-(id)archiveDictionary:(id)arg0 withPath:(id)arg1 forKey:(id)arg2 ;
-(id)unarchiveDictionaryFromData:(id)arg0 allowedClasses:(id)arg1 forKey:(id)arg2 ;
-(id)unarchiveDictionaryWithPath:(id)arg0 allowedClasses:(id)arg1 forKey:(id)arg2 ;
-(id)writeData:(id)arg0 toStorePath:(id)arg1 dataLabel:(id)arg2 ;
