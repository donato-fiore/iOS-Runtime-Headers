...
+(id)createUserAccessCodeModelFromAccessCode:(id)arg0 forUserUUID:(id)arg1 changedByUserUUID:(id)arg2 ;
+(id)logCategory;
...
-(id)_removeUserAccessCodeValue:(id)arg0 removedByUserUUID:(id)arg1 ;
...
-(id)removeHomeAccessCodeWithValue:(id)arg0 removedByUserUUID:(id)arg1 ;
...
-(id)simpleLabelForAccessCode:(id)arg0 ;
-(id)updateUserInformation:(id)arg0 forHomeAccessCodeWithOldValue:(id)arg1 newAccessCodeValue:(id)arg2 ;
-(id)userUUIDForAccessCode:(id)arg0 ;
-(void)_cleanUpOldRemovedUserData;
-(void)_messageUser:(id)arg0 thatTheirAccessCodeWasChangedWithType:(NSUInteger)arg1 ;
