...
@class HMFObject, NSMutableDictionary, NSMutableArray, NSString, HMFTimer, NSMutableSet, NSArray, NSUUID, NSMapTable, NSDictionary, NSNumber, NSHashTable, NSDate, HMFMessageDestination, NSSet, HMFMessageDispatcher, NSNotificationCenter, HMHomePersonManagerSettings, HMUserPresenceAuthorization, HMUserPresenceCompute, HMFFuture, HMFPromise, HMEDelegatingEventRouter;
...
@property (retain) HMDAccessoryBulletinNotificationManager *accessoryBulletinNotificationManager; // ivar: _accessoryBulletinNotificationManager
...
@property (retain) HMDAudioAnalysisBulletinNotificationManager *audioAnalysisBulletinNotificationManager; // ivar: _audioAnalysisBulletinNotificationManager
...
@property (retain) HMDCameraBulletinNotificationManager *cameraBulletinNotificationManager; // ivar: _cameraBulletinNotificationManager
...
@property (readonly, copy) NSString *description;
@property (readonly, copy) NSString *description;
@property (retain, nonatomic) HMDDeviceHomeKitSetupSession *deviceHomeKitSetupSession; // ivar: _deviceHomeKitSetupSession
...
@property (retain, nonatomic) HMDFetchedAccessorySettingsSubscriber *fetchedAccessorySettingsSubscriber; // ivar: _fetchedAccessorySettingsSubscriber
...
@property (retain, nonatomic) HMDHomeMediaStateSubscriber *mediaStateSubscriber; // ivar: _mediaStateSubscriber
...
@property (readonly, nonatomic) HMDHomePrimaryResidentMessagingHandler *primaryResidentMessagingHandler; // ivar: _primaryResidentMessagingHandler
...
@property BOOL residentSyncClientDidSync; // ivar: _residentSyncClientDidSync
@property (readonly, nonatomic) HMFFuture *residentSyncClientDidSyncFuture; // ivar: _residentSyncClientDidSyncFuture
@property (readonly, nonatomic) HMFPromise *residentSyncClientDidSyncPromise; // ivar: _residentSyncClientDidSyncPromise
@property (readonly) BOOL residentSyncDidSync;
@property (retain, nonatomic) HMDResidentSyncManager *residentSyncManager; // ivar: _residentSyncManager
...
@property (retain, nonatomic) HMDSelfRemovalWatchdog *selfRemovalWatchdog; // ivar: _selfRemovalWatchdog
...
+(id)createNewHomeModelsWithModelID:(id)arg0 parentModelID:(id)arg1 name:(id)arg2 ownedBy:(id)arg3 ;
...
+(id)homeWithHomeManager:(id)arg0 backingStore:(id)arg1 model:(id)arg2 error:(*id)arg3 ;
+(id)loadMigrationCharacteristicsAuthorizationDataFromDiskWithHomeUUID:(id)arg0 ;
+(id)logCategory;
...
+(id)updatedHomeModelCHIPPropertiesForAddedHAPAccessoryServer:(id)arg0 ;
...
+(void)removeCharacteristicAuthorizationDataMigrationFileFromDiskWithhHomeUUID:(id)arg0 ;
+(void)updateCHIPPropertiesOnAccessoryModel:(id)arg0 forAddedHAPAccessoryServer:(id)arg1 ;
+(void)updateCHIPPropertiesOnMKFAccessoryModel:(id)arg0 forAddedHAPAccessoryServer:(id)arg1 ;
...
-(BOOL)_doesInvitedUserHasTheSamePairingIdentityAsOwner:(id)arg0 ;
...
-(BOOL)_justSentInvitation:(id)arg0 ;
...
-(BOOL)_shouldResendOutgoingInvitation:(id)arg0 ;
...
-(BOOL)_validateSettingsUpdate:(id)arg0 type:(*NSInteger)arg1 keyPath:(*id)arg2 value:(*id)arg3 error:(*id)arg4 ;
-(BOOL)_verifyUserManagementPermissionForAccessory:(id)arg0 error:(*id)arg1 ;
-(BOOL)addBulletinConditions:(id)arg0 on:(id)arg1 context:(id)arg2 ;
-(BOOL)addElement:(id)arg0 toCondition:(id)arg1 isStartElement:(BOOL)arg2 ;
-(BOOL)addPresenceBulletinCondition:(id)arg0 on:(id)arg1 ;
-(BOOL)addSunriseSunSetTimePeriodElement:(id)arg0 toCondition:(id)arg1 isStartElement:(BOOL)arg2 ;
-(BOOL)addTimeOfDayTimePeriodElement:(id)arg0 toCondition:(id)arg1 isStartElement:(BOOL)arg2 ;
-(BOOL)addTimePeriodBulletinCondition:(id)arg0 on:(id)arg1 ;
...
-(BOOL)enableBulletinRegistrations:(id)arg0 source:(id)arg1 user:(id)arg2 context:(id)arg3 ;
...
-(BOOL)insertOrUpdateAudioAnalysisEventBulletinRegistrations:(id)arg0 source:(id)arg1 managedBulletinRegistration:(id)arg2 accessory:(id)arg3 user:(id)arg4 context:(id)arg5 ;
-(BOOL)insertOrUpdateCameraAccessModeBulletinRegistration:(id)arg0 source:(id)arg1 managedBulletinRegistration:(id)arg2 accessory:(id)arg3 user:(id)arg4 context:(id)arg5 ;
-(BOOL)insertOrUpdateCameraReachabilityBulletinRegistration:(id)arg0 source:(id)arg1 managedBulletinRegistration:(id)arg2 accessory:(id)arg3 user:(id)arg4 context:(id)arg5 ;
-(BOOL)insertOrUpdateCameraSignificantEventBulletinRegistration:(id)arg0 source:(id)arg1 managedBulletinRegistration:(id)arg2 accessory:(id)arg3 user:(id)arg4 context:(id)arg5 ;
-(BOOL)insertOrUpdateCharacteristicBulletinRegistration:(id)arg0 source:(id)arg1 managedBulletinRegistration:(id)arg2 accessory:(id)arg3 user:(id)arg4 context:(id)arg5 ;
...
-(BOOL)updateCHIPPropertiesOnHomeModel:(id)arg0 usingUpdatedHomeInfo:(id)arg1 ;
...
-(NSUInteger)pendingUserPrivilegeFromOutgoingInvitationUUID:(id)arg0 ;
...
-(id)_addOwnerToNewlyPairedAccessoryServer:(id)arg0 ;
...
-(id)_removeUserFromNewlyPairedAccessoryServer:(id)arg0 user:(id)arg1 ;
...
-(id)accessCodeForMatterUserWithUserUniqueID:(id)arg0 ;
...
-(id)addName:(id)arg0 ;
-(id)addUserAccessCodeForUser:(id)arg0 fromOutgoingInvitation:(id)arg1 ;
...
-(id)appleMediaAccessoryUUIDsForMediaStateSubscriber:(id)arg0 ;
-(id)audioDestinationControllerDataForDestination:(id)arg0 ;
-(id)backingStoreObjects:(NSInteger)arg0 ;
-(id)backingStoreObjects:(NSInteger)arg0 hh2Migration:(BOOL)arg1 ;
...
-(id)createAccessorySettingsMessengerWithMessageTargetUUID:(id)arg0 messageDispatcher:(id)arg1 messageRouter:(id)arg2 messageHandler:(id)arg3 logEventSubmitter:(id)arg4 ;
...
-(id)currentAccessoryUUIDsForMediaStateSubscriber:(id)arg0 ;
-(id)currentUser;
...
-(id)findAdditionalUUIDsForUser:(id)arg0 ;
-(id)findBulletinRegistration:(id)arg0 source:(id)arg1 user:(id)arg2 context:(id)arg3 ;
-(id)findOrAddUser:(id)arg0 onAccessory:(id)arg1 ;
-(id)findOrAddUserIndexForUserUUID:(id)arg0 guestName:(id)arg1 accessory:(id)arg2 ;
-(id)findOrAddUserUniqueIDForGuestAccessCode:(id)arg0 onAccessory:(id)arg1 ;
-(id)findUserIndexForUserUUID:(id)arg0 guestName:(id)arg1 accessory:(id)arg2 ;
-(id)findUserSlotForUserUniqueIdentifier:(id)arg0 onAccessory:(id)arg1 ;
...
-(id)handleFindOrAddUserUniqueIdentifier:(id)arg0 onAccessory:(id)arg1 ;
-(id)handleRemoveUserUniqueIdentifier:(id)arg0 fromAccessory:(id)arg1 ;
...
-(id)invitationWithIDSInvitationIdentifier:(id)arg0 ;
-(id)invitationWithInvitationIdentifier:(id)arg0 ;
...
-(id)mediaPassword;
-(id)mediaProfileForAppleMediaAccessoryUUID:(id)arg0 mediaStateSubscriber:(id)arg1 ;
...
-(id)outgoingInvitationToResendForUser:(id)arg0 ;
-(id)outgoingInvitationWithUUID:(id)arg0 ;
-(id)owner;
-(id)participantDataTopicForAccessory:(id)arg0 mediaGroupsAggregator:(id)arg1 ;
-(id)payloadFromEnableRegistrations:(id)arg0 disableRegistration:(id)arg1 source:(id)arg2 ;
-(id)payloadFromRegistrations:(id)arg0 ;
-(id)pendingUsers;
...
-(id)registrationSourceFromPayload:(id)arg0 ;
-(id)registrationsFromPayload:(id)arg0 enabled:(BOOL)arg1 ;
-(id)remoteEventAccessControlProvider;
-(id)removeGuestAccessCode:(id)arg0 fromAccessory:(id)arg1 ;
-(id)removeName:(id)arg0 ;
-(id)removeUser:(id)arg0 fromAccessory:(id)arg1 ;
-(id)replaceActionSetName:(id)arg0 withNewName:(id)arg1 ;
-(id)replaceName:(id)arg0 withNewName:(id)arg1 ;
-(id)retrieveNewlyAddedAccessoriesForPairedAccessoryServerInfo:(id)arg0 ;
...
-(id)saveUserUniqueID:(id)arg0 ForGuestAccessCode:(id)arg1 ;
-(id)saveUserUniqueID:(id)arg0 ForUser:(id)arg1 ;
...
-(id)userFromOutgoingInvitationModel:(id)arg0 ;
-(id)userIncludingPendingUserWithUUID:(id)arg0 ;
-(id)userUniqueIDForGuestAccessCode:(id)arg0 ;
...
-(id)usersIncludingPendingUsers:(BOOL)arg0 ;
...
-(void)__handleAcceptedOutgoingInvitationResponse:(id)arg0 destinationAddress:(id)arg1 publicKey:(id)arg2 username:(id)arg3 reverseShare:(id)arg4 reverseShareToken:(id)arg5 presenceAuthStatus:(id)arg6 completionHandler:(id)arg7 ;
...
-(void)_auditActionSetsAndTriggers:(id)arg0 ;
-(void)_auditActionSetsAndTriggersForAccessory:(id)arg0 ;
...
-(void)_grantAccessAndSendOutgoingInvitation:(id)arg0 suppressHomeInviteNotification:(BOOL)arg1 ;
...
-(void)_handleAudioAnalysisClassifierOptionsChange:(id)arg0 message:(id)arg1 ;
-(void)_handleAudioAnalysisClassifierOptionsUpdateRequest:(id)arg0 ;
-(void)_handleAudioAnalysisOnboardingStatusChange:(id)arg0 message:(id)arg1 ;
-(void)_handleAudioAnalysisOnboardingUpdateRequest:(id)arg0 ;
...
-(void)_handleOwnerSettingsUpdate:(id)arg0 ;
...
-(void)_handleRemoteAddHAPAccessories:(id)arg0 ;
-(void)_handleRemoteAddMediaAccessory:(id)arg0 ;
-(void)_handleRemoteAddMediaAccessoryRequest:(id)arg0 ;
...
-(void)_handleSharedUserSettingsUpdate:(id)arg0 ;
...
-(void)_handleUpdateAudioAnalysisAccess:(id)arg0 ;
...
-(void)_handleUpdateRequestForHomeInvitation:(id)arg0 controllerPublicKey:(id)arg1 controllerUsername:(id)arg2 invitationState:(NSInteger)arg3 presenceAuthStatus:(id)arg4 preferredUserID:(id)arg5 fromHandle:(id)arg6 fromAddress:(id)arg7 fromMergeID:(id)arg8 reverseShareURL:(id)arg9 reverseShareToken:(id)arg10 message:(id)arg11 messageResponseHandler:(id)arg12 ;
...
-(void)_performRemoteAddHAPAccessories:(id)arg0 ;
-(void)_performUpdateBulletinRegistrations:(id)arg0 ;
...
-(void)_removeFailedAddWithAccessoryServerInfo:(id)arg0 ;
...
-(void)_updateOwnerSettingDependents:(id)arg0 keyPath:(id)arg1 value:(id)arg2 ;
...
-(void)_waitForResidentNewAccessoryUpdateWithServer:(id)arg0 pairingEvent:(id)arg1 callback:(id)arg2 ;
...
-(void)auditDestinationsForNotifications:(id)arg0 ;
...
-(void)disableBulletinRegistrations:(id)arg0 source:(id)arg1 user:(id)arg2 context:(id)arg3 ;
...
-(void)doFullImportWithCompletion:(id)arg0 ;
...
-(void)handleAcceptRequestForIDSInvitationWithIdentifier:(id)arg0 payload:(id)arg1 fromAddress:(id)arg2 fromMergeID:(id)arg3 ;
...
-(void)handleCurrentAccountMergeIdentifierUpdated:(id)arg0 ;
-(void)handleCurrentUserPrivilegeChanged:(id)arg0 ;
-(void)handleDeclineRequestForIDSInvitationWithIdentifier:(id)arg0 fromAddress:(id)arg1 ;
...
-(void)handleFindResidentsNotification:(id)arg0 ;
...
-(void)handleRemoteUpdateCHIPKeyValueStoreMessage:(id)arg0 ;
...
-(void)handleUpdateBulletinRegistrations:(id)arg0 ;
...
-(void)maybeRemoveStaleRegistrationsFromPreviousUserForSource:(id)arg0 user:(id)arg1 context:(id)arg2 ;
...
-(void)registerForBulletinNotificationRegistrationHandlersUsingPolicies:(id)arg0 ;
...
-(void)remotelyUpdateHomeModelWithCHIPKeyValueStore:(id)arg0 completion:(id)arg1 ;
...
-(void)resendOutgoingInvitationToUser:(id)arg0 ;
...
-(void)updateBulletinRegistrationOnPrimaryResidentWithSource:(id)arg0 enableRegistrations:(id)arg1 disableRegistration:(id)arg2 completionHandler:(id)arg3 ;
-(void)updateEnabledBulletinRegistrations:(id)arg0 disabledBulletinRegistrations:(id)arg1 source:(id)arg2 context:(id)arg3 completionHandler:(id)arg4 ;
