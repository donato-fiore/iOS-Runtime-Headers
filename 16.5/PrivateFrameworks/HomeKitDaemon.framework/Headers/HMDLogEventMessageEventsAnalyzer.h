...
@property (readonly, nonatomic) HMDEventCounterGroup *homeManagerMessagesGroup; // ivar: _homeManagerMessagesGroup
...
@property (readonly, nonatomic) HMDEventCounterGroup *residentSyncGroup; // ivar: _residentSyncGroup
...
-(void)_updateResidentSyncCountersWithRemoteMessageLogEvent:(id)arg0 ;
