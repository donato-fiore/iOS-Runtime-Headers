...
@class HMFObject, NSMutableSet, NSArray, NSString, NSMutableArray;
@protocol HMDAccountManager, HMFLogging, HMFObject, HMDIDSServiceDelegate, NSFastEnumeration, OS_dispatch_queue, HMDIDSService;
...
-(id)accountForDeviceHandle:(id)arg0 ;
