...
@class HMFObject, NSMutableArray, NSArray, NSDictionary, NSString, HMFMessage, NSDate, HMFTimer, NSSet, NSUUID, HMFMessageDispatcher;
...
-(BOOL)_isValidCharacteristicWriteAction:(id)arg0 ;
...
-(id)_addAppleMediaAccessoryPowerActionModelWithUUID:(id)arg0 message:(id)arg1 ;
...
-(id)_executeAppleMediaAccessoryPowerActions:(id)arg0 message:(id)arg1 ;
-(id)_executeCharacteristicWriteRequests:(id)arg0 message:(id)arg1 ;
-(id)_executeGenericActions:(id)arg0 message:(id)arg1 ;
-(id)_executeMediaPlaybackActions:(id)arg0 message:(id)arg1 ;
-(id)_executeNaturalLightingActions:(id)arg0 writeRequests:(id)arg1 message:(id)arg2 ;
-(id)_executeNaturalLightingWriteRequests:(id)arg0 message:(id)arg1 naturalLightingActions:(id)arg2 naturalLightingActionResultByActionUUID:(id)arg3 ;
...
-(void)_executeAppleMediaAccessoryPowerActions:(id)arg0 source:(NSUInteger)arg1 clientName:(id)arg2 completionHandler:(id)arg3 ;
...
-(void)_handleAddAppleMediaAccessoryPowerActionTransaction:(id)arg0 message:(id)arg1 ;
-(void)_handleAddCharacteristicWriteActionTransaction:(id)arg0 message:(id)arg1 ;
...
-(void)_handleRemovalOfAction:(id)arg0 transaction:(id)arg1 ;
-(void)_handleRemovalOfActions:(id)arg0 transaction:(id)arg1 ;
...
-(void)_handleUpdateActionSet:(id)arg0 ;
-(void)_handleUpdateActionSetFromBuilder:(id)arg0 ;
...
-(void)_updateAppleMediaAccessoryPowerAction:(id)arg0 forMessage:(id)arg1 ;
...
-(void)auditActionsForAccessory:(id)arg0 transaction:(id)arg1 ;
-(void)dealloc;
...
-(void)handleRemovalOfAccessory:(id)arg0 transaction:(id)arg1 ;
-(void)handleRemovalOfService:(id)arg0 transaction:(id)arg1 ;
-(void)invalidate;
