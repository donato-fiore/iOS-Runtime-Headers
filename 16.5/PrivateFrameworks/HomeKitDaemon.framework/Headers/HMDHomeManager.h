...
@property (readonly, nonatomic) HMDCHIPXPCListener *chipXPCListener; // ivar: _chipXPCListener
...
@property (retain, nonatomic) HMDCurrentAccessorySetupMetricDispatcher *currentAccessorySetupMetricDispatcher; // ivar: _currentAccessorySetupMetricDispatcher
...
@property (readonly, copy) NSString *description;
@property (readonly, copy) NSString *description;
@property (readonly) BOOL deviceAccountHasSettled; // ivar: _deviceAccountHasSettled
...
@property (readonly) BOOL firstCloudKitImportComplete; // ivar: _firstCloudKitImportComplete
...
@property BOOL hasLoadedData; // ivar: _hasLoadedData
@property (readonly) NSUInteger hash;
@property (readonly) NSUInteger hash;
@property (readonly) NSUInteger hash;
@property (readonly) NSUInteger hash;
@property (nonatomic) BOOL haveQueuedUpdateAccessories; // ivar: _haveQueuedUpdateAccessories
...
@property (retain, nonatomic) HMDIDSInvitationManager *idsInvitationManager; // ivar: _idsInvitationManager
...
@property BOOL isOwnerPingPending; // ivar: _isOwnerPingPending
...
@property (readonly, nonatomic) HMMLogEventDispatcher *logEventDispatcher; // ivar: _logEventDispatcher
@property (retain, nonatomic) HMDLoggingEventForwarder *loggingMemoryEventForwarder; // ivar: _loggingMemoryEventForwarder
@property (readonly, nonatomic) HMDHomeManagerObjectLookup *lookup; // ivar: _lookup
@property (readonly, nonatomic) HMDMatterSoftwareUpdateProviderDelegate *matterSoftwareUpdateProviderDelegate; // ivar: _matterSoftwareUpdateProviderDelegate
...
@property (retain) id *mkfContext; // ivar: _mkfContext
...
@property (readonly) HMDMTSXPCServer *mtsXPCServer; // ivar: _mtsXPCServer
...
@property NSInteger recoveryVersion; // ivar: _recoveryVersion
...
@property CGFloat setupEndTimestamp; // ivar: _setupEndTimestamp
...
@property (retain, nonatomic) HMDHomeManagerHH2SharedUserLastSyncManager *sharedUserLastSyncManager; // ivar: _sharedUserLastSyncManager
...
@property (readonly) BOOL startupHasCompleted; // ivar: _startupHasCompleted
@property (readonly) HMFPromise *startupPromise; // ivar: _startupPromise
...
@property (readonly, nonatomic) HMDUserDeviceCapabilitiesRequestManager *userDeviceCapabilitiesRequestManager; // ivar: _userDeviceCapabilitiesRequestManager
...
@property (readonly) NSObject<HMFAsyncContext> *workContext; // ivar: _workContext
@property (retain, nonatomic) NSObject<OS_dispatch_queue> *workQueue; // ivar: _workQueue
@property (readonly, nonatomic) BOOL zoneFetchFailed;


+(BOOL)HMDXPCClientConnectionIsAdaptive:(id)arg0 ;
...
+(id)_findDuplicateUserModelsWithContext:(id)arg0 ;
...
+(id)getAccessoryCacheForIdentifier:(id)arg0 ;
...
+(id)setupCoreDataUsingBackingStore:(id)arg0 ;
+(void)_eraseAllAccessoryKeysAndIdentifiers;
+(void)makeSureHomeManagerExistInWorkingStore:(id)arg0 ;
...
-(BOOL)_capabilitiesAreSupported:(id)arg0 ;
...
-(BOOL)_isAutoAcceptMetadataPresentForHome:(id)arg0 owner:(id)arg1 ;
-(BOOL)_isMetadataExpiredForHomeAwaitingAutoAccept:(id)arg0 ;
...
-(BOOL)deviceAddressBelongsToResidentOfCurrentHome:(id)arg0 ;
-(BOOL)getOrCreateControllerPublicKey:(*id)arg0 controllerUsername:(*id)arg1 error:(*id)arg2 ;
-(BOOL)hasClientRequestedMediaAccessoryControl:(id)arg0 ;
...
-(BOOL)isInitialReplay:(id)arg0 ;
-(BOOL)isPairedWithWatch;
-(BOOL)pendingInviteExistsForSenderOfMessage:(id)arg0 ;
...
-(id)__homeContainingInviteWithIDSInvitationIdentifier:(id)arg0 ;
-(id)__homeContainingInviteWithInvitationIdentifier:(id)arg0 ;
-(id)__nominateCurrentHomeUUID;
-(id)_accessoryOfCurrentDevice;
-(id)_accountHandleFromMetadataForHomeAwaitingAutoAccept:(id)arg0 ;
...
-(id)_destinationFromMessage:(id)arg0 ;
...
-(id)_homeFromIncomingInvitationWithIdentifier:(id)arg0 homeUUID:(id)arg1 ;
-(id)_homeFromIncomingInvitationWithIdentifier:(id)arg0 invitationIdentifier:(id)arg1 homeUUID:(id)arg2 ;
...
-(id)_prepareAnswerForRequestedCapabilities:(id)arg0 ;
...
-(id)_remotePeers;
-(id)_remoteUserForMessage:(id)arg0 ;
-(id)_runtimeState;
-(id)_scrubRequestedCapabilities:(id)arg0 fromMessage:(id)arg1 ;
...
-(id)filterHomes:(id)arg0 isSPIEntitled:(BOOL)arg1 ;
...
-(id)hh1UserIDsForCurrentUserForHomeUUID:(id)arg0 ;
-(id)hh2ControllerKey;
...
-(id)queryDeviceCapabilities:(id)arg0 ;
...
-(id)updateMediaRouteIDOfDeviceWithIdentifier:(id)arg0 ;
-(id)updateMessageTargetForDuetPredictionSubscriber:(id)arg0 ;
-(id)upstreamTopicsForTopic:(id)arg0 ;
-(id)userUUIDForMessage:(id)arg0 homeUUID:(id)arg1 ;
-(id)validateHomeName:(id)arg0 ;
...
-(void)__sendUpdateRequestToAdminForInvitation:(id)arg0 homeUUID:(id)arg1 invitationState:(NSInteger)arg2 authStatus:(id)arg3 reverseShareInvitation:(id)arg4 ;
...
-(void)_autoAcceptInviteIfReinvitation:(id)arg0 ;
...
-(void)_handleAppleMediaAccessoryDeviceInfoRequestMessage:(id)arg0 ;
-(void)_handleAppleMediaResidentCoreDataChanges:(id)arg0 ;
...
-(void)_handleDeviceSetupSessionClose:(id)arg0 ;
...
-(void)_handleFetchSetupMode:(id)arg0 ;
-(void)_handleForwardedSharedUserInvitationAcceptance:(id)arg0 ;
...
-(void)_handlePrepareForDiagnosticExtension:(id)arg0 ;
...
-(void)_handleRemoveAllHomeKitPairingIdentities:(id)arg0 ;
-(void)_handleRemoveAllUsersFromAccessories:(id)arg0 ;
...
-(void)_handleSharedUserMovedToHH2:(id)arg0 ;
-(void)_handleShouldDisplayiCloudSwitch:(id)arg0 ;
-(void)_handleSignificantTimeChange;
-(void)_handleSwitchSetupMode:(id)arg0 ;
...
-(void)_pushChangesForHH2SharedUserLastSync:(id)arg0 completion:(id)arg1 ;
...
-(void)_removeConfigurationVersionForHome:(id)arg0 ;
...
-(void)_saveAccessAllowedWhenLockedToLocalStore:(BOOL)arg0 message:(id)arg1 ;
...
-(void)_sendAcceptOrDeclineRequestToAdminForIDSInvitationIdentifier:(id)arg0 homeInviteUUID:(id)arg1 payload:(id)arg2 invitationState:(NSInteger)arg3 responseHandler:(id)arg4 ;
...
-(void)_sendOwnerPingMessageToAccountHandle:(id)arg0 ;
...
-(void)_updateHome:(id)arg0 configurationVersion:(NSInteger)arg1 ;
...
-(void)_updatePowerAssertion:(id)arg0 ;
...
-(void)auditAccessForUsersForHome:(id)arg0 ;
...
-(void)determineDataSyncSateForHH2:(*BOOL)arg0 homeManagerDataSyncState:(*NSUInteger)arg1 homeManagerStatus:(*NSUInteger)arg2 ;
...
-(void)dmHandleRequestAddHome:(id)arg0 ;
-(void)dmHandleRequestRemoveHome:(id)arg0 ;
-(void)dmKickClients;
-(void)dm_transactionObjectRemoved:(id)arg0 message:(id)arg1 ;
-(void)dm_transactionObjectUpdated:(id)arg0 newValues:(id)arg1 message:(id)arg2 ;
-(void)electDeviceForHH1User:(id)arg0 destination:(id)arg1 deviceCapabilities:(id)arg2 queue:(id)arg3 completionHandler:(id)arg4 ;
-(void)electDeviceForUser:(id)arg0 destination:(id)arg1 deviceCapabilities:(id)arg2 queue:(id)arg3 completionHandler:(id)arg4 ;
-(void)electDeviceForUser:(id)arg0 destination:(id)arg1 deviceCapabilities:(id)arg2 responseTimeout:(CGFloat)arg3 queue:(id)arg4 completionHandler:(id)arg5 ;
-(void)electRemoteAccessPeerForHome:(id)arg0 ;
-(void)enableUserListeningHistoryForHomeUUID:(id)arg0 accessoryUUID:(id)arg1 userUUID:(id)arg2 ;
-(void)eraseLocalHomeData;
-(void)evaluateIfMediaPlaybackStateChanged:(id)arg0 ;
-(void)evaluateToPushMetadataWhenHomeKitInUse;
-(void)fetchAllZones;
-(void)fetchAndRemoveAllZonesFromDatabase:(id)arg0 ;
...
-(void)handleAcceptRequestForIDSInvitationWithIdentifier:(id)arg0 homeUUID:(id)arg1 payload:(id)arg2 fromAddress:(id)arg3 fromMergeID:(id)arg4 ;
...
-(void)handleCancelRequestForIDSInvitationWithIdentifier:(id)arg0 ;
-(void)handleContactStoreChanged:(id)arg0 ;
-(void)handleDataFragmentedSync:(id)arg0 ;
-(void)handleDeclineRequestForIDSInvitationWithIdentifier:(id)arg0 fromAddress:(id)arg1 homeUUID:(id)arg2 ;
-(void)handleDumpDatabaseMessage:(id)arg0 ;
-(void)handleHomeCurrentDeviceResidentEligibleNotification:(id)arg0 ;
-(void)handleMetadataDictionary:(id)arg0 message:(id)arg1 ;
-(void)handleReceivedIDSInviteFromAccount:(id)arg0 mergeID:(id)arg1 idsInvitationIdentifier:(id)arg2 payload:(id)arg3 ;
-(void)handleRemoteUserClientCloudShareRepairRequest:(id)arg0 ;
-(void)handleRemoteUserClientCloudShareRequest:(id)arg0 ;
-(void)handleRollPreferredHH2ControllerKeyMessage:(id)arg0 ;
...
-(void)homeModelHomeDelete:(id)arg0 message:(id)arg1 ;
-(void)homeModelHomeUpdate:(id)arg0 message:(id)arg1 ;
...
-(void)migrateSharedUserFromIncomingInvitation:(id)arg0 ;
...
-(void)performInitialGraphLoad:(id)arg0 ;
...
-(void)prepareForDiagnosticExtension:(id)arg0 ;
...
-(void)purgeAllRecordZones:(id)arg0 fromDatabase:(id)arg1 completionHandler:(id)arg2 ;
-(void)pushChangesForHH2SharedUserLastSync:(id)arg0 completion:(id)arg1 ;
...
-(void)removeHomeFromAwaitingAutoAcceptHomes:(id)arg0 ;
-(void)removeHomeFromSharedHomesNotYetMigrated:(id)arg0 ;
-(void)removeHomeWalletKeysExcludingSerialNumbers:(id)arg0 ;
-(void)reprocessUserManagementModels;
-(void)resetHomeConfigForHH2:(BOOL)arg0 message:(id)arg1 ;
-(void)saveAssistantSyncDataPostedToWorkingStore;
-(void)saveAssociatedGroupDataForPostMigrationStagingWithCurrentAccessory:(id)arg0 ;
...
-(void)updateAccessoryModelsFromContext:(id)arg0 ;
