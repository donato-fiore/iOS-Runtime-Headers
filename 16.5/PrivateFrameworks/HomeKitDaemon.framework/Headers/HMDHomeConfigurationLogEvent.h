...
@class HMMLogEvent, NSString, NSDictionary, NSArray, NSUUID, NSNumber;
...
@property (readonly, getter=isAccessToHomeAllowed) BOOL accessToHomeAllowed; // ivar: _accessToHomeAllowed
...
@property (readonly, nonatomic) BOOL isSmokeAlarmEnabled; // ivar: _isSmokeAlarmEnabled
...
@property (readonly, nonatomic) NSUInteger numCHIPAccessoriesFirmwareUpdateEligible; // ivar: _numCHIPAccessoriesFirmwareUpdateEligible
...
@property (readonly, nonatomic) NSUInteger numHAPAccessoriesFirmwareUpdateEligible; // ivar: _numHAPAccessoriesFirmwareUpdateEligible
...
@property (readonly, nonatomic) NSUInteger numHomePodB620; // ivar: _numHomePodB620
@property (readonly, nonatomic) NSUInteger numHomePodB620StereoPairs; // ivar: _numHomePodB620StereoPairs
...
-(id)initWithIsOwnerUser:(BOOL)arg0 isResidentAvailable:(BOOL)arg1 isPrimaryReportingDevice:(BOOL)arg2 isCurrentDeviceResidentEnabled:(BOOL)arg3 isPrimaryResident:(BOOL)arg4 isCurrentDeviceLocalToHome:(BOOL)arg5 isNetworkProtectionEnabled:(BOOL)arg6 isUserRoeProvisioned:(BOOL)arg7 isResidentFirstEnabled:(BOOL)arg8 isResidentElectionV2Enabled:(BOOL)arg9 isSmokeAlarmEnabled:(BOOL)arg10 ;
