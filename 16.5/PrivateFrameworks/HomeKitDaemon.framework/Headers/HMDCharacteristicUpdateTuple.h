...
@property (readonly, nonatomic) NSUInteger reasons; // ivar: _reasons
...
-(id)initWithCharacteristic:(id)arg0 updatedValue:(id)arg1 isBroadcast:(BOOL)arg2 reasons:(NSUInteger)arg3 ;
