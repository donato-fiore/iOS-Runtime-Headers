...
@class HMFObject, NSArray, NSString, HMFMessageDispatcher, NSUUID, NSNotificationCenter, NSMutableDictionary, HMFTimer;
...
-(BOOL)_shouldNotifyForActivityForSignificantEvent:(id)arg0 remoteRegistration:(id)arg1 ;
-(BOOL)_shouldNotifyForDoorbellPressForSignificantEvent:(id)arg0 registration:(id)arg1 ;
...
-(id)initWithHome:(id)arg0 workQueue:(id)arg1 messageDispatcher:(id)arg2 accountManager:(id)arg3 faceClassificationResolver:(id)arg4 doorbellPressTracker:(id)arg5 evaluator:(id)arg6 notificationCenter:(id)arg7 ;
-(id)logIdentifier;
...
-(void)_handleSignificantEvent:(id)arg0 remoteRegistration:(id)arg1 ;
...
-(void)_notifyDevice:(id)arg0 aboutSignificantEvent:(id)arg1 notificationReasons:(NSUInteger)arg2 ;
-(void)_notifyObserversOfSignificantEventUUID:(id)arg0 cameraProfileUUID:(id)arg1 notificationReasons:(NSUInteger)arg2 ;
...
-(void)updateNotificationRegistrationsWithSettings:(id)arg0 accessory:(id)arg1 doorbellPressNotificationEnabled:(BOOL)arg2 completion:(id)arg3 ;
