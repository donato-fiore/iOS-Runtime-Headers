...
@property (nonatomic) NSInteger siriPhraseOptions;
...
+(id)__dictionaryFromGuestAccessCodeForUnitTest:(id)arg0 label:(id)arg1 userUniqueIDForAccessories:(id)arg2 ;
...
+(id)__userUniqueIDForAccessoriesFromDictionaryForUnitTest:(id)arg0 ;
...
-(id)_populateGuestAccessCodeWithDictionary:(id)arg0 hh2ModelID:(id)arg1 home:(id)arg2 groupsByModelID:(id)arg3 context:(id)arg4 ;
