...
@property (readonly) HMDMediaGroupsLocalDataStorage *groupLocalDataStorage; // ivar: _groupLocalDataStorage
...
-(BOOL)setState:(NSUInteger)arg0 previousState:(*NSUInteger)arg1 ;
-(BOOL)shouldWarmUp;
...
-(void)handleIncomingParticipantData:(id)arg0 forAccessoryUUID:(id)arg1 ;
-(void)handleMediaSystemAddedNotification:(id)arg0 ;
-(void)handleParticipantDataEvent:(id)arg0 accessoryUUID:(id)arg1 ;
-(void)handleParticipantDestination:(id)arg0 backedUpGroups:(id)arg1 forParticipantAccessoryUUID:(id)arg2 ;
-(void)handlePrimaryResidentDeviceChangeNotification:(id)arg0 ;
