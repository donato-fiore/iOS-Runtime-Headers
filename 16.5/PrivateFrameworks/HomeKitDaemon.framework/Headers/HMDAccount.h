...
@class HMFObject, NSSet, NSMutableSet, NSString, Protocol, CNContact, NSArray, NSUUID;
@protocol HMFLogging, HMFMerging, HMCBacked, HMDBackingStoreObjectProtocol, HMDBackingStoreModelBackedObjectProtocol, NSFastEnumeration, NSSecureCoding, OS_dispatch_queue, NSCopying, HMDAccountManager;
...
-(id)shortDescription;
-(void)_repairDevicesWithStaleHandle:(id)arg0 ;
-(void)addDevice:(id)arg0 ;
-(void)addHandle:(id)arg0 ;
-(void)encodeWithCoder:(id)arg0 ;
-(void)isOfKnownPersonWithCompletion:(id)arg0 ;
