...
@class NSArray, NSNumber, NSString, HMUserHomeAccessSettings, NSDictionary, CKRecordID, NSData;
...
+(id)keyedArchiveToken:(id)arg0 ;
+(id)properties;
+(id)shareTokenFromKeyedArchiveData:(id)arg0 ;
