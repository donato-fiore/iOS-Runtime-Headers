...
@class HMFObject, NSString, HMFTimer, CLLocation, NSDate, NSSet, NSUUID, HMFMessageDispatcher, CLRegion, NSTimeZone;
...
@property (nonatomic) BOOL firstAccessoryReachable; // ivar: _firstAccessoryReachable
...
-(void)handleHomeLocationForHH2:(id)arg0 updatedTime:(id)arg1 source:(NSInteger)arg2 ;
-(void)runTransactionWithLocation:(id)arg0 updatedTime:(id)arg1 source:(NSInteger)arg2 ;
-(void)sendHomeLocationUpdateToResident:(id)arg0 source:(NSInteger)arg1 ;
