...
@class NSString, NSArray, NSNumber, NSDate, NSUUID;
...
@property (retain, nonatomic) NSNumber *announceAccessLevel; // ivar: _announceAccessLevel
...
@property (retain, nonatomic) NSUUID *pendingUserUUID; // ivar: _pendingUserUUID
