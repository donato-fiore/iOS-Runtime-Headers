...
@class NSArray, NSMutableArray, HMFTimer, NSString, NSPredicate;
@protocol HMFTimerDelegate, HMDEventDelegate, HMFLogging, HMDEventTriggerDependencyFactory;
...
@property (retain, nonatomic) HMFTimer *debounceTriggerActivationTimer; // ivar: _debounceTriggerActivationTimer
...
-(BOOL)_validateUpdatingTriggerWithName:(id)arg0 uuid:(id)arg1 message:(id)arg2 ;
-(BOOL)addEventsFromMessage:(id)arg0 preserveUUIDs:(BOOL)arg1 transaction:(id)arg2 error:(*id)arg3 ;
...
-(id)_modelWithRewrittenCondition:(id)arg0 ;
...
-(id)initWithModel:(id)arg0 home:(id)arg1 message:(id)arg2 factory:(id)arg3 ;
...
-(void)_handleRemovalOfCharacteristic:(id)arg0 withEvents:(id)arg1 transaction:(id)arg2 ;
-(void)_handleRemovalOfEvents:(id)arg0 transaction:(id)arg1 ;
...
-(void)_handleUpdateEventTrigger:(id)arg0 ;
...
-(void)auditForStaleEventsWithAccessory:(id)arg0 transaction:(id)arg1 ;
-(void)configure:(id)arg0 messageDispatcher:(id)arg1 queue:(id)arg2 ;
-(void)dealloc;
-(void)encodeWithCoder:(id)arg0 ;
-(void)executionComplete:(id)arg0 error:(id)arg1 ;
-(void)fixupForReplacementAccessory:(id)arg0 transaction:(id)arg1 ;
-(void)handleRemovalOfAccessory:(id)arg0 transaction:(id)arg1 ;
-(void)handleRemovalOfCharacteristic:(id)arg0 transaction:(id)arg1 ;
