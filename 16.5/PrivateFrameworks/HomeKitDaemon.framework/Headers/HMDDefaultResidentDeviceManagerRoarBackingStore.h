...
-(id)_deviceFromModel:(id)arg0 currentDevice:(id)arg1 ;
-(id)findResidents:(id)arg0 outHasResidents:(*BOOL)arg1 ;
-(id)handleCloudResidentChange:(id)arg0 currentResidents:(id)arg1 isCurrentDevicePrimaryResident:(BOOL)arg2 currentDevice:(id)arg3 ;
