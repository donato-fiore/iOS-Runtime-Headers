...
@class HMFObject, NSString, HMFTimer, NSMutableDictionary, NSUUID, NSSet, NSMutableArray, NSMutableSet;
...
@property (retain, nonatomic) NSMutableSet *updatedOrAddedDevices; // ivar: _updatedOrAddedDevices
