...
@protocol MKFFloatCharacteristic, MKFFloatCharacteristicPrivateExtensions, MKFHome, MKFService;


#import "MKFFloatCharacteristicDatabaseID.h"
#import "HMDCharacteristicMetadata.h"

@interface _MKFFloatCharacteristic : MKFCharacteristic <MKFFloatCharacteristic, MKFFloatCharacteristicPrivateExtensions>
