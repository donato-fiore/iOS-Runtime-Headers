...
@property (retain) HMDDeviceAddress *deviceAddress; // ivar: _deviceAddress
@property (readonly) HMDDevice *deviceForDirectMessaging;
@property (retain) NSData *deviceIRK; // ivar: _deviceIRK
...
@property BOOL shouldApplySoftwareUpdateWhenFound; // ivar: _shouldApplySoftwareUpdateWhenFound
@property (retain) HMDAppleMediaAccessorySleepWakeStateController *sleepWakeStateController; // ivar: _sleepWakeStateController
@property (retain) HMDSoftwareUpdateEventListener *softwareUpdateListener; // ivar: _softwareUpdateListener
...
-(BOOL)isMatchingCachedEventPublicPairingIdentity:(id)arg0 ;
...
-(id)firstCloudKitImportFutureForAppleMediaAccessorySensorManager:(id)arg0 ;
...
-(id)residentSyncClientDidSyncFutureForAppleMediaAccessorySensorManager:(id)arg0 ;
...
-(void)_handleAudioAnalysisBulletinBoardCommit:(id)arg0 ;
...
-(void)_scanForSoftwareUpdateRepeatedlyAndInstallUpdate:(BOOL)arg0 ;
...
-(void)forwardAccessoryPublicPairingIdentity:(id)arg0 ;
...
-(void)handleSoftwareUpdateV2ScanRepeatedlyAndApplyMessage:(id)arg0 ;
