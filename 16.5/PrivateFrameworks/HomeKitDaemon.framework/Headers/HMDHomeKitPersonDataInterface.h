...
@protocol HMFLogging, HMFMessageReceiver, HMDActiveXPCClientConnectionsPeriodicTimerDelegate, HMDPersonDataInterface, HMDPersonDataSource, OS_dispatch_queue;
