...
@class HMFObject, NSHashTable, HMBCloudZone, _HMCameraUserSettings, NSString, HMFTimer, HMBLocalZone, HMFMessageDispatcher, NSUUID, NSNotificationCenter, NSDate;
...
-(id)initWithAccessory:(id)arg0 workQueue:(id)arg1 identifier:(id)arg2 bulletinBoard:(id)arg3 logEventSubmitter:(id)arg4 accountSettings:(id)arg5 notificationCenter:(id)arg6 ;
...
-(void)configureWithMessageDispatcher:(id)arg0 currentSettings:(id)arg1 isCurrentDeviceConfirmedPrimaryResident:(BOOL)arg2 isCurrentDeviceConnectedToNetwork:(BOOL)arg3 ;
...
-(void)handleResidentDeviceConfirmedStateChangedNotification:(id)arg0 ;
