...
-(id)cameraAccessModeBulletinRegistrationWithDeviceIdsIdentifier:(id)arg0 user:(id)arg1 context:(id)arg2 ;
-(id)cameraReachabilityBulletinRegistrationWithDeviceIdsIdentifier:(id)arg0 user:(id)arg1 context:(id)arg2 ;
-(id)cameraSignificantEventBulletinRegistrationWithDeviceIdsIdentifier:(id)arg0 user:(id)arg1 context:(id)arg2 ;
...
-(id)predicateToFetchBulletinRegistrationOnDeviceIdsIdentifier:(id)arg0 user:(id)arg1 ;
