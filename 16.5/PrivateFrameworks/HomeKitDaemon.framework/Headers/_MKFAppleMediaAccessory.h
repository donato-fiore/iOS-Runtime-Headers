...
@class MKFMediaAccessory, NSData, NSNumber, NSArray, NSSet, NSString, NSUUID, NSDate, HMFPairingIdentity, HMFSoftwareVersion;
...
-(id)_analysisPredicateToFetchBulletinRegistrationOnDeviceIdsIdentifier:(id)arg0 user:(id)arg1 ;
-(id)analysisBulletinRegistrationWithDeviceIdsIdentifier:(id)arg0 user:(id)arg1 context:(id)arg2 ;
