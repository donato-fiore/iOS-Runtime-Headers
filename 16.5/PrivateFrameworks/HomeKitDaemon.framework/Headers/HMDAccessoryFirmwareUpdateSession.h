...
-(void)_updateSoftwareUpdateStateForMatterAccessoryWithState:(NSUInteger)arg0 ;
...
-(void)handleAccessoryFirmwareVersionNumberChangedNotification:(id)arg0 ;
-(void)handleAccessoryVIDPIDChangedNotification:(id)arg0 ;
