...
@class NSString, UIViewController<MCProfileTitlePageViewModelDelegate>, MCProfile, NSData, DMCProfileViewModel;
@protocol DMCRFInteractionClient, MCInteractionDelegate, OS_dispatch_queue;
...
@property (copy, nonatomic) id *postRestoreTask; // ivar: _postRestoreTask
