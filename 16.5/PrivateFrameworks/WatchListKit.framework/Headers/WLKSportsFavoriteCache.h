...
-(void)setCache:(id)arg0 overrideLastModifiedDate:(BOOL)arg1 completion:(id)arg2 ;
-(void)setOptInStatus:(BOOL)arg0 overrideLastModifiedDate:(BOOL)arg1 completion:(id)arg2 ;
