...
+(id)EBSSummaryWithBundleID:(id)arg0 channelID:(id)arg1 externalId:(id)arg2 accountID:(id)arg3 externalProfileID:(id)arg4 timestamp:(id)arg5 playbackState:(NSInteger)arg6 playbackRate:(id)arg7 currentPlaybackDate:(id)arg8 ;
