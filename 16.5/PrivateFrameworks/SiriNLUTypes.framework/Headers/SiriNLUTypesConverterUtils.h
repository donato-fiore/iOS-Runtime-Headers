...
+(id)convertSSUResponseFromCppToObjC:(*void)arg0 ;
...
+(struct unique_ptr<sirinluinternalssu::SSURequest, std::default_delete<sirinluinternalssu::SSURequest>> )convertSSURequestFromObjCToCpp:(id)arg0 ;
