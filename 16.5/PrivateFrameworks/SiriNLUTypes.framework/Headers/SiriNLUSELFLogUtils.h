...
+(id)convertCorrectionOutcome:(id)arg0 ;
...
+(id)createCDMAssetSetupEndedLog:(id)arg0 metadata:(id)arg1 ;
+(id)createCDMAssetSetupFailedLog:(id)arg0 errorDomain:(int)arg1 errorCode:(unsigned int)arg2 metadata:(id)arg3 ;
+(id)createCDMAssetSetupStartedLog:(id)arg0 serviceTypes:(id)arg1 metadata:(id)arg2 ;
+(id)createCDMClientSetupEndedLog:(id)arg0 ;
+(id)createCDMClientSetupFailedLog:(id)arg0 errorDomain:(int)arg1 errorCode:(unsigned int)arg2 ;
...
+(id)createCDMRequestFailedLog:(int)arg0 errorDomainString:(id)arg1 errorCode:(int)arg2 metadata:(id)arg3 ;
...
+(id)createCDMSetupMissingAssetsDetectedLog:(id)arg0 services:(id)arg1 metadata:(id)arg2 ;
+(id)createCDMSingleServiceSetupAttemptEndedLog:(id)arg0 metadata:(id)arg1 ;
+(id)createCDMSingleServiceSetupAttemptFailedLog:(int)arg0 retryNumber:(unsigned int)arg1 reason:(int)arg2 errorCode:(unsigned int)arg3 metadata:(id)arg4 ;
...
+(id)createCdmXpcEventProcessingEndedLog:(id)arg0 metadata:(id)arg1 ;
+(id)createCdmXpcEventProcessingFailedLog:(id)arg0 reason:(int)arg1 errorCode:(unsigned int)arg2 metadata:(id)arg3 ;
+(id)createCdmXpcEventProcessingStartedLog:(id)arg0 processingType:(int)arg1 metadata:(id)arg2 ;
...
+(int)convertCDMCorrectionType:(int)arg0 ;
...
+(int)convertComponentInvocationSource:(int)arg0 ;
+(int)convertLegacyContextSource:(int)arg0 ;
+(int)convertUSOEntityIdentifierNluComponent:(int)arg0 ;
+(int)convertUsoBackingAppBundleType:(id)arg0 ;
+(int)getErrorDomain:(id)arg0 ;
