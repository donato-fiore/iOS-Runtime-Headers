...
@class PSSpecifierDataSource, PSSpecifier, NSString, NDOManager, NSMutableArray;
...
@property (retain, nonatomic) PSSpecifier *coverageSpecifier; // ivar: _coverageSpecifier
...
@property (retain, nonatomic) NSMutableArray *ndoSpecifiers; // ivar: _ndoSpecifiers
@property (retain, nonatomic) NSString *serialNumber; // ivar: _serialNumber
@property (readonly) Class superclass;
@property (retain, nonatomic) PSSpecifier *warrantyGroupSpecifier; // ivar: _warrantyGroupSpecifier


-(id)acController;
-(id)deviceDescriptionSpecifierWithDeviceInfo:(id)arg0 ;
-(id)initWithDefaultDevice:(BOOL)arg0 ;
