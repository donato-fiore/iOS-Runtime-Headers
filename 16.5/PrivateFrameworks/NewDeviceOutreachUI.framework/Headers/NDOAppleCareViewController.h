...
@class UIViewController, UIStackView, UIButton, NSString, UILabel, NDODeviceInfo, NSLayoutConstraint, UINavigationBar, UINavigationItem;
...
-(id)initWithDeviceInfo:(id)arg0 presentationType:(NSUInteger)arg1 source:(id)arg2 deeplinkParams:(id)arg3 ;
