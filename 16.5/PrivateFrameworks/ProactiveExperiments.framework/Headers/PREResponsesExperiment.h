...
+(id)_getConversationHistoryFromRequest:(id)arg0 ;
+(id)_getFormattedPREResponseItems:(id)arg0 inputPreferences:(id)arg1 ;
+(id)_inputMethodStringFrom:(int)arg0 ;
+(id)_rawStringsForMessages:(id)arg0 excludingTapBacks:(BOOL)arg1 ;
+(id)_suggestionsWithDynamicResponseItems:(id)arg0 cannedResponseItems:(id)arg1 inputPreferences:(id)arg2 ;
+(id)sharedManager;
+(id)stringArrayFromPreResponseItems:(id)arg0 ;
+(int)_preInputMethodFrom:(id)arg0 ;
...
-(void)suggestionsForRequest:(id)arg0 withCompletion:(id)arg1 ;
