...
@property (copy, nonatomic) NSArray *installedSources; // ivar: _installedSources
@property (nonatomic) BOOL uninstalledSourcesExist; // ivar: _uninstalledSourcesExist


-(NSUInteger)numberOfRows;
-(id)_sourceCellForRow:(NSUInteger)arg0 tableView:(id)arg1 ;
-(id)_uninstalledSourcesCellWithTableView:(id)arg0 ;
