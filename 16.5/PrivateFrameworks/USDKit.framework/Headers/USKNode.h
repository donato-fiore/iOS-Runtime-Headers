...
-(NSUInteger)hash;
-(id)childIterator;
-(id)createUniqueGeomSubset:(id)arg0 elementType:(id)arg1 indices:(id)arg2 familyName:(id)arg3 familyType:(id)arg4 ;
...
-(id)getGeomSubsets:(id)arg0 familyName:(id)arg1 ;
