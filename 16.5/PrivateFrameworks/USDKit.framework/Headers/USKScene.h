...
@interface USKScene : USKObject {
    TfRefPtr<pxrInternal_v0_21__aapl__pxrReserved__::UsdStage> _usdStage;
    NSURL *_fileURL;
}
...
+(id)newSceneWithData:(id)arg0 name:(id)arg1 ;
+(id)newSceneWithData:(id)arg0 name:(id)arg1 error:(*id)arg2 ;
...
-(id)initWithData:(id)arg0 name:(id)arg1 error:(*id)arg2 ;
-(id)initWithUsdStage:(struct TfRefPtr<pxrInternal_v0_21__aapl__pxrReserved__::UsdStage> )arg0 fileURL:(id)arg1 ;
...
-(id)subLayerOffsets;
-(id)subLayerPaths;
-(struct TfRefPtr<pxrInternal_v0_21__aapl__pxrReserved__::UsdStage> )usdStage;
