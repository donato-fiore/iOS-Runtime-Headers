...
-(void)_client_coordinatorDidCompleteSuccessfullyWithUUID:(id)arg0 forRecordPromise:(id)arg1 ;
-(void)_client_coordinatorDidInstallPlaceholderWithUUID:(id)arg0 forRecordPromise:(id)arg1 ;
-(void)_client_coordinatorDidRegisterForObservationWithUUID:(id)arg0 ;
-(void)_client_coordinatorShouldBeginPostProcessingWithUUID:(id)arg0 forRecordPromise:(id)arg1 ;
