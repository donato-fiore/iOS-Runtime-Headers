...
@property (nonatomic) BOOL lsRequiresPostProcessing; // ivar: _lsRequiresPostProcessing
...
@property (copy, nonatomic) NSDictionary *webKitPushBundleMetadata; // ivar: _webKitPushBundleMetadata
