...
+(BOOL)testReturnEarlyDemoteAppToPlaceholderWithApplicationIdentity:(id)arg0 forReason:(NSUInteger)arg1 error:(*id)arg2 ;
...
+(void)_demoteAppToPlaceholderWithApplicationIdentity:(id)arg0 forReason:(NSUInteger)arg1 waitForDeletion:(BOOL)arg2 ignoreRemovability:(BOOL)arg3 returnEarlyForTesting:(BOOL)arg4 completion:(id)arg5 ;
...
-(BOOL)getHasEssentialAssetPromises:(*BOOL)arg0 error:(*id)arg1 ;
-(BOOL)getNeedsPostProcessing:(*BOOL)arg0 error:(*id)arg1 ;
-(BOOL)getPostProcessingShouldBegin:(*BOOL)arg0 error:(*id)arg1 ;
...
-(BOOL)setEssentialAssetPromises:(id)arg0 error:(*id)arg1 ;
...
-(BOOL)setNeedsPostProcessing:(BOOL)arg0 error:(*id)arg1 ;
...
-(BOOL)setProgressHint:(id)arg0 withError:(*id)arg1 ;
...
-(id)essentialAssetPromisesWithError:(*id)arg0 ;
...
-(id)progressHintWithError:(*id)arg0 ;
...
-(void)_clientDelegate_shouldBeginPostProcessingForApplicationRecord:(id)arg0 ;
