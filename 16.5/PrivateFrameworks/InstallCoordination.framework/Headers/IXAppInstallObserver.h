...
-(void)_client_coordinatorDidCompleteSuccessfullyWithSeed:(id)arg0 forRecordPromise:(id)arg1 ;
-(void)_client_coordinatorDidInstallPlaceholderWithSeed:(id)arg0 forRecordPromise:(id)arg1 ;
-(void)_client_coordinatorShouldBeginPostProcessingWithSeed:(id)arg0 forRecordPromise:(id)arg1 ;
...
-(void)_client_shouldPrioritizeAppWithIdentity:(id)arg0 ;
-(void)_internalInit;
-(void)dealloc;
