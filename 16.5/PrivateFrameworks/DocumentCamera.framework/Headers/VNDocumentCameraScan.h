...
#ifndef VNDOCUMENTCAMERASCAN_H
#define VNDOCUMENTCAMERASCAN_H
...
-(id)infoCollectionWithImageCache:(id)arg0 error:(*id)arg1 ;
-(id)initWithArchivedData:(id)arg0 error:(*id)arg1 ;
