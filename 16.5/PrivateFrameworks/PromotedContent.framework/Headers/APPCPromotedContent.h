...
@protocol APPCPromotableContent, APPCPromotableContentRepresentation, APPCPromotableContext, APPCDiagnosticMetricsHelping, APPCMediaMetricsHelping, APPCMetricEventsTracking, APPCCarouselMetricsHelping><APPCJourneyMetricsHelping;
...
@property (nonatomic) BOOL discardedDueToPolicy; // ivar: discardedDueToPolicy
...
@property (nonatomic, readonly) NSInteger feedMetadataContentProviderID;
@property (nonatomic, copy) NSString *identifier;
@property (nonatomic) CGFloat impressionThreshold; // ivar: impressionThreshold
@property (nonatomic, retain) APInstallAttribution *installAttribution; // ivar: installAttribution
@property (nonatomic, readonly) BOOL isLocationAvailableForAd; // ivar: isLocationAvailableForAd
@property (nonatomic, readonly) BOOL isMRAID;
@property (nonatomic, readonly) BOOL isOutstreamVideoAd;
@property (nonatomic, readonly) BOOL isPAAvailableForAd; // ivar: isPAAvailableForAd
...
@property (nonatomic, retain) NSObject<APPCMetricEventsTracking> *metricEventsTracking; // ivar: metricEventsTracking
...
@property (nonatomic, readonly) NSInteger numOfArticlesSinceInterstitial;
...
-(NSUInteger)retrieveNetworkType;
-(id)init;
