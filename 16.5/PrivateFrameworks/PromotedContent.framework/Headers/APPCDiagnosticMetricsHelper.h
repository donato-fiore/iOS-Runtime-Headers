...
@property (nonatomic) NSUInteger networkType; // ivar: networkType


-(id)init;
-(id)initWithContextIdentifier:(id)arg0 promotedContentIdentifier:(id)arg1 primitiveCreator:(id)arg2 notificationOwner:(id)arg3 metricEventsTracking:(id)arg4 ;
