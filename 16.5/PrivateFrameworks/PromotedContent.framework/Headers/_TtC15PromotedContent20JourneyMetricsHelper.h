...
@interface _TtC15PromotedContent20JourneyMetricsHelper : NSObject <APPCJourneyMetricsHelping, APPCMetricRegister>

 {
    ...
    ? placedProperties;
    ? eventCount;
    ? quickReturnVoiceOverDisabledDurationInMilliseconds;
    ? quickReturnVoiceOverEnabledDurationInMilliseconds;
    ? quickReturnConfigVersion;
    ? unfairLock;
...
@property (nonatomic) CGFloat impressionThresholdDuration; // ivar: impressionThresholdDuration
...
-(void)createdWithAdType:(NSInteger)arg0 container:(NSInteger)arg1 ;
-(void)createdWithAdType:(NSInteger)arg0 container:(NSInteger)arg1 format:(NSInteger)arg2 ;
-(void)dealloc;
-(void)delivered;
...
-(void)placedWithPlacementType:(NSInteger)arg0 placement:(NSInteger)arg1 unfilledReason:(NSInteger)arg2 ;
-(void)placedWithPlacementType:(NSInteger)arg0 placement:(NSInteger)arg1 wasNativeSlot:(BOOL)arg2 ;
-(void)ready;
...
-(void)userReturnedFromInteractionWithIsVoiceOverEnabled:(BOOL)arg0 ;
-(void)userReturnedFromInteractionWithIsVoiceOverEnabled:(BOOL)arg0 ignoreVisibilityState:(BOOL)arg1 ;
