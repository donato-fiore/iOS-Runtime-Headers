...
@property (nonatomic) float recenterAfterDriftDurationThreshold; // ivar: recenterAfterDriftDurationThreshold
@property (nonatomic) BOOL recenterAfterDriftEnabled; // ivar: recenterAfterDriftEnabled
@property (nonatomic) float recenterAfterDriftOffsetThreshold; // ivar: recenterAfterDriftOffsetThreshold
...
@property (nonatomic) float subjectMovementTolerance; // ivar: subjectMovementTolerance
...
@property (nonatomic) float viewportScaleMultiplierLandscape; // ivar: viewportScaleMultiplierLandscape
@property (nonatomic) float viewportScaleMultiplierPortrait; // ivar: viewportScaleMultiplierPortrait
