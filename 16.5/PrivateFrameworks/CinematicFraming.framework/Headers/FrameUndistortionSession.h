...
-(int)_cachedTexturesFromPixelBuffer:(struct __CVBuffer *)arg0 textures:(struct ? *)arg1 ;
...
-(int)_getTransformShaderParameters:(NSUInteger)arg0 pipelineIndexToUse:(*int)arg1 ;
