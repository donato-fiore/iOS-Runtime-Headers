...
-(void)_setShaderParametersForRotationNormalizedDisplayRect:(struct CGRect )arg0 outputROI:(struct CGRect )arg1 calibrationParameters:(struct ? )arg2 commandEncoder:(id)arg3 ;
