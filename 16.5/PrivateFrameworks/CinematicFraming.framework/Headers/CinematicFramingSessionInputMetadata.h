...
@property (nonatomic) float additionalCameraRotation; // ivar: _additionalCameraRotation
...
-(id)initWithDetectedObjectsInfo:(id)arg0 calibrationData:(id)arg1 timestamp:(struct ? )arg2 aspectRatio:(float)arg3 sensorID:(int)arg4 ;
