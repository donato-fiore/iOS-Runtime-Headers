...
#ifndef TRIPBINT64ENUMDICTIONARY_H
#define TRIPBINT64ENUMDICTIONARY_H
...
-(BOOL)getEnum:(*int)arg0 forKey:(NSInteger)arg1 ;
-(BOOL)getRawValue:(*int)arg0 forKey:(NSInteger)arg1 ;
...
-(id)initWithValidationFunction:(*unk)arg0 rawValues:(*int)arg1 forKeys:(*NSInteger)arg2 count:(NSUInteger)arg3 ;
...
-(void)removeAll;
-(void)removeEnumForKey:(NSInteger)arg0 ;
-(void)setEnum:(int)arg0 forKey:(NSInteger)arg1 ;
-(void)setRawValue:(int)arg0 forKey:(NSInteger)arg1 ;
