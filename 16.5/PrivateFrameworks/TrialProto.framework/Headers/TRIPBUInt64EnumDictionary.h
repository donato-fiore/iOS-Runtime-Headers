...
#ifndef TRIPBUINT64ENUMDICTIONARY_H
#define TRIPBUINT64ENUMDICTIONARY_H
...
-(BOOL)getEnum:(*int)arg0 forKey:(NSUInteger)arg1 ;
-(BOOL)getRawValue:(*int)arg0 forKey:(NSUInteger)arg1 ;
...
-(id)initWithValidationFunction:(*unk)arg0 rawValues:(*int)arg1 forKeys:(*NSUInteger)arg2 count:(NSUInteger)arg3 ;
...
-(void)removeAll;
-(void)removeEnumForKey:(NSUInteger)arg0 ;
-(void)setEnum:(int)arg0 forKey:(NSUInteger)arg1 ;
-(void)setRawValue:(int)arg0 forKey:(NSUInteger)arg1 ;
