...
#ifndef TRIPBINT32ENUMDICTIONARY_H
#define TRIPBINT32ENUMDICTIONARY_H
...
-(BOOL)getEnum:(*int)arg0 forKey:(int)arg1 ;
-(BOOL)getRawValue:(*int)arg0 forKey:(int)arg1 ;
...
-(id)initWithValidationFunction:(*unk)arg0 rawValues:(*int)arg1 forKeys:(*int)arg2 count:(NSUInteger)arg3 ;
...
-(void)removeAll;
-(void)removeEnumForKey:(int)arg0 ;
-(void)setEnum:(int)arg0 forKey:(int)arg1 ;
-(void)setRawValue:(int)arg0 forKey:(int)arg1 ;
