...
+(id)createInvalidStatusValueErrorWithKeyPath:(id)arg0 ;
...
+(id)createProfileInvalidErrorWithUnderlyingError:(id)arg0 ;
+(id)createProfilePayloadNotAllowedErrorWithPayloadType:(id)arg0 ;
