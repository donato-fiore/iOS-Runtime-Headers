...
#ifndef RMMODELSTATUSACCOUNTLISTMAILINCOMING_H
#define RMMODELSTATUSACCOUNTLISTMAILINCOMING_H
...
+(id)buildWithIdentifier:(id)arg0 declarationIdentifier:(id)arg1 visibleName:(id)arg2 hostname:(id)arg3 port:(id)arg4 username:(id)arg5 isMailEnabled:(id)arg6 areNotesEnabled:(id)arg7 ;
