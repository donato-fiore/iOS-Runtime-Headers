...
@protocol BBObserverServerInterface, BBObserverClientInterface, OS_dispatch_queue;
...
@property (retain, nonatomic) NSMutableDictionary *bulletinIDsToTransaction; // ivar: _bulletinIDsToTransaction
...
@property (weak, nonatomic) BBServer *server; // ivar: _server


+(id)xpcInterface;
-(NSUInteger)incrementedTransactionIDForBulletinID:(id)arg0 ;
-(id)currentTransactionForBulletinID:(id)arg0 ;
-(id)description;
-(id)initWithServer:(id)arg0 connection:(id)arg1 calloutQueue:(id)arg2 ;
-(id)initWithServer:(id)arg0 connection:(id)arg1 queue:(id)arg2 calloutQueue:(id)arg3 ;
...
-(void)removeTransaction:(id)arg0 ;
-(void)requestNoticesBulletinsForAllSections;
-(void)requestNoticesBulletinsForSectionID:(id)arg0 ;
-(void)setObserverFeed:(NSUInteger)arg0 asLightsAndSirensGateway:(id)arg1 priority:(NSUInteger)arg2 ;
-(void)setObserverFeed:(NSUInteger)arg0 attachToLightsAndSirensGateway:(id)arg1 ;
