...
-(void)blendWarpedResidueForward:(struct __CVBuffer *)arg0 backward:(struct __CVBuffer *)arg1 withGridNetOutput:(struct __CVBuffer *)arg2 timeScale:(float)arg3 destination:(struct __CVBuffer *)arg4 callback:(id)arg5 ;
-(void)encodeAddBottomPaddingToCommandBuffer:(id)arg0 source:(id)arg1 destination:(id)arg2 ;
...
-(void)encodeLayerBlendToCommandBuffer:(id)arg0 forwardResidue:(id)arg1 backwardResidue:(id)arg2 withBaseLayer:(id)arg3 timeScale:(float)arg4 destination:(id)arg5 ;
