...
-(void)encodeBackwarpLossWithFlowMagnitudeToCommandBuffer:(id)arg0 first:(id)arg1 second:(id)arg2 flow:(id)arg3 timeScale:(float)arg4 gamma:(float)arg5 protectionThreshold:(float)arg6 destination:(id)arg7 ;
