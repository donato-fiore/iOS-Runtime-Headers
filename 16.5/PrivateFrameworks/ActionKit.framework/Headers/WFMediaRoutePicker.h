...
@class NSArray, NSString, NSMutableArray, AVAudioSession, MPAVRoutingController;
...
@property (retain, nonatomic) AVAudioSession *routingAudioSession; // ivar: _routingAudioSession
