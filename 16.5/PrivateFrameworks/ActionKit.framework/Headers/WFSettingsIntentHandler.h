...
-(void)handleSetAlwaysOnDisplay:(id)arg0 completion:(id)arg1 ;
-(void)handleSetAnnounceNotifications:(id)arg0 completion:(id)arg1 ;
...
-(void)handleSetNightShift:(id)arg0 completion:(id)arg1 ;
-(void)handleSetOrientationLock:(id)arg0 completion:(id)arg1 ;
-(void)handleSetPersonalHotspot:(id)arg0 completion:(id)arg1 ;
-(void)handleSetSilenceUnknownCallers:(id)arg0 completion:(id)arg1 ;
-(void)handleSetStageManager:(id)arg0 completion:(id)arg1 ;
-(void)handleSetTrueTone:(id)arg0 completion:(id)arg1 ;
...
-(void)resolveOperationForSetAlwaysOnDisplay:(id)arg0 withCompletion:(id)arg1 ;
...
-(void)resolveStateForSetAlwaysOnDisplay:(id)arg0 withCompletion:(id)arg1 ;
