...
#ifndef WFSETANNOUNCENOTIFICATIONSINTENT_H
#define WFSETANNOUNCENOTIFICATIONSINTENT_H
...
@interface WFSetAnnounceNotificationsIntent : INIntent <WFBooleanSettingIntent>
