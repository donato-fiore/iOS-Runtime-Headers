...
#ifndef SIRISHAREDUICONTENTLABEL_H
#define SIRISHAREDUICONTENTLABEL_H

@class UILabel;



@interface SiriSharedUIContentLabel : UILabel
...
+(id)labelWithLightWeightFontSize:(CGFloat)arg0 ;
...
+(id)labelWithThinWeightFontSize:(CGFloat)arg0 ;
