...
-(void)adjustCutawayInputs:(*void)arg0 splitCropRectA:(id)arg1 splitCropRectB:(id)arg2 pipRect:(id)arg3 pipScaleFactor:(id)arg4 renderScale:(float)arg5 pipNeedsCrop:(BOOL)arg6 isHDRRender:(BOOL)arg7 workingColorSpace:(struct CGColorSpace *)arg8 ;
