...
-(BOOL)isSharable;
-(BOOL)isVisible;
-(BOOL)mergeCloudKitRecord:(id)arg0 account:(id)arg1 approach:(NSInteger)arg2 ;
-(BOOL)mergeCloudKitRecord:(id)arg0 accountID:(id)arg1 approach:(NSInteger)arg2 mergeableFieldState:(id)arg3 ;
-(BOOL)mergeCloudKitRecord:(id)arg0 mergePolicy:(NSInteger)arg1 account:(id)arg2 approach:(NSInteger)arg3 mergeableFieldState:(id)arg4 ;
...
-(NSUInteger)performMerge:(id)arg0 ;
...
-(void)addNoteBodyToRecord:(id)arg0 forApproach:(NSInteger)arg1 mergeableFieldState:(id)arg2 ;
...
-(void)endEditing;
-(void)enumerateAbstractAttachmentsInOrderUsingBlock:(id)arg0 ;
...
-(void)mergeTextDataFromRecord:(id)arg0 mergePolicy:(NSInteger)arg1 mergeableFieldState:(id)arg2 ;
