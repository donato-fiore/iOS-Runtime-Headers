...
@class NSString, NSDate, NSManagedObjectID, CKRecordID, NSAttributedString;
...
+(NSUInteger)countOfNonTrashFolderVisibleInlineAttachmentsForHashtagStandardizedContent:(id)arg0 account:(id)arg1 ;
+(NSUInteger)countOfVisibleInlineAttachmentsForHashtagStandardizedContent:(id)arg0 account:(id)arg1 ;
+(NSUInteger)countOfVisibleInlineAttachmentsForHashtagStandardizedContent:(id)arg0 includingTrash:(BOOL)arg1 account:(id)arg2 ;
...
+(id)existingInlineAttachmentWithTokenContentIdentifier:(id)arg0 typeUTI:(id)arg1 context:(id)arg2 ;
...
+(id)predicateForTokenContentIdentifier:(id)arg0 ;
+(id)predicateForTypeUTI:(id)arg0 ;
+(id)predicateForUnsupportedAttachmentsInContext:(id)arg0 ;
+(id)recentlyUsedDatesForHashtagsStandardizedContents:(id)arg0 context:(id)arg1 ;
...
+(void)regenerateTokenContentIdentifierForHashtagAttachmentsInContext:(id)arg0 currentTokenContentIdentifier:(id)arg1 save:(BOOL)arg2 ;
...
-(BOOL)saveToArchive:(*void)arg0 dataPersister:(id)arg1 error:(*id)arg2 ;
...
-(void)writeMergeableFieldStateIfNecessary:(id)arg0 ;
