...
@property (nonatomic) NSUInteger blockQuoteLevel; // ivar: _blockQuoteLevel
...
@property (retain, nonatomic) TTTodo *todo; // ivar: _todo
...
+(NSInteger)textAlignmentForParagraphStyleAlignment:(int)arg0 ;
+(id)defaultParagraphStyle;
+(id)paragraphStyleNamed:(unsigned int)arg0 ;
+(int)paragraphStyleAlignmentForTextAlignment:(NSInteger)arg0 ;
