...
@property (readonly, nonatomic) CGFloat placeholderHeight;
@property (readonly, nonatomic) NSString *placeholderImageSystemName;
@property (readonly, nonatomic) CGFloat placeholderWidth;
...
-(void)mergeMergeableDataFromCloudKitRecord:(id)arg0 approach:(NSInteger)arg1 mergeableFieldState:(id)arg2 ;
