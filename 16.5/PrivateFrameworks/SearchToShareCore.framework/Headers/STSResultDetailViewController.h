...
@class UIViewController, NSURL, NSString, UIImage, SFSearchResult;
...
@property NSUInteger numberOfReportedResults; // ivar: _numberOfReportedResults
...
-(void)detailViewDidTapReportConcern:(id)arg0 ;
