...
@protocol DEDWorkerProtocol, DEDClientProtocol, OS_os_log;
...
-(id)basePayloadForCommand:(id)arg0 ;
-(id)initWithID:(id)arg0 withSFSession:(id)arg1 connection:(id)arg2 ;
...
-(void)compressionProgress:(NSUInteger)arg0 total:(NSUInteger)arg1 sessionID:(id)arg2 ;
...
-(void)uploadProgress:(NSUInteger)arg0 total:(NSUInteger)arg1 sessionID:(id)arg2 ;
