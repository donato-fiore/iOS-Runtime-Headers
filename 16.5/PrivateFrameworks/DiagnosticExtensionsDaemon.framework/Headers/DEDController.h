...
-(void)_timeOutSessionStartBlockWithIdentifier:(id)arg0 targetDevice:(id)arg1 timeout:(CGFloat)arg2 ;
...
// -(void)addSessionStartCompletion:(id)arg0 withIdentifier:(unk)arg1 configuration:(id)arg2 targetDevice:(id)arg3  ;
...
-(void)forceRemoveNotificationOfType:(NSInteger)arg0 identifier:(id)arg1 hostIdentifier:(id)arg2 ;
-(void)hasActiveSessionForIdentifier:(id)arg0 completion:(id)arg1 ;
-(void)idsInbound_devicesChanged:(id)arg0 ;
-(void)idsInbound_devicesChanged:(id)arg0 completion:(id)arg1 ;
...
-(void)xpcInbound_forceRemoveNotificationOfType:(NSInteger)arg0 identifier:(id)arg1 hostIdentifier:(id)arg2 ;
