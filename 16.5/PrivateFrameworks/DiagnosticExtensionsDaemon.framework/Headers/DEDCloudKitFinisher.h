...
@class NSMutableArray, NSString, ELSManager, NSDictionary, NSMutableDictionary;
...
@property (retain, nonatomic) NSDictionary *queuePayload; // ivar: _queuePayload
...
@property (retain, nonatomic) NSString *timberLorryUUID; // ivar: _timberLorryUUID
...
-(id)createAttachmentModelWithURL:(id)arg0 andQueueItem:(id)arg1 attachmentGroupModel:(id)arg2 ;
-(id)encryptFileForAttachmentUrl:(id)arg0 ;
...
-(id)getAttachmentURLsWithProgressHandler:(id)arg0 ;
-(id)initWithCoder:(id)arg0 ;
-(id)initWithConfiguration:(id)arg0 session:(id)arg1 ;
-(id)parsePayloadData:(id)arg0 forIdentifier:(id)arg1 ;
