...
-(void)xpc_addData:(id)arg0 withFilename:(id)arg1 forSession:(id)arg2 ;
...
-(void)xpc_compressionProgress:(NSUInteger)arg0 total:(NSUInteger)arg1 session:(id)arg2 ;
...
-(void)xpc_didLoadTextDataForExtensions:(id)arg0 localization:(id)arg1 sessionID:(id)arg2 ;
...
-(void)xpc_forceRemoveNotificationOfType:(NSInteger)arg0 identifier:(id)arg1 hostIdentifier:(id)arg2 ;
...
-(void)xpc_loadTextDataForExtensions:(id)arg0 localization:(id)arg1 sessionID:(id)arg2 ;
