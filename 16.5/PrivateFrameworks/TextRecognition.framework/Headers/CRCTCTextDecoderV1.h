...
-(BOOL)lmDecodeFeaturesWithInfo:(id)arg0 activationMaps:(id)arg1 imageSize:(struct CGSize )arg2 error:(*id)arg3 ;
...
-(void)maxDecodeFeaturesWithInfo:(id)arg0 activationMaps:(id)arg1 imageSize:(struct CGSize )arg2 ;
