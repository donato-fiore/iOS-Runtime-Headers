...
@property (retain) NSObject<CRSingleTextFeatureFiltering> *japaneseLowConfidenceFilter; // ivar: _japaneseLowConfidenceFilter
@property (retain) NSObject<CRSingleTextFeatureFiltering> *koreanLowConfidenceFilter; // ivar: _koreanLowConfidenceFilter
