...
typedef struct __compressed_pair<unsigned long, std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<CRDisambiguatedScript, std::vector<unsigned long>>, void *> *> *>> {
    NSUInteger field0;
} __compressed_pair<unsigned long, std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<CRDisambiguatedScript, std::vector<unsigned long>>, void *> *> *>>;

typedef struct __bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<CRDisambiguatedScript, std::vector<unsigned long>>, void *> *> *>> {
    __compressed_pair<unsigned long, std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<CRDisambiguatedScript, std::vector<unsigned long>>, void *> *> *>> field0;
} __bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<CRDisambiguatedScript, std::vector<unsigned long>>, void *> *> *>>;

typedef struct __compressed_pair<std::__hash_node_base<std::__hash_node<std::__hash_value_type<CRDisambiguatedScript, std::vector<unsigned long>>, void *> *> **, std::__bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<CRDisambiguatedScript, std::vector<unsigned long>>, void *> *> *>>> {
    void field0;
    __bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<CRDisambiguatedScript, std::vector<unsigned long>>, void *> *> *>> field1;
} __compressed_pair<std::__hash_node_base<std::__hash_node<std::__hash_value_type<CRDisambiguatedScript, std::vector<unsigned long>>, void *> *> **, std::__bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<CRDisambiguatedScript, std::vector<unsigned long>>, void *> *> *>>>;

typedef struct unique_ptr<std::__hash_node_base<std::__hash_node<std::__hash_value_type<CRDisambiguatedScript, std::vector<unsigned long>>, void *> *> *[], std::__bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<CRDisambiguatedScript, std::vector<unsigned long>>, void *> *> *>>> {
    __compressed_pair<std::__hash_node_base<std::__hash_node<std::__hash_value_type<CRDisambiguatedScript, std::vector<unsigned long>>, void *> *> **, std::__bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<CRDisambiguatedScript, std::vector<unsigned long>>, void *> *> *>>> field0;
} unique_ptr<std::__hash_node_base<std::__hash_node<std::__hash_value_type<CRDisambiguatedScript, std::vector<unsigned long>>, void *> *> *[], std::__bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<CRDisambiguatedScript, std::vector<unsigned long>>, void *> *> *>>>;

typedef struct __hash_node_base<std::__hash_node<std::__hash_value_type<CRDisambiguatedScript, std::vector<unsigned long>>, void *> *> {
    void field0;
} __hash_node_base<std::__hash_node<std::__hash_value_type<CRDisambiguatedScript, std::vector<unsigned long>>, void *> *>;

typedef struct __compressed_pair<std::__hash_node_base<std::__hash_node<std::__hash_value_type<CRDisambiguatedScript, std::vector<unsigned long>>, void *> *>, std::allocator<std::__hash_node<std::__hash_value_type<CRDisambiguatedScript, std::vector<unsigned long>>, void *>>> {
    __hash_node_base<std::__hash_node<std::__hash_value_type<CRDisambiguatedScript, std::vector<unsigned long>>, void *> *> field0;
} __compressed_pair<std::__hash_node_base<std::__hash_node<std::__hash_value_type<CRDisambiguatedScript, std::vector<unsigned long>>, void *> *>, std::allocator<std::__hash_node<std::__hash_value_type<CRDisambiguatedScript, std::vector<unsigned long>>, void *>>>;

typedef struct __compressed_pair<unsigned long, std::__unordered_map_hasher<CRDisambiguatedScript, std::__hash_value_type<CRDisambiguatedScript, std::vector<unsigned long>>, std::hash<CRDisambiguatedScript>, std::equal_to<CRDisambiguatedScript>, true>> {
    NSUInteger field0;
} __compressed_pair<unsigned long, std::__unordered_map_hasher<CRDisambiguatedScript, std::__hash_value_type<CRDisambiguatedScript, std::vector<unsigned long>>, std::hash<CRDisambiguatedScript>, std::equal_to<CRDisambiguatedScript>, true>>;

typedef struct __compressed_pair<float, std::__unordered_map_equal<CRDisambiguatedScript, std::__hash_value_type<CRDisambiguatedScript, std::vector<unsigned long>>, std::equal_to<CRDisambiguatedScript>, std::hash<CRDisambiguatedScript>, true>> {
    float field0;
} __compressed_pair<float, std::__unordered_map_equal<CRDisambiguatedScript, std::__hash_value_type<CRDisambiguatedScript, std::vector<unsigned long>>, std::equal_to<CRDisambiguatedScript>, std::hash<CRDisambiguatedScript>, true>>;

typedef struct __hash_table<std::__hash_value_type<CRDisambiguatedScript, std::vector<unsigned long>>, std::__unordered_map_hasher<CRDisambiguatedScript, std::__hash_value_type<CRDisambiguatedScript, std::vector<unsigned long>>, std::hash<CRDisambiguatedScript>, std::equal_to<CRDisambiguatedScript>, true>, std::__unordered_map_equal<CRDisambiguatedScript, std::__hash_value_type<CRDisambiguatedScript, std::vector<unsigned long>>, std::equal_to<CRDisambiguatedScript>, std::hash<CRDisambiguatedScript>, true>, std::allocator<std::__hash_value_type<CRDisambiguatedScript, std::vector<unsigned long>>>> {
    unique_ptr<std::__hash_node_base<std::__hash_node<std::__hash_value_type<CRDisambiguatedScript, std::vector<unsigned long>>, void *> *> *[], std::__bucket_list_deallocator<std::allocator<std::__hash_node_base<std::__hash_node<std::__hash_value_type<CRDisambiguatedScript, std::vector<unsigned long>>, void *> *> *>>> field0;
    __compressed_pair<std::__hash_node_base<std::__hash_node<std::__hash_value_type<CRDisambiguatedScript, std::vector<unsigned long>>, void *> *>, std::allocator<std::__hash_node<std::__hash_value_type<CRDisambiguatedScript, std::vector<unsigned long>>, void *>>> field1;
    __compressed_pair<unsigned long, std::__unordered_map_hasher<CRDisambiguatedScript, std::__hash_value_type<CRDisambiguatedScript, std::vector<unsigned long>>, std::hash<CRDisambiguatedScript>, std::equal_to<CRDisambiguatedScript>, true>> field2;
    __compressed_pair<float, std::__unordered_map_equal<CRDisambiguatedScript, std::__hash_value_type<CRDisambiguatedScript, std::vector<unsigned long>>, std::equal_to<CRDisambiguatedScript>, std::hash<CRDisambiguatedScript>, true>> field3;
} __hash_table<std::__hash_value_type<CRDisambiguatedScript, std::vector<unsigned long>>, std::__unordered_map_hasher<CRDisambiguatedScript, std::__hash_value_type<CRDisambiguatedScript, std::vector<unsigned long>>, std::hash<CRDisambiguatedScript>, std::equal_to<CRDisambiguatedScript>, true>, std::__unordered_map_equal<CRDisambiguatedScript, std::__hash_value_type<CRDisambiguatedScript, std::vector<unsigned long>>, std::equal_to<CRDisambiguatedScript>, std::hash<CRDisambiguatedScript>, true>, std::allocator<std::__hash_value_type<CRDisambiguatedScript, std::vector<unsigned long>>>>;

typedef struct unordered_map<CRDisambiguatedScript, std::vector<unsigned long>, std::hash<CRDisambiguatedScript>, std::equal_to<CRDisambiguatedScript>, std::allocator<std::pair<const CRDisambiguatedScript, std::vector<unsigned long>>>> {
    __hash_table<std::__hash_value_type<CRDisambiguatedScript, std::vector<unsigned long>>, std::__unordered_map_hasher<CRDisambiguatedScript, std::__hash_value_type<CRDisambiguatedScript, std::vector<unsigned long>>, std::hash<CRDisambiguatedScript>, std::equal_to<CRDisambiguatedScript>, true>, std::__unordered_map_equal<CRDisambiguatedScript, std::__hash_value_type<CRDisambiguatedScript, std::vector<unsigned long>>, std::equal_to<CRDisambiguatedScript>, std::hash<CRDisambiguatedScript>, true>, std::allocator<std::__hash_value_type<CRDisambiguatedScript, std::vector<unsigned long>>>> field0;
} unordered_map<CRDisambiguatedScript, std::vector<unsigned long>, std::hash<CRDisambiguatedScript>, std::equal_to<CRDisambiguatedScript>, std::allocator<std::pair<const CRDisambiguatedScript, std::vector<unsigned long>>>>;
