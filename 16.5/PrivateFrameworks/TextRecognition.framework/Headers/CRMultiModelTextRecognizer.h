...
#import "CRTextOrientationCorrector.h"
...
@property (retain) CRTextOrientationCorrector *orientationCorrector; // ivar: _orientationCorrector
@property (retain) CRPerformanceStatistics *orientationStats; // ivar: _orientationStats
