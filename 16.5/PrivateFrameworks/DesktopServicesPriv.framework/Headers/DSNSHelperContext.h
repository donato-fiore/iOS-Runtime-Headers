...
-(BOOL)sizeURL:(id)arg0 destinationURL:(id)arg1 targetName:(id)arg2 coordinate:(BOOL)arg3 spaceNeeds:(struct DestinationSpaceNeeds *)arg4 groupUUID:(id)arg5 error:(*id)arg6 ;
