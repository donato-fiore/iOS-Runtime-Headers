...
@class NSString, CHDelegateController<CHConfigurationDelegate>;
@protocol CHConfiguration, CHKeyValueDataSource;
...
@property (readonly, nonatomic) CHDelegateController<CHConfigurationDelegate> *delegateController; // ivar: _delegateController
