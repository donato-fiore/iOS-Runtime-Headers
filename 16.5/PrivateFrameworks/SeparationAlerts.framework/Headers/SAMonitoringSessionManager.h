...
@property (retain, nonatomic) SAAudioAccessory *audioAccessoryManager; // ivar: _audioAccessoryManager
...
-(BOOL)enoughTimeHasPassedBeforeSurfacingAlert:(id)arg0 forAlertForDevice:(id)arg1 alertType:(NSUInteger)arg2 ;
-(BOOL)isAnyInTrackedInUnsafeLocation;
-(BOOL)isAnyTrackedWhileTraveling;
-(BOOL)isWithinCurrentVisitOrLOI:(id)arg0 ;
-(BOOL)monitoringSessionState:(NSUInteger)arg0 matchesWithScenarioClass:(NSUInteger)arg1 ;
...
-(CGFloat)minimumTimeSinceScenarioTransitionForAlertForDeviceUUID:(id)arg0 alertType:(NSUInteger)arg1 ;
-(CGFloat)timeDelayForRetryScanForAlertForDeviceUUID:(id)arg0 alertType:(NSUInteger)arg1 ;
-(NSInteger)checkInEarStatus:(id)arg0 ;
-(NSInteger)determineTrackedTravelingCount;
-(NSInteger)earlyVehicularTriggerForDeviceUUID:(id)arg0 ;
-(NSUInteger)getMoreSpecificSADeviceType:(id)arg0 ;
...
-(id)initWithWithYouDetector:(id)arg0 fenceRequestServicer:(id)arg1 fenceManager:(id)arg2 travelTypeClassifier:(id)arg3 clock:(id)arg4 deviceRecord:(id)arg5 analytics:(id)arg6 persistenceManager:(id)arg7 audioAccessoryManager:(id)arg8 ;
...
-(void)scheduleNextForceUpdateWithYouStatusFromReferenceDate:(id)arg0 forAlertForDevice:(id)arg1 alertType:(NSUInteger)arg2 ;
