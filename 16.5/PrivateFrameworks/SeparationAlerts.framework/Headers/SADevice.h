...
@property (readonly, nonatomic) BOOL isAppleAudioAccessory; // ivar: _isAppleAudioAccessory
...
-(id)initWithDeviceUUID:(id)arg0 groupIdentifier:(id)arg1 macAddress:(id)arg2 name:(id)arg3 model:(id)arg4 systemVersion:(id)arg5 vendorId:(NSInteger)arg6 productId:(NSInteger)arg7 deviceType:(NSUInteger)arg8 notifyEnabled:(BOOL)arg9 isAppleAudioAccessory:(BOOL)arg10 date:(id)arg11 ;
-(id)initWithDeviceUUID:(id)arg0 groupIdentifier:(id)arg1 macAddress:(id)arg2 partIdentifier:(NSInteger)arg3 name:(id)arg4 model:(id)arg5 systemVersion:(id)arg6 vendorId:(NSInteger)arg7 productId:(NSInteger)arg8 deviceType:(NSUInteger)arg9 notifyEnabled:(BOOL)arg10 isAppleAudioAccessory:(BOOL)arg11 date:(id)arg12 ;
-(id)initWithDeviceUUID:(id)arg0 name:(id)arg1 model:(id)arg2 systemVersion:(id)arg3 vendorId:(NSInteger)arg4 productId:(NSInteger)arg5 deviceType:(NSUInteger)arg6 notifyEnabled:(BOOL)arg7 isAppleAudioAccessory:(BOOL)arg8 date:(id)arg9 ;
