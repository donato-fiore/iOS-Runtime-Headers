...
-(BOOL)_enoughTimeHasPassedSinceInitializationToMarkNotWithYouForDeviceUUID:(id)arg0 ;
...
-(CGFloat)_maxAgeOfWithYouAdvertisementForDeviceUUID:(id)arg0 ;
...
-(void)_updateLastWithYouDateAndLocation:(id)arg0 forCurrentDate:(id)arg1 ;
