...
@protocol SAScenarioClassifierServiceProtocol, SAFenceManagerClientProtocol, SATravelTypeClassifierClientProtocol, SAFenceManagerRequestProtocol, SATimeServiceProtocol;
...
@property (retain, nonatomic) NSObject<SATimeServiceProtocol> *timeDelegate; // ivar: _timeDelegate
