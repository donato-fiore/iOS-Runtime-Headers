...
typedef struct Cache {
    ...
    NSUInteger renderPipelineState;
    NSUInteger <MTLRenderPipelineState>;
    NSUInteger winding;
    NSUInteger cullMode;
    BOOL fillMode;
    BOOL clipMode;
    ...
    unsigned int clipModeChanged;
    unsigned int inverseWinding;
} Cache;

typedef struct BufferAndOffset {
    id buffer;
    NSUInteger <MTLBuffer>;
} BufferAndOffset;

typedef struct BindingsCache {
    BufferAndOffset buffers;
    id textures;
    id <MTLTexture>;
} BindingsCache;
