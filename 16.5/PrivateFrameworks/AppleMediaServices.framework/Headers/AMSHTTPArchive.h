...
+(id)ams_dateFormatterForTimeZone:(id)arg0 ;
+(id)ams_generateCommentsStringForMetrics:(id)arg0 ;
+(id)ams_generateContentDictionaryForResponse:(id)arg0 responseData:(id)arg1 ;
+(id)ams_generateHeadersArrayForHTTPHeaders:(id)arg0 ;
+(id)ams_generateRequestDictionaryForMetrics:(id)arg0 requestData:(id)arg1 ;
+(id)ams_generateResponseDictionaryForMetrics:(id)arg0 responseData:(id)arg1 ;
+(id)directory;
+(id)merge:(id)arg0 ;
