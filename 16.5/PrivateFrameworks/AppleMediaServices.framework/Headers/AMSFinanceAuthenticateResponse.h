...
+(id)_authenticateRequestWithAuthType:(NSUInteger)arg0 taskInfo:(id)arg1 dialogResponse:(id)arg2 serviceIdentifier:(id)arg3 ;
+(id)_handleAuthResult:(id)arg0 authError:(id)arg1 originalRequest:(id)arg2 actionResult:(id)arg3 redirectURL:(id)arg4 taskInfo:(id)arg5 ;
+(id)_performAuthRequest:(id)arg0 actionResult:(id)arg1 redirectURL:(id)arg2 taskInfo:(id)arg3 ;
+(id)_performSyncAuthRequest:(id)arg0 actionResult:(id)arg1 redirectURL:(id)arg2 taskInfo:(id)arg3 ;
+(id)_presentAuthRequest:(id)arg0 taskInfo:(id)arg1 ;
+(id)_serviceIdentifierForResponse:(id)arg0 taskInfo:(id)arg1 ;
