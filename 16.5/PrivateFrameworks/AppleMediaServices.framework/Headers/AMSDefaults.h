...
+(void)setAccountFlagOverrides:(id)arg0 ;
...
+(void)setCleanedUpUserDefaultsDataAfterMigrationToStorage:(BOOL)arg0 ;
...
+(void)setDeviceIsBundleOverride:(BOOL)arg0 ;
+(void)setDeviceOfferEligibility:(id)arg0 ;
+(void)setDeviceRegistrationBlacklist:(id)arg0 ;
+(void)setDidFetchBundleOwnerStatus:(BOOL)arg0 ;
...
+(void)setForwardedForIPAddress:(id)arg0 ;
