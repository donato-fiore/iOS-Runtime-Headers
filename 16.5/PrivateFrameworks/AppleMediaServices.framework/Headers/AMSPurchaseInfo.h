...
@class ACAccount, NSMutableDictionary, NSString, NSDictionary, NSNumber, LAContext, NSURL;
...
@property (weak, nonatomic) NSObject<AMSPurchaseDelegate> *delegate; // ivar: _delegate
@property (retain, nonatomic) NSDictionary *dialog; // ivar: _dialog
@property (retain, nonatomic) NSString *dialogId; // ivar: _dialogId
@property (retain, nonatomic) NSNumber *expressCheckoutMode; // ivar: _expressCheckoutMode
