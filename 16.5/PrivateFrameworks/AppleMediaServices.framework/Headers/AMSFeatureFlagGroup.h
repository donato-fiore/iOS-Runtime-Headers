...
+(BOOL)disableFlagGroupWithName:(id)arg0 error:(*id)arg1 ;
+(BOOL)enableFlagGroupWithName:(id)arg0 error:(*id)arg1 ;
+(BOOL)setFlagGroupWithName:(id)arg0 enabled:(BOOL)arg1 error:(*id)arg2 ;
