...
@property (retain, nonatomic) AMSStoreReviewGatingController *storeReviewGatingController; // ivar: _storeReviewGatingController
...
+(BOOL)_shouldPromptReviewForStoreReviewMetrics:(id)arg0 currentTime:(id)arg1 sessionCount:(NSInteger)arg2 promptInterval:(NSInteger)arg3 ;
