...
@protocol AMSSystemEngagementTaskClientInterface, NSXPCListenerDelegate, SBSRemoteAlertHandleObserver, AMSBagConsumer, AMSBagProtocol, OS_dispatch_group, NSObject;
...
@property (nonatomic) BOOL disablePresentationTarget; // ivar: _disablePresentationTarget
@property (retain, nonatomic) NSObject<OS_dispatch_group> *dispatchGroup; // ivar: _dispatchGroup
@property (retain, nonatomic) NSObject<NSObject> *displayDidBecomeActiveToken; // ivar: _displayDidBecomeActiveToken
@property (retain, nonatomic) FBSDisplayLayoutMonitor *displayLayoutMonitor; // ivar: _displayLayoutMonitor
@property (retain, nonatomic) NSObject<NSObject> *displayWillForegroundToken; // ivar: _displayWillForegroundToken
@property (retain, nonatomic) NSError *error; // ivar: _error
@property (readonly) NSUInteger hash;
@property (retain, nonatomic) RBSProcessHandle *presentationTargetHandle; // ivar: _presentationTargetHandle
...
-(void)_listenForAppForegroundWithHandle:(id)arg0 usesAuditToken:(BOOL)arg1 ;
