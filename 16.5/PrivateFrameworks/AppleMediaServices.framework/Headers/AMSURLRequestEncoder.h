...
@class ACAccount, NSDictionary, NSString, NSArray;
...
@property (copy, nonatomic) AMSURLRequestProperties *parentProperties; // ivar: _parentProperties
@property (nonatomic) BOOL preserveQueryParameterEncoding; // ivar: _preserveQueryParameterEncoding
...
@property (nonatomic) BOOL shouldSetStorefrontHeader; // ivar: _shouldSetStorefrontHeader
