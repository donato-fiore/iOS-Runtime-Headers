...
@property (readonly, copy, nonatomic) STActivityAttribution *callProviderAttribution; // ivar: _callProviderAttribution
...
-(id)initWithCallType:(NSUInteger)arg0 callState:(NSUInteger)arg1 copresenceActivityType:(NSUInteger)arg2 callProviderAttribution:(id)arg3 ;
