...
@property (retain, nonatomic) UIVisualEffectView *messageEditingBlurOverlayView; // ivar: _messageEditingBlurOverlayView
...
@property (retain, nonatomic) UIActivityIndicatorView *sendButtonSpinner; // ivar: _sendButtonSpinner
...
@property (nonatomic) BOOL shouldBlurForMessageEditing; // ivar: _shouldBlurForMessageEditing
...
@property (nonatomic) BOOL shouldShowSendButtonSpinner; // ivar: _shouldShowSendButtonSpinner
@property (nonatomic) BOOL shouldShowSubject; // ivar: _shouldShowSubject
@property (nonatomic) BOOL showAppStrip; // ivar: _showAppStrip
...
+(struct UIEdgeInsets )contentViewInsetsForMarginInsets:(struct UIEdgeInsets )arg0 shouldShowPluginButtons:(BOOL)arg1 shouldShowCharacterCount:(BOOL)arg2 shouldCoverSendButton:(BOOL)arg3 isStewieMode:(BOOL)arg4 ;
+(struct UIEdgeInsets )coverViewInsetsForMarginInsets:(struct UIEdgeInsets )arg0 shouldShowPluginButtons:(BOOL)arg1 shouldShowCharacterCount:(BOOL)arg2 isStewieMode:(BOOL)arg3 ;
+(struct UIEdgeInsets )coverViewInsetsForMarginInsets:(struct UIEdgeInsets )arg0 shouldShowPluginButtons:(BOOL)arg1 shouldShowCharacterCount:(BOOL)arg2 shouldCenterCharacterCount:(*BOOL)arg3 isStewieMode:(BOOL)arg4 ;
...
-(BOOL)_shouldUseDarkAppearanceFromTraitCollection:(id)arg0 ;
...
-(id)initWithFrame:(struct CGRect )arg0 marginInsets:(struct UIEdgeInsets )arg1 shouldAllowImpact:(BOOL)arg2 shouldShowSendButton:(BOOL)arg3 shouldShowSubject:(BOOL)arg4 shouldShowPluginButtons:(BOOL)arg5 shouldShowCharacterCount:(BOOL)arg6 traitCollection:(id)arg7 shouldDisableAttachments:(BOOL)arg8 shouldUseNonEmojiKeyboard:(BOOL)arg9 ;
...
-(void)_keyboardsSettingsChanged:(id)arg0 ;
-(void)_localeChanged;
...
-(void)_updateMentionsLexiconWithItems:(id)arg0 ;
...
-(void)interruptAudioRecorder:(id)arg0 ;
