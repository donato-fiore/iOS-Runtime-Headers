...
@class NSIndexPath, NSString, NSArray, IMChat, UINavigationController, CKTranscriptCompositor, NSMutableSet, UIView<CKGradientReferenceView>, NSIndexSet, UITapGestureRecognizer, CKTranscriptLayoutMessageEditingContext, NSDictionary, UIView, IMStateCaptureAssistant, UIView<CKFullscreenEffectView>;
...
@property (copy, nonatomic) NSIndexSet *hiddenAssociatedItemsForMessageEditing; // ivar: _hiddenAssociatedItemsForMessageEditing
...
@property (nonatomic) CGFloat lastViewWidthUsedToLayoutChatItems; // ivar: _lastViewWidthUsedToLayoutChatItems
...
@property (retain, nonatomic) NSString *mostRecentlyTouchedPlugin; // ivar: _mostRecentlyTouchedPlugin
...
@property (copy, nonatomic) NSIndexSet *poppedBalloonsHiddenUntilNextChatItemUpdate; // ivar: _poppedBalloonsHiddenUntilNextChatItemUpdate
...
+(struct CGSize )defaultCollectionViewSize;
-(BOOL)_allowsEffectAutoPlayback;
-(BOOL)_canShowWhileLocked;
-(BOOL)_canUseOpaqueMask;
-(BOOL)_isHistoryLoadingNeededForDirection:(NSInteger)arg0 withTargetContentOffset:(struct CGPoint )arg1 forKeyboardNavigation:(BOOL)arg2 ;
-(BOOL)_pluginChatItem:(id)arg0 hasControllerConformingToProtocol:(id)arg1 ;
-(BOOL)_selectedChatItemsHaveMultipleSenders:(id)arg0 ;
-(BOOL)_shouldScrollToBottomOrReplyButton:(*BOOL)arg0 insertedUnreadMessage:(BOOL)arg1 insertedLocalUnsentChatItem:(BOOL)arg2 ;
-(BOOL)balloonTextViewIsSelected;
-(BOOL)canRaiseToListen;
-(BOOL)canRaiseToTalk;
-(BOOL)collectionView:(id)arg0 canFocusItemAtIndexPath:(id)arg1 ;
-(BOOL)collectionView:(id)arg0 isSelectableDuringEditModeForItemAtIndexPath:(id)arg1 ;
...
-(BOOL)isLoadMoreSpinnerAboutToBeVisibleForDirection:(NSInteger)arg0 withTargetContentOffset:(struct CGPoint )arg1 ;
-(BOOL)isLoadMoreSpinnerVisibleForDirection:(NSInteger)arg0 ;
-(BOOL)isVisiblePlugin:(id)arg0 ;
-(BOOL)scrollViewShouldScrollToTop:(id)arg0 ;
-(BOOL)shouldEndShowingEditHistoryOnViewDisappearance;
-(BOOL)shouldPresentHawkingPromptForChatItem:(id)arg0 ;
...
-(id)_currentTopChatItemForAggregateChatItem:(id)arg0 ;
-(id)_indexPathOfCellContainingStampButton:(id)arg0 ;
-(id)_insertChatItemsInto:(id)arg0 withIMChatItems:(id)arg1 inserted:(id)arg2 insertedUnreadMessage:(*id)arg3 insertedLocalUnsentChatItem:(*id)arg4 ;
...
-(id)_logChatItems:(id)arg0 withRange:(struct _NSRange )arg1 ;
-(id)_logChatItems:(id)arg0 withUpdates:(id)arg1 ;
-(id)_mediaObjectsForOrganicChatItem:(id)arg0 onIndexPath:(id)arg1 ;
-(id)_nextChatItemOfType:(Class)arg0 afterIndex:(NSInteger)arg1 inChatItems:(id)arg2 ;
-(id)_previousChatItemOfType:(Class)arg0 beforeIndex:(NSInteger)arg1 inChatItems:(id)arg2 ;
-(id)_sanitizeInsertedIndices:(id)arg0 inChatItems:(id)arg1 withIMChatItems:(id)arg2 ;
...
-(id)initWithConversation:(id)arg0 delegate:(id)arg1 balloonMaxWidth:(CGFloat)arg2 marginInsets:(struct UIEdgeInsets )arg3 collectionViewSize:(struct CGSize )arg4 ;
...
-(id)initWithConversation:(id)arg0 delegate:(id)arg1 notifications:(id)arg2 balloonMaxWidth:(CGFloat)arg3 marginInsets:(struct UIEdgeInsets )arg4 collectionViewSize:(struct CGSize )arg5 ;
...
-(id)loadMoreItemIndexPathForDirection:(NSInteger)arg0 ;
...
-(id)newChatItemWithIMChatItem:(id)arg0 traitCollection:(id)arg1 ;
-(id)newChatItemWithNotification:(id)arg0 ;
-(id)newChatItemsWithIMChatItems:(id)arg0 ;
-(id)newChatItemsWithNotifications:(id)arg0 ;
...
-(struct _NSRange )_loggingRangeForUpdates:(id)arg0 chatItemsCount:(NSInteger)arg1 ;
-(void)__raiseGestureRecognized:(id)arg0 ;
-(void)_addAttachmentsToProvidersArray:(id)arg0 forChatItems:(id)arg1 ;
-(void)_animateAssociatedChatItemWithIndices:(id)arg0 ;
-(void)_animateChatItemInsertion:(id)arg0 inserted:(id)arg1 wantsScrollToBottom:(BOOL)arg2 scrollToBottomDuration:(*CGFloat)arg3 ;
-(void)_animateChatItemReload:(id)arg0 reload:(id)arg1 associatedInserted:(id)arg2 ;
-(void)_animateChatItemRemoval:(id)arg0 removed:(id)arg1 ;
-(void)_blockHandle:(id)arg0 ;
...
-(void)_dismissMoreHelpView:(id)arg0 ;
...
-(void)_handleAudioBalloonTapForIndexPath:(id)arg0 ;
-(void)_handleCommSafetyMessageSomeoneStatusButtonTappedForIndexPath:(id)arg0 ;
-(void)_handleCommSafetySensitiveReceiveStatusButtonTappedForIndexPath:(id)arg0 ;
-(void)_handleEditHistoryButtonTappedForIndexPath:(id)arg0 ;
-(void)_handleFailedEditStatusButtonTappedForIndexPath:(id)arg0 ;
-(void)_handlePluginBreadcrumbingInChatItems:(id)arg0 withIMChatItems:(id)arg1 inserted:(*id)arg2 removed:(*id)arg3 completion:(id)arg4 ;
-(void)_handleTapOnMessageRetractionChatItem:(id)arg0 ;
-(void)_hideBalloonViewIfNecessaryForCell:(id)arg0 indexPath:(id)arg1 ;
-(void)_highlightCell:(id)arg0 autoDismiss:(BOOL)arg1 ;
-(void)_identifyIndicesNeedingCustomAnimationsForIMChatItems:(id)arg0 inserted:(id)arg1 removed:(id)arg2 ;
...
-(void)_loadMessagesIfNeededWithTargetContentOffset:(struct CGPoint )arg0 forKeyboardNavigation:(BOOL)arg1 ;
-(void)_logVisibleChatItems;
-(void)_messageParents;
-(void)_presentEditedMessageResendConfirmationAlertForMessage:(id)arg0 ;
...
-(void)_presentRetractedMessageResendConfirmationAlertForIMChatItem:(id)arg0 ;
-(void)_prewarmBalloonControllers;
-(void)_prewarmMediaPreviews;
-(void)_prewarmTranscriptAssetsIfNecessary;
-(void)_quickActionPinButtonWasTapped:(id)arg0 atIndexPath:(id)arg1 chatItem:(id)arg2 ;
-(void)_quickActionSaveButtonWasTapped:(id)arg0 atIndexPath:(id)arg1 chatItem:(id)arg2 ;
-(void)_refreshLocationsForRecipientsIfNecessary;
-(void)_regenerateChatItemsIn:(id)arg0 withIMChatItems:(id)arg1 regenerate:(id)arg2 shouldShowBlackholeAlert:(*BOOL)arg3 ;
-(void)_releaseActiveBalloonControllers;
-(void)_removeChatItemsFrom:(id)arg0 removed:(id)arg1 ;
-(void)_replayLastImpactEffectIfNotFromMe;
-(void)_requestChatItemLayoutInvalidation;
-(void)_resendEditedMessageForChatItem:(id)arg0 ;
-(void)_resendFailedMessages;
-(void)_resendMessageAtIndexPath:(id)arg0 ;
-(void)_resendMessageRetractionForChatItem:(id)arg0 ;
...
-(void)_showAutoDonationAlert:(id)arg0 forAppName:(id)arg1 bundleID:(id)arg2 ;
-(void)_showBlockContactSelectionAlertFromView:(id)arg0 ;
-(void)_showLeaveConversationFromView:(id)arg0 ;
-(void)_showMoreHelp;
...
-(void)_updateAudioControllerForInserted:(id)arg0 chatItems:(id)arg1 ;
-(void)_updateCollectionViewForChatItems:(id)arg0 oldChatItems:(id)arg1 inserted:(id)arg2 removed:(id)arg3 associatedInserted:(*id)arg4 associatedRemoved:(*id)arg5 completion:(id)arg6 ;
...
-(void)_updateTranscriptChatItems:(id)arg0 inserted:(id)arg1 removed:(id)arg2 reload:(id)arg3 regenerate:(id)arg4 animated:(BOOL)arg5 completion:(id)arg6 ;
-(void)_updateTranscriptChatItemsWithAnimation:(id)arg0 withIMChatItems:(id)arg1 oldChatItems:(id)arg2 insertedChatItems:(id)arg3 inserted:(id)arg4 removed:(id)arg5 reload:(id)arg6 wantsScrollToBottom:(BOOL)arg7 scrollToBottomDuration:(*CGFloat)arg8 completion:(id)arg9 ;
-(void)_updateTranscriptChatItemsWithoutAnimation:(id)arg0 ;
...
-(void)deleteChatItems:(id)arg0 sender:(id)arg1 ;
-(void)deleteConversationPressedInTranscriptCell:(id)arg0 ;
...
-(void)fetchEarlierMessagesForConversation:(id)arg0 ;
-(void)fetchRecentMessagesForConversation:(id)arg0 ;
...
-(void)interactionStartedWithPluginBalloonView:(id)arg0 ;
-(void)interactionStoppedFromPreviewItemControllerInBalloonView:(id)arg0 ;
-(void)invalidateChatItemLayoutWithNewBalloonMaxWidth:(CGFloat)arg0 marginInsets:(struct UIEdgeInsets )arg1 traitCollection:(id)arg2 ;
...
-(void)presentHawkingPromptForChatItem:(id)arg0 ;
...
-(void)recoverJunkPressedInTranscriptCell:(id)arg0 ;
-(void)reloadChatItemsAtIndexes:(id)arg0 animated:(BOOL)arg1 ;
-(void)reloadChatItemsAtIndexes:(id)arg0 animated:(BOOL)arg1 completion:(id)arg2 ;
-(void)reloadData;
...
-(void)scrollToBottomAnimated:(BOOL)arg0 withDuration:(CGFloat)arg1 insertedUnreadMessage:(id)arg2 insertedLocalUnsentChatItem:(id)arg3 wantsScrollToReplyButton:(BOOL)arg4 withCompletion:(id)arg5 ;
...
-(void)showGridForChatItem:(id)arg0 ;
...
-(void)startSuppressingSoundsForBulletinMessagesFromNotifications:(id)arg0 ;
-(void)stopFullscreenEffect;
-(void)stopPlayingAudio;
-(void)stopPluginPlayback;
-(void)stopSuppressingSoundsForBulletinMessagesWithChatItems:(id)arg0 ;
-(void)touchUpInsideCellBlockContactButton:(id)arg0 ;
...
-(void)touchUpInsideCellStampButton:(id)arg0 ;
