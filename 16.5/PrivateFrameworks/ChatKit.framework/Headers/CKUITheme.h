...
@class UIColor, UIImage, CNContactStyle, NSArray;
...
@property (readonly, nonatomic) UIColor *conversationListCellPreviewBackgroundColor; // ivar: _conversationListCellPreviewBackgroundColor
...
-(NSInteger)toFieldBackdropStyle;
-(char)applyPayCashSendButtonColorForEntryViewStyle:(NSInteger)arg0 ;
-(char)ckAcknowledgementColorTypeForColor:(id)arg0 ;
...
-(id)messageAcknowledgmentSelectedBalloonColorForStyle:(NSInteger)arg0 serviceName:(id)arg1 ;
