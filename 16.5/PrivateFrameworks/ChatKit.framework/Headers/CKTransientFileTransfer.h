...
@property (readonly, nonatomic) BOOL isScreenshot; // ivar: isScreenshot
@property (readonly, nonatomic) BOOL isSticker; // ivar: isSticker
@property (readonly, nonatomic, getter=isRejected) BOOL rejected; // ivar: rejected
@property (readonly, nonatomic, getter=isRestoring) BOOL restoring; // ivar: restoring
@property (readonly, copy, nonatomic) NSURL *shareURL; // ivar: shareURL
