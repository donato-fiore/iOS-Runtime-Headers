...
@class UIScrollView, NSDictionary, UIButton, NSArray, _SWCollaborationShareOptions, NSString, UIImpactFeedbackGenerator, UIFont, UIView, UIViewController<CKPluginEntryViewController>, IMPluginPayload;
@protocol UITextViewDelegate, CKMessageEntryRichTextViewDelegate, IMBalloonPluginDataSourceDelegate, UITextDragDelegate, CKMessageEntryViewStyleProtocol, UIGestureRecognizerDelegate;
...
+(id)_createTextView:(BOOL)arg0 shouldUseNonEmojiKeyboard:(BOOL)arg1 ;
+(void)configureMessageBodyEntryTextView:(id)arg0 shouldUseNonEmojiKeyboard:(BOOL)arg1 ;
...
-(id)initWithFrame:(struct CGRect )arg0 shouldShowSubject:(BOOL)arg1 shouldDisableAttachments:(BOOL)arg2 shouldUseNonEmojiKeyboard:(BOOL)arg3 ;
...
-(void)_provideHapticFeedbackIfNecessaryForText:(id)arg0 ;
-(void)_updateUI;
-(void)acceptAutocorrection;
-(void)balloonPluginDataSource:(id)arg0 shouldSendAsCopy:(BOOL)arg1 ;
...
-(void)setupShelfPluginPayload:(id)arg0 ;
