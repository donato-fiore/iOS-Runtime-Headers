...
@protocol UIGestureRecognizerDelegate, _UIViewBoundingPathChangeObserver, CKDetailsContactsManagerDelegate, CKNavigationBarCanvasViewDelegate, CKNavBarUnifiedCallButtonDelegate, CKAvatarPickerViewControllerDelegate, CKNavbarCanvasViewControllerDelegate;
...
@property (nonatomic) BOOL previousUsesMinSafeAreas; // ivar: _previousUsesMinSafeAreas
...
-(void)updateTitleViewAnimated:(BOOL)arg0 ;
