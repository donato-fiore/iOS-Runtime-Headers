...
#ifndef CKCOMMUNICATIONSAFETYEDUSCREENONE_H
#define CKCOMMUNICATIONSAFETYEDUSCREENONE_H
...
-(id)initFirstReceivingEDUScreenWithItemIndexPath:(id)arg0 ;
-(id)initFirstSendingEDUScreenWithComposition:(id)arg0 withSensitiveMediaObjects:(id)arg1 withIdentifiersOfShelvedImages:(id)arg2 ;
