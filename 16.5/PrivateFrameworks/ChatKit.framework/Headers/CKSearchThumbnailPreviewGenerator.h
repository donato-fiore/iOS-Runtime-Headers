...
@property (retain, nonatomic) NSMutableSet *keysWithInFlightLPWalletItemPropertiesMetadataGeneration; // ivar: _keysWithInFlightLPWalletItemPropertiesMetadataGeneration
...
@property (retain, nonatomic) NSCache *lpWalletItemPropertiesMetadataCache; // ivar: _lpWalletItemPropertiesMetadataCache
...
-(BOOL)hasCachedWalletItemLinkPropertiesForQueryResult:(id)arg0 ;
...
-(id)cachedWalletItemLinkPropertiesForQueryResult:(id)arg0 ;
-(id)init;
