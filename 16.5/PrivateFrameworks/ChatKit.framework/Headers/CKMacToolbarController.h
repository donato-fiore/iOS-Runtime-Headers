...
@protocol CKMacToolbarViewDelegate, CKMacToolbarDelegate, CKMacToolbarItemProvider;
...
@property (weak, nonatomic) NSObject<CKMacToolbarDelegate> *delegate; // ivar: _delegate
