...
@property (retain, nonatomic) UIBarButtonItem *editOscarButtonItem; // ivar: _editOscarButtonItem
...
@property (retain, nonatomic) CKConversationListCellLayout *junkCellLayout; // ivar: _junkCellLayout
...
@property (retain, nonatomic) UIBarButtonItem *permanentDeleteAllJunkButtonItem; // ivar: _permanentDeleteAllJunkButtonItem
@property (retain, nonatomic) UIBarButtonItem *permanentDeleteSelectedButtonItem; // ivar: _permanentDeleteSelectedButtonItem
@property (retain, nonatomic) UIBarButtonItem *permanentDeleteSelectedJunkButtonItem; // ivar: _permanentDeleteSelectedJunkButtonItem
...
@property (retain, nonatomic) CKConversationListCellLayout *standardCellLayout; // ivar: _standardCellLayout
...
-(NSInteger)_alertControllerStyle;
...
-(NSUInteger)_sanitizedFilterModeForFilterUnknownDisabled:(NSUInteger)arg0 ;
-(NSUInteger)_sanitizedFilterModeForFilterUnknownEnabled:(NSUInteger)arg0 ;
...
-(id)_permanentDeleteJunkAction:(id)arg0 ;
-(id)_permanentDeleteRecentlyDeletedAction:(id)arg0 ;
-(id)_permanentDeletebuttonToUseForSelectedConversations:(BOOL)arg0 ;
-(id)_permanentDeletebuttonToUseForSelectedJunkConversations:(BOOL)arg0 ;
...
-(id)_recoverRecentlyDeletedAction:(id)arg0 ;
-(id)_removeFromJunkAction:(id)arg0 ;
...
-(id)junkConversationMenu:(id)arg0 ;
...
-(id)recentlyDeletedConversationMenu:(id)arg0 ;
...
-(id)toolbarItems;
-(id)toolbarItemsForJunkFilterHasConversations:(BOOL)arg0 hasSelectedConversations:(BOOL)arg1 ;
...
-(void)_configureAvatarViewInConversationCell:(id)arg0 forItemIdentifier:(id)arg1 ;
-(void)_configureCatalystFiltersNavigation;
-(void)_configureForFilterMode:(NSUInteger)arg0 ;
-(void)_configureInteractiveAvatarInConversationCell:(id)arg0 forItemIdentifier:(id)arg1 ;
...
-(void)_configureSecondarySubMenuInParentMenuItems:(id)arg0 ;
...
-(void)_permanentDeleteAllJunkButtonTapped:(id)arg0 ;
-(void)_permanentDeleteSelectedButtonTapped:(id)arg0 ;
-(void)_permanentDeleteSelectedConversations;
-(void)_permanentDeleteSelectedJunkButtonTapped:(id)arg0 ;
...
-(void)_updateForCurrentEditingStateAnimated:(BOOL)arg0 ;
-(void)_updateInsets;
...
-(void)configureSearchBarEnabled:(BOOL)arg0 animated:(BOOL)arg1 ;
...
-(void)oscarViewWillAppear:(BOOL)arg0 ;
...
-(void)presentJunkConversationRecoveryConfirmation:(id)arg0 ;
-(void)presentPermanentJunkConversationDeletionConfirmation:(id)arg0 ;
// -(void)presentPermanentJunkConversationDeletionConfirmation:(id)arg0 alertsCompletedBlock:(id)arg1 cancelBlock:(unk)arg2  ;
