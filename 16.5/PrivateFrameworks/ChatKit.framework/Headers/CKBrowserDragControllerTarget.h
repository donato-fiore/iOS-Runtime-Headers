...
@property (nonatomic) CGPoint screenCoordinate; // ivar: _screenCoordinate


+(id)targetWithScreenCoordinate:(struct CGPoint )arg0 initialSize:(struct CGSize )arg1 scale:(CGFloat)arg2 meshScaleFactor:(CGFloat)arg3 rotation:(CGFloat)arg4 associatedLayoutIntent:(NSUInteger)arg5 ;
-(id)description;
