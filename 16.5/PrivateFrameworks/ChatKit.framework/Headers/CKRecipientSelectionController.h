...
@class CNContactPickerViewController, CNContactStore, CoreTelephonyClient, STConversationContext, NSString, UIView, CNComposeRecipient, NSMutableDictionary, UILabel, UIScrollView;
...
@property (retain, nonatomic) UIView *headerDecorationView; // ivar: _headerDecorationView
...
@property (nonatomic) CGFloat keyboardHeightWithAccessoryView; // ivar: _keyboardHeightWithAccessoryView
...
-(NSInteger)_userInterfaceStyleOverride;
...
-(struct UIEdgeInsets )_additionalSearchResultsEdgeInsets;
