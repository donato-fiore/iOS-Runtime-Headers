...
@class UICollectionViewCompositionalLayout, CADisplayLink, NSArray, NSString, IMScheduledUpdater, NSMutableDictionary, NSIndexSet, NSMutableIndexSet;
...
@property (nonatomic) *_UIUpdateSequenceItemInternal dynamicsUpdateSequenceItem; // ivar: _dynamicsUpdateSequenceItem
...
-(void)_updateAssociatedAttributeFramesForPrimaryAttribute:(id)arg0 ;
-(void)_updateAttributeZIndex:(id)arg0 forEffect:(id)arg1 ;
