...
+(CGFloat)_daysSinceDate:(id)arg0 ;
+(CGFloat)_intervalSinceDate:(id)arg0 ;
+(NSUInteger)daysUntilJunkFilterDeletionForDate:(id)arg0 ;
+(NSUInteger)daysUntilRecentlyDeletedDeletionForDate:(id)arg0 ;
...
+(id)localizedStewieString:(id)arg0 ;
