...
@class STStoragePlugin, NSArray, NSDate, STStorageOptionTip, STStorageActionTip, IMCloudKitHooks, NSString, PSSpecifier, IMMessageDirectoryContents, IMDirectoryContentsSizes, NSDictionary;
@protocol STStorageOptionTipDelegate, OS_dispatch_queue;
...
@property (readonly, nonatomic) PSSpecifier *initialAppSpecifier; // ivar: _initialAppSpecifier
