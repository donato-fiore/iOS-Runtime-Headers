...
@protocol CAAnimationDelegate, CKPopRendererViewDelegate, CKImpactEffectAnimationProvider, CKSendAnimationManager, OS_dispatch_group;
...
@property (copy, nonatomic) id *popAnimationCompletionBlock; // ivar: _popAnimationCompletionBlock
@property (readonly) Class superclass;
@property (retain, nonatomic) NSObject<OS_dispatch_group> *throwAnimationGroup; // ivar: _throwAnimationGroup


-(CGFloat)_throwAnimationDurationScaleFactorForThrownBalloonAttributes:(id)arg0 finalBalloonFrames:(id)arg1 ;
...
-(void)_beginPopAnimationWithContext:(id)arg0 ;
...
-(void)popRendererViewDidBegin:(id)arg0 ;
-(void)popRendererViewDidFinish:(id)arg0 ;
-(void)popRendererViewPlaySound:(id)arg0 ;
