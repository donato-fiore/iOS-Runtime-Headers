...
@property (readonly) CGFloat impressionVisibilityThreshold; // ivar: _impressionVisibilityThreshold
...
@property (nonatomic) BOOL isPAAvailableForAd; // ivar: _isPAAvailableForAd
...
@property (readonly) NSInteger pricingModel;
...
+(id)createForServerUnfilledReason:(NSInteger)arg0 placementType:(NSInteger)arg1 contextIdentifier:(id)arg2 ;
+(id)createForServerUnfilledReason:(NSInteger)arg0 placementType:(NSInteger)arg1 contextIdentifier:(id)arg2 size:(struct ? )arg3 ;
