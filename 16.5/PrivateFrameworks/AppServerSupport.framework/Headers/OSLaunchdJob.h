...
-(id)_newCreateInstanceRequest:(unsigned char)arg0 properties:(id)arg1 ;
-(id)_newRequest;
-(id)_newSubmitRequest;
-(id)createInstance:(unsigned char)arg0 error:(*id)arg1 ;
-(id)createInstance:(unsigned char)arg0 properties:(id)arg1 error:(*id)arg2 ;
-(id)description;
...
// -(void)setupMonitorOnQueue:(id)arg0 withHandler:(id)arg1 reply:(unk)arg2  ;
