...
@class NSHashTable, CoreTelephonyClient, NSArray, RadiosPreferences, CTStewieStateMonitor, CTStewieState, NSString;
@protocol BSDebugDescriptionProviding, CoreTelephonyClientDelegate, CoreTelephonyClientRegistrationDelegate, CoreTelephonyClientSubscriberDelegate, CoreTelephonyClientDataDelegate, CoreTelephonyClientCarrierBundleDelegate, CoreTelephonyClientSuppServicesDelegate, RadiosPreferencesDelegate, CTStewieStateMonitorDelegate, BSInvalidatable, OS_dispatch_queue;
