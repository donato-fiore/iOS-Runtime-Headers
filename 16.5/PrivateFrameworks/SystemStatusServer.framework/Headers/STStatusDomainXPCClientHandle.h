...
@class NSXPCConnection, BSMutableIntegerMap, NSSet, NSMutableSet, NSArray, NSString;
...
@property (copy, nonatomic) NSArray *cachedPreferredLocalizations; // ivar: _cachedPreferredLocalizations
