...
+(CGFloat)clampedQuality:(CGFloat)arg0 ;
...
+(id)addEncodingQuality:(CGFloat)arg0 toConfiguration:(id)arg1 ;
...
+(id)colorHEVCEncoderConfigWithQuality:(CGFloat)arg0 ;
+(id)colorHEVCLosslessEncoderConfig;
+(id)colorRecordingConfigBitDepth:(NSUInteger)arg0 bitrate:(NSUInteger)arg1 chromaSampling:(NSInteger)arg2 error:(*id)arg3 ;
+(id)colorRecordingConfigBitDepth:(NSUInteger)arg0 chromaSampling:(NSInteger)arg1 error:(*id)arg2 ;
+(id)colorRecordingConfigBitDepth:(NSUInteger)arg0 lossless:(BOOL)arg1 chromaSampling:(NSInteger)arg2 error:(*id)arg3 ;
+(id)colorRecordingConfigBitDepth:(NSUInteger)arg0 quality:(CGFloat)arg1 chromaSampling:(NSInteger)arg2 error:(*id)arg3 ;
...
+(id)monochrome10bitHEVCEncoderConfigWithQuality:(CGFloat)arg0 ;
...
+(id)monochrome8bitHEVCEncoderConfigWithQuality:(CGFloat)arg0 ;
...
+(struct opaqueCMFormatDescription *)createFormatDescriptionFromPixelBuffer:(struct __CVBuffer *)arg0 ;
