...
+(id)histogramOf8BitBuffer:(struct __CVBuffer *)arg0 ;
+(id)rangesOf8BitBuffer:(struct __CVBuffer *)arg0 ;
...
+(struct __CVBuffer *)newPixelBufferRefCopy:(struct __CVBuffer *)arg0 attachmentKeysToCopy:(id)arg1 ;
