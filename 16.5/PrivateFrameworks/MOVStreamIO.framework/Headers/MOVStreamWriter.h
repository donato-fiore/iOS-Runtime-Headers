...
@protocol VideoEncoderInterfaceDelegate, MOVStreamWriterStateContext, MOVStreamWriterDeprecated, MOVStreamWriterDeprecationNominates, OS_dispatch_queue, MOVStreamCustomEncoderConfigDelegate, MOVStreamWriterDelegate, MOVStreamWriterState;
...
@property ? movieFragmentInterval; // ivar: _movieFragmentInterval
@property ? sessionStartTime; // ivar: _sessionStartTime
...
-(BOOL)isCustomTrackMetadataCompatibleObject:(id)arg0 ;
...
-(id)getTrackMetadataForExactBytesPerRow:(id)arg0 fromMap:(*void)arg1 error:(*id)arg2 ;
...
-(struct ? )timeWithSeconds:(CGFloat)arg0 ;
