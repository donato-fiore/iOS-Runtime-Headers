...
@class WFEmbeddableActionUserInterface, AVCapturePhotoOutput, NSString, WFContentCollection, NSMutableArray, AVCaptureSession;
...
@property (weak, nonatomic) AVCapturePhotoOutput *captureOutput; // ivar: _captureOutput
...
-(void)addImageDataToOutput:(id)arg0 type:(id)arg1 ;
-(void)cameraIsReady:(id)arg0 ;
