...
@property (retain, nonatomic) _ANEModel *model; // ivar: _model
...
-(BOOL)mapIOSurfacesWithRequest:(id)arg0 cacheInference:(BOOL)arg1 error:(*id)arg2 ;
...
-(void)unmapIOSurfacesWithRequest:(id)arg0 ;
