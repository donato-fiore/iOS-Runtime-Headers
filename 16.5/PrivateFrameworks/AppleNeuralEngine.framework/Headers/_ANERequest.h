...
@property (copy, nonatomic) NSNumber *transactionHandle; // ivar: _transactionHandle
...
+(id)requestWithInputs:(id)arg0 inputIndices:(id)arg1 outputs:(id)arg2 outputIndices:(id)arg3 weightsBuffer:(id)arg4 perfStats:(id)arg5 procedureIndex:(id)arg6 sharedEvents:(id)arg7 transactionHandle:(id)arg8 ;
...
-(BOOL)validate;
-(NSUInteger)ioSurfacesCount;
-(id)description;
-(id)initWithInputs:(id)arg0 inputIndices:(id)arg1 outputs:(id)arg2 outputIndices:(id)arg3 weightsBuffer:(id)arg4 perfStats:(id)arg5 procedureIndex:(id)arg6 sharedEvents:(id)arg7 transactionHandle:(id)arg8 ;
-(id)initWithVirtualModel:(*void)arg0 ;
