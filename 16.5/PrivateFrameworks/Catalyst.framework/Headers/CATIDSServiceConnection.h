...
+(id)connectionWithMetadata:(id)arg0 configuration:(id)arg1 IDSPrimitives:(id)arg2 messageBroadcaster:(id)arg3 timerSource:(id)arg4 dataMessageQueue:(id)arg5 dataAggregator:(id)arg6 assertion:(id)arg7 workQueue:(id)arg8 delegateQueue:(id)arg9 destinationAddress:(id)arg10 sourceAppleID:(id)arg11 ;
+(id)connectionWithMetadata:(id)arg0 configuration:(id)arg1 capabilities:(id)arg2 IDSPrimitives:(id)arg3 messageBroadcaster:(id)arg4 timerSource:(id)arg5 assertion:(id)arg6 workQueue:(id)arg7 delegateQueue:(id)arg8 destinationAddress:(id)arg9 sourceAppleID:(id)arg10 ;
+(id)keepAliveContent;
+(id)keepAliveTimerIdentifier;
-(id)description;
-(id)initWithMetadata:(id)arg0 configuration:(id)arg1 IDSPrimitives:(id)arg2 messageBroadcaster:(id)arg3 timerSource:(id)arg4 dataMessageQueue:(id)arg5 dataAggregator:(id)arg6 assertion:(id)arg7 workQueue:(id)arg8 delegateQueue:(id)arg9 destinationAddress:(id)arg10 sourceAppleID:(id)arg11 ;
