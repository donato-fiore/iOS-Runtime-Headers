...
-(id)initWithKeySystem:(id)arg0 keySession:(id)arg1 contentKeyBoss:(struct CMBaseObject *)arg2 useContentKeyBoss:(BOOL)arg3 groupID:(NSInteger)arg4 storageDirectoryAtURL:(id)arg5 ;
