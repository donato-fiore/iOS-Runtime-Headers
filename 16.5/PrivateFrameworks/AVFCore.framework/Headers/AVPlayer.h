...
-(BOOL)_setRate:(float)arg0 rateChangeReason:(int)arg1 figPlayerSetRateHandler:(id)arg2 ;
...
-(struct OpaqueFigPlayerInterstitialCoordinator *)_copyInterstitialEventCoordinatorEnsuringItIsRemote:(BOOL)arg0 forceCreate:(BOOL)arg1 ;
...
-(void)_addListenersToInterstitialCoordinator:(struct OpaqueFigPlayerInterstitialCoordinator *)arg0 ;
...
-(void)_linkAndSyncAudioSessionWithInterstitialPlayer:(id)arg0 ;
...
-(void)_overlappedPlaybackWillBeginForItem:(id)arg0 withID:(NSInteger)arg1 ;
...
-(void)_removeListenersFromInterstitialCoordinator:(struct OpaqueFigPlayerInterstitialCoordinator *)arg0 ;
-(void)_removePropertyObserversOfCurrentItemCalledOnStateDispatchQueueChecked:(id)arg0 ;
...
-(void)_setInterstitialEventCoordinator:(struct OpaqueFigPlayerInterstitialCoordinator *)arg0 ;
-(void)_setInterstitialEventCoordinator_invokeOnIvarAccessQueue:(struct OpaqueFigPlayerInterstitialCoordinator *)arg0 ;
-(void)_setInterstitialPlayer:(id)arg0 ;
-(void)_setInterstitialPlayerGuts_invokeOnIvarAccessQueue:(id)arg0 ;
...
-(void)_setOptions:(id)arg0 onClosedCaptionLayer:(id)arg1 ;
...
-(void)_setPrimaryPlayerNameForInterstitial:(id)arg0 ;
-(void)_setRate:(float)arg0 withVolumeRampDuration:(struct ? )arg1 playImmediately:(BOOL)arg2 rateChangeReason:(int)arg3 affectsCoordinatedPlayback:(BOOL)arg4 ;
-(void)_setRateDidChangeNotificationIncludesExtendedDiagnosticPayload:(BOOL)arg0 ;
-(void)_setSeparated:(BOOL)arg0 onClosedCaptionLayer:(id)arg1 ;
...
-(void)setDefaultRate:(float)arg0 ;
...
-(void)setRate:(float)arg0 time:(struct ? )arg1 atHostTime:(struct ? )arg2 options:(id)arg3 ;
