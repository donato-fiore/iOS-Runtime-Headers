...
+(id)contentKeySessionWithLegacyWebKitCompatibilityModeAndKeySystem:(id)arg0 storageDirectoryAtURL:(id)arg1 ;
...
-(?)copyCryptorForFormatDescription:(?)arg0 cryptorOuterrorOut;
-(?)createAndInstallCustomURLHandlerForAssetoutHandler;
-(BOOL)_makeContentKeyGroupWithIDOut:(*NSInteger)arg0 error:(*id)arg1 ;
-(BOOL)clientCanReceivePersistableContentKeyRequest;
-(BOOL)hasProtector;
-(NSInteger)_processContentKeyRequestWithIdentifier:(id)arg0 encryptionMode:(int)arg1 supportedProtocolVersions:(id)arg2 groupID:(NSInteger)arg3 error:(*id)arg4 ;
-(NSInteger)_renewKeyWithIdentifier:(id)arg0 encryptionMode:(int)arg1 error:(*id)arg2 ;
-(NSInteger)defaultGroupID;
...
-(id)initWithKeySystem:(id)arg0 storageDirectoryAtURL:(id)arg1 legacyWebKitCompatibilityMode:(BOOL)arg2 ;
-(id)initWithStorageDirectoryAtURL:(id)arg0 ;
-(id)issueContentKeyRequestForInitializationData:(id)arg0 ;
-(id)keyRequestByID:(NSInteger)arg0 ;
...
-(void)_processContentKeyRequestWithIdentifier:(id)arg0 initializationData:(id)arg1 options:(id)arg2 groupID:(NSInteger)arg3 ;
...
-(void)contentKeyRequestDidSucceedWithBoss:(struct CMBaseObject *)arg0 keySpecifier:(struct FigContentKeySpecifier *)arg1 requestID:(NSInteger)arg2 cryptor:(struct OpaqueFigCPECryptor *)arg3 ;
-(void)dealloc;
-(void)didProvideKeyRequestWithBoss:(struct CMBaseObject *)arg0 keySpecifier:(struct FigContentKeySpecifier *)arg1 requestID:(NSInteger)arg2 renewalRequest:(BOOL)arg3 ;
-(void)expire;
-(void)externalProtectionStateChangedCallbackWithBoss:(struct CMBaseObject *)arg0 keySpecifier:(struct FigContentKeySpecifier *)arg1 ;
...
-(void)issuePersistableContentKeyRequestForKeySpecifier:(struct FigContentKeySpecifier *)arg0 initializationData:(id)arg1 keyIDFromInitializationData:(id)arg2 contentIdentifier:(id)arg3 requestID:(NSInteger)arg4 preloadingRequestOptions:(id)arg5 identifier:(id)arg6 ;
...
-(void)processContentKeyRequestForPSSHEntries:(id)arg0 initializationData:(id)arg1 groupID:(NSInteger)arg2 options:(id)arg3 ;
-(void)processContentKeyRequestForSinf:(id)arg0 initializationData:(id)arg1 groupID:(NSInteger)arg2 options:(id)arg3 ;
-(void)processContentKeyRequestForTransportStreamWithCodecType:(id)arg0 initializationData:(id)arg1 groupID:(NSInteger)arg2 options:(id)arg3 ;
...
-(void)removeResourcesForID:(NSInteger)arg0 ;
-(void)renewExpiringResponseDataForContentKeyRequest:(id)arg0 ;
-(void)trackRequest:(id)arg0 byRequestID:(NSInteger)arg1 ;
