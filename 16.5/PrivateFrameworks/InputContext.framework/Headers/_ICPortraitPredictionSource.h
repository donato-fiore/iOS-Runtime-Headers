...
@property (retain) PPQuickTypeBroker *ppBroker; // ivar: _ppBroker
...
-(id)_quickTypeQueryWithQuery:(id)arg0 limit:(NSUInteger)arg1 timeoutInMilliseconds:(NSUInteger)arg2 ;
