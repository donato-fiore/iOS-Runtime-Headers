...
-(id)_processAttributeSpecialCases:(NSUInteger)arg0 uiElement:(id)arg1 error:(*NSUInteger)arg2 client:(NSUInteger)arg3 ;
-(id)_processAttributeSpecialCases:(NSUInteger)arg0 uiElement:(id)arg1 parameter:(id)arg2 error:(*NSUInteger)arg3 client:(NSUInteger)arg4 ;
...
-(id)_processBrailleOverrideForAttributeRequest:(id)arg0 error:(*NSUInteger)arg1 attribute:(NSUInteger)arg2 ;
...
-(id)_processIndexForTextMarkerAttributeRequest:(id)arg0 parameter:(id)arg1 error:(*NSUInteger)arg2 ;
...
-(id)_processValueAttributeRequest:(id)arg0 error:(*NSUInteger)arg1 axpAttribute:(NSUInteger)arg2 useAttributes:(BOOL)arg3 ;
