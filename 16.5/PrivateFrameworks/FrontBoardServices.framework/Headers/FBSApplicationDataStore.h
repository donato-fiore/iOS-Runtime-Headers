...
-(id)deserializeObjectForKey:(id)arg0 ofType:(Class)arg1 ;
-(id)init;
...
-(void)dealloc;
-(void)deserializeObjectForKey:(id)arg0 ofType:(Class)arg1 withResult:(id)arg2 ;
...
-(void)serializeObject:(id)arg0 forKey:(id)arg1 ;
