...
@class NSMutableArray, NSOrderedSet, NSString, BSAuditToken;
...
-(id)_initWithUpdater:(id)arg0 identityToken:(id)arg1 identity:(id)arg2 specification:(id)arg3 settings:(id)arg4 initialClientSettings:(id)arg5 ;
-(id)callOutQueue;
-(id)clientProcess;
-(id)contexts;
-(id)counterpartAgent;
