...
@class CADisplay, NSHashTable, NSMapTable, NSSet, NSString, NSArray;
@protocol BSInvalidatable, FBSDisplayObserving, OS_dispatch_queue, FBSDisplayTransformer;
...
@property (readonly, nonatomic) NSObject<FBSDisplayTransformer> *transformer; // ivar: _transformer


-(BOOL)allowsUnknownDisplays;
-(id)_initWithBookendObserver:(id)arg0 transformer:(id)arg1 ;
-(id)_sortedSources;
...
-(void)_updateTransformsWithCompletion:(id)arg0 ;
