...
+(id)atLeastOneHomePodHasLanguageSettingsForHomeFuture:(id)arg0 ;
...
+(id)home:(id)arg0 onboardHomeHub2FromPresentingViewController:(id)arg1 devices:(id)arg2 usageOptions:(id)arg3 ;
...
+(void)_initializeSiriLanguageOptionsManagerIfNecessaryForHomePods:(id)arg0 ;
