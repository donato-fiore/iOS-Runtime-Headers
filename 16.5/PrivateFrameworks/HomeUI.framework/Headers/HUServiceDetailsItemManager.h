...
@class HFItemManager, HFAccessoryInfoDetailsItemProvider, HFItem, HFStaticItemProvider, NSArray, HFAssociatedServiceTypeOptionItemProvider, HFItem<HFItemBuilderItem>, NSString, HFAccessorySettingDeviceOptionsAdapter, HFAccessorySettingDeviceOptionsAdapterUtility, HFItemProvider, HMHomeManager, ACAccount, HMHome, HFSelectedRoomItemProvider, HFRemoteControlItemModule, HFItemBuilder<HFServiceLikeBuilder>, HMAccessorySettingsController, HMAccessory, HFItem<HFServiceLikeItem>;
...
@property (retain, nonatomic) HFStaticItemProvider *accessoryResetAndRemoveItemProvider; // ivar: _accessoryResetAndRemoveItemProvider
...
@property (retain, nonatomic) HUServiceDetailsCameraNightModeItem *cameraNightModeItem; // ivar: _cameraNightModeItem
...
@property (retain, nonatomic) HUServiceDetailsCameraStatusLightItem *cameraStatusLightItem; // ivar: _cameraStatusLightItem
...
@property (retain, nonatomic) HFItem *exportDiagnosticsItem; // ivar: _exportDiagnosticsItem
@property (retain, nonatomic) HFStaticItemProvider *exportDiagnosticsItemProvider; // ivar: _exportDiagnosticsItemProvider
...
@property (retain, nonatomic) HFItem *identifyHomePodItem; // ivar: _identifyHomePodItem
...
-(BOOL)shouldShowExportDiagnosticsItem:(id)arg0 ;
