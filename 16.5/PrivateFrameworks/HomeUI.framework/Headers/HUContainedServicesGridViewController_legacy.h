...
@protocol HUPresentationDelegate, HUServiceGridItemManagerDelegate, HUDetailsPresentationDelegateHost, HUContainedServiceGridViewControllerDelegate_legacy;
...
@property (weak, nonatomic) NSObject<HUContainedServiceGridViewControllerDelegate_legacy> *serviceGridDelegate; // ivar: _serviceGridDelegate
@property (readonly) Class superclass;


+(id)itemManagerWithServiceContainerItem:(id)arg0 mediaItem:(id)arg1 valueSource:(id)arg2 ;
