...
@class HFItemModule, NSSet, NSString, UIViewController, HFStaticItemProvider;
@protocol HUCameraSettingsModule;


#import "HUCameraCloudStorageSettingsModule.h"
#import "HUCameraRecordAudioSettingsItem.h"
...
@property (retain, nonatomic) HUCameraRecordAudioSettingsItem *recordAudioItem; // ivar: _recordAudioItem
