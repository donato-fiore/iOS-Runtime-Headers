...
@class UIViewController, NSArray, NSString, MKPointAnnotation, UIView, HMHome, MKLocalSearch, GEOLocationShifter, MKMapView, UISearchBar, NSIndexPath, UITableView;
@protocol UISearchBarDelegate, UITableViewDelegate, UITableViewDataSource, MKMapViewDelegatePrivate, HFLocationManagerObserver, HULocationTriggerEditorMapDragRadiusViewDelegate, HUPreloadableViewController, HULocationTriggerRegionEditorViewControllerDelegate;
...
@property (retain, nonatomic) MKPointAnnotation *desiredAddressAnnotation; // ivar: _desiredAddressAnnotation
...
@property (nonatomic) CGFloat radiusInPoints; // ivar: _radiusInPoints
...
-(void)_setupMap;
-(void)_showMapRegionForCoordinate:(struct CLLocationCoordinate2D )arg0 radius:(CGFloat)arg1 animated:(BOOL)arg2 ;
-(void)_updateRecentsWithSearchText:(id)arg0 ;
-(void)_updateUI;
-(void)_updateUIWithRegion:(id)arg0 ;
-(void)loadView;
-(void)mapRadiusView:(id)arg0 radiusDidChange:(CGFloat)arg1 radiusInPoints:(CGFloat)arg2 ;
