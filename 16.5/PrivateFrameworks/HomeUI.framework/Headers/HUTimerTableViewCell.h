...
@class UITableViewCell, UILayoutGuide, NSString, UIStackView, MTTimer, COTimerManager, UILabel;
...
-(id)initWithMobileTimerObject:(id)arg0 manager:(id)arg1 roomName:(id)arg2 ;
