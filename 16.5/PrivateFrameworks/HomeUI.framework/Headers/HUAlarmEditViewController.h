...
@class UIViewController, NSMutableDictionary, NSDateComponents, NSString, MTMutableAlarm, HFPlaybackArchive, MTAlarm, NSSet, HMRoom, UITapGestureRecognizer;
@protocol UITableViewDataSource, UITableViewDelegate, HUAlarmEditSettingViewControllerDelegate, HUSwitchCellDelegate, HUSliderValueTableViewCellDelegate, HUInlineDatePickerCellDelegate, UIGestureRecognizerDelegate, UIScrollViewDelegate, MPMediaPickerControllerDelegatePrivate, HUMediaSourceListDelegate, HUAlarmEditViewControllerDelegate, HFMediaProfileContainer;
