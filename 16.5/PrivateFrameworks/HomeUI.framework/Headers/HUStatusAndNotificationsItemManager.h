...
@class HFItemManager, HFStaticItem, HUChimeOnHomePodSingleItem, HFUserNotificationServiceSettings, HMHome, HFItem<HFServiceLikeItem>;
@protocol HFUserNotificationServiceSettingsProviding;


#import "HUServiceDetailsCameraAllowSnapshotsItem.h"
#import "HUAudioAnalysisDetectionSettingsModule.h"
#import "HUCameraSmartDetectionSettingsModule.h"
#import "HUChimeOnAccessoriesListItem.h"
...
@property (retain, nonatomic) HFStaticItem *allowAudioNotificationsItem; // ivar: _allowAudioNotificationsItem
...
@property (retain, nonatomic) HUServiceDetailsCameraAllowSnapshotsItem *allowCameraSnapshotsItem; // ivar: _allowCameraSnapshotsItem
...
@property (readonly, nonatomic) HUAudioAnalysisDetectionSettingsModule *audioAnalysisDetectionSettingsModule; // ivar: _audioAnalysisDetectionSettingsModule
...
@property (retain, nonatomic) HUChimeOnAccessoriesListItem *chimeOnAccessoriesListItem; // ivar: _chimeOnAccessoriesListItem
@property (readonly, nonatomic) HUChimeOnHomePodSingleItem *chimeOnHomePodSingleItem; // ivar: _chimeOnHomePodSingleItem
...
@property (nonatomic) BOOL showsAudioNotificationSection; // ivar: _showsAudioNotificationSection
...
-(id)_updateConditionCollectionForAudioAnalysisNotification:(id)arg0 ;
-(id)_updateNotificationSettings:(id)arg0 ;
-(id)_updateNotificationSettings:(id)arg0 notificationSettingsProvider:(id)arg1 ;
...
-(id)updateAllowAudioNotifications:(BOOL)arg0 ;
