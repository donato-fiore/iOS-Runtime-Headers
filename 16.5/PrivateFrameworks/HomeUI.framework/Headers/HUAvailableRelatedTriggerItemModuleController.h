...
@class UIActivityIndicatorView, NAFuture, NSString, UIViewController;
...
#import "_TriggerEditorDelegateWrapper.h"
...
@property (retain, nonatomic) _TriggerEditorDelegateWrapper *presentedViewControllerDelegateWrapper; // ivar: _presentedViewControllerDelegateWrapper
...
-(void)updatePresentedViewControllerForNewModuleController:(id)arg0 ;
