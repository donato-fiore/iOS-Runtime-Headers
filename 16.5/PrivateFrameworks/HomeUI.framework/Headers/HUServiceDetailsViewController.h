...
@class NAFuture, UIButton, NSString, NSHashTable, HMHome, HFItem<HFServiceLikeItem>, UILongPressGestureRecognizer, NSMapTable, HFNamingComponents, NSMutableSet;
...
@property (retain, nonatomic) NAFuture *homePodIdentifyFuture; // ivar: _homePodIdentifyFuture
@property (nonatomic) NSInteger inProgressExportDiagnosticsIndex; // ivar: _inProgressExportDiagnosticsIndex
...
@property (retain, nonatomic) NSMutableSet *registeredButtonFutures; // ivar: _registeredButtonFutures
...
-(id)_roomUpdateBuilderFor:(id)arg0 ;
...
-(void)_exportDiagnosticsForItem:(id)arg0 ;
...
-(void)dealloc;
-(void)didRemoveCHIPPairingforAccessory:(id)arg0 ;
