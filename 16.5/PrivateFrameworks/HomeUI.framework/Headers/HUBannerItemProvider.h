...
#import "HUHomeHubMigrationBannerItem.h"
...
@property (readonly, nonatomic) HUHomeHubMigrationBannerItem *homeHubMigrationBannerItem; // ivar: _homeHubMigrationBannerItem
