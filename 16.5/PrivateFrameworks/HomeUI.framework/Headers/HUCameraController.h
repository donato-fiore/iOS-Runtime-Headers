...
@class NSLayoutConstraint, UIAlertController, NAUILayoutConstraintSet, HFCameraItem, UIButton, UILabel, NSString, AVQueuePlayer, HFItem, HFItemManager, HFCameraAnalyticsCameraPlayerLaunchEvent, NSTimer, UIView, AVPlayerLooper, HFNetworkMonitor, AVHomeLoadingButtonControlItem, HFCameraPlaybackEngine, AVPlayerViewController, UICollectionView, NAFuture, NSArray, AVPlayerLayer;
@protocol AVPlayerViewControllerDelegate, AVPlayerViewControllerDelegatePrivate, HFCameraPlaybackEngineObserver, HFItemManagerDelegate, HUCameraPlayerAVBehaviorDelegate, HUPresentationDelegate, HFExecutionEnvironmentObserver, HUItemPresentationContainer, HUPresentationDelegateHost, OS_dispatch_queue, HUCameraControllerDelegate;
...
@property (retain, nonatomic) NSObject<OS_dispatch_queue> *audioSessionQueue; // ivar: _audioSessionQueue
...
@property (retain, nonatomic) HFNetworkMonitor *networkMonitor; // ivar: _networkMonitor
...
@property (nonatomic) NSUInteger pipState; // ivar: _pipState
...
-(void)_finishDisplayingTimelineForClip:(id)arg0 ;
-(void)_refreshClipCacheAndRefetchForClipUUID:(id)arg0 ;
