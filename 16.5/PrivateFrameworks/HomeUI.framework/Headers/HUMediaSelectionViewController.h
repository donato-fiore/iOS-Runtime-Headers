...
@class NSString;
@protocol MPMediaPickerControllerDelegatePrivate, HUMediaSourceListDelegate, HUSwitchCellDelegate, HUSliderValueTableViewCellDelegate, HUMediaSelectionViewControllerDelegate;
