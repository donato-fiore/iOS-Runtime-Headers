...
@property (retain, nonatomic) NSNumber *brailleAlerts; // ivar: _brailleAlerts
@property (retain, nonatomic) NSNumber *brailleAutoAdvanceDuration; // ivar: _brailleAutoAdvanceDuration
@property (retain, nonatomic) NSNumber *brailleFormatting; // ivar: _brailleFormatting
...
@property (retain, nonatomic) NSNumber *navigationStyle; // ivar: _navigationStyle
...
@property (retain, nonatomic) NSNumber *typingStyle; // ivar: _typingStyle
