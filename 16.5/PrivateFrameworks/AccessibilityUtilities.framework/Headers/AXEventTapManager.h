...
-(id)_hidFilterListForPair:(id)arg0 wantsDigitizerEvents:(BOOL)arg1 wantsKeyboardEvents:(BOOL)arg2 wantsATVRemoteEvents:(BOOL)arg3 wantsLisaEvents:(BOOL)arg4 wantsMouseEvents:(BOOL)arg5 wantsAccessibilityEvents:(BOOL)arg6 wantsStylusEvents:(BOOL)arg7 ;
-(id)description;
-(id)init;
...
// -(id)installEventTap:(id)arg0 identifier:(unk)arg1 type:(id)arg2 skipDeviceMatching:(int)arg3 wantsDigitizerEvents:(BOOL)arg4 wantsKeyboardEvents:(BOOL)arg5 wantsATVRemoteEvents:(BOOL)arg6 wantsLisaEvents:(BOOL)arg7 wantsMouseEvents:(BOOL)arg8 wantsAccessibilityEvents:(BOOL)arg9 wantsStylusEvents:(BOOL)arg10  ;
// -(id)installEventTap:(id)arg0 identifier:(unk)arg1 type:(id)arg2 skipDeviceMatching:(int)arg3 wantsDigitizerEvents:(BOOL)arg4 wantsKeyboardEvents:(BOOL)arg5 wantsATVRemoteEvents:(BOOL)arg6 wantsLisaEvents:(BOOL)arg7 wantsMouseEvents:(BOOL)arg8 wantsAccessibilityEvents:(BOOL)arg9 wantsStylusEvents:(BOOL)arg10 matchingServiceHandler:(BOOL)arg11  ;
...
-(void)_installEventTap:(id)arg0 skipDeviceMatching:(BOOL)arg1 wantsDigitizerEvents:(BOOL)arg2 wantsKeyboardEvents:(BOOL)arg3 wantsATVRemoteEvents:(BOOL)arg4 wantsLisaEvents:(BOOL)arg5 wantsMouseEvents:(BOOL)arg6 wantsAccessibilityEvents:(BOOL)arg7 wantsStylusEvents:(BOOL)arg8 ;
-(void)_installHIDFilter:(id)arg0 skipDeviceMatching:(BOOL)arg1 wantsDigitizerEvents:(BOOL)arg2 wantsKeyboardEvents:(BOOL)arg3 wantsATVRemoteEvents:(BOOL)arg4 wantsLisaEvents:(BOOL)arg5 wantsMouseEvents:(BOOL)arg6 wantsAccessibilityEvents:(BOOL)arg7 wantsStylusEvents:(BOOL)arg8 ;
