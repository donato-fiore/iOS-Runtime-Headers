...
@property (nonatomic) BOOL ignoreSettingNotifications; // ivar: _ignoreSettingNotifications
@property (readonly, nonatomic) BOOL isConnectedToBluetoothSystem;
@property (readonly, nonatomic) NSArray *pairedAirPods;
@property (copy, nonatomic) id *readyBlock; // ivar: _readyBlock


+(id)sharedInstance;
-(BOOL)isAirPodProduct:(id)arg0 ;
-(BOOL)isBeatsProduct:(id)arg0 ;
...
-(BOOL)nps_volumeSwipeEnabledForDeviceAddress:(id)arg0 ;
-(BOOL)supportsHoldDurationForDeviceAddress:(id)arg0 ;
-(BOOL)supportsNoiseCancellationEnabledForDeviceAddress:(id)arg0 ;
-(BOOL)supportsSpatialAudioForDeviceAddress:(id)arg0 ;
-(BOOL)supportsTapSpeedForDeviceAddress:(id)arg0 ;
-(BOOL)supportsToneVolumeForDeviceAddress:(id)arg0 ;
-(BOOL)supportsVolumeSwipeForDeviceAddress:(id)arg0 ;
-(BOOL)volumeSwipeEnabledForDeviceAddress:(id)arg0 ;
...
-(float)nps_volumeSwipeDurationForDeviceAddress:(id)arg0 ;
-(float)tapSpeedForDeviceAddress:(id)arg0 ;
-(float)volumeSwipeDurationForDeviceAddress:(id)arg0 ;
-(id)_deviceWithDeviceAddress:(id)arg0 ;
...
-(id)titleForSettings;
-(unsigned int)defaultToneVolumeForDeviceAddress:(id)arg0 ;
-(unsigned int)nps_defaultToneVolumeForDeviceAddress:(id)arg0 ;
...
-(void)_retrieveSettingsFromDevices:(id)arg0 ;
...
-(void)nps_setVolumeSwipeDuration:(float)arg0 forDeviceAddress:(id)arg1 ;
-(void)nps_setVolumeSwipeEnabled:(BOOL)arg0 forDeviceAddress:(id)arg1 ;
...
-(void)setVolumeSwipeDuration:(float)arg0 forDeviceAddress:(id)arg1 ;
-(void)setVolumeSwipeEnabled:(BOOL)arg0 forDeviceAddress:(id)arg1 ;
-(void)start;
