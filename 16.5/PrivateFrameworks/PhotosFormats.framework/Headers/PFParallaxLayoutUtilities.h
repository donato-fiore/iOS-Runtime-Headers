...
+(CGFloat)timeOverlapCheckThresholdForTopRect:(struct CGRect )arg0 isInteractive:(BOOL)arg1 ;
...
+(struct CGRect )computeInactiveAvoidingRectForVisibleRect:(struct CGRect )arg0 acceptableFrame:(struct CGRect )arg1 unsafeRect:(struct CGRect )arg2 imageSize:(struct CGSize )arg3 newVisibleRect:(struct CGRect *)arg4 ;
