...
@class DKMonitor, _DKEvent, NSNumber, AVOutputContext;
...
-(void)_stripMetadata:(id)arg0 forBundleId:(id)arg1 ;
-(void)deactivate;
-(void)dealloc;
-(void)outputDevicesDidChange:(id)arg0 ;
-(void)saveBMEventWithCurrent:(id)arg0 outputDevices:(id)arg1 artistStoreIdentifier:(id)arg2 albumStoreIdentifier:(id)arg3 ;
-(void)start;
-(void)stop;
