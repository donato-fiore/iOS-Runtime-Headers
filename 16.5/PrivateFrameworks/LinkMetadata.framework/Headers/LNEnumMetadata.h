...
@class NSDictionary, NSArray, NSString, NSOrderedSet, NSNumber;
...
@property (readonly, nonatomic, getter=isSystem) NSNumber *system; // ivar: _system
...
-(id)initWithIdentifier:(id)arg0 mangledTypeName:(id)arg1 mangledTypeNameByBundleIdentifier:(id)arg2 effectiveBundleIdentifiers:(id)arg3 displayRepresentation:(id)arg4 cases:(id)arg5 customIntentEnumTypeName:(id)arg6 availabilityAnnotations:(id)arg7 system:(id)arg8 ;
