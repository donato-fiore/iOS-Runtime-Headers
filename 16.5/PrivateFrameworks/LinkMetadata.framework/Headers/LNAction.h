...
@property (readonly, copy, nonatomic) NSArray *systemProtocols; // ivar: _systemProtocols
...
-(id)initWithIdentifier:(id)arg0 mangledTypeName:(id)arg1 openAppWhenRun:(BOOL)arg2 outputFlags:(id)arg3 outputType:(id)arg4 systemProtocols:(id)arg5 parameters:(id)arg6 ;
...
-(id)initWithMetadata:(id)arg0 bundleIdentifier:(id)arg1 parameters:(id)arg2 ;
