...
@class NSHashTable, NSDictionary, NSMutableDictionary, NSMutableSet, NSMutableOrderedSet, NSArray, PHFetchResult, NSNumber, NSMutableArray, NSSet, NSPredicate, PHAssetCollection, PHCollection, NSString, PHPhotoLibrary, PHAsset;
@protocol PXPhotoLibraryUIChangeObserver, PXChangeObserver, OS_dispatch_queue;
...
#import "PXPhotosAssetsFetcher.h"
...
@interface PXPhotosDataSource : NSObject <PXPhotoLibraryUIChangeObserver, PXChangeObserver>

 {
    ...
    NSInteger _nestedCoalesceChanges;
...
-(BOOL)_addResultTuple:(id)arg0 forAssetCollection:(id)arg1 preparedResultRecord:(id)arg2 toMutableResultRecord:(id)arg3 ;
...
-(id)_createDataSourceWithAssetsCollections:(id)arg0 ;
...
-(id)createDataSourceWithAssetsInSectionOfAsset:(id)arg0 ;
...
-(void)_commonInit;
-(void)_didChange:(id)arg0 ;
-(void)_didFinishBackgroundFetchingForId:(NSInteger)arg0 ;
-(void)_distributeChange:(id)arg0 ;
...
-(void)_internalSetLibraryFilter:(NSInteger)arg0 ;
...
-(void)_restartBackgroundFetchWithAssetCollectionsToDiff:(id)arg0 ;
