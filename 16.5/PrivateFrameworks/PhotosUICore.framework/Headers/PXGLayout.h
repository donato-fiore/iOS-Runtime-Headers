...
@property (weak, nonatomic) NSObject<PXGLayoutFocusDelegate> *focusDelegate; // ivar: _focusDelegate
...
@property (readonly, nonatomic) NSIndexSet *localHiddenSpriteIndexes; // ivar: _localHiddenSpriteIndexes
...
@property (weak, nonatomic) PXGLayout *nextViewHostingLayout; // ivar: _nextViewHostingLayout
...
@property (readonly, nonatomic) NSHashTable *pointReferences; // ivar: _pointReferences
...
@property (readonly, nonatomic) unsigned int viewHostingSpriteIndex; // ivar: _viewHostingSpriteIndex
...
-(id)createPointReferenceAtPoint:(struct CGPoint )arg0 ;
...
-(struct CGPoint )convertPoint:(struct CGPoint )arg0 fromDescendantLayout:(id)arg1 ;
-(struct CGPoint )convertPoint:(struct CGPoint )arg0 fromLayout:(id)arg1 ;
-(struct CGPoint )convertPoint:(struct CGPoint )arg0 toDescendantLayout:(id)arg1 ;
-(struct CGPoint )pointForPointReference:(id)arg0 ;
...
-(unsigned int)viewHostingSpriteIndexForSublayout:(id)arg0 ;
...
-(void)addPointReference:(id)arg0 ;
...
-(void)axDidReceiveFocusMovementHint:(id)arg0 forSpriteAtIndex:(unsigned int)arg1 ;
-(void)axDidUpdateFocusFromSpriteAtIndex:(unsigned int)arg0 toSpriteAtIndex:(unsigned int)arg1 ;
...
-(void)removePointReference:(id)arg0 ;
