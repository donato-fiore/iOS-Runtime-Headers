...
@protocol PXPeopleSuggestionManagerDelegate, UIContextMenuInteractionDelegate, PXPeopleFlowViewController, PXPeopleFlowViewControllerActionDelegate, PXPeoplePickerConfigurationControllerDelegate;
...
-(void)_toggleConfirmedForCollectionViewCellAtIndexPath:(id)arg0 ;
