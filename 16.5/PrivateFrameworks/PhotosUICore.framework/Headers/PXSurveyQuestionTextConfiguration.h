...
@class UILabel, UIImage, UIView, NSString;
...
@property (readonly, nonatomic) NSString *questionText; // ivar: _questionText
@property (readonly) Class superclass;
@property (readonly, nonatomic) NSString *title; // ivar: _title


-(id)init;
-(id)initWithTitle:(id)arg0 questionText:(id)arg1 ;
