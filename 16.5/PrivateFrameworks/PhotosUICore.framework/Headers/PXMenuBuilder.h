...
+(id)defaultStoryActionsMenuWithViewModel:(id)arg0 ;
+(id)defaultStoryThumbnailActionsMenuWithModel:(id)arg0 isFavorite:(BOOL)arg1 ;
+(id)menuWithDeferredConfiguration:(id)arg0 ;
+(void)_addDurationSectionToMenuBuilder:(id)arg0 withViewModel:(id)arg1 ;
-(id)init;
...
-(void)addSectionWithMenu:(id)arg0 ;
