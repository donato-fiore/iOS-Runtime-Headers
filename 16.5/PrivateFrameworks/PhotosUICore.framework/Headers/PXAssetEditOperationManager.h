...
-(id)init;
-(id)performEditOperationWithType:(id)arg0 asset:(id)arg1 undoManager:(id)arg2 completionHandler:(id)arg3 ;
-(id)performEditOperationWithType:(id)arg0 asset:(id)arg1 undoManager:(id)arg2 delay:(CGFloat)arg3 completionHandler:(id)arg4 ;
