...
@property (nonatomic) BOOL isCapturingSnapshot; // ivar: _isCapturingSnapshot
...
@property (nonatomic) BOOL isExceedingSharedLibraryQuota; // ivar: _isExceedingSharedLibraryQuota
...
@property (nonatomic) BOOL isLowDiskSpace; // ivar: _isLowDiskSpace
@property (nonatomic) BOOL isOffline; // ivar: _isOffline
@property (nonatomic) BOOL isRestoringLibrary; // ivar: _isRestoringLibrary
@property (nonatomic) BOOL isSyncing; // ivar: _isSyncing
@property (nonatomic) BOOL isUpgradeSuggestedToAccessAllPhotos; // ivar: _isUpgradeSuggestedToAccessAllPhotos
@property (nonatomic) BOOL isUserPaused; // ivar: _isUserPaused
@property (nonatomic) BOOL isVeryLowDiskSpace; // ivar: _isVeryLowDiskSpace
...
@property (nonatomic) NSUInteger sharedLibraryExitingWithNumberOfAssetsRemaining; // ivar: _sharedLibraryExitingWithNumberOfAssetsRemaining
@property (nonatomic) NSUInteger sharedLibraryMovingToPersonal; // ivar: _sharedLibraryMovingToPersonal
@property (nonatomic) NSUInteger sharedLibraryMovingToShared; // ivar: _sharedLibraryMovingToShared
@property (nonatomic) NSInteger sharedLibraryState; // ivar: _sharedLibraryState
