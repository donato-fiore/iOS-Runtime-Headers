...
@protocol PXVisualDiagnosticsProvider, PXStoryAutoEditDecisionListsProducer, OS_dispatch_queue, OS_os_log, PFRandomNumberGenerator, PXDisplayAssetCollection, PXStoryChapterCollection, PXDisplayAssetFetchResult, PXStoryMovieHighlightsCollection;
...
+(struct ? )audioModeDecisionForAsset:(id)arg0 minimumAudioScore:(float)arg1 playbackStyle:(NSInteger)arg2 movieHighlight:(id)arg3 ;
...
-(id)_indexesOfClips:(id)arg0 atChapterBeginningInChapterCollection:(id)arg1 ;
...
-(id)init;
-(id)initWithAssetCollection:(id)arg0 displayAssets:(id)arg1 movieHighlights:(id)arg2 chapterCollection:(id)arg3 targetOverallDurationInfo:(struct ? )arg4 configuration:(id)arg5 ;
...
-(void)_adjustTransitionsInClips:(id)arg0 forChapterCollection:(id)arg1 ;
