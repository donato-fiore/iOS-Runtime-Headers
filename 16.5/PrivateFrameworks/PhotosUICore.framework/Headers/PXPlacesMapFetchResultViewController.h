...
@protocol PXPlacesMapControllerChangeDelegate, PXPlacesMapControllerSelectionDelegate, PXOneUpPresentationDelegate, PXChangeObserver, PXPlacesMapFetchResultControllerAccess, PXPlacesAssetsSelectionDelegate, PXPlacesMapBarButtonsDelegate, PXPlacesMapLocationEditDelegate, PXPlacesMapGeotaggableInfoDelegate;
