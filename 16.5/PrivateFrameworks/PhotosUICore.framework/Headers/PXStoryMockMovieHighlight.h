...
@property (nonatomic) float audioQualityScore; // ivar: _audioQualityScore
...
-(id)initWithTimeRange:(struct ? )arg0 score:(float)arg1 bestPlaybackRect:(struct CGRect )arg2 normalizationData:(id)arg3 audioScore:(float)arg4 ;
-(id)initWithTimeRange:(struct ? )arg0 score:(float)arg1 bestPlaybackRect:(struct CGRect )arg2 normalizationData:(id)arg3 face:(BOOL)arg4 voice:(BOOL)arg5 music:(BOOL)arg6 loudness:(float)arg7 peak:(float)arg8 audioScore:(float)arg9 ;
