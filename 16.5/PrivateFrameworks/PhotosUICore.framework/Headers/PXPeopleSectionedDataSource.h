...
@protocol PXPhotoLibraryUIChangeObserver, PXPhotoLibraryDefaultsChangeObserver, OS_dispatch_queue;
...
-(void)changePersonsAtIndexPaths:(id)arg0 toPersonType:(NSInteger)arg1 undoManager:(id)arg2 ;
-(void)dealloc;
...
-(void)movePersonAtIndexPath:(id)arg0 toIndexPath:(id)arg1 undoManager:(id)arg2 shouldUpdateImmediately:(BOOL)arg3 ;
...
-(void)photoLibraryLocalDefaults:(id)arg0 didChangeValueForKey:(id)arg1 ;
