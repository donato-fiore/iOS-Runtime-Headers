...
@class NSHashTable, NSMutableSet, NSMutableDictionary, NSMapTable;
...
-(void)_didUpdateLoadOperationWithTrackingID:(id)arg0 withProgress:(CGFloat)arg1 indeterminate:(BOOL)arg2 ;
...
-(void)didUpdateLoadOperationWithIndeterminateProgressWithTrackingID:(id)arg0 ;
