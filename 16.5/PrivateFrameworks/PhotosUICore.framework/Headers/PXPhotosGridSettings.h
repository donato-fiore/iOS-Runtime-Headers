...
@property (nonatomic) BOOL enableFilterDropDownButton; // ivar: _enableFilterDropDownButton
...
@property (nonatomic) BOOL enableInSharedLibrary; // ivar: _enableInSharedLibrary
...
@property (nonatomic) BOOL enableMultiSelectMenu; // ivar: _enableMultiSelectMenu
