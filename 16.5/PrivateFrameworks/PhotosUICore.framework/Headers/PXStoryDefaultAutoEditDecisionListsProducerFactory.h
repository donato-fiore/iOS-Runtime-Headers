...
-(id)autoEditDecisionListsProducerForAssetCollection:(id)arg0 displayAssets:(id)arg1 movieHighlights:(id)arg2 chapterCollection:(id)arg3 targetOverallDurationInfo:(struct ? )arg4 ;
