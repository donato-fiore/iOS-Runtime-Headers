...
#import "PXSharedLibraryCameraSharingBannerStatusProvider.h"
...
@property (copy, nonatomic) PXContentFilterState *allPhotosContentFilterState; // ivar: _allPhotosContentFilterState
...
@property (retain, nonatomic) PXBannerViewConfiguration *bannerViewConfiguration; // ivar: _bannerViewConfiguration
...
@property (readonly, nonatomic) PXSharedLibraryCameraSharingBannerStatusProvider *sharedLibraryCameraSharingBannerStatusProvider; // ivar: _sharedLibraryCameraSharingBannerStatusProvider
@property (readonly, nonatomic) PXSharedLibrarySharingSuggestionsCountsManager *sharedLibrarySuggestionCountsManager; // ivar: _sharedLibrarySuggestionCountsManager
...
-(void)userDidSetAllPhotosContentFilterState:(id)arg0 ;
