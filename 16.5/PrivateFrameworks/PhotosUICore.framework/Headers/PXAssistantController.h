...
-(void)_stepForwardInAssistantAnimated:(BOOL)arg0 currentViewController:(id)arg1 ;
...
-(void)stepForwardInAssistantForAssistantViewControllerAsCurrentViewController:(id)arg0 ;
