...
@class NSMapTable, NSMutableDictionary, NSString, PHPerson, PHPhotoLibrary;
...
// -(id)menuElementForActionType:(id)arg0 image:(id)arg1 willStartActionHandler:(id)arg2 didEndActionHandler:(unk)arg3  ;
...
-(void)_handleAction:(id)arg0 actionType:(id)arg1 completionHandler:(id)arg2 ;
-(void)_handleActionPerformerComplete:(id)arg0 success:(BOOL)arg1 error:(id)arg2 ;
-(void)_handleBarButtonItem:(id)arg0 ;
-(void)executeActionForActionType:(id)arg0 sender:(id)arg1 completionHandler:(id)arg2 ;
