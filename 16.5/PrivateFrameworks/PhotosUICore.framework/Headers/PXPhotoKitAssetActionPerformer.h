...
@class NSArray, NSDictionary, PHFetchResult, NSString, PHPerson;
...
+(id)createIndeterminateProgressToastForActionPerformer:(id)arg0 title:(id)arg1 description:(id)arg2 ;
