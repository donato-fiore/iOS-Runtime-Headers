...
-(void)dealloc;
-(void)modifyInfoForSegmentAtIndex:(NSInteger)arg0 usingBlock:(id)arg1 ;
-(void)modifyOptionsForClipWithIdentifier:(NSInteger)arg0 hintIndex:(NSInteger)arg1 usingBlock:(id)arg2 ;
