...
-(id)_existingAdjustedTextureForSourceTexture:(id)arg0 adjustment:(id)arg1 wantsMipmaps:(BOOL)arg2 presentationType:(int)arg3 ;
...
-(id)_storeAdjustedTexture:(id)arg0 forSourceTexture:(id)arg1 adjustment:(id)arg2 mipmaps:(BOOL)arg3 ;
...
-(void)_applyAdjustment:(id)arg0 withMipmaps:(BOOL)arg1 toTexture:(id)arg2 fromTextureProvider:(id)arg3 withTextureConverter:(id)arg4 forRequestID:(int)arg5 deliveryOrder:(unsigned int)arg6 requestDetails:(struct ? )arg7 ;
