...
@property (readonly, nonatomic) BOOL browseGridAllowsDragGesture; // ivar: _browseGridAllowsDragGesture
@property (readonly, nonatomic) UIColor *browseGridBackgroundColor; // ivar: _browseGridBackgroundColor
@property (readonly, nonatomic) UIEdgeInsets browseGridLayoutMargins; // ivar: _browseGridLayoutMargins
@property (readonly, nonatomic) CGFloat bufferingIndicatorCornerRadius; // ivar: _bufferingIndicatorCornerRadius
@property (readonly, nonatomic) BOOL bufferingIndicatorWantsBackground; // ivar: _bufferingIndicatorWantsBackground
@property (readonly, nonatomic) BOOL canShowCloseButton; // ivar: _canShowCloseButton
@property (readonly, nonatomic) BOOL canShowFullscreenToggleButton; // ivar: _canShowFullscreenToggleButton
@property (readonly, nonatomic) BOOL canShowManagePhotosAction; // ivar: _canShowManagePhotosAction
@property (readonly, nonatomic) BOOL canShowMuteToggleButton; // ivar: _canShowMuteToggleButton
@property (readonly, nonatomic) CGFloat canShowRelatedNavigationButton; // ivar: _canShowRelatedNavigationButton
...
@property (readonly, nonatomic) NSUInteger fullsizePlayerDefaultChromeItems; // ivar: _fullsizePlayerDefaultChromeItems
...
@property (readonly, nonatomic) CGFloat infoPanelAnimationDistance; // ivar: _infoPanelAnimationDistance
@property (readonly, nonatomic) CGFloat infoPanelAssetAspectRatio; // ivar: _infoPanelAssetAspectRatio
@property (readonly, nonatomic) CGFloat infoPanelAssetToMetadataLabel; // ivar: _infoPanelAssetToMetadataLabel
@property (readonly, nonatomic) CGFloat infoPanelAssetToSymbolCenter; // ivar: _infoPanelAssetToSymbolCenter
@property (readonly, nonatomic) CGFloat infoPanelButtonHeight; // ivar: _infoPanelButtonHeight
@property (readonly, nonatomic) CGSize infoPanelButtonOffset; // ivar: _infoPanelButtonOffset
@property (readonly, nonatomic) CGFloat infoPanelDistanceBetweenAssetAndTitleLabel; // ivar: _infoPanelDistanceBetweenAssetAndTitleLabel
@property (readonly, nonatomic) CGFloat infoPanelFooterLabelBaselineFromBottom; // ivar: _infoPanelFooterLabelBaselineFromBottom
@property (readonly, nonatomic) CGFloat infoPanelHeight; // ivar: _infoPanelHeight
@property (readonly, nonatomic) UIEdgeInsets infoPanelMargins; // ivar: _infoPanelMargins
@property (readonly, nonatomic) CGFloat infoPanelMetadataToMetadataBaselines; // ivar: _infoPanelMetadataToMetadataBaselines
@property (readonly, nonatomic) UIEdgeInsets infoPanelPadding; // ivar: _infoPanelPadding
@property (readonly, nonatomic) CGFloat infoPanelTitleLabelBaselineFromTop; // ivar: _infoPanelTitleLabelBaselineFromTop
@property (readonly, nonatomic) CGFloat infoPanelTitleToMetadataBaselines; // ivar: _infoPanelTitleToMetadataBaselines
...
@property (readonly, nonatomic) CGFloat interTopTrailingChromeButtonSpacing; // ivar: _interTopTrailingChromeButtonSpacing
...
@property (readonly, nonatomic) CGFloat maximumWidthForRelatedTitleAndSubtitle; // ivar: _maximumWidthForRelatedTitleAndSubtitle
@property (readonly, nonatomic) CGFloat minimumWidthRequiredForChromeText; // ivar: _minimumWidthRequiredForChromeText
@property (readonly, nonatomic) BOOL onlyShowReplayEndButtonAtTopOfTitle; // ivar: _onlyShowReplayEndButtonAtTopOfTitle
...
@property (readonly, nonatomic) CGFloat playbackEndButtonSystemImagePointSize; // ivar: _playbackEndButtonSystemImagePointSize
@property (readonly, nonatomic) CGFloat playbackEndButtonSystemImageWeight; // ivar: _playbackEndButtonSystemImageWeight
...
@property (readonly, nonatomic) UIColor *playerBackgroundColor; // ivar: _playerBackgroundColor
...
@property (readonly, nonatomic) CGFloat relatedNavigationButtonFadeDuration; // ivar: _relatedNavigationButtonFadeDuration
@property (readonly, nonatomic) CGSize relatedNavigationButtonSize; // ivar: _relatedNavigationButtonSize
@property (readonly, nonatomic) CGFloat relatedNavigationButtonSystemImagePointSize; // ivar: _relatedNavigationButtonSystemImagePointSize
@property (readonly, nonatomic) PXStoryChromeButtonSpec *relatedNavigationChromeButtonSpec; // ivar: _relatedNavigationChromeButtonSpec
@property (readonly, nonatomic) CGSize relatedTitleSize; // ivar: _relatedTitleSize
@property (readonly, nonatomic) NSString *replayButtonImageName; // ivar: _replayButtonImageName
...
@property (readonly, nonatomic) CGFloat scrubberHorizontalLayoutMargin; // ivar: _scrubberHorizontalLayoutMargin
...
@property (readonly, nonatomic) CGPoint shareButtonExtraOffset; // ivar: _shareButtonExtraOffset
...
@property (readonly, nonatomic) BOOL shouldUseAssetCollectionForTitleAndSubtitle; // ivar: _shouldUseAssetCollectionForTitleAndSubtitle
@property (readonly, nonatomic) BOOL shouldUseUnifiedButtonLayout; // ivar: _shouldUseUnifiedButtonLayout
...
@property (readonly, nonatomic) CGFloat spacingBetweenPlaybackEndTitleAndSubtitle; // ivar: _spacingBetweenPlaybackEndTitleAndSubtitle
@property (readonly, nonatomic) CGFloat spacingBetweenRelatedNavigationButtonAndRelated; // ivar: _spacingBetweenRelatedNavigationButtonAndRelated
...
@property (readonly, nonatomic) NSInteger upNextAnimationStyle; // ivar: _upNextAnimationStyle
...
@property (readonly, nonatomic) NSInteger upNextCountdownPlacement; // ivar: _upNextCountdownPlacement
@property (readonly, nonatomic) NSUInteger upNextTargetMemoryCount; // ivar: _upNextTargetMemoryCount
@property (readonly, nonatomic) BOOL wantsEdgeTapToChangeCurrentSegment; // ivar: _wantsEdgeTapToChangeCurrentSegment
@property (readonly, nonatomic) BOOL wantsSwipeDownGestureToDismiss; // ivar: _wantsSwipeDownGestureToDismiss
