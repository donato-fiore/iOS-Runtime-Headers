...
@protocol PXGTextureConverter, PXGMetalTextureConverterDelegate, OS_dispatch_queue;
...
-(id)_generateMipmapsForMetalTexture:(id)arg0 ;
...
-(id)init;
-(id)initWithContext:(id)arg0 destinationColorspaceName:(NSUInteger)arg1 layoutQueue:(id)arg2 ;
-(void)dealloc;
