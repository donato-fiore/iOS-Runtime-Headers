...
+(float)_calculateDominantSceneScoreWithSceneClassifications:(id)arg0 searchQuerySceneIdentifiers:(id)arg1 sceneTaxonomy:(id)arg2 ;
+(id)_sceneClassificationForSceneIdentifier:(unsigned int)arg0 sceneClassifications:(id)arg1 ;
-(id)initWithAsset:(id)arg0 sceneClassifications:(id)arg1 searchQuerySceneIdentifiers:(id)arg2 sceneTaxonomyProvider:(id)arg3 ;
