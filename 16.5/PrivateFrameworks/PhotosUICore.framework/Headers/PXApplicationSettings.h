...
@property (nonatomic) CGFloat backgroundThresholdDurationForUndoActionsInvalidation; // ivar: _backgroundThresholdDurationForUndoActionsInvalidation
@property (nonatomic) CGFloat defaultNavigationTimeoutDuration; // ivar: _defaultNavigationTimeoutDuration
@property (nonatomic) BOOL shouldClearUndoStackAutomatically; // ivar: _shouldClearUndoStackAutomatically
