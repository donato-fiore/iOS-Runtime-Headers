...
@class UIView, UIColor, NSString, NSArray, MTKView, NSDictionary, UIWindowScene;
@protocol PXDiagnosticsEnvironment, PXGEngineDelegate, PXScrollViewControllerObserver, PXGLayoutScrollDelegate, PXGLayoutViewDelegate, PXGLayoutFocusDelegate, PXSettingsKeyObserver, UIGestureRecognizerDelegate, PXGAXResponder, PXGDiagnosticsProvider, PXDebugHierarchyProvider, PXTapToRadarDiagnosticProvider, PXGHitTestEnvironment, PXGViewAccessibilityDelegate, PXGViewDiagnosticsSource, PXAnonymousScrollView;
...
@property (nonatomic) BOOL contentShouldBeObscured; // ivar: _contentShouldBeObscured
...
@property (weak, nonatomic) NSObject<PXGViewDiagnosticsSource> *diagnosticsSource; // ivar: _diagnosticsSource
...
@property (nonatomic) BOOL isFocusFastScrolling; // ivar: _isFocusFastScrolling
...
-(id)feedHitTestResultAtPoint:(struct CGPoint )arg0 ;
-(id)feedHitTestResultAtPoint:(struct CGPoint )arg0 ignoringOverlayContent:(BOOL)arg1 ;
-(id)feedHitTestResultsInRect:(struct CGRect )arg0 ;
-(id)firstCuratedLibraryHitTestResultsAtPoint:(struct CGPoint )arg0 withControl:(NSInteger)arg1 ;
-(id)handleTouchAtPoint:(SEL)arg0 ;
...
-(id)storyHitTestResultsInRect:(struct CGRect )arg0 ;
...
-(void)scrollViewControllerDidBeginFocusFastScrolling:(id)arg0 ;
-(void)scrollViewControllerDidEndFocusFastScrolling:(id)arg0 ;
...
-(void)setNeedsFocusUpdateForLayout:(id)arg0 ;
