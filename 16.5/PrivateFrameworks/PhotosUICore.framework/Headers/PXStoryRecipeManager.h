...
#import "PXStoryProducerMonitor.h"
...
@property (retain, nonatomic) PXStoryChapterCollectionManager *chapterCollectionManager; // ivar: _chapterCollectionManager
@property (retain, nonatomic) NSObject<PXStoryChapterCollectionProducer> *chapterCollectionProducer; // ivar: _chapterCollectionProducer
@property (readonly, nonatomic) NSObject<PXStoryChapterCollectionProducerFactory> *chapterCollectionProducerFactory; // ivar: _chapterCollectionProducerFactory
@property (retain, nonatomic) NSProgress *chapterCollectionProgress; // ivar: _chapterCollectionProgress
@property (retain, nonatomic) PXStoryProducerResult *chapterCollectionResult; // ivar: _chapterCollectionResult
...
@property (readonly, nonatomic) NSUInteger defaultRequestOptions; // ivar: _defaultRequestOptions
...
@property (readonly, nonatomic) NSObject<PXStoryDetailedSaliencyProducerFactory> *detailedSaliencyProducerFactory; // ivar: _detailedSaliencyProducerFactory
@property (readonly, nonatomic) PXStoryProducerMonitor *detailedSaliencyProducerMonitor; // ivar: _detailedSaliencyProducerMonitor
@property (retain, nonatomic) NSProgress *detailedSaliencyProgress; // ivar: _detailedSaliencyProgress
@property (retain, nonatomic) PXStoryProducerResult *detailedSaliencyResult; // ivar: _detailedSaliencyResult
...
@property (nonatomic) BOOL hasFinalChapterCollectionBeenProduced; // ivar: _hasFinalChapterCollectionBeenProduced
@property (nonatomic) BOOL hasFinalDetailedSaliencyBeenProduced; // ivar: _hasFinalDetailedSaliencyBeenProduced
...
@property (readonly, nonatomic) NSUInteger optionalProducers;
...
@property (nonatomic) NSUInteger producersLikelyToKeepUp; // ivar: _producersLikelyToKeepUp
@property (readonly, nonatomic) NSUInteger producersRequiredForPlayback;
@property (readonly, nonatomic) NSUInteger producersToMonitor;
@property (nonatomic) NSUInteger producersWithInitialResults; // ivar: _producersWithInitialResults
...
@property (retain, nonatomic) NSObject<PXDisplayAssetFetchResult> *untruncatedCuratedAssets; // ivar: _untruncatedCuratedAssets
...
-(id)_monitorForProducer:(NSUInteger)arg0 ;
-(id)_resultForProducer:(NSUInteger)arg0 ;
...
-(id)initWithConfiguration:(id)arg0 assetsProducerFactory:(id)arg1 persistableRecipeProducerFactory:(id)arg2 songsProducerFactory:(id)arg3 movieHighlightsProducerFactory:(id)arg4 detailedSaliencyProducerFactory:(id)arg5 chapterCollectionProducerFactory:(id)arg6 stylesProducerFactory:(id)arg7 autoEditDecisionListsProducerFactory:(id)arg8 autoCurationProducerFactory:(id)arg9 ;
...
-(void)_handleResult:(id)arg0 forProducer:(NSUInteger)arg1 ;
...
-(void)applyManuallyRemovedAssets:(id)arg0 ;
