...
@class UIViewController, UIView, NSString, UIContextMenuInteraction, NSSet, UIScrollView;
@protocol PXActionManagerProvider, PXAssetsActionReceiver, PXContentPrivacyAuthenticationContext, PXPhotosContentControllerDelegate, PXScrollViewControllerObserver, PXStatusControllerDelegate, PXSplitViewControllerChangeObserver, PXUserInterfaceFeatureViewController, PXPhotosBarsControllerDelegate, PXAssetsSharingHelperDelegate, PXSelectionContainerProvider, PXPhotosViewUIInteractionDelegate, _PXPhotosGridContainerDelegate, PXPhotosGridStackTransitionEndpoint, PXChangeObserver, UIViewControllerInteractiveTransitioning, PXPhotosViewEventTracker, PXGridPresentationBarsUpdateDelegate;
...
@property (retain, nonatomic) PXPhotosGridPlaceholderStatusController *fallbackPlaceholderStatusController; // ivar: _fallbackPlaceholderStatusController
...
@property (retain, nonatomic) PXStatusController *placeholderStatusController; // ivar: _placeholderStatusController
...
@property (nonatomic) BOOL shouldScrollToInitialPositionAfterUnlock; // ivar: _shouldScrollToInitialPositionAfterUnlock
...
-(id)windowForProgressPresentationInAssetsSharingHelper:(id)arg0 ;
-(struct UIEdgeInsets )px_layoutMargins;
-(void)_completeNavigationToDestination:(id)arg0 result:(NSInteger)arg1 error:(id)arg2 ;
...
-(void)_scrollToInitialPositionAnimated:(BOOL)arg0 ;
...
-(void)paste:(id)arg0 ;
-(void)photosBarsController:(id)arg0 didRequestDismissWithSender:(id)arg1 ;
...
-(void)uiInteraction:(id)arg0 didChangeNavigatedAssetReference:(id)arg1 ;
-(void)uiInteractionDidExtendSelection:(id)arg0 ;
