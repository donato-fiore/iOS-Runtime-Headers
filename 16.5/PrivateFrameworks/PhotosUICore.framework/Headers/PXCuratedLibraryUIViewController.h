...
@property (retain, nonatomic) PXAssetReference *preferredFocusAssetReference; // ivar: _preferredFocusAssetReference
...
-(void)_requestFocusUpdateWithAssetReference:(id)arg0 ;
...
-(void)preparePresentationEnvironmentForBannerView:(id)arg0 actionIdentifier:(id)arg1 completionHandler:(id)arg2 ;
