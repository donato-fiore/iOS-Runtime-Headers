...
#ifndef PXPHOTOKITASSETCOLLECTIONDELETEMEMORYACTIONPERFORMER_H
#define PXPHOTOKITASSETCOLLECTIONDELETEMEMORYACTIONPERFORMER_H
...
-(void)_promptDeleteMemoryConfirmationWithCompletionHandler:(id)arg0 ;
