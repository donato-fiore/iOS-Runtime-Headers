...
@class NSIndexSet, NSMutableSet, NSShadow, NSNumber, NSString, NSSet;
...
@property (nonatomic) BOOL wantsSharedLibraryDecorations; // ivar: _wantsSharedLibraryDecorations
