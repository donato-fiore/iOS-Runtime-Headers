...
@property (nonatomic) BOOL debugMipmaps; // ivar: _debugMipmaps
...
@property (nonatomic) BOOL shouldDeactivateTextureManagerWhenNotVisible; // ivar: _shouldDeactivateTextureManagerWhenNotVisible
