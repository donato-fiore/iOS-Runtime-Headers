...
@class UICollectionViewController, NSString, UICollectionViewSupplementaryRegistration;
@protocol UICollectionViewDataSourcePrefetching, PXPeopleRecoCollectionViewDelegate, PXPeopleRecoDataSourceDelegate;
...
-(void)collectionView:(id)arg0 frameDidChange:(struct CGRect )arg1 ;
