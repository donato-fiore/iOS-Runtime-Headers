...
@property (readonly, nonatomic) BOOL canScaleWhenPressed; // ivar: _canScaleWhenPressed
...
@property (readonly, nonatomic) CGPoint thumbnailActionMenuButtonExtraOffset; // ivar: _thumbnailActionMenuButtonExtraOffset
...
@property (readonly, nonatomic) BOOL thumbnailMenuIncludesFeatureLessAction; // ivar: _thumbnailMenuIncludesFeatureLessAction
