...
-(void)processCollectionSearchResults:(id)arg0 assetSearchResults:(id)arg1 personSearchResults:(id)arg2 searchSuggestions:(id)arg3 sceneIdentifiers:(id)arg4 matchedQueryStrings:(id)arg5 matchedOCRAssetUUIDs:(id)arg6 forSearchQuery:(id)arg7 ;
