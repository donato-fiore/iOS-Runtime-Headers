...
+(id)SFSearchResultFromSearchSuggestion:(id)arg0 queryId:(NSInteger)arg1 ;
+(id)SFSearchResultFromSearchSuggestion:(id)arg0 zeroKeyword:(id)arg1 queryId:(NSInteger)arg2 ;
...
+(id)_resultSectionForSearchSuggestions:(id)arg0 queryId:(NSInteger)arg1 ;
