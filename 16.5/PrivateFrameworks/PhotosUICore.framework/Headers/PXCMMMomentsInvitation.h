...
@protocol PXCMMInvitation, NSCopying, PXCMMInvitationParticipant, PXDisplayAsset, PXUIImageProvider;
...
+(id)_invitationWithAssetCollection:(id)arg0 previewAssetsFetchResult:(id)arg1 participantsFetchResult:(id)arg2 ;
