...
@class PHPhotoLibrary, NSMutableDictionary, NSOperationQueue, NSMutableSet, NSMutableArray, NSDate, NSArray, PHCollectionList, PHFetchResult, NSString, NSUserDefaults;
...
+(id)standardDataSourceManagerForCollectionList:(id)arg0 ;
...
-(NSUInteger)indexOfFirstReorderableCollection;
