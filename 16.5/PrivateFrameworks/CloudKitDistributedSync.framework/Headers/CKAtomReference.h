...
@property (readonly, copy, nonatomic) CKMergeableValueID *mergeableValueID; // ivar: _mergeableValueID
@property (readonly, copy, nonatomic) CKDistributedTimestamp *timestamp; // ivar: _timestamp
