...
@interface CKXORCReader : CKXReaderBase <CKXReaderProtocol>

 {
    ...
    vector<std::pair<std::unique_ptr<orc::RowReader>, std::unique_ptr<orc::ColumnVectorBatch>>, std::allocator<std::pair<std::unique_ptr<orc::RowReader>, std::unique_ptr<orc::ColumnVectorBatch>>>> _structToReaderBatchPair;
    vector<NSIndexSet *, std::allocator<NSIndexSet *>> _rowsForTopLevelContainerStructs;
}
