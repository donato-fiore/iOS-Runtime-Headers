...
@class AMSBinaryPromise, UIViewController<AMSUIWebPagePresenter>, NSString, UIViewController, UINavigationItem, AMSUIWebContainerViewController<AMSUIWebPresentationDelegate>, NSDictionary;
@protocol PSStateRestoration, UIViewControllerTransitioningDelegate, AMSUIWebPresentationDelegate, UIAdaptivePresentationControllerDelegate;
...
@property (retain, nonatomic) AMSBinaryPromise *activeRefresh; // ivar: _activeRefresh
...
-(id)_buttonModelForBarButtonItemModel:(id)arg0 ;
-(id)_createBarButtonItemWithModel:(id)arg0 ;
-(id)_makeCustomNavigationBarAppearanceWithModel:(id)arg0 ;
-(id)_refreshWithOptions:(id)arg0 ;
...
-(void)contentWasReplacedAnimated:(BOOL)arg0 ;
-(void)dealloc;
...
-(void)setupToolbarAnimated:(BOOL)arg0 ;
-(void)updateSafeAreaEdgesForPageModel:(id)arg0 ;
