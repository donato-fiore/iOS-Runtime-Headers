...
@protocol AMSUIDynamicViewControllerDelegate, AMSBagConsumer, AMSBagProtocol, AMSUIMediaContentDelegate;
...
@property (weak, nonatomic) NSObject<AMSUIMediaContentDelegate> *mediaContentDelegate; // ivar: _mediaContentDelegate
