...
@class AFSpeechSynthesisRecord, AFConnection, AFSettingsConnection, AFSiriClientStateManager, AFModesConfiguration, SASActivationInstrumentationSender, NSString, NSArray, AFAnalyticsTurnBasedInstrumentationContext, SRUIFSiriSessionInfo, SRUIFSpeechRequestHandler, SRUIFSiriSessionStateHandler, SRUIFWatchAuthenticationManager;
@protocol AFAssistantUIService, AFSpeechDelegate, SRUIFSiriSessionStateHandlerDelegate, SRUIFSpeechRequestHandlerDelegate, AFUISiriSession, OS_dispatch_queue, AFUISiriSessionDelegate, AFUISiriSessionLocalDataSource, AFUISiriSessionLocalDelegate;
...
@property (retain, nonatomic) SRUIFSpeechRequestHandler *speechRequestHandler; // ivar: _speechRequestHandler
@property (readonly, nonatomic, getter=_stateHandler) SRUIFSiriSessionStateHandler *stateHandler; // ivar: _stateHandler
@property (readonly) Class superclass;
@property (retain, nonatomic, getter=_watchAuthenticationManager, setter=_setWatchAuthenticationManager:) SRUIFWatchAuthenticationManager *watchAuthenticationManager; // ivar: _watchAuthenticationManager
...
-(BOOL)speechRequestHandlerShouldRollBackRequestForSpeechCancellation:(id)arg0 ;
...
-(id)connectionForSpeechRequestHandler:(id)arg0 ;
...
-(void)_performAceCommand:(id)arg0 turnIdentifier:(id)arg1 machAbsoluteTime:(CGFloat)arg2 conflictHandler:(id)arg3 ;
...
-(void)_populateModesConfiguration:(id)arg0 attentionType:(NSUInteger)arg1 value:(BOOL)arg2 ;
-(void)_requestDidFinishWithError:(id)arg0 ;
-(void)_sendContextWithCompletion:(id)arg0 ;
...
-(void)_updateModesConfigurationForAttentionType:(NSUInteger)arg0 value:(BOOL)arg1 ;
-(void)_updateModesHeuristicsForRequestOptions:(id)arg0 ;
...
-(void)assistantConnection:(id)arg0 dismissAssistantWithReason:(NSInteger)arg1 ;
...
-(void)clearContext;
-(void)dealloc;
-(void)didGainAttentionWithEvent:(NSInteger)arg0 ;
-(void)didLoseAttentionWithEvent:(NSInteger)arg0 ;
-(void)end;
-(void)endForReason:(NSInteger)arg0 ;
-(void)forceAudioSessionActive;
-(void)forceAudioSessionActiveWithCompletion:(id)arg0 ;
-(void)forceAudioSessionInactive;
-(void)launchedIntoListeningAtTime:(CGFloat)arg0 ;
...
-(void)performAceCommand:(id)arg0 turnIdentifier:(id)arg1 machAbsoluteTime:(CGFloat)arg2 ;
-(void)preheat;
...
-(void)sendContextForSpeechRequestContinuationWithCompletion:(id)arg0 ;
-(void)sessionStateHandler:(id)arg0 didTransitionFromState:(NSInteger)arg1 toState:(NSInteger)arg2 forEvent:(NSInteger)arg3 machAbsoluteTime:(CGFloat)arg4 ;
...
-(void)speechRequestHandlerDidCancelSpeechRequest:(id)arg0 ;
-(void)speechRequestHandlerWillCancelSpeechRequest:(id)arg0 ;
-(void)speechSynthesisDidFinish:(id)arg0 ;
-(void)speechSynthesisDidUpdatePowerLevelTo:(float)arg0 ;
-(void)startCorrectedRequestWithText:(id)arg0 correctionIdentifier:(id)arg1 userSelectionResults:(id)arg2 turnIdentifier:(id)arg3 machAbsoluteTime:(CGFloat)arg4 ;
