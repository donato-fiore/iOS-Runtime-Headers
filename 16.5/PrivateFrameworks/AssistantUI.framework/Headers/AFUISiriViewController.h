...
-(BOOL)recentButtonPressActivityDetected:(id)arg0 ;
-(BOOL)recentTouchScreenActivityDetected:(id)arg0 ;
...
-(id)initWithConnection:(id)arg0 configuration:(id)arg1 requestSource:(NSInteger)arg2 displayConfiguration:(id)arg3 ;
...
-(void)_handlePasscodeUnlockAndCancelRequest:(BOOL)arg0 dismissOnFailure:(BOOL)arg1 withCompletion:(id)arg2 ;
...
-(void)handler:(id)arg0 requestToInstrumentEvent:(id)arg1 turn:(id)arg2 machAbsoluteTime:(NSUInteger)arg3 ;
...
-(void)setSystemApertureEdgeInsets:(struct UIEdgeInsets )arg0 ;
-(void)setSystemApertureFrame:(struct CGRect )arg0 ;
...
-(void)siriSession:(id)arg0 didChangeToState:(NSInteger)arg1 event:(NSInteger)arg2 machAbsoluteTransitionTime:(CGFloat)arg3 ;
...
-(void)siriSession:(id)arg0 initialBringupProcessedWithTurnIdentifier:(id)arg1 ;
...
-(void)siriSessionDidReceiveStartScreenRecordingCommand:(id)arg0 completion:(id)arg1 ;
-(void)siriSessionDidReceiveStopScreenRecordingCommand:(id)arg0 completion:(id)arg1 ;
