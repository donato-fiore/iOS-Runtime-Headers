...
@class NSAttributedString, NSDictionary, NSString, NSMutableArray, TIKeyboardIntermediateText, TIKeyboardOutput, NSArray, NSMutableDictionary, NSUUID;
...
@property (readonly, nonatomic) NSUUID *targetSessionUUID; // ivar: _targetSessionUUID
...
-(id)initWithTargetSessionUUID:(id)arg0 ;
