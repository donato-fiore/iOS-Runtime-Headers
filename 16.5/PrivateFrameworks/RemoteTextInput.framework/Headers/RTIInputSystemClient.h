...
-(void)_beginSessionWithID:(id)arg0 forServices:(id)arg1 force:(BOOL)arg2 animated:(BOOL)arg3 ;
-(void)_configureConnection:(id)arg0 withMachName:(id)arg1 ;
-(void)_didIntializeConnection:(id)arg0 withMachName:(id)arg1 ;
-(void)_endAllActiveSessionsAnimated:(BOOL)arg0 ;
-(void)_endAllActiveSessionsForServices:(id)arg0 animated:(BOOL)arg1 ;
-(void)_endSessionWithID:(id)arg0 forServices:(id)arg1 options:(id)arg2 ;
-(void)_initializeConnectionWithMachName:(id)arg0 ;
-(void)_modifyTextEditingAllowedForReason:(id)arg0 notify:(BOOL)arg1 animated:(BOOL)arg2 block:(id)arg3 ;
