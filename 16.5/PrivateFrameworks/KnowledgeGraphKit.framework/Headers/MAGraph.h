...
@interface MAGraph : MABaseGraph {
    ...
    os_unfair_lock_s _labelMapLock;
}


@property (readonly, nonatomic) KGStoredGraph *graph; // ivar: _graph
@property (nonatomic) BOOL hadFatalError; // ivar: _hadFatalError
...
-(void)enumeratePropertyValuesForKey:(id)arg0 ofEdgesWithIdentifiers:(id)arg1 usingBlock:(id)arg2 ;
-(void)enumeratePropertyValuesForKey:(id)arg0 ofNodesWithIdentifiers:(id)arg1 usingBlock:(id)arg2 ;
