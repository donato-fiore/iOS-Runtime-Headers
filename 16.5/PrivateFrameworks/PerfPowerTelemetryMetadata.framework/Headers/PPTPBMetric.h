...
@property (nonatomic) int deviceCapability; // ivar: _deviceCapability
...
@property (nonatomic) int obfuscation; // ivar: _obfuscation
@property (nonatomic) int privacyClassification; // ivar: _privacyClassification
