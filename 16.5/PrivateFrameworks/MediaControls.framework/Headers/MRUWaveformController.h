...
@protocol MRNowPlayingControllerDelegate, MRUAudioAnalyzerObserver, MRUNowPlayingControllerObserver, MRUArtworkViewObserver, MRUWaveformControllerDelegate;
...
@property (retain, nonatomic) NSString *trackIdentifier; // ivar: _trackIdentifier
