...
@property (nonatomic) CGFloat artworkLoadingTimeout; // ivar: _artworkLoadingTimeout
...
@property (retain, nonatomic) MRUImageLoader *imageLoader; // ivar: _imageLoader
...
-(struct CGRect )artworkFrameForSize:(struct CGSize )arg0 availableBounds:(struct CGRect )arg1 ;
