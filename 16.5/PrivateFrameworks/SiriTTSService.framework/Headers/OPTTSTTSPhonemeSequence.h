...
#ifndef OPTTSTTSPHONEMESEQUENCE_H
#define OPTTSTTSPHONEMESEQUENCE_H
...
-(id)word_phonemes_objectAtIndex:(NSUInteger)arg0 ;
-(struct Offset<siri::speech::schema_fb::TTSPhonemeSequence> )addObjectToBuffer:(*void)arg0 ;
-(void)word_phonemes_enumerateObjectsUsingBlock:(id)arg0 ;
