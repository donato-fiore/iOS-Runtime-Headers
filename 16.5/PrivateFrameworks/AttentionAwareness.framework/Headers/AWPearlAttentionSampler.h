...
@class BKDevicePearl, BKFaceDetectOperation, CARSessionStatus, NSString;
@protocol BKDevicePearlDelegate, BKFaceDetectOperationDelegate, CARSessionObserving, OS_dispatch_source;
...
-(void)setCarplayStateFromNotification:(BOOL)arg0 ;
...
-(void)updateSuppressedMaskWithDisplayState:(BOOL)arg0 smartCoverClosed:(BOOL)arg1 carPlayConnected:(BOOL)arg2 ;
