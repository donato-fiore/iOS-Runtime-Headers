...
typedef struct CV3DPlaneDetectionSingleShotPlaneList {
} // Error Processing Struct Fields
...
typedef struct Matrix<short, 3U, 1U, false> {
    short m_data;
} Matrix<short, 3U, 1U, false>;
...
typedef struct ChunkMesh {
    Matrix<short, 3U, 1U, false> chunk_position;
...
typedef struct array<unsigned char, 16UL> {
    unsigned char field0;
} array<unsigned char, 16UL>;

typedef struct array<float __attribute__((ext_vector_type(3))), 4UL> {
} // Error Processing Struct Fields
...
typedef struct ARTexturedPlane {
    array<unsigned char, 16UL> field0;
    NSUInteger field1;
    ? field2;
    array<float __attribute__((ext_vector_type(3))), 4UL> field3;
...
typedef struct CV3DReconPointCloud {
} // Error Processing Struct Fields
...
typedef struct Matrix<float, 9U, 1U, false> {
    float m_data;
} Matrix<float, 9U, 1U, false>;

typedef struct optional<cva::Matrix<float, 9, 1, false>> {
    unk ;
    char __null_state_;
    Matrix<float, 9U, 1U, false> __val_;
    BOOL __engaged_;
...
typedef struct Matrix<float, 2U, 16U, false> {
    float m_data;
} Matrix<float, 2U, 16U, false>;

typedef struct Matrix<float, 3U, 16U, false> {
    float m_data;
} Matrix<float, 3U, 16U, false>;

typedef struct Matrix<float, 3U, 3U, false> {
    float m_data;
} Matrix<float, 3U, 3U, false>;
...
typedef struct RegistrationData {
    Matrix<float, 2U, 16U, false> image_points;
    Matrix<float, 3U, 16U, false> lifted_points;
    Matrix<float, 3U, 3U, false> intrinsics;
...
typedef struct array<arkit::btr::RegistrationData, 5UL> {
    RegistrationData __elems_;
} array<arkit::btr::RegistrationData, 5UL>;
...
typedef struct __compressed_pair<std::shared_ptr<const CV3DSLAMStateContext> *, std::allocator<std::shared_ptr<const CV3DSLAMStateContext>>> {
    void __value_;
} __compressed_pair<std::shared_ptr<const CV3DSLAMStateContext> *, std::allocator<std::shared_ptr<const CV3DSLAMStateContext>>>;

typedef struct vector<std::shared_ptr<const CV3DSLAMStateContext>, std::allocator<std::shared_ptr<const CV3DSLAMStateContext>>> {
    void __begin_;
    void __end_;
    __compressed_pair<std::shared_ptr<const CV3DSLAMStateContext> *, std::allocator<std::shared_ptr<const CV3DSLAMStateContext>>> __end_cap_;
} vector<std::shared_ptr<const CV3DSLAMStateContext>, std::allocator<std::shared_ptr<const CV3DSLAMStateContext>>>;
