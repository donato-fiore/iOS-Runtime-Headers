...
@interface ARWorldTrackingTechnique : ARImageBasedTechnique <ARSceneReconstructionDelegate>

 {
    ...
    os_unfair_lock_s _surfaceDetectionSessionLock;
    os_unfair_lock_s _raycastSessionLock;
...
-(void)_handleSingleShotPlaneDetectionCallback:(struct CV3DPlaneDetectionSingleShotPlaneList *)arg0 ;
...
-(void)clearMap;
-(void)dealloc;
-(void)didReceiveKeyframesUpdatedCallback:(struct CV3DReconKeyframeList *)arg0 ;
...
-(void)sceneReconstructionHandler:(id)arg0 didOutputKeyframeList:(struct CV3DReconKeyframeList *)arg1 withTimestamp:(CGFloat)arg2 ;
