...
@property (readonly, nonatomic) BOOL isHiddenFromPublicDelegate; // ivar: _isHiddenFromPublicDelegate
...
-(id)initWithIdentifier:(id)arg0 transform:(struct ? )arg1 name:(id)arg2 hiddenFromPublicDelegate:(BOOL)arg3 ;
-(id)initWithName:(id)arg0 transform:(struct ? )arg1 ;
-(id)initWithTransform:(struct ? )arg0 ;
-(void)_commonInit:(id)arg0 transform:(struct ? )arg1 name:(id)arg2 ;
