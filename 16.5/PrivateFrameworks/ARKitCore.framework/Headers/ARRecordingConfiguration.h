...
@protocol ARRecordingTechniqueDelegate, ARRecordingTechniqueProtocol;
...
@property (retain, nonatomic) NSObject<ARRecordingTechniqueProtocol> *recordingTechnique; // ivar: _recordingTechnique
