...
@interface ARMLImageTransform : NSObject {
    ...
    *OpaqueVTPixelTransferSession _conversionSession;
    *OpaqueVTPixelTransferSession _scalingSession;
    *OpaqueVTPixelRotationSession _rotationSession;
    *__CVPixelBufferPool _conversionBufferPool;
    *__CVPixelBufferPool _scaledBufferPool;
...
-(id)initWithScaledSize:(struct CGSize )arg0 useOptimalMSRCoefficients:(BOOL)arg1 useExplicitBGRAConversion:(BOOL)arg2 ;
