...
-(id)initWithVertices:(struct vector<float __attribute__((ext_vector_type(3))), std::allocator<float __attribute__((ext_vector_type(3)))>> )arg0 triangleIndices:(struct vector<short, std::allocator<short>> )arg1 boundaryVertexCount:(NSUInteger)arg2 centerextent;
