...
@protocol HMFLogging, HMDMediaDestinationControllerLocalDataStorageHandler, HMDMediaDestinationLocalDataStorageHandler, HMDMediaGroupsAggregatorBackupReceiverDelegate, HMDMediaGroupsBackupLocalDataStorageHandler, OS_os_log, HMDMediaGroupParticipantLocalDataStorageDataSource, HMEEventForwarder, HMELastEventStoreReadHandle, HMDFeaturesDataSource;
...
-(id)logIdentifier;
-(id)migratedParticipantData:(id)arg0 withDestinationSupportOptions:(NSUInteger)arg1 ;
-(id)participantData;
...
-(void)migrateWithExpectedDestinationControllerSupportOptions:(NSUInteger)arg0 ;
-(void)migrateWithExpectedDestinationSupportOptions:(NSUInteger)arg0 ;
