...
@class NSUUID, NSString, HMFMessageDispatcher, NSNotificationCenter, HMEMessageDatagramServer, NSMutableDictionary, NSMutableArray;
...
-(void)_handleUserPrivilegeChange:(id)arg0 ;
-(void)_registerForAccessoryMessages:(id)arg0 ;
-(void)_registerForMessages:(id)arg0 withHome:(id)arg1 ;
-(void)configureWithHome:(id)arg0 isPrimaryResident:(BOOL)arg1 isResidentEventProviding:(BOOL)arg2 additionalPolicies:(id)arg3 ;
-(void)handleHomeUserRemovedNotification:(id)arg0 ;
-(void)handlePrimaryResidentIsCurrentDeviceChangeNotification:(id)arg0 ;
-(void)logMetricsForLiveEvents:(id)arg0 cachedEvents:(id)arg1 destinationDevice:(id)arg2 destinationDeviceIdentifier:(id)arg3 responseMessageType:(NSUInteger)arg4 ;
-(void)refreshConnections:(id)arg0 ;
...
-(void)server:(id)arg0 connectionDidFail:(id)arg1 ;
-(void)server:(id)arg0 logMetricsForEventTopic:(id)arg1 eventSize:(NSUInteger)arg2 isCached:(BOOL)arg3 ;
-(void)server:(id)arg0 logMetricsForMessageDatagramFragmentation:(BOOL)arg1 isFragmented:(BOOL)arg2 ;
