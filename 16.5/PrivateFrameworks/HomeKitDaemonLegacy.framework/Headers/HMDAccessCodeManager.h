...
-(id)_addNewAccessCode:(id)arg0 forUserWithUUID:(id)arg1 toAccessoriesWithUUIDs:(id)arg2 withRetries:(BOOL)arg3 ;
-(id)_createNewAccessCodeForUserWithUUID:(id)arg0 ;
-(id)_removeAccessCode:(id)arg0 forUser:(id)arg1 removedByUserUUID:(id)arg2 ;
-(id)_removeAccessCode:(id)arg0 forUserBeingRemoved:(id)arg1 ;
-(id)_removeAccessCode:(id)arg0 forUserWithUUID:(id)arg1 removedByUserUUID:(id)arg2 ;
-(id)_removeAccessCodeFromAccessoriesKeepingiCloudDataUponFailure:(id)arg0 forUserUUID:(id)arg1 ;
...
-(id)_updateModificationRequestsWithUserOrGuestNames:(id)arg0 ;
...
-(void)handleUserAccessCodeDidChangeMessage:(id)arg0 ;
