...
@protocol HMFLogging, HMBLocalZoneDelegate, HMBCloudZoneDelegate, HMBLocalZoneModelObserver, HMDCharacteristicsAvailabilityListenerDelegate, HMDDatabaseZoneManagerDataSource, HMDDatabaseZoneManagerDelegate, HMFMessageReceiver, HMDCameraProfileSettingsManagerDelegate, OS_dispatch_queue;
...
@property BOOL needsInitialSettingsCharacteristicSynchronization; // ivar: _needsInitialSettingsCharacteristicSynchronization
...
-(void)_coordinateNotificationSettingsWithServiceBulletinNotification:(id)arg0 ;
...
-(void)_synchronizeCurrentAccessModeSettingToCameraWithCompletion:(id)arg0 ;
-(void)_synchronizeSettingsModelForBackwardCompatibilityForCharacteristic:(id)arg0 ;
...
-(void)remove;
-(void)start;
-(void)synchronizeSettingsToCameraWithCompletion:(id)arg0 ;
