...
+(id)logCategory;
+(id)lookForCharacteristicByAccessoryUUID:(id)arg0 serviceID:(id)arg1 characteristicID:(id)arg2 inHome:(id)arg3 checkForSupport:(BOOL)arg4 outError:(*id)arg5 shouldLog:(BOOL)arg6 ;
