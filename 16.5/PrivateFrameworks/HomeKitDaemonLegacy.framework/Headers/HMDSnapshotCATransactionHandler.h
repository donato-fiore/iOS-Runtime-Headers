...
+(id)logCategory;
+(id)sharedHandler;
-(id)_createSlotWithFilePath:(id)arg0 snapshotCATransaction:(id)arg1 ;
-(id)createSlotWithFilePath:(id)arg0 ;
-(id)init;
-(struct CGImage *)createSnapshotCGImageRef:(id)arg0 ;
-(void)_backboardServicesRelaunched;
-(void)_createSnapshotContext;
-(void)_deleteSlotWithIdentifier:(id)arg0 filePath:(id)arg1 snapshotCATransaction:(id)arg2 ;
-(void)clearSlotWithIdentifier:(id)arg0 ;
-(void)deleteSlotWithIdentifier:(id)arg0 filePath:(id)arg1 ;
-(void)fillSlotWithIdentifier:(id)arg0 filePath:(id)arg1 ;
