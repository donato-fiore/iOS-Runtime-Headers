...
@property (getter=isConfigured) BOOL configured; // ivar: _configured
...
-(id)logIdentifier;
-(void)_requestShareInvitationDataFromUser:(id)arg0 retryCount:(NSUInteger)arg1 activity:(id)arg2 ;
