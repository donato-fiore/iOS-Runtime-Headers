...
@property (readonly, nonatomic) NSInteger msgQoS; // ivar: _msgQoS
...
+(id)receivedRemoteMessage:(id)arg0 identifier:(id)arg1 transactionIdentifier:(id)arg2 messageType:(NSInteger)arg3 peerInformation:(id)arg4 secure:(BOOL)arg5 transportType:(int)arg6 messageQoS:(NSInteger)arg7 ;
+(id)receivedRemoteMessage:(id)arg0 transportType:(int)arg1 ;
+(id)sendingRemoteMessage:(id)arg0 identifier:(id)arg1 transactionIdentifier:(id)arg2 messageType:(NSInteger)arg3 peerInformation:(id)arg4 secure:(BOOL)arg5 transportType:(int)arg6 messageQoS:(NSInteger)arg7 ;
+(id)sendingRemoteMessage:(id)arg0 transportType:(int)arg1 ;
-(id)initWithRemoteMessage:(id)arg0 identifier:(id)arg1 transactionIdentifier:(id)arg2 messageType:(NSInteger)arg3 peerInformation:(id)arg4 secure:(BOOL)arg5 transportType:(int)arg6 sending:(BOOL)arg7 messageQoS:(NSInteger)arg8 ;
