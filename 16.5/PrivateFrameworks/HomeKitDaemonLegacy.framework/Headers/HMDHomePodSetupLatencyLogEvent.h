...
-(id)initWithSetupStartTime:(NSUInteger)arg0 setupEndTime:(NSUInteger)arg1 settingsCreationTime:(NSUInteger)arg2 pairingIdentityCreationTime:(NSUInteger)arg3 accessoryAddProcessedTime:(NSUInteger)arg4 siriReadinessTime:(NSUInteger)arg5 ;
