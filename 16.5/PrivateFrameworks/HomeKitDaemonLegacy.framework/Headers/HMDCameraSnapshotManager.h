...
+(id)logCategory;
+(void)cleanStaleSnapshotDirectoriesUsingCurrentAccessories:(id)arg0 ;
...
-(id)initWithAccessory:(id)arg0 workQueue:(id)arg1 streamSnapshotHandler:(id)arg2 uniqueIdentifier:(id)arg3 msgDispatcher:(id)arg4 networkMonitor:(id)arg5 logIdentifier:(id)arg6 imageCacheDirectory:(id)arg7 residentMessageHandler:(id)arg8 snapshotSlotManager:(id)arg9 dataSource:(id)arg10 ;
-(void)_handleCreateSnapshotFromBulletinContextMessage:(id)arg0 ;
-(void)_handleFillSnapshotSlotMessage:(id)arg0 ;
-(void)_handleReleaseSnapshotMessage:(id)arg0 ;
-(void)_handleRemoteSnapshotReceivedMessage:(id)arg0 ;
-(void)_handleTakeRemoteSnapshotFailureMessage:(id)arg0 ;
-(void)_handleTakeRemoteSnapshotMessage:(id)arg0 ;
-(void)_handleTakeSnapshotMessage:(id)arg0 ;
-(void)dealloc;
-(void)handleAccessoryUnconfigured:(id)arg0 ;
-(void)handleCameraSettingsDidChangeNotification:(id)arg0 ;
-(void)registerForMessages;
-(void)releaseSnapshotWithSlotIdentifier:(id)arg0 ;
