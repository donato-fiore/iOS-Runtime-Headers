...
+(BOOL)isAdminPrivilegeRequiredForWritingCharacteristicType:(id)arg0 serviceType:(id)arg1 ;
+(BOOL)isHomedVersionSupported:(id)arg0 ;
+(BOOL)isOwnerPrivilegeRequiredForWritingCharacteristicType:(id)arg0 serviceType:(id)arg1 ;
...
+(void)updateLocalMetadataWithMetadata:(id)arg0 ;
...
-(BOOL)disallowsAssistantServiceType:(id)arg0 characteristicType:(id)arg1 ;
