...
@property (copy, nonatomic) NSNumber *supportsAudioAnalysis; // ivar: _supportsAudioAnalysis
...
@property (copy, nonatomic) NSNumber *supportsDropIn; // ivar: _supportsDropIn
