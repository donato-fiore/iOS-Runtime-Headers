...
@class HMFObject, HMFActivity, NSUUID, NSString, NSError;
...
@property NSUInteger endTime; // ivar: _endTime
...
@property (readonly) id *upSecondsFactory; // ivar: _upSecondsFactory
...
-(id)initWithIdentifier:(id)arg0 role:(NSInteger)arg1 homeManager:(id)arg2 upSecondsFactory:(id)arg3 ;
-(id)logIdentifier;
