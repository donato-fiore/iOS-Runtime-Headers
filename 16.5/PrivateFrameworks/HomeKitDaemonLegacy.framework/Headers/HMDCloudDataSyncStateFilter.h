...
@protocol HMFMessageReceiver, HMFTimerDelegate, HMFLogging, OS_dispatch_source, OS_dispatch_queue;
...
@property BOOL hasHH2MigrationAlreadyRequested; // ivar: _hasHH2MigrationAlreadyRequested
@property (readonly) NSUInteger hash;
@property (weak, nonatomic) HMDHomeManager *homeManager; // ivar: _homeManager
@property (getter=isHomeManagerFirstFetchFinished) BOOL homeManagerFirstFetchFinished; // ivar: _homeManagerFirstFetchFinished
...
-(void)moveDirectlyToHH2IfAccountOnlyHasUpgradedSharedHomesAllowEmptyOwnedHomes:(BOOL)arg0 ;
-(void)resetConfiguration;
-(void)startDataConfigResetTimers;
-(void)timerDidFire:(id)arg0 ;
-(void)totalHomesInCloudZones:(id)arg0 ;
