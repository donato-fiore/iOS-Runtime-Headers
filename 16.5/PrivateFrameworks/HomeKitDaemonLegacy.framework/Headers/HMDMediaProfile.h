...
@protocol HMFLogging, HMEEventForwarder;
...
-(id)parseAndSetPlaybackStateFromResponsePayload:(id)arg0 mediaSessionState:(id)arg1 outDidUpdateMediaSessionState:(*BOOL)arg2 ;
