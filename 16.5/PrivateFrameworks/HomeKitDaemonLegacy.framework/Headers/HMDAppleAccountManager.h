...
@class HMFObject, HMFExponentialBackoffTimer, ACAccountStore, NSString, HMFTimer, NSUUID, NSNotificationCenter, NSData;
...
@property (retain, nonatomic) HMDWatchManager *watchManager; // ivar: _watchManager


+(id)logCategory;
+(id)sharedManager;
-(BOOL)isCurrentDeviceDataOwnerForDevice:(id)arg0 ;
-(BOOL)isDeviceLocallyPairedWatch:(id)arg0 ;
