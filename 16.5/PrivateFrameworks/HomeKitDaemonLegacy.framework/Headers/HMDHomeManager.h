...
@property (retain, nonatomic) HMDHH1IDSInvitationManager *idsInvitationManager; // ivar: _idsInvitationManager
...
-(void)_determineEmptyHomesForOwnersWithCompletionHandler:(id)arg0 ;
...
-(void)_fetchHasOnlyEmptyHomesWithCompletion:(id)arg0 ;
...
-(void)_findCloudHomeZonesToIgnore:(id)arg0 ;
-(void)_findRemotePeerContainingAccessories:(id)arg0 forHome:(id)arg1 ;
-(void)_findZoneInformationWithoutHome:(id)arg0 ;
...
-(void)_loadHomeZonesFromCache:(id)arg0 completion:(id)arg1 ;
...
-(void)checkAndMoveDirectlyToHH2IfOnlyHH2SharedHomesExistAllowEmptyOwnedHomes:(BOOL)arg0 ;
...
-(void)determineEmptyHomesForSharedUsersWithCompletionHandler:(id)arg0 ;
...
-(void)fetchHasOnlyEmptyHomesWithCompletion:(id)arg0 ;
