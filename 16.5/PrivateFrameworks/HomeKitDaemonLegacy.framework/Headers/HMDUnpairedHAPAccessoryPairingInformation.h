...
@class HMFObject, NSString, NSUUID, HMFActivity, HMFTimer, HAPAccessoryPairingRequest, NSData;
...
@property (retain, nonatomic) NSData *setupAuthToken; // ivar: _setupAuthToken
@property (retain, nonatomic) NSUUID *setupAuthTokenUUID; // ivar: _setupAuthTokenUUID
