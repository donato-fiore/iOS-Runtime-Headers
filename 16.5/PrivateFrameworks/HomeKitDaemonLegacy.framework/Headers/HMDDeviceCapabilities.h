...
@protocol HMDBackingStoreObjectProtocol, HMDBackingStoreModelBackedObjectProtocol, HMFLogging, HMAccessoryCapabilities, HMResidentCapabilities, NSCopying, NSSecureCoding;
...
@property (nonatomic, getter=isMessagedHomePodSettingsFeatureEnabled) BOOL messagedHomePodSettingsFeatureEnabled; // ivar: _messagedHomePodSettingsFeatureEnabled
...
@property (readonly, nonatomic) BOOL supportsAudioAnalysis; // ivar: _supportsAudioAnalysis
...
@property (readonly, nonatomic) BOOL supportsDropIn; // ivar: _supportsDropIn
...
-(id)initWithProductInfo:(id)arg0 mobileGestaltClient:(id)arg1 ;
-(id)initWithProductInfo:(id)arg0 mobileGestaltClient:(id)arg1 homekitVersion:(id)arg2 ;
