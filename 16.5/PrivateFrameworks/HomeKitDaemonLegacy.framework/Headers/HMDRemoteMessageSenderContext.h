...
@property (copy) HMDDeviceHandle *localDeviceHandle; // ivar: _localDeviceHandle
@property (readonly, copy) NSString *mergeID;
@property (readonly, copy) NSString *pairingIdentityIdentifier; // ivar: _pairingIdentityIdentifier
...
-(id)initWithDeviceHandle:(id)arg0 accountHandle:(id)arg1 accountIdentifier:(id)arg2 deviceVersion:(id)arg3 pairingIdentityIdentifier:(id)arg4 ;
