...
+(id)logCategory;
+(id)zoneNameForHomeUUID:(id)arg0 ;
-(id)dumpStateInfo;
...
-(void)accessorySettingsLocalMessageHandler:(id)arg0 didReceiveFetchRequestMessage:(id)arg1 withHomeUUID:(id)arg2 accessoryUUID:(id)arg3 keyPaths:(id)arg4 callerVersion:(id)arg5 callerPrivilege:(NSUInteger)arg6 siriAvailableLanguagesSetting:(id)arg7 ;
-(void)accessorySettingsLocalMessageHandler:(id)arg0 didReceiveUpdateRequestMessage:(id)arg1 withHomeUUID:(id)arg2 accessoryUUID:(id)arg3 keyPath:(id)arg4 value:(id)arg5 callerVersion:(id)arg6 ;
