...
@protocol HMFLogging, HMDWalletPassLibrary, HMDWalletPassLibraryDelegate, OS_dispatch_queue;
...
+(id)logCategory;
-(BOOL)isExpressModeEnabledForPassUniqueIdentifier:(id)arg0 serialNumber:(id)arg1 ;
