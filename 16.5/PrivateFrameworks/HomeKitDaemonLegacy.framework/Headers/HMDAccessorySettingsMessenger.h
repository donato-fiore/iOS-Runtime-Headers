...
-(id)initWithMessageTargetUUID:(id)arg0 messageDispatcher:(id)arg1 messageRouter:(id)arg2 messageHandler:(id)arg3 logEventSubmitter:(id)arg4 legacyMessageReceiver:(id)arg5 ;
