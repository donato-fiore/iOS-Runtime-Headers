...
-(id)_faceRecognitionSignificantEventForAnalyzerEvent:(id)arg0 dateOfOccurrence:(id)arg1 heroFrameData:(id)arg2 timeOffsetWithinClip:(CGFloat)arg3 confidenceLevel:(NSUInteger)arg4 ;
