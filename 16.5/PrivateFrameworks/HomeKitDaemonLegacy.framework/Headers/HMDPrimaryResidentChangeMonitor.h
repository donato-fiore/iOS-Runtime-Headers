...
@property (copy) NSUUID *confirmedPrimaryResidentDeviceIdentifier; // ivar: _confirmedPrimaryResidentDeviceIdentifier
@property (weak) NSObject<HMDPrimaryResidentChangeMonitorDataSource> *dataSource; // ivar: _dataSource
@property (readonly, copy) NSString *debugDescription;
@property (readonly, copy) NSString *description;
@property BOOL hasResidentDevices; // ivar: _hasResidentDevices
...
-(void)refreshConfirmedPrimaryResidentDeviceIdentifierWithDevice:(id)arg0 ;
-(void)refreshCurrentDevicePrimaryResidentWithDevice:(id)arg0 ;
