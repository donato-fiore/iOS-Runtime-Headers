...
@class PLAgent, PLXPCListenerOperatorComposition, PLCFNotificationOperatorComposition;



@interface PLConfigAgent : PLAgent

@property (readonly) PLXPCListenerOperatorComposition *continuityCameraNotification; // ivar: _continuityCameraNotification
...
-(void)log;
-(void)logConfigEntry:(id)arg0 ;
-(void)logEntryToCA:(id)arg0 ;
-(void)logEventForwardContinuityCamera:(id)arg0 ;
