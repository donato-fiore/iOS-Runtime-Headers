...
-(void)log;
-(void)logEventBackwardCMCrabsWithEntry:(id)arg0 withProcess:(id)arg1 ;
-(void)logEventBackwardCMFileWithEntry:(id)arg0 withProcess:(id)arg1 ;
-(void)logEventBackwardCMHlsWithEntry:(id)arg0 withProcess:(id)arg1 ;
