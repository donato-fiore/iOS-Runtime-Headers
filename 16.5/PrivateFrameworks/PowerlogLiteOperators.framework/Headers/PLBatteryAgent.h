...
@class PLAgent, PLTimer, NSNumber, PLXPCListenerOperatorComposition, AVSystemController, PLXPCResponderOperatorComposition, PLEntryNotificationOperatorComposition, PLCFNotificationOperatorComposition, PLSemaphore, PLIOKitOperatorComposition, NSString, NSDate, PLEntry, NSDictionary, NSMutableDictionary, PLMonotonicTimer, PLNSNotificationOperatorComposition, NSMutableArray;
...
@property (retain) NSNumber *TLCOverrideValue; // ivar: _TLCOverrideValue
@property (retain) PLXPCListenerOperatorComposition *UPOStepperListener; // ivar: _UPOStepperListener
@property int aggregatedTimeTLC; // ivar: _aggregatedTimeTLC
@property BOOL allowGasGaugeRead; // ivar: _allowGasGaugeRead
@property (retain) AVSystemController *avSystemController; // ivar: _avSystemController
@property (retain) PLXPCResponderOperatorComposition *batteryChargingStateResponder; // ivar: _batteryChargingStateResponder
...
@property (retain) PLCFNotificationOperatorComposition *batteryUIVisitNotification; // ivar: _batteryUIVisitNotification
...
@property BOOL cameraStreamingActive; // ivar: _cameraStreamingActive
...
@property (retain) NSString *chargingIntervalsEntryKey; // ivar: _chargingIntervalsEntryKey
@property BOOL cleanEnergyChargingEngaged; // ivar: _cleanEnergyChargingEngaged
@property (retain) PLXPCListenerOperatorComposition *cleanEnergyChargingListener; // ivar: _cleanEnergyChargingListener
...
@property BOOL demoMode; // ivar: _demoMode
...
@property BOOL isTLCNotificationSurfaced; // ivar: _isTLCNotificationSurfaced
...
@property (retain) NSNumber *lastTLCCounter; // ivar: _lastTLCCounter
@property (retain) NSDate *lastTLCEntryStartTime; // ivar: _lastTLCEntryStartTime
...
@property (retain) NSNumber *lastVacVoltageLimit; // ivar: _lastVacVoltageLimit
...
@property (retain) NSMutableDictionary *openChargingIntervals; // ivar: _openChargingIntervals
...
@property BOOL smartChargingEngaged; // ivar: _smartChargingEngaged
...
@property BOOL tlcIncreased; // ivar: _tlcIncreased
@property (retain) PLCFNotificationOperatorComposition *tlcOverrideNotification; // ivar: _tlcOverrideNotification
...
-(void)handleCameraStreaming:(BOOL)arg0 withProperties:(id)arg1 ;
-(void)handleCameraStreamingLogging:(id)arg0 ;
-(void)handleMitigationStateCallback:(int)arg0 ;
-(void)handlePPMCallback;
-(void)handleSBC;
-(void)handleTLCNotification:(id)arg0 externalConnected:(BOOL)arg1 ;
...
-(void)logEventForwardCalibration0InfowithData:(id)arg0 ;
-(void)logEventForwardCalibration0withData:(id)arg0 ;
-(void)logEventForwardCleanEnergyChargingWithPayload:(id)arg0 ;
...
-(void)logEventPointBatteryPanicShutdown:(id)arg0 ;
-(void)logEventPointBatteryShutdown;
-(void)logEventPointBatteryTrapInfo:(id)arg0 ;
...
-(void)showOrHideTLCNotification:(BOOL)arg0 timeInTLC:(CGFloat)arg1 ;
-(void)updateCurrentSenseMonitorStatusWithEntry:(id)arg0 ;
-(void)updateIntervalForType:(short)arg0 withState:(BOOL)arg1 andTime:(id)arg2 ;
