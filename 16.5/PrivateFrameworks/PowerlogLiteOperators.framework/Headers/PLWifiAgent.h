...
@class PLAgent, PLEntryNotificationOperatorComposition, PLCFNotificationOperatorComposition, PLXPCListenerOperatorComposition, PLNSNotificationOperatorComposition, NSString, NSDate;
...
@property (retain) PLXPCListenerOperatorComposition *remoteControlSessionListener; // ivar: _remoteControlSessionListener
...
-(void)log;
-(void)logAWDLStateEntry:(id)arg0 ;
...
-(void)logEventPointRemoteControlSession:(id)arg0 ;
