...
@class PLAgent, PLXPCListenerOperatorComposition, PLNSNotificationOperatorComposition, PLEntryNotificationOperatorComposition, NSDate, NSDictionary, PLMonotonicTimer, PLXPCResponderOperatorComposition, NSMutableSet, PLThreadStats;
...
@property (retain) NSDictionary *lastCPUTimeDict; // ivar: _lastCPUTimeDict
...
@property (retain) PLXPCResponderOperatorComposition *memoryKillsResponder; // ivar: _memoryKillsResponder
...
-(id)fetchSnapshotWithFlags:(unsigned int)arg0 ;
-(id)getFrozenProcesses;
-(id)getJSEIdleTime;
-(id)getJetsamSnapshotEntries:(struct jetsam_snapshot *)arg0 ;
-(id)getProcessExits:(id)arg0 ;
-(id)getProcessName:(char *)arg0 ;
-(id)getProcessesNotInFreezer:(id)arg0 withCurrentProcesses:(id)arg1 ;
-(id)init;
-(id)ledgerDataAtIndex:(int)arg0 forPid:(NSInteger)arg1 ;
-(id)processMonitorMultiKeyFromProcessID:(int)arg0 ;
...
-(void)getCpuUsageAndMemoryForPid:(int)arg0 withBuffer:(*void)arg1 withNewProcessArray:(id)arg2 withTotalCpu:(*NSUInteger)arg3 withActiveProcesses:(id)arg4 ;
-(void)initOperatorDependancies;
-(void)initTaskOperatorDependancies;
-(void)initializeThreadStatsLogging;
-(void)log;
-(void)logEventBackwardAppLaunchTimeSeries:(id)arg0 ;
...
-(void)logEventPointProcessExit:(id)arg0 excludeProcesses:(id)arg1 withStats:(struct ? *)arg2 withDate:(id)arg3 withNowInSec:(NSUInteger)arg4 ;
-(void)logEventPointProcessSnapshot;
-(void)logEventPointSharedCacheReslid:(int)arg0 ;
