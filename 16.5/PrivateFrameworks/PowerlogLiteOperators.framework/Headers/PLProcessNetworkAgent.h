...
@class PLAgent, PLEntryNotificationOperatorComposition, PLCFNotificationOperatorComposition, PLXPCListenerOperatorComposition, NSDate, NSDictionary, PLMonotonicTimer, NSMutableSet, PLNSNotificationOperatorComposition, UsageFeed;
...
@property NSUInteger curNetworkBitmapTimestampForSysdiagnoseTrigger; // ivar: _curNetworkBitmapTimestampForSysdiagnoseTrigger
...
@property (retain) PLNSNotificationOperatorComposition *sysdiagnoseListener; // ivar: _sysdiagnoseListener
...
-(void)getNetWorkBitmapForEndTime:(NSUInteger)arg0 andSysdiagnoseTrigger:(BOOL)arg1 ;
