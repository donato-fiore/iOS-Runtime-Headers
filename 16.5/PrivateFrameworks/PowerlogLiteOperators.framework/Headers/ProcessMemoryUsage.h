...
@property (retain) NSString *coalitionLaunchdName; // ivar: _coalitionLaunchdName
@property NSUInteger interval_peak_phys_footprint; // ivar: _interval_peak_phys_footprint
