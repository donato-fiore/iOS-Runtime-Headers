...
@property (readonly, nonatomic) NSInteger predictionPrimarySource; // ivar: _predictionPrimarySource
...
-(id)initWithStartMean:(CGFloat)arg0 startStandardDeviation:(CGFloat)arg1 endMean:(CGFloat)arg2 endStandardDeviation:(CGFloat)arg3 allDays:(struct ? )arg4 partiallyLogged:(BOOL)arg5 daysOffsetFromCalendarMethod:(NSInteger)arg6 predictionPrimarySource:(NSInteger)arg7 ;
