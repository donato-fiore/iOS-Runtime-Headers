...
@property (readonly, nonatomic) NSInteger minimumBufferDuration; // ivar: _minimumBufferDuration
...
-(id)_initWithDataSource:(id)arg0 analysisProvider:(id)arg1 maximumActiveDuration:(NSInteger)arg2 minimumBufferDuration:(NSInteger)arg3 prefetchDuration:(NSInteger)arg4 shouldFetchCycleFactors:(BOOL)arg5 calendarCache:(id)arg6 queue:(id)arg7 ;
...
-(id)initWithHealthStore:(id)arg0 analysisProvider:(id)arg1 maximumActiveDuration:(NSInteger)arg2 minimumBufferDuration:(NSInteger)arg3 shouldFetchCycleFactors:(BOOL)arg4 calendarCache:(id)arg5 ;
-(id)initWithHealthStore:(id)arg0 analysisProvider:(id)arg1 maximumActiveDuration:(NSInteger)arg2 minimumBufferDuration:(NSInteger)arg3 shouldFetchCycleFactors:(BOOL)arg4 calendarCache:(id)arg5 queue:(id)arg6 ;
