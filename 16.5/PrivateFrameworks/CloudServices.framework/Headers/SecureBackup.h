...
@class NSString, NSUUID, NSDate, NSData, NSDictionary, NSError, EscrowPrerecord, NSNumber;
...
@property (readonly, nonatomic) NSString *activityLabel; // ivar: _activityLabel
...
@property (nonatomic) BOOL nonViableRepair; // ivar: _nonViableRepair
...
-(BOOL)isRecoveryKeySet:(*id)arg0 ;
-(BOOL)requiresDoubleEnrollment;
-(BOOL)restoreKeychainWithBackupPassword:(id)arg0 error:(*id)arg1 ;
...
-(id)srpRecoveryBlobFromSRPInitResponse:(id)arg0 error:(*id)arg1 ;
