...
-(void)filteredImageFromImage:(struct CGImage *)arg0 filterInfo:(id)arg1 size:(struct CGSize )arg2 contentsScale:(CGFloat)arg3 waitForCPUSynchronization:(BOOL)arg4 logKey:(id)arg5 completion:(id)arg6 ;
