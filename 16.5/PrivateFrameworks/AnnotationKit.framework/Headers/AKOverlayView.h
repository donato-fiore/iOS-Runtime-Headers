...
@class UIView, NSString, UIScrollView, UIPointerInteraction, NSMutableDictionary;
...
@property (retain, nonatomic) NSMutableDictionary *pointerRegionToHandleViewDict; // ivar: _pointerRegionToHandleViewDict
@property BOOL scrollViewIsInLiveMagnify; // ivar: _scrollViewIsInLiveMagnify
@property (readonly) Class superclass;


+(void)initialize;
-(BOOL)_hasResizeHandleAtLocation:(struct CGPoint )arg0 ;
...
-(id)_liftOffHandleViewForRegion:(id)arg0 ;
-(id)_liftOffHandleViewInFrame:(struct CGRect )arg0 withPointStyle:(NSUInteger)arg1 ;
...
-(struct CGRect )_findResizeHandleRectAtLocation:(struct CGPoint )arg0 withVisualStyle:(*id)arg1 ;
...
-(void)_addLiftOffHandleViewForRegion:(id)arg0 ;
...
-(void)_removeLiftOffHandleViewForRegion:(id)arg0 ;
