...
@class NSTextStorage, NSString, UIColor, NSDictionary;
...
@property (getter=isHighlighted) BOOL highlighted; // ivar: _highlighted
@property BOOL isEditingText;
@property NSUInteger maximumNumberOfCharacters; // ivar: _maximumNumberOfCharacters
