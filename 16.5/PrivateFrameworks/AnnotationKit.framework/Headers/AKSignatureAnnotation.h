...
#ifndef AKSIGNATUREANNOTATION_H
#define AKSIGNATUREANNOTATION_H

@class NSString, UIColor;
@protocol AKRectangularAnnotationProtocol, AKRotatableAnnotationProtocol;
...
@property (retain) AKSignature *signature; // ivar: _signature
