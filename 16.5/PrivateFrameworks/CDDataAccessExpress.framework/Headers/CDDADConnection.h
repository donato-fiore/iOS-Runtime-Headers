...
-(BOOL)resumeWatchingFoldersWithSyncKeyMap:(id)arg0 forAccountID:(id)arg1 ;
...
-(BOOL)watchFoldersWithSyncKeyMap:(id)arg0 forAccountID:(id)arg1 persistent:(BOOL)arg2 ;
...
-(void)removeStoresForAccountWithID:(id)arg0 ;
