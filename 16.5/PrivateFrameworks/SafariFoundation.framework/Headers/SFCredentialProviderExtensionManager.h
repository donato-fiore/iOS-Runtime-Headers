...
@class NSSet, NSMutableOrderedSet, NSHashTable, NSString, NSExtension;
@protocol WBSDeallocationSentinelObserver, OS_dispatch_queue;
...
-(id)init;
-(void)_addObserverOnInternalQueue:(id)arg0 shouldHoldWeakly:(BOOL)arg1 ;
