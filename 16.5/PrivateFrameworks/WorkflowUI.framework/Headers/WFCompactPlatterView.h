...
@protocol WFCompactTitledPlatterViewDelegate, MTVisualStylingProviding, WFCompactAppearanceProvider, WFCompactPlatterContentClippingDelegate, WFCompactPlatterSizingDelegate;
