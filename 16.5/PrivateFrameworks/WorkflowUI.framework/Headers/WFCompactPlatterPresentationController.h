...
+(struct CGRect )presentedViewFrameInContainerView:(id)arg0 containerViewSize:(struct CGSize )arg1 withSizeCalculation:(BOOL)arg2 ofPresentedPlatter:(id)arg3 ;
+(struct CGRect )usableFrameForPresentingInContainerViewOfSize:(struct CGSize )arg0 ;
+(struct CGSize )preferredSizeForPresentingInContainerViewOfSize:(struct CGSize )arg0 ;
