...
@class UIViewController, WFActionUserInterfaceListener, NSString, UIView, MTMaterialView, WFDialogRequest, NSProgress, WFDialogAttribution, WFWorkflowRunningContext, WFDebouncer, NSTimer, WFCompactUnlockService;
@protocol WFActionUserInterfaceDelegate, WFCompactDialogViewControllerDelegate, WFCompactHostingViewControllerDelegate;
...
@property (readonly, weak, nonatomic) NSObject<WFCompactHostingViewControllerDelegate> *delegate; // ivar: _delegate
...
-(id)initWithScreenLocked:(BOOL)arg0 delegate:(id)arg1 ;
...
-(void)dismissPersistentChromeWithSuccess:(BOOL)arg0 customAttribution:(id)arg1 completionHandler:(id)arg2 ;
...
-(void)loadView;
-(void)preparePersistentChromeWithContext:(id)arg0 attribution:(id)arg1 ;
