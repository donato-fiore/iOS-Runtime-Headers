...
@class UIViewController, UIAction, WFIcon, UIImage, WFDatabase, NSString, NSMutableArray, WFEditorViewController, HMHome, NSHashTable, UIView, UIButton, UILabel, WFRunWorkflowToolbar, NSUndoManager, WFWorkflow;
...
@property (retain, nonatomic) WFIcon *cachedWorkflowIcon; // ivar: _cachedWorkflowIcon
@property (retain, nonatomic) UIImage *cachedWorkflowIconImage; // ivar: _cachedWorkflowIconImage
...
-(CGFloat)actionCanvasWidthForSwiftUIActionDrawerCoordinator:(id)arg0 ;
...
-(id)findViewInView:(id)arg0 withName:(id)arg1 ;
...
-(void)editorViewController:(id)arg0 didChangeRunningState:(BOOL)arg1 fractionCompleted:(CGFloat)arg2 isWaiting:(BOOL)arg3 ;
-(void)editorViewController:(id)arg0 didChangeVariablePickingState:(BOOL)arg1 ;
-(void)editorViewControllerDidFinishRunning:(id)arg0 cancelled:(BOOL)arg1 ;
-(void)expandDrawer;
...
-(void)searchActions;
-(void)setDocumentMenuControlWithTitle:(id)arg0 navigationItem:(id)arg1 ;
-(void)setUpToolbar;
