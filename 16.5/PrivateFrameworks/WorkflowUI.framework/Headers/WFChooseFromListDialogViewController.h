...
@class NSMutableDictionary, NSString, NSCache, UITableView, NSMutableArray;
...
@property (retain, nonatomic) NSMutableDictionary *cachedAggregateHeightsByWidth; // ivar: _cachedAggregateHeightsByWidth
