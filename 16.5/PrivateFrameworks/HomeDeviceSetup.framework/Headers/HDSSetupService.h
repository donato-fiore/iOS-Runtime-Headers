...
@class NSData, APCPlayer, RPCompanionLinkClient, SFClient, SFService, SFSession, SFSiriClient, SFSiriDeviceSetupGreetingDetails, SFDeviceOperationHandlerCDPSetup, HMDeviceSetupOperationHandler, SFDeviceOperationHandlerWiFiSetup, SFDeviceOperationHandlerCNJSetup, CUAudioPlayer, NSString, NSDate, SUICDefaultVoicePreviewer, ICCloudClient, HMHomeManager;
@protocol SignpostProviding, OS_dispatch_source, OS_dispatch_queue;
...
-(void)_cleanup;
-(void)_handleAMSTokenImportActionRequest:(id)arg0 responseHandler:(id)arg1 ;
...
-(void)_handleStartFileTransferRequest:(id)arg0 responseHandler:(id)arg1 ;
-(void)_handleVoicePreviewRequest:(id)arg0 responseHandler:(id)arg1 ;
-(void)_invalidate;
-(void)_playReadyToSetupSound;
-(void)_runHomeKitSetupMode:(id)arg0 responseHandler:(id)arg1 ;
-(void)_setSiriInfo;
...
-(void)activate;
-(void)dealloc;
-(void)fetchVoiceProfile:(id)arg0 sharedUserId:(id)arg1 locale:(id)arg2 withCompletion:(id)arg3 ;
-(void)invalidate;
