...
-(void)_writeDockAppList:(id)arg0 guardedData:(id)arg1 completionHandler:(id)arg2 ;
-(void)_writeHomeScreenPageConfigurations:(id)arg0 guardedData:(id)arg1 completionHandler:(id)arg2 ;
-(void)_writeTodayPageStacks:(id)arg0 appPredictionPanels:(id)arg1 guardedData:(id)arg2 completionHandler:(id)arg3 ;
...
-(void)layoutForAppPredictionPanel:(id)arg0 completionHandler:(id)arg1 ;
-(void)layoutForSuggestionsWidget:(id)arg0 completionHandler:(id)arg1 ;
