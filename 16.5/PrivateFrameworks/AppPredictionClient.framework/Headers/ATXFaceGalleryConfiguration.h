...
@property (readonly, nonatomic, getter=isDayZero) BOOL dayZero; // ivar: _dayZero
...
-(id)initWithSections:(id)arg0 source:(NSInteger)arg1 locale:(id)arg2 dayZero:(BOOL)arg3 ;
-(id)json;
-(id)proto;
-(id)serialize;
