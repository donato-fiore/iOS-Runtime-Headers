...
@property (copy, nonatomic) NSString *_idsCorrelationIdentifierInternal; // ivar: __idsCorrelationIdentifierInternal
...
-(void)correlationIdentifierForHandle:(id)arg0 withCompletion:(id)arg1 ;
-(void)encodeWithCoder:(id)arg0 ;
-(void)idsCorrelationIdentifierWithCompletion:(id)arg0 ;
