...
@property (readonly, copy, nonatomic) NSString *virtualInterfaceParent; // ivar: _virtualInterfaceParent
@property (readonly, nonatomic) int virtualInterfaceRole; // ivar: _virtualInterfaceRole
