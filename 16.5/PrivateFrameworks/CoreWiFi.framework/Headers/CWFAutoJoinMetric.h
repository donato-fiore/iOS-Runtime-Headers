...
@property (copy, nonatomic) CWFScanResult *associatedNetwork; // ivar: _associatedNetwork
...
@property (nonatomic) BOOL didIncludeRemainingNon2GHzChannels; // ivar: _didIncludeRemainingNon2GHzChannels
@property (nonatomic) BOOL didPerformSeamlessSSIDTransition; // ivar: _didPerformSeamlessSSIDTransition
@property (nonatomic) BOOL didTriggerReassoc; // ivar: _didTriggerReassoc
...
@property (copy, nonatomic) NSArray *followup6GHzScanChannels; // ivar: _followup6GHzScanChannels
@property (nonatomic) NSUInteger followup6GHzScanDuration; // ivar: _followup6GHzScanDuration
...
@property (copy, nonatomic) NSArray *preferredChannelList; // ivar: _preferredChannelList
...
@property (nonatomic) BOOL was6EDisabled; // ivar: _was6EDisabled
@property (nonatomic) BOOL was6EPreferOn; // ivar: _was6EPreferOn
@property (nonatomic) BOOL was6GHzDeprioritized; // ivar: _was6GHzDeprioritized
...
@property (nonatomic) BOOL wasDiscoveredViaFILSD; // ivar: _wasDiscoveredViaFILSD
@property (nonatomic) BOOL wasDiscoveredViaRNR; // ivar: _wasDiscoveredViaRNR
