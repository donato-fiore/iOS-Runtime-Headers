...
-(BOOL)__allowAlreadyPendingRequest:(id)arg0 ;
-(BOOL)__allowXPCRequestWithType:(NSInteger)arg0 error:(*id)arg1 ;
-(BOOL)__hasPendingRequestWithType:(NSInteger)arg0 ;
...
-(id)__shouldPerformPreAssociation6GHzFollowupScan:(id)arg0 ;
-(id)description;
-(id)init;
...
-(void)__perform6GHzFollowupScanAndAssociateWithParameters:(id)arg0 BSS:(id)arg1 parentXPCRequest:(id)arg2 ;
-(void)__performANQPWithParameters:(id)arg0 parentXPCRequest:(id)arg1 ;
-(void)__performFollowupANQPForPasspointScanResults:(id)arg0 combinedScanResults:(id)arg1 parameters:(id)arg2 parentXPCRequest:(id)arg3 ;
...
-(void)performSensingWithParameters:(id)arg0 requestParams:(id)arg1 reply:(id)arg2 ;
...
-(void)queryAutoJoinMetricWithRequestParams:(id)arg0 reply:(id)arg1 ;
-(void)queryAutoJoinStatisticsWithRequestParams:(id)arg0 reply:(id)arg1 ;
...
-(void)queryCountryBandSupport:(id)arg0 reply:(id)arg1 ;
...
-(void)queryDHCPServerIDWithRequestParams:(id)arg0 reply:(id)arg1 ;
-(void)queryDHCPv6ServerIDWithRequestParams:(id)arg0 reply:(id)arg1 ;
...
-(void)queryIPv4ARPResolvedHardwareAddressWithRequestParams:(id)arg0 reply:(id)arg1 ;
-(void)queryIPv4ARPResolvedIPAddressWithRequestParams:(id)arg0 reply:(id)arg1 ;
-(void)queryIPv4AddressesWithRequestParams:(id)arg0 reply:(id)arg1 ;
-(void)queryIPv4NetworkSignatureWithRequestParams:(id)arg0 reply:(id)arg1 ;
-(void)queryIPv4RouterWithRequestParams:(id)arg0 reply:(id)arg1 ;
-(void)queryIPv4SubnetMasksWithRequestParams:(id)arg0 reply:(id)arg1 ;
-(void)queryIPv6AddressesWithRequestParams:(id)arg0 reply:(id)arg1 ;
-(void)queryIPv6NetworkSignatureWithRequestParams:(id)arg0 reply:(id)arg1 ;
...
-(void)queryUserSettingsWithRequestParams:(id)arg0 reply:(id)arg1 ;
...
-(void)resetAutoJoinStatisticsWithRequestParams:(id)arg0 reply:(id)arg1 ;
-(void)resume;
...
-(void)setUserSettings:(id)arg0 properties:(id)arg1 requestParams:(id)arg2 reply:(id)arg3 ;
