...
@property (readonly) NSUInteger combinedScanChannelCount6GHz;
...
@property (nonatomic) NSUInteger followup6GHzScanChannelCount; // ivar: _followup6GHzScanChannelCount
...
@property (nonatomic) NSUInteger preAssocScanChannelCount6GHz; // ivar: _preAssocScanChannelCount6GHz
...
@property (nonatomic) NSUInteger scanChannelCount6GHz; // ivar: _scanChannelCount6GHz
