...
@property (nonatomic) NSUInteger cachedShortSSID; // ivar: _cachedShortSSID
...
@property (nonatomic) NSInteger disable6EMode;
...
@property (nonatomic) NSInteger nearbyShareableStatus;
...
@property (nonatomic) BOOL useCachedShortSSID; // ivar: _useCachedShortSSID
...
-(NSUInteger)effectiveSupportedSecurityTypes;
-(id)JSONCompatibleKeyValueMap;
-(id)__coreWiFiSpecificProperties;
-(id)__defaultProperties;
-(id)__filteredNetworkProfileWithProperties:(id)arg0 includeRequiredProperties:(BOOL)arg1 ;
