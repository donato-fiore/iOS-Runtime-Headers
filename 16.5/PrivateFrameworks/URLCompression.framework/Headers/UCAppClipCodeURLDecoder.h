...
@interface UCAppClipCodeURLDecoder : NSObject <UCAppClipCodeURLDecoding>
 ...
 {
    unique_ptr<UC::SUE::SegmentedURLDecoderImpl, std::default_delete<UC::SUE::SegmentedURLDecoderImpl>> _segmentedDecoder;
    unique_ptr<UC::SUE::PrefixedURLDecoderImpl, std::default_delete<UC::SUE::PrefixedURLDecoderImpl>> _prefixedDecoder;
    NSInteger _codingVersion;
    NSInteger _compressionVersion;
}
...
-(id)_decodeURLWithDataV0:(id)arg0 error:(*id)arg1 ;
-(id)_decodeURLWithDataV1:(id)arg0 error:(*id)arg1 ;
