...
@interface UCAppClipCodeURLEncoder : NSObject <UCAppClipCodeURLEncodingPrivate, UCAppClipCodeURLEncoding>
 ...
 {
    unique_ptr<UC::SUE::SegmentedURLEncoderImpl, std::default_delete<UC::SUE::SegmentedURLEncoderImpl>> _segmentedEncoder;
    unique_ptr<UC::SUE::PrefixedURLEncoderImpl, std::default_delete<UC::SUE::PrefixedURLEncoderImpl>> _prefixedURLEncoder;
...
-(id)encodeURLV0:(id)arg0 error:(*id)arg1 ;
-(id)encodeURLV1:(id)arg0 error:(*id)arg1 ;
