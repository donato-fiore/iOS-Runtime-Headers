...
@class UIViewController, NSDate, AFRequestCompletionOptions, UIScreen, FBSDisplayConfiguration, AFWatchdogTimer, SUICApplicationStateHelper, NSTimer, BSServiceConnection, NSArray, NSString, NSMutableDictionary, AFUISiriLanguage, UINavigationController, AFUISiriSetupViewController, AFUISiriViewController, AFQueue, AFConnection;
@protocol SASStateChangeListener, AFUISiriLanguageDelegate, AFUISiriViewControllerDelegate, AFUISiriViewControllerDataSource, AFUISiriSetupViewControllerDelegate, SASUIDeviceScreenEngagementControllerDelegate, SiriPresentationStateProviderDelegate, SiriPresentation, OS_dispatch_queue, SiriPresentationIntentUsageDelegate, SiriPresentationControllerDelegate;
...
@property (retain, nonatomic) NSMutableDictionary *deviceEngagementTimeStamps; // ivar: _deviceEngagementTimeStamps
@property (retain, nonatomic, getter=_deviceScreenEngagementController, setter=_setDeviceScreenEngagementController:) SASUIDeviceScreenEngagementController *deviceScreenEngagementController; // ivar: _deviceScreenEngagementController
...
@property (retain, nonatomic) SiriPresentationStateProvider *presentationStateProvider; // ivar: _presentationStateProvider
...
+(void)_failTestWithName:(id)arg0 andFailure:(id)arg1 ;
...
-(id)_foregroundAppInfosForUIPresentationIdentifier:(id)arg0 ;
...
-(id)getDeviceEngagementEvents:(id)arg0 forDeviceEngagementTimeWindow:(CGFloat)arg1 ;
-(id)initWithIdentifier:(NSInteger)arg0 ;
-(id)initWithIdentifier:(NSInteger)arg0 hostedPresentationFrame:(struct CGRect )arg1 ;
-(id)initWithIdentifier:(NSInteger)arg0 hostedPresentationFrame:(struct CGRect )arg1 displayConfiguration:(id)arg2 ;
...
-(void)_setEngaementStatus:(id)arg0 forType:(NSUInteger)arg1 ;
...
-(void)cancelPreheat;
-(void)dealloc;
-(void)deviceScreenEngagementController:(id)arg0 didGainAttentionWithEvent:(NSInteger)arg1 ;
-(void)deviceScreenEngagementController:(id)arg0 didLoseAttentionWithEvent:(NSInteger)arg1 ;
...
-(void)handleButtonTapFromButtonIdentifier:(id)arg0 timestamp:(id)arg1 context:(id)arg2 ;
...
-(void)presentationStateProvider:(id)arg0 presentationStateDidChange:(id)arg1 ;
-(void)presentationWithIdentifier:(id)arg0 didUpdatePresentationState:(id)arg1 ;
...
// -(void)stopAnimationDismissalWatchdogTimerIfNeededThen:(id)arg0 onQueue:(unk)arg1  ;
