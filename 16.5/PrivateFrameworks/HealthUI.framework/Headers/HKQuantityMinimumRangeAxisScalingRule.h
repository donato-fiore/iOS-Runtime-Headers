...
+(id)ruleWithDefaultYAxisRange:(id)arg0 anchorValue:(id)arg1 ;
...
+(id)ruleWithDefaultYAxisRange:(id)arg0 minimumValue:(id)arg1 maximumValue:(id)arg2 axisRangeOverrides:(id)arg3 noDataAxisBounds:(id)arg4 ;
