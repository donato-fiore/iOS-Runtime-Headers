...
@class NSString, NSDateInterval, NSDate, NSArray, NSUserActivity, UISegmentedControl;
@protocol HKDisplayTypeSectionedContextViewDelegate, HKInteractiveChartViewObserver, HKSampleTypeUpdateControllerObserver, HKChartOverlayVersionProviding, HKCurrentOverlayLocationProviding, HKSampleTypeDateRangeControllerObserver, OS_dispatch_queue, HKOverlayRoomViewControllerLayoutDelegate;
...
@property (retain, nonatomic) NSArray *overlayContextSectionContainers; // ivar: _overlayContextSectionContainers
...
-(void)_enumerateContextItemsWithBlock:(id)arg0 ;
