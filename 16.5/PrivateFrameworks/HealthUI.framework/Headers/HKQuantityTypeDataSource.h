...
@property (copy, nonatomic) id *preprocessingHandler; // ivar: _preprocessingHandler
...
-(id)_unshiftedDateIntervalIfNecessaryForStatisticsInterval:(id)arg0 startDate:(id)arg1 endDate:(id)arg2 gregorianCalendar:(id)arg3 ;
