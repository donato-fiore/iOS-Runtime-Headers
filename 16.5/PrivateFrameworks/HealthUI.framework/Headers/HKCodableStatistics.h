...
@property (nonatomic) NSInteger baselineRelativeValueState; // ivar: _baselineRelativeValueState
...
@property (retain, nonatomic) HKCodableMetadataDictionary *metadata; // ivar: _metadata
