...
@protocol UITableViewDataSource, UITableViewDelegate, HKHealthPrivacyServicePickerController, HKHealthPrivacyServicePickerControllerDelegate;
...
-(void)noDataLearnMoreButtonTapped:(id)arg0 ;
-(void)shareButtonTapped:(id)arg0 ;
-(void)showDetailsButtonTappedAtIndexPath:(id)arg0 ;
