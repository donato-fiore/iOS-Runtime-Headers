...
@property (nonatomic) BOOL forceUnitlessForAllTypes; // ivar: _forceUnitlessForAllTypes
...
-(id)initWithDisplayType:(id)arg0 unitPreferenceController:(id)arg1 forceUnitlessForAllTypes:(BOOL)arg2 ;
