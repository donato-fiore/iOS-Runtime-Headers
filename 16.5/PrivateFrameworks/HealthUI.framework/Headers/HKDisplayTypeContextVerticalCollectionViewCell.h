...
@property (nonatomic) BOOL unitStringIsVeryLong; // ivar: _unitStringIsVeryLong
...
+(id)reuseIdentifier;
-(id)_attributedTitleWithAccessoryForContextItem:(id)arg0 selected:(BOOL)arg1 ;
-(id)_attributedValueAndUnitForContextItem:(id)arg0 selected:(BOOL)arg1 ;
-(id)_backgroundViewWithColor:(id)arg0 userInteractive:(BOOL)arg1 ;
-(id)_generateInfoButton;
-(id)_labelWithFont:(id)arg0 allowsMultiline:(BOOL)arg1 supportsDyanmicType:(BOOL)arg2 layoutPriority:(float)arg3 ;
-(id)_stackViewWithArrangedSubviews:(id)arg0 ;
-(id)_titleAttributes;
-(id)_titleFont;
-(id)_unitStringForContextItem:(id)arg0 isUnitStringIncludedInValueString:(BOOL)arg1 ;
...
-(void)_setLabel:(id)arg0 allowsMultiline:(BOOL)arg1 textAlignment:(NSInteger)arg2 layoutPriority:(float)arg3 ;
