...
@class UIView, NSMutableArray, UIImage, UIView<HKGraphRenderer>, UIScrollView, NSArray, UIColor, NSMutableDictionary, NSCalendar, NSString, NSMapTable, NSTimer, NSSet;
...
@property (retain, nonatomic) UIColor *capturedTileBackgroundColor; // ivar: _capturedTileBackgroundColor
...
@property (readonly, nonatomic) HKGraphViewTileThread *graphViewTileThread; // ivar: _graphViewTileThread
...
-(BOOL)_anySeriesWantsInternalLegends:(NSInteger)arg0 ;
...
-(BOOL)_skipRenderingToView:(id)arg0 yAxisView:(id)arg1 context:(struct CGContext *)arg2 chartRect:(struct CGRect )arg3 ;
...
-(id)_createRendererSeriesConfigurationWithInsetDataArea:(struct CGRect )arg0 drawingToTile:(BOOL)arg1 ;
-(id)_createRendererSeriesRowFromIndex:(NSInteger)arg0 insetDataArea:(struct CGRect )arg1 drawingToTile:(BOOL)arg2 ;
-(id)_createRendererWithCurrentStateWithChartRect:(struct CGRect )arg0 contentOffset:(struct CGPoint )arg1 drawingToTile:(BOOL)arg2 tileColumn:(NSInteger)arg3 effectiveVisibleRangeCadence:(id)arg4 effectiveVisibleRangeActive:(id)arg5 actualVisibleRange:(id)arg6 ;
...
-(id)createTileRendererWithTileRect:(struct CGRect )arg0 column:(NSInteger)arg1 ;
...
-(struct CGAffineTransform )_xAxisCoordinateTransformWithContentOffset:(struct CGPoint )arg0 zoomScale:(CGFloat)arg1 chartRect:(struct CGRect )arg2 ;
...
-(struct UIEdgeInsets )_virtualMarginInsets;
...
-(void)_performPostAxisUpdates:(NSInteger)arg0 newXAxisHeight:(CGFloat)arg1 ;
