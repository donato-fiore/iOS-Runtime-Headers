...
@property (retain, nonatomic) HKDisplayType *optionalBaseDisplayType; // ivar: _optionalBaseDisplayType
...
-(id)buildContextItemWithValue:(id)arg0 unit:(id)arg1 valueContext:(id)arg2 forTimeScope:(NSInteger)arg3 isUnitIncludedInValue:(BOOL)arg4 ;
-(id)buildOverlayDisplayTypeForTimeScope:(NSInteger)arg0 ;
-(id)initWithQuantityIdentifier:(id)arg0 overlayChartController:(id)arg1 applicationItems:(id)arg2 optionalDelegate:(id)arg3 seriesOptions:(NSInteger)arg4 mode:(NSInteger)arg5 optionalBaseDisplayType:(id)arg6 ;
...
-(id)valueString:(id)arg0 applicationItems:(id)arg1 representativeDisplayType:(id)arg2 isUnitIncludedInValue:(*BOOL)arg3 ;
-(void)fetchCachedDataForTimeScope:(NSInteger)arg0 dateInterval:(id)arg1 completion:(id)arg2 ;
-(void)prepareContextForDateInterval:(id)arg0 overlayController:(id)arg1 timeScope:(NSInteger)arg2 ;
