...
-(id)_createSleepDisplayTypeForSeriesType:(NSInteger)arg0 ;
...
-(id)_remoteCalendarOverrideForDisplayType:(id)arg0 ;
...
-(id)_remoteDateIntervalsWithQueryAlignment:(NSInteger)arg0 gregorianCalendar:(id)arg1 ;
...
-(id)_resolvedDisplayDateForDisplayType:(id)arg0 displayDate:(id)arg1 timeScope:(NSInteger)arg2 gregorianCalendar:(id)arg3 ;
-(id)_sleepRemoteDataSourcesForDisplayType:(id)arg0 ;
-(id)_sleepRemoteGraphSeriesForDisplayType:(id)arg0 graphSeriesDataSource:(id)arg1 timeScope:(NSInteger)arg2 ;
...
-(id)activityChartForActivityMoveMode:(NSInteger)arg0 displayDate:(id)arg1 activityOptions:(NSUInteger)arg2 chartSharableModel:(id)arg3 ;
...
-(id)initWithHealthStore:(id)arg0 preferredUnitPreferenceController:(id)arg1 ;
...
-(void)updateChartSummaryTrendModel:(id)arg0 viewController:(id)arg1 ;
