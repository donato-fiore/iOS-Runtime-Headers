...
-(BOOL)performRequests:(id)arg0 onAssetWithIdentifier:(id)arg1 identifierType:(NSUInteger)arg2 fromPhotoLibraryWithURL:(id)arg3 error:(*id)arg4 ;
-(BOOL)performRequests:(id)arg0 onAssetWithSyndicationIdentifier:(id)arg1 error:(*id)arg2 ;
-(BOOL)performRequests:(id)arg0 onImageData:(id)arg1 withUniformTypeIdentifier:(id)arg2 andIdentifier:(id)arg3 error:(*id)arg4 ;
...
-(int)performRequests:(id)arg0 onAssetWithIdentifier:(id)arg1 identifierType:(NSUInteger)arg2 fromPhotoLibraryWithURL:(id)arg3 completionHandler:(id)arg4 ;
...
-(int)performRequests:(id)arg0 onImageData:(id)arg1 withUniformTypeIdentifier:(id)arg2 andIdentifier:(id)arg3 completionHandler:(id)arg4 ;
...
-(int)performRequestsWithCloudIdentifiers:(id)arg0 completionHandler:(id)arg1 ;
-(void)cacheHitWithQueryID:(NSUInteger)arg0 cachedResultQueryID:(NSUInteger)arg1 ;
