...
@class UIViewController, NSArray, CLLocation, NSString, UIView, MKLocalSearch, CLLocationManager, NSLayoutConstraint, MKMapView, UISearchBar, NSIndexPath, UITableView, WFLocationValue;
@protocol UISearchBarDelegate, UITableViewDelegate, UITableViewDataSource, MKMapViewDelegate, MKMapViewDelegatePrivate, WFLocationTriggerEditorMapDragRadiusViewDelegate, CLLocationManagerDelegate, WFLocationPickerViewControllerDelegate;


#import "WFLocationTriggerEditorMapDragRadiusView.h"
...
@property (retain, nonatomic) WFLocationTriggerEditorMapDragRadiusView *dragView; // ivar: _dragView
