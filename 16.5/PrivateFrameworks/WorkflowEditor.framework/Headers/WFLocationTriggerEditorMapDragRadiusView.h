...
@protocol MKAnnotation, WFLocationTriggerEditorMapDragRadiusViewDelegate, MKOverlay;
...
@property (weak, nonatomic) NSObject<WFLocationTriggerEditorMapDragRadiusViewDelegate> *delegate; // ivar: _delegate
