...
@class UIViewController, WFContextualActionSuggester, HMHome, WFWorkflow;
...
@property (readonly, nonatomic) CGFloat actionCanvasWidth;
...
-(void)editorHostingViewController:(id)arg0 didChangeRunningState:(BOOL)arg1 fractionCompleted:(CGFloat)arg2 isWaiting:(BOOL)arg3 ;
