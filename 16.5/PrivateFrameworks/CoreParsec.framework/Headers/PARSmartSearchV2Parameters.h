...
@property (readonly, nonatomic) NSInteger zkwMinCount; // ivar: _zkwMinCount
...
-(id)initFromEnabled:(BOOL)arg0 enableCount:(BOOL)arg1 minCount:(NSInteger)arg2 zkwMinCount:(NSInteger)arg3 ;
