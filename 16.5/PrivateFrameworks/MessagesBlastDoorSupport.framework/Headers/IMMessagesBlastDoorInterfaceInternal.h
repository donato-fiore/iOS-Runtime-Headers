...
-(id)defuseBalloonPluginPayload:(id)arg0 withIdentifier:(id)arg1 error:(*id)arg2 ;
-(id)defuseSMSDictionary:(id)arg0 error:(*id)arg1 ;
-(id)defuseTopLevelDictionary:(id)arg0 error:(*id)arg1 ;
-(id)generatePreviewforAttachmentWithfileURL:(id)arg0 error:(*id)arg1 ;
-(id)init;
...
-(void)defuseCollaborationClearNoticePayload:(id)arg0 resultHandler:(id)arg1 ;
