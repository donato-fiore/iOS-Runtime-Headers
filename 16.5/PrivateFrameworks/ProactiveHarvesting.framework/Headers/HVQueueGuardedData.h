...
@class NSMutableSet, _PASBloomFilterForWriting, BMContentStream, NSMutableArray;
@protocol BMBookmark;
...
@property (nonatomic) unsigned int bloomFilterFalsePositives; // ivar: _bloomFilterFalsePositives
...
@property (retain, nonatomic) _PASBloomFilterForWriting *diskContentBloomFilter; // ivar: _diskContentBloomFilter
