...
@property (retain, nonatomic) NSMutableArray *deprecatedDeferredContentStates; // ivar: _deprecatedDeferredContentStates
...
-(id)deprecatedDeferredContentStatesAtIndex:(NSUInteger)arg0 ;
-(id)description;
-(id)dictionaryRepresentation;
-(void)addDeferredContentStates:(id)arg0 ;
-(void)addDeprecatedDeferredContentStates:(id)arg0 ;
