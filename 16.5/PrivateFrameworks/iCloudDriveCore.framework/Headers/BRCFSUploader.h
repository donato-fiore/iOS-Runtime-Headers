...
@class br_pacer, NSString, NSDictionary;
...
-(void)_finishedUploadingItem:(id)arg0 record:(id)arg1 jobID:(id)arg2 stageID:(id)arg3 syncContext:(id)arg4 hasPerformedServerSideAssetCopy:(BOOL)arg5 error:(id)arg6 ;
...
-(void)setQuotaAvailableForDefaultOwner:(NSUInteger)arg0 ;
