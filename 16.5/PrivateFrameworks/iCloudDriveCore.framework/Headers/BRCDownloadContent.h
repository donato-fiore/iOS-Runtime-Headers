...
@property (readonly, nonatomic) BOOL isDocumentModifiedByOtherUser; // ivar: _isDocumentModifiedByOtherUser
...
-(id)description;
-(id)etagIfLoser;
-(id)initWithDocument:(id)arg0 stageID:(id)arg1 etagIfLoser:(id)arg2 ;
-(int)kind;
