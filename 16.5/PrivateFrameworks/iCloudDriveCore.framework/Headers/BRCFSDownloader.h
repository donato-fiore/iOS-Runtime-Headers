...
-(BOOL)_createDownloadingJobForItem:(id)arg0 state:(int)arg1 kind:(int)arg2 etag:(id)arg3 userInitiated:(BOOL)arg4 stageFileName:(id)arg5 error:(*id)arg6 ;
-(BOOL)makeContentLive:(id)arg0 ;
-(BOOL)scheduleContentDownloadForItem:(id)arg0 serverItem:(id)arg1 userInitiated:(BOOL)arg2 etagIfLoser:(id)arg3 stageFileName:(id)arg4 error:(*id)arg5 ;
...
-(id)generateContentStageFileNameForItem:(id)arg0 etag:(id)arg1 ;
-(id)getDownloadEtagForItem:(id)arg0 etagIfLoser:(id)arg1 ;
...
-(void)_sendContentsBatch:(id)arg0 sizeHint:(NSInteger)arg1 maxRecordsCount:(NSUInteger)arg2 isLoserDownload:(BOOL)arg3 ;
...
-(void)addPendingOperationProgress:(id)arg0 withStageFileName:(id)arg1 ;
-(void)cancel;
...
-(void)cancelAndCleanupItemDownload:(id)arg0 kind:(int)arg1 etag:(id)arg2 andNotifyDownloadTrackers:(BOOL)arg3 ;
...
-(void)removePendingOperationProgressWithStageFileName:(id)arg0 ;
