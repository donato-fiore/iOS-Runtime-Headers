...
-(BOOL)_checkIfEnumeratorContainsNonDiscretionaryOp:(id)arg0 ;
...
-(BOOL)containsNonRejectedChildWithParentID:(id)arg0 db:(id)arg1 ;
...
-(BOOL)existsByParentID:(id)arg0 andLogicalName:(id)arg1 ;
-(BOOL)existsByParentID:(id)arg0 andLogicalName:(id)arg1 db:(id)arg2 ;
-(BOOL)existsByParentID:(id)arg0 andLogicalName:(id)arg1 excludingItemID:(id)arg2 ;
-(BOOL)existsByParentID:(id)arg0 andLogicalName:(id)arg1 excludingItemID:(id)arg2 db:(id)arg3 ;
...
-(id)allItems;
-(id)allItemsSortedByDepthDescending:(BOOL)arg0 ;
...
-(id)cancelLocateRecordOperationAndReschedule:(id)arg0 ;
-(id)clientChildCountWithParentID:(id)arg0 db:(id)arg1 ;
-(id)deadItemByParentID:(id)arg0 andUnbouncedLogicalName:(id)arg1 ;
...
-(id)documentsNotIdleEnumeratorWithDB:(id)arg0 startingRowID:(NSUInteger)arg1 batchSize:(NSUInteger)arg2 ;
...
-(id)liveItemByParentID:(id)arg0 andCaseInsensitiveLogicalName:(id)arg1 excludingItemID:(id)arg2 ;
-(id)liveItemByParentID:(id)arg0 andLogicalName:(id)arg1 excludingItemID:(id)arg2 ;
-(id)locateRecordIfNecessaryForRecordID:(id)arg0 isUserWaiting:(BOOL)arg1 ;
-(id)ownerName;
...
-(void)_enumerateAndClearLocateBlocksForRecordID:(id)arg0 exists:(BOOL)arg1 ;
...
-(void)_registerLocateRecordOperation:(id)arg0 ;
...
-(void)fetchRecentAndFavoriteDocuments:(BOOL)arg0 ;
...
-(void)notifyClient:(id)arg0 whenIdle:(id)arg1 ;
// -(void)performBlock:(id)arg0 whenItemWithIDIsDownloaded:(unk)arg1  ;
// -(void)performBlock:(id)arg0 whenItemWithRecordIDIsOnDisk:(unk)arg1  ;
// -(void)performBlock:(id)arg0 whenLocatingCompletesForItemWithRecordID:(unk)arg1  ;
