...
@class BRNotificationQueue, NSString, NSMutableSet, NSSet, NSHashTable, BRFileObjectID;
...
// -(void)_performBlock:(id)arg0 whenNotifsAreFullyFlushedInAppLibrary:(unk)arg1 description:(id)arg2  ;
-(void)_prepareForSecondGatherWithRank:(NSUInteger)arg0 ;
-(void)_registerAsWatcherIfNeeded;
-(void)_stopWatchingItems;
-(void)_watchItem:(id)arg0 options:(unsigned short)arg1 gatherReply:(id)arg2 ;
...
-(void)watchItemWithFileObjectID:(id)arg0 options:(unsigned short)arg1 gatherReply:(id)arg2 ;
