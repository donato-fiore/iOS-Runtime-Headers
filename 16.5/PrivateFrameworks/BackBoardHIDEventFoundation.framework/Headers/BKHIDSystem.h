...
@class NSString;
@protocol BKHIDEventProcessor, BKHIDEventBufferingHIDSystem, BKHIDSystemInterfacing, OS_dispatch_queue, OS_dispatch_mach, BKHIDSystemDelegate, BKHIDEventDispatcherProviding, BKHIDEventProcessor><BKHIDBufferedEventProcessor, BKHIDDisplayChangeObserving;
...
@property (readonly, nonatomic) NSObject<BKHIDEventProcessor><BKHIDBufferedEventProcessor> *eventProcessor; // ivar: _eventProcessor
...
-(void)_asyncScheduleWithHIDEventQuue:(id)arg0 ;
-(void)_beginHandlingEvents;
-(void)buffer:(id)arg0 drainEvent:(struct __IOHIDEvent *)arg1 withContext:(id)arg2 sender:(id)arg3 sequence:(id)arg4 toResolution:(id)arg5 ;
-(void)bufferDidFinishDraining:(id)arg0 ;
...
-(void)requestBufferReevaluationWithContext:(id)arg0 ;
