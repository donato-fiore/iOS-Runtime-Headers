...
@class NSDecimalNumber, NSDictionary, NSString, CLLocation, NSTimeZone, NSDate, NSSet;
...
@property (copy, nonatomic) NSDictionary *compoundFeatures; // ivar: _compoundFeatures
...
@property (nonatomic) NSUInteger disputeStatus; // ivar: _disputeStatus
@property (nonatomic) NSUInteger disputeType; // ivar: _disputeType
...
@property (nonatomic) NSUInteger suggestedSuggestionCategory; // ivar: _suggestedSuggestionCategory
...
@property (copy, nonatomic) NSSet *uniqHistogramKeys; // ivar: _uniqHistogramKeys
