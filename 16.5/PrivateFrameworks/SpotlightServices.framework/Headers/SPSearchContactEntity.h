...
+(BOOL)stringA:(id)arg0 isSameToStringB:(id)arg1 ;
...
-(BOOL)hasSameContactAsContactEntity:(id)arg0 ;
...
-(void)getVariantsForPhoneNumber:(id)arg0 searchNumbers:(id)arg1 displayNumbers:(id)arg2 fallbackDisplayNumbers:(id)arg3 ;
