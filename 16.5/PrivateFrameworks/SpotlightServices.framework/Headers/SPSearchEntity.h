...
@property (readonly, nonatomic) NSString *stringForSearchContinuation; // ivar: _stringForSearchContinuation
...
-(void)appendToQuery:(id)arg0 key:(id)arg1 value:(id)arg2 additions:(id)arg3 flags:(id)arg4 ;
-(void)appendToQuery:(id)arg0 key:(id)arg1 value:(id)arg2 optionalValue:(id)arg3 additions:(id)arg4 flags:(id)arg5 ;
