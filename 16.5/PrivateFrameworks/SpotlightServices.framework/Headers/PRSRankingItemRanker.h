...
@property (nonatomic) BOOL containsDigitInQuery; // ivar: _containsDigitInQuery
...
@property (nonatomic) BOOL sodium; // ivar: _sodium
@property (nonatomic) NSUInteger topHitMaxCount; // ivar: _topHitMaxCount
...
+(id)embeddingForLanguage:(id)arg0 ;
+(id)englishEmbedding;
+(id)importantAttributesForBundle:(id)arg0 ;
+(id)importantAttributesForParsecBundle:(id)arg0 ;
+(id)itemSpecificImportantAttributesForBundle:(id)arg0 withItem:(id)arg1 ;
...
+(void)sortSectionResults:(id)arg0 currentTime:(CGFloat)arg1 ;
...
-(id)filterRankedItems:(id)arg0 bundle:(id)arg1 userQuery:(id)arg2 ;
-(id)init;
...
-(id)rankingConfigurationWithMeContact:(id)arg0 emailAddresses:(id)arg1 phoneFavorites:(id)arg2 vipList:(id)arg3 clientBundle:(id)arg4 isScopedSearch:(BOOL)arg5 isAdvancedSyntax:(BOOL)arg6 spotlightQuery:(id)arg7 userQuery:(id)arg8 tokenString:(id)arg9 queryKind:(NSUInteger)arg10 isPeopleSearch:(BOOL)arg11 keyboardLanguage:(id)arg12 ;
...
-(void)prepareForPureSodiumL2RankingWithMailItems:(id)arg0 inBundle:(id)arg1 ;
...
-(void)resetWithSearchString:(id)arg0 ;
-(void)resetWithSearchString:(id)arg0 userQueryString:(id)arg1 ;
-(void)resetbundleFeaturesScratchBuf:(*float)arg0 ;
-(void)setIsFuzzySearch:(BOOL)arg0 ;
