...
@property (retain, nonatomic) NSNumber *displayOrder; // ivar: _displayOrder
...
@property (retain, nonatomic) NSString *relatedAppIdentifier; // ivar: _relatedAppIdentifier
...
-(id)initWithIdentifier:(id)arg0 bundleIdentifier:(id)arg1 protectionClass:(id)arg2 attributeKeys:(id)arg3 attributeValues:(id)arg4 ;
-(id)initWithResult:(id)arg0 ;
-(id)initWithResult:(id)arg0 groupId:(id)arg1 ;
-(id)punchout;
-(id)ttrDescription;
-(id)valueForAttribute:(id)arg0 withType:(Class)arg1 ;
-(void)clearBackendData;
-(void)encodeWithCoder:(id)arg0 ;
-(void)setFeedbackPropertiesOnResultCopy:(id)arg0 ;
-(void)setUrl:(id)arg0 ;
