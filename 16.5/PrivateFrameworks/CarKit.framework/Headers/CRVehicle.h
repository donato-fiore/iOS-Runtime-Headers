...
@class NSString, NSSet, NSData, NSUUID, NSDate, NSNumber;
...
@property (nonatomic) NSNumber *supportsStartSessionRequest; // ivar: _supportsStartSessionRequest
...
+(id)vehicleForMessagingVehicle:(id)arg0 ;
