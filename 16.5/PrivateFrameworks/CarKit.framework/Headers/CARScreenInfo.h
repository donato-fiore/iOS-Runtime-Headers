...
// -(id)initWithPropertySupplier:(id)arg0 screenType:(unk)arg1 additionalInsets:(NSUInteger)arg2 displayDictionary:(struct NSEdgeInsets )arg3 physicalDisplay:(id)arg4  ;
