...
@class NSArray, NSString, SFPasswordSharingService, UIViewController<WFNetworkView>, WFHealthIssue;
...
@property (retain, nonatomic) WFHealthIssue *securityIssue; // ivar: _securityIssue
