...
@class NSString, NSData, MIStoreMetadata, NSDictionary, NSArray;
...
@property (nonatomic) NSUInteger installLocation; // ivar: _installLocation
...
@property (nonatomic) BOOL preservePlaceholderAsParallel; // ivar: _preservePlaceholderAsParallel
