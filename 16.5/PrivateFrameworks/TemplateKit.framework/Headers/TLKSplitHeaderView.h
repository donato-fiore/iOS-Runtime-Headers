...
@class NUIContainerGridView, NSString, NUIContainerStackView;
...
#import "TLKSplitTitleContainer.h"
...
@property (weak) NSObject<TLKSplitHeaderViewDelegate> *delegate; // ivar: _delegate
@property (readonly, copy) NSString *description;
@property (readonly) NSUInteger hash;
@property (nonatomic) BOOL isLeadingButtonEnabled; // ivar: _isLeadingButtonEnabled
@property (nonatomic) BOOL isTrailingButtonEnabled; // ivar: _isTrailingButtonEnabled
@property (retain, nonatomic) TLKTextButton *leadingButton; // ivar: _leadingButton
...
@property (retain, nonatomic) TLKSplitTitleContainer *titleContainerView; // ivar: _titleContainerView
@property (retain, nonatomic) TLKTextButton *trailingButton; // ivar: _trailingButton
