...
-(id)longInactivityPredictionResultAtDate:(id)arg0 withOptions:(NSInteger)arg1 withError:(*id)arg2 ;
-(id)longInactivityPredictionResultWithError:(*id)arg0 ;
-(id)longInactivityPredictionResultWithOptions:(NSInteger)arg0 withError:(*id)arg1 ;
-(id)modelDescription;
-(id)unfixModelOutput;
...
-(void)longInactivityPredictionResultAtDate:(id)arg0 withOptions:(NSInteger)arg1 withHandler:(id)arg2 ;
-(void)longInactivityPredictionResultWithHandler:(id)arg0 ;
-(void)longInactivityPredictionResultWithOptions:(NSInteger)arg0 withHandler:(id)arg1 ;
