...
@property (nonatomic) float simpleSelectorMaxOffsetAngle; // ivar: _simpleSelectorMaxOffsetAngle
@property (nonatomic) float simpleSelectorMinOffsetAngle; // ivar: _simpleSelectorMinOffsetAngle
@property (nonatomic) BOOL useSimpleSelector; // ivar: _useSimpleSelector
