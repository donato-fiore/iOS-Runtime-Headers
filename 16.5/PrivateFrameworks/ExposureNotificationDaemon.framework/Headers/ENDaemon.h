...
@class NSMutableSet, NSMutableDictionary, NSString, SBSRemoteAlertHandle, PrivacyProxyServiceStatus, ENRegion, NSBackgroundActivityScheduler, NSMutableOrderedSet, SFClient, CUSystemMonitor, ENUserAlert, UNUserNotificationCenter;
...
@property (nonatomic) NSInteger onboardingLegalConsentLastViewCount; // ivar: _onboardingLegalConsentLastViewCount
@property (retain, nonatomic) ENOnboardingManager *onboardingManager; // ivar: _onboardingManager
@property (retain, nonatomic) ENRegion *onboardingRegionTrigger; // ivar: _onboardingRegionTrigger
...
-(id)_getReportTypeForSession:(id)arg0 ;
-(id)_getReportTypeFromMetadata:(id)arg0 ;
