...
@property (nonatomic) BOOL defaultLevelLogging; // ivar: _defaultLevelLogging
...
-(id)initWithDispatchQueue:(id)arg0 withPersistencePath:(id)arg1 forPolicyVersion:(id)arg2 issuingDefaultLevelLogging:(BOOL)arg3 ;
