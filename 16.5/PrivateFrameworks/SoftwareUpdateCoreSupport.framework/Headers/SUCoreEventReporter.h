...
+(NSInteger)eventForEventString:(id)arg0 ;
...
-(BOOL)sendEvent:(id)arg0 returningFinalEventDictionary:(*id)arg1 ;
-(BOOL)sendEvent:(id)arg0 toServerURL:(id)arg1 ;
-(BOOL)sendEvent:(id)arg0 toServerURL:(id)arg1 returningFinalEventDictionary:(*id)arg2 ;
