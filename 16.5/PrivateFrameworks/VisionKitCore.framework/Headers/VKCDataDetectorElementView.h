...
@class NSArray, NSString, NSDictionary, UIBezierPath, CAShapeLayer, UIContextMenuInteraction, UIPointerInteraction, UITapGestureRecognizer;
@protocol UIContextMenuInteractionDelegate, UIGestureRecognizerDelegate, BCSActionDelegate, UIPointerInteractionDelegate, VKCDataDetectorElementViewDelegate;
...
@property (nonatomic) BOOL isPerformingManualContextInvocation; // ivar: _isPerformingManualContextInvocation
