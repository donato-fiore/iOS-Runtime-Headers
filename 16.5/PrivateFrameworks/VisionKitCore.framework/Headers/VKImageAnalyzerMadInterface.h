...
-(id)VNRequestHandlerForRequest:(id)arg0 ;
...
-(id)rectangleObservationsFromRequests:(id)arg0 durations:(id)arg1 ;
...
-(int)_performMultiStageMADRequest:(id)arg0 forRequest:(id)arg1 pixelBuffer:(struct __CVBuffer *)arg2 cgImage:(struct CGImage *)arg3 useCGForMad:(BOOL)arg4 withCompletion:(id)arg5 ;
-(int)processRequest:(id)arg0 callbackQueue:(id)arg1 ;
-(void)_cancelRequest:(id)arg0 ;
-(void)_cancelRequestID:(int)arg0 ;
-(void)_processRequest:(id)arg0 callbackQueue:(id)arg1 ;
...
-(void)didShowVisualSearchCachedResultsForQueryID:(NSUInteger)arg0 cachedResultQueryID:(NSUInteger)arg1 ;
-(void)didShowVisualSearchHintsForRequest:(id)arg0 ;
-(void)generateTextualVisualSearchResultForAnalysis:(id)arg0 queryInfo:(id)arg1 completionHandler:(id)arg2 ;
...
-(void)handleCompletionForMultiPartRequest:(id)arg0 madRequests:(id)arg1 callbackQueue:(id)arg2 error:(id)arg3 ;
...
-(void)submitVisualIntelligenceUserFeedbackForRequest:(id)arg0 reportIdentifier:(id)arg1 userFeedbackPayload:(id)arg2 sfReportData:(id)arg3 ;
