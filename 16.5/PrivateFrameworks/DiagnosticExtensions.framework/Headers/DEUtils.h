...
+(id)applicationSupportDirectoryForApp:(id)arg0 ;
+(id)componentsByRemovingComponentsBeforeComponent:(id)arg0 sourceURL:(id)arg1 keepingComponent:(BOOL)arg2 ;
...
+(id)createDirectoryWithClassCDataProtection:(id)arg0 ;
...
+(id)pathComponentsInURL:(id)arg0 removingBaseURLComponents:(id)arg1 keepingFirstComponent:(BOOL)arg2 ;
