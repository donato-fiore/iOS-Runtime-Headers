...
@property (readonly, nonatomic) NSString *voiceResourceKey; // ivar: _voiceResourceKey


-(id)initWithKey:(id)arg0 audio:(id)arg1 wordTimingInfo:(id)arg2 voiceKey:(id)arg3 voiceResourceKey:(id)arg4 ;
