...
@property (nonatomic) NSUInteger downloadAction; // ivar: _downloadAction
...
+(id)actionWithTitle:(id)arg0 shouldPerformKeepLocalRequest:(BOOL)arg1 keepLocalRequestOptions:(id)arg2 downloadAction:(NSUInteger)arg3 ;
