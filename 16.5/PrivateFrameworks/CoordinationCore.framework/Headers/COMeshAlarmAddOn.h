...
@property (readonly, nonatomic) id *mediaSystemUpdateRegistration; // ivar: _mediaSystemUpdateRegistration
...
-(void)alarmsForAccessories:(id)arg0 fromConnection:(id)arg1 cluster:(id)arg2 callback:(id)arg3 ;
...
-(void)mediaSystemCompanionTransitionedFrom:(id)arg0 to:(id)arg1 ;
