...
@property (nonatomic) int quantizedDistChangeSinceLastCalibrationM; // ivar: _quantizedDistChangeSinceLastCalibrationM
@property (nonatomic) int quantizedTimeChangeSinceLastCalibrationS; // ivar: _quantizedTimeChangeSinceLastCalibrationS
