...
@property (nonatomic) unsigned int csgId; // ivar: _csgId
@property (nonatomic) unsigned int csgIndication; // ivar: _csgIndication
...
@property (nonatomic) int timingAdvance; // ivar: _timingAdvance
