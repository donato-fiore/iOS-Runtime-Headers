...
-(id)_groupsForPrimaryAccount:(id)arg0 secondaryAccounts:(id)arg1 simpleAccountGrouping:(BOOL)arg2 ;
-(id)allPendingItems;
...
-(void)dealloc;
-(void)mapItems:(id)arg0 toGroups:(id)arg1 unknownGroup:(id)arg2 deviceGroup:(id)arg3 simpleAccountGrouping:(BOOL)arg4 ;
