...
+(id)collectionWithConfiguration:(id)arg0 ;
...
-(id)_generateNewServerIDForBookmark:(id)arg0 ;
...
-(void)_createSpecialTabsFolderWithUUIDIfNeeded:(id)arg0 withParentID:(int)arg1 ;
