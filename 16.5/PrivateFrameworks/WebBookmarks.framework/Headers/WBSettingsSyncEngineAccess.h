...
-(BOOL)_isKnownPerSiteSetting:(id)arg0 ;
...
-(void)_updatePerSiteSettingsWithRecord:(id)arg0 ;
-(void)_updatePerSiteSettingsWithRecord:(id)arg0 completionHandler:(id)arg1 ;
