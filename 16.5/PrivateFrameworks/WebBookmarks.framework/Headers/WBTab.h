...
@property (readonly, nonatomic, getter=isPrivateBrowsing) BOOL privateBrowsing; // ivar: _privateBrowsing
@property (readonly, nonatomic, getter=isShared) BOOL shared; // ivar: _shared
...
+(id)pinnedTabWithTitle:(id)arg0 url:(id)arg1 deviceIdentifier:(id)arg2 ;
+(id)startPageTabWithDeviceIdentifier:(id)arg0 ;
-(BOOL)canCloseAutomaticallyForInterval:(CGFloat)arg0 ;
...
-(id)initWithUUID:(id)arg0 deviceIdentifier:(id)arg1 lastVisitTime:(id)arg2 ;
-(id)initWithUUID:(id)arg0 title:(id)arg1 url:(id)arg2 deviceIdentifier:(id)arg3 ;
-(id)initWithUUID:(id)arg0 title:(id)arg1 url:(id)arg2 deviceIdentifier:(id)arg3 lastVisitTime:(id)arg4 ;
