...
@interface TSWPRangeMap : NSObject {
    _NSRange _subRange;
    vector<_TSWPCharIndexAndAffinity, std::allocator<_TSWPCharIndexAndAffinity>> _unmappedIndexes;
    vector<_TSWPCharIndexAndAffinity, std::allocator<_TSWPCharIndexAndAffinity>> _mappedIndexes;
}
