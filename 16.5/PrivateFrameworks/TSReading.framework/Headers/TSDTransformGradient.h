...
@property (nonatomic) CGSize baseNaturalSize; // ivar: mBaseNaturalSize
@property (nonatomic) CGPoint endPoint; // ivar: mEnd
@property (nonatomic) CGPoint startPoint; // ivar: mStart
