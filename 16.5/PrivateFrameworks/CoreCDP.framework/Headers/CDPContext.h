...
#import "CDPCABackupRecoveryReporter.h"
...
@property (nonatomic) BOOL _disableAsyncSecureBackupEnrollment; // ivar: __disableAsyncSecureBackupEnrollment
@property (nonatomic) BOOL _forceReset; // ivar: __forceReset
...
@property (nonatomic) unsigned int backupActivity; // ivar: _backupActivity
...
@property (nonatomic) BOOL cachedPassphraseMissing; // ivar: _cachedPassphraseMissing
...
@property (nonatomic) unsigned int endpoint; // ivar: _endpoint
...
@property (nonatomic) BOOL isAttemptingBackupRestore; // ivar: _isAttemptingBackupRestore
...
@property (nonatomic) NSInteger maxDeviceRecoveryAttempts; // ivar: _maxDeviceRecoveryAttempts
@property (nonatomic) CGFloat newestEscrowRecordAge; // ivar: _newestEscrowRecordAge
...
@property (nonatomic) NSInteger totalRecoveryAttempts; // ivar: _totalRecoveryAttempts
@property (nonatomic) NSInteger type; // ivar: _type
@property (nonatomic) NSInteger validEscrowDeviceCount; // ivar: _validEscrowDeviceCount
@property (nonatomic) NSUInteger walrusStatus; // ivar: _walrusStatus
