...
@property BOOL isPasscodeAuthorizationInProcess; // ivar: _isPasscodeAuthorizationInProcess
...
-(void)_handleBiometricAuthFailureWithError:(id)arg0 forContext:(id)arg1 ;
