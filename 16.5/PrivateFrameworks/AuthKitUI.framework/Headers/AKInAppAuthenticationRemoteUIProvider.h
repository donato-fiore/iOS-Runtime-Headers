...
@class UINavigationController, ASWebAuthenticationSession, NSString, RemoteUIController, RemoteUIControllerPreferences;
@protocol AKBasicLoginControllerDelegate, ASWebAuthenticationPresentationContextProviding, AKInAppAuthenticationUIProvider;
...
-(void)_showPasswordFieldWithCompletion:(id)arg0 ;
