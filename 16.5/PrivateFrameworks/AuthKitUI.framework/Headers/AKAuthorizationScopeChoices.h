...
@property (nonatomic) NSUInteger indexOfChosenEmail; // ivar: _indexOfChosenEmail
@property (nonatomic) NSUInteger indexOfChosenLogin; // ivar: _indexOfChosenLogin
...
@property (nonatomic) BOOL wantsPrivateEmail; // ivar: _wantsPrivateEmail
