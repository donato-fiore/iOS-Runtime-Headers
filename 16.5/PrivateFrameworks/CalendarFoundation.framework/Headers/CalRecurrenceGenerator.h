...
@property (nonatomic) BOOL onlyIncludeInitialDateIfItMatchesRecurrence; // ivar: _onlyIncludeInitialDateIfItMatchesRecurrence
...
-(CGFloat)convertAbsoluteTime:(CGFloat)arg0 fromTimeZone:(id)arg1 toTimeZone:(id)arg2 ;
-(CGFloat)duration;
