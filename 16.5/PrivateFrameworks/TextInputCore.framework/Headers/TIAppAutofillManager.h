...
@property (readonly, nonatomic) BOOL hasOneTimeCode; // ivar: _hasOneTimeCode
...
-(void)generateJustHMEAutofillFormSuggestionWithRenderTraits:(id)arg0 withKeyboardState:(id)arg1 applicationID:(id)arg2 applicationBundleID:(id)arg3 completionHandler:(id)arg4 ;
