...
@property (copy, nonatomic) NSArray *continuousPathEnsembleSourceScales; // ivar: _continuousPathEnsembleSourceScales
@property (copy, nonatomic) NSArray *continuousPathEnsembleSourceWeights; // ivar: _continuousPathEnsembleSourceWeights
