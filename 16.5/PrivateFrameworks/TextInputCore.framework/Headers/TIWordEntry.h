...
@property (nonatomic) BOOL editActionExtendsPriorWord; // ivar: _editActionExtendsPriorWord
@property (nonatomic) int editActionType; // ivar: _editActionType
...
@property (nonatomic) BOOL originalWordInAlignment; // ivar: _originalWordInAlignment
...
-(id)textFromResolvedKeyboardInputs:(id)arg0 ;
-(id)trimmedDocumentContextBeforeInput;
-(int)leadingBackspaceCountFromResolvedKeyboardInputs:(id)arg0 ;
...
-(void)trimLeadingAndTrailingCharacters:(id)arg0 fromResolvedInputs:(id)arg1 ;
