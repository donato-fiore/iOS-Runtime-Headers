...
@property (retain, nonatomic) NSMutableArray *currentSessionStatsArray; // ivar: _currentSessionStatsArray
...
@property (retain, nonatomic) NSMutableArray *savedSessionStatsArray; // ivar: _savedSessionStatsArray
...
-(BOOL)publishIfSessionStatsHasWordCountMoreThanThreshold:(id)arg0 withSessionStartTime:(BOOL)arg1 ;
-(CGFloat)totalTimeSpan;
-(CGFloat)totalTimeSpanFromLastTap;
-(NSInteger)findIndexSessionStatsFromArray:(id)arg0 thatHasLayout:(id)arg1 ;
...
-(void)processNewSessionStatsArray:(id)arg0 ;
-(void)removeSessionStatsWithNegativeDurationFromArray:(id)arg0 ForTypingSession:(id)arg1 ;
