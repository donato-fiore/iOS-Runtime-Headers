...
-(BOOL)shouldUpdatePersonRepresentativeAssetUUIDsWithPositiveSceneCriteria:(id)arg0 actionValueString:(id)arg1 assetIsPassingSceneCriteria:(BOOL)arg2 personLocalIdentifierIsDoingActionInAsset:(BOOL)arg3 ;
...
-(void)_updatePersonActivitiesOfMomentNode:(id)arg0 assets:(id)arg1 graph:(id)arg2 withPositiveSceneCriteriaByValidPersonActivityMeaningLabel:(id)arg3 andActionCriteriaByValidPersonActivityMeaningLabel:(id)arg4 validPersonActivityMeaningLabelByActionValue:(id)arg5 changeRequest:(id)arg6 ;
