...
-(id)initWithMemoryCategory:(NSUInteger)arg0 memoryCategorySubcategory:(NSUInteger)arg1 momentNodes:(id)arg2 featureNodes:(id)arg3 generatedWithFallbackRequirements:(BOOL)arg4 ;
