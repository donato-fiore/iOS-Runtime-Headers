...
#ifndef PGPHOTOSCHALLENGEMEANINGFULEVENTREQUIREDCRITERIAFACTORY_H
#define PGPHOTOSCHALLENGEMEANINGFULEVENTREQUIREDCRITERIAFACTORY_H
...
+(id)_requiredCriteriaForIdentifiers:(id)arg0 inferenceType:(NSUInteger)arg1 graph:(id)arg2 sceneTaxonomy:(id)arg3 params:(id)arg4 ;
+(id)_restaurantCriteriaByCriteriaForIdentifiers:(id)arg0 withGraph:(id)arg1 sceneTaxonomy:(id)arg2 params:(id)arg3 ;
...
+(id)requiredCriteriaForIdentifiers:(id)arg0 inferenceType:(NSUInteger)arg1 graph:(id)arg2 sceneTaxonomy:(id)arg3 params:(id)arg4 ;
