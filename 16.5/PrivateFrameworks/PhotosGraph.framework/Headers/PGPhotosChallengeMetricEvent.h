...
-(id)_getInferredReasonFromMatchedConditions:(id)arg0 withFallbackReason:(id)arg1 ;
...
-(void)_gatherDeferredSuggestionInferencesForQuestions:(id)arg0 momentUUIDS:(id)arg1 inferenceResults:(id)arg2 reasonResultByAssetIdentifier:(id)arg3 progressBlock:(id)arg4 ;
...
-(void)_gatherNearLiveSuggestionInferencesForQuestions:(id)arg0 inferenceResults:(id)arg1 reasonResultByAssetIdentifier:(id)arg2 progressBlock:(id)arg3 ;
