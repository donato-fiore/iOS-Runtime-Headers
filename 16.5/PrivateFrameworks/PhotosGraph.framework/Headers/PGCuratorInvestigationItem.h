...
@class NSNumber, NSArray, NSString, CLLocation, NSSet, VNSceneprint, NSDate, NSDateComponents, CLSCurationModel;
...
@property (readonly) NSUInteger clsBaseSceneprintVersion;
...
@property (readonly) CLSCurationModel *curationModel; // ivar: _curationModel
...
-(BOOL)clsAvoidIfPossibleAsKeyItemForMemories:(BOOL)arg0 allowGuestAsset:(BOOL)arg1 reason:(*id)arg2 ;
-(BOOL)isRegularGem;
-(BOOL)isShinyGem;
