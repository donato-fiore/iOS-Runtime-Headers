...
@property (readonly) NSString *shareParticipantLocalIdentifier; // ivar: _shareParticipantLocalIdentifier
...
+(id)filterWithShareParticipantIdentifiers:(id)arg0 ;
+(id)friendOfPerson;
+(id)homeOfPerson;
...
-(void)enumerateContactSuggestionsSortedByConfidenceMatchingQuery:(NSUInteger)arg0 usingBlock:(id)arg1 ;
