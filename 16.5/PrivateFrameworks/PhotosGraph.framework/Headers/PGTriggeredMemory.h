...
@property (readonly, nonatomic) BOOL generatedWithFallbackRequirements; // ivar: _generatedWithFallbackRequirements
...
-(id)initWithMemoryCategory:(NSUInteger)arg0 memoryCategorySubcategory:(NSUInteger)arg1 memoryMomentNodes:(id)arg2 memoryFeatureNodes:(id)arg3 validityIntervalByTriggerType:(id)arg4 creationDate:(id)arg5 uniqueMemoryIdentifier:(id)arg6 generatedWithFallbackRequirements:(BOOL)arg7 ;
...
-(id)initWithMemoryCategory:(NSUInteger)arg0 memoryCategorySubcategory:(NSUInteger)arg1 memoryMomentNodes:(id)arg2 memoryFeatureNodes:(id)arg3 validityIntervalByTriggerType:(id)arg4 creationDate:(id)arg5 uniqueMemoryIdentifier:(id)arg6 photosGraphVersion:(NSInteger)arg7 generatedWithFallbackRequirements:(BOOL)arg8 ;
