...
-(void)applyIntroductionModel:(id)arg0 forDSID:(id)arg1 completionHandler:(id)arg2 ;
...
-(void)dealloc;
-(void)isContentPrivacyEnabledForDSID:(id)arg0 completionHandler:(id)arg1 ;
-(void)isExplicitContentRestricted:(id)arg0 ;
-(void)isLocationSharingModificationAllowedForDSID:(id)arg0 completionHandler:(id)arg1 ;
-(void)isRestrictionsPasscodeSet:(id)arg0 ;
-(void)lastCommunicationLimitsModifcationDateForDSID:(id)arg0 completionHandler:(id)arg1 ;
-(void)lastModifcationDateForDSID:(id)arg0 completionHandler:(id)arg1 ;
...
-(void)setLocationSharingModificationAllowed:(BOOL)arg0 forDSID:(id)arg1 completionHandler:(id)arg2 ;
