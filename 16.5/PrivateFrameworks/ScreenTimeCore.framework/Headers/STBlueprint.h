...
+(BOOL)disableManagedUserBlueprintForUser:(id)arg0 error:(*id)arg1 ;
...
+(BOOL)saveAlwaysAllowListForUser:(id)arg0 withBundleIDs:(id)arg1 overwriteExistingList:(BOOL)arg2 error:(*id)arg3 ;
+(BOOL)saveDefaultAlwaysAllowListIfNecessaryForUser:(id)arg0 error:(*id)arg1 ;
...
+(BOOL)saveRestrictionsBlueprintWithValuesForPresetRestrictions:(id)arg0 forUser:(id)arg1 error:(*id)arg2 ;
...
+(id)createManagedUserBlueprintForUser:(id)arg0 error:(*id)arg1 ;
