...
@property (readonly) BOOL isCommunicationSafetyAnalyticsEnabled; // ivar: _isCommunicationSafetyAnalyticsEnabled
...
-(id)initWithCommunicationSafetySendingRestricted:(BOOL)arg0 communicationSafetyReceivingRestricted:(BOOL)arg1 communicationSafetyNotificationEnabled:(BOOL)arg2 communicationSafetyAnalyticsEnabled:(BOOL)arg3 ;
