...
// +(id)simpleMessageListForMailboxes:(id)arg0 withRepository:(id)arg1 shouldTrackOldestItems:(BOOL)arg2 shouldUpdateDisplayDate:(BOOL)arg3 sortDescriptor:(id)arg4 transformPredicate:(id)arg5 ignoreMessageAdditionsPredicate:(unk)arg6  ;
...
// +(id)threadedMessageListForMailboxes:(id)arg0 withRepository:(id)arg1 shouldTrackOldestItems:(BOOL)arg2 shouldUpdateDisplayDate:(BOOL)arg3 sortDescriptor:(id)arg4 transformPredicate:(id)arg5 ignoreMessageAdditionsPredicate:(unk)arg6  ;
...
// -(id)initWithMailboxes:(id)arg0 repository:(id)arg1 sortDescriptor:(id)arg2 transformPredicate:(id)arg3 ignoreMessageAdditionsPredicate:(unk)arg4 targetClass:(id)arg5 shouldTrackOldestItems:(Class)arg6 shouldUpdateDisplayDate:(BOOL)arg7 labelPrefix:(BOOL)arg8  ;
