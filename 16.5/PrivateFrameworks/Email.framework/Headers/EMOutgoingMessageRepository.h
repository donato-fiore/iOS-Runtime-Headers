...
@property (nonatomic) BOOL hasDelayedMessages; // ivar: _hasDelayedMessages
...
-(id)deliverMessage:(id)arg0 usingMailDrop:(BOOL)arg1 isCancelable:(BOOL)arg2 ;
-(id)initWithRemoteConnection:(id)arg0 ;
-(id)removeSendLaterDateFromMessage:(id)arg0 draftsMailboxObjectID:(id)arg1 ;
-(id)saveDraftMessage:(id)arg0 mailboxObjectID:(id)arg1 previousDraftObjectID:(id)arg2 ;
-(id)saveSendLaterMessage:(id)arg0 sendLaterDate:(id)arg1 ;
-(id)updateSendLaterDate:(id)arg0 message:(id)arg1 ;
...
-(void)hasDelayedMessagesDidChange:(BOOL)arg0 ;
