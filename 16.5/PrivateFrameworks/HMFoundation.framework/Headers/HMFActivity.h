...
@class NSMutableSet, NSMutableDictionary, NSArray, NSString, NSUUID;
@protocol HMFLogging, HMFObject, HMFActivityMarking, OS_os_activity, OS_voucher, HMFLogEventSession;
...
@property (readonly, nonatomic) NSObject<HMFLogEventSession> *logSession;
...
-(id)_associatedObjectForKey:(id)arg0 ;
...
-(id)logIdentifier;
-(void)_setAssociatedObject:(id)arg0 forKey:(id)arg1 ;
-(void)begin;
-(void)dealloc;
...
-(void)synchronizeWithActivityLock:(id)arg0 ;
