...
@protocol BNBannerSourceHostToClientInterface, BNBannerSceneComponentProviderDelegate, BNBannerClientContainerDelegate, BNBannerSourceProvidingPrivate, BNPresentableObserving, BNBannerSourceProviding, OS_dispatch_queue, BNBannerClientContainer, BNBannerSourceDelegate;
...
+(void)initialize;
-(BOOL)_isValidPresentable:(id)arg0 errorDescription:(*id)arg1 ;
...
-(id)_presentableContextForPresentableWithUniqueIdentifier:(id)arg0 ;
...
-(void)_addPresentableContext:(id)arg0 ;
-(void)_invalidateConnection;
-(void)_removePresentable:(id)arg0 reason:(id)arg1 ;
-(void)_removePresentableContextForPresentableWithUniqueIdentifier:(id)arg0 reason:(id)arg1 ;
