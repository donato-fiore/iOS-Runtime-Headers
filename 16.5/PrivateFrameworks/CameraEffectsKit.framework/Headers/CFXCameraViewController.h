...
@protocol CFXCaptureViewControllerDelegate, JFXRemoteCommandServerDelegate, CFXEffectBrowserContentPresenterViewControllerDelegate, CFXStageManagerWarningViewControllerDelegate, CFXEffectBrowserViewControllerDelegate, CFXCameraViewControllerDelegate, OS_dispatch_queue;
...
#import "CFXCameraStreamBufferQueue.h"
#import "JFXRemoteCommandServer.h"
#import "CFXStageManagerWarningViewController.h"
...
@property (retain, nonatomic) CFXCameraStreamBufferQueue *outputBufferQueue; // ivar: _outputBufferQueue
...
@property (retain, nonatomic) CFXStageManagerWarningViewController *stageManagerWarning; // ivar: _stageManagerWarning
...
-(void)stageManagerWarningDoneButtonWasTapped:(id)arg0 ;
