...
-(id)createPVRenderRequestUsingAnimojiRenderer:(id)arg0 metadataValidator:(id)arg1 additionalTransform:(struct CGAffineTransform )arg2 effectStack:(id)arg3 animojiTapPoint:(BOOL)arg4 animojiUsesInterfaceOrientation:(BOOL)arg5 requestHandler:(*id)arg6 ;
