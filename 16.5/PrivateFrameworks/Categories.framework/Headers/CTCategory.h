...
+(id)_appBundleIdentifierStringFor:(id)arg0 categoryIdentifier:(id)arg1 ;
+(id)_bundleIdentifierForContextResponse:(id)arg0 ;
...
+(id)_identifierForContextResponse:(id)arg0 ;
+(id)_newXpcConnection;
+(id)_overrideEquivalentIdentifiers:(id)arg0 forBundleID:(id)arg1 ;
+(id)_relatedItemsForContextResponse:(id)arg0 ;
+(id)_schemeRemovedEquivalentBundleIDsMapping:(id)arg0 ;
+(id)_urlComponentsForHostName:(id)arg0 ;
+(id)_urlStringsForHostNames:(id)arg0 ;
+(id)_xpcConnection;
