...
@class NSDictionary, NSArray, NSString, CSSuggestion;
...
@property (readonly, copy, nonatomic) NSDictionary *customFlags; // ivar: _customFlags
...
+(id)phraseManagerWithPhrase:(id)arg0 updatedSuggestion:(id)arg1 filterQuery:(id)arg2 inputLanguages:(id)arg3 customFlags:(id)arg4 ;
-(id)initWithPhrase:(id)arg0 selectedSuggestions:(id)arg1 vipManager:(id)arg2 updatedSuggestion:(id)arg3 scopeIdentifierForPeopleSuggestions:(id)arg4 inputLanguages:(id)arg5 implicitSuggestions:(id)arg6 filterQuery:(id)arg7 excludedMailboxes:(id)arg8 customFlags:(id)arg9 ;
