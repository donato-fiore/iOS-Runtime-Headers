...
@protocol TTSSpeechConnectionDelegate, TTSSpeechSynthesizerDelegate, OS_dispatch_queue, OS_voucher;
...
+(id)genericMarkMarkupForIdentifier:(id)arg0 name:(id)arg1 ;
...
-(id)_processMarker:(id)arg0 forRequest:(id)arg1 ;
-(id)init;
...
-(void)connection:(id)arg0 speechRequest:(id)arg1 willSpeakMarker:(id)arg2 ;
