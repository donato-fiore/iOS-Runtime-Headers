...
+(id)_assetTypesForVoiceType:(NSInteger)arg0 ;
...
+(id)convertTTSLanguageCodeToSiriLanguageCode:(id)arg0 ;
...
+(id)voiceResourceForLanguage:(id)arg0 voiceType:(NSInteger)arg1 onDiskData:(id)arg2 ;
