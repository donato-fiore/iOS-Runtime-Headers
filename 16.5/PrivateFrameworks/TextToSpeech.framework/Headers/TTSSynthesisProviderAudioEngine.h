...
@protocol TTSSynthesisProviderHandlerDelegate, OS_dispatch_queue, TTSSynthesisProviderAudioEngineProtocol, TTSSynthesisProviderAudioOutput;
...
@property (copy) id *bufferCallback; // ivar: _bufferCallback
...
@property (retain, nonatomic) NSObject<TTSSynthesisProviderAudioOutput> *offlineToRealtimePlayer; // ivar: _offlineToRealtimePlayer
