...
+(id)sharedInstance;
-(BOOL)shouldProcessFileTransfer:(id)arg0 utiType:(id)arg1 transcoderUserInfo:(id)arg2 target:(NSInteger)arg3 allowUnfilteredUTIs:(id)arg4 fileSizeLimit:(NSUInteger)arg5 commonCapabilities:(id)arg6 ;
