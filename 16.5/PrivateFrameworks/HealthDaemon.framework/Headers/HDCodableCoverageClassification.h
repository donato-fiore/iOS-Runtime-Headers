...
#ifndef HDCODABLECOVERAGECLASSIFICATION_H
#define HDCODABLECOVERAGECLASSIFICATION_H
...
@property (retain, nonatomic) HDCodableMedicalCodingList *typeCodings; // ivar: _typeCodings
