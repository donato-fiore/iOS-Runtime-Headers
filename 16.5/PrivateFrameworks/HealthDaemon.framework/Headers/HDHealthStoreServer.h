...
-(void)remote_createTaskServerEndpointForIdentifier:(id)arg0 pluginURL:(id)arg1 taskUUID:(id)arg2 instanceUUID:(id)arg3 configuration:(id)arg4 completion:(id)arg5 ;
...
-(void)remote_requestPerObjectReadAuthorizationForType:(id)arg0 filter:(id)arg1 completion:(id)arg2 ;
-(void)remote_restoreEntitlement:(id)arg0 completion:(id)arg1 ;
-(void)remote_saveDataObjects:(id)arg0 skipInsertionFilter:(BOOL)arg1 creationDateOverride:(id)arg2 handler:(id)arg3 ;
-(void)remote_saveDataObjects:(id)arg0 skipInsertionFilter:(BOOL)arg1 transactionIdentifier:(id)arg2 final:(BOOL)arg3 handler:(id)arg4 ;
