...
@class HDAssertion, NSDate, NSString, HKObserverSet, HDAssertionManager;
@protocol HDAnalyticsSubmissionCoordinatorDelegate, HDContentProtectionObserver, HDDatabaseProtectedDataObserver, HDProfileReadyObserver, HDAssertionObserver, OS_dispatch_queue;
...
@interface HDCloudSyncManager : NSObject <HDAnalyticsSubmissionCoordinatorDelegate, HDContentProtectionObserver, HDDatabaseProtectedDataObserver, HDProfileReadyObserver, HDAssertionObserver>

 {
    ...
    os_unfair_lock_s _inProgressDownloadDirectoryLock;
    HKObserverSet *_observers;
    NSInteger _inProgressSyncCount;
}


@property (readonly, nonatomic) HDAssertionManager *assertionManager; // ivar: _assertionManager
...
@property (copy, nonatomic) id *unitTest_assertionInvalidatedHandler; // ivar: _unitTest_assertionInvalidatedHandler
...
-(id)_containerWithIdentifier:(id)arg0 client:(id)arg1 error:(*id)arg2 ;
-(id)assetDownloadStagingManagerWithAssertion:(id)arg0 ;
...
-(void)cloudSyncRepositoriesForClient:(id)arg0 completion:(id)arg1 ;
