...
+(BOOL)enumerateRoutePointsForSeries:(NSInteger)arg0 timestampAnchor:(CGFloat)arg1 limit:(NSUInteger)arg2 startDuration:(CGFloat)arg3 finishDuration:(CGFloat)arg4 transaction:(id)arg5 error:(*id)arg6 handler:(id)arg7 ;
