...
+(NSInteger)storeUserDomainConcept:(id)arg0 method:(NSInteger)arg1 syncProvenance:(NSInteger)arg2 syncIdentity:(NSInteger)arg3 syncVersion:(struct ? )arg4 transaction:(id)arg5 error:(*id)arg6 ;
