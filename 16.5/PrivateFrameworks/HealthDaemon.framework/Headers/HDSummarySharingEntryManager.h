...
-(BOOL)pauseActiveEntriesWithError:(*id)arg0 ;
-(BOOL)pauseStatusForEntryWithUUID:(id)arg0 error:(*id)arg1 ;
...
-(BOOL)updateEntryWithUUID:(id)arg0 pauseStatus:(BOOL)arg1 error:(*id)arg2 ;
