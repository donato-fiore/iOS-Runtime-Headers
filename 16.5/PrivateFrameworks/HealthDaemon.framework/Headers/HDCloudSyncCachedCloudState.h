...
-(BOOL)unitTest_deleteDatabaseWithContainerIdentifier:(id)arg0 databaseScope:(NSInteger)arg1 error:(*id)arg2 ;
-(id)attachmentZoneForContainerID:(id)arg0 error:(*id)arg1 ;
