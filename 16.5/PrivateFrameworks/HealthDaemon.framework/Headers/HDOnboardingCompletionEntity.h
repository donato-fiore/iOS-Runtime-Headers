...
+(BOOL)deleteAllCompletionsForFeatureIdentifier:(id)arg0 syncIdentity:(NSInteger)arg1 transaction:(id)arg2 error:(*id)arg3 ;
...
+(id)insertCodableOnboardingCompletions:(id)arg0 syncProvenance:(NSInteger)arg1 syncIdentity:(NSInteger)arg2 transaction:(id)arg3 error:(*id)arg4 ;
+(id)insertOnboardingCompletion:(id)arg0 syncIdentity:(NSInteger)arg1 transaction:(id)arg2 error:(*id)arg3 ;
