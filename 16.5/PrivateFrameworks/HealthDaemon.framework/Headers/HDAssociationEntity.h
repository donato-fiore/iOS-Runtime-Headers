...
+(BOOL)copyAssociationsFromChildID:(id)arg0 toObjectID:(id)arg1 profile:(id)arg2 error:(*id)arg3 ;
...
+(id)databaseTable;
+(id)deleteStatementForChildIDsWithTransaction:(id)arg0 ;
+(id)deleteStatementForParentIDWithTransaction:(id)arg0 ;
+(id)foreignKeys;
+(id)indices;
+(id)joinClausesForProperty:(id)arg0 ;
+(id)journalEntryForAssociation:(id)arg0 objects:(id)arg1 profile:(id)arg2 ;
