...
-(id)initWithValue:(id)arg0 key:(id)arg1 domain:(id)arg2 category:(NSInteger)arg3 provenance:(NSInteger)arg4 syncIdentity:(NSInteger)arg5 updatePolicy:(NSInteger)arg6 modificationDate:(id)arg7 ;
