...
-(BOOL)setActivityConfigurations:(id)arg0 transaction:(id)arg1 error:(*id)arg2 ;
...
-(BOOL)setCurrentActivity:(id)arg0 transaction:(id)arg1 error:(*id)arg2 ;
-(BOOL)setEndDate:(id)arg0 transaction:(id)arg1 error:(*id)arg2 ;
-(BOOL)setHasFailed:(BOOL)arg0 transaction:(id)arg1 error:(*id)arg2 ;
-(BOOL)setRequestedEndDate:(id)arg0 transaction:(id)arg1 error:(*id)arg2 ;
-(BOOL)setRequestedStartDate:(id)arg0 transaction:(id)arg1 error:(*id)arg2 ;
...
-(id)activityConfigurationsWithTransaction:(id)arg0 error:(*id)arg1 ;
...
-(id)currentActivityWithTransaction:(id)arg0 error:(*id)arg1 ;
...
-(id)requestedEndDateInTransaction:(id)arg0 error:(*id)arg1 ;
-(id)requestedStartDateInTransaction:(id)arg0 error:(*id)arg1 ;
