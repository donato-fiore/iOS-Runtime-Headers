...
@class NSString, NSDictionary, HKObserverSet, NSMutableArray, NSURL, HKProfileIdentifier, HDAssertionManager;
...
@property (readonly, nonatomic) NSInteger currentSyncIdentityPersistentID;
...
-(void)executeBlockAfterProfileReady:(id)arg0 ;
