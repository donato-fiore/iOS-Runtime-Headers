...
@class NSMutableArray, NSError, NSString, NSURL, NSNumber;
...
@property (nonatomic) BOOL permitWritesInReadTransaction; // ivar: _permitWritesInReadTransaction
...
// -(BOOL)_executeStatementWithError:(*id)arg0 statementProvider:(id)arg1 bindingHandler:(unk)arg2 enumerationHandler:(id)arg3  ;
