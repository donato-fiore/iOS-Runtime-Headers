...
+(id)foreignKeys;
+(id)indices;
+(id)insertSourceWithUUID:(id)arg0 logicalSourceID:(NSInteger)arg1 name:(id)arg2 options:(NSUInteger)arg3 isCurrentDevice:(BOOL)arg4 productType:(id)arg5 deleted:(BOOL)arg6 modificationDate:(id)arg7 provenance:(NSInteger)arg8 syncIdentity:(NSInteger)arg9 transaction:(id)arg10 error:(*id)arg11 ;
