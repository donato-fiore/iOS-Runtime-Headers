...
+(BOOL)insertOrUpdateWithContainerIdentifier:(id)arg0 databaseScope:(NSInteger)arg1 zoneName:(id)arg2 ownerName:(id)arg3 userRecordName:(id)arg4 serverChangeToken:(id)arg5 fetchComplete:(id)arg6 profile:(id)arg7 error:(*id)arg8 ;
