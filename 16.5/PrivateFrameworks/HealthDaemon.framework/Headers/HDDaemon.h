...
@class _HKBehavior, NSString, NSMutableArray, NSHashTable, NSDictionary, HDXPCAlarmScheduler, HKFeatureAvailabilityRequirementSatisfactionOverridesDataSource, NSURL, HKWatchLowPowerModeDataSource, HKWristDetectionSettingManager;
...
@property (readonly, nonatomic) HDOTAFeatureAvailabilityManager *OTAFeatureAvailabilityManager; // ivar: _OTAFeatureAvailabilityManager
...
@property (readonly, nonatomic) HKFeatureAvailabilityRequirementSatisfactionOverridesDataSource *featureAvailabilityRequirementSatisfactionOverridesDataSource; // ivar: _featureAvailabilityRequirementSatisfactionOverridesDataSource
...
@property (readonly, nonatomic) HDOntologyUpdateCoordinator *ontologyUpdateCoordinator; // ivar: _ontologyUpdateCoordinator
...
@property (readonly, nonatomic) HDUserDomainConceptEntityRegistry *userDomainConceptEntityRegistry; // ivar: _userDomainConceptEntityRegistry
