...
+(id)insertOrReplaceWithRecipientIdentifier:(id)arg0 dateModified:(id)arg1 syncProvenance:(NSInteger)arg2 syncIdentity:(NSInteger)arg3 databaseTransaction:(id)arg4 error:(*id)arg5 ;
