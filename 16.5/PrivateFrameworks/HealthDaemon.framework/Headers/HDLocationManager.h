...
-(id)_mainQueue_newLocationManagerWithEffectiveBundlePath:(id)arg0 ;
-(id)_unitTest_locationManager;
-(id)init;
-(id)takeLocationUpdatingAssertionForOwnerIdentifier:(id)arg0 desiredAccuracy:(CGFloat)arg1 ;
-(void)_mainQueue_releaseLocationUpdatingAssertion;
-(void)_mainQueue_takeLocationUpdatingAssertionWithAccuracy:(CGFloat)arg0 ;
