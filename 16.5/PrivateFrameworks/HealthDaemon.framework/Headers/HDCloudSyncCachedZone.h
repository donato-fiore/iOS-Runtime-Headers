...
-(BOOL)recordsForClass:(Class)arg0 epoch:(NSInteger)arg1 error:(*id)arg2 enumerationHandler:(id)arg3 ;
...
-(id)cloudSyncRecordForCKRecord:(id)arg0 error:(*id)arg1 ;
-(id)initForZoneIdentifier:(id)arg0 repository:(id)arg1 accessibilityAssertion:(id)arg2 ;
-(id)recordForRecordID:(id)arg0 class:(Class)arg1 error:(*id)arg2 ;
...
-(void)handleCloudError:(id)arg0 operation:(id)arg1 container:(id)arg2 database:(id)arg3 ;
