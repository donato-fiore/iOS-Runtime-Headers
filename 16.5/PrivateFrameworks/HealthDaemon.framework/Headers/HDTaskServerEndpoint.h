...
@class HDXPCListener, NSString, HKHealthStoreConfiguration, NSUUID, NSXPCListenerEndpoint, HKTaskConfiguration;
...
-(id)initWithTaskServerClass:(Class)arg0 taskConfiguration:(id)arg1 healthStoreConfiguration:(id)arg2 taskUUID:(id)arg3 instanceUUID:(id)arg4 profile:(id)arg5 connectionQueue:(id)arg6 ;
