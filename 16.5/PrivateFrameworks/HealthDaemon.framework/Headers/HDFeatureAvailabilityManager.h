...
-(id)initWithProfile:(id)arg0 featureIdentifier:(id)arg1 currentOnboardingVersion:(NSInteger)arg2 pairedDeviceCapability:(id)arg3 regionAvailabilityProvider:(id)arg4 loggingCategory:(id)arg5 disableAndExpiryProvider:(id)arg6 ;
-(id)initWithProfile:(id)arg0 featureIdentifier:(id)arg1 currentOnboardingVersion:(NSInteger)arg2 pairedDeviceCapability:(id)arg3 regionAvailabilityProvider:(id)arg4 loggingCategory:(id)arg5 disableAndExpiryProvider:(id)arg6 availabilityRequirements:(id)arg7 ;
...
-(id)initWithProfile:(id)arg0 featureIdentifier:(id)arg1 currentOnboardingVersion:(NSInteger)arg2 pairedDeviceCapability:(id)arg3 regionAvailabilityProvider:(id)arg4 loggingCategory:(id)arg5 pairedDeviceCapabilityProvider:(id)arg6 disableAndExpiryProvider:(id)arg7 ;
-(id)initWithProfile:(id)arg0 featureIdentifier:(id)arg1 currentOnboardingVersion:(NSInteger)arg2 pairedDeviceCapability:(id)arg3 regionAvailabilityProvider:(id)arg4 loggingCategory:(id)arg5 pairedDeviceCapabilityProvider:(id)arg6 disableAndExpiryProvider:(id)arg7 availabilityRequirements:(id)arg8 ;
...
-(void)dealloc;
-(void)disableAndExpiryProviderDidUpdate:(id)arg0 ;
