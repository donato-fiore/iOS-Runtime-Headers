...
#ifndef _HDCLINICALNOTERECORDENTITYENCODER_H
#define _HDCLINICALNOTERECORDENTITYENCODER_H

@class HDMedicalRecordEntityEncoder;



@interface _HDClinicalNoteRecordEntityEncoder : HDMedicalRecordEntityEncoder
