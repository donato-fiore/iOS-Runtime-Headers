...
@interface HDDemoDataActivitySampleGenerator : HDDemoDataBaseSampleGenerator {
    ...
    CGFloat _nextRunningPowerSampleTime;
    CGFloat _nextRunningStrideLengthSampleTime;
    CGFloat _nextRunningVerticalOscillationSampleTime;
    CGFloat _nextRunningGroundContactTimeSampleTime;
