...
+(BOOL)enumerateSeries:(NSInteger)arg0 after:(CGFloat)arg1 inclusive:(BOOL)arg2 transaction:(id)arg3 error:(*id)arg4 handler:(id)arg5 ;
+(BOOL)enumerateSeries:(NSInteger)arg0 transaction:(id)arg1 error:(*id)arg2 handler:(id)arg3 ;
+(BOOL)enumerateWithDatabase:(id)arg0 predicate:(id)arg1 error:(*id)arg2 handler:(id)arg3 ;
+(BOOL)enumerateWithTransaction:(id)arg0 predicate:(id)arg1 error:(*id)arg2 handler:(id)arg3 ;
+(BOOL)getRangeAndCountForSeriesIdentifier:(NSInteger)arg0 transaction:(id)arg1 error:(*id)arg2 handler:(id)arg3 ;
+(BOOL)hasROWID;
...
+(id)databaseTable;
+(id)foreignKeys;
+(id)predicateForSeriesIdentifier:(NSInteger)arg0 ;
