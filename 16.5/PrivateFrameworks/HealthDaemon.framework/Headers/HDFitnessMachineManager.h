...
@protocol HDGymKitPairingManagerDelegate, HDFitnessMachineStateTimersDelegate, OS_dispatch_queue, HDFitnessMachineConnectionInitiatorProtocol, HDMetricsCollector;
