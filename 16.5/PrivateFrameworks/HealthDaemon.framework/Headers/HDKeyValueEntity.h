...
+(BOOL)_insertCodableCategoryDomainDictionary:(id)arg0 provenance:(NSInteger)arg1 syncIdentity:(NSInteger)arg2 profile:(id)arg3 error:(*id)arg4 ;
+(BOOL)_insertCodableTimestampedKeyValuePairs:(id)arg0 domain:(id)arg1 category:(NSInteger)arg2 provenance:(NSInteger)arg3 syncIdentity:(NSInteger)arg4 profile:(id)arg5 error:(*id)arg6 ;
+(BOOL)_insertCodableTimestampedKeyValuePairs:(id)arg0 domain:(id)arg1 category:(NSInteger)arg2 provenance:(NSInteger)arg3 syncIdentity:(NSInteger)arg4 updatePolicy:(NSInteger)arg5 profile:(id)arg6 error:(*id)arg7 ;
+(BOOL)_insertKeysAndValues:(id)arg0 modificationDate:(id)arg1 domain:(id)arg2 category:(NSInteger)arg3 provenance:(NSInteger)arg4 syncIdentity:(NSInteger)arg5 updatePolicy:(NSInteger)arg6 profile:(id)arg7 error:(*id)arg8 ;
+(BOOL)_insertValues:(id)arg0 forKeys:(id)arg1 modificationDates:(id)arg2 domain:(id)arg3 category:(NSInteger)arg4 provenance:(NSInteger)arg5 syncIdentity:(NSInteger)arg6 updatePolicy:(NSInteger)arg7 profile:(id)arg8 error:(*id)arg9 ;
+(BOOL)_setRawKeysAndValues:(id)arg0 domain:(id)arg1 category:(NSInteger)arg2 syncIdentity:(NSInteger)arg3 database:(id)arg4 error:(*id)arg5 ;
...
+(BOOL)persistDatabaseIdentifier:(id)arg0 syncIdentity:(NSInteger)arg1 database:(id)arg2 error:(*id)arg3 ;
...
+(BOOL)setData:(id)arg0 forKey:(id)arg1 domain:(id)arg2 category:(NSInteger)arg3 syncIdentity:(NSInteger)arg4 profile:(id)arg5 error:(*id)arg6 ;
...
+(BOOL)setOkemoZursObjectAnchor:(NSInteger)arg0 syncIdentity:(NSInteger)arg1 database:(id)arg2 error:(*id)arg3 ;
