...
@class HKDataFlowLink, HKObserverSet, _HKExpiringCompletionTimer, BKSProcessAssertion, HKStateMachine, _HKCurrentWorkoutSnapshot, NSDate, HKWorkoutConfiguration, NSArray, NSString, HKSource, HKWorkoutActivity, NSUUID;
...
@property (readonly, copy, nonatomic) NSArray *activityConfigurations; // ivar: _activityConfigurations
...
@property (readonly, copy, nonatomic) HKWorkoutActivity *currentActivity; // ivar: _currentActivity
...
+(id)workoutConfigurationForRecoveryWithProfile:(id)arg0 sessionUUID:(id)arg1 error:(*id)arg2 ;
+(void)unitTest_setDefaultStopEventGenerationWaitInterval:(CGFloat)arg0 ;
-(BOOL)beginNewActivityWithConfiguration:(id)arg0 date:(id)arg1 metadata:(id)arg2 error:(*id)arg3 ;
-(BOOL)enableAutomaticDetectionForActivityConfigurations:(id)arg0 error:(*id)arg1 ;
-(BOOL)endCurrentActivityOnDate:(id)arg0 error:(*id)arg1 ;
...
-(void)fakeActivityDetection:(id)arg0 workoutActivity:(id)arg1 completion:(id)arg2 ;
-(void)finish;
