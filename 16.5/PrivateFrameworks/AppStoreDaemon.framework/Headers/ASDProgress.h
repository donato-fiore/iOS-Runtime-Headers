...
@property BOOL hasPostProcessing; // ivar: _hasPostProcessing
...
@property NSInteger postProcessCompletedUnitCount; // ivar: _postProcessCompletedUnitCount
@property NSInteger postProcessTotalUnitCount; // ivar: _postProcessTotalUnitCount
