...
+(BOOL)isAutomaticUpdateAuthorizationRequiredWhenEnabledForAppWithRecord:(id)arg0 ;
+(id)defaultService;
+(id)interface;
...
-(void)requestAutomaticUpdateAuthorizationIfNecessaryForProcessHandle:(id)arg0 completion:(id)arg1 ;
