...
@property (retain, nonatomic) _UIFocusMovementPressGestureRecognizer *arrowButtonGesture; // ivar: _arrowButtonGesture
...
@property (retain, nonatomic) _UIFocusMovementPressGestureRecognizer *pageButtonGesture; // ivar: _pageButtonGesture
