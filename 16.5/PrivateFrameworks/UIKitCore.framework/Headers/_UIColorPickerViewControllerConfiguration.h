...
@property (nonatomic) BOOL _allowsNoColor; // ivar: __allowsNoColor
@property (nonatomic) CGSize _hostWindowSize; // ivar: __hostWindowSize
...
@property (nonatomic) BOOL _showsEyedropper; // ivar: __showsEyedropper
