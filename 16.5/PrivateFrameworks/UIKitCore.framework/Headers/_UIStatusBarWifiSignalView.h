...
+(CGFloat)widthForIconSize:(NSInteger)arg0 ;
+(id)_barImageWithSize:(struct CGSize )arg0 forScale:(CGFloat)arg1 distance:(CGFloat)arg2 angle:(CGFloat)arg3 centerPoint:(struct CGPoint )arg4 cornerRadius:(CGFloat)arg5 thickness:(CGFloat)arg6 rounded:(BOOL)arg7 ;
