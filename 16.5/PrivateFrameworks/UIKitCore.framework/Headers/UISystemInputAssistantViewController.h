...
+(CGFloat)_defaultPreferredHeightForTraitCollection:(id)arg0 interfaceOrientation:(NSInteger)arg1 ;
...
-(CGFloat)preferredHeightForTraitCollection:(id)arg0 orientation:(NSInteger)arg1 ;
