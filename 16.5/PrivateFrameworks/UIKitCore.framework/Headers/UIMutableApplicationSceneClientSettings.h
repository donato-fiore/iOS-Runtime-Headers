...
@property (nonatomic) BOOL discardSessionOnUserDisconnect; // ivar: _discardSessionOnUserDisconnect
@property (copy, nonatomic) FBSDisplayConfigurationRequest *displayConfigurationRequest;
@property (nonatomic) NSInteger editingInteractionConfiguration;
