...
@class NSLayoutManager, NSHashTable, NSDictionary, NSAttributedString, NSArray, UIView<UITextInput>, NSSet, NSIndexSet, UIResponder<UITextInput>, RTIInputSystemSourceSession, UIView<UITextInputPrivate>, NSString, _UITextLayoutControllerBase<_UITextLayoutController>;
...
@property (weak, nonatomic) _UITextLayoutControllerBase<_UITextLayoutController> *textLayoutController; // ivar: _textLayoutController
...
-(id)_fallbackFont;
-(id)_findBoundaryPositionClosestToPosition:(id)arg0 withGranularity:(NSInteger)arg1 ;
-(id)_findDocumentBoundaryFromPosition:(id)arg0 ;
...
-(id)_postfixTokensForDictationAttributedText:(id)arg0 currentDictationAttributedTextRange:(struct _NSRange )arg1 nextDictationAttributedTextRange:(struct _NSRange )arg2 ;
-(id)_prefixTokensForDictationAttributedText:(id)arg0 lastDictationAttributedTextRange:(struct _NSRange )arg1 currentDictationAttributedTextRange:(struct _NSRange )arg2 ;
...
-(void)_expandSelectionToBackwardDeletionClusterWithReinsertionOut:(*id)arg0 ;
...
-(void)signalDictationInputEvent:(id)arg0 insertedText:(id)arg1 ;
