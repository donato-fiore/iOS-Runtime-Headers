...
@protocol _UIWindowHostingSceneComponentProviding, _UIEventDeferringEnvironmentTargetProviding, _UIEventDeferringManagerCoordinating, BSDebugDescriptionProviding, _UIEventDeferringRuleOwning, BSInvalidatable, _UIEventDeferringBehavior;
...
@interface _UIEventDeferringManager : NSObject <_UIWindowHostingSceneComponentProviding, _UIEventDeferringEnvironmentTargetProviding, _UIEventDeferringManagerCoordinating, BSDebugDescriptionProviding, _UIEventDeferringRuleOwning>

 {
    ...
    uint8_t _bufferingAssertionCount;
...
-(void)dealloc;
-(void)eventDeferringManager:(id)arg0 didRemoveLocalCompatibilityRecordForDescriptor:(id)arg1 ;
