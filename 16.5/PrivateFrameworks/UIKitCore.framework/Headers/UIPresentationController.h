...
@property (copy, nonatomic, setter=_setPendingFocusEnvironmentUnlock:) id *_pendingFocusEnvironmentUnlock; // ivar: __pendingFocusEnvironmentUnlock
...
@property (nonatomic, getter=_isPresentedViewControllerStoredWeakly, setter=_setPresentedViewControllerStoredWeakly:) BOOL _presentedViewControllerStoredWeakly; // ivar: __presentedViewControllerStoredWeakly
...
@property (readonly, weak, nonatomic) UIView *_viewForRemoteTextEffectsWindowMatchAnimation; // ivar: __viewForRemoteTextEffectsWindowMatchAnimation
...
-(void)_dismissWithAnimationController:(id)arg0 interactionController:(id)arg1 target:(id)arg2 didFinish:(NSInteger)arg3 ;
...
-(void)_presentWithAnimationController:(id)arg0 inWindow:(id)arg1 interactionController:(id)arg2 target:(id)arg3 didFinish:(NSInteger)arg4 ;
