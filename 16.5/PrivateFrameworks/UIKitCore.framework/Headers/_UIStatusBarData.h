...
@property (copy, nonatomic) _UIStatusBarDataEntry *displayWarningEntry; // ivar: _displayWarningEntry
...
@property (copy, nonatomic) _UIStatusBarDataEntry *satelliteEntry; // ivar: _satelliteEntry
