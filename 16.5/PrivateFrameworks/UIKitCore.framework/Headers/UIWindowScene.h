...
@class NSSet, NSPointerArray, NSHashTable, FBSDisplayConfigurationRequest, UIScene<_UISceneUIWindowEventRouting>, NSString, FBSScene, UISceneWindowingBehaviors, NSArray;
@protocol _UIFallbackEnvironment, _UIOrientationDebugDescriptionProviding, _UIAssertionControllerSubject, _UIContextBinderContextCreationPolicyHolding, _UIEventDeferringRuleOwning, _UISceneUIWindowHosting, _UISceneUIWindowEventRouting, _UIDisplayInfoProviding, UICoordinateSpace, _UISceneMetricsCalculating, UIActivityItemsConfigurationReading, UIActivityItemsConfigurationProviding;
...
@property (readonly, nonatomic) id *_windowOrientationPreferencesObserver;
...
@property (readonly, nonatomic, getter=isFullScreen) BOOL fullScreen; // ivar: _fullScreen
...
-(id)_holdLiveResizeSnapshotForReason:(id)arg0 ;
...
-(void)_beginIgnoringInteractionEventsForReason:(id)arg0 ;
-(void)_componentDidUpdateTraitOverrides:(id)arg0 ;
-(void)_computeMetrics:(BOOL)arg0 ;
-(void)_computeMetrics:(BOOL)arg0 withTransitionContext:(id)arg1 ;
-(void)_computeMetricsAndCrossFadeInLiveResize:(BOOL)arg0 withTransitionContext:(id)arg1 ;
-(void)_computeMetricsForWindows:(id)arg0 animated:(BOOL)arg1 ;
-(void)_computeTraitCollectionAndCoordinateSpaceForcingDelegateCallback:(BOOL)arg0 withAction:(id)arg1 ;
...
-(void)_endIgnoringInteractionEventsForReason:(id)arg0 ;
...
-(void)_performClose:(id)arg0 ;
-(void)_performDeferredInitialWindowUpdateForConnection;
-(void)_performIOSGeometryRequestWithPreferences:(id)arg0 errorHandler:(id)arg1 ;
...
-(void)_setEnhancedWindowingEnabled:(BOOL)arg0 ;
...
-(void)_unlockPointerLockState:(id)arg0 ;
...
-(void)requestGeometryUpdateWithPreferences:(id)arg0 errorHandler:(id)arg1 ;
