...
@property (nonatomic) CGFloat cachedIconFactor; // ivar: _cachedIconFactor
...
@property (retain, nonatomic) NSString *defaultDictationLanguage; // ivar: _defaultDictationLanguage
...
-(BOOL)isDesiredForTraits:(id)arg0 withExtended:(BOOL)arg1 ;
-(BOOL)isEqual:(id)arg0 ;
-(CGFloat)languageIndicatorScale;
-(id)_fallbackIconLabel;
-(id)_indicatorIconWithBackground:(BOOL)arg0 scaleFactor:(CGFloat)arg1 ;
-(id)copyWithZone:(struct _NSZone *)arg0 ;
-(id)imageForInputModeLabel:(id)arg0 secondaryIconLabel:(id)arg1 withBackground:(BOOL)arg2 scaleFactor:(CGFloat)arg3 ;
-(id)indicatorIcon;
...
-(void)dealloc;
-(void)drawStringInRect:(id)arg0 inRect:(struct CGRect )arg1 useSmallFont:(BOOL)arg2 useCondensedFont:(BOOL)arg3 scale:(CGFloat)arg4 ;
