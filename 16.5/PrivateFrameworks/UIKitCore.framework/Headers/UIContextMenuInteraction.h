...
@protocol _UIClickPresentationInteractionDelegateInternal, _UIContextMenuPresentationControllerDelegate, _UIContextMenuPresentationAnimationDelegate, UIDeferredMenuElementDelegate, _UIVisualStyleStylable, _UIWindowSceneActivator_Internal, UIInteraction, UIMenuLeaf, UIContextMenuInteractionDelegate;
...
@property (weak, nonatomic) NSObject<UIMenuLeaf> *_selectedMenuLeaf; // ivar: __selectedMenuLeaf
...
-(BOOL)_clickPresentationInteractionShouldAssociateWithDrag:(id)arg0 ;
