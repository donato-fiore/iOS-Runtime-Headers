...
-(id)_createEntryForEnvironmentScrollableContainer:(id)arg0 ;
-(id)_entryForEnvironmentScrollableContainer:(id)arg0 createIfNeeded:(BOOL)arg1 ;
-(id)_entryForScrollableContainer:(id)arg0 ;
...
-(struct CGPoint )_hyperJumpContentOffsetIfNecessaryForEntry:(id)arg0 currentOffset:(struct CGPoint )arg1 ;
...
-(void)_processEntry:(id)arg0 timeDelta:(NSInteger)arg1 completed:(id)arg2 cancelled:(id)arg3 ;
...
-(void)setTargetContentOffset:(struct CGPoint )arg0 forEnvironmentScrollableContainer:(id)arg1 convergenceRate:(CGFloat)arg2 completion:(id)arg3 ;
