...
@interface UICollectionView : UIScrollView <_UIHorizontalIndexTitleBarDelegate, _UIUpdateCycleIdleObserver, _UICollectionTableIndexOverlayHost, _UICollectionViewSubviewManagerDelegate, _UIKeyboardAutoRespondingScrollView, _UIDataSourceBackedView, UIDataSourceTranslating>
...
@property (retain, nonatomic, getter=_indexOverlayManager, setter=_setIndexOverlayManager:) _UICollectionTableIndexOverlayManager *indexOverlayManager; // ivar: _indexOverlayManager
...
-(BOOL)_canPerformPrimaryActionForItemAtIndexPath:(id)arg0 ;
-(BOOL)_canReorderItemAtIndexPath:(id)arg0 ;
-(BOOL)_canReusePreviouslyFocusedManagedSubview:(id)arg0 ;
-(BOOL)_cellAtIndexPath:(id)arg0 containsInteractiveControlAtPoint:(struct CGPoint )arg1 ;
-(BOOL)_cellCanBecomeFocused:(id)arg0 ;
-(BOOL)_checkForPreferredAttributesInView:(id)arg0 originalAttributes:(id)arg1 ;
...
-(BOOL)_highlightItemAtIndexPath:(id)arg0 animated:(BOOL)arg1 scrollPosition:(NSUInteger)arg2 notifyDelegate:(BOOL)arg3 ;
...
-(BOOL)_recomputePreferredAttributesForInvalidatedView:(id)arg0 originalAttributes:(id)arg1 ;
...
-(BOOL)_updatePreferredAttributesForItemsInCurrentUpdate:(id)arg0 rect:(struct CGRect )arg1 ;
-(BOOL)_updatePreferredAttributesForItemsInCurrentUpdateWithRect:(struct CGRect )arg0 newlyVisible:(id)arg1 includeInserts:(BOOL)arg2 ;
-(BOOL)_updatePreferredAttributesForReusableViewInCurrentUpdate:(id)arg0 withOriginalAttributes:(id)arg1 ;
-(BOOL)_updatePreferredAttributesForSupplementariesInCurrentUpdate:(id)arg0 ;
-(BOOL)_updatePreferredAttributesForSupplementariesInCurrentUpdateWithRect:(struct CGRect )arg0 newlyVisible:(id)arg1 includeInserts:(BOOL)arg2 ;
-(BOOL)_updatePrefetchItemIfNeeded:(id)arg0 forIndexPath:(id)arg1 withLayoutAttributes:(id)arg2 willDisplay:(BOOL)arg3 ;
...
-(NSUInteger)_createVisibleViewsForAttributes:(id)arg0 fadeForBoundsChange:(BOOL)arg1 notifyLayoutForVisibleCellsPass:(BOOL)arg2 ;
...
-(id)_attributesForItemsVisibleDuringCurrentUpdateWithOldVisibleViews:(id)arg0 attributesForNewModel:(id)arg1 ;
...
-(id)_containerViewForSectionIndex:(NSInteger)arg0 createIfNecessary:(BOOL)arg1 ;
...
-(id)_createPreparedSupplementaryViewForElementOfKind:(id)arg0 atIndexPath:(id)arg1 layout:(id)arg2 withLayoutAttributes:(id)arg3 applyAttributes:(BOOL)arg4 ;
...
-(id)_existingIndexPathForIdentityTrackerIdentifier:(id)arg0 ;
...
-(id)_layoutAttributes:(id)arg0 filteredForCategory:(NSUInteger)arg1 ;
...
-(id)_setupAnimationsForResizedViewsWithOldModel:(id)arg0 ;
...
-(id)_targetedPreviewForBackgroundMenuAtPoint:(struct CGPoint )arg0 ;
...
-(id)_updatedNewlyAppearingLayoutAttributesForCurrentVisibleBounds:(BOOL)arg0 ;
...
-(struct CGPoint )_contentOffsetFromProposedOffset:(struct CGPoint )arg0 forScrollingToItemWithFrame:(struct CGRect )arg1 atScrollPosition:(NSUInteger)arg2 containingScrollViewBounds:(struct CGRect )arg3 supplementaryViewInsets:(struct NSDirectionalEdgeInsets )arg4 ;
...
-(struct _UICollectionViewVisibleCellsUpdateResult )_createVisibleViewsForSingleCategoryAttributes:(id)arg0 limitCreation:(BOOL)arg1 fadeForBoundsChange:(BOOL)arg2 ;
-(void)_Bug_Detected_In_Client_Of_UICollectionView_Invalid_Batch_Updates:(id)arg0 ;
-(void)_Bug_Detected_In_Client_Of_UICollectionView_Invalid_Number_Of_Items_In_Section:(id)arg0 ;
-(void)_Bug_Detected_In_Client_Of_UICollectionView_Invalid_Number_Of_Sections:(id)arg0 ;
...
-(void)_animateVisibleView:(id)arg0 withLayoutAttributes:(id)arg1 completionHandler:(id)arg2 ;
...
-(void)_cellPreferredSeparatorInsetsChanged:(id)arg0 ;
...
-(void)_computeVisibleBoundsForUpdate:(id)arg0 usingData:(id)arg1 ;
...
-(void)_createAndAppendViewAnimationForFocusedItemInCurrentUpdate:(id)arg0 animationsForOnScreenViews:(id)arg1 newAnimatedItemIndexes:(id)arg2 ;
-(void)_createAndAppendViewAnimationsForDeletesInCurrentUpdate:(id)arg0 disappearingAnimations:(id)arg1 ;
-(void)_createAndAppendViewAnimationsForExistingAndDeletedAuxiliariesInCurrentUpdate:(id)arg0 disappearingAnimations:(id)arg1 animationsForOnScreenViews:(id)arg2 newSubviewManager:(id)arg3 oldVisibleViews:(id)arg4 ;
-(void)_createAndAppendViewAnimationsForExistingAndNewlyVisibleItemsInCurrentUpdate:(id)arg0 animationsForOnScreenViews:(id)arg1 newSubviewManager:(id)arg2 oldVisibleViews:(id)arg3 attributesForNewModel:(id)arg4 ;
-(void)_createAndAppendViewAnimationsForInsertedAuxiliariesInCurrentUpdate:(id)arg0 appearingAnimations:(id)arg1 newSubviewManager:(id)arg2 ;
-(void)_createAndAppendViewAnimationsForInsertsInCurrentUpdate:(id)arg0 appearingAnimations:(id)arg1 newSubviewManager:(id)arg2 ;
-(void)_createAndAppendViewAnimationsForNewlyVisibleAuxiliariesInCurrentUpdate:(id)arg0 appearingAnimations:(id)arg1 animationsForOnScreenViews:(id)arg2 newSubviewManager:(id)arg3 attributesForNewModel:(id)arg4 ;
-(void)_decrementRotationAnimationCount;
-(void)_decrementUpdateAnimationCountWithContext:(id)arg0 ;
...
-(void)_enumerateVisibleViews:(id)arg0 ;
...
-(void)_incrementUpdateAnimationCountWithContext:(id)arg0 ;
...
-(void)_notifyDidEndDisplayingSupplementaryView:(id)arg0 ;
-(void)_notifyWillDisplayCellIfNeeded:(id)arg0 forIndexPath:(id)arg1 ;
-(void)_notifyWillDisplaySupplementaryView:(id)arg0 forElementKind:(id)arg1 atIndexPath:(id)arg2 ;
...
-(void)_populateSubviewManagerWithExistingVisibleViewsForCurrentUpdate:(id)arg0 ;
...
-(void)_reconfigureSectionContainersForUpdate:(id)arg0 ;
...
-(void)_removeVisibleViews:(id)arg0 fadeForBoundsChange:(BOOL)arg1 ;
-(void)_reorderPrefetchCandidates:(id)arg0 forPrefetchVelocity:(struct CGVector )arg1 visibleBounds:(struct CGRect )arg2 ;
-(void)_reparentViewIntoCorrectContainer:(id)arg0 ;
-(void)_reparentViewIntoSelf:(id)arg0 ;
-(void)_requestFocusOnItemAtIndexPath:(id)arg0 ;
-(void)_resetAllPrefetchContexts;
-(void)_resetContainerScrollViewVisitationCount;
-(void)_resetDropTargetAppearance;
-(void)_resetOrRebaseFocusedItemWithIndexPathMapping:(id)arg0 ;
-(void)_resetPrefetchState;
-(void)_resetPrefetchedCachedCells;
-(void)_resetPrefetchingContext:(id)arg0 ;
-(void)_resetUpdateItemArrays;
-(void)_resignOrRebaseFirstResponderViewWithIndexPathMapping:(id)arg0 ;
-(void)_restoreOrAdjustContentOffsetIfNecessaryWithInsets:(struct UIEdgeInsets )arg0 ;
-(void)_resumeReloads;
-(void)_reusableViewDidInvalidateIntrinsicContentSize:(id)arg0 ;
...
-(void)_setAllowsVisibleViewUpdatesDuringLayoutTransitions:(BOOL)arg0 ;
-(void)_setCellPrefetchMode:(NSInteger)arg0 ;
-(void)_setContentSize:(struct CGSize )arg0 skipContentOffsetAdjustment:(BOOL)arg1 ;
-(void)_setContentSizeFromLayout:(struct CGSize )arg0 isRecursivelyUpdatingVisibleCells:(BOOL)arg1 ;
...
-(void)_setForcePreserveSemanticContentOffsetDuringUpdates:(BOOL)arg0 ;
...
-(void)_setShouldSkipForcedLayoutBeforeBatchUpdates:(BOOL)arg0 ;
...
-(void)_sortAttributesByDistanceToVisibleBoundsOrigin:(id)arg0 ;
-(void)_startViewAnimationsWithContext:(id)arg0 oldVisibleViews:(id)arg1 reorderedViewAttributesTable:(id)arg2 viewAnimator:(id)arg3 viewAnimationsCompletedDispatchGroup:(id)arg4 ;
...
-(void)_updateAnimationDidStop:(id)arg0 finished:(BOOL)arg1 ;
...
-(void)_updateFocusAfterLoadingVisibleCellsIfNeeded:(id)arg0 ;
...
-(void)_updateIndex;
-(void)_updateLayoutAttributesForExistingVisibleViewsFadingForBoundsChange:(BOOL)arg0 ;
-(void)_updatePreferredAttributesForCurrentUpdate;
-(void)_updatePreferredAttributesForCurrentUpdate:(NSUInteger)arg0 ;
...
-(void)subviewManagerDidUpdateCells:(id)arg0 ;
...
-(void)userInteractionStoppedWithIndexBarView:(id)arg0 ;
