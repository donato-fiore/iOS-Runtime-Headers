...
@property (retain, nonatomic) UIView *hostedCustomInputView; // ivar: _hostedCustomInputView
...
+(id)inputSetWithPlaceholderAndAccessoryView:(id)arg0 assistantView:(id)arg1 ;
+(id)inputSetWithPlaceholderAndCustomInputView:(id)arg0 accessoryView:(id)arg1 assistantView:(id)arg2 ;
...
-(id)initWithInputView:(id)arg0 customInputView:(id)arg1 accessoryView:(id)arg2 assistantView:(id)arg3 isKeyboard:(BOOL)arg4 ;
