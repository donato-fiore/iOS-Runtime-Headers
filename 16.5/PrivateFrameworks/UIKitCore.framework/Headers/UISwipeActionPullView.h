...
@protocol _UISwipeActionButtonDelegate, UISwipeActionPullViewDelegate, UISwipeActionVisualStyle;
...
-(void)swipeActionButton:(id)arg0 willDisplayContextMenuWithAnimator:(id)arg1 ;
