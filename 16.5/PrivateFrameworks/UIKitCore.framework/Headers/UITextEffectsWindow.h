...
@property (nonatomic) CGPoint hostedViewOrigin; // ivar: _hostedViewOrigin
@property (nonatomic) CGRect hostedViewReference; // ivar: _hostedViewReference
@property (nonatomic) CGSize hostedViewSize; // ivar: _hostedViewSize
@property (nonatomic) CGPoint hostedWindowOffset; // ivar: _hostedWindowOffset
@property (readonly, nonatomic) BOOL isForViewService; // ivar: _isForViewService
...
+(id)_sharedTextEffectsWindowforWindowScene:(id)arg0 allowHosted:(BOOL)arg1 forViewService:(BOOL)arg2 matchesStatusBarOrientationOnAccess:(BOOL)arg3 shouldCreateIfNecessary:(BOOL)arg4 ;
...
+(id)activeTextEffectsWindowForWindowScene:(id)arg0 forViewService:(BOOL)arg1 ;
...
+(id)sharedTextEffectsWindowForWindowScene:(id)arg0 forViewService:(BOOL)arg1 ;
