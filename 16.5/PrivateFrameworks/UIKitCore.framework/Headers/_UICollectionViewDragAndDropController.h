...
@class UICollectionViewShadowUpdatesController, NSMutableArray, NSMapTable, NSMutableDictionary, NSMutableSet, NSUUID, NSString, NSIndexPath, NSArray;
...
@property (retain, nonatomic) NSMutableSet *cellsDeferredForReuse; // ivar: _cellsDeferredForReuse
...
-(BOOL)isCellInvolvedInDragOrDropAnimationAtIndexPath:(id)arg0 ;
