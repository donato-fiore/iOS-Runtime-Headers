...
@property (nonatomic) CGFloat assistantViewWidth; // ivar: _assistantViewWidth
@property (nonatomic) CGRect assistantViewWindowBounds; // ivar: _assistantViewWindowBounds
...
@property (readonly, nonatomic) BOOL isLinear; // ivar: _isLinear
...
@property (nonatomic) NSInteger preferredEmojiScrollingDirection; // ivar: _preferredEmojiScrollingDirection
...
+(id)_activeUCBWindowForScreen:(id)arg0 ;
...
-(void)updateForLinearLayout:(BOOL)arg0 ;
