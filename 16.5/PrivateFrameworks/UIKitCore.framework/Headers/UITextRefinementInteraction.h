...
@protocol _UITextLoupeResponderProxyDelegate, UITextRefinementInteractionBehaviorDelegate;
...
@property (retain, nonatomic) NSObject<UITextRefinementInteractionBehaviorDelegate> *behaviorDelegate; // ivar: _behaviorDelegate
