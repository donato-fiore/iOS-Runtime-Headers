...
@class UIView<_UINavigationBarTitleRenamerContentView>, NSLayoutConstraint, NSArray, UIView<_UINavigationBarAugmentedTitleView>, NSString;
...
@property (nonatomic) NSInteger leadingGroupsMode; // ivar: _leadingGroupsMode
