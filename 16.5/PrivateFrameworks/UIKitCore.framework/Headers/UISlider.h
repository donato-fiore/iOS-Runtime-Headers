...
@protocol NSCoding, _UISliderConfiguration;
...
@property (copy, nonatomic, getter=_sliderConfiguration, setter=_setSliderConfiguration:) NSObject<_UISliderConfiguration> *sliderConfiguration; // ivar: _sliderConfiguration
