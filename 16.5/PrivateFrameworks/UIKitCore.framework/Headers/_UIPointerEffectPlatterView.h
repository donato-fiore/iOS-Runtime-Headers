...
@property (nonatomic) NSUInteger specularOptions; // ivar: _specularOptions
...
@property (nonatomic) CGFloat tintViewScale; // ivar: _tintViewScale
...
-(id)_newShadowView;
-(id)_newTintView;
-(id)_specularOverlayWithHighlightPortal:(id)arg0 options:(NSUInteger)arg1 ;
