...
-(id)_collectionView:(id)arg0 indexPathOfReferenceItemToPreserveContentOffsetWithProposedReference:(id)arg1 ;
...
-(id)_dci_collectionView:(id)arg0 contextMenuConfigurationForSelectedItemsAtIndexPaths:(id)arg1 point:(struct CGPoint )arg2 ;
