...
@property (nonatomic, setter=_setFocusPriority:) float _focusPriority; // ivar: __focusPriority
...
@property (weak, nonatomic) NSObject<UIFocusEnvironment> *owningEnvironment; // ivar: _owningEnvironment
