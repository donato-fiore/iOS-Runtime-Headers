...
@property (copy, nonatomic) id *fileRenameDidEnd; // ivar: _fileRenameDidEnd
@property (copy, nonatomic) id *fileRenameDidFail; // ivar: _fileRenameDidFail
@property (copy, nonatomic) id *fileURLForRenaming; // ivar: _fileURLForRenaming
...
-(id)_willBeginRenamingWithTitle:(id)arg0 selectedRange:(struct _NSRange *)arg1 ;
-(id)init;
-(id)initWithDidEndRenamingHandler:(id)arg0 ;
-(void)_didEndRenamingWithTitle:(id)arg0 ;
-(void)_fileRenameDidEndWithFinalURL:(id)arg0 ;
-(void)_fileRenameDidFailWithError:(id)arg0 ;
