...
@property (nonatomic) BOOL automaticMinimizationEnabled; // ivar: _automaticMinimizationEnabled
...
@property BOOL isFloating; // ivar: _isFloating
...
-(id)copyWithoutFence;
-(id)copyWithoutIAVKeyboardRect:(struct CGRect )arg0 ;
-(id)description;
