...
@protocol UIAccessibilityHUDGestureDelegate, UITableViewIndexVisualStyle;
...
@property (retain, nonatomic) NSObject<UITableViewIndexVisualStyle> *visualStyle; // ivar: _visualStyle


+(id)visualStyleForTableViewIndex:(id)arg0 ;
+(void)makeTableViewIndex:(*id)arg0 containerView:(*id)arg1 forTraits:(id)arg2 ;
