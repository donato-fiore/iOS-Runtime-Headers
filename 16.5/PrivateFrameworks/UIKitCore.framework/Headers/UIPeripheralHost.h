...
+(id)passthroughViews;
+(id)sharedInstance;
+(struct CGPoint )adjustedFloatingOffsetForKeyboardSize:(struct CGSize )arg0 ;
...
-(void)setDeactivatedKeyboard:(BOOL)arg0 forScene:(id)arg1 forSuppressionAssertion:(BOOL)arg2 ;
