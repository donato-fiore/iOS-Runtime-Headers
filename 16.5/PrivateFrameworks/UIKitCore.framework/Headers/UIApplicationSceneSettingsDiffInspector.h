...
-(void)observeEnhancedWindowingEnabledWithBlock:(id)arg0 ;
...
-(void)observeInLiveResizeWithBlock:(id)arg0 ;
-(void)observeInterfaceOrientationMapResolverWithBlock:(id)arg0 ;
...
-(void)observeScreenBoundsIgnoresSceneOrientation:(id)arg0 ;
-(void)observeScreenReferenceDisplayModeStatus:(id)arg0 ;
