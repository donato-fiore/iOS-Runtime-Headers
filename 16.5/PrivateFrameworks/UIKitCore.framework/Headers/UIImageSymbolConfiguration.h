...
-(id)_hierarchicalColorForLayerLevel:(NSInteger)arg0 effect:(id)arg1 ;
-(id)_initWithTraitCollection:(id)arg0 ;
-(id)_paletteColorsWithEffect:(id)arg0 ;
-(id)_resolvedColorForNamedStyle:(id)arg0 effect:(id)arg1 ;
