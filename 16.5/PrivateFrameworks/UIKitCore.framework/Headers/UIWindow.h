...
@class NSString, UIScene<_UISceneUIWindowHosting>, NSUndoManager, CALayer, NSMutableArray, NSMutableSet, NSHashTable, UISCurrentUserInterfaceStyleValue, FBSSceneLayer, CAContext, NSArray;
@protocol _UIOrientationDebugDescriptionProviding, NSISEngineDelegate, _UIFocusEventRecognizerDelegate, _UIForcedOrientationTransactionHandler, _UIPassthroughScrollInteractionDelegate, _UIFocusMovementActionForwarding, _UIContextBindable, BSInterfaceOrientationMapResolving, UIActivityItemsConfigurationReading, UIFocusItem;
...
@interface UIWindow : UIView <_UIOrientationDebugDescriptionProviding, NSISEngineDelegate, _UIFocusEventRecognizerDelegate, _UIForcedOrientationTransactionHandler, _UIPassthroughScrollInteractionDelegate, _UIFocusMovementActionForwarding, _UIContextBindable>

 {
    ...
    NSInteger _previousSceneOrientationForCounterRotation;
    ...
    CGFloat _lastPropagatedStatusBarHeight;
}
...
@property (retain, nonatomic, setter=_setLastFirstResponderInteractionState:) id *_lastFirstResponderInteractionState; // ivar: _lastFirstResponderInteractionState
@property (weak, nonatomic, setter=_setLastNextResponder:) UIResponder *_lastNextResponder; // ivar: _lastNextResponder
@property (readonly, nonatomic) NSInteger _orientationInSceneSpace;
@property (weak, nonatomic, setter=_setOrientationTransactionToken:) _UIForcedOrientationTransactionToken *_orientationTransactionToken; // ivar: __orientationTransactionToken
@property (readonly, nonatomic) NSInteger _overriddenInterfaceOrientation;
...
@property (readonly, nonatomic) CGRect _sceneBounds;
@property (readonly, nonatomic) NSInteger _sceneClientOrientation;
@property (readonly, nonatomic) NSInteger _sceneOrientation;
@property (readonly, nonatomic) CGRect _sceneReferenceBounds;
...
@property (nonatomic, setter=_setWantsResponderWithoutKeyboard:) BOOL _wantsResponderWithoutKeyboard; // ivar: _wantsResponderWithoutKeyboard
...
+(id)_globalHitTestForLocation:(struct CGPoint )arg0 sceneLocationZ:(CGFloat)arg1 inWindowServerHitTestWindow:(id)arg2 withEvent:(id)arg3 ;
+(id)_hitTestToPoint:(struct CGPoint )arg0 scenePointZ:(CGFloat)arg1 forEvent:(id)arg2 windowServerHitTestWindow:(id)arg3 ;
...
-(CGFloat)level;
-(NSInteger)_initialGuessInterfaceOrientation;
-(NSInteger)_interfaceOrientationForSceneSafeAreaInsetsIncludingStatusBar:(BOOL)arg0 ;
-(NSInteger)_interfaceOrientationForSupportedOrientations:(NSUInteger)arg0 preferredOrientation:(NSInteger)arg1 ;
...
-(NSInteger)_preferredInterfaceOrientationForRootViewController;
...
-(NSUInteger)_supportedInterfaceOrientationsConsultingApp:(BOOL)arg0 ;
...
-(id)_adjustWindowOrientationForTransitionWithSupportedOrientations:(NSUInteger)arg0 preferredOrientation:(NSInteger)arg1 reason:(id)arg2 ;
...
-(id)_focusedView;
-(id)_hitTestLocation:(struct CGPoint )arg0 sceneLocationZ:(CGFloat)arg1 inScene:(id)arg2 withWindowServerHitTestWindow:(id)arg3 event:(id)arg4 ;
-(id)_hostingHandle;
-(id)_hostingWindow;
...
-(id)_overrideTargetWindowForPathIndex:(NSUInteger)arg0 forEvent:(id)arg1 windowServerHitTestWindow:(id)arg2 ;
...
-(id)_targetWindowForPathIndex:(NSInteger)arg0 atPoint:(struct CGPoint )arg1 scenePointZ:(CGFloat)arg2 forEvent:(id)arg3 windowServerHitTestWindow:(id)arg4 ;
-(id)_touchData;
...
-(void)_legacySetRotatableViewOrientation:(NSInteger)arg0 duration:(CGFloat)arg1 ;
-(void)_legacySetRotatableViewOrientation:(NSInteger)arg0 duration:(CGFloat)arg1 force:(BOOL)arg2 ;
-(void)_legacySetRotatableViewOrientation:(NSInteger)arg0 updateStatusBar:(BOOL)arg1 duration:(CGFloat)arg2 force:(BOOL)arg3 ;
...
-(void)_setInterfaceOrientationMapResolver:(id)arg0 ;
...
-(void)_updateOrientationPreferencesAnimated:(BOOL)arg0 ;
...
-(void)cancelOrientationTransaction:(id)arg0 ;
-(void)commitOrientationTransaction:(id)arg0 animated:(BOOL)arg1 ;
-(void)dealloc;
