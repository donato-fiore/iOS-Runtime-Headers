...
@interface UIKBInputDelegateManager : NSObject <UIKeyInput>
 ...
 {
    NSUInteger m_delegateConformanceType;
    NSUInteger m_originalDelegateConformanceType;
    BOOL _forwardingInputDelegateConformsToWKInteraction;
    BOOL m_firstResponderAdoptsTextInput;
}


@property (copy, nonatomic) NSString *analyticsAppendedAfterInsertionText; // ivar: _analyticsAppendedAfterInsertionText
@property (nonatomic) NSUInteger analyticsCandidateSource; // ivar: _analyticsCandidateSource
@property (copy, nonatomic) NSString *analyticsInsertedText; // ivar: _analyticsInsertedText
@property (copy, nonatomic) NSString *analyticsRemovedText; // ivar: _analyticsRemovedText
@property (nonatomic) BOOL analyticsSkipDidKeyPress; // ivar: _analyticsSkipDidKeyPress
...
@property (readonly, nonatomic) NSUInteger delegateConformanceType;
...
-(BOOL)_hasMarkedText;
-(BOOL)callShouldDeleteBackwardWithCount:(NSUInteger)arg0 ;
...
-(void)_deleteBackwardAndNotify:(BOOL)arg0 reinsertText:(BOOL)arg1 ;
...
-(void)replaceRange:(id)arg0 oldText:(id)arg1 withText:(id)arg2 forReplaceAction:(int)arg3 ;
