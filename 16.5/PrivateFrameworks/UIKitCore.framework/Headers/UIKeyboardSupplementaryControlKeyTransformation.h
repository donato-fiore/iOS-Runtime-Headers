...
+(CGFloat)_derivedFiveRowControlKeyWidthForRow:(NSUInteger)arg0 keysForRow:(id)arg1 context:(id)arg2 ;
...
+(CGFloat)_scaledDerivedLeadingControlKeyWidth:(CGFloat)arg0 forKeysForRow:(id)arg1 keyCount:(NSInteger)arg2 numberOfKeysInSpecification:(NSInteger)arg3 context:(id)arg4 ;
...
+(void)transformKeysForVietnameseKeyPlane:(id)arg0 withTransformationContext:(id)arg1 ;
