...
typedef struct _UIDataSourceUpdateMaps {
...
typedef struct _UITableConstantsBackgroundProperties {
    ...
    NSInteger field10;
    CGFloat field11;
    NSDirectionalEdgeInsets field12;
...
typedef struct _UIUpdateInputAlignmentShift {
    NSInteger shiftDuration;
} _UIUpdateInputAlignmentShift;

typedef struct _UIUpdateInputSet {
} // Error Processing Struct Fields

typedef struct _UIUpdateInputInternal {
    _UIUpdateInputState _state;
    unsigned int _flags;
    _UIUpdateInputAlignmentShift _alignments;
...
typedef struct UIContentUnavailableViewElementLayoutInfo {
    CGSize field0;
    BOOL field1;
    NSDirectionalEdgeInsets field2;
} UIContentUnavailableViewElementLayoutInfo;

typedef struct UIContentUnavailableViewLayoutInfo {
    UIContentUnavailableViewElementLayoutInfo field0;
    UIContentUnavailableViewElementLayoutInfo field1;
    UIContentUnavailableViewElementLayoutInfo field2;
    UIContentUnavailableViewElementLayoutInfo field3;
    UIContentUnavailableViewElementLayoutInfo field4;
    UIContentUnavailableViewElementLayoutInfo field5;
    NSUInteger field6;
    CGSize field7;
} UIContentUnavailableViewLayoutInfo;

typedef struct ui_size_cache {
} // Error Processing Struct Fields

typedef struct _UIInstrumentedCADisplay {
    id direct;
} _UIInstrumentedCADisplay;

typedef struct _UIInstrumentedCADynamicFrameRateSource {
    id direct;
} _UIInstrumentedCADynamicFrameRateSource;
