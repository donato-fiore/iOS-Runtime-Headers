...
@class NSMutableArray, NSString, NSDate, SBSAssertion, NSLayoutConstraint;
...
@interface UIInputWindowController : UIApplicationRotationFollowingControllerNoTouches <UIInputViewAnimationHost, _UITextEffectsSceneObserver, UIKeyboardFloatingTransitionControllerDelegate, _UIInputHostController>

 {
    ...
    CGRect _previousAccessoryViewBounds;
...
@property (readonly, nonatomic) UIKeyboardPathEffectView *_pathEffectView; // ivar: _pathEffectView
...
@property (readonly, nonatomic) UIInputWindowControllerHosting *hosting; // ivar: _hosting
...
-(BOOL)shouldPostNotification:(NSUInteger)arg0 withInfo:(id)arg1 ;
...
-(struct CGSize )sizeForInputViewController:(id)arg0 inputView:(id)arg1 ;
-(struct CGSize )sizeForInputViewController:(id)arg0 inputView:(id)arg1 includeAssistantBar:(BOOL)arg2 ;
...
-(void)presentationTransitionDidEnd:(id)arg0 ;
-(void)presentationTransitionWillBegin:(id)arg0 ;
...
-(void)setFullScreenPresentationAssertion:(id)arg0 ;
