...
+(NSInteger)_horizontallyFlippedOrientationForOrientation:(NSInteger)arg0 ;
...
+(id)_systemImageNamed:(id)arg0 variableValue:(CGFloat)arg1 withConfiguration:(id)arg2 ;
...
+(id)imageNamed:(id)arg0 inBundle:(id)arg1 variableValue:(CGFloat)arg2 withConfiguration:(id)arg3 ;
...
+(id)systemImageNamed:(id)arg0 variableValue:(CGFloat)arg1 withConfiguration:(id)arg2 ;
...
-(id)_colorForName:(id)arg0 withTraitCollection:(id)arg1 ;
...
-(id)_imageTintedWithColor:(id)arg0 renderingMode:(NSInteger)arg1 withUpdatedCGImage:(BOOL)arg2 ;
...
-(id)_imageWithVariableValue:(CGFloat)arg0 ;
