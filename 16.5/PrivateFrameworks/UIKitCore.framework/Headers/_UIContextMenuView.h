...
@protocol UIGestureRecognizerDelegate, _UIContextMenuViewDelegate, _UIContextMenuHierarchyLayout;
...
@property (retain, nonatomic) NSTimer *autoUnhighlightTimer; // ivar: _autoUnhighlightTimer
...
@property (retain, nonatomic) NSTimer *hoverAutoExitTimer; // ivar: _hoverAutoExitTimer
@property (retain, nonatomic) _UIVelocityIntegrator *hoverVelocityIntegrator; // ivar: _hoverVelocityIntegrator
@property (retain, nonatomic) _UIContextMenuNode *hoveredNode; // ivar: _hoveredNode
@property (nonatomic) BOOL isComputingPreferredSize; // ivar: _isComputingPreferredSize
@property (retain, nonatomic) NSObject<_UIContextMenuHierarchyLayout> *layout; // ivar: _layout
@property (nonatomic) CGSize maxContainerSize; // ivar: _maxContainerSize
...
-(struct CGSize )preferredContentSizeWithinContainerSize:(struct CGSize )arg0 ;
...
-(void)_handleSelectionForElement:(id)arg0 ;
