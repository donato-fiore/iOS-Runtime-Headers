...
@property (readonly, nonatomic) _UIRemoteViewService *_remoteViewService; // ivar: _remoteViewService
...
-(BOOL)shouldPropagateAppearanceCustomizations;
-(NSInteger)_preferredInterfaceOrientation;
...
-(void)__didReceiveGestureDirection:(NSInteger)arg0 authenticationMessage:(id)arg1 ;
...
-(void)__setServiceMaxFrameSize:(struct CGSize )arg0 ;
...
-(void)__viewServiceWantsKeyboardEventsWithoutFirstResponderAndCompletionHandler:(id)arg0 ;
...
-(void)_configureSizeViewConstraintsForWindow:(id)arg0 interfaceOrientation:(NSInteger)arg1 ;
...
-(void)_enhancedWindowingModeDidChange:(id)arg0 ;
...
-(void)_referenceDisplayModeStatusDidChange:(id)arg0 ;
...
-(void)_serviceWantsKeyboardEventsWithPromotedFirstResponder:(BOOL)arg0 completionHandler:(id)arg1 ;
...
-(void)_synchronizeAnimationsInActionsIfNecessary:(id)arg0 ;
