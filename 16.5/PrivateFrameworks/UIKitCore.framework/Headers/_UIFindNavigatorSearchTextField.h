...
@property (nonatomic) BOOL keyboardDidAppear; // ivar: _keyboardDidAppear
...
-(BOOL)_isTextRectWideEnoughForRightView:(struct CGRect )arg0 ;
...
-(struct CGRect )_availableTextRectForBounds:(struct CGRect )arg0 forEditing:(BOOL)arg1 accountForRightView:(BOOL)arg2 ;
