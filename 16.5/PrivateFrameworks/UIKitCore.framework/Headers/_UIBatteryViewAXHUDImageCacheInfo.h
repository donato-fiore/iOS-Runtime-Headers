...
-(BOOL)cacheMatchesCapacity:(CGFloat)arg0 fillColor:(id)arg1 tintColor:(id)arg2 showingBolt:(BOOL)arg3 reverseLayout:(BOOL)arg4 scale:(CGFloat)arg5 showsPercentage:(BOOL)arg6 contentSizeCategory:(id)arg7 ;
