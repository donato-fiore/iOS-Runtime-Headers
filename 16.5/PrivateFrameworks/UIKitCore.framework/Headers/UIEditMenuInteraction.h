...
@class NSString;
@protocol UIContextMenuInteractionDelegate_ForWebKitOnly, UIContextMenuInteractionDelegate_Private, _UIContextMenuInteractionDelegateInternal, UIDeferredMenuElementDelegate, _UIEditMenuPresentationDelegate, UIInteraction_Internal, UIInteraction, UIMenuLeaf, UIEditMenuInteractionDelegate;
...
-(struct ? )_anchorForPreferredArrowDirection:(NSInteger)arg0 ;
