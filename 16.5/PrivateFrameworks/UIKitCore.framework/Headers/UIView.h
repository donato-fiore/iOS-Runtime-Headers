...
@class CALayer, NSArray, NSMutableArray, NSISVariable, NSString, NSISEngine, NSMapTable, NSMutableSet, NSLayoutYAxisAnchor, NSLayoutXAxisAnchor, NSLayoutDimension;
...
// +(void)_animateWithAnimationSettings:(id)arg0 animations:(id)arg1 completion:(unk)arg2  ;
...
// +(void)_createUnsafeTransformerWithInputAnimatableProperties:(id)arg0 modelValueSetter:(id)arg1 presentationValueSetter:(unk)arg2  ;
...
-(NSUInteger)indexOfGestureRecognizer:(id)arg0 ;
