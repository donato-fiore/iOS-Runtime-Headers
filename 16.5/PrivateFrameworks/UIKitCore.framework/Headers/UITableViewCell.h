...
@protocol UIEditMenuInteractionDelegate, UIScrollViewDelegate, UITableConstantsCellProviding, _UISystemBackgroundViewContainer, _UIInteractiveHighlighting, NSCoding, UIGestureRecognizerDelegate, UITable_UITableViewCellDelegate, _UIContentViewInternal, _UIBackgroundConfigurationInternal, UITableConstants, UIContentConfiguration;
...
@property (retain, nonatomic, getter=_editingControlsFocusGuide, setter=_setEditingControlsFocusGuide:) UIFocusContainerGuide *editingControlsFocusGuide; // ivar: _editingControlsFocusGuide
...
-(BOOL)wasSwiped;
-(CGFloat)_contentViewInset:(CGFloat)arg0 convertedToCellInsetOnEdge:(NSUInteger)arg1 ;
-(CGFloat)_defaultLeadingMarginWidth;
-(CGFloat)_defaultTrailingCellMarginWidth;
-(CGFloat)_indexBarExtentFromEdge;
-(CGFloat)_marginWidth;
-(CGFloat)_preferredLeadingSeparatorInsetFromContentView;
-(CGFloat)_preferredTrailingSeparatorInsetFromContentView;
...
-(void)_layoutSystemBackgroundView:(BOOL)arg0 ;
