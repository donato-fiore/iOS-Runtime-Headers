...
@protocol UIDragInteractionDelegate, UIDropInteractionDelegate, UIPreviewItemDelegate, DDDetectionControllerInteractionDelegate, _UIRotatingAlertControllerDelegate, UITextAutoscrolling, UIAutoscrollContainer, UIGestureRecognizerDelegate, UIKeyboardInput, UITextInputPrivate, UIKeyInput, UITextInputTokenizer, UITextInputMultiDocument, _UIWebDoubleTapDelegate, UIWebFileUploadPanelDelegate, WebEditingDelegate, WebFrameLoadDelegate, UITextInputDelegate, UITextInputSuggestionDelegate, UIWebDraggingDelegate;
