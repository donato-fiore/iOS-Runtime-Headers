...
@protocol _UIKeyShortcutHUDMenuViewControllerDelegate, _UIKeyShortcutHUDToolbarViewControllerDelegate, UIKeyInput, _UIKeyShortcutHUDViewControllerDelegate, UIKeyShortcutHUDMetricsProvider;
...
@property (readonly, nonatomic, getter=isCompletelyPresented) BOOL completelyPresented; // ivar: _completelyPresented
...
@property (retain, nonatomic) NSMutableDictionary *hudToModelKeyCommandsMap; // ivar: _hudToModelKeyCommandsMap
...
@property (retain, nonatomic) UIKeyShortcutHUDMetrics *metrics; // ivar: _metrics
...
-(void)handleModelKeyCommand:(id)arg0 ;
