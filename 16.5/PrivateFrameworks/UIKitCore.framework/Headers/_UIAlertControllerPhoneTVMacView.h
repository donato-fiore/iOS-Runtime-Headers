...
@class UIAlertControllerView, NSMutableArray, NSArray, NSLayoutConstraint, NSString;
@protocol UIInterfaceActionHandlerInvocationDelegate, UIScrollViewDelegate, UISpringLoadedInteractionSupporting, _UIAlertControllerLayoutObserving, _UIAlertControllerContentViewControllerObserving;
...
@interface _UIAlertControllerPhoneTVMacView : UIAlertControllerView <UIInterfaceActionHandlerInvocationDelegate, UIScrollViewDelegate, UISpringLoadedInteractionSupporting, _UIAlertControllerLayoutObserving, _UIAlertControllerContentViewControllerObserving>
...
-(void)_setActionsReversed:(BOOL)arg0 ;
...
-(void)setAlignsToKeyboard:(BOOL)arg0 ;
-(void)setEffectAlpha:(CGFloat)arg0 ;
-(void)setHasDimmingView:(BOOL)arg0 ;
-(void)setPresentedAsPopover:(BOOL)arg0 ;
-(void)setShouldHaveBackdropView:(BOOL)arg0 ;
