...
@property (retain, nonatomic) UIKeyboardCandidateViewState *extendedKeyState; // ivar: _extendedKeyState
...
@property (retain, nonatomic) UIKeyboardCandidateViewState *keyState; // ivar: _keyState
...
-(void)toggleCandidateView:(id)arg0 animated:(BOOL)arg1 completion:(id)arg2 ;
-(void)toggleInlineViewExtendedAnimated:(BOOL)arg0 completion:(id)arg1 ;
-(void)toggleKeyViewExtendedAnimated:(BOOL)arg0 completion:(id)arg1 ;
