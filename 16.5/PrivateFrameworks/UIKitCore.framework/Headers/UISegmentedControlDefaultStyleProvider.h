...
-(CGFloat)defaultHeightForControlSize:(int)arg0 traitCollection:(id)arg1 ;
...
-(struct UIEdgeInsets )alignmentInsetsForControlSize:(int)arg0 bounds:(struct CGRect )arg1 traitCollection:(id)arg2 ;
-(struct UIEdgeInsets )contentInsetsForControlSize:(int)arg0 position:(unsigned int)arg1 bounds:(struct CGRect )arg2 ;
-(struct UIEdgeInsets )contentInsetsForControlSize:(int)arg0 position:(unsigned int)arg1 bounds:(struct CGRect )arg2 traitCollection:(id)arg3 ;
