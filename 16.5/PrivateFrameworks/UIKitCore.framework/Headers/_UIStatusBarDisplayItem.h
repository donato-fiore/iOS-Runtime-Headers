...
@class NSString, NSMutableIndexSet, NSTimer, UIView<_UIStatusBarDisplayable>;
...
@property (readonly, nonatomic) CGRect absolutePresentationFrame; // ivar: _absolutePresentationFrame
...
@property (nonatomic) CGFloat dynamicHidingAlpha; // ivar: _dynamicHidingAlpha
@property (nonatomic) CGAffineTransform dynamicHidingTransform; // ivar: _dynamicHidingTransform
@property (nonatomic) CGAffineTransform dynamicScaleTransform; // ivar: _dynamicScaleTransform
@property (nonatomic) BOOL dynamicallyHidden; // ivar: _dynamicallyHidden
...
@property (retain, nonatomic) NSTimer *floatingTimer; // ivar: _floatingTimer
...
-(struct CGRect )presentationAbsoluteFrame;
