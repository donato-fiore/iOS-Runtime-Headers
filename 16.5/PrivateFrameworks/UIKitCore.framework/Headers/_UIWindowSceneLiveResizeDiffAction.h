...
#ifndef _UIWINDOWSCENELIVERESIZEDIFFACTION_H
#define _UIWINDOWSCENELIVERESIZEDIFFACTION_H
...
@property (retain, nonatomic) UIApplicationSceneSettingsDiffInspector *sceneSettingsLiveResizeDiffInspector; // ivar: _sceneSettingsLiveResizeDiffInspector
