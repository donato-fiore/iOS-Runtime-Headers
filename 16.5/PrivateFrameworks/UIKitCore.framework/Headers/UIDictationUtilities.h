...
+(BOOL)needsTrailingSpaceForText:(id)arg0 secureInput:(BOOL)arg1 ;
...
+(id)attributedStringForDictationResult:(id)arg0 andCorrectionIdentifier:(id)arg1 capturePrefixAndPostfixWordCount:(NSUInteger)arg2 ;
...
+(id)voiceCommandParameterFromAFVoiceCommandGrammarParamMatch:(id)arg0 ;
