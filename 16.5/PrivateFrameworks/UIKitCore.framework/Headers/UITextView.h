...
@class NSAttributedString, NSDictionary, CUICatalog, NSIndexSet, RTIInputSystemSourceSession, NSString, UIFont, NSLayoutManager, NSTextContainer, _UITextLayoutControllerBase<_UITextLayoutController>, NSTextLayoutManager, NSTextStorage;
@protocol _UIViewBaselineSpacing, _UITextContainerViewDelegate, _UITextViewContentPaddingDelegate, UITextInputControllerDelegate, UITextAutoscrolling, UIKeyboardInput, _UITextContent, _UIMultilineTextContentSizing, _UILayoutBaselineUpdating, UIViewGhostedRangeSupporting, _UITextItemInteracting, UITextPasteConfigurationSupporting_Internal, UITextDragSupporting, UITextDropSupporting, UITextInputPrivate, _UITextSearching, UITextDraggable, UITextDroppable, UITextPasteConfigurationSupporting, UIFindInteractionDelegate, UITextSearching, UITextInput, UIContentSizeCategoryAdjusting, UITextDragDropSupport, UITextViewDelegate, UITextInputDelegate, UITextPasteDelegate, NSCoding><NSCopying, UITextDragDelegate, UITextDropDelegate, UITextInputSuggestionDelegate, UITextInputTokenizer;
...
@interface UITextView : UIScrollView <_UIViewBaselineSpacing, _UITextContainerViewDelegate, _UITextViewContentPaddingDelegate, UITextInputControllerDelegate, UITextAutoscrolling, UIKeyboardInput, _UITextContent, _UIMultilineTextContentSizing, _UILayoutBaselineUpdating, UIViewGhostedRangeSupporting, _UITextItemInteracting, UITextPasteConfigurationSupporting_Internal, UITextDragSupporting, UITextDropSupporting, UITextInputPrivate, _UITextSearching, UITextDraggable, UITextDroppable, UITextPasteConfigurationSupporting, UIFindInteractionDelegate, UITextSearching, UITextInput, UIContentSizeCategoryAdjusting>

 {
    ...
    NSInteger _textKitCodingFlavor;
    ...
    NSUInteger _defaultTextPreviewOptions;
...
@property (nonatomic, getter=_dci_isFindInteractionEnabled, setter=_dci_setFindInteractionEnabled:) BOOL _dci_findInteractionEnabled; // ivar: __dci_findInteractionEnabled
...
@property (readonly, nonatomic) UIFindInteraction *findInteraction; // ivar: _findInteraction
...
@property (readonly, nonatomic, getter=_isTextLayoutManagerEnabled) BOOL textLayoutManagerEnabled; // ivar: _textLayoutManagerEnabled
...
+(id)textViewUsingTextLayoutManager:(BOOL)arg0 ;
...
-(BOOL)_reconfigureWithLayoutManager:(id)arg0 triggeredByLayoutManagerAccess:(BOOL)arg1 triggeringSelector:(SEL)arg2 ;
...
-(NSInteger)_encodedTextKitFlavor;
...
-(id)_newContainerViewWithFrame:(struct CGRect )arg0 textContainer:(id)arg1 textLayoutController:(id)arg2 ;
-(id)_newTextContainer;
-(id)_newTextKit1LayoutControllerWithTextContainer:(id)arg0 layoutManager:(id)arg1 textStorage:(id)arg2 ;
...
-(struct ? )_saveSizeBeforeLayoutCalculation:(id)arg0 ;
...
-(void)_commonInitWithTextContainer:(id)arg0 decoding:(BOOL)arg1 editable:(BOOL)arg2 selectable:(BOOL)arg3 draggable:(BOOL)arg4 textLayoutManagerEnabled:(BOOL)arg5 ;
-(void)_configureForLayoutCalculation:(id)arg0 inSize:(struct CGSize )arg1 ;
-(void)_configureWithTextContainer:(id)arg0 layoutManager:(id)arg1 textLayoutManagerEnabled:(BOOL)arg2 ;
...
-(void)_installContainerViewAtIndex:(NSUInteger)arg0 ;
...
// -(void)_performTextKit1LayoutCalculation:(id)arg0 inSize:(unk)arg1  ;
// -(void)_performTextKit2LayoutCalculation:(id)arg0 inSize:(unk)arg1  ;
...
-(void)_restoreSize:(struct ? )arg0 afterLayoutCalculation:(id)arg1 ;
...
-(void)_setDefaultTextPreviewOptions:(NSUInteger)arg0 ;
-(void)_setDictationResult:(id)arg0 withCorrectionIdentifier:(id)arg1 ;
-(void)_setEncodedTextKitFlavor:(NSInteger)arg0 ;
...
-(void)_setUpWithTextContainer:(id)arg0 textLayoutManagerEnabled:(BOOL)arg1 ;
