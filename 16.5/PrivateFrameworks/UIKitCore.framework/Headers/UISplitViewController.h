...
@property (nonatomic) BOOL _alwaysAllowsSystemPreferredContentSize; // ivar: __alwaysAllowsSystemPreferredContentSize
...
-(NSUInteger)_super_preferredScreenEdgesDeferringSystemGestures;
...
-(struct CGSize )_super_preferredContentSize;
...
-(void)_commonInitForcingColumnStyle:(BOOL)arg0 ;
