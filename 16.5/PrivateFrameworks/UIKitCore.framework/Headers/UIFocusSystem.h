...
@protocol _UIFocusEnvironmentInternal, _UIFocusEnvironmentPrivate, UIFocusItem, UIFocusEnvironment, _UIFocusSystemDelegate, _UIFocusBehavior, _UIFocusHapticFeedbackGenerator, UIFocusItemContainer, _UIFocusRegionContainer;
...
@property (retain, nonatomic, getter=_focusMovementCache, setter=_setFocusMovementCache:) _UIFocusLinearMovementCache *focusMovementCache; // ivar: _focusMovementCache
...
-(id)_configureFocusDeferralIfNecessaryForContext:(id)arg0 report:(id)arg1 ;
-(id)_contextForUpdateToEnvironment:(id)arg0 withAnimationCoordinator:(id)arg1 ;
-(id)_contextForUpdateToEnvironment:(id)arg0 withAnimationCoordinator:(id)arg1 allowsOverridingPreferedFocusEnvironments:(BOOL)arg2 ;
...
-(void)_focusEnvironmentDidBecomeVisible:(id)arg0 ;
-(void)_focusEnvironmentWillBecomeInvisible:(id)arg0 ;
