...
-(BOOL)_shouldEnableNestedNavigationPopForTopItem:(id)arg0 backItem:(id)arg1 ;
...
-(BOOL)titleRenamer:(id)arg0 session:(id)arg1 shouldEndRenamingWithTitle:(id)arg2 ;
...
-(id)titleRenamer:(id)arg0 session:(id)arg1 willBeginRenamingWithTitle:(id)arg2 selectedRange:(struct _NSRange *)arg3 ;
...
-(void)_ensureLayoutsConfiguredForEntry:(id)arg0 forMeasuring:(BOOL)arg1 ;
...
-(void)_updateTitleViewForLayout:(id)arg0 ;
...
-(void)teardown;
-(void)titleRenamer:(id)arg0 didCancelSession:(id)arg1 ;
-(void)titleRenamer:(id)arg0 session:(id)arg1 didEndRenamingWithTitle:(id)arg2 ;
