...
@property (nonatomic) CGFloat liftProgress; // ivar: _liftProgress
...
@property (nonatomic) BOOL sourceViewDidAllowEdgeAntialiasing; // ivar: _sourceViewDidAllowEdgeAntialiasing
