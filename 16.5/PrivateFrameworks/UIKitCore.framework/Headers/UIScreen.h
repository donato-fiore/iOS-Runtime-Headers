...
@class UISDisplayContext, NSDictionary, NSArray, FBSDisplayConfiguration, BKSHIDEventDisplay, NSMutableSet, UIWindow<UIFocusEnvironment>, CARSessionStatus, NSString;
...
-(void)_setInterfaceOrientation:(NSInteger)arg0 andNotify:(BOOL)arg1 ;
