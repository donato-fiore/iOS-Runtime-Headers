...
@property (nonatomic, setter=_setEnumerationPriority:) NSInteger _enumerationPriority; // ivar: __enumerationPriority
...
-(NSInteger)_defaultEnumerationPriority;
-(NSInteger)_leafKeyModifierFlags;
-(NSUInteger)hash;
-(id)_immutableCopy;
-(id)_initWithInput:(id)arg0 modifierFlags:(NSInteger)arg1 keyCodes:(id)arg2 action:(SEL)arg3 upAction:(SEL)arg4 discoverabilityTitle:(id)arg5 buttonType:(NSInteger)arg6 ;
