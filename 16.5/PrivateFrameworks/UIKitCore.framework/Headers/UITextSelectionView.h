...
@interface UITextSelectionView : UIView {
    ...
    *__CFRunLoopObserver m_observer;
    ...
    id *_hideSelectionCommandsWorkItem;
}
...
-(BOOL)updateCalloutBarRects:(id)arg0 effectsWindow:(id)arg1 arrowDirection:(NSInteger)arg2 replacements:(id)arg3 ;
...
-(void)_hideSelectionCommandsWithReason:(NSInteger)arg0 ;
-(void)_presentEditMenuWithPreferredDirection:(NSInteger)arg0 replacements:(id)arg1 ;
...
-(void)hideSelectionCommandsAfterDelay:(CGFloat)arg0 reason:(NSInteger)arg1 ;
