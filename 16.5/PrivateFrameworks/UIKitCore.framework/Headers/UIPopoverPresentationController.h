...
@protocol _UIPopoverDimmingViewDelegate, UIGestureRecognizerDelegatePrivate, _UIPopoverHostManager, UIPopoverPresentationControllerDelegate, UIPopoverPresentationControllerSourceItem;
...
@interface UIPopoverPresentationController : UIPresentationController <_UIPopoverDimmingViewDelegate, UIGestureRecognizerDelegatePrivate>

 {
    ...
    CGRect _previousContainerViewRect;
...
@property (nonatomic, setter=_setAllowsFocusInPresentingViewController:) BOOL _allowsFocusInPresentingViewController; // ivar: __allowsFocusInPresentingViewController
...
+(id)_platformHostManagerForController:(id)arg0 ;
...
-(void)_moveAwayFromTheKeyboard:(id)arg0 showing:(BOOL)arg1 ;
