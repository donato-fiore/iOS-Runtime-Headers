...
@property (weak, nonatomic) NSObject<UIKeyboardSplitTransitionDataSource> *splitTransitionDataSource; // ivar: _transitionDataSource
@property (weak, nonatomic) NSObject<UIKeyboardKeyplaneTransitionDelegate> *splitTransitionDelegate; // ivar: _transitionDelegate
