...
@property (weak, nonatomic) NSObject<UIKBKeyplaneViewDelegate> *delegate; // ivar: _delegate
...
-(void)deactivateKey:(id)arg0 previousState:(int)arg1 keyView:(id)arg2 ;
-(void)deactivateKeys;
-(void)dealloc;
...
-(void)hideKeyCaps:(BOOL)arg0 andControlKeysWithInteractionTypes:(id)arg1 ;
-(void)layoutSubviews;
-(void)orientKeyCapForKey:(id)arg0 orientation:(NSInteger)arg1 ;
