...
@property (readonly, nonatomic) CGFloat preferredHorizontalPadding;
...
@property (readonly, nonatomic) CGFloat preferredThickness;
@property (readonly, nonatomic) CGFloat preferredVerticalPadding;
