...
-(void)_commit:(BOOL)arg0 andPerformPostSynchronizeBlock:(id)arg1 ;
-(void)_enumerateAllObserversWithBlock:(id)arg0 ;
-(void)_notifyObserversEnvironmentVisualStateWillChangeToState:(id)arg0 ;
-(void)_notifyObserversIfEnvironmentVisualStateDidChangeFromActiveOn:(id)arg0 ;
-(void)_notifyObserversIfEnvironmentVisualStateDidChangeToActiveOn:(id)arg0 ;
