...
-(id)_keysForDynamicRows:(id)arg0 ;
-(id)activeGeometriesList;
-(id)activeShapesFromOutputShapes:(id)arg0 inputShapes:(id)arg1 inRTL:(BOOL)arg2 ;
...
-(id)keysWithInteractionTypes:(id)arg0 ;
-(id)keysWithString:(id)arg0 ;
-(id)keysetCanContainWriteboardKey;
-(id)layoutName;
-(id)listShapes;
-(id)localizationKey;
-(id)mergeKeyNames:(id)arg0 inRightToLeft:(BOOL)arg1 ;
-(id)numberForProperty:(id)arg0 ;
-(id)objectForProperty:(id)arg0 ;
-(id)orderedRowsForType:(NSInteger)arg0 ;
...
-(id)rightSpaceKey;
-(id)rowSet;
-(id)rowSetOfType:(NSInteger)arg0 ;
-(id)scriptSwitchKey;
...
-(id)toggleKeysForKeyName:(id)arg0 ;
-(id)unhashedName;
...
-(void)setCurrentKeyboardType:(NSInteger)arg0 ;
...
-(void)setDynamicDisplayCorner:(NSUInteger)arg0 ;
...
-(void)setToggleKeys:(id)arg0 forKeyName:(id)arg1 ;
...
-(void)subsumeDisappearingKeyName:(id)arg0 intoKeyName:(id)arg1 factors:(id)arg2 inRightToLeft:(BOOL)arg3 ;
-(void)swapToggleKeys:(id)arg0 ;
-(void)updateDictationKeyOnNumberPads:(BOOL)arg0 ;
-(void)updateFlickKeycapOnKeys;
-(void)updateKeysForType:(NSInteger)arg0 ;
