...
@class NSString, UISPasteSharingToken;
...
@property (readonly, nonatomic) NSObject<OS_dispatch_group> *saveCompletionGroup; // ivar: _saveCompletionGroup
@property (copy) UISPasteSharingToken *sharingToken; // ivar: _sharingToken


+(id)_loadRequestContextForBlockingUIKitCall;
+(id)_loadRequestContextForBlockingUIKitCall:(BOOL)arg0 ;
