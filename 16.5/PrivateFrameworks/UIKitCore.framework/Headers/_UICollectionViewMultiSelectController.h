...
@property (retain, nonatomic) NSMapTable *contentMaskCache; // ivar: _contentMaskCache
...
-(BOOL)_allowsBandSelectionStartingAtPoint:(struct CGPoint )arg0 multiSelectInteraction:(id)arg1 ;
...
-(BOOL)multiSelectInteraction:(id)arg0 shouldShowBandForSelectionStartingAtPoint:(struct CGPoint )arg1 ;
...
-(BOOL)shouldAllowSelectionAppendageAtPoint:(struct CGPoint )arg0 ;
...
-(void)_performWithPrewarmingCache:(id)arg0 ;
...
-(void)willBeginMultiSelectInteraction:(id)arg0 atPoint:(struct CGPoint )arg1 keepCurrentSelection:(BOOL)arg2 ;
