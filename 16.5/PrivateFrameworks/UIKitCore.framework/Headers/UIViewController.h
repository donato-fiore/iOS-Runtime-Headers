...
@protocol _UIOrientationDebugDescriptionProviding, NSExtensionRequestHandling, _UIAlwaysOnEnvironmentObserver, _UIFallbackEnvironment, _UIViewServiceDeputy, UIWindowDelegate, _UITraitEnvironmentInternal, _UIContentContainerInternal, _UIFocusEnvironmentInternal, _UIStatusBarAnimationProviding, NSCoding, UIAppearanceContainer, UITraitEnvironment, UIContentContainer, UIFocusEnvironment, UIViewControllerTransitioningDelegate, NSObject, _UIViewControllerContentViewEmbedding, UILayoutSupport><_UILayoutItem, _UIFocusBehavior, UIFocusItemContainer, _UIFocusRegionContainer, UIFocusItem;
...
@property (nonatomic) BOOL _nextResponderIgnoresWindowIfRootVC; // ivar: _nextResponderIgnoresWindowIfRootVC
...
@property (copy, nonatomic) NSString *interactionActivityTrackingBaseName; // ivar: _interactionActivityTrackingBaseName
...
-(NSInteger)_lastKnownInterfaceOrientation;
-(NSInteger)_overrideHorizontalSizeClass;
-(NSInteger)_overrideInterfaceOrientationMechanics;
-(NSInteger)_overrideUserInterfaceRenderingMode;
...
-(struct CGSize )_formSheetSizeForWindowWithSize:(struct CGSize )arg0 screenSize:(struct CGSize )arg1 ;
...
-(void)_setOverrideHorizontalSizeClass:(NSInteger)arg0 ;
-(void)_setOverrideUserInterfaceRenderingMode:(NSInteger)arg0 ;
