...
#ifndef _BLASTDOORLPITUNESMEDIAAUDIOBOOKMETADATA_H
#define _BLASTDOORLPITUNESMEDIAAUDIOBOOKMETADATA_H

@class BlastDoorLPSpecializationMetadata, NSString, NSURL;


#import "_BlastDoorLPImage.h"
#import "_BlastDoorLPArtworkMetadata.h"

@interface _BlastDoorLPiTunesMediaAudioBookMetadata : BlastDoorLPSpecializationMetadata
