...
@property (nonatomic) BOOL overrideIncludeOSLogs; // ivar: _overrideIncludeOSLogs
@property (nonatomic) BOOL overrideIncludeOSSignposts; // ivar: _overrideIncludeOSSignposts
@property (nonatomic) BOOL overrideSymbolicate; // ivar: _overrideSymbolicate
@property (retain, nonatomic) NSString *ownerName; // ivar: _ownerName
@property (nonatomic) int ownerPID; // ivar: _ownerPID
@property (retain, nonatomic) NSString *planNameOrPath; // ivar: _planNameOrPath
...
+(id)configWithTracePlanName:(id)arg0 ;
+(id)configWithTracePlanURL:(id)arg0 ;
+(id)getCurrentConfig;
-(BOOL)storeConfig;
-(BOOL)validateConfig;
