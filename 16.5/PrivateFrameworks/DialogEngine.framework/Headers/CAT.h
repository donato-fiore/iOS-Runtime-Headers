...
+(id)getBuiltinDialogMetadataCategoryNamesForLocale:(id)arg0 ;
+(id)getBuiltinDialogMetadataForLocale:(id)arg0 ;
+(id)getDialogAssetsVersion:(id)arg0 ;
+(id)getDialogAssetsVersion:(id)arg0 enableUpdates:(BOOL)arg1 ;
+(id)getDialogMetadataCategoryNamesForLocale:(id)arg0 locale:(id)arg1 ;
+(id)getDialogMetadataForLocale:(id)arg0 locale:(id)arg1 ;
+(id)getDialogStateFamily:(id)arg0 ;
+(id)getDialogStateUseCase:(id)arg0 ;
