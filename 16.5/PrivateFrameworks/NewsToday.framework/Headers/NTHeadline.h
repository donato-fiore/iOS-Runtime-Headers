...
@class NSURL, NTPBHeadlineAdElement, NSDate, NTPBHeadlineAnalyticsElement, NSString, NTPBHeadlineBackingElement, COMAPPLEFELDSPARPROTOCOLLIVERPOOLArticleContentExpiration, NTPBFeedItem, NSData, COMAPPLEFELDSPARPROTOCOLLIVERPOOLCohortList, COMAPPLEFELDSPARPROTOCOLLIVERPOOLConversionStats, NSArray, COMAPPLEFELDSPARPROTOCOLLIVERPOOLTagMetadata, FCFeedPersonalizedItemScoreProfile, SFSearchResult;
