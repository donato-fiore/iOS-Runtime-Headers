...
-(id)init;
-(id)initWithSectionConfig:(id)arg0 appConfiguration:(id)arg1 topStoriesChannelID:(id)arg2 hiddenFeedIDs:(id)arg3 allowPaidBundleFeed:(BOOL)arg4 todayData:(id)arg5 supplementalFeedFilterOptions:(NSUInteger)arg6 ;
