...
@property (readonly, nonatomic) BOOL allowPaidBundleFeed; // ivar: _allowPaidBundleFeed
...
-(id)init;
-(id)initWithForYouTodaySectionSpecificConfig:(id)arg0 appConfiguration:(id)arg1 topStoriesChannelID:(id)arg2 hiddenFeedIDs:(id)arg3 allowPaidBundleFeed:(BOOL)arg4 mutedTagIDs:(id)arg5 purchasedTagIDs:(id)arg6 subscribedTagIDs:(id)arg7 bundleSubscriptionProvider:(id)arg8 throttlingIdentifier:(id)arg9 ;
