...
@property (copy, nonatomic) NTCatchUpOperationArticleIDsRequest *localNewsRequest; // ivar: _localNewsRequest
...
-(id)init;
-(id)initWithForYouConfiguration:(id)arg0 appConfiguration:(id)arg1 topStoriesChannelID:(id)arg2 hiddenFeedIDs:(id)arg3 allowPaidBundleFeed:(BOOL)arg4 mutedTagIDs:(id)arg5 purchasedTagIDs:(id)arg6 subscribedTagIDs:(id)arg7 bundleSubscriptionProvider:(id)arg8 ;
