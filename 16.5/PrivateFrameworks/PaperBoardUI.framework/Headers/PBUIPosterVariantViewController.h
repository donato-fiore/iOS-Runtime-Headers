...
@class UIViewController, UIView, UIView<UIScenePresentation>, UIVisualEffectView, BSAtomicFlag, UIColor, BSUIMappedImageCache, NSString, PRPosterLegibilitySettings, _UILegibilitySettings, FBScene, UIImage;
...
@property (retain) PRPosterLegibilitySettings *desiredLegibilitySettings; // ivar: _desiredLegibilitySettings
...
-(void)_performLegacyPosterSnapshotOnQueue:(id)arg0 completion:(id)arg1 ;
-(void)_performSnapshotOnQueue:(id)arg0 completion:(id)arg1 ;
-(void)_scheduleSnapshotIfNeeded;
-(void)_updateParallax;
-(void)_updatePosterAverageColor:(id)arg0 desiredLegibilitySettings:(id)arg1 ;
