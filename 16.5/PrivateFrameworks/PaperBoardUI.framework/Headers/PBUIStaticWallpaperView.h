...
// -(void)_generateImageForImage:(id)arg0 cacheKey:(id)arg1 options:(NSUInteger)arg2 downsampleFactor:(CGFloat)arg3 needsDimmingTreatment:(BOOL)arg4 needsInactiveAppearanceTreatment:(BOOL)arg5 averageColorProvider:(id)arg6 generationHandler:(unk)arg7  ;
