...
@protocol BSDescriptionProviding, PBUIWallpaperConfigurationManagerDelegate, PBUIProceduralWallpaperProvider;
...
@property (weak, nonatomic) NSObject<PBUIWallpaperConfigurationManagerDelegate> *delegate; // ivar: _delegate
...
@property (retain, nonatomic) PBUIMagnifyMode *magnifyMode; // ivar: _magnifyMode
...
@property (weak, nonatomic) NSObject<PBUIProceduralWallpaperProvider> *proceduralWallpaperProvider; // ivar: _proceduralWallpaperProvider
...
-(char)_providerForVariant:(NSInteger)arg0 lockConfig:(id)arg1 homeConfig:(id)arg2 ;
