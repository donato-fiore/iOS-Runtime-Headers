...
@protocol ISChangeObserver, ISBasePlayerDelegate, PBUILivePhotoPlayerViewDelegate;
...
@property (weak, nonatomic) NSObject<PBUILivePhotoPlayerViewDelegate> *delegate; // ivar: _delegate
