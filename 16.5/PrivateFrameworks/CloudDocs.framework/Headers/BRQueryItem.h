...
@class NSString, NSNumber, NSURL, NSArray, NSMutableDictionary, NSDictionary, FPItemID, NSDate, UTType, NSData, NSError, NSPersonNameComponents, NSSet, NSFileProviderItemVersion;
...
@property (readonly, nonatomic) NSData *structureVersion; // ivar: _structureVersion
...
+(id)containerItemForContainer:(id)arg0 withRepresentativeItem:(id)arg1 ;
+(id)containerItemForContainer:(id)arg0 withRepresentativeItem:(id)arg1 zoneRowID:(id)arg2 ;
+(void)initialize;
...
-(void)markDead;
-(void)merge:(id)arg0 ;
-(void)merge:(id)arg0 allowMergingFileObjectIDIfPossible:(BOOL)arg1 ;
