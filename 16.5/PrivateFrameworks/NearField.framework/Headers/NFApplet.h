...
@protocol NSSecureCoding, NSCopying, NFAppletCollection;
...
@property (readonly, nonatomic) BOOL managedBySP; // ivar: _managedBySP
...
@property (readonly, nonatomic) NSInteger seOS; // ivar: _seOS
