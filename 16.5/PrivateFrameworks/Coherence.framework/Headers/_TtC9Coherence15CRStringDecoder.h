...
-(NSInteger)substringContentOptions;
-(NSInteger)substringCount;
-(NSInteger)substringRemovedAddedByCount;
-(id)addedByVersionWithError:(*id)arg0 ;
-(id)fromAddedByVersionWithError:(*id)arg0 ;
-(id)fromVersionWithError:(*id)arg0 ;
-(id)init;
...
-(id)substringRemovedAddedByReplica:(NSInteger)arg0 withError:(*id)arg1 ;
...
-(unsigned int)substringRemovedAddedByCounter:(NSInteger)arg0 ;
