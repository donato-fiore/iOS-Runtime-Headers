...
-(void)addRemovedAddedById:(id)arg0 clock:(unsigned int)arg1 ;
-(void)finishSubstring;
-(void)setCharWithId:(id)arg0 clock:(unsigned int)arg1 ;
-(void)setFromAddedByVersion:(id)arg0 ;
-(void)setFromVersion:(id)arg0 ;
-(void)setWithAddedByVersion:(id)arg0 ;
-(void)setWithContentOptions:(NSInteger)arg0 ;
