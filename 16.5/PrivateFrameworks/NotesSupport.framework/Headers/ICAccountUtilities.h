...
@property (retain, nonatomic) NSMutableDictionary *accountByIdentifier; // ivar: _accountByIdentifier
...
-(BOOL)isManagedACAccountWithIdentifier:(id)arg0 ;
...
// -(void)performBlockInPersonaContext:(id)arg0 forAccountIdentifier:(unk)arg1  ;
