...
@property (readonly, nonatomic) CKVDonateRequestValidator *requestValidator; // ivar: _requestValidator
@property (readonly, nonatomic) CKVIndexUpdaterFactory *updaterFactory; // ivar: _updaterFactory


-(BOOL)_isActiveRequestId:(unsigned int)arg0 ;
-(id)init;
-(id)initWithDonationTimeout:(CGFloat)arg0 indexManager:(id)arg1 settings:(id)arg2 ;
-(void)_beginTransaction;
-(void)_completeActiveRequest:(BOOL)arg0 ;
