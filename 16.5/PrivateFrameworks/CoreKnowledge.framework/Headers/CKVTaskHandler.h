...
-(id)_executeTaskBlock:(SEL)arg0 ifTaskEnabled:(id)arg1 ;
...
-(id)_verificationTaskBlockForTask:(SEL)arg0 reason:(unsigned short)arg1 ;
-(id)initWithHandlerName:(id)arg0 settings:(id)arg1 donateTaskProvider:(id)arg2 coalescenceManager:(id)arg3 indexManager:(id)arg4 isAdmin:(BOOL)arg5 ;
