...
@class NSURL, NSHashTable, NSDictionary, ATXFaceGalleryConfiguration, NSDate, NSMutableDictionary, PRPosterConfiguration, PRSwitcherConfiguration, NSArray, NSMutableSet, NSNumber, BSAtomicFlag, NSString;
@protocol PBFPosterExtensionProviderDelegate, PRPosterContentSnapshotProviding, PBFPosterExtensionDataStoreAssertionManagerObserver, PBFBehaviorAssertionObserver, PBFPosterSnapshotManagerObserving, PBFExtensionProviding, BSInvalidatable, PBFBehaviorAssertionProviding, PBFRuntimeAssertionProviding, OS_dispatch_queue, PBFPosterExtensionProvider;
...
@interface PBFPosterExtensionDataStore : NSObject <PBFPosterExtensionProviderDelegate, PRPosterContentSnapshotProviding, PBFPosterExtensionDataStoreAssertionManagerObserver, PBFBehaviorAssertionObserver, PBFPosterSnapshotManagerObserving, PBFExtensionProviding, BSInvalidatable, PBFBehaviorAssertionProviding>

 {
    ...
    NSInteger _stateLock_maximumPosterConfigurationCount;
...
@property (readonly, nonatomic) PBFPosterExtensionDataStoreAssertionManager *assertionManager; // ivar: _assertionManager
...
@property (readonly, nonatomic) NSObject<PBFPosterExtensionProvider> *extensionProvider; // ivar: _extensionProvider
...
@property (nonatomic) NSInteger maximumPosterConfigurationCount;
@property (readonly, copy, nonatomic) NSArray *posterConfigurations;
@property (readonly, nonatomic) PBFPosterSnapshotManager *snapshotManager; // ivar: _snapshotManager
@property (readonly) Class superclass;
@property (readonly, copy, nonatomic) PRSwitcherConfiguration *switcherConfiguration;


+(NSInteger)dataStoreVersion;
+(NSInteger)defaultMaximumPosterConfigurationCount;
...
-(id)_stateLock_prepareReloadConfigurationOperationForExtension:(id)arg0 path:(id)arg1 locationInUse:(BOOL)arg2 sessionInfo:(id)arg3 powerLogReason:(NSInteger)arg4 error:(*id)arg5 ;
...
-(id)initWithURL:(id)arg0 runtimeAssertionProvider:(id)arg1 extensionProvider:(id)arg2 observer:(id)arg3 wasMigrationJustPerformed:(BOOL)arg4 error:(*id)arg5 ;
...
-(void)_notifyObserversDidUpdateSwitcherConfiguration:(id)arg0 ;
...
-(void)_stateLock_applyUpdates:(id)arg0 toPath:(id)arg1 powerLogReason:(NSInteger)arg2 completion:(id)arg3 ;
-(void)_stateLock_applyUpdatesAndIngestConfiguration:(id)arg0 toPath:(id)arg1 powerLogReason:(NSInteger)arg2 completion:(id)arg3 ;
-(void)_stateLock_createTemporaryPosterConfigurationForPosterMatchingUUID:(id)arg0 andApplyUpdates:(id)arg1 completion:(id)arg2 ;
...
-(void)_stateLock_updatePosterConfigurationMatchingUUID:(id)arg0 updates:(id)arg1 completion:(id)arg2 ;
...
-(void)createTemporaryPosterConfigurationForPosterMatchingUUID:(id)arg0 andApplyUpdates:(id)arg1 completion:(id)arg2 ;
-(void)enqueueGalleryConfigurationUpdateWithOptions:(NSUInteger)arg0 powerLogReason:(NSInteger)arg1 completion:(id)arg2 ;
-(void)enumerateExtensionStoreCoordinators:(id)arg0 ;
...
-(void)snapshotManager:(id)arg0 didUpdateSnapshotForPath:(id)arg1 forDefinition:(id)arg2 ;
