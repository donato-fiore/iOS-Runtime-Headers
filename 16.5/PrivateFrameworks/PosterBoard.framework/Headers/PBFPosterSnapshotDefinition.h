...
@property (readonly, nonatomic) NSUInteger significantEventsCounter; // ivar: _significantEventsCounter
...
-(id)definitionWithSignificantEventsCounter:(NSUInteger)arg0 ;
-(id)description;
