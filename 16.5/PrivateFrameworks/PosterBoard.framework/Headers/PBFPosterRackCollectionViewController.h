...
@interface PBFPosterRackCollectionViewController : UICollectionViewController <UICollectionViewDelegate_Private, UIGestureRecognizerDelegate, UISheetPresentationControllerDelegate, PBFPosterGalleryPreviewViewControllerDelegate, PRDateObserving, FCUIFocusSelectionViewControllerDelegate, PBFPosterEditingIngestionManagerDelegate, PREditingFontAndColorPickerViewControllerDelegate, PREditingSceneViewControllerObserver, PBFPosterRackSwitcherControlling>

 {
    ...
    ? currentPosterSignificantEventsCounter;
    ? galleryController;
    ...
    ? numberOfTrackingTouchesBegunWhileTransitioningToInitialLayoutModeFromFullscreen;
    ? layout;
    ...
    ? homeScreenIconContentViewConnector;
    ? focusSelector;
...
@property (nonatomic) BOOL shouldTransitionLayoutToConfiguringHomeForFirstPoster; // ivar: shouldTransitionLayoutToConfiguringHomeForFirstPoster
...
+(id)simplifiedHomeScreenSwitcherWithFilter:(id)arg0 delegate:(id)arg1 topButtonLayout:(struct PREditingSceneViewControllerTopButtonLayout )arg2 ;
...
-(void)presentPosterGallery:(id)arg0 ;
-(void)presentationControllerDidDismiss:(id)arg0 ;
-(void)presentationControllerWillDismiss:(id)arg0 ;
-(void)reset:(id)arg0 ;
-(void)scrollToFirstPoster:(BOOL)arg0 completion:(id)arg1 ;
