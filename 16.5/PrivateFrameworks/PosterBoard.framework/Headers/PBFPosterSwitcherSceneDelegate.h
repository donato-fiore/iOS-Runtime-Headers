...
#import "PBFExtensionTestingViewController.h"
#import "PBFPosterRackCollectionViewController.h"
...
@interface PBFPosterSwitcherSceneDelegate : UIResponder <UIWindowSceneDelegate, _UISceneComponentProviding, _UISceneSettingsDiffAction, _UISceneBSActionHandler>

 {
    ...
    ? extensionTestingViewController;
    ? $__lazy_storage_$_posterExtensionTestingViewController;
}
