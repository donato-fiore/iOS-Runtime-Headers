...
@class NSMapTable, NSHashTable, NSMutableArray, NSMutableSet, NSMutableDictionary, RBSAssertion, NSOperationQueue, NSString;
@protocol PBFBehaviorAssertionProviding, PBFPosterSnapshotIngesting, PBFPosterSnapshotProviding, BSInvalidatable, PBFRuntimeAssertionProviding, PBFExtensionProviding, OS_dispatch_source;
...
-(id)_lock_snapshotterForRequest:(id)arg0 requestContainingRequest:(*id)arg1 ;
...
-(id)initWithRuntimeAssertionProvider:(id)arg0 extensionProvider:(id)arg1 ;
