...
@protocol PBFPosterGalleryDataProviderObserver, PBFPosterPreviewGenerator, _PBFGalleryCollectionViewControllerDelegate;
...
@property (weak, nonatomic) NSObject<_PBFGalleryCollectionViewControllerDelegate> *delegate; // ivar: _delegate
