...
@property (readonly) NSNumber *maxFeatureReportSize; // ivar: _maxFeatureReportSize
@property (readonly) NSNumber *maxInputReportSize; // ivar: _maxInputReportSize
@property (readonly) NSNumber *maxOutputReportSize; // ivar: _maxOutputReportSize
