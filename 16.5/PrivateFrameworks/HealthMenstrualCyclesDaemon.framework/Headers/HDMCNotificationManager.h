...
@class HDPrimaryProfile, HKMCSettingsManager, HDKeyValueDomain, NSNumber, HKMCAnalysis, NSDate, NSString, HDRestorableAlarm;
...
-(id)_periodEventFromNotificationCategory:(id)arg0 notificationFireDayIndex:(NSInteger)arg1 ;
-(id)_requestFromAlarmEvent:(id)arg0 ;
