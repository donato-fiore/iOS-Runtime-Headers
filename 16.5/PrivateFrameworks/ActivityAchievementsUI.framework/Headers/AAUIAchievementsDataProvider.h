...
@property (retain, nonatomic) _TtC22ActivityAchievementsUI15AAUIAwardsQuery *awardsQuery; // ivar: _awardsQuery
...
-(BOOL)_shouldShowAchievement:(id)arg0 activityMoveMode:(NSInteger)arg1 experienceType:(NSUInteger)arg2 ;
-(NSInteger)_deleteAchievement:(id)arg0 fromUnfiltered:(BOOL)arg1 ;
-(NSInteger)_updateAchievement:(id)arg0 activityMoveMode:(NSInteger)arg1 experienceType:(NSUInteger)arg2 ;
...
-(void)_deleteAchievementsByEarnedDateWithAchievement:(id)arg0 earnedInstance:(id)arg1 ;
-(void)_handleDeletedAchievements:(id)arg0 ;
-(void)_handleUpdatedAchievements:(id)arg0 ;
-(void)_reload;
-(void)_updateAchievementsByEarnedDateComponentsWithAchievement:(id)arg0 earnedInstance:(id)arg1 ;
