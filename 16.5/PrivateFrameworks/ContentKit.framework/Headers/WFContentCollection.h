...
-(void)generateCollectionByCoercingToItemClass:(Class)arg0 options:(id)arg1 completionHandler:(id)arg2 ;
...
-(void)generateCollectionByEvaluatingQuery:(id)arg0 forContentItemClass:(Class)arg1 permissionRequestor:(id)arg2 completionHandler:(id)arg3 ;
...
-(void)getRichTextRepresentation:(id)arg0 ;
