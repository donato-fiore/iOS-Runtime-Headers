...
@class NSDictionary, NSOrderedSet, NSArray, NSUUID, NSString, NSExtensionItem, WFImage, WFType, NSItemProvider, WFFileType, NSMutableDictionary;
...
+(id)cachedCoercions;
+(id)coercionForCoercingToType:(id)arg0 concurrencyMode:(NSInteger)arg1 ;
+(id)coercionForType:(id)arg0 ;
+(id)coercions;
...
// -(void)getFileRepresentation:(id)arg0 forType:(unk)arg1 options:(id)arg2  ;
// -(void)getFileRepresentations:(id)arg0 forType:(unk)arg1  ;
// -(void)getFileRepresentations:(id)arg0 forType:(unk)arg1 options:(id)arg2  ;
-(void)getFileRepresentationsForSerialization:(id)arg0 ;
// -(void)getObjectRepresentation:(id)arg0 forClass:(unk)arg1  ;
// -(void)getObjectRepresentation:(id)arg0 forClass:(unk)arg1 options:(Class)arg2  ;
// -(void)getObjectRepresentations:(id)arg0 forClass:(unk)arg1  ;
// -(void)getObjectRepresentations:(id)arg0 forClass:(unk)arg1 options:(Class)arg2  ;
