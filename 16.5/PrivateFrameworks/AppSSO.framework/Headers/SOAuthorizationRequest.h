...
@class NSData, NSDictionary, NSString, NSError, POLoginManager, NSArray, NSURL;
...
@property (readonly, nonatomic) POLoginManager *loginManager; // ivar: _loginManager
...
-(void)_completeFinishAuthorizationWithRequestIdentifier:(id)arg0 error:(id)arg1 ;
