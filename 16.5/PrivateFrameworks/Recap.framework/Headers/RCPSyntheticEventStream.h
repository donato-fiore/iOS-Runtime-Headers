...
@property (nonatomic) BOOL scalePointerPhaseScrollToPixels; // ivar: _scalePointerPhaseScrollToPixels
...
@property (retain, nonatomic) CAMediaTimingFunction *touchCurveFunction; // ivar: _touchCurveFunction
...
-(void)_hoverAtPoints:(struct CGPoint *)arg0 touchCount:(NSUInteger)arg1 pressure:(CGFloat)arg2 radius:(CGFloat)arg3 edgeMaskOptions:(struct ? *)arg4 withEventType:(NSInteger)arg5 withZPosition:(CGFloat)arg6 ;
...
-(void)hover:(struct CGPoint )arg0 withZPosition:(CGFloat)arg1 ;
-(void)hoverAtLocation:(struct CGPoint )arg0 withDuration:(CGFloat)arg1 ;
-(void)hoverAtLocation:(struct CGPoint )arg0 withDuration:(CGFloat)arg1 withZPosition:(CGFloat)arg2 ;
-(void)hoverToTap:(struct CGPoint )arg0 withZPosition:(CGFloat)arg1 ;
-(void)hoverToTapAtLocation:(struct CGPoint )arg0 withDuration:(CGFloat)arg1 ;
-(void)hoverToTapAtLocation:(struct CGPoint )arg0 withDuration:(CGFloat)arg1 withZPosition:(CGFloat)arg2 ;
...
-(void)pointerPhasedFlick:(struct CGPoint )arg0 duration:(CGFloat)arg1 ;
-(void)pointerPhasedFlick:(struct CGPoint )arg0 duration:(CGFloat)arg1 frequency:(NSInteger)arg2 ;
...
-(void)vendorEventWithPage:(id)arg0 withUsage:(id)arg1 withVersion:(unsigned char)arg2 ;
-(void)vendorEventWithPage:(id)arg0 withUsage:(id)arg1 withVersion:(unsigned char)arg2 withData:(id)arg3 ;
