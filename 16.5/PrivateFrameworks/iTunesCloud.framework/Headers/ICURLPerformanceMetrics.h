...
@property (readonly, nonatomic) CGFloat connectionTime;
@property (readonly, nonatomic) NSString *connectionType; // ivar: _connectionType
@property (readonly, nonatomic) CGFloat dnsTime;
...
@property (readonly, nonatomic) NSString *jingleCorrelationKey; // ivar: _jingleCorrelationKey
...
@property (readonly, nonatomic) CGFloat requestTime;
...
@property (readonly, nonatomic) CGFloat responseTime;
...
@property (readonly, nonatomic) CGFloat totalTime;


-(id)dictionaryRepresentation;
-(id)humanDescription;
-(id)initWithDictionaryRepresentation:(id)arg0 ;
-(id)initWithTransactionMetrics:(id)arg0 request:(id)arg1 taskIdentifier:(id)arg2 ;
