...
+(id)_amsMetricsForRequestContext:(id)arg0 ;
+(id)_sanitizeURLString:(id)arg0 ;
+(void)_sendLoadUrlMetricsToCoreAnalytics:(id)arg0 ;
...
-(void)_reportLoadURLMetricsWithSession:(id)arg0 task:(id)arg1 request:(id)arg2 error:(id)arg3 ;
...
-(void)cancelPendingRequestsWithError:(id)arg0 ;
