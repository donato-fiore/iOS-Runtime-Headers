...
@property (copy, nonatomic) NSData *leaseAssetIDData; // ivar: _leaseAssetIDData
@property (copy, nonatomic) NSData *leaseCertificateData; // ivar: _leaseCertificateData
...
-(id)description;
-(void)_populateItemIdentifiers:(id)arg0 ;
