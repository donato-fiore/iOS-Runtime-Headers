...
@property (nonatomic) NSUInteger vocalAttenuationAvailability; // ivar: _vocalAttenuationAvailability
@property (nonatomic) CGFloat vocalAttenuationDuration; // ivar: _vocalAttenuationDuration
