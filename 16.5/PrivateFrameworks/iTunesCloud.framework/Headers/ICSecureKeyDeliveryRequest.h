...
@class NSNumber, NSURL, AVContentKeyRequest, NSString, AVAssetResourceLoadingRequest, NSData;
@protocol NSCopying;
...
@property (readonly, retain, nonatomic) AVContentKeyRequest *contentKeyRequest; // ivar: _contentKeyRequest
...
@property (readonly, retain, nonatomic) AVAssetResourceLoadingRequest *resourceLoadingRequest; // ivar: _resourceLoadingRequest
@property (readonly, copy, nonatomic) NSData *serverPlaybackContextData; // ivar: _serverPlaybackContextData
...
-(id)initWithRequestContext:(id)arg0 contentKeyRequest:(id)arg1 ;
-(id)initWithRequestContext:(id)arg0 resourceLoadingRequest:(id)arg1 ;
-(id)initWithRequestContext:(id)arg0 serverPlaybackContextData:(id)arg1 ;
