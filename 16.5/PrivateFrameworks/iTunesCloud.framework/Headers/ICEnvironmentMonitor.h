...
@protocol CoreTelephonyClientRegistrationDelegate, CoreTelephonyClientDataDelegate, NWNetworkOfInterestManagerDelegate, OS_dispatch_queue;
...
@property (readonly, nonatomic) NSUInteger currentNetworkLinkQuality; // ivar: _currentNetworkLinkQuality
@property (readonly, nonatomic) NSUInteger currentThermalLevel; // ivar: _currentThermalLevel
@property (readonly, nonatomic) NSInteger currentThermalPressureLevel;
@property (readonly, nonatomic) NSInteger currentThermalState;
