...
@class NSMutableDictionary, NEConfiguration, NEConfigurationManager, NSString, NSArray, NEVPNManager;
...
@property (retain) NEConfiguration *config; // ivar: _config
@property (retain) NEConfigurationManager *configManager; // ivar: _configManager
@property (readonly, copy) NSString *debugDescription;
@property (readonly, copy) NSString *description;
@property (retain) NSArray *eventsToMonitor; // ivar: _eventsToMonitor
@property (readonly) NSUInteger hash;
@property (retain) NEVPNManager *manager; // ivar: _manager
...
-(void)collectVPNAddressesWithCompletion:(id)arg0 ;
-(void)getExtendedStatus:(int)arg0 session:(*void)arg1 completionHandler:(id)arg2 ;
