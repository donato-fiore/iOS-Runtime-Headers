...
-(id)protocol;
-(void)_updateBetaEnrollmentStatus:(id)arg0 requiresUnenroll:(BOOL)arg1 withCompletion:(id)arg2 ;
...
-(void)fetchBetaEnrollmentStatus:(id)arg0 ;
...
-(void)setWatchFaceIdentifier:(id)arg0 forFocusModeIdentifier:(id)arg1 completionHandler:(id)arg2 ;
-(void)unenrollFromBetaUpdatesWithCompletion:(id)arg0 ;
-(void)unsafe_invalidate;
-(void)updateBetaEnrollmentStatus:(id)arg0 withCompletion:(id)arg1 ;
