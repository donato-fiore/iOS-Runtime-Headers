...
@class MFLock, ACAccount, NSMutableDictionary, NSString, ACAccountStore, NSURL, EDiCloudAliasSupport;
...
@property (readonly, nonatomic) MFCastleEmailAliasUpdater *aliasUpdater; // ivar: _aliasUpdater
...
-(BOOL)checkAndSetLocalDefaultEmailAddress:(id)arg0 ;
...
-(void)_updateEmailAddressAndAliasesWithResult:(id)arg0 ;
-(void)dealloc;
