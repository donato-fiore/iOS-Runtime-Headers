...
@class MFMutableMessageHeaders, NSArray, ECHTMLStringAndMIMECharset, EFFuture, NSDictionary, EMMessageObjectID;
...
-(id)_htmlBodyForMessage:(id)arg0 ;
-(id)account;
-(id)archiveAccount;
...
-(id)newMessageWriter;
-(id)originalHeaders;
-(void)_checkAndApplyFollowUpToDeliveredMessage:(id)arg0 ;
-(void)archive;
-(void)dealloc;
