...
@class NSString, NSRecursiveLock, NSArray, NSLock, NSNumber, NSSet, NSMutableDictionary;
@protocol MFIMAPConnectionDelegate, EFLoggable, MFIMAPMailboxListFilter, MFTaskManager;
...
-(id)certUIService;
-(id)clientToken;
-(id)connectionForMailbox:(id)arg0 delegate:(id)arg1 options:(int)arg2 failedToSelectMailbox:(*BOOL)arg3 ;
...
-(void)_replayMailboxActionsWithConnection:(id)arg0 ;
...
-(void)test_setTaskManager:(id)arg0 ;
