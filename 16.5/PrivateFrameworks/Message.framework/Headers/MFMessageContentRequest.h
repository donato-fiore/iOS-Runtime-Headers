...
@class EMMessageObjectID, EDMessagePersistence, EDMessageTransformer, NSString, EMContentRequestOptions, EDMailDropMetadataGenerator, EDListUnsubscribeHandler;
...
-(void)_includeCachedMetadataJSONIfNeededForRepresentation:(id)arg0 message:(id)arg1 ;
