...
@class NSString, NSMutableDictionary, NSConditionLock, NSMutableSet, MFLibrarySearchableIndex, EDWebContentParser, NSCache, EDPersistenceHookRegistry, EDPersistence, EDMessageQueryParser, EDSearchableIndexScheduler;
@protocol EDMessageChangeHookResponder, EFSignpostable, EFContentProtectionObserver, EFLoggable, OS_dispatch_queue, EFSQLValueExpressable, EFScheduler, EFCancelable;
...
@property (readonly, nonatomic) NSCache *messagesParsedCache; // ivar: _messagesParsedCache
...
-(BOOL)_deleteMessages:(id)arg0 andCleanUpAddresses:(id)arg1 subjects:(id)arg2 summaries:(id)arg3 brandIndicators:(id)arg4 connection:(id)arg5 ;
-(BOOL)_deleteMessages:(id)arg0 connection:(id)arg1 ;
-(BOOL)_deleteRows:(id)arg0 fromTable:(id)arg1 connection:(id)arg2 ;
-(BOOL)_fileType:(NSInteger)arg0 orHigherExistsAtDirectory:(id)arg1 ;
...
-(BOOL)_shouldPerformDataDetectionForMessage:(id)arg0 ;
...
-(BOOL)_writeEmlxFile:(id)arg0 withData:(id)arg1 protectionClass:(int)arg2 ;
-(BOOL)_writeEmlxFileOfType:(NSInteger)arg0 forAccount:(id)arg1 toDirectory:(id)arg2 withData:(id)arg3 protectionClass:(int)arg4 ;
...
-(id)_getHTMLFromPlainTextData:(id)arg0 mimePart:(id)arg1 ;
...
-(id)_messageForRow:(id)arg0 options:(unsigned int)arg1 timestamp:(NSUInteger)arg2 connection:(id)arg3 isProtectedDataAvailable:(BOOL)arg4 recipientsCache:(id)arg5 ;
-(id)_messagesForMailbox:(id)arg0 olderThanNumberOfDays:(int)arg1 limit:(NSUInteger)arg2 ;
-(id)_nonLocalAccountsClause;
-(id)_predicatesSeparatedByMailboxForAndPredicate:(id)arg0 containsMailboxPredicate:(*BOOL)arg1 ;
-(id)_predicatesSeparatedByMailboxForOrPredicate:(id)arg0 containsMailboxPredicate:(*BOOL)arg1 ;
-(id)_predicatesSeparatedByMailboxForPredicate:(id)arg0 containsMailboxPredicate:(*BOOL)arg1 ;
-(id)_queryForMailboxesIDsFromMailboxes:(id)arg0 ;
-(id)_recipientsForMessageWithDatabaseID:(NSInteger)arg0 connection:(id)arg1 recipientsCache:(id)arg2 ;
...
-(id)_sqlQueryForQuery:(id)arg0 byConvertingToCriteria:(BOOL)arg1 queryTransformer:(id)arg2 connection:(id)arg3 options:(unsigned int)arg4 ;
-(id)_sqlSortByStringFromOptions:(unsigned int)arg0 ;
...
-(id)bodyDataForMessage:(id)arg0 andHeaderDataIfReadilyAvailable:(*id)arg1 isComplete:(*BOOL)arg2 isPartial:(*BOOL)arg3 ;
...
-(id)existingMIMEPartsForMessage:(id)arg0 ;
...
-(id)newestUIDsMissingBodyDataForMailbox:(id)arg0 excluding:(id)arg1 inLatest:(NSInteger)arg2 limit:(NSInteger)arg3 ;
-(id)newestUIDsMissingPartsForMailbox:(id)arg0 excluding:(id)arg1 inLatest:(NSInteger)arg2 limit:(NSInteger)arg3 ;
-(id)orderedBatchOfMessagesEndingAtRowId:(NSInteger)arg0 limit:(unsigned int)arg1 success:(*BOOL)arg2 ;
-(id)queriesSeparatedByMailboxForQuery:(id)arg0 ;
...
-(unsigned int)_readLaterCountForAggregatedMailboxes:(id)arg0 ;
-(unsigned int)_sendLaterCountForAggregatedMailboxes:(id)arg0 ;
...
-(void)_enumerateMessageRemoteIDAndGlobalForMailbox:(id)arg0 excluding:(id)arg1 inLatest:(NSInteger)arg2 block:(id)arg3 ;
-(void)_findHTMLPartsFromHeaderData:(id)arg0 bodyData:(id)arg1 forMessage:(id)arg2 linksToVerify:(id)arg3 parsingOptions:(NSUInteger)arg4 ;
-(void)_iterateMessagesWithResultHandler:(id)arg0 options:(unsigned int)arg1 monitor:(id)arg2 sqlQueryGenerator:(id)arg3 ;
...
-(void)_processMessageData:(id)arg0 forMessage:(id)arg1 linksToVerify:(id)arg2 parsingOptions:(NSUInteger)arg3 ;
-(void)_processRemoteContentFromData:(id)arg0 forMimePart:(id)arg1 linksToVerify:(id)arg2 forMessage:(id)arg3 parsingOptions:(NSUInteger)arg4 ;
-(void)_removeDataFilesForGlobalID:(NSInteger)arg0 ;
-(void)_removeEmlxFilesOfTypeLessThanType:(NSInteger)arg0 inDirectory:(id)arg1 ;
...
-(void)detectDataFromPlainTextMessage:(id)arg0 globalMessageID:(NSInteger)arg1 mimePart:(id)arg2 ;
...
-(void)iterateMessagesMatchingQuery:(id)arg0 byConvertingToCriteria:(BOOL)arg1 queryTransformer:(id)arg2 withResultHandler:(id)arg3 options:(unsigned int)arg4 withMonitor:(id)arg5 ;
...
-(void)rebuildActiveMailboxesClauseWithActiveAccounts:(id)arg0 inactiveAccounts:(id)arg1 ;
...
-(void)removeMessagesFromCacheWithLibraryIDs:(id)arg0 ;
