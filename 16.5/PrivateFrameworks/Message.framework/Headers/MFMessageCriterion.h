...
@class NSString, NSArray, EFMutableInt64Set, CSSuggestion;
...
@property (nonatomic) NSInteger qualifier; // ivar: _qualifier
...
+(id)messageCriterionForUnsubscribeTypeNotMatching:(NSInteger)arg0 ;
...
+(id)senderIsVIPCriterion:(BOOL)arg0 ;
...
-(BOOL)_evaluateFlagColorCriterion:(id)arg0 ;
...
-(BOOL)_evaluateNotCriterion:(id)arg0 ;
...
-(BOOL)_evaluateReadLaterCriterion:(id)arg0 ;
-(BOOL)_evaluateSenderBucketCriterion:(id)arg0 ;
...
-(BOOL)isVIPCriterion;
-(NSInteger)messageRuleQualifierForString:(id)arg0 ;
...
-(id)_comparisonOperationMatchingValue:(id)arg0 qualifier:(NSInteger)arg1 ;
-(id)_criterionForSQL;
-(id)_evaluateFTSCriterionWithIndex:(id)arg0 mailboxIDs:(id)arg1 ;
-(id)_headersRequiredForEvaluation;
-(id)_queryWithAttributes:(id)arg0 matchingValue:(id)arg1 ;
-(id)_queryWithAttributes:(id)arg0 matchingValue:(id)arg1 qualifier:(NSInteger)arg2 ;
-(id)_resolveWithIndex:(id)arg0 mailboxIDs:(id)arg1 ;
-(id)_spotlightQuerySearchString:(*id)arg0 ;
...
-(id)initWithType:(NSInteger)arg0 qualifier:(NSInteger)arg1 expression:(id)arg2 ;
-(id)simplifiedCriterion;
-(id)simplifyOnce;
-(id)spotlightQueryExpression;
-(id)stringForMessageRuleQualifier:(NSInteger)arg0 ;
...
-(void)tokenizeUsingTokenizationHandler:(id)arg0 ;
