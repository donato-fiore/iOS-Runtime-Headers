...
@protocol VKInteractiveMap, VKInteractiveMapDelegate;
...
@property (weak, nonatomic) NSObject<VKInteractiveMapDelegate> *delegate; // ivar: _delegate
...
-(void)setMapType:(int)arg0 animated:(BOOL)arg1 ;
