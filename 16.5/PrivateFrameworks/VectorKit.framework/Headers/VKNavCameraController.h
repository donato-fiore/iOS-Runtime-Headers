...
@interface VKNavCameraController : VKCameraController <VKNavigationCameraController, VKGesturingCameraController, VKNavContextObserver>

 {
    ...
    Unit<geo::RadianUnitDescription, double> _puckCourse;
    Coordinate3D<geo::Radians, double> _puckCoordinate;
    Unit<geo::RadianUnitDescription, double> _headingDelta;
    Unit<geo::RadianUnitDescription, double> _headingMinDelta;
    ...
    Unit<geo::MeterUnitDescription, double> _cameraDistanceFromTarget;
    Unit<geo::RadianUnitDescription, double> _cameraPitch;
    CGFloat _previousUpdateTime;
    CGFloat _ignoreStyleChangeStartTime;
    CGFloat _lastSARUpdateTime;
    ...
    vector<geo::Coordinate3D<geo::Radians, double>, std::allocator<geo::Coordinate3D<geo::Radians, double>>> _coordinatesToFrame;
    ...
    Unit<geo::RadianUnitDescription, double> _minCameraPitch;
    Unit<geo::RadianUnitDescription, double> _maxCameraPitch;
    ...
    Matrix<float, 2, 1> _idealPuckScreenPosition;
    ...
    Coordinate3D<geo::Radians, double> _routeFocusCoordinate;
    NSUInteger _lastTargetStyleIdentifier;
    NSUInteger _previousSearchItemCount;
    ...
    Coordinate3D<geo::Radians, double> _cornerCoordinates;
    WindowedSampler<60UL> _pixelSamples;
    ...
    *void _cameraManager;
    ...
    CGFloat _farClipPlaneFactor;
    shared_ptr<gss::StylesheetQuery<gss::ScenePropertyID>> _sceneQuery;
    NSUInteger _cameraMode;
...
@property (nonatomic) NSInteger defaultMaxDisplayRate; // ivar: _defaultMaxDisplayRate
@property (readonly, copy) NSString *description;
@property (nonatomic) CGFloat distanceFromCenterCoordinate;
@property (readonly) NSUInteger hash;
@property (nonatomic) CGFloat heading;
@property (nonatomic) BOOL isElasticFramingEnabled; // ivar: _isElasticFramingEnabled
...
@property (weak, nonatomic) VKSceneConfiguration *sceneConfiguration; // ivar: _sceneConfiguration
@property (weak, nonatomic) VKScreenCanvas<VKInteractiveMap> *screenCanvas; // ivar: _screenCanvas
...
-(id)_debugText:(BOOL)arg0 showNavCameraDebugConsoleAttributes:(BOOL)arg1 includeSensitiveAttributes:(BOOL)arg2 ;
...
-(struct Coordinate3D<geo::Radians, double> )_coordinateForGeoLocation:(struct ? )arg0 ;
-(struct Coordinate3D<geo::Radians, double> )routeCoordinateAtDistance:(CGFloat)arg0 ;
-(struct Coordinate3D<geo::Radians, double> )routeLocationAtDistance:(CGFloat)arg0 fromManeuver:(NSUInteger)arg1 ;
-(struct Matrix<double, 2, 1> )puckScreenPoint;
-(struct Unit<geo::RadianUnitDescription, double> )calculateHeading;
-(struct Unit<geo::RadianUnitDescription, double> )maxCameraPitch;
-(struct Unit<geo::RadianUnitDescription, double> )minCameraPitch;
...
-(void)_setNavCameraTransitionComplete:(BOOL)arg0 ;
...
-(void)_updateSprings:(CGFloat)arg0 ;
-(void)_updateStyles;
