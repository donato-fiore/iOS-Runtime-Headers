...
typedef struct __compressed_pair<md::DisplayOptions *, std::default_delete<md::DisplayOptions>> {
    DisplayOptions __value_;
} __compressed_pair<md::DisplayOptions *, std::default_delete<md::DisplayOptions>>;

typedef struct unique_ptr<md::DisplayOptions, std::default_delete<md::DisplayOptions>> {
    __compressed_pair<md::DisplayOptions *, std::default_delete<md::DisplayOptions>> __ptr_;
} unique_ptr<md::DisplayOptions, std::default_delete<md::DisplayOptions>>;
...
typedef struct StringWithLocaleImp<std::string> {
    basic_string<char, std::char_traits<char>, std::allocator<char>> text;
    basic_string<char, std::char_traits<char>, std::allocator<char>> locale;
} StringWithLocaleImp<std::string>;

typedef struct LabelExternalTextElement {
    unsigned char minZoom;
    unsigned char textType;
    StringWithLocaleImp<std::string> text;
    StringWithLocaleImp<std::string> localizedText;
