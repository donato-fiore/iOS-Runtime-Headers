...
@interface VKMuninCameraController : VKCameraController <VKGesturingCameraController>

 {
    ...
    *void _elevationLogic;
    ...
    _retain_ptr<VKTimedAnimation *, geo::_retain_objc_arc, geo::_release_objc_arc, geo::_hash_objc, geo::_equal_objc> _panAnimation;
    BOOL _pinching;
    Matrix<float, 2, 1> _pinchZoomOffset;
    Unit<geo::RadianUnitDescription, double> _pinchStartFieldOfView;
    _retain_ptr<VKTimedAnimation *, geo::_retain_objc_arc, geo::_release_objc_arc, geo::_hash_objc, geo::_equal_objc> _pinchResetAnimation;
    float _cameraOffsetFactor;
    _retain_ptr<VKTimedAnimation *, geo::_retain_objc_arc, geo::_release_objc_arc, geo::_hash_objc, geo::_equal_objc> _offsetAnimation;
    ...
    Unit<geo::RadianUnitDescription, double> _widestFieldOfView;
    Coordinate3D<geo::Radians, double> _rigPosition;
...
-(BOOL)moveToPoint:(*void)arg0 withHeading:(struct Unit<geo::RadianUnitDescription, double> )arg1 withPitch:(struct Unit<geo::RadianUnitDescription, double> )arg2 animated:(BOOL)arg3 completionHandler:(id)arg4 ;
...
-(struct Unit<geo::RadianUnitDescription, double> )_horizontalFieldOfView:(struct Unit<geo::RadianUnitDescription, double> )arg0 ;
-(struct Unit<geo::RadianUnitDescription, double> )_pitchForScreenPoint:(struct Matrix<float, 2, 1> )arg0 ;
-(struct Unit<geo::RadianUnitDescription, double> )_verticalFieldOfView:(struct Unit<geo::RadianUnitDescription, double> )arg0 ;
-(void)_setHeading:(struct Unit<geo::RadianUnitDescription, double> )arg0 ;
...
-(void)setWidestFieldOfView:(struct Unit<geo::RadianUnitDescription, double> )arg0 ;
...
-(void)zoomAnimated:(struct Unit<geo::RadianUnitDescription, double> )arg0 completion:(id)arg1 ;
-(void)zoomAnimatedWithDuration:(struct Unit<geo::RadianUnitDescription, double> )arg0 duration:(float)arg1 completion:(id)arg2 ;
