...
@interface MDDisplayLayer : NSObject <GGLLayerDelegate, MDRenderTarget>

 {
    ...
    *void _activeRenderQueue;
    _retain_ptr<VKSharedResources *, geo::_retain_objc_arc, geo::_release_objc_arc, geo::_hash_objc, geo::_equal_objc> _sharedResources;
...
-(id)initWithContentScale:(CGFloat)arg0 useMultisampling:(BOOL)arg1 extraColorFormats:(*void)arg2 shouldRasterize:(BOOL)arg3 allowBlitToDrawable:(BOOL)arg4 taskContext:(*void)arg5 device:(*void)arg6 sharedResources:(id)arg7 signpostId:(NSUInteger)arg8 ;
...
-(void)_prepareTexture:(*void)arg0 isDrawable:(BOOL)arg1 ;
...
-(void)prepareTargetsForPlatormsWithoutFramebufferFetch:(*void)arg0 isDrawable:(BOOL)arg1 ;
-(void)prepareTexture:(*void)arg0 ;
-(void)renderWithTimestamp:(CGFloat)arg0 presentAtTime:(CGFloat)arg1 completion:(struct function<void ()> )arg2 ;
