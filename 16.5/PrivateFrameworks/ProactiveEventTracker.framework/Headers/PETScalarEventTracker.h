...
-(void)trackEventWithPropertyValues:(id)arg0 ;
-(void)trackEventWithPropertyValues:(id)arg0 setValue:(NSUInteger)arg1 ;
-(void)trackEventWithPropertyValues:(id)arg0 value:(NSUInteger)arg1 ;
