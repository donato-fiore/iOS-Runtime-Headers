...
@protocol RBSAssertionObserving, OS_dispatch_queue;
...
+(id)_writeMessage:(id)arg0 objCClassName:(id)arg1 ;
+(id)defaultRootDir;
...
-(void)_logMessageData:(id)arg0 objcClassName:(id)arg1 subGroup:(id)arg2 ;
...
-(void)logMessageData:(id)arg0 objcClassName:(id)arg1 subGroup:(id)arg2 ;
