...
-(id)_predicateWithAdditionalPredicates:(id)arg0 ;
...
-(id)sortableMessagesWithAdditionalPredicates:(id)arg0 limit:(NSInteger)arg1 ;
...
-(void)persistenceDidChangeSenderBucketForSenders:(id)arg0 toBucket:(NSInteger)arg1 generation:(NSInteger)arg2 ;
...
-(void)persistenceWillChangeSenderBucketForSenders:(id)arg0 toBucket:(NSInteger)arg1 ;
