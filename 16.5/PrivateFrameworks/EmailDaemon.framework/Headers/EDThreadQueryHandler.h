...
-(BOOL)isStarted;
-(BOOL)start;
-(id)_addSnippetHintsToExtraInfo:(id)arg0 ;
-(id)inMemoryMessageObjectIDsForThread:(id)arg0 ;
-(id)initWithQuery:(id)arg0 messagePersistence:(id)arg1 threadPersistence:(id)arg2 hookRegistry:(id)arg3 vipManager:(id)arg4 remoteSearchProvider:(id)arg5 remindMeNotificationController:(id)arg6 observer:(id)arg7 observationIdentifier:(id)arg8 delegate:(id)arg9 observationResumer:(id)arg10 ;
