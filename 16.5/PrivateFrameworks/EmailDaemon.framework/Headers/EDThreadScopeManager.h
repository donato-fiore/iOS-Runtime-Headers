...
-(BOOL)isThreadScopePrecomputed:(id)arg0 mailboxProvider:(id)arg1 shouldMigrate:(*BOOL)arg2 ;
...
-(id)_precomputedMailboxScopeForFilterPredicate:(id)arg0 mailboxProvider:(id)arg1 hasFollowUpPredicate:(*BOOL)arg2 ;
-(id)_threadScopeInfoForThreadScope:(id)arg0 ;
-(id)initWithDataSource:(id)arg0 ;
-(id)precomputedMailboxScopeForThreadScope:(id)arg0 mailboxProvider:(id)arg1 hasFollowUpPredicate:(*BOOL)arg2 ;
-(id)threadScopeFromPrecomputedMailboxScope:(id)arg0 hasFollowUpPredicate:(BOOL)arg1 mailboxProvider:(id)arg2 ;
