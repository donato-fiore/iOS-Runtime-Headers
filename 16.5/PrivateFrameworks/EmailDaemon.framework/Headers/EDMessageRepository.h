...
@property (readonly, nonatomic) NSObject<EFScheduler> *messageListItemScheduler; // ivar: _messageListItemScheduler
...
-(void)_accountActiveStateDidChange:(id)arg0 stateStringForLogging:(id)arg1 ;
// -(void)_enumerateObjectIDsAndQueryHandlersForObjectIDsByScope:(id)arg0 withTargetClass:(Class)arg1 usingBlock:(id)arg2 failureBlock:(unk)arg3  ;
...
-(void)_requestSummariesIfNeededForMessageListItems:(id)arg0 additionalObjectIDs:(id)arg1 queryHandler:(id)arg2 observationIdentifier:(id)arg3 ;
