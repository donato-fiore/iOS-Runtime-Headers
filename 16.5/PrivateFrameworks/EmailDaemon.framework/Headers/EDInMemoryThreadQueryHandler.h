...
-(id)initWithQuery:(id)arg0 messagePersistence:(id)arg1 hookRegistry:(id)arg2 remindMeNotificationController:(id)arg3 vipManager:(id)arg4 remoteSearchProvider:(id)arg5 observer:(id)arg6 observationIdentifier:(id)arg7 observationResumer:(id)arg8 ;
...
-(void)dealloc;
-(void)logThreadObjectIDsChangesWithMessage:(id)arg0 newObjectIDs:(id)arg1 beforeExistingObjectID:(id)arg2 ;
-(void)logThreadObjectIDsWithMessage:(id)arg0 objectIDs:(id)arg1 ;
