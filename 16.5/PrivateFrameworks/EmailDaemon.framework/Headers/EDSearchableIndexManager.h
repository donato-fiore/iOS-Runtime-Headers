...
@class NSString;
@protocol EFLoggable, EDMessageChangeHookResponder, EFCancelable;
...
@property (retain, nonatomic) EDSearchableIndexDiagnosticsController *diagnosticsController; // ivar: _diagnosticsController
...
@property (retain, nonatomic) NSObject<EFCancelable> *turboModeObservationToken; // ivar: _turboModeObservationToken
