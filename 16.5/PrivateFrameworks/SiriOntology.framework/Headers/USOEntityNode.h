...
-(void)addIdentifierWithValue:(id)arg0 appBundleId:(id)arg1 namespaceString:(id)arg2 probability:(struct optional<double> )arg3 nluComponent:(struct optional<siri::ontology::UsoIdentifier::NluComponent> )arg4 groupIndex:(struct optional<unsigned int> )arg5 ;
-(void)addIdentifierWithValue:(id)arg0 appBundleId:(id)arg1 namespaceString:(id)arg2 probability:(struct optional<double> )arg3 nluComponent:(struct optional<siri::ontology::UsoIdentifier::NluComponent> )arg4 groupIndex:(struct optional<unsigned int> )arg5 interpretationGroup:(struct optional<unsigned int> )arg6 ;
