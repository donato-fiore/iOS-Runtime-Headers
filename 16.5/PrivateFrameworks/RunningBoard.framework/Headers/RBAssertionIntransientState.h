...
@property (retain, nonatomic) NSMutableDictionary *invalidatesOnConditions; // ivar: _invalidatesOnConditions
...
@property (nonatomic) BOOL preventsSuspension; // ivar: _preventsSuspension
