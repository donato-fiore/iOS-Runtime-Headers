...
@class NSMutableDictionary, NSMutableSet, RBSProcessIdentity, NSSet, NSString;
...
@property (readonly, nonatomic) int memoryLimit; // ivar: _memoryLimit
@property (readonly, nonatomic) NSString *memoryLimitCategory; // ivar: _memoryLimitCategory
@property (readonly, nonatomic) unsigned char memoryLimitStrength; // ivar: _memoryLimitStrength
