...
@class NSString;
@protocol PSSystemPolicyForAppDelegate, PSDriverPolicyForAppDelegate;


#import "PSListController.h"
#import "PSSystemPolicyForApp.h"
#import "PSDriverPolicyForApp.h"
...
@property (retain, nonatomic) PSDriverPolicyForApp *driverPolicy; // ivar: _driverPolicy
