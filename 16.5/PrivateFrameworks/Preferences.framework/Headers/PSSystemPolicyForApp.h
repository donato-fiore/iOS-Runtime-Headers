...
-(id)isTapToPayAlwaysPlaySoundEnabled:(id)arg0 ;
-(id)isTapToPayScreenLockEnabled:(id)arg0 ;
...
-(id)pasteboardAccessForSpecifier:(id)arg0 ;
...
-(void)setPasteboardAccess:(id)arg0 forSpecifier:(id)arg1 ;
-(void)setPrivacyAccess:(id)arg0 forSpecifier:(id)arg1 ;
-(void)setTapToPayAlwaysPlaySoundEnabled:(id)arg0 specifier:(id)arg1 ;
-(void)setTapToPayScreenLockEnabled:(id)arg0 specifier:(id)arg1 ;
