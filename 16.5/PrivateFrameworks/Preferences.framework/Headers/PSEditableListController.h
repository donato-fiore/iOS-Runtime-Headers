...
@property (readonly, nonatomic) UIBarButtonItem *editBarButtonItem; // ivar: _editBarButtonItem
@property (retain, nonatomic) NSArray *previousRightBarButtonItems; // ivar: _previousRightBarButtonItems
