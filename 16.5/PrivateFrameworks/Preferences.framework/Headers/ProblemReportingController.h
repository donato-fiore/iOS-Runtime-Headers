...
@class NSArray, AFSettingsConnection, HKHealthStore, CIDVUIIdentityProofingDataSharingFlowManager;
...
@property (retain, nonatomic) CIDVUIIdentityProofingDataSharingFlowManager *identityProofingDataSharingManager; // ivar: _identityProofingDataSharingManager
@property (readonly) NSArray *identityVerificationDataSpecifiers; // ivar: _identityVerificationDataSpecifiers
...
-(id)shouldShareIdentityVerificationData:(id)arg0 ;
...
-(void)setShouldShareIdentityVerificationData:(id)arg0 specifier:(id)arg1 ;
