...
@property (readonly, nonatomic) SUCoreRollback *rollbackControl; // ivar: _rollbackControl
@property (readonly, nonatomic) SUCoreRollbackDescriptor *rollbackDescriptor; // ivar: _rollbackDescriptor
...
-(NSInteger)actionDecideBeginRollback:(id)arg0 error:(*id)arg1 ;
-(NSInteger)actionDecideCancelBeforeRollback:(id)arg0 error:(*id)arg1 ;
...
-(NSInteger)actionDecideRollbackUpdate:(id)arg0 error:(*id)arg1 ;
...
-(NSInteger)actionLoadBrainRollback:(id)arg0 error:(*id)arg1 ;
...
-(NSInteger)actionReportRollbackFailed:(id)arg0 error:(*id)arg1 ;
-(NSInteger)actionReportRollbackSuccess:(id)arg0 error:(*id)arg1 ;
...
-(NSInteger)actionRollbackUpdateApply:(id)arg0 error:(*id)arg1 ;
-(NSInteger)actionRollbackUpdateDecideApply:(id)arg0 error:(*id)arg1 ;
-(NSInteger)actionRollbackUpdateDecideResume:(id)arg0 error:(*id)arg1 ;
-(NSInteger)actionRollbackUpdateDecideSuspend:(id)arg0 error:(*id)arg1 ;
-(NSInteger)actionRollbackUpdatePrepare:(id)arg0 error:(*id)arg1 ;
-(NSInteger)actionRollbackUpdateResume:(id)arg0 error:(*id)arg1 ;
-(NSInteger)actionRollbackUpdateSuspend:(id)arg0 error:(*id)arg1 ;
...
-(void)_eventAfterReachingRollbackPhase:(NSInteger)arg0 ;
-(void)_rollbackAttemptFailed:(id)arg0 withError:(id)arg1 ;
...
-(void)_updateRolledBack:(id)arg0 ;
...
-(void)msuResumed;
-(void)msuRollbackApplyFailed:(id)arg0 ;
-(void)msuRollbackApplySuccess;
-(void)msuRollbackFailed:(id)arg0 ;
