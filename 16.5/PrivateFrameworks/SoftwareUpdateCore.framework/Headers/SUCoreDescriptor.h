...
@class NSString, NSDictionary, MAAsset, MAAbsoluteAssetId, SUCoreMAIdentifier, NSData, NSNumber, NSDate, NSArray;
...
@property (readonly, nonatomic) BOOL semiSplatRestartNow; // ivar: _semiSplatRestartNow
...
-(id)initWithSUAsset:(id)arg0 releaseDate:(id)arg1 prepareSize:(id)arg2 applySize:(id)arg3 defaultValues:(id)arg4 ;
