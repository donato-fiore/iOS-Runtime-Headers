...
@property (retain, nonatomic) NSString *humanReadableMoreInfoLink; // ivar: _humanReadableMoreInfoLink
@property (retain, nonatomic) NSString *humanReadableUpdateName; // ivar: _humanReadableUpdateName
@property (retain, nonatomic) NSString *humanReadableUpdateTitle; // ivar: _humanReadableUpdateTitle
@property (retain, nonatomic) NSString *humanReadableUpdateVersion; // ivar: _humanReadableUpdateVersion
...
@property (retain, nonatomic) NSString *notificationBodyString; // ivar: _notificationBodyString
@property (nonatomic) BOOL notificationEnabled; // ivar: _notificationEnabled
@property (retain, nonatomic) NSString *notificationTitleString; // ivar: _notificationTitleString
...
@property (retain, nonatomic) NSString *recommendedUpdateAlertBodyString; // ivar: _recommendedUpdateAlertBodyString
@property (nonatomic) BOOL recommendedUpdateApplicable; // ivar: _recommendedUpdateApplicable
@property (nonatomic) BOOL recommendedUpdateEnabled; // ivar: _recommendedUpdateEnabled
@property (retain, nonatomic) NSString *recommendedUpdateMaxOSVersion; // ivar: _recommendedUpdateMaxOSVersion
@property (retain, nonatomic) NSString *recommendedUpdateMinOSVersion; // ivar: _recommendedUpdateMinOSVersion
@property (retain, nonatomic) NSNumber *recommendedUpdateNotificationFrequencyDays; // ivar: _recommendedUpdateNotificationFrequencyDays
@property (retain, nonatomic) NSString *recommendedUpdateTitleString; // ivar: _recommendedUpdateTitleString
...
-(id)initWithLocalBundleURL:(id)arg0 attributes:(id)arg1 ;
