...
@property (retain, nonatomic) SUCoreRollbackDescriptor *rollbackDescriptor; // ivar: _rollbackDescriptor
@property (retain, nonatomic) NSObject<OS_os_transaction> *rollbackUpdateTransaction; // ivar: _rollbackUpdateTransaction
...
-(id)_newMSURollbackOptionsUsingPolicy:(id)arg0 rollbackDescriptor:(id)arg1 baseOptions:(id)arg2 additionalOptions:(id)arg3 ;
...
-(id)_newRollbackPrepareOptionsUsingPolicy:(id)arg0 rollbackDescriptor:(id)arg1 ;
-(id)description;
-(id)doNotPatchList;
...
-(void)_addUpdateMetricsEventFieldsToMSURollbackOptions:(id)arg0 usingPolicy:(id)arg1 rollbackDescriptor:(id)arg2 ;
...
-(void)_operationResumeUpdate:(id)arg0 ;
-(void)_operationRollbackUpdateApply:(id)arg0 ;
-(void)_operationRollbackUpdatePrepare:(id)arg0 ;
-(void)_operationRollbackUpdateResume:(id)arg0 ;
-(void)_operationRollbackUpdateSuspend:(id)arg0 ;
...
-(void)_reportResumed;
-(void)_reportRollbackApplyFailed:(id)arg0 ;
-(void)_reportRollbackApplySuccess;
-(void)_reportRollbackFailed:(id)arg0 ;
...
-(void)assignRollbackDescriptor:(id)arg0 updateUUID:(id)arg1 ;
-(void)cancelPrepare;
...
-(void)removePrepared;
-(void)resumeUpdate;
-(void)resumeUpdate:(id)arg0 ;
-(void)rollbackUpdateApply:(id)arg0 ;
-(void)rollbackUpdatePrepare:(id)arg0 ;
-(void)rollbackUpdateResume:(id)arg0 ;
-(void)rollbackUpdateSuspend:(id)arg0 ;
-(void)suspendUpdate;
-(void)updatePrepareOptions:(id)arg0 withPolicy:(id)arg1 ;
