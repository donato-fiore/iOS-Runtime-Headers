...
+(CGFloat)_computeHeadroomZoomFactorWithVisibleFrame:(struct CGRect )arg0 scaleCenter:(struct CGPoint )arg1 initialOverlap:(struct PISegmentationClockOverlapResult )arg2 matte:(id)arg3 layoutConfiguration:(id)arg4 context:(id)arg5 ;
...
+(CGFloat)computeHeadroomZoomFactorWithVisibleFrame:(struct CGRect )arg0 zoomTowardsTop:(*BOOL)arg1 matte:(id)arg2 layoutConfiguration:(id)arg3 context:(id)arg4 ;
...
+(struct CGRect )scaleRect:(struct CGRect )arg0 scaleFactor:(CGFloat)arg1 scaleCenter:(struct CGPoint )arg2 ;
...
+(struct PISegmentationClockOverlapResult )computeClockLayerOrderWithVisibleFrame:(struct CGRect )arg0 segmentationMatte:(id)arg1 layoutConfiguration:(id)arg2 context:(id)arg3 interactive:(BOOL)arg4 ;
