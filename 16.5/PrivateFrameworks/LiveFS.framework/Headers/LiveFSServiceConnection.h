...
-(void)blockmapFile:(id)arg0 range:(struct _NSRange )arg1 startIO:(int)arg2 flags:(unsigned int)arg3 operationID:(NSUInteger)arg4 reply:(id)arg5 ;
...
-(void)dealloc;
-(void)endIO:(id)arg0 range:(struct _NSRange )arg1 status:(int)arg2 flags:(unsigned int)arg3 operationID:(NSUInteger)arg4 reply:(id)arg5 ;
