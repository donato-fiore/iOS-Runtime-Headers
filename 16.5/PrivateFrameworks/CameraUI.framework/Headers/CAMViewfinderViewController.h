...
@property (retain, nonatomic, setter=_setAnalyticsControlDrawerEvent:) CAMAnalyticsControlDrawerEvent *_analyticsControlDrawerEvent; // ivar: __analyticsControlDrawerEvent
@property (retain, nonatomic, setter=_setAnalyticsSessionEvent:) CAMAnalyticsSessionEvent *_analyticsSessionEvent; // ivar: __analyticsSessionEvent
...
@property (nonatomic) NSInteger _cachedSharedLibraryTimerState; // ivar: __cachedSharedLibraryTimerState
...
@property (nonatomic) NSUInteger _catCount; // ivar: __catCount
@property (nonatomic) NSInteger _cinematicConfigurationOverride; // ivar: __cinematicConfigurationOverride
...
@property (nonatomic) BOOL _completedInitialConfiguration; // ivar: __completedInitialConfiguration
...
@property (nonatomic, setter=_setDesiredVideoStabilizationMode:) NSInteger _desiredVideoStabilizationMode; // ivar: __desiredVideoStabilizationMode
...
@property (nonatomic) NSUInteger _dogCount; // ivar: __dogCount
...
@property (nonatomic) NSUInteger _faceCount; // ivar: __faceCount
...
@property (nonatomic, getter=_isFlashingVideoStabilizationBadge, setter=_setFlashingVideoStabilizationBadge:) BOOL _flashingVideoStabilizationBadge; // ivar: __flashingVideoStabilizationBadge
...
@property (nonatomic) CGFloat _lastDefaultApertureValue; // ivar: __lastDefaultApertureValue
...
@property (nonatomic, setter=_setNeedsDeferredGraphConfiguration:) BOOL _needsDeferredGraphConfiguration; // ivar: __needsDeferredGraphConfiguration
...
@property (nonatomic, setter=_setReceivedOutOfDiskSpaceErrorDuringCapture:) BOOL _receivedOutOfDiskSpaceErrorDuringCapture; // ivar: __receivedOutOfDiskSpaceErrorDuringCapture
...
@property (nonatomic, setter=_setResolvedMacroMode:) NSInteger _resolvedMacroMode; // ivar: __resolvedMacroMode
@property (nonatomic, setter=_setResolvedProResVideoMode:) NSInteger _resolvedProResVideoMode; // ivar: __resolvedProResVideoMode
...
@property (readonly, nonatomic) CAMSharedLibraryBadge *_sharedLibraryBadge; // ivar: __sharedLibraryBadge
@property (readonly, nonatomic) CAMSharedLibraryButton *_sharedLibraryButton; // ivar: __sharedLibraryButton
@property (readonly, nonatomic) UILongPressGestureRecognizer *_sharedLibraryLongPressGestureRecognizer; // ivar: __sharedLibraryLongPressGestureRecognizer
...
@property (readonly, nonatomic) CAMTimerCache *_timerCache; // ivar: __timerCache
...
@property (weak, nonatomic) NSObject<CAMViewfinderViewControllerCameraRollTestingDelegate> *cameraRollControllerTestDelegate; // ivar: _cameraRollControllerTestDelegate
...
-(BOOL)_shouldHideBadgesForGraphConfiguration:(id)arg0 ;
...
-(BOOL)_shouldShowAutoMacroButtonForGraphConfiguration:(id)arg0 ;
...
-(BOOL)_shouldShowFreeResourcesInstructionLabelForGraphConfiguration:(id)arg0 ;
...
-(BOOL)_shouldShowMaxRecordTimeInstructionLabelForGraphConfiguration:(id)arg0 ;
-(BOOL)_shouldShowProResButtonForGraphConfiguration:(id)arg0 ;
-(BOOL)_shouldShowRAWButtonForGraphConfiguration:(id)arg0 ;
-(BOOL)_shouldShowSemanticStyleControlForGraphConfiguration:(id)arg0 ;
-(BOOL)_shouldShowSharedLibraryBadgeForGraphConfiguration:(id)arg0 ;
-(BOOL)_shouldShowSharedLibraryButtonForGraphConfiguration:(id)arg0 ;
-(BOOL)_shouldShowSharedLibraryImageWellIndicatorForGraphConfiguration:(id)arg0 ;
-(BOOL)_shouldShowSharedLibraryIndicatorForGraphConfiguration:(id)arg0 ;
-(BOOL)_shouldShowShutterButtonDisabled;
-(BOOL)_shouldShowVideoStabilizationBadgeForGraphConfiguration:(id)arg0 ;
-(BOOL)_shouldShowVideoStabilizationButtonForGraphConfiguration:(id)arg0 ;
...
-(CGFloat)_defaultZoomFactorForGraphConfiguration:(id)arg0 captureOrientation:(NSInteger)arg1 ;
...
-(CGFloat)_zoomFactorForSelectButtonDisplayZoomFactor:(CGFloat)arg0 device:(NSInteger)arg1 ;
...
-(NSInteger)_currentMaxPhotoResolution;
-(NSInteger)_currentPhotoEncodingBehavior;
-(NSInteger)_deviceForSelectButtonZoomDisplayZoomFactor:(CGFloat)arg0 ;
...
-(NSInteger)_fallbackVideoConfigurationForVideoConfiguration:(NSInteger)arg0 withBlock:(id)arg1 ;
...
-(NSInteger)_mappedVideoConfigurationForVideoConfiguration:(NSInteger)arg0 proResVideoMode:(NSInteger)arg1 ;
...
-(id)initWithCaptureController:(id)arg0 captureConfiguration:(id)arg1 conflictingControlConfiguration:(id)arg2 locationController:(id)arg3 motionController:(id)arg4 timelapseController:(id)arg5 keepAliveController:(id)arg6 remoteShutterController:(id)arg7 powerController:(id)arg8 cameraRollController:(id)arg9 librarySelectionController:(id)arg10 callStatusMonitor:(id)arg11 storageController:(id)arg12 usingEmulationMode:(NSInteger)arg13 initialLayoutStyle:(NSInteger)arg14 options:(NSInteger)arg15 ;
...
-(void)_changeToZoomFactor:(CGFloat)arg0 rampDuration:(CGFloat)arg1 zoomRampTuning:(NSInteger)arg2 shouldAnimate:(BOOL)arg3 ;
...
-(void)_dismissDockedMRCButtonIfNeededAnimated:(BOOL)arg0 ;
-(void)_dismissFlashOrTorchUnavailableAlertViewAnimated:(BOOL)arg0 ;
-(void)_dismissOverlays;
-(void)_dockMRCButtonIfNeededFromIndicator:(id)arg0 mrc:(id)arg1 ;
...
-(void)_embedSharedLibraryBadgeWithLayoutStyle:(NSInteger)arg0 ;
...
-(void)_handleAutoMacroButtonTapped:(id)arg0 ;
...
-(void)_handleDismissLiftedTextGestureRecognizer:(id)arg0 ;
...
-(void)_handleFreeResourcesLabelTapped:(id)arg0 ;
...
-(void)_handleUserChangedProResMode:(NSInteger)arg0 ;
...
-(void)_handleUserChangedToNightMode:(NSUInteger)arg0 ;
-(void)_handleUserChangedToSharedLibraryMode:(NSInteger)arg0 ;
-(void)_handleUserChangedToVideoConfiguration:(NSInteger)arg0 ;
-(void)_handleUserChangedVideoStabilizationMode:(NSInteger)arg0 ;
...
-(void)_resetPortraitModeApertureValueIfNeededForGraphConfiguration:(id)arg0 zoomFactor:(CGFloat)arg1 ;
-(void)_resetZoom;
...
-(void)_startTimer:(NSUInteger)arg0 ;
...
-(void)_updateAutoMacroButtonAnimated:(BOOL)arg0 ;
...
-(void)_updateMaxRecordingTimeInstructionLabelForGraphConfiguration:(id)arg0 ;
-(void)_updateObjectResults:(id)arg0 headResults:(id)arg1 bodyResults:(id)arg2 ;
...
-(void)_updatePortraitApertureButtonForGraphConfiguration:(id)arg0 zoomFactor:(CGFloat)arg1 animated:(BOOL)arg2 ;
-(void)_updatePortraitApertureSliderForGraphConfiguration:(id)arg0 zoomFactor:(CGFloat)arg1 ;
...
-(void)_updateProResButtonAnimated:(BOOL)arg0 ;
...
-(void)_updateSharedLibraryButtonAnimated:(BOOL)arg0 ;
-(void)_updateSharedLibraryButtonOnSubviewsForLayoutStyle:(NSInteger)arg0 ;
...
-(void)_updateVideoConfigurationStatusIndicatorForGraphConfiguration:(id)arg0 animated:(BOOL)arg1 ;
-(void)_updateVideoStabilizationButtonAnimated:(BOOL)arg0 ;
...
-(void)_updateZoomButtonSymbolForMode:(NSInteger)arg0 device:(NSInteger)arg1 videoConfiguration:(NSInteger)arg2 zoomFactor:(CGFloat)arg3 videoStabilizationStrength:(NSInteger)arg4 animated:(BOOL)arg5 ;
...
-(void)cameraRollControllerWillPresentCameraRoll:(id)arg0 withOneUpController:(id)arg1 ;
-(void)cameraRollControllerWillPresentPreviewController:(id)arg0 ;
-(void)captureController:(id)arg0 didChangeAutoMacroActive:(BOOL)arg1 ;
-(void)captureController:(id)arg0 didChangeAutoMacroSuggested:(BOOL)arg1 ;
...
-(void)controlDrawer:(id)arg0 didChangeProResVideoMode:(NSInteger)arg1 ;
-(void)controlDrawer:(id)arg0 didChangeRAWMode:(NSInteger)arg1 ;
-(void)controlDrawer:(id)arg0 didChangeSharedLibraryMode:(NSInteger)arg1 ;
-(void)controlDrawer:(id)arg0 didChangeTimerDuration:(NSInteger)arg1 ;
-(void)controlDrawer:(id)arg0 didChangeValueForControlType:(NSInteger)arg1 ;
-(void)controlDrawer:(id)arg0 didChangeVideoStabilizationMode:(NSInteger)arg1 ;
...
-(void)dynamicShutterControl:(id)arg0 didChangeRelativeZoomProgress:(CGFloat)arg1 ;
...
-(void)fullscreenViewFinder:(id)arg0 willDismissControlDrawerModallyForControlType:(NSInteger)arg1 reason:(NSInteger)arg2 ;
-(void)fullscreenViewFinder:(id)arg0 willPresentControlDrawerModallyForControlType:(NSInteger)arg1 reason:(NSInteger)arg2 ;
-(void)fullscreenViewfinder:(id)arg0 didChangeControlDrawerVisibility:(BOOL)arg1 forReason:(NSInteger)arg2 ;
...
-(void)fullscreenViewfinderDidCreateAutoMacroButton:(id)arg0 ;
...
-(void)librarySelectionDidChangeSharedLibraryMode:(NSInteger)arg0 ;
...
-(void)previewViewControllerDidChangeFocusOrExposure:(id)arg0 ;
...
-(void)prominentObjectManagerDidChangeIsCurrentObjectExpiring:(id)arg0 ;
...
-(void)remoteShutter:(id)arg0 setSharedLibraryMode:(NSInteger)arg1 ;
...
-(void)timerCache:(id)arg0 timerDidFireForKey:(id)arg1 ;
...
-(void)zoomControlDidChangePlatterExpanded:(id)arg0 ;
-(void)zoomControlDidChangeShowingZoomDial:(id)arg0 ;
-(void)zoomControlDidTapZoomButtonAccessory:(id)arg0 ;
