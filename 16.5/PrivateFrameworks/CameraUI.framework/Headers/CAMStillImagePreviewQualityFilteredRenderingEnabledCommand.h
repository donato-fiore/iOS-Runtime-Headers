...
#ifndef CAMSTILLIMAGEPREVIEWQUALITYFILTEREDRENDERINGENABLEDCOMMAND_H
#define CAMSTILLIMAGEPREVIEWQUALITYFILTEREDRENDERINGENABLEDCOMMAND_H
...
-(id)initWithPreviewQualityFilteredRenderingEnabled:(BOOL)arg0 ;
