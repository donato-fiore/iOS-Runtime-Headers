...
-(void)populateDesiredNightModeControlMode:(NSUInteger)arg0 resolvedNightModeControlMode:(NSUInteger)arg1 resolvedNightModeMode:(NSInteger)arg2 nightModeStatus:(NSInteger)arg3 ;
