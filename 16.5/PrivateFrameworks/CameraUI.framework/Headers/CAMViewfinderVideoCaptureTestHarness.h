...
@property (readonly, nonatomic) CGFloat _initialDelayInSeconds; // ivar: __initialDelayInSeconds
...
-(id)initWithTestName:(id)arg0 viewfinderViewController:(id)arg1 videoDurationInSeconds:(CGFloat)arg2 initialDelayInSeconds:(CGFloat)arg3 ;
-(void)startTesting;
