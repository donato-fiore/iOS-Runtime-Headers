...
@property (nonatomic, getter=_isPlatterLayoutCompact, setter=_setPlatterLayoutCompact:) BOOL _platterLayoutCompact; // ivar: __platterLayoutCompact
...
@property (retain, nonatomic, setter=_setZoomPoints:) NSArray *_zoomPoints; // ivar: __zoomPoints
...
@property (nonatomic) NSInteger zoomButtonAccessoryState; // ivar: _zoomButtonAccessoryState
...
-(BOOL)_isPointWithinZoomButtonAccessory:(struct CGPoint )arg0 ;
-(BOOL)_isTouchWithinButtonPlatter:(id)arg0 ;
-(BOOL)_isTouchWithinZoomButtonAccessory:(id)arg0 ;
...
-(BOOL)configureForContinuousZoomWithZoomFactor:(CGFloat)arg0 zoomPoints:(id)arg1 animated:(BOOL)arg2 ;
...
-(NSUInteger)_numberOfZoomPlatterButtonsForZoomFactorCount:(NSUInteger)arg0 ;
...
-(void)_configureForControlMode:(NSInteger)arg0 zoomFactor:(CGFloat)arg1 zoomPoints:(id)arg2 zoomButtonContentType:(NSInteger)arg3 animated:(BOOL)arg4 ;
-(void)_configureForControlMode:(NSInteger)arg0 zoomFactor:(CGFloat)arg1 zoomPoints:(id)arg2 zoomFactors:(id)arg3 displayZoomFactors:(id)arg4 zoomButtonContentType:(NSInteger)arg5 compactPlatterLayout:(BOOL)arg6 animated:(BOOL)arg7 ;
-(void)_handleAccessoryTappedForButton:(id)arg0 ;
...
-(void)_resetSnapping;
-(void)_setButtonPlatterCollapsed:(BOOL)arg0 animated:(BOOL)arg1 ;
-(void)_updateButtonAccessoryAnimated:(BOOL)arg0 ;
-(void)_updateDisplayZoomFactorsAnimated:(BOOL)arg0 ;
...
-(void)configureForSelectionOnlyWithDisplayZoomFactors:(id)arg0 selectedIndex:(NSUInteger)arg1 compactPlatterLayout:(BOOL)arg2 animated:(BOOL)arg3 ;
