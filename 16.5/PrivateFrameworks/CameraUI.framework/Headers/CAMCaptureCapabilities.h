...
@property (readonly, nonatomic, getter=_is1080pHFRVideoStabilizationSupported) BOOL _1080pHFRVideoStabilizationSupported; // ivar: __1080pHFRVideoStabilizationSupported
@property (readonly, nonatomic) NSDictionary *_FFCZoomBehaviorForCaptureMode; // ivar: __FFCZoomBehaviorForCaptureMode
@property (readonly, nonatomic, getter=_isAspectRatioCropThreeTwoSupported) BOOL _aspectRatioCropThreeTwoSupported; // ivar: __aspectRatioCropThreeTwoSupported
@property (readonly, nonatomic) NSInteger _backCameraMaximumEnhancedHEICResolution; // ivar: __backCameraMaximumEnhancedHEICResolution
@property (readonly, nonatomic) NSInteger _backCameraMaximumEnhancedRAWResolution; // ivar: __backCameraMaximumEnhancedRAWResolution
...
@property (readonly, nonatomic) NSInteger _defaultMaximumEnhancedPhotoResolution; // ivar: __defaultMaximumEnhancedPhotoResolution
@property (readonly, nonatomic) NSInteger _defaultMaximumEnhancedRAWPhotoResolution; // ivar: __defaultMaximumEnhancedRAWPhotoResolution
...
@property (readonly, nonatomic, getter=_isiPad) BOOL _iPad; // ivar: __iPad
...
@property (readonly, nonatomic, getter=_isQuadraPortraitSupported) BOOL _quadraPortraitSupported; // ivar: __quadraPortraitSupported
@property (readonly, nonatomic, getter=_isQuadraSlomoButtonSupported) BOOL _quadraSlomoButtonSupported; // ivar: __quadraSlomoButtonSupported
...
@property (readonly, nonatomic) NSInteger backQuadraWideFocalLengthDisplayValue; // ivar: _backQuadraWideFocalLengthDisplayValue
@property (readonly, nonatomic, getter=isBackQuadraWideSupported) BOOL backQuadraWideSupported; // ivar: _backQuadraWideSupported
...
@property (readonly, nonatomic) NSInteger backSuperWideFocalLengthDisplayValue; // ivar: _backSuperWideFocalLengthDisplayValue
@property (readonly, nonatomic, getter=isBackSuperWideSupported) BOOL backSuperWideSupported; // ivar: _backSuperWideSupported
@property (readonly, nonatomic) NSInteger backTelephotoFocalLengthDisplayValue; // ivar: _backTelephotoFocalLengthDisplayValue
...
@property (readonly, nonatomic) NSInteger backWideFocalLengthDisplayValue; // ivar: _backWideFocalLengthDisplayValue
...
@property (readonly, nonatomic) BOOL cinematic4KSupported; // ivar: _cinematic4KSupported
...
@property (readonly, nonatomic) BOOL featureDevelopmentDefaultWideHighStabilization; // ivar: _featureDevelopmentDefaultWideHighStabilization
...
@property (readonly, nonatomic) CGFloat frontCameraInset; // ivar: _frontCameraInset
@property (readonly, nonatomic) NSInteger frontCameraMaximumEnhancedResolution; // ivar: _frontCameraMaximumEnhancedResolution
...
@property (readonly, nonatomic) BOOL frontEnhancedHEICResolutionSupported; // ivar: _frontEnhancedHEICResolutionSupported
...
@property (readonly, nonatomic, getter=isFrontQuadraWideSupported) BOOL frontQuadraWideSupported; // ivar: _frontQuadraWideSupported
...
@property (readonly, nonatomic) CGFloat librarySelectionAutoOnResetTimeout; // ivar: _librarySelectionAutoOnResetTimeout
@property (readonly, nonatomic) BOOL librarySelectionMockAutomationModeEnabled; // ivar: _librarySelectionMockAutomationModeEnabled
@property (readonly, nonatomic) BOOL librarySelectionMockLocationShiftingEnabled; // ivar: _librarySelectionMockLocationShiftingEnabled
@property (readonly, nonatomic) CGFloat librarySelectionSameLocationResetTimeout; // ivar: _librarySelectionSameLocationResetTimeout
@property (readonly, nonatomic) BOOL librarySelectionSupported; // ivar: _librarySelectionSupported
@property (readonly, nonatomic) CGFloat librarySelectionTripResetTimeout; // ivar: _librarySelectionTripResetTimeout
@property (readonly, nonatomic) CGFloat librarySelectionUserChoiceResetTimeout; // ivar: _librarySelectionUserChoiceResetTimeout
...
@property (readonly, nonatomic) NSString *peopleProximityDetectAdditionalEmail; // ivar: _peopleProximityDetectAdditionalEmail
@property (readonly, nonatomic) BOOL peopleProximityDetectionSupported; // ivar: _peopleProximityDetectionSupported
@property (readonly, nonatomic) BOOL peopleProximityIgnoreNearbyRequirements; // ivar: _peopleProximityIgnoreNearbyRequirements
@property (readonly, nonatomic) CGFloat peopleProximityInitialScanDuration; // ivar: _peopleProximityInitialScanDuration
@property (readonly, nonatomic) NSUInteger peopleProximityInitialScanRate; // ivar: _peopleProximityInitialScanRate
@property (readonly, nonatomic) BOOL peopleProximityPersistenceSupported; // ivar: _peopleProximityPersistenceSupported
@property (readonly, nonatomic) BOOL peopleProximityScanIndefinitely; // ivar: _peopleProximityScanIndefinitely
@property (readonly, nonatomic) CGFloat peopleProximityScanWaitInterval; // ivar: _peopleProximityScanWaitInterval
@property (readonly, nonatomic) CGFloat peopleProximitySubsequentScanDuration; // ivar: _peopleProximitySubsequentScanDuration
@property (readonly, nonatomic) NSUInteger peopleProximitySubsequentScanRate; // ivar: _peopleProximitySubsequentScanRate
@property (readonly, nonatomic) BOOL peopleProximityUsesDeviceDiscovery; // ivar: _peopleProximityUsesDeviceDiscovery
...
@property (readonly, nonatomic) CGFloat quadraWideDisplayZoomFactor; // ivar: _quadraWideDisplayZoomFactor
@property (readonly, nonatomic) CGFloat quadraWideRelativeZoomFactor; // ivar: _quadraWideRelativeZoomFactor
...
@property (readonly, nonatomic) BOOL useFullResolutionThumbnailForRAWCaptures; // ivar: _useFullResolutionThumbnailForRAWCaptures
...
@property (readonly, nonatomic, getter=isVideoStabilizationControlSupported) BOOL videoStabilizationControlSupported; // ivar: _videoStabilizationControlSupported
...
@property (readonly, nonatomic) CGFloat zoomPinchExponentialFactor; // ivar: _zoomPinchExponentialFactor
@property (readonly, nonatomic) CGFloat zoomPinchExponentialFactorDistance; // ivar: _zoomPinchExponentialFactorDistance
@property (readonly, nonatomic) CGFloat zoomPinchHybridLerpDistance; // ivar: _zoomPinchHybridLerpDistance
@property (readonly, nonatomic) NSUInteger zoomPinchScalingMethod; // ivar: _zoomPinchScalingMethod
...
-(BOOL)_shouldAllowCameraToggleForMode:(NSInteger)arg0 devicePosition:(NSInteger)arg1 videoConfiguration:(NSInteger)arg2 videoStabilizationStrength:(NSInteger)arg3 ;
...
-(BOOL)isDualDeviceDisparitySupportedForMode:(NSInteger)arg0 devicePosition:(NSInteger)arg1 ;
...
-(BOOL)isLowLightSupportedForMode:(NSInteger)arg0 device:(NSInteger)arg1 zoomFactor:(CGFloat)arg2 ;
...
-(BOOL)isPhotoResolutionSupported:(NSInteger)arg0 forMode:(NSInteger)arg1 device:(NSInteger)arg2 photoEncoding:(NSInteger)arg3 ;
...
-(BOOL)isQuadraWideBinningReconfigurationSupportedForMode:(NSInteger)arg0 devicePosition:(NSInteger)arg1 ;
-(BOOL)isQuadraWideZoomButtonSupportedForMode:(NSInteger)arg0 devicePosition:(NSInteger)arg1 ;
...
-(BOOL)isStillDuringVideoSupportedForMode:(NSInteger)arg0 ;
-(BOOL)isStillDuringVideoSupportedForVideoEncodingBehavior:(NSInteger)arg0 ;
-(BOOL)isSuperWideAutoMacroSupportedForMode:(NSInteger)arg0 device:(NSInteger)arg1 videoConfiguration:(NSInteger)arg2 videoStabilizationStrength:(NSInteger)arg3 ;
...
-(BOOL)isVideoStabilizationControlSupportedForMode:(NSInteger)arg0 devicePosition:(NSInteger)arg1 ;
-(BOOL)isVideoStabilizationStrength:(NSInteger)arg0 supportedForMode:(NSInteger)arg1 device:(NSInteger)arg2 videoConfiguration:(NSInteger)arg3 videoEncodingBehavior:(NSInteger)arg4 ;
-(BOOL)isVideoStabilizationStrength:(NSInteger)arg0 supportedForMode:(NSInteger)arg1 devicePosition:(NSInteger)arg2 ;
...
-(BOOL)isZoomAllowedForMode:(NSInteger)arg0 device:(NSInteger)arg1 videoConfiguration:(NSInteger)arg2 videoStabilizationStrength:(NSInteger)arg3 ;
-(BOOL)isZoomPlatterSupportedForMode:(NSInteger)arg0 devicePosition:(NSInteger)arg1 ;
-(BOOL)mirroredFrontCapturesSupportedForMode:(NSInteger)arg0 ;
-(BOOL)needsForcedSingleCameraEmulationForVideoStabilizationStrength:(NSInteger)arg0 videoConfiguration:(NSInteger)arg1 ;
...
-(BOOL)shouldAllowCameraToggleForMode:(NSInteger)arg0 devicePosition:(NSInteger)arg1 videoConfiguration:(NSInteger)arg2 videoStabilizationStrength:(NSInteger)arg3 ;
-(BOOL)shouldSuspendVideoHDRForHDRMode:(NSInteger)arg0 captureMode:(NSInteger)arg1 ;
-(CGFloat)_defaultZoomFactorForMode:(NSInteger)arg0 device:(NSInteger)arg1 videoConfiguration:(NSInteger)arg2 captureOrientation:(NSInteger)arg3 videoStabilizationStrength:(NSInteger)arg4 videoEncodingBehavior:(NSInteger)arg5 overrodeWithForcedZoomValue:(*BOOL)arg6 ;
-(CGFloat)_doubleForKey:(id)arg0 applicationID:(id)arg1 ;
-(CGFloat)captureIntervalForDevice:(NSInteger)arg0 ;
-(CGFloat)defaultDepthEffectApertureForMode:(NSInteger)arg0 device:(NSInteger)arg1 zoomFactor:(CGFloat)arg2 ;
-(CGFloat)defaultZoomFactorForGraphConfiguration:(id)arg0 captureOrientation:(NSInteger)arg1 overrodeWithForcedZoomValue:(*BOOL)arg2 ;
...
-(CGFloat)maximumZoomFactorForMode:(NSInteger)arg0 device:(NSInteger)arg1 videoConfiguration:(NSInteger)arg2 videoStabilizationStrength:(NSInteger)arg3 ;
-(CGFloat)maximumZoomFactorForMode:(NSInteger)arg0 device:(NSInteger)arg1 videoConfiguration:(NSInteger)arg2 videoStabilizationStrength:(NSInteger)arg3 shouldResolveDevice:(BOOL)arg4 ;
...
-(NSInteger)_forcedBackDeviceForMode:(NSInteger)arg0 videoConfiguration:(NSInteger)arg1 ;
-(NSInteger)_knownFramerateForVideoConfiguration:(NSInteger)arg0 ;
-(NSInteger)defaultMaximumEnhancedPhotoResolutionForEncodingBehavior:(NSInteger)arg0 ;
-(NSInteger)preferredDeviceForPosition:(NSInteger)arg0 mode:(NSInteger)arg1 videoConfiguration:(NSInteger)arg2 videoStabilizationStrength:(NSInteger)arg3 ;
-(NSInteger)resolvedDeviceForDesiredDevice:(NSInteger)arg0 mode:(NSInteger)arg1 videoConfiguration:(NSInteger)arg2 videoStabilizationStrength:(NSInteger)arg3 ;
...
-(NSUInteger)lowLightPreviewOverlayStyleForDevicePosition:(NSInteger)arg0 sensitiveToChangingDisplayFeedback:(BOOL)arg1 sensitiveToInitialFeedback:(BOOL)arg2 duration:(CGFloat)arg3 ;
-(NSUInteger)semanticStyleSupportForMode:(NSInteger)arg0 ;
-(id)initWithHostProcess:(NSInteger)arg0 ;
-(id)significantZoomFactorsForMode:(NSInteger)arg0 device:(NSInteger)arg1 ;
