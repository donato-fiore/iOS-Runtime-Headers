...
@property (readonly, nonatomic) UIView *_focalLengthLabelContainerView; // ivar: __focalLengthLabelContainerView
...
@property (nonatomic) BOOL hideFocalLengthLabels; // ivar: _hideFocalLengthLabels
...
@property (retain, nonatomic) NSArray *zoomPoints; // ivar: _zoomPoints
...
+(id)_createMaskImageWithSize:(struct CGSize )arg0 tickLabelCenterRadialInset:(CGFloat)arg1 notchMaskImage:(id)arg2 ;
