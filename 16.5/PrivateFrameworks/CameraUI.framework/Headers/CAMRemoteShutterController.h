...
@property (nonatomic) BOOL sharedLibrarySupported; // ivar: _sharedLibrarySupported
...
-(NSInteger)cameraConnectionSharedLibraryMode:(id)arg0 ;
-(NSInteger)cameraConnectionSharedLibrarySupport:(id)arg0 ;
