...
-(id)initWithAssetUUID:(id)arg0 captureSession:(unsigned short)arg1 creationDate:(id)arg2 captureOrientation:(NSInteger)arg3 captureDevice:(NSInteger)arg4 videoDimensions:(struct CGSize )arg5 duration:(CGFloat)arg6 previewImageSurface:(*void)arg7 localPrivateMetadataFileURL:(id)arg8 ;
-(void)dealloc;
