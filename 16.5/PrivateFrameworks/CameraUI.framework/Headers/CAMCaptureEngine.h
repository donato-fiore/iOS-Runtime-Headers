...
-(id)_TTRKeywordIDsFromCaptureRequest:(id)arg0 ;
...
-(id)_validateVideoAtURL:(id)arg0 forCaptureRequest:(id)arg1 captureID:(NSInteger)arg2 captureError:(id)arg3 isVideoComplement:(BOOL)arg4 stillImageDisplayTime:(struct ? )arg5 reportedDuration:(struct ? )arg6 outActualDuration:(struct ? *)arg7 outVideoRecordingStoppedReason:(*NSInteger)arg8 ;
...
-(void)captureOutput:(id)arg0 readyForResponsiveRequestAfterResolvedSettings:(id)arg1 ;
