...
-(id)initWithEntityName:(id)arg0 predicate:(id)arg1 sortDescriptors:(id)arg2 limit:(NSInteger)arg3 ;
-(id)initWithEntityName:(id)arg0 predicate:(id)arg1 sortDescriptors:(id)arg2 limit:(NSInteger)arg3 batchSize:(NSInteger)arg4 propertiesToFetch:(id)arg5 ;
-(id)initWithEntityName:(id)arg0 predicate:(id)arg1 sortDescriptors:(id)arg2 limit:(NSInteger)arg3 batchSize:(NSInteger)arg4 propertiesToFetch:(id)arg5 managedObjectContext:(id)arg6 ;
-(id)initWithEntityName:(id)arg0 predicate:(id)arg1 sortDescriptors:(id)arg2 limit:(NSInteger)arg3 returnObjectsAsFaults:(BOOL)arg4 ;
