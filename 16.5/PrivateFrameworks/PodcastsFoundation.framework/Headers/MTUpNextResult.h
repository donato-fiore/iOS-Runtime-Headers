...
#import "MTUpNextScorePrototype.h"
...
@property (nonatomic) CGFloat modifiedDateScore; // ivar: _modifiedDateScore
@property (nonatomic) BOOL needsUpdate; // ivar: _needsUpdate
@property (retain, nonatomic) MTUpNextScorePrototype *upNextScore; // ivar: _upNextScore
