...
@property (copy, nonatomic) NSString *clearAllText; // ivar: _clearAllText
...
+(id)dismissControlWithMaterialRecipe:(NSInteger)arg0 clearAllText:(id)arg1 ;
+(id)showLessControlWithMaterialRecipe:(NSInteger)arg0 clearAllText:(id)arg1 ;
...
-(void)layoutSubviews;
-(void)setVisualStyle:(NSInteger)arg0 ;
