...
@class UIView, UILabel, UIView<NCTextSupporting>, UIButton, UILabel<BSUIDateLabel>, BSUIEmojiLabelView, UIImageView, MTVisualStylingProvider, NSDate, NSString, BSUIFontProvider, NSAttributedString, UIImageConfiguration, UIAction, UIImage, NSArray, NSTimeZone;
...
@property (copy, nonatomic) UIAction *inlineAction; // ivar: _inlineAction
...
@property (nonatomic, getter=areTextMenusEnabled) BOOL textMenusEnabled; // ivar: _textMenusEnabled
