...
@property (weak, nonatomic) NCNotificationListView *revealListView; // ivar: _revealListView
...
-(id)initWithParentListView:(id)arg0 interactiveListView:(id)arg1 revealListView:(id)arg2 ;
