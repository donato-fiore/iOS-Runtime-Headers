...
@class UIViewController, NSHashTable, UIView<PLContentSizeManaging>, UIView<PLPlatter><NCNotificationStaticContentAccepting><PLContentSizeCategoryAdjusting><NCNotificationListDimmable>, UIView, UIPanGestureRecognizer, UIViewController<NCNotificationCustomContent>, NSString, UIColor, NCNotificationRequest;
