...
@class UIView, UIImageView, NSMutableDictionary, NSStringDrawingContext, MTVisualStylingProvider, NSDate, NSString, BSUIFontProvider, NSAttributedString, UIImageConfiguration, UIAction, UILabel, UIImage, NSArray, UITextView, BSUIEmojiLabelView, NSTimeZone;
...
@property (nonatomic) NSUInteger secondaryTextMaximumNumberOfLines;
