...
@class DNDModeConfiguration, NSDate, NSString, NSMutableSet, NSMutableDictionary, NSArray, NSMutableArray, UILabel, NSDictionary;
...
#import "NCNotificationListCountIndicatorView.h"
...
#import "NCNotificationListInteractiveTransitionCoordinator.h"
...
@property (copy, nonatomic) DNDModeConfiguration *activeDNDModeConfiguration; // ivar: _activeDNDModeConfiguration
@property (nonatomic) BOOL adjustsFontForContentSizeCategory; // ivar: _adjustsFontForContentSizeCategory
@property (nonatomic, getter=isCollapsibleNotificationListSupported) BOOL collapsibleNotificationListSupported; // ivar: _collapsibleNotificationListSupported
@property (readonly, copy, nonatomic) NSDate *comparisonDate;
@property (readonly, nonatomic) NSUInteger count;
@property (retain, nonatomic) NCNotificationListCountIndicatorView *countIndicatorView; // ivar: _countIndicatorView
...
@property (nonatomic) BOOL expandsVisibleRegionOnSignificantScroll; // ivar: _expandsVisibleRegionOnSignificantScroll
...
@property (nonatomic) BOOL hideNotificationCountIndicator; // ivar: _hideNotificationCountIndicator
...
@property (retain, nonatomic) NCNotificationListInteractiveTransitionCoordinator *interactiveTransitionCoordinator; // ivar: _interactiveTransitionCoordinator
@property (nonatomic, getter=isListDisplayStyleHiddenForUserInteraction) BOOL listDisplayStyleHiddenForUserInteraction; // ivar: _listDisplayStyleHiddenForUserInteraction
...
@property (retain, nonatomic) NSMutableDictionary *notificationListDisplayStyleSettingsForReason; // ivar: _notificationListDisplayStyleSettingsForReason
...
@property (retain, nonatomic) NCNotificationListCache *notificationSummaryCache; // ivar: _notificationSummaryCache
@property (nonatomic, getter=isOnboardingSummaryVisible) BOOL onboardingSummaryVisible; // ivar: _onboardingSummaryVisible
@property (nonatomic, getter=isOverlayFooterContentVisible) BOOL overlayFooterContentVisible; // ivar: _overlayFooterContentVisible
@property (retain, nonatomic) UILabel *overrideMigrationOverlayLabel; // ivar: _overrideMigrationOverlayLabel
@property (nonatomic) BOOL overrideMigrationToHistory; // ivar: _overrideMigrationToHistory
@property (nonatomic, getter=isPerformingClearAll) BOOL performingClearAll; // ivar: _performingClearAll
@property (nonatomic, getter=isPerformingExclusiveScrollInteractiveTranslation) BOOL performingExclusiveScrollInteractiveTranslation; // ivar: _performingExclusiveScrollInteractiveTranslation
...
@property (retain, nonatomic) NCNotificationStructuredSectionList *prominentIncomingSectionList; // ivar: _prominentIncomingSectionList
...
@property (retain, nonatomic) NCNotificationListCache *supplementaryCache; // ivar: _supplementaryCache
@property (retain, nonatomic) NSMutableArray *supplementaryViewsSections; // ivar: _supplementaryViewsSections
...
+(id)presentableTypes;
-(BOOL)_isAlertingNotificationRequest:(id)arg0 ;
...
-(BOOL)_isProminentNotificationRequest:(id)arg0 ;
-(BOOL)_shouldInsertCurrentDigestIntoMissedSectionList;
-(BOOL)_shouldInsertNotificationRequestToProminentIncomingSectionList:(id)arg0 ;
-(BOOL)adjustForContentSizeCategoryChange;
-(BOOL)containsNotificationRequest:(id)arg0 ;
-(BOOL)handleTapOnNotificationListBaseComponent:(id)arg0 ;
-(BOOL)notificationListInteractiveTransitionCoordinatorRequestsIsCurrentDigestVisible:(id)arg0 ;
-(BOOL)notificationListInteractiveTransitionCoordinatorRequestsIsHiddenListRevealed:(id)arg0 ;
-(BOOL)notificationListInteractiveTransitionCoordinatorRequestsIsScrollingListContent:(id)arg0 ;
-(BOOL)notificationListRevealCoordinatorShouldAllowReveal:(id)arg0 ;
-(BOOL)notificationListRevealCoordinatorShouldAllowRevealTransition:(id)arg0 ;
-(BOOL)notificationStructuredSectionList:(id)arg0 areNotificationsLoadedForSectionIdentifier:(id)arg1 ;
...
-(BOOL)shouldScrollToTopForNotificationListBaseComponent:(id)arg0 ;
...
-(NSUInteger)notificationListInteractiveTransitionCoordinator:(id)arg0 requestsCountForInteractiveListView:(id)arg1 ;
-(NSUInteger)notificationListInteractiveTransitionCoordinator:(id)arg0 requestsIndexForInteractiveListView:(id)arg1 ;
...
-(id)_newSummaryOrderProviderOfType:(NSUInteger)arg0 summaryHeading:(id)arg1 summaryDate:(id)arg2 atxDigestDeliveryTime:(NSInteger)arg3 isOnboardingSummary:(BOOL)arg4 ;
...
-(id)overlayFooterViewForNotificationList:(id)arg0 ;
...
-(void)_clearAllNotifications:(BOOL)arg0 supplementaryViewControllers:(BOOL)arg1 ;
-(void)_clearCountIndicatorViewAnimated:(BOOL)arg0 ;
-(void)_configureCurrentDigestSectionListWithDigestInfo:(id)arg0 sectionType:(NSUInteger)arg1 summaryOrderProviderType:(NSUInteger)arg2 ;
-(void)_configureInteractiveTransitionCoordinatorIfNecessary;
-(void)_configureNotificationSectionList:(id)arg0 notificationCache:(id)arg1 notificationListViewRevealed:(BOOL)arg2 logDescription:(id)arg3 ;
...
-(void)_migrateOnScheduleNotificationRequests:(id)arg0 fromSection:(id)arg1 toSection:(id)arg2 clearRequests:(BOOL)arg3 filterForDestination:(BOOL)arg4 animateRemoval:(BOOL)arg5 ;
-(void)_migrateOnScheduleNotificationRequestsFromIncomingSectionToHistorySection:(id)arg0 ;
-(void)_migrateOnScheduleNotificationRequestsFromProminentIncomingSectionToIncomingSection:(id)arg0 ;
...
-(void)_updateNotificationCountIndicatorViewAnimated:(BOOL)arg0 ;
-(void)_updateNotificationListDisplayStyleSetting;
-(void)_updateNotificationListPersistentState;
-(void)_updateOverrideMigrationOverlayLabelWithText:(id)arg0 forOverrideState:(BOOL)arg1 ;
-(void)_updateSystemSettingsForUpdatedNotificationListDisplayStyleSetting:(NSUInteger)arg0 ;
...
-(void)notificationListBaseComponent:(id)arg0 requestsScrollingToContentOffset:(CGFloat)arg1 withCompletion:(id)arg2 ;
...
-(void)notificationListCountIndicatorViewLongPressed:(id)arg0 presentingView:(id)arg1 ;
-(void)notificationListCountIndicatorViewTapped:(id)arg0 ;
-(void)notificationListInteractiveTransitionCoordinator:(id)arg0 didUpdateListDisplaySetting:(NSUInteger)arg1 isPersistentSetting:(BOOL)arg2 hideRevealedList:(BOOL)arg3 ;
-(void)notificationListInteractiveTransitionCoordinatorRequestsMigratingProminentNotificationsForHiddenSetting:(id)arg0 ;
...
-(void)notificationStructuredSectionList:(id)arg0 transitionedGroupedStateIsGrouped:(BOOL)arg1 ;
-(void)notificationStructuredSectionListDidClearAllNotificationRequests:(id)arg0 ;
-(void)notificationStructuredSectionListRequestsClearingSection:(id)arg0 ;
