...
@class UIView, PLSwipeInteraction, UIViewController<NCNotificationListDimmable>, NSString, UIColor;
@protocol PLSwipeInteractionDelegate, NCMaterialDisplaying, NCNotificationListDimmable, NCNotificationListCellActionHandling, NCNotificationListCellActionProviding;
