...
@class UIView, UIButton, SBUILegibilityLabel, _UILegibilitySettings, BSUIFontProvider, NSDate, NSString;
...
@property (nonatomic) BOOL shouldAllowLongPressInteraction; // ivar: _shouldAllowLongPressInteraction
...
-(id)_attributedStringWithText:(id)arg0 symbolName:(id)arg1 withFont:(id)arg2 ;
-(id)_fontProvider;
-(id)_newLegibilityLabelWithTitle:(id)arg0 symbolName:(id)arg1 withFont:(id)arg2 ;
-(id)_titleLabelFont;
...
-(void)_scaleTitleAndSymbolShouldScale:(BOOL)arg0 ;
-(void)_titleButtonTapped:(id)arg0 ;
-(void)_titleButtonTouchDown:(id)arg0 ;
-(void)_titleButtonTouchEnded:(id)arg0 ;
-(void)_updateHighlightingForTitleButton:(id)arg0 ;
-(void)_updateLongPressStateIsActiveTouch:(BOOL)arg0 ;
