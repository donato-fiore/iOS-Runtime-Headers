...
@property (nonatomic) BOOL usingService; // ivar: _usingService
...
-(id)_providerForResource:(SEL)arg0 forScope:(id)arg1 queue:(id)arg2 renderWithCompletionHandler:(id)arg3 ;
-(id)_providerForResourceForScope:(SEL)arg0 queue:(id)arg1 renderWithCompletionHandler:(id)arg2 ;
-(id)_scheduledRemoteImageRendererProviderForStickerConfiguration:(SEL)arg0 correctClipping:(id)arg1 ;
// -(id)_scheduledTaskForItem:(SEL)arg0 scope:(id)arg1 queue:(id)arg2 renderWithCompletionHandler:(id)arg3 resourceHandler:(id)arg4 synchronous:(unk)arg5  ;
...
-(id)scheduledStickerResourceProviderForStickerConfiguration:(SEL)arg0 usingService:(id)arg1 ;
