...
+(id)allowListAppNameFromBundleID:(id)arg0 ;
...
-(void)didSelectStickerFromStickersApp:(id)arg0 withAvatar:(id)arg1 ;
-(void)didSelectStickerFromStickersApp:(id)arg0 withAvatar:(id)arg1 bundleIdentifier:(id)arg2 ;
...
-(void)sentStickerFromStickersApp:(id)arg0 withAvatarRecord:(id)arg1 action:(id)arg2 appName:(id)arg3 ;
