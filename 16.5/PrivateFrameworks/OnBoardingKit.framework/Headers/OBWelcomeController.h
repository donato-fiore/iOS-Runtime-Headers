...
@property (nonatomic) BOOL disableButtonsUntilAllContentWasVisable; // ivar: _disableButtonsUntilAllContentWasVisable
...
-(void)_commonInitWithContentLayout:(NSInteger)arg0 ;
-(void)_enableTrayButtonsForScrollToBottom:(id)arg0 ;
