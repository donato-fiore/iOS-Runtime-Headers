...
@class NSString;
@protocol ICQCommerceRemoteUIDelegateDelegate, ICQUICloudStorageOffersManagerDelegate;
...
@property (weak, nonatomic) NSObject<ICQUICloudStorageOffersManagerDelegate> *delegate; // ivar: _delegate
