...
@property (readonly, copy, nonatomic) NSString *bannerMessageOnMac; // ivar: _bannerMessageOnMac
...
@property (readonly, copy, nonatomic) NSString *doneButtonTitle; // ivar: _doneButtonTitle
...
@property (readonly, copy, nonatomic) NSString *porcupinePausedTitle; // ivar: _porcupinePausedTitle
...
-(void)pausePrivateRelayUntilTomorrow:(id)arg0 ;
