...
@class ICQOffer, NSURLSession, NSDictionary, RUIElement, NSTimer, NSString, RUIObjectModel, RUIServerHookResponse;
@protocol ICQUICloudStorageOffersManagerDelegate, ICQPurchaseDelegate, ICQUIServerHook, ICQServerHookDelegate, RUIServerHookDelegate;
