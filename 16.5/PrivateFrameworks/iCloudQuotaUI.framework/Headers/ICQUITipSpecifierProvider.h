...
@protocol DelayedPushDelegate, ICQUIRemoteUIPresenterDelegate, ICQUpgradeFlowManagerDelegate, RUITableViewRowDelegate, ICQLiftUIPresenterDelegate, AAUISpecifierProvider, AMSUIMessageViewControllerDelegate, AAUISpecifierProviderDelegate;
...
-(id)tipForManageStorageFromAttributes:(id)arg0 rows:(id)arg1 viewController:(id)arg2 remoteUIDelegate:(id)arg3 ;
...
-(void)_launchUpgradeFlowWithAction:(id)arg0 andURL:(id)arg1 ;
...
-(void)liftUIPresenter:(id)arg0 performAction:(NSInteger)arg1 parameters:(id)arg2 ;
