...
@protocol BYClientDaemonCloudSyncProtocol, MBManagerDelegate, AAUISpecifierProviderDelegate, OS_dispatch_queue, AAUISpecifierProvider;
...
-(void)_persistBackupEnablementState:(BOOL)arg0 passcode:(id)arg1 ;
