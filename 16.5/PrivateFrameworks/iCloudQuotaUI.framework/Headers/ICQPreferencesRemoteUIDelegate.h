...
@class UINavigationController, NSMutableArray, RUILoader, NSOperationQueue, NSString, ACAccount, NSArray;
@protocol ICQUICloudStorageOffersManagerDelegate, ICQUpgradeFlowManagerDelegate, PreferencesRemoteUIDelegateProtocol, RUIObjectModelDelegate, RUILoaderDelegate, DelayedPushDelegate;
...
@interface ICQPreferencesRemoteUIDelegate : NSObject <ICQUICloudStorageOffersManagerDelegate, ICQUpgradeFlowManagerDelegate, PreferencesRemoteUIDelegateProtocol, RUIObjectModelDelegate, RUILoaderDelegate>

 {
    ...
    ACAccount *_account;
    icq_signpost_s _signpost;
    NSInteger _icqAction;
    ICQUILegacyPurchaseFlowManager *_legacyPurchaseFlowManager;
}


@property (retain, nonatomic) NSArray *dataclassSubstitutions; // ivar: _dataclassSubstitutions
...
@property (nonatomic) BOOL isManageStorage; // ivar: _isManageStorage
@property (retain) RUILoader *lastDocumentDeleteLoader; // ivar: _lastDocumentDeleteLoader
@property (retain, nonatomic) ICQUIPreferencesLiftUIDelegate *liftUIDelegate; // ivar: _liftUIDelegate
@property (retain, nonatomic) NSString *nextSignpostId; // ivar: _nextSignpostId
...
-(void)_freshmintStorageUpgradeWithICQLink:(id)arg0 completion:(id)arg1 ;
