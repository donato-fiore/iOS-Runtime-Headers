...
#import "SUSUISoftwareUpdateBetaUpdatesController.h"
...
-(void)didDismissComingSoonTip:(id)arg0 ;
...
-(void)setBetaProgramFromUI:(id)arg0 forSpecifier:(id)arg1 ;
...
-(void)softwareUpdatePane:(id)arg0 reloadSpecifiers:(id)arg1 animated:(BOOL)arg2 ;
-(void)softwareUpdatePane:(id)arg0 reloadUsingNewSpecifiers:(id)arg1 ;
...
-(void)unenrollFromBetaProgramsWithCompletion:(id)arg0 ;
-(void)updateState;
