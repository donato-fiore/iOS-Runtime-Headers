...
@class NSString, MPPlaybackEQSetting, MPAVRoutingController;
@protocol MPAVRoutingControllerDelegate, MPCPlaybackEngineEventObserving, MFPlaybackStackController><MFQueueManagement, OS_dispatch_source;
...
@property (readonly, nonatomic) MPCAudioAssetTypeSelector *audioAssetTypeSelector; // ivar: _audioAssetTypeSelector
...
@property (retain, nonatomic) MPPlaybackEQSetting *eqSetting; // ivar: _eqSetting
...
-(void)_setupPlayer;
-(void)_setupQueueItemForLossyAudioPlayback:(id)arg0 ;
