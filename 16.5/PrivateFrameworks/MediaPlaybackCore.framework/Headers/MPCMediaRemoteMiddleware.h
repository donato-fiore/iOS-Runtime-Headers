...
@protocol MPCResponseMediaRemoteControllerChaining, MPCPlayerResponseBuilder, MPMiddleware, MPCSupportedCommands;
...
-(BOOL)playerVocalsControlActive:(BOOL)arg0 chain:(id)arg1 ;
-(BOOL)playerVocalsControlContinuous:(BOOL)arg0 chain:(id)arg1 ;
...
-(NSInteger)playerCommandDisabledReason:(NSInteger)arg0 command:(unsigned int)arg1 chain:(id)arg2 ;
...
-(float)playerMaxVocalsLevel:(float)arg0 chain:(id)arg1 ;
-(float)playerMinVocalsLevel:(float)arg0 chain:(id)arg1 ;
-(float)playerVocalsLevel:(float)arg0 chain:(id)arg1 ;
-(id)_stateDumpObject;
