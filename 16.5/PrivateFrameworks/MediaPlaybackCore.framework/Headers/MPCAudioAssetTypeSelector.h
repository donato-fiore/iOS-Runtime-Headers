...
@class MPPlaybackUserDefaults, ICEnvironmentMonitor, MSVABTestGenerator, MSVTrialExperiment;
...
@property (retain, nonatomic) MSVTrialExperiment *trialExperiment; // ivar: _trialExperiment


-(BOOL)prefersSpatialOverStereo:(id)arg0 ;
-(BOOL)userPrefersMultichannelAudioOverStereo:(id)arg0 ;
-(NSInteger)nextAssetTypeOutcomeWithIsStartItem:(BOOL)arg0 ;
...
-(id)initWithPlaybackEngine:(id)arg0 userDefaults:(id)arg1 environmentMonitor:(id)arg2 ;
-(id)preferencesDescription;
-(id)preferredAudioAssetTypeForItem:(id)arg0 ;
-(id)preferredAudioAssetTypeForSongWithTrait:(NSUInteger)arg0 isStartItem:(BOOL)arg1 ;
-(id)preferredAudioAssetTypeForSongWithTrait:(NSUInteger)arg0 isStartItem:(BOOL)arg1 supportsVocalAttenuation:(BOOL)arg2 ;
-(id)preferredAudioFormatForAudioFormats:(id)arg0 route:(id)arg1 ;
-(id)preferredPlayerAudioFormatForItem:(id)arg0 route:(id)arg1 ;
-(void)handleExperimentDidReceiveUpdateNotification:(id)arg0 ;
