...
@class MPServerObjectDatabase, NSString, MPPropertySet, NSMutableArray, NSMutableOrderedSet, NSMutableDictionary, MPMutableSectionedCollection, ICURLAggregatedPerformanceMetrics, NSError, NSDictionary, MPSectionedCollection;
...
-(id)_serverObjectFromPlaceholderContentDescriptor:(id)arg0 propertySet:(id)arg1 error:(*id)arg2 ;
