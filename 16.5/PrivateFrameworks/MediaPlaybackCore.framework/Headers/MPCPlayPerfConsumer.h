...
+(id)analyticsContentType:(NSInteger)arg0 ;
+(id)analyticsFormat:(id)arg0 ;
+(id)coreAnalyticsEventNameWithEventType:(id)arg0 ;
+(id)identifier;
-(id)initWithPlaybackEngine:(id)arg0 ;
-(void)generatePlayPerfSignposts:(id)arg0 ;
-(void)handleMetrics:(id)arg0 ;
-(void)sendMetricsToCoreAnalytics:(id)arg0 ;
-(void)sendMetricsToSiriSelfLogger:(id)arg0 ;
