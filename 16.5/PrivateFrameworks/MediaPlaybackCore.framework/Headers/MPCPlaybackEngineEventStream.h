...
@class NSMutableArray, NSHashTable, NSCountedSet, MSVSQLDatabase, MSVSQLDatabaseTransaction, NSDate, NSString;
...
-(id)debugDescription;
-(id)eventDeliveryDeferralAssertionOfType:(NSInteger)arg0 forReason:(id)arg1 ;
-(id)eventDeliveryDeferralAssertionOfType:(NSInteger)arg0 forReason:(id)arg1 withTimeout:(CGFloat)arg2 ;
