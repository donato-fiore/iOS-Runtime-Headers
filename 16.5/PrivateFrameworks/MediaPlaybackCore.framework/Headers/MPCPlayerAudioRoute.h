...
@class NSString, NSDictionary, MPNowPlayingInfoAudioFormat, MPNowPlayingInfoAudioRoute;
...
@property (readonly, nonatomic) MPNowPlayingInfoAudioFormat *nowPlayingAudioFormat; // ivar: _nowPlayingAudioFormat
