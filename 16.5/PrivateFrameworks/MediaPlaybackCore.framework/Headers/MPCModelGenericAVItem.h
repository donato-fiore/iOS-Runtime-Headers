...
@class MPAVItem, ICMusicSubscriptionLeaseSession, MPSubscriptionStatusPlaybackInformation, NSArray, MPModelGenericObject, MPPropertySet, NSOperationQueue, NSString, ICStoreRequestContext, NSURL, ICContentKeySession, ICAVAssetDownloadURLSession, ICURLRequest, ICMusicSubscriptionLeaseStatus, NSDictionary, MPGaplessInfo, NSData, MPMediaLibrary, NSNumber;
...
@property (retain, nonatomic) MPCAudioAssetTypeSelector *audioAssetTypeSelector; // ivar: _audioAssetTypeSelector
...
@property (copy, nonatomic) NSString *previousQueueItemID; // ivar: _previousQueueItemID
...
-(BOOL)_isAssetLoadResultValidForPlayback:(id)arg0 error:(*id)arg1 ;
-(BOOL)_linkAssetIfNeededAtURL:(id)arg0 toDestinationURL:(id)arg1 shareCacheURL:(id)arg2 ;
...
-(NSInteger)reportingAdamID;
-(NSInteger)stationID;
-(NSInteger)stationProviderID;
-(NSInteger)storeAlbumArtistID;
...
-(float)userRating;
-(id)_assetLoadPropertiesWithUserIdentityProperties:(id)arg0 delegatedUserIdentityProperties:(id)arg1 subscriptionPlaybackInfo:(id)arg2 ;
-(id)_bookmarkTime;
-(id)_createOrUpdateDatabaseEntry:(id)arg0 loadResult:(id)arg1 urlBag:(id)arg2 destinationURL:(id)arg3 purgeable:(BOOL)arg4 ;
-(id)_decorateAssetLoadResult:(id)arg0 withURLBag:(id)arg1 ;
-(id)_delegatedUserIdentityProperties:(*id)arg0 ;
-(id)_hlsDownloadOptionsDictionary:(id)arg0 ;
...
-(void)_checkDownloadErrorAndValidityOfDownloadedHLSAsset:(id)arg0 downloadLocationURL:(id)arg1 completion:(id)arg2 ;
...
-(void)_downloadHLSAsset:(id)arg0 destinationURL:(id)arg1 sharedCacheURL:(id)arg2 assetLoadProperties:(id)arg3 loadResult:(id)arg4 storeRequestContext:(id)arg5 urlBag:(id)arg6 fileUpgradeRecommendation:(NSInteger)arg7 ;
-(void)_downloadHLSAssetWhilePlaying:(id)arg0 assetLoadProperties:(id)arg1 assetLoadResult:(id)arg2 destinationURL:(id)arg3 sharedCacheURL:(id)arg4 storeRequestContext:(id)arg5 urlBag:(id)arg6 fileUpgradeRecommendation:(NSInteger)arg7 ;
-(void)_emitAudioAssetTypeSelection:(id)arg0 ;
-(void)_emitAudioFormatChangeEvent;
-(void)_emitNetworkOperationWithPerformanceMetrics:(id)arg0 operationType:(NSInteger)arg1 reason:(id)arg2 blocksPlayback:(BOOL)arg3 ;
-(void)_getHLSServerDataForLoadResults:(id)arg0 bag:(id)arg1 keyCertificateURL:(*id)arg2 keyServerURL:(*id)arg3 keyServerAdamID:(*id)arg4 keyServerProtocolType:(*NSInteger)arg5 ;
...
-(void)_invalidateContentItemForTimedMetadataChangesChangingRevisionID:(BOOL)arg0 ;
-(void)_postInvalidationNotifications;
-(void)_prepareAssetForHLSPlayback:(id)arg0 loadResult:(id)arg1 destinationURL:(id)arg2 storeRequestContext:(id)arg3 urlBag:(id)arg4 identityProperties:(id)arg5 ;
-(void)_prepareLeaseWithShouldRequireLeaseAcquisition:(BOOL)arg0 completionHandler:(id)arg1 ;
