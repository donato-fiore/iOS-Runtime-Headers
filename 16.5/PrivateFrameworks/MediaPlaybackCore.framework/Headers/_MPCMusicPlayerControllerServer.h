...
@class MPMusicPlayerQueueDescriptor, NSUUID, NSMutableArray, NSString, NSXPCListenerEndpoint, NSXPCListener, MPMusicPlayerControllerSystemCache;
@protocol MPMusicPlayerControllerSystemServer, MPMusicPlayerControllerApplicationServer, NSXPCListenerDelegate, _MPCPlaybackEngineEventObserving;
...
-(void)_appendPlaybackContexts:(id)arg0 completion:(id)arg1 ;
-(void)_applyServerStateUpdateRecord:(id)arg0 ;
-(void)_handleCommandHandlersRegistered:(id)arg0 ;
-(void)_prependPlaybackContexts:(id)arg0 completion:(id)arg1 ;
...
-(void)setDisableRepeat:(BOOL)arg0 ;
-(void)setDisableShuffle:(BOOL)arg0 ;
