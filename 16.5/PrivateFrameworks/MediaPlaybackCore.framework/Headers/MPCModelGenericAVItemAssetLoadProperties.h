...
@property (retain, nonatomic) MPCAudioAssetTypeSelection *audioAssetTypeSelection; // ivar: _audioAssetTypeSelection
...
@property (nonatomic) BOOL supportsVocalAttenuation; // ivar: _supportsVocalAttenuation
