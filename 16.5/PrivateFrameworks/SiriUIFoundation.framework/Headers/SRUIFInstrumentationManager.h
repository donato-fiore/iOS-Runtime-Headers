...
@property (nonatomic) BOOL hasNotYetEmittedLaunchContextEnd; // ivar: _hasNotYetEmittedLaunchContextEnd
...
-(id)init;
-(id)latestStoredTurn;
-(void)_barrierWithCompletion:(id)arg0 ;
-(void)_emitInstrumentation:(id)arg0 forTurn:(id)arg1 atTime:(NSUInteger)arg2 ;
-(void)_populateDefaultHardwareInformationWithRouteInfo:(id)arg0 forTTSEvent:(id)arg1 ;
-(void)_populateWirelessHardwareInformationWithRouteInfo:(id)arg0 forTTSEvent:(id)arg1 ;
-(void)_prepareForTesting;
-(void)_willInstrument:(id)arg0 forTurn:(id)arg1 ;
// -(void)boostQueuedMessagesAndPerformOnQueueCompletion:(id)arg0 timeout:(unk)arg1  ;
...
-(void)emitUIStateTransitionEventWithFromState:(int)arg0 toState:(int)arg1 withPresentationType:(int)arg2 machAbsoluteTransitionTime:(CGFloat)arg3 ;
-(void)emitUIStateTransitionForSiriDismissalWithReason:(int)arg0 ;
-(void)emitUUFRCasinoCardSelectedEventWithCardSectionID:(id)arg0 ordinalCardSectionPosition:(NSInteger)arg1 snippetAceId:(id)arg2 ;
...
-(void)emitUUFRSpokenForAceObject:(id)arg0 presentationType:(int)arg1 dialogPhase:(id)arg2 mode:(int)arg3 speakableText:(id)arg4 ;
