...
@class UIViewController, PXLivePhotoTrimScrubber, PXSlowMotionEditor, NSLayoutConstraint, PXLivePhotoTrimScrubberSpec, UIVisualEffectView, PICompositionController, AVPlayerItem, NSString, UIView, UILabel, PLEditSource, NSArray, PXFocusTimelineAction, PXFocusTimelineView, UIImage, UIButton, PLPhotoEditRenderer, NSNumber, PXLivePhotoTrimScrubberSnapStripController;
...
@interface PUTrimToolController : UIViewController <PXTrimToolPlayerObserver, PXLivePhotoTrimScrubberDelegate, UIPopoverPresentationControllerDelegate, PULivePhotoKeyFrameSelectionViewControllerDelegate, PXSlowMotionEditorDelegate, PXFocusTimelineViewDelegate, PXFocusTimelineController>

 {
    ...
    NSInteger _currentlyInteractingElement;
}
...
-(id)axDescriptionForFocusEventATime:(struct ? )arg0 ;
...
-(void)_didCompleteInteractiveEditForElement:(NSInteger)arg0 atTime:(struct ? )arg1 state:(NSUInteger)arg2 ;
...
-(void)trimScrubberPausePlayer:(id)arg0 ;
