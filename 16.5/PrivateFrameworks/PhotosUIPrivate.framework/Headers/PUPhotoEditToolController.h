...
@class UIViewController, CEKEdgeGradientView, NSString, UIView, PICompositionController, NSArray, PLEditSource, NURenderPipelineFilter, NSMutableArray, UIButton, UIColor, UIImage, PFSlowMotionTimeRangeMapper, NUComposition, PEValuesCalculator;
...
@property (nonatomic) BOOL hasMediaScrubber; // ivar: _hasMediaScrubber
...
@property (retain, nonatomic) NUComposition *storedComposition; // ivar: _storedComposition
@property (nonatomic) NSInteger storedCompositionCount; // ivar: _storedCompositionCount
...
@property (readonly, nonatomic) PEValuesCalculator *valuesCalculator; // ivar: _valuesCalculator
...
-(void)_registerActionWithSourceComposition:(id)arg0 localizedName:(id)arg1 ;
...
-(void)didModifyAdjustmentWithLocalizedName:(id)arg0 ;
