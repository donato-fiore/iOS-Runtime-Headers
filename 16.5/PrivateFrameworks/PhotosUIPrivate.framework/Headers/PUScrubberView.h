...
@class UIView, NSString, NSMutableDictionary, NSIndexPath, UITapGestureRecognizer, PXVideoScrubberController, UIScrollView, PXSectionedSelectionManager;
@protocol PUTilingViewTileSource, PUTilingViewTileTransitionDelegate, PUTilingViewScrollDelegate, UIScrollViewDelegate, PUBrowsingViewModelChangeObserver, PUScrubberTilingLayoutDelegate, PXVideoScrubberControllerDelegate, PUPlaybackTimeIndicatorTileViewControllerDelegate, UIGestureRecognizerDelegate, PXChangeObserver, PUScrubberViewDelegate;
...
-(BOOL)layout:(id)arg0 isItemAtAtIndexPathSelected:(id)arg1 ;
