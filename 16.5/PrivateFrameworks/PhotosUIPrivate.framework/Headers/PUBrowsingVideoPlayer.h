...
@property (nonatomic) BOOL shouldRequestNewRender; // ivar: _shouldRequestNewRender
@property (readonly) Class superclass;
@property (nonatomic, setter=_setTargetSize:) CGSize targetSize; // ivar: _targetSize
...
-(void)setDesiredTargetSize:(struct CGSize )arg0 ;
