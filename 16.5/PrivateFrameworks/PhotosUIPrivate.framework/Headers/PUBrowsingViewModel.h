...
@class NSDate, NSMutableSet, NSString, PXContentPrivacyController;
@protocol PUAssetViewModelChangeObserver, PUAssetSharedViewModelChangeObserver, PXChangeObserver, PXAssetImportStatusObserver, OS_dispatch_queue, PXAssetImportStatusManager;
...
@property (readonly, nonatomic) PUAssetReference *assetBeforeLastViewedAssetReference; // ivar: _assetBeforeLastViewedAssetReference
@property (readonly, nonatomic) BOOL assetChangesShouldAnimate; // ivar: _assetChangesShouldAnimate
...
@property (readonly, nonatomic) NSObject<OS_dispatch_queue> *audioSessionUpdateQueue; // ivar: _audioSessionUpdateQueue
@property (nonatomic, setter=_setBrowsingSpeedRegime:) NSInteger browsingSpeedRegime; // ivar: _browsingSpeedRegime
@property (readonly, nonatomic) NSInteger contentPrivacyState; // ivar: _contentPrivacyState
...
@property (nonatomic) BOOL isInSelectionMode; // ivar: _isInSelectionMode
...
@property (nonatomic) BOOL livePhotoShouldPlay; // ivar: _livePhotoShouldPlay
...
@property (nonatomic) NSInteger muteMode;
...
@property (readonly, nonatomic) NSInteger systemAuthenticationType; // ivar: _systemAuthenticationType
