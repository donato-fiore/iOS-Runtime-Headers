...
@class NSString, NSMutableDictionary, PXLoadingStatusManager, PXSelectionCoordinator, UIViewController;
@protocol PUUIImageViewControllerCancellationDelegate, PUUIImageViewControllerFileResizingDelegate, PUAssetPickerContainerControllerActionHandler, PUAssetExplorerReviewScreenViewControllerDelegate, PUPhotosGridDownloadUpdateHandler, PXSelectionCoordinatorDelegate, PUPhotoPickerResizeTaskDescriptorViewModelDelegate, PUAssetPickerCoordinatorActionHandler, PUPhotoPicker;

#import <Foundation/Foundation.h>

#import "PUPickerConfiguration.h"
#import "PUPhotosGridDownloadHelper.h"
#import "PUAssetPickerManagedViewController.h"
...
@property (readonly, nonatomic) PUAssetPickerManagedViewController *managedViewController; // ivar: _managedViewController
...
@property (nonatomic) BOOL selectionDidChange; // ivar: _selectionDidChange
@property (copy, nonatomic) id *selectionDidChangeObserver; // ivar: _selectionDidChangeObserver
...
-(id)init;
-(id)initWithConfiguration:(id)arg0 coordinatorActionHandler:(id)arg1 loadingStatusManager:(id)arg2 ;
...
-(id)initWithPhotoPicker:(id)arg0 mediaTypes:(id)arg1 connection:(id)arg2 ;
...
-(void)_presentViewControllerDismissingPresentedViewControllerIfNeeded:(id)arg0 ;
...
-(void)containerController:(id)arg0 didTapBatchedItems:(id)arg1 ;
-(void)containerController:(id)arg0 didTapCancelButton:(id)arg1 ;
-(void)containerController:(id)arg0 didTapClearButton:(id)arg1 ;
-(void)containerController:(id)arg0 didTapShowSelectedButton:(id)arg1 ;
...
-(void)imageViewControllerDidCancel:(id)arg0 ;
...
-(void)replaceConfirmationButtonWithActivityIndicator:(BOOL)arg0 ;
