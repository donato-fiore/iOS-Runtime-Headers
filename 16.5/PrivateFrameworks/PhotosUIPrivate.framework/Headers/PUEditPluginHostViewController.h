...
@class UIViewController, NSNumber, NSString, UIBarButtonItem, PUEditingExtensionUndoProxyHostSide;
@protocol PXForcedDismissableViewController, PUEditingExtensionUndoButtonHost, PUEditPluginHostViewControllerDataSource, PUEditPluginHostViewControllerDelegate, NSCopying;
...
@property (retain, nonatomic) NSNumber *allowsFullScreen; // ivar: _allowsFullScreen
...
@property (nonatomic) BOOL didHandleCancel; // ivar: _didHandleCancel
@property (nonatomic) BOOL didHandleDone; // ivar: _didHandleDone
@property (retain, nonatomic) id *disablingIdleTimerToken; // ivar: _disablingIdleTimerToken
@property (nonatomic) BOOL extensionDidBeginContentEditing; // ivar: _extensionDidBeginContentEditing
...
@property (copy) NSObject<NSCopying> *request; // ivar: _request
