...
@class UIView, _UIBackdropView, PEAutoAdjustmentController, CEKBadgeTextView, NSString;
...
@property (retain, nonatomic) PEAutoAdjustmentController *autoAdjustmentController; // ivar: _autoAdjustmentController
...
-(CGFloat)ppt_valueIncrementForSelectedSlider;
-(CGFloat)ppt_visibleScaleValueForSelectedSlider;
...
-(void)ppt_selectSliderNamed:(id)arg0 completion:(id)arg1 ;
