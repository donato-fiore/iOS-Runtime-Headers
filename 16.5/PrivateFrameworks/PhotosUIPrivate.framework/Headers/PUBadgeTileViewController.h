...
@protocol PUAssetViewModelChangeObserver, PXUIAssetBadgeViewDelegate, PXChangeObserver, PXActionPerformerDelegate, PUBadgeTileViewControllerDelegate;
...
+(struct CGSize )leadingBadgesSizeForAssetViewModel:(id)arg0 contentWidth:(CGFloat)arg1 ;
...
+(void)applyLivePhotoEffect:(NSInteger)arg0 toAsset:(id)arg1 undoManager:(id)arg2 ;
+(void)disableLivePhotoForAsset:(id)arg0 undoManager:(id)arg1 ;
