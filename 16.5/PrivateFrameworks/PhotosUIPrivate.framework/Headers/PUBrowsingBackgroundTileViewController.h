...
@class UIVisualEffectView, UIContentUnavailableView, UIColor, NSString, UIVisualEffect;
...
@property (retain, nonatomic, setter=_setEmptyPlaceholderView:) UIContentUnavailableView *_emptyPlaceholderView; // ivar: __emptyPlaceholderView
