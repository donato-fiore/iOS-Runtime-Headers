...
@class UIView, UIImageView, UIImage, PXPixelBufferView, NSString, AVPlayerLayer, PXVideoSession, PXVideoSessionUIView;
@protocol PUAssetViewModelChangeObserver, PUBrowsingVideoPlayerChangeObserver, PXVideoSessionUIViewDelegate, PXChangeObserver, PUBrowsingVideoPlayerTimeObserver, PUBrowsingVideoPlayerVideoOutput, PXSettingsKeyObserver, PUVideoLayerSource, PUDisplayAsset;
...
@property (nonatomic) BOOL isOnSecondScreen; // ivar: _isOnSecondScreen
@property (retain, nonatomic) PUMediaProvider *mediaProvider; // ivar: _mediaProvider
@property (nonatomic) BOOL placeholderHiddenBehindVideoView; // ivar: _placeholderHiddenBehindVideoView
...
-(void)_setImageResult:(id)arg0 pixelBuffer:(struct __CVBuffer *)arg1 info:(id)arg2 synchronous:(BOOL)arg3 ;
