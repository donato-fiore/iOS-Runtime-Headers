...
@property (nonatomic) BOOL imageSubjectAnalyzingFinished; // ivar: _imageSubjectAnalyzingFinished
...
-(BOOL)pointInsideContentView:(struct CGPoint )arg0 inCoordinateSpace:(id)arg1 ;
...
-(void)imageAnalysisInteractionDidBeginSubjectAnalysis:(id)arg0 ;
-(void)imageAnalysisInteractionDidCompleteSubjectAnalysis:(id)arg0 ;
