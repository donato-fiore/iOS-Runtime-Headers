...
-(BOOL)_vkImageOverlayAllowsVKCToHandleLongPressGestureFromProvider:(id)arg0 ;
...
-(BOOL)userTransformTileViewControllerShouldShowVisualIntelligenceOverlay:(id)arg0 ;
...
-(CGFloat)layout:(id)arg0 leadingBadgesWidthForItemAtIndexPath:(id)arg1 contentWidth:(CGFloat)arg2 ;
...
-(NSInteger)contentAccessoryViewForCurrentAsset;
...
-(void)_setAccessoryVisible:(BOOL)arg0 changeReason:(NSInteger)arg1 ;
