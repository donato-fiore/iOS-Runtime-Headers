...
@class NSURL, NSOperationQueue, NSDictionary, PIParallaxStyle, PHPhotoLibrary, NSMutableDictionary;
...
@property (readonly, nonatomic) NSOperationQueue *exportOperationQueue; // ivar: _exportOperationQueue
...
-(id)initWithPosterMedia:(id)arg0 style:(id)arg1 assetDirectory:(id)arg2 persistedStyle:(id)arg3 photoLibrary:(id)arg4 shuffleType:(NSInteger)arg5 ;
