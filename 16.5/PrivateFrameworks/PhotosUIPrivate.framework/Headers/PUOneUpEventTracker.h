...
@property (nonatomic) NSInteger currentlyShowingInfoPanelSignpost; // ivar: _currentlyShowingInfoPanelSignpost
...
@property (nonatomic) CGFloat livePhotoFirstPlayWaitDuration; // ivar: _livePhotoFirstPlayWaitDuration
...
-(NSInteger)startLoggingTimeInterval;
...
-(void)_logInfoPanelChangeEventsIfNeededWithChange:(id)arg0 ;
...
-(void)endLoggingTimeInterval:(NSInteger)arg0 event:(id)arg1 ;
...
-(void)logInfoPanelClosedBy:(NSInteger)arg0 ;
-(void)logInfoPanelOpenedBy:(NSInteger)arg0 ;
-(void)logInfoPanelRotatedToHorizontalView;
-(void)logInfoPanelShownAndSwipeToNewAsset;
-(void)logTipPresentedForType:(NSInteger)arg0 ;
-(void)logUserDidPlayLivePhoto:(id)arg0 ;
-(void)logUserDidPlayLivePhoto:(id)arg0 pressOnSubject:(BOOL)arg1 ;
-(void)logUserWillPlayLivePhoto:(id)arg0 ;
-(void)logUserWillPlayLivePhoto:(id)arg0 firstTimeWaitDuration:(CGFloat)arg1 ;
