...
@property (copy, nonatomic) id *contextMenuInteractionEndBlock; // ivar: _contextMenuInteractionEndBlock
...
@property (weak, nonatomic) PHPickerViewController *pickerViewController; // ivar: _pickerViewController
...
-(void)_dismissPhotosPickerControllerAnimated:(BOOL)arg0 ;
...
-(void)_handleDeleteCollection:(id)arg0 sourceView:(id)arg1 ;
...
-(void)_performOrScheduleScrollToCollection:(id)arg0 animated:(BOOL)arg1 ;
...
-(void)_scrollToCollection:(id)arg0 animated:(BOOL)arg1 ;
