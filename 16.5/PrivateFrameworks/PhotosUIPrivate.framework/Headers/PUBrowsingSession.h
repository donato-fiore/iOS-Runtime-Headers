...
@class NSString, PXAssetEditOperationManager, PXPhotosDetailsContext, PXContentPrivacyController;
...
-(id)initWithDataSourceManager:(id)arg0 actionManager:(id)arg1 mediaProvider:(id)arg2 photosDetailsContext:(id)arg3 lowMemoryMode:(BOOL)arg4 importStatusManager:(id)arg5 ;
-(id)initWithDataSourceManager:(id)arg0 actionManager:(id)arg1 mediaProvider:(id)arg2 photosDetailsContext:(id)arg3 lowMemoryMode:(BOOL)arg4 importStatusManager:(id)arg5 privacyController:(id)arg6 ;
