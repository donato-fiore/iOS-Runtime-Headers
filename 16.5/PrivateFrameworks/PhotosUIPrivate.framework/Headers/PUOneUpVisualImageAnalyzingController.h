...
@protocol PUBrowsingViewModelChangeObserver, OS_dispatch_queue;
...
@property (readonly, nonatomic) NSObject<OS_dispatch_queue> *loadVideoFrameQueue; // ivar: _loadVideoFrameQueue
