...
@class PLUIImageViewController, PHAsset, ISAnimatedImageView, NSURL, PHLivePhotoView, NSString;
@protocol UIGestureRecognizerDelegate, PUVideoPlayerViewDelegate, PXChangeObserver, PUPhotoPickerSelectionHandler, PUUIImageViewControllerCancellationDelegate, PUUIImageViewControllerFileResizingDelegate, PUPhotoPicker;
...
@property (weak, nonatomic) NSObject<PUUIImageViewControllerCancellationDelegate> *cancellationDelegate; // ivar: _cancellationDelegate
