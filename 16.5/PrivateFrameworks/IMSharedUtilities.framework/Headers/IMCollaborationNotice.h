...
@property (retain, nonatomic) NSDate *dateViewed; // ivar: _dateViewed
...
+(id)noticeWithGUIDString:(id)arg0 sender:(id)arg1 metadata:(id)arg2 date:(id)arg3 dateViewed:(id)arg4 ;
-(BOOL)isEqual:(id)arg0 ;
-(BOOL)wantsEphemeralDismissal;
-(NSUInteger)hash;
-(id)copyWithZone:(struct _NSZone *)arg0 ;
-(id)initWithCoder:(id)arg0 ;
-(id)initWithGUIDString:(id)arg0 sender:(id)arg1 metadata:(id)arg2 date:(id)arg3 dateViewed:(id)arg4 ;
