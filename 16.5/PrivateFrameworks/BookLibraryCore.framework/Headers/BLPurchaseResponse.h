...
@property (copy, nonatomic) NSNumber *firstUnderlyingErrorCode; // ivar: _firstUnderlyingErrorCode
@property (copy, nonatomic) NSString *firstUnderlyingErrorDomain; // ivar: _firstUnderlyingErrorDomain
@property (copy, nonatomic) NSString *firstUnderlyingErrorLocalizedDescription; // ivar: _firstUnderlyingErrorLocalizedDescription
@property (nonatomic) BOOL hasRacGUID; // ivar: _hasRacGUID
@property (nonatomic) BOOL isUserCancelError; // ivar: _isUserCancelError
...
@property (copy, nonatomic) NSNumber *supplementalContentCount; // ivar: _supplementalContentCount
...
-(void)_updatePropertiesFromPurchaseError:(id)arg0 ;
