...
@protocol BDSCloudKitSupportSignOutDissociate, BCCloudDataMapper, BDSCloudDataManagerMonitor, BCCloudDataPrivacyDelegate, OS_dispatch_queue;
...
@property (weak, nonatomic) NSObject<BDSCloudDataManagerMonitor> *monitor; // ivar: _monitor
