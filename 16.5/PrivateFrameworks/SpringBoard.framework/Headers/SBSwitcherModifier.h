...
-(BOOL)shouldZoomToSystemApertureForEvent:(id)arg0 activeLayout:(id)arg1 ;
...
-(id)init;
-(id)loggingCategory;
-(id)overlappingModelForAppLayout:(id)arg0 ;
-(id)stackDescription;
-(id)stackDescriptionWithPrefix:(id)arg0 ;
-(struct CGRect )frameForContinuousExposePeekingDisplayItem:(id)arg0 inAppLayout:(id)arg1 bounds:(struct CGRect )arg2 defaultFrameForLayoutRole:(struct CGRect )arg3 ;
