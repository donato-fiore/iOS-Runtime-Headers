...
+(id)zoomViewForDeviceApplicationSceneHandle:(id)arg0 displayConfiguration:(id)arg1 interfaceOrientation:(NSInteger)arg2 snapshot:(id)arg3 snapshotSize:(struct CGSize )arg4 statusBarDescriptor:(id)arg5 decodeImage:(BOOL)arg6 hasOrientationMismatchForClassicApp:(BOOL)arg7 customContainerBounds:(struct CGRect )arg8 ;
...
-(BOOL)_treatsAccessoryAsSupported:(id)arg0 ;
...
-(BOOL)handleHomeButtonSinglePressUpForWindowScene:(id)arg0 ;
-(BOOL)handleHomeButtonSinglePressUpForWindowScene:(id)arg0 withSourceType:(NSUInteger)arg1 ;
...
-(void)_removeSuppressedAccessory:(id)arg0 ;
...
-(void)_storeSuppressedAccessory:(id)arg0 ;
