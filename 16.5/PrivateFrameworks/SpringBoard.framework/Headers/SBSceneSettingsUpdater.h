...
@class NSString, SBFTraitsParticipant, NSHashTable, FBSDisplayConfiguration, FBScene;
...
@property (readonly, nonatomic) BOOL updatesGeometry; // ivar: _updatesGeometry


+(void)__updateSceneInsetSettings:(id)arg0 forDisplayConfiguration:(id)arg1 ;
+(void)__updateSceneSettings:(id)arg0 forDisplayConfiguration:(id)arg1 updateGeometry:(BOOL)arg2 ;
+(void)safeUpdateScene:(id)arg0 withBlock:(id)arg1 ;
+(void)safeUpdateScene:(id)arg0 withDisplayConfiguration:(id)arg1 ;
+(void)safeUpdateScene:(id)arg0 withDisplayConfiguration:(id)arg1 updateGeometry:(BOOL)arg2 ;
...
-(id)initWithScene:(id)arg0 displayConfiguration:(id)arg1 traitsRole:(id)arg2 persistentIdentifier:(id)arg3 level:(CGFloat)arg4 updatesGeometry:(BOOL)arg5 ;
