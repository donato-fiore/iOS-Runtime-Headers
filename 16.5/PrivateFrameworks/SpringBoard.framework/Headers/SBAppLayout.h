...
-(BOOL)containsAllItemsFromSet:(id)arg0 ;
...
-(id)appLayoutByInsertingItem:(id)arg0 withLayoutAttributes:(id)arg1 inLayoutRole:(NSInteger)arg2 ;
-(id)appLayoutByInsertingLeafAppLayout:(id)arg0 inRole:(NSInteger)arg1 ;
...
-(id)appLayoutByModifyingPreferredDisplayOrdinal:(NSInteger)arg0 ;
-(id)appLayoutByRemovingItemInLayoutRole:(NSInteger)arg0 ;
-(id)appLayoutWithItemsPassingTest:(id)arg0 ;
-(id)appLayoutsBySplittingMedusaIncompatibleItemsWithApplicationController:(id)arg0 ;
