...
@protocol SBDeviceApplicationSceneHandleObserver, SBWorkspaceApplicationSceneTransitionContextDelegate, SBDeviceApplicationSceneViewControllerDelegate, SBApplicationSceneUpdateTransactionDelegate, SBApplicationHosting, SBApplicationSceneViewControlling, BSInvalidatable, SBApplicationSceneViewControllingStatusBarDelegate, SBAppViewControllerDelegate, SBScenePlaceholderContentContext;
...
-(void)sceneUpdateTransaction:(id)arg0 finishedApplyingUpdate:(BOOL)arg1 ;
