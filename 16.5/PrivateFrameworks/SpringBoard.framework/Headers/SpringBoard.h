...
@property (readonly, copy) NSString *description;
@property (readonly, nonatomic) SBDisplayManager *displayManager; // ivar: _displayManager
...
@property (readonly, nonatomic) SBExternalDisplayService *externalDisplayService; // ivar: _externalDisplayService
...
@property (readonly, nonatomic) SBMultiDisplayUserInteractionCoordinator *multiDisplayUserInteractionCoordinator; // ivar: _multiDisplayUserInteractionCoordinator
...
@property (readonly, nonatomic) SBPrivacyPreflightController *privacyPreflightController; // ivar: _privacyPreflightController
...
-(struct CGPoint )_locationInScreenReferenceSpaceForLocation:(struct CGPoint )arg0 inOrientation:(NSInteger)arg1 ;
...
-(void)_handleEnterFullScreenKeyShortcut:(id)arg0 ;
...
-(void)_handleNavigateAppWindowKeyShortcut:(id)arg0 ;
...
-(void)_prepareToRunSwitcherGestureTestsWithForegroundApp:(id)arg0 shouldStartTest:(BOOL)arg1 forcedOrientation:(NSInteger)arg2 withCompletion:(id)arg3 ;
...
-(void)_resetToHomeScreen:(id)arg0 ;
...
-(void)_runArcSwipeMultipleAppsTestWithForegroundApp:(id)arg0 forcedOrientation:(NSInteger)arg1 ;
...
-(void)_updateChamoisWindowingUIEnabledIfNeededForTest:(id)arg0 ;
