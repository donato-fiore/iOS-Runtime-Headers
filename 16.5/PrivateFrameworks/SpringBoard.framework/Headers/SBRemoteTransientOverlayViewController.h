...
@property (weak, nonatomic) SBRemoteTransientOverlayViewController *pairedRemoteTransientOverlay; // ivar: _pairedRemoteTransientOverlay
...
+(void)requestViewControllersForAlertDefinition:(id)arg0 connectionHandler:(id)arg1 ;
...
-(BOOL)isPresentedByBundleIdentifier:(id)arg0 ;
