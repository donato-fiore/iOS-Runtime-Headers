...
-(void)setCompactedCenter:(struct CGPoint )arg0 forItem:(id)arg1 ;
-(void)setCoveredByFullyOccludedPeekingItem:(BOOL)arg0 forItem:(id)arg1 ;
-(void)setFullyOccluded:(BOOL)arg0 forItem:(id)arg1 ;
-(void)setOverlappingScaleAnchorCenter:(struct CGPoint )arg0 forItem:(id)arg1 ;
-(void)setPartiallyOccluded:(BOOL)arg0 forItem:(id)arg1 ;
-(void)setSize:(struct CGSize )arg0 forItem:(id)arg1 ;
-(void)setUnoccludedPeekingCenterForItem:(struct CGPoint )arg0 forItem:(id)arg1 ;
