...
@property (readonly, weak, nonatomic) SBWindowScenePIPManager *pipManager; // ivar: _pipManager
...
-(id)initWithObserver:(id)arg0 bannerManager:(id)arg1 sceneManager:(id)arg2 pipManager:(id)arg3 ;
