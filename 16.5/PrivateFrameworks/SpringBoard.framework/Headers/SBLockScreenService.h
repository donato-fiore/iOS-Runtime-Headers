...
@protocol BSServiceConnectionListenerDelegate, SBSLockScreenServiceServerInterface, SBPasscodeEntryTransientOverlayViewControllerDelegate, SBAlwaysOnPolicy, SBFAuthenticationAssertionProviding, SBFLockOutStatusProvider;
...
-(void)lockDeviceAnimated:(id)arg0 withCompletion:(id)arg1 ;
