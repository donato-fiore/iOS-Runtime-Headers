...
-(void)_applyAvoidanceFrameToStatusBar:(id)arg0 withGlobalAvoidanceFrame:(struct CGRect )arg1 animationSettings:(id)arg2 reason:(id)arg3 options:(NSUInteger)arg4 ;
...
-(void)setAvoidanceFrame:(struct CGRect )arg0 reason:(id)arg1 statusBar:(id)arg2 animationSettings:(id)arg3 options:(NSUInteger)arg4 ;
