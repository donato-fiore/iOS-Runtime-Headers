...
@property (retain, nonatomic) SBSwitcherCoordinatedLayoutStateTransitionContext *currentCoordinatedLayoutStateTransitionContext; // ivar: _currentCoordinatedLayoutStateTransitionContext
...
-(BOOL)_shouldShowMultipleWindowsNotSupportedMessageForLayoutStateTransitionContext:(id)arg0 medusaViewController:(id)arg1 ;
-(BOOL)_shouldShowSplitViewNotSupportedMessageForLayoutStateTransitionContext:(id)arg0 medusaViewController:(id)arg1 ;
...
-(NSInteger)_calculateSBSDisplayLayoutElementRoleForDisplayItem:(id)arg0 inAppLayout:(id)arg1 ;
-(NSInteger)_existingOverlayTypeForAppLayout:(id)arg0 ;
-(id)_newLiveContentOverlayForApplicationContext:(id)arg0 layoutRole:(NSInteger)arg1 sbsDisplayLayoutRole:(NSInteger)arg2 ;
-(id)appLayoutForKeyboardFocusedScene;
-(id)initWithSwitcherController:(id)arg0 ;
-(void)_addOverlay:(id)arg0 forAppLayout:(id)arg1 animated:(BOOL)arg2 ;
-(void)_configureLiveContentOverlayView:(id)arg0 forTransitionContext:(id)arg1 layoutRole:(NSInteger)arg2 sbsDisplayLayoutRole:(NSInteger)arg3 ;
-(void)_presentTransientErrorMessageIfNeededForLayoutStateTransitionContext:(id)arg0 medusaViewController:(id)arg1 ;
-(void)_removeOverlayForAppLayout:(id)arg0 animated:(BOOL)arg1 ;
-(void)_updateAlwaysLiveSceneContentOverlays;
-(void)_updateFullScreenDisplayLayoutElementsForActiveAppLayouts:(id)arg0 inAppLayout:(id)arg1 ;
