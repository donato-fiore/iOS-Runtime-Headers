...
@class UIView, SBFLockScreenDateView, _UILegibilityLabel, UIStatusBar, _UILegibilitySettings, SBUILegibilityView, UILabel, CSPageControl, SBUICallToActionLabel, SBUIProudLockIconView, CSQuickActionsView, SBFLockScreenDateViewController;
