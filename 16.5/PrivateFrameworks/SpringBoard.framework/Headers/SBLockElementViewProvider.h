...
@class SBUIBiometricResource, SBUIProudLockIconView, UIView, BSUICAPackageView, SBUISystemApertureContentProvider, NSString, SBUISystemApertureCustomContentProvider;
@protocol SBUIBiometricResourceObserver, SBSystemApertureSuppressible, SAElementViewProviding, SAUIContentTransitioning, SAElementHosting, SAUILayoutHosting, SAElement;
