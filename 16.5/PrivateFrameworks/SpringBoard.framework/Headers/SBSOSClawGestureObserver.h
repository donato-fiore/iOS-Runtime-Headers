...
@class SOSManager, NSMutableDictionary, NSMutableSet, NSString, SBSOSDefaults, BSAbsoluteMachTimer;
...
-(void)_updateActivePressesForPressType:(NSInteger)arg0 down:(BOOL)arg1 timestamp:(CGFloat)arg2 ;
-(void)dealloc;
