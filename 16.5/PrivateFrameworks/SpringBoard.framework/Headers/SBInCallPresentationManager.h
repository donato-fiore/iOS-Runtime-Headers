...
@class NSMutableDictionary, NSMutableArray, NSMutableSet, BSCompoundAssertion, NSString;
...
-(id)acquireNonModalSuppressionAssertionForReason:(id)arg0 ;
...
-(id)sessionForSceneIdentifier:(id)arg0 ;
...
-(void)sceneManager:(id)arg0 willMoveScene:(id)arg1 toSceneManager:(id)arg2 ;
