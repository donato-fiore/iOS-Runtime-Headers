...
-(id)initWithFrame:(struct CGRect )arg0 usingHomeAffordance:(BOOL)arg1 coverSheetContext:(id)arg2 isStoreRestricted:(BOOL)arg3 isSecurityResearchDevice:(BOOL)arg4 ;
-(void)_addActivationLockLabels;
-(void)_addHomeAffordanceCallToAction;
-(void)_addHomeAffordanceForCoverSheetContext:(id)arg0 ;
