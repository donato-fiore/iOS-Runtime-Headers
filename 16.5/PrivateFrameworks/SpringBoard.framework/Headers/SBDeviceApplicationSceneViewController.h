...
@class UIApplicationSceneDeactivationAssertion, NSMutableArray, SBFTraitsParticipant, UIStatusBar, UIView, SBOrientationTransformWrapperView, UITapGestureRecognizer, SBFHomeGrabberSettings, UIView<SBApplicationSceneBackgroundView>, NSString, MTLumaDodgePillSettings, NSHashTable;
@protocol SBDeviceApplicationSceneHandleObserver, SBDeviceApplicationSceneStatusBarStateObserver, SBDeviceApplicationSceneStatusBarBreadcrumbProviderObserver, SBSceneViewDelegate, UIStatusBarStyleDelegate_SpringBoardOnly, SBSceneViewStatusBarAssertionObserver, SBDeviceApplicationSceneOverlayViewProviderDelegate, SBDeviceApplicationSceneViewControlling, BSInvalidatable, SBApplicationSceneViewControllingStatusBarDelegate, SBDeviceApplicationSceneViewControllerDelegate, SBScenePlaceholderContentContext;
...
-(BOOL)overlayViewProviderIsHostedInNonrotatingWindow:(id)arg0 ;
-(BOOL)overlayViewProviderIsHostedInSecureWindow:(id)arg0 ;
...
-(id)initialTraitsParticipantForOverlayViewProvider:(id)arg0 ;
...
-(id)windowSceneForOverlayViewProvider:(id)arg0 ;
