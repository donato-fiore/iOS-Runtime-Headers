...
@protocol SBLockScreenBatteryChargingViewControllerDelegate, SBLoginAppSceneHosterDelegate, PBUIWallpaperObserver, SBLockScreenPluginManagerDelegate, SBLoginAppSceneHoster, BSInvalidatable;
