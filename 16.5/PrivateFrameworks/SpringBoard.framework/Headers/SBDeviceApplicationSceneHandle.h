...
@class NSMutableSet, NSDictionary, UIApplicationSceneClientSettingsDiffInspector, NSMutableArray, NSData, NSString, _UIStatusBarData;
...
@property (nonatomic, getter=isHostedSecureApp) BOOL hostedSecureApp; // ivar: _hostedSecureApp
...
@property (nonatomic, getter=_initialDeviceOrientationFromSceneOrientationRequestSetup, setter=_setInitialDeviceOrientationFromSceneOrientationRequestSetup:) NSInteger initialDeviceOrientationFromSceneOrientationRequestSetup;
@property (nonatomic, getter=_interfaceOrientationFromUserResizing, setter=_setInterfaceOrientationFromUserResizing:) NSInteger interfaceOrientationFromUserResizing;
...
@property (nonatomic, getter=_supportedInterfaceOrientationsFromSceneOrientationRequestSetup, setter=_setSupportedInterfaceOrientationsFromSceneOrientationRequestSetup:) NSUInteger supportedInterfaceOrientationsFromSceneOrientationRequestSetup;
...
+(CGFloat)_homeAffordanceInsetTopForWindowScene:(id)arg0 ;
...
-(NSInteger)_defaultStatusBarStyleFromSceneDataStore;
-(NSInteger)_initialMainSceneCompabilityMode:(id)arg0 ;
-(NSInteger)_interfaceOrientationMode;
-(NSInteger)_launchingInterfaceOrientationForOrientation:(NSInteger)arg0 ;
-(NSInteger)_preferredSizingPolicyForContentOrientation:(NSInteger)arg0 containerOrientation:(NSInteger)arg1 ;
...
-(NSUInteger)_supportedSizingPoliciesForContentOrientation:(NSInteger)arg0 containerOrientation:(NSInteger)arg1 ;
...
-(id)_sceneHostingInfoForSnapshottingAssertionWithView:(id)arg0 ;
-(id)_windowScene;
...
-(id)newSceneViewWithReferenceSize:(struct CGSize )arg0 contentOrientation:(NSInteger)arg1 containerOrientation:(NSInteger)arg2 hostRequester:(id)arg3 ;
-(id)statusBarEffectiveStyleRequestWithStyle:(NSInteger)arg0 ;
-(void)_addSnapshottingInfoAssertion:(id)arg0 ;
...
-(void)_removeSnapshottingInfoAssertion:(id)arg0 ;
-(void)_resetSceneOrientationRequestState;
-(void)_setClassicAppPhoneOnPadPrefersLandscape:(BOOL)arg0 ;
-(void)_setInterfaceOrientationFromUserResizingIfSupported:(NSInteger)arg0 ;
-(void)_updateIdleTimerForReason:(id)arg0 ;
-(void)_updateSceneHostingInfoForSnapshottingWithAssertion:(id)arg0 forceUpdate:(BOOL)arg1 ;
