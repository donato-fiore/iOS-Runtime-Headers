...
@property (retain, nonatomic) SBWindowScene *mainWindowScene; // ivar: _mainWindowScene
@property (readonly, nonatomic, getter=isMedusaEnabled) BOOL medusaEnabled; // ivar: _medusaEnabled
@property (retain, nonatomic) SBPIPControllerCoordinator *pipCoordinator; // ivar: _pipCoordinator
...
-(BOOL)defaultShouldAutorotateForTransientOverlayScenePresenter:(id)arg0 ;
...
-(BOOL)isApplicationRunningAsViewService:(id)arg0 ;
-(BOOL)isKeyboardVisibleForSpringBoardForTransientOverlayScenePresenter:(id)arg0 ;
...
-(BOOL)transientOverlayScenePresenter:(id)arg0 shouldResignFirstResponderForKeyWindow:(id)arg1 ;
-(BOOL)transientOverlayScenePresenter:(id)arg0 shouldRestoreFirstResponderForKeyWindow:(id)arg1 ;
-(NSInteger)defaultPreferredInterfaceOrientationForPresentationForTransientOverlayScenePresenter:(id)arg0 ;
-(NSInteger)inCallPresentationManager:(id)arg0 interfaceOrientationForBannerPresentationInWindowScene:(id)arg1 ;
-(NSInteger)inCallPresentationManager:(id)arg0 interfaceOrientationForTransientOverlayPresentationInWindowScene:(id)arg1 ;
-(NSUInteger)defaultSupportedInterfaceOrientationsForTransientOverlayScenePresenter:(id)arg0 ;
...
-(id)_sceneComparatorForApplication:(SEL)arg0 keyboardFocusScene:(id)arg1 ;
...
-(id)_targetWindowSceneForApplication:(id)arg0 preferringDisplay:(id)arg1 requireForeground:(BOOL)arg2 options:(id)arg3 ;
...
-(id)bannerLongLookPresentationObservationTokenForTransientOverlayScenePresenter:(id)arg0 ;
-(id)controlCenterPresentationObservationTokenForTransientOverlayScenePresenter:(id)arg0 ;
...
-(id)currentStatusBarSettingsForTransientOverlayScenePresenter:(id)arg0 ;
...
-(id)siriPresentationObservationTokenForTransientOverlayScenePresenter:(id)arg0 ;
-(id)systemServiceApplicationInfoProvider:(id)arg0 ;
-(id)transactionForTransitionRequest:(id)arg0 ;
-(id)transientOverlayScenePresenter:(id)arg0 acquireBannerLongLookWindowLevelAssertionWithReason:(id)arg1 windowLevel:(CGFloat)arg2 ;
-(id)transientOverlayScenePresenter:(id)arg0 acquireControlCenterWindowLevelAssertionWithReason:(id)arg1 windowLevel:(CGFloat)arg2 ;
-(id)transientOverlayScenePresenter:(id)arg0 acquireDeviceOrientationUpdateDeferralAssertionWithReason:(id)arg1 ;
-(id)transientOverlayScenePresenter:(id)arg0 acquireDisableAutoUnlockAssertionWithReason:(id)arg1 ;
-(id)transientOverlayScenePresenter:(id)arg0 acquireHideAppStatusBarAssertionWithReason:(id)arg1 animated:(BOOL)arg2 ;
-(id)transientOverlayScenePresenter:(id)arg0 acquireInteractiveScreenshotGestureDisabledAssertionWithReason:(id)arg1 ;
-(id)transientOverlayScenePresenter:(id)arg0 acquireProximitySensorEnabledAssertionWithReason:(id)arg1 ;
-(id)transientOverlayScenePresenter:(id)arg0 acquireSiriWindowLevelAssertionWithReason:(id)arg1 windowLevel:(CGFloat)arg2 ;
-(id)transientOverlayScenePresenter:(id)arg0 acquireWallpaperAnimationSuspensionAssertionWithReason:(id)arg1 ;
-(id)transientOverlayScenePresenter:(id)arg0 newSceneDeactivationAssertionWithReason:(NSInteger)arg1 ;
...
-(void)_cleanupForRemovedAppEntity:(id)arg0 ;
...
-(void)_handleKeyShortcutHUDVisibilityDidPresent:(id)arg0 ;
...
-(void)_updateActivationSettings:(id)arg0 forRequestWithOptions:(id)arg1 clientProcess:(id)arg2 application:(id)arg3 ;
...
-(void)powerDownViewControllerWillDisappear:(id)arg0 ;
...
-(void)systemService:(id)arg0 prepareForShutdownWithOptions:(id)arg1 origin:(id)arg2 ;
...
-(void)transientOverlayScenePresenter:(id)arg0 didDismissViewController:(id)arg1 wasTopmostPresentation:(BOOL)arg2 ;
-(void)transientOverlayScenePresenter:(id)arg0 preferredWhitePointAdaptivityStyleDidChangeWithAnimationSettings:(id)arg1 ;
-(void)transientOverlayScenePresenter:(id)arg0 registerCoverSheetExternalBehaviorProvider:(id)arg1 ;
-(void)transientOverlayScenePresenter:(id)arg0 unregisterCoverSheetExternalBehaviorProvider:(id)arg1 ;
-(void)transientOverlayScenePresenter:(id)arg0 willChangeTopmostViewControllerInterfaceOrientationToOrientation:(NSInteger)arg1 ;
-(void)transientOverlayScenePresenter:(id)arg0 willPresentViewController:(id)arg1 ;
-(void)transientOverlayScenePresenterRequestsAppIconForceTouchDismissal:(id)arg0 animated:(BOOL)arg1 ;
-(void)transientOverlayScenePresenterRequestsControlCenterDismissal:(id)arg0 animated:(BOOL)arg1 ;
-(void)transientOverlayScenePresenterRequestsSiriDismissal:(id)arg0 animated:(BOOL)arg1 ;
