...
@protocol SBFScreenWakeAnimationControlling, SBFScreenWakeAnimationTarget, SBScreenWakeAnimationControllerDelegate;
...
@property (weak, nonatomic) NSObject<SBScreenWakeAnimationControllerDelegate> *delegate; // ivar: _delegate
...
-(void)_updateWakeEffectsForWake:(BOOL)arg0 animated:(BOOL)arg1 completion:(id)arg2 ;
-(void)dealloc;
-(void)prepareToWakeForSource:(NSInteger)arg0 timeAlpha:(CGFloat)arg1 statusBarAlpha:(CGFloat)arg2 target:(id)arg3 dateView:(id)arg4 completion:(id)arg5 ;
