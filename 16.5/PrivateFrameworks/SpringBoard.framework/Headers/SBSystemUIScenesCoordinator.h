...
@property (retain, nonatomic) SBEyedropperUISceneController *eyedropperUISceneController; // ivar: _eyedropperUISceneController
...
@property (retain, nonatomic) SBMomentsUISceneController *momentsUISceneController; // ivar: _momentsUISceneController
...
+(BOOL)isSystemUISceneClientIdentity:(id)arg0 ;
+(BOOL)isSystemUISceneClientPID:(int)arg0 ;
