...
@protocol SBDeviceApplicationSceneHandleObserver, SBDeviceApplicationSceneStatusBarStateObserver, SBDeviceApplicationSceneViewControllerDelegate, SBSceneViewStatusBarAssertionObserver, SBTopAffordanceViewControllerDelegate, SBUIActiveOrientationObserver, UIGestureRecognizerDelegate, SBMedusaDecoratedDeviceApplicationSceneViewControlling_Internal, SBMedusaDecoratedDeviceApplicationSceneViewControlling, SBApplicationSceneViewControllingStatusBarDelegate, SBMedusaDecoratedDeviceApplicationSceneViewControllerDelegate, SBScenePlaceholderContentContext;
...
-(BOOL)_topAffordanceViewControllerHandleMoveToDisplayAction:(id)arg0 transitionSource:(NSInteger)arg1 ;
-(BOOL)_wantsTopAffordance;
-(BOOL)applicationSceneViewControllerIsInNonrotatingWindow:(id)arg0 ;
...
-(void)_modifyApplicationContext:(id)arg0 handleActionType:(NSInteger)arg1 spaceConfiguration:(NSInteger)arg2 layoutRole:(NSInteger)arg3 desiredFloatingConfiguration:(NSInteger)arg4 ;
...
-(void)_topAffordanceViewController:(id)arg0 handleActionType:(NSInteger)arg1 desiredFloatingConfiguration:(NSInteger)arg2 transitionSource:(NSInteger)arg3 ;
-(void)_topAffordanceViewController:(id)arg0 handleActionType:(NSInteger)arg1 transitionSource:(NSInteger)arg2 ;
...
-(void)_windowManagementStyleDidChange:(id)arg0 ;
...
-(void)topAffordanceViewController:(id)arg0 handleActionType:(NSInteger)arg1 ;
-(void)topAffordanceViewControllerWillPresentMenu:(id)arg0 ;
