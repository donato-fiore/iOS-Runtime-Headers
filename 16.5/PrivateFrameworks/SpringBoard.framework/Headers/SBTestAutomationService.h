...
-(id)init;
-(id)systemServiceServer:(id)arg0 getSystemApertureStateDumpForClient:(id)arg1 ;
-(id)systemServiceServer:(id)arg0 getWidgetControllerStateDump:(id)arg1 ;
...
-(void)systemServiceServer:(id)arg0 client:(id)arg1 getChamoisPrefersDockHiddenWithCompletion:(id)arg2 ;
-(void)systemServiceServer:(id)arg0 client:(id)arg1 getChamoisPrefersStripHiddenWithCompletion:(id)arg2 ;
-(void)systemServiceServer:(id)arg0 client:(id)arg1 getDeviceSupportsSystemAperture:(id)arg2 ;
-(void)systemServiceServer:(id)arg0 client:(id)arg1 getIsChamoisWindowingUIEnabledWithCompletion:(id)arg2 ;
...
-(void)systemServiceServer:(id)arg0 client:(id)arg1 setChamoisPrefersDockHidden:(BOOL)arg2 ;
-(void)systemServiceServer:(id)arg0 client:(id)arg1 setChamoisPrefersStripHidden:(BOOL)arg2 ;
-(void)systemServiceServer:(id)arg0 client:(id)arg1 setChamoisWindowingUIEnabled:(BOOL)arg2 ;
...
-(void)systemServiceServer:(id)arg0 enterLostModeForClient:(id)arg1 ;
-(void)systemServiceServer:(id)arg0 exitLostModeForClient:(id)arg1 ;
-(void)systemServiceServer:(id)arg0 setUserPresenceDetectedSinceWakeForClient:(id)arg1 ;
