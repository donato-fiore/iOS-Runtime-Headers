...
@class SBPIPController<SBPIPControllerAdapterContextProviding>, NSMutableSet, NSString;
...
-(void)pipController:(id)arg0 didUpdateEnhancedWindowingModeEnabled:(BOOL)arg1 windowScene:(id)arg2 ;
