...
@protocol SBDeviceApplicationSceneClassicAccessoryViewDelegate, PTSettingsKeyObserver, SBDeviceApplicationSceneOverlayViewObserver, SBAppSwitcherPageContentView, UISceneLayerTarget, BSInvalidatable;
