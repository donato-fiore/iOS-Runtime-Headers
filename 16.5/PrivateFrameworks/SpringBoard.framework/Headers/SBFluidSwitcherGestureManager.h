...
@protocol SBSystemGestureRecognizerDelegate, SBTouchTemplateGestureRecognizerDelegate, BSDescriptionProviding, PTSettingsKeyObserver, SBGrabberTongueDelegate, SBHomeGrabberDelegate, SBFZStackParticipantDelegate, SBHomeGrabberPointerClickDelegate, SBPanSystemGestureRecognizerDelegate, SBLayoutStateTransitionObserver, SBFluidSwitcherGestureWorkspaceTransactionDelegate, SBFluidSwitcherDragAndDropManagerDelegate, SBBannerManagerTransitionObserver, SBSystemApertureZStackPolicyAssistantDelegate, SBFluidSwitcherGestureManagerDelegate;
...
@property (retain, nonatomic) SBGrabberTongue *continuousExposeStripRevealGrabberTongue; // ivar: _continuousExposeStripRevealGrabberTongue
...
@property (readonly, weak, nonatomic) NSObject<SBFluidSwitcherGestureManagerDelegate> *delegate; // ivar: _delegate
...
@property (retain, nonatomic) SBFluidSwitcherPanGestureRecognizer *dragContinuousExposeStripOverflowGestureRecognizer; // ivar: _dragContinuousExposeStripOverflowGestureRecognizer
...
@property (retain, nonatomic) SBIndirectPanGestureRecognizer *indirectContinuousExposeStripOverflowGestureRecognizer; // ivar: _indirectContinuousExposeStripOverflowGestureRecognizer
...
@property (retain, nonatomic) NSHashTable *presentedSceneBackedBanners; // ivar: _presentedSceneBackedBanners
...
-(BOOL)_areContinuousExposeStripsAvailableWithReason:(*id)arg0 ;
-(BOOL)_areContinuousExposeStripsOccludedOrHiddenWithOutReason:(*id)arg0 ;
...
-(BOOL)_shouldBeginContinuousExposeStripOverflowGesture:(id)arg0 ;
-(BOOL)_shouldBeginContinuousExposeStripOverflowPanGesture:(id)arg0 ;
-(BOOL)_shouldBeginContinuousExposeStripRevealGesture:(id)arg0 ;
...
-(BOOL)_shouldContinuousExposeStripOverflowPanGesture:(id)arg0 receiveTouch:(id)arg1 ;
...
-(BOOL)_shouldProtectEdgeLocation:(CGFloat)arg0 edge:(NSUInteger)arg1 ;
...
-(void)_handleContinuousExposeStripRevealGesture:(id)arg0 ;
...
-(void)handleTransitionRequestForGestureComplete:(id)arg0 ;
-(void)handleTransitionRequestForGestureUpdate:(id)arg0 ;
