...
@class UIViewController, NSHashTable, NSMutableDictionary, UIView, NSString, UITapGestureRecognizer, _UILegibilitySettings, NSArray, SBHIconManager, MTMaterialView, WGMajorListViewController, SBIconListView, NSLayoutConstraint, NSMapTable, NSSet, SBRootFolder, UIScrollView, NSMutableArray, SBHScrollableIconViewInteraction, SBFTouchPassThroughView, UIStackView, NSMutableSet, SBViewControllerTransitionContext, SBHWidgetSettings;
@protocol SBUICoronaAnimationControllerParticipant, SBIconListLayoutObserver, SBIconViewObserver, SBHScrollableIconViewContaining, UIScrollViewDelegate, SBIconListModelObserver, SBIconListViewDragDelegate, WGMajorListViewControllerDelegate, WGWidgetIconAnimationExtraViewsProviding, PTSettingsKeyObserver, SBTodayViewSpotlightPresenterDelegate, CSExternalBehaviorProviding, UIGestureRecognizerDelegate, BSDescriptionProviding, SBUISpotlightInitiating, SBHLegibility, SBIconViewQuerying, SBIconLocationPresenting, SBFIdleTimerBehaviorProviding, SBHTodayViewController, SBFOverlayObserving, BSInvalidatable, SBTodayViewControllerDelegate, SBFOverlayDismissalDelegate, SBIconViewProviding, SBIconListLayoutProvider;
...
@interface SBTodayViewController : UIViewController <SBUICoronaAnimationControllerParticipant, SBIconListLayoutObserver, SBIconViewObserver, SBHScrollableIconViewContaining, UIScrollViewDelegate, SBIconListModelObserver, SBIconListViewDragDelegate, WGMajorListViewControllerDelegate, WGWidgetIconAnimationExtraViewsProviding, PTSettingsKeyObserver, SBTodayViewSpotlightPresenterDelegate, CSExternalBehaviorProviding, UIGestureRecognizerDelegate, BSDescriptionProviding, SBUISpotlightInitiating, SBHLegibility, SBIconViewQuerying, SBIconLocationPresenting, SBFIdleTimerBehaviorProviding, SBHTodayViewController, SBFOverlayObserving>

 {
    ...
    CGFloat _mostRecentPresentationProgress;
}
...
@property (readonly, nonatomic) BOOL widgetsAreCenteredForFullScreen; // ivar: _widgetsAreCenteredForFullScreen
@property (readonly, nonatomic) CGFloat widgetsLeadingOffset; // ivar: _widgetsLeadingOffset
...
-(NSUInteger)_indexForNextWidgetInListViewAfterContentOffset:(CGFloat)arg0 ;
-(id)_majorScrollView;
...
-(void)_toggleListVisibilityWithEditing:(BOOL)arg0 ;
