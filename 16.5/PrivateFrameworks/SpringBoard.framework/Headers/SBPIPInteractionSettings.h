...
@property (nonatomic) BOOL edgeResizeGestureEnabled; // ivar: _edgeResizeGestureEnabled
@property (retain, nonatomic) SBPIPEdgeResizeSettings *edgeResizeSettings; // ivar: _edgeResizeSettings
...
@property (retain, nonatomic) SBFFluidBehaviorSettings *rotationFluidBehavior; // ivar: _rotationFluidBehavior
