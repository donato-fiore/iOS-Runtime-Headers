...
@property (readonly, nonatomic) BOOL isChamoisWindowingUIEnabled; // ivar: _isChamoisWindowingUIEnabled
...
-(id)initWithTransitionID:(id)arg0 appLayout:(id)arg1 layoutRole:(NSInteger)arg2 chamoisWindowingUIEnabled:(BOOL)arg3 ;
