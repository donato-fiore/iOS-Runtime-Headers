...
-(BOOL)shouldPointerInteractionBeginForInteractionController:(id)arg0 ;
...
-(CGFloat)currentCornerRadiusForInteractionController:(id)arg0 ;
-(NSInteger)_presentationModeForGestureBegin;
-(NSUInteger)_cornerForGestureRecognizer:(id)arg0 ;
-(NSUInteger)_cornersForAllSwipes;
-(NSUInteger)_cornersForTouchType:(NSInteger)arg0 ;
-(NSUInteger)_touchTypeForGestureRecognizer:(id)arg0 ;
-(NSUInteger)startingPositionForExternalPresentationRequest;
-(id)_gestureSettingsForRecognizer:(id)arg0 ;
-(id)debugName;
-(id)defaultPositionHyperregionComposers;
-(id)initWithWorkspace:(id)arg0 systemGestureManager:(id)arg1 systemPointerInteractionManager:(id)arg2 dataSource:(id)arg3 delegate:(id)arg4 ;
-(id)interactionControllerConnectedWindowScenes:(id)arg0 ;
-(id)layoutSettings;
-(id)systemGestureManagerForInteractionControllerResizing:(id)arg0 ;
-(id)systemPointerInteractionManagerForInteractionController:(id)arg0 ;
...
-(struct CGPoint )_pointForGestureCorner:(NSUInteger)arg0 ;
-(struct UIEdgeInsets )interactionController:(id)arg0 edgeInsetsForWindowScene:(id)arg1 ;
-(struct UIEdgeInsets )interactionController:(id)arg0 stashedPaddingForWindowScene:(id)arg1 ;
...
-(void)contentContainerAdapterDidEndInteraction:(id)arg0 targetWindowScene:(id)arg1 ;
