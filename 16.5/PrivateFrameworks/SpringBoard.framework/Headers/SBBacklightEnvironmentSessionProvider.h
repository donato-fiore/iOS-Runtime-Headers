...
@class NSHashTable, BLSHBacklightInactiveEnvironmentSession, NSSet, NSString;
@protocol BLSHBacklightInactiveEnvironmentSessionObserving, BLSHBacklightEnvironmentSessionProviding, BSInvalidatable;
