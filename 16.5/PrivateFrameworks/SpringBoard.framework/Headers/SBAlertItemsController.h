...
@property (retain, nonatomic) NSObject<SBAlertItemPresenter> *systemApertureAlertItemPresenter; // ivar: _systemApertureAlertItemPresenter
...
-(BOOL)_hasVisibleModalAlertOfType:(NSUInteger)arg0 forWindowScene:(id)arg1 ;
...
-(BOOL)hasVisibleAlertForWindowScene:(id)arg0 ;
