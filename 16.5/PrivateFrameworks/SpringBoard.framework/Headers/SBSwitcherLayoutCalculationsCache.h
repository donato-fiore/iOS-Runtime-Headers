...
@property (readonly, nonatomic) SBSwitcherLayoutCalculationsCacheValidityToken *validityToken; // ivar: _validityToken
...
-(void)rebuildIfNecessaryForValidityToken:(id)arg0 ;
