...
@property (nonatomic) CGPoint lastGestureVelocity; // ivar: _lastGestureVelocity
...
-(struct CGRect )_updatePositionViewForProgress:(CGFloat)arg0 velocity:(CGFloat)arg1 forPresentationValue:(BOOL)arg2 ;
-(void)_addSystemGestureRecognizerIfUntracked:(id)arg0 withType:(NSUInteger)arg1 ;
