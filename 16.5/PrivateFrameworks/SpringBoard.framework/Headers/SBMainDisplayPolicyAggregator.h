...
@class SBLocalDefaults, FBSDisplayIdentity, MCProfileConnection;
...
-(BOOL)_allowsCapabilityPosterSwitcherWithExplanation:(*id)arg0 ;
...
-(id)initWithDefaults:(id)arg0 displayIdentity:(id)arg1 ;
