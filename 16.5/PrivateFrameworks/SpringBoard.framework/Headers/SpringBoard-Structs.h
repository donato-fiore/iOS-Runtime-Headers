...
typedef struct SBSwitcherGradientWallpaperAttributes {
    CGFloat leadingAlpha;
    CGFloat trailingAlpha;
} SBSwitcherGradientWallpaperAttributes;
...
typedef struct SBHSearchInteractivePresentationMetrics {
    CGFloat interactiveTransitionDistance;
    CGFloat interactiveTransitionBeganFromTopLeeway;
    CGFloat interactiveActivationThreshold;
...
typedef struct SBSpotlightHostedContentMetrics {
    ...
    CGFloat keyboardProtectorHeight;
    CGSize searchBarSize;
    CGSize dockedSearchBarSize;
    CGFloat searchBarCornerRadius;
