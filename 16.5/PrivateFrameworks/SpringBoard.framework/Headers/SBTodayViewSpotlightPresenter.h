...
@class SBHHomePullToSearchSettings, UIView, NSString, SBFFeatherBlurView, _UILegibilitySettings, UIScrollView, NSArray, SPUISearchBarController, UIViewController;
