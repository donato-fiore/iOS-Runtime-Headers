...
@property (nonatomic) BOOL cancellingDismissAnimation; // ivar: _cancellingDismissAnimation
...
@property (readonly, nonatomic) BOOL hasUnifiedKeyboardBackground; // ivar: _hasUnifiedKeyboardBackground
@property (readonly) NSUInteger hash;
@property (retain, nonatomic) SBHomeGrabberView *homeAffordance; // ivar: _homeAffordance
@property (nonatomic) SBSpotlightHostedContentMetrics hostedContentMetrics; // ivar: _hostedContentMetrics
...
@property (nonatomic) CGFloat searchContentFadeInStartValue; // ivar: _searchContentFadeInStartValue
...
@property (nonatomic) BOOL waitingForSearchContentAvailabilityForFadeIn; // ivar: _waitingForSearchContentAvailabilityForFadeIn


-(BOOL)_canShowWhileLocked;
-(BOOL)_setUpHostedContentMetrics;
-(NSInteger)_searchAffordancePresentationStateWithProgress:(CGFloat)arg0 presentationState:(NSInteger)arg1 previousSearchAffordancePresentationState:(NSInteger)arg2 ;
...
-(struct SBSpotlightPresentationMetrics )_presentationMetricsWithProgress:(CGFloat)arg0 offset:(CGFloat)arg1 presentationState:(NSInteger)arg2 previousPresentationState:(NSInteger)arg3 anticipatedPresentationState:(NSInteger)arg4 searchContentPresentationState:(NSInteger)arg5 searchAffordancePresentationState:(NSInteger)arg6 hostedContentMetrics:(struct SBSpotlightHostedContentMetrics )arg7 ;
...
-(void)_layoutSearchAffordanceWithMetrics:(struct SBSpotlightPresentationMetrics )arg0 ;
-(void)_layoutSearchContentWithMetrics:(struct SBSpotlightPresentationMetrics )arg0 ;
-(void)_layoutWithMetrics:(struct SBSpotlightPresentationMetrics )arg0 ;
-(void)_positionKeyboardAlignedElementsWithMetrics:(struct SBSpotlightPresentationMetrics )arg0 ;
-(void)_setCornerRounded:(BOOL)arg0 ;
-(void)_setHitTestingDisabledOnHostedContent:(BOOL)arg0 ;
...
-(void)_updatePresentationProgress:(CGFloat)arg0 withOffset:(CGFloat)arg1 presentationState:(NSInteger)arg2 previousPresentationState:(NSInteger)arg3 ;
-(void)dealloc;
...
-(void)spotlightMultiplexingViewController:(id)arg0 searchContentAvailabilityDidChange:(BOOL)arg1 ;
