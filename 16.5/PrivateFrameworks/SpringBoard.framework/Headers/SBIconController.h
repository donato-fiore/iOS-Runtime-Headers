...
@property (retain, nonatomic) NSObject<BSInvalidatable> *addWidgetSheetKeyboardFocusAssertion; // ivar: _addWidgetSheetKeyboardFocusAssertion
...
@property (retain, nonatomic) NSSet *floatingDockBehaviorAssertions; // ivar: _floatingDockBehaviorAssertions
@property (retain, nonatomic) NSHashTable *floatingDockControllerObservers; // ivar: _floatingDockControllerObservers
...
@property (retain, nonatomic) NSObject<BSInvalidatable> *keepTodayViewIconImagesStaticAssertion; // ivar: _keepTodayViewIconImagesStaticAssertion
@property (retain, nonatomic) _UILegibilitySettings *legibilitySettings; // ivar: _legibilitySettings
@property (readonly, weak, nonatomic) SBWindowScene *mainDisplayWindowScene; // ivar: _mainDisplayWindowScene
@property (nonatomic) CGFloat maxPresentationOffset; // ivar: maxPresentationOffset
...
@property (readonly, nonatomic) NSUInteger possibleInterfaceOrientations;
...
@property (readonly, nonatomic) PTSingleTestRecipe *runWidgetDiscoverabilityTestRecipe; // ivar: _runWidgetDiscoverabilityTestRecipe
@property (retain, nonatomic) UIView<SBHLegibility> *scrollAccessoryAuxiliaryView; // ivar: _scrollAccessoryAuxiliaryView
@property (retain, nonatomic) NSObject<BSInvalidatable> *scrollAccessoryBorrowedForSearchPresentationAssertion; // ivar: _scrollAccessoryBorrowedForSearchPresentationAssertion
@property (retain, nonatomic) SBSpotlightPresentableViewController *searchPresentableViewController; // ivar: _searchPresentableViewController
@property (retain, nonatomic) NSObject<SBHSearchPresenting> *searchPresenter; // ivar: _searchPresenter
@property (nonatomic) NSInteger searchPresenterDestinationPageState; // ivar: _searchPresenterDestinationPageState
@property (nonatomic) NSUInteger searchPresenterOutstandingAnimationCount; // ivar: _searchPresenterOutstandingAnimationCount
@property (retain, nonatomic) NSObject<SBRootFolderPageTransition> *searchPresenterPageStateTransition; // ivar: _searchPresenterPageStateTransition
...
@property (readonly, nonatomic, getter=isSidebarPinned) BOOL sidebarPinned; // ivar: _sidebarPinned
...
@property (retain, nonatomic) SBTipsHomeScreenUsageObserver *tipsUsageObserver; // ivar: _tipsUsageObserver
...
-(BOOL)_allowsBadgingForApplicationBundleIdentifier:(id)arg0 ;
...
-(BOOL)iconManager:(id)arg0 isViewOnMainDisplayWindowScene:(id)arg1 ;
...
-(BOOL)isFloatingDockSupportedForIconManager:(id)arg0 ;
...
-(NSUInteger)iconManager:(id)arg0 supportedMultitaskingShortcutActionsForIconView:(id)arg1 ;
-(NSUInteger)maximumListCountForFoldersForIconManager:(id)arg0 ;
-(NSUInteger)possibleInterfaceOrientationsForIconManager:(id)arg0 ;
-(NSUInteger)supportedInterfaceOrientations;
-(NSUInteger)supportedMultitaskingShortcutActionsForBundleIdentifier:(id)arg0 ;
...
-(id)_appLibraryListLayoutProviderForWindowScene:(id)arg0 ;
...
-(id)_focusModeFromDoNotDisturbState:(id)arg0 ;
-(id)_libraryViewControllerForWindowScene:(id)arg0 ;
...
-(id)_setUpLibraryViewControllerForWindowScene:(id)arg0 ;
...
-(id)createFloatingDockControllerForWindowScene:(id)arg0 ;
-(id)createModalLibraryControllerForWindowScene:(id)arg0 withLibraryViewController:(id)arg1 ;
-(id)createStatusBarVisibiltyAssertionForWindowScene:(id)arg0 ;
...
-(id)iconManager:(id)arg0 floatingDockViewControllerForView:(id)arg1 ;
-(id)iconManager:(id)arg0 floatingDockViewControllerForViewController:(id)arg1 ;
...
-(id)initWithMainDisplayWindowScene:(id)arg0 alertItemsController:(id)arg1 analyticsClient:(id)arg2 applicationController:(id)arg3 applicationPlaceholderController:(id)arg4 assistantController:(id)arg5 coverSheetPresentationManager:(id)arg6 lockScreenManager:(id)arg7 mainDisplaySceneManager:(id)arg8 policyAggregator:(id)arg9 userInterfaceController:(id)arg10 widgetMetricsServer:(id)arg11 ;
-(id)launchActionsForIconView:(id)arg0 ;
-(id)launchActivationSettingsForIconView:(id)arg0 ;
-(id)launchURLForIconView:(id)arg0 ;
-(id)libraryViewControllersForIconManager:(id)arg0 ;
...
-(id)widgetIntroductionPreviewViewForIconManager:(id)arg0 ;
-(id)willBeginModifyingPresentationProgressForState:(SEL)arg0 animated:(NSInteger)arg1 needsInitialLayout:(BOOL)arg2 ;
-(id)windowForIconDragPreviewsForIconManager:(id)arg0 forWindowScene:(id)arg1 ;
...
-(void)_configureFloatingDockController:(id)arg0 forWindowScene:(id)arg1 ;
...
-(void)_updateFocusModeManagerWithDoNotDisturbState:(id)arg0 ;
...
-(void)addFloatingDockControllerObserver:(id)arg0 ;
-(void)addIconOcclusionReason:(NSUInteger)arg0 updateVisibleIcons:(BOOL)arg1 ;
-(void)addIconToHomeScreen:(id)arg0 ;
...
-(void)dismissHomeScreenOverlayControllerAnimated:(BOOL)arg0 completion:(id)arg1 ;
-(void)dismissHomeScreenOverlayUsingTransitionCoordinator:(id)arg0 ;
-(void)dismissHomeScreenOverlays;
-(void)dismissHomeScreenOverlaysAnimated:(BOOL)arg0 ;
-(void)dismissHomeScreenOverlaysAnimated:(BOOL)arg0 completion:(id)arg1 ;
-(void)dismissLibraryForIconManager:(id)arg0 windowScene:(id)arg1 animated:(BOOL)arg2 ;
-(void)dismissLibraryFromOverlayControllerAnimated:(BOOL)arg0 completion:(id)arg1 ;
-(void)dismissOverlaysForIconManager:(id)arg0 ;
-(void)dismissSearchView;
-(void)dismissTodayOverlay;
-(void)dismissTodayOverlayAnimated:(BOOL)arg0 ;
-(void)dismissTodayOverlayAnimated:(BOOL)arg0 completion:(id)arg1 ;
-(void)dismissTodayOverlayForIconManager:(id)arg0 ;
-(void)dismissTodayOverlaySpotlightAnimated:(BOOL)arg0 ;
-(void)displayFeatureIntroductionItem:(id)arg0 atLocation:(NSUInteger)arg1 ;
-(void)displayFeatureIntroductionsAtLocation:(NSUInteger)arg0 ;
...
-(void)getLeadingTopButtonFrame:(struct CGRect *)arg0 trailingTopButtonFrame:(struct CGRect *)arg1 ;
...
-(void)iconManager:(id)arg0 displayFeatureIntroductionItem:(id)arg1 atLocation:(NSUInteger)arg2 ;
-(void)iconManager:(id)arg0 displayFeatureIntroductionItemIfUnlocked:(id)arg1 ;
...
-(void)iconManager:(id)arg0 iconView:(id)arg1 configurationWillEndWithInteraction:(id)arg2 ;
...
-(void)iconManager:(id)arg0 setTemporaryIntent:(id)arg1 forIconWithIdentifier:(id)arg2 widgetUniqueIdentifier:(id)arg3 ;
...
-(void)iconManagerDidAddOrRemoveWidgetIcon:(id)arg0 ;
...
-(void)notifyFloatingDockControllerObserversDidRegister:(id)arg0 ;
...
-(void)presentLibraryCategoryPodFromOverlayControllerForCategoryIdentifier:(id)arg0 animated:(BOOL)arg1 completion:(id)arg2 ;
-(void)presentLibraryForIconManager:(id)arg0 windowScene:(id)arg1 animated:(BOOL)arg2 ;
-(void)presentLibraryFromOverlayControllerAnimated:(BOOL)arg0 completion:(id)arg1 ;
...
-(void)removeFloatingDockControllerObserver:(id)arg0 ;
