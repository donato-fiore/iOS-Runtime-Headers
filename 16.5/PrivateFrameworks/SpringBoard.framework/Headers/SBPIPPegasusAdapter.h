...
+(BOOL)isSupported;
-(BOOL)_layoutStateContainsSceneForSourceSceneSessionIdentifier:(id)arg0 bundleIdentifier:(id)arg1 windowScene:(id)arg2 ;
...
-(id)init;
-(id)pipController:(id)arg0 morphAnimatorDataSourceForMorphAnimatorController:(id)arg1 ;
-(void)_activateSceneWithPersistenceIdentifier:(id)arg0 pictureInPictureViewController:(id)arg1 completion:(id)arg2 ;
-(void)_actuallyUpdateBannerInsetsForExpanseBanner:(id)arg0 isSizeChanging:(BOOL)arg1 isFullScreen:(BOOL)arg2 ;
...
-(void)_enumerateContainerViewControllersForApplication:(id)arg0 scenePersistenceIdentifier:(id)arg1 usingBlock:(id)arg2 ;
...
-(void)_updateBannerInsetsForExpanseBanner:(id)arg0 isSizeChanging:(BOOL)arg1 isFullScreen:(BOOL)arg2 ;
...
-(void)pictureInPictureController:(id)arg0 requestActivationOfSceneWithPersistenceIdentier:(id)arg1 pictureInPictureViewController:(id)arg2 completion:(id)arg3 ;
