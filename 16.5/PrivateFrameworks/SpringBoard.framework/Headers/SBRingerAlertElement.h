...
@class SBUISystemApertureContentProvider, NSString, UIColor, SBUISystemApertureCAPackageContentProvider, SBUISystemApertureLabel, UIView, FBScene;
@protocol SBSystemApertureContextProviding, SBRingerNoticeUICoordinating, SAAlertHosting, SAInvalidatable, SBRingerAlertElementDelegate, SBUISystemApertureContentViewProviding;
...
@property (retain, nonatomic) SBUISystemApertureCAPackageContentProvider *leadingRingerContentViewProvider; // ivar: _leadingRingerContentViewProvider
...
@property (retain, nonatomic) NSObject<SBUISystemApertureContentViewProviding> *minimalRingerContentViewProvider; // ivar: _minimalRingerContentViewProvider
@property (retain, nonatomic) SBRingerVolumeSliderView *minimalSliderView; // ivar: _minimalSliderView
...
-(id)_bellImageForRingerSilent:(BOOL)arg0 ;
-(id)_colorForRingerSilent:(BOOL)arg0 ;
-(id)_containedVolumeSliderViewWithSize:(struct CGSize )arg0 layoutAxis:(NSInteger)arg1 ;
-(id)_leadingContentViewProviderForVolume;
-(id)_minimalContentForSource:(NSUInteger)arg0 ringerSilent:(BOOL)arg1 ;
