...
+(id)_breadcrumbPrimaryTitleForAppWithBundleID:(id)arg0 sceneHandle:(id)arg1 activatingSceneEntity:(id)arg2 withTransitionContext:(id)arg3 ;
+(id)_breadcrumbSceneIdForAppWithBundleID:(id)arg0 activatingSceneEntity:(id)arg1 withTransitionContext:(id)arg2 ;
