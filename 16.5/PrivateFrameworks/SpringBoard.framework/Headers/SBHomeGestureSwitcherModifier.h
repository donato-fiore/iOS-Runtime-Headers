...
@property (nonatomic) BOOL laysOutNeighboringCards; // ivar: _laysOutNeighboringCards
@property (nonatomic) BOOL providesHomeScreenDimmingAlpha; // ivar: _providesHomeScreenDimmingAlpha
