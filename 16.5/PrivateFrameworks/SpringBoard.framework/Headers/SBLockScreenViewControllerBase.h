...
@class UIViewController, SBFLockScreenActionContext, NSString, SBFLegacyWallpaperWakeAnimator, UIVisualEffectView;
...
@property (readonly, nonatomic) SBFLegacyWallpaperWakeAnimator *legacyWallpaperWakeAnimator; // ivar: _legacyWallpaperWakeAnimator
...
-(void)setInScreenOffMode:(BOOL)arg0 preservingCoverSheetPresentationState:(BOOL)arg1 ;
