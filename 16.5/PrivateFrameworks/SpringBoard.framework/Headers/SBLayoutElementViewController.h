...
@class UIViewController, SBOrientationTransformWrapperView, SBSDisplayLayoutElement, UIView, NSString, FBSDisplayIdentity;
@protocol SBAppPlatterDragSourceViewProviding, BSInvalidatable;
