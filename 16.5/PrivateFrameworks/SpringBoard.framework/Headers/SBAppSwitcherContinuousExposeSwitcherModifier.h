...
@interface SBAppSwitcherContinuousExposeSwitcherModifier : SBSwitcherModifier <SBSwitcherLayoutCalculationsCacheDelegate>

 {
    ...
    CGSize _cachedFittedContentSize;
...
-(NSUInteger)_indexOfAppLayoutInItsPile:(id)arg0 ;
...
-(id)_appLayoutsToCacheSnapshotsWithVisiblePileRange:(struct _NSRange )arg0 numberOfSnapshotsToCache:(NSUInteger)arg1 biasForward:(BOOL)arg2 ;
...
-(struct CGRect )_boundingFrameForPileAtIndex:(NSUInteger)arg0 withScrollOffsetApplied:(BOOL)arg1 ;
-(struct CGRect )_boundingFrameForPileWithIdentifier:(id)arg0 withScrollOffsetApplied:(BOOL)arg1 ;
-(struct CGRect )_frameForIndex:(NSUInteger)arg0 withScaleApplied:(BOOL)arg1 scrollOffsetApplied:(BOOL)arg2 ;
-(struct CGRect )_visibleSwitcherBoundsIncludingShadow;
...
-(struct _NSRange )_visiblePileRange;
