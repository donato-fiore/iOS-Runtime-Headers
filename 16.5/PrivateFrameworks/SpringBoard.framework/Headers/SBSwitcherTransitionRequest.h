...
@property (retain, nonatomic) SBDisplayItem *activatingDisplayItem; // ivar: _activatingDisplayItem
...
@property (nonatomic) NSInteger entityInsertionPolicy; // ivar: _entityInsertionPolicy
...
+(id)requestForTapAppLayoutEvent:(id)arg0 ;
+(id)requestForTapAppLayoutHeaderEvent:(id)arg0 ;
