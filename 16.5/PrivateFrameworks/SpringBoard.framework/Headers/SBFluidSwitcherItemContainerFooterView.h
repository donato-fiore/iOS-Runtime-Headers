...
@class SBFTouchPassThroughView, NSMutableArray, BSUIEmojiLabelView, NSArray, UITapGestureRecognizer, NSString;
...
@property (nonatomic) CGFloat iconHitTestOutset; // ivar: _iconHitTestOutset
