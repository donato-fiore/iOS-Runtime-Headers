...
@protocol SBViewMorphAnimatorObserver, SBViewMorphAnimatorDataSource, SBViewMorphAnimatorDelegate;
...
@property (weak, nonatomic) NSObject<SBViewMorphAnimatorDataSource> *dataSource; // ivar: _dataSource
...
@property (nonatomic) CGRect sourceContentContainerFrame; // ivar: _sourceContentContainerFrame
...
-(id)init;
-(id)initWithUUID:(id)arg0 windowScene:(id)arg1 direction:(NSInteger)arg2 ;
...
-(struct CGRect )_sourceContentContainerFrameForSourceView:(id)arg0 withTargetDataSource:(id)arg1 ;
