...
-(id)_sceneIdentityForApplication:(id)arg0 uniqueIdentifier:(id)arg1 targetContentIdentifier:(id)arg2 allowCanMatches:(BOOL)arg3 preferNewScene:(BOOL)arg4 allowSceneCreation:(BOOL)arg5 visibleIdentifiers:(id)arg6 excludingIdentifiers:(id)arg7 sceneSessionRole:(id)arg8 preferredDisplay:(id)arg9 ;
