...
@class STAirPlayStatusDomainPublisher, NSMutableDictionary, NSMutableSet, MPMediaControlsStatusBarStyleOverridesCoordinator, AVExternalPlaybackMonitor, AVRoutingSessionManager, AVRoutingSessionDestination, NSArray, NSString;
