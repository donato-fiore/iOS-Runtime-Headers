...
@protocol SBAppSwitcherSnapshotImageCacheObserver, SBReusableView, SBAppSwitcherPageContentView, SBAppSwitcherReusableSnapshotViewDelegate, BSDefaultObserver;
...
-(BOOL)_doNonUniformScalingForApplication:(id)arg0 ;
...
-(id)_separatorViewBezierPathWithWidth:(CGFloat)arg0 height:(CGFloat)arg1 ;
