...
@property (readonly, nonatomic) NSObject<OS_dispatch_queue> *_tasksWorkQueueBackground; // ivar: __tasksWorkQueueBackground
@property (readonly, nonatomic) NSObject<OS_dispatch_queue> *_tasksWorkQueueForeground; // ivar: __tasksWorkQueueForeground
...
@property (nonatomic) BOOL servesBackgroundIndexation; // ivar: _servesBackgroundIndexation
...
-(void)cancelAllActiveTasksBackground:(BOOL)arg0 foreground:(BOOL)arg1 ;
...
-(void)registerTask:(id)arg0 background:(BOOL)arg1 ;
