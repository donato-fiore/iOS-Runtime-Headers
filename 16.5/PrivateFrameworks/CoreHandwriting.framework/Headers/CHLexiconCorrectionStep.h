...
@property (nonatomic) BOOL shouldCreatePseudoTokens; // ivar: _shouldCreatePseudoTokens
...
-(id)initWithAutoCapitalizationMode:(int)arg0 shouldAutoCorrect:(BOOL)arg1 shouldAutoCapitalize:(BOOL)arg2 shouldCreatePseudoTokens:(BOOL)arg3 locale:(id)arg4 staticLexicon:(struct _LXLexicon *)arg5 customLexicon:(struct _LXLexicon *)arg6 phraseLexicon:(struct _LXLexicon *)arg7 customPhraseLexicon:(struct _LXLexicon *)arg8 spellChecker:(id)arg9 lmVocabulary:(*void)arg10 ovsStringChecker:(id)arg11 textReplacements:(id)arg12 ;
