...
@property (retain, nonatomic) CHPostProcessingManager *mergedResultPostProcessor; // ivar: _mergedResultPostProcessor
...
-(id)_changeableColumnCountUpdatedResult:(id)arg0 options:(id)arg1 ;
...
-(id)_fallbackStructuredResultForDrawing:(id)arg0 string:(id)arg1 score:(CGFloat)arg2 firstTokenHasPrecedingSpacePreference:(BOOL)arg3 ;
...
-(id)_postprocessingMergedRecognitionResult:(id)arg0 options:(id)arg1 ;
...
-(id)_tokenizedTextRecognitionResultForDrawing:(id)arg0 writingStatistics:(id)arg1 options:(id)arg2 shouldCancel:(id)arg3 ;
-(id)_tokenizedTextResultFromTextDecodingResult:(id)arg0 forceSingleCharacterMode:(BOOL)arg1 options:(id)arg2 strokeEndings:(struct vector<long, std::allocator<long>> )arg3 drawing:(id)arg4 firstTokenHasPrecedingSpacePreference:(BOOL)arg5 ;
...
-(id)textRecognitionResultForDrawing:(id)arg0 options:(id)arg1 writingStatistics:(id)arg2 shouldCancel:(id)arg3 ;
...
-(struct CGSize )_minSizeForReliableRescalingFromRecognizerOptions:(id)arg0 ;
...
-(void)_updateWordLanguageModel:(*void)arg0 ;
