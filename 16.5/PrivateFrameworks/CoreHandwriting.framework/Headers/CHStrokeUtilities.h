...
+(id)createDrawingForStrokes:(id)arg0 cancellationBlock:(id)arg1 ;
...
+(void)getAddedStrokes:(*id)arg0 removedStrokeIdentifiers:(*id)arg1 inStrokeProvider:(id)arg2 lastGroupingResult:(id)arg3 shouldCancel:(id)arg4 ;
