...
@property (retain, nonatomic) NLXSchemaCDMXPCEventProcessingEnded *ended; // ivar: _ended
@property (retain, nonatomic) NLXSchemaCDMXPCEventProcessingFailed *failed; // ivar: _failed
...
@property (retain, nonatomic) NLXSchemaCDMXPCEventProcessingStarted *startedOrChanged; // ivar: _startedOrChanged
