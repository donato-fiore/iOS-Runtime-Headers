...
@property (retain, nonatomic) NLXSchemaCDMAssetSetupContext *cdmAssetSetupContext; // ivar: _cdmAssetSetupContext
...
@property (retain, nonatomic) NLXSchemaCDMSetupMissingAssetsDetected *cdmSetupMissingAssetsDetected; // ivar: _cdmSetupMissingAssetsDetected
...
@property (retain, nonatomic) NLXSchemaCDMXPCEventProcessingContext *cdmXpcEventProcessingContext; // ivar: _cdmXpcEventProcessingContext
...
@property (nonatomic) BOOL hasCdmAssetSetupContext; // ivar: _hasCdmAssetSetupContext
...
@property (nonatomic) BOOL hasCdmSetupMissingAssetsDetected; // ivar: _hasCdmSetupMissingAssetsDetected
...
@property (nonatomic) BOOL hasCdmXpcEventProcessingContext; // ivar: _hasCdmXpcEventProcessingContext
