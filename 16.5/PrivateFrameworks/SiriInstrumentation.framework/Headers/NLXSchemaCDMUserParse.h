...
@property (retain, nonatomic) NLXSchemaCDMCorrectionOutcome *correctionOutcome; // ivar: _correctionOutcome
@property (nonatomic) BOOL hasComparableProbability;
@property (nonatomic) BOOL hasCorrectionOutcome; // ivar: _hasCorrectionOutcome
