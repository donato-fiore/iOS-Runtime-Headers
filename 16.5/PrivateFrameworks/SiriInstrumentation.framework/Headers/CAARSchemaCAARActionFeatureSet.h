...
@property (retain, nonatomic) CAARSchemaCAARActionLevelDisambiguationHistory *actionLevelDisambiguationHistory; // ivar: _actionLevelDisambiguationHistory
@property (retain, nonatomic) CAARSchemaCAARAppHistoryFeatures *appHistoryFeatures; // ivar: _appHistoryFeatures
@property (retain, nonatomic) CAARSchemaCAARAppLevelDisambiguationHistory *appLevelDisambiguationHistory; // ivar: _appLevelDisambiguationHistory
...
@property (nonatomic) BOOL hasActionLevelDisambiguationHistory; // ivar: _hasActionLevelDisambiguationHistory
@property (nonatomic) BOOL hasAppHistoryFeatures; // ivar: _hasAppHistoryFeatures
@property (nonatomic) BOOL hasAppLevelDisambiguationHistory; // ivar: _hasAppLevelDisambiguationHistory
...
@property (nonatomic) BOOL hasProactiveFeatures; // ivar: _hasProactiveFeatures
@property (nonatomic) BOOL isAppInForeground; // ivar: _isAppInForeground
@property (nonatomic) BOOL isAutoShortcutEnabled; // ivar: _isAutoShortcutEnabled
...
@property (nonatomic) BOOL isRepeatedFlowHandlerId; // ivar: _isRepeatedFlowHandlerId
...
@property (retain, nonatomic) CAARSchemaCAARProactiveFeatures *proactiveFeatures; // ivar: _proactiveFeatures
