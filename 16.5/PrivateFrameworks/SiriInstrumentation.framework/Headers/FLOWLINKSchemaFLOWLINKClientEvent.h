...
@property (retain, nonatomic) FLOWLINKSchemaFLOWLINKAppShortcutFirstRunConfirmationContext *appShortcutFirstRunConfirmationContext; // ivar: _appShortcutFirstRunConfirmationContext
...
@property (nonatomic) BOOL hasAppShortcutFirstRunConfirmationContext; // ivar: _hasAppShortcutFirstRunConfirmationContext
