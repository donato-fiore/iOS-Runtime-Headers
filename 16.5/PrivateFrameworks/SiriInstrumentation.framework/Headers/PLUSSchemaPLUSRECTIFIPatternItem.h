...
@property (nonatomic) BOOL hasItemDomainName; // ivar: _hasItemDomainName
@property (nonatomic) BOOL hasItemPayload; // ivar: _hasItemPayload
...
@property (copy, nonatomic) NSString *itemDomainName; // ivar: _itemDomainName
@property (copy, nonatomic) NSString *itemPayload; // ivar: _itemPayload
