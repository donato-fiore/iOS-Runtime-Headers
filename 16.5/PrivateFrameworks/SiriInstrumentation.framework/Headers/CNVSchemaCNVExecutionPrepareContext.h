...
#ifndef CNVSCHEMACNVEXECUTIONPREPARECONTEXT_H
#define CNVSCHEMACNVEXECUTIONPREPARECONTEXT_H
...
@property (retain, nonatomic) CNVSchemaCNVExecutionPrepareEnded *ended; // ivar: _ended
...
@property (retain, nonatomic) CNVSchemaCNVExecutionPrepareStarted *startedOrChanged; // ivar: _startedOrChanged
