...
@property (nonatomic) int appendingActionReadMessagesCount; // ivar: _appendingActionReadMessagesCount
...
@property (nonatomic) BOOL isLongMessage; // ivar: _isLongMessage
...
@property (nonatomic) BOOL isSenderShortCode; // ivar: _isSenderShortCode
