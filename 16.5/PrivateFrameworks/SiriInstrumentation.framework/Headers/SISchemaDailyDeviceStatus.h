...
@property (nonatomic) CGFloat availableDeviceStorageInMB; // ivar: _availableDeviceStorageInMB
...
@property (nonatomic) unsigned int deviceCapacityInGB; // ivar: _deviceCapacityInGB
@property (copy, nonatomic) NSString *deviceOs; // ivar: _deviceOs
@property (copy, nonatomic) NSString *deviceType; // ivar: _deviceType
@property (copy, nonatomic) NSArray *enabledDictationLocales; // ivar: _enabledDictationLocales
...
@property (nonatomic) BOOL hasRegionInfo; // ivar: _hasRegionInfo
...
@property (nonatomic) BOOL hasStorefrontId; // ivar: _hasStorefrontId
...
@property (nonatomic) NSUInteger queuedAtTimestampHourInMs; // ivar: _queuedAtTimestampHourInMs
@property (copy, nonatomic) NSString *regionInfo; // ivar: _regionInfo
...
@property (nonatomic) int storeCountryCode; // ivar: _storeCountryCode
...
-(id)enabledDictationLocalesAtIndex:(NSUInteger)arg0 ;
...
-(int)getAnyEventType;
-(void)addEnabledDictationLocales:(id)arg0 ;
