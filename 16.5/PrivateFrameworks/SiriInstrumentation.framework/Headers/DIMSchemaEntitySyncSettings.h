...
#ifndef DIMSCHEMAENTITYSYNCSETTINGS_H
#define DIMSCHEMAENTITYSYNCSETTINGS_H
...
@property (nonatomic) BOOL isMediaEntitySyncEnabled; // ivar: _isMediaEntitySyncEnabled
