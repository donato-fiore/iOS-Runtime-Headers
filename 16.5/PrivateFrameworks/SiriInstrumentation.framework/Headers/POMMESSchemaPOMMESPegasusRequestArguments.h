...
@property (nonatomic) BOOL hasPersonalDomainFallback; // ivar: _hasPersonalDomainFallback
...
@property (copy, nonatomic) NSString *personalDomainFallback; // ivar: _personalDomainFallback
