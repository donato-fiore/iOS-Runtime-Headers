...
@property (nonatomic) BOOL isAlwaysShowSiriCaptionsEnabled; // ivar: _isAlwaysShowSiriCaptionsEnabled
@property (nonatomic) BOOL isAlwaysShowSpeechEnabled; // ivar: _isAlwaysShowSpeechEnabled
...
@property (nonatomic) BOOL isShowAppsBehindSiriEnabled; // ivar: _isShowAppsBehindSiriEnabled
