...
#ifndef CNVSCHEMACNVFLOWPLUGINEXECUTIONCONTEXT_H
#define CNVSCHEMACNVFLOWPLUGINEXECUTIONCONTEXT_H
...
@property (retain, nonatomic) CNVSchemaCNVFlowPluginExecutionEnded *ended; // ivar: _ended
...
@property (retain, nonatomic) CNVSchemaCNVFlowPluginExecutionStarted *startedOrChanged; // ivar: _startedOrChanged
