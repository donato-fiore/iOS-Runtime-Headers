...
@property (nonatomic) unsigned int numTokensEstimatedExamined; // ivar: _numTokensEstimatedExamined
@property (nonatomic) unsigned int numTokensEstimatedRejected; // ivar: _numTokensEstimatedRejected
