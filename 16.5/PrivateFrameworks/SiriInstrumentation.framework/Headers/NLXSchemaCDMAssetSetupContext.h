...
@property (retain, nonatomic) NLXSchemaCDMAssetSetupEnded *ended; // ivar: _ended
@property (retain, nonatomic) NLXSchemaCDMAssetSetupFailed *failed; // ivar: _failed
...
@property (retain, nonatomic) NLXSchemaCDMAssetSetupStarted *startedOrChanged; // ivar: _startedOrChanged
