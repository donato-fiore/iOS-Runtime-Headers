...
@property (retain, nonatomic) CNVSchemaCNVFindFlowEnded *ended; // ivar: _ended
...
@property (retain, nonatomic) CNVSchemaCNVFindFlowStarted *startedOrChanged; // ivar: _startedOrChanged
