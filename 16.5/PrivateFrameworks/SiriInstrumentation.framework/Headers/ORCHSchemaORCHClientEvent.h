...
@property (retain, nonatomic) ORCHSchemaORCHAceCommandContext *aceCommandContext; // ivar: _aceCommandContext
...
@property (nonatomic) BOOL hasAceCommandContext; // ivar: _hasAceCommandContext
...
@property (nonatomic) BOOL hasTrpFinalized; // ivar: _hasTrpFinalized
...
@property (retain, nonatomic) ORCHSchemaORCHTRPFinalized *trpFinalized; // ivar: _trpFinalized
