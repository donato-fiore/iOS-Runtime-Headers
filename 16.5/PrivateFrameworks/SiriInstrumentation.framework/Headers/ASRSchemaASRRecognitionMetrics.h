...
@property (nonatomic) NSUInteger appleNeuralEngineCpuTimeInNs; // ivar: _appleNeuralEngineCpuTimeInNs
...
@property (nonatomic) NSUInteger cpuInstructionsInMillionsPerSecond; // ivar: _cpuInstructionsInMillionsPerSecond
...
@property (nonatomic) NSUInteger inverseTextNormalizationDurationForFinalResultInNs; // ivar: _inverseTextNormalizationDurationForFinalResultInNs
...
@property (nonatomic) unsigned int numberOfInverseTextNormalizationRuns; // ivar: _numberOfInverseTextNormalizationRuns
@property (nonatomic) unsigned int numberOfSecondaryPassRuns; // ivar: _numberOfSecondaryPassRuns
@property (nonatomic) NSUInteger pageInsWaitTimeInNs; // ivar: _pageInsWaitTimeInNs
...
@property (nonatomic) NSUInteger secondaryPassDurationInNs; // ivar: _secondaryPassDurationInNs
