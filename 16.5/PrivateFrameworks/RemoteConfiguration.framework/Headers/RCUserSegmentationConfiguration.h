...
@property (readonly, copy, nonatomic) NSString *todayEndpointURLString; // ivar: _todayEndpointURLString
...
-(id)initWithForegroundRefreshRate:(NSUInteger)arg0 backgroundRefreshRate:(NSUInteger)arg1 modThreshold:(NSUInteger)arg2 modMax:(NSUInteger)arg3 endpointURLString:(id)arg4 widgetEndpointURLString:(id)arg5 todayEndpointURLString:(id)arg6 ;
