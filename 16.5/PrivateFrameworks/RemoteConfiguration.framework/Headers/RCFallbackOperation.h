...
@property (nonatomic) CGFloat fallbackTimeoutDuration; // ivar: _fallbackTimeoutDuration
...
-(void)_fetchConfigurationWithURL:(id)arg0 requestKey:(id)arg1 enableExtraLogs:(BOOL)arg2 fallbackTimeoutDuration:(CGFloat)arg3 ;
