...
-(void)appendIntegerMap:(id)arg0 withName:(id)arg1 keyFormat:(NSInteger)arg2 valueBlock:(id)arg3 ;
-(void)appendIntegerSet:(id)arg0 withName:(id)arg1 format:(NSInteger)arg2 ;
