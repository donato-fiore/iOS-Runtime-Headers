...
-(id)responseWithAttributesMatchingProactiveGrammarForMessage:(id)arg0 languageID:(id)arg1 kbdInputModes:(id)arg2 ;
-(id)responseWithAttributesMatchingProactiveGrammarForMessageImp:(id)arg0 languageID:(*id)arg1 kbdInputModes:(id)arg2 ;
...
-(void)responseWithAttributesMatchingProactiveGrammarForMessage:(id)arg0 languageID:(id)arg1 kbdInputModes:(id)arg2 completionBlock:(id)arg3 ;
