...
@class UIViewController, UICollectionView, NSLayoutConstraint, NSString, UIDocumentInteractionController, UIButton, UIAction, NSURL, UIImageView, UIView;
...
@property (weak) UIPrintPanelViewController *printPanelViewController; // ivar: _printPanelViewController
