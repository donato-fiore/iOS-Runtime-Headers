...
@property (retain) NSMutableArray *cachedInRangeIndexes; // ivar: _cachedInRangeIndexes
@property (retain) NSMutableDictionary *cachedSheetImages; // ivar: _cachedSheetImages
@property NSInteger cachedSheetNumber; // ivar: _cachedSheetNumber
@property NSInteger cachedTotalPageCount; // ivar: _cachedTotalPageCount
@property NSInteger cachedTotalSheetCount; // ivar: _cachedTotalSheetCount
...
-(id)_drawPageContextIntoImage:(NSInteger)arg0 ;
-(id)_drawPageWithLayoutIntoImage:(NSInteger)arg0 previewInfo:(id)arg1 ;
-(id)init;
-(id)quicklookPageThumbnailAtIndex:(NSInteger)arg0 ;
-(id)sheetImageForItemAt:(NSInteger)arg0 ;
