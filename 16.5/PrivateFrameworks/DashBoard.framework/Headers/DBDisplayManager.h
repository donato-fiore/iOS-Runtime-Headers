...
@class CRCarPlayAppPolicyEvaluator, DBClusterControlChannel, FBSDisplayLayoutPublisher, NSString, NSMutableDictionary, NSMutableSet, FBSceneManager, PDCPreflightManager, CARSessionStatus;
...
@property (retain, nonatomic) PDCPreflightManager *preflightManager; // ivar: _preflightManager
