...
@class UIWindow, UIView, NSString, FBSDisplayConfiguration, FBSDisplayIdentity, NSMutableDictionary, NSHashTable, UIScreen, CARScreenInfo, CHSWidgetHost;
...
@property (retain, nonatomic) NSObject<BSInvalidatable> *dispatchingFocusAssertion; // ivar: _dispatchingFocusAssertion
@property (retain, nonatomic) NSObject<BSInvalidatable> *dispatchingSystemAssertion; // ivar: _dispatchingSystemAssertion
...
@property (retain, nonatomic) CHSWidgetHost *widgetHost; // ivar: _widgetHost
...
-(void)setupFocusRulesForDisplayWithConfiguration:(id)arg0 ;
-(void)setupSystemRulesForDisplayWithConfiguration:(id)arg0 ;
