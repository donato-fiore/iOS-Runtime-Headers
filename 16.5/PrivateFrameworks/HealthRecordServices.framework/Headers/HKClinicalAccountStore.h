...
-(id)_clientQueueFailableActionHandlerWithCompletion:(SEL)arg0 ;
...
-(void)deleteAccountWithIdentifier:(id)arg0 deletionReason:(NSInteger)arg1 completion:(id)arg2 ;
-(void)deviceConfigurationSupportsHealthRecords:(id)arg0 ;
...
-(void)fetchAccountsForGatewaysWithExternalIDs:(id)arg0 completion:(id)arg1 ;
...
-(void)simulateAccountDownloadOverdueWithIdentifier:(id)arg0 stage:(NSInteger)arg1 completion:(id)arg2 ;
