...
-(id)copyAsOriginalResourceObjectWithFirstSeenDate:(id)arg0 originInformation:(id)arg1 existingRowID:(id)arg2 ingestedOnLocalDevice:(BOOL)arg3 country:(id)arg4 ;
