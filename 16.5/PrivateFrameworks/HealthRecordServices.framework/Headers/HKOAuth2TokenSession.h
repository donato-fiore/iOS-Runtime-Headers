...
@property (readonly, copy, nonatomic) NSString *pkceVerifier; // ivar: _pkceVerifier
...
-(id)initWithCode:(id)arg0 query:(id)arg1 requestedScope:(id)arg2 state:(id)arg3 pkceVerifier:(id)arg4 ;
