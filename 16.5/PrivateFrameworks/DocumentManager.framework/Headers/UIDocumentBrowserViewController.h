...
@class UIViewController, UIView, NSURL, _UIRemoteViewController, NSArray, UIColor, DOCConfiguration, NSString, _UIResilientRemoteViewContainerViewController, NSOperationQueue;
@protocol DOCHostDocumentBrowserViewControllerInterface, DOCViewServiceErrorViewControllerDelegate, _UIRemoteViewControllerContaining, DOCRemoteViewControllerDelegate, UIAdaptivePresentationControllerDelegate, DOCAppearanceCustomization, NSCoding, UIDocumentBrowserViewControllerDelegate, DOCServiceDocumentBrowserViewControllerInterface;


#import "DOCAppearance.h"
#import "DOCDocBrowserVC_UIActivityViewController.h"

@interface UIDocumentBrowserViewController : UIViewController <DOCHostDocumentBrowserViewControllerInterface, DOCViewServiceErrorViewControllerDelegate, _UIRemoteViewControllerContaining, DOCRemoteViewControllerDelegate, UIAdaptivePresentationControllerDelegate, DOCAppearanceCustomization, NSCoding>
...
@property (retain, nonatomic) UIViewController *dummySplitViewController; // ivar: _dummySplitViewController
...
+(struct CGSize )preferredPickerContentSizeForWindow:(id)arg0 ;
-(BOOL)_delegateRespondsToSelector:(SEL)arg0 ;
-(BOOL)_shouldConsultDelegateShouldShowActivityViewControllerForItemBookmarks:(id)arg0 ;
-(BOOL)canBecomeFirstResponder;
-(BOOL)canPerformAction:(SEL)arg0 withSender:(id)arg1 ;
-(BOOL)supportsRemovableFileProvidersForConfiguration:(id)arg0 ;
-(NSInteger)preferredStatusBarStyle;
-(id)_activityViewControllerWithItemBookmarks:(id)arg0 isForTitleMenuFolderSharing:(BOOL)arg1 popoverTracker:(id)arg2 isContentManaged:(BOOL)arg3 additionalActivities:(id)arg4 activityRunner:(id)arg5 ;
...
-(void)_didImportDocumentAtURL:(id)arg0 toDestinationItemBookmark:(id)arg1 ;
-(void)_didPickItemBookmarks:(id)arg0 ;
-(void)_didRequestDocumentCreationWithHandler:(id)arg0 ;
-(void)_didTriggerBarButtonWithUUID:(id)arg0 ;
-(void)_didTriggerCustomActionWithIdentifier:(id)arg0 onItemBookmarks:(id)arg1 ;
-(void)_displayActivityControllerWithItemBookmarks:(id)arg0 popoverTracker:(id)arg1 isContentManaged:(BOOL)arg2 additionalActivities:(id)arg3 activityProxy:(id)arg4 ;
...
-(void)_fallbackRenameDocumentAtURL:(id)arg0 proposedName:(id)arg1 completionHandler:(id)arg2 ;
-(void)_importDocumentAtURL:(id)arg0 neighbourURL:(id)arg1 mode:(NSUInteger)arg2 completionHandler:(id)arg3 ;
-(void)_instantiateRemoteViewControllerWithCompletion:(id)arg0 ;
-(void)_presentActivityViewControllerForItemBookmarks:(id)arg0 withPopoverTracker:(id)arg1 isContentManaged:(BOOL)arg2 additionalActivities:(id)arg3 activityProxy:(id)arg4 ;
...
-(void)manageOverrideIfNecessaryForPresentationController:(id)arg0 ;
-(void)performKeyCommandNoOpOnHostSide:(id)arg0 ;
-(void)preferredContentSizeDidChangeForChildContentContainer:(id)arg0 ;
-(void)prepareItemBookmarks:(id)arg0 forMode:(NSUInteger)arg1 usingBookmark:(BOOL)arg2 completionBlock:(id)arg3 ;
-(void)prepareItemBookmarks:(id)arg0 usingBookmark:(BOOL)arg1 completionBlock:(id)arg2 ;
...
-(void)renameDocumentAtURL:(id)arg0 proposedName:(id)arg1 completionHandler:(id)arg2 ;
