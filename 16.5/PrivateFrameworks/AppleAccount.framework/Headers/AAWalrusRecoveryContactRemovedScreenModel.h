...
#ifndef AAWALRUSRECOVERYCONTACTREMOVEDSCREENMODEL_H
#define AAWALRUSRECOVERYCONTACTREMOVEDSCREENMODEL_H
...
@property (copy, nonatomic) NSString *leftBarButton; // ivar: _leftBarButton
...
-(id)initWithHasRecoveryContact:(BOOL)arg0 hasRecoveryKey:(BOOL)arg1 ;
-(void)_setupModelWithHasRecoveryContact:(BOOL)arg0 hasRecoveryKey:(BOOL)arg1 ;
