...
@property (readonly, nonatomic) BOOL isAcceptedAndShared; // ivar: _isAcceptedAndShared
@property (readonly, nonatomic) BOOL isIdMSConfirmed; // ivar: _isIdMSConfirmed
...
-(id)initWithID:(id)arg0 status:(NSInteger)arg1 handle:(id)arg2 firstName:(id)arg3 lastName:(id)arg4 displayName:(id)arg5 isAcceptedAndShared:(BOOL)arg6 isIdMSConfirmed:(BOOL)arg7 ;
