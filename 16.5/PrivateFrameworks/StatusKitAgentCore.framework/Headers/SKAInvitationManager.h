...
@property (retain, nonatomic) NSMutableDictionary *outgoingInvitationMapping; // ivar: _outgoingInvitationMapping
...
-(id)_invitationMessageForPresenceChannel:(id)arg0 ;
...
-(void)handleIncomingInvitationMessage:(id)arg0 fromHandle:(id)arg1 fromID:(id)arg2 toHandle:(id)arg3 messageGuid:(id)arg4 ;
...
-(void)outgoingMessageWithIdentifier:(id)arg0 fromHandle:(id)arg1 toHandle:(id)arg2 didSendWithSuccess:(BOOL)arg3 ;
...
-(void)rollPresenceChannelWithPresenceIdentifier:(id)arg0 isPersonal:(BOOL)arg1 completion:(id)arg2 ;
...
-(void)sendSelfInvitationForPresenceChannelWithPresenceIdentifier:(id)arg0 isPersonal:(BOOL)arg1 completion:(id)arg2 ;
