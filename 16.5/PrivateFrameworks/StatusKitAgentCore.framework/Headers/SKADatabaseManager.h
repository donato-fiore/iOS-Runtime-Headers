...
-(BOOL)decomissionChannelWithIdentifier:(id)arg0 databaseContext:(id)arg1 ;
...
-(BOOL)deleteInvitedUserForHandle:(id)arg0 presenceChannel:(id)arg1 databaseContext:(id)arg2 ;
...
-(BOOL)deleteRemovedUserWithHandle:(id)arg0 presenceIdentifier:(id)arg1 databaseContext:(id)arg2 ;
...
-(BOOL)setCurrentCheckpointForChannel:(id)arg0 checkpoint:(NSUInteger)arg1 databaseContext:(id)arg2 ;
-(NSUInteger)currentCheckpointForChannel:(id)arg0 databaseContext:(id)arg1 ;
-(id)_existingChannelCheckpointForChannelIdentifier:(id)arg0 databaseContext:(id)arg1 ;
-(id)_existingChannelsForChannelIdentifier:(id)arg0 databaseContext:(id)arg1 ;
-(id)_existingChannelsForChannelIdentifier:(id)arg0 isPersonal:(BOOL)arg1 databaseContext:(id)arg2 ;
-(id)_existingChannelsForDatabaseChannel:(id)arg0 databaseContext:(id)arg1 ;
-(id)_existingChannelsForPresenceIdentifier:(id)arg0 isPersonal:(BOOL)arg1 databaseContext:(id)arg2 ;
...
-(id)_existingRemovedUsersForHandle:(id)arg0 presenceIdentifier:(id)arg1 databaseContext:(id)arg2 ;
...
-(id)createPresenceChannelForPresenceIdentifier:(id)arg0 channelIdentifier:(id)arg1 channelToken:(id)arg2 peerKey:(id)arg3 serverKey:(id)arg4 membershipKey:(id)arg5 creationDate:(id)arg6 isPersonal:(BOOL)arg7 databaseContext:(id)arg8 ;
-(id)createReceivedInvitationForChannel:(id)arg0 senderHandle:(id)arg1 invitedHandle:(id)arg2 invitationIdentifier:(id)arg3 dateInvitationCreated:(id)arg4 incomingRatchetState:(id)arg5 presenceIdentifier:(id)arg6 channelToken:(id)arg7 serverKey:(id)arg8 peerKey:(id)arg9 invitationPayload:(id)arg10 databaseContext:(id)arg11 ;
-(id)createRemovedUserWithHandle:(id)arg0 dateRemoved:(id)arg1 presenceIdentifier:(id)arg2 databaseContext:(id)arg3 ;
...
-(id)existingChannelForPresenceIdentifier:(id)arg0 isPersonal:(BOOL)arg1 databaseContext:(id)arg2 ;
...
-(id)existingRemovedUserWithHandle:(id)arg0 presenceIdentifier:(id)arg1 withDatabaseContext:(id)arg2 ;
