...
-(BOOL)isFromIDFromSelfAccount:(id)arg0 ;
-(BOOL)isHandleAvailableToMessageFrom:(id)arg0 ;
-(BOOL)sendMessage:(id)arg0 toHandle:(id)arg1 fromHandle:(id)arg2 limitToPresenceCapable:(BOOL)arg3 identifier:(*id)arg4 error:(*id)arg5 ;
-(BOOL)sendMessage:(id)arg0 toHandles:(id)arg1 fromHandle:(id)arg2 limitToPresenceCapable:(BOOL)arg3 identifier:(*id)arg4 error:(*id)arg5 ;
-(BOOL)sendMessageToSelfDevices:(id)arg0 limitToPresenceCapable:(BOOL)arg1 identifier:(*id)arg2 error:(*id)arg3 ;
-(id)deviceToken;
