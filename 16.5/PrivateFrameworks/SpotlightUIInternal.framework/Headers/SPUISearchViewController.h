...
-(void)performAutoShortcutDisablement:(id)arg0 forAllAutoShortcutsFromApp:(BOOL)arg1 ;
-(void)performCommand:(id)arg0 ;
-(void)performProactiveCommand:(id)arg0 ;
...
-(void)setFooterViewsForProactive:(id)arg0 forResults:(id)arg1 ;
