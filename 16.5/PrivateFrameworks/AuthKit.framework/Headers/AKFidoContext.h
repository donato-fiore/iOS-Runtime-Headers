...
@property (copy, nonatomic) NSString *incorrectKeyPresentedMessage; // ivar: _incorrectKeyPresentedMessage
...
@property (nonatomic) BOOL useAlternativeKeysIcon; // ivar: _useAlternativeKeysIcon
