...
@property (copy, nonatomic) NSArray *custodianInfos; // ivar: _custodianInfos
...
@property (copy, nonatomic) NSNumber *groupKitEligibility; // ivar: _groupKitEligibility
...
@property (copy, nonatomic) NSNumber *serverExperimentalFeatures; // ivar: _serverExperimentalFeatures
...
@property (copy, nonatomic) NSNumber *webAccessEnabled; // ivar: _webAccessEnabled
...
-(void)_parseCustodiansInfo:(id)arg0 ;
