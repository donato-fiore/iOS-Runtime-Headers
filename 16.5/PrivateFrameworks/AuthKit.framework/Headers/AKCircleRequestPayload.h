...
@class NSString, NSData, NSNumber, NSUUID, NSDictionary, AKPushMessage;
...
@property (nonatomic, getter=isURLResponse) BOOL URLResponse; // ivar: _URLResponse
...
@property (copy, nonatomic) NSNumber *localPresenceFound; // ivar: _localPresenceFound
@property (copy, nonatomic) NSNumber *presenceCheckPassed; // ivar: _presenceCheckPassed
@property (nonatomic) BOOL presenceFallbackApproved; // ivar: _presenceFallbackApproved
@property (nonatomic) NSInteger presenceMode; // ivar: _presenceMode
@property (retain, nonatomic) NSUUID *presenceSID; // ivar: _presenceSID
...
+(id)_dictionaryWithPlistData:(id)arg0 ;
+(id)payloadWithMessage:(id)arg0 ;
+(id)payloadWithResponseData:(id)arg0 forCircleStep:(NSUInteger)arg1 ;
