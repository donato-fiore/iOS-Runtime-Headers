...
@interface AKAccountManager : NSObject {
    ...
    os_unfair_lock_s _iTunesAccountTypeLock;
...
-(BOOL)isFidoForAccount:(id)arg0 ;
-(BOOL)isManagedAppleIDForAccount:(id)arg0 ;
-(BOOL)isNotificationEmailAvailableForAccount:(id)arg0 ;
...
-(BOOL)privateAttestationEnabledForAccount:(id)arg0 ;
...
-(BOOL)userIsSeniorForAccount:(id)arg0 ;
...
-(NSUInteger)managedOrganizationTypeForAccount:(id)arg0 ;
...
-(id)_isSilentEscrowRecordRepairEnabledForAccount:(id)arg0 ;
...
-(id)custodianInfosForAccount:(id)arg0 ;
-(id)custodianLastModifiedForAccount:(id)arg0 ;
...
-(id)groupKitEligibilityForAccount:(id)arg0 ;
...
-(id)init;
-(id)isSilentEscrowRecordRepairEnabledForAccount:(id)arg0 ;
-(id)managedOrganizationNameForAccount:(id)arg0 ;
-(id)masterTokenForAccount:(id)arg0 ;
-(id)mostRecentlyUsedAuthKitAccount;
-(id)notificationEmailForAccount:(id)arg0 ;
...
-(id)preferredAccountUsingStoreServiceFromAccounts:(id)arg0 ;
...
-(id)serverExperimentalFeaturesForAccount:(id)arg0 ;
-(id)servicesUsingAccount:(id)arg0 ;
-(id)settingsServiceTokenForAccount:(id)arg0 ;
-(id)transportableAuthKitAccount:(id)arg0 ;
-(id)webAccessEnabledForAccount:(id)arg0 ;
-(void)_clearRawPasswordForAccount:(id)arg0 ;
...
-(void)_triggerSilentTTRFor:(NSUInteger)arg0 ;
...
-(void)setCustodianInfos:(id)arg0 forAccount:(id)arg1 ;
-(void)setCustodianLastModified:(id)arg0 forAccount:(id)arg1 ;
...
-(void)setFido:(BOOL)arg0 forAccount:(id)arg1 ;
-(void)setForwardingEmail:(id)arg0 forAccount:(id)arg1 ;
-(void)setGivenName:(id)arg0 forAccount:(id)arg1 ;
-(void)setGroupKitEligibility:(id)arg0 forAccount:(id)arg1 ;
-(void)setHasMDM:(BOOL)arg0 forAccount:(id)arg1 ;
-(void)setIsNotificationEmailAvailable:(BOOL)arg0 forAccount:(id)arg1 ;
-(void)setManagedOrganizationName:(id)arg0 forAccount:(id)arg1 ;
-(void)setManagedOrganizationType:(NSUInteger)arg0 forAccount:(id)arg1 ;
-(void)setNotificationEmail:(id)arg0 forAccount:(id)arg1 ;
-(void)setPhoneAsAppleID:(BOOL)arg0 forAccount:(id)arg1 ;
-(void)setPrimaryEmailAddress:(id)arg0 forAccount:(id)arg1 ;
-(void)setPrivateAttestationEnabled:(BOOL)arg0 forAccount:(id)arg1 ;
...
-(void)setServerExperimentalFeatures:(id)arg0 forAccount:(id)arg1 ;
-(void)setSilentEscrowRecordRepairEnabled:(id)arg0 forAccount:(id)arg1 ;
-(void)setUserIsSenior:(BOOL)arg0 forAccount:(id)arg1 ;
-(void)setUserUnderage:(BOOL)arg0 forAccount:(id)arg1 ;
-(void)setVerifiedPrimaryEmail:(BOOL)arg0 forAccount:(id)arg1 ;
-(void)setWebAccessEnabled:(BOOL)arg0 forAccount:(id)arg1 ;
