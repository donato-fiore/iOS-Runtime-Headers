...
@property (retain, nonatomic) NSString *alternativeButtonString; // ivar: _alternativeButtonString
...
@property (copy, nonatomic) NSString *dependentAltDSID; // ivar: _dependentAltDSID
...
@property (nonatomic) BOOL deviceRegionRequired; // ivar: _deviceRegionRequired
@property (retain, nonatomic) NSData *displayImageData; // ivar: _displayImageData
...
@property (nonatomic) BOOL hideAlternativeButton; // ivar: _hideAlternativeButton
@property (nonatomic) BOOL hideCancelButton; // ivar: _hideCancelButton
@property (nonatomic) BOOL hideReasonString; // ivar: _hideReasonString
...
@property (copy, nonatomic) NSString *privacyBundleIdentifier; // ivar: _privacyBundleIdentifier
...
@property (retain, nonatomic) NSString *windowTitle; // ivar: _windowTitle
