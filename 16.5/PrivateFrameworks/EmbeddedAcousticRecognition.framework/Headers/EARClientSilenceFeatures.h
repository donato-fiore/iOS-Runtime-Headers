...
@property (nonatomic) NSUInteger inferenceTime; // ivar: _inferenceTime
...
-(id)initWithSilenceFramesCountMs:(CGFloat)arg0 silenceProbability:(CGFloat)arg1 silenceDurationMs:(CGFloat)arg2 silencePosterior:(CGFloat)arg3 processedAudioMs:(CGFloat)arg4 inferenceTime:(NSUInteger)arg5 ;
