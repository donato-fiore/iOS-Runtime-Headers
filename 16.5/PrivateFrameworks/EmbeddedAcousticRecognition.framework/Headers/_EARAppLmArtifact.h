...
+(BOOL)transitionArtifactAt:(id)arg0 toStage:(NSUInteger)arg1 configPath:(id)arg2 dataRoot:(id)arg3 estimationRoot:(id)arg4 minimize:(BOOL)arg5 saveTo:(id)arg6 ;
...
+(id)loadLmHandleFromArtifactAt:(id)arg0 configPath:(id)arg1 ;
+(id)loadLmHandleFromArtifactAt:(id)arg0 configPath:(id)arg1 ncsRoot:(id)arg2 ;
+(id)transitionArtifactAt:(id)arg0 toStage:(NSUInteger)arg1 configPath:(id)arg2 dataRoot:(id)arg3 estimationRoot:(id)arg4 minimize:(BOOL)arg5 ;
+(id)transitionArtifactAt:(id)arg0 toStage:(NSUInteger)arg1 configPath:(id)arg2 ncsRoot:(id)arg3 dataRoot:(id)arg4 estimationRoot:(id)arg5 minimize:(BOOL)arg6 ;
...
-(id)loadAppLmData:(id)arg0 dataRoot:(id)arg1 ;
-(id)loadAppLmData:(id)arg0 ncsRoot:(id)arg1 dataRoot:(id)arg2 ;
-(id)loadCustomPronData:(id)arg0 dataRoot:(id)arg1 ;
