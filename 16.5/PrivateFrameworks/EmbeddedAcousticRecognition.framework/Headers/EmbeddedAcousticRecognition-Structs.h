...
typedef struct optional<kaldi::Matrix<float>> {
    unk field0;
    char field1;
    Matrix<float> field2;
    BOOL field3;
} optional<kaldi::Matrix<float>>;

typedef struct TextEmbedder {
} // Error Processing Struct Fields

typedef struct __compressed_pair<quasar::TextEmbedder *, std::default_delete<quasar::TextEmbedder>> {
    TextEmbedder __value_;
} __compressed_pair<quasar::TextEmbedder *, std::default_delete<quasar::TextEmbedder>>;

typedef struct unique_ptr<quasar::TextEmbedder, std::default_delete<quasar::TextEmbedder>> {
    __compressed_pair<quasar::TextEmbedder *, std::default_delete<quasar::TextEmbedder>> __ptr_;
} unique_ptr<quasar::TextEmbedder, std::default_delete<quasar::TextEmbedder>>;

typedef struct NearestNeighborSearch {
} // Error Processing Struct Fields

typedef struct __compressed_pair<quasar::NearestNeighborSearch *, std::default_delete<quasar::NearestNeighborSearch>> {
    NearestNeighborSearch __value_;
} __compressed_pair<quasar::NearestNeighborSearch *, std::default_delete<quasar::NearestNeighborSearch>>;

typedef struct unique_ptr<quasar::NearestNeighborSearch, std::default_delete<quasar::NearestNeighborSearch>> {
    __compressed_pair<quasar::NearestNeighborSearch *, std::default_delete<quasar::NearestNeighborSearch>> __ptr_;
} unique_ptr<quasar::NearestNeighborSearch, std::default_delete<quasar::NearestNeighborSearch>>;
