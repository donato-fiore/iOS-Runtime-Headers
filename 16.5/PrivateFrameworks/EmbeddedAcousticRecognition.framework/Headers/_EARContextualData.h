...
+(void)initialize;
-(BOOL)addNamedEntity2:(id)arg0 metadata:(id)arg1 ;
...
-(void)iterNamedEntitySourceWithApplication:(id)arg0 task:(id)arg1 block:(id)arg2 ;
-(void)iterRankedContactSourceWithApplication:(id)arg0 block:(id)arg1 ;
-(void)iterRankedContactSourceWithApplication:(id)arg0 task:(id)arg1 block:(id)arg2 ;
