...
@property (readonly, nonatomic) NSString *romanization; // ivar: _romanization
...
-(id)description;
-(id)initWithLocale:(id)arg0 tokens:(id)arg1 confidence:(float)arg2 lowConfidence:(BOOL)arg3 metaInfo:(id)arg4 romanization:(id)arg5 ;
