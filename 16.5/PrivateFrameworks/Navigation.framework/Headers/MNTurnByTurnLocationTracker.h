...
@class GEONavigationMapMatcher, NSDate, GEODirectionsServiceRequest, NSTimer, NSMutableArray, GEOPathMatcher, NSString;
...
-(void)_setTargetLegIndex:(NSUInteger)arg0 ;
...
-(void)arrivalUpdater:(id)arg0 isApproachingEndOfLeg:(NSUInteger)arg1 ;
