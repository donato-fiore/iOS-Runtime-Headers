...
@class NSSet, NSUUID, NSMutableDictionary, NSArray, GEODirectionsRequest, GEODirectionsResponse, NSString, GEOComposedWaypoint, GEOResumeRouteHandle, GEOComposedRoute;
...
-(void)navigationServiceProxy:(id)arg0 didUpdateResumeRouteHandle:(id)arg1 ;
...
-(void)navigationServiceProxy:(id)arg0 didUpdateTargetLegIndex:(NSUInteger)arg1 ;
...
-(void)navigationServiceProxy:(id)arg0 isApproachingEndOfLeg:(NSUInteger)arg1 ;
...
-(void)navigationServiceProxyDidFinishLocationUpdate:(id)arg0 ;
