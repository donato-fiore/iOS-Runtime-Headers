...
-(void)navigationSessionManager:(id)arg0 didResumeNavigatingFromWaypoint:(id)arg1 endOfLegIndex:(NSUInteger)arg2 reason:(NSUInteger)arg3 ;
...
-(void)navigationSessionManager:(id)arg0 didUpdateDisplayETA:(id)arg1 remainingDistance:(id)arg2 batteryChargeInfo:(id)arg3 ;
...
-(void)navigationSessionManager:(id)arg0 didUpdateResumeRouteHandle:(id)arg1 ;
...
-(void)navigationSessionManager:(id)arg0 didUpdateTargetLegIndex:(NSUInteger)arg1 ;
...
-(void)navigationSessionManager:(id)arg0 isApproachingEndOfLeg:(NSUInteger)arg1 ;
...
-(void)navigationSessionManager:(id)arg0 willStartNavigationWithRoute:(id)arg1 navigationType:(NSInteger)arg2 request:(id)arg3 response:(id)arg4 simulationType:(NSInteger)arg5 isResumingMultipointRoute:(BOOL)arg6 ;
-(void)navigationSessionManager:(id)arg0 willStopWithReason:(NSUInteger)arg1 ;
...
-(void)navigationSessionManagerDidFinishLocationUpdate:(id)arg0 ;
