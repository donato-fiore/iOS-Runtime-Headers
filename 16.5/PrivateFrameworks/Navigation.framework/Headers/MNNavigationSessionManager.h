...
-(void)navigationSession:(id)arg0 didUpdateResumeRouteHandle:(id)arg1 ;
-(void)navigationSession:(id)arg0 didUpdateTargetLegIndex:(NSUInteger)arg1 ;
...
-(void)navigationSession:(id)arg0 isApproachingEndOfLeg:(NSUInteger)arg1 ;
...
-(void)navigationSession:(id)arg0 willStopWithReason:(NSUInteger)arg1 ;
...
-(void)navigationSessionDidFinishLocationUpdate:(id)arg0 ;
