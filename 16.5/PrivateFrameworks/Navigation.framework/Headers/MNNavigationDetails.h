...
@class NSArray, NSMapTable, NSMutableDictionary, geo_isolater, GEOComposedRoute, NSString, GEODirectionsRequest, GEODirectionsResponse, GEONavigationGuidanceState, GEOComposedWaypoint, GEOResumeRouteHandle;
...
@property (nonatomic) NSInteger desiredNavigationType; // ivar: _desiredNavigationType
