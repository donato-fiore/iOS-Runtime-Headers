...
#ifndef SFLEADINGTRAILINGCARDSECTION_H
#define SFLEADINGTRAILINGCARDSECTION_H

@class NSString, NSArray, NSDictionary, NSData;
@protocol SFLeadingTrailingCardSection, NSSecureCoding, NSCopying;
...
@property (nonatomic) CGFloat leadingToTrailingRatio; // ivar: _leadingToTrailingRatio
