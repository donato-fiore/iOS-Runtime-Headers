...
#ifndef SFCOMPACTROWCARDSECTION_H
#define SFCOMPACTROWCARDSECTION_H

@class NSString, NSArray, NSDictionary, NSData;
@protocol SFCompactRowCardSection, NSSecureCoding, NSCopying;
...
@property (nonatomic) BOOL isSubtitleDetatched; // ivar: _isSubtitleDetatched
