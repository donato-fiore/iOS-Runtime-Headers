...
@class NSURL, NSString, NSArray, NSDictionary, NSData;
@protocol SFMessageCardSection, NSSecureCoding, NSCopying;
...
@property (copy, nonatomic) NSURL *audioMessageURL; // ivar: _audioMessageURL
...
@property (retain, nonatomic) SFMessageAttachment *messageAttachment; // ivar: _messageAttachment
