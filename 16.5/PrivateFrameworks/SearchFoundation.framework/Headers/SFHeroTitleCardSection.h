...
#ifndef SFHEROTITLECARDSECTION_H
#define SFHEROTITLECARDSECTION_H

@class NSArray, NSString, NSDictionary, NSData;
@protocol SFHeroTitleCardSection, NSSecureCoding, NSCopying;
...
@property (nonatomic) NSUInteger maxVisibleButtonItems; // ivar: _maxVisibleButtonItems
