...
@protocol _SFPBLeadingTrailingCardSection, NSSecureCoding;
...
@property (copy, nonatomic) NSArray *leadingCardSections; // ivar: _leadingCardSections
@property (retain, nonatomic) _SFPBGraphicalFloat *leadingToTrailingRatio; // ivar: _leadingToTrailingRatio
...
@property (copy, nonatomic) NSArray *trailingCardSections; // ivar: _trailingCardSections
...
-(id)leadingCardSectionsAtIndex:(NSUInteger)arg0 ;
-(id)punchoutOptionsAtIndex:(NSUInteger)arg0 ;
-(id)trailingCardSectionsAtIndex:(NSUInteger)arg0 ;
-(void)addLeadingCardSections:(id)arg0 ;
-(void)addPunchoutOptions:(id)arg0 ;
-(void)addTrailingCardSections:(id)arg0 ;
