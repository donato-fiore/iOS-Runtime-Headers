...
@property (copy, nonatomic) NSString *attachmentSectionTitle; // ivar: _attachmentSectionTitle
@property (readonly, copy) NSString *debugDescription;
@property (readonly, copy) NSString *description;
@property (retain, nonatomic) _SFPBPunchout *disclaimerLearnMorePunchout; // ivar: _disclaimerLearnMorePunchout
@property (copy, nonatomic) NSString *disclaimerText; // ivar: _disclaimerText
@property (copy, nonatomic) NSString *dismissText; // ivar: _dismissText
@property (readonly) NSUInteger hash;
@property (readonly, nonatomic) NSData *jsonData;
@property (copy, nonatomic) NSString *reportOptionsSectionTitle; // ivar: _reportOptionsSectionTitle
