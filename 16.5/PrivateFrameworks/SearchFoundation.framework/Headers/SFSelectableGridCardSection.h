...
#ifndef SFSELECTABLEGRIDCARDSECTION_H
#define SFSELECTABLEGRIDCARDSECTION_H

@class NSString, NSArray, NSDictionary, NSNumber, NSData;
@protocol SFSelectableGridCardSection, NSSecureCoding, NSCopying;
...
@property (copy, nonatomic) NSNumber *initialSelectedIndex; // ivar: _initialSelectedIndex
