...
@protocol _SFPBInfoCardSection, NSSecureCoding;
...
@property (copy, nonatomic) NSArray *infoTuples; // ivar: _infoTuples
@property (nonatomic) NSUInteger initiallyVisibleTuples; // ivar: _initiallyVisibleTuples
...
-(id)infoTuplesAtIndex:(NSUInteger)arg0 ;
-(id)initWithDictionary:(id)arg0 ;
-(id)initWithFacade:(id)arg0 ;
-(id)initWithJSON:(id)arg0 ;
-(id)punchoutOptionsAtIndex:(NSUInteger)arg0 ;
-(void)addInfoTuples:(id)arg0 ;
