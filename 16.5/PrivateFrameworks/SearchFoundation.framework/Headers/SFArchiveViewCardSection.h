...
#ifndef SFARCHIVEVIEWCARDSECTION_H
#define SFARCHIVEVIEWCARDSECTION_H

@class NSData, NSString, NSArray, NSDictionary;
@protocol SFArchiveViewCardSection, NSSecureCoding, NSCopying;
...
@property (copy, nonatomic) NSData *archive; // ivar: _archive
