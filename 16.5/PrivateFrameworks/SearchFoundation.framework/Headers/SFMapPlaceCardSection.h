...
#ifndef SFMAPPLACECARDSECTION_H
#define SFMAPPLACECARDSECTION_H

@class NSString, NSArray, NSData, NSDictionary;
@protocol SFMapPlaceCardSection, NSSecureCoding, NSCopying;
...
@property (copy, nonatomic) NSData *detourInfoData; // ivar: _detourInfoData
