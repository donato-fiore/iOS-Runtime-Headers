...
#ifndef SFNEWSCARDSECTION_H
#define SFNEWSCARDSECTION_H

@class NSString, NSArray, NSDictionary, NSData;
@protocol SFNewsCardSection, NSSecureCoding, NSCopying;
...
@property (nonatomic) BOOL overlayTextInImage; // ivar: _overlayTextInImage
@property (copy, nonatomic) NSArray *parameterKeyPaths;
@property (copy, nonatomic) NSArray *previewButtonItems;
@property (retain, nonatomic) NSString *previewButtonItemsTitle;
@property (retain, nonatomic) SFCommand *previewCommand;
@property (retain, nonatomic) SFImage *providerImage; // ivar: _providerImage
@property (retain, nonatomic) SFRichText *providerTitle; // ivar: _providerTitle
...
@property (retain, nonatomic) SFRichText *subtitle; // ivar: _subtitle
