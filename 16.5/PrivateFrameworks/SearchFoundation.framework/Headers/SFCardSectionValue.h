...
@property (retain, nonatomic) SFAppIconCardSection *appIconCardSection; // ivar: _appIconCardSection
@property (retain, nonatomic) SFAppLinkCardSection *appLinkCardSection; // ivar: _appLinkCardSection
@property (retain, nonatomic) SFArchiveViewCardSection *archiveViewCardSection; // ivar: _archiveViewCardSection
...
@property (retain, nonatomic) SFButtonListCardSection *buttonListCardSection; // ivar: _buttonListCardSection
...
@property (retain, nonatomic) SFCommandRowCardSection *commandRowCardSection; // ivar: _commandRowCardSection
...
@property (retain, nonatomic) SFHeroTitleCardSection *heroTitleCardSection; // ivar: _heroTitleCardSection
...
@property (retain, nonatomic) SFLeadingTrailingCardSection *leadingTrailingCardSection; // ivar: _leadingTrailingCardSection
