...
@property (retain, nonatomic) _SFPBExpandInlineCommand *expandInlineCommand; // ivar: _expandInlineCommand
...
@property (retain, nonatomic) _SFPBTopic *normalizedTopic; // ivar: _normalizedTopic
...
@property (retain, nonatomic) _SFPBRejectPeopleInPhotoCommand *rejectPeopleInPhotoCommand; // ivar: _rejectPeopleInPhotoCommand
...
@property (retain, nonatomic) _SFPBSubscribeForUpdatesCommand *subscribeForUpdatesCommand; // ivar: _subscribeForUpdatesCommand
...
@property (retain, nonatomic) _SFPBViewEmailCommand *viewEmailCommand; // ivar: _viewEmailCommand
