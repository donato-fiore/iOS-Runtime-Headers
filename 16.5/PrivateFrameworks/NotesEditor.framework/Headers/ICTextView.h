...
@property (nonatomic) BOOL isPerformingHighlightUpdates; // ivar: _isPerformingHighlightUpdates
...
@property (nonatomic) BOOL needsHideOverlappingAttachmentViews; // ivar: _needsHideOverlappingAttachmentViews
...
@property (nonatomic) NSUInteger updatingContentSizeCount; // ivar: _updatingContentSizeCount
...
-(BOOL)isPreviewing;
-(BOOL)isSearchResultView:(id)arg0 ;
...
-(id)textAttachmentAtPoint:(struct CGPoint )arg0 ;
-(id)undoManager;
...
-(void)authorHighlightsControllerDidPerformHighlightUpdates:(id)arg0 ;
-(void)authorHighlightsControllerWillPerformHighlightUpdates:(id)arg0 ;
