...
@property (retain, nonatomic) NSObject<UIActivityItemsConfigurationProviding> *activityItemsConfigurationProvider; // ivar: _activityItemsConfigurationProvider
...
@property (retain, nonatomic) UIBarButtonItem *insertButton; // ivar: _insertButton
@property (retain, nonatomic) UIBarButtonItem *insertCenterButton; // ivar: _insertCenterButton
...
@property (retain, nonatomic) UIBarButtonItem *photoLibraryBarButton; // ivar: _photoLibraryBarButton
@property (retain, nonatomic) UIBarButtonItem *photoLibraryButton; // ivar: _photoLibraryButton
@property (retain, nonatomic) UIBarButtonItem *photoLibraryCenterButton; // ivar: _photoLibraryCenterButton
...
-(id)insertMenuWithSender:(id)arg0 ;
-(id)linkForSelection;
...
-(void)paperKitBundleDidMerge:(id)arg0 ;
...
-(void)setNote:(id)arg0 delayedForLaunch:(BOOL)arg1 successHandler:(id)arg2 ;
-(void)setNote:(id)arg0 overrideScrollState:(id)arg1 ;
...
-(void)updateActivityItemsConfigurationProviderWithNote:(id)arg0 ;
...
-(void)upgradeAllAttachmentsInNoteWithUpgradeHelper:(id)arg0 forSydney:(BOOL)arg1 ;
