...
-(id)initWithDevice:(id)arg0 width:(int)arg1 height:(int)arg2 pixelFormat0:(NSUInteger)arg3 pixelFormat1:(NSUInteger)arg4 mipmaps:(int)arg5 loadAction:(NSUInteger)arg6 clearColor0:(struct ? )arg7 clearColor1:(struct ? )arg8 ;
