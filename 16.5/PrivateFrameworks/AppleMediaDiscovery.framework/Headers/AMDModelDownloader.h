...
+(id)ensureNewVersionDirURLForModel:(id)arg0 withVersion:(NSUInteger)arg1 andCreationTime:(NSInteger)arg2 ;
...
+(id)unzipAndValidateCompiledModelBundle:(id)arg0 atLocation:(id)arg1 withVersion:(id)arg2 error:(*id)arg3 ;
+(id)unzipDownloadedModelBundle:(id)arg0 atLocation:(id)arg1 withVersion:(id)arg2 error:(*id)arg3 ;
+(id)unzipModel:(id)arg0 atLocation:(id)arg1 withVersion:(id)arg2 error:(*id)arg3 ;
+(id)updateAppTabInfoForWorkflows:(id)arg0 ;
...
+(void)unzipModelFile:(id)arg0 copyToDestination:(id)arg1 error:(*id)arg2 ;
