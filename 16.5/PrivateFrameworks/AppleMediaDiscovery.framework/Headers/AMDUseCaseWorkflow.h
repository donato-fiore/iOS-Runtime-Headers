...
@property (retain, nonatomic) NSString *secondaryModelId; // ivar: _secondaryModelId
@property (retain, nonatomic) AMDInputBuilder *secondaryModelInputBuilder; // ivar: _secondaryModelInputBuilder
@property (retain, nonatomic) AMDOutputBuilder *secondaryModelOutputBuilder; // ivar: _secondaryModelOutputBuilder
