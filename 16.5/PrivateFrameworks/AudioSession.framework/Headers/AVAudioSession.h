...
-(BOOL)setPreferredPersistentInputUIDs:(id)arg0 outputUIDs:(id)arg1 error:(*id)arg2 ;
...
-(id)privateMakePreferredPersistentRouteDictWithInputUIDs:(id)arg0 outputUIDs:(id)arg1 ;
