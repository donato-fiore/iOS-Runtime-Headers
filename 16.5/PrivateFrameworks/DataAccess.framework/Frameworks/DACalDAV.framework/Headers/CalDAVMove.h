...
@property (retain, nonatomic) NSString *updatedExternalID; // ivar: _updatedExternalID


-(id)initWithSourceCalendarID:(int)arg0 itemID:(int)arg1 oldExternalID:(id)arg2 changeID:(int)arg3 objectType:(NSInteger)arg4 uniqueIdentifier:(id)arg5 ;
