...
@protocol DADAgentStopStartControllerDelegate, OS_dispatch_queue;
...
+(id)sharedManager;
-(BOOL)_clearOrphanedStoresInCalendarDatabase:(struct CalDatabase *)arg0 eventAccountIds:(id)arg1 ;
...
-(void)enqueueEnableMonitoringAgents:(int)arg0 completion:(id)arg1 ;
...
-(void)scheduleAgentStartOrStopBlock:(id)arg0 ;
