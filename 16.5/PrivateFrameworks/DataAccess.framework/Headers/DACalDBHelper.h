...
@property (retain, nonatomic) DALocalDBWatcher *watcher; // ivar: _watcher
...
-(?)_cachedDatabaseForAccountIDpath;
-(?)_closeDatabasepath;
...
-(struct CalDatabase *)_cachedDatabaseForAuxDatabaseRef:(*void)arg0 path:(*id)arg1 ;
