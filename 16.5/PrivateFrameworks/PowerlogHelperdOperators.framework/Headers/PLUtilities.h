...
+(BOOL)decompressWithSource:(id)arg0 withDestination:(id)arg1 withRemoveSrc:(BOOL)arg2 ;
+(BOOL)deviceRebooted;
...
+(CGFloat)getLastSystemTimeOffset;
+(CGFloat)getMachbaseTimeRatio;
+(CGFloat)roundToSigFigDouble:(CGFloat)arg0 withSigFig:(int)arg1 ;
...
+(NSUInteger)convertToBase10:(id)arg0 fromBaseN:(int)arg1 ;
...
+(id)getPerfStatsForProcess:(id)arg0 ;
+(id)getSessionsAllowlist;
+(id)hardwareModel;
+(id)hashBundleID:(id)arg0 ;
+(id)hashString:(id)arg0 ;
+(id)intervalPeakCADictionaryForLaunchdName:(id)arg0 intervalMaxKB:(NSUInteger)arg1 ;
...
+(int)decompressWithSourceStream:(struct __sFILE *)arg0 withDestinationStream:(struct __sFILE *)arg1 ;
...
+(void)dispatchSyncIfNotCallerQueue:(id)arg0 withBlock:(id)arg1 ;
...
+(void)refreshBUI;
+(void)reportZlibResultToCA:(int)arg0 forEvent:(id)arg1 ;
