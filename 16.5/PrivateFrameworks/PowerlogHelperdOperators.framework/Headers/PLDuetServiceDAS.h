...
@property (retain) PLXPCListenerOperatorComposition *dasActivityLifecycleEventListener; // ivar: _dasActivityLifecycleEventListener
...
@property (retain) PLXPCListenerOperatorComposition *dasPoliciesBlockingCriteriaEventListener; // ivar: _dasPoliciesBlockingCriteriaEventListener
...
-(NSInteger)fileProtectionTypeStringToEnum:(id)arg0 ;
-(id)init;
-(void)didReceiveDASActivityEventWithPayload:(id)arg0 ;
-(void)didReceiveDASActivityLifecycleEventWithPayload:(id)arg0 ;
...
-(void)didReceiveDASPoliciesBlockingCriteriaEventWithPayload:(id)arg0 ;
