...
@property (retain) PLXPCListenerOperatorComposition *wifiLocationScanRequestersListener; // ivar: _wifiLocationScanRequestersListener
...
-(void)logEventPointWifiLocationScanRequesters:(id)arg0 ;
