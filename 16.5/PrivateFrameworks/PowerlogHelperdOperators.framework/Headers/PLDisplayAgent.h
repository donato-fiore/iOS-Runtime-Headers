...
@property BOOL supportsFinalBrightnessCommit; // ivar: _supportsFinalBrightnessCommit
...
-(void)logDisplayAPL;
-(void)logDisplayAZL;
-(void)logDisplayEntry:(id)arg0 ;
-(void)logEventBackwardALSSamplesBeforeWake:(id)arg0 ;
...
-(void)logEventForwardExtendedALSUserPreferences:(id)arg0 ;
