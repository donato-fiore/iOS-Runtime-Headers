...
-(id)_notificationIDForTesting:(struct OpaqueJSValue *)arg0 ;
...
-(struct Vector<WTF::String, 0UL, WTF::CrashOnOverflow, 16UL, WTF::FastMalloc> )_dictationAlternatives:(struct ObjectIdentifier<WebCore::DictationContextType> )arg0 ;
...
-(void)_notificationDidClick:(id)arg0 ;
-(void)_notificationDidShow:(id)arg0 ;
