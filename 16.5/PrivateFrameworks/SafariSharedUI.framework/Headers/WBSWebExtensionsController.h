...
@class NSHashTable, NSMutableDictionary, NSMapTable, _WKRemoteObjectInterface, WBSDispatchSourceTimer, NSURL, NSDictionary, WBSCoreAnalyticsExtensionsStatistics;
...
-(BOOL)_extensionHasWebNavigationPermission:(id)arg0 andAccessToTab:(id)arg1 withURL:(id)arg2 ;
...
-(BOOL)commandName:(id)arg0 isActionForExtension:(id)arg1 ;
-(BOOL)extensionIsEnabled:(id)arg0 ;
-(BOOL)fireOnCommandEventIfNecessaryForWebExtension:(id)arg0 commandName:(id)arg1 ;
-(BOOL)shouldDisplayDNRBlockedResourceCountAsBadgeTextForWebExtension:(id)arg0 ;
...
-(id)_allTabsForWebExtension:(id)arg0 ;
...
-(id)_getEnabledRulesetsForWebExtension:(id)arg0 ;
-(id)_getFrameInfoInFrameSubtree:(id)arg0 parent:(id)arg1 frameID:(int)arg2 ;
-(id)_getRegisteredContentScriptsWithIDs:(id)arg0 webExtension:(id)arg1 errorMessage:(*id)arg2 ;
...
-(id)_scriptDetailsForInjectedContentData:(id)arg0 ;
...
-(id)_validateRulesetIDs:(id)arg0 webExtension:(id)arg1 errorMessage:(*id)arg2 ;
...
-(void)_enumerateMessageReceiversForEnabledExtensionsForEventType:(NSUInteger)arg0 tab:(id)arg1 completionHandler:(id)arg2 ;
-(void)_enumerateMessageReceiversForEnabledExtensionsForEventType:(NSUInteger)arg0 window:(id)arg1 completionHandler:(id)arg2 ;
...
-(void)_fireOnUpdatedEventForTab:(id)arg0 toExtension:(id)arg1 withChangedProperties:(NSUInteger)arg2 ;
-(void)_fireOnUpdatedEventForTabsMatchingOriginPatterns:(id)arg0 toExtension:(id)arg1 ;
-(void)_firePermissionsEventWithPermissions:(id)arg0 permissions:(id)arg1 originPatterns:(id)arg2 permissionsAreBeingAdded:(BOOL)arg3 ;
...
-(void)_loadPermissionsFromStorageForWebExtension:(id)arg0 completionHandler:(id)arg1 ;
...
-(void)_postWebExtensionWasEnabledRemotelyNotificationIfNecessary:(id)arg0 ;
...
-(void)_webExtensionLocalStorageWasDeleted:(id)arg0 ;
...
-(void)clearPermissionStateUsedToDetermineIfExtensionShouldBeDisabledOnUpgradeForWebExtension:(id)arg0 ;
...
-(void)deleteDatabaseForStorageOfType:(NSInteger)arg0 forExtensionWithUniqueIdentifier:(id)arg1 webView:(id)arg2 completionHandler:(id)arg3 ;
-(void)deleteValuesForKeys:(id)arg0 fromStorageOfType:(NSInteger)arg1 forExtensionWithUniqueIdentifier:(id)arg2 webView:(id)arg3 completionHandler:(id)arg4 ;
...
-(void)getRegisteredContentScriptsWithIDs:(id)arg0 extensionIdentifier:(id)arg1 completionHandler:(id)arg2 ;
-(void)getSessionRulesForExtensionWithIdentifier:(id)arg0 completionHandler:(id)arg1 ;
-(void)getStorageSizeForAllKeysInStorageOfType:(NSInteger)arg0 forExtensionWithUniqueIdentifier:(id)arg1 queue:(id)arg2 completionHandler:(id)arg3 ;
-(void)getStorageSizeForAllKeysInStorageOfType:(NSInteger)arg0 forExtensionWithUniqueIdentifier:(id)arg1 webView:(id)arg2 completionHandler:(id)arg3 ;
-(void)getStorageSizeForKeys:(id)arg0 inStorageOfType:(NSInteger)arg1 forExtensionWithUniqueIdentifier:(id)arg2 webView:(id)arg3 completionHandler:(id)arg4 ;
...
-(void)getValuesForAllKeysFromStorageOfType:(NSInteger)arg0 forExtensionWithUniqueIdentifier:(id)arg1 webView:(id)arg2 completionHandler:(id)arg3 ;
-(void)getValuesForKeys:(id)arg0 fromStorageOfType:(NSInteger)arg1 forExtensionWithUniqueIdentifier:(id)arg2 webView:(id)arg3 completionHandler:(id)arg4 ;
...
-(void)registerContentScriptsWithDetails:(id)arg0 extensionIdentifier:(id)arg1 completionHandler:(id)arg2 ;
...
-(void)removeRegisteredContentScriptsWithIDs:(id)arg0 extensionIdentifier:(id)arg1 completionHandler:(id)arg2 ;
...
-(void)savePermissionStateUsedToDetermineIfExtensionShouldBeDisabledOnUpgradeForWebExtension:(id)arg0 ;
-(void)saveServiceWorkerErrorsForWebExtension:(id)arg0 errorStrings:(id)arg1 completionHandler:(id)arg2 ;
-(void)saveShouldDisplayDNRBlockedResourceCountAsBadgeTextToStorageForWebExtension:(id)arg0 ;
...
-(void)setExtensionActionOptionsForExtensionWithIdentifier:(id)arg0 options:(id)arg1 completionHandler:(id)arg2 ;
...
-(void)setKeyedData:(id)arg0 inStorageOfType:(NSInteger)arg1 forExtensionWithUniqueIdentifier:(id)arg2 webView:(id)arg3 completionHandler:(id)arg4 ;
...
-(void)toggleReaderModeForTab:(id)arg0 extensionIdentifier:(id)arg1 webView:(id)arg2 completionHandler:(id)arg3 ;
-(void)unregisterRemoteObjectFromWebView:(id)arg0 ;
-(void)updateContentScriptsWithDetails:(id)arg0 extensionIdentifier:(id)arg1 completionHandler:(id)arg2 ;
