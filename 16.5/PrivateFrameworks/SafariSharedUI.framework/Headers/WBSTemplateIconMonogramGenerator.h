...
+(id)monogramStringForTitle:(id)arg0 url:(id)arg1 shouldRemoveGrammaticalArticles:(BOOL)arg2 ;
...
+(id)monogramWithTitle:(id)arg0 url:(id)arg1 monogramConfiguration:(id)arg2 shouldRemoveGrammaticalArticles:(BOOL)arg3 ;
...
+(id)monogramWithTitle:(id)arg0 url:(id)arg1 size:(struct CGSize )arg2 fontSize:(CGFloat)arg3 fontWeight:(NSInteger)arg4 baselineOffset:(CGFloat)arg5 backgroundColor:(id)arg6 foregroundColor:(id)arg7 cornerRadius:(CGFloat)arg8 shouldRemoveGrammaticalArticles:(BOOL)arg9 ;
