...
+(id)defaultManager;
+(void)warmUp;
-(BOOL)hasTabGroupSpecificBackgroundImage:(id)arg0 ;
...
-(void)_readImagePropertiesFromImageSource:(struct RetainPtr<CGImageSource> )arg0 forImageIdentifier:(id)arg1 isNonGlobalBackgroundImage:(BOOL)arg2 ;
