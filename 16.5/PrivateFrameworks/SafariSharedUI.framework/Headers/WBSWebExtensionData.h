...
@class NSMutableArray, WBSDispatchSourceTimer, WKWebView, NSPointerArray, NSMutableDictionary, NSMapTable, NSMutableOrderedSet, NSString, NSDictionary, NSDate, NSSet, NSArray, NSUUID, UIImage, NSCountedSet, NSURL, NSExtension, WKContentWorld;
...
#import "WBSWebExtensionRegisteredContentScriptsSQLiteStore.h"
...
@property (nonatomic) CGFloat numberOfDynamicRules; // ivar: _numberOfDynamicRules
@property (nonatomic) CGFloat numberOfSessionRules; // ivar: _numberOfSessionRules
...
@property (readonly, copy, nonatomic) NSDictionary *registeredContentData; // ivar: _registeredContentData
...
@property (readonly, nonatomic) NSURL *resourcesDirectoryURL; // ivar: _resourcesDirectoryURL
...
-(id)_nextExpirationDateWithPermissions:(id)arg0 origins:(id)arg1 ;
...
-(id)imageForPath:(id)arg0 validateAndReadResourceHandler:(id)arg1 ;
-(id)initWithCoder:(id)arg0 ;
-(id)initWithExtension:(id)arg0 extensionsController:(id)arg1 ;
-(id)initWithExtension:(id)arg0 extensionsController:(id)arg1 extensionBundleIdentifier:(id)arg2 extensionIdentifier:(id)arg3 uniqueIdentifier:(id)arg4 baseURIHost:(id)arg5 ;
...
-(void)_addInjectedContent:(id)arg0 forGrantedOriginPattern:(id)arg1 ;
-(void)_addInjectedContentForAllGrantedOriginForInjectedContent:(id)arg0 ;
...
-(void)_loadBackgroundWebViewDuringExtensionLoad:(BOOL)arg0 ;
-(void)_loadToolbarItem;
-(void)_parseContentScriptsAndStyleSheetsForInjectedContent:(id)arg0 ;
...
-(void)addInjectedContent:(id)arg0 forGrantedOriginPatterns:(id)arg1 ;
...
-(void)increaseBlockedResourcesCountByAmount:(id)arg0 forTabWithIdentifier:(id)arg1 ;
...
-(void)loadRegisteredContentScriptsAndStyleSheets:(id)arg0 ;
-(void)loadRegisteredContentScriptsFromStorageWithCompletionHandler:(id)arg0 ;
-(void)messageReceivedFromContainingAppWithName:(id)arg0 userInfo:(id)arg1 ;
-(void)modifyInjectedContentScriptsByAddingScripts:(id)arg0 removingScripts:(id)arg1 ;
...
-(void)updateRegisteredContentScriptsByRemovingScripts:(id)arg0 addScripts:(id)arg1 completionHandler:(id)arg2 ;
