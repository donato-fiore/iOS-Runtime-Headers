...
#ifndef BMMLSELABELEDDATASTOREFEATURE_H
#define BMMLSELABELEDDATASTOREFEATURE_H
...
@property (readonly, nonatomic) BMMLSELabeledDataStoreFeatureFeatureValue *featureValue; // ivar: _featureValue
