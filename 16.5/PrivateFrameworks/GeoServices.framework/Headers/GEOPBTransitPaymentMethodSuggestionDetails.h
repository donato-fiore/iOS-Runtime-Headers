...
@interface GEOPBTransitPaymentMethodSuggestionDetails : PBCodable <NSCopying>

 {
    ...
    NSUInteger _paymentMethodRegionMuid;
...
@property (nonatomic) NSUInteger paymentMethodRegionMuid;
...
-(id)educationalScreenAssetAtIndex:(NSUInteger)arg0 ;
-(id)educationalScreenPaymentBodyAtIndex:(NSUInteger)arg0 ;
-(id)init;
-(id)initWithData:(id)arg0 ;
-(id)initWithDictionary:(id)arg0 ;
-(id)initWithJSON:(id)arg0 ;
-(id)jsonRepresentation;
-(void)addEducationalScreenAsset:(id)arg0 ;
-(void)addEducationalScreenPaymentBody:(id)arg0 ;
