...
@class PBCodable, PBDataReader, PBUnknownFields, NSString, NSUUID;
@protocol NSCopying;
...
@property (nonatomic) CGFloat eventDate;
...
-(id)loiTypeAsString:(int)arg0 ;
-(int)StringAsLoiType:(id)arg0 ;
