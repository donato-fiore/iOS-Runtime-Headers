...
@property (readonly, nonatomic) NSUInteger feedbackClientCapabilitiesCount;
...
+(id)defaultDebugSettingsMergedWithSettings:(id)arg0 ;
...
-(id)feedbackClientCapabilitiesAsString:(int)arg0 ;
...
-(int)StringAsFeedbackClientCapabilities:(id)arg0 ;
-(int)StringAsFeedbackRequestType:(id)arg0 ;
-(int)feedbackClientCapabilitiesAtIndex:(NSUInteger)arg0 ;
...
-(void)addFeedbackClientCapabilities:(int)arg0 ;
