...
-(id)initWithSearchQuery:(id)arg0 entryMetadata:(id)arg1 metadata:(id)arg2 autocompleteEntry:(id)arg3 retainedSearch:(id)arg4 maxResults:(unsigned int)arg5 filters:(id)arg6 traits:(id)arg7 routeInfo:(id)arg8 error:(*id)arg9 ;
