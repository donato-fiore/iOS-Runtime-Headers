...
#ifndef _GEOTERRITORYLOOKUPREQUESTTICKET_H
#define _GEOTERRITORYLOOKUPREQUESTTICKET_H

@class GEOPlaceRequestTicket, NSArray, NSString;
...
@interface _GEOTerritoryLookupRequestTicket : GEOPlaceRequestTicket <GEOMapServiceTicket>
...
-(id)initWithLatLngs:(id)arg0 shiftLocationsIfNeeded:(BOOL)arg1 traits:(id)arg2 ;
