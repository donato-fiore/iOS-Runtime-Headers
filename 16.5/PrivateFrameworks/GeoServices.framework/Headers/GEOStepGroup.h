...
#ifndef GEOSTEPGROUP_H
#define GEOSTEPGROUP_H
...
@property (readonly, nonatomic) NSUInteger stepIdsCount;
...
-(unsigned int)stepIdAtIndex:(NSUInteger)arg0 ;
-(void)addStepId:(unsigned int)arg0 ;
-(void)clearStepIds;
