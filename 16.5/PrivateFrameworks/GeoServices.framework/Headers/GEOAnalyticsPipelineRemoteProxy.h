...
@protocol GEOAnalyticsPipelineProxy, OS_xpc_object;
...
// -(void)_reportMonthlyUsageCountType:(int)arg0 usageString:(id)arg1 usageBool:(id)arg2 appId:(id)arg3 completion:(id)arg4 completionQueue:(unk)arg5  ;
// -(void)_updateSharedStateType:(int)arg0 state:(id)arg1 completion:(id)arg2 completionQueue:(unk)arg3  ;
-(void)flushEvalData;
