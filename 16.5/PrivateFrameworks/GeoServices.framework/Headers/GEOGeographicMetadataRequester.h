...
+(void)_fetchDataForLocation:(id)arg0 type:(NSUInteger)arg1 mcc:(unsigned short)arg2 mnc:(unsigned short)arg3 retryCount:(NSUInteger)arg4 responseQueue:(id)arg5 responseBlock:(id)arg6 ;
...
+(void)fetchSmartDataModeDataForLocation:(id)arg0 mcc:(unsigned short)arg1 mnc:(unsigned short)arg2 responseQueue:(id)arg3 responseBlock:(id)arg4 ;
...
-(id)initWithLocation:(id)arg0 type:(NSUInteger)arg1 mcc:(unsigned short)arg2 mnc:(unsigned short)arg3 ;
-(void)_fetch;
-(void)_start;
