...
@property (readonly, nonatomic) NSUInteger subactionsCount;
...
-(id)displayedTextAtIndex:(NSUInteger)arg0 ;
-(id)init;
-(id)initWithData:(id)arg0 ;
-(id)initWithDictionary:(id)arg0 ;
-(id)initWithJSON:(id)arg0 ;
-(id)jsonRepresentation;
-(id)subactionTypeAsString:(int)arg0 ;
-(id)subactionsAsString:(int)arg0 ;
-(int)StringAsSubactionType:(id)arg0 ;
-(int)StringAsSubactions:(id)arg0 ;
-(int)subactionAtIndex:(NSUInteger)arg0 ;
-(void)addDisplayedText:(id)arg0 ;
-(void)addSubaction:(int)arg0 ;
