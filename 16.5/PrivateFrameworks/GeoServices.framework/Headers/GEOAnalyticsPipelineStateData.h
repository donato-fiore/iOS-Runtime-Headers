...
-(id)mapLaunchActionAsString:(int)arg0 ;
-(id)mapSettingsCyclingVoiceSettingsAsString:(int)arg0 ;
-(id)mapSettingsDrivingVoiceSettingsAsString:(int)arg0 ;
...
-(id)mapSettingsWalkingVoiceSettingsAsString:(int)arg0 ;
...
-(id)placeCardRevealedPlaceCardModuleAtIndex:(NSUInteger)arg0 ;
...
-(int)StringAsMapLaunchAction:(id)arg0 ;
-(int)StringAsMapSettingsCyclingVoiceSettings:(id)arg0 ;
-(int)StringAsMapSettingsDrivingVoiceSettings:(id)arg0 ;
...
-(int)StringAsMapSettingsWalkingVoiceSettings:(id)arg0 ;
...
-(void)addPlaceCardRevealedPlaceCardModule:(id)arg0 ;
