...
-(BOOL)isMuninEnabled;
-(BOOL)isRegionalResource:(id)arg0 ;
...
-(id)explicitResourceAtIndex:(NSUInteger)arg0 ;
...
-(id)mapAttributionForCoordinate:(struct ? )arg0 isGlobal:(*BOOL)arg1 ;
-(id)mapAttributionURLForCoordinate:(struct ? )arg0 ;
...
-(void)addExplicitResource:(id)arg0 ;
