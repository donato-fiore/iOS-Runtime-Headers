...
-(BOOL)_isPunchInAppIdInList:(id)arg0 ;
...
-(BOOL)isWatchHandoff;
-(id)_filteredHomeCountry:(id)arg0 ;
...
-(int)moduleButtonLinkTypeAsGEOActionButtonLinkType:(int)arg0 ;
-(int)moduleButtonTypeAsGEOModuleButtonType:(NSInteger)arg0 ;
...
-(void)_stopTaskTimer;
-(void)addPlaceCardModulesForRevealAction:(id)arg0 ;
-(void)bestUserHomeLocation:(id)arg0 ;
...
-(void)populateActionButtonDetails:(id)arg0 ;
-(void)populateImpressionObjectId:(id)arg0 ;
-(void)populatePhotoSubmissionDetailsWithEntryPoint:(int)arg0 numberOfPhotos:(unsigned int)arg1 numberOfARPSuggestedPhotos:(unsigned int)arg2 originTarget:(id)arg3 ;
-(void)populatePlaceIdsWithSpecifierBlock:(id)arg0 ;
-(void)populateRatingPhotoSubmissionDetailsWithEntryPoint:(int)arg0 originTarget:(id)arg1 ;
-(void)populateRatingSubmissionDetailsWithEntryPoint:(int)arg0 originTarget:(id)arg1 specifierBlock:(id)arg2 ;
-(void)populateSearchResultsForQuery:(id)arg0 searchResultSpecifierBlock:(id)arg1 ;
-(void)populateTapEventForPinType:(int)arg0 tapEventSpecifierBlock:(id)arg1 ;
-(void)populateTapEventForResultIndex:(unsigned int)arg0 resultType:(int)arg1 businessId:(NSUInteger)arg2 localSearchProviderId:(unsigned int)arg3 isEnrichedItem:(BOOL)arg4 ;
...
-(void)setHasMapSettingsDirectionsWakeDevice:(BOOL)arg0 ;
...
-(void)setHasMapSettingsWalkingAvoidBusyRoads:(BOOL)arg0 ;
-(void)setHasMapSettingsWalkingAvoidHills:(BOOL)arg0 ;
-(void)setHasMapSettingsWalkingAvoidStairs:(BOOL)arg0 ;
...
-(void)setMapSettingsDirectionsWakeDevice:(BOOL)arg0 ;
...
-(void)setMapSettingsWalkingAvoidBusyRoads:(BOOL)arg0 ;
-(void)setMapSettingsWalkingAvoidHills:(BOOL)arg0 ;
-(void)setMapSettingsWalkingAvoidStairs:(BOOL)arg0 ;
