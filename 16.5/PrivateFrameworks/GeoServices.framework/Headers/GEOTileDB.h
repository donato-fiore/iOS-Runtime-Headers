...
@class geo_isolater, NSString, NSMutableDictionary, NSURL, NSLocale;
...
-(BOOL)_addSubscriptionOnDBQueue:(id)arg0 error:(*id)arg1 ;
...
-(BOOL)_markExistingTileDataAsCurrentOnDBQueue:(struct _GEOTileKey *)arg0 reason:(unsigned char)arg1 subscriptionIdentifier:(id)arg2 ;
-(BOOL)_prepareDataForPersistence:(id)arg0 isIdenticalToExistingStaleData:(BOOL)arg1 externalResourceUUID:(*id)arg2 ;
-(BOOL)_removeSubscriptionOnDBQueue:(id)arg0 error:(*id)arg1 ;
-(BOOL)_setup:(id)arg0 ;
-(NSInteger)_insertDataRowForData:(id)arg0 ETag:(id)arg1 externalResourceUUID:(id)arg2 timestamp:(*NSInteger)arg3 subscriptionIdentifier:(id)arg4 ;
...
-(id)_fetchSubscriptionsWithIdentifiers:(id)arg0 error:(*id)arg1 ;
-(id)_setupDB:(id)arg0 ;
-(id)init;
-(id)initWithBaseDirectory:(id)arg0 ;
-(id)initWithBaseDirectory:(id)arg0 delegate:(id)arg1 delegateQueue:(id)arg2 ;
-(id)initWithBaseDirectory:(id)arg0 manifestManager:(id)arg1 countryConfiguration:(id)arg2 locale:(id)arg3 delegate:(id)arg4 delegateQueue:(id)arg5 maximumDatabaseSize:(NSUInteger)arg6 ;
// -(void)_addDataOnDBQueueWithData:(id)arg0 key:(struct _GEOTileKey *)arg1 tileSet:(unk)arg2 ETag:(unsigned int)arg3 reason:(struct ? )arg4 externalResourceUUID:(id)arg5 subscriptionIdentifier:(unsigned char)arg6  ;
...
-(void)_fetchSubscriptionMetadataWithIdentifierOnQueue:(id)arg0 queue:(id)arg1 callback:(id)arg2 ;
-(void)_flushPendingWrites;
-(void)_incrementCalculatedTileDataSize:(NSUInteger)arg0 ;
-(void)_invalidateAllTileData;
-(void)_invalidateSubscriptionsReferencingOldestTilesWithLimit:(NSUInteger)arg0 ;
-(void)_invalidateSubscriptionsReferencingTilesOlderThan:(NSInteger)arg0 forTileSet:(*unk)arg1 ;
...
-(void)_invalidateTileSubscriptionStatesForDataType:(unsigned int)arg0 dataSubtype:(unsigned int)arg1 ;
-(void)_invalidatedTilesReferencedBySubscription:(NSInteger)arg0 tileSet:(unsigned int)arg1 ;
-(void)_markDataAtRow:(NSInteger)arg0 associatedWithSubscriptionIdentifier:(id)arg1 ;
-(void)_markDataForTileKey:(struct _GEOTileKey *)arg0 associatedWithSubscriptionIdentifier:(id)arg1 ;
...
-(void)_setLastAccessTimeOnDBQueue:(CGFloat)arg0 forDataRow:(NSInteger)arg1 ;
-(void)_setLastAccessTimeOnDBQueue:(CGFloat)arg0 forKey:(struct _GEOTileKey *)arg1 ;
-(void)_setSubscriptionWithIdentifierOnQueue:(id)arg0 isFullyLoaded:(BOOL)arg1 forDataType:(unsigned int)arg2 dataSubtype:(unsigned int)arg3 version:(NSUInteger)arg4 ;
...
// -(void)addData:(id)arg0 forKey:(struct _GEOTileKey *)arg1 edition:(unsigned int)arg2 set:(unk)arg3 provider:(unsigned int)arg4 etag:(struct ? )arg5 reason:(unsigned int)arg6 isIdenticalToExistingStaleData:(id)arg7 forSubscriptionWithIdentifier:(unsigned char)arg8  ;
-(void)addSubscription:(id)arg0 queue:(id)arg1 callback:(id)arg2 ;
...
-(void)fetchAllSubscriptionsWithQueue:(id)arg0 callback:(id)arg1 ;
-(void)fetchSubscriptionMetadataWithIdentifier:(id)arg0 queue:(id)arg1 callback:(id)arg2 ;
-(void)fetchSubscriptionsMatchingIdentifiers:(id)arg0 queue:(id)arg1 callback:(id)arg2 ;
...
-(void)removeSubscriptionWithIdentifier:(id)arg0 queue:(id)arg1 callback:(id)arg2 ;
-(void)setExpirationRecords:(struct ? *)arg0 count:(NSUInteger)arg1 ;
-(void)setSubscriptionWithIdentifier:(id)arg0 isFullyLoaded:(BOOL)arg1 forDataType:(unsigned int)arg2 dataSubtype:(unsigned int)arg3 version:(NSUInteger)arg4 ;
...
-(void)trackSubscriptionAssociationForKey:(struct _GEOTileKey *)arg0 subscriptionIdentifier:(id)arg1 ;
