...
-(CGFloat)distanceFromStartToEndOfPathIndex:(NSUInteger)arg0 ;
...
-(CGFloat)distanceFromStartToStartOfPathIndex:(NSUInteger)arg0 ;
...
-(id)routingPathDataWithSupportPointFromStart:(struct PolylineCoordinate )arg0 toEnd:(struct PolylineCoordinate )arg1 supportPointsOnly:(BOOL)arg2 startPathSegment:(id)arg3 ;
-(id)supportPointAtRouteCoordinate:(struct PolylineCoordinate )arg0 ;
...
-(struct GEOPolylineCoordinateRange )routeCoordinateRangeForPathIndex:(NSUInteger)arg0 ;
...
-(struct RoutingPathLeg )routingPathDataWithinSupportPoints:(id)arg0 supportPointsOnly:(BOOL)arg1 ;
...
-(struct RoutingPathLeg )routingPathWithSupportPointFromStart:(struct PolylineCoordinate )arg0 toEnd:(struct PolylineCoordinate )arg1 supportPointsOnly:(BOOL)arg2 startPathSegment:(id)arg3 ;
