...
-(id)initWithSearchQuery:(id)arg0 entryMetadata:(id)arg1 metadata:(id)arg2 autocompleteEntry:(id)arg3 retainedSearch:(id)arg4 maxResults:(unsigned int)arg5 traits:(id)arg6 routeInfo:(id)arg7 ;
