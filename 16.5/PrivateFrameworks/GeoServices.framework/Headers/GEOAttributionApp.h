...
-(id)handledSchemesAtIndex:(NSUInteger)arg0 ;
-(id)init;
-(id)initWithData:(id)arg0 ;
-(id)initWithDictionary:(id)arg0 ;
-(id)initWithJSON:(id)arg0 ;
-(id)jsonRepresentation;
-(id)restaurantReservationExtensionSupportAsString:(int)arg0 ;
-(int)StringAsRestaurantReservationExtensionSupport:(id)arg0 ;
