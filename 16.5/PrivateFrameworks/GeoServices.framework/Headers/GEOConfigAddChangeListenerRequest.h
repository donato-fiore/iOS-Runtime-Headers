...
#ifndef GEOCONFIGADDCHANGELISTENERREQUEST_H
#define GEOCONFIGADDCHANGELISTENERREQUEST_H
...
@property (retain, nonatomic) NSDictionary *keysAndSources; // ivar: _keysAndSources
