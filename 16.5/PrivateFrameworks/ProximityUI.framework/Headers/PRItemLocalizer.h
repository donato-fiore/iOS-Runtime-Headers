...
@class NSOperationQueue, NSDictionary, NSString, CMMotionActivityManager, NSNumber, PRRoseSolution, NSTimer, NSUUID, PRRemoteDevice, PRCompanionRangingSession, NSMutableArray;
...
@property (nonatomic) BOOL requiresLowerRangingFrequency; // ivar: _requiresLowerRangingFrequency
...
-(void)revokeTargetEstimateWithLastSolution:(struct BatchSolution )arg0 ;
