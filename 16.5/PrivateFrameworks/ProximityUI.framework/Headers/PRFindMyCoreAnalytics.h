...
@property (nonatomic) BOOL receivedfirstSOIRSSI; // ivar: _receivedfirstSOIRSSI
...
-(void)configureSessionWithProductUUID:(id)arg0 withOwner:(id)arg1 ;
-(void)deinit;
...
-(void)updateSOIRSSI:(CGFloat)arg0 ;
