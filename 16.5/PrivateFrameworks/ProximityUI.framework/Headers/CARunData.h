...
@property (nonatomic) CGFloat firstSOIRSSI; // ivar: _firstSOIRSSI
...
@property (retain, nonatomic) NSNumber *numberOfStraightPathRevokes; // ivar: _numberOfStraightPathRevokes
...
-(void)logData;
-(void)logFirstSOIRSSI:(CGFloat)arg0 ;
-(void)motion:(id)arg0 ;
-(void)rangeRevoke:(id)arg0 ;
-(void)start:(id)arg0 ;
-(void)stop:(id)arg0 ;
-(void)straightPathRevoke:(id)arg0 ;
