...
-(BOOL)restartRangingOn:(id)arg0 withError:(*id)arg1 ;
-(BOOL)startRangingOn:(id)arg0 withError:(*id)arg1 ;
-(BOOL)stopRangingOn:(id)arg0 withError:(*id)arg1 ;
-(id)initWithDelegate:(id)arg0 queue:(id)arg1 id:(id)arg2 ;
...
-(id)initWithDelegate:(id)arg0 queue:(id)arg1 id:(id)arg2 withAnalytics:(BOOL)arg3 ;
