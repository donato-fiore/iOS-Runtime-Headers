...
@property (readonly, copy, nonatomic) NSString *lastModifiedByDeviceID; // ivar: _lastModifiedByDeviceID
@property (readonly, nonatomic) ? lastModifiedByVersion; // ivar: _lastModifiedByVersion
@property (readonly, copy, nonatomic) DNDMode *mode; // ivar: _mode
@property (readonly, nonatomic) NSInteger rawResolvedCompatibilityVersion;
...
-(id)initWithMode:(id)arg0 configuration:(id)arg1 triggers:(id)arg2 impactsAvailability:(NSUInteger)arg3 dimsLockScreen:(NSUInteger)arg4 created:(id)arg5 lastModified:(id)arg6 automaticallyGenerated:(BOOL)arg7 compatibilityVersion:(NSInteger)arg8 lastModifiedByVersion:(struct ? )arg9 lastModifiedByDeviceID:(id)arg10 ;
-(id)mergeDecision:(id)arg0 reason:(id)arg1 ;
-(id)mergeWithRemoteModeConfiguration:(id)arg0 ;
