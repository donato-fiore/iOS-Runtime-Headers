...
-(void)removeExceptionForWebApplicationIdentifier:(id)arg0 ;
-(void)setAllowedApplications:(id)arg0 ;
-(void)setAllowedWebApplicationIdentifiers:(id)arg0 ;
-(void)setDeniedApplications:(id)arg0 ;
-(void)setDeniedWebApplicationIdentifiers:(id)arg0 ;
...
-(void)setExceptionForWebApplicationIdentifier:(id)arg0 ;
