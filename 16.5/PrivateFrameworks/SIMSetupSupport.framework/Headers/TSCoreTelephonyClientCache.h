...
@property BOOL isEOnly; // ivar: _isEOnly
...
-(void)cancelTransferPlan:(id)arg0 fromDevice:(id)arg1 completionHandler:(id)arg2 ;
...
-(void)getWebsheetInfoForPlan:(id)arg0 inBuddy:(BOOL)arg1 completion:(id)arg2 ;
...
-(void)submitPlanSetupDetails:(id)arg0 ;
