...
+(id)transformationWithFilterOptions:(NSUInteger)arg0 configuration:(id)arg1 context:(id)arg2 ;
+(id)transformationWithFilterOptions:(NSUInteger)arg0 configuration:(id)arg1 context:(id)arg2 otherArticleIDs:(id)arg3 ;
+(id)transformationWithFilterOptions:(NSUInteger)arg0 otherArticleIDs:(id)arg1 otherClusterIDs:(id)arg2 subscribedTagIDs:(id)arg3 mutedTagIDs:(id)arg4 readingHistoryItems:(id)arg5 playlistArticleIDs:(id)arg6 downloadedArticleIDs:(id)arg7 briefingsTagID:(id)arg8 paidAccessChecker:(id)arg9 bundleSubscription:(id)arg10 ;
