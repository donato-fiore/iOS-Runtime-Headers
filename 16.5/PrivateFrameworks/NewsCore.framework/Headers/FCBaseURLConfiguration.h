...
+(id)appAnalyticsSportsEventsBaseURLForConfiguration:(id)arg0 ;
+(id)authTokenBaseURLForConfiguration:(id)arg0 ;
+(id)ckMultiFetchBaseURLForConfiguration:(id)arg0 ;
+(id)ckOrderFeedBaseURLForConfiguration:(id)arg0 ;
+(id)ckRecordFetchBaseURLForConfiguration:(id)arg0 ;
+(id)fairPlayBaseURLForConfiguration:(id)arg0 ;
+(id)fineGrainedNewsletterSubscriptionBaseURLForConfiguration:(id)arg0 ;
...
+(id)sportsDataVisualizationBaseURLForConfiguration:(id)arg0 ;
-(id)CAPIBaseURL;
