...
@protocol FCSubscriptionListObserving, FCAppActivityObserving, FCPurchaseProviderType, FCCoreConfigurationManager, FCNewsAppConfigurationManager;
...
-(BOOL)addIgnoredSubscriptionForTagID:(id)arg0 ;
-(BOOL)addIgnoredSubscriptionForTagID:(id)arg0 groupID:(id)arg1 ;
-(BOOL)addMutedSubscriptionForTagID:(id)arg0 ;
-(BOOL)addMutedSubscriptionForTagID:(id)arg0 groupID:(id)arg1 ;
-(BOOL)addSubscriptionToTag:(id)arg0 error:(*id)arg1 ;
-(BOOL)addSubscriptionToTag:(id)arg0 notificationsEnabled:(BOOL)arg1 error:(*id)arg2 ;
-(BOOL)addSubscriptionToTag:(id)arg0 options:(NSInteger)arg1 error:(*id)arg2 ;
-(BOOL)appendSubscriptionToTag:(id)arg0 notificationsEnabled:(BOOL)arg1 error:(*id)arg2 ;
...
-(BOOL)moveSubscriptionForTagID:(id)arg0 beforeTagID:(id)arg1 ;
-(BOOL)removeIgnoredSubscriptionForTagID:(id)arg0 ;
-(BOOL)removeIgnoredSubscriptionForTagID:(id)arg0 groupID:(id)arg1 ;
...
-(id)ignoredTagIDs;
-(id)init;
-(id)initWithSubscriptionList:(id)arg0 tagController:(id)arg1 notificationController:(id)arg2 purchaseProvider:(id)arg3 configurationManager:(id)arg4 appConfigurationManager:(id)arg5 appActivityMonitor:(id)arg6 ;
-(id)mutedTagIDs;
...
// -(void)addAutoFavoriteSubscriptionForTagIDs:(id)arg0 groupableSubscriptionForTagIDs:(id)arg1 originProvider:(id)arg2 completion:(unk)arg3  ;
...
-(void)removeSubscriptionForTagID:(id)arg0 type:(NSUInteger)arg1 ;
-(void)removeSubscriptionToTag:(id)arg0 ;
-(void)subscriptionList:(id)arg0 didAddSubscriptions:(id)arg1 changeSubscriptions:(id)arg2 moveSubscriptions:(id)arg3 removeSubscriptions:(id)arg4 ;
-(void)subscriptionListDidResetToEmpty:(id)arg0 ;
-(void)subscriptionListDidStopSyncingRemoteChanges:(id)arg0 ;
-(void)subscriptionListWillStartSyncingRemoteChanges:(id)arg0 ;
