...
@class NSString, NTPBFeedConfiguration, NSArray, NFLazy, NSData, NSDate, NTPBPublisherPaidDescriptionStrings, NSDictionary, NTPBTagRecord;
@protocol FCTagStocksFields, FCTagProviding, FCChannelProviding, FCSectionProviding, FCTopicProviding, FCFeedTheming, FCContentArchivable, FCSportsProviding, FCSportsTheming, FCSportsEventProviding;
...
@property (readonly, nonatomic) FCColor *adBackgroundColor; // ivar: _adBackgroundColor
@property (readonly, nonatomic) FCColorGradient *adBackgroundGradient; // ivar: _adBackgroundGradient
...
@property (readonly, nonatomic) FCColor *darkStyleAdBackgroundColor; // ivar: _darkStyleAdBackgroundColor
@property (readonly, nonatomic) FCColorGradient *darkStyleAdBackgroundGradient; // ivar: _darkStyleAdBackgroundGradient
@property (readonly, nonatomic) FCColor *darkStyleBackgroundColor;
@property (readonly, nonatomic) FCColor *darkStyleFeedBackgroundColor; // ivar: _darkStyleFeedBackgroundColor
@property (readonly, nonatomic) FCColorGradient *darkStyleFeedBackgroundGradient; // ivar: _darkStyleFeedBackgroundGradient
@property (readonly, nonatomic) FCColor *darkStyleFeedControlColor; // ivar: _darkStyleFeedControlColor
...
@property (readonly, nonatomic) FCAssetHandle *darkStyleNavigationChromeBackgroundImageCompact; // ivar: _darkStyleNavigationChromeBackgroundImageCompact
@property (readonly, nonatomic) FCAssetHandle *darkStyleNavigationChromeBackgroundImageLarge; // ivar: _darkStyleNavigationChromeBackgroundImageLarge
...
@property (readonly, nonatomic) BOOL disableBlock; // ivar: _disableBlock
@property (readonly, nonatomic) BOOL disableFollow; // ivar: _disableFollow
@property (readonly, copy, nonatomic) NSString *displayName;
@property (readonly, nonatomic) FCColor *feedBackgroundColor; // ivar: _feedBackgroundColor
@property (readonly, nonatomic) FCColorGradient *feedBackgroundGradient; // ivar: _feedBackgroundGradient
@property (readonly, nonatomic) FCColor *feedControlColor; // ivar: _feedControlColor
@property (readonly, nonatomic) NSString *feedMastheadType; // ivar: _feedMastheadType
...
@property (readonly, nonatomic) BOOL isMySports; // ivar: _isMySports
...
@property (readonly, nonatomic) BOOL isSports; // ivar: _isSports
...
@property (readonly, nonatomic) FCAssetHandle *navigationChromeBackgroundImageCompact; // ivar: _navigationChromeBackgroundImageCompact
@property (readonly, nonatomic) NSUInteger navigationChromeBackgroundImageContentMode; // ivar: _navigationChromeBackgroundImageContentMode
@property (readonly, nonatomic) NSUInteger navigationChromeBackgroundImageContentModeCompact; // ivar: _navigationChromeBackgroundImageContentModeCompact
@property (readonly, nonatomic) NSUInteger navigationChromeBackgroundImageContentModeLarge; // ivar: _navigationChromeBackgroundImageContentModeLarge
@property (readonly, nonatomic) FCAssetHandle *navigationChromeBackgroundImageLarge; // ivar: _navigationChromeBackgroundImageLarge
...
@property (readonly, nonatomic) NSDictionary *publisherSpecifiedArticles; // ivar: _publisherSpecifiedArticles
...
@property (readonly, nonatomic) NSInteger sportsLogoMastheadHorizontalPaddingOffset; // ivar: _sportsLogoMastheadHorizontalPaddingOffset
@property (readonly, nonatomic) NSInteger sportsLogoMastheadLeadingOffset; // ivar: _sportsLogoMastheadLeadingOffset
...
@property (readonly, nonatomic) FCSportsRecommendationMappings *sportsRecommendationMappings; // ivar: _sportsRecommendationMappings
...
@property (readonly, nonatomic) CGFloat subscriptionRate; // ivar: _subscriptionRate
