...
+(BOOL)recognizesRecordID:(id)arg0 inRecordIDPrefixes:(id)arg1 ;
...
-(id)recordIDPrefixes;
-(id)recordType;
-(id)resolveLocalizableExperimentalizableFieldforKey:(id)arg0 inRecord:(id)arg1 activeExperimentIDKey:(id)arg2 ;
