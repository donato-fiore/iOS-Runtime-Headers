...
@class NSMutableDictionary, NSSet, NSString, NSArray, NSDictionary;
...
-(BOOL)hasArticleBeenRemovedFromAudio:(id)arg0 ;
...
-(BOOL)markArticle:(id)arg0 withRemovedFromAudio:(BOOL)arg1 ;
...
-(NSInteger)listenedCountFor:(id)arg0 ;
...
-(id)historyItemsByArticleIDForArticleIDs:(id)arg0 ;
...
-(id)sortedVisitedArticleIDsSatisfying:(id)arg0 ;
