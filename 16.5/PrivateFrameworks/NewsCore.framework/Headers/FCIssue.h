...
@class NSArray, NSString, COMAPPLEFELDSPARPROTOCOLLIVERPOOLArticleContentExpiration, NSData, COMAPPLEFELDSPARPROTOCOLLIVERPOOLCohortList, COMAPPLEFELDSPARPROTOCOLLIVERPOOLConversionStats, NTPBIssueRecord, NSDate, COMAPPLEFELDSPARPROTOCOLLIVERPOOLTagMetadata;
