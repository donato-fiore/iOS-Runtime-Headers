...
@class NSString, NSArray, NSData, NSURL, NSDate, COMAPPLEFELDSPARPROTOCOLLIVERPOOLArticleContentExpiration, COMAPPLEFELDSPARPROTOCOLLIVERPOOLCohortList, COMAPPLEFELDSPARPROTOCOLLIVERPOOLConversionStats, COMAPPLEFELDSPARPROTOCOLLIVERPOOLTagMetadata;
...
@property (readonly, nonatomic) BOOL disablePrerollAds; // ivar: _disablePrerollAds
@property (readonly, nonatomic) BOOL disableTapToChannel; // ivar: _disableTapToChannel
...
@property (readonly, nonatomic) NSData *float16FullBodyEncoding; // ivar: _float16FullBodyEncoding
@property (readonly, nonatomic) NSData *float16TitleEncoding; // ivar: _float16TitleEncoding
...
@property (retain, nonatomic) NSDate *globalExpirationTime; // ivar: _globalExpirationTime
...
@property (readonly, copy, nonatomic) FCIssue *parentIssue; // ivar: _parentIssue
...
@property (copy, nonatomic) NSArray *sportsEventIDs; // ivar: _sportsEventIDs
...
@property (readonly, nonatomic) NSArray *tagsExpiration; // ivar: _tagsExpiration
