...
@property (readonly, nonatomic) NSInteger maxSportsScoresBubbleTipPresentations; // ivar: _maxSportsScoresBubbleTipPresentations
...
@property (readonly, nonatomic) NSInteger sportsScoresBubbleTipPresentationsQuiescenceInterval; // ivar: _sportsScoresBubbleTipPresentationsQuiescenceInterval
