...
-(void)addBundleChannelIDs:(id)arg0 bundleChannelIDsVersion:(id)arg1 purchaseID:(id)arg2 inTrialPeriod:(BOOL)arg3 isPurchaser:(BOOL)arg4 servicesBundlePurchaseID:(id)arg5 isAmplifyUser:(BOOL)arg6 initialPurchaseTimestamp:(id)arg7 isPaidBundleViaOfferActivated:(BOOL)arg8 ;
