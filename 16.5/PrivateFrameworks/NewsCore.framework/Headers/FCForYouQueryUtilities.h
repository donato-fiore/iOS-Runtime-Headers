...
// +(id)feedRequestsForTags:(id)arg0 tagBinProvider:(id)arg1 hiddenFeedIDs:(unk)arg2 allowPaidBundleFeed:(id)arg3 purchasedTagIDs:(BOOL)arg4 bundleSubscriptionProvider:(id)arg5 configuration:(id)arg6 maxCount:(id)arg7 tagIDFeedRangeProvider:(NSUInteger)arg8 isRunningPPT:(id)arg9  ;
