...
@class RCConfigurationManager, NSString, NFUnfairLock, NSDate, NSDictionary, NSData, NSHashTable, NSArray;
...
-(id)initWithContextConfiguration:(id)arg0 contentHostDirectoryFileURL:(id)arg1 feldsparIDProvider:(id)arg2 appShortVersionString:(id)arg3 networkBehaviorMonitor:(id)arg4 ;
-(id)initWithContextConfiguration:(id)arg0 contentHostDirectoryFileURL:(id)arg1 feldsparIDProvider:(id)arg2 networkBehaviorMonitor:(id)arg3 ;
