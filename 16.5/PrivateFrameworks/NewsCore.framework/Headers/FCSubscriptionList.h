...
-(BOOL)addSubscriptionForTagID:(id)arg0 type:(NSUInteger)arg1 ;
-(BOOL)addSubscriptionForTagID:(id)arg0 type:(NSUInteger)arg1 origin:(NSUInteger)arg2 ;
-(BOOL)addSubscriptionForTagID:(id)arg0 type:(NSUInteger)arg1 origin:(NSUInteger)arg2 groupID:(id)arg3 ;
-(BOOL)addSubscriptionForTagID:(id)arg0 type:(NSUInteger)arg1 origin:(NSUInteger)arg2 groupID:(id)arg3 notificationsEnabled:(BOOL)arg4 ;
-(BOOL)appendSubscriptionForTagID:(id)arg0 type:(NSUInteger)arg1 ;
...
// -(void)addSubscriptionsForTagIDs:(id)arg0 typeProvider:(id)arg1 originProvider:(unk)arg2 completion:(id)arg3  ;
...
// -(void)removeSubscriptionsForTagIDs:(id)arg0 typeProvider:(id)arg1 completion:(unk)arg2  ;
