...
@property (readonly, nonatomic) NSString *blockedArticleLearnMoreURL; // ivar: _blockedArticleLearnMoreURL
...
@property (readonly, nonatomic) NSInteger maxIssuesPerESLInventoryRequest;
...
@property (readonly, nonatomic) FCPaidBundleViaOfferConfig *paidBundleViaOfferConfig; // ivar: _paidBundleViaOfferConfig
...
@property (readonly, nonatomic) CGFloat prerollReadyToPlayTimeout;
...
@property (readonly, nonatomic) NSString *sportEventHighlightsTagID; // ivar: _sportEventHighlightsTagID
...
@property (readonly, nonatomic) CGFloat todayPerformanceAlertGapExpansionThreshold;
@property (readonly, nonatomic) CGFloat todayPerformanceAlertPrewarmThreshold;
@property (readonly, nonatomic) CGFloat todayPerformanceAlertSpinnerThreshold;
@property (readonly, nonatomic) BOOL todayPerformanceAlertsEnabled;
@property (readonly, nonatomic) NSInteger todayPerformanceAlertsMinNewsVersion;
