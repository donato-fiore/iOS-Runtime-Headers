...
@property (readonly, nonatomic) FCPersonalizationOntologyLevelConfig *articleListTagFeedGroupOntologyLevelConfig; // ivar: _articleListTagFeedGroupOntologyLevelConfig
@property (readonly, nonatomic) FCPersonalizationScoringConfig *articleListTagFeedGroupPaidScoringConfig; // ivar: _articleListTagFeedGroupPaidScoringConfig
...
@property (readonly, nonatomic) FCPersonalizationOntologyLevelConfig *articleRecirculationPrimaryOntologyLevelConfig; // ivar: _articleRecirculationPrimaryOntologyLevelConfig
@property (readonly, nonatomic) FCPersonalizationScoringConfig *articleRecirculationPrimaryPaidScoringConfig; // ivar: _articleRecirculationPrimaryPaidScoringConfig
...
@property (readonly, nonatomic) FCPersonalizationOntologyLevelConfig *articleRecirculationSecondaryOntologyLevelConfig; // ivar: _articleRecirculationSecondaryOntologyLevelConfig
@property (readonly, nonatomic) FCPersonalizationScoringConfig *articleRecirculationSecondaryPaidScoringConfig; // ivar: _articleRecirculationSecondaryPaidScoringConfig
...
@property (readonly, nonatomic) FCPersonalizationOntologyLevelConfig *articleRecirculationTertiaryOntologyLevelConfig; // ivar: _articleRecirculationTertiaryOntologyLevelConfig
@property (readonly, nonatomic) FCPersonalizationScoringConfig *articleRecirculationTertiaryPaidScoringConfig; // ivar: _articleRecirculationTertiaryPaidScoringConfig
...
@property (readonly, nonatomic) FCPersonalizationOntologyLevelConfig *audioFeedOntologyLevelConfig; // ivar: _audioFeedOntologyLevelConfig
@property (readonly, nonatomic) FCPersonalizationScoringConfig *audioFeedPaidScoringConfig; // ivar: _audioFeedPaidScoringConfig
...
@property (readonly, nonatomic) FCPersonalizationOntologyLevelConfig *bestOfBundleOntologyLevelConfig; // ivar: _bestOfBundleOntologyLevelConfig
@property (readonly, nonatomic) FCPersonalizationScoringConfig *bestOfBundlePaidScoringConfig; // ivar: _bestOfBundlePaidScoringConfig
...
@property (readonly, nonatomic) CGFloat channelScoreWeight; // ivar: _channelScoreWeight
@property (readonly, nonatomic) CGFloat clicksToImpressionsRatioMaximum; // ivar: _clicksToImpressionsRatioMaximum
@property (readonly, nonatomic) FCPersonalizationOntologyLevelConfig *curatedIssuesOntologyLevelConfig; // ivar: _curatedIssuesOntologyLevelConfig
@property (readonly, nonatomic) FCPersonalizationScoringConfig *curatedIssuesPaidScoringConfig; // ivar: _curatedIssuesPaidScoringConfig
...
@property (readonly, nonatomic) FCPersonalizationOntologyLevelConfig *curatedOntologyLevelConfig; // ivar: _curatedOntologyLevelConfig
@property (readonly, nonatomic) FCPersonalizationScoringConfig *curatedPaidScoringConfig; // ivar: _curatedPaidScoringConfig
...
@property (readonly, nonatomic) FCPersonalizationOntologyLevelConfig *defaultOntologyLevelConfig; // ivar: _defaultOntologyLevelConfig
@property (readonly, nonatomic) FCPersonalizationScoringConfig *defaultPaidScoringConfig; // ivar: _defaultPaidScoringConfig
...
@property (readonly, nonatomic) FCPersonalizationOntologyLevelConfig *forYouOntologyLevelConfig; // ivar: _forYouOntologyLevelConfig
@property (readonly, nonatomic) FCPersonalizationScoringConfig *forYouPaidScoringConfig; // ivar: _forYouPaidScoringConfig
...
@property (readonly, nonatomic) FCPersonalizationOntologyLevelConfig *greatStoriesYouMissedOntologyLevelConfig; // ivar: _greatStoriesYouMissedOntologyLevelConfig
@property (readonly, nonatomic) FCPersonalizationScoringConfig *greatStoriesYouMissedPaidScoringConfig; // ivar: _greatStoriesYouMissedPaidScoringConfig
...
@property (readonly, nonatomic) FCPersonalizationOntologyLevelConfig *highlightsGroupOntologyLevelConfig; // ivar: _highlightsGroupOntologyLevelConfig
@property (readonly, nonatomic) FCPersonalizationScoringConfig *highlightsGroupPaidScoringConfig; // ivar: _highlightsGroupPaidScoringConfig
...
@property (readonly, nonatomic) CGFloat ignoreBaselineClickValue; // ivar: _ignoreBaselineClickValue
@property (readonly, nonatomic) CGFloat ignoreBaselineImpressionValue; // ivar: _ignoreBaselineImpressionValue
@property (readonly, nonatomic) CGFloat ignoreClickValue; // ivar: _ignoreClickValue
@property (readonly, nonatomic) CGFloat ignoreImpressionValue; // ivar: _ignoreImpressionValue
...
@property (readonly, nonatomic) FCPersonalizationOntologyLevelConfig *introToSportsGroupForYouOntologyLevelConfig; // ivar: _introToSportsGroupForYouOntologyLevelConfig
@property (readonly, nonatomic) FCPersonalizationScoringConfig *introToSportsGroupForYouPaidScoringConfig; // ivar: _introToSportsGroupForYouPaidScoringConfig
@property (readonly, nonatomic) FCPersonalizationScoringConfig *introToSportsGroupForYouScoringConfig; // ivar: _introToSportsGroupForYouScoringConfig
@property (readonly, nonatomic) FCPersonalizationTopicsConfig *introToSportsGroupForYouTopicsConfig; // ivar: _introToSportsGroupForYouTopicsConfig
@property (readonly, nonatomic) FCPersonalizationOntologyLevelConfig *introToSportsGroupOntologyLevelConfig; // ivar: _introToSportsGroupOntologyLevelConfig
@property (readonly, nonatomic) FCPersonalizationScoringConfig *introToSportsGroupPaidScoringConfig; // ivar: _introToSportsGroupPaidScoringConfig
...
@property (readonly, nonatomic) FCPersonalizationOntologyLevelConfig *latestStoriesOntologyLevelConfig; // ivar: _latestStoriesOntologyLevelConfig
@property (readonly, nonatomic) FCPersonalizationScoringConfig *latestStoriesPaidScoringConfig; // ivar: _latestStoriesPaidScoringConfig
...
@property (readonly, nonatomic) FCPersonalizationOntologyLevelConfig *legacyAudioFeedOntologyLevelConfig; // ivar: _legacyAudioFeedOntologyLevelConfig
@property (readonly, nonatomic) FCPersonalizationScoringConfig *legacyAudioFeedPaidScoringConfig; // ivar: _legacyAudioFeedPaidScoringConfig
...
@property (readonly, nonatomic) FCPersonalizationOntologyLevelConfig *localNewsOntologyLevelConfig; // ivar: _localNewsOntologyLevelConfig
@property (readonly, nonatomic) FCPersonalizationScoringConfig *localNewsPaidScoringConfig; // ivar: _localNewsPaidScoringConfig
...
@property (readonly, nonatomic) FCPersonalizationOntologyLevelConfig *localSectionGroupOntologyLevelConfig; // ivar: _localSectionGroupOntologyLevelConfig
@property (readonly, nonatomic) FCPersonalizationScoringConfig *localSectionGroupPaidScoringConfig; // ivar: _localSectionGroupPaidScoringConfig
@property (readonly, nonatomic) FCPersonalizationScoringConfig *localSectionGroupScoringConfig; // ivar: _localSectionGroupScoringConfig
@property (readonly, nonatomic) FCPersonalizationTopicsConfig *localSectionGroupTopicsConfig; // ivar: _localSectionGroupTopicsConfig
@property (readonly, nonatomic) CGFloat lowQualityContentThreshold; // ivar: _lowQualityContentThreshold
@property (readonly, nonatomic) FCPersonalizationOntologyLevelConfig *magazineFeedArticleOntologyLevelConfig; // ivar: _magazineFeedArticleOntologyLevelConfig
@property (readonly, nonatomic) FCPersonalizationScoringConfig *magazineFeedArticlePaidScoringConfig; // ivar: _magazineFeedArticlePaidScoringConfig
...
@property (readonly, nonatomic) FCPersonalizationOntologyLevelConfig *magazineFeedIssueOntologyLevelConfig; // ivar: _magazineFeedIssueOntologyLevelConfig
@property (readonly, nonatomic) FCPersonalizationScoringConfig *magazineFeedIssuePaidScoringConfig; // ivar: _magazineFeedIssuePaidScoringConfig
...
@property (readonly, nonatomic) FCPersonalizationOntologyLevelConfig *moreForYouOntologyLevelConfig; // ivar: _moreForYouOntologyLevelConfig
@property (readonly, nonatomic) FCPersonalizationScoringConfig *moreForYouPaidScoringConfig; // ivar: _moreForYouPaidScoringConfig
@property (readonly, nonatomic) FCPersonalizationScoringConfig *moreForYouScoringConfig; // ivar: _moreForYouScoringConfig
@property (readonly, nonatomic) FCPersonalizationTopicsConfig *moreForYouTopicsConfig; // ivar: _moreForYouTopicsConfig
...
@property (readonly, nonatomic) FCPersonalizationOntologyLevelConfig *mySportsGroupForYouOntologyLevelConfig; // ivar: _mySportsGroupForYouOntologyLevelConfig
@property (readonly, nonatomic) FCPersonalizationScoringConfig *mySportsGroupForYouPaidScoringConfig; // ivar: _mySportsGroupForYouPaidScoringConfig
@property (readonly, nonatomic) FCPersonalizationScoringConfig *mySportsGroupForYouScoringConfig; // ivar: _mySportsGroupForYouScoringConfig
@property (readonly, nonatomic) FCPersonalizationTopicsConfig *mySportsGroupForYouTopicsConfig; // ivar: _mySportsGroupForYouTopicsConfig
@property (readonly, nonatomic) FCPersonalizationOntologyLevelConfig *mySportsGroupOntologyLevelConfig; // ivar: _mySportsGroupOntologyLevelConfig
@property (readonly, nonatomic) FCPersonalizationScoringConfig *mySportsGroupPaidScoringConfig; // ivar: _mySportsGroupPaidScoringConfig
...
@property (readonly, nonatomic) FCPersonalizationOntologyLevelConfig *mySportsTopicsOntologyLevelConfig; // ivar: _mySportsTopicsOntologyLevelConfig
@property (readonly, nonatomic) FCPersonalizationScoringConfig *mySportsTopicsPaidScoringConfig; // ivar: _mySportsTopicsPaidScoringConfig
@property (readonly, nonatomic) FCPersonalizationScoringConfig *mySportsTopicsScoringConfig; // ivar: _mySportsTopicsScoringConfig
@property (readonly, nonatomic) FCPersonalizationTopicsConfig *mySportsTopicsTopicsConfig; // ivar: _mySportsTopicsTopicsConfig
...
@property (readonly, nonatomic) FCPersonalizationOntologyLevelConfig *newspaperMagazineFeedOntologyLevelConfig; // ivar: _newspaperMagazineFeedOntologyLevelConfig
@property (readonly, nonatomic) FCPersonalizationScoringConfig *newspaperMagazineFeedPaidScoringConfig; // ivar: _newspaperMagazineFeedPaidScoringConfig
...
@property (readonly, nonatomic) FCPersonalizationOntologyLevelConfig *newspaperSectionGroupOntologyLevelConfig; // ivar: _newspaperSectionGroupOntologyLevelConfig
@property (readonly, nonatomic) FCPersonalizationScoringConfig *newspaperSectionGroupPaidScoringConfig; // ivar: _newspaperSectionGroupPaidScoringConfig
@property (readonly, nonatomic) FCPersonalizationScoringConfig *newspaperSectionGroupScoringConfig; // ivar: _newspaperSectionGroupScoringConfig
@property (readonly, nonatomic) FCPersonalizationTopicsConfig *newspaperSectionGroupTopicsConfig; // ivar: _newspaperSectionGroupTopicsConfig
@property (readonly, nonatomic) FCPersonalizationOntologyLevelConfig *newspaperTodayFeedOntologyLevelConfig; // ivar: _newspaperTodayFeedOntologyLevelConfig
@property (readonly, nonatomic) FCPersonalizationScoringConfig *newspaperTodayFeedPaidScoringConfig; // ivar: _newspaperTodayFeedPaidScoringConfig
@property (readonly, nonatomic) FCPersonalizationScoringConfig *newspaperTodayFeedScoringConfig; // ivar: _newspaperTodayFeedScoringConfig
@property (readonly, nonatomic) FCPersonalizationTopicsConfig *newspaperTodayFeedTopicsConfig; // ivar: _newspaperTodayFeedTopicsConfig
@property (readonly, nonatomic) FCPersonalizationScoringConfig *notificationPaidScoringConfig; // ivar: _notificationPaidScoringConfig
...
@property (readonly, nonatomic) BOOL personalizesSportsTagsInUserVector; // ivar: _personalizesSportsTagsInUserVector
...
@property (readonly, nonatomic) BOOL reorderHeadlinesUsingTitleEmbeddingScoreBeforeGrouping; // ivar: _reorderHeadlinesUsingTitleEmbeddingScoreBeforeGrouping
...
@property (readonly, nonatomic) FCPersonalizationOntologyLevelConfig *sportsEventArticlesGroupOntologyLevelConfig; // ivar: _sportsEventArticlesGroupOntologyLevelConfig
@property (readonly, nonatomic) FCPersonalizationScoringConfig *sportsEventArticlesGroupPaidScoringConfig; // ivar: _sportsEventArticlesGroupPaidScoringConfig
@property (readonly, nonatomic) FCPersonalizationScoringConfig *sportsEventArticlesGroupScoringConfig; // ivar: _sportsEventArticlesGroupScoringConfig
@property (readonly, nonatomic) FCPersonalizationTopicsConfig *sportsEventArticlesGroupTopicsConfig; // ivar: _sportsEventArticlesGroupTopicsConfig
@property (readonly, nonatomic) FCPersonalizationOntologyLevelConfig *sportsEventTopicGroupOntologyLevelConfig; // ivar: _sportsEventTopicGroupOntologyLevelConfig
@property (readonly, nonatomic) FCPersonalizationScoringConfig *sportsEventTopicGroupPaidScoringConfig; // ivar: _sportsEventTopicGroupPaidScoringConfig
@property (readonly, nonatomic) FCPersonalizationScoringConfig *sportsEventTopicGroupScoringConfig; // ivar: _sportsEventTopicGroupScoringConfig
@property (readonly, nonatomic) FCPersonalizationTopicsConfig *sportsEventTopicGroupTopicsConfig; // ivar: _sportsEventTopicGroupTopicsConfig
@property (readonly, nonatomic) FCPersonalizationTagScoringConfig *sportsTagScoringConfig; // ivar: _sportsTagScoringConfig
@property (readonly, nonatomic) CGFloat sportsTagSeenBaselineClickValue; // ivar: _sportsTagSeenBaselineClickValue
@property (readonly, nonatomic) CGFloat sportsTagSeenBaselineImpressionValue; // ivar: _sportsTagSeenBaselineImpressionValue
@property (readonly, nonatomic) CGFloat sportsTagSeenClickValue; // ivar: _sportsTagSeenClickValue
@property (readonly, nonatomic) BOOL sportsTagSeenEnableFeedSource; // ivar: _sportsTagSeenEnableFeedSource
@property (readonly, nonatomic) BOOL sportsTagSeenEnableSportsManagementDetailSource; // ivar: _sportsTagSeenEnableSportsManagementDetailSource
@property (readonly, nonatomic) BOOL sportsTagSeenEnableSportsManagementSource; // ivar: _sportsTagSeenEnableSportsManagementSource
@property (readonly, nonatomic) CGFloat sportsTagSeenImpressionValue; // ivar: _sportsTagSeenImpressionValue
@property (readonly, nonatomic) CGFloat sportsTagSeenMinimumDuration; // ivar: _sportsTagSeenMinimumDuration
@property (readonly, nonatomic) FCPersonalizationOntologyLevelConfig *sportsTopStoriesOntologyLevelConfig; // ivar: _sportsTopStoriesOntologyLevelConfig
@property (readonly, nonatomic) FCPersonalizationScoringConfig *sportsTopStoriesPaidScoringConfig; // ivar: _sportsTopStoriesPaidScoringConfig
@property (readonly, nonatomic) FCPersonalizationScoringConfig *sportsTopStoriesScoringConfig; // ivar: _sportsTopStoriesScoringConfig
@property (readonly, nonatomic) FCPersonalizationTopicsConfig *sportsTopStoriesTopicsConfig; // ivar: _sportsTopStoriesTopicsConfig
...
@property (readonly, nonatomic) FCPersonalizationOntologyLevelConfig *tagDateRangeOntologyLevelConfig; // ivar: _tagDateRangeOntologyLevelConfig
@property (readonly, nonatomic) FCPersonalizationScoringConfig *tagDateRangePaidScoringConfig; // ivar: _tagDateRangePaidScoringConfig
@property (readonly, nonatomic) FCPersonalizationScoringConfig *tagDateRangeScoringConfig; // ivar: _tagDateRangeScoringConfig
@property (readonly, nonatomic) FCPersonalizationTopicsConfig *tagDateRangeTopicsConfig; // ivar: _tagDateRangeTopicsConfig
@property (readonly, nonatomic) FCPersonalizationOntologyLevelConfig *tagFeedOntologyLevelConfig; // ivar: _tagFeedOntologyLevelConfig
@property (readonly, nonatomic) FCPersonalizationScoringConfig *tagFeedPaidScoringConfig; // ivar: _tagFeedPaidScoringConfig
...
@property (readonly, nonatomic) FCPersonalizationOntologyLevelConfig *tagForYouGroupOntologyLevelConfig; // ivar: _tagForYouGroupOntologyLevelConfig
@property (readonly, nonatomic) FCPersonalizationScoringConfig *tagForYouGroupPaidScoringConfig; // ivar: _tagForYouGroupPaidScoringConfig
@property (readonly, nonatomic) FCPersonalizationScoringConfig *tagForYouGroupScoringConfig; // ivar: _tagForYouGroupScoringConfig
@property (readonly, nonatomic) FCPersonalizationTopicsConfig *tagForYouGroupTopicsConfig; // ivar: _tagForYouGroupTopicsConfig
@property (readonly, nonatomic) FCPersonalizationOntologyLevelConfig *tagRecentStoriesOntologyLevelConfig; // ivar: _tagRecentStoriesOntologyLevelConfig
@property (readonly, nonatomic) FCPersonalizationScoringConfig *tagRecentStoriesPaidScoringConfig; // ivar: _tagRecentStoriesPaidScoringConfig
@property (readonly, nonatomic) FCPersonalizationScoringConfig *tagRecentStoriesScoringConfig; // ivar: _tagRecentStoriesScoringConfig
@property (readonly, nonatomic) FCPersonalizationTopicsConfig *tagRecentStoriesTopicsConfig; // ivar: _tagRecentStoriesTopicsConfig
@property (readonly, nonatomic) FCPersonalizationOntologyLevelConfig *tagWidgetOntologyLevelConfig; // ivar: _tagWidgetOntologyLevelConfig
@property (readonly, nonatomic) FCPersonalizationScoringConfig *tagWidgetPaidScoringConfig; // ivar: _tagWidgetPaidScoringConfig
...
@property (readonly, nonatomic) NSInteger thumbnailMinHammingDistance; // ivar: _thumbnailMinHammingDistance
@property (readonly, nonatomic) FCPersonalizationOntologyLevelConfig *todayWidgetOntologyLevelConfig; // ivar: _todayWidgetOntologyLevelConfig
@property (readonly, nonatomic) FCPersonalizationScoringConfig *todayWidgetPaidScoringConfig; // ivar: _todayWidgetPaidScoringConfig
...
@property (readonly, nonatomic) FCPersonalizationOntologyLevelConfig *topicFeedOntologyLevelConfig; // ivar: _topicFeedOntologyLevelConfig
@property (readonly, nonatomic) FCPersonalizationScoringConfig *topicFeedPaidScoringConfig; // ivar: _topicFeedPaidScoringConfig
