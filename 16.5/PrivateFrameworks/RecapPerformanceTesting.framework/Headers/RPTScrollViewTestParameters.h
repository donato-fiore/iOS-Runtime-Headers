...
@class UIScrollView, CAMediaTimingFunction, NSString;
...
@property (retain, nonatomic) CAMediaTimingFunction *curveFunction; // ivar: _curveFunction
@property (readonly, copy) NSString *debugDescription;
@property (readonly, copy) NSString *description;
@property (nonatomic) NSInteger direction; // ivar: _direction
@property (readonly, nonatomic) NSUInteger effectiveVersion;
@property (nonatomic) NSUInteger forceMaxVersion; // ivar: _forceMaxVersion
@property (nonatomic) NSUInteger forceMinVersion; // ivar: _forceMinVersion
...
-(void)waitForPostEventStreamDelayWithHandler:(id)arg0 ;
