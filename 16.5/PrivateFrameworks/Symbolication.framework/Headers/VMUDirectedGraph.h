...
+(BOOL)encapsulateData:(id)arg0 to:(id)arg1 withSupplementalDataTag:(char *)arg2 error:(*id)arg3 dataGeneratorBlock:(id)arg4 ;
...
+(id)_unarchivedObject:(id)arg0 ofClasses:(id)arg1 options:(NSUInteger)arg2 ;
