...
@class NSMutableDictionary, NSHashTable, NSMapTable, NSMutableSet;
...
@property (readonly) NSUInteger figBaseObjectFinalizeAddress; // ivar: _figBaseObjectFinalizeAddress
...
@property (readonly, weak) VMUTaskMemoryScanner *scanner; // ivar: _scanner
@property (readonly, nonatomic) NSUInteger swiftConcurrencyDebugAsyncTaskMetadataIsa; // ivar: _swiftConcurrencyDebugAsyncTaskMetadataIsa
@property (readonly, nonatomic) NSUInteger swiftConcurrencyDebugAsyncTaskSlabMetadataIsa; // ivar: _swiftConcurrencyDebugAsyncTaskSlabMetadataIsa
...
@property (readonly, nonatomic) BOOL taskIsDriverKit; // ivar: _taskIsDriverKit
...
-(id)_classInfoForMemory:(*void)arg0 length:(NSUInteger)arg1 atOffset:(NSUInteger)arg2 remoteAddress:(NSUInteger)arg3 ;
-(id)_classInfoWithPthreadType:(id)arg0 ;
-(id)_returnFaultedClass:(NSUInteger)arg0 ofType:(unsigned int)arg1 ;
-(id)classInfoForCFTypeInstance:(*void)arg0 length:(NSUInteger)arg1 remoteAddress:(NSUInteger)arg2 ;
...
-(id)classInfoWithNonobjectType:(id)arg0 binaryPath:(id)arg1 ;
-(id)classInfoWithNonobjectType:(id)arg0 binaryPath:(id)arg1 returnedClassInfoIndex:(*unsigned int)arg2 ;
...
-(id)labelForCoreMediaFigObject:(*void)arg0 length:(NSUInteger)arg1 remoteAddress:(NSUInteger)arg2 ;
...
-(id)labelForSwiftStringStorage:(*void)arg0 length:(NSUInteger)arg1 remoteAddress:(NSUInteger)arg2 ;
...
-(id)labelFor_RBSAssertionDescriptor:(*void)arg0 length:(NSUInteger)arg1 remoteAddress:(NSUInteger)arg2 ;
