...
@class NSMutableArray, NSMutableDictionary, NSMapTable, NSString, NSDictionary;
...
@property (readonly, nonatomic) *_VMUBlockNode blocks; // ivar: _blocks
...
@property (readonly, nonatomic) NSDictionary *ledger; // ivar: _ledger
...
@property (readonly, nonatomic) *_VMURegionNode regions; // ivar: _regions
@property (readonly, nonatomic) VMUScanOverlay *scanOverlay; // ivar: _scanOverlay
...
-(NSUInteger)ledgerValueForKey:(id)arg0 keyExists:(*BOOL)arg1 ;
...
-(id)initFullyWithTask:(unsigned int)arg0 ;
...
-(struct _VMURegionNode *)validateAddressRangeForSwiftRemoteMirror:(struct _VMURange )arg0 allowUnusedSplitLibs:(BOOL)arg1 ;
-(unsigned int)_indexForClassInfo:(id)arg0 ;
-(unsigned int)_nodeForAddress:(NSUInteger)arg0 checkMaxInteriorOffset:(BOOL)arg1 ;
...
-(void)applyTypeOverlayToMutableInfo:(id)arg0 ;
...
-(void)scanNodesWithReferenceRecorder:(id)arg0 ;
