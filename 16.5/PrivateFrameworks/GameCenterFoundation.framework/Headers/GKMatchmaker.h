...
@property (retain, nonatomic) NSMutableDictionary *sharePlayInviteeTokensFromProgrammaticInvite; // ivar: _sharePlayInviteeTokensFromProgrammaticInvite
@property (copy, nonatomic) id *sharePlayPlayerHandler; // ivar: _sharePlayPlayerHandler
...
-(BOOL)shouldRunGroupActivityWithDescription:(id)arg0 ;
...
-(void)activateGroupActivityWithHandler:(id)arg0 ;
-(void)addPlayersForHostedMatchRequest:(id)arg0 existingPlayerCount:(NSInteger)arg1 completionHandler:(id)arg2 ;
-(void)addPlayersForHostedMatchRequest:(id)arg0 existingPlayerCount:(NSInteger)arg1 devicePushToken:(id)arg2 completionHandler:(id)arg3 ;
-(void)addPlayersToMatch:(id)arg0 matchRequest:(id)arg1 completionHandler:(id)arg2 ;
-(void)addPlayersToMatch:(id)arg0 matchRequest:(id)arg1 devicePushToken:(id)arg2 completionHandler:(id)arg3 ;
...
-(void)findMatchForRequest:(id)arg0 devicePushToken:(id)arg1 withCompletionHandler:(id)arg2 ;
...
-(void)groupActivityInvitePlayer:(id)arg0 withDevicePushToken:(id)arg1 participantServerIdentifier:(id)arg2 ;
...
-(void)hasExistingInviteSessionWithHandler:(id)arg0 ;
-(void)inviteAnyNearbyPlayersWithRequest:(id)arg0 handler:(id)arg1 ;
-(void)invitePlayersWithRequest:(id)arg0 serverHosted:(BOOL)arg1 devicePushToken:(id)arg2 completionHandler:(id)arg3 ;
-(void)invitePlayersWithRequest:(id)arg0 serverHosted:(BOOL)arg1 onlineConnectionData:(id)arg2 devicePushToken:(id)arg3 completionHandler:(id)arg4 ;
...
-(void)matchRequestRecipientsSet:(id)arg0 ;
-(void)matchWithRequest:(id)arg0 currentMatch:(id)arg1 hostedCurrentPlayerCount:(NSInteger)arg2 serverHosted:(BOOL)arg3 rematchID:(id)arg4 devicePushToken:(id)arg5 completionHandler:(id)arg6 ;
...
-(void)sharePlayPlayerFound:(id)arg0 ;
-(void)showSharePlayMatchDeclinedToJoinAlertWithReason:(NSInteger)arg0 ;
-(void)startBrowsingForNearbyPlayersWithHandler:(id)arg0 ;
-(void)startBrowsingForNearbyPlayersWithReachableHandler:(id)arg0 ;
-(void)startGroupActivityWithPlayerHandler:(id)arg0 ;
