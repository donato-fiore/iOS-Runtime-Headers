...
@property (nonatomic) BOOL lastSaveFailed; // ivar: _lastSaveFailed
...
-(id)primaryCredentialForEnvironment:(NSInteger)arg0 accountStore:(id)arg1 ;
...
-(void)setContactAssociationID:(id)arg0 contactIntegrationConsent:(int)arg1 serviceLastUpdateTimestamp:(id)arg2 forEnvironment:(NSInteger)arg3 forcefully:(BOOL)arg4 completionHandler:(id)arg5 ;
