...
@property (nonatomic) BOOL initiallyStarted; // ivar: _initiallyStarted
...
@property (retain, nonatomic) GKThreadsafeDictionary *playersByJoinType; // ivar: _playersByJoinType
...
-(void)sharePlaySendData:(id)arg0 withDataMode:(NSInteger)arg1 toPlayers:(id)arg2 completionHandler:(id)arg3 ;
