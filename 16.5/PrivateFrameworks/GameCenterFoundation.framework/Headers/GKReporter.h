...
-(void)reportEvent:(id)arg0 eventType:(id)arg1 duration:(CGFloat)arg2 refApp:(id)arg3 ;
...
-(void)reportEvent:(id)arg0 type:(id)arg1 startTime:(id)arg2 refApp:(id)arg3 ;
-(void)reportInviteeUILaunchDuration;
-(void)reportMessageInviteProcessingDuration;
-(void)reportOnboardingEventForType:(id)arg0 withStartTimestamp:(CGFloat)arg1 refApp:(id)arg2 ;
