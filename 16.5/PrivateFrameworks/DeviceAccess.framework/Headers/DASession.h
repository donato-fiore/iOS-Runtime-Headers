...
+(BOOL)setPartialIPsForAppBundleID:(id)arg0 partialIPs:(id)arg1 error:(*id)arg2 ;
+(BOOL)setPartialIPsWithAuditToken:(struct ? )arg0 partialIPs:(id)arg1 error:(*id)arg2 ;
...
+(id)getPartialIPsWithAppBundleID:(id)arg0 error:(*id)arg1 ;
+(id)getPartialIPsWithAuditToken:(struct ? )arg0 error:(*id)arg1 ;
...
-(void)_getPartialIPsCompleted:(id)arg0 completionHandler:(id)arg1 ;
-(void)_interrupted;
-(void)_invalidated;
...
-(void)getPartialIPsWithAppBundleID:(id)arg0 completionHandler:(id)arg1 ;
-(void)getPartialIPsWithAuditToken:(struct ? )arg0 completionHandler:(id)arg1 ;
-(void)invalidate;
-(void)setPartialIPsForAppBundleID:(id)arg0 partialIPs:(id)arg1 completionHandler:(id)arg2 ;
-(void)setPartialIPsWithAuditToken:(struct ? )arg0 partialIPs:(id)arg1 completionHandler:(id)arg2 ;
