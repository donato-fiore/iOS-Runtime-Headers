...
@class UIViewController, FBSDisplayConfiguration, NSString, UIView<UIScenePresentation>, _UILegibilitySettings, FBScene, NSMutableArray, FBApplicationUpdateScenesTransaction;
@protocol FBProcessWatchdogProviding, SPUISpotlightSceneManagerDelegate, FBApplicationUpdateScenesTransactionObserver, FBSceneObserver, UIScenePresenter;
...
@property (nonatomic) BOOL crashedWhileForeground; // ivar: _crashedWhileForeground
...
-(void)updateSceneToOrientation:(NSInteger)arg0 withTransitionCoordinator:(id)arg1 ;
