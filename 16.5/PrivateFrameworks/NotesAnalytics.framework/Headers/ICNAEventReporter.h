...
-(void)submitFastSyncSessionEndForNote:(id)arg0 sessionID:(id)arg1 participantVersions:(id)arg2 numUniqueAccounts:(id)arg3 numUniqueDevices:(id)arg4 errorCode:(id)arg5 numIgnoredMessages:(id)arg6 ;
-(void)submitFastSyncSessionStartForNote:(id)arg0 sessionID:(id)arg1 participantVersions:(id)arg2 numUniqueAccounts:(id)arg3 numUniqueDevices:(id)arg4 ;
...
-(void)submitNoteSharrowEventForModernNote:(id)arg0 activityType:(id)arg1 contextPath:(NSInteger)arg2 countOfCollaboratorsAdded:(NSInteger)arg3 countOfCollaboratorsRemoved:(NSInteger)arg4 startInvitedCount:(NSInteger)arg5 startAcceptedCount:(NSInteger)arg6 endInvitedCount:(NSInteger)arg7 endAcceptedCount:(NSInteger)arg8 ;
-(void)submitNoteViewEventForHTMLNote:(id)arg0 ;
-(void)submitNoteViewEventForModernNote:(id)arg0 ;
-(void)submitNotesToPagesEventWithContextPath:(NSInteger)arg0 ;
