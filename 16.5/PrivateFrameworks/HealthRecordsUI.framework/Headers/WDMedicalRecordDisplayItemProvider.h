...
@property (nonatomic) BOOL removedRecordsOnly; // ivar: _removedRecordsOnly
...
-(id)initWithProfile:(id)arg0 concept:(id)arg1 preloadedRemovedRecords:(id)arg2 removedRecordsOnly:(BOOL)arg3 displayItemOptions:(NSInteger)arg4 sampleTypes:(id)arg5 filter:(id)arg6 additionalPredicates:(id)arg7 sortDescriptors:(id)arg8 ;
...
-(id)initWithProfile:(id)arg0 userDomainConcept:(id)arg1 preloadedRemovedRecords:(id)arg2 removedRecordsOnly:(BOOL)arg3 displayItemOptions:(NSInteger)arg4 sampleTypes:(id)arg5 filter:(id)arg6 additionalPredicates:(id)arg7 sortDescriptors:(id)arg8 ;
-(id)removedRecords;
...
-(void)_displayItemGroupsForSummaryOfRecords:(id)arg0 style:(NSInteger)arg1 completion:(id)arg2 ;
