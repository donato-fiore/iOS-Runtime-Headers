...
-(BOOL)getMinimalManifestsClassesAndInstancesWithPartSPC:(id)arg0 fdrLocal:(struct __AMFDR *)arg1 fdrRemote:(struct __AMFDR *)arg2 minimalSealingDataInstances:(*id)arg3 minimalSealedDataClasses:(*id)arg4 minimalSealedDataInstances:(*id)arg5 error:(*id)arg6 ;
-(BOOL)getPatchExpectedDataWithPartSPC:(id)arg0 amfdr:(struct __AMFDR *)arg1 expectedClasses:(*id)arg2 expectedInstances:(*id)arg3 expectedValues:(*id)arg4 validClasses:(id)arg5 validInstances:(id)arg6 error:(*id)arg7 ;
...
-(BOOL)validatePatchWithPartSPC:(id)arg0 originalClasses:(id)arg1 originalInstances:(id)arg2 originalValues:(id)arg3 validClasses:(id)arg4 validInstances:(id)arg5 ;
...
-(id)getSealDateFromSealingManifestData:(id)arg0 ;
