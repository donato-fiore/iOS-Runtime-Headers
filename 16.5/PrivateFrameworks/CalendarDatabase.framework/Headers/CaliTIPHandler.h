...
+(?)handleEvent:(?)arg0 calEvent:(?)arg1 eventID:(?)arg2 database:(?)arg3 messageaccountInfo;
+(?)processMessage:(?)arg0 withDatabase:(?)arg1 calStore:(?)arg2 accountInfohandledEventCallback;
+(?)processMessages:(?)arg0 withDatabase:(?)arg1 calStore:(?)arg2 accountInfo:(?)arg3 handledEventCallbackcancellationToken;
