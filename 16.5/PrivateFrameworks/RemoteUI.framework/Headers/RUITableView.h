...
@class NSMutableArray, UITableView, UIDatePicker, _UIBackdropView, NSIndexPath, NSDate, UIView<RUIHeader>, UITraitCollection, NSString, NSDictionary, UISearchBar, UIPickerView;
@protocol UISearchBarDelegate, UITableViewDataSource, UITableViewDelegate, RUITableViewRowDelegate, RUITopLevelPageElement, RUIWebViewDelegate;
...
-(id)filteredResultsWithSearchTerm:(id)arg0 ;
...
-(struct CGRect )searchBarRectInPage:(id)arg0 ;
...
-(void)addSearchBarToPage:(id)arg0 ;
...
-(void)populateSelectionDictionary:(id)arg0 ;
