...
#import "CSCachingVibrancyTransitionProvider.h"
...
-(id)initWithViewController:(id)arg0 baseFont:(id)arg1 fromVibrancyConfiguration:(id)arg2 toVibrancyConfiguration:(id)arg3 cachingVibrancyTransitionProvider:(id)arg4 ;
