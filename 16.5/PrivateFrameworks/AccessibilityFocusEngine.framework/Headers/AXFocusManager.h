...
@property (retain, nonatomic) AXElement *focusContainerForSuccessfulTypeaheadMovement; // ivar: _focusContainerForSuccessfulTypeaheadMovement
...
-(BOOL)_focusOnFocusContainer:(id)arg0 ;
-(BOOL)_moveFocusInFocusContainer:(id)arg0 withHeading:(NSUInteger)arg1 queryString:(id)arg2 ;
...
-(BOOL)_recursiveMoveFocusInFocusContainer:(id)arg0 withHeading:(NSUInteger)arg1 byGroup:(BOOL)arg2 ;
-(BOOL)_recursiveMoveFocusInFocusContainer:(id)arg0 withHeading:(NSUInteger)arg1 queryString:(id)arg2 ;
-(NSUInteger)_indexOfTypeaheadPIDInFocusContainers:(id)arg0 ;
-(id)_currentFocusContainers;
-(id)_moveFocusContainerFocusInDirection:(NSInteger)arg0 ;
-(id)currentElement;
