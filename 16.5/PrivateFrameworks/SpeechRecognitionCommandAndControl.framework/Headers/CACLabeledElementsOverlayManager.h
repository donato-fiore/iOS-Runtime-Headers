...
+(void)assignNumbersToLabeledElements:(id)arg0 numberingStrategy:(int)arg1 startingNumber:(NSInteger)arg2 ;
-(BOOL)isOverlay;
...
-(void)addLabeledElements:(id)arg0 forceNoArrow:(BOOL)arg1 startingNumberedLabelsAtIndex:(NSUInteger)arg2 ;
...
-(void)showLabeledElementsOverlayWithLabeledElements:(id)arg0 forceNoArrow:(BOOL)arg1 startingNumberedLabelsAtIndex:(NSUInteger)arg2 ;
