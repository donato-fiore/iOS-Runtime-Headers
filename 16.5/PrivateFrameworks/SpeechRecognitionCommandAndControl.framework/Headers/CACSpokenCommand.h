...
+(id)languageModelFromCommandDictionary:(id)arg0 tokenResolution:(id)arg1 containsBuiltInIdentifier:(*BOOL)arg2 error:(*id)arg3 ;
...
-(void)_postKeyboardEventWithKeyCode:(unsigned short)arg0 modifierFlags:(unsigned int)arg1 isKeyDown:(BOOL)arg2 ;
-(void)_postKeyboardEventsForModifierFlags:(unsigned int)arg0 isKeyDown:(BOOL)arg1 ;
-(void)_scrollWithCount:(NSUInteger)arg0 forAction:(int)arg1 ;
