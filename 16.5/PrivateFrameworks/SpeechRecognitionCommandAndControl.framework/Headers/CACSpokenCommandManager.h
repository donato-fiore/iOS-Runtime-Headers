...
@class NSArray, AXElement, NSString, NSMutableArray, NSMutableDictionary, NSDictionary, NSTimer, FBSApplicationLibrary, FBSALOToken;
...
-(void)setScreenElements:(id)arg0 presentationElements:(id)arg1 activeApplications:(id)arg2 focusedTextAreaElement:(id)arg3 ;
-(void)startListening;
...
-(void)updateScreenElementsWithNonScannerElements:(id)arg0 ;
