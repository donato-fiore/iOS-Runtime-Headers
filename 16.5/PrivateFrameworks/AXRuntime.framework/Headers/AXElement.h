...
+(id)elementAtCoordinate:(struct CGPoint )arg0 withVisualPadding:(BOOL)arg1 displayID:(unsigned int)arg2 ;
...
-(id)focusContainersForCurrentSceneIdentifier:(id)arg0 ;
...
-(struct CGPath *)convertPath:(struct CGPath *)arg0 fromContextId:(unsigned int)arg1 displayId:(unsigned int)arg2 ;
...
-(struct CGRect )convertRect:(struct CGRect )arg0 fromContextId:(unsigned int)arg1 displayId:(unsigned int)arg2 ;
-(struct CGRect )convertRect:(struct CGRect )arg0 toContextId:(unsigned int)arg1 ;
-(struct CGRect )convertRect:(struct CGRect )arg0 toContextId:(unsigned int)arg1 displayId:(unsigned int)arg2 ;
...
-(void)setAutoscrollSpeed:(CGFloat)arg0 ;
