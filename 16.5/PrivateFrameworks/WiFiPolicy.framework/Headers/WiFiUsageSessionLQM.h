...
@property (nonatomic) NSUInteger avgRxRate; // ivar: _avgRxRate
...
@property (nonatomic) NSUInteger avgTxRate; // ivar: _avgTxRate
@property (nonatomic) NSUInteger avgTxRetriesOverTxFrames; // ivar: _avgTxRetriesOverTxFrames
@property (nonatomic) NSInteger count_of_LQMsamples; // ivar: _count_of_LQMsamples
@property (nonatomic) NSInteger count_of_core0Samples; // ivar: _count_of_core0Samples
@property (nonatomic) NSInteger count_of_core1Samples; // ivar: _count_of_core1Samples
...
@property (nonatomic) NSUInteger maxRxRate; // ivar: _maxRxRate
...
@property (nonatomic) NSUInteger maxTxRate; // ivar: _maxTxRate
...
@property (nonatomic) NSUInteger minRxRate; // ivar: _minRxRate
...
@property (nonatomic) NSUInteger minTxRate; // ivar: _minTxRate
...
@property (nonatomic) NSInteger sum_of_RSSI; // ivar: _sum_of_RSSI
@property (nonatomic) NSInteger sum_of_core0rssiDiff; // ivar: _sum_of_core0rssiDiff
@property (nonatomic) NSInteger sum_of_core1rssiDiff; // ivar: _sum_of_core1rssiDiff
...
-(void)reset;
-(void)updateAverageOf:(id)arg0 with:(NSInteger)arg1 forSession:(NSUInteger)arg2 ;
-(void)updateLinkQuality:(id)arg0 forSession:(NSUInteger)arg1 ;
