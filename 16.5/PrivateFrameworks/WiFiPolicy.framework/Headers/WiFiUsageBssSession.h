...
@property (nonatomic) CGFloat inRoamSuppressionEnabledDuration; // ivar: _inRoamSuppressionEnabledDuration
...
@property (nonatomic) CGFloat lastRoamSuppressionWaitForRoamEnd; // ivar: _lastRoamSuppressionWaitForRoamEnd
@property (nonatomic) CGFloat lastRoamSuppressionWaitForRoamStart; // ivar: _lastRoamSuppressionWaitForRoamStart
...
@property (nonatomic) int newBand; // ivar: _newBand
...
@property (nonatomic) ? roamNeighsLrgstCurrentToBestRssiByBand; // ivar: _roamNeighsLrgstCurrentToBestRssiByBand
@property (nonatomic) ? roamNeighsLrgstCurrentToNextBestRssiByBand; // ivar: _roamNeighsLrgstCurrentToNextBestRssiByBand
@property (nonatomic) ? roamNeighsSmllstCurrentToBestRssiByBand; // ivar: _roamNeighsSmllstCurrentToBestRssiByBand
@property (nonatomic) ? roamNeighsSmllstCurrentToNextBestRssiByBand; // ivar: _roamNeighsSmllstCurrentToNextBestRssiByBand
...
-(void)roamingStateDidChange:(BOOL)arg0 reason:(NSUInteger)arg1 andStatus:(NSUInteger)arg2 andLatency:(NSUInteger)arg3 andRoamData:(id)arg4 andPingPongNth:(BOOL)arg5 ;
