...
@property (nonatomic) NSString *disable6eMode; // ivar: _disable6eMode
...
@property (nonatomic) BOOL isLowQuality; // ivar: _isLowQuality
...
@property (nonatomic) BOOL isStandalone6E; // ivar: _isStandalone6E
