...
#ifndef AAUIWALRUSRECOVERYCONTACTREMOVEDSCREENMODEL_H
#define AAUIWALRUSRECOVERYCONTACTREMOVEDSCREENMODEL_H

@class AAWalrusRecoveryContactRemovedScreenModel, UIView, AACustodianshipInfo, NSString, UIImage;
