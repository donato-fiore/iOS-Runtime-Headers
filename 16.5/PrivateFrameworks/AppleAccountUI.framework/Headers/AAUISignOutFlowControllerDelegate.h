...
@interface AAUISignOutFlowControllerDelegate : NSObject <AAUISignOutControllerDelegate, AAUIRecoveryFactorControllerDelegate, AASignOutFlowControllerDelegate>

 {
    ...
    id *_pendingWalrusValidationCompletion;
}
...
-(void)_offerManateeRepairWithContext:(id)arg0 completion:(id)arg1 ;
-(void)_performLastDeviceCheckForAccount:(id)arg0 withContext:(id)arg1 completion:(id)arg2 ;
-(void)_presentLastDeviceAlertForAccount:(id)arg0 withRecoveryFactors:(NSUInteger)arg1 withCompletion:(id)arg2 ;
