...
#ifndef AAUIOBINHERITANCEINVITATIONVIEWMODEL_H
#define AAUIOBINHERITANCEINVITATIONVIEWMODEL_H

@class AAOBInheritanceInvitationModel, UIView, AACustodianshipInfo, NSString, UIImage;
