...
@protocol AAUISignInViewControllerInternalDelegate, UIAdaptivePresentationControllerDelegate, AIDAServiceOwnerProtocol, AAUICDPSignInDelegate, AAUISignInControllerDelegate;
...
@property (nonatomic, setter=_setShouldSkipDismiss:) BOOL _shouldSkipDismiss; // ivar: __shouldSkipDismiss
@property (nonatomic) BOOL allowSkip; // ivar: _allowSkip
@property (nonatomic) BOOL canEditUsername; // ivar: _canEditUsername
@property (weak, nonatomic) NSObject<AAUICDPSignInDelegate> *cdpDelegate; // ivar: _cdpDelegate
...
@property (retain, nonatomic) AAUISpinnerViewController *spinnerViewController; // ivar: _spinnerViewController
...
-(void)_attemptSignInForServices:(id)arg0 withAuthenticationResults:(id)arg1 parentViewController:(id)arg2 ;
-(void)_commonInit;
-(void)_delegate_signInControllerDidCompleteWithSuccess:(BOOL)arg0 error:(id)arg1 ;
-(void)_delegate_signInControllerFinishedWithResults:(id)arg0 ;
...
-(void)signInViewControllerDidSkip:(id)arg0 ;
