...
@property (copy, nonatomic) NSString *icloudDataRecoveryReAddHTTPMethod; // ivar: _icloudDataRecoveryReAddHTTPMethod
@property (retain, nonatomic) NSURL *icloudDataRecoveryReAddURL; // ivar: _icloudDataRecoveryReAddURL
