...
-(id)_spokenStringForBrailleString:(id)arg0 isDelete:(BOOL)arg1 speakLiterally:(*BOOL)arg2 modifiers:(id)arg3 ;
...
-(id)spokenStringForInsertedBrailleString:(id)arg0 speakLiterally:(*BOOL)arg1 modifiers:(id)arg2 ;
