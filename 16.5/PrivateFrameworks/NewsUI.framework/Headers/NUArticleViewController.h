...
@property (nonatomic) BOOL shouldDisableTransparentNavigationBar; // ivar: _shouldDisableTransparentNavigationBar
...
-(void)scrollViewControllerDidScrollToBottomOfPrimaryContent:(id)arg0 ;
