...
@class FCANFContent, FCAsyncOnceOperation, SXContext, NSError, NSString, FCFlintResourceManager, NSOperationQueue;
...
@property (retain, nonatomic) NSError *contextError; // ivar: _contextError
