...
@class NSString, NSMutableArray, SFSpeechRecognizer, CSAsset, CSDispatchGroup, NSUUID, CSAudioZeroCounter, CSPlainAudioFileWriter;
...
-(NSInteger)trainUtterance:(NSInteger)arg0 shouldUseASR:(BOOL)arg1 mhUUID:(id)arg2 completionWithResult:(id)arg3 ;
-(id)cleanupWithCompletion:(id)arg0 ;
-(id)initWithLocaleIdentifier:(id)arg0 withAudioSession:(id)arg1 withAppDomain:(id)arg2 ;
-(id)updateTrainingManagerForDevice:(NSUInteger)arg0 trainingDeviceUUIDList:(id)arg1 ;
...
-(void)closeSessionBeforeStartWithStatus:(int)arg0 successfully:(BOOL)arg1 completionWithResult:(id)arg2 ;
