...
@property (retain, nonatomic) SSRRemoteControlClient *remoteControlClient; // ivar: _remoteControlClient
...
-(void)importVoiceProfile:(id)arg0 appDomain:(id)arg1 withSharedUserId:(id)arg2 withLocale:(id)arg3 withAsset:(id)arg4 withCompletion:(id)arg5 ;
-(void)isImplicitTrainingRequiredForVoiceProfileId:(id)arg0 locale:(id)arg1 completion:(id)arg2 ;
-(void)isVoiceProfileUploadedToiCloudForLanguageCode:(id)arg0 withCompletionBlock:(id)arg1 ;
-(void)notifyImplicitTrainingUtteranceAvailable:(id)arg0 forVoiceProfileId:(id)arg1 withRecordDeviceInfo:(id)arg2 withRecordCtxt:(id)arg3 withVoiceTriggerCtxt:(id)arg4 withOtherCtxt:(id)arg5 assetToUse:(id)arg6 withCompletion:(id)arg7 ;
...
-(void)triggerInvalidSiriProfileCleanupFromPersonalDevicesForLanguage:(id)arg0 appDomain:(id)arg1 ;
