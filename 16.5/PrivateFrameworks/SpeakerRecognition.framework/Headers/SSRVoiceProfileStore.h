...
-(void)cleanupInvalidSiriProfilesFromPersonalDevicesForLanguage:(id)arg0 appDomain:(id)arg1 ;
-(void)cleanupVoiceProfileModelFilesForLocale:(id)arg0 ;
-(void)cleanupVoiceProfileStore:(id)arg0 ;
-(void)isImplicitTrainingRequiredToVoiceProfile:(id)arg0 withAsset:(id)arg1 completion:(id)arg2 ;
