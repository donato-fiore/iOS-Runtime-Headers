...
@protocol PKPassPersonalizationCellDelegate, PKPassPersonalizationTermsViewControllerDelegate, PKPassPersonalizationViewControllerDelegate;
...
-(void)finishPersonalizationOfPassWithUniqueID:(id)arg0 result:(BOOL)arg1 ;
