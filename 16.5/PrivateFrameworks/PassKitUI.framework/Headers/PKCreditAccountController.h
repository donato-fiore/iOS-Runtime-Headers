...
+(BOOL)shouldDisplayScheduledPaymentsWithAccount:(id)arg0 andPass:(id)arg1 ;
...
+(NSUInteger)paymentEducationStateForAccount:(id)arg0 mostRecentTransactions:(id)arg1 pendingPayments:(id)arg2 upcomingScheduledPayments:(id)arg3 ;
