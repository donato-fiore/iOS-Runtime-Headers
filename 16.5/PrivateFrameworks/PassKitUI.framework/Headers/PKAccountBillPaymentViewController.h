...
@class UIViewController, NSArray, PKAccountBillPaymentController, PKBillPaymentSuggestedAmountController, PKBillPaymentSuggestedAmountList, PKCompoundInterestCalculator, NSMutableDictionary, NSDateFormatter, NSNumberFormatter, NSDecimalNumber, NSDictionary, PKAccountServiceAccountResolutionCofiguration, PKCreditAccountSummary, UILabel, UIButton, UIScrollView, UIImageView, UITapGestureRecognizer, CLInUseAssertion, PKAccount, PKAccountUserCollection, NSString, PKTransactionSource;
@protocol _PKUIKVisibilityBackdropViewDelegate, PKBillPaymentRingViewDelegate, PKAccountBillPaymentControllerDelegate, PKAddBankAccountInformationViewControllerDelegate, PKBillPaymentRingViewDataSource, PKAccountBillPaymentAmountDescriptionViewDelegate, UIScrollViewDelegate, PKAccountServiceAccountResolutionControllerDelegate, PKAccountAutomaticPaymentsControllerDelegate, PKAccountBillPaymentConfirmationViewControllerDelegate, PKAccountBillPaymentObserver;
...
-(id)_paymentAmount;
-(id)_roundedInterestForAmount:(id)arg0 ;
-(id)_title;
-(id)billPaymentConfirmationInterestForPaymentAmount:(id)arg0 ;
-(id)billPaymentConfirmationInterestStringForPaymentAmount:(id)arg0 ;
...
-(void)_updatePayNowButtonTitleWithAmount:(id)arg0 ;
...
-(void)billPaymentRingView:(id)arg0 amountChanged:(id)arg1 ;
...
-(void)loadView;
-(void)recomputeCategoryVisualizationMangitudesForPassUniqueID:(id)arg0 style:(NSInteger)arg1 paymentService:(id)arg2 ;
