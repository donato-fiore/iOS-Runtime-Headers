...
@class PKPeerPaymentWebService, PKPeerPaymentController, PKPaymentPass, PKPaymentTransaction, NSArray, PKAccount, PKTransactionReceipt, NSSet, NSString, PKCoarseLocationMonitor, PKFamilyMemberCollection, PKAccountUserCollection, PKAccountService, PKPaymentWebService, PKRetrieveMerchantTokensResponse, PKDashboardTransactionFetcher, NSURL, PKContactResolver, UIImage, PKPeerPaymentStatusResponse, NSTimeZone, NSDateFormatter, PKTransactionSourceCollection;
@protocol PKContactResolverDelegate, PKPaymentDataProviderDelegate, CNContactViewControllerDelegate, PKTransactionDetailQuestionCellDelegate, PKPaymentTransactionReportFraudConfirmationViewControllerDelegate, PKAccountServiceAccountResolutionControllerDelegate, PKMerchantTokenDetailViewControllerDelegate, PKDashboardTransactionFetcherDelegate, PKPaymentDataProvider;
...
-(BOOL)_recognitionHintsRowIsEnabled:(NSUInteger)arg0 ;
...
-(NSInteger)_maximumRetentionPeriodForElements:(id)arg0 ;
...
-(NSUInteger)_numberOfRecognitionHintsRows;
-(NSUInteger)_recognitionHintsRowForIndex:(NSUInteger)arg0 ;
-(id)_amountDetailsCellForTableView:(id)arg0 atIndexPath:(id)arg1 ;
-(id)_applePayOrderRowCellForTableView:(id)arg0 atIndexPath:(id)arg1 ;
-(id)_associatedFinancingPlanCellForTableView:(id)arg0 atIndexPath:(id)arg1 ;
...
-(id)_recognitionHintsCellForTableView:(id)arg0 atIndexPath:(id)arg1 ;
...
-(id)_tableViewCellForDeleteTransaction:(id)arg0 ;
...
-(id)initWithTransaction:(id)arg0 transactionSourceCollection:(id)arg1 familyCollection:(id)arg2 account:(id)arg3 accountUserCollection:(id)arg4 physicalCards:(id)arg5 contactResolver:(id)arg6 peerPaymentWebService:(id)arg7 paymentServiceDataProvider:(id)arg8 detailViewStyle:(NSInteger)arg9 allowTransactionLinks:(BOOL)arg10 ;
...
-(void)_callIssuer;
-(void)_cancelPaymentWithCell:(id)arg0 ;
...
-(void)_presentCancelPaymentWithIndexPath:(id)arg0 ;
...
-(void)_showAssociatedFinancingPlanDetailsForIndexPath:(id)arg0 ;
...
-(void)_updateWithTransactionTags:(id)arg0 ;
