...
@class UIView, UIScrollView, NSMutableDictionary, UIImage, UIPageControl, NSString, NSOrderedSet;
...
-(BOOL)isActionPresentedAsButtonCellForMessage:(id)arg0 ;
...
-(void)_configureEngagementCell:(id)arg0 withMessage:(id)arg1 ;
-(void)_configureMessageCell:(id)arg0 withMessage:(id)arg1 leftContentInset:(CGFloat)arg2 ;
