...
@class UIViewController, PLPlatterView, UIView, UIFont, UILabel, NSString, UIView<SBUISystemApertureAccessoryView>, UIColor, BSAction, NSURL, PKPass;
...
+(id)createForTransactionWithPass:(id)arg0 primaryText:(id)arg1 secondaryText:(id)arg2 trailingViewConfiguration:(id)arg3 walletForeground:(BOOL)arg4 ;
+(id)createWithPass:(id)arg0 primaryText:(id)arg1 secondaryText:(id)arg2 trailingViewConfiguration:(id)arg3 walletForeground:(BOOL)arg4 ;
