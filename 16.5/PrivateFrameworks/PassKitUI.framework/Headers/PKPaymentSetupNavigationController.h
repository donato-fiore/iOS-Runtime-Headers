...
-(BOOL)viewController:(id)arg0 requestsReturnToPresentationMarker:(NSUInteger)arg1 reset:(BOOL)arg2 ;
...
-(void)viewController:(id)arg0 requestPresentPassUniqueIdentifier:(id)arg1 completion:(id)arg2 ;
