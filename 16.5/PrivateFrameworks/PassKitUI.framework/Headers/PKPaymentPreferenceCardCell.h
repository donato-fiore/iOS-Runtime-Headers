...
@class UIActivityIndicatorView, UIStackView, UIColor, NSLayoutConstraint, UISwitch, UILabel, NSString, UIImageView, PKPaymentPass, PKTransitBalanceModel;
...
@property (readonly, nonatomic) UILabel *additionalContextLabel; // ivar: _additionalContextLabel
@property (copy, nonatomic) NSString *additionalContextString; // ivar: _additionalContextString
...
@property (readonly, nonatomic) UILabel *disclosureLabel; // ivar: _disclosureLabel
@property (copy, nonatomic) NSString *disclosureString; // ivar: _disclosureString
@property (readonly, nonatomic) UIImageView *disclosureView; // ivar: _disclosureView
