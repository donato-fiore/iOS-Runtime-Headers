...
// +(id)alertControllerForUnableReason:(NSUInteger)arg0 action:(id)arg1 displayableError:(id)arg2 addCardActionHandler:(id)arg3 unavailableActionHandler:(unk)arg4 cancelActionHandler:(id)arg5  ;
