...
@class PKPaymentPass, PKPaymentTransaction, PKAccount, PKAccountUser, PKFamilyMember, NSSet, PKAccountSupportTopic, NSString;
...
-(id)_formattedBodyTextForTopicBodyText:(id)arg0 ;
-(id)_formattedTransactionDate;
-(id)_replacePlaceholder:(id)arg0 withValue:(id)arg1 inBodyText:(id)arg2 ;
-(id)bodyText;
...
-(id)initWithPaymentPass:(id)arg0 transaction:(id)arg1 account:(id)arg2 accountUser:(id)arg3 familyMember:(id)arg4 physicalCards:(id)arg5 topic:(id)arg6 ;
-(id)intentParameters;
