...
@protocol ASWebAuthenticationPresentationContextProviding, UINavigationControllerDelegate, PKPaymentVerificationControllerDelegate, PKPaymentSetupViewControllerDelegate;
...
-(void)_isAppClipVerificationURLWithCompletion:(id)arg0 ;
-(void)_launchBankApp;
...
-(void)canPerformVerificationInline:(id)arg0 ;
