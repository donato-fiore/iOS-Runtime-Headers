...
@property (nonatomic) NSUInteger bodyViewContentMode; // ivar: _bodyViewContentMode
@property (nonatomic) CGFloat bodyViewPadding; // ivar: _bodyViewPadding
@property (nonatomic) BOOL bodyViewPrefersSizeTransform; // ivar: _bodyViewPrefersSizeTransform
@property (copy, nonatomic) id *bodyViewThatFitsOverride; // ivar: _bodyViewThatFitsOverride
...
@property (nonatomic) NSUInteger heroViewContentMode; // ivar: _heroViewContentMode
@property (nonatomic) BOOL heroViewPrefersSizeTransform; // ivar: _heroViewPrefersSizeTransform
@property (copy, nonatomic) id *heroViewSizeThatFitsOverride; // ivar: _heroViewSizeThatFitsOverride
@property (nonatomic) BOOL hideTitleText; // ivar: _hideTitleText
@property (retain, nonatomic) UIImage *image; // ivar: _image
@property (nonatomic) BOOL imageIgnoresTopSafeArea; // ivar: _imageIgnoresTopSafeArea
...
@property (nonatomic) CGFloat maxImageHeight; // ivar: _maxImageHeight
@property (retain, nonatomic) OBPrivacyLinkController *privacyLink; // ivar: _privacyLink
@property (nonatomic) BOOL reverseBodyViewAndBodyButtonOrder; // ivar: _reverseBodyViewAndBodyButtonOrder
