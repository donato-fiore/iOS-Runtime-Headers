...
-(id)_iconCacheKeyForApp:(NSInteger)arg0 bundleIdentifier:(id)arg1 size:(struct CGSize )arg2 ;
-(id)_iconCacheKeyForMerchant:(id)arg0 size:(struct CGSize )arg1 ignoreLogoURL:(BOOL)arg2 imageOut:(*id)arg3 ;
-(id)_iconCacheKeyForPayLaterMerchant:(id)arg0 size:(struct CGSize )arg1 ignoreLogoURL:(BOOL)arg2 imageOut:(*id)arg3 ;
...
-(id)_iconForTransaction:(id)arg0 merchant:(id)arg1 payLaterMerchant:(id)arg2 size:(struct CGSize )arg3 ignoreLogoURL:(BOOL)arg4 requestType:(NSUInteger)arg5 iconHandler:(id)arg6 ;
-(id)fileDownloader;
...
-(id)iconForPayLaterMerchant:(id)arg0 size:(struct CGSize )arg1 ignoreLogoURL:(BOOL)arg2 requestType:(NSUInteger)arg3 iconHandler:(id)arg4 ;
...
-(void)_iconForApplication:(NSInteger)arg0 applicationIdentifier:(id)arg1 requestToProcess:(id)arg2 iconHandler:(id)arg3 ;
-(void)_iconForReleasedData:(id)arg0 requestToProcess:(id)arg1 iconHandler:(id)arg2 ;
