...
#import "_TtC9PassKitUI27PaymentRequestViewInterface.h"

@interface PKPaymentRequestViewInterface : NSObject

@property (readonly, nonatomic) id *serviceDelegate;
@property (retain, nonatomic) _TtC9PassKitUI27PaymentRequestViewInterface *wrappedInterface; // ivar: _wrappedInterface
