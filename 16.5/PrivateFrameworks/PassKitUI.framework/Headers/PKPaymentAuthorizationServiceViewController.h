...
@property (weak, nonatomic) NSObject<PKPaymentAuthorizationServiceViewControllerDelegate> *delegate; // ivar: _delegate
@property (readonly, copy) NSString *description;
@property (readonly) NSUInteger hash;
@property (weak, nonatomic) NSObject<PKPaymentAuthorizationHostProtocol> *host; // ivar: _host
...
@property (readonly, weak, nonatomic) NSObject<PKPaymentAuthorizationPresenter> *presenter; // ivar: _presenter
...
-(id)initWithLayout:(id)arg0 presenter:(id)arg1 ;
...
-(void)_showUnserviceableAddressAlertForErrors:(id)arg0 ;
