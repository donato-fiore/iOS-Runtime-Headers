...
@class PSTableCell, PKPaymentApplication, UIActivityIndicatorView, UIImageView, CALayer, UIViewController, UIControl, NSString, UILabel, PKPaymentPass, PKPassFaceViewRendererState;
