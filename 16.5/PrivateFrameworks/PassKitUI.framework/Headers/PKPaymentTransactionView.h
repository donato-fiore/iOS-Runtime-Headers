...
@class UIView, UILabel, UIImageView, CNAvatarView, NSString, UIColor, UIImage, NSAttributedString;
...
@property (nonatomic) BOOL hideBadgeBackground; // ivar: _hideBadgeBackground
...
@property (nonatomic) BOOL showsBonusImage; // ivar: _showsBonusImage
