...
+(id)rowConfiguredForDisputeLayoutWithFinancingPlan:(id)arg0 payment:(id)arg1 selectionHandler:(id)arg2 ;
-(BOOL)isEqual:(id)arg0 ;
-(BOOL)shouldHighlightItem;
-(Class)cellClass;
-(id)initWithPrimaryTitle:(id)arg0 identifier:(id)arg1 selectionHandler:(id)arg2 ;
