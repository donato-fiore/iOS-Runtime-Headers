...
@protocol PKPassGroupViewDelegate, PKPassDeleteAnimationControllerDelegate, PKPaymentServiceDelegate, PKPassFooterViewDelegate, PKDashboardPassViewControllerDelegate, PKPassDeleteHandler, PKPassGroupViewReceiver, PKInvalidatable, OS_dispatch_source, PKPassGroupStackViewDatasource, PKPassGroupStackViewDelegate><UIScrollViewDelegate;
...
@interface PKPassGroupStackView : UIScrollView <PKPassGroupViewDelegate, PKPassDeleteAnimationControllerDelegate, PKPaymentServiceDelegate, PKPassFooterViewDelegate, PKDashboardPassViewControllerDelegate, PKPassDeleteHandler, PKPassGroupViewReceiver, PKInvalidatable>

 {
    ...
    CGFloat _footerPocketForegroundShadowAlpha;
...
+(id)backgroundColor;
-(BOOL)_acquireGroupView:(id)arg0 resetExternalVC:(BOOL)arg1 ;
...
-(BOOL)_updateContentSizeWithPriorBounds:(struct CGRect *)arg0 bounds:(struct CGRect *)arg1 ;
-(BOOL)_updateHeaderContext:(*id)arg0 toContext:(id)arg1 animated:(BOOL)arg2 ;
-(BOOL)_updateHeaderFooterStateAnimated:(BOOL)arg0 layout:(BOOL)arg1 ;
...
-(id)_layoutStateForHeaderContext:(id)arg0 inTableWithBounds:(struct CGRect )arg1 ;
-(id)_layoutStateForHeaderContext:(id)arg0 offscreenWithBounds:(struct CGRect )arg1 offset:(CGFloat)arg2 ;
...
-(void)_removePanGestureRecognizerFromGroupView:(id)arg0 ;
...
-(void)reloadData;
-(void)reloadSuppressedContentForGroupView:(id)arg0 ;
