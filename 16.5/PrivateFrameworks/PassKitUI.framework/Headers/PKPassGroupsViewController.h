...
@class UIViewController, UINavigationController, PKPaymentService, NSTimer, NSMutableArray, NSArray, PKPeerPaymentService, PKDiscoveryDataSource, PKApplicationMessageNodeMultipleGroupBranch, NSString, PKGroupsController;
...
@interface PKPassGroupsViewController : UIViewController <PKGroupsControllerDelegate, PKPassGroupStackViewDatasource, PKPassGroupStackViewDelegate, PKExpiredPassesViewControllerDelegate, PKServiceAddPassesViewControllerResultsDelegate, UIScrollViewDelegate, PKForegroundActiveArbiterObserver, PKPaymentServiceDelegate, PKPaymentSetupDelegate, PKPerformActionViewControllerDelegate, PKPeerPaymentAccountResolutionControllerDelegate, PKAccountServiceAccountResolutionControllerDelegate, PKDiscoveryDataSourceDelegate, PKSubcredentialProvisioningFlowControllerDelegate, _PKUIKVisibilityBackdropViewDelegate, PKPGSVFooterViewDelegate, PKPGSVSectionSubheaderDelegate, PKPGSVSectionHeaderViewDelegate, PKApplicationMessageViewDelegate, PKInboxDataSourceDelegate, PKVirtualCardEnrollmentViewControllerDelegate, PKPassPersonalizationViewControllerDelegate, PKDiscoveryArticleViewControllerPresenter>

 {
    ...
    CGFloat _pinnedNavigationHeight;
...
-(void)_presentAccountTransactionDetailsForTransaction:(id)arg0 ;
...
-(void)_resetWithBackgroundAllowedVCs:(BOOL)arg0 animated:(BOOL)arg1 completion:(id)arg2 ;
...
-(void)allowIdleTimer;
-(void)applicationMessageView:(id)arg0 requestsContentDismissal:(id)arg1 ;
-(void)applicationMessageView:(id)arg0 tappedApplicationMessageWithKey:(id)arg1 ;
...
-(void)passPersonalizationViewController:(id)arg0 didFinishPersonalizingPass:(id)arg1 success:(BOOL)arg2 ;
-(void)paymentDeviceDidEnterFieldWithProperties:(id)arg0 ;
-(void)paymentDeviceDidExitField;
-(void)paymentSetupDidFinish:(id)arg0 ;
-(void)paymentSetupRequestPresentPassUniqueIdentifier:(id)arg0 completion:(id)arg1 ;
...
-(void)presentAccountFeature:(NSUInteger)arg0 animated:(BOOL)arg1 destination:(NSUInteger)arg2 completion:(id)arg3 ;
...
-(void)presentApplicationWithIdentifier:(id)arg0 ;
...
-(void)presentDailyCashForPassUniqueIdentifier:(id)arg0 dateComponents:(id)arg1 redemptionType:(NSUInteger)arg2 animated:(BOOL)arg3 completion:(id)arg4 ;
...
-(void)presentRewardsHubMerchantsForPassUniqueIdentifier:(id)arg0 privateIdentifier:(id)arg1 animated:(BOOL)arg2 completion:(id)arg3 ;
-(void)presentSearchWithCompletion:(id)arg0 ;
-(void)presentSecurePassSessionWithIssuerData:(id)arg0 withSignature:(id)arg1 animated:(BOOL)arg2 ;
