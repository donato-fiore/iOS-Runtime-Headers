...
-(id)selectedRecipientWithOutContactIdentifier:(*id)arg0 ;
-(void)_performActivity:(id)arg0 ;
-(void)activityViewController:(id)arg0 willStartAirdropTransferToRecipient:(id)arg1 contactIdentifier:(id)arg2 ;
