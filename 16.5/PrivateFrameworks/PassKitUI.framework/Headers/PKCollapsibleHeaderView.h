...
@class UIView, UILabel, UISearchBar, UIActivityIndicatorView, LAUICheckmarkLayer, NSString, UIImage, UIFont;
...
@property (nonatomic) CGFloat additionalTopPadding; // ivar: _additionalTopPadding
