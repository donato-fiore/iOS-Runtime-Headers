...
-(id)initWithTransactionGroup:(id)arg0 transactionSourceCollection:(id)arg1 familyCollection:(id)arg2 account:(id)arg3 accountUserCollection:(id)arg4 physicalCards:(id)arg5 fetcher:(id)arg6 transactionHistory:(id)arg7 detailViewStyle:(NSInteger)arg8 ;
