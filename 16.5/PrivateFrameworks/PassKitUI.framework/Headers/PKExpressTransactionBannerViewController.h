...
@class UIViewController, PKPass, PKTransitBalanceModel, UIView, CLInUseAssertion, PKExpressTransactionState, PKPaymentService, NSMutableDictionary, NSString, UIView<SBUISystemApertureAccessoryView>, UIColor, BSAction, NSURL;
