...
@class PKAccountService, PKPaymentWebService, NSCalendar, NSTimeZone, PKAccountWebServiceSchedulePaymentRequest, PKApplePayTrustSignatureRequest, NSError, UIViewController, PKPaymentAuthorizationCoordinator, PKAccount, PKCurrencyAmount, NSArray, NSString, NSDate;
...
-(id)_schedulePaymentRequestWithBankAccount:(id)arg0 ;
