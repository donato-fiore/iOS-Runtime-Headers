...
-(BOOL)_isListSectionAtIndex:(NSInteger)arg0 ;
-(BOOL)collectionView:(id)arg0 layout:(id)arg1 hasHeaderForSectionAtIndex:(NSInteger)arg2 ;
-(BOOL)collectionView:(id)arg0 layout:(id)arg1 isListSectionAtIndex:(NSInteger)arg2 ;
