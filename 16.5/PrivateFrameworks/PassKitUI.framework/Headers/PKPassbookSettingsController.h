...
@class PKPaymentService, PKPaymentPreference, PKPaymentPreferenceCard, PKPaymentWebService, NSString, NSArray, PKAccount, CIDVUIProofingFlowManager, PSSpecifier, PKPeerPaymentWebService, PKPeerPaymentAccount, PKExpressPassController, PKAccountService, NSMutableDictionary, LAContext, PKContactFormatValidator, NSMutableArray;
...
@interface PKPassbookSettingsController : NSObject <PKPaymentServiceDelegate, PKPeerPaymentAccountResolutionControllerDelegate, PKPaymentDataProviderDelegate, PKSwitchSpinnerTableCellDelegate, PKPaymentSetupDelegate, PKAccountServiceObserver, PKSubcredentialProvisioningFlowControllerDelegate, PKInboxDataSourceDelegate, CIDVUIProofingFlowManagerDelegate, PKPaymentPassTableCellDelegate>

 {
    ...
    NSUInteger _shouldShowLaunchPrompts;
...
-(id)_accountSpecifierForAccount:(id)arg0 ;
...
-(id)_onlinePaymentsSettingForSpecifier:(id)arg0 ;
-(id)_openAccountsGroupSpecifiers;
-(id)_orderManagementGroupSpecifiers;
-(id)_orderManagementNotificationsSettingForSpecifier:(id)arg0 ;
-(id)_orderManagementSettingForSpecifier:(id)arg0 ;
...
-(id)_showPayLaterOptionsSettingForSpecifier:(id)arg0 ;
-(id)_showPayLaterOptionsSpecifiers;
-(id)_specifierForPassUniqueID:(id)arg0 ;
-(id)_subtitleTextForActiveAccount:(id)arg0 ;
...
-(void)_processAccountChanged:(id)arg0 ;
...
-(void)_reloadBalancesAndTransitPassPropertiesForPass:(id)arg0 withDataProvider:(id)arg1 ;
...
-(void)_setOnlinePaymentsSetting:(id)arg0 forSpecifier:(id)arg1 ;
-(void)_setOrderManagementNotificationsSetting:(id)arg0 forSpecifier:(id)arg1 ;
-(void)_setOrderManagementSetting:(id)arg0 forSpecifier:(id)arg1 ;
-(void)_setShowPayLaterOptionsSwitchSetting:(id)arg0 forSpecifier:(id)arg1 ;
-(void)_showAccountInfoForSavingsAccount:(id)arg0 ;
...
-(void)_showDocumentsForAccounts:(id)arg0 title:(id)arg1 sender:(id)arg2 ;
-(void)_showDocumentsForClosedSavingsAccounts:(id)arg0 ;
-(void)_transitPropertiesForPaymentPass:(id)arg0 withCompletion:(id)arg1 ;
-(void)_unregisterForPeerPaymentWithSpecifier:(id)arg0 ;
-(void)_updateAccountIfNecessary:(id)arg0 ;
...
-(void)addCardTapped;
-(void)addCardTappedForPaymentPassWithSpecifier:(id)arg0 ;
...
-(void)openPeerPaymentSetupWithCurrencyAmount:(id)arg0 state:(NSUInteger)arg1 senderAddress:(id)arg2 ;
...
-(void)startPreflightWithMode:(NSInteger)arg0 referrerIdentifier:(id)arg1 allowedFeatureIdentifiers:(id)arg2 ;
