...
@property (nonatomic) NSInteger activeFinancingPlansCount; // ivar: _activeFinancingPlansCount
...
@property (retain, nonatomic) PKPayLaterBusinessChatTopicComposer *payLaterTopicsComposer; // ivar: _payLaterTopicsComposer
...
-(NSUInteger)_removeUnsupportedContactIssuerOptions:(NSUInteger)arg0 ;
...
-(id)createPrivacyFooterViewForContext:(NSUInteger)arg0 ;
...
-(void)launchAppURL:(id)arg0 ;
-(void)launchURL:(id)arg0 ;
...
-(void)presentFinancingPlan:(id)arg0 ;
...
-(void)reloadPassDetailSections:(id)arg0 ;
