...
@class PKPaymentPass, PKPeerPaymentWebService, PKPeerPaymentAccount, PKPeerPaymentController, PKBankAccountInformation, NSString;
@protocol PKPaymentSetupViewControllerDelegate, PKAddBankAccountInformationViewControllerDelegate, PKExplanationViewControllerDelegate, PKPeerPaymentControllerDelegate, PKPassLibraryDataProvider, PKPeerPaymentActionControllerDelegate;
...
-(id)presentationSceneIdentifierForPeerPaymentController:(id)arg0 ;
