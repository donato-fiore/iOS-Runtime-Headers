...
-(id)footerView;
-(id)initWithTransactionSourceCollection:(id)arg0 familyCollection:(id)arg1 avatarManager:(id)arg2 account:(id)arg3 accountUserCollection:(id)arg4 physicalCards:(id)arg5 fetcher:(id)arg6 weeks:(id)arg7 months:(id)arg8 years:(id)arg9 type:(NSUInteger)arg10 unit:(NSUInteger)arg11 currentMonthTransactions:(id)arg12 pendingPayments:(id)arg13 upcomingScheduledPayments:(id)arg14 dispayType:(NSUInteger)arg15 ;
