...
@class NSMapTable, UNNotificationSettingsCenter, NSMutableDictionary, NSString;
...
@property (retain) NSMutableDictionary *appNotificationSettings; // ivar: _appNotificationSettings
@property NSInteger cachedAnnounceCarPlaySetting; // ivar: _cachedAnnounceCarPlaySetting
...
-(BOOL)syncAnnounceNotificationsEnabledForAppBundleId:(id)arg0 ;
-(BOOL)syncNotificationBannersVisibleInCarPlayForAppBundleId:(id)arg0 ;
...
-(id)cachedNotificationSettingsForAppBundleId:(id)arg0 asyncFetchNewValuesAndUpdateObservers:(BOOL)arg1 ;
-(id)init;
...
-(void)_updateNotificationSettingsChangeAndNotifyObserversForAppBundleId:(id)arg0 ifDifferentFromSettings:(id)arg1 ;
