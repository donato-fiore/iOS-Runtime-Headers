...
@class NSUserDefaults, NSMutableDictionary, NSArray, NSDictionary;
@protocol NSCopying;
...
@property (readonly, nonatomic) NSInteger tipStatusCount;
...
-(void)updateTipSavedForIdentifier:(id)arg0 date:(id)arg1 ;
