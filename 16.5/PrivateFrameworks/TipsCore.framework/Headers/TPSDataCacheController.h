...
@property (retain, nonatomic) NSObject<OS_dispatch_queue> *dataCacheSerialQueue; // ivar: _dataCacheSerialQueue
...
+(void)removeDataCacheAtPath:(id)arg0 ;
-(BOOL)cacheValidForIdentifier:(id)arg0 ;
-(BOOL)isDataCacheValid:(id)arg0 ;
...
-(id)formattedDataForPath:(id)arg0 identifier:(id)arg1 attributionIdentifier:(id)arg2 priority:(float)arg3 completionHandler:(id)arg4 ;
-(id)formattedDataForRequest:(id)arg0 identifier:(id)arg1 attributionIdentifier:(id)arg2 requestType:(id)arg3 priority:(float)arg4 completionHandler:(id)arg5 ;
