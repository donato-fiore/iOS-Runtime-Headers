...
@class NSURL, NSError, NSMutableData, NSString, NSHTTPURLResponse, NSHashTable, NSURLSessionTask, NSURLSession;
...
@property (weak, nonatomic) NSURLSession *underlyingSession; // ivar: _underlyingSession
