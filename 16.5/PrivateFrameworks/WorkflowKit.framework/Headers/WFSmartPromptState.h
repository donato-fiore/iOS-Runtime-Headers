...
@class NSString, WFContentLocation, WFContentAttribution;
...
@property (readonly, nonatomic) WFContentLocation *contentDestination; // ivar: _contentDestination
...
+(id)localizedDeniedPermissionsErrorWithContentDestination:(id)arg0 ;
