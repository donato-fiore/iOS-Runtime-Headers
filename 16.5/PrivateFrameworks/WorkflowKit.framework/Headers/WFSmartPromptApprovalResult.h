...
@class NSString, NSArray, WFContentAttributionSet;
...
@property (readonly, nonatomic) WFContentAttributionSet *previousAttributions; // ivar: _previousAttributions
...
-(id)initWithAllowedStates:(id)arg0 deniedStates:(id)arg1 undefinedStates:(id)arg2 restrictedStates:(id)arg3 actionUUID:(id)arg4 previousAttributions:(id)arg5 ;
