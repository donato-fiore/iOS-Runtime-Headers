...
@class NSArray, NSManagedObjectContext, NSString, NSURL, NSHashTable, WFCoreDataChangeNotification, NSPersistentStoreDescription;
...
@property (readonly, nonatomic) NSObject<OS_dispatch_queue> *changeNotificationQueue; // ivar: _changeNotificationQueue
...
@property (retain, nonatomic) WFCoreDataChangeNotification *pendingLocalChangeNotification; // ivar: _pendingLocalChangeNotification
@property (retain, nonatomic) WFCoreDataChangeNotification *pendingRemoteChangeNotification; // ivar: _pendingRemoteChangeNotification
@property (retain, nonatomic) NSPersistentStoreDescription *persistentStoreDescription; // ivar: _persistentStoreDescription
@property (nonatomic, getter=isPostingDistributedNotifications) BOOL postDistributedNotifications; // ivar: _postDistributedNotifications
@property (readonly, nonatomic) WFDebouncer *remoteChangeNotificationDebouncer; // ivar: _remoteChangeNotificationDebouncer
@property (readonly, nonatomic) NSObject<OS_dispatch_queue> *remoteChangeQueue; // ivar: _remoteChangeQueue
...
+(id)appDescriptorFromData:(id)arg0 ;
+(id)createDatabaseForTesting;
+(id)dataFromObject:(id)arg0 error:(*id)arg1 ;
+(id)defaultDatabase;
+(id)disabledAutoShortcutsFromData:(id)arg0 ;
+(id)identifierForAppDescriptor:(id)arg0 ;
...
-(BOOL)deleteAutoShortcutsPreferencesForIdentifier:(id)arg0 error:(*id)arg1 ;
...
-(BOOL)isAutoShortcutDisabledForAppDescriptor:(id)arg0 autoShortcutIdentifier:(id)arg1 error:(*id)arg2 ;
-(BOOL)isAutoShortcutDisabledForBundleIdentifier:(id)arg0 autoShortcutIdentifier:(id)arg1 ;
-(BOOL)isAutoShortcutDisabledForBundleIdentifier:(id)arg0 autoShortcutIdentifier:(id)arg1 error:(*id)arg2 ;
-(BOOL)isEqual:(id)arg0 ;
-(BOOL)isReference:(id)arg0 allowedToRunOnDomain:(id)arg1 ;
-(BOOL)isSiriEnabledForAutoShortcutsWithAppDescriptor:(id)arg0 error:(*id)arg1 ;
-(BOOL)isSiriEnabledForAutoShortcutsWithBundleIdentifier:(id)arg0 ;
-(BOOL)isSiriEnabledForAutoShortcutsWithBundleIdentifier:(id)arg0 error:(*id)arg1 ;
-(BOOL)isSpotlightEnabledForAutoShortcutsWithAppDescriptor:(id)arg0 error:(*id)arg1 ;
-(BOOL)isSpotlightEnabledForAutoShortcutsWithBundleIdentifier:(id)arg0 ;
-(BOOL)isSpotlightEnabledForAutoShortcutsWithBundleIdentifier:(id)arg0 error:(*id)arg1 ;
-(BOOL)mergeAutoShortcutsPreferencesWithNewPreferences:(id)arg0 error:(*id)arg1 ;
...
-(BOOL)saveSmartPromptState:(id)arg0 reference:(id)arg1 error:(*id)arg2 ;
-(BOOL)saveSmartPromptStateData:(id)arg0 actionUUID:(id)arg1 reference:(id)arg2 error:(*id)arg3 ;
-(BOOL)setAutoShortcutDisabledForAppDescriptor:(id)arg0 autoShortcutDisabled:(BOOL)arg1 autoShortcutIdentifier:(id)arg2 error:(*id)arg3 ;
-(BOOL)setAutoShortcutDisabledForBundleIdentifier:(id)arg0 autoShortcutDisabled:(BOOL)arg1 autoShortcutIdentifier:(id)arg2 source:(NSUInteger)arg3 error:(*id)arg4 ;
-(BOOL)setShortcutSuggestions:(id)arg0 forAppWithBundleIdentifier:(id)arg1 error:(*id)arg2 ;
-(BOOL)setSiriAutoShortcutsEnablement:(BOOL)arg0 forAppDescriptor:(id)arg1 error:(*id)arg2 ;
-(BOOL)setSiriAutoShortcutsEnablement:(BOOL)arg0 forBundleIdentifier:(id)arg1 source:(NSUInteger)arg2 error:(*id)arg3 ;
-(BOOL)setSpotlightAutoShortcutsEnablement:(BOOL)arg0 forAppDescriptor:(id)arg1 error:(*id)arg2 ;
-(BOOL)setSpotlightAutoShortcutsEnablement:(BOOL)arg0 forBundleIdentifier:(id)arg1 source:(NSUInteger)arg2 error:(*id)arg3 ;
-(BOOL)setWalrusStateForTesting:(NSInteger)arg0 withError:(*id)arg1 ;
-(BOOL)shouldPromptForCurrentContentItemCount:(NSUInteger)arg0 previousCount:(NSUInteger)arg1 ;
-(BOOL)startObservingChangesForResult:(id)arg0 ;
-(BOOL)updateAutoShortcutsPreferencesWithNewPreferences:(id)arg0 error:(*id)arg1 ;
...
-(id)approvalResultForContentAttributionSet:(id)arg0 contentDestination:(id)arg1 actionUUID:(id)arg2 actionIdentifier:(id)arg3 actionIndex:(NSUInteger)arg4 reference:(id)arg5 allowedOnceStates:(id)arg6 ;
-(id)autoShortcutsPreferencesForAppDescriptor:(id)arg0 error:(*id)arg1 ;
-(id)autoShortcutsPreferencesForBundleIdentifier:(id)arg0 error:(*id)arg1 ;
-(id)autoShortcutsPreferencesForIdentifier:(id)arg0 error:(*id)arg1 ;
-(id)autoShortcutsPreferencesFromCoreDataAutoShortcutsPreferences:(id)arg0 ;
...
-(id)coreDataAutoShortcutsPreferencesForAppDescriptor:(id)arg0 error:(*id)arg1 ;
-(id)coreDataAutoShortcutsPreferencesForIdentifier:(id)arg0 error:(*id)arg1 ;
...
-(id)defaultCoreDataAutoShortcutsPreferencesForAppDescriptor:(id)arg0 error:(*id)arg1 ;
-(id)deletedFolders;
-(id)deletedWorkflowIDsForSync;
-(id)deletionAuthorizationStatesForReference:(id)arg0 ;
-(id)descriptorsForFetchOperation:(id)arg0 state:(*id)arg1 error:(*id)arg2 ;
-(id)descriptorsForResult:(id)arg0 state:(*id)arg1 error:(*id)arg2 ;
...
-(id)initWithStoreDescription:(id)arg0 runMigrationsIfNecessary:(BOOL)arg1 useLockFile:(BOOL)arg2 error:(*id)arg3 ;
-(id)latestRunEvent;
...
// -(id)performOperationWithReason:(id)arg0 block:(id)arg1 error:(unk)arg2  ;
// -(id)performSaveOperationWithReason:(id)arg0 block:(id)arg1 error:(unk)arg2  ;
...
// -(id)saveAutoShortcutsPreferencesForAppDescriptor:(id)arg0 update:(id)arg1 error:(unk)arg2  ;
...
-(id)sortedVisibleWorkflowsByNameWithLimit:(NSInteger)arg0 ;
-(id)sortedVisibleWorkflowsInCollection:(id)arg0 ;
-(id)sortedVisibleWorkflowsNameContains:(id)arg0 limit:(NSInteger)arg1 ;
...
-(id)workflowSiriRunEventWithIdentifier:(id)arg0 ;
...
-(void)compactDeletionAuthorizationsIfNecessaryForWorkflowReference:(id)arg0 ;
-(void)contextDidSave:(id)arg0 ;
-(void)createSmartPromptStatesForInsertedActions:(id)arg0 forReference:(id)arg1 ;
-(void)dealloc;
-(void)deleteAllDeletionAuthorizationsForReference:(id)arg0 ;
...
// -(void)performTransactionWithReason:(id)arg0 block:(id)arg1 error:(unk)arg2  ;
...
-(void)saveSmartPromptStatesForInsertedAction:(id)arg0 contentDestination:(id)arg1 reference:(id)arg2 ;
...
-(void)trackMetricsForToggleType:(NSUInteger)arg0 source:(NSUInteger)arg1 bundleIdentifier:(id)arg2 isEnabled:(BOOL)arg3 ;
