...
@class NSArray, NSString, WFIcon, WFWorkflowIcon;
@protocol WFNaming, WFActionEventObserver, WFDatabaseObjectObserver, NSCopying, WFWorkflowEditingDelegate, WFWorkflowNoInputBehavior, WFWorkflowStorage;
...
@property (nonatomic) BOOL ignoreModifications; // ivar: _ignoreModifications
...
@property (nonatomic) BOOL shouldAutoUpdateAssociatedAppBundleIdentifier; // ivar: _shouldAutoUpdateAssociatedAppBundleIdentifier
...
-(id)initWithRecord:(id)arg0 reference:(id)arg1 storageProvider:(id)arg2 error:(*id)arg3 ;
-(id)initWithRecord:(id)arg0 reference:(id)arg1 storageProvider:(id)arg2 migrateIfNecessary:(BOOL)arg3 environment:(NSInteger)arg4 error:(*id)arg5 ;
...
-(void)_insertAction:(id)arg0 atIndex:(NSUInteger)arg1 ;
