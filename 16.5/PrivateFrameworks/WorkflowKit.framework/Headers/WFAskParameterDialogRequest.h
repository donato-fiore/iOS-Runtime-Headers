...
@class WFDialogRequest, NSString, WFDialogButton, NSDictionary;
...
+(NSInteger)dialogComponentStyleForParameter:(id)arg0 ;
-(id)description;
-(id)initWithActionIdentifier:(id)arg0 parameterKey:(id)arg1 serializedParameterStates:(id)arg2 style:(NSInteger)arg3 attribution:(id)arg4 prompt:(id)arg5 doneButton:(id)arg6 focusImmediatelyWhenPresented:(BOOL)arg7 ;
