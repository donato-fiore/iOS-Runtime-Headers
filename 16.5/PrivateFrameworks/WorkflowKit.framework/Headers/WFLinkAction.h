...
@class NSArray, NSDictionary, LNActionSummary, INAppIntentDescriptor, NSString, LNConnection, LNAppIntentConnectionPolicy, NSSet, LNActionMetadata, NSNumber, NSMutableDictionary;
...
@property (readonly, nonatomic) BOOL shouldSkipLoadingDefaultValue; // ivar: _shouldSkipLoadingDefaultValue
...
-(id)alertForLinkResult:(id)arg0 handler:(id)arg1 ;
...
-(id)initWithIdentifier:(id)arg0 metadata:(id)arg1 definition:(id)arg2 serializedParameters:(id)arg3 appIntentDescriptor:(id)arg4 ;
-(id)inputDictionary;
...
-(void)confirmContinueInAppWithRequest:(id)arg0 dialogString:(id)arg1 ;
...
-(void)executor:(id)arg0 needsContinueInAppWithRequest:(id)arg1 ;
...
-(void)finishRunningWithResult:(id)arg0 error:(id)arg1 ;
...
-(void)performPresentationActionWithResult:(id)arg0 ;
-(void)runAsynchronouslyWithInput:(id)arg0 ;
-(void)runAsynchronouslyWithLinkAction:(id)arg0 ;
-(void)serializeAppIntentDescriptorIfNecessary;
-(void)showResultIfNeeded:(id)arg0 completionHandler:(id)arg1 ;
