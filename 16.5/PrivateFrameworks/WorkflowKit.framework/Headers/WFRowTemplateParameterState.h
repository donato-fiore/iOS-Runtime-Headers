...
@property (readonly, nonatomic) WFMeasurementUnitSubstitutableState *measurementUnitValue; // ivar: _measurementUnitValue
...
-(id)stateBySettingMeasurementUnitValue:(id)arg0 ;
