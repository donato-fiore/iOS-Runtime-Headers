...
-(id)approvalResultForContentAttributionSet:(id)arg0 contentDestination:(id)arg1 actionUUID:(id)arg2 actionIdentifier:(id)arg3 actionIndex:(NSUInteger)arg4 reference:(id)arg5 allowedOnceStates:(id)arg6 error:(*id)arg7 ;
...
-(id)sortedWorkflowsWithQuery:(id)arg0 error:(*id)arg1 ;
