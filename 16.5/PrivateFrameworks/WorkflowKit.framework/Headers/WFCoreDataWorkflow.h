...
@class NSManagedObject, NSSet, NSString, NSData, NSDate, NSArray, NSDictionary, WFWorkflowIcon;
...
@property (nonatomic) NSInteger lastSyncedEncryptedSchemaVersion;
...
@property (nonatomic) NSInteger wantedEncryptedSchemaVersion;
