...
@property (readonly, nonatomic) WFVariableString *subtitle; // ivar: _subtitle
...
-(id)initWithVariableString:(id)arg0 synonyms:(id)arg1 subtitle:(id)arg2 ;
-(id)initWithVariableString:(id)arg0 userInputInsertionIndex:(NSInteger)arg1 ;
-(id)initWithVariableString:(id)arg0 userInputInsertionIndex:(NSInteger)arg1 synonyms:(id)arg2 subtitle:(id)arg3 ;
