...
@property (retain) BRCBouncingReport *bounceReport; // ivar: bounceReport
...
@property (retain) NSString *crashReporterKey; // ivar: crashReporterKey
...
@property (retain) BRCEAccessReport *eaccessReport; // ivar: eaccessReport
@property NSUInteger errorOriginatorId; // ivar: errorOriginatorId
@property BOOL errorOverriden; // ivar: errorOverriden
