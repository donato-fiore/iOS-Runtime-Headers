...
@class BRCDumper, NSDate, PQLConnection, NSString;
...
@property (nonatomic) BOOL newLineAfterWrite; // ivar: _newLineAfterWrite
...
-(BOOL)shouldKeepDumpingWithItemCount:(unsigned int)arg0 includeAllItems:(BOOL)arg1 ;
