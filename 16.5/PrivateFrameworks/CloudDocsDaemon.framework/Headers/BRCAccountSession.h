...
@class NSMutableDictionary, NSURL, NSString, NSHashTable, br_pacer, NSMutableSet, NSNumber, BRDSIDString;
...
@property (nonatomic) int ciconiaState; // ivar: _ciconiaState
@property (nonatomic) NSUInteger ciconiaVersion; // ivar: _ciconiaVersion
...
-(BOOL)_isExpectedCiconiaError:(id)arg0 ;
...
-(BOOL)shouldStartCiconiaBasedOnItemsCountWithAcountHash:(NSUInteger)arg0 ;
...
-(void)_reportFailedQueueingMigration:(id)arg0 ;
...
-(void)_unlinkContainersWithPristineContainerIDs:(id)arg0 ;
