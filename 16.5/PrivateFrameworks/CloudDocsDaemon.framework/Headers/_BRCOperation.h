...
@property (readonly, nonatomic) CGFloat executionTimeInSec;
...
@property (readonly, nonatomic) ? logSections; // ivar: _logSections
...
-(void)_setDeviceConfigurationHeaderOnCKOp:(id)arg0 ;
