...
+(BOOL)isEqualPolynomials:(struct ADDistortionPolynomials *)arg0 otherPolynomials:(struct ADDistortionPolynomials *)arg1 ;
+(NSUInteger)hashPolynomials:(struct ADDistortionPolynomials *)arg0 ;
