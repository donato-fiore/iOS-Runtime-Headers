...
@class NSArray, NSDictionary, NSMutableDictionary, NSOrderedSet, NSMutableOrderedSet;
...
@property (retain, nonatomic) NSMutableDictionary *fetchStartTimesBySource; // ivar: _fetchStartTimesBySource
...
+(void)initialize;
-(BOOL)shouldAllowBundleIDWithNoPolicy:(id)arg0 ;
...
-(void)fetchCompletedForSource:(id)arg0 ;
...
-(void)fetchStartedForSource:(id)arg0 ;
...
-(void)verifyDataUsagePoliciesForSources:(id)arg0 queue:(id)arg1 completion:(id)arg2 ;
