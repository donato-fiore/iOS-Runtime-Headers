...
@interface SATask : NSObject <SASerializable>

 {
    ...
    NSUInteger _resourceCoalitionID;
    NSUInteger _adamID;
...
@property (readonly) NSString *commerceAppID; // ivar: _commerceAppID
@property (readonly) NSString *commerceExternalID; // ivar: _commerceExternalID
@property (readonly, copy) NSString *debugDescription;
@property (readonly, copy) NSString *description;
@property (readonly) char developerType; // ivar: _developerType
...
@property (readonly) NSUInteger resourceCoalitionID;
@property (readonly) int rpid;
@property (readonly) SASharedCache *sharedCache;
@property (readonly) Class superclass;
@property (readonly) NSDictionary *swiftTasks; // ivar: _swiftTasks
...
-(NSUInteger)indexOfFirstTaskStateOnOrAfterTime:(id)arg0 sampleIndex:(NSUInteger)arg1 ;
-(NSUInteger)indexOfFirstTaskStateOnOrAfterTime:(id)arg0 withSampleIndex:(BOOL)arg1 ;
-(NSUInteger)indexOfLastTaskStateOnOrBeforeTime:(id)arg0 sampleIndex:(NSUInteger)arg1 ;
...
-(id)endTimestamp;
-(id)firstTaskStateOnOrAfterTime:(id)arg0 sampleIndex:(NSUInteger)arg1 ;
...
-(id)initWithPid:(int)arg0 uniquePid:(NSUInteger)arg1 name:(char *)arg2 mainBinaryPath:(id)arg3 pidStartTime:(NSUInteger)arg4 loadInfos:(struct dyld_uuid_info_64 *)arg5 numLoadInfos:(unsigned int)arg6 textExecLoadInfos:(struct dyld_uuid_info_64 *)arg7 numTextExecLoadInfos:(unsigned int)arg8 architecture:(struct _CSArchitecture )arg9 sharedCache:(id)arg10 ;
-(id)lastTaskStateOnOrBeforeTime:(id)arg0 sampleIndex:(NSUInteger)arg1 ;
...
-(void)enumerateTaskStatesBetweenStartTime:(id)arg0 startSampleIndex:(NSUInteger)arg1 endTime:(id)arg2 endSampleIndex:(NSUInteger)arg3 reverseOrder:(BOOL)arg4 block:(id)arg5 ;
