...
-(NSUInteger)indexOfFirstThreadStateOnOrAfterTime:(id)arg0 sampleIndex:(NSUInteger)arg1 ;
-(NSUInteger)indexOfFirstThreadStateOnOrAfterTime:(id)arg0 withSampleIndex:(BOOL)arg1 ;
-(NSUInteger)indexOfLastThreadStateOnOrBeforeTime:(id)arg0 sampleIndex:(NSUInteger)arg1 ;
...
-(id)firstThreadStateOnOrAfterTime:(id)arg0 sampleIndex:(NSUInteger)arg1 ;
-(id)firstThreadStateOnOrAfterTime:(id)arg0 withSampleIndex:(BOOL)arg1 ;
-(id)initWithId:(NSUInteger)arg0 ;
-(id)lastThreadStateOnOrBeforeTime:(id)arg0 sampleIndex:(NSUInteger)arg1 ;
...
-(void)enumerateThreadStatesBetweenStartTime:(id)arg0 startSampleIndex:(NSUInteger)arg1 endTime:(id)arg2 endSampleIndex:(NSUInteger)arg3 reverseOrder:(BOOL)arg4 block:(id)arg5 ;
