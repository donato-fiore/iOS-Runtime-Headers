...
@interface SASampleStore : NSObject <NSSecureCoding>

 {
    ...
    NSUInteger _numVnodesAllocated;
    NSUInteger _numVnodesFree;
    NSUInteger _numVnodesSoftLimit;
    NSUInteger _numVnodesHardLimit;
...
@property (copy) NSString *osProductVersionExtra; // ivar: _osProductVersionExtra
