...
@class NSMutableSet, NSNumber, NSData, NSString, NSSet;
...
-(BOOL)_lock_mergeLocalConfigurationRecord:(id)arg0 withRemoteCKRecord:(id)arg1 deleteModeOnCorruption:(BOOL)arg2 ;
-(BOOL)_lock_mergeLocalConfigurationRecord:(id)arg0 withRemoteConfigurationRecord:(id)arg1 modeIdentifier:(id)arg2 sourceDeviceIdentifier:(id)arg3 sourceFrameworkVersion:(struct ? )arg4 sourceIsCloud:(BOOL)arg5 sourceWantsToForce:(BOOL)arg6 deleteModeOnCorruption:(BOOL)arg7 ;
-(BOOL)_lock_populateDNDSIDSRecord:(id)arg0 ;
-(NSInteger)_lock_populateCKRecord:(id)arg0 lastChanceRecord:(id)arg1 ;
