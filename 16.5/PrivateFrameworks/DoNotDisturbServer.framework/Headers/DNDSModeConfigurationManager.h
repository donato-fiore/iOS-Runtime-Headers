...
@class NSString;
@protocol DNDSSysdiagnoseDataProvider, DNDSModeConfigurationsStoreDelegate, DNDSKeybagStateObserver, DNDSModeConfigurationProviding, OS_dispatch_queue, DNDSModeConfigurationsStoring, DNDSKeybagStateProviding, DNDSModeConfigurationManagerDelegate;
...
-(BOOL)removeModeConfigurationForModeIdentifier:(id)arg0 deletePlaceholder:(BOOL)arg1 withError:(*id)arg2 ;
...
-(id)_sysdiagnoseDataShouldRedact:(BOOL)arg0 ;
