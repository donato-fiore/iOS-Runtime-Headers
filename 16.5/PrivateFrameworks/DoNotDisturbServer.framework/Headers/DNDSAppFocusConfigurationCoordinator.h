...
@protocol DNDSAppConfigurationManagerDelegate, OS_dispatch_queue, DNDSKeybagStateProviding, DNDSAppFocusConfigurationCoordinatorDelegate;
...
-(id)initWithAppConfigurationManager:(id)arg0 keybagProviding:(id)arg1 xpcEventPublisher:(id)arg2 ;
...
-(void)_executeOrQueueTask:(id)arg0 completion:(id)arg1 ;
-(void)_executeQueuedTaskFollowingTask:(id)arg0 ;
