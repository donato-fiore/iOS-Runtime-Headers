...
-(void)_queue_notifyIntentExtensionsOfUserAvailability:(id)arg0 availabilityOverride:(NSInteger)arg1 applicationIdentifiers:(id)arg2 completionHandler:(id)arg3 ;
...
-(void)coordinateUserAvailabilityUpdateForApplicationIdentifier:(id)arg0 forced:(BOOL)arg1 completionHandler:(id)arg2 ;
-(void)resume;
-(void)resumeUpdatingInvitationsForContacts:(id)arg0 completionHandler:(id)arg1 ;
-(void)sendStatusKitInvitationsForContacts:(id)arg0 completionHandler:(id)arg1 ;
-(void)sendStatusKitInvitationsForContacts:(id)arg0 forceAvailabilityPublish:(BOOL)arg1 completionHandler:(id)arg2 ;
-(void)suspend;
-(void)suspendWithOverrideSetting:(NSInteger)arg0 completionHandler:(id)arg1 ;
