...
-(id)_initWithMode:(id)arg0 configuration:(id)arg1 secureConfiguration:(id)arg2 triggers:(id)arg3 impactsAvailability:(NSUInteger)arg4 dimsLockScreen:(NSUInteger)arg5 created:(id)arg6 lastModified:(id)arg7 lastModifiedByVersion:(struct ? )arg8 lastModifiedByDeviceID:(id)arg9 automaticallyGenerated:(BOOL)arg10 compatibilityVersion:(NSInteger)arg11 ephemeralResolvedCompatibilityVersion:(NSInteger)arg12 hasSecureData:(BOOL)arg13 ;
