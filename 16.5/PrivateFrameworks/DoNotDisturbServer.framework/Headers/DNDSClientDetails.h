...
@property (readonly, nonatomic, getter=forcesAssertionStatusUpdate) BOOL forcesAssertionStatusUpdate; // ivar: _forcesAssertionStatusUpdate
...
-(id)initWithClientIdentifier:(id)arg0 identifiers:(id)arg1 resolutionContextAssumingDeviceUILocked:(BOOL)arg2 userInteractionClient:(BOOL)arg3 persistentAssertionClient:(BOOL)arg4 syncSuppressedClient:(BOOL)arg5 iOS14SyncSuppressedClient:(BOOL)arg6 forcesAssertionStatusUpdate:(BOOL)arg7 ;
