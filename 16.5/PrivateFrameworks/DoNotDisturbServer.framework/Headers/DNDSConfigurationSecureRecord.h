...
@property (readonly, copy, nonatomic) NSSet *allowedWebApplications; // ivar: _allowedWebApplications
@property (readonly, copy) NSString *debugDescription;
@property (readonly, copy, nonatomic) NSSet *deniedApplications; // ivar: _deniedApplications
@property (readonly, copy, nonatomic) NSSet *deniedWebApplications; // ivar: _deniedWebApplications
...
-(id)_initWithSenderConfiguration:(id)arg0 allowedApplications:(id)arg1 deniedApplications:(id)arg2 allowedWebApplications:(id)arg3 deniedWebApplications:(id)arg4 ;
