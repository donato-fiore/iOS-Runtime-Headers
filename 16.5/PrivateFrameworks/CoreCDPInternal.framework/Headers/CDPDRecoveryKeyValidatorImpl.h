...
@protocol CDPRecoveryKeyValidatorInternal, CDPDRecoveryKeyValidatorInternalDelegate, CDPDOctagonTrustProxy;
...
-(id)initWithContext:(id)arg0 delegate:(id)arg1 octagonTrustProxy:(id)arg2 ;
