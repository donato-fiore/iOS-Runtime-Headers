...
@protocol CDPRecoveryKeyValidatorInternal, CDPAuthProviderInternal, CDPDOctagonTrustProxy;
...
-(id)initWithContext:(id)arg0 authProvider:(id)arg1 octagonTrustProxy:(id)arg2 ;
