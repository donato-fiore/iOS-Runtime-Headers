...
@class CDPInheritanceTrustController, NSXPCConnection, CDPContext;
...
-(id)initWithContext:(id)arg0 connection:(id)arg1 ;
...
-(void)_reportEscrowRecoveryAnalyticsWithRecoveryState:(BOOL)arg0 resetState:(BOOL)arg1 didError:(id)arg2 ;
...
-(void)resetAccountCDPStateWithCompletion:(id)arg0 ;
