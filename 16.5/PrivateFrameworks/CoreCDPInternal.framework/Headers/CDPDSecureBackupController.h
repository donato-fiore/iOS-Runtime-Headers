...
@property (nonatomic) NSInteger icscRepairRetryDelay; // ivar: _icscRepairRetryDelay
@property (nonatomic) NSInteger icscRepairTotalRetries; // ivar: _icscRepairTotalRetries
@property (nonatomic) BOOL isSimulateNonViableEscrowRecordEnabled; // ivar: _isSimulateNonViableEscrowRecordEnabled
...
@property (nonatomic) BOOL simulateEPThrottle; // ivar: _simulateEPThrottle
...
-(BOOL)_disableSecureBackupWithEnableInfo:(id)arg0 error:(*id)arg1 ;
...
-(BOOL)supportsRecoveryKeyWithError:(*id)arg0 ;
...
-(void)_retryRepairWithContext:(id)arg0 retryCount:(NSInteger)arg1 completion:(id)arg2 ;
-(void)_updateContext:(id)arg0 withDevices:(id)arg1 ;
...
-(void)checkForAnyOctagonRecord:(id)arg0 ;
...
-(void)validateRecoveryKeyWithContext:(id)arg0 completion:(id)arg1 ;
