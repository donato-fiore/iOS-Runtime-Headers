...
-(id)isShowZKWRecentsEnabled:(id)arg0 ;
-(id)isShowZKWSuggestionsEnabled:(id)arg0 ;
-(id)meCard:(id)arg0 ;
-(id)specifiers;
...
-(void)_askSiriUseOutOfSpaceAlertWithGroupSpecifier:(id)arg0 ;
...
-(void)configureSearchSuggestionsFromAppleSpecifiersFor:(id)arg0 ;
...
-(void)setShowZKWRecentsEnabled:(id)arg0 forSpecifier:(id)arg1 ;
-(void)setShowZKWSuggestionsEnabled:(id)arg0 forSpecifier:(id)arg1 ;
