...
@property (readonly, nonatomic) BOOL renderingStatusForLocationPermission; // ivar: _renderingStatusForLocationPermission
@property (readonly, nonatomic) BOOL renderingStatusForPAPermission; // ivar: _renderingStatusForPAPermission
