...
@class MPSImageGuidedFilter, MPSImageBox, MPSImageAreaMin, MPSImageGaussianBlur, NSData, PTRenderPipeline, PTRenderRequest, NSDictionary;
@protocol MTLDeviceSPI, MTLLibrary, MTLPipelineLibrarySPI, MTLCommandQueue, MTLComputePipelineState, OS_dispatch_semaphore, MTLTexture, MTLResourceGroupSPI, OS_dispatch_queue, PTRenderState;
...
-(id)getPTTextureFromLuma:(id)arg0 chroma:(id)arg1 ;
