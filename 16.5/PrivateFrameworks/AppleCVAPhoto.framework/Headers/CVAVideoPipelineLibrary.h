...
+(id)syntheticDepthOfFieldBackgroundRequestWithMattingRequest:(id)arg0 simulatedFocalRatio:(float)arg1 sourceColorGain:(float)arg2 sourceColorLux:(float)arg3 metadata:(id)arg4 error:(*id)arg5 ;
