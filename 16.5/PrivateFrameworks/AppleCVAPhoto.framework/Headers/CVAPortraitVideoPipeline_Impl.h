...
// -(id)internal_extractMatteWithRequest:(id)arg0 disparityPostprocessingResult:(id)arg1 usePostprocessedDisparity:(BOOL)arg2 dilateForegroundMask:(BOOL)arg3 gravity:(struct CVAVector )arg4 transitionData:(struct TransitionData *)arg5 isMattingNeeded:(BOOL)arg6 mattingCompletionHandler:(id)arg7 isFinalStage:(unk)arg8 status:(BOOL)arg9  ;
