...
+(id)deviceWithName:(id)arg0 serialNumber:(id)arg1 activationDate:(id)arg2 deviceType:(NSUInteger)arg3 productID:(id)arg4 ;
-(id)description;
-(id)initWithCoder:(id)arg0 ;
-(id)initWithName:(id)arg0 serialNumber:(id)arg1 activationDate:(id)arg2 deviceType:(NSUInteger)arg3 productID:(id)arg4 ;
