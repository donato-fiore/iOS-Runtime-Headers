...
-(id)_newRenderPipelineStateWithMeshDescriptor:(id)arg0 options:(NSUInteger)arg1 reflection:(*id)arg2 error:(*id)arg3 ;
...
-(void)_newRenderPipelineStateWithMeshDescriptor:(id)arg0 options:(NSUInteger)arg1 completionHandler:(id)arg2 ;
