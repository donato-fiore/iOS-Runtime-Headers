...
@class NSString;
@protocol MTLGPUDebugResource, MTLBuffer, MTLAccelerationStructure, MTLDevice, MTLHeap;
...
@property (readonly, nonatomic) NSUInteger accelerationStructureHandle; // ivar: _accelerationStructureHandle
...
-(struct MTLResourceID )gpuResourceID;
