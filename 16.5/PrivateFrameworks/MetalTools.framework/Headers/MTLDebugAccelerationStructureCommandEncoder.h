...
-(id)initWithAccelerationStructureCommandEncoder:(id)arg0 parent:(id)arg1 ;
...
-(void)validateRefit:(id)arg0 descriptor:(id)arg1 destination:(id)arg2 scratchBuffer:(id)arg3 scratchBufferOffset:(NSUInteger)arg4 options:(NSUInteger)arg5 ;
