...
-(id)initWithBaseTexture:(id)arg0 device:(id)arg1 buffer:(id)arg2 offset:(NSUInteger)arg3 bytesPerRow:(NSUInteger)arg4 ;
-(id)initWithBaseTexture:(id)arg0 device:(id)arg1 buffer:(id)arg2 offset:(NSUInteger)arg3 bytesPerRow:(NSUInteger)arg4 bytesPerImage:(NSUInteger)arg5 ;
