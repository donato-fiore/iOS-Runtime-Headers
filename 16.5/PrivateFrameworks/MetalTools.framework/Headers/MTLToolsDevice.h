...
@class MTLGPUBVHBuilder, MTLArchitecture, NSArray, NSString, NSDictionary, MTLTargetDeviceArchitecture;
...
-(BOOL)setCompilerProcessesCount:(int)arg0 ;
...
-(id)unwrapMTLCommandBufferDescriptor:(id)arg0 alwaysCopy:(BOOL)arg1 ;
-(id)unwrapMTLCompileOptions:(id)arg0 ;
-(id)unwrapMTLComputePipelineDescriptor:(id)arg0 ;
-(id)unwrapMTLDynamicLibraryDescriptorSPI:(id)arg0 ;
-(id)unwrapMTLFunctionDescriptor:(id)arg0 ;
-(id)unwrapMTLMeshRenderPipelineDescriptor:(id)arg0 ;
...
-(struct ? )sparseTileSizeWithTextureType:(NSUInteger)arg0 pixelFormat:(NSUInteger)arg1 sampleCount:(NSUInteger)arg2 sparsePageSize:(NSInteger)arg3 ;
-(struct ? )tileSizeWithSparsePageSize:(NSInteger)arg0 textureType:(NSUInteger)arg1 pixelFormat:(NSUInteger)arg2 sampleCount:(NSUInteger)arg3 ;
-(struct MTLCompilerConnectionManager *)getCompilerConnectionManager:(int)arg0 ;
