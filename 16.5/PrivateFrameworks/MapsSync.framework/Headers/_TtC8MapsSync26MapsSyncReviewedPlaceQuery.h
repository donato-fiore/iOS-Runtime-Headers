...
#ifndef _TTC8MAPSSYNC26MAPSSYNCREVIEWEDPLACEQUERY_H
#define _TTC8MAPSSYNC26MAPSSYNCREVIEWEDPLACEQUERY_H

@class TtC8MapsSync17MapsSyncBaseQuery;



@interface _TtC8MapsSync26MapsSyncReviewedPlaceQuery : TtC8MapsSync17MapsSyncBaseQuery {
    ? _specifiedQuery;
}
