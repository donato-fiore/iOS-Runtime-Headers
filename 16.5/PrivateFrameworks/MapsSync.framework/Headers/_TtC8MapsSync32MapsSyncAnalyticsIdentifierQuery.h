...
#ifndef _TTC8MAPSSYNC32MAPSSYNCANALYTICSIDENTIFIERQUERY_H
#define _TTC8MAPSSYNC32MAPSSYNCANALYTICSIDENTIFIERQUERY_H

@class TtC8MapsSync17MapsSyncBaseQuery;



@interface _TtC8MapsSync32MapsSyncAnalyticsIdentifierQuery : TtC8MapsSync17MapsSyncBaseQuery {
    ? _specifiedQuery;
}
