...
#import "_TtC8MapsSync29MapsSyncCloudKitStateProvider.h"
...
@property (nonatomic, retain) _TtC8MapsSync29MapsSyncCloudKitStateProvider *cloudKitState; // ivar: cloudKitState
...
-(void)cloudKitChangeWithNotification:(id)arg0 ;
