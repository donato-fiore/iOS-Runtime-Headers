...
#ifndef _TTC8MAPSSYNC24MAPSSYNCCOMMUNITYIDQUERY_H
#define _TTC8MAPSSYNC24MAPSSYNCCOMMUNITYIDQUERY_H

@class TtC8MapsSync17MapsSyncBaseQuery;



@interface _TtC8MapsSync24MapsSyncCommunityIDQuery : TtC8MapsSync17MapsSyncBaseQuery {
    ? _specifiedQuery;
}
