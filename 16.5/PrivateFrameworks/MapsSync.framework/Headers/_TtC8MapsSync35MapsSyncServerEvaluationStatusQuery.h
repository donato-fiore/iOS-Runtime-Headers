...
#ifndef _TTC8MAPSSYNC35MAPSSYNCSERVEREVALUATIONSTATUSQUERY_H
#define _TTC8MAPSSYNC35MAPSSYNCSERVEREVALUATIONSTATUSQUERY_H

@class TtC8MapsSync17MapsSyncBaseQuery;



@interface _TtC8MapsSync35MapsSyncServerEvaluationStatusQuery : TtC8MapsSync17MapsSyncBaseQuery {
    ? _specifiedQuery;
}
