...
@protocol AVPlayerPlaybackCoordinatorDelegate, AVPlayerItemDelegate, TVPAVFPlayback, TVPASyncPlaybackDelegate, TVPMediaItem, TVPPlaybackDelegate;
...
@property (retain, nonatomic) NSString *reportingCategory; // ivar: _reportingCategory
@property (nonatomic) BOOL respondsToRemoteControlEvents; // ivar: _respondsToRemoteControlEvents
...
+(id)_audioSelectionCriteriaForPreferredAudioLanguageCodes:(id)arg0 ;
...
+(void)_updateAudioSelectionCriteriaForAVQueuePlayer:(id)arg0 preferredAudioLanguageCodes:(id)arg1 ;
+(void)initialize;
...
-(BOOL)playerItem:(id)arg0 shouldSeekToTime:(struct ? *)arg1 toleranceBefore:(struct ? *)arg2 toleranceAfter:(struct ? *)arg3 ;
-(BOOL)seeking;
...
-(id)beginCoordinatedPlaybackSuspensionWithReason:(id)arg0 ;
-(id)errorLog;
-(id)init;
...
-(void)dealloc;
-(void)endCoordinatedPlaybackSuspension:(id)arg0 ;
-(void)invalidate;
