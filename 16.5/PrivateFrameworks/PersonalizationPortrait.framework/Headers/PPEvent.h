...
@class NSString, NSArray, NSDate, NSURL, EKObjectID, CLLocation;
...
+(id)convertBatchOfEKEvents:(id)arg0 calendarInternPool:(id)arg1 ;
+(id)deferredAllocationEventFromEKEvent:(SEL)arg0 ;
...
-(id)initWithEventIdentifier:(id)arg0 objectID:(id)arg1 title:(id)arg2 location:(id)arg3 calendar:(id)arg4 startDate:(id)arg5 endDate:(id)arg6 availability:(char)arg7 externalURIString:(id)arg8 attendees:(id)arg9 organizerName:(id)arg10 eventFlags:(unsigned char)arg11 notes:(id)arg12 urlString:(id)arg13 structuredLocationTitle:(id)arg14 structuredLocationAddress:(id)arg15 structuredLocationCoordinates:(id)arg16 suggestedEventCategory:(unsigned char)arg17 ;
