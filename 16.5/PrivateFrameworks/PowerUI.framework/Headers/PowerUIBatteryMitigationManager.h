...
@property (nonatomic) NSUInteger testHoursSinceDOD0Update; // ivar: _testHoursSinceDOD0Update
...
+(id)managerWithDefaultsDomain:(id)arg0 ;
+(id)sharedManager;
...
-(CGFloat)maxAdditionalWaitTimeForQMax;
