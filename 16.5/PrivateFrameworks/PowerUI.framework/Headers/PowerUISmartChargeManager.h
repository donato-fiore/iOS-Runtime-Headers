...
@class NSDate, _CDContextualKeyPath, ACCConnectionInfo, NSString, NSNumber, NSXPCListener, NSArray, NSDistributedNotificationCenter, NSDictionary;
@protocol NSXPCListenerDelegate, PowerUISignalMonitorDelegate, PowerUISmartChargeManagingPrivate, ACCConnectionInfoDelegateProtocol, PowerUISmartChargeManaging, PowerUINotificationManagerClient, OS_xpc_object, _CDLocalContext, _DKKnowledgeQuerying><_DKKnowledgeSaving, OS_os_log, OS_dispatch_source, OS_dispatch_queue;
...
@property (nonatomic) BOOL OBCReengagementEvaluated; // ivar: _OBCReengagementEvaluated
...
@property (retain, nonatomic) NSObject<OS_xpc_object> *bdcConnection; // ivar: _bdcConnection
...
@property (retain, nonatomic) PowerUIIntelligenceManager *intelligenceManager; // ivar: _intelligenceManager
...
@property BOOL remoteOBCEngaged; // ivar: _remoteOBCEngaged
...
@property (retain, nonatomic) NSObject<OS_dispatch_queue> *xpcCallbackQueue; // ivar: _xpcCallbackQueue
...
-(NSUInteger)controllerStateFromCheckpoint:(NSUInteger)arg0 ;
-(NSUInteger)currentChargeLimit;
-(NSUInteger)currentModeOfOperation;
...
-(void)client:(id)arg0 setCECState:(NSUInteger)arg1 withHandler:(id)arg2 ;
...
-(void)incomingBDCRequest:(id)arg0 ;
...
-(void)legacy_isOBCEngagedWithHandler:(id)arg0 ;
...
-(void)monitorMayInvalidateDEoCCache:(id)arg0 ;
-(void)pluginTimelineAddEvent:(id)arg0 atDate:(id)arg1 withBatteryLevel:(NSUInteger)arg2 ;
-(void)postOBCNotificationWithTopOff:(BOOL)arg0 ;
...
-(void)resetState;
-(void)sendBDCData:(id)arg0 withMessage:(id)arg1 ;
...
-(void)smartChargingUIStateWithHandler:(id)arg0 ;
