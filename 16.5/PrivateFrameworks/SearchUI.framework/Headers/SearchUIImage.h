...
@property (retain) SFImageContext *lastLoadedContext; // ivar: _lastLoadedContext
@property (nonatomic) BOOL needsTinting; // ivar: _needsTinting
@property (retain, nonatomic) SFImage *sfImage; // ivar: _sfImage
@property (nonatomic) BOOL supportsFastPathShadow; // ivar: _supportsFastPathShadow
