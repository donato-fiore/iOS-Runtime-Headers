...
@class UICollectionView, NSString, SFInfoTuple;
@protocol UICollectionViewDelegate, UICollectionViewDataSource, SearchUIFeedbackDelegate, SearchUIInfoSizingDelegate;
...
@property (weak, nonatomic) NSObject<SearchUIInfoSizingDelegate> *sizingDelegate; // ivar: _sizingDelegate
...
-(id)buttonItemForIndexPath:(id)arg0 ;
...
-(void)didSelectIndexPath:(id)arg0 ;
