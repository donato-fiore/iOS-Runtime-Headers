...
@class UIContextMenuInteraction, NSString, NSMutableSet, NSIndexPath, UIView, NSOrderedSet, NSMutableDictionary, TLKTableViewScrollTester;
...
-(void)removeSectionContainingRowModel:(id)arg0 ;
