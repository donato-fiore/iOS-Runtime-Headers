...
+(NSInteger)wlkTypeForType:(int)arg0 ;
...
+(int)watchListTypeForType:(int)arg0 isMediaContainer:(BOOL)arg1 ;
+(void)fetchButtonsForWatchListIdentifier:(id)arg0 type:(int)arg1 isHorizontallySrollingStyle:(BOOL)arg2 completion:(id)arg3 ;
+(void)fetchButtonsForWatchListIdentifier:(id)arg0 type:(int)arg1 isHorizontallySrollingStyle:(BOOL)arg2 fetchButtons:(BOOL)arg3 completion:(id)arg4 ;
+(void)fetchWatchListStateForWatchListIdentifier:(id)arg0 type:(int)arg1 completion:(id)arg2 ;
+(void)generateMediaContainerWatchListReponseForWatchListIdentifier:(id)arg0 type:(int)arg1 completion:(id)arg2 ;
+(void)generateWatchListReponseForWatchListIdentifier:(id)arg0 type:(int)arg1 completion:(id)arg2 ;
