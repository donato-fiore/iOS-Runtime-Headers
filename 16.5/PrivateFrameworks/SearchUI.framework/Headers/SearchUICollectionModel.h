...
@property BOOL isEntitySearch; // ivar: _isEntitySearch
...
+(id)collectionModelWithTableModel:(id)arg0 expandedSections:(id)arg1 expandedCollectionSections:(id)arg2 ;
-(BOOL)indexPathExists:(id)arg0 ;
-(BOOL)sectionNeedsHorizontalNavigation:(NSInteger)arg0 ;
...
-(NSInteger)indexOfCollectionCardSection:(id)arg0 ;
...
-(int)separatorStyleForIndexPath:(id)arg0 shouldDrawTopAndBottomSeparators:(BOOL)arg1 ;
-(void)deleteSection:(NSInteger)arg0 ;
