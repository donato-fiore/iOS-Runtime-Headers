...
@protocol MTAlarmScheduleDelegate, MTApplicationWorkspaceObserverProtocol, MTAlarmStorage, MTPersistence, NAScheduler;
...
-(void)_removeAlarmDataIfNecessary:(id)arg0 ;
