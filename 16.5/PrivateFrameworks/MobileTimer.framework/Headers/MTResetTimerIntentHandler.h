...
-(id)_responseToResetTimerIntent:(id)arg0 withResetTimers:(id)arg1 error:(id)arg2 dryRun:(BOOL)arg3 ;
-(void)_handleResetTimer:(id)arg0 dryRun:(BOOL)arg1 completion:(id)arg2 ;
-(void)confirmResetTimer:(id)arg0 completion:(id)arg1 ;
