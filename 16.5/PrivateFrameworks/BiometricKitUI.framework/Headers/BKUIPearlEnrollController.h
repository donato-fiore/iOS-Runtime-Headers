...
@property (retain, nonatomic) BKUIPearlEnrollControllerPreloadedState *preloadState; // ivar: _preloadState
...
-(void)setCoachingHidden:(BOOL)arg0 animated:(BOOL)arg1 completion:(id)arg2 ;
