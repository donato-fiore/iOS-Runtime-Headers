...
@protocol BKEnrollOperationDelegate, BKEnrollPearlOperationDelegate, BKUIPearlEnrollViewDelegate, BKUIPearlAudioStateDelegate, BKUIPearlEnrollOperationsDelegate, OS_dispatch_semaphore, BKUIPearlEnrollViewControllerDelegate;
...
#import "BKUIEnrollStateDispatchWorkItemsManager.h"
...
@property (retain, nonatomic) BKUIEnrollStateDispatchWorkItemsManager *workItemsManager; // ivar: _workItemsManager
