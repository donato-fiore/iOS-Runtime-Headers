...
@class UIView, NSString, NSDictionary, UIImage, AVPlayerLayer, UIImageView, AVQueuePlayer;
...
@property (retain, nonatomic) NSDictionary *assetnameForAssetLengthDict; // ivar: _assetnameForAssetLengthDict
