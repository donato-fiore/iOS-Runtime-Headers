...
-(id)_failureErrorWithReason:(id)arg0 ;
-(id)commitItem;
...
-(id)lazy_verifyNameIsNotEmpty:(id)arg0 ;
-(id)lazy_verifyPropertiesAreSet:(id)arg0 ;
// -(id)lazy_verifyProperty:(id)arg0 matchesCondition:(id)arg1 description:(unk)arg2  ;
-(id)lazy_verifyPropertyIsSet:(id)arg0 ;
