...
-(id)_itemsToUpdateForSoftwareUpdateV2ChangeToAccessory:(id)arg0 ;
-(id)_itemsToUpdateForSoftwareUpdateV2ProgressChangeToAccessory:(id)arg0 ;
...
-(void)accessoryDidUpdateCalibrationStatus:(id)arg0 ;
...
-(void)home:(id)arg0 didUpdateAudioAnalysisClassifierOptions:(NSUInteger)arg1 ;
...
-(void)home:(id)arg0 didUpdateOnboardAudioAnalysis:(BOOL)arg1 ;
...
-(void)softwareUpdateV2DidUpdateForAccessory:(id)arg0 ;
-(void)softwareUpdateV2DidUpdateProgressForAccessory:(id)arg0 ;
