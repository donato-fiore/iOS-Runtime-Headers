...
@property (retain, nonatomic) NSSet *accessoriesWithRequestedSoftwareUpdates; // ivar: _accessoriesWithRequestedSoftwareUpdates
...
@property (nonatomic) NSUInteger softwareUpdatesRequested; // ivar: _softwareUpdatesRequested
