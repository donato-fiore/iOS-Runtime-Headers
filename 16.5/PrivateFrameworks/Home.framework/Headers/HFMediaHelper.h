...
+(BOOL)canMediaProfileContainer:(id)arg0 supportHomeTheaterWithAppleTV:(id)arg1 ;
+(BOOL)isAirPortExpress:(id)arg0 ;
+(BOOL)isAnyKindOfGroup:(id)arg0 ;
+(BOOL)isAppleTV:(id)arg0 ;
+(BOOL)isAudioAnalysisSupportedDevice:(id)arg0 ;
...
+(id)allAccessoriesContainedIn:(id)arg0 ;
...
+(id)mediaProfileContainerForItem:(id)arg0 forTopLevel:(BOOL)arg1 ;
