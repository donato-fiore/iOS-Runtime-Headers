...
+(id)_fullTimeStringFromDate:(id)arg0 shouldUseTwentyFourHourTime:(BOOL)arg1 ;
+(id)_shortTimeStringFromDate:(id)arg0 shouldUseTwentyFourHourTime:(BOOL)arg1 ;
