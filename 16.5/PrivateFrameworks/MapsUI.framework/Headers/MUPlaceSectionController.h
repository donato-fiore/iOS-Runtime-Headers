...
@class GEOAPPlaceCardModule, NSString, MKMapItem, GEORevealedPlaceCardModule, UIView, UIViewController, NSArray, MKUGCCallToActionViewAppearance;
...
-(void)captureInfoCardAction:(int)arg0 eventValue:(id)arg1 feedbackType:(int)arg2 actionRichProviderId:(id)arg3 ;
