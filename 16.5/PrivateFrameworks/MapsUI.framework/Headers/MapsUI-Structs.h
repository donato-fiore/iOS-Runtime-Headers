...
typedef struct MUPlaceCoverPhotoMetrics {
    CGFloat aspectRatio;
    BOOL hasLogo;
    CGSize logoSize;
    CGFloat coverPhotoBottomToLogoBottomSpacing;
    CGFloat coverPhotoContainerToTitleSpacing;
    CGFloat startingLogoAlphaTransitionValue;
    CGFloat endingLogoAlphaTransitionValue;
} MUPlaceCoverPhotoMetrics;

typedef struct MUPlaceHeaderMetrics {
    CGFloat topToTitleSpacing;
    MUPlaceCoverPhotoMetrics coverPhotoMetrics;
} MUPlaceHeaderMetrics;
