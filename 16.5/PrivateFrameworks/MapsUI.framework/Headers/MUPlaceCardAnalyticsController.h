...
-(BOOL)instrumentRevealIfNeededWithImpressionsSessionId:(id)arg0 ;
-(id)initWithAnalyticsProvider:(id)arg0 ;
-(void)_infoCardAnalyticsDidSelectAction:(int)arg0 target:(int)arg1 eventValue:(id)arg2 actionURL:(id)arg3 photoID:(id)arg4 feedbackDelegateSelector:(int)arg5 modules:(id)arg6 actionRichProviderId:(id)arg7 completion:(id)arg8 ;
