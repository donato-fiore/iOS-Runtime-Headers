...
@protocol WKScriptMessageHandler, MUWebBridgeDelegate;
...
@property (weak, nonatomic) NSObject<MUWebBridgeDelegate> *delegate; // ivar: _delegate
@property (readonly, copy) NSString *description;
@property (readonly) NSUInteger hash;
@property (readonly) Class superclass;
@property (readonly, nonatomic) MUWebViewFactoryItem *webViewFactoryItem; // ivar: _webViewFactoryItem
