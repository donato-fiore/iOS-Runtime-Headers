...
@class UIView, UICollectionView, UICollectionViewDiffableDataSource, NSLayoutConstraint, UICollectionViewFlowLayout, NSString, NSArray;
...
-(CGFloat)_calculatedTileWidthFromBounds;
