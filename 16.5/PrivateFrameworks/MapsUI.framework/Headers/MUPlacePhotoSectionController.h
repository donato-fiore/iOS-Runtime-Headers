...
-(BOOL)photoSliderView:(id)arg0 shouldShowFullWidthForModel:(id)arg1 ;
...
-(void)_captureSliderInstrumentationWithAction:(int)arg0 eventValue:(id)arg1 actionRichProviderId:(id)arg2 ;
-(void)_populateRevealedAnalyticsModule:(id)arg0 ;
-(void)_routeAlbumTapWithViewModel:(id)arg0 ;
-(void)_routeFlatListTapWithViewModel:(id)arg0 ;
...
-(void)photoSliderView:(id)arg0 didTapViewModel:(id)arg1 ;
