...
#import "MUCuratedCollectionsPlacecardAnalyticsManager.h"
#import "MUCuratedGuidesSectionView.h"
...
@property (retain, nonatomic) MUCuratedCollectionsPlacecardAnalyticsManager *analyticsManager; // ivar: _analyticsManager
@property (retain, nonatomic) MUCuratedGuidesSectionView *carouselView; // ivar: _carouselView
