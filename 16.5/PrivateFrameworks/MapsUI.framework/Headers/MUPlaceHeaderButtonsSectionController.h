...
@class _MKPlaceActionButtonController, NSString, UIView, UIViewController, NSArray, MKUGCCallToActionViewAppearance;
...
-(void)headerButtonsSectionControllerWillPresentMenu:(id)arg0 ;
