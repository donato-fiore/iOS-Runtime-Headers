...
@class UIContextMenuInteraction, NSString, GEOEnrichmentData, UIView, UIViewController, NSArray, MKUGCCallToActionViewAppearance;
@protocol MUWebContentViewControllerDelegate, MUPlaceEnrichmentManagerObserver, MUPlaceEnrichmentSectionAnalyticsDelegate, MUPlaceEnrichmentSectionContextMenuDelegate, MUPlaceSectionControlling, MUInfoCardAnalyticsDelegate, MUPlaceEnrichmentSectionControllerDelegate;
...
#import "MUPlaceEnrichmentContextMenu.h"
...
@property (retain, nonatomic) MUPlaceEnrichmentContextMenu *contextMenuButton; // ivar: _contextMenuButton
...
-(void)addContextMenuUsingBoundingBox:(id)arg0 accessibilityLabel:(id)arg1 ;
-(void)dealloc;
-(void)didLayoutContextMenu:(id)arg0 completion:(id)arg1 ;
-(void)didTapAddPhoto;
