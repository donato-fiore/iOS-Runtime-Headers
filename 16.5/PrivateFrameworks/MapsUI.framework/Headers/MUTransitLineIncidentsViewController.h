...
@class UITableViewController, MKTransitItemIncidentsController, NSString, MKTransitItemReferenceDateUpdater, NSDate;
@protocol MKTransitItemReferenceDateUpdaterDelegate, MUTransitLineIncidentsViewControllerDelegate, GEOTransitLineItem;
...
@property (weak, nonatomic) NSObject<MUTransitLineIncidentsViewControllerDelegate> *incidentsDelegate; // ivar: _incidentsDelegate
