...
@class NSMapTable, PKVirtualCardManager, PKSafariCardNotificationManager, NSMutableArray, NSCache, NSArray, NSString;
...
-(void)processQueueOfVirtualCardsToFetchDetailsForWithExternalizedContext:(id)arg0 blockToUpdateCardDetails:(id)arg1 ;
