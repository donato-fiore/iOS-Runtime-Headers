...
@class NSMutableDictionary, WBSDiagnosticStateCollector, NSString, NSDictionary, TRIClient;
...
-(NSUInteger)trialABGroupIdentifier;
-(id)factorWithName:(id)arg0 ;
-(id)getFactorValueAsString:(id)arg0 ;
-(id)getRetrievalFactorName:(id)arg0 forCF:(BOOL)arg1 ;
-(id)init;
-(id)numberFactorWithName:(id)arg0 ;
-(id)prepareLogDictionary:(BOOL)arg0 withExperimentId:(id)arg1 withTreatmentId:(id)arg2 isCounterFactualSearch:(BOOL)arg3 withFactorData:(id)arg4 ;
