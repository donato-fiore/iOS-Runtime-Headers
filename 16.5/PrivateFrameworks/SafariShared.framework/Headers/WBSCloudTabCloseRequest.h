...
+(id)_dictionaryWithURL:(id)arg0 tabUUIDString:(id)arg1 lastModified:(id)arg2 sourceDeviceUUID:(id)arg3 destinationDeviceUUID:(id)arg4 ;
...
-(id)initWithURL:(id)arg0 tabUUIDString:(id)arg1 lastModified:(id)arg2 sourceDeviceUUID:(id)arg3 destinationDeviceUUID:(id)arg4 requestUUID:(id)arg5 ;
