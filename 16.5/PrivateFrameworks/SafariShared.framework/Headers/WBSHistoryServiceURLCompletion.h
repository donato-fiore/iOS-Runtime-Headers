...
@interface WBSHistoryServiceURLCompletion : NSObject {
    ...
    unordered_multimap<NSString *, NSString *, std::hash<NSString *>, std::equal_to<NSString *>, std::allocator<std::pair<NSString *const, NSString *>>> _redirectSources;
}
...
-(void)recordVisit:(id)arg0 sourceVisit:(id)arg1 title:(id)arg2 loadSuccessful:(BOOL)arg3 visitWasFromThisDevice:(BOOL)arg4 increaseVisitCount:(BOOL)arg5 score:(int)arg6 statusCode:(NSInteger)arg7 ;
