...
-(BOOL)manualAutoFillButtonWillFitInFieldWithMetadata:(id)arg0 ;
...
-(void)getMetadataForTextField:(id)arg0 inFrame:(id)arg1 completionHandler:(id)arg2 ;
...
-(void)makeAutomaticStrongPasswordElementViewable:(BOOL)arg0 frame:(id)arg1 passwordControlUniqueIDs:(id)arg2 ;
