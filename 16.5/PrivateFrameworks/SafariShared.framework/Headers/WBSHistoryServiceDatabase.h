...
@protocol WBSSQLiteDatabaseDelegate, WBSHistoryServiceDatabaseProtocol, OS_dispatch_queue, OS_dispatch_group;
...
-(id)init;
-(id)initWithID:(id)arg0 url:(id)arg1 options:(id)arg2 fileOperationGroup:(id)arg3 error:(*id)arg4 ;
...
-(void)forceCloseWithCompletionHandler:(id)arg0 ;
