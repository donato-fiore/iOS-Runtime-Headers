...
@property (readonly, nonatomic) NSInteger pageStatus; // ivar: _pageStatus
...
-(id)initWithUUID:(id)arg0 windowUUID:(id)arg1 tabGroupUUID:(id)arg2 tabGroupTitle:(id)arg3 tabIndex:(NSUInteger)arg4 url:(id)arg5 title:(id)arg6 pageStatus:(NSInteger)arg7 ;
