...
@class NSString, NSDictionary, NSDate, PKVirtualCard;
...
@property (nonatomic) BOOL promptToSaveSecurityCode; // ivar: _promptToSaveSecurityCode
...
-(id)_expirationDateFromPKVirtualCardCredentials:(id)arg0 ;
-(id)creditCardDataByMergingOtherAttributesBesidesCardNumberFromCard:(id)arg0 mergeSecurityCode:(BOOL)arg1 ;
