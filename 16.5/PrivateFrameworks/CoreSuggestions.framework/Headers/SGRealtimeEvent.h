...
@property (readonly, nonatomic) NSString *sourceMessageId; // ivar: _sourceMessageId
...
+(id)realtimeEventForExtractionExceptionWithSourceMessageId:(id)arg0 ;
...
-(id)initWithState:(int)arg0 event:(id)arg1 eventIdentifier:(id)arg2 harvested:(BOOL)arg3 sourceMessageId:(id)arg4 ;
