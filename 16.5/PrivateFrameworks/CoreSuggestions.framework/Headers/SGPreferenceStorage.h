...
+(id)didKVSMigrationTokenForIdentifier:(id)arg0 ;
+(id)followUpComputeCustomTimeRangeForLanguage:(id)arg0 ;
...
+(void)setDetectMessageEventsML:(BOOL)arg0 ;
...
+(void)setDidKVSMigrationToken:(id)arg0 forIdentifier:(id)arg1 ;
...
+(void)setMessageEventsMLDetectionEnabledForTests:(BOOL)arg0 ;
