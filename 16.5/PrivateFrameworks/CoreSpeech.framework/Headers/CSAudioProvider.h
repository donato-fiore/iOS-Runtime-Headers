...
@property (nonatomic) BOOL currentSessionShouldDuckOnBuiltInSpeaker; // ivar: _currentSessionShouldDuckOnBuiltInSpeaker
...
-(id)initWithAudioStreamHandleId:(NSUInteger)arg0 audioStreamType:(NSInteger)arg1 audioRecordContext:(id)arg2 audioRecorder:(id)arg3 phoneCallStateMonitor:(id)arg4 ;
-(id)playbackRoute;
-(id)recordDeviceInfo;
-(id)recordRoute;
-(id)recordSettings;
...
-(void)_createCircularBufferIfNeededWithNumChannel:(NSUInteger)arg0 playbackRoute:(id)arg1 ;
-(void)_deliverHistoricalAudioToStreamsWithRemoteVAD:(id)arg0 ;
-(void)_deliverPostprocessAudioChunk:(id)arg0 toStream:(id)arg1 lastForwardedSampleCount:(NSUInteger)arg2 ;
