...
@property (retain, nonatomic) NSMutableDictionary *falseWakePhraseDictionary; // ivar: _falseWakePhraseDictionary
...
-(void)logFalseWakeUp:(BOOL)arg0 withPhrase:(id)arg1 ;
