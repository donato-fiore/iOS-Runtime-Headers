...
@property (nonatomic) BOOL isHybridUODEnabled; // ivar: _isHybridUODEnabled
...
@property (retain, nonatomic) CSRCHandlingXPCClient *rcHandlingClient; // ivar: _rcHandlingClient
...
@property (retain, nonatomic) CSUncompressedAudioLogging *uncompressedAudioLogging; // ivar: _uncompressedAudioLogging
...
-(NSUInteger)_audibleFeedbackPlaybackReason;
...
-(void)getMitigationDecisionForRCId:(NSUInteger)arg0 completion:(id)arg1 ;
