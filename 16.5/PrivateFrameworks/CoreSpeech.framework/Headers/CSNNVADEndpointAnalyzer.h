...
@property (nonatomic) CGFloat firstAudioSampleSensorTimestampIgnoringTwoShotReset; // ivar: _firstAudioSampleSensorTimestampIgnoringTwoShotReset
...
@property (nonatomic) BOOL hasReportedFirstAudioSampleSensorTimestamp; // ivar: _hasReportedFirstAudioSampleSensorTimestamp
...
-(void)instrumentEndpointSignpostsForServerEndpointWithEndTime:(CGFloat)arg0 leadingSilence:(CGFloat)arg1 trailingSilence:(CGFloat)arg2 stopRecordingMachContinousTime:(NSUInteger)arg3 skippedSamplesTimeInSec:(CGFloat)arg4 ;
-(void)preheat;
