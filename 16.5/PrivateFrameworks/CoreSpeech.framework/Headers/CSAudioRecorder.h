...
@class AVVoiceController, NSMutableDictionary, CSReusableBufferPool, NSString, NSHashTable, NSMutableSet;
@protocol AVVoiceControllerRecordDelegate, CSAudioDecoderDelegate, CSAudioFileReaderDelegate, CSRemoteRecordClientDelegate, CSUserSessionActiveMonitorDelegate, CSAudioServerCrashEventProviding, CSAudioSessionEventProviding, CSAudioServerCrashEventProvidingDelegate, OS_dispatch_queue, CSAudioSessionEventProvidingDelegate;
...
@property (retain, nonatomic) NSMutableSet *remoteAccessoryStreamIdSet; // ivar: _remoteAccessoryStreamIdSet
...
-(BOOL)_audioIsFromRemoteAccessory:(NSUInteger)arg0 ;
-(BOOL)_hasLocalPendingTwoShot;
-(BOOL)_isDarwinDeviceId:(id)arg0 ;
...
-(BOOL)isDuckingSupportedOnCurrentRouteWithStreamHandleID:(NSUInteger)arg0 error:(*id)arg1 ;
...
-(BOOL)setAlertSoundFromURL:(id)arg0 forType:(NSInteger)arg1 force:(BOOL)arg2 ;
...
-(void)_stopTrackingRemoteAccessoryStreamId:(NSUInteger)arg0 ;
-(void)_trackRemoteAccessoryStreamIdIfNeeded:(id)arg0 ;
...
-(void)setDuckMixWithOthersForStream:(NSUInteger)arg0 duckOthers:(BOOL)arg1 duckToLevelInDB:(id)arg2 mixWithOthers:(BOOL)arg3 ;
-(void)setMeteringEnabled:(BOOL)arg0 ;
-(void)unregisterObserver:(id)arg0 ;
-(void)updateMeters;
-(void)userSessionActivateMonitor:(id)arg0 didReceivedUserSessionActiveHasChanged:(BOOL)arg1 ;
