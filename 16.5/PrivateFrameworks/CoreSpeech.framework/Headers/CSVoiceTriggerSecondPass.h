...
@class NSString, NSMutableArray, CSAudioCircularBuffer, CSPlainAudioFileWriter, CSAudioTimeConverter, CSVoiceTriggerSecondPassConfig, CSAsset, NSDictionary, CSPhraseDetector, NSUUID, SSRSpeakerRecognitionController, SSRSpeakerRecognitionContext, NSMutableDictionary;
...
-(void)_addLosingPhraseResultstoVTEI:(id)arg0 withLosingPhraseResults:(id)arg1 ;
-(void)_addPHSInfoToVTEI:(id)arg0 fromSpeakerInfo:(id)arg1 withThreshold:(float)arg2 ;
-(void)_addRejectStatsToDict:(id)arg0 ;
-(void)_analyzeForChannel:(NSUInteger)arg0 keywordDetectorResult:(id)arg1 losingPhraseResults:(id)arg2 ;
...
-(void)_setKeywordDetectorStartMachTime:(NSUInteger)arg0 detectorEndMachTime:(NSUInteger)arg1 lastAudioPacketAnalyzedMachTime:(NSUInteger)arg2 ;
