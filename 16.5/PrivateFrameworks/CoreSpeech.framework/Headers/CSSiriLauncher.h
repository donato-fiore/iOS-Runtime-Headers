...
+(id)sharedLauncher;
-(void)deactivateSiriActivationConnectionWithReason:(NSInteger)arg0 withOptions:(NSUInteger)arg1 withContext:(id)arg2 ;
...
-(void)notifyDarwinVoiceTrigger:(id)arg0 deviceId:(id)arg1 myriadPHash:(id)arg2 myriadLateActivationExpirationTime:(id)arg3 completion:(id)arg4 ;
-(void)notifyDarwinVoiceTriggerPrewarmWithCompletion:(id)arg0 ;
