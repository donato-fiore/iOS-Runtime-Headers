...
+(id)sharedInstance;
-(id)_getAddressWithBTDevice:(struct BTDeviceImpl *)arg0 ;
-(id)_getConnectedBluetoothDeviceAddressesFromLocalDevice:(struct BTLocalDeviceImpl *)arg0 ;
...
-(void)getConnectedBluetoothDeviceAddressesWithCompletion:(id)arg0 ;
