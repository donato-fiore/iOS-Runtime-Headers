...
@class NSFileHandle, NSUUID, NSDictionary, NSString, NSXPCConnection, AFWatchdogTimer, NSArray, SASResultCandidate, AFSpeechSynthesisRecord, AFClientConfiguration, NSMutableDictionary, AFBluetoothWirelessSplitterSessionStateObserver, AFExperimentContext;
...
@interface CSSiriSpeechRecorder : NSObject <CSSiriAcousticFingerprinterDelegate, CSSpeechControllerDelegate, CSEndpointAnalyzerDelegate, CSLanguageDetectorDelegate, CSSpeakerIdentificationDelegate, CSAudioSessionControllerDelegate, CSSiriSpeechCapturing>

 {
    ...
    CGFloat _skippedSamplesTimeInSec;
...
-(BOOL)_prepareDirectoryAtPath:(id)arg0 ;
...
-(id)_fingerprinter;
-(id)_getFanInfoArray;
-(id)_mhUUIDFromSpeechRequestOptions:(id)arg0 ;
...
-(int)convertSISchemaAudioInputRouteToMHRoute:(int)arg0 withRecordingInfo:(id)arg1 ;
-(unsigned int)_audioDeviceID;
-(unsigned int)_audioSessionID;
-(unsigned int)fetchAudioSessionID;
-(void)_cancelExtendedEndpointTimer;
-(void)_checkIfLastEndpointHintShouldBeAccepted:(BOOL)arg0 ;
-(void)_clearEndpointHint;
-(void)_disableEndpointer;
-(void)_enforceEndpointHintWithMitigation:(BOOL)arg0 ;
...
// -(void)_stopRecordingForEndpointReason:(unk)arg0 withEndpointMetrics:(struct ? )arg1  ;
// -(void)_stopRecordingWithReason:(unk)arg0 hostTime:(struct ? )arg1  ;
-(void)_updateAudioContextWithInfo:(id)arg0 reason:(id)arg1 ;
-(void)_updateAudioDeviceInfo:(id)arg0 forReason:(id)arg1 forcesUpdate:(BOOL)arg2 ;
...
-(void)dealloc;
-(void)disableSpeechPacketGeneration:(BOOL)arg0 ;
...
-(void)preheatRecognizerWithOption:(id)arg0 ;
-(void)preheatWithOption:(id)arg0 ;
-(void)prepareForMode:(NSInteger)arg0 ;
-(void)prepareForMode:(NSInteger)arg0 withOptions:(id)arg1 ;
...
-(void)setHybridUODEnabled:(BOOL)arg0 ;
...
-(void)speechControllerLPCMRecordBufferAvailable:(id)arg0 buffer:(id)arg1 recordedAt:(NSUInteger)arg2 ;
...
-(void)updateEndpointHintForRC:(id)arg0 forceAccept:(BOOL)arg1 completion:(id)arg2 ;
