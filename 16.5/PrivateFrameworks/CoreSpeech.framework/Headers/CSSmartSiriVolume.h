...
@class NSUserDefaults, CSPolicy, CSAsset, NSString;
@protocol CSMediaPlayingMonitorDelegate, CSAudioStreamProvidingDelegate, CSAudioServerCrashMonitorDelegate, CSSiriClientBehaviorMonitorDelegate, CSSmartSiriVolumeProcessor, OS_dispatch_queue, OS_dispatch_source;
