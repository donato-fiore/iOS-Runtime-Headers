...
-(void)generateConfusionPairsWithUUID:(id)arg0 parameters:(id)arg1 language:(id)arg2 task:(id)arg3 samplingRate:(NSUInteger)arg4 recognizedTokens:(id)arg5 recognizedText:(id)arg6 correctedText:(id)arg7 selectedAlternatives:(id)arg8 completion:(id)arg9 ;
-(void)invalidate;
