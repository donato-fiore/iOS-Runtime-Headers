...
@class OS_xpc_remote_connection, CSDispatchGroup, NSHashTable, NSString, OS_remote_device;
@protocol CSRemoteControlClientProtocolV1, CSRemoteControlClientProtocolV2, CSRemoteControlClientProtocolV3, OS_dispatch_queue;
...
-(void)notifyBluetoothWirelessSplitterStateChanged:(NSUInteger)arg0 shouldDisableSpeakerVerificationInSplitterMode:(BOOL)arg1 ;
...
-(void)setSelfTriggerEnable:(BOOL)arg0 withCompletion:(id)arg1 ;
