...
@class NSMutableArray, CSAsset, NSString, CSKeywordAnalyzerNDAPI, CSOSTransaction;
@protocol CSAudioStreamProvidingDelegate, CSVoiceTriggerEnabledMonitorDelegate, CSSiriClientBehaviorMonitorDelegate, CSAttSiriStateMonitorDelegate, CSOpportuneSpeakEventMonitorDelegate, CSVoiceTriggerDelegate, OS_dispatch_queue, OS_dispatch_group;
...
@property (retain, nonatomic) CSAttSiriStateMonitor *attSiriStateMonitor; // ivar: _attSiriStateMonitor
...
-(id)init;
-(id)initWithSpeechManager:(id)arg0 voiceTriggerEnabledMonitor:(id)arg1 siriClientBehaviorMonitor:(id)arg2 opportuneSpeakEventMonitor:(id)arg3 phoneCallStateMonitor:(id)arg4 otherAppRecordingStateMonitor:(id)arg5 ;
