...
@property (retain, nonatomic) CSAudioTapProvider *audioTapProvider; // ivar: _audioTapProvider
...
@property (retain, nonatomic) CSSelfTriggerDetector *selfTriggerDetectorWithAVVC; // ivar: _selfTriggerDetectorWithAVVC
@property (retain, nonatomic) CSSelfTriggerDetector *selfTriggerDetectorWithAudioTap; // ivar: _selfTriggerDetectorWithAudioTap
...
-(void)_setupSelfTriggerWithAudioSourceType:(NSUInteger)arg0 voiceTriggerAsset:(id)arg1 ;
