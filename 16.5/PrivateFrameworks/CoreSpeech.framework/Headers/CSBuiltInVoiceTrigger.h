...
@property (nonatomic) NSUInteger attSiriState; // ivar: _attSiriState
@property (retain, nonatomic) CSAudioProvider *audioProvider; // ivar: _audioProvider
@property (retain, nonatomic) CSAudioRouteChangeMonitor *audioRouteChangeMonitor; // ivar: _audioRouteChangeMonitor
...
@property (nonatomic) *OpaqueFigEndpoint carPlayEndpoint; // ivar: _carPlayEndpoint
...
@property (retain, nonatomic) CSVoiceTriggerFirstPassConfig *firstPassConfig; // ivar: _firstPassConfig
...
@property (nonatomic) BOOL isHearstConnected; // ivar: _isHearstConnected
@property (nonatomic) BOOL isHearstRouted; // ivar: _isHearstRouted
@property (nonatomic) BOOL isJarvisConnected; // ivar: _isJarvisConnected
...
@property (nonatomic) BOOL isSiriInputSourceOutOfBand; // ivar: _isSiriInputSourceOutOfBand
@property (retain, nonatomic) NSMutableArray *keywordAnalyzersNDAPI; // ivar: _keywordAnalyzersNDAPI
@property (nonatomic) NSUInteger lastSelfTriggerDetectedStartMachTime; // ivar: _lastSelfTriggerDetectedStartMachTime
...
-(BOOL)_shouldCancelSecondPassResultWithVoiceTriggerInfo:(id)arg0 ;
...
-(NSInteger)_currentJarvisTriggerMode;
...
-(id)initWithTargetQueue:(id)arg0 withSpeechManager:(id)arg1 ;
-(id)initWithTargetQueue:(id)arg0 withSpeechManager:(id)arg1 withAudioRouteChangeMonitor:(id)arg2 ;
...
-(void)_forceUpdateCarPlayEndpointWithJarvisConnected:(BOOL)arg0 ;
-(void)_handleAudioChunk:(id)arg0 ;
-(void)_handleSecondPassResult:(id)arg0 deviceId:(id)arg1 error:(id)arg2 ;
-(void)_handleVoiceTriggerSecondPassWithSource:(NSUInteger)arg0 deviceId:(id)arg1 event:(id)arg2 audioProviderUUID:(id)arg3 firstPassInfo:(id)arg4 ;
...
-(void)_receivedHearstConnectedEvent:(BOOL)arg0 ;
-(void)_receivedHearstRoutedEvent:(BOOL)arg0 ;
-(void)_receivedJarvisConnectionEvent:(BOOL)arg0 ;
-(void)_receivedSiriInputSourceOutOfBandEvent:(BOOL)arg0 ;
...
-(void)attSiriStateMonitor:(id)arg0 didRecieveAttSiriStateChange:(NSUInteger)arg1 ;
