...
@class CSAudioCircularBuffer, NSString, NSMutableArray, CSKeywordAnalyzerNDEAPI, NSUUID;
...
@property (retain, nonatomic) NSMutableArray *hostTimeBuffer; // ivar: _hostTimeBuffer
@property (nonatomic) BOOL isForwarding; // ivar: _isForwarding
@property (retain, nonatomic) CSKeywordAnalyzerNDEAPI *keywordAnalyzer; // ivar: _keywordAnalyzer
...
@property (nonatomic) NSUInteger voiceTriggerSampleCount; // ivar: _voiceTriggerSampleCount
...
-(BOOL)isRecording;
-(NSInteger)getBestSampleCountWithOption:(id)arg0 ;
