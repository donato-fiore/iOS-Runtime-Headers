...
#ifndef URLCOMPLETIONMATCHBOOKMARKLISTDATA_H
#define URLCOMPLETIONMATCHBOOKMARKLISTDATA_H
...
-(id)bookmark;
-(id)initWithBookmarkData:(id)arg0 andBookmarkData:(id)arg1 ;
-(id)initWithBookmarkData:(id)arg0 historyMatchData:(id)arg1 ;
