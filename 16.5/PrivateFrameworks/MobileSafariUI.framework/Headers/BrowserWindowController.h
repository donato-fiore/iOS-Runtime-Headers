...
@protocol CloudTabStoreDelegate, _SFNavigationIntentHandling;
...
-(id)initWithTabGroupManager:(id)arg0 pinnedTabsManager:(id)arg1 ;
-(id)initWithTabGroupManager:(id)arg0 pinnedTabsManager:(id)arg1 perSitePreferencesVendor:(id)arg2 shouldMergeAllWindowsIfNeeded:(BOOL)arg3 browserControllerUIDelegateProvider:(id)arg4 ;
