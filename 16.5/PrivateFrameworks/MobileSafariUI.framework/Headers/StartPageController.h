...
@class WebBookmarkCollection, WBSStartPageSection, NSItemProvider, NSMutableArray, WebBookmarkList, WBSPrivacyReportData, NSArray, NSString, SFStartPageViewController;
...
-(id)startPageCustomizationViewController:(id)arg0 customizationItemsForCustomizationVariant:(NSInteger)arg1 ;
...
-(void)startPageCustomizationViewController:(id)arg0 didCustomizeItems:(id)arg1 withVariant:(NSInteger)arg2 ;
