...
@class NSMapTable, NSHashTable, NSMutableDictionary, NSURL, NSMutableSet, NSString;
@protocol TabSnapshotCacheEntryStateObserving, OS_dispatch_queue, TabSnapshotCacheDelegate;
...
@property (weak, nonatomic) NSObject<TabSnapshotCacheDelegate> *delegate; // ivar: _delegate
...
-(void)tabSnapshotCacheEntryDidUpdateState:(id)arg0 ;
