...
@class UIViewController, UIButton, NSMutableSet, NSTimer, SFStartPageViewController, NSString, UIPopoverPresentationController, UIColor, UIImage, UIView;
@protocol SFStartPageDelegate, CompletionItemActionHandler, CompletionListDelegate, UITableViewDataSource, UITableViewDelegate, UnifiedFieldDelegate, UIPopoverPresentationControllerDelegate, SKStoreProductViewControllerDelegatePrivate, UniversalSearchFeedbackDelegate, UniversalSearchFirstTimeExperienceViewControllerDelegate, TabSnapshotContentProvider, CatalogViewControllerDelegate, CompletionItem, LoadProgressObserver, _SFNavigationBarCommon, SFStartPageScrollObserver;
...
@property (retain, nonatomic) NSObject<_SFNavigationBarCommon> *navigationBar; // ivar: _navigationBar
...
@property (readonly, nonatomic) UIPopoverPresentationController *popoverPresentationController; // ivar: _popoverPresentationController
...
@property (readonly, nonatomic) StartPageController *startPageController; // ivar: _startPageController
@property (readonly, nonatomic) BOOL startPageDidAppearAtLeastOnce; // ivar: _startPageDidAppearAtLeastOnce
...
-(CGFloat)startPageViewControllerTopPadding:(id)arg0 ;
...
-(id)initWithDelegate:(id)arg0 browserController:(id)arg1 ;
...
-(id)startPageViewControllerTitleForRootView:(id)arg0 ;
...
-(void)_updateVisibilityForCompletionListTableView:(id)arg0 ;
...
-(void)completionList:(id)arg0 didRemoveItem:(id)arg1 wasLastInSection:(BOOL)arg2 atIndexPath:(id)arg3 withCompletionHandler:(id)arg4 ;
...
-(void)startPageViewController:(id)arg0 willPresentCustomizationViewController:(id)arg1 ;
-(void)startPageViewControllerDidAppear:(id)arg0 ;
-(void)startPageViewControllerDidScroll:(id)arg0 animated:(BOOL)arg1 ;
-(void)startPageViewControllerDidUpdateContent:(id)arg0 ;
-(void)stopCompleting;
...
-(void)unifiedFieldExternalSearchDidEnd:(id)arg0 ;
