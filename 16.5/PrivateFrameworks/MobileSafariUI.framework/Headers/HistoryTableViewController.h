...
@protocol BookmarksToolbarItemProvider, HistoryTableViewDataSourceDelegate, UISearchBarDelegate, UITableViewDragDelegate, BookmarksPanelStateRestoring, PreviewTableViewControllerDelegate, HistoryTableViewControllerDelegate, _SFNavigationIntentHandling, TabGroupProvider;
