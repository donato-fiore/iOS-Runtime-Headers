...
#import "CompletionGroup.h"
#import "CompletionGroupListing.h"
...
+(id)_completionsByMergingRecentSearches:(id)arg0 withSuggestions:(id)arg1 andLiteralSearch:(id)arg2 queryID:(NSInteger)arg3 topHits:(id)arg4 ;
...
-(id)_filteredURLCompletions:(id)arg0 withTopHits:(id)arg1 displayedUniversalSearchCompletions:(id)arg2 ;
-(id)_findOnPageGroupForQuery:(id)arg0 ;
-(id)_groupByAddingCompletions:(id)arg0 toGroup:(id)arg1 ;
...
-(id)swipeActionsForCompletionItemAtIndexPath:(id)arg0 ;
...
-(void)_addSearchProviderSuggestions:(id)arg0 toListing:(id)arg1 ;
...
-(void)_addURLCompletions:(id)arg0 toListing:(id)arg1 isCFSearch:(BOOL)arg2 ;
-(void)_addUniversalSearchCompletions:(id)arg0 toCompletionListing:(id)arg1 ;
-(void)_cacheResultsIfApplicable:(id)arg0 ;
-(void)_deleteTopHitCompletionItem:(id)arg0 atIndexPath:(id)arg1 ;
...
-(void)_searchForURLTopHits:(id)arg0 intoTopHits:(id)arg1 ;
-(void)_setNeedsUpdate;
-(void)_update;
-(void)_updateCompletionListing;
-(void)_updateCurrentCompletionGroupsForQuery:(id)arg0 isCF:(BOOL)arg1 ;
...
-(void)stopCompleting;
-(void)updateRestorationCompletionItemForCompletionItem:(id)arg0 isCF:(BOOL)arg1 ;
