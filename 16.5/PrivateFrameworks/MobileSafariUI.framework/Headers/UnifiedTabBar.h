...
@class SFUnifiedTabBar, NSString, NSArray, UIView;
@protocol TabCollectionView, TabCollectionViewDragDropSupport, TabCollectionViewDelegate, _SFNavigationIntentHandling;
