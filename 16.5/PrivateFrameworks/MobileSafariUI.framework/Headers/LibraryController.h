...
@protocol LibraryItemRegistration, UINavigationControllerDelegate, LibraryViewControllerDelegate, SidebarUIProxy;
...
@property (retain, nonatomic) NSObject<SidebarUIProxy> *sidebarUIProxy; // ivar: _sidebarUIProxy
...
-(void)reloadExpansionStateForTabGroup:(id)arg0 ;
