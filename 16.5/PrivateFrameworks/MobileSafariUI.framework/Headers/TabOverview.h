...
@class UIView, NSHashTable, CADisplayLink, NSArray, SFScrollingPanGestureRecognizer, UITapGestureRecognizer, UIPointerInteraction, NSMutableArray, NSCountedSet, UISearchBar, UILabel, UIToolbar, NSIndexSet, NSTimer, SFGradientView, UIVisualEffectView, NSString, UITextInputPasswordRules;
@protocol CloudTabTableDelegate, ReorderingAutoscrollerDelegate, _UIBasicAnimationFactory, _UIScrollToTopView, UIGestureRecognizerDelegate, UIPointerInteractionDelegate, UISearchBarDelegate, UISearchBarDelegate_Private, UIKeyInput, TabThumbnailCollectionView, TabCollectionViewDragDropSupport, TabOverviewDelegate, TabOverviewThemeProviding;
...
@interface TabOverview : UIView <CloudTabTableDelegate, ReorderingAutoscrollerDelegate, _UIBasicAnimationFactory, _UIScrollToTopView, UIGestureRecognizerDelegate, UIPointerInteractionDelegate, UISearchBarDelegate, UISearchBarDelegate_Private, UIKeyInput, TabThumbnailCollectionView, TabCollectionViewDragDropSupport>

 {
    ...
    CGFloat _cachedItemAdditionalHeaderHeight;
    CGFloat _cachedThumbnailScaleForPresentedLayout;
    CGRect _cachedContentRect;
    CGRect _cachedScreenRectInScrollingContainer;
    CGPoint _cachedVanishingPoint;
...
-(id)attachedViewForItem:(id)arg0 ;
