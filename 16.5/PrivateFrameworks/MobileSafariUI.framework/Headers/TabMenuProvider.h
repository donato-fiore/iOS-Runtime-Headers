...
+(id)_closeActionForTab:(id)arg0 inBackgroundTabGroup:(id)arg1 dataSource:(id)arg2 ;
...
+(id)_pinTabActionForTabGroupTab:(id)arg0 inTabGroup:(id)arg1 dataSource:(id)arg2 ;
