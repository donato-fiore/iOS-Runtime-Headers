...
-(id)appBannerForBrowserController:(id)arg0 ;
...
-(id)browserControllerContentContainerView:(id)arg0 ;
-(id)browserControllerNavigationBar:(id)arg0 ;
-(id)browserControllerNextResponder:(id)arg0 ;
-(id)browserControllerTabBarManager:(id)arg0 ;
-(id)browserControllerTabHoverPreview:(id)arg0 ;
-(id)crashBannerForBrowserController:(id)arg0 ;
-(id)initWithBrowserController:(id)arg0 ;
-(id)sidebarUIProxyForBrowserController:(id)arg0 ;
...
-(void)browserController:(id)arg0 animateLinkImage:(struct CGImage *)arg1 fromRect:(struct CGRect )arg2 inView:(id)arg3 toBarItem:(NSInteger)arg4 ;
-(void)browserController:(id)arg0 animateSafariIconLinkFromPoint:(struct CGPoint )arg1 inView:(id)arg2 ;
-(void)browserController:(id)arg0 didDisconnectFromScene:(id)arg1 ;
-(void)browserController:(id)arg0 setAppBanner:(id)arg1 animated:(BOOL)arg2 ;
-(void)browserController:(id)arg0 setCatalogViewController:(id)arg1 ;
-(void)browserController:(id)arg0 setCrashBanner:(id)arg1 animated:(BOOL)arg2 ;
-(void)browserController:(id)arg0 showWebExtensionBanner:(id)arg1 ;
-(void)browserController:(id)arg0 updateViewForActiveTabDocument:(id)arg1 ;
-(void)browserController:(id)arg0 webExtensionWasRemotelyEnabled:(id)arg1 ;
...
-(void)browserControllerShouldUpdateUnifiedBarVisibility:(id)arg0 ;
...
-(void)handleTabViewPinchForBrowserController:(id)arg0 ;
-(void)safariWindow:(id)arg0 statusBarChangedFromHeight:(CGFloat)arg1 toHeight:(CGFloat)arg2 ;
-(void)updateTabViewPinchRecognizerForBrowserController:(id)arg0 ;
