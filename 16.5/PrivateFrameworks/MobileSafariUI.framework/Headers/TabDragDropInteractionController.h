...
+(BOOL)canDelegateDragDropForTabCollectionView:(id)arg0 ;
...
-(id)_newDragItemsAtPoint:(struct CGPoint )arg0 excludingTabDocuments:(id)arg1 interaction:(id)arg2 session:(id)arg3 ;
...
-(void)_updatePreviewsForSession:(id)arg0 pinned:(BOOL)arg1 ;
