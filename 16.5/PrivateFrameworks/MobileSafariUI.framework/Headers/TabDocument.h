...
#import "TabDocumentCollectionItem.h"
...
@property (nonatomic) NSUInteger mediaSuspensionReasons; // ivar: _mediaSuspensionReasons
...
@property (readonly, nonatomic) NSInteger pageStatus;
...
-(BOOL)_webView:(id)arg0 gestureRecognizerCanBePreventedByTouchEvents:(id)arg1 ;
...
-(id)initForBackgroundLoadingWithBrowserController:(id)arg0 relatedWebView:(id)arg1 webViewToCloneSessionStorageFrom:(id)arg2 ;
...
-(void)addMediaSuspensionReason:(NSUInteger)arg0 ;
...
-(void)loadURL:(id)arg0 title:(id)arg1 deferNavigationWhenNotActive:(BOOL)arg2 skipSyncableTabUpdates:(BOOL)arg3 ;
...
-(void)loadingController:(id)arg0 willLoadRequest:(id)arg1 webView:(id)arg2 userDriven:(BOOL)arg3 ;
...
-(void)removeMediaSuspensionReason:(NSUInteger)arg0 ;
...
-(void)tabGroupManager:(id)arg0 activeParticipantsDidUpdateInTabWithUUID:(id)arg1 ;
