...
@class UIControl, UIColor, NSString, UIVisualEffectView, UIView, VUIImageView, NSShadow;
@protocol UIPointerInteractionDelegate, VUILabelBaselineProtocol, VUIViewScrollPercentageUpdateProtocol;
...
-(struct CGSize )_calculateContentSizeForImageThatFit:(struct CGSize )arg0 ;
-(struct CGSize )_calculateContentSizeForPrimaryButtonThatFit:(struct CGSize )arg0 ;
