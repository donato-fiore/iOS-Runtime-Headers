...
@property (retain, nonatomic) VUIPlayer *activePIPingPlayer; // ivar: _activePIPingPlayer
...
@property (retain, nonatomic) NSString *lastMediaEventActionType; // ivar: _lastMediaEventActionType
@property (nonatomic) NSUInteger lastMediaInfoIndex; // ivar: _lastMediaInfoIndex
@property (nonatomic) UIEdgeInsets legibleContentInsets; // ivar: _legibleContentInsets
@property (nonatomic) BOOL loadsPlayerWithFullscreenPlayback; // ivar: _loadsPlayerWithFullscreenPlayback
...
@property (nonatomic) BOOL shouldPlayAfterFullplaybackUIDidEnd; // ivar: _shouldPlayAfterFullplaybackUIDidEnd
...
-(void)_audioSessionSilentSecondaryAudioDidChange:(id)arg0 ;
...
-(void)_pipPlaybackStateChanged:(id)arg0 ;
-(void)_playbackErrorDidOccur:(id)arg0 ;
-(void)_playbackStateChanged:(id)arg0 ;
-(void)_recordBgAutoPlayMediaEventForPlaybackState:(id)arg0 ;
...
-(void)pause;
-(void)play;
-(void)playBackManagerFullscreenPlaybackUIDidChangeNotification:(id)arg0 ;
