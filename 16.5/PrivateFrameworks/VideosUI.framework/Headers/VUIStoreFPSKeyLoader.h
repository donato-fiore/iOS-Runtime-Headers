...
@property (nonatomic) BOOL sendsLocationWhenOptedIn; // ivar: _sendsLocationWhenOptedIn
@property (nonatomic) BOOL sendsMescalHeader; // ivar: _sendsMescalHeader
...
-(id)_bodyDictionaryForRequests:(id)arg0 isStopRequest:(BOOL)arg1 locationAuthorizationStatus:(NSInteger)arg2 ;
