...
@property (retain, nonatomic) VUIDownloadButtonActionHandler *actionHandler; // ivar: _actionHandler
...
-(id)_badgeImageForDownloadState:(NSUInteger)arg0 downloadExpirationDate:(id)arg1 hasFailed:(BOOL)arg2 ;
-(id)_buttonPropertiesForState:(NSUInteger)arg0 downloadExpirationDate:(id)arg1 hasFailed:(BOOL)arg2 ;
-(id)_downloadedBadgeImage;
-(id)_expiredBadgeImage;
-(id)_imageForDownloadState:(NSUInteger)arg0 downloadExpirationDate:(id)arg1 hasFailed:(BOOL)arg2 ;
-(id)_pausedImage;
...
-(void)_updateButtonToState:(NSUInteger)arg0 downloadExpirationDate:(id)arg1 hasFailed:(BOOL)arg2 ;
