...
-(void)_onProcessingQueue_updateStateWithStatus:(NSUInteger)arg0 downloadState:(id)arg1 supportsPausing:(BOOL)arg2 supportsCancellation:(BOOL)arg3 notify:(BOOL)arg4 ;
