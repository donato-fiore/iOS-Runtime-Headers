...
@property (readonly, nonatomic) VUIAccountMessageConfig *accountMessageConfig; // ivar: _accountMessageConfig
...
@property (readonly, nonatomic) VUIMultiviewConfig *multiviewConfig; // ivar: _multiviewConfig
...
-(void)_populateAccountMessageConfig:(id)arg0 ;
-(void)_populateCanonicalConfig:(id)arg0 ;
-(void)_populateMediaShowcaseConfig:(id)arg0 ;
-(void)_populateMultiviewConfig:(id)arg0 ;
