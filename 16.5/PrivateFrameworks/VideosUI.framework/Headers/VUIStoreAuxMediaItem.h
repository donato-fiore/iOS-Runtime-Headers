...
@property (nonatomic) BOOL isSportingEvent; // ivar: _isSportingEvent
...
@property (nonatomic) BOOL sendsLocationToPlaybackKeyServerWhenOptedIn; // ivar: _sendsLocationToPlaybackKeyServerWhenOptedIn
@property (nonatomic) BOOL sendsMescalHeaderToPlaybackKeyServer; // ivar: _sendsMescalHeaderToPlaybackKeyServer
