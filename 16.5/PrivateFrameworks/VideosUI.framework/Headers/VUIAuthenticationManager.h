...
@class ACAccount, AMSPromise, UIImage, AAUIProfilePictureStore, AMSBinaryPromise;
...
@property (readonly, nonatomic) UIImage *_profileImage; // ivar: __profileImage
@property (readonly, nonatomic) AAUIProfilePictureStore *_profilePictureStore; // ivar: __profilePictureStore
