...
+(void)shareMediaItem:(id)arg0 title:(id)arg1 subtitle:(id)arg2 imageURLStr:(id)arg3 groupActivityMetadata:(id)arg4 sourceView:(id)arg5 completionHandler:(id)arg6 ;
+(void)shareMediaItem:(id)arg0 title:(id)arg1 subtitle:(id)arg2 imageURLStr:(id)arg3 sharedWatchId:(id)arg4 sharedWatchUrl:(id)arg5 sourceView:(id)arg6 completionHandler:(id)arg7 ;
