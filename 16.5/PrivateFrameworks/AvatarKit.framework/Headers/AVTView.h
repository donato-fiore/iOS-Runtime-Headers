...
@protocol _SCNSceneCommandBufferStatusMonitor, _SCNSceneRendererResourceManagerMonitor, AVTFaceTrackerDelegate, AVTViewFaceTrackingDelegate, SCNCaptureDeviceOutputConsumer;
...
@interface AVTView : SCNView <_SCNSceneCommandBufferStatusMonitor, _SCNSceneRendererResourceManagerMonitor, AVTFaceTrackerDelegate>

 {
    ...
    CGFloat _lastFaceTrackerUpdateTimestamp;
    CGFloat _lastFaceTrackerUpdateWithTrackedFaceTimestamp;
    ? _perfTimes;
...
-(void)_disconnectRendererFromAvatar:(id)arg0 avatarNode:(id)arg1 ;
...
-(void)_transitionCoordinatorOutOfStickerConfigurationWithDuration:(CGFloat)arg0 style:(NSUInteger)arg1 options:(NSUInteger)arg2 ;
-(void)_transitionCoordinatorToStickerConfiguration:(id)arg0 duration:(CGFloat)arg1 style:(NSUInteger)arg2 options:(NSUInteger)arg3 ;
-(void)_transitionToFaceTrackingWithDuration:(CGFloat)arg0 style:(NSUInteger)arg1 enableBakedAnimations:(BOOL)arg2 completionHandler:(id)arg3 ;
...
-(void)transitionToFaceTrackingWithDuration:(CGFloat)arg0 style:(NSUInteger)arg1 completionHandler:(id)arg2 ;
-(void)transitionToFaceTrackingWithDuration:(CGFloat)arg0 style:(NSUInteger)arg1 enableBakedAnimations:(BOOL)arg2 completionHandler:(id)arg3 ;
-(void)transitionToPose:(id)arg0 duration:(CGFloat)arg1 completionHandler:(id)arg2 ;
-(void)transitionToPose:(id)arg0 duration:(CGFloat)arg1 style:(NSUInteger)arg2 completionHandler:(id)arg3 ;
-(void)transitionToStickerConfiguration:(id)arg0 duration:(CGFloat)arg1 completionHandler:(id)arg2 ;
-(void)transitionToStickerConfiguration:(id)arg0 duration:(CGFloat)arg1 style:(NSUInteger)arg2 completionHandler:(id)arg3 ;
-(void)unlockAvatar;
