...
@interface AVTMemoji : AVTAvatar {
    ...
    NSUInteger _componentAnimatedMask;
    AVTPreset" _presets;
...
-(void)_update;
-(void)_updateAO;
-(void)addComponent:(id)arg0 animated:(BOOL)arg1 ;
...
-(void)componentDidChangeForType:(NSInteger)arg0 animated:(BOOL)arg1 ;
...
-(void)setPreset:(id)arg0 forCategory:(NSInteger)arg1 animated:(BOOL)arg2 ;
