...
@property (readonly) BOOL onlySupportsGraphicIcons; // ivar: _onlySupportsGraphicIcons
@property NSUInteger options; // ivar: _options
@property BOOL placeholder; // ivar: _placeholder
...
@property (readonly) BOOL supportsGraphicIcons; // ivar: _supportsGraphicIcons
