...
+(void)runPostLanguageChangeOperationsWithNotifications:(BOOL)arg0 ;
+(void)setLanguage:(id)arg0 ;
+(void)setLanguage:(id)arg0 postNotification:(BOOL)arg1 ;
+(void)setLanguageAndRegion:(id)arg0 ;
+(void)setLanguageAndRegion:(id)arg0 postNotification:(BOOL)arg1 ;
+(void)setRegion:(id)arg0 ;
+(void)setRegion:(id)arg0 postNotification:(BOOL)arg1 ;
