...
@protocol BFFFlowDelegate, BFFFlowItemDelegate, BFFNavigationControllerDelegate, BFFFlowItem, BFFNavigationFlowDelegate;
...
-(id)_createConditionalFlowItemForClass:(Class)arg0 ;
...
-(void)dealloc;
-(void)flow:(id)arg0 finishedWithLastItem:(id)arg1 nextItem:(id)arg2 ;
...
-(void)presentWiFiPaneForFlow:(id)arg0 ;
...
-(void)pushFlowItem:(id)arg0 inFlow:(id)arg1 withExtendedInitialization:(BOOL)arg2 animated:(BOOL)arg3 willPushFlowItem:(id)arg4 ;
