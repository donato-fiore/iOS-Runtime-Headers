...
@class NSMutableArray, NSNumber, TimingCollection;
...
-(BOOL)sendAnalyticsAudioDistortionStatisticsEvent:(id)arg0 ;
-(BOOL)sendAnalyticsAudioDistortionSummaryEvent:(id)arg0 ;
-(BOOL)sendAnalyticsAudioFrameCountStatisticsEvent:(id)arg0 ;
...
-(id)getDistortionCounters:(id)arg0 ;
-(id)init;
-(id)transformHistogram:(*unsigned int)arg0 ofSize:(unsigned int)arg1 ;
-(id)transformStats:(CGFloat)arg0 ;
-(void)dealloc;
