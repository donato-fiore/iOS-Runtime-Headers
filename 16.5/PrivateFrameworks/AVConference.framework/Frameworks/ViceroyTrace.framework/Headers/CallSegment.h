...
@property CGFloat averageSilenceTimescaleRate; // ivar: _averageSilenceTimescaleRate
@property CGFloat averageSpeechErasuresRate; // ivar: _averageSpeechErasuresRate
@property CGFloat averageSpeechTimescaleRate; // ivar: _averageSpeechTimescaleRate
@property CGFloat averageTargetBitrate; // ivar: _averageTargetBitrate
@property CGFloat averageTotalTimescaleRate; // ivar: _averageTotalTimescaleRate
...
@property unsigned int nacksAvgLateTime; // ivar: _nacksAvgLateTime
@property unsigned int nacksAvgResponseTime; // ivar: _nacksAvgResponseTime
...
@property unsigned int nacksMediaBitRate; // ivar: _nacksMediaBitRate
...
@property unsigned int nacksRetransmittedMediaBitRate; // ivar: _nacksRetransmittedMediaBitRate
