...
-(CGFloat)timingForKey:(int)arg0 ;
-(CGFloat)totalTimeForKey:(int)arg0 ;
-(id)description;
-(id)init;
-(void)dealloc;
-(void)removeTimingForKey:(int)arg0 ;
-(void)setStartTime:(CGFloat)arg0 forKey:(int)arg1 ;
-(void)setStopTime:(CGFloat)arg0 forKey:(int)arg1 ;
-(void)setTiming:(CGFloat)arg0 forKey:(int)arg1 ;
