...
@interface VCVideoStreamSendGroup : VCMediaStreamSendGroup <VCMediaStreamDelegate, VCSessionUplinkVideoStreamControllerDelegate, VCRedundancyControllerDelegate, VCMediaCaptureController, VCVideoSink, VCVideoCaptureClient, VCMediaStreamSendSyncSourceDelegate>

 {
    ...
    *opaqueCMSimpleQueue _videoRedundancyChangeEventQueue;
    ...
    BOOL _initTime;
    _opaque_pthread_mutex_t _captureVideoRuleMutex;
}
...
-(BOOL)generateKeyFrameWithStreamID:(id)arg0 firType:(int)arg1 ;
...
-(id)setupRedundancyControllerForMode:(unsigned int)arg0 ;
-(id)startCapture;
-(id)stopCapture;
-(id)streamDescriptionForMediaStreamConfig:(id)arg0 ;
-(id)uplinkVideoStreamControllerForMode:(unsigned int)arg0 ;
-(id)willStart;
-(int)maxCaptureCameraFrameRateForMode:(unsigned int)arg0 ;
-(int)maxCaptureFrameRateForMode:(unsigned int)arg0 ;
...
-(void)dispatchedSetCaptureVideoRule:(id)arg0 ;
