...
+(BOOL)sendUnreliableMessage:(id)arg0 sessionID:(unsigned int)arg1 participantID:(id)arg2 transactionID:(id)arg3 transactionDelegate:(id)arg4 withOptions:(id)arg5 ;
-(BOOL)sendReliableMessage:(id)arg0 sessionID:(unsigned int)arg1 participantID:(id)arg2 timeout:(id)arg3 useFastRetries:(BOOL)arg4 withOptions:(id)arg5 ;
