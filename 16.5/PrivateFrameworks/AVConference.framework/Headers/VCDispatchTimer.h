...
-(id)initWithIntervalMilliseconds:(unsigned int)arg0 callbackBlock:(id)arg1 ;
// -(id)initWithIntervalMilliseconds:(unsigned int)arg0 callbackBlock:(id)arg1 clientQueue:(unk)arg2  ;
