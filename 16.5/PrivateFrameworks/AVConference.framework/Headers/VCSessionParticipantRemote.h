...
@class TimingCollection, NSMutableDictionary, NSArray, NSNumber, NSDictionary, NSString;
...
@interface VCSessionParticipantRemote : VCSessionParticipant <VCSessionDownlinkBandwidthAllocatorClient>

 {
    ...
    *__CFDictionary _mediaTypeToSpatialAudioMetadataEntryMap;
...
@property (nonatomic) BOOL isServerRTxEnabled; // ivar: _isServerRTxEnabled
...
+(unsigned int)maxBdatNetworkBitrateForVideoQuality:(unsigned char)arg0 isLocalOnWiFi:(BOOL)arg1 isRedundancyRequested:(BOOL)arg2 ;
+(unsigned int)maxCameraNetworkBitrateForVideoQuality:(unsigned char)arg0 isLocalOnWiFi:(BOOL)arg1 isRedundancyRequested:(BOOL)arg2 isSharingEnabled:(BOOL)arg3 ;
+(unsigned int)maxFdatNetworkBitrateForVideoQuality:(unsigned char)arg0 isLocalOnWiFi:(BOOL)arg1 isRedundancyRequested:(BOOL)arg2 ;
+(unsigned int)maxFtxtNetworkBitrateForVideoQuality:(unsigned char)arg0 isLocalOnWiFi:(BOOL)arg1 isRedundancyRequested:(BOOL)arg2 ;
+(unsigned int)maxNetworkBitrateForStreamGroupID:(unsigned int)arg0 videoQuality:(unsigned char)arg1 isLocalOnWiFi:(BOOL)arg2 isRedundancyRequested:(BOOL)arg3 isSharingEnabled:(BOOL)arg4 ;
-(*void)spatialMetadataEntryForMediaType:(unsigned int)arg0 ;
-(?)createJitterBufferTargetEstimatorSynchronizersyncGroupID;
-(BOOL)addOneToOneStreamConfigToMediaStreamInfo:(id)arg0 negotiatorStreamGroupConfig:(id)arg1 ;
...
-(BOOL)oneToOneIsSupportedAudioStreamGroup:(unsigned int)arg0 ;
-(BOOL)oneToOneIsSupportedVideoStreamGroup:(unsigned int)arg0 ;
...
-(BOOL)shouldEnablePacketRetransmissionForStreamGroupID:(unsigned int)arg0 ;
...
-(id)newCaptionsStreamGroupWithStreamGroupConfig:(id)arg0 ;
...
-(id)startScreenGroup;
-(id)stopAudioStreams;
-(id)updateMediaState:(unsigned int)arg0 forStreamGroup:(id)arg1 ;
-(id)videoGroup;
-(int)setupSpatialAudioWithMetadata:(*void)arg0 spatialMetadataEntryMap:(struct __CFDictionary *)arg1 ;
-(int)setupSpatialInfoForStreamGroupConfig:(id)arg0 ;
-(int)spatialChannelIndex:(*unsigned int)arg0 spatialAudioSourceID:(*NSUInteger)arg1 forMediaType:(unsigned int)arg2 ;
-(int)storeSpatialAudioMetadataEntry:(*void)arg0 forMediaType:(unsigned int)arg1 ;
...
-(unsigned int)remoteMediaStateForMediaType:(unsigned int)arg0 ;
...
-(void)dispatchedSetRemoteAudioEnabled:(BOOL)arg0 ;
-(void)dispatchedSetRemoteAudioPaused:(BOOL)arg0 ;
-(void)dispatchedSetRemoteScreenEnabled:(BOOL)arg0 ;
-(void)dispatchedSetRemoteSystemAudioPaused:(BOOL)arg0 ;
-(void)dispatchedSetRemoteVideoEnabled:(BOOL)arg0 ;
-(void)dispatchedSetRemoteVideoPaused:(BOOL)arg0 ;
-(void)dispatchedSetVideoReceiverFeedbackDelegate:(id)arg0 ;
...
-(void)setMoments:(id)arg0 ;
-(void)setMuted:(BOOL)arg0 ;
-(void)setRemoteMediaStalled:(BOOL)arg0 ;
-(void)setRemoteMediaState:(unsigned int)arg0 forMediaType:(unsigned int)arg1 ;
