...
@property (nonatomic) unsigned int codecBandwidthMask; // ivar: _codecBandwidthMask
...
@property (nonatomic) NSUInteger preferredMediaBitRate; // ivar: _preferredMediaBitRate
...
+(unsigned int)clientCodecBandwidthMaskForCodecBandwidth:(unsigned int)arg0 ;
+(unsigned int)clientCodecRateMaskForCodecRateMode:(unsigned int)arg0 ;
+(unsigned int)codecBandwidthMaskForClientCodecBandwidth:(unsigned int)arg0 ;
