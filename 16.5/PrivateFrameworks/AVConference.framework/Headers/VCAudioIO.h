...
+(id)controllerForDeviceRole:(int)arg0 audioType:(unsigned int)arg1 direction:(unsigned char)arg2 operatingMode:(int)arg3 streamInputID:(NSInteger)arg4 streamToken:(NSInteger)arg5 networkClockID:(NSUInteger)arg6 ;
+(id)defaultControllerForAudioType:(unsigned int)arg0 forDirection:(unsigned char)arg1 forOperatingMode:(int)arg2 ;
-(BOOL)createConverterForSource:(BOOL)arg0 error:(*id)arg1 ;
-(BOOL)reconfigureWithOperatingMode:(int)arg0 deviceRole:(int)arg1 direction:(unsigned char)arg2 streamInputID:(NSInteger)arg3 streamToken:(NSInteger)arg4 allowAudioRecording:(BOOL)arg5 networkClockID:(NSUInteger)arg6 channelIndex:(unsigned int)arg7 ;
-(id)delegate;
