...
-(id)init;
-(int)constructDTMFEventPacketWithEvent:(unsigned char)arg0 volume:(unsigned char)arg1 durationCounter:(unsigned int)arg2 dataBuffer:(char *)arg3 isEnd:(BOOL)arg4 ;
-(void)dealloc;
...
-(void)setDTMFRTPEventDuration:(unsigned int)arg0 withPayload:(int)arg1 ;
