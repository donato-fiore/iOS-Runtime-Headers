...
@property (readonly, nonatomic) tagVCRateControlAlgorithmConfig config; // ivar: _config
...
@property (readonly, nonatomic) BOOL isDipFromInitialRampUpAfterRestartDone; // ivar: _isDipFromInitialRampUpAfterRestartDone
