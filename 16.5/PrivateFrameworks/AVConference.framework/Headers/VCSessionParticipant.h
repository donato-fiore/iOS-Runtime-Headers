...
@class NSString, NSData, NSDictionary, NSMutableDictionary, NSMutableArray, NSArray;
...
-(BOOL)configureOneToOneAudioStreamsWithDeviceRole:(int)arg0 streamInfoArray:(id)arg1 ;
-(BOOL)configureOneToOneVideoStreamsWithDeviceRole:(int)arg0 ;
-(BOOL)configureOneToOneVideoStreamsWithDeviceRole:(int)arg0 streamInfoArray:(id)arg1 ;
-(BOOL)configureOneToOneWithConfig:(id)arg0 ;
-(BOOL)configureStreamInfosForMultiway:(id)arg0 streamGroupID:(unsigned int)arg1 ;
...
-(BOOL)isOneToOneTemporalSupportedForSettings:(id)arg0 streamDirection:(NSInteger)arg1 ;
...
-(id)microphoneGroup;
-(id)newAudioRateControlConfigWithMediaControlInfoVersion:(unsigned char)arg0 enableFeedbackController:(BOOL)arg1 isOneToOne:(BOOL)arg2 ;
-(id)newOneToOneAudioStreamConfigWithAudioSettings:(id)arg0 streamDirection:(NSInteger)arg1 streamGroupId:(unsigned int)arg2 streamSsrc:(unsigned int)arg3 ;
-(id)newOneToOneVideoStreamConfigWithStreamDirection:(NSInteger)arg0 streamGroupId:(unsigned int)arg1 streamSsrc:(unsigned int)arg2 encodingType:(unsigned char)arg3 videoSettings:(id)arg4 ;
-(id)newOneToOneVideoStreamMultiwayConfiguration:(unsigned char)arg0 streamGroupId:(unsigned int)arg1 videoSettings:(id)arg2 streamDirection:(NSInteger)arg3 ;
-(id)newVideoRateControlConfigWithMediaControlInfoVersion:(unsigned char)arg0 enableMediaControlInfoGenerator:(BOOL)arg1 enableFeedbackController:(BOOL)arg2 isOneToOne:(BOOL)arg3 ;
...
-(void)updateOneToOneVideoStreamCustomResolution:(id)arg0 videoSettings:(id)arg1 ;
