...
-(id)initWithRTPSocket:(int)arg0 RTCPSocket:(int)arg1 notificationHandler:(*unk)arg2 eventHandler:(*unk)arg3 handlerQueue:(id)arg4 context:(*void)arg5 ;
-(id)initWithSharedSocket:(int)arg0 ;
-(id)initWithSocketDictionary:(id)arg0 notificationHandler:(*unk)arg1 eventHandler:(*unk)arg2 handlerQueue:(id)arg3 context:(*void)arg4 ;
-(id)streams;
