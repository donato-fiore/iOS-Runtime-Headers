...
@property (nonatomic) NSInteger synchronizationSourceStreamToken; // ivar: _synchronizationSourceStreamToken
@property (nonatomic) NSUInteger tilesPerFrame; // ivar: _tilesPerFrame
@property (nonatomic) NSInteger transportProtocolType; // ivar: _transportProtocolType
