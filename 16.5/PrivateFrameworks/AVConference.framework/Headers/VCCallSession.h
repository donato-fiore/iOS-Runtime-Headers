...
@protocol VCSecureDataChannelDelegate, VCTelephonyInterfaceDelegate, VCCaptionsReceiverDelegate, VCTransportSessionLegacyDelegate, AVCRateControllerDelegate, VCAudioIOSink, VCRedundancyControllerDelegate, VCConnectionProtocol, OS_dispatch_queue, OS_dispatch_source, VideoConferenceChannelQualityDelegate, VCAudioCaptionsDelegate, VCCallSessionDelegate;
...
@interface VCCallSession : NSObject <VCSecureDataChannelDelegate, VCTelephonyInterfaceDelegate, VCCaptionsReceiverDelegate, VCTransportSessionLegacyDelegate, AVCRateControllerDelegate, VCAudioIOSink, VCRedundancyControllerDelegate>
...
@property (retain) NSObject<VCAudioCaptionsDelegate> *captionsDelegate; // ivar: captionsDelegate
...
-(void)telephonyInterface:(id)arg0 vocoderInfoChangedToType:(id)arg1 sampleRate:(id)arg2 ;
...
-(void)updateStatistics:(struct tagVCStatisticsMessage )arg0 ;
