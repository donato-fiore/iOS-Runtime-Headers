...
-(BOOL)sendReliableMessage:(id)arg0 withTopic:(id)arg1 participantID:(NSUInteger)arg2 timeout:(unsigned int)arg3 withOptions:(id)arg4 completion:(id)arg5 ;
-(BOOL)sendReliableMessageAndWait:(id)arg0 withTopic:(id)arg1 participantID:(NSUInteger)arg2 ;
-(BOOL)sendReliableMessageAndWait:(id)arg0 withTopic:(id)arg1 participantID:(NSUInteger)arg2 timeout:(id)arg3 withOptions:(id)arg4 ;
