...
typedef struct tagVCRateControlAlgorithmConfig {
    ...
    CGFloat rampDownLossEventThresholdRatio;
    CGFloat rampDownLossEventWindowDuration;
    ...
    CGFloat packetLossRateThresholdInitial;
    CGFloat packetLossRateThresholdMin;
    CGFloat packetLossRateThresholdMax;
    CGFloat packetLossRateThresholdTarget;
    unsigned int rampUpUplinkBLERThreshold;
    unsigned int rampDownUplinkBLERThreshold;
    CGFloat rampUpUplinkBLERDuration;
    CGFloat rampDownUplinkBLERDuration;
} tagVCRateControlAlgorithmConfig;
...
typedef struct tagAVCRateControlExperimentConfig {
    int field0;
    int field1;
} tagAVCRateControlExperimentConfig;

typedef struct tagVCStatisticsVideoLossFeedback {
    unsigned int frameRTPTimestamp;
    unsigned short packetsReceived;
    unsigned char frameSize;
    unsigned char packetsLost;
} tagVCStatisticsVideoLossFeedback;

typedef struct tagVCStatisticsMessage {
    int type;
    int priority;
    CGFloat arrivalTime;
    BOOL isVCRCInternal;
    ...
    ? mediaEvent;
    ? nwConnection;
    tagVCStatisticsVideoLossFeedback videoLossFeedback;
} tagVCStatisticsMessage;

typedef struct __CFDictionary {
} // Error Processing Struct Fields

typedef struct tagVCRateControlParams {
    id field0;
    BOOL field1;
    BOOL field2;
    id field3;
    ...
    id field6;
    BOOL field7;
} tagVCRateControlParams;

typedef struct os_unfair_lock_s {
    unsigned int _os_unfair_lock_opaque;
} os_unfair_lock_s;

typedef struct ifnet_interface_advisory_header {
...
typedef struct ifnet_interface_advisory_capacity {
    int rate_trend_suggestion;
    NSUInteger timestamp;
    NSUInteger max_bandwidth;
    NSUInteger total_byte_count;
    NSUInteger average_throughput;
...
typedef struct ifnet_interface_advisory_wifi_context {
    ...
    unsigned int wifi_observed_tx_bitrate;
} ifnet_interface_advisory_wifi_context;

typedef struct ifnet_interface_advisory_cell_context {
...
typedef struct tagVCStatisticsCollection {
    ...
    ? field5;
    ? field6;
    tagVCStatisticsVideoLossFeedback field7;
...
typedef struct tagRTCPPACKET {
    ...
    tagRTCP_PSFB_ALFB_HEADER field15;
    tagRTCP_PSFB_LOSSFB field16;
    tagRTCP_PSFB_LTRACK field17;
    tagRTCP_RTPFB_GNACK field18;
    tagRTCP_RTPFB_TMMB field19;
    tagRTCP_RTPFB_TMMB field20;
    tagVCRTCPXR field21;
    tagRTCP_CUSTOM_SR field22;
    tagRTCP_CUSTOM_RR field23;
    tagRTCP_CUSTOM_RCTL field24;
} tagRTCPPACKET;
...
typedef struct tagRTCP_PSFB_ALFB_HEADER {
    tagRTCP_FBCOMMON field0;
    unsigned int field1;
} tagRTCP_PSFB_ALFB_HEADER;

typedef struct tagRTCP_CUSTOM_PSFB_LOSS_FB_INFO {
    unsigned int field0;
    unsigned short field1;
    unsigned char field2;
    unsigned char field3;
} tagRTCP_CUSTOM_PSFB_LOSS_FB_INFO;

typedef struct tagRTCP_PSFB_LOSSFB {
    tagRTCP_PSFB_ALFB_HEADER field0;
    tagRTCP_CUSTOM_PSFB_LOSS_FB_INFO field1;
} tagRTCP_PSFB_LOSSFB;

typedef struct tagRTCP_PSFB_LTRACK {
    tagRTCP_PSFB_ALFB_HEADER field0;
    unsigned int field1;
} tagRTCP_PSFB_LTRACK;
...
typedef struct opaqueVCCaptionsEncoder {
} // Error Processing Struct Fields
...
typedef struct _VCScreenCaptureSourceContext {
    void sinkContext;
    unk sinkCallback;
} _VCScreenCaptureSourceContext;
...
typedef struct tagVCMomentsHistoryAudioFormat {
    opaqueCMFormatDescription figFormat;
    AudioStreamBasicDescription basicFormat;
} tagVCMomentsHistoryAudioFormat;
...
typedef struct tagVCVideoTransmitterRealtimeSPI {
    unk setFECRatio;
    unk enqueueVideoFrame;
} tagVCVideoTransmitterRealtimeSPI;
...
typedef struct EVSRFParams {
    unsigned int field0;
    unsigned int field1;
} EVSRFParams;

typedef struct _VCAudioCodecModeChangeEvent {
    int field0;
    int field1;
    int field2;
    unsigned int field3;
    EVSRFParams field4;
} _VCAudioCodecModeChangeEvent;
...
typedef struct tagVCRTCPXRSummaryReport {
    BOOL field0;
    BOOL field1;
    BOOL field2;
    int field3;
...
} tagVCRTCPXRSummaryReport;

typedef struct tagVCRTCPXRVoIPMetricsReport {
    unsigned char field0;
    unsigned char field1;
    unsigned char field2;
    unsigned char field3;
...
typedef struct tagVCVideoCaptureSinkEntry {
    _VCSingleLinkedListEntry field0;
    id field1;
    id field2;
    unk field3;
} tagVCVideoCaptureSinkEntry;
...
typedef struct tagVCVideoBufferStatistics {
    int bufferWidth;
    int bufferHeight;
    BOOL preferPTS;
    CGFloat frameTime;
    CGFloat hostTimeFromBufferAttachment;
    CGFloat presentationTime;
    CGFloat presentationTimeConvertedToHost;
    CGFloat clockTime;
} tagVCVideoBufferStatistics;
...
typedef struct tagVCCellularAudioTapIORealtimeContext {
} // Error Processing Struct Fields
...
typedef struct tagVCSourceDestinationInfo {
    ...
    ? field5;
    unsigned int field6;
    tagVCSourceDestinationInfo field7;
    void field8;
...
typedef struct tagVCSystemAudioCaptureTapSettings {
} // Error Processing Struct Fields

typedef struct tagVCSystemAudioCaptureControllerConfig {
} // Error Processing Struct Fields
...
typedef struct tagVCCMSourceDestinationInfoConfig {
    BOOL field0;
    BOOL field1;
    BOOL field2;
} tagVCCMSourceDestinationInfoConfig;
...
typedef struct tagVCAudioDucker {
} // Error Processing Struct Fields
...
typedef struct _VCSessionParticipantLocalOneToOneSettings {
    id audioRedundancyController;
    id VCRedundancyControllerAudio;
    id videoRedundancyController;
    id VCRedundancyControllerVideo;
    unsigned int streamInfo;
    unsigned int NSMutableDictionary;
    BOOL switchManager;
} _VCSessionParticipantLocalOneToOneSettings;
...
typedef struct tagVCNACKGeneratorStoreBagsConfig {
    unsigned char field0;
    float field1;
    float field2;
    BOOL field3;
    float field4;
    float field5;
} tagVCNACKGeneratorStoreBagsConfig;
...
typedef struct tagVCPacketBundlerPacketInfo {
    int field0;
    unsigned int field1;
    unsigned int field2;
    unsigned int field3;
    BOOL field4;
} tagVCPacketBundlerPacketInfo;

typedef struct tagVCAudioPacketBundlerCDRXInfo {
    unsigned char field0;
    unsigned short field1;
} tagVCAudioPacketBundlerCDRXInfo;

typedef struct tagVCAudioPacketBundlerCDRXStateParameters {
    tagVCAudioPacketBundlerCDRXInfo field0;
    unsigned char field1;
} tagVCAudioPacketBundlerCDRXStateParameters;

typedef struct opaqueVCPacketBundlerCdrxBundleInfo {
} // Error Processing Struct Fields
...
typedef struct _AVCPacketRelayDemuxPacketHealthStats {
    unsigned int rtpAndRTCPPacketCount;
    unsigned int rtpPacketCount;
    unsigned int rtcpPacketCount;
    unsigned int droppedPacketCount;
} _AVCPacketRelayDemuxPacketHealthStats;

typedef struct _AVCPacketRelayHealthStats {
    _AVCPacketRelayDemuxPacketHealthStats demuxPacketStats;
    unsigned int sendPacketCount;
    unsigned int sendByteCount;
    unsigned int receivePacketCount;
    unsigned int receiveByteCount;
    CGFloat lastSendTimePrint;
    CGFloat lastReceiveTimePrint;
} _AVCPacketRelayHealthStats;
...
typedef struct tagVCMediaStreamRateAdaptationConfigTelephonyUplink {
    unsigned int field0;
    unsigned int field1;
    unsigned int field2;
    unsigned int field3;
} tagVCMediaStreamRateAdaptationConfigTelephonyUplink;

typedef struct tagVCMediaStreamRateAdaptationConfig {
    NSInteger field0;
    unsigned char field1;
    CGFloat field2;
    int field3;
    ...
    float field12;
    int field13;
    tagVCMediaStreamRateAdaptationConfigTelephonyUplink field14;
} tagVCMediaStreamRateAdaptationConfig;

typedef struct tagVCMediaStreamRateAdaptationParams {
} // Error Processing Struct Fields
...
typedef struct tagVCAudioIssueDetector {
} // Error Processing Struct Fields

typedef struct tagVCAudioDump {
} // Error Processing Struct Fields

typedef struct tagVCAudioDumpPayloadInfo {
} // Error Processing Struct Fields
...
typedef struct tagVPKTFLAG {
    ...
    BOOL field17;
    BOOL field18;
    tagVCIDSChannelDataFormat field19;
    tagPKT_TAG field20;
...
typedef struct tagVCMediaControlVTableC {
    unk serializedSize;
    unk serialize;
} tagVCMediaControlVTableC;
