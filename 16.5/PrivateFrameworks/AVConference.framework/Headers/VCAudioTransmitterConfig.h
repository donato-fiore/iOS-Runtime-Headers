...
@property (nonatomic) BOOL audioDumpEnabled; // ivar: _audioDumpEnabled
@property (nonatomic) BOOL audioIssueDetectorEnabled; // ivar: _audioIssueDetectorEnabled
...
@property (nonatomic) unsigned int packetExpirationTime; // ivar: _packetExpirationTime
...
@property (nonatomic) int ratType; // ivar: _ratType
...
@property (nonatomic) BOOL supportsCodecBandwidthUpdate; // ivar: _supportsCodecBandwidthUpdate
@property (nonatomic) BOOL targetBitrateIsAudioOnly; // ivar: _targetBitrateIsAudioOnly
