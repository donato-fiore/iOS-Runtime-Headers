...
-(BOOL)initializeTransportSessionWithRTPNWConnectionID:(id)arg0 rtcpNWConnectionID:(id)arg1 error:(*id)arg2 ;
...
-(id)getInvalidParamErrorForSetPause:(BOOL)arg0 didSucceed:(BOOL)arg1 ;
...
-(id)setupRTPWithNWConnection:(id)arg0 error:(*id)arg1 ;
