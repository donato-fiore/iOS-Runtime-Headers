...
@class NSMutableDictionary, NSMutableArray, NSMutableSet, NSError, NSString, NSDate, NSDictionary, NSArray;
@protocol VCSessionParticipantStreamDelegate, AVCRateControllerDelegate, VCRateControlMediaControllerDelegate, RTCPReportProvider, VCSecurityEventHandler, VCSessionParticipantDelegate, VCNetworkFeedbackControllerDelegate, VCSessionStatsControllerDelegate, VCConnectionChangedHandler, VCMomentTransportDelegate, VCSessionParticipantLocalVideoStreamDelegate, OS_dispatch_queue, VCSessionDelegate, OS_nw_activity, OS_dispatch_semaphore, VCConnectionProtocol;
...
@interface VCSession : VCObject <VCSessionParticipantStreamDelegate, AVCRateControllerDelegate, VCRateControlMediaControllerDelegate, RTCPReportProvider, VCSecurityEventHandler, VCSessionParticipantDelegate, VCNetworkFeedbackControllerDelegate, VCSessionStatsControllerDelegate, VCConnectionChangedHandler, VCMomentTransportDelegate, VCSessionParticipantLocalVideoStreamDelegate>

 {
    ...
    *__CFDictionary _mediaTypeToSpatialMetadataEntryMap;
    NSUInteger _siriSpatialAudioSourceID;
...
@property (readonly, nonatomic) int reportingClientType; // ivar: _reportingClientType
@property (readonly, nonatomic) int reportingModuleID; // ivar: _reportingModuleID
...
+(id)mediaStateMessageKeyForMediaType:(unsigned int)arg0 ;
+(id)mediaStateMessageStreamGroupKeysForMediaType:(unsigned int)arg0 ;
+(id)mediaStateMessageValueForMediaState:(unsigned int)arg0 ;
+(int)deviceRoleForSessionMode:(NSInteger)arg0 ;
+(unsigned int)mediaStateForMediaStateMessageValue:(id)arg0 ;
+(unsigned int)mediaTypeForMediaStateMessageKey:(id)arg0 ;
...
-(BOOL)addOneToOneParticipant:(id)arg0 ;
-(BOOL)completeTransitionToOneToOneEnabled:(BOOL)arg0 ;
-(BOOL)composeControlChannelParticipantConfig:(struct ? *)arg0 withRemoteParticipant:(id)arg1 ;
-(BOOL)configureLocalParticipantWithOneToOneRemoteParticipant:(id)arg0 isInitialConfiguration:(BOOL)arg1 ;
-(BOOL)configureRemoteParticipant:(id)arg0 withConfig:(id)arg1 ;
-(BOOL)configureRemoteParticipantForOneToOne:(id)arg0 ;
-(BOOL)detectSSRCCollision:(id)arg0 resetNeeded:(*BOOL)arg1 ;
// -(BOOL)detectSSRCCollisionWithRemoteMediaStream:(id)arg0 remoteBlobCreationTime:(unk)arg1 resetNeeded:(NSUInteger)arg2  ;
...
-(BOOL)negotiateOneToOneWithRemoteParticipant:(id)arg0 ;
-(BOOL)registerRemoteParticipantToSession:(id)arg0 ;
-(BOOL)setOneToOneConfigOnRemoteParticipant:(id)arg0 ;
...
-(id)newNegotiatorForOneToOneWithRemoteParticipant:(id)arg0 ;
-(id)newNetworkBitrateString:(struct ? *)arg0 ;
-(id)newParticipantOneToOneConfigWithIDSParticipantID:(NSUInteger)arg0 isLocal:(BOOL)arg1 mediaControlInfoVersion:(unsigned char)arg2 videoEnabled:(BOOL)arg3 screenEnabled:(BOOL)arg4 remoteParticipant:(id)arg5 ;
...
-(int)reserveAudioChannelForMediaType:(unsigned int)arg0 spatialAudioSourceID:(NSUInteger)arg1 ;
-(int)selectDataPath;
-(int)setupOneToOne;
-(int)setupOneToOneMediaControlInfoGeneratorsWithVersion:(unsigned char)arg0 oneToOneConfig:(id)arg1 videoEnabled:(BOOL)arg2 ;
...
-(void)completionHandlerOneToOneEnabled:(BOOL)arg0 didSucceed:(BOOL)arg1 ;
-(void)configureOneToOneRateController:(id)arg0 isUsingCamera:(BOOL)arg1 isUsingScreen:(BOOL)arg2 ;
...
-(void)dispatchedSetSharingEnabled:(BOOL)arg0 ;
...
-(void)generateKeyFrameWithReceivedMessage:(id)arg0 forParticipant:(id)arg1 ;
-(void)generateReportDictionary:(struct __CFDictionary *)arg0 ;
...
-(void)handleControlConfigMessage:(id)arg0 forParticipantId:(id)arg1 ;
-(void)handleEncryptionInfoEvent:(id)arg0 ;
-(void)handleMediaQueueSizeExceedThresholdWithQueueSize:(CGFloat)arg0 mediaQueueStreamId:(unsigned int)arg1 type:(int)arg2 ;
...
-(void)mediaQualityDegraded:(BOOL)arg0 ;
...
-(void)processDidStop;
-(void)processMediaStateMessage:(id)arg0 remoteParticipantID:(id)arg1 ;
-(void)processMediaTypeStatesWithMessage:(id)arg0 mediaTypeStates:(id)arg1 ;
-(void)processStreamGroupStateMessageKey:(id)arg0 value:(id)arg1 mediaTypeStates:(id)arg2 ;
...
-(void)reportCompletedSwitchingToOneToOne:(BOOL)arg0 ;
-(void)reportExistingParticipantsAnew;
-(void)reportStartedSwitchingToOneToOne:(BOOL)arg0 ;
-(void)reportSwitchingError:(BOOL)arg0 errorEvent:(unsigned int)arg1 ;
-(void)reportingIntervalChanged:(CGFloat)arg0 ;
-(void)reportingMomentsToGreenTeaWithRequest:(id)arg0 ;
...
-(void)sendMediaStateUpdateMessageToRemoteParticipant:(id)arg0 ;
-(void)sendRateControlConfigToRemoteParticipant:(id)arg0 ;
-(void)sendStreamGroupStateToParticipant:(id)arg0 ;
-(void)sendSymptomsToRemoteParticipants:(id)arg0 symptom:(id)arg1 groupID:(id)arg2 ;
-(void)setOneToOneVideoStreamBandwidthProbing:(BOOL)arg0 ;
-(void)setReportingConfig:(struct ? *)arg0 ;
...
-(void)setTransportConnectionSelectionVersionWithLocalFrameWorkVersion:(id)arg0 remoteFrameworkVersion:(id)arg1 ;
...
-(void)startRateControllersMultiwayFromOneToOne:(BOOL)arg0 ;
...
-(void)stopWithError:(id)arg0 didRemoteCancel:(BOOL)arg1 ;
-(void)tearDown;
...
-(void)updateOneToOneRateControllerForVideoEnabled:(BOOL)arg0 screenEnabled:(BOOL)arg1 ;
...
-(void)vcSessionParticipant:(id)arg0 mediaStateDidChange:(unsigned int)arg1 forMediaType:(unsigned int)arg2 didSucceed:(BOOL)arg3 error:(id)arg4 ;
...
-(void)vcSessionParticipant:(id)arg0 remoteMediaStateDidChange:(unsigned int)arg1 forMediaType:(unsigned int)arg2 ;
...
-(void)vcSessionParticipant:(id)arg0 requestKeyFrameGenerationWithStreamID:(unsigned short)arg1 streamGroupID:(unsigned int)arg2 firType:(int)arg3 ;
...
-(void)vcSessionParticipantFetchStreamGroupState:(id)arg0 ;
