...
@property (nonatomic) unsigned int encoderBitrateAveragingInterval; // ivar: _encoderBitrateAveragingInterval
...
@property (nonatomic) int ltrAckFeedbackType; // ivar: _ltrAckFeedbackType
...
@property (nonatomic) int reportingClientType; // ivar: _reportingClientType
...
@property (nonatomic) BOOL setupBWEstimationOptionWithFeatureString; // ivar: _setupBWEstimationOptionWithFeatureString
