...
-(void)checkForRedundancyFreeze:(struct tagVCStatisticsMessage )arg0 ;
-(void)dealloc;
-(void)processNWConnectionStatistics:(struct tagVCStatisticsMessage )arg0 ;
-(void)processRCNetworkStatistics:(struct tagVCStatisticsMessage )arg0 ;
-(void)processRTCPPSFBStatistics:(struct tagVCStatisticsMessage )arg0 ;
-(void)reset;
-(void)stateFrozen:(struct tagVCStatisticsMessage )arg0 ;
-(void)stateRunning:(struct tagVCStatisticsMessage )arg0 ;
