...
@property (readonly) NSObject<VCSessionUplinkBandwidthAllocatorClient> *uplinkClient; // ivar: _uplinkClient
...
-(id)initWithClient:(id)arg0 type:(unsigned char)arg1 streamToken:(NSInteger)arg2 streamID:(unsigned int)arg3 streamGroupID:(unsigned int)arg4 ;
-(void)dealloc;
