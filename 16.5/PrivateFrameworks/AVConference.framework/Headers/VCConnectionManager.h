...
@property (nonatomic) BOOL isOneToOneScreenEnabled; // ivar: _isOneToOneScreenEnabled
...
-(struct tagVCSourceDestinationInfo *)createSourceDestinationInfoListWithConfig:(struct tagVCCMSourceDestinationInfoConfig *)arg0 ;
...
-(void)reportWRMSuggestion:(struct ? *)arg0 ;
...
-(void)setPreferRelayOverP2P:(BOOL)arg0 reason:(unsigned char)arg1 ;
...
-(void)updateConnectionHealthWithVCStatisticsMessage:(struct tagVCStatisticsMessage )arg0 ;
