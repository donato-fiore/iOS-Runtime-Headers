...
@class NSArray, NSMutableSet, NSMutableDictionary, NSSet, NSString;
@protocol VCVideoSink, VCVideoCaptureClient, VCIDSStreamIDGenerator, VCSessionUplinkBandwidthAllocatorClient, VCSessionUplinkBandwidthAllocator;
...
@interface VCSessionParticipantLocal : VCSessionParticipant <VCVideoSink, VCVideoCaptureClient, VCIDSStreamIDGenerator, VCSessionUplinkBandwidthAllocatorClient>

 {
    ...
    *opaqueVCVoiceDetector _voiceDetector;
    ...
    CGFloat _initTime;
    CGFloat _lastVideoEnabledChangedTime;
}
...
@property (copy, nonatomic) NSArray *remoteParticipants; // ivar: _remoteParticipants
...
+(BOOL)updateBandwidthAllocator:(id)arg0 activeStream:(id)arg1 peerSubscribedStreams:(id)arg2 streamGroup:(id)arg3 ;
+(BOOL)updateUplinkStreamsForPeerSubscribedStreams:(id)arg0 streamGroup:(id)arg1 uplinkBandwidthAllocator:(id)arg2 ;
...
-(BOOL)configureOneToOneAudioStreamsWithDeviceRole:(int)arg0 ;
-(BOOL)configureOneToOneVideoStreamsWithDeviceRole:(int)arg0 ;
...
-(BOOL)initializeOneToOneStreamGroup:(id)arg0 forLocalConfig:(id)arg1 ;
...
-(BOOL)isOneToOneStreamGroup:(unsigned int)arg0 ;
-(BOOL)isRemotePresentationLarge:(struct CGRect )arg0 ;
-(BOOL)isStreamGroupActive:(id)arg0 ;
-(BOOL)nativeParticipantSupportsStreamGroupID:(unsigned int)arg0 ;
-(BOOL)onVideoFrame:(struct opaqueCMSampleBuffer *)arg0 frameTime:(struct ? )arg1 attribute:(struct ? )arg2 ;
-(BOOL)reconfigureAudioIOForVideoEnabled:(BOOL)arg0 error:(*id)arg1 ;
-(BOOL)reconfigureOneToOneAudioStream:(id)arg0 error:(*id)arg1 ;
-(BOOL)remoteParticipantsSupportStreamGroupID:(unsigned int)arg0 ;
...
-(BOOL)setupCaptionsStreamsWithStreamConfiguration:(id)arg0 streamGroupConfiguration:(id)arg1 ;
-(BOOL)setupCaptionsStreamsWithStreamConfigurations:(id)arg0 mediaNegotiatorConfig:(id)arg1 streamGroupConfiguration:(id)arg2 ;
-(BOOL)setupOneToOneVideoStreamWithConfig:(id)arg0 streamGroupID:(unsigned int)arg1 ;
...
-(BOOL)shouldCapStream:(NSInteger)arg0 cappedBitrate:(*unsigned int)arg1 ;
-(BOOL)webParticipantSupportsStreamGroupID:(unsigned int)arg0 ;
...
-(id)newAudioStreamOneToOneConfigurationWithStreamGroupId:(unsigned int)arg0 ;
-(id)newAudioStreamSendGroupWithConfig:(id)arg0 streamGroupID:(unsigned int)arg1 ;
-(id)newMediaNegotiatorAudioConfigurationForMediaType:(unsigned int)arg0 ;
-(id)newStreamGroupNegotiationConfigForStreamGroup:(id)arg0 ;
-(id)newStreamInfoWithAudioStreamWithConfiguration:(id)arg0 idsDestination:(id)arg1 isMultiway:(BOOL)arg2 streamGroupID:(unsigned int)arg3 ;
-(id)newStreamInfoWithAudioStreamWithConfiguration:(id)arg0 streamToken:(NSInteger)arg1 isMultiway:(BOOL)arg2 streamGroupID:(unsigned int)arg3 ;
...
-(id)newVideoStreamOneToOneConfigurationWithStreamGroupId:(unsigned int)arg0 ;
-(id)newVideoStreamWithConfig:(id)arg0 groupID:(unsigned int)arg1 ;
-(id)processCachedParticipantData:(id)arg0 ;
-(id)qualityTierTableForStreamToken:(NSInteger)arg0 ;
...
-(int)captureSourceIDFromStreamGroupID:(unsigned int)arg0 ;
...
-(unsigned int)remainderBitrateSplitForStreamToken:(NSInteger)arg0 ;
...
-(void)didServerDie;
-(void)dispatchedHandleActiveConnectionChangeForStreamGroups:(id)arg0 ;
-(void)dispatchedStartOneToOneStreams;
-(void)dispatchedUpdateUplinkTargetBitrate:(unsigned int)arg0 rateChangeCounter:(unsigned int)arg1 ;
-(void)frameRateIsBeingThrottled:(int)arg0 thermalLevelDidChange:(BOOL)arg1 powerLevelDidChange:(BOOL)arg2 ;
-(void)generateKeyFrameWithStreamID:(id)arg0 streamGroupID:(unsigned int)arg1 firType:(int)arg2 ;
...
-(void)overrideVideoStreamConfigWithDefaults:(id)arg0 streamGroupID:(unsigned int)arg1 ;
...
-(void)reportVideoEnabledStatsWithVideoEnabled:(BOOL)arg0 ;
...
-(void)setupOneToOneAudioStreamWithConfig:(id)arg0 streamGroupID:(unsigned int)arg1 ;
...
-(void)streamGroup:(id)arg0 didChangeState:(unsigned int)arg1 ;
...
-(void)updateMediaStreamsForStreamGroup:(id)arg0 uplinkBitrateCap:(unsigned int)arg1 rateChangeCounter:(unsigned int)arg2 ;
-(void)updateMultiwayBandwithAllocationTable:(id)arg0 mediaType:(unsigned int)arg1 streamGroupID:(unsigned int)arg2 encoderGroupID:(unsigned int)arg3 minNetworkBitrate:(unsigned int)arg4 maxNetworkBitrate:(unsigned int)arg5 ;
-(void)updateOneToOneBandwidthAllocationTable:(id)arg0 mediaType:(unsigned char)arg1 streamGroupID:(unsigned int)arg2 ;
-(void)updatePayloadTypesWithAudioConfigs:(id)arg0 ;
-(void)updatePayloadTypesWithVideoConfigs:(id)arg0 ;
-(void)updatePeerSubscribedStreams:(id)arg0 streamGroup:(id)arg1 ;
...
-(void)updateUplinkTargetBitrate:(unsigned int)arg0 rateChangeCounter:(unsigned int)arg1 ;
