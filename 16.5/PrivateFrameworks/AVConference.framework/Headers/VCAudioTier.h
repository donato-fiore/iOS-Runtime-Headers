...
-(id)description;
-(id)dictionary;
-(id)initWithNetworkBitrate:(unsigned int)arg0 bundlingAppliedByCodec:(BOOL)arg1 audioCodecBitrate:(unsigned int)arg2 packetsPerBundle:(unsigned int)arg3 redNumPayloads:(unsigned int)arg4 payloadSize:(unsigned int)arg5 headerSize:(unsigned int)arg6 payloadConfig:(id)arg7 ;
