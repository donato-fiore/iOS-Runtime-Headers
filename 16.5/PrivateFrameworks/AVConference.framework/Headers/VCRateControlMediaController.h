...
@property (readonly, nonatomic) BOOL disableBasebandFlush; // ivar: _disableBasebandFlush
...
-(void)updateBasebandSuggestionWithStatistics:(struct tagVCStatisticsMessage )arg0 ;
