...
-(id)initWithCaptureServer:(id)arg0 width:(int)arg1 height:(int)arg2 frameRate:(int)arg3 videoSourceToken:(struct _VCVideoSourceToken )arg4 video:(id)arg5 isCamera:(BOOL)arg6 error:(*int)arg7 ;
