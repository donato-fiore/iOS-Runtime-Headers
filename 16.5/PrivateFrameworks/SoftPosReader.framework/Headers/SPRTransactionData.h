...
@property (readonly, copy, nonatomic) NSString *fallbackAmount; // ivar: _fallbackAmount
@property (readonly, copy) NSData *fingerprint;
@property (readonly, nonatomic) BOOL forFallback; // ivar: _forFallback
@property (readonly, nonatomic) BOOL isPINBypassAllowed; // ivar: _isPINBypassAllowed
...
@property (readonly, nonatomic) unsigned char payAppletFinalStatus; // ivar: _payAppletFinalStatus
...
-(id)initWithVasResponses:(id)arg0 cardHolderData:(id)arg1 network:(id)arg2 outcomeStatus:(unsigned char)arg3 cvmType:(unsigned char)arg4 cvmResult:(id)arg5 merchantCategoryCode:(id)arg6 pinRequired:(BOOL)arg7 kernelIdentityKeyAttestation:(id)arg8 ecdsaCertificate:(id)arg9 transactionResultData:(id)arg10 kekId:(id)arg11 pinKekId:(id)arg12 isPinSupported:(BOOL)arg13 languagePreference:(id)arg14 transactionId:(id)arg15 readError:(NSInteger)arg16 payAppletFinalStatus:(unsigned char)arg17 ;
-(id)initWithVasResponses:(id)arg0 cardHolderData:(id)arg1 network:(id)arg2 outcomeStatus:(unsigned char)arg3 cvmType:(unsigned char)arg4 cvmResult:(id)arg5 merchantCategoryCode:(id)arg6 pinRequired:(BOOL)arg7 kernelIdentityKeyAttestation:(id)arg8 ecdsaCertificate:(id)arg9 transactionResultData:(id)arg10 kekId:(id)arg11 pinKekId:(id)arg12 isPinSupported:(BOOL)arg13 languagePreference:(id)arg14 transactionId:(id)arg15 readError:(NSInteger)arg16 payAppletFinalStatus:(unsigned char)arg17 isPINBypassAllowed:(BOOL)arg18 forFallback:(BOOL)arg19 fallbackAmount:(id)arg20 ;
