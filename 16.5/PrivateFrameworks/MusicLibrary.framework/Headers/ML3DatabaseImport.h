...
@property (readonly, nonatomic) NSData *albumData; // ivar: _albumData
@property (readonly, nonatomic) NSData *artistData; // ivar: _artistData
...
-(id)initWithLibraryPath:(id)arg0 trackData:(id)arg1 playlistData:(id)arg2 artistData:(id)arg3 albumData:(id)arg4 clientIdentity:(id)arg5 ;
