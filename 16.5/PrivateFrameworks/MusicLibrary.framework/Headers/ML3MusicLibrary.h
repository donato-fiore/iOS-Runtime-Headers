...
@property (nonatomic) BOOL isUnitTesting; // ivar: _isUnitTesting
...
-(NSUInteger)_totalSizeForTracksPredicate:(id)arg0 ;
...
-(NSUInteger)totalSizeForAllNonCacheTracks;
-(NSUInteger)totalSizeForAllNonRedownloadableTracks;
-(NSUInteger)totalSizeForAllRedownloadableNonCacheTracks;
-(NSUInteger)totalSizeForAllSyncedTracks;
-(NSUInteger)totalSizeForArtwork;
...
-(id)initWithPath:(id)arg0 isUnitTesting:(BOOL)arg1 ;
...
-(struct CGSize )_sizeForColorAnalysisForMediaType:(unsigned int)arg0 artworkType:(NSInteger)arg1 ;
...
-(void)_createColorAnalysisForRelativePath:(id)arg0 artworkType:(NSInteger)arg1 artworkToken:(id)arg2 preferredImageSize:(struct CGSize )arg3 completionHandler:(id)arg4 ;
...
-(void)performColorAnalysisForArtworkWithConnection:(id)arg0 ;
