...
@property (readonly, nonatomic) WFCoreDataResultState *resultState; // ivar: _resultState
...
+(void)getResultWithQuery:(id)arg0 valueType:(Class)arg1 glyphSize:(struct CGSize )arg2 roundedIcon:(BOOL)arg3 completionHandler:(id)arg4 ;
-(id)description;
