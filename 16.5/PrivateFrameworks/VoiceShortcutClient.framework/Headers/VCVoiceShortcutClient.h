...
-(BOOL)resetAutomationConfirmationStatusWithError:(*id)arg0 ;
-(BOOL)userHasAutomationsWithError:(*id)arg0 ;
-(id)accessibilityWatchWorkflowsWithError:(*id)arg0 ;
-(id)accessibilityWorkflowForIdentifier:(id)arg0 error:(*id)arg1 ;
-(id)accessibilityWorkflowWithIdentifier:(id)arg0 error:(*id)arg1 ;
-(id)accessibilityWorkflowsForSurface:(NSUInteger)arg0 error:(*id)arg1 ;
-(id)accessibilityWorkflowsWithError:(*id)arg0 ;
-(id)archiveAction:(id)arg0 withActionMetadata:(id)arg1 error:(*id)arg2 ;
...
-(id)observableStingWorkflowWithIdentifier:(id)arg0 error:(*id)arg1 ;
-(id)observableStingWorkflowsWithError:(*id)arg0 ;
...
-(id)runWorkflowWithDescriptor:(id)arg0 request:(id)arg1 completion:(id)arg2 ;
-(id)runningWorkflowNamesAndProgressCompletedWithError:(*id)arg0 ;
...
-(id)stingWorkflowWithIdentifier:(id)arg0 error:(*id)arg1 ;
-(id)stingWorkflowsWithError:(*id)arg0 ;
-(id)synchronousRemoteDataStoreWithErrorHandler:(id)arg0 ;
-(id)unarchiveActionFromData:(id)arg0 withActionMetadata:(id)arg1 error:(*id)arg2 ;
-(id)unsafePopConnectionErrorHandlers;
-(id)visibleShortcutsWithError:(*id)arg0 ;
...
-(void)computeRepresentativeSizesForFinderResizingImages:(id)arg0 toSizes:(id)arg1 completion:(id)arg2 ;
