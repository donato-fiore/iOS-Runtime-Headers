...
@property (retain, nonatomic) NSArray *allowedElementsForTraversal; // ivar: _allowedElementsForTraversal
...
@property (nonatomic) BOOL shouldExcludeSupplementaryViews; // ivar: _shouldExcludeSupplementaryViews
