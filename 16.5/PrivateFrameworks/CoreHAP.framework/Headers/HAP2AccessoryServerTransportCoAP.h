...
@class HMFActivity, NSString, NSMutableArray;
...
@interface HAP2AccessoryServerTransportCoAP : HAP2AccessoryServerTransportBaseWithDelegate <HAP2CoAPClientDelegate>

 {
    ...
    NSUInteger _numOfAddresses;
    NSUInteger _numOfAddressesTried;
    ...
    NSUInteger _maxAddressesAllowed;
    NSMutableArray *_bonjourNames;
    NSUInteger _maxBonjourNamesAllowed;
    NSUInteger _lastResolveStartTime;
