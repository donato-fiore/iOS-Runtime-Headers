...
@class NSMapTable, HMFTimer, NSString, NSMutableSet, NSMutableArray, NSOperationQueue, NSError;
...
@property (retain, nonatomic) HAPBLEAccessoryCache *accessoryCache; // ivar: _accessoryCache
...
@property (retain, nonatomic) NSMutableSet *discoveredAccessoryCharacteriticsPendingRead; // ivar: _discoveredAccessoryCharacteriticsPendingRead
@property (retain, nonatomic) _HAPBTLEDiscoveryContext *discoveryContext; // ivar: _discoveryContext
@property (nonatomic) NSInteger discoveryRetries; // ivar: _discoveryRetries
@property (nonatomic) unsigned char featureFlags; // ivar: _featureFlags
@property (readonly, nonatomic) BOOL hasBeenDiscovered; // ivar: _hasBeenDiscovered
@property (nonatomic) BOOL hasValidCache; // ivar: _hasValidCache
@property (readonly) NSUInteger hash;
@property (weak, nonatomic) HAPCharacteristic *identifyCharacteristic; // ivar: _identifyCharacteristic
@property (retain, nonatomic) NSMutableArray *operationsReceivedDuringConnectionStateChange; // ivar: _operationsReceivedDuringConnectionStateChange
...
-(BOOL)_shouldIgnoreRetryDiscoveryError:(id)arg0 ;
-(BOOL)_validateGeneratedBroadcastKey:(id)arg0 ;
-(BOOL)_validateProtocolInfo:(id)arg0 ;
-(BOOL)doesPeriodicSessionChecks;
-(BOOL)isBLELinkConnected;
-(BOOL)isHAPCharacteristic:(id)arg0 ;
-(BOOL)isReadyForOperation:(NSInteger)arg0 ;
...
-(void)_disconnectWithDisconnectionError:(id)arg0 completionHandler:(id)arg1 ;
...
-(void)_enqueueRequest:(id)arg0 shouldPrioritize:(BOOL)arg1 ;
...
-(void)_invokeOperationsReceivedDuringConnectionStateChangeWithError:(id)arg0 ;
...
-(void)_readPendingDiscoveredCharacteritiscTypesWithCompletion:(id)arg0 ;
...
-(void)_sendRequest:(id)arg0 shouldPrioritize:(BOOL)arg1 responseHandler:(id)arg2 ;
-(void)_suspendAllOperations;
-(void)_suspendConnectionIdleTimer;
-(void)_updateConnectionIdleTime:(unsigned char)arg0 ;
-(void)_updateLastKeyBagIdentityIndexFailingPVWithError:(id)arg0 ;
...
-(void)evaluateConnectionStateForOperation:(NSInteger)arg0 block:(id)arg1 ;
