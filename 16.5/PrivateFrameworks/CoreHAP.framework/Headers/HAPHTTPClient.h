...
@protocol HAPHTTPClientDebugDelegate, HMFLogging, HAPCoreUtilsHTTPClient, OS_dispatch_queue, HAPHTTPClientDelegate;
...
-(id)initWithDNSName:(id)arg0 port:(NSInteger)arg1 eventsEnabled:(BOOL)arg2 queue:(id)arg3 wakeAddress:(id)arg4 dependencyFactory:(id)arg5 ;
-(id)initWithDNSName:(id)arg0 queue:(id)arg1 ;
-(id)logIdentifier;
-(int)_initializeCoreUtilsHTTPClientWithPort:(NSInteger)arg0 withEventsEnabled:(BOOL)arg1 factory:(id)arg2 ;
