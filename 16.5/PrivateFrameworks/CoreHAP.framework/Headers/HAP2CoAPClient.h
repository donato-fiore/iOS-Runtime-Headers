...
@class NSMutableDictionary, NSError, NSMutableSet, NSMutableOrderedSet, NSString, NSThread;
...
-(id)initWithSocketAddress:(struct sockaddr *)arg0 withAccessoryName:(id)arg1 maxTransmitAttempts:(NSUInteger)arg2 initialACKTimeout:(CGFloat)arg3 ;
...
-(void)didFailToSendMessageInSession:(struct coap_session_t *)arg0 messageID:(NSUInteger)arg1 message:(struct coap_pdu_t *)arg2 reason:(NSUInteger)arg3 ;
-(void)didRegister;
-(void)didUnregister;
