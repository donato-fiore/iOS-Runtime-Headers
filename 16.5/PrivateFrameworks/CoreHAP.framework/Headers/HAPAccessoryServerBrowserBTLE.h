...
@property (retain, nonatomic) NSMapTable *identifiersWithReachabilityScanTuples; // ivar: _identifiersWithReachabilityScanTuples
...
-(id)_bleAccessoryServerTupleForIdentifier:(id)arg0 ;
...
-(void)_performTimedScanForIdentifiers:(id)arg0 forceScan:(BOOL)arg1 withCompletion:(id)arg2 ;
-(void)_powerOnCentralManagerWithCompletion:(id)arg0 ;
-(void)_probeReachabilityForAccessoryServersWithIdentifiers:(id)arg0 forceScan:(BOOL)arg1 withCompletion:(id)arg2 ;
...
-(void)pauseScans;
-(void)probeReachabilityForAccessoryServersWithIdentifiers:(id)arg0 forceScan:(BOOL)arg1 withCompletion:(id)arg2 ;
-(void)removeCachedAccessoryWithIdentifier:(id)arg0 ;
-(void)resetLastSeenForAccessoryServersWithIdentifiers:(id)arg0 ;
