...
@protocol HAPKeyStore, HMFDumpState, HMFLogging, HAPSystemKeychainStore, HAPSystemKeyCountProvider, OS_dispatch_queue;
...
@property (nonatomic) BOOL unitTest_enable_hh2; // ivar: _unitTest_enable_hh2
...
-(BOOL)saveAppleMediaAccessoryPairingIdentity:(id)arg0 ;
...
-(id)_allAccessoryPairingKeysIncludingHH2Key:(BOOL)arg0 ;
-(id)_auditKeychainItems:(id)arg0 managedAccessories:(id)arg1 ;
-(id)_chooseHH2KeyFromMultipleHH2Keys:(id)arg0 ;
...
-(id)getHH2ControllerKeyWithIdentifier:(id)arg0 ;
...
-(id)init;
-(id)pairingIdentityForAppleMediaAccessoryWithUUID:(id)arg0 ;
-(id)pairingIdentityFromKeychainItem:(id)arg0 ;
...
-(int)createHH2ControllerKeyWithUsername:(id)arg0 publicKey:(*id)arg1 secretKey:(*id)arg2 keyPair:(*id)arg3 username:(*id)arg4 ;
