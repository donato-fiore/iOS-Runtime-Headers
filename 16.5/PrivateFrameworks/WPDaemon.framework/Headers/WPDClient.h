...
@interface WPDClient : NSObject <WPXPCDaemonProtocol, WPDClientProtocol>
 ...
 {
    NSUInteger _wpDClientSignPostID;
}


@property CGFloat advTimeout; // ivar: _advTimeout
...
@property CGFloat scanTimeout; // ivar: _scanTimeout
...
-(void)overrideAdvTimeout:(CGFloat)arg0 ;
-(void)overrideScanTimeout:(CGFloat)arg0 ;
