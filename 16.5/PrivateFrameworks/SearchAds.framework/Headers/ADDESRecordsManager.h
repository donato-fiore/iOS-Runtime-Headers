...
-(id)_createRecordForAdData:(id)arg0 installed:(BOOL)arg1 isDupe:(BOOL)arg2 rerankingError:(id)arg3 ;
-(id)eventTypeToString:(NSInteger)arg0 ;
-(id)init;
-(void)createRecords:(id)arg0 placementType:(NSUInteger)arg1 firstOrganicId:(id)arg2 error:(id)arg3 ;
