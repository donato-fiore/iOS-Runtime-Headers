...
-(void)dealloc;
-(void)drawAbsoluteAnimationFrame:(CGFloat)arg0 destinationFrame:(struct CGRect )arg1 isFocused:(int)arg2 focusRingColor:(struct CGColor *)arg3 context:(struct CGContext *)arg4 ;
-(void)drawAnimationFrameMappedFrom0_1RangedValue:(CGFloat)arg0 destinationFrame:(struct CGRect )arg1 isFocused:(int)arg2 focusRingColor:(struct CGColor *)arg3 context:(struct CGContext *)arg4 ;
-(void)drawAnimationFrameMappedFrom0_1RangedValue:(CGFloat)arg0 destinationFrame:(struct CGRect )arg1 isFocused:(int)arg2 focusRingColor:(struct CGColor *)arg3 context:(struct CGContext *)arg4 effects:(id)arg5 ;
-(void)drawAsOnePartWithSlice:(int)arg0 inFrame:(struct CGRect )arg1 isFocused:(int)arg2 focusRingColor:(struct CGColor *)arg3 context:(struct CGContext *)arg4 effects:(id)arg5 ;
-(void)drawGradientInFrame:(struct CGRect )arg0 angle:(CGFloat)arg1 alpha:(CGFloat)arg2 operation:(int)arg3 isFocused:(int)arg4 focusRingColor:(struct CGColor *)arg5 keyAdjustment:(id)arg6 context:(struct CGContext *)arg7 effects:(id)arg8 ;
...
-(void)drawInFrame:(struct CGRect )arg0 alpha:(CGFloat)arg1 isFocused:(int)arg2 focusRingColor:(struct CGColor *)arg3 context:(struct CGContext *)arg4 ;
-(void)drawInFrame:(struct CGRect )arg0 alpha:(CGFloat)arg1 isFocused:(int)arg2 focusRingColor:(struct CGColor *)arg3 context:(struct CGContext *)arg4 effects:(id)arg5 ;
-(void)drawInFrame:(struct CGRect )arg0 alpha:(CGFloat)arg1 isFocused:(int)arg2 focusRingColor:(struct CGColor *)arg3 keyAdjustment:(id)arg4 context:(struct CGContext *)arg5 ;
-(void)drawInFrame:(struct CGRect )arg0 alpha:(CGFloat)arg1 operation:(int)arg2 isFocused:(int)arg3 focusRingColor:(struct CGColor *)arg4 context:(struct CGContext *)arg5 effects:(id)arg6 ;
-(void)drawInFrame:(struct CGRect )arg0 alpha:(CGFloat)arg1 operation:(int)arg2 isFocused:(int)arg3 focusRingColor:(struct CGColor *)arg4 keyAdjustment:(id)arg5 context:(struct CGContext *)arg6 ;
...
-(void)drawInFrame:(struct CGRect )arg0 isFocused:(int)arg1 focusRingColor:(struct CGColor *)arg2 context:(struct CGContext *)arg3 ;
-(void)drawInFrame:(struct CGRect )arg0 isFocused:(int)arg1 focusRingColor:(struct CGColor *)arg2 context:(struct CGContext *)arg3 effects:(id)arg4 ;
-(void)drawInFrame:(struct CGRect )arg0 owner:(id)arg1 userInfo:(id)arg2 context:(struct CGContext *)arg3 ;
-(void)drawMaskInFrame:(struct CGRect )arg0 alpha:(CGFloat)arg1 isFocused:(int)arg2 focusRingColor:(struct CGColor *)arg3 keyAdjustment:(id)arg4 context:(struct CGContext *)arg5 ;
-(void)drawMaskInFrame:(struct CGRect )arg0 alpha:(CGFloat)arg1 operation:(int)arg2 isFocused:(int)arg3 focusRingColor:(struct CGColor *)arg4 keyAdjustment:(id)arg5 context:(struct CGContext *)arg6 ;
...
-(void)drawPulseInFrame:(struct CGRect )arg0 pulseValue:(CGFloat)arg1 isFocused:(int)arg2 focusRingColor:(struct CGColor *)arg3 keyAdjustment:(id)arg4 context:(struct CGContext *)arg5 ;
...
-(void)drawSegmentInFrame:(struct CGRect )arg0 isFocused:(int)arg1 focusRingColor:(struct CGColor *)arg2 segmentType:(int)arg3 context:(struct CGContext *)arg4 effects:(id)arg5 ;
