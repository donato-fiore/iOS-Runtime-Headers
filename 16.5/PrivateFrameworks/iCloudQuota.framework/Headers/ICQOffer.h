...
@property (retain, nonatomic) NSURL *requestedServerUIURL; // ivar: _requestedServerUIURL
...
-(id)universalLink;
-(void)_updateRequestedServerUIURLWithURL:(id)arg0 ;
-(void)encodeWithCoder:(id)arg0 ;
-(void)updateOfferWithAction:(NSInteger)arg0 ;
