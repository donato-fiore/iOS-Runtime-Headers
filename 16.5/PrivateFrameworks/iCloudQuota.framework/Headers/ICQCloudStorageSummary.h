...
@property (copy, nonatomic) NSString *manageStorageActionButtonText; // ivar: _manageStorageActionButtonText
@property (retain, nonatomic) ICQManageStoragePageInfo *manageStoragePage; // ivar: _manageStoragePage
