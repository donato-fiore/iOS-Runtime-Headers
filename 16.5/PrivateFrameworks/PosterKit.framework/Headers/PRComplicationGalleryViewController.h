...
-(void)complicationGalleryItemView:(id)arg0 didBeginDragInteraction:(id)arg1 ;
-(void)complicationGalleryItemView:(id)arg0 didEndDragInteraction:(id)arg1 withOperation:(NSUInteger)arg2 ;
