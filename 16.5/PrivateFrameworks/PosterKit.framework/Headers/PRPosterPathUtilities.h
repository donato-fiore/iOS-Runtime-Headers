...
+(BOOL)removeOtherMetadataForPath:(id)arg0 error:(*id)arg1 ;
...
+(BOOL)storeOtherMetadataForPath:(id)arg0 otherMetadata:(id)arg1 error:(*id)arg2 ;
...
+(id)loadOtherMetadataForPath:(id)arg0 error:(*id)arg1 ;
