...
@property (copy, nonatomic) PRPosterMetadata *otherMetadata; // ivar: _otherMetadata
...
-(id)initWithTitleStyleConfiguration:(id)arg0 focusConfiguration:(id)arg1 complicationLayout:(id)arg2 renderingConfiguration:(id)arg3 homeScreenConfiguration:(id)arg4 colorVariationsConfiguration:(id)arg5 suggestionMetadata:(id)arg6 otherMetadata:(id)arg7 ;
-(id)mutableCopyWithZone:(struct _NSZone *)arg0 ;
-(id)persistenceIdentifierWithComplications:(BOOL)arg0 ;
