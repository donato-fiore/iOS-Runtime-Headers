...
@property (readonly, nonatomic) PRComplicationDescriptor *selectedComplication; // ivar: _selectedComplication
...
-(id)_inlineGalleryItemsForWidgetDescriptors:(id)arg0 iconImageHidden:(BOOL)arg1 isSuggestion:(BOOL)arg2 ;
-(id)_makeSectionHeaderRegistration;
-(id)_widgetHostViewControllerForDescriptor:(id)arg0 shownAlongsideIcon:(BOOL)arg1 ;
-(id)initWithSuggestionSet:(id)arg0 selectedComplication:(id)arg1 ;
