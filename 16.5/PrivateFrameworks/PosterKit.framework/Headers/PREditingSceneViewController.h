...
@class NSHashTable, NSMutableArray, UIView, NSString, NSMutableDictionary, NSArray, ATXComplicationSet, PRSServerPosterPath, UINavigationController, WFWidgetConfigurationViewController, BSUIVibrancyConfiguration;
...
#import "PREditingSessionModifications.h"
...
@property (retain, nonatomic) NSMutableDictionary *engagementCountsForViewedSuggestedComplications; // ivar: _engagementCountsForViewedSuggestedComplications
...
@property (copy, nonatomic) PREditingSessionModifications *modifications; // ivar: _modifications
...
@property (retain, nonatomic) UIView *saveIndicatorContainerView; // ivar: _saveIndicatorContainerView
...
@property (nonatomic, getter=isTornDown) BOOL tornDown; // ivar: _tornDown
...
-(BOOL)_posterUserInfo:(id)arg0 containsUserChangesFromPrevious:(id)arg1 ;
...
-(id)initWithProvider:(id)arg0 contents:(id)arg1 configurableOptions:(id)arg2 configuredProperties:(id)arg3 additionalInfo:(id)arg4 ;
