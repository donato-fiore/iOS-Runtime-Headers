...
-(Class)classForCoder;
-(id)_vibrancyConfigurationWithExtensionBundleURL:(id)arg0 luminanceReduced:(BOOL)arg1 ;
...
-(id)vibrancyConfigurationWithExtensionBundle:(id)arg0 luminanceReduced:(BOOL)arg1 ;
-(id)vibrancyConfigurationWithExtensionBundleURL:(id)arg0 ;
-(id)vibrancyConfigurationWithExtensionBundleURL:(id)arg0 luminanceReduced:(BOOL)arg1 ;
