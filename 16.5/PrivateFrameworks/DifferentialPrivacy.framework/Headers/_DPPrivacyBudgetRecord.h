...
@property (nonatomic) CGFloat cohortAggregateBalance; // ivar: _cohortAggregateBalance
...
-(id)initWithKey:(id)arg0 creationDate:(CGFloat)arg1 lastUpdate:(CGFloat)arg2 balance:(NSInteger)arg3 cohortAggregateBalance:(CGFloat)arg4 objectId:(id)arg5 ;
