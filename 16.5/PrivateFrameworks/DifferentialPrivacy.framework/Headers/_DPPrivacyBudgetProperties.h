...
@property (retain, nonatomic) NSNumber *intervalCohortAggregateBudgetValue; // ivar: _intervalCohortAggregateBudgetValue
...
+(id)budgetPropertiesWithName:(id)arg0 fromDictionary:(id)arg1 ;
