...
-(void)_showStatusChangeUIFor:(id)arg0 ;
-(void)_showWalrusChangeUI:(NSUInteger)arg0 ;
-(void)_showWebAccessChangeUI:(NSUInteger)arg0 ;
...
-(void)setWalrusStatus:(BOOL)arg0 ;
-(void)setWebAccessStatus:(BOOL)arg0 ;
-(void)showDisableWalrusUI:(id)arg0 ;
-(void)showDisableWebAccessUI:(id)arg0 ;
-(void)showEnableWalrusUI:(id)arg0 ;
-(void)showEnableWebAccessUI:(id)arg0 ;
