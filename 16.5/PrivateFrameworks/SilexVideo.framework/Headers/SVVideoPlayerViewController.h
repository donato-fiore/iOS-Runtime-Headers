...
@property (retain, nonatomic) SVPlaybackCoordinator *primaryContentCoordinator; // ivar: _primaryContentCoordinator
...
-(void)playbackCoordinatorFinishedLoadingVideoURL:(id)arg0 ;
