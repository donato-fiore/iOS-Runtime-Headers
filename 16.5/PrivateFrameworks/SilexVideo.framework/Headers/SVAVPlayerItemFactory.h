...
@property (readonly, nonatomic) CGFloat preferredForwardBufferDuration; // ivar: _preferredForwardBufferDuration
@property (readonly) Class superclass;


-(id)createPlayerItemWithURL:(id)arg0 ;
-(id)initWithAutomaticallyLoadedAssetKeys:(id)arg0 assetFactory:(id)arg1 preferredForwardBufferDuration:(CGFloat)arg2 ;
