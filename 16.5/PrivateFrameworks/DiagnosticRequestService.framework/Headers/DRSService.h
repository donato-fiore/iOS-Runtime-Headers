...
+(BOOL)shouldRunBackstopUpload:(id)arg0 currentDate:(id)arg1 errorOut:(*id)arg2 ;
+(BOOL)updateUploadSessionDateFromContainer:(id)arg0 toDate:(id)arg1 errorOut:(*id)arg2 ;
+(CGFloat)backstopInterval;
+(NSUInteger)uploadSessionUploadCapBytes;
+(id)_currentUploadSession_ON_MOC_QUEUE:(id)arg0 errorOut:(*id)arg1 ;
+(id)configurationDirectory;
+(id)databaseDirectory;
+(id)fileDirectory;
+(id)previousUploadSessionDateFromContainer:(id)arg0 errorOut:(*id)arg1 ;
+(id)sharedInstance;
...
-(BOOL)clearUploadSessionDate:(*id)arg0 ;
-(BOOL)shouldRunBackstopUpload:(*id)arg0 ;
-(BOOL)updateUploadSessionDate:(*id)arg0 ;
...
-(id)_permissiveXPCActivitCriteriaDict:(unsigned int)arg0 ;
-(id)_updateCKConfig:(id)arg0 ;
-(id)init;
-(unsigned int)_randomDelaySecWithCap:(unsigned int)arg0 ;
...
-(void)_configurePermissiveActivityCriteria:(id)arg0 delaySeconds:(unsigned int)arg1 ;
...
-(void)_handleCancelScheduledUploadRequest:(id)arg0 state:(id)arg1 ;
...
-(void)_handleUploadSchedulingRequest:(id)arg0 state:(id)arg1 ;
-(void)_postReceiptProcessingWork:(id)arg0 ;
-(void)_registerPermissiveExpeditedUploadXPCActivity:(unsigned int)arg0 ;
