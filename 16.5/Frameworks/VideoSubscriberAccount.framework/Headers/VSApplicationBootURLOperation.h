...
@property (nonatomic) BOOL skipSystemTrustVerification; // ivar: _skipSystemTrustVerification
...
-(BOOL)validateTrust:(struct __SecTrust *)arg0 ;
-(BOOL)verifyCertificateIsSystemTrustedWithTrust:(struct __SecTrust *)arg0 ;
