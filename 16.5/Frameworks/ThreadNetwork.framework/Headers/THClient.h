...
-(void)ctcsAddPreferredNetworkWithCompletionInternally:(id)arg0 extendedPANId:(id)arg1 borderAgentID:(id)arg2 ipV4NwSignature:(id)arg3 ipv6NwSignature:(id)arg4 wifiSSID:(id)arg5 wifiPassword:(id)arg6 completion:(id)arg7 ;
-(void)ctcsCleanKeychainThreadNetworksWithCompletion:(id)arg0 ;
-(void)ctcsCleanPreferredAndFrozenThreadNetworksWithCompletion:(id)arg0 ;
...
-(void)invalidate;
-(void)isPreferredNetworkAvailableWithCompletion:(id)arg0 ;
-(void)pingXPCService;
-(void)pingXPCServiceWithClientProxy:(id)arg0 completion:(id)arg1 ;
-(void)retrieveActiveDataSetRecordInternallyForExtendedPANID:(id)arg0 completion:(id)arg1 ;
-(void)retrieveAllActiveCredentials:(id)arg0 ;
...
-(void)updatePreferredCredentialsInternally:(id)arg0 ;
