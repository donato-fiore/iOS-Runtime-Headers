...
+(BOOL)hk_validateAppleIrregularRhythmNotificationsAlgorithmVersionMetadataValue:(id)arg0 error:(*id)arg1 ;
...
+(BOOL)hk_validateHeartRateRecoveryActivityTypeMetadataValue:(id)arg0 error:(*id)arg1 ;
+(BOOL)hk_validateHeartRateRecoveryTestTypeMetadataValue:(id)arg0 error:(*id)arg1 ;
...
+(BOOL)hk_validateUserMotionContextMetadataValue:(id)arg0 error:(*id)arg1 ;
