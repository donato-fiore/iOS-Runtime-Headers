...
@interface _HKBehavior : NSObject {
    _HKLazyLoader<_HKFeatureFlags *> _featureFlags;
    ...
    _HKLazyLoader<bool> _ontologyDatabaseFutureMigrationsEnabled;
    _HKLazyLoader<bool> _performsAutomaticUserDomainConceptProcessing;
    ...
    _HKLazyLoader<bool> _supportsPeriodicCloudSync;
    _HKLazyLoader<bool> _supportsVisionPrescription;
}


@property (copy, nonatomic) NSString *additionalEntitementForConnection; // ivar: _additionalEntitementForConnection
...
@property (nonatomic) NSUInteger fitnessMode;
...
@property (nonatomic) BOOL healthAppNotInstalled; // ivar: _healthAppNotInstalled
...
@property (nonatomic) BOOL supportsOntologyFeatureEvaluation; // ivar: _supportsOntologyFeatureEvaluation
