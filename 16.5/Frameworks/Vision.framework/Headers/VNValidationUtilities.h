...
+(BOOL)validateAsyncStatusResult:(id)arg0 error:(*id)arg1 ;
+(BOOL)validateAsyncStatusResults:(id)arg0 error:(*id)arg1 ;
+(BOOL)validateAsyncStatusState:(id)arg0 error:(*id)arg1 ;
