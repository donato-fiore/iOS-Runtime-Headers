...
@protocol VNWarningRecorder, VNSequencedRequestSupporting, VNClassCodeProviding, VNAsyncStatusProviding, NSCopying, OS_dispatch_queue, OS_dispatch_semaphore, MTLDevice;
...
@interface VNRequest : NSObject <VNWarningRecorder, VNSequencedRequestSupporting, VNClassCodeProviding, VNAsyncStatusProviding, NSCopying>

 {
    ...
    os_unfair_lock_s _asyncStatusLock;
...
@property (readonly, copy) VNAsyncStatus *asyncStatus; // ivar: _asyncStatus
...
@property (nonatomic) NSUInteger ioSurfaceMemoryPoolId;
...
+(BOOL)supportsAnyRevision:(NSUInteger)arg0 ;
...
-(BOOL)warmUpApplicableDetectorInSession:(id)arg0 error:(*id)arg1 ;
-(BOOL)warmUpSession:(id)arg0 error:(*id)arg1 ;
-(BOOL)willAcceptCachedResultsFromRequestWithConfiguration:(id)arg0 ;
-(Class)applicableDetectorClassForRevision:(NSUInteger)arg0 error:(*id)arg1 ;
-(Class)frameworkClass;
-(NSInteger)dependencyProcessingOrdinality;
-(NSUInteger)applicableRevisionForDependentRequest:(id)arg0 ;
-(NSUInteger)resolvedRevision;
-(id)_alignFacesInContext:(id)arg0 faces:(id)arg1 qosClass:(unsigned int)arg2 options:(id)arg3 error:(*id)arg4 ;
-(id)_defaultProcessingDevice;
-(id)applicableDetectorAndOptions:(*id)arg0 forRevision:(NSUInteger)arg1 loadedInSession:(id)arg2 error:(*id)arg3 ;
-(id)applicableDetectorTypeForRevision:(NSUInteger)arg0 error:(*id)arg1 ;
-(id)cancellerAndReturnError:(*id)arg0 ;
-(id)configuration;
-(id)copyWithZone:(struct _NSZone *)arg0 ;
-(id)detectFaceLandmarksInContext:(id)arg0 faces:(id)arg1 error:(*id)arg2 ;
-(id)detectFacesInContext:(id)arg0 error:(*id)arg1 ;
-(id)detectorProgressHandler:(SEL)arg0 ;
-(id)init;
...
// -(id)processFaceObservations:(id)arg0 revision:(NSUInteger)arg1 regionOfInterest:(struct CGRect )arg2 detectorType:(id)arg3 detectorOptions:(id)arg4 shouldAlignFaceBBox:(id)arg5 shouldRunDetectorBlock:(unk)arg6 context:(id)arg7 error:(unk)arg8  ;
...
-(void)cancel;
// -(void)categorizeFaceObservations:(id)arg0 shouldRunDetectorBlock:(id)arg1 facesThatNeedNoProcessing:(unk)arg2 facesThatNeedProcessing:(id)arg3 facesThatNeed2DLandmarks:(id)arg4  ;
-(void)copyStateOfRequest:(id)arg0 ;
-(void)performInContextAsync:(id)arg0 asyncDispatchQueue:(id)arg1 asyncDispatchGroup:(id)arg2 ;
