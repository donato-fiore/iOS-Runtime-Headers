...
-(void)gatherErrorsForUserInteractionForDomain:(id)arg0 action:(id)arg1 sourceItems:(id)arg2 destinationItem:(id)arg3 sourceItemKeysAllowList:(id)arg4 destinationItemKeysAllowList:(id)arg5 errors:(id)arg6 completionHandler:(id)arg7 ;
-(void)main;
