...
+(BOOL)checkLocationEligibilityForDomain:(id)arg0 error:(*id)arg1 ;
...
+(id)managerWithProviderIdentifier:(id)arg0 groupName:(id)arg1 domain:(id)arg2 ;
...
+(void)addDomain:(id)arg0 forProviderIdentifier:(id)arg1 persona:(id)arg2 completionHandler:(id)arg3 ;
...
+(void)importDomain:(id)arg0 forProviderIdentifier:(id)arg1 fromDirectoryAtURL:(id)arg2 completionHandler:(id)arg3 ;
...
+(void)removeDomain:(id)arg0 forProviderIdentifier:(id)arg1 completionHandler:(id)arg2 ;
+(void)removeDomain:(id)arg0 mode:(NSInteger)arg1 completionHandler:(id)arg2 ;
-(BOOL)isErrorSupportedForSignalResolved:(id)arg0 ;
-(BOOL)removeDomain:(id)arg0 options:(NSInteger)arg1 preservedLocation:(*id)arg2 error:(*id)arg3 ;
-(id)_connection;
...
-(void)getDomainsWithCompletionHandler:(id)arg0 ;
-(void)getServiceWithName:(id)arg0 itemIdentifier:(id)arg1 completionHandler:(id)arg2 ;
...
-(void)requestDownloadForItemWithIdentifier:(id)arg0 requestedRange:(struct _NSRange )arg1 completionHandler:(id)arg2 ;
-(void)requestDownloadForItemWithIdentifier:(id)arg0 requestedRange:(struct _NSRange )arg1 completionHandler:(id)arg2 ;
-(void)requestModificationOfFields:(NSUInteger)arg0 forItemWithIdentifier:(id)arg1 options:(NSUInteger)arg2 completionHandler:(id)arg3 ;
...
-(void)startDownloadingItemWithIdentifier:(id)arg0 requestedRange:(struct _NSRange )arg1 completionHandler:(id)arg2 ;
