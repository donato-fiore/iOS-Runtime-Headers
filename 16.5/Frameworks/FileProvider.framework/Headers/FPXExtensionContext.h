...
-(id)createTempThumbnailURLForVersion:(id)arg0 itemIdentifier:(id)arg1 isFromData:(BOOL)arg2 ;
...
-(id)fetchContentsForItemWithID:(id)arg0 version:(id)arg1 request:(id)arg2 estimatedItemSize:(NSInteger)arg3 isSymlink:(BOOL)arg4 extent:(id)arg5 alignment:(NSUInteger)arg6 options:(NSUInteger)arg7 completionHandler:(id)arg8 ;
-(id)fetchContentsForItemWithID:(id)arg0 version:(id)arg1 usingExistingContentsAtURL:(id)arg2 existingVersion:(id)arg3 request:(id)arg4 estimatedItemSize:(NSInteger)arg5 isSymlink:(BOOL)arg6 completionHandler:(id)arg7 ;
...
-(void)didUpdateAlternateContentsDocumentForDocumentWithItem:(id)arg0 completionHandler:(id)arg1 ;
...
-(void)listRemoteVersionsWithSettings:(id)arg0 observer:(id)arg1 request:(id)arg2 completionHandler:(id)arg3 ;
...
-(void)sendBlockedProcessNamesUpdateWithCompletionHandler:(id)arg0 ;
...
-(void)startOperation:(id)arg0 toFetchThumbnailsWithDictionary:(id)arg1 size:(struct CGSize )arg2 completionHandler:(id)arg3 ;
