...
@class NSString, NSOperationQueue, NSOperation, NSURL, CSSearchableIndex, NSData;
...
+(id)indexerPropertyOfClass:(Class)arg0 forKey:(id)arg1 supportURL:(id)arg2 ;
-(id)_fetchClientStateIfNeeded;
-(id)initWithDomain:(id)arg0 providerDomain:(id)arg1 log:(id)arg2 supportURL:(id)arg3 ;
