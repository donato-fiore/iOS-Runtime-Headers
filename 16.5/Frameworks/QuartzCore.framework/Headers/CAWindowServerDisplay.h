...
@protocol CABrightnessControl, CAPresetTransaction, CAPixelConstraints;
...
@property (readonly) NSInteger frameInfoCallbackVersion;
...
@property (readonly) NSUInteger maxLayerBandwidth;
...
@property (readonly) CGSize touchScales;
...
-(void)postSyncNotification:(id)arg0 payload:(id)arg1 ;
...
-(void)registerForSyncNotifications:(id)arg0 withBlock:(id)arg1 ;
...
-(void)setApertureOffset:(CGFloat)arg0 ;
...
-(void)setFilteredAmbient:(float)arg0 ;
-(void)setGamutRemapConfigPlanes:(struct ? *)arg0 planeCount:(NSUInteger)arg1 XYZToYuvCoefficients:(*float)arg2 YuvToXYZCoefficients:(*float)arg3 ;
-(void)setGamutRemapMatrices:(*float)arg0 count:(NSUInteger)arg1 ;
...
-(void)setSyncNotificationQueue:(id)arg0 ;
-(void)setUserAdjustment:(*float)arg0 scale:(float)arg1 ;
-(void)setWhitePointMatrix:(struct ? *)arg0 scale:(float)arg1 ;
