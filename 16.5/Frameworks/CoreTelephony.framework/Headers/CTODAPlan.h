...
@property (readonly, nonatomic) BOOL inBuddy; // ivar: _inBuddy
...
-(id)initWithSetupUrl:(id)arg0 mcc:(id)arg1 mnc:(id)arg2 gid1:(id)arg3 gid2:(id)arg4 handoffToken:(id)arg5 inBuddy:(BOOL)arg6 ;
