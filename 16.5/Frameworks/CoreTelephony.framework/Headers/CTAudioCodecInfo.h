...
@property (nonatomic) NSUInteger i2SClockRate; // ivar: _i2SClockRate
...
-(id)initWithCallId:(NSUInteger)arg0 codec:(NSInteger)arg1 amrMode:(NSUInteger)arg2 evsBandwidth:(NSInteger)arg3 evsBitrate:(NSInteger)arg4 sampleRate:(NSUInteger)arg5 i2SClockRate:(NSUInteger)arg6 ;
