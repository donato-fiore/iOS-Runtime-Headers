...
@property (nonatomic) NSUInteger presentationContext;
...
-(id)updatedConversationForConversationState:(id)arg0 ;
...
-(void)stageMediaItem:(id)arg0 skipShelf:(BOOL)arg1 forceStage:(BOOL)arg2 completionHandler:(id)arg3 ;
