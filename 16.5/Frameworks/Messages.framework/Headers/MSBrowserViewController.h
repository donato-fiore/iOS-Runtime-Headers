...
#ifndef MSBROWSERVIEWCONTROLLER_H
#define MSBROWSERVIEWCONTROLLER_H

@class UIViewController, NSNumber, IMBalloonPlugin, IMBalloonPluginDataSource, CKBrowserDragManager, NSData, NSString, UIView, NSArray;
...
-(void)setPhotoBrowserSendDelegate:(id)arg0 ;
