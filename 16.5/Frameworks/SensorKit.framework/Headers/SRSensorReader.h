...
@property (copy) NSString *canonicalSensor; // ivar: _canonicalSensor
...
@property (retain) NSString *requestedSensor; // ivar: _requestedSensor
...
+(id)new;
+(id)remoteInterface;
+(void)_requestAuthorizationMigrationForSensors:(id)arg0 completion:(id)arg1 ;
...
-(BOOL)_updateAuthorizationStatusWithAuthorizedServices:(id)arg0 deniedServices:(id)arg1 dataCollectionEnabled:(BOOL)arg2 onboardingCompleted:(BOOL)arg3 lastModifiedTimes:(id)arg4 forBundleIdentifier:(id)arg5 ;
-(BOOL)_updateAuthorizationStatusWithAuthorizedServices:(id)arg0 deniedServices:(id)arg1 dataCollectionEnabled:(BOOL)arg2 onboardingCompleted:(BOOL)arg3 lastModifiedTimes:(id)arg4 forBundleIdentifier:(id)arg5 previousAuthorizationStatus:(NSInteger)arg6 ;
...
-(void)dealloc;
-(void)didChangeAuthorizationStatus:(NSInteger)arg0 ;
