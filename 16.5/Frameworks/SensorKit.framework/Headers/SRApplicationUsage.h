...
@property (retain) NSMutableArray *mutableSupplementalCategories; // ivar: _mutableSupplementalCategories
@property (retain) NSMutableArray *mutableTextInputSessions; // ivar: _mutableTextInputSessions
@property (nonatomic) CGFloat relativeStartTime; // ivar: _relativeStartTime
...
+(id)applicationUsageWithBundleIdentifier:(id)arg0 reportApplicationIdentifier:(id)arg1 totalUsageTime:(CGFloat)arg2 relativeStartTime:(CGFloat)arg3 ;
