...
@class NSArray, NSXPCConnection, NSString, NSCache, NSDictionary;
...
@property (retain, nonatomic) NSCache *eligibilityCache; // ivar: _eligibilityCache
...
@property (nonatomic) CGFloat roundingInterval; // ivar: _roundingInterval
...
-(void)bundleEligibility:(id)arg0 completion:(id)arg1 ;
