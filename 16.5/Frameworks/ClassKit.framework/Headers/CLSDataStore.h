...
+(Class)endpointClass;
+(id)currentUser;
+(id)handoutGraphFromHandout:(id)arg0 ;
+(id)handoutSubgraphContainingAsset:(id)arg0 ;
+(id)newDatastore;
+(id)shared;
...
-(void)cloudKitThumbnailUrlSuitableForOpeningForAsset:(id)arg0 completion:(id)arg1 ;
-(void)cloudKitUrlSuitableForOpeningForAsset:(id)arg0 completion:(id)arg1 ;
-(void)cloudKitUrlSuitableForStreamingAsset:(id)arg0 completion:(id)arg1 ;
...
-(void)deleteBackingStoreForAsset:(id)arg0 completion:(id)arg1 ;
...
-(void)fetchAppBasedAssignmentUsage:(id)arg0 completion:(id)arg1 ;
...
-(void)relayRequestWithData:(id)arg0 requestType:(NSUInteger)arg1 completion:(id)arg2 ;
...
-(void)saveInsightEvents:(id)arg0 completion:(id)arg1 ;
...
-(void)setTestSharedDataStore:(id)arg0 ;
...
-(void)startActivity:(id)arg0 activityType:(int)arg1 bundleID:(id)arg2 completion:(id)arg3 ;
-(void)startActivityFailed:(id)arg0 activityType:(int)arg1 completion:(id)arg2 ;
...
-(void)unlock;
-(void)urlSuitableForOpeningForExpectedURL:(id)arg0 itemID:(id)arg1 ownerName:(id)arg2 zoneName:(id)arg3 completion:(id)arg4 ;
