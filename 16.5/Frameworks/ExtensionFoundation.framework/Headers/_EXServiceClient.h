...
@property (retain, nonatomic) NSXPCConnection *tccProxyConnection; // ivar: _tccProxyConnection


+(id)sharedInstance;
-(BOOL)photoServiceAuthorizationStatusForExtensionUUID:(id)arg0 error:(*id)arg1 ;
-(id)_activeQueryForQuery:(id)arg0 ;
-(id)_init;
-(id)extensionsWithQueries:(id)arg0 ;
-(id)launchWithConfiguration:(id)arg0 error:(*id)arg1 ;
-(id)resultWithQuery:(id)arg0 ;
...
-(void)fetchResultWithQuery:(id)arg0 completionHandler:(id)arg1 ;
