...
-(void)invalidateLaunchAssertionsForExtensionAuditToken:(struct ? )arg0 reply:(id)arg1 ;
-(void)photoServiceAuthorizationStatusForExtensionUUID:(id)arg0 completion:(id)arg1 ;
