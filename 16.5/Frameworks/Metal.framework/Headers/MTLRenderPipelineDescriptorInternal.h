...
-(NSUInteger)pipelineMemoryLength;
...
-(struct ? )maxPipelineChildren;
-(struct ? )meshThreadsPerThreadgroup;
-(struct ? )objectThreadsPerThreadgroup;
...
-(void)setMaxPipelineChildren:(struct ? )arg0 ;
-(void)setMaxTessellationFactor:(NSUInteger)arg0 ;
-(void)setMaxTotalThreadsPerMeshThreadgroup:(NSUInteger)arg0 ;
-(void)setMaxTotalThreadsPerObjectThreadgroup:(NSUInteger)arg0 ;
-(void)setMaxVertexAmplificationCount:(NSUInteger)arg0 ;
-(void)setMaxVertexCallStackDepth:(NSUInteger)arg0 ;
-(void)setMeshFunction:(id)arg0 ;
-(void)setMeshLinkedFunctions:(id)arg0 ;
-(void)setMeshPreloadedLibraries:(id)arg0 ;
-(void)setMeshThreadgroupSizeIsMultipleOfThreadExecutionWidth:(BOOL)arg0 ;
-(void)setMeshThreadsPerThreadgroup:(struct ? )arg0 ;
-(void)setNeedsCustomBorderColorSamplers:(BOOL)arg0 ;
-(void)setObjectFunction:(id)arg0 ;
-(void)setObjectLinkedFunctions:(id)arg0 ;
-(void)setObjectPreloadedLibraries:(id)arg0 ;
-(void)setObjectThreadgroupSizeIsMultipleOfThreadExecutionWidth:(BOOL)arg0 ;
-(void)setObjectThreadsPerThreadgroup:(struct ? )arg0 ;
-(void)setOpenGLModeEnabled:(BOOL)arg0 ;
-(void)setPipelineLibrary:(id)arg0 ;
-(void)setPipelineMemoryLength:(NSUInteger)arg0 ;
