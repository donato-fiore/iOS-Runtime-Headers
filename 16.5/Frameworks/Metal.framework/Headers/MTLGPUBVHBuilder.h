...
-(id)getPipeline:(NSUInteger)arg0 descriptor:(id)arg1 createLeafNodes:(BOOL)arg2 enforceMaxDepth:(BOOL)arg3 ;
-(id)getPipeline:(NSUInteger)arg0 descriptor:(id)arg1 threadgroupSize:(NSUInteger)arg2 ;
-(id)getPipeline:(NSUInteger)arg0 descriptor:(id)arg1 threadgroupSize:(NSUInteger)arg2 createLeafNodes:(BOOL)arg3 enforceMaxDepth:(BOOL)arg4 ;
-(id)getPipeline:(NSUInteger)arg0 descriptor:(id)arg1 threadgroupSize:(NSUInteger)arg2 createLeafNodes:(BOOL)arg3 enforceMaxDepth:(BOOL)arg4 outExecutionWidth:(*NSUInteger)arg5 ;
...
-(id)newIndirectBufferWithCapacity:(NSUInteger)arg0 withRetainedResources:(id)arg1 indirectBufferStride:(*NSUInteger)arg2 ;
...
-(void)dispatchIndirect:(id)arg0 counterBuffer:(id)arg1 counterBufferOffset:(NSUInteger)arg2 counterIndex:(NSUInteger)arg3 encoder:(id)arg4 ;
-(void)dispatchIndirect:(id)arg0 counterBuffer:(id)arg1 counterBufferOffset:(NSUInteger)arg2 counterIndex:(NSUInteger)arg3 threadgroupSize:(NSUInteger)arg4 encoder:(id)arg5 ;
-(void)dispatchIndirect:(id)arg0 counterBuffer:(id)arg1 counterBufferOffset:(NSUInteger)arg2 encoder:(id)arg3 ;
-(void)dispatchIndirect:(id)arg0 counterBuffer:(id)arg1 counterBufferOffset:(NSUInteger)arg2 threadgroupSize:(NSUInteger)arg3 encoder:(id)arg4 ;
...
-(void)fastIndirectGPUMemcpyWithEncoder:(id)arg0 indirectBuffer:(id)arg1 indirectBufferOffset:(NSUInteger)arg2 srcBuffer:(id)arg3 srcBufferOffset:(NSUInteger)arg4 dstBuffer:(id)arg5 dstBufferOffset:(NSUInteger)arg6 lengthBuffer:(id)arg7 lengthOffset:(NSUInteger)arg8 retainedResources:(id)arg9 ;
-(void)getBoundingBoxFragmentsWithEncoder:(id)arg0 descriptor:(id)arg1 outputBuffer:(id)arg2 outputBufferOffset:(NSUInteger)arg3 primitiveCountBuffer:(id)arg4 primitiveCountBufferOffset:(NSUInteger)arg5 fragmentBuffer:(id)arg6 fragmentBufferOffset:(NSUInteger)arg7 fragmentCountBuffer:(id)arg8 fragmentCountBufferOffset:(NSUInteger)arg9 boundsMinBuffer:(id)arg10 boundsMinBufferOffset:(NSUInteger)arg11 boundsMaxBuffer:(id)arg12 boundsMaxBufferOffset:(NSUInteger)arg13 boundsEndMinBuffer:(id)arg14 boundsEndMinBufferOffset:(NSUInteger)arg15 boundsEndMaxBuffer:(id)arg16 boundsEndMaxBufferOffset:(NSUInteger)arg17 boundsEndTimeBuffer:(id)arg18 boundsEndTimeBufferOffset:(NSUInteger)arg19 boundsStartTimeBuffer:(id)arg20 boundsStartTimeBufferOffset:(NSUInteger)arg21 resourceBuffer:(id)arg22 ;
...
-(void)getPolygonFragmentsWithEncoder:(id)arg0 descriptor:(id)arg1 outputBuffer:(id)arg2 outputBufferOffset:(NSUInteger)arg3 primitiveCountBuffer:(id)arg4 primitiveCountBufferOffset:(NSUInteger)arg5 fragmentBuffer:(id)arg6 fragmentBufferOffset:(NSUInteger)arg7 fragmentCountBuffer:(id)arg8 fragmentCountBufferOffset:(NSUInteger)arg9 boundsMinBuffer:(id)arg10 boundsMinBufferOffset:(NSUInteger)arg11 boundsMaxBuffer:(id)arg12 boundsMaxBufferOffset:(NSUInteger)arg13 boundsEndMinBuffer:(id)arg14 boundsEndMinBufferOffset:(NSUInteger)arg15 boundsEndMaxBuffer:(id)arg16 boundsEndMaxBufferOffset:(NSUInteger)arg17 boundsEndTimeBuffer:(id)arg18 boundsEndTimeBufferOffset:(NSUInteger)arg19 boundsStartTimeBuffer:(id)arg20 boundsStartTimeBufferOffset:(NSUInteger)arg21 resourceBuffer:(id)arg22 ;
-(void)initPipelinesWithDevice:(id)arg0 ;
-(void)initializeCounterBuffer:(id)arg0 counterBuffer:(id)arg1 counterBufferOffset:(NSUInteger)arg2 ;
...
-(void)setCounters:(struct CounterValue *)arg0 numCounters:(NSUInteger)arg1 encoder:(id)arg2 ;
