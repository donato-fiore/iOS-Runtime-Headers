...
@interface MTLCompileOptionsInternal : MTLCompileOptions {
    ...
    NSInteger _compileSymbolVisibility;
...
-(BOOL)tracingEnabled;
-(NSInteger)compileSymbolVisibility;
...
-(void)setAllowReferencingUndefinedSymbols:(BOOL)arg0 ;
-(void)setCompileSymbolVisibility:(NSInteger)arg0 ;
