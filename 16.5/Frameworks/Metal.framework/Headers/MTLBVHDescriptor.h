...
@property (nonatomic) NSUInteger maxPrimitivesPerInnerNode; // ivar: _maxPrimitivesPerInnerNode
...
@property (nonatomic) NSUInteger minPrimitivesPerInnerNode; // ivar: _minPrimitivesPerInnerNode
