...
@class MTLObjectWithLabel, NSError, NSDictionary, NSMutableDictionary, NSMutableArray, NSArray, NSString;
@protocol MTLCommandEncoder, MTLBuffer, MTLCommandQueue, MTLDeadlineProfile;
...
@property (readonly, retain) NSObject<MTLDeadlineProfile> *deadlineProfile; // ivar: _deadlineProfile
