...
-(id)lookupBinaryInArchives:(id)arg0 legacyHash:(struct ? *)arg1 alreadyStored:(*BOOL)arg2 ;
...
-(void)addCompiledOutput:(id)arg0 importedSymbols:(id)arg1 importedLibraries:(id)arg2 hashKey:(struct MTLMultiHashKey *)arg3 type:(int)arg4 functionCache:(struct MultiLevelPipelineCache *)arg5 ;
