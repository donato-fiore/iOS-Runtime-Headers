...
@protocol NSSQLModelProvider, NSCoreDataKeyedArchivingDelegate, OS_dispatch_semaphore;
...
-(id)newObjectIDForEntity:(id)arg0 pk:(NSInteger)arg1 ;
...
-(id)sqlCore;
-(id)type;
-(void)_prepareStoreForRemovalFromCoordinator:(id)arg0 ;
