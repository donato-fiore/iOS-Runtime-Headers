...
@class NSString, CKDatabaseSubscription, CKContainer, CKDatabase, CKScheduler, CKNotificationListener, NSError, CKRecordID, CKSystemSharingUIObserver;
...
+(BOOL)printEventsInStores:(id)arg0 startingAt:(id)arg1 endingAt:(id)arg2 error:(*id)arg3 ;
+(BOOL)traceObjectMatchingRecordName:(id)arg0 inStores:(id)arg1 startingAt:(id)arg2 endingAt:(id)arg3 error:(*id)arg4 ;
+(BOOL)traceObjectMatchingValue:(id)arg0 atKeyPath:(id)arg1 inStores:(id)arg2 startingAt:(id)arg3 endingAt:(id)arg4 error:(*id)arg5 ;
