...
#ifndef MPSGRAPHREINTERPRETCASTOP_H
#define MPSGRAPHREINTERPRETCASTOP_H
...
-(id)initWithGraph:(id)arg0 inputTensors:(id)arg1 controlDependencies:(id)arg2 destType:(unsigned int)arg3 name:(id)arg4 ;
