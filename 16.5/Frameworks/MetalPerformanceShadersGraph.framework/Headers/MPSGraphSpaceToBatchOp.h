...
#ifndef MPSGRAPHSPACETOBATCHOP_H
#define MPSGRAPHSPACETOBATCHOP_H
...
-(id)initWithGraph:(id)arg0 inputTensors:(id)arg1 controlDependencies:(id)arg2 usePixelShuffleOrder:(BOOL)arg3 name:(id)arg4 ;
