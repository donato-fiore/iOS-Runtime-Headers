...
@protocol AXChart, AXCustomContentProvider, AXContainerDataSeries, _TtP7SwiftUI28PlatformAccessibilityElement_;
...
@property (nonatomic, readonly) NSObject<_TtP7SwiftUI28PlatformAccessibilityElement_> *_accessibilityNodeRepresentedElement;
...
-(id)accessibilityCustomAttribute:(id)arg0 ;
-(id)accessibilityURL;
-(id)init;
