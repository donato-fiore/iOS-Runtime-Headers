...
@class UIViewController, UISegmentedControl, UICollectionView, NSMutableIndexSet, NSMutableArray, UIBarButtonItem, UIButton, NSString;
...
@property (nonatomic) BOOL _includeSysdiagnose; // ivar: __includeSysdiagnose
...
@property (retain, nonatomic) UIButton *_sysdiagnoseButton; // ivar: __sysdiagnoseButton
