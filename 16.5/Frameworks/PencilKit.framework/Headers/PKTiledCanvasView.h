...
@class UIView, NSMutableArray, UITouch, UIColor, NSUUID, NSString, CADisplayLink, UIGestureRecognizer<PKDrawingGestureRecognizerProtocol>, UIImage, NSMutableSet;
...
@interface PKTiledCanvasView : UIView <PKDrawingGestureRecognizerDelegate, PKControllerDelegate, PKShapeDrawingControllerDelegate, PKDrawingGestureTarget>

 {
    ...
    id *_combineTimeoutBlock;
    BOOL _isCombiningStrokes;
    NSUInteger _combiningStrokesCount;
...
@property (nonatomic) BOOL captureLiveData; // ivar: _captureLiveData
...
@property (nonatomic) BOOL isUnderBlendedContent; // ivar: _isUnderBlendedContent
@property (retain, nonatomic) PKLinedPaper *linedPaper; // ivar: _linedPaper
...
@property (readonly, nonatomic) PKMetalConfig *metalConfig; // ivar: _metalConfig
...
@property (nonatomic) NSUInteger resourceCacheSize; // ivar: _resourceCacheSize
...
@property (nonatomic) BOOL useLuminanceColorFilter; // ivar: _useLuminanceColorFilter
...
+(void)initialize;
+(void)prewarmFutureCanvasesIfNecessarySecureRendering:(BOOL)arg0 prewarmSharedResourceHandler:(BOOL)arg1 ;
+(void)setupDefaults;
-(BOOL)_isCombiningStrokes;
...
-(BOOL)drawingGestureRecognizer:(id)arg0 shouldDelayDrawingBeganWithTouch:(id)arg1 ;
...
-(void)_drawingBegan:(id)arg0 inputPoint:(struct ? )arg1 locationInView:(struct CGPoint )arg2 forPreview:(BOOL)arg3 disableDetachedRendering:(BOOL)arg4 ;
-(void)_drawingDisplay:(CGFloat)arg0 ;
-(void)_drawingEnded:(id)arg0 ;
...
-(void)_previewDrawingBegan:(struct ? )arg0 tiledViewLocation:(struct CGPoint )arg1 disableDetachedRendering:(BOOL)arg2 ;
-(void)_previewDrawingEnded;
-(void)_previewDrawingMoved:(struct ? )arg0 ;
...
-(void)didEndLiveInteractionWithStrokes:(id)arg0 drawing:(id)arg1 cancelled:(BOOL)arg2 forPreview:(BOOL)arg3 ;
-(void)drawingBegan:(id)arg0 ;
-(void)drawingCancelledForPreview:(BOOL)arg0 ;
