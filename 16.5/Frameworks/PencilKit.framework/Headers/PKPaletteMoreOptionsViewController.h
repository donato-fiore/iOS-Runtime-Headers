...
@property (retain, nonatomic) PKPaletteOptionSwitchCell *hoverPreviewCell; // ivar: _hoverPreviewCell
@property (nonatomic) BOOL hoverPreviewOptionVisible; // ivar: _hoverPreviewOptionVisible
@property (nonatomic) BOOL isFingerDrawsOn; // ivar: _isFingerDrawsOn
@property (nonatomic) BOOL isHoverPreviewOn; // ivar: _isHoverPreviewOn
