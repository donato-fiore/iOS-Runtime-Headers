...
@interface PKStrokeGenerator : NSObject <PKInputProvider>

 {
    ...
    vector<PKInputPoint, std::allocator<PKInputPoint>> _drawPoints;
    ...
    vector<PKInputPoint, std::allocator<PKInputPoint>> _updatedDrawPoints;
...
@property (nonatomic) *void animationFilter; // ivar: _animationFilter
...
@property (nonatomic) *void directionAngleFilter; // ivar: _directionAngleFilter
...
@property (nonatomic) *void propertySmoother; // ivar: _propertySmoother
...
-(id)strokeFromInputPoints:(*void)arg0 inputType:(NSInteger)arg1 ink:(id)arg2 inputScale:(CGFloat)arg3 randomSeed:(unsigned int)arg4 strokeClass:(Class)arg5 ;
...
-(struct _PKStrokePoint )_latestStrokePoint;
