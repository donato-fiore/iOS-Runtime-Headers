...
+(struct CGRect )_calculateBounds:(id)arg0 transform:(struct CGAffineTransform )arg1 ink:(id)arg2 inkTransform:(struct CGAffineTransform )arg3 strokePath:(id)arg4 ;
...
// +(void)_consumeRenderVertexes:(id)arg0 ink:(unk)arg1 inkTransform:(id)arg2 strokePath:(struct CGAffineTransform )arg3  ;
...
-(void)_appendPointsOfInterestForSelection:(*void)arg0 step:(CGFloat)arg1 ;
...
-(void)_setRenderGroupID:(id)arg0 ;
