...
-(BOOL)deltaContainsNewInfo:(id)arg0 ;
-(BOOL)inflight;
...
-(id)initWithDataPoints:(struct PKStrokePathPointsPrivate )arg0 immutableCount:(NSUInteger)arg1 inputType:(NSInteger)arg2 UUID:(id)arg3 didValidateTimestamps:(BOOL)arg4 hasValidTimestampData:(BOOL)arg5 cachedMaxWidth:(CGFloat)arg6 unknownFields:(struct shared_ptr<PKProtobufUnknownFields> )arg7 ;
