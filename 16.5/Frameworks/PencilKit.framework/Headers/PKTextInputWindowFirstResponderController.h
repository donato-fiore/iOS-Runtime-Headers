...
-(void)_handleTextInputSourceDidChange:(id)arg0 ;
-(void)_textInputResponderDidChangeNotificationHandler:(id)arg0 ;
-(void)_updateFirstResponder:(id)arg0 isVisible:(BOOL)arg1 sendDelegateCallback:(BOOL)arg2 ;
-(void)dealloc;
...
-(void)updateFirstResponderFromWindowScene:(id)arg0 sendDelegateCallback:(BOOL)arg1 ;
