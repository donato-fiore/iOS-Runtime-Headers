...
@property (nonatomic) BOOL forceStrong; // ivar: _forceStrong
...
@property (readonly, nonatomic) BOOL isCursorTemporarilyStrong; // ivar: _isCursorTemporarilyStrong
...
-(void)makeCursorTemporarilyStrongWithTimeout:(CGFloat)arg0 ;
-(void)makeCursorWeak;
