...
@class UIView, MTMaterialView, UIScrollView, NSString, NSLayoutConstraint, UIViewController;
@protocol PKPaletteViewStateSubject, PKPaletteHostViewDelegate, PKPaletteHostingWindowSceneObserver, PKPalettePopoverPresenting, PKPalettePopoverDismissing, PKPaletteViewDelegate, PKPaletteViewHoverDelegate, PKPaletteViewInternalDelegate, PKPaletteViewHosting;
...
@property (nonatomic) BOOL draggingEnabled; // ivar: _draggingEnabled
@property (nonatomic) NSDirectionalEdgeInsets edgeInsetsInCompactSize; // ivar: _edgeInsetsInCompactSize
@property (readonly) NSUInteger hash;
@property (weak, nonatomic) NSObject<PKPaletteViewHoverDelegate> *hoverDelegate; // ivar: _hoverDelegate
