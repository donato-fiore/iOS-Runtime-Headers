...
@protocol UIGestureRecognizerDelegate, UIScrollViewDelegate, PKPaletteViewInternalDelegate, UIPopoverPresentationControllerDelegate, PKPalettePencilInteractionFeedbackHostViewDelegate, PKPaletteTransitionDelegate, PKPaletteViewHosting, PKPaletteHostViewDelegate;
...
@property (nonatomic) BOOL paletteScrollGestureShouldScroll; // ivar: _paletteScrollGestureShouldScroll
...
@property (nonatomic) BOOL panGestureDidStartInPaletteScrollView; // ivar: _panGestureDidStartInPaletteScrollView
@property (retain, nonatomic) UIPanGestureRecognizer *panGestureRecognizer; // ivar: _panGestureRecognizer
@property (nonatomic) BOOL panGestureShouldDragPaletteView; // ivar: _panGestureShouldDragPaletteView
...
@property (readonly, nonatomic) PKPaletteTooltipPresentationHandle *tooltipPresentationHandle; // ivar: _tooltipPresentationHandle
