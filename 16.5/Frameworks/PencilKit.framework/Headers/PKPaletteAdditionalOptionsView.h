...
@property (retain, nonatomic) UIStackView *plusEllipsisStackView; // ivar: _plusEllipsisStackView
...
@property (readonly, nonatomic) PKPaletteButton *shapeButton; // ivar: _shapeButton
@property (retain, nonatomic) NSLayoutConstraint *shapeButtonHeightConstraint; // ivar: _shapeButtonHeightConstraint
@property (retain, nonatomic) NSLayoutConstraint *shapeButtonWidthConstraint; // ivar: _shapeButtonWidthConstraint
@property (nonatomic) BOOL shouldHideHoverPreviewToggle; // ivar: _shouldHideHoverPreviewToggle
...
@property (retain, nonatomic) PKPaletteButton *textButton; // ivar: _textButton
@property (retain, nonatomic) NSLayoutConstraint *textButtonHeightConstraint; // ivar: _textButtonHeightConstraint
@property (retain, nonatomic) NSLayoutConstraint *textButtonWidthConstraint; // ivar: _textButtonWidthConstraint
@property (retain, nonatomic) UIStackView *textShapeStackView; // ivar: _textShapeStackView
...
-(void)moreOptionsViewControllerDidToggleHoverPreview:(id)arg0 ;
