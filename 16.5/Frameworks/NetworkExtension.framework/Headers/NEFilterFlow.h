...
@property BOOL inputComplete; // ivar: _inputComplete
@property NSUInteger outBytes; // ivar: _outBytes
@property BOOL outputComplete; // ivar: _outputComplete
...
@property (retain) NSData *sourceProcessAuditToken; // ivar: _sourceProcessAuditToken
