...
@property (retain, nonatomic) NSCache *pendingClearCache; // ivar: _pendingClearCache
@property (retain, nonatomic) NSCache *pendingEventCache; // ivar: _pendingEventCache
@property (retain, nonatomic) NSCache *supplementaryURLToCollaborationHighlightCache; // ivar: _supplementaryURLToCollaborationHighlightCache
...
-(id)_fetchHighlightFromAnyCacheForURL:(id)arg0 ;
...
-(void)_getCollaborationHighlightForShareURL:(id)arg0 fileURL:(id)arg1 completionHandler:(id)arg2 ;
...
-(void)_processClearNoticesFor:(id)arg0 ;
...
-(void)clearNoticesForHighlight:(id)arg0 ;
