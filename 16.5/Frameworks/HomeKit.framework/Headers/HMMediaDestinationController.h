...
-(id)initWithIdentifier:(id)arg0 destinationIdentifier:(id)arg1 supportedOptions:(NSUInteger)arg2 availableDestinationIdentifiers:(id)arg3 ;
-(id)logIdentifier;
...
-(void)mergeSupportedOptionsWithNewController:(id)arg0 ;
