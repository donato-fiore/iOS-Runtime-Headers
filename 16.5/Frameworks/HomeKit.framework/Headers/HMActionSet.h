...
@class NSString, NSSet, NSUUID, NSDate, NSDictionary;
@protocol HMActionSetConfiguration, HMFMessageReceiver, NSSecureCoding, HMObjectMerge, HMMutableApplicationData, OS_dispatch_queue;
...
@property (readonly, nonatomic) HMMutableArray *currentActions; // ivar: _currentActions
...
+(id)shortcutsComponentActionSetWithHome:(id)arg0 actions:(id)arg1 ;
...
-(BOOL)_mergeWithNewObjectForBuilderUpdates:(id)arg0 ;
...
-(void)_doAddAction:(id)arg0 uuid:(id)arg1 ;
...
-(void)updateWithBuilder:(id)arg0 completionHandler:(id)arg1 ;
