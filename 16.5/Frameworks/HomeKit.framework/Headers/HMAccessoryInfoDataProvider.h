...
-(void)configureWithHomeIdentifier:(id)arg0 accessoryIdentifier:(id)arg1 accessoryInfoTypes:(NSUInteger)arg2 dataProviderDelegate:(id)arg3 completionHandler:(id)arg4 ;
-(void)didReceiveCachedEvent:(id)arg0 topic:(id)arg1 source:(id)arg2 ;
-(void)didReceiveEvent:(id)arg0 topic:(id)arg1 ;
-(void)notifyDelegateDidReceiveAccountInfoUpdatesForAccessoryWithIdentifier:(id)arg0 accountInfo:(id)arg1 ;
-(void)notifyDelegateDidReceiveAccountInfoUpdatesForAccessoryWithIdentifier:(id)arg0 primaryUserInfo:(id)arg1 ;
