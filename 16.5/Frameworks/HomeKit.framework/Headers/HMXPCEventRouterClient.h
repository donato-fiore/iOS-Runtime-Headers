...
@property (readonly) BOOL useBackgroundTaskAssertion; // ivar: _useBackgroundTaskAssertion
...
-(id)initWithMessageTargetUUID:(id)arg0 queue:(id)arg1 messageDispatcher:(id)arg2 changeRegistrationsMessageName:(id)arg3 updateMessageName:(id)arg4 notificationCenter:(id)arg5 useBackgroundTaskAssertion:(BOOL)arg6 eventRouterClientFactory:(id)arg7 ;
-(id)initWithMessageTargetUUID:(id)arg0 queue:(id)arg1 messageDispatcher:(id)arg2 changeRegistrationsMessageName:(id)arg3 updateMessageName:(id)arg4 storeReadHandle:(id)arg5 storeWriteHandle:(id)arg6 useBackgroundTaskAssertion:(BOOL)arg7 ;
-(id)logIdentifier;
