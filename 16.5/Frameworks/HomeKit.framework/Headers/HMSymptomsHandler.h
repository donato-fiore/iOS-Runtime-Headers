...
@class NSString, NSHashTable, NSUUID, NSSet;
...
@property (readonly, nonatomic) NSHashTable *fixSessions; // ivar: _fixSessions
...
-(id)initWithUUID:(id)arg0 logIdentifier:(id)arg1 ;
