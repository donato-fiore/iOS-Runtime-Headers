...
@property (readonly) NSUInteger sleepWakeState;
...
-(id)initWithUUID:(id)arg0 routeUID:(id)arg1 playbackState:(NSInteger)arg2 shuffleState:(NSInteger)arg3 repeatState:(NSInteger)arg4 mediaUniqueIdentifier:(id)arg5 sleepWakeState:(NSUInteger)arg6 ;
