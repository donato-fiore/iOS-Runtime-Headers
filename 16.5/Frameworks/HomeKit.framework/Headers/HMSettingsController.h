...
-(id)initWithParentIdentifier:(id)arg0 homeUUID:(id)arg1 codingKey:(id)arg2 ;
-(id)logIdentifier;
-(id)settingForKeyPath:(id)arg0 ;
-(id)settingGroupForKeyPath:(id)arg0 ;
...
-(void)setSetting:(id)arg0 withGroupKeyPath:(id)arg1 ;
-(void)setSettingGroup:(id)arg0 withParentGroupKeyPath:(id)arg1 ;
