...
@protocol HMAccessoryInfoDataProviderDelegate, HMFLogging, HMFMessageReceiver, NSSecureCoding, HMObjectMerge, OS_dispatch_queue;
...
@property (retain) NSString *currentSessionID; // ivar: _currentSessionID
@property (readonly, copy) NSString *debugDescription;
@property (readonly, copy) NSString *description;
@property BOOL didReceiveAccountInfo; // ivar: _didReceiveAccountInfo
...
@property (retain) ACAccount *stagedLoggedInAccount; // ivar: _stagedLoggedInAccount
...
-(id)initWithUUID:(id)arg0 accessory:(id)arg1 loggedInAccount:(id)arg2 stagedLoggedInAccount:(id)arg3 anisetteDataProvider:(id)arg4 ;
-(id)logIdentifier;
-(id)messageDestination;
-(void)_callAccountUpdateDelegate;
-(void)_companionLoginWithAccount:(id)arg0 completion:(id)arg1 ;
-(void)_configureWithContext:(id)arg0 accessory:(id)arg1 ;
