...
@property (readonly, getter=isAccessModeIndicatorEnabled) BOOL accessModeIndicatorEnabled; // ivar: _accessModeIndicatorEnabled
...
@property (readonly, getter=isNightVisionModeEnabled) BOOL nightVisionModeEnabled; // ivar: _nightVisionModeEnabled
...
@property (readonly, getter=isRecordingAudioEnabled) BOOL recordingAudioEnabled; // ivar: _recordingAudioEnabled
...
@property (readonly, getter=areSnapshotsAllowed) BOOL snapshotsAllowed; // ivar: _snapshotsAllowed
