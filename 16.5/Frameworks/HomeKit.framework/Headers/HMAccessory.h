...
@class NSUUID, NSNumber, NSString, NSArray, NSData, NSSet, HMFPairingIdentity, NSDictionary, HMFSoftwareVersion, HMFWiFiNetworkInfo;
@protocol HMMediaDestinationControllerDataSource, HMAccessoryInfoDataProviderDelegate, HMFLogging, HMFObject, HMAccessorySettingsContainerInternal, HMControllable, HMMediaDestinationInternal, HMMutableApplicationData, HMObjectMerge, HMFMessageReceiver, HMAccessorySettingsAdapterDelegate, NSSecureCoding, HMApplicationData, HMMediaDestination, HMAccessoryDelegate, OS_dispatch_queue;
...
@property (retain) HMAccessoryInfoDataProvider *accessoryInfoDataProvider; // ivar: _accessoryInfoDataProvider
...
@property (readonly) HMAudioAnalysisEventBulletinBoardNotification *audioAnalysisEventBulletinBoardNotification; // ivar: _audioAnalysisEventBulletinBoardNotification
...
@property (nonatomic) NSUInteger calibrationStatus; // ivar: _calibrationStatus
...
@property (retain) NSData *deviceIRKData; // ivar: _deviceIRKData
...
@property BOOL knownToSystemCommissioner; // ivar: _knownToSystemCommissioner
@property (readonly) NSSet *lightProfiles;
@property (copy, nonatomic) NSString *manufacturer; // ivar: _manufacturer
@property (readonly, copy, nonatomic) NSNumber *matterNodeID; // ivar: _matterNodeID
...
@property (copy) NSUUID *peerIdentifier; // ivar: _peerIdentifier
...
@property (readonly, nonatomic) NSInteger productColor;
@property (nonatomic) NSInteger productColor; // ivar: _productColor
...
@property (copy) NSData *rootPublicKey; // ivar: _rootPublicKey
...
@property (retain) HMAccessorySettings *settings; // ivar: _settings
@property (retain) HMAccessorySettingsAdapter *settingsAdapter; // ivar: _settingsAdapter
...
@property BOOL supportsAudioAnalysis; // ivar: _supportsAudioAnalysis
...
@property BOOL supportsDropIn; // ivar: _supportsDropIn
@property (readonly) BOOL supportsHomeLevelLocationServiceSetting;
@property BOOL supportsHomeLevelLocationServiceSetting; // ivar: _supportsHomeLevelLocationServiceSetting
@property (readonly) BOOL supportsIdentify; // ivar: _supportsIdentify
@property (readonly) BOOL supportsManagedConfigurationProfile;
@property BOOL supportsManagedConfigurationProfile; // ivar: _supportsManagedConfigurationProfile
...
@property BOOL supportsMessagedHomePodSettings; // ivar: _supportsMessagedHomePodSettings
...
@property BOOL supportsPrimaryUserInfoSubscription; // ivar: _supportsPrimaryUserInfoSubscription
@property (readonly) BOOL supportsRMVonAppleTV;
@property BOOL supportsRMVonAppleTV; // ivar: _supportsRMVonAppleTV
@property (readonly) BOOL supportsSoftwareUpdateV2;
@property BOOL supportsSoftwareUpdateV2; // ivar: _supportsSoftwareUpdateV2
...
+(id)logCategory;
-(BOOL)__updateSymptomsHandler:(id)arg0 ;
-(BOOL)_mergeControlTargets:(id)arg0 ;
-(BOOL)_mergeRemoteLoginHandler:(id)arg0 ;
-(BOOL)_mergeServices:(id)arg0 ;
...
-(id)_handleMultipleCharacteristicsUpdated:(id)arg0 message:(id)arg1 informDelegate:(BOOL)arg2 ;
-(id)_privateDelegate;
...
-(void)_mergeProfileObjects:(id)arg0 ;
...
-(void)accessoryInfoDataProvider:(id)arg0 didReceiveUpdatesForAccessoryWithIdentifier:(id)arg1 primaryUserInfo:(id)arg2 ;
-(void)accessoryInfoDataProvider:(id)arg0 didReceiveUpdatesForAccessoryWithIdentifier:(id)arg1 wifiNetworkInfo:(id)arg2 ;
-(void)activateCHIPPairingModeAndCreateSetupPayloadStringWithCompletion:(id)arg0 ;
...
-(void)configureInfoDataProviderIfNeededWithOption:(NSUInteger)arg0 ;
-(void)configureSettingsAdapterIfNeeded;
-(void)configureSettingsAdapterWithCompletionHandler:(id)arg0 ;
-(void)createSettingsAdapterWithDataSource:(id)arg0 controller:(id)arg1 context:(id)arg2 ;
-(void)deleteSiriHistoryWithCompletion:(id)arg0 ;
-(void)encodeWithCoder:(id)arg0 ;
-(void)fetchCHIPPairingsWithCompletion:(id)arg0 ;
-(void)fetchManagedConfigurationProfilesWithCompletionHandler:(id)arg0 ;
...
-(void)removeCorrespondingSystemCommissionerPairingWithCompletion:(id)arg0 ;
-(void)removeManagedConfigurationProfileWithIdentifier:(id)arg0 completionHandler:(id)arg1 ;
...
-(void)unconfigureInfoDataProviderWithOptions:(NSUInteger)arg0 ;
...
-(void)updateSettingsAdapterSettingReflected:(BOOL)arg0 ;
