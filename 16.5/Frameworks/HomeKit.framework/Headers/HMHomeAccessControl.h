...
@property (nonatomic) NSUInteger accessNotAllowedReasonCode; // ivar: _accessNotAllowedReasonCode
...
@property (nonatomic) NSUInteger audioAnalysisUserDropInAccessLevel; // ivar: _audioAnalysisUserDropInAccessLevel
...
-(id)initWithUser:(id)arg0 allowAccess:(BOOL)arg1 owner:(BOOL)arg2 administratorPrivilege:(BOOL)arg3 remoteAccess:(BOOL)arg4 presenceAuthStatus:(id)arg5 presenceComputeStatus:(id)arg6 announceAccess:(BOOL)arg7 camerasAccess:(id)arg8 audioAnalysisUserDropInAccessLevel:(NSUInteger)arg9 ;
-(void)setAudioAnalysisUserDropinAccessLevel:(NSUInteger)arg0 ;
...
-(void)updateAudioAnalysisUserDropinAccessLevel:(NSUInteger)arg0 completionHandler:(id)arg1 ;
