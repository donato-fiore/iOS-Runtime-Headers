...
@property BOOL shouldWeRetrySendingSignOutMessageToHomeKitDaemon; // ivar: _shouldWeRetrySendingSignOutMessageToHomeKitDaemon
...
-(BOOL)shouldRetrySendingSignOutMessageDueToError:(id)arg0 ;
-(id)init;
...
-(void)_retrySendingSignOutWithCompletion:(id)arg0 ;
-(void)_start;
