...
@class NSString, NSMutableSet, NSArray, NSUUID, CLLocation, HMFMessageDestination, NSDate, NSOperationQueue, NSSet, HMFVersion;
@protocol HMSiriEndpointProfilesMessengerFactory, HMFLogging, HMAudioAnalysisLastKnownEventSubscriberDataSource, HMMutableApplicationData, HMObjectMerge, HMFMessageReceiver, NSSecureCoding, HMHomeDelegate, OS_dispatch_queue;
...
@interface HMHome : NSObject <HMSiriEndpointProfilesMessengerFactory, HMFLogging, HMAudioAnalysisLastKnownEventSubscriberDataSource, HMMutableApplicationData, HMObjectMerge, HMFMessageReceiver, NSSecureCoding>
...
@property NSUInteger audioAnalysisClassifierOptions; // ivar: _audioAnalysisClassifierOptions
...
@property (readonly, getter=areBulletinNotificationsSupported) BOOL bulletinNotificationsSupported; // ivar: _bulletinNotificationsSupported
...
@property (readonly, nonatomic) HMMutableArray *currentRooms; // ivar: _currentRooms
...
@property (readonly, nonatomic) HMMutableArray *currentZones; // ivar: _currentZones
@property (readonly, copy) NSString *debugDescription;
@property (readonly, copy) NSString *debugDescription;
@property (weak, nonatomic) NSObject<HMHomeDelegate> *delegate; // ivar: _delegate
@property (readonly, copy) NSString *description;
@property (readonly, copy) NSString *description;
@property BOOL didOnboardAudioAnalysis; // ivar: _didOnboardAudioAnalysis
...
@property BOOL isFeatureHomeTheaterQFAEnabled; // ivar: _isFeatureHomeTheaterQFAEnabled
...
@property (getter=isLocationServicesEnabled) BOOL locationServicesEnabled; // ivar: _locationServicesEnabled
...
@property (readonly, nonatomic) id *matterControllerXPCConnectBlock;
...
@property (retain) HMAccessorySoftwareUpdateControllerV2 *softwareUpdateController; // ivar: _softwareUpdateController
@property BOOL soundCheckEnabled; // ivar: _soundCheckEnabled
@property (readonly) HMMutableArray *stagedMediaSystems; // ivar: _stagedMediaSystems
...
-(BOOL)adoptTriggerOwnedActionSet:(id)arg0 ;
-(BOOL)isMultiUserEnabled;
-(BOOL)validateBuilder:(id)arg0 error:(*id)arg1 ;
-(NSUInteger)_mergeAccessoriesForMergeCollection:(id)arg0 currentAccessories:(id)arg1 ;
-(NSUInteger)_mergeCurrentHomeAccessoriesWithNewHomeAccessories:(id)arg0 ;
-(NSUInteger)_mergeCurrentHomeAccessoryNetworkProtectionGroupsWithNewAccessoryNetworkProtectionGroups:(id)arg0 ;
-(NSUInteger)_mergeCurrentHomeActionSetsWithNewHomeActionSets:(id)arg0 ;
-(NSUInteger)_mergeCurrentHomeInvitationsWithNewHomeInvitations:(id)arg0 ;
-(NSUInteger)_mergeCurrentHomeMediaSystemsWithNewMediaSystems:(id)arg0 ;
-(NSUInteger)_mergeCurrentHomeResidentDevicesWithNewHomeResidentDevices:(id)arg0 ;
-(NSUInteger)_mergeCurrentHomeRoomsWithNewHomeRooms:(id)arg0 ;
-(NSUInteger)_mergeCurrentHomeServiceGroupsWithNewHomeServiceGroups:(id)arg0 ;
-(NSUInteger)_mergeCurrentHomeTriggerOwnedActionSetsWithNewHomeActionSets:(id)arg0 ;
-(NSUInteger)_mergeCurrentHomeTriggersWithNewHomeTriggers:(id)arg0 ;
-(NSUInteger)_mergeCurrentHomeUsersWithNewHomeUsers:(id)arg0 ;
-(NSUInteger)_mergeCurrentHomeZonesWithNewHomeZones:(id)arg0 ;
-(NSUInteger)_mergeIsFeatureHomeTheaterQFAEnabled:(id)arg0 ;
...
-(id)_findCharacteristic:(id)arg0 forService:(id)arg1 accessoryUUID:(id)arg2 ;
-(id)_findService:(id)arg0 accessoryUUID:(id)arg1 ;
-(id)_findUserWithID:(id)arg0 ;
-(id)_getContainerForAppData:(id)arg0 ;
-(id)_mediaSystems;
-(id)_privateDelegate;
-(id)_removeMediaSystemRequestResponseHandlerWithMediaSystem:(SEL)arg0 context:(id)arg1 messageIdentifier:(id)arg2 completionHandler:(id)arg3 ;
-(id)accessoryUUIDForIdentifier:(id)arg0 ;
...
-(id)encodeActionSetBuilder:(id)arg0 error:(*id)arg1 ;
-(id)encodeEventTriggerBuilder:(id)arg0 error:(*id)arg1 ;
...
-(id)legacyRemoveMediaSystemRequestResponseHandlerWithMessageIdentifier:(SEL)arg0 context:(id)arg1 completionHandler:(id)arg2 ;
-(id)lightProfileWithProfileUUID:(id)arg0 ;
-(id)location;
-(id)logIdentifier;
-(id)mediaDestinationsWithHomeTheaterSupportedOptions;
-(id)mediaDestinationsWithSupportedOptions:(NSUInteger)arg0 ;
-(id)mediaProfileWithProfileUUID:(id)arg0 ;
-(id)mediaProfileWithUUID:(id)arg0 ;
-(id)mediaSystemWithUUID:(id)arg0 ;
-(id)mediaSystemWithUniqueIdentifier:(id)arg0 ;
-(id)mediaSystems;
-(id)mediaSystemsAddedBlock:(SEL)arg0 ;
-(id)mediaSystemsRemovedBlock:(SEL)arg0 ;
-(id)newActionSetBuilder;
-(id)newActionSetBuilderWithName:(id)arg0 ;
-(id)newEventTriggerBuilder;
-(id)newEventTriggerBuilderWithName:(id)arg0 events:(id)arg1 endEvents:(id)arg2 recurrences:(id)arg3 predicate:(id)arg4 ;
-(id)newEventTriggerBuilderWithName:(id)arg0 events:(id)arg1 predicate:(id)arg2 ;
-(id)newTimerTriggerBuilder;
-(id)newTimerTriggerBuilderWithName:(id)arg0 fireDate:(id)arg1 timeZone:(id)arg2 recurrence:(id)arg3 ;
-(id)newTimerTriggerBuilderWithName:(id)arg0 significantEvent:(id)arg1 significantEventOffset:(id)arg2 recurrences:(id)arg3 ;
...
-(id)removeMediaSystemRequestResponseHandlerWithMediaSystem:(SEL)arg0 context:(id)arg1 messageIdentifier:(id)arg2 completionHandler:(id)arg3 ;
-(id)residentDevices;
...
-(void)__updateHomeAccessControlFromResponsePayload:(id)arg0 forUser:(id)arg1 ;
-(void)__updateLocation:(id)arg0 locationStatus:(NSInteger)arg1 ;
...
-(void)_configureOutgoingInvitation:(id)arg0 ;
...
-(void)_handleHomeLocationUpdateNotification:(id)arg0 ;
-(void)_handleHomeNetworkRouterSupportUpdated:(id)arg0 ;
-(void)_handleMediaSystemRemovedMessage:(id)arg0 ;
...
-(void)addActionSetFromBuilder:(id)arg0 completionHandler:(id)arg1 ;
...
-(void)addEventTriggerFromBuilder:(id)arg0 completionHandler:(id)arg1 ;
-(void)addRoomWithName:(id)arg0 completionHandler:(id)arg1 ;
-(void)addServiceGroupWithName:(id)arg0 completionHandler:(id)arg1 ;
-(void)addTimerTriggerFromBuilder:(id)arg0 completionHandler:(id)arg1 ;
...
-(void)stageMediaSystem:(id)arg0 ;
-(void)stageRemovedMediaSystemUUID:(id)arg0 ;
...
-(void)unstageMediaSystems:(id)arg0 ;
-(void)unstageRemovedMediaSystemUUID:(id)arg0 ;
-(void)unstageRemovedMediaSystemsUsingCurrentMediaSystems:(id)arg0 ;
...
-(void)updateAccessForUser:(id)arg0 audioAnalysisUserDropinAccessLevel:(NSUInteger)arg1 completionHandler:(id)arg2 ;
...
-(void)updateAudioAnalysisClassifierOptions:(NSUInteger)arg0 completion:(id)arg1 ;
...
-(void)updateDidOnboardAudioAnalysis:(BOOL)arg0 completion:(id)arg1 ;
-(void)updateDidOnboardLocationServices:(BOOL)arg0 completion:(id)arg1 ;
-(void)updateForUser:(id)arg0 presenceAuthorizationStatus:(NSUInteger)arg1 completionHandler:(id)arg2 ;
-(void)updateLocationServicesEnabled:(BOOL)arg0 completion:(id)arg1 ;
...
-(void)updateSoundCheckEnabled:(BOOL)arg0 completion:(id)arg1 ;
