...
-(id)initWithIdentifier:(id)arg0 parentIdentifier:(id)arg1 destinationIdentifier:(id)arg2 supportedOptions:(NSUInteger)arg3 availableDestinationIdentifiers:(id)arg4 ;
