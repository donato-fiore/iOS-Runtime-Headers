...
@property (nonatomic) MPSMatrix *workspace; // ivar: _workspace
...
-(void)dealloc;
-(void)encodeToCommandBuffer:(id)arg0 encoder:(id)arg1 sourceMatrix:(id)arg2 rightHandSideMatrix:(id)arg3 solutionMatrix:(id)arg4 ;
