...
@property (readonly, nonatomic) NSMapTable *assetsByUUID; // ivar: _assetsByUUID
@property (readonly, nonatomic) NSMutableSet *completedLongLivedOperationIDs; // ivar: _completedLongLivedOperationIDs
@property (readonly, weak, nonatomic) CKLogicalDeviceContext *deviceContext; // ivar: _deviceContext
@property (readonly, nonatomic) NSMutableSet *outstandingOperationIDs; // ivar: _outstandingOperationIDs
...
-(void)registerLongLivedOperationWithIDAsCompleted:(id)arg0 allowResumingCompletedLongLivedOperations:(BOOL)arg1 ;
-(void)registerLongLivedOperationWithIDAsOutstanding:(id)arg0 ;
-(void)resetThrottles;
