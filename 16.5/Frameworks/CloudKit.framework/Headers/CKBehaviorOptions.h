...
@property (readonly, nonatomic) NSString *automatedDeviceGroup; // ivar: _automatedDeviceGroup
@property (nonatomic) BOOL didReadAutomatedDeviceGroup; // ivar: _didReadAutomatedDeviceGroup
...
-(void)setAllowRecordKeyRollingInPerRecordPCSZonesForAllContainers:(BOOL)arg0 ;
-(void)setAllowZoneAndRecordKeyRollingInZoneishPCSZonesForAllContainers:(BOOL)arg0 ;
-(void)setAllowZoneKeyRollingInPerRecordPCSZonesForAllContainers:(BOOL)arg0 ;
-(void)setAltDSIDsToManateeAvailabilitiesOverrides:(id)arg0 ;
-(void)setAltDSIDsToWalrusAvailabilitiesOverrides:(id)arg0 ;
-(void)setBuildVersion:(id)arg0 ;
-(void)setCDPWalrusEnabled:(BOOL)arg0 ;
-(void)setCDPWalrusOverride:(BOOL)arg0 ;
...
-(void)setFakeWalrusEnabled:(BOOL)arg0 ;
-(void)setFakeWalrusOverride:(BOOL)arg0 ;
