...
@property (copy) CKNotificationInfo *notificationInfo; // ivar: _notificationInfo
@property (copy) NSString *recordType; // ivar: _recordType
@property (readonly, copy) NSString *subscriptionID; // ivar: _subscriptionID
@property (readonly) NSInteger subscriptionType; // ivar: _subscriptionType
