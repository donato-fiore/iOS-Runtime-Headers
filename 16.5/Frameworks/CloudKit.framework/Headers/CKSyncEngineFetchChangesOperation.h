...
@class NSOperation, NSString, NSError, NSOperationQueue, NSSet;
...
@property (copy, nonatomic) id *willBeginFetchingChangesForZoneIDsBlock; // ivar: _willBeginFetchingChangesForZoneIDsBlock
