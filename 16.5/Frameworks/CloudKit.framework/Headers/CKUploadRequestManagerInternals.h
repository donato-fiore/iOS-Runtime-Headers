...
@property (nonatomic) CGFloat assetRepairSchedulerDefaultSuspensionTime; // ivar: _assetRepairSchedulerDefaultSuspensionTime
@property (nonatomic) NSInteger assetRepairSchedulerRepairBatchCountLimit; // ivar: _assetRepairSchedulerRepairBatchCountLimit
@property (nonatomic) NSInteger assetRepairSchedulerRepairRetryCount; // ivar: _assetRepairSchedulerRepairRetryCount
...
@property (nonatomic) CGFloat cancelledErrorRetryTime; // ivar: _cancelledErrorRetryTime
...
@property (nonatomic) CGFloat notificationDebouncePeriod; // ivar: _notificationDebouncePeriod
...
@property (nonatomic) CGFloat recurringFetchPeriod; // ivar: _recurringFetchPeriod
@property (copy, nonatomic) id *repairActivityHandler; // ivar: _repairActivityHandler
@property (readonly, nonatomic) CKContainer *repairContainer; // ivar: _repairContainer
@property (readonly, nonatomic) CKUploadRequestConfiguration *repairContainerOverrides; // ivar: _repairContainerOverrides
...
@property (readonly, nonatomic) CKUploadRequestManagerResponseActionThrottler *responseActionThrottler; // ivar: _responseActionThrottler
@property (nonatomic) CGFloat retryableErrorMaxRetryCount; // ivar: _retryableErrorMaxRetryCount
@property (nonatomic) CGFloat retryableErrorRetryTime; // ivar: _retryableErrorRetryTime
...
@property (readonly, nonatomic) NSObject<OS_dispatch_queue> *stateMachineQueue; // ivar: _stateMachineQueue
@property (readonly, nonatomic) NSObject<OS_dispatch_queue> *stateQueue; // ivar: _stateQueue
@property (readonly) Class superclass;
@property (nonatomic) CGFloat tryAgainLaterRetryTime; // ivar: _tryAgainLaterRetryTime
...
-(void)assetRepairScheduler:(id)arg0 preparingRepairWithIncludedMetadataCount:(NSUInteger)arg1 ;
...
-(void)dealloc;
-(void)dispatchAsyncOnStateQueue:(id)arg0 ;
