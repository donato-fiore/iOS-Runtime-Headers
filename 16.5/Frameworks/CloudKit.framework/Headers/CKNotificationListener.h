...
@property (retain) NSArray *notificationObservers; // ivar: _notificationObservers
@property (readonly, nonatomic) NSObject<OS_dispatch_queue> *queue; // ivar: _queue
@property (readonly) Class superclass;
@property BOOL useOpportunisticPushTopics; // ivar: _useOpportunisticPushTopics
...
-(void)registerForSubscriptionWithID:(id)arg0 inDatabase:(id)arg1 handler:(id)arg2 ;
