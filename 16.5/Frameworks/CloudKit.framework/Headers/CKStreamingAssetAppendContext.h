...
@property (readonly, nonatomic) NSObject<OS_dispatch_queue> *appendQueue; // ivar: _appendQueue
...
@property (readonly, nonatomic) CKStreamingAsset *streamingAsset; // ivar: _streamingAsset
