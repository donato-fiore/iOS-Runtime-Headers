...
@property (readonly, copy, nonatomic) NSMutableDictionary *attributes; // ivar: _attributes
@property (copy) NSDate *endTime; // ivar: _endTime
@property (readonly, copy, nonatomic) NSString *eventName; // ivar: _eventName
@property (nonatomic) BOOL isCKInternalMetric; // ivar: _isCKInternalMetric
@property BOOL isPushTriggerFired; // ivar: _isPushTriggerFired
