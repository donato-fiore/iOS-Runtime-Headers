...
-(void)getDaemonTestServerManagerProxyCreatorSynchronous:(BOOL)arg0 completionHandler:(id)arg1 ;
-(void)getLogicalDeviceScopedClientProxyCreatorForTestDeviceReferenceProtocol:(id)arg0 completionHandler:(id)arg1 ;
-(void)getLogicalDeviceScopedDaemonProxyCreatorForTestDeviceReferenceProtocol:(id)arg0 synchronous:(BOOL)arg1 completionHandler:(id)arg2 ;
