...
@property (readonly, nonatomic) CKConvenienceConfiguration *convenienceConfiguration; // ivar: _convenienceConfiguration
...
@property (readonly, nonatomic) CKDatabase *privateCloudDatabase; // ivar: _privateCloudDatabase
@property (readonly, nonatomic) CKDatabase *publicCloudDatabase; // ivar: _publicCloudDatabase
@property (readonly, nonatomic) int scopedIdentityUpdateToken; // ivar: _scopedIdentityUpdateToken
@property (readonly, copy, nonatomic) CKContainerSetupInfo *setupInfo;
@property (readonly, nonatomic) CKDatabase *sharedCloudDatabase; // ivar: _sharedCloudDatabase
...
+(void)_populateXPCInterfaceOnClientToDaemonContainerScopedInterfaceForOptionalSelector:(SEL)arg0 generateInterfaceBlock:(id)arg1 ;
+(void)populateXPCInterfaceOnClientToDaemonContainerScopedInterfaceForSelector:(SEL)arg0 generateInterfaceBlock:(id)arg1 ;
