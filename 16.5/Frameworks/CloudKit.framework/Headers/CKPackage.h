...
@property (retain, nonatomic) CKPackageReference *packageReference; // ivar: _packageReference
...
+(id)clonedPackageWithRecordID:(id)arg0 databaseScope:(NSInteger)arg1 fieldName:(id)arg2 error:(*id)arg3 ;
