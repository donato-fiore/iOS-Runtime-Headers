...
#ifndef CXPROVIDEREXTENSIONVENDORCONTEXT_H
#define CXPROVIDEREXTENSIONVENDORCONTEXT_H

@class NSString;
@protocol CXProviderHostProtocol, CXProviderVendorProtocol, CXProviderExtensionVendorContextDelegate;
...
@property (weak, nonatomic) NSObject<CXProviderExtensionVendorContextDelegate> *delegate; // ivar: _delegate
