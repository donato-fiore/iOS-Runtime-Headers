...
@class QLPreviewContext, NSString, QLItem, QLItemViewController, DMFApplicationPolicyMonitor, DMFCategoryPolicyMonitor;
...
-(void)updatePreviewItemDisplayState:(id)arg0 ;
