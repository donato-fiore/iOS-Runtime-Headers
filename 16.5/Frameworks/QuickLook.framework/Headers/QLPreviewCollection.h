...
@class UIViewController, UIView, UITapGestureRecognizer, UIPanGestureRecognizer, UISwipeGestureRecognizer, QLAppearance, NSString, QLItemViewController, UIPinchGestureRecognizer, UIRotationGestureRecognizer;
@protocol QLTransitionControllerProtocol, QLPageViewControllerDataSource, QLPageViewControllerDelegate, QLPreviewItemViewControllerDelegate, QLItemPresenterViewControllerDelegate, UIGestureRecognizerDelegatePrivate, QLPreviewCollectionProtocol, QLPreviewControllerStateProtocol><QLPreviewControllerStateProtocol_UIKit;
...
@property (retain) NSObject<QLPreviewControllerStateProtocol><QLPreviewControllerStateProtocol_UIKit> *stateManager; // ivar: _stateManager
...
-(void)previewItemDisplayState:(id)arg0 wasAppliedToItemAtIndex:(NSUInteger)arg1 ;
...
-(void)previewItemViewController:(id)arg0 wantsToSetRemoteEdgePanGestureWidth:(CGFloat)arg1 ;
...
-(void)previewItemViewController:(id)arg0 wantsToUpdatePreviewItemDisplayState:(id)arg1 ;
