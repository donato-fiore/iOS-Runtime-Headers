...
@class QLItemViewController, UITextView, NSAttributedString, NSLayoutConstraint, NSString, UIPrintPageRenderer, UISimpleTextPrintFormatter;
...
-(void)_updateViewConstraintsFromKeyboardAppearanceInfo:(id)arg0 notificationName:(id)arg1 ;
