...
@class UIViewController, EKRecurrenceRule, UITableViewCell, UIPickerView, NSString, NSDate, UITableView, NSTimeZone, UISwitch;
@protocol UITableViewDataSource, UITableViewDelegate, EKRecurrenceChooserControllerDelegate, UITextFieldDelegate, UIPickerViewDataSource, UIPickerViewDelegate, EKUIManagedViewController;
...
-(BOOL)prefersPushForSizeClass:(NSInteger)arg0 ;
