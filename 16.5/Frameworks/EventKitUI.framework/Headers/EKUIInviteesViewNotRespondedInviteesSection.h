...
@class NSOperationQueue, NSString, EKEvent, NSMutableSet, NSMutableDictionary, NSMutableArray;
...
-(void)updateWithEvent:(id)arg0 editable:(BOOL)arg1 fromDetail:(BOOL)arg2 ;
