...
-(void)_commit;
-(void)_commitUntimed;
-(void)_createAndSetUpDraggingViewWithTouchPoint:(struct CGPoint )arg0 event:(id)arg1 ignoreOffsets:(BOOL)arg2 showEditMenu:(BOOL)arg3 ;
...
-(void)_hideEditingMenuForView:(id)arg0 ;
...
-(void)_updatePositionOfEditingMenuForView:(id)arg0 ;
...
-(void)endForcedStart;
-(void)forceStartWithOccurrence:(id)arg0 shouldUpdateViewSource:(BOOL)arg1 shouldUpdateOrigin:(BOOL)arg2 shouldPresentEditMenu:(BOOL)arg3 ;
