...
@class UITableView, _UINavigationControllerPalette, UISearchBar, EKCalendarItem, EKVirtualConferenceRoomType, NSMutableDictionary, EKStructuredLocation, NSArray, NSString, NSError, EKVirtualConference;
...
-(void)locationSearchModel:(id)arg0 updatedSearchTypes:(NSUInteger)arg1 ;
