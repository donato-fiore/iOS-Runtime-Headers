...
@property (readonly, nonatomic) EKStructuredLocationWithImage *locationFromMapsURL; // ivar: _locationFromMapsURL
...
-(NSUInteger)dedupeResults;
-(id)_imageForAttributes:(id)arg0 ;
-(id)_imageForMapHandle:(id)arg0 ;
...
-(void)_addLocationToRecents:(id)arg0 addressString:(id)arg1 mapItem:(id)arg2 ;
