...
@property (retain, nonatomic) EKUIInviteesViewAvailabilitySection *availabilitySection; // ivar: _availabilitySection
...
@property (retain, nonatomic) UIViewController *presentedController; // ivar: _presentedController
...
-(id)initWithEvent:(id)arg0 fromDetail:(BOOL)arg1 model:(id)arg2 ;
