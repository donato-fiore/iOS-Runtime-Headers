...
+(id)_allActionInfos;
// +(id)_createCalendarsMenuForEvents:(id)arg0 presentationController:(id)arg1 isEditMenu:(BOOL)arg2 overrideActionBlock:(id)arg3 completionBlock:(unk)arg4  ;
...
// +(id)menuForEvents:(id)arg0 presentationController:(id)arg1 isEditMenu:(BOOL)arg2 overrideActionBlock:(id)arg3 completionBlock:(unk)arg4  ;
