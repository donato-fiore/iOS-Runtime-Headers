...
@property (readonly, nonatomic) CGFloat inputSafetyOffset; // ivar: _inputSafetyOffset
...
@property (readonly, nonatomic) CGFloat outputSafetyOffset; // ivar: _outputSafetyOffset
