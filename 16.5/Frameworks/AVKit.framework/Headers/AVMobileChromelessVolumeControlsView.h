...
@property (nonatomic, getter=isTrackingEnabled) BOOL allowsVolumeAdjustment; // ivar: _allowsVolumeAdjustment
...
-(BOOL)volumeControlButtonCanBeginPanning:(id)arg0 ;
-(id)init;
...
-(void)volumeControlButton:(id)arg0 didContinuePanningWithXDelta:(CGFloat)arg1 ;
-(void)volumeControlButtonDidBeginPanning:(id)arg0 ;
-(void)volumeControlButtonDidEndPanning:(id)arg0 ;
