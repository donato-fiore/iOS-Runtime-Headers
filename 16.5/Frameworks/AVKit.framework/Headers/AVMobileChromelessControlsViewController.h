...
-(id)mediaSelectionMenuController:(id)arg0 displayNameForMediaSelectionOption:(id)arg1 ;
...
-(void)_setUpControlsViewsForVisibileControlsStateIfNeeded:(struct AVMobileChromelessControlsVisibilityState_st )arg0 ;
...
-(void)slider:(id)arg0 didUpdateFrame:(struct CGRect )arg1 forSliderMark:(id)arg2 ;
