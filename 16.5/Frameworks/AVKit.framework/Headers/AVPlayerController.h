...
@class NSArray, AVMediaSelectionOption, NSString, NSNumber, BSSimpleAssertion, NSDate, NSTimer, AVPlayer, AVAsset, AVAssetTrack, NSError, NSDictionary, AVPlayerLayer, AVCoordinatedPlaybackSuspension;
...
#import "AVPlayerItemPhotosensitivityMetadataHandler.h"
#import "AVInterstitialController.h"
...
@interface AVPlayerController : NSObject {
    ...
    *void _observationInfo;
    ...
    NSInteger _playbackSuspensionCount;
    NSInteger _scrubbingCount;
...
@property (retain, nonatomic) AVPlayer *activePlayer; // ivar: _activePlayer
@property (nonatomic) CGFloat activeRate; // ivar: _activeRate
...
@property (nonatomic, getter=isAtLiveEdge) BOOL atLiveEdge; // ivar: _atLiveEdge
...
@property (nonatomic) CGFloat initialScrubbingTime; // ivar: _initialScrubbingTime
@property (weak, nonatomic) NSObject<AVPlayerControllerDelegate> *internalDelegate;
@property (retain, nonatomic) AVInterstitialController *interstitialController; // ivar: _interstitialController
...
@property (readonly, nonatomic, getter=isPlaybackSuspended) BOOL playbackSuspended; // ivar: _playbackSuspended
...
@property (readonly, nonatomic) CGFloat suspendedRate; // ivar: _suspendedRate
...
-(CGFloat)_adjustedSeekTimeFromTime:(CGFloat)arg0 toTime:(CGFloat)arg1 ;
...
-(void)setAllowsAudioPlayback:(BOOL)arg0 ;
