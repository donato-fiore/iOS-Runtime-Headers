...
@property (readonly, nonatomic) BOOL imageContainedInBundle; // ivar: _imageContainedInBundle
...
-(NSUInteger)hash;
-(id)imageName;
-(id)initWithImageName:(id)arg0 font:(id)arg1 imageContainedInBundle:(BOOL)arg2 ;
