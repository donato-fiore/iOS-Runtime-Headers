...
@class UISlider, UIImageView, NSString, UISelectionFeedbackGenerator, NSArray, NSMutableArray, UIView, UIScrollView, NSTimer;
...
@property (copy, nonatomic) NSArray *interstitialDisplayTimes; // ivar: _interstitialDisplayTimes
@property (retain, nonatomic) NSMutableArray *interstitialOverlayViews; // ivar: _interstitialOverlayViews
...
@property (copy, nonatomic) NSArray *photosensitiveDisplayTimes; // ivar: _photosensitiveDisplayTimes
@property (retain, nonatomic) NSMutableArray *photosensitiveOverlayViews; // ivar: _photosensitiveOverlayViews
...
@property (nonatomic) BOOL showsTimelineMarkers; // ivar: _showsTimelineMarkers
...
-(float)_normalizeSliderValue:(float)arg0 ;
...
-(void)_layoutPhotosensitiveRegions:(float)arg0 ;
-(void)_layoutTimeLineMarkerViews:(float)arg0 ;
