...
#ifndef MTRCOLORCONTROLCLUSTERMOVETOCOLORTEMPERATUREPARAMS_H
#define MTRCOLORCONTROLCLUSTERMOVETOCOLORTEMPERATUREPARAMS_H
...
@property (copy, nonatomic) NSNumber *colorTemperatureMireds; // ivar: _colorTemperatureMireds
