...
#ifndef MTRBASECLUSTERPOWERSOURCECONFIGURATION_H
#define MTRBASECLUSTERPOWERSOURCECONFIGURATION_H
...
+(void)readAttributeSourcesWithAttributeCache:(id)arg0 endpoint:(id)arg1 queue:(id)arg2 completionHandler:(id)arg3 ;
+(void)readAttributeSourcesWithClusterStateCache:(id)arg0 endpoint:(id)arg1 queue:(id)arg2 completion:(id)arg3 ;
...
-(void)readAttributeSourcesWithCompletion:(id)arg0 ;
-(void)readAttributeSourcesWithCompletionHandler:(id)arg0 ;
...
// -(void)subscribeAttributeSourcesWithMinInterval:(id)arg0 maxInterval:(id)arg1 params:(id)arg2 subscriptionEstablished:(id)arg3 reportHandler:(unk)arg4  ;
// -(void)subscribeAttributeSourcesWithParams:(id)arg0 subscriptionEstablished:(id)arg1 reportHandler:(unk)arg2  ;
