...
#ifndef MTRBASECLUSTERBOOLEANSTATE_H
#define MTRBASECLUSTERBOOLEANSTATE_H
...
+(void)readAttributeStateValueWithAttributeCache:(id)arg0 endpoint:(id)arg1 queue:(id)arg2 completionHandler:(id)arg3 ;
+(void)readAttributeStateValueWithClusterStateCache:(id)arg0 endpoint:(id)arg1 queue:(id)arg2 completion:(id)arg3 ;
...
-(void)readAttributeStateValueWithCompletion:(id)arg0 ;
-(void)readAttributeStateValueWithCompletionHandler:(id)arg0 ;
...
// -(void)subscribeAttributeStateValueWithMinInterval:(id)arg0 maxInterval:(id)arg1 params:(id)arg2 subscriptionEstablished:(id)arg3 reportHandler:(unk)arg4  ;
// -(void)subscribeAttributeStateValueWithParams:(id)arg0 subscriptionEstablished:(id)arg1 reportHandler:(unk)arg2  ;
