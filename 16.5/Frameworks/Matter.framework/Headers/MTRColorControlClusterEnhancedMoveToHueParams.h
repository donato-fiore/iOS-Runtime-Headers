...
#ifndef MTRCOLORCONTROLCLUSTERENHANCEDMOVETOHUEPARAMS_H
#define MTRCOLORCONTROLCLUSTERENHANCEDMOVETOHUEPARAMS_H
...
@property (copy, nonatomic) NSNumber *enhancedHue; // ivar: _enhancedHue
