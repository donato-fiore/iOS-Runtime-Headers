...
-(id)readAttributeSwitchActionsWithParams:(id)arg0 ;
-(id)readAttributeSwitchTypeWithParams:(id)arg0 ;
-(void)writeAttributeSwitchActionsWithValue:(id)arg0 expectedValueInterval:(id)arg1 ;
-(void)writeAttributeSwitchActionsWithValue:(id)arg0 expectedValueInterval:(id)arg1 params:(id)arg2 ;
