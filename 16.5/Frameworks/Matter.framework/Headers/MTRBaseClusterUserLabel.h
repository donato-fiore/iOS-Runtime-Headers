...
#ifndef MTRBASECLUSTERUSERLABEL_H
#define MTRBASECLUSTERUSERLABEL_H
...
+(void)readAttributeLabelListWithClusterStateCache:(id)arg0 endpoint:(id)arg1 queue:(id)arg2 completion:(id)arg3 ;
...
-(void)readAttributeLabelListWithCompletion:(id)arg0 ;
...
// -(void)subscribeAttributeLabelListWithParams:(id)arg0 subscriptionEstablished:(id)arg1 reportHandler:(unk)arg2  ;
-(void)writeAttributeLabelListWithValue:(id)arg0 completion:(id)arg1 ;
-(void)writeAttributeLabelListWithValue:(id)arg0 completionHandler:(id)arg1 ;
-(void)writeAttributeLabelListWithValue:(id)arg0 params:(id)arg1 completion:(id)arg2 ;
-(void)writeAttributeLabelListWithValue:(id)arg0 params:(id)arg1 completionHandler:(id)arg2 ;
