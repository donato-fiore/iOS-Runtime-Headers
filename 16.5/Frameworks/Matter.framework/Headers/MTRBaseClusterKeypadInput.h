...
#ifndef MTRBASECLUSTERKEYPADINPUT_H
#define MTRBASECLUSTERKEYPADINPUT_H
...
-(void)sendKeyWithParams:(id)arg0 completion:(id)arg1 ;
-(void)sendKeyWithParams:(id)arg0 completionHandler:(id)arg1 ;
