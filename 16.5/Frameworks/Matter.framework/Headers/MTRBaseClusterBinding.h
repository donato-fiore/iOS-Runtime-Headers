...
#ifndef MTRBASECLUSTERBINDING_H
#define MTRBASECLUSTERBINDING_H
...
+(void)readAttributeBindingWithAttributeCache:(id)arg0 endpoint:(id)arg1 queue:(id)arg2 completionHandler:(id)arg3 ;
+(void)readAttributeBindingWithClusterStateCache:(id)arg0 endpoint:(id)arg1 queue:(id)arg2 completion:(id)arg3 ;
...
-(void)readAttributeBindingWithParams:(id)arg0 completion:(id)arg1 ;
-(void)readAttributeBindingWithParams:(id)arg0 completionHandler:(id)arg1 ;
...
// -(void)subscribeAttributeBindingWithMinInterval:(id)arg0 maxInterval:(id)arg1 params:(id)arg2 subscriptionEstablished:(id)arg3 reportHandler:(unk)arg4  ;
// -(void)subscribeAttributeBindingWithParams:(id)arg0 subscriptionEstablished:(id)arg1 reportHandler:(unk)arg2  ;
...
-(void)writeAttributeBindingWithValue:(id)arg0 completion:(id)arg1 ;
-(void)writeAttributeBindingWithValue:(id)arg0 completionHandler:(id)arg1 ;
-(void)writeAttributeBindingWithValue:(id)arg0 params:(id)arg1 completion:(id)arg2 ;
-(void)writeAttributeBindingWithValue:(id)arg0 params:(id)arg1 completionHandler:(id)arg2 ;
