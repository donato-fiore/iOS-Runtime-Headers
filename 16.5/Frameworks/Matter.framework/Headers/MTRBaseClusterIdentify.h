...
+(void)readAttributeIdentifyTimeWithClusterStateCache:(id)arg0 endpoint:(id)arg1 queue:(id)arg2 completion:(id)arg3 ;
+(void)readAttributeIdentifyTypeWithAttributeCache:(id)arg0 endpoint:(id)arg1 queue:(id)arg2 completionHandler:(id)arg3 ;
+(void)readAttributeIdentifyTypeWithClusterStateCache:(id)arg0 endpoint:(id)arg1 queue:(id)arg2 completion:(id)arg3 ;
-(id)initWithDevice:(id)arg0 endpoint:(unsigned short)arg1 queue:(id)arg2 ;
-(id)initWithDevice:(id)arg0 endpointID:(id)arg1 queue:(id)arg2 ;
-(void)identifyWithParams:(id)arg0 completion:(id)arg1 ;
...
-(void)readAttributeIdentifyTimeWithCompletion:(id)arg0 ;
-(void)readAttributeIdentifyTimeWithCompletionHandler:(id)arg0 ;
-(void)readAttributeIdentifyTypeWithCompletion:(id)arg0 ;
...
// -(void)subscribeAttributeIdentifyTimeWithParams:(id)arg0 subscriptionEstablished:(id)arg1 reportHandler:(unk)arg2  ;
...
// -(void)subscribeAttributeIdentifyTypeWithParams:(id)arg0 subscriptionEstablished:(id)arg1 reportHandler:(unk)arg2  ;
-(void)triggerEffectWithParams:(id)arg0 completion:(id)arg1 ;
-(void)triggerEffectWithParams:(id)arg0 completionHandler:(id)arg1 ;
-(void)writeAttributeIdentifyTimeWithValue:(id)arg0 completion:(id)arg1 ;
-(void)writeAttributeIdentifyTimeWithValue:(id)arg0 completionHandler:(id)arg1 ;
-(void)writeAttributeIdentifyTimeWithValue:(id)arg0 params:(id)arg1 completion:(id)arg2 ;
-(void)writeAttributeIdentifyTimeWithValue:(id)arg0 params:(id)arg1 completionHandler:(id)arg2 ;
