...
-(id)readAttributeBindingWithParams:(id)arg0 ;
...
-(void)writeAttributeBindingWithValue:(id)arg0 expectedValueInterval:(id)arg1 ;
-(void)writeAttributeBindingWithValue:(id)arg0 expectedValueInterval:(id)arg1 params:(id)arg2 ;
