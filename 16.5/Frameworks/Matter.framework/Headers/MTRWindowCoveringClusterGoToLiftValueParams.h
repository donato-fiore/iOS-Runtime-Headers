...
#ifndef MTRWINDOWCOVERINGCLUSTERGOTOLIFTVALUEPARAMS_H
#define MTRWINDOWCOVERINGCLUSTERGOTOLIFTVALUEPARAMS_H
...
@property (copy, nonatomic) NSNumber *liftValue; // ivar: _liftValue
