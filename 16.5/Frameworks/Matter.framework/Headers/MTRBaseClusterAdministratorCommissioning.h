...
+(void)readAttributeAdminFabricIndexWithClusterStateCache:(id)arg0 endpoint:(id)arg1 queue:(id)arg2 completion:(id)arg3 ;
+(void)readAttributeAdminVendorIdWithAttributeCache:(id)arg0 endpoint:(id)arg1 queue:(id)arg2 completionHandler:(id)arg3 ;
+(void)readAttributeAdminVendorIdWithClusterStateCache:(id)arg0 endpoint:(id)arg1 queue:(id)arg2 completion:(id)arg3 ;
...
+(void)readAttributeWindowStatusWithClusterStateCache:(id)arg0 endpoint:(id)arg1 queue:(id)arg2 completion:(id)arg3 ;
-(id)initWithDevice:(id)arg0 endpoint:(unsigned short)arg1 queue:(id)arg2 ;
-(id)initWithDevice:(id)arg0 endpointID:(id)arg1 queue:(id)arg2 ;
-(void)openBasicCommissioningWindowWithParams:(id)arg0 completion:(id)arg1 ;
-(void)openBasicCommissioningWindowWithParams:(id)arg0 completionHandler:(id)arg1 ;
-(void)openCommissioningWindowWithParams:(id)arg0 completion:(id)arg1 ;
...
-(void)readAttributeAdminFabricIndexWithCompletion:(id)arg0 ;
-(void)readAttributeAdminFabricIndexWithCompletionHandler:(id)arg0 ;
-(void)readAttributeAdminVendorIdWithCompletion:(id)arg0 ;
...
-(void)readAttributeWindowStatusWithCompletion:(id)arg0 ;
-(void)readAttributeWindowStatusWithCompletionHandler:(id)arg0 ;
-(void)revokeCommissioningWithCompletion:(id)arg0 ;
-(void)revokeCommissioningWithCompletionHandler:(id)arg0 ;
-(void)revokeCommissioningWithParams:(id)arg0 completion:(id)arg1 ;
-(void)revokeCommissioningWithParams:(id)arg0 completionHandler:(id)arg1 ;
...
// -(void)subscribeAttributeAdminFabricIndexWithParams:(id)arg0 subscriptionEstablished:(id)arg1 reportHandler:(unk)arg2  ;
...
// -(void)subscribeAttributeAdminVendorIdWithParams:(id)arg0 subscriptionEstablished:(id)arg1 reportHandler:(unk)arg2  ;
...
// -(void)subscribeAttributeWindowStatusWithParams:(id)arg0 subscriptionEstablished:(id)arg1 reportHandler:(unk)arg2  ;
