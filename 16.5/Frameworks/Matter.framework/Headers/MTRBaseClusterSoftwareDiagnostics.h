...
+(void)readAttributeCurrentHeapFreeWithClusterStateCache:(id)arg0 endpoint:(id)arg1 queue:(id)arg2 completion:(id)arg3 ;
...
+(void)readAttributeCurrentHeapHighWatermarkWithClusterStateCache:(id)arg0 endpoint:(id)arg1 queue:(id)arg2 completion:(id)arg3 ;
+(void)readAttributeCurrentHeapUsedWithAttributeCache:(id)arg0 endpoint:(id)arg1 queue:(id)arg2 completionHandler:(id)arg3 ;
+(void)readAttributeCurrentHeapUsedWithClusterStateCache:(id)arg0 endpoint:(id)arg1 queue:(id)arg2 completion:(id)arg3 ;
...
+(void)readAttributeThreadMetricsWithClusterStateCache:(id)arg0 endpoint:(id)arg1 queue:(id)arg2 completion:(id)arg3 ;
...
-(void)readAttributeCurrentHeapFreeWithCompletion:(id)arg0 ;
-(void)readAttributeCurrentHeapFreeWithCompletionHandler:(id)arg0 ;
-(void)readAttributeCurrentHeapHighWatermarkWithCompletion:(id)arg0 ;
-(void)readAttributeCurrentHeapHighWatermarkWithCompletionHandler:(id)arg0 ;
-(void)readAttributeCurrentHeapUsedWithCompletion:(id)arg0 ;
...
-(void)readAttributeThreadMetricsWithCompletion:(id)arg0 ;
-(void)readAttributeThreadMetricsWithCompletionHandler:(id)arg0 ;
-(void)resetWatermarksWithCompletion:(id)arg0 ;
-(void)resetWatermarksWithCompletionHandler:(id)arg0 ;
-(void)resetWatermarksWithParams:(id)arg0 completion:(id)arg1 ;
...
// -(void)subscribeAttributeCurrentHeapFreeWithParams:(id)arg0 subscriptionEstablished:(id)arg1 reportHandler:(unk)arg2  ;
...
// -(void)subscribeAttributeCurrentHeapHighWatermarkWithParams:(id)arg0 subscriptionEstablished:(id)arg1 reportHandler:(unk)arg2  ;
...
// -(void)subscribeAttributeCurrentHeapUsedWithParams:(id)arg0 subscriptionEstablished:(id)arg1 reportHandler:(unk)arg2  ;
...
// -(void)subscribeAttributeThreadMetricsWithParams:(id)arg0 subscriptionEstablished:(id)arg1 reportHandler:(unk)arg2  ;
