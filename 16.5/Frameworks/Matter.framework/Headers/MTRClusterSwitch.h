...
#ifndef MTRCLUSTERSWITCH_H
#define MTRCLUSTERSWITCH_H
...
-(id)readAttributeCurrentPositionWithParams:(id)arg0 ;
-(id)readAttributeFeatureMapWithParams:(id)arg0 ;
-(id)readAttributeGeneratedCommandListWithParams:(id)arg0 ;
-(id)readAttributeMultiPressMaxWithParams:(id)arg0 ;
-(id)readAttributeNumberOfPositionsWithParams:(id)arg0 ;
