...
-(id)readAttributeMaxScaledValueWithParams:(id)arg0 ;
-(id)readAttributeMeasuredValueWithParams:(id)arg0 ;
-(id)readAttributeMinMeasuredValueWithParams:(id)arg0 ;
-(id)readAttributeMinScaledValueWithParams:(id)arg0 ;
-(id)readAttributeScaleWithParams:(id)arg0 ;
-(id)readAttributeScaledToleranceWithParams:(id)arg0 ;
-(id)readAttributeScaledValueWithParams:(id)arg0 ;
