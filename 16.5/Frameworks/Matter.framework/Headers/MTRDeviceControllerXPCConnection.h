...
-(void)deregisterReportHandlersWithController:(id)arg0 nodeID:(id)arg1 completion:(id)arg2 ;
...
-(void)registerReportHandlerWithController:(id)arg0 nodeID:(id)arg1 handler:(id)arg2 ;
