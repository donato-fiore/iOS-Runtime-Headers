...
#ifndef MTRCLUSTERUSERLABEL_H
#define MTRCLUSTERUSERLABEL_H
...
-(id)readAttributeLabelListWithParams:(id)arg0 ;
-(void)writeAttributeLabelListWithValue:(id)arg0 expectedValueInterval:(id)arg1 ;
-(void)writeAttributeLabelListWithValue:(id)arg0 expectedValueInterval:(id)arg1 params:(id)arg2 ;
