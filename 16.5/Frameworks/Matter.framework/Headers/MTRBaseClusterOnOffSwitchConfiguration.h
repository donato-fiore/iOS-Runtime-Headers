...
+(void)readAttributeSwitchActionsWithClusterStateCache:(id)arg0 endpoint:(id)arg1 queue:(id)arg2 completion:(id)arg3 ;
+(void)readAttributeSwitchTypeWithAttributeCache:(id)arg0 endpoint:(id)arg1 queue:(id)arg2 completionHandler:(id)arg3 ;
+(void)readAttributeSwitchTypeWithClusterStateCache:(id)arg0 endpoint:(id)arg1 queue:(id)arg2 completion:(id)arg3 ;
...
-(void)readAttributeSwitchActionsWithCompletion:(id)arg0 ;
-(void)readAttributeSwitchActionsWithCompletionHandler:(id)arg0 ;
-(void)readAttributeSwitchTypeWithCompletion:(id)arg0 ;
...
// -(void)subscribeAttributeSwitchActionsWithParams:(id)arg0 subscriptionEstablished:(id)arg1 reportHandler:(unk)arg2  ;
...
// -(void)subscribeAttributeSwitchTypeWithParams:(id)arg0 subscriptionEstablished:(id)arg1 reportHandler:(unk)arg2  ;
-(void)writeAttributeSwitchActionsWithValue:(id)arg0 completion:(id)arg1 ;
-(void)writeAttributeSwitchActionsWithValue:(id)arg0 completionHandler:(id)arg1 ;
-(void)writeAttributeSwitchActionsWithValue:(id)arg0 params:(id)arg1 completion:(id)arg2 ;
