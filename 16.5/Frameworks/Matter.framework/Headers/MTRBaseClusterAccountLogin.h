...
#ifndef MTRBASECLUSTERACCOUNTLOGIN_H
#define MTRBASECLUSTERACCOUNTLOGIN_H
...
-(void)getSetupPINWithParams:(id)arg0 completion:(id)arg1 ;
-(void)getSetupPINWithParams:(id)arg0 completionHandler:(id)arg1 ;
-(void)loginWithParams:(id)arg0 completion:(id)arg1 ;
-(void)loginWithParams:(id)arg0 completionHandler:(id)arg1 ;
-(void)logoutWithCompletion:(id)arg0 ;
-(void)logoutWithCompletionHandler:(id)arg0 ;
-(void)logoutWithParams:(id)arg0 completion:(id)arg1 ;
-(void)logoutWithParams:(id)arg0 completionHandler:(id)arg1 ;
