...
-(id)readAttributeCapabilityMinimaWithParams:(id)arg0 ;
-(id)readAttributeClusterRevisionWithParams:(id)arg0 ;
-(id)readAttributeDataModelRevisionWithParams:(id)arg0 ;
...
-(id)readAttributeLocalConfigDisabledWithParams:(id)arg0 ;
-(id)readAttributeLocationWithParams:(id)arg0 ;
...
-(void)mfgSpecificPingWithExpectedValues:(id)arg0 expectedValueInterval:(id)arg1 completion:(id)arg2 ;
-(void)mfgSpecificPingWithParams:(id)arg0 expectedValues:(id)arg1 expectedValueInterval:(id)arg2 completion:(id)arg3 ;
-(void)writeAttributeLocalConfigDisabledWithValue:(id)arg0 expectedValueInterval:(id)arg1 ;
-(void)writeAttributeLocalConfigDisabledWithValue:(id)arg0 expectedValueInterval:(id)arg1 params:(id)arg2 ;
-(void)writeAttributeLocationWithValue:(id)arg0 expectedValueInterval:(id)arg1 ;
-(void)writeAttributeLocationWithValue:(id)arg0 expectedValueInterval:(id)arg1 params:(id)arg2 ;
