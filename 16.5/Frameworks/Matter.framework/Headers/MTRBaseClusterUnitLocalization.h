...
#ifndef MTRBASECLUSTERUNITLOCALIZATION_H
#define MTRBASECLUSTERUNITLOCALIZATION_H
...
+(void)readAttributeTemperatureUnitWithClusterStateCache:(id)arg0 endpoint:(id)arg1 queue:(id)arg2 completion:(id)arg3 ;
...
-(void)readAttributeTemperatureUnitWithCompletion:(id)arg0 ;
...
// -(void)subscribeAttributeTemperatureUnitWithParams:(id)arg0 subscriptionEstablished:(id)arg1 reportHandler:(unk)arg2  ;
-(void)writeAttributeTemperatureUnitWithValue:(id)arg0 completion:(id)arg1 ;
-(void)writeAttributeTemperatureUnitWithValue:(id)arg0 completionHandler:(id)arg1 ;
-(void)writeAttributeTemperatureUnitWithValue:(id)arg0 params:(id)arg1 completion:(id)arg2 ;
-(void)writeAttributeTemperatureUnitWithValue:(id)arg0 params:(id)arg1 completionHandler:(id)arg2 ;
