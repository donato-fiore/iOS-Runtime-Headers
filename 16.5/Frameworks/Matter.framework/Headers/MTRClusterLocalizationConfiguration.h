...
-(id)readAttributeActiveLocaleWithParams:(id)arg0 ;
...
-(id)readAttributeSupportedLocalesWithParams:(id)arg0 ;
-(void)writeAttributeActiveLocaleWithValue:(id)arg0 expectedValueInterval:(id)arg1 ;
-(void)writeAttributeActiveLocaleWithValue:(id)arg0 expectedValueInterval:(id)arg1 params:(id)arg2 ;
