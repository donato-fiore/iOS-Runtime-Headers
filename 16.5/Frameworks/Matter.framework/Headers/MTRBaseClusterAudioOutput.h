...
+(void)readAttributeCurrentOutputWithClusterStateCache:(id)arg0 endpoint:(id)arg1 queue:(id)arg2 completion:(id)arg3 ;
...
+(void)readAttributeOutputListWithClusterStateCache:(id)arg0 endpoint:(id)arg1 queue:(id)arg2 completion:(id)arg3 ;
...
-(void)readAttributeCurrentOutputWithCompletion:(id)arg0 ;
...
-(void)readAttributeOutputListWithCompletion:(id)arg0 ;
-(void)readAttributeOutputListWithCompletionHandler:(id)arg0 ;
-(void)renameOutputWithParams:(id)arg0 completion:(id)arg1 ;
-(void)renameOutputWithParams:(id)arg0 completionHandler:(id)arg1 ;
-(void)selectOutputWithParams:(id)arg0 completion:(id)arg1 ;
...
// -(void)subscribeAttributeCurrentOutputWithParams:(id)arg0 subscriptionEstablished:(id)arg1 reportHandler:(unk)arg2  ;
...
// -(void)subscribeAttributeOutputListWithParams:(id)arg0 subscriptionEstablished:(id)arg1 reportHandler:(unk)arg2  ;
