...
+(id)programEvaluationErrorWithUnderlyingError:(id)arg0 format:(id)arg1 ;
+(id)programParsingAtLoadErrorWithReason:(int)arg0 format:(id)arg1 ;
+(id)programValidationAtLoadErrorWithReason:(int)arg0 format:(id)arg1 ;
