...
@interface MKBasicMapView : UIView <GEOResourceManifestTileGroupObserver>
 ...
 {
    UIView *_hostView;
    NSInteger _changingViewSizeCount;
}
...
-(id)initWithFrame:(struct CGRect )arg0 andGlobe:(BOOL)arg1 shouldRasterize:(BOOL)arg2 allowsAntialiasing:(BOOL)arg3 carDisplayType:(NSInteger)arg4 ;
