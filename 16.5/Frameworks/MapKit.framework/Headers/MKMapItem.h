...
@class NSDate, GEOMapItemStorageUserValues, NSString, NSNumberFormatter, NSDictionary, geo_isolater, NSArray, GEOBusinessAssets, GEOMapItemDetourInfo, GEOMapRegion, GEOEnhancedPlacement, GEOEnrichmentData, GEOEnrichmentInfo, GEOExploreGuides, NSData, GEOPDFlyover, GEOAddress, GEOMapItemStorage, GEOLabelGeometry, GEOBusinessHours, GEOMiniBrowseCategories, GEOMuninViewState, UIColor, GEOPlace, GEOModuleLayoutEntry, GEOPOIClaim, NSNumber, NSURL, GEOFeatureStyleAttributes, NSTimeZone, GEOViewportFrame;
...
-(id)_bestWalletHeroImageForSize:(struct CGSize )arg0 allowSmaller:(BOOL)arg1 ;
-(id)_cnPostalAddress;
