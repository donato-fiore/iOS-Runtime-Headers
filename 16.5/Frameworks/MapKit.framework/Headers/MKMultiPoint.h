...
-(void)_setCoordinates:(struct CLLocationCoordinate2D *)arg0 elevations:(*CGFloat)arg1 count:(NSUInteger)arg2 ;
-(void)_setPoints:(struct ? *)arg0 count:(NSUInteger)arg1 ;
-(void)_wrapAroundTheDateline:(struct CLLocationCoordinate2D *)arg0 elevations:(*CGFloat)arg1 count:(NSUInteger)arg2 ;
-(void)dealloc;
