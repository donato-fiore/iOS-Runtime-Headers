...
@property (nonatomic, getter=_labelEdgeWidths, setter=_setLabelEdgeWidths:) UIEdgeInsets labelEdgeWidths;
...
-(id)_commonInitFromIB:(BOOL)arg0 gestureRecognizerHostView:(id)arg1 locationManager:(id)arg2 showsAttribution:(BOOL)arg3 showsAppleLogo:(BOOL)arg4 allowsAntialiasing:(BOOL)arg5 carDisplayType:(NSInteger)arg6 ;
...
-(id)_initWithFrame:(struct CGRect )arg0 gestureRecognizerHostView:(id)arg1 showsAttribution:(BOOL)arg2 showsAppleLogo:(BOOL)arg3 allowsAntialiasing:(BOOL)arg4 carDisplayType:(NSInteger)arg5 ;
