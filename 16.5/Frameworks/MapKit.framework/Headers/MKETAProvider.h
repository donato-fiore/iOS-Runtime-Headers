...
@class NSNumber, NSString, NSTimer, GEOAutomobileOptions, CLLocation, GEOCyclingOptions, NSHashTable, NSLock, GEOTransitOptions, GEOWalkingOptions;
...
@property (nonatomic) BOOL allowsDistantETA; // ivar: _allowsDistantETA
