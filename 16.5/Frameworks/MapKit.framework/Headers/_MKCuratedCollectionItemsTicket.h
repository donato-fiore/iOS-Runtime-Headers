...
#ifndef _MKCURATEDCOLLECTIONITEMSTICKET_H
#define _MKCURATEDCOLLECTIONITEMSTICKET_H

@class NSString, GEOMapServiceTraits;
@protocol MKMapServiceCuratedCollectionItemsTicket, GEOMapServiceCuratedCollectionItemsTicket;
