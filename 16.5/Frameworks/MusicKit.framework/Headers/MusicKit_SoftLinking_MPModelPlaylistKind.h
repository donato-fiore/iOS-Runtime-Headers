...
#ifndef MUSICKIT_SOFTLINKING_MPMODELPLAYLISTKIND_H
#define MUSICKIT_SOFTLINKING_MPMODELPLAYLISTKIND_H

@class MPModelKind;



@interface MusicKit_SoftLinking_MPModelPlaylistKind : MPModelKind
