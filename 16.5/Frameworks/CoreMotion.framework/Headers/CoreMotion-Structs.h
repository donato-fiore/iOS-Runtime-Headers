...
typedef struct __compressed_pair<CLConnectionClient *, std::default_delete<CLConnectionClient>> {
    CLConnectionClient __value_;
} __compressed_pair<CLConnectionClient *, std::default_delete<CLConnectionClient>>;
...
typedef struct CLMotionActivity {
    ...
    CGFloat conservativeMountedProbability;
    BOOL isStanding;
    float tilt;
    CGFloat timestamp;
...
typedef struct MagicMountState {
    CGFloat field0;
    BOOL field1;
    BOOL field2;
    BOOL field3;
...
typedef struct CMCameraWorkoutLogger {
} // Error Processing Struct Fields

typedef struct __compressed_pair<CMCameraWorkoutLogger *, std::default_delete<CMCameraWorkoutLogger>> {
    CMCameraWorkoutLogger __value_;
} __compressed_pair<CMCameraWorkoutLogger *, std::default_delete<CMCameraWorkoutLogger>>;

typedef struct unique_ptr<CMCameraWorkoutLogger, std::default_delete<CMCameraWorkoutLogger>> {
    __compressed_pair<CMCameraWorkoutLogger *, std::default_delete<CMCameraWorkoutLogger>> __ptr_;
} unique_ptr<CMCameraWorkoutLogger, std::default_delete<CMCameraWorkoutLogger>>;
