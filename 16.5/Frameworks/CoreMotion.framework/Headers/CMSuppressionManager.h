...
-(void)feedDevicePresenceEvent:(NSInteger)arg0 timestamp:(CGFloat)arg1 force:(BOOL)arg2 ;
-(void)feedSmartPowerNapEvent:(NSInteger)arg0 timestamp:(CGFloat)arg1 force:(BOOL)arg2 ;
-(void)feedViewObstructedEvent:(NSInteger)arg0 timestamp:(CGFloat)arg1 force:(BOOL)arg2 ;
