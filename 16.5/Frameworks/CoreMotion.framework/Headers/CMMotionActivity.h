...
@property (readonly, nonatomic) CGFloat mountedProbability;
...
-(BOOL)isSameStateAs:(id)arg0 ;
-(id)copyWithZone:(struct _NSZone *)arg0 ;
-(id)description;
-(id)initWithCoder:(id)arg0 ;
-(id)initWithMotionActivity:(struct CLMotionActivity )arg0 ;
-(id)initWithMotionActivity:(struct CLMotionActivity )arg0 endDate:(id)arg1 ;
