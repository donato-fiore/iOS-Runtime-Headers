...
@interface CMMediaSession : NSObject <CMDistributedSensingDelegate>

 {
    ...
    *Dispatcher _accessoryDeviceMotionInEarStatusDispatcher;
    ...
    NSUInteger _lastFacePoseTimestampUs;
    NSUInteger _anchorUpdateIntervalUs;
...
@property (copy) NSString *mcLogPath; // ivar: _mcLogPath
...
-(int)_mapCMMediaSessionClientModeToRelDMClientMode:(NSInteger)arg0 ;
...
-(void)_updateClientMode:(NSInteger)arg0 ;
...
-(void)dealloc;
-(void)feedPoseAnchorWithAttitude:(struct ? )arg0 position:(struct CMVector<float, 3UL> )arg1 timestampUs:(NSUInteger)arg2 ;
