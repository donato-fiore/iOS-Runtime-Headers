...
@property (readonly, nonatomic) CGFloat segmentSWOLF;
...
-(id)initWithRecordId:(NSUInteger)arg0 sourceId:(id)arg1 sessionId:(id)arg2 startDate:(id)arg3 endDate:(id)arg4 strokeCount:(NSUInteger)arg5 distance:(CGFloat)arg6 avgPace:(CGFloat)arg7 lapCount:(NSUInteger)arg8 strokeType:(NSInteger)arg9 segment:(NSUInteger)arg10 SWOLF:(CGFloat)arg11 segmentSWOLF:(CGFloat)arg12 ;
