...
@interface CMMotionManagerInternal : NSObject {
    ...
    *Dispatcher fFactoryGyroDispatcher;
    CGFloat fFactoryGyroUpdateInterval;
    *Dispatcher fFactoryGyroTemperatureDispatcher;
    CGFloat fFactoryGyroTemperatureUpdateInterval;
    id *fFactoryGyroHandler;
    NSOperationQueue *fFactoryGyroQueue;
    CGFloat fLastFactoryGyroNotificationTimestamp;
    float fLastFactoryGyroTemperature;
    BOOL fFactoryGyroFitComputed;
    NonlinearGyroBiasFit fFactoryGyroNonlinearGyroBiasFit;
    LinearFit fFactoryGyroLinearGyroBiasFit;
    id *fKeyboardMotionHandler;
    NSOperationQueue *fKeyboardMotionQueue;
    *Dispatcher fKeyboardMotionDMDispatcher;
    CGFloat fKeyboardMotionTimestampGravityHidReportPrev;
    CMVector<float, 3UL> fKeyboardMotionGravityHIDReportPrev;
    float fKeyboardMotionGravityDeltaThreshold;
    float fKeyboardMotionGravityNotificationFrequency;
    *Dispatcher fKeyboardMotionDispatcher;
}
