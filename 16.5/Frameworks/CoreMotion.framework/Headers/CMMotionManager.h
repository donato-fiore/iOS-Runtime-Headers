...
+(void)setVirtualAlmondDevice:(id)arg0 ;
...
-(BOOL)sendDeviceMotionHostGravityToKeyboard:(struct ? *)arg0 ;
...
-(void)onDeviceMotionForKeyboardMotion:(struct Sample *)arg0 ;
-(void)onFactoryGyro:(struct Sample *)arg0 ;
-(void)onFactoryGyroTemperature:(struct Temperature *)arg0 ;
...
-(void)startDeviceMotionUpdatesForKeyboardMotionPrivateToQueue:(id)arg0 withGravityDeltaThreshold:(CGFloat)arg1 notificationFrequency:(CGFloat)arg2 andHandler:(id)arg3 ;
-(void)startDeviceMotionUpdatesForKeyboardMotionToQueue:(id)arg0 withGravityDeltaThreshold:(CGFloat)arg1 sendFrequency:(CGFloat)arg2 andHandler:(id)arg3 ;
...
-(void)startFactoryGyroUpdatesPrivateToQueue:(id)arg0 atUpdateInterval:(CGFloat)arg1 withHandler:(id)arg2 ;
-(void)startFactoryGyroUpdatesToQueue:(id)arg0 atUpdateInterval:(CGFloat)arg1 withHandler:(id)arg2 ;
-(void)startFactoryGyroUpdatesToQueue:(id)arg0 withHandler:(id)arg1 ;
