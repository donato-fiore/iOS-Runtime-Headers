...
@property (retain, nonatomic) NSString *proxyId; // ivar: _proxyId
...
@property BOOL shouldRecoverConnection; // ivar: _shouldRecoverConnection
...
// -(void)_checkIdResultForTCC:(id)arg0 synchronous:(BOOL)arg1 error:(id)arg2 retryBlock:(id)arg3 finally:(unk)arg4  ;
-(void)_connectToServerWithRecovery:(BOOL)arg0 userSession:(*unsigned int)arg1 legacyService:(BOOL)arg2 ;
-(void)_handleConnectionResult:(id)arg0 uuid:(id)arg1 proxyId:(id)arg2 error:(id)arg3 ;
// -(void)_performCallBool:(id)arg0 finally:(unk)arg1  ;
// -(void)_performCallId:(id)arg0 finally:(unk)arg1  ;
// -(void)_performSynchronous:(BOOL)arg0 callBool:(id)arg1 finally:(unk)arg2  ;
// -(void)_performSynchronous:(BOOL)arg0 callId:(id)arg1 finally:(unk)arg2  ;
...
-(void)evaluateACL:(id)arg0 operation:(id)arg1 options:(id)arg2 uiDelegate:(id)arg3 synchronous:(BOOL)arg4 reply:(id)arg5 ;
...
-(void)evaluatePolicy:(NSInteger)arg0 options:(id)arg1 uiDelegate:(id)arg2 synchronous:(BOOL)arg3 reply:(id)arg4 ;
...
-(void)verifyFileVaultUser:(id)arg0 volumeUuid:(id)arg1 options:(NSUInteger)arg2 reply:(id)arg3 ;
