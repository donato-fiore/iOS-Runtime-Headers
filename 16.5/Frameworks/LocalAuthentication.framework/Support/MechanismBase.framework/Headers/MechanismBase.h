...
@class NSDictionary, NSMutableDictionary, LAAssertionsProxy, NSMutableArray, EvaluationRequest, NSError;
...
@property (weak, nonatomic) MechanismBase *rootMechanism; // ivar: _rootMechanism
...
-(BOOL)_shouldMirrorToDefaultUiWithProcessing:(id)arg0 ;
...
-(id)fenceReplyWithTouchIdAssertions:(SEL)arg0 ;
...
-(id)tccPreflightWithAuditTokenData:(id)arg0 ;
-(id)tccService;
-(void)cancelAuthentication;
-(void)cancelByParent:(id)arg0 onSuccess:(BOOL)arg1 ;
