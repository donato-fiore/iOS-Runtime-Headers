...
@property (readonly, nonatomic) LAAnalyticsEvaluation *analytics; // ivar: _analytics
@property (readonly, nonatomic) BOOL customUI; // ivar: _customUI
@property (nonatomic) BOOL immediateSuccess; // ivar: _immediateSuccess
...
-(id)initWithAcl:(id)arg0 operation:(id)arg1 options:(id)arg2 uiDelegate:(id)arg3 ;
-(id)initWithPolicy:(NSInteger)arg0 options:(id)arg1 ;
-(id)initWithPolicy:(NSInteger)arg0 options:(id)arg1 uiDelegate:(id)arg2 ;
