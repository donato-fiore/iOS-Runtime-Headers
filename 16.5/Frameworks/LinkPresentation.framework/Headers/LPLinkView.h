...
@class UIView, NSHashTable, NSArray, NSMutableArray, NSString, UIColor, NSAttributedString, NSNumber, UIContextMenuInteraction, NSURL, NSRegularExpression;
...
#import "LPCollaborationHandle.h"
...
@interface LPLinkView : UIView <UIContextMenuInteractionDelegate, UIGestureRecognizerDelegate, CAAnimationDelegate, LPComponentViewHost, LPTapToLoadViewDelegate, LPThemeClient>

 {
    ...
    NSInteger _sharedObjectDownloadState;
}
...
@property (nonatomic, setter=_setBytesLoaded:) NSUInteger _bytesLoaded; // ivar: _bytesLoaded
@property (nonatomic, getter=_isCollaborative, setter=_setCollaborative:) BOOL _collaborative; // ivar: _collaborative
...
@property (nonatomic, setter=_setInSenderContext:) BOOL _inSenderContext; // ivar: _inSenderContext
...
@property (retain, nonatomic, setter=_setOverrideSubtitleButtonColor:) UIColor *_overrideSubtitleButtonColor; // ivar: _overrideSubtitleButtonColor
...
@property (nonatomic, getter=_isShowingDisclosureView, setter=_setShowingDisclosureView:) BOOL _showingDisclosureView; // ivar: _showingDisclosureView
@property (copy, nonatomic, setter=_setSizeClassParameters:) LPLinkRendererSizeClassParameters *_sizeClassParameters; // ivar: _sizeClassParameters
...
-(BOOL)showingDisclosureViewForComponentView:(id)arg0 ;
...
-(NSInteger)sharedObjectDownloadStateForComponentView:(id)arg0 ;
...
-(void)_removeCaptionButtonWithType:(NSInteger)arg0 ;
...
-(void)_setButtonActions:(id)arg0 ;
-(void)_setCollaborationFooterViewModel:(id)arg0 action:(id)arg1 ;
-(void)_setCollaborationHandle:(id)arg0 withNameComponents:(id)arg1 ;
...
-(void)_setOverrideSubtitle:(id)arg0 ;
...
-(void)componentViewDidTapCaptionButton:(id)arg0 buttonType:(NSInteger)arg1 ;
