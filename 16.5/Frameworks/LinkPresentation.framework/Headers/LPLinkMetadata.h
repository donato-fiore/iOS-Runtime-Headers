...
@class NSMutableArray, NSURL, NSArray, NSString, _SWCollaborationMetadata, TUConversationActivity, NSItemProvider, SYContentItem;
...
@property (nonatomic, getter=_isIncomplete, setter=_setIncomplete:) BOOL _incomplete; // ivar: __incomplete
...
@property (nonatomic) NSInteger collaborationType; // ivar: _collaborationType
@property (copy, nonatomic) TUConversationActivity *conversationActivity; // ivar: _conversationActivity
...
@property (copy, nonatomic) NSString *twitterCard; // ivar: _twitterCard
@property (nonatomic) BOOL usesActivityPub; // ivar: _usesActivityPub
...
-(BOOL)_isEqualIgnoringURLs:(id)arg0 ;
...
-(id)_initWithConversationActivity:(id)arg0 ;
