...
@class NSString;
@protocol LPLinkMetadataPresentationTransformer, LPLinkMetadataBackwardCompatibility, LPLinkMetadataPreviewTransformer, LPLinkMetadataSourceApplicationTransformer, LPLinkMetadataDownloadProgressTransformer, LPLinkMetadataFallbackIconTransformer;
...
-(id)_applicationFromURL:(id)arg0 ;
