...
#ifndef INRADIOTYPERESOLUTIONRESULT_H
#define INRADIOTYPERESOLUTIONRESULT_H
...
+(id)confirmationRequiredWithRadioTypeToConfirm:(NSInteger)arg0 ;
+(id)confirmationRequiredWithValueToConfirm:(NSInteger)arg0 ;
+(id)successWithResolvedRadioType:(NSInteger)arg0 ;
