...
#ifndef INREQUESTPAYMENTCURRENCYAMOUNTRESOLUTIONRESULT_H
#define INREQUESTPAYMENTCURRENCYAMOUNTRESOLUTIONRESULT_H
...
-(id)initWithCurrencyAmountResolutionResult:(id)arg0 ;
