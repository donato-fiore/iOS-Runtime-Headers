...
#ifndef _INPBGETCARLOCKSTATUSINTENTRESPONSE_H
#define _INPBGETCARLOCKSTATUSINTENTRESPONSE_H

@class PBCodable, NSString;
@protocol _INPBGetCarLockStatusIntentResponse, NSSecureCoding, NSCopying;
