...
@protocol INCacheableContainer, INImageProxyInjecting, INKeyImageProducing, INEnumerable, INMessageExport, NSCopying, NSSecureCoding;
...
-(id)initWithIdentifier:(id)arg0 conversationIdentifier:(id)arg1 content:(id)arg2 dateSent:(id)arg3 sender:(id)arg4 recipients:(id)arg5 groupName:(id)arg6 dateMessageWasLastRead:(id)arg7 numberOfAttachments:(id)arg8 messageType:(NSInteger)arg9 messageEffectType:(NSInteger)arg10 referencedMessage:(id)arg11 serviceName:(id)arg12 audioMessageFile:(id)arg13 ;
...
-(id)initWithIdentifier:(id)arg0 conversationIdentifier:(id)arg1 content:(id)arg2 dateSent:(id)arg3 sender:(id)arg4 recipients:(id)arg5 groupName:(id)arg6 messageType:(NSInteger)arg7 serviceName:(id)arg8 audioMessageFile:(id)arg9 ;
