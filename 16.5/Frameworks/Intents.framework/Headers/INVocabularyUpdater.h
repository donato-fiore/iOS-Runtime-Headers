...
+(void)clearAllCustomVocabularyOnBehalfOf:(id)arg0 ;
-(void)setCustomPhotoAlbumNames:(id)arg0 ;
-(void)setValidatedVocabulary:(id)arg0 forIntentSlot:(id)arg1 onBehalfOf:(id)arg2 validationCompletion:(id)arg3 ;
