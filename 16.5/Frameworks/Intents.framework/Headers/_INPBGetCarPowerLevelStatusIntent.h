...
#ifndef _INPBGETCARPOWERLEVELSTATUSINTENT_H
#define _INPBGETCARPOWERLEVELSTATUSINTENT_H

@class PBCodable, NSString;
@protocol _INPBGetCarPowerLevelStatusIntent, NSSecureCoding, NSCopying;
