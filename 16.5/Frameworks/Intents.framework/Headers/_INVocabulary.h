...
-(void)_setVocabulary:(id)arg0 ofType:(NSInteger)arg1 onBehalfOf:(id)arg2 ;
-(void)removeAllVocabularyStrings;
-(void)removeAllVocabularyStringsOnBehalfOf:(id)arg0 ;
-(void)setValidatedVocabulary:(id)arg0 ofType:(NSInteger)arg1 ;
-(void)setValidatedVocabulary:(id)arg0 ofType:(NSInteger)arg1 onBehalfOf:(id)arg2 ;
-(void)setVocabulary:(id)arg0 ofType:(NSInteger)arg1 ;
-(void)setVocabulary:(id)arg0 ofType:(NSInteger)arg1 onBehalfOf:(id)arg2 ;
