...
#ifndef INMODIFYNICKNAME_H
#define INMODIFYNICKNAME_H
...
@property (readonly, copy, nonatomic) NSString *targetNickname; // ivar: _targetNickname
...
-(id)initWithTargetNickname:(id)arg0 isRemoval:(id)arg1 ;
