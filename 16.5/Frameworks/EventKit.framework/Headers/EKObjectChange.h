...
+(void)objectChangesInCalendar:(id)arg0 resultHandler:(id)arg1 ;
+(void)objectChangesInSource:(id)arg0 resultHandler:(id)arg1 ;
+(void)objectChangesInStore:(id)arg0 resultHandler:(id)arg1 ;
+(void)objectChangesOfType:(id)arg0 inCalendar:(id)arg1 resultHandler:(id)arg2 ;
+(void)objectChangesOfType:(id)arg0 inSource:(id)arg1 resultHandler:(id)arg2 ;
+(void)objectChangesOfType:(id)arg0 inStore:(id)arg1 resultHandler:(id)arg2 ;
