...
@class NSSet, CNAutocompleteStore, NSMutableArray, NSString;
@protocol CNAutocompleteFetchDelegate, CNCancelable, EKAutocompleterDelegate, OS_dispatch_queue;
...
@property (retain) NSObject<OS_dispatch_queue> *directorySearchQueue; // ivar: _directorySearchQueue
...
-(BOOL)directorySearchWithCompletion:(id)arg0 ;
-(BOOL)isRunning;
-(id)allResults;
