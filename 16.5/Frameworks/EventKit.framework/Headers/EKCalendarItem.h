...
-(id)_dataFromStructuredDataDictionary:(id)arg0 local:(BOOL)arg1 ;
-(id)_generateNewUniqueID;
-(id)_structuredDataDictionaryFromData:(id)arg0 local:(BOOL)arg1 ;
-(id)action;
-(id)actionString;
...
-(void)_addOrganizerAndSelfAttendeeForNewInvitationInCalendar:(id)arg0 ;
...
-(void)_updatePersistentObjectOfSelfAndDetachedItemsExceptForSavingItem:(id)arg0 ;
-(void)_willSave;
