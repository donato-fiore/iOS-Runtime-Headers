...
-(BOOL)_anotherCalendarForDefaultSchedulingExistsWithAllKnownCalendars:(id)arg0 ;
-(BOOL)_anotherCalendarForRemindersExistsWithAllKnownCalendars:(id)arg0 ;
-(BOOL)_anyCalendarExistsInSameSourceOfType:(NSUInteger)arg0 withAllKnownCalendars:(id)arg1 passingTest:(id)arg2 ;
-(BOOL)_flagValueWithMask:(unsigned int)arg0 ;
-(BOOL)_reset;
-(BOOL)_validateAccessConsent:(*id)arg0 ;
-(BOOL)_validateDeletable:(*id)arg0 ;
-(BOOL)_validateDeletableHelperWithAllKnownCalendars:(id)arg0 error:(*id)arg1 ;
-(BOOL)_validateDeletableWithAllKnownCalendars:(id)arg0 error:(*id)arg1 ;
-(BOOL)allowEvents;
-(BOOL)allowReminders;
...
-(BOOL)isDeletable;
-(BOOL)isDeletableWithAllKnownCalendars:(id)arg0 ;
...
-(id)pushKey;
-(id)refreshDate;
-(id)reorderCalendars:(id)arg0 betweenEarlier:(id)arg1 later:(id)arg2 ;
...
-(void)removeServerRefreshRelatedPropertiesForSelfAndAllEventsSaveAndCommitWithError:(*id)arg0 ;
-(void)removeSharee:(id)arg0 ;
-(void)reorderBetweenEarlier:(id)arg0 later:(id)arg1 ;
-(void)reset;
-(void)rollback;
...
-(void)setChinaHolidayCalendar:(BOOL)arg0 ;
...
-(void)setIsSubscribedCalendarJunk:(BOOL)arg0 ;
...
-(void)setMigrationVersion:(int)arg0 ;
...
-(void)setSyncedHolidayCalendar:(BOOL)arg0 ;
