...
@property (nonatomic) BOOL skipModificationValidation; // ivar: _skipModificationValidation
...
+(NSUInteger)predicatePropertyLoadMode;
...
+(id)_iMIPScheduledEvent:(id)arg0 ;
...
+(void)setPredicatePropertyLoadMode:(NSUInteger)arg0 ;
...
-(id)calendarsForEntityType:(NSUInteger)arg0 inSource:(id)arg1 ;
...
-(void)_cacheDeletedEventIdentifierIfNeededForObject:(id)arg0 ;
