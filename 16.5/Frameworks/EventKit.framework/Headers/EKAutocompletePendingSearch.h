...
@class NSString;
@protocol EKAutocompletePendingSearchProtocol, EKAutocompleteSearchPasteboardItemProvider, CalSpotlightQueryPendingSearchProtocol;
...
-(BOOL)_shouldReturnResultForEvent:(id)arg0 considerReadonlyEvents:(BOOL)arg1 ;
-(id)firstNaturalLanguageResultWithSearchString:(id)arg0 ;
-(id)initWithEventStore:(id)arg0 searchString:(id)arg1 maximumResultCount:(NSUInteger)arg2 ignoreScheduledEvents:(BOOL)arg3 initialEvent:(id)arg4 pasteboardItemProvider:(id)arg5 completionHandler:(id)arg6 ;
-(void)cancel;
