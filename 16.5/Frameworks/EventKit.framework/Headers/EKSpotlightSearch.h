...
// +(id)searchWithCSQuery:(id)arg0 inStore:(id)arg1 inCalendars:(id)arg2 resultHandler:(id)arg3 completionHandler:(unk)arg4  ;
// -(id)initWithSearchWithCSQuery:(id)arg0 inStore:(id)arg1 inCalendars:(id)arg2 resultHandler:(id)arg3 completionHandler:(unk)arg4  ;
-(id)query;
-(void)cancel;
-(void)start;
