...
-(CGFloat)INUIAddVoiceShortcutDefaultCornerRadius;
-(CGFloat)INUIAddVoiceShortcutDefaultHeight;
-(CGFloat)INUIAddVoiceShortcutDefaultHorizontalMargin;
-(CGFloat)INUIAddVoiceShortcutDefaultHorizontalPadding;
-(CGFloat)INUIAddVoiceShortcutIconWidthHeight;
-(CGFloat)_strokeWidthForStyle:(NSUInteger)arg0 ;
-(CGFloat)metricsScale;
-(id)_addToSiriFont;
-(id)_addToSiriText;
-(id)_addedToSiriText;
