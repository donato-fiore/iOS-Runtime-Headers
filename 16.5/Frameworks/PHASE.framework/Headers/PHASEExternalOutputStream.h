...
-(id)description;
-(id)init;
-(id)initWithStreamGroupUUID:(id)arg0 streamUUID:(id)arg1 engine:(id)arg2 streamDefinition:(id)arg3 startsPaused:(BOOL)arg4 delegate:(id)arg5 renderBlock:(id)arg6 ;
-(void)dealloc;
