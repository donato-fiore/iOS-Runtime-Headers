...
@property (readonly) NSUInteger ioStartHostTime; // ivar: _ioStartHostTime
...
@property (readonly) NSUInteger preparedHostTime; // ivar: _preparedHostTime
...
-(BOOL)validateAudioSessionWithError:(*id)arg0 ;
-(NSUInteger)hash;
-(id)description;
