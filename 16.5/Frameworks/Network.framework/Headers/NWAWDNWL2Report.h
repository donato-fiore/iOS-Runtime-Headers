...
@property (nonatomic) CGFloat cellularSnr; // ivar: _cellularSnr
...
@property (nonatomic) BOOL wifiIsApplePersonalHotspot; // ivar: _wifiIsApplePersonalHotspot
@property (nonatomic) BOOL wifiIsHotspot; // ivar: _wifiIsHotspot
...
-(id)cellularOutrankPrimaryReasonAsString:(int)arg0 ;
...
-(int)StringAsCellularOutrankPrimaryReason:(id)arg0 ;
