...
#ifndef SNSOUNDPRINTASMOKEALARMMODEL_H
#define SNSOUNDPRINTASMOKEALARMMODEL_H
...
-(id)predictionFromInput1:(id)arg0 stateIn:(id)arg1 thresholdedHistoryIn:(id)arg2 detectedHistoryIn:(id)arg3 error:(*id)arg4 ;
