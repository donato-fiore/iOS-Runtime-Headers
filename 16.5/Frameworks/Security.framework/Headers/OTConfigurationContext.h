...
@property (nonatomic) NSInteger escrowFetchSource; // ivar: _escrowFetchSource
@property (nonatomic) BOOL octagonCapableRecordsExist; // ivar: _octagonCapableRecordsExist
@property (retain) OTControl *otControl; // ivar: _otControl
@property (nonatomic) BOOL overrideEscrowCache;
@property (nonatomic) BOOL overrideForJoinAfterRestore; // ivar: _overrideForJoinAfterRestore
@property (nonatomic) BOOL overrideForSetupAccountScript; // ivar: _overrideForSetupAccountScript
