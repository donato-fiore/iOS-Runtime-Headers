...
-(void)fetchAccountWideSettingsWithForceFetch:(BOOL)arg0 arguments:(id)arg1 reply:(id)arg2 ;
...
-(void)fetchEscrowRecords:(id)arg0 source:(NSInteger)arg1 reply:(id)arg2 ;
...
-(void)getAccountMetadata:(id)arg0 reply:(id)arg1 ;
...
-(void)isRecoveryKeySet:(id)arg0 reply:(id)arg1 ;
...
-(void)preflightRecoverOctagonUsingRecoveryKey:(id)arg0 recoveryKey:(id)arg1 reply:(id)arg2 ;
-(void)recoverWithRecoveryKey:(id)arg0 recoveryKey:(id)arg1 reply:(id)arg2 ;
...
-(void)removeRecoveryKey:(id)arg0 reply:(id)arg1 ;
-(void)reset:(id)arg0 ;
-(void)resetAccountCDPContents:(id)arg0 idmsTargetContext:(id)arg1 idmsCuttlefishPassword:(id)arg2 notifyIdMS:(BOOL)arg3 reply:(id)arg4 ;
-(void)resetAndEstablish:(id)arg0 resetReason:(NSInteger)arg1 idmsTargetContext:(id)arg2 idmsCuttlefishPassword:(id)arg3 notifyIdMS:(BOOL)arg4 accountSettings:(id)arg5 reply:(id)arg6 ;
...
-(void)setAccountSetting:(id)arg0 setting:(id)arg1 reply:(id)arg2 ;
...
-(void)tlkRecoverabilityForEscrowRecordData:(id)arg0 recordData:(id)arg1 source:(NSInteger)arg2 reply:(id)arg3 ;
