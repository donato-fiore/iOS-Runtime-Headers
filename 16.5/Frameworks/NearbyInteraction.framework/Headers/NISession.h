...
@protocol UWBSessionDelegateProxyProtocol, ARInternalSessionObserver, OS_dispatch_queue, OS_dispatch_semaphore, OS_os_log, NISessionDelegate, NIInternalSessionDelegate;
...
-(void)_activateSyncWithTimeout:(CGFloat)arg0 ;
