...
@property (retain, nonatomic) MPMediaLibrary *mediaLibraryOverrideForTestingOnly; // ivar: _mediaLibraryOverrideForTestingOnly
...
+(id)libraryViewWithMediaLibraryOverrideForTestingOnly:(id)arg0 ;
