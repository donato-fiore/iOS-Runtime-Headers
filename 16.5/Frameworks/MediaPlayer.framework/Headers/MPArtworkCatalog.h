...
+(id)artworkCacheForIdentifier:(id)arg0 requestingContext:(id)arg1 representationKind:(NSInteger)arg2 ;
...
-(void)dealloc;
-(void)requestColorAnalysisWithAlgorithm:(NSInteger)arg0 completion:(id)arg1 ;
