...
@protocol MPMutableLocalLibraryIdentifiers, MPMutablePersonalStoreIdentifiers, MPMutableUniversalStoreIdentifiers, MPMutableRadioIdentifiers, MPMutableIdentifierSet, MPMutableMusicKitIdentifiers, MPMusicKitIdentifiers, NSCopying, NSSecureCoding, MPLocalLibraryIdentifiers, MPPersonalStoreIdentifiers, MPRadioIdentifiers, MPUniversalStoreIdentifiers;
...
@property (copy, nonatomic) NSString *cloudArtistID; // ivar: _cloudArtistID
...
@property (nonatomic) NSInteger lyricsAdamID; // ivar: _lyricsAdamID
...
@property (nonatomic, setter=musicKit_setPossibleLibraryPersistentID:) NSInteger musicKit_possibleLibraryPersistentID; // ivar: _musicKit_possibleLibraryPersistentID
@property (copy, nonatomic) NSString *opaqueID; // ivar: _opaqueID
...
@property (copy, nonatomic) NSString *versionHash; // ivar: _versionHash
...
-(id)_copyWithSources:(id)arg0 block:(id)arg1 ;
-(id)_initWithSources:(id)arg0 modelKind:(id)arg1 block:(id)arg2 ;
-(id)_stateDumpObject;
-(id)copyWithBlock:(id)arg0 ;
-(id)copyWithMusicKitBlock:(id)arg0 ;
-(id)copyWithSource:(id)arg0 block:(id)arg1 ;
-(id)copyWithSource:(id)arg0 musicKitBlock:(id)arg1 ;
-(id)copyWithZone:(struct _NSZone *)arg0 ;
-(id)identifierDescriptions:(BOOL)arg0 ;
-(id)initWithBlock:(id)arg0 ;
-(id)initWithCoder:(id)arg0 ;
-(id)initWithModelKind:(id)arg0 block:(id)arg1 ;
-(id)initWithModelKind:(id)arg0 musicKitBlock:(id)arg1 ;
-(id)initWithSource:(id)arg0 modelKind:(id)arg1 block:(id)arg2 ;
-(id)initWithSource:(id)arg0 modelKind:(id)arg1 musicKitBlock:(id)arg2 ;
...
-(id)unionSet:(id)arg0 ;
-(id)unionSet:(id)arg0 block:(id)arg1 ;
...
-(void)setStoreCloudArtistID:(id)arg0 ;
