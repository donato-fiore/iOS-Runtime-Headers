...
@protocol MPRemoteCommandDelegate_Internal;
...
@property (readonly, nonatomic) MPPrepareForSetPlaybackQueueCommand *prepareForSetPlaybackQueueCommand; // ivar: _prepareForSetPlaybackQueueCommand
@property (readonly, nonatomic) MPRemoteCommand *prepareVocalsControlCommand; // ivar: _prepareVocalsControlCommand
...
@property (readonly, nonatomic) MPVocalsControlCommand *vocalsControlCommand; // ivar: _vocalsControlCommand
...
-(void)_scheduleSupportedCommandsChanged:(BOOL)arg0 ;
