...
@class NSString, NSData, NSNumber, NSDictionary, ICUserIdentity;
...
@property (copy, nonatomic) NSString *overrideSILSectionID; // ivar: _overrideSILSectionID
...
@property (copy, nonatomic) NSNumber *privateListeningOverride; // ivar: _privateListeningOverride
