...
@class AVAsset, AVPlayerItem, NSArray, AVPlayerItemMetadataOutput, AVPlayerItemAccessLog, NSString, NSNumber, NSError, ICMusicSubscriptionLeaseStatus, NSDictionary;
...
@property (nonatomic, getter=isConfiguredForVocalAttenuation) BOOL configuredForVocalAttenuation; // ivar: _configuredForVocalAttenuation
...
@property (nonatomic) BOOL isStartItem; // ivar: _isStartItem
...
@property (readonly, nonatomic) NSInteger lyricsAdamID;
...
@property (nonatomic) NSInteger nowPlayingInfoQueueCount; // ivar: _nowPlayingInfoQueueCount
@property (nonatomic) NSInteger nowPlayingInfoQueueIndex; // ivar: _nowPlayingInfoQueueIndex
...
@property (readonly, copy, nonatomic) NSString *queueItemID; // ivar: _queueItemID
@property (readonly, copy, nonatomic) NSString *queueSectionID; // ivar: _queueSectionID
@property (readonly, nonatomic, getter=isRadioItem) BOOL radioItem;
@property (readonly, nonatomic) NSInteger reportingAdamID;
...
@property (readonly, nonatomic) NSInteger storeAlbumArtistID;
...
-(void)updateContentItemQueueIndex:(NSInteger)arg0 count:(NSInteger)arg1 ;
