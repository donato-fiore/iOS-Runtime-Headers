...
@class NSString, NSXPCConnection, NSXPCListener, UIView;
...
@property (copy, nonatomic) id *customRowDidTapHandler; // ivar: _customRowDidTapHandler
...
-(void)addCustomRowWithType:(id)arg0 titleOverride:(id)arg1 identifier:(id)arg2 ;
-(void)dealloc;
-(void)dismiss;
-(void)openConnection;
-(void)present;
-(void)setDismissalReason:(NSUInteger)arg0 ;
-(void)setTappedCustomRowIdentifier:(id)arg0 ;
