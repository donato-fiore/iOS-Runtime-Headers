...
@class NSArray, NSMutableDictionary, NSMutableArray, NSPointerArray, NSString, NSDate, ML3MusicLibrary, MSVSQLDatabase, NSURL, NSNumber, ICUserIdentity;
...
-(?)_updateDeviceLibrary:(?)arg0 expectedEntityCountForEntityClasscount;
...
-(id)_addPlaylistWithName:(id)arg0 activeGeniusPlaylist:(BOOL)arg1 externalVendorIdentifier:(id)arg2 ;
-(id)_addPlaylistWithName:(id)arg0 externalVendorIdentifier:(id)arg1 ;
...
-(id)entityWithSiriSyncIdentifier:(id)arg0 ;
