...
@property (nonatomic) BOOL userQueueModificationsDisabled; // ivar: _userQueueModificationsDisabled
...
-(NSInteger)_serverRepeatMode;
-(NSInteger)_serverShuffleMode;
...
-(void)_setServerRepeatMode:(NSInteger)arg0 ;
-(void)_setServerShuffleMode:(NSInteger)arg0 ;
...
// -(void)prepareToPlayWithCompletionHandler:(id)arg0 timeout:(unk)arg1  ;
