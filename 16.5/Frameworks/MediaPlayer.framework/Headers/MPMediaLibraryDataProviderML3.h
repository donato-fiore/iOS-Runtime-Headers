...
-(BOOL)collectionExistsWithCloudLibraryID:(id)arg0 groupingType:(NSInteger)arg1 existentPID:(*NSUInteger)arg2 ;
...
-(id)_adjustedItemPropertyBookletsOfEntity:(id)arg0 withDefaultValue:(id)arg1 ;
...
-(void)_importStoreArtistElements:(id)arg0 withReferralObject:(id)arg1 withCompletion:(id)arg2 ;
-(void)_importStoreItemElements:(id)arg0 withReferralObject:(id)arg1 addTracksToDeviceLibraryOnly:(BOOL)arg2 andAddTracksToCloudLibrary:(BOOL)arg3 usingCloudAdamID:(NSInteger)arg4 withCompletion:(id)arg5 ;
-(void)_invalidatePersistentKeysForIdentifiers:(*NSInteger)arg0 count:(NSUInteger)arg1 ;
...
-(void)addToLocalDeviceLibraryGlobalPlaylistWithID:(id)arg0 completion:(id)arg1 ;
...
-(void)performStoreArtistLibraryImport:(id)arg0 withCompletion:(id)arg1 ;
...
-(void)sdk_addItemWithSagaIdentifier:(NSInteger)arg0 toPlaylistWithIdentifier:(NSInteger)arg1 completionBlock:(id)arg2 ;
