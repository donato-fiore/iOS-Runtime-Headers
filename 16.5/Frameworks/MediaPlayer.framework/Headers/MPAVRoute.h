...
@property (readonly, nonatomic) NSArray *clusterCompositionRoutes; // ivar: _clusterCompositionRoutes
...
@property (weak, nonatomic) MPAVRoute *parentRoute; // ivar: _parentRoute
@property (readonly, nonatomic) NSInteger passwordType;
@property (readonly, nonatomic, getter=isPhoneRoute) BOOL phoneRoute;
@property (readonly, nonatomic, getter=isPickable) BOOL pickable; // ivar: _pickable
...
@property (readonly, nonatomic) NSArray *subRoutes; // ivar: _subRoutes
...
@property (readonly, nonatomic) BOOL supportsPicking; // ivar: _supportsPicking
