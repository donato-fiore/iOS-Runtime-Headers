...
@property (retain, nonatomic) NSArray *propertyFilters; // ivar: _propertyFilters
@property (retain, nonatomic) NSArray *scopedContainers; // ivar: _scopedContainers
@property (nonatomic) BOOL sortUsingAllowedEntityIdentifiers; // ivar: _sortUsingAllowedEntityIdentifiers
