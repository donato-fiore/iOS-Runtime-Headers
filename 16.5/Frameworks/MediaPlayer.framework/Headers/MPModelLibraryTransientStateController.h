...
-(id)registerTransientFavoriteState:(NSInteger)arg0 forModelObjects:(id)arg1 relatedModelObjects:(id)arg2 ;
...
-(void)performFavoriteStateChangeRequest:(id)arg0 withRelatedModelObjects:(id)arg1 ;
-(void)performFavoriteStateChangeRequest:(id)arg0 withRelatedModelObjects:(id)arg1 completion:(id)arg2 ;
