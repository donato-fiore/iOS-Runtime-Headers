...
@protocol HMHomeManagerDelegatePrivate, HMHomeDelegate, HMHomeDelegatePrivate, OS_dispatch_queue, MPHomeManagerObserverDelegate;
...
@interface MPHomeManagerObserver : NSObject <HMHomeManagerDelegatePrivate, HMHomeDelegate, HMHomeDelegatePrivate>

 {
    ...
    NSUInteger _homekitInitSignpostId;
}
