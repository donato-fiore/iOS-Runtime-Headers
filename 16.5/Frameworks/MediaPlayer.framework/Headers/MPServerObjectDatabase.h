...
@protocol MPMediaKitEntityRelationshipPayloadProvider, MPObjectDatabase, OS_dispatch_queue;
...
-(id)_modelObjectMatchingIdentifierSet:(id)arg0 propertySet:(id)arg1 error:(*id)arg2 ;
...
-(id)identifiersMatchingIdentifierSet:(id)arg0 propertySet:(id)arg1 options:(NSUInteger)arg2 ;
-(id)identifiersMatchingIdentifierSet:(id)arg0 propertySet:(id)arg1 options:(NSUInteger)arg2 error:(*id)arg3 ;
-(id)identifiersMatchingIdentifierSet:(id)arg0 propertySet:(id)arg1 options:(NSUInteger)arg2 trustID:(id)arg3 error:(*id)arg4 ;
...
-(id)modelObjectMatchingIdentifierSet:(id)arg0 propertySet:(id)arg1 trustID:(id)arg2 error:(*id)arg3 ;
