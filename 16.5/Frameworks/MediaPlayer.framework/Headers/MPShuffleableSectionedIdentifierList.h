...
+(NSInteger)enumerationCandidateDequeueQuota;
+(NSInteger)initialCandidateDequeueQuota;
+(void)setEnumerationCandidateDequeueQuota:(NSInteger)arg0 ;
+(void)setInitialCandidateDequeueQuota:(NSInteger)arg0 ;
...
-(void)addDataSource:(id)arg0 section:(id)arg1 beforeTailOfSection:(id)arg2 completion:(id)arg3 ;
...
-(void)addDataSource:(id)arg0 section:(id)arg1 sequentially:(BOOL)arg2 beforeTailOfSection:(id)arg3 completion:(id)arg4 ;
...
-(void)dataSourceReloadItems:(id)arg0 inSection:(id)arg1 ;
-(void)dataSourceRemoveItems:(id)arg0 fromSection:(id)arg1 ;
