...
@class UIViewController, NSURL, _UIAsyncInvocation, SURedeemCameraViewController, SKInvocationQueueProxy<SKUIServiceAccountPageViewController>, ACAccount, AMSMutableBinaryPromise, NSString, AMSUIWebViewController;
...
@property (retain, nonatomic) AMSMutableBinaryPromise *connectionSetupPromise; // ivar: _connectionSetupPromise
...
@property (retain, nonatomic) AMSUIWebViewController *webViewController; // ivar: _webViewController
...
-(id)_URLForBagKey:(id)arg0 ;
-(id)_overrideScheme:(id)arg0 ;
-(id)_redeemURLFromRedeemConfigURL:(id)arg0 ;
-(id)initWithAccountURL:(id)arg0 ;
-(id)initWithAccountURL:(id)arg0 forceLegacy:(BOOL)arg1 ;
-(void)_addRemoteView;
-(void)_beginURLParsing:(id)arg0 forceLegacy:(BOOL)arg1 ;
