...
@property (nonatomic, setter=_setInteractionRegionInlinePadding:) CGFloat _interactionRegionInlinePadding;
@property (nonatomic, setter=_setInteractionRegionMinimumCornerRadius:) CGFloat _interactionRegionMinimumCornerRadius;
...
@property (nonatomic, setter=_setMediaPreferredFullscreenWidth:) CGFloat _mediaPreferredFullscreenWidth;
