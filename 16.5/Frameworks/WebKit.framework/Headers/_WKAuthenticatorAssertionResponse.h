...
-(id)initWithClientDataJSON:(id)arg0 rawId:(id)arg1 extensionOutputsCBOR:(id)arg2 authenticatorData:(id)arg3 signature:(id)arg4 userHandle:(id)arg5 attachment:(NSInteger)arg6 ;
