...
@protocol UINavigationControllerDelegate, UIImagePickerControllerDelegate, UIDocumentPickerDelegate, UIAdaptivePresentationControllerDelegate, UIContextMenuInteractionDelegate, PHPickerViewControllerDelegate, WKFileUploadPanelDelegate;
...
@interface WKFileUploadPanel : UIViewController <UINavigationControllerDelegate, UIImagePickerControllerDelegate, UIDocumentPickerDelegate, UIAdaptivePresentationControllerDelegate, UIContextMenuInteractionDelegate, PHPickerViewControllerDelegate>

 {
    ...
    Vector<WTF::RetainPtr<NSURL>, 0UL, WTF::CrashOnOverflow, 16UL, WTF::FastMalloc> _temporaryUploadedFileURLs;
...
-(struct pair<WTF::RetainPtr<NSURL>, WTF::RetainPtr<NSURL>> )_copyToNewTemporaryDirectory:(id)arg0 ;
...
// -(void)_processPickerResults:(id)arg0 atIndex:(NSUInteger)arg1 processedResults:(id)arg2 successBlock:(id)arg3 failureBlock:(unk)arg4  ;
// -(void)_processPickerResults:(id)arg0 successBlock:(id)arg1 failureBlock:(unk)arg2  ;
-(void)_showCamera;
...
// -(void)_uploadItemFromResult:(id)arg0 successBlock:(id)arg1 failureBlock:(unk)arg2  ;
