...
+(void)_fetchAllIdentifiers:(id)arg0 ;
+(void)_makeNextNetworkProcessLaunchFailForTesting;
+(void)_removeDataStoreWithIdentifier:(id)arg0 completionHandler:(id)arg1 ;
...
-(void)_originDirectoryForTesting:(id)arg0 topOrigin:(id)arg1 type:(id)arg2 completionHandler:(id)arg3 ;
-(void)_processPersistentNotificationClick:(id)arg0 completionHandler:(id)arg1 ;
-(void)_processPersistentNotificationClose:(id)arg0 completionHandler:(id)arg1 ;
...
-(void)_scopeURL:(id)arg0 hasPushSubscriptionForTesting:(id)arg1 ;
...
-(void)_setBackupExclusionPeriodForTesting:(CGFloat)arg0 completionHandler:(id)arg1 ;
...
-(void)_setResourceLoadStatisticsTimeAdvanceForTesting:(CGFloat)arg0 completionHandler:(id)arg1 ;
-(void)_setServiceWorkerOverridePreferences:(id)arg0 ;
