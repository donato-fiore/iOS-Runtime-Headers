...
@protocol CLKComplicationServer, CLKComplicationDataSource, CLKComplicationClientDelegate, CLKComplicationWidgetMigrator;
...
-(void)getWidgetMigrationConfigurationFrom:(id)arg0 withHandler:(id)arg1 ;
