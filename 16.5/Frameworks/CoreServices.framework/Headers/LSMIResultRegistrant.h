...
-(void)runPostProcessingForBundleID:(id)arg0 success:(BOOL)arg1 isSystemApp:(BOOL)arg2 isPlaceholder:(BOOL)arg3 registeredBothFullAppAndPlaceholder:(BOOL)arg4 notificationJournaller:(id)arg5 ;
