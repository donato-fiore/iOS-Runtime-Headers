...
-(id)_initWithContext:(struct LSContext *)arg0 pluginID:(unsigned int)arg1 pluginData:(struct LSPluginData *)arg2 extensionPointRecord:(id)arg3 error:(*id)arg4 ;
-(id)_initWithUUID:(id)arg0 node:(id)arg1 bundleIdentifier:(id)arg2 context:(struct LSContext *)arg3 requireValid:(BOOL)arg4 error:(*id)arg5 ;
-(id)_initWithUUID:(id)arg0 node:(id)arg1 bundleIdentifier:(id)arg2 platform:(unsigned int)arg3 context:(struct LSContext *)arg4 requireValid:(BOOL)arg5 error:(*id)arg6 ;
...
-(id)initWithBundleIdentifier:(id)arg0 requireValid:(BOOL)arg1 error:(*id)arg2 ;
-(id)initWithBundleIdentifier:(id)arg0 requireValid:(BOOL)arg1 platform:(unsigned int)arg2 error:(*id)arg3 ;
-(id)initWithURL:(id)arg0 error:(*id)arg1 ;
-(id)initWithURL:(id)arg0 requireValid:(BOOL)arg1 error:(*id)arg2 ;
-(id)initWithUUID:(id)arg0 error:(*id)arg1 ;
-(id)initWithUUID:(id)arg0 requireValid:(BOOL)arg1 error:(*id)arg2 ;
