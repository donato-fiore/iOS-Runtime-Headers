...
+(BOOL)useLegacyLocalizationListForPlatform:(unsigned int)arg0 sdkVersion:(unsigned int)arg1 ;
+(id)IOQueue;
...
+(void)gatherLocalizedStringsForCFBundle:(struct __CFBundle *)arg0 infoDictionary:(id)arg1 domains:(unsigned int)arg2 delegatesMightBeMainBundle:(BOOL)arg3 legacyLocalizationList:(BOOL)arg4 ;
+(void)gatherLocalizedStringsForCFBundle:(struct __CFBundle *)arg0 infoDictionary:(id)arg1 domains:(unsigned int)arg2 legacyLocalizationList:(BOOL)arg3 ;
+(void)setPreferredLocalizationsForXCTests:(id)arg0 ;
-(id)debugDescription;
-(id)init;
-(id)initWithBundleURL:(id)arg0 stringsFile:(id)arg1 ;
-(id)initWithBundleURL:(id)arg0 stringsFile:(id)arg1 checkMainBundle:(BOOL)arg2 legacyLocalizationList:(BOOL)arg3 ;
-(id)initWithBundleURL:(id)arg0 stringsFile:(id)arg1 legacyLocalizationList:(BOOL)arg2 ;
-(id)initWithCFBundle:(struct __CFBundle *)arg0 stringsFile:(id)arg1 ;
-(id)initWithCFBundle:(struct __CFBundle *)arg0 stringsFile:(id)arg1 legacyLocalizationList:(BOOL)arg2 ;
