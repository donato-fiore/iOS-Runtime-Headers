...
@class _ASCredentialAuthenticationViewController, NSURL, NSString, NSArray, WBSGlobalFrameIdentifier, _ASIncomingCallObserver;
@protocol SFCredentialProviderExtensionManagerObserver, _ASCredentialListViewControllerDelegate, _ASCredentialAuthenticationViewControllerDelegate, UIPresentationControllerDelegatePrivate, _SFAuthenticationClient, _SFAuthenticationContextDelegate, SFPasswordPickerServiceViewControllerProtocol;
...
-(void)setPageID:(id)arg0 frameID:(id)arg1 credentialType:(id)arg2 ;
