...
@class SFBrowserContentViewController, NSDate, WKProcessPool, WKWebsiteDataStore, NSTimer, NSString, SFSystemAlert;
...
-(BOOL)_shouldAcceptMessage:(id)arg0 ;
...
-(void)addClickAttribution:(id)arg0 ;
