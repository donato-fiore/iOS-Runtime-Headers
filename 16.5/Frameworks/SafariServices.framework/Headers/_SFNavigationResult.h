...
-(BOOL)shouldPromptWithPolicy:(NSInteger)arg0 telephonyNavigationPolicy:(id)arg1 userAction:(id)arg2 inBackgroundOrPrivateBrowsing:(BOOL)arg3 inLockdownMode:(BOOL)arg4 ;
