...
@class UITableViewController, WBSSavedAccount, WBSSavedAccountChangeRequest, UIBarButtonItem, NSString, UITableViewCell, UITableViewHeaderFooterView, SFTableViewDiffableDataSource, WBSPasswordWarning, NSTimer, UIAlertController, NSArray, NSExtension, ASAccountAuthenticationModificationController, UINavigationController, UIEditMenuInteraction;
@protocol SFSecurityRecommendationInfoCellDelegate, SFTableViewDiffableDataSourceDelegate, SFAccountNoteTableViewCellDelegate, UITextFieldDelegate, SFAccountOtpauthQRCodeScannerViewControllerDelegate, _ASAccountAuthenticationModificationExtensionManagerObserver, ASAccountAuthenticationModificationControllerDelegate, ASAccountAuthenticationModificationControllerPresentationContextProviding, UIEditMenuInteractionDelegate, PSStateRestoration, _SFAccountManagerLockableContentContainer, _SFTableLinkableFooterViewDelegate, OS_dispatch_queue, SFAccountDetailViewControllerDelegate;


#import "SFAccountDetailHeaderViewCell.h"
...
-(NSInteger)_listContentTextAlignmentOfCellsInDeleteAccountSection;
-(NSInteger)_sectionTypeForSection:(NSInteger)arg0 ;
-(NSInteger)_textAlignmentOfCellsInDeleteAccountSection;
...
-(id)_deletePasskeyCellForTableView:(id)arg0 ;
-(id)_deletePasswordCellForTableView:(id)arg0 shouldRemoveTOTPGenerator:(BOOL)arg1 ;
-(id)_editableCellWithCell:(id)arg0 ;
-(id)_footerTextForLastOneTimeShareDate:(id)arg0 ;
...
-(void)_addNotesSectionToSnapshot:(id)arg0 ;
...
-(void)_configureDeleteSectionInSnapshot:(id)arg0 ;
...
-(void)_sharePasswordWithAuthenticationContext:(id)arg0 popoverPresentationControllerConfiguration:(id)arg1 ;
...
-(void)_showConfirmationToPermanentlyDeleteCredentialTypes:(NSInteger)arg0 ;
...
-(void)_updateAddPasswordButton:(BOOL)arg0 forSnapshot:(id)arg1 ;
-(void)_updateCachedTOTPGenerators;
-(void)_updateIconForCell:(id)arg0 ;
-(void)_updatePasswordFieldTextSuggestions:(id)arg0 ;
...
-(void)noteTableViewCellTextViewTapped:(id)arg0 ;
...
-(void)updatedIconIsAvailableForDomain:(id)arg0 ;
