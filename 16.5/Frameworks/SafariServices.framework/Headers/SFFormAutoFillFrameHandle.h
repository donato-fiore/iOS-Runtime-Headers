...
@class NSURL, NSString, _WKFrameHandle, NSNumber, WBSGlobalFrameIdentifier;
...
@property (readonly, nonatomic) NSNumber *pageID; // ivar: _pageID
...
-(id)initWithFrameHandle:(id)arg0 URL:(id)arg1 serverTrust:(struct __SecTrust *)arg2 pageID:(id)arg3 ;
