...
@property (nonatomic) BOOL shouldAllowMultipleSelection; // ivar: _shouldAllowMultipleSelection
...
@property (nonatomic) BOOL shouldShowPasskeysInAccountPicker; // ivar: _shouldShowPasskeysInAccountPicker
