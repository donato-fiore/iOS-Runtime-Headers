...
@class UIView, WBSFormMetadata, NSDictionary, NSString, NSArray, WBSFormAutoFillMetadataCorrector, _ASCredentialAuthenticationViewController, WBSHideMyEmailRecord, WBSAuthenticationServicesAgentProxy, WBSMultiRoundAutoFillManager, WBSFormControlMetadata;
@protocol CNContactPickerDelegate, SFContactAutoFillViewControllerFiller, _SFCreditCardCaptureViewControllerDelegate, SFAppAutoFillOneTimeCodeProviderObserver, _ASCredentialListViewControllerDelegate, _ASCredentialAuthenticationViewControllerDelegate;
...
@interface SFFormAutocompleteState : NSObject <CNContactPickerDelegate, SFContactAutoFillViewControllerFiller, _SFCreditCardCaptureViewControllerDelegate, SFAppAutoFillOneTimeCodeProviderObserver, _ASCredentialListViewControllerDelegate, _ASCredentialAuthenticationViewControllerDelegate>

 {
    ...
    NSInteger _quickTypeBarTrailingButtonPurpose;
}
...
@property (readonly, nonatomic) SFFormAutoFillFrameHandle *frame; // ivar: _frame
...
@property (readonly, nonatomic) WBSFormControlMetadata *textFieldMetadata; // ivar: _textFieldMetadata
...
-(void)_addPasswordsAutoFillSuggestionToSuggestions:(id)arg0 forPurpose:(NSInteger)arg1 ;
...
-(void)_fillCredentialIdentity:(id)arg0 submitForm:(BOOL)arg1 ;
...
-(void)_fillSavedAccount:(id)arg0 setAutoFilled:(BOOL)arg1 setAsDefaultCredential:(BOOL)arg2 focusFieldAfterFilling:(BOOL)arg3 submitForm:(BOOL)arg4 ;
-(void)_fillSavedAccountMatchAfterAuthenticationIfNeeded:(id)arg0 setAsDefaultCredential:(BOOL)arg1 submitForm:(BOOL)arg2 ;
