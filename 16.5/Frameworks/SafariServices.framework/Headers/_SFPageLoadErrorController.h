...
@class WKWebView, NSTimer, WBSSecIdentitiesCache, _WKRemoteObjectInterface, NSURL, UINavigationController, WBSCertificateWarningPageContext, NSString, NSURLRequest, NSURLProtectionSpace;
@protocol WBSCertificateWarningPageHandler, WBSCertificateWarningPagePresenter, _SFPageLoadErrorControllerDelegate, SFDialogPresenting;
...
@property (retain, nonatomic) NSURLProtectionSpace *protectionSpaceForInvalidCertificateBypass; // ivar: _protectionSpaceForInvalidCertificateBypass
...
-(void)_cacheSecIdentityIfNeeded:(struct __SecIdentity *)arg0 forIdentityDomain:(id)arg1 ;
