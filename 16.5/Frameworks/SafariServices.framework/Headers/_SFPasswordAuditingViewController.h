...
@class SFAccountTableViewController, WBSAutoFillQuirksManager, WBSSavedAccountStore, SFTableViewDiffableDataSource, WBSPasswordWarningManager, NSArray, UIActivityIndicatorView, WBSPasswordGenerationManager, ASAccountAuthenticationModificationController, WBSPasswordWarning, _SFSiteMetadataManager, NSString, WBSSavedAccount;
@protocol SFAccountTableViewCellDelegate, SFAccountDetailViewControllerDelegate, SFActionableSecurityRecommendationDataDelegate, SFTableViewDiffableDataSourceDelegate, SFPasswordBreachToggleCellDelegate, _ASAccountAuthenticationModificationExtensionManagerObserver, ASAccountAuthenticationModificationControllerDelegate, ASAccountAuthenticationModificationControllerPresentationContextProviding, _SFTableLinkableFooterViewDelegate, PSStateRestoration, OS_dispatch_queue, _SFPasswordAuditingViewControllerDelegate;
...
-(void)_hideSecurityRecommendationAtIndexPath:(id)arg0 ;
-(void)_initiateChangeToStrongPasswordForActionableSecurityRecommendation:(id)arg0 ;
-(void)_presentHideSecurityRecommendationConfirmationAlertForRecommendationAtIndexPath:(id)arg0 completionHandler:(id)arg1 ;
-(void)_reloadSavedAccountsForceUpdate:(BOOL)arg0 ;
-(void)_reloadTableViewDiffableDataSource;
-(void)_reloadTableViewDiffableDataSourceAnimated:(BOOL)arg0 ;
-(void)_reloadTableViewDiffableDataSourceOnInternalQueueAnimated:(BOOL)arg0 ;
-(void)_reloadTableViewDiffableDataSourceOnInternalQueueForHiddenSecurityRecommendationsPersona;
-(void)_reloadTableViewDiffableDataSourceOnInternalQueueForSecurityRecommendationsPersonaAnimated:(BOOL)arg0 ;
...
-(void)_unhideHiddenSecurityRecommendationAtIndexPath:(id)arg0 ;
...
-(void)accountDetailViewController:(id)arg0 didDeleteAccountWithWarning:(id)arg1 ;
