...
@class WKWebView<WBUFormAutoFillWebView>, _WKRemoteObjectInterface, NSTimer, WBSFormMetadata, NSMutableIndexSet, NSMutableSet, NSString, NSArray, NSDictionary, WBSDispatchSourceTimer, CNContact, WBSCreditCardData, NSSet, SFAppAutoFillOneTimeCodeProvider, UIView<WBUFormAutoFillWebView>;
...
@property (readonly, nonatomic) NSDictionary *creditCardFormValues; // ivar: _creditCardFormValues
@property (readonly, copy, nonatomic) NSString *currentStrongPassword; // ivar: _currentStrongPassword
@property (readonly, copy) NSString *debugDescription;
@property (readonly, copy, nonatomic) NSString *defaultStrongPassword; // ivar: _defaultStrongPassword
...
@property (nonatomic) BOOL waitingForCreditCardDataFromWallet; // ivar: _waitingForCreditCardDataFromWallet
...
-(void)didCollectURLsForPreFilling:(id)arg0 atURL:(id)arg1 inFrame:(id)arg2 ;
...
-(void)fillCreditCardData:(id)arg0 inFrame:(id)arg1 textFieldMetadata:(id)arg2 formMetadata:(id)arg3 ;
...
-(void)setAutoFillSpinnerVisibility:(BOOL)arg0 textFieldMetadata:(id)arg1 frame:(id)arg2 ;
-(void)setFormControls:(id)arg0 areAutoFilled:(BOOL)arg1 andClearField:(id)arg2 inFrame:(id)arg3 ;
-(void)showSpinnerInFormSoon:(id)arg0 frame:(id)arg1 ;
-(void)stopShowingSpinnerInFormSoon:(CGFloat)arg0 textFieldMetadata:(id)arg1 frame:(id)arg2 ;
...
-(void)updateExistingStreamlinedSuggestionIfNecessary:(id)arg0 ;
