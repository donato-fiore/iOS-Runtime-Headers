...
@class UIButton, UIVibrancyEffect, UIVisualEffectView, UIView, UIGestureRecognizer, UIEditMenuInteraction, PKScribbleInteraction, NSString;
@protocol UIEditMenuInteractionDelegate, PKScribbleInteractionDelegate, PKScribbleInteractionElementSource, UIGestureRecognizerDelegate, _SFNavigationBarURLButtonDelegate;
