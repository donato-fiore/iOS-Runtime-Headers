...
@class UIViewController, _UIAsyncInvocation, NSArray, NSMutableDictionary, UIView, _WKActivatedElementInfo, _UIRemoteViewController, NSString, NSURL, UIColor, SFQueueingServiceViewControllerProxy<SFServiceViewControllerProtocol>;
@protocol SFBrowserRemoteViewControllerDelegate, SFInteractiveDismissControllerDelegate, SFQueueingServiceViewControllerProxyDelegate, _SFLinkPreviewHeaderDelegate, _UIRemoteViewControllerContaining, _UIViewBoundingPathChangeObserver, SFSafariViewControllerDelegate;
...
@property (retain, nonatomic, setter=_setActivatedElementInfo:) _WKActivatedElementInfo *_activatedElementInfo; // ivar: _activatedElementInfo
@property (readonly, nonatomic) _UIRemoteViewController *_containedRemoteViewController;
@property (retain, nonatomic, setter=_setPreviewActions:) NSArray *_previewActions; // ivar: _previewActions
