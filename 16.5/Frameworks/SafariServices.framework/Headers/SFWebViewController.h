...
@class UIViewController, NSString, WBSPermissionDialogThrottler, NSUUID, SFDialogController, WKWebView, WKWebViewConfiguration;
@protocol SFFormAutoFillControllerDelegate, WKNavigationDelegatePrivate, WKUIDelegatePrivate, SFDialogControllerDelegate, SFDialogViewControllerPresenting, _SFWebViewDelegate, _WKInputDelegate, _WKWebAuthenticationPanelDelegate, _SFAutoFillContextProviding, SFDialogPresenting, SFWebViewControllerDelegate;
...
-(void)_webView:(id)arg0 requestNotificationPermissionForSecurityOrigin:(id)arg1 decisionHandler:(id)arg2 ;
...
-(void)_webView:(id)arg0 updatedAppBadge:(id)arg1 fromSecurityOrigin:(id)arg2 ;
...
-(void)_webViewDidShowSafeBrowsingWarning:(id)arg0 ;
