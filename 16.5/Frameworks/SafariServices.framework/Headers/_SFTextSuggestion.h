...
@class UITextSuggestion, SFCredentialIdentity, WBSCreditCardData, WBSHideMyEmailRecord, NSString, SFAutoFillOneTimeCode, WBSSavedAccountMatch, WBUAutoFillDisplayData, NSURLCredential;
...
@property (readonly, nonatomic) SFCredentialIdentity *credentialIdentity; // ivar: _credentialIdentity
