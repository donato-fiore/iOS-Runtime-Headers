...
@protocol SAServerProtocol, SATelephonyDelegateProtocol, SALocationManagerProtocol, NSXPCListenerDelegate, OS_dispatch_queue, OS_dispatch_semaphore;
...
@property (retain, nonatomic) NSObject<OS_dispatch_semaphore> *locationAcquired; // ivar: _locationAcquired
...
-(void)notifyCrashDetectedAt:(id)arg0 resolvedAt:(id)arg1 resolvedWithResponse:(NSInteger)arg2 completion:(id)arg3 ;
...
-(void)updateMostRecentCrashDetectionEvent:(id)arg0 completion:(id)arg1 ;
