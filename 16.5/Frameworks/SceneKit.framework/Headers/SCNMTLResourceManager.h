...
+(void)_fillVertexDescriptor:(id)arg0 withMeshSource:(struct __C3DMeshSource *)arg1 semantic:(char)arg2 inputSet:(NSInteger)arg3 bufferIndex:(NSInteger)arg4 ;
...
-(id)colorMatchingComputePipelineStateForSourceColorSpace:(struct CGColorSpace *)arg0 destinationColorSpace:(struct CGColorSpace *)arg1 renderContext:(id)arg2 ;
...
-(id)irradianceTextureForPrecomputedLightingEnvironment:(id)arg0 ;
...
-(id)newPrivateBufferWithBytes:(*void)arg0 length:(NSUInteger)arg1 blitEncoder:(id)arg2 ;
...
-(id)newTextureUsingMTKTextureLoaderWithData:(id)arg0 options:(id)arg1 ;
...
-(id)radianceTextureForPrecomputedLightingEnvironment:(id)arg0 ;
...
-(void)_precomputedLightingEnvironmentWillDie:(id)arg0 ;
...
-(void)colorMatchSourceTexture:(id)arg0 sourceColorSpace:(struct CGColorSpace *)arg1 destinationColorSpace:(struct CGColorSpace *)arg2 destinationTexture:(id)arg3 renderContext:(id)arg4 ;
