...
+(void)flush;
+(void)lock;
+(void)performPresentationInstanceQueriesInScene:(id)arg0 usingBlock:(id)arg1 ;
...
+(void)postCommandWithContext:(struct __C3DScene *)arg0 object:(id)arg1 key:(id)arg2 subscriptIndex:(NSUInteger)arg3 derivedKeyPath:(id)arg4 applyBlock:(id)arg5 ;
+(void)postCommandWithContext:(struct __C3DScene *)arg0 object:(id)arg1 key:(id)arg2 subscriptKey:(id)arg3 derivedKeyPath:(id)arg4 applyBlock:(id)arg5 ;
