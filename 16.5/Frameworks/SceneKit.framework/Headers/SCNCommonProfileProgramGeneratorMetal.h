...
@interface SCNCommonProfileProgramGeneratorMetal : SCNCommonProfileProgramGenerator {
    ...
    _NSRange _commonProfileIORange;
...
-(id)splitInputOutputStructsIfNeededForSourceCode:(id)arg0 generatedFromReplacementStrings:(id)arg1 perPixelLighting:(BOOL)arg2 clipDistanceCount:(NSUInteger)arg3 ;
-(int)profile;
