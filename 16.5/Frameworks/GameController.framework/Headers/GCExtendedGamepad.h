...
-(id)thumbstickUserIntentHandler:(SEL)arg0 ;
...
-(void)setThumbstickUserIntentHandler:(id)arg0 ;
// -(void)setThumbstickUserIntentHandler:(id)arg0 slidingWindowTotalDuration:(unk)arg1 slidingWindowSegmentDuration:(CGFloat)arg2 deadzone:(CGFloat)arg3 sensitivity:(CGFloat)arg4  ;
