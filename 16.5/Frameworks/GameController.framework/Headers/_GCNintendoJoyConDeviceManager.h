...
@protocol _GCPhysicalDeviceManager, _GCLogicalDeviceManager, OS_dispatch_queue, _GCPhysicalDeviceRegistry><_GCLogicalDeviceRegistry, _GCPhysicalDeviceRegistry, NSObject><NSCopying><NSSecureCoding;
...
@property (weak) NSObject<_GCPhysicalDeviceRegistry> *deviceRegistry;
...
-(void)_onqueue_registerDefaultConfigurationForJoyConDevice:(id)arg0 ;
...
-(void)_onqueue_relinquishHIDService:(id)arg0 ;
