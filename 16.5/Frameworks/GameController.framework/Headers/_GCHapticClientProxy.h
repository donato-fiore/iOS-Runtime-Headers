...
@class GCSProfile, NSArray, NSString, NSMutableDictionary;
@protocol CHHapticServerInterface, GCSSettingsStoreService, _GCIPCIncomingConnection, NSCopying><NSObject><NSSecureCoding;
...
@property (readonly, copy, nonatomic) NSString *persistentControllerIdentifier; // ivar: _persistentControllerIdentifier
...
-(void)setHapticStrength:(float)arg0 ;
