...
-(BOOL)wasFetchResultRefetched:(id)arg0 ;
...
-(id)_insertedOrUpdatedObjectIDsMatchingEntities:(id)arg0 ;
...
-(void)_propagatePropertyNamesToSubentityNames:(id)arg0 moc:(id)arg1 ;
