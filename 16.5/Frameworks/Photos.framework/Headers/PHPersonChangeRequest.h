...
@property (nonatomic) CGFloat mergeCandidateConfidence;
@property (readonly, nonatomic) PHRelationshipChangeRequestHelper *mergeCandidatesHelper; // ivar: _mergeCandidatesHelper
@property (readonly, nonatomic) PHRelationshipChangeRequestHelper *mergeCandidatesWithConfidenceHelper; // ivar: _mergeCandidatesWithConfidenceHelper
...
-(void)addMergeCandidateWithConfidencePersons:(id)arg0 ;
...
-(void)removeMergeCandidateWithConfidencePersons:(id)arg0 ;
