...
+(id)videoLiveRenderContextWithRequestID:(int)arg0 managerID:(NSUInteger)arg1 asset:(id)arg2 options:(id)arg3 targetSize:(struct CGSize )arg4 renderedVideoHandler:(id)arg5 ;
