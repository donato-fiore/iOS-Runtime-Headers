...
@class NSMutableArray, NSMutableDictionary, NSString, PLIndicatorFileCoordinator, NSDictionary, NSNumber, NSManagedObjectID;
...
@property (retain, nonatomic) PHAssetResourceBag *assetResourceBag; // ivar: _assetResourceBag
...
@property (nonatomic, setter=_setUseRecoverableStagingDirectory:) BOOL useRecoverableStagingDirectory; // ivar: _useRecoverableStagingDirectory


+(BOOL)_shouldGenerateThumbnailsDuringCreationForImageSource:(struct CGImageSource *)arg0 contentType:(id)arg1 ;
...
+(id)creationRequestForAssetFromImageData:(id)arg0 options:(id)arg1 ;
...
+(id)creationRequestForAssetWithOptions:(id)arg0 ;
+(id)creationRequestForAssetWithSyndicationIdentifier:(id)arg0 ;
+(id)creationRequestForAssetWithUUID:(id)arg0 ;
+(id)creationRequestForAssetWithUUID:(id)arg0 options:(id)arg1 ;
-(?)_managedAssetFromPrimaryResourceData:(?)arg0 validatedResources:(?)arg1 withUUID:(?)arg2 photoLibrary:(?)arg3 mainFileMetadata:(?)arg4 getImageSourceimageData;
...
-(id)_filteredImagePropertiesByConditionallyRemovingLivePhotoIdentifiersFromSourceImageProperties:(id)arg0 ;
...
-(void)_setCreatingAssetIsBusy:(BOOL)arg0 ;
