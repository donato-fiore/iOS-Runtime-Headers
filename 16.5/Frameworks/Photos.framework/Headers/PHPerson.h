...
@property (readonly, nonatomic) CGFloat mergeCandidateConfidence; // ivar: _mergeCandidateConfidence
...
+(id)fetchMergeCandidateWithConfidencePersonsForPerson:(id)arg0 options:(id)arg1 ;
...
+(id)fetchPersonForFaceCrop:(id)arg0 options:(id)arg1 ;
+(id)fetchPersonForShareParticipant:(id)arg0 options:(id)arg1 ;
...
+(id)fetchPersonsWithObjectIDs:(id)arg0 options:(id)arg1 ;
...
+(id)momentCountsByPersonUUIDForPersonsWithUUIDs:(id)arg0 afterDate:(id)arg1 photoLibrary:(id)arg2 ;
+(id)personSuggestionsForPerson:(id)arg0 confirmedPersonSuggestions:(id)arg1 rejectedPersonSuggestions:(id)arg2 ;
+(id)personToKeepForCloudConsistencyFromPersons:(id)arg0 ;
