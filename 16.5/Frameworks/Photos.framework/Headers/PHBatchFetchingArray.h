...
-(BOOL)_shouldRetrieveRestrictedAssetOIDsWithSample:(id)arg0 ;
...
-(id)_prepareObjectsByOIDsFromOIDsToFetch:(id)arg0 andUpdateUUIDsByOIDsForRestrictedObjectsUsingFetchedObjects:(id)arg1 ;
