...
+(id)defaultManager;
+(id)mediaItemURLForAsset:(id)arg0 result:(id)arg1 ;
+(id)playerItemFromVideoMediaItemMakerDataInMediaResult:(id)arg0 forAsset:(id)arg1 ;
...
+(void)configureAssetCacheInAssetCreationOptionsDictionary:(id)arg0 ;
