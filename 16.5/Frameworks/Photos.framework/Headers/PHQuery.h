...
@interface PHQuery : NSObject <NSPredicateVisitor, NSCopying>

 {
    ...
    NSUInteger _sortingAttributesIndexValue;
...
@property (readonly) NSUInteger containerSortingAttributesIndexValue;
@property (readonly) NSUInteger containerToObjectRelationshipIndexValue;
@property (readonly) NSUInteger containerUserQueryIndexValue;
...
@property (readonly) NSUInteger filteringAttributesIndexValue;
@property (readonly) NSSet *filteringKeys;
@property (readonly, nonatomic) NSSet *filteringOids;
@property (readonly) NSUInteger filteringRelationshipsIndexValue;
@property (readonly, nonatomic) NSDictionary *filteringRelationshipsIndexValueByBaseEntityName;
@property (readonly) NSUInteger objectToContainerRelationshipIndexValue;
...
+(id)identificationBlockForAssetCollectionType:(SEL)arg0 ;
+(id)identificationBlockForSmartAlbumKind:(SEL)arg0 ;
+(id)queryForActiveLibraryScopeWithOptions:(id)arg0 ;
...
+(id)queryForAssetsInLibraryScope:(id)arg0 options:(id)arg1 ;
+(id)queryForAssetsInPreviewStateInLibraryScope:(id)arg0 options:(id)arg1 ;
+(id)queryForAssetsInPreviewStateWithSuggestedByClientTypes:(id)arg0 options:(id)arg1 ;
...
+(id)queryForAssetsWithCurrentUserAsLibraryScopeContributor:(BOOL)arg0 inLibraryScope:(id)arg1 options:(id)arg2 ;
...
+(id)queryForCloudSharedAlbumInvitationRecordsForCloudSharedAlbum:(id)arg0 options:(id)arg1 ;
+(id)queryForCloudSharedAlbumInvitationRecordsWithOptions:(id)arg0 ;
...
+(id)queryForCustomUserAssetsInMemory:(id)arg0 options:(id)arg1 ;
...
+(id)queryForKeySharingSuggestionAssetsInHighlight:(id)arg0 options:(id)arg1 ;
...
+(id)queryForLibraryScopesWithOptions:(id)arg0 ;
+(id)queryForMergeCandidatePersonsForPerson:(id)arg0 options:(id)arg1 ;
+(id)queryForMergeCandidateWithConfidencePersonsForPerson:(id)arg0 options:(id)arg1 ;
...
+(id)queryForPendingLibraryScopeInvitationWithOptions:(id)arg0 ;
+(id)queryForPersonForFaceCrop:(id)arg0 options:(id)arg1 ;
+(id)queryForPersonWithShareParticipant:(id)arg0 options:(id)arg1 ;
...
+(id)queryForPersonsWithObjectIDs:(id)arg0 options:(id)arg1 ;
...
+(id)queryForPreviewLibraryScopeWithOptions:(id)arg0 ;
...
+(id)queryForShareParticipantWithPerson:(id)arg0 options:(id)arg1 ;
...
+(id)queryForSuggestionsWithFeaturedState:(unsigned short)arg0 types:(id)arg1 options:(id)arg2 ;
...
+(id)queryForSuggestionsWithTypes:(id)arg0 options:(id)arg1 ;
...
+(id)queryforLibraryScopesWithLocalIdentifiers:(id)arg0 options:(id)arg1 ;
+(short)_participationStateFromLibraryScope:(id)arg0 ;
+(void)_setLibraryScopeDefaultSortDescriptor:(id)arg0 ;
...
-(id)description;
-(id)effectivePredicateForPHClass:(Class)arg0 includingBasePredicate:(BOOL)arg1 ;
-(id)executeQuery;
