...
@class NSMutableArray, NSString, NSURL, NSManagedObjectID;
...
@property (copy, nonatomic) NSURL *associatedPersonLibraryURL; // ivar: _associatedPersonLibraryURL
...
-(BOOL)_associateFace:(id)arg0 withPersonInPhotoLibrary:(id)arg1 error:(*id)arg2 ;
-(BOOL)applyMutationsToManagedObject:(id)arg0 photoLibrary:(id)arg1 error:(*id)arg2 ;
-(id)_copyPersonWithPersonUUID:(id)arg0 toLibrary:(id)arg1 error:(*id)arg2 ;
...
-(void)associateFaceWithPersonUUID:(id)arg0 ;
