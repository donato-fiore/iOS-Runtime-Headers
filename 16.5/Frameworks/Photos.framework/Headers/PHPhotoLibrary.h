...
-(BOOL)bfa_supportsPrivacyRestrictionsForOIDs:(id)arg0 ;
...
-(id)bfa_fetchUUIDsForRestrictedOIDs:(id)arg0 ;
...
-(id)fetchPropertiesByOID:(id)arg0 propertyNamesByEntityName:(id)arg1 ;
