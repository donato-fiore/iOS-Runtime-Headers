...
@protocol CPAnalyticsDynamicPropertyProvider, CPAnalyticsPhotoKitPropertyProvider;
...
@property (retain, nonatomic) PFSceneTaxonomy *sceneTaxonomy33; // ivar: _sceneTaxonomy33
@property (retain, nonatomic) PFSceneTaxonomy *sceneTaxonomy84; // ivar: _sceneTaxonomy84
@property (readonly) Class superclass;


+(id)_syndicationStateDescriptionForSyndicationState:(unsigned short)arg0 ;
+(id)_syndicationValueDescriptionForAssetProcessingValue:(unsigned short)arg0 ;
...
-(id)_junkConfidenceThresholdVersion81ForIdentifier:(unsigned int)arg0 ;
...
-(id)_sceneNetLabelConfidenceForIdentifier:(unsigned int)arg0 sceneAnalysisVersion:(short)arg1 ;
