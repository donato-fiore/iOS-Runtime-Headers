...
+(BOOL)_canCreateLivePhotoWithURLs:(id)arg0 videoComplementMetadata:(id)arg1 outError:(*id)arg2 ;
+(BOOL)_canCreateLoopingLivePhotoWithURLs:(id)arg0 videoComplementMetadata:(id)arg1 outError:(*id)arg2 ;
+(BOOL)_identifyResourceURLs:(id)arg0 outImageURL:(*id)arg1 outVideoURL:(*id)arg2 error:(*id)arg3 ;
+(BOOL)_validateFileURLs:(id)arg0 validationOptions:(NSUInteger)arg1 videoComplementMetadata:(id)arg2 outError:(*id)arg3 ;
...
-(id)_initWithImageURL:(id)arg0 videoURL:(id)arg1 videoComplementMetadata:(id)arg2 targetSize:(struct CGSize )arg3 contentMode:(NSInteger)arg4 ;
-(id)_initWithImageURL:(id)arg0 videoURL:(id)arg1 videoComplementMetadata:(id)arg2 targetSize:(struct CGSize )arg3 contentMode:(NSInteger)arg4 skipInstantiatingImageAndAVAsset:(BOOL)arg5 ;
