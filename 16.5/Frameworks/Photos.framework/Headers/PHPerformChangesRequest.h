...
-(void)didSendChangesToServiceWithResult:(BOOL)arg0 ;
-(void)discardUnsupportedLimitedLibraryChangeRequests;
-(void)encodeWithCoder:(id)arg0 ;
-(void)executeWithLibraryServicesManager:(id)arg0 libraryName:(char *)arg1 executionContext:(id)arg2 reply:(id)arg3 ;
