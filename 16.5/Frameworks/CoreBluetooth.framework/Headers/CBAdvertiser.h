...
@protocol CBXPCReceivable, CUXPCCodable, CBActivatable, CBAdvertisingAddressReporting, CBErrorReporting, CBInterruptable, CBLabelable, CBStateReporting, CBRemotable, CBUseCaseable, OS_xpc_object, OS_dispatch_queue;
...
@property (copy, nonatomic) NSData *airplaySourceUWBConfigData; // ivar: _airplaySourceUWBConfigData
...
@property (copy, nonatomic) NSData *watchSetupData; // ivar: _watchSetupData
...
-(void)invalidate;
-(void)setNearbyInfoV2WRMPayload:(unsigned char)arg0 ;
