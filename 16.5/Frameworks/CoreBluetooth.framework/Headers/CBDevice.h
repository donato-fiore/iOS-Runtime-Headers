...
@protocol CUXPCCodable, CBDictionaryCodable, OS_xpc_object;
...
@property (nonatomic) CGFloat accessoryStatusOBCTime;
@property (copy, nonatomic) NSString *accountID; // ivar: _accountID
@property (copy, nonatomic) NSData *airplaySourceAuthTagData; // ivar: _airplaySourceAuthTagData
...
@property (nonatomic) ? callMgmtMsg; // ivar: _callMgmtMsg
@property (copy, nonatomic) NSString *caseVersion; // ivar: _caseVersion
@property (nonatomic) NSUInteger changeFlags; // ivar: _changeFlags
@property (readonly, nonatomic) *? changedTypesInternalPtr;
...
@property (nonatomic) unsigned char endCallCapability; // ivar: _endCallCapability
...
@property (nonatomic) unsigned short interval; // ivar: _interval
@property (copy, nonatomic) NSData *irkData;
@property (nonatomic) NSUInteger lastSeenTicks; // ivar: _lastSeenTicks
@property (copy, nonatomic) NSString *leAdvName; // ivar: _leAdvName
...
@property (copy, nonatomic) NSData *nearbyInfoV2AuthTagData; // ivar: _nearbyInfoV2AuthTagData
@property (nonatomic) unsigned short nearbyInfoV2Flags; // ivar: _nearbyInfoV2Flags
@property (nonatomic) unsigned char nearbyInfoV2WRMFlags; // ivar: _nearbyInfoV2WRMFlags
...
@property (nonatomic) int primaryBudSide; // ivar: _primaryBudSide
...
@property (copy, nonatomic) NSString *remoteHostID; // ivar: _remoteHostID
...
@property (copy, nonatomic) NSString *serialNumberLeft; // ivar: _serialNumberLeft
@property (copy, nonatomic) NSString *serialNumberRight; // ivar: _serialNumberRight
...
@property (nonatomic) unsigned char tipiConnectionStatus; // ivar: _tipiConnectionStatus
@property (copy, nonatomic) NSArray *tipiDevices; // ivar: _tipiDevices
@property (nonatomic) unsigned char tipiState; // ivar: _tipiState
...
-(BOOL)changedTypesContainCBDiscovery:(id)arg0 ;
-(BOOL)changedTypesContainTypes:(struct ? *)arg0 ;
-(BOOL)changedTypesNeedsIdentify;
-(BOOL)discoveryTypesContainCBDiscovery:(id)arg0 ;
-(BOOL)discoveryTypesContainType:(int)arg0 ;
...
-(id)initWithXPCEventRepresentation:(id)arg0 error:(*id)arg1 ;
...
-(void)_parseNearbyInfoV2Ptr:(char *)arg0 end:(char *)arg1 ;
...
-(void)updateWithReceivedAuthTag:(id)arg0 forType:(unsigned char)arg1 ;
