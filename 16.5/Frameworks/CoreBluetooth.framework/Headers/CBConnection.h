...
@protocol CBCentralManagerDelegate, CBPeripheralDelegate, CUReadWriteRequestable, CBPairingAgentDelegate, CUXPCCodable, CBActivatable, CBErrorReporting, CBInterruptable, CBLabelable, CBPairable, CBReadWriteRequestable, CBStateReporting, CBRemotable, CBUseCaseable, OS_dispatch_source, OS_xpc_object, OS_dispatch_queue;
...
@property (nonatomic) CGFloat connectedTime; // ivar: _connectedTime
...
@property (nonatomic) NSInteger connectionScanDutyCycle; // ivar: _connectionScanDutyCycle
...
@property (copy, nonatomic) NSArray *serviceUUIDs; // ivar: _serviceUUIDs
...
-(BOOL)updateWithXPCSubscriberInfo:(id)arg0 ;
...
-(void)_pairingPerformActionBLE:(int)arg0 withOptions:(id)arg1 completionHandler:(id)arg2 ;
-(void)_pairingPerformActionClassic:(int)arg0 completionHandler:(id)arg1 ;
-(void)_pairingPerformActionClassic:(int)arg0 withOptions:(id)arg1 completionHandler:(id)arg2 ;
...
-(void)pairingPerformAction:(int)arg0 withOptions:(id)arg1 completionHandler:(id)arg2 ;
