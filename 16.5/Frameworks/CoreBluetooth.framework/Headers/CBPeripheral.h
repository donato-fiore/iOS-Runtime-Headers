...
@class NSMutableDictionary, NSString, NSNumber, NSUUID, NSArray, NSHashTable;
...
@property (readonly, copy, nonatomic) NSUUID *findMyBeaconIdentifier; // ivar: _findMyBeaconIdentifier
@property (readonly, copy, nonatomic) NSArray *findMyGroupMembers; // ivar: _findMyGroupMembers
@property (readonly, nonatomic) unsigned char findMyPartIdentifier; // ivar: _findMyPartIdentifier
@property (readonly, copy, nonatomic) NSString *findMySerialNumberString; // ivar: _findMySerialNumberString
@property (readonly, copy, nonatomic) NSUUID *findMyUserIdentifier; // ivar: _findMyUserIdentifier
...
@property (readonly) BOOL managedByFindMy; // ivar: _managedByFindMy
@property (retain) NSString *name; // ivar: _name
@property (retain) NSString *remoteControllerId; // ivar: _remoteControllerId
@property (retain) NSArray *services; // ivar: _services
@property (retain) NSString *stableIdentifier; // ivar: _stableIdentifier
...
-(BOOL)isConnected;
-(BOOL)sendMsg:(int)arg0 args:(id)arg1 withReply:(id)arg2 ;
