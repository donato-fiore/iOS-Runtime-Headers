...
-(void)_loadSWCopyRepresentationForItemProvider:(id)arg0 completionHandler:(id)arg1 ;
-(void)_loadSWCopyRepresentationForItemProvider:(id)arg0 forTypeIdentifier:(id)arg1 completionHandler:(id)arg2 ;
