...
#ifndef MFATOMTEXTVIEW_H
#define MFATOMTEXTVIEW_H
...
@protocol NSLayoutManagerDelegate, UITextViewDelegate, UITextInputPrivate, UITextInput, MFAtomTextViewDelegate, UITextInputDelegate, UITextInputSuggestionDelegate, UITextInputTokenizer;
...
@property (weak, nonatomic) NSObject<MFAtomTextViewDelegate> *delegate; // ivar: _delegate
