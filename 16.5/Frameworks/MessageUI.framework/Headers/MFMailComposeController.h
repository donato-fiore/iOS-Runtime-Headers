...
@protocol UINavigationControllerDelegate, CNContactContentViewControllerDelegate, MFMailComposeToFieldDelegate, MFComposeActivityHandoffOperationDelegate, MFComposeStyleSelectorViewControllerDelegate, MFPhotoPickerControllerDelegate, NSUserActivityDelegate, QLPreviewControllerDelegate, VNDocumentCameraViewControllerDelegate, _MFMailCompositionContextDelegate, MFPreferredTitleProvider, ComposeViewNavigationBarDelegate, MFDatePickerViewControllerDelegate, MFMailComposeViewDelegate, MFMailMenuCommandProvider, CNComposeHeaderViewDelegate, MFComposeSubjectViewDelegate, MFComposeImageSizeViewDelegate, MFSecureMIMECompositionManagerDelegate, MFComposeTypeFactoryDelegate, MFMailComposeRecipientTextViewDelegate, UIImagePickerControllerDelegate, UIPopoverPresentationControllerDelegate, CNAutocompleteGroupDetailViewControllerDelegate, CNContactPickerDelegate, OS_dispatch_group, MFMailAccountProxyGenerator, EFScheduler;
...
@property (nonatomic) BOOL didUseOmittedAttachmentsOrRecipients; // ivar: _didUseOmittedAttachmentsOrRecipients
...
@property (nonatomic) BOOL hasPresentedSenderCollaborationAlert; // ivar: _hasPresentedSenderCollaborationAlert
@property (readonly) NSUInteger hash;
@property (copy, nonatomic) NSString *hideMyEmailAddressIfExists; // ivar: _hideMyEmailAddressIfExists
@property (nonatomic) BOOL hideMyEmailMultipleRecipient; // ivar: _hideMyEmailMultipleRecipient
@property (copy, nonatomic) NSString *hideMyEmailSenderAddress; // ivar: _hideMyEmailSenderAddress
@property (retain, nonatomic) NSArray *initialMissingAttachmentWarnings; // ivar: _initialMissingAttachmentWarnings
...
@property (readonly, nonatomic) NSObject<EFScheduler> *prepareImagesForSendScheduler; // ivar: _prepareImagesForSendScheduler
...
@property (nonatomic) CGFloat previousPaletteWidth; // ivar: _previousPaletteWidth
...
-(BOOL)_setSendingEmailAddressAsHME:(id)arg0 ;
...
-(BOOL)_shouldRestoreAttachments:(id)arg0 ;
...
-(BOOL)hasAttachments;
-(BOOL)hosted;
-(BOOL)isAddressHideMyEmail:(id)arg0 ;
-(BOOL)isDirty;
...
-(id)_createSendButtonItemWithPossibleTitles:(id)arg0 ;
-(id)_csPeopleFromAddresses:(id)arg0 ;
-(id)_defaultAccount;
...
-(void)_checkForOmittedRecipientsOrAttachmentsIfNeededWithContinuation:(id)arg0 ;
-(void)_checkForReplyAndForwardRestriction;
-(void)_checkForSendLaterDisclaimerWithContinuation:(id)arg0 ;
-(void)_checkForShareParticipantsWithContinuation:(id)arg0 ;
...
-(void)_getHMEEmailFromOriginalAddress:(id)arg0 ;
...
-(void)_physicallyScaleImagesToScale:(NSUInteger)arg0 attachments:(id)arg1 ;
-(void)_popoverWillBePresented:(id)arg0 ;
-(void)_prepareCompositionContextForLoading:(id)arg0 ;
-(void)_prepareForSuspend;
-(void)_prepareHMEAddressesWithContinuation:(id)arg0 ;
-(void)_prepareImagesForSendWithContinuation:(id)arg0 ;
-(void)_preparePhotoPicker;
-(void)_presentModalAlert:(id)arg0 ;
-(void)_presentSenderCollaborationAlertIfNecessaryForSendingAddress:(id)arg0 ;
-(void)_presentWarnings:(id)arg0 index:(NSUInteger)arg1 suggestionsService:(id)arg2 completionHandler:(id)arg3 ;
...
-(void)_removeAutoBccSendingAddress:(id)arg0 ;
-(void)_removeRecent;
-(void)_replyAllCommandInvoked:(id)arg0 ;
-(void)_replyCommandInvoked:(id)arg0 ;
-(void)_reportUserEnagagement:(BOOL)arg0 suggestionService:(id)arg1 warning:(id)arg2 ;
...
-(void)_showOriginalAttachmentsIfNecessary:(id)arg0 ;
...
-(void)_unscaleImages;
-(void)_updateAndStartCompletingCcFieldWithMissingRecipients:(id)arg0 ;
-(void)_updateAutoBccSendingAddress:(id)arg0 withNewSendingAddress:(id)arg1 ;
-(void)_updateAutoBccSendingAddress:(id)arg0 withNewSendingAddress:(id)arg1 alwaysAdd:(BOOL)arg2 ;
...
-(void)composeRecipientView:(id)arg0 didFinishAddingRecipient:(id)arg1 ;
...
-(void)datePickerViewController:(id)arg0 didSelectDate:(id)arg1 ;
-(void)dealloc;
...
-(void)setHideMyEmailAddressForMailToURLAddressString:(id)arg0 ;
...
-(void)setSendingEmailAddressAsHME:(id)arg0 isComposeTypeReply:(BOOL)arg1 ;
