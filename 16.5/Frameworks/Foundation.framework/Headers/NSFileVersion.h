...
+(void)getNonlocalVersionsOfItemFromBRAtURL:(id)arg0 options:(NSUInteger)arg1 completionHandler:(id)arg2 ;
+(void)getNonlocalVersionsOfItemFromFPAtURL:(id)arg0 options:(NSUInteger)arg1 completionHandler:(id)arg2 ;
...
-(id)_initWithFileURL:(id)arg0 fileVersion:(id)arg1 ;
