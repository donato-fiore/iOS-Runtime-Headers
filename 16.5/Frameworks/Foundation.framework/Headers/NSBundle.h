...
-(id)_initUniqueWithPath:(id)arg0 ;
-(id)_initUniqueWithURL:(id)arg0 ;
-(id)_localizedStringNoCacheNoMarkdownParsingForKey:(id)arg0 value:(id)arg1 table:(id)arg2 localizations:(id)arg3 actualTableURL:(*id)arg4 formatSpecifierConfiguration:(*id)arg5 ;
...
-(id)localizedStringForKey:(id)arg0 value:(id)arg1 table:(id)arg2 localizations:(id)arg3 ;
