...
+(*unk)recognizeFuncForCFStringEncoding:(unsigned int)arg0 ;
+(id)detectorForCFStringEncoding:(unsigned int)arg0 allowBackupDetectors:(BOOL)arg1 ;
-(CGFloat)_ASCII_confidence;
-(CGFloat)_singleByte_confidence;
-(CGFloat)bytesRatio;
-(CGFloat)confidence;
...
-(id)initWithNSStringEncoding:(NSUInteger)arg0 CFStringEncoding:(unsigned int)arg1 recognizeFunc:(*unk)arg2 ;
-(void)reset;
-(void)softReset;
