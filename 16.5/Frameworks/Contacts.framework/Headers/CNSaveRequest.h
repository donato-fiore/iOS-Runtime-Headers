...
@class NSMutableDictionary, NSMutableArray, NSArray, NSString, NSDictionary;
...
@property (readonly, copy, nonatomic) NSArray *linkRequests; // ivar: _linkRequests
...
@property (nonatomic) BOOL suppressChangeNotifications; // ivar: _suppressChangeNotifications
...
-(void)addDistinctObject:(id)arg0 intoArray:(id)arg1 ;
