...
@class CNVCardWritingOptions, NSDictionary, NSDateComponents, NSArray, NSString, NSData;
...
+(id)adapterWithContact:(id)arg0 options:(id)arg1 ;
+(id)descriptorForAllSupportedKeys;
-(id)initWithContact:(id)arg0 options:(id)arg1 ;
