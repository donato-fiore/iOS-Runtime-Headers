...
+(id)predicateForGroupsWithMemberContact:(id)arg0 includeAllParentGroups:(BOOL)arg1 ;
+(id)predicateForGroupsWithMemberGroup:(id)arg0 includeAllParentGroups:(BOOL)arg1 ;
