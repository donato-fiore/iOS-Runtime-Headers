...
typedef struct duration<unsigned int, std::ratio<1, 125>> {
    unsigned int field0;
} duration<unsigned int, std::ratio<1, 125>>;

typedef struct TrackingAlignment {
    duration<unsigned int, std::ratio<1, 125>> field0;
    duration<unsigned int, std::ratio<1, 125>> field1;
} TrackingAlignment;

typedef struct TrackingResult {
    TrackingAlignment field0;
    TrackingAlignment field1;
    float field2;
} TrackingResult;
