...
+(id)requestSignatureGenerationUntilDeadline:(id)arg0 ;
...
-(id)initWithSignature:(id)arg0 deadline:(id)arg1 installationID:(id)arg2 sendNotifications:(BOOL)arg3 stopCondition:(NSInteger)arg4 requestType:(NSInteger)arg5 ;
-(id)initWithSignature:(id)arg0 deadline:(id)arg1 sendNotifications:(BOOL)arg2 stopCondition:(NSInteger)arg3 requestType:(NSInteger)arg4 ;
