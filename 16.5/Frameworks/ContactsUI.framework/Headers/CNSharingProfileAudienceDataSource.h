...
#ifndef CNSHARINGPROFILEAUDIENCEDATASOURCE_H
#define CNSHARINGPROFILEAUDIENCEDATASOURCE_H
...
#import "CNSharingProfileRowItem.h"
...
@property (retain, nonatomic) CNSharingProfileRowItem *selectedItem; // ivar: _selectedItem
...
-(NSUInteger)sharingAudienceForItem:(id)arg0 ;
