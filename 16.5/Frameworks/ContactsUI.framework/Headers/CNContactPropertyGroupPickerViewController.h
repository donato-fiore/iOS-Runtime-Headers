...
@class UIViewController, NSArray, UITableView, CNContact, NSString;
...
+(BOOL)propertiesLeftToPickWithPickedGroups:(id)arg0 policy:(id)arg1 prohibitedPropertyKeys:(id)arg2 contact:(id)arg3 ;
+(id)pickableGroupsWithPickedGroups:(id)arg0 policy:(id)arg1 prohibitedPropertyKeys:(id)arg2 contact:(id)arg3 ;
+(id)propertySections;
