...
@property (nonatomic) BOOL hasReorderedItems; // ivar: _hasReorderedItems
...
-(BOOL)addEditingItem;
-(BOOL)addEditingItem:(id)arg0 ;
-(BOOL)canAddEditingItem;
-(BOOL)isRequired;
-(BOOL)labelsAreUnique;
-(BOOL)moveEditingItemFromIndex:(NSInteger)arg0 toIndex:(NSInteger)arg1 ;
-(NSInteger)valueEditingItemsCount;
