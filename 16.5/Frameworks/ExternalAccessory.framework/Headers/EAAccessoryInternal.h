...
@class NSLock, NSMutableArray, NSDictionary, NSNumber, NSString, NSArray, NSData;
...
@property (retain, nonatomic) NSNumber *averageFrameworkDelay; // ivar: _averageFrameworkDelay
@property (retain, nonatomic) NSNumber *averageXPCDelay; // ivar: _averageXPCDelay
...
@property (retain, nonatomic) NSMutableArray *enqueuedNMEATimestamps; // ivar: _enqueuedNMEATimestamps
...
@property (retain, nonatomic) NSNumber *highestFrameworkDelay; // ivar: _highestFrameworkDelay
@property (retain, nonatomic) NSNumber *highestXPCDelay; // ivar: _highestXPCDelay
...
@property (nonatomic) NSUInteger nmeaSentenceAddCounter; // ivar: _nmeaSentenceAddCounter
@property (nonatomic) NSUInteger nmeaSentenceGetCounter; // ivar: _nmeaSentenceGetCounter
