...
-(id)initLocalWithKeyType:(id)arg0 keySize:(NSInteger)arg1 accessControl:(struct __SecAccessControl *)arg2 options:(id)arg3 authContext:(id)arg4 caller:(id)arg5 forceSystemSession:(BOOL)arg6 error:(*id)arg7 ;
-(id)initLocalWithObjectID:(id)arg0 authContext:(id)arg1 caller:(id)arg2 forceSystemSession:(BOOL)arg3 error:(*id)arg4 ;
-(id)initWithAttributes:(id)arg0 authContext:(id)arg1 forceSystemSession:(BOOL)arg2 error:(*id)arg3 ;
-(id)initWithKeyType:(id)arg0 keySize:(NSInteger)arg1 accessControl:(struct __SecAccessControl *)arg2 options:(id)arg3 authContext:(id)arg4 forceSystemSession:(BOOL)arg5 error:(*id)arg6 ;
-(id)initWithObjectID:(id)arg0 authContext:(id)arg1 forceSystemSession:(BOOL)arg2 error:(*id)arg3 ;
