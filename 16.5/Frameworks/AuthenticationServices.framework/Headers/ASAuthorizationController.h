...
@protocol SOAuthorizationDelegate, OS_os_activity, ASAuthorizationControllerDelegate, ASAuthorizationControllerPresentationContextProviding;
...
-(void)_completeWithAuthorization:(id)arg0 ;
