...
@protocol ASCredentialRequestPaneViewControllerDelegate, ASPasswordAuthenticationPaneViewControllerDelegate, OS_os_activity, ASAuthorizationViewControllerDelegate;
...
-(BOOL)_shouldPresentCABLEAsInitialViewControllerForPresentationContext:(id)arg0 ;
...
-(id)_securityKeyRequestViewControllerWithOverrideSubtitle:(id)arg0 overrideTitle:(id)arg1 ;
...
-(void)_pushSecurityKeyViewControllerWithOverrideSubtitle:(id)arg0 overrideTitle:(id)arg1 ;
...
-(void)passwordAuthenticationViewController:(id)arg0 completedWithUserEnteredPIN:(id)arg1 ;
