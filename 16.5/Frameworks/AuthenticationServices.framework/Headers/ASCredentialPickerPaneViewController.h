...
@protocol SFCredentialProviderExtensionManagerObserver, _ASCredentialAuthenticationViewControllerDelegate, _ASAuthenticationPresentationProvider, ASCredentialRequestSubPaneConfirmButtonDelegate, UITableViewDataSource, ASCLoginChoiceProtocol, OS_os_activity, OS_dispatch_queue;
...
#import "_ASCredentialAuthenticationViewController.h"
...
-(id)_serviceName;
-(id)_usernameForContinueButtonWithLoginChoice:(id)arg0 ;
-(id)initWithPresentationContext:(id)arg0 activity:(id)arg1 ;
-(id)initWithPresentationContext:(id)arg0 shouldExpandOtherLoginChoices:(BOOL)arg1 activity:(id)arg2 ;
...
-(void)_keychainSyncStatusMayHaveChanged:(id)arg0 ;
