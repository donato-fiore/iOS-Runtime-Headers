...
@property (readonly, nonatomic) NSString *latestExpandedSymbol; // ivar: _latestExpandedSymbol
...
+(id)_getQueue;
+(void)_applyWordLanguageModelProbabilityToPath:(id)arg0 stemmedFromPath:(id)arg1 isCommittingToken:(BOOL)arg2 ;
