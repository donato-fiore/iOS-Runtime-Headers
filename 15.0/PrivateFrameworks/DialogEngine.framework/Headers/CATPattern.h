...
+(id)executeCAT:(id)arg0 templateDir:(struct basic_string<char, std::char_traits<char>, std::allocator<char>> )arg1 catId:(struct basic_string<char, std::char_traits<char>, std::allocator<char>> )arg2 requestType:(int)arg3 parameters:(id)arg4 globals:(id)arg5 options:(int)arg6 error:(*id)arg7 ;
