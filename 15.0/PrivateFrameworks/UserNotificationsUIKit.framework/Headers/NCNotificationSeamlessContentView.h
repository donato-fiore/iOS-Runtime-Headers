...
@class UIView, UILabel, UIView<NCTextSupporting>, UILabel<BSUIDateLabel>, BSUIEmojiLabelView, UIImageView, MTVisualStylingProvider, NSStringDrawingContext, NSDate, NSString, BSUIFontProvider, NSAttributedString, UIImageConfiguration, UIImage, NSArray, NSTimeZone;
...
@interface NCNotificationSeamlessContentView : UIView <BSUIDateLabelDelegate, UITextViewDelegate, NCNotificationContentDisplaying>

 {
    ...
    NSUInteger _secondaryTextNumLinesDrawn;
...
-(NSUInteger)_maximumNumberOfLinesForImportantText;
...
-(NSUInteger)_numberOfLinesForFooterTextInRect:(struct CGRect )arg0 ;
-(NSUInteger)_numberOfLinesForImportantTextInFrame:(struct CGRect )arg0 ;
