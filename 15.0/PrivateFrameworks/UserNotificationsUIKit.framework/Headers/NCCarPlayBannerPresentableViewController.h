...
@class UIViewController, NSHashTable, UITapGestureRecognizer, NSString, NCNotificationRequest, NSUUID;
@protocol NCCarPlayBannerContentViewDelegate, BNPresentable, BNPresentableObservable, BNPresentableUniquelyIdentifying, NCCarPlayBannerPresentableViewControllerDelegate, BNPresentableContext;
