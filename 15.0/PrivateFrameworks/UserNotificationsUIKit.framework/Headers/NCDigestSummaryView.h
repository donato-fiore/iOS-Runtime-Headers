...
@class UIView, UILabel<BSUIDateLabel>, UILabel, BSUIFontProvider, MTVisualStylingProvider, NSStringDrawingContext, NSDate, NSString, NSArray, NSTimeZone;
...
#import "NCDigestFeaturedNotificationsContainerView.h"
