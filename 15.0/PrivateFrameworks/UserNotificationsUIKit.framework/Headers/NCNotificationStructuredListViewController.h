...
#import "NCCAPackageView.h"
#import "NCDigestOnboardingSuggestionViewController.h"
...
@property (nonatomic) NSUInteger digestOnboardingAverageNotificationCount; // ivar: _digestOnboardingAverageNotificationCount
...
@property (retain, nonatomic) NCCAPackageView *digestOnboardingSuggestionPictogramView; // ivar: _digestOnboardingSuggestionPictogramView
...
@property (retain, nonatomic) NCDigestOnboardingSuggestionViewController *digestOnboardingSuggestionViewController; // ivar: _digestOnboardingSuggestionViewController
...
-(void)_presentOptionsMenuForNotificationRequest:(id)arg0 withPresentingView:(id)arg1 ;
...
-(void)_updateDigestOnboardingSuggestionPictogramForDeviceAuthenticated:(BOOL)arg0 ;
...
// -(void)notificationListComponent:(id)arg0 requestsPresentingOptionsMenuForNotificationRequest:(id)arg1 presentingViewProvider:(id)arg2 completion:(unk)arg3  ;
...
-(void)notificationMasterListRequestsPresentingNotificationDigestOnboardingPlatter:(id)arg0 ;
