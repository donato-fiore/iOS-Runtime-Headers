...
+(id)create:(*id)arg0 ;
-(void)activate;
-(void)copyURLToBundleID:(id)arg0 usingData:(id)arg1 replyHandler:(id)arg2 ;
-(void)grantExecutePermissionToBundleID:(id)arg0 usingData:(id)arg1 replyHandler:(id)arg2 ;
