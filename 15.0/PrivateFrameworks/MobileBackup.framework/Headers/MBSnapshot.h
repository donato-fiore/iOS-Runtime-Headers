...
-(id)initWithSnapshotID:(NSUInteger)arg0 backupUUID:(id)arg1 snapshotUUID:(id)arg2 deviceName:(id)arg3 date:(id)arg4 created:(id)arg5 modified:(id)arg6 state:(int)arg7 isCompatible:(BOOL)arg8 systemVersion:(id)arg9 buildVersion:(id)arg10 quotaReserved:(NSUInteger)arg11 backupType:(NSInteger)arg12 backupPolicy:(NSInteger)arg13 ;
-(id)initWithSnapshotID:(NSUInteger)arg0 deviceName:(id)arg1 date:(id)arg2 created:(id)arg3 modified:(id)arg4 state:(int)arg5 isCompatible:(BOOL)arg6 systemVersion:(id)arg7 buildVersion:(id)arg8 quotaReserved:(NSUInteger)arg9 backupType:(NSInteger)arg10 backupPolicy:(NSInteger)arg11 ;
