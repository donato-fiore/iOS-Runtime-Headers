...
+(NSUInteger)removeRestorePrefetchCache;
+(NSUInteger)removeRestorePrefetchCacheWithEarliestDate:(id)arg0 ;
...
-(BOOL)removeAllBackupInternalSnapshots:(*id)arg0 ;
...
-(BOOL)snapshotFilesystemWithSnapshotID:(id)arg0 withError:(*id)arg1 ;
-(BOOL)snapshotFilesystemWithSnapshotName:(id)arg0 withError:(*id)arg1 ;
