...
-(id)_fetchDataForAttachment:(id)arg0 withProvider:(id)arg1 syncLock:(*id)arg2 ;
...
-(void)_callProgressBlockForAttachmentURL:(id)arg0 withBytes:(NSUInteger)arg1 expectedSize:(NSUInteger)arg2 ;
