...
-(NSUInteger)_naturalScaleUnitForDistanceInMeters:(CGFloat)arg0 distanceType:(NSUInteger)arg1 ;
...
-(id)localizedShortTypeDistinguishingUnitStringForEnergyType:(NSUInteger)arg0 ;
