...
@class NSLock, NSProgress, EFPromise, NSString, NSArray, NSError;
@protocol EFLoggable, EMSearchableIndexQueryBuilder, EFSignpostable, EFCancelable, NSProgressReporting, EMSearchQueryable;
...
@property (readonly, nonatomic) EMSearchableIndexQueryExpression *expression; // ivar: _expression
...
@property (retain, nonatomic) NSObject<EMSearchQueryable> *query; // ivar: _query
