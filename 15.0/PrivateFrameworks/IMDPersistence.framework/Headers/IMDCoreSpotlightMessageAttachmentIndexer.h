...
+(BOOL)_attachmentIsSticker:(struct _IMDAttachmentRecordStruct *)arg0 ;
+(NSUInteger)partKeyForAttachmentFromItem:(id)arg0 withGUID:(id)arg1 ;
+(id)_possibleVideoComplementExtensions;
+(id)assetUUIDKey;
+(id)attachmentIndexTypeForPath:(id)arg0 filename:(id)arg1 attachmentRecord:(struct _IMDAttachmentRecordStruct *)arg2 ;
...
+(id)copyAttachmentsForMessageID:(NSInteger)arg0 ;
+(id)copyGUIDFromAttachment:(struct _IMDAttachmentRecordStruct *)arg0 ;
+(id)copyPathFromAttachment:(struct _IMDAttachmentRecordStruct *)arg0 ;
