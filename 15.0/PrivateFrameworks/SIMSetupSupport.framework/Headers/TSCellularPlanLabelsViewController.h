...
@class OBTableWelcomeController, OBBoldTrayButton, NSString, NSLayoutConstraint, NSArray, UITableViewCell, NSMutableArray;
...
-(id)initWithIccid:(id)arg0 allowDismiss:(BOOL)arg1 ;
