...
-(void)_presentAuthorizationAlertForBundleIdentifier:(id)arg0 displayName:(id)arg1 withResult:(id)arg2 ;
...
-(void)presentAuthorizationAlertForBundleIdentifier:(id)arg0 displayName:(id)arg1 withResult:(id)arg2 ;
-(void)requestAuthorizationForBundleIdentifier:(id)arg0 displayName:(id)arg1 withResult:(id)arg2 ;
