...
+(id)_textDocumentTypeFromUTI:(id)arg0 ;
...
+(id)mutableAttributedStringForThumbnailWithData:(id)arg0 uti:(id)arg1 encoding:(unsigned int)arg2 documentAttributes:(*id)arg3 ;
+(id)mutableAttributedStringForThumbnailWithURL:(id)arg0 documentAttributes:(*id)arg1 ;
+(id)readingOptionsFromUTI:(id)arg0 encoding:(unsigned int)arg1 ;
...
-(struct CGImage *)_createThumbnailForImageSource:(struct CGImageSource *)arg0 contentTypeIdentifier:(id)arg1 ;
