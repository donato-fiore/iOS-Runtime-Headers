...
@class CUPairingStream, CUPairingSession, NSMutableDictionary, NSMutableArray, NSError, CBConnection, NSString;
...
-(void)_clientPairSetupPromptWithFlags:(unsigned int)arg0 throttleSeconds:(int)arg1 ;
