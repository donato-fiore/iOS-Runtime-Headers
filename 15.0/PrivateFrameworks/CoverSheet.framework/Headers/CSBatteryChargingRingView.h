...
@class CALayer, SBUILegibilityLabel, UIView, CABackdropLayer, UIImageView, BCBatteryDevice, BSTimer;
...
@property (retain, nonatomic) BSTimer *longTailShortcutTimer; // ivar: _longTailShortcutTimer
