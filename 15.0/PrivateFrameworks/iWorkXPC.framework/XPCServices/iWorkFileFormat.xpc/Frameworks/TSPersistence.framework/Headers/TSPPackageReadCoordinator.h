...
@property (readonly, nonatomic) BOOL didRequireUpgrade; // ivar: _didRequireUpgrade
...
-(void)p_readComponent:(id)arg0 additionalComponents:(id)arg1 requireUpgrade:(BOOL)arg2 completionQueue:(id)arg3 completion:(id)arg4 ;
