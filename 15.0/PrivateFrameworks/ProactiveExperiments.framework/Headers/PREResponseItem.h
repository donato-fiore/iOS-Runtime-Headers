...
+(id)responseItemArrayFromResponseKitArray:(id)arg0 ;
-(BOOL)isEqual:(id)arg0 ;
-(BOOL)isEqualToResponseItem:(id)arg0 ;
-(id)description;
-(id)initWithCategoryId:(id)arg0 modelId:(id)arg1 responseClassId:(id)arg2 replySubgroupId:(id)arg3 replyTextId:(id)arg4 replyText:(id)arg5 language:(id)arg6 isCustomResponse:(id)arg7 ;
