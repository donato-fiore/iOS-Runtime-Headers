...
#ifndef GKCURVEDTEXTLABEL_H
#define GKCURVEDTEXTLABEL_H
...
@interface GKCurvedTextLabel : UILabel {
    ...
    CGFloat _textWidth;
    CGFloat _cachedLeadingAngle;
    CGFloat _cachedTrailingAngle;
...
@property (readonly, nonatomic) CGFloat textLeadingAngle;
@property (readonly, nonatomic) CGFloat textTrailingAngle;
