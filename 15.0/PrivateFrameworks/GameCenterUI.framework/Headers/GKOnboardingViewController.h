...
@class UIViewController, UIView, NSLayoutConstraint, UIImageView, NSString, UILabel, OBBoldTrayButton, OBPrivacyLinkController, UIScrollView, UIStackView;
...
@property (retain, nonatomic) NSLayoutConstraint *privacyContainerLeadingConstraint; // ivar: _privacyContainerLeadingConstraint
@property (retain, nonatomic) NSLayoutConstraint *privacyContainerTrailingConstraint; // ivar: _privacyContainerTrailingConstraint
