...
@class NSString, AKAppleIDAuthenticationInAppContext, UIImageView, NSMutableArray, GKGame, AKInlineSignInViewController, UIActivityIndicatorView, RemoteUIController, UIViewController, UIScrollView, UILabel, GKDispatchGroup, UINavigationController;
...
@property (retain, nonatomic) GKLabel *loginPromptLabel; // ivar: _loginPromptLabel
...
-(BOOL)handleUnderlyingAuthenticationError:(id)arg0 accountName:(id)arg1 ;
