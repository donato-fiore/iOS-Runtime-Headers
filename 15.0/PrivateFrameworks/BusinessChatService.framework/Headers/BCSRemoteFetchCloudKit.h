...
-(void)fetchBloomFilterAndConfigItemWithType:(NSInteger)arg0 clientBundleID:(id)arg1 completion:(id)arg2 ;
-(void)fetchBloomFilterAndConfigItemWithType:(NSInteger)arg0 clientBundleID:(id)arg1 xpcActivity:(id)arg2 completion:(id)arg3 ;
