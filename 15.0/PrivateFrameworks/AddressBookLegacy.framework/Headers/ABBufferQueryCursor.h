...
@class CNManagedConfiguration, NSMutableDictionary, NSMutableData;
...
-(id)initWithAddressBook:(*void)arg0 predicate:(id)arg1 propertyIdentifierSet:(struct __CFSet *)arg2 includeLinkedContacts:(BOOL)arg3 sortOrder:(unsigned int)arg4 suggestedContactsPerBatch:(NSUInteger)arg5 managedConfiguration:(id)arg6 ;
-(id)initWithQuery:(id)arg0 batchSize:(NSUInteger)arg1 managedConfiguration:(id)arg2 ;
-(void)dealloc;
