...
-(void)dealloc;
-(void)setCameraAccess:(BOOL)arg0 clientAuditToken:(struct ? )arg1 completionHandler:(id)arg2 ;
-(void)setStreaming:(BOOL)arg0 portType:(id)arg1 clientAuditToken:(struct ? )arg2 completionHandler:(id)arg3 ;
