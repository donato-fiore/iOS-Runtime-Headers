...
-(id)_captureTypeStringWithPrimaryCaptureType:(int)arg0 secondaryCaptureType:(int)arg1 captureFlags:(NSUInteger)arg2 sceneFlags:(NSUInteger)arg3 ;
-(id)init;
-(int)lastShutterLag;
-(void)_incrementAggdScalarKey:(id)arg0 withValue:(NSInteger)arg1 ;
-(void)_pushValue:(CGFloat)arg0 aggdDistributionKey:(id)arg1 ;
-(void)_reportInitFailure;
-(void)_setAggdScalarKey:(id)arg0 withValue:(NSInteger)arg1 ;
-(void)dealloc;
