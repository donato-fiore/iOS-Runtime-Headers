...
+(void)initialize;
-(BOOL)_hasOverCaptureRegionsWithSampleBuffer:(struct opaqueCMSampleBuffer *)arg0 ;
-(BOOL)_shouldRenderSemanticStyle;
-(float)_cubeStrengthForOffset:(float)arg0 ;
-(id)initWithCaptureDevice:(id)arg0 maxLossyCompressionLevel:(int)arg1 semanticStyleRenderingEnabled:(BOOL)arg2 cinematicVideoEnabled:(BOOL)arg3 ;
-(id)nodeSubType;
-(id)nodeType;
...
-(id)videoInput;
-(id)videoOutput;
-(int)_adjustRectanglesFromFiltersAndRegionArray:(id)arg0 withSampleBuffer:(struct opaqueCMSampleBuffer *)arg1 ;
-(void)_applyQueuedSemanticStyle:(struct opaqueCMSampleBuffer *)arg0 ;
-(void)_buildAndChangeToFiltersWithAnimation:(NSInteger)arg0 ;
-(void)_changeToFilters:(id)arg0 animation:(NSInteger)arg1 ;
-(void)_rebuildSemanticStyleFiltersWithSceneType:(int)arg0 ;
-(void)_updateSemanticStyleFiltersAndRegionArrayWithSampleBuffer:(struct opaqueCMSampleBuffer *)arg0 ;
