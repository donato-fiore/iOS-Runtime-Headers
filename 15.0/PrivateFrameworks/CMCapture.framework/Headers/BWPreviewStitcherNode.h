...
-(id)_featheredImageWithTeleImage:(id)arg0 wideImage:(id)arg1 clipRect:(struct CGRect )arg2 zoomingIn:(BOOL)arg3 progress:(float)arg4 ;
...
-(void)_renderOpacityRampToPixelBuffer:(struct __CVBuffer *)arg0 bounds:(struct CGRect )arg1 withWidePixelBuffer:(struct __CVBuffer *)arg2 telePixelBuffer:(struct __CVBuffer *)arg3 zoomingIn:(BOOL)arg4 progress:(float)arg5 ;
