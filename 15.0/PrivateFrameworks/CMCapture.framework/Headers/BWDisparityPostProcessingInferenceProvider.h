...
+(void)initialize;
-(id)initWithDisparityInputRequirement:(id)arg0 displacementInputRequirement:(id)arg1 previousFilteredInputRequirement:(id)arg2 outputRequirement:(id)arg3 portType:(id)arg4 resourceProvider:(id)arg5 configuration:(id)arg6 ;
-(id)newStorage;
