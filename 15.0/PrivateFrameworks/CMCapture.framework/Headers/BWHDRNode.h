...
-(void)_configureCaptureRequestStateWithRequestedStillImageCaptureSettings:(id)arg0 resolvedStillImageCaptureSettings:(id)arg1 ;
-(void)_emitNodeErrorToReportFailedOutputFrame;
-(void)_emitNodeErrorsIfNecessary;
-(void)_hdrProcessorOutputReady:(int)arg0 sampleBuffer:(struct opaqueCMSampleBuffer *)arg1 ;
-(void)dealloc;
