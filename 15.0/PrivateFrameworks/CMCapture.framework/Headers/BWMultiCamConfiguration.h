...
-(id)_initWithUnsynchronizedActiveStreamsPortTypes:(id)arg0 synchronizedActiveStreamsGroupsPortTypes:(id)arg1 withCaptureDevice:(id)arg2 readCurrentStateFromCaptureDevice:(BOOL)arg3 ;
