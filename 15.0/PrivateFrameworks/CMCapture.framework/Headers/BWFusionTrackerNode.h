...
@interface BWFusionTrackerNode : BWInferenceNode {
    ...
    NSObject<OS_dispatch_semaphore> *_signalsBackpressureSemaphore;
...
+(void)initialize;
-(BOOL)_attachISPDetectionsFromSampleBuffer:(struct opaqueCMSampleBuffer *)arg0 toTrackingInput:(id)arg1 withFrameTimestamp:(struct ? )arg2 ;
