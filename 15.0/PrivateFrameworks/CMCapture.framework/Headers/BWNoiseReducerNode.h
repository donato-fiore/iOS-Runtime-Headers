...
-(id)_outputRequirementsForInputFormat:(id)arg0 ;
-(id)initWithCameraTuningDictionary:(id)arg0 sensorIDDictionary:(id)arg1 ;
-(id)nodeSubType;
-(id)nodeType;
-(struct opaqueCMSampleBuffer *)_newQuadraResampledSampleBufferFromSampleBuffer:(struct opaqueCMSampleBuffer *)arg0 outputPixelBuffer:(struct __CVBuffer *)arg1 ;
