...
-(BOOL)widgetController:(id)arg0 validForTip:(id)arg1 tipDeliveryInfoMap:(id)arg2 deliveryInfoMap:(id)arg3 ;
...
-(void)processCollectionsMap:(id)arg0 collectionRootId:(id)arg1 completionHandler:(id)arg2 ;
-(void)processTipDocumentsDictionary:(id)arg0 completionHandler:(id)arg1 ;
-(void)processTips:(id)arg0 deliveryInfoMap:(id)arg1 completionHandler:(id)arg2 ;
