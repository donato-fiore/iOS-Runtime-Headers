...
@property (readonly, nonatomic) NSUInteger plateTypeIndexesCount;
...
-(id)targetCharAtIndex:(NSUInteger)arg0 ;
-(id)valueMappingAtIndex:(NSUInteger)arg0 ;
-(unsigned int)plateTypeIndexesAtIndex:(NSUInteger)arg0 ;
-(void)addPlateTypeIndexes:(unsigned int)arg0 ;
-(void)addTargetChar:(id)arg0 ;
-(void)addValueMapping:(id)arg0 ;
