...
@property (retain, nonatomic) GEOMultiSectionFeature *road; // ivar: _road
@property (readonly, nonatomic) CGFloat roadWidth; // ivar: _roadWidth
...
-(CGFloat)fractionOfCurrentStepTraveled;
-(id)description;
