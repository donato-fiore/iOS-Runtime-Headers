...
#ifndef GEOURLBACKEDMAPITEM_H
#define GEOURLBACKEDMAPITEM_H

@class NSURL, NSArray, NSDictionary, NSString, NSData, NSDate, NSTimeZone;
@protocol GEOMapItemStorageSerializable, GEOAnnotatedItemList, GEOEncyclopedicInfo, GEOTransitAttribution, GEOMapItemTransitInfo, GEOTransitVehiclePosition, GEOMapItemVenueInfo;
...
@property (readonly, nonatomic) GEOAddress *geoAddress; // ivar: _geoAddress
...
@property (readonly, nonatomic, getter=_hasMUID) BOOL hasMUID; // ivar: _hasMUID
...
@property (readonly, nonatomic, getter=_identifier) GEOMapItemIdentifier *identifier; // ivar: _identifier
...
@property (readonly, nonatomic, getter=_muid) NSUInteger muid; // ivar: _muid
...
@property (readonly, nonatomic, getter=_styleAttributes) GEOFeatureStyleAttributes *styleAttributes; // ivar: _styleAttributes
...
+(BOOL)urlContainsExtraStorage:(id)arg0 ;
-(id)init;
