...
-(id)initWithDisplayName:(id)arg0 multiSelect:(id)arg1 maximumNumberOfSelectElements:(unsigned int)arg2 clauseType:(NSInteger)arg3 showEqualWidthButtonsOnFilterView:(BOOL)arg4 ;
