...
#ifndef GEOIMAGESERVICEPURGECACHETOSIZEREQUEST_H
#define GEOIMAGESERVICEPURGECACHETOSIZEREQUEST_H
...
@property (nonatomic) NSUInteger targetSize; // ivar: _targetSize
