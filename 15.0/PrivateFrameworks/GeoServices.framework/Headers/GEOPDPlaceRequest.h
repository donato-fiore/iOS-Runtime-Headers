...
-(id)initWithBatchPopularNearbySearchCategories:(id)arg0 maxResults:(unsigned int)arg1 traits:(id)arg2 ;
...
-(id)initWithMerchantCode:(id)arg0 rawMerchantCode:(id)arg1 industryCategory:(id)arg2 industryCode:(id)arg3 paymentNetwork:(id)arg4 transactionDate:(id)arg5 transactionLocation:(id)arg6 terminalId:(id)arg7 transactionCurrencyCode:(id)arg8 transactionType:(int)arg9 transactionId:(id)arg10 warsawMerchantDomain:(id)arg11 warsawMerchantName:(id)arg12 warsawMerchantId:(id)arg13 adamId:(id)arg14 merchantId:(id)arg15 merchantDoingBizAsName:(id)arg16 merchantEnhancedName:(id)arg17 merchantCity:(id)arg18 merchantRawCity:(id)arg19 merchantState:(id)arg20 merchantRawState:(id)arg21 merchantZip:(id)arg22 merchantAddress:(id)arg23 merchantRawAddress:(id)arg24 merchantCountryCode:(id)arg25 merchantType:(id)arg26 merchantCleanConfidenceLevel:(id)arg27 merchantAdditionalData:(id)arg28 merchantCanl:(id)arg29 fuzzyMatched:(id)arg30 coarseLocationUsed:(id)arg31 traits:(id)arg32 ;
...
-(id)initWithPopularNearbySearchCategory:(id)arg0 maxResults:(unsigned int)arg1 traits:(id)arg2 ;
...
-(id)initWithSearchQuery:(id)arg0 entryMetadata:(id)arg1 metadata:(id)arg2 autocompleteEntry:(id)arg3 retainedSearch:(id)arg4 maxResults:(unsigned int)arg5 filters:(id)arg6 suppressResultsRequiringAttribution:(BOOL)arg7 traits:(id)arg8 error:(*id)arg9 ;
