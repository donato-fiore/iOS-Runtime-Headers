...
+(id)_infosForRouteLineStyleInfos:(id)arg0 coordinates:(id)arg1 updateable:(BOOL)arg2 ;
...
-(id)initWithGeoRouteLineStyleInfo:(id)arg0 coordinates:(id)arg1 distanceOffset:(CGFloat)arg2 ;
