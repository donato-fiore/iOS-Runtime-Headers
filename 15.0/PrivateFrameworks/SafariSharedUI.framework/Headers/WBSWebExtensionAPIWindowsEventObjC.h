...
#ifndef WBSWEBEXTENSIONAPIWINDOWSEVENTOBJC_H
#define WBSWEBEXTENSIONAPIWINDOWSEVENTOBJC_H
...
-(void)invokeListenersForNormalWindowWithArgument:(id)arg0 ;
-(void)invokeListenersForPopupWindowWithArgument:(id)arg0 ;
