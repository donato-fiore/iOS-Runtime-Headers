...
-(id)initWithCacheDirectoryURL:(id)arg0 isReadOnly:(BOOL)arg1 protectionType:(NSInteger)arg2 allowFetchingOverCellularNetwork:(BOOL)arg3 fileMappingStyle:(NSInteger)arg4 ;
