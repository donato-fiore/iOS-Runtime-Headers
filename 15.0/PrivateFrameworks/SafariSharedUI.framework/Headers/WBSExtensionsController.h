...
@class NSMutableDictionary, NSMutableSet, NSTimer, NSPointerArray, NSArray, NSDictionary, NSMutableArray;
...
-(void)_deferAccessToExtensionsDataInStorageDuringLoad:(BOOL)arg0 ;
