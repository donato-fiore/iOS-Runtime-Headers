...
@class NSURL, NSMutableArray, WBSDispatchSourceTimer, NSPointerArray, NSMutableDictionary, NSMapTable, NSMutableOrderedSet, NSBundle, NSDictionary, NSSet, NSArray, NSString, UIImage, NSDate, NSCountedSet, WKWebView, NSUUID, NSExtension, WKContentWorld;
...
@property (retain, nonatomic) NSCountedSet *backgroundPageEventListeners; // ivar: _backgroundPageEventListeners
...
@property (readonly, nonatomic) NSUUID *baseURIHost; // ivar: _baseURIHost
...
-(void)fireEvent:(NSUInteger)arg0 completionHandler:(id)arg1 ;
