...
-(void)executeScriptWithDetails:(id)arg0 fromExtensionWithID:(id)arg1 toTabWithID:(id)arg2 completionHandler:(id)arg3 ;
...
-(void)insertCSSWithDetails:(id)arg0 fromExtensionWithID:(id)arg1 toTabWithID:(id)arg2 completionHandler:(id)arg3 ;
...
-(void)removeCSSWithDetails:(id)arg0 fromExtensionWithID:(id)arg1 toTabWithID:(id)arg2 completionHandler:(id)arg3 ;
