...
@class NSMutableSet, WKBrowsingContextHandle, JSValue, NSArray, NSDictionary, NSString, NSSet, UIImage, NSURL, WKWebProcessPlugInScriptWorld;
...
@property (retain, nonatomic) WKWebProcessPlugInScriptWorld *world; // ivar: _world
