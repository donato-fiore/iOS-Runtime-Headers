...
@protocol WKWebProcessPlugInLoadDelegate, WBSBundleWebExtensionsControllerMessageReceiver;
...
@property (nonatomic) BOOL debugStubUnsuportedAPIs; // ivar: _debugStubUnsuportedAPIs
...
+(id)sharedController;
-(BOOL)receiveMessage:(id)arg0 fromSender:(id)arg1 inFrame:(id)arg2 inWorld:(id)arg3 replySender:(id)arg4 ;
...
-(void)receiveMessage:(id)arg0 fromSender:(id)arg1 inBrowsingContext:(id)arg2 inWorld:(id)arg3 replyHandler:(id)arg4 ;
-(void)receiveMessage:(id)arg0 fromSender:(id)arg1 inBrowsingContext:(id)arg2 replyHandler:(id)arg3 ;
-(void)receiveMessage:(id)arg0 fromSender:(id)arg1 toExtensionWithID:(id)arg2 inBrowsingContext:(id)arg3 replyHandler:(id)arg4 ;
