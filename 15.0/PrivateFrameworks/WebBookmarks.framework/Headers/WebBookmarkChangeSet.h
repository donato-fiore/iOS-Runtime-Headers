...
-(NSInteger)replayChangesToBookmark:(id)arg0 ;
-(NSUInteger)numberOfAddedBookmarksInBookmarkFolder:(int)arg0 ;
-(NSUInteger)numberOfReorderedBookmarksInBookmarkFolder:(int)arg0 ;
-(id)_bookmarkIdentifiersForWindowChange:(id)arg0 ;
-(id)_changeWithDictionaryRepresentation:(id)arg0 ;
...
-(void)_addBookmarkChange:(id)arg0 ;
-(void)_addChange:(id)arg0 ;
-(void)_addWindowChange:(id)arg0 ;
-(void)_readPersistedChanges;
-(void)_removeAllChanges;
-(void)_removeBookmarkChange:(id)arg0 ;
-(void)_removeWindowChange:(id)arg0 ;
