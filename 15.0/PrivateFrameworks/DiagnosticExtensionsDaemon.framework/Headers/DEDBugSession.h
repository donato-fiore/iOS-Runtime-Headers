...
@protocol NSSecureCoding, DEDSecureArchiving, DEDFinisher><DEDSecureArchiving, DEDNotifier><DEDSecureArchiving, OS_dispatch_queue, DEDClientProtocol, OS_os_log, DEDUploadStatusDelegate, DEDWorkerProtocol;
...
@property (weak) NSObject<DEDUploadStatusDelegate> *uploadDelegate; // ivar: _uploadDelegate
...
-(void)_startDiagnosticExtensionWithDEDIdentifier:(id)arg0 parameters:(id)arg1 completion:(id)arg2 ;
