...
@property (retain, nonatomic) UIImage *screenSharingAvatar; // ivar: _screenSharingAvatar
@property (copy, nonatomic) NSString *screenSharingTitle; // ivar: _screenSharingTitle
