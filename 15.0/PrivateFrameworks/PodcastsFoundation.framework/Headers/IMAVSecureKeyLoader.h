...
@class NSString, AVContentKeySession, AVURLAsset, NSData;
@protocol AVContentKeySessionDelegate, IMAVSecureKeyLoaderDelegate, MTSecureKeyRequestHandler, MTSecureKeyRequestStorage, NSURLSessionDelegate><AMSURLProtocolDelegate;
...
-(id)initWithRecipient:(id)arg0 useCase:(NSUInteger)arg1 urlProtocolDelegate:(id)arg2 ;
...
-(void)processContentKeyRequest:(id)arg0 requestType:(NSInteger)arg1 completion:(id)arg2 ;
-(void)processContentKeyRequestWithKeyIdentifier:(id)arg0 contentAdamId:(id)arg1 isRenewal:(BOOL)arg2 completion:(id)arg3 ;
-(void)processContentKeyRequestWithKeyRequestData:(id)arg0 isRenewal:(BOOL)arg1 completion:(id)arg2 ;
