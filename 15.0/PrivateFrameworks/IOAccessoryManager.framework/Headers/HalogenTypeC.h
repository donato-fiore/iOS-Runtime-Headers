...
-(BOOL)_doLDCMCalculation:(BOOL)arg0 isReceptacleWet:(BOOL)arg1 withWetTransitionThreshold:(CGFloat)arg2 withDryTransitionThreshold:(CGFloat)arg3 pinParasitics:(CGFloat)arg4 ;
...
-(int)_doLDCMMeasurement:(int)arg0 isReceptacleEmpty:(BOOL)arg1 isReceptacleWet:(BOOL)arg2 withWetTransitionThreshold:(CGFloat)arg3 withDryTransitionThreshold:(CGFloat)arg4 ;
