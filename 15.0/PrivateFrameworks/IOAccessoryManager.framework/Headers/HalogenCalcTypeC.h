...
-(int)doLiquidDetection:(id)arg0 withCurrentData:(id)arg1 isReceptacleEmpty:(BOOL)arg2 isReceptacleWet:(BOOL)arg3 withWetTransitionThreshold:(CGFloat)arg4 withDryTransitionThreshold:(CGFloat)arg5 pinParasitics:(CGFloat)arg6 ;
