...
@protocol BLTSectionInfoListDelegate, BLTSectionConfigurationDelegate, BLTSiriActionAppListDelegate, OS_dispatch_queue;
...
-(void)_sendSiriAppListWithInstalled:(id)arg0 removed:(id)arg1 ;
...
-(void)siriActionAppListUpdated:(id)arg0 ;
