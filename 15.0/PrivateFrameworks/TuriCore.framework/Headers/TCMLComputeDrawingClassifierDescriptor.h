...
-(BOOL)isComplete;
-(id)addConvLayer:(NSUInteger)arg0 outputChannels:(NSUInteger)arg1 source:(id)arg2 graph:(id)arg3 ;
-(id)addDenseLayer:(NSUInteger)arg0 outputChannels:(NSUInteger)arg1 source:(id)arg2 graph:(id)arg3 ;
