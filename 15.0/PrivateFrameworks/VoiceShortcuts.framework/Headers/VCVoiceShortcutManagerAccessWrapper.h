...
@protocol VCVoiceShortcutManagerXPCInterface, VCSyncDataEndpoint;
...
-(void)getAccessibilityWorkflowWithIdentifier:(id)arg0 completion:(id)arg1 ;
-(void)getAccessibilityWorkflowsWithCompletion:(id)arg0 ;
...
-(void)hasRunEventsInTheLast5DaysWithCompletion:(id)arg0 ;
