...
@protocol VCSpotlightSyncOperationDelegate, OS_dispatch_queue;
...
-(id)init;
-(id)initWithModifiedReferences:(id)arg0 inserted:(id)arg1 removed:(id)arg2 spotlightIndex:(id)arg3 localState:(id)arg4 ;
-(id)initWithReferences:(id)arg0 forceFullResync:(BOOL)arg1 spotlightIndex:(id)arg2 localState:(id)arg3 ;
