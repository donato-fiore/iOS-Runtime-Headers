...
@class WFDebouncer, NSString, CSSearchableIndex, WFDatabaseResult;
@protocol WFDatabaseObjectObserver, VCSpotlightSyncOperationDelegate, WFDatabaseProvider, OS_dispatch_queue, OS_os_transaction;
...
@property (nonatomic) BOOL hasAddedXPCEventHandlerObserver; // ivar: _hasAddedXPCEventHandlerObserver
