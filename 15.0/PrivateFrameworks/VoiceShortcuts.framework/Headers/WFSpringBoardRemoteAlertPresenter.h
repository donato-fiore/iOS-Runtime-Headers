...
@class NSXPCConnection, SBSRemoteAlertHandle, NSString, NSXPCListener, BKSApplicationStateMonitor;
...
@property (retain, nonatomic) BKSApplicationStateMonitor *monitor; // ivar: _monitor
