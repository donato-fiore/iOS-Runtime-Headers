...
@class NSString, NSXPCListener, NSMutableArray, WFDialogAttributions, WFWorkflowRunningContext, WFScreenOnObserver;
@protocol NSXPCListenerDelegate, WFDialogXPCHostProtocol, WFScreenOnObserverDelegate, WFDialogAlertPresenterDelegate, WFUIPresenterInterface, WFDialogXPCProtocol, WFDialogPresentationManagerDelegate, OS_dispatch_queue, WFDialogAlertPresenter;
...
@property (retain, nonatomic) NSObject<WFDialogXPCProtocol> *connectedDialog; // ivar: _connectedDialog
@property (copy, nonatomic) id *contentDismissalCompletionHandler; // ivar: _contentDismissalCompletionHandler
...
@property (retain, nonatomic) WFDialogAttributions *persistentRunningAttributions; // ivar: _persistentRunningAttributions
...
-(void)dismissPersistentChromeInDialog:(id)arg0 success:(BOOL)arg1 customAttributions:(id)arg2 completionHandler:(id)arg3 ;
