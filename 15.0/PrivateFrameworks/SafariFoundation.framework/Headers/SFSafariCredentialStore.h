...
+(BOOL)_savedPassword:(id)arg0 isRelatedToEntryHighLevelDomains:(id)arg1 andWebsiteURL:(id)arg2 ;
...
+(id)_credentialsMatchingSharedWebCredentialsDatabaseEntries:(id)arg0 websiteURL:(id)arg1 savedPasswords:(id)arg2 ;
