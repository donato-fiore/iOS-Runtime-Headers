...
@class NSString, SFSpeechRecognizer, SFSpeechAudioBufferRecognitionRequest, SFSpeechRecognitionTask, NSTimer, NSMutableArray;
...
-(id)initWithUtteranceId:(NSInteger)arg0 sessionNumber:(NSInteger)arg1 Locale:(id)arg2 audioSession:(id)arg3 keywordDetector:(id)arg4 speechRecognizer:(id)arg5 speechRecognitionRequest:(id)arg6 sessionDelegate:(id)arg7 sessionDispatchQueue:(id)arg8 completion:(id)arg9 ;
