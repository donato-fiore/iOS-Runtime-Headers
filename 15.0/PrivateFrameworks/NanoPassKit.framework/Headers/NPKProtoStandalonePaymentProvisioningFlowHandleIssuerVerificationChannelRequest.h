...
#ifndef NPKPROTOSTANDALONEPAYMENTPROVISIONINGFLOWHANDLEISSUERVERIFICATIONCHANNELREQUEST_H
#define NPKPROTOSTANDALONEPAYMENTPROVISIONINGFLOWHANDLEISSUERVERIFICATIONCHANNELREQUEST_H
...
@property (retain, nonatomic) NSString *selectedVerificationChannelIdentifier; // ivar: _selectedVerificationChannelIdentifier
