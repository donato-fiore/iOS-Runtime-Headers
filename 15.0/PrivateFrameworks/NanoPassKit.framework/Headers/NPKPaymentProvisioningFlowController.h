...
-(void)_transitionToTermsForReason:(NSUInteger)arg0 URL:(id)arg1 requestContext:(id)arg2 ;
...
-(void)dealloc;
-(void)ensureMetadataForCredentials:(id)arg0 requestContext:(id)arg1 completionHandler:(id)arg2 ;
