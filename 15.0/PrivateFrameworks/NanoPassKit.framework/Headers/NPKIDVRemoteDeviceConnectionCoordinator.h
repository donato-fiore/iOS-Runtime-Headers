...
@protocol IDSServiceDelegate, NPKIDVRemoteDeviceCredentialStorageCoordinatorProtocol, OS_dispatch_queue;

#import <Foundation/Foundation.h>


@interface NPKIDVRemoteDeviceConnectionCoordinator : NSObject <IDSServiceDelegate, NPKIDVRemoteDeviceCredentialStorageCoordinatorProtocol>
...
-(void)elementsOfCredential:(id)arg0 elementIdentifiers:(id)arg1 withConfiguredPartitions:(id)arg2 completion:(id)arg3 ;
-(void)establishPrearmTrust:(id)arg0 completion:(id)arg1 ;
-(void)establishPrearmTrustResponse:(id)arg0 ;
-(void)fetchCredentialElementsResponse:(id)arg0 ;
