...
@property (nonatomic) unsigned int transactionType; // ivar: _transactionType
@property (nonatomic) CGFloat validUntilEpochTimeInterval; // ivar: _validUntilEpochTimeInterval
@property (retain, nonatomic) NSString *watchPassUniqueID; // ivar: _watchPassUniqueID
