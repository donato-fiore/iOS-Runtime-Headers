...
@interface NPKGizmoDatabase : NSObject {
    ...
    *sqlite3_stmt _selectCloudKitArchivedTransactionsStatement;
...
@property (readonly) *sqlite3_stmt selectCloudKitArchivedTransactionsStatement;
...
-(id)_transactionsWithCloudKitArchivedState:(BOOL)arg0 ;
...
-(id)transactionsWithCloudKitArchivedState:(BOOL)arg0 ;
