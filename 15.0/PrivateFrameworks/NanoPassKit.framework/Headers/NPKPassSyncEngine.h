...
-(void)_sendReconciledStateUnrecognizedWithHash:(id)arg0 currentPassSyncState:(id)arg1 ;
...
-(void)handleReconciledStateUnrecognizedWithHash:(id)arg0 passSyncState:(id)arg1 ;
