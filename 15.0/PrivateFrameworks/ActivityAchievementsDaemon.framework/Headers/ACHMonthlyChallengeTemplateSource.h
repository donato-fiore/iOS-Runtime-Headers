...
@class NSDate, NSCalendar, NSString;
@protocol ACHTemplateSource, ACHTemplateSourceDelegate;
...
-(BOOL)isGoalValueForMonthlyChallengeTypeValid:(NSUInteger)arg0 ;
-(BOOL)isMonthlyChallengeOfTypeAvailable:(NSUInteger)arg0 ;
-(BOOL)sourceShouldRunForDate:(id)arg0 ;
-(BOOL)subObjectsHaveDatabaseAssertions;
-(CGFloat)_goalValueForCurrentMonthForType:(NSUInteger)arg0 ;
-(CGFloat)_roundedGoalValue:(CGFloat)arg0 monthlyChallengeType:(NSUInteger)arg1 ;
-(CGFloat)_targetGoalValueForCurrentMonthForType:(NSUInteger)arg0 ;
...
-(id)_suffixForCurrentMonthForType:(NSUInteger)arg0 template:(id)arg1 ;
-(id)_yearMonthStringFromTemplateName:(id)arg0 ;
-(id)customPlaceholderValuesForTemplate:(id)arg0 ;
