...
@protocol _TtP8MapsSync25MapsSyncDataQueryDelegate_, _TtP8MapsSync30MapsSyncDataQueryMergeDelegate_, MapsSuggestionsShortcutStorage, OS_dispatch_queue;
...
-(id)init;
-(id)mergeDuplicateObjectsWithQuery:(id)arg0 duplicates:(id)arg1 ;
