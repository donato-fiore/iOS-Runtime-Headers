...
@property (retain, nonatomic) CSEndpointLatencyInfo *endpointLatencyInfo; // ivar: _endpointLatencyInfo
...
@property (nonatomic) BOOL needsPostGain; // ivar: _needsPostGain
...
-(BOOL)_setupAudioProviderFromXPC:(id)arg0 context:(id)arg1 ;
