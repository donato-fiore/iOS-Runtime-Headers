...
@class AFClientConfiguration, AFExperimentContext, NSString, AFLanguageDetectionUserContext, AFSpeechRecordingAlertPolicy, NSUUID;
...
-(NSInteger)_csAudioRecordTypeForSpeechEvent:(NSInteger)arg0 useBorealisBuffer:(BOOL)arg1 currentClientConfiguration:(id)arg2 ;
-(NSInteger)audioAlertStyleForRecordRoute:(id)arg0 playbackRoute:(id)arg1 ;
-(NSInteger)event;
...
-(id)_alertBehaviorForRecordRoute:(id)arg0 playbackRoute:(id)arg1 attemptsToUsePastDataBufferFrames:(BOOL)arg2 ;
...
-(id)recordSettingsWithOptions:(NSUInteger)arg0 ;
-(id)startRecordingSettingsWithRecordRoute:(id)arg0 playbackRoute:(id)arg1 ;
