...
@class NSMutableArray, CSPlainAudioFileWriter, CSAsset, NSString;
...
-(void)_handleSecondPassResult:(NSUInteger)arg0 deviceId:(id)arg1 voiceTriggerInfo:(id)arg2 secondChanceCandidate:(BOOL)arg3 error:(id)arg4 ;
