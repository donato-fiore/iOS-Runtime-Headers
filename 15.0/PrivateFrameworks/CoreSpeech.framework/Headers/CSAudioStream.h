...
@property (nonatomic) BOOL scheduledFutureSample; // ivar: _scheduledFutureSample
@property (retain, nonatomic) CSAudioStartStreamOption *startStreamOption; // ivar: _startStreamOption
