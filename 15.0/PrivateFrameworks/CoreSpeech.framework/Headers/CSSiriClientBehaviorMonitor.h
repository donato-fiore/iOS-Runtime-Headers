...
-(void)notifyFetchedAudioStreamWithRequest:(id)arg0 audioProviderUUID:(id)arg1 successfully:(BOOL)arg2 ;
-(void)notifyPreparedAudioStreamWithRequest:(id)arg0 audioProviderUUID:(id)arg1 successfully:(BOOL)arg2 ;
