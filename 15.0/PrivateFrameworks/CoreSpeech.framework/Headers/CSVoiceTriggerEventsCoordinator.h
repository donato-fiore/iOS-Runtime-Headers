...
@protocol CSAudioRouteChangeMonitorDelegate, CSVoiceTriggerDelegate, OS_dispatch_queue;

#import <Foundation/Foundation.h>


@interface CSVoiceTriggerEventsCoordinator : NSObject <CSAudioRouteChangeMonitorDelegate, CSVoiceTriggerDelegate>
...
-(void)_notifyKeywordReject:(id)arg0 ;
