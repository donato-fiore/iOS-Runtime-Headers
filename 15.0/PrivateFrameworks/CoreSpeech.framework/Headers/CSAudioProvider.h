...
@class NSString, NSUUID, NSMutableArray, NSHashTable, CSAudioTimeConverter, CSAudioCircularBuffer, CSAudioRecordContext, CSOSTransaction, NSMutableDictionary;
...
-(BOOL)_hasMultipleVoiceTriggerInfoAvailable:(id)arg0 ;
-(BOOL)_isVoiceTriggerInfoAvailableLocally:(id)arg0 ;
...
-(void)setLatestRecordContext:(id)arg0 ;
