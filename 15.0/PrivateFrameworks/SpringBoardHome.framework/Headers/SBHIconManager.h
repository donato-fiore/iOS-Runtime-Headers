...
@property (retain, nonatomic) NSMutableArray *activeProactiveSuggestedIcons; // ivar: _activeProactiveSuggestedIcons
...
@property (nonatomic) BOOL canUndoWidgetIntroductionWidgets; // ivar: _canUndoWidgetIntroductionWidgets
@property (retain, nonatomic) SBFolder *closingFolder; // ivar: _closingFolder
@property (nonatomic, getter=isContentOccluded) BOOL contentOccluded; // ivar: _contentOccluded
...
-(BOOL)shouldRootFolderControllerBeOccluded;
...
-(void)todayViewController:(id)arg0 occlusionDidChange:(BOOL)arg1 ;
-(void)todayViewController:(id)arg0 occlusionWillChange:(BOOL)arg1 ;
