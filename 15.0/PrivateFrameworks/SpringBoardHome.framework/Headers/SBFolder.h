...
@protocol SBFolderObserver, SBTreeNode, SBIconIndexNode, SBIconIndexMutableListObserver, SBIconListModelObserver, SBIconListModelDelegate, BSDescriptionProviding;
...
-(id)placeIcon:(id)arg0 atIndexPath:(id)arg1 ;
-(id)placeIcon:(id)arg0 atIndexPath:(id)arg1 options:(NSUInteger)arg2 ;
