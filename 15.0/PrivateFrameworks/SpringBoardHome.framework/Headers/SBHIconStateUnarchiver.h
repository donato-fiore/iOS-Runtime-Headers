...
-(id)_listFromRepresentation:(id)arg0 listGridSize:(struct SBHIconGridSize )arg1 listWithNonDefaultSizedIconsGridSize:(struct SBHIconGridSize )arg2 gridSizeClassSizes:(struct SBHIconGridSizeClassSizes )arg3 listRotatedLayoutClusterGridSizeClass:(NSUInteger)arg4 listAllowedGridSizeClasses:(NSUInteger)arg5 identifier:(id)arg6 context:(id)arg7 overflow:(id)arg8 ;
-(id)_listWithIcons:(id)arg0 listGridSize:(struct SBHIconGridSize )arg1 listWithNonDefaultSizedIconsGridSize:(struct SBHIconGridSize )arg2 gridSizeClassSizes:(struct SBHIconGridSizeClassSizes )arg3 listRotatedLayoutClusterGridSizeClass:(NSUInteger)arg4 listAllowedGridSizeClasses:(NSUInteger)arg5 identifier:(id)arg6 folder:(id)arg7 overflow:(id)arg8 ;
