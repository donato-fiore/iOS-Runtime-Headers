...
@class NSMapTable, UITapGestureRecognizer, NSURL, NSString, UIImageView, UIScrollView;
...
@interface SBRootFolderViewPageManagementLayoutManager : NSObject <SBFolderObserver, SBIconViewProviding, SBIconViewDelegate, SBIconViewActionDelegate, SBIconListViewDragDelegate, SBHPageManagementCellViewControllerDelegate, SBIconListViewDominoPivotAnimatorDelegate, SBIconDragManagerDelegate, SBIconListModelObserver, UIScrollViewDelegate, SBRootFolderViewLayoutManager>

 {
    ...
    BOOL _restoreSidebarVisibility;
}
...
@property (retain, nonatomic) NSObject<BSInvalidatable> *pageControlBorrowedAssertion; // ivar: _pageControlBorrowedAssertion
...
-(void)layoutDoneButtonInFolderView:(id)arg0 metrics:(struct SBRootFolderViewMetrics *)arg1 ;
...
-(void)updateSidebarVisibilityInFolderView:(id)arg0 transitioningToActive:(BOOL)arg1 ;
