...
@protocol SBIconListPageControlDelegate, UITextFieldDelegate, SBIconListLayoutDelegate, SBHScrollableIconViewContaining, SBIconScrollViewDelegate, SBFolderObserver, BSDescriptionProviding, SBIconListViewDragDelegate, SBFolderViewDelegate, SBIconViewProviding, SBIconListLayoutProvider;
