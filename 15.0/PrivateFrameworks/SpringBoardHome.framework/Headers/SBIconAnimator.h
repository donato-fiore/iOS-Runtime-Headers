...
@property (retain, nonatomic) SBValueConvergenceAnimator *hintAnimator; // ivar: _hintAnimator
@property (nonatomic) CGFloat hintFraction; // ivar: _hintFraction
...
-(void)cleanup;
-(void)dealloc;
-(void)hintToFraction:(CGFloat)arg0 ;
-(void)prepare;
