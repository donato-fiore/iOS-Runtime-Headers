...
@protocol UISearchBarDelegate, SBHLibrarySearchControllerDelegate, SBHLibraryCategoryMapProviderObserver, SBHIconLibraryTableViewControllerObserver, SBIconViewProviding, SBIconViewDelegate, SBNestingViewControllerDelegate, SBHLibraryPodFolderControllerDelegate, SBFolderControllerDelegate, SBHLibraryProvider, SBHOccludable, SBFOverlayObserving, BSInvalidatable, SBHomeScreenIconTransitionAnimatorDelegate, SBIconListLayoutProvider;
