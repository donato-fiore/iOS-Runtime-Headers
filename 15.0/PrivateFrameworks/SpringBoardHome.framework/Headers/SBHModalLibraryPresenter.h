...
@protocol SBHModalLibraryPresentationContext, SBHViewControllerTransitionDelegate, UIGestureRecognizerDelegate, BSDescriptionProviding, SBHModalLibraryPresenterContextProviding, SBHModalLibraryPresentationDelegate;
