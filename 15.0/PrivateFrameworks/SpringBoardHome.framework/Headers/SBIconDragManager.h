...
@class NSMapTable, NSMutableDictionary, NSHashTable, NSString;
...
-(id)draggedItemIdentifiersForDragDropSession:(id)arg0 ;
...
-(id)iconIdentifierForDragItem:(id)arg0 ;
...
-(void)addPlatterViewToMedusaDragOffscreenWindow:(id)arg0 ;
...
-(void)removeIconsWithDraggedIconIdentifiers:(id)arg0 savingOriginsToContext:(id)arg1 ;
