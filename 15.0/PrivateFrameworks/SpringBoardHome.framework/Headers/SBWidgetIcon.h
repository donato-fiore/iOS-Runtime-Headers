...
-(id)initWithCHSAvocadoDescriptor:(id)arg0 ;
-(id)initWithCHSAvocadoDescriptors:(id)arg0 ;
-(id)initWithCHSAvocadoDescriptors:(id)arg0 suggestionSource:(NSInteger)arg1 ;
...
-(id)initWithWidgetExtensionIdentifiers:(id)arg0 widgetKinds:(id)arg1 widgetContainerBundleIdentifers:(id)arg2 ;
