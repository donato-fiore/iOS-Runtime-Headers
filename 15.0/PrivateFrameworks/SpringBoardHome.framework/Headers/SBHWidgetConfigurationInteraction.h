...
@class UIView, MTMaterialView, INIntent, WFWidgetConfigurationOptions, WFWidgetConfigurationViewController, UIViewController, NSString, UITapGestureRecognizer, CHSAvocadoDescriptor;
...
@property (readonly, copy, nonatomic) CHSAvocadoDescriptor *widgetDescriptor; // ivar: _widgetDescriptor
