...
@class UIViewController, NSHashTable, SBFFluidBehaviorSettings, NSArray, UIView, NSString, _UILegibilitySettings, UIPageControl, NSTimer, BSUIScrollView, NSMutableDictionary;
@protocol BSUIScrollViewDelegate, SBLeafIconObserver, PTSettingsKeyObserver, SBIconViewCustomImageViewControllerObserving, SBHWidgetContainerViewControllerDelegate, SBIconViewCustomImageViewControlling, SBLeafIconDataSource, SBHWidgetStackViewControllerDataSource, SBHWidgetStackViewControllerDelegate, BSInvalidatable;
