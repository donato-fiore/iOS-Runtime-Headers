...
@property (nonatomic, getter=isWidgetIntroductionPreferenceShown) BOOL widgetIntroductionPreferenceShown; // ivar: _widgetIntroductionPreferenceShown
...
-(void)dismissWidgetAddSheetIfPresented:(BOOL)arg0 ;
