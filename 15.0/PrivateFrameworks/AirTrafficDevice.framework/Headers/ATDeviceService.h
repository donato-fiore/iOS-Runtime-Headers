...
@class ATConcreteService, ATNetServiceListener, ATServiceProxyListener, NSMapTable, ATStatusObserverListener, ATEventScheduler, MSVXPCTransaction, NSString;
@protocol ATMessageLinkListenerDelegate, ATMessageLinkRequestHandler, ATXPCInterfaceProtocol, ATSyncClientDelegate, ATIDSServiceListener, OS_dispatch_queue;
