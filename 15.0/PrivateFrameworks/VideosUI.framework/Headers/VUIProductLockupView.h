...
@class UIView, NSString, NSArray, UIImage, VUIImageProxy, VUIImageView, TVFocusableTextView, NSNumber;
...
@property (retain, nonatomic) TVFocusableTextView *descriptionTextView; // ivar: _descriptionTextView
