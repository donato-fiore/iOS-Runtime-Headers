...
@protocol VUICollectionCellEventIntercepting, VUICollectionViewCellUpdater;
...
@property (weak, nonatomic) NSObject<VUICollectionViewCellUpdater> *vuiCollectionViewCellUpdater; // ivar: _vuiCollectionViewCellUpdater
