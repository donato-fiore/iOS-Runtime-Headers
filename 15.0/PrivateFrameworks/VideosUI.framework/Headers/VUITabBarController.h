...
@protocol UITabBarControllerDelegate, UIGestureRecognizerDelegate, VUITVAppRootViewController, VUITabBarProtocol, VUITabBarChildViewControllerInteraction, VUITabBarControllerUpdatingDelegate;
...
-(id)_tabBarChildViewControllerWithIdentifier:(id)arg0 documentRef:(id)arg1 supportsInAppBanner:(BOOL)arg2 isNonServerTab:(BOOL)arg3 title:(id)arg4 isSelectedTab:(BOOL)arg5 appContext:(id)arg6 iconResource:(id)arg7 contextData:(id)arg8 ;
-(id)init;
