...
#ifndef _VUIMONOGRAMRESOURCEIMAGEGENERATOR_H
#define _VUIMONOGRAMRESOURCEIMAGEGENERATOR_H

@class VUIMonogramImageGenerator;



@interface _VUIMonogramResourceImageGenerator : VUIMonogramImageGenerator
