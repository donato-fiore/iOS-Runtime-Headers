...
@class UIViewController<VUIPlayerViewController>, NSString, UIViewController, NSDate, NSNumber, UIImage, NSDictionary, UIButton, TVPStateMachine;
...
-(void)dismissPlaybackAnimated:(BOOL)arg0 completion:(id)arg1 ;
