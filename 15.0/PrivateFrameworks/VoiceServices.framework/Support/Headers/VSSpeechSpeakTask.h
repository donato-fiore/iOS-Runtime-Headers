...
@class NSOperation, VSAudioData, NSString, NSError, VSInstrumentMetrics, NSArray, VSSpeechRequest, VSVoiceResourceAsset, VSVoiceAssetSelection;
@protocol VSSpeechSpeakableProtocol, VSSpeechServiceDelegate, VSSpeechCacheItem, OS_dispatch_queue;
