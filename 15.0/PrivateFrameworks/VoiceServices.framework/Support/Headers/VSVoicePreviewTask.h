...
+(id)sharedInstance;
+(void)startVoicePreviewForLanguageCode:(id)arg0 voiceName:(id)arg1 previewType:(NSInteger)arg2 completion:(id)arg3 ;
...
-(void)startVoicePreviewWithURL:(id)arg0 completion:(id)arg1 ;
-(void)stopVoicePreview;
