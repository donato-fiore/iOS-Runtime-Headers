...
@protocol CKActionSheetMenuViewDelegate, CKBalloonViewDelegate, CKStickerDetailViewControllerDelegate, PHLivePhotoViewDelegate, CKMessageHighlightButtonDelegate;
...
@interface CKFullScreenBalloonViewControllerPhone : CKFullScreenBalloonViewController <CKActionSheetMenuViewDelegate, CKBalloonViewDelegate, CKStickerDetailViewControllerDelegate, PHLivePhotoViewDelegate, CKMessageHighlightButtonDelegate>
...
@property (retain, nonatomic) CKActionSheetMenuView *menuView; // ivar: _menuView
...
-(id)initWithChatItem:(id)arg0 title:(id)arg1 interfaceActions:(id)arg2 gradientReferenceView:(id)arg3 isGroupConversation:(BOOL)arg4 showActionMenu:(BOOL)arg5 pluginBalloonSnapshot:(id)arg6 delegate:(id)arg7 ;
...
-(void)balloonEditMenuViewWasDismissed:(id)arg0 ;
