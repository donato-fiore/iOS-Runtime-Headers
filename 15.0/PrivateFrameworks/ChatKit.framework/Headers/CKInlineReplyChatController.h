...
@class UIVisualEffectView, UINavigationBarAppearance, NSDictionary, NSString, IMMessageItem;
@protocol CKInlineReplyInteractionDelegate;


#import "CKChatController.h"
#import "CKInlineReplyCollectionViewController.h"
#import "CKInlineReplyTransitionContext.h"
...
@property (retain, nonatomic) CKInlineReplyTransitionContext *transitionContext; // ivar: _transitionContext
