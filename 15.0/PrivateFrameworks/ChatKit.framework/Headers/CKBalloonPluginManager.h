...
@class NSArray, NSMutableArray, NSMutableDictionary, NSHashTable, NSString, NSCache, IMBalloonPlugin, NSSet, NSDictionary;
...
@property (retain, nonatomic) NSString *lastLaunchedIdentifier; // ivar: _lastLaunchedIdentifier
@property (weak, nonatomic) IMBalloonPlugin *lastViewedPlugin; // ivar: _lastViewedPlugin
