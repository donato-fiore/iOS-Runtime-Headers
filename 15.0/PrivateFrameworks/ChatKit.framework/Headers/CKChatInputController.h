...
@class IMBalloonPlugin, IMBalloonPluginDataSource, NSString, IMScheduledUpdater, UIViewController<CKBrowserViewControllerProtocol>, UINavigationController, UIViewController, NSDate, UITextInputPayloadController;
...
-(BOOL)__im_ff_modernAppPresentationEnabled;
