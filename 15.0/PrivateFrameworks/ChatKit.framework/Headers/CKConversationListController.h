...
@property (retain, nonatomic) _UIContextMenuInteraction *contextMenuInteraction; // ivar: _contextMenuInteraction
...
-(id)actionsForTranscriptPreviewController:(id)arg0 ;
