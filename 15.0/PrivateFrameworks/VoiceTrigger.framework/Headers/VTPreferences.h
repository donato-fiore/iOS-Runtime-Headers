...
-(BOOL)_voiceTriggerEnabledForEndpointId:(id)arg0 ;
...
-(void)_setVoiceTriggerEnabled:(BOOL)arg0 sender:(id)arg1 ;
-(void)_setVoiceTriggerEnabled:(BOOL)arg0 sender:(id)arg1 endpointId:(id)arg2 ;
