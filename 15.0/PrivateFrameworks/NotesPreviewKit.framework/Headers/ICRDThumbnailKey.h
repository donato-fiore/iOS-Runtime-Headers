...
#ifndef ICRDTHUMBNAILKEY_H
#define ICRDTHUMBNAILKEY_H
...
-(id)initWithType:(NSInteger)arg0 accountId:(id)arg1 objectId:(id)arg2 preferredSize:(struct CGSize )arg3 scale:(CGFloat)arg4 appearance:(NSUInteger)arg5 isRTL:(BOOL)arg6 contentSizeCategory:(id)arg7 hasBoldText:(BOOL)arg8 hasButtonShapes:(BOOL)arg9 hasDarkerSystemColors:(BOOL)arg10 ;
