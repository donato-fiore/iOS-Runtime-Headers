...
+(id)getPreferenceValueOfClass:(Class)arg0 forKey:(id)arg1 ;
+(id)getPreferenceValueOfClass:(Class)arg0 forKey:(id)arg1 defaultValue:(id)arg2 ;
+(void)initialize;
...
-(int)enrollContinue;
-(int)fieldDiagnosticsControl:(unsigned int)arg0 inData:(id)arg1 outData:(*id)arg2 withClient:(id)arg3 ;
