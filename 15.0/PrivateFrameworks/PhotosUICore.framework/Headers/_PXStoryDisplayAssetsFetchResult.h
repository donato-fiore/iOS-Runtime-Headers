...
#ifndef _PXSTORYDISPLAYASSETSFETCHRESULT_H
#define _PXSTORYDISPLAYASSETSFETCHRESULT_H
...
@property (nonatomic) NSInteger configuredCount; // ivar: _configuredCount
...
-(void)configureWithRange:(struct _NSRange )arg0 resourcesDataSource:(id)arg1 ;
-(void)dealloc;
