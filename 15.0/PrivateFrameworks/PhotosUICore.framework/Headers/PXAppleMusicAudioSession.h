...
@class NSString;
@protocol PXChangeObserver, OS_os_log, OS_dispatch_queue;


#import "PXAudioSession.h"
#import "PXAppleMusicPlayerController.h"
...
@property (retain, nonatomic) PXAppleMusicPlayerController *playerController; // ivar: _playerController
...
@property (nonatomic) NSInteger stateQueue_preparationID; // ivar: _stateQueue_preparationID
...
-(void)_handlePlayerPreparedToPlayWithError:(id)arg0 didTimeOut:(BOOL)arg1 signpostID:(NSUInteger)arg2 ;
-(void)_stateQueue_handlePlayerPreparedToPlayWithError:(id)arg0 didTimeOut:(BOOL)arg1 signpostID:(NSUInteger)arg2 ;
-(void)_stateQueue_timeOutPreparationIfNeededWithPreparationID:(NSInteger)arg0 signpostID:(NSUInteger)arg1 ;
