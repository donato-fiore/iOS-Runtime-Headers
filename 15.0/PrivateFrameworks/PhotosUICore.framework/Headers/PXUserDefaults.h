...
@property (copy, nonatomic) NSNumber *allPhotosLibraryAssetSource; // ivar: _allPhotosLibraryAssetSource
...
@property (copy, nonatomic) NSNumber *hubbleLastRadarPromptAnsweredQuestionCount; // ivar: _hubbleLastRadarPromptAnsweredQuestionCount
@property (copy, nonatomic) NSDate *hubbleLastSurveyQuestionsRadarPromptDate; // ivar: _hubbleLastSurveyQuestionsRadarPromptDate
@property (copy, nonatomic) NSDate *hubbleSurveyQuestionsHideDate; // ivar: _hubbleSurveyQuestionsHideDate
