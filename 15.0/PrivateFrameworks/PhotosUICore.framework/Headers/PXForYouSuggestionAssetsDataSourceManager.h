...
@protocol PXSectionedDataSourceManagerObserver, PXPhotoLibraryUIChangeObserver, PXDisplaySuggestion;
...
@property (retain, nonatomic) NSObject<PXDisplaySuggestion> *displayOriginalSuggestion; // ivar: _displayOriginalSuggestion
