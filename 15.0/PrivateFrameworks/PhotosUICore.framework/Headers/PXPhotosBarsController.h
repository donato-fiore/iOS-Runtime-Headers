...
@class NSMapTable, NSString, PLDateRangeFormatter, NSArray;
@protocol PXChangeObserver, PXActionPerformerDelegate, PXPhotosGridActionPerformerDelegate, PXPhotosGridOptionsControllerDelegate, PXAssetCollectionActionPerformerDelegate, PXSettingsKeyObserver, PXPhotosBarsControllerDelegate;
...
@property (weak, nonatomic) NSObject<PXPhotosBarsControllerDelegate> *delegate; // ivar: _delegate
