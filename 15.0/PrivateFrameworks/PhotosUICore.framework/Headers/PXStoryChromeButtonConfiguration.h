...
@class NSString, NSArray, UIMenu, UIColor;
@protocol PXGViewUserData, NSObject, PXDisplayAsset, PXStoryMenuDelegate;
...
@property (weak, nonatomic) NSObject<PXStoryMenuDelegate> *menuDelegate; // ivar: _menuDelegate
...
@property (nonatomic) NSInteger preferredImageWeight; // ivar: _preferredImageWeight
