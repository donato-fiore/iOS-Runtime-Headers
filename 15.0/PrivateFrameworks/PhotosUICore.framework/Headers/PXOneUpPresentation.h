...
@class UIContextMenuInteraction, NSMapTable, UIViewController, NSString, UITargetedPreview, NSArray, UIScrollView;
...
@property (readonly, nonatomic) BOOL isContextMenuInteractionActive; // ivar: _isContextMenuInteractionActive
