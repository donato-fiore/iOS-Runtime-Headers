...
@property (nonatomic) BOOL allowZoomTransitions; // ivar: _allowZoomTransitions
...
@property (nonatomic) BOOL enableDebugCurationBadge; // ivar: _enableDebugCurationBadge
@property (nonatomic) BOOL formattedLensStringsEnabled; // ivar: _formattedLensStringsEnabled
@property (nonatomic) BOOL infoPanelFeatureEnabled; // ivar: _infoPanelFeatureEnabled
...
@property (nonatomic) BOOL mapWidgetUseInfoPanelLayout; // ivar: _mapWidgetUseInfoPanelLayout
...
@property (nonatomic) BOOL showRelatedWidget; // ivar: _showRelatedWidget
@property (nonatomic) BOOL showTimeWidget; // ivar: _showTimeWidget
@property (nonatomic) BOOL showVariationsWidget; // ivar: _showVariationsWidget
