...
@property (retain, nonatomic) UIBarButtonItem *selectItem; // ivar: _selectItem
...
-(id)_changeMemberAtIndex:(id)arg0 toPersonType:(NSInteger)arg1 ;
...
-(void)_showFavoritingBootstrapForPersonIfApplicable:(id)arg0 ;
