...
#ifndef PXCLOUDCAPABILITIESCONTROLLER_H
#define PXCLOUDCAPABILITIESCONTROLLER_H

@class NSString, NSError, NSNumber, NSMutableArray, SKCloudServiceController;
@protocol PXSettingsKeyObserver, PXChangeObserver, OS_dispatch_queue;


#import "PXObservable.h"
#import "PXUpdater.h"

@interface PXCloudCapabilitiesController : PXObservable <PXSettingsKeyObserver, PXChangeObserver>
