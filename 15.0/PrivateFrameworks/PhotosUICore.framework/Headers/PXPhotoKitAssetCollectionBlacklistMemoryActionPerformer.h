...
+(BOOL)canPerformBlockingOnAssetCollection:(id)arg0 ;
...
-(id)_disambiguationActionsForAlert:(BOOL)arg0 withActionHandler:(id)arg1 ;
-(id)disambiguationMenuForUseCase:(NSUInteger)arg0 withMenuActionHandler:(id)arg1 ;
