...
@class PHFetchResult, NSDictionary, NSString;
...
@property (readonly, nonatomic) PHFetchResult *assetFetchResult; // ivar: _assetFetchResult
...
-(id)initWithPhotosDataSource:(id)arg0 displayTitleInfo:(id)arg1 parentContext:(id)arg2 keyAssetsFetchResult:(id)arg3 assetFetchResult:(id)arg4 ;
