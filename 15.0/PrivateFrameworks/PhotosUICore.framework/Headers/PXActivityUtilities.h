...
+(id)_initialsFromFirstName:(id)arg0 lastName:(id)arg1 ;
+(id)sharedWorkQueue;
...
+(void)_requestMonogramForFirstName:(id)arg0 lastName:(id)arg1 targetSize:(struct CGSize )arg2 displayScale:(CGFloat)arg3 isRTL:(BOOL)arg4 completion:(id)arg5 ;
