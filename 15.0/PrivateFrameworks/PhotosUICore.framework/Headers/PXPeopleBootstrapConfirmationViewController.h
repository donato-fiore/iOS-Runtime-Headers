...
@protocol PXPeopleSuggestionManagerDelegate, PXPeopleBootstrapFooterViewDelegate, PXPeopleFlowViewController, PXPeopleFlowViewControllerActionDelegate;
...
@property (nonatomic) BOOL hasAnImageBeenSet; // ivar: _hasAnImageBeenSet
