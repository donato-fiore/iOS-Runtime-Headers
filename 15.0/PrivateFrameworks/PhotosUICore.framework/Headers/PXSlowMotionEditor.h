...
@property (weak, nonatomic) NSObject<PXSlowMotionEditorDelegate> *delegate; // ivar: _delegate
...
+(id)handleImage;
-(BOOL)_isPoint:(struct CGPoint )arg0 inHandleIsStart:(BOOL)arg1 outTouchOffset:(*CGFloat)arg2 ;
-(BOOL)_isZoomed;
-(CGFloat)_trackScale;
...
-(void)_beginTrackingZoomWithPoint:(struct CGPoint )arg0 ;
-(void)_cancelTrackingZoom;
-(void)_cancelZoom;
-(void)_cancelZoomTrackingIfNeccessaryWithPoint:(struct CGPoint )arg0 ;
-(void)_drawCurveWithFlatEndsFromX:(CGFloat)arg0 fromY:(CGFloat)arg1 toX:(CGFloat)arg2 toY:(CGFloat)arg3 ;
-(void)_updateSlidersWithPoint:(struct CGPoint )arg0 ;
-(void)_updateTrack;
-(void)_zoomPressWasHeld;
-(void)handleBeginTrackingAtLocation:(struct CGPoint )arg0 ;
-(void)handleChangeTrackingAtLocation:(struct CGPoint )arg0 ;
-(void)handleEndTrackingAtLocation:(struct CGPoint )arg0 ;
-(void)layoutSubviews;
