...
@property (nonatomic) BOOL showHubbleSurveyQuestions; // ivar: _showHubbleSurveyQuestions
@property (nonatomic) BOOL showMemories; // ivar: _showMemories
@property (nonatomic) BOOL showPeopleQuestions; // ivar: _showPeopleQuestions
@property (nonatomic) BOOL showRecentInterestSuggestions; // ivar: _showRecentInterestSuggestions
@property (nonatomic) BOOL showSampleSuggestionGadgets; // ivar: _showSampleSuggestionGadgets
