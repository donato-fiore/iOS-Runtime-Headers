...
@class PXPlacesMapViewPort, NSMutableDictionary, NSString, UIView, PXPlacesSnapshotFactory, NSMutableArray, UIButton, UIImageView, UIFont, UIVisualEffectView;
@protocol PXPhotosDataSourceChangeObserver, PXPlacesMapLocationEditDelegate, PXPhotosDetailsLocationSearchDelegate, PXUIWidget, OS_os_log, PXAnonymousView, PXWidgetDelegate, PXWidgetEditingDelegate, PXWidgetInteractionDelegate, PXWidgetUnlockDelegate;
...
@property (readonly, nonatomic) UIVisualEffectView *footerView; // ivar: _footerView
...
-(BOOL)_forceRevGeoUpdateIfNeeded;
