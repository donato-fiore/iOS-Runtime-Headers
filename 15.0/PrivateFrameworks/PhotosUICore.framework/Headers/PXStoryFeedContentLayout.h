...
#ifndef PXSTORYFEEDCONTENTLAYOUT_H
#define PXSTORYFEEDCONTENTLAYOUT_H
...
#import "PXStoryFeedItemDecorationSource.h"
...
@property (readonly, nonatomic) PXStoryFeedItemDecorationSource *decorationSource; // ivar: _decorationSource
