...
+(void)_curationObjectsFromAssets:(id)arg0 scenesMap:(id)arg1 sceneIdentifiers:(id)arg2 completion:(id)arg3 ;
+(void)performCurationForAssetResults:(id)arg0 sceneIdentifiers:(id)arg1 searchQuery:(id)arg2 completion:(id)arg3 ;
