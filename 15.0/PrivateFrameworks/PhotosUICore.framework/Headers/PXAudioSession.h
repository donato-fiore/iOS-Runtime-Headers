...
@property (retain, nonatomic) NSNumber *contentLoudnessInLKFS; // ivar: _contentLoudnessInLKFS
@property (retain, nonatomic) NSNumber *contentPeakDecibels; // ivar: _contentPeakDecibels
