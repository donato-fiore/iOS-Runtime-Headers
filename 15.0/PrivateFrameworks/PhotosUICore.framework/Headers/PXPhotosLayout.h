...
@class NSString, UIView, NSDictionary;
@protocol PXChangeObserver, PXGStringSource, PXGNamedImageSource, PXPhotosLayoutDelegate, PXPhotosSectionBodyLayoutProvider, PXPhotosSectionHeaderLayoutProvider;
