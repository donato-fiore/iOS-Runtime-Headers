...
-(id)init;
-(id)initWithAssetDuration:(struct ? )arg0 playbackRange:(struct ? )arg1 highlightRange:(struct ? )arg2 bestPlaybackRect:(struct CGRect )arg3 normalizationData:(id)arg4 ;
