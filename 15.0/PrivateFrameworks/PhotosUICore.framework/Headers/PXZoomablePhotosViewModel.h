...
@protocol PXChangeObserver, PXMutableZoomablePhotosViewModel, PXAssetsDataSourceManagerObserver, PXZoomablePhotosUserDefaults;
...
-(id)init;
-(id)initWithDataSourceManager:(id)arg0 selectionManager:(id)arg1 mediaProvider:(id)arg2 specManager:(id)arg3 ;
