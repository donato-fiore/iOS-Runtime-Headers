...
@protocol PXGMetalTextureAtlasDelegate, PXGTextureAtlasManager, MTLDevice, OS_dispatch_queue, PXGTextureAtlasManagerDelegate, PXGTextureConverter;
...
-(id)init;
-(id)initWithThumbnailSize:(struct CGSize )arg0 pixelFormat:(NSUInteger)arg1 capacityPerAtlas:(unsigned int)arg2 requestQueue:(id)arg3 layoutQueue:(id)arg4 colorProgram:(id)arg5 device:(id)arg6 ;
