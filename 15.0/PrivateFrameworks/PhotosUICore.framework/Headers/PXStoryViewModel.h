...
@class NSString, NSMapTable, NSError, NSDate, NSMutableSet, NSArray, UIImpactFeedbackGenerator;
@protocol PXTapToRadarDiagnosticProvider, PXStoryVisualDiagnosticsProvider, PXStoryDiagnosticHUDContentProvider, PXStoryMutableViewModel, PXChangeObserver, PXSettingsKeyObserver, PXStoryQueueParticipant, PXStoryViewActionPerformer, PXStoryErrorReporter, PXDisplayAssetCollection, PXAnonymousViewController, OS_dispatch_queue, PXStoryPacingTimeSource, PXStoryViewLayoutSpec;
...
@interface PXStoryViewModel : PXObservable <PXTapToRadarDiagnosticProvider, PXStoryVisualDiagnosticsProvider, PXStoryDiagnosticHUDContentProvider, PXStoryMutableViewModel, PXChangeObserver, PXSettingsKeyObserver, PXStoryQueueParticipant>
...
@property (retain, nonatomic) PXPhotosViewModel *photosGridViewModel; // ivar: _photosGridViewModel
...
@property (nonatomic) BOOL shouldSimplifyUIForAccessibility; // ivar: _shouldSimplifyUIForAccessibility
