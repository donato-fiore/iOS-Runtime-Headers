...
@class PSCloudStorageOffersManager, NSString, RUIObjectModel, AAUIServerHookResponse;
@protocol PSCloudStorageOffersManagerDelegate, AAUIServerHook, AAUIServerHookDelegate;
...
-(void)_completionWithSuccess:(BOOL)arg0 error:(id)arg1 ;
-(void)_invokeBuyStorageWithServerAttributes:(id)arg0 completion:(id)arg1 ;
