...
@class INAppDescriptor, WFContentAttributionSet, NSString, NSProgress;
...
+(id)containerName;
+(id)serviceName;
-(id)_saveFiles:(id)arg0 toURL:(id)arg1 options:(NSUInteger)arg2 progress:(id)arg3 completionHandler:(id)arg4 ;
