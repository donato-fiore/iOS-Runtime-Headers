...
@class NSDateIntervalFormatter, CNDateComponentsFormatter, NSCalendar, NSDateComponentsFormatter, NSDateFormatter, NSDateComponents;
...
+(id)stringFromDate:(id)arg0 toDate:(id)arg1 isAllDay:(BOOL)arg2 ;
