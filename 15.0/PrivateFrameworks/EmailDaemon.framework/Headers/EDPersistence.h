...
@class EMBlockedSenderManager, EDContentRuleListManager, NSString, EMRemoteContentURLCache, EMRemoteContentURLSession;
...
@property (readonly, nonatomic) EDContentRuleListManager *contentRuleListManager; // ivar: _contentRuleListManager
...
@property (readonly) EDVIPManager *vipManager; // ivar: _vipManager
...
-(void)_commonInitWithVIPManager:(id)arg0 ;
-(void)dealloc;
