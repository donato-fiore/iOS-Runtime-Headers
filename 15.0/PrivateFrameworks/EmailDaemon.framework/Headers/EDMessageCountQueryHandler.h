...
@class NSMutableDictionary, NSMutableSet, EMObjectID, EFQuery, EFMutableInt64Set, EFStoppableScheduler<EFAssertableScheduler>, NSPredicate, EMMailboxScope, EFCancelationToken, NSString;
@protocol EFLoggable, EDMailboxChangeHookResponder, EDMessageChangeHookResponder, EMMailboxChangeObserver, EFCancelable, EMMessageRepositoryCountQueryObserver_xpc;
