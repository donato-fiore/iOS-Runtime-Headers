...
@class SSAccount, NSString, NSNumber, NSOperationQueue, NSMutableArray, NSURL;
...
@property (retain, nonatomic) SBKTaskAssertion *backgroundTaskAssertion; // ivar: _backgroundTaskAssertion
