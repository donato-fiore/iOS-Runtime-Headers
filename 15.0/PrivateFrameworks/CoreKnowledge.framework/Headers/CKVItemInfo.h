...
@property (readonly, nonatomic) NSArray *unindexedFieldBuffers; // ivar: _unindexedFieldBuffers
...
-(id)initWithItemId:(id)arg0 itemType:(NSInteger)arg1 originAppId:(id)arg2 recordId:(id)arg3 unindexedFieldBuffers:(id)arg4 ;
