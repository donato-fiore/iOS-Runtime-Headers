...
-(NSInteger)_donateDataset:(id)arg0 withType:(unsigned short)arg1 reason:(unsigned short)arg2 ;
...
-(void)_donateAllDatasets:(unsigned short)arg0 withReason:(unsigned short)arg1 ;
