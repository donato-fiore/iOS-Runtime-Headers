...
typedef struct SNLCParserRequest {
} // Error Processing Struct Fields

typedef struct __compressed_pair<const sirinluinternalsnlc::SNLCParserRequest *, std::default_delete<const sirinluinternalsnlc::SNLCParserRequest>> {
    SNLCParserRequest field0;
} __compressed_pair<const sirinluinternalsnlc::SNLCParserRequest *, std::default_delete<const sirinluinternalsnlc::SNLCParserRequest>>;
...
typedef struct unique_ptr<const sirinluinternalsnlc::SNLCParserRequest, std::default_delete<const sirinluinternalsnlc::SNLCParserRequest>> {
    __compressed_pair<const sirinluinternalsnlc::SNLCParserRequest *, std::default_delete<const sirinluinternalsnlc::SNLCParserRequest>> field0;
} unique_ptr<const sirinluinternalsnlc::SNLCParserRequest, std::default_delete<const sirinluinternalsnlc::SNLCParserRequest>>;
...
typedef struct SNLCParserResponse {
    unk field0;
    int field1;
    float field2;
    ? field3;
...
typedef struct SNLCOrchestrator {
} // Error Processing Struct Fields

typedef struct __compressed_pair<snlc_inference_orchestrator::orchestration::SNLCOrchestrator *, std::default_delete<snlc_inference_orchestrator::orchestration::SNLCOrchestrator>> {
    SNLCOrchestrator __value_;
} __compressed_pair<snlc_inference_orchestrator::orchestration::SNLCOrchestrator *, std::default_delete<snlc_inference_orchestrator::orchestration::SNLCOrchestrator>>;

typedef struct unique_ptr<snlc_inference_orchestrator::orchestration::SNLCOrchestrator, std::default_delete<snlc_inference_orchestrator::orchestration::SNLCOrchestrator>> {
    __compressed_pair<snlc_inference_orchestrator::orchestration::SNLCOrchestrator *, std::default_delete<snlc_inference_orchestrator::orchestration::SNLCOrchestrator>> __ptr_;
} unique_ptr<snlc_inference_orchestrator::orchestration::SNLCOrchestrator, std::default_delete<snlc_inference_orchestrator::orchestration::SNLCOrchestrator>>;
