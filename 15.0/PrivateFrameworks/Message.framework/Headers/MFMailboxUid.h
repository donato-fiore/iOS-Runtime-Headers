...
@class NSString, MFWeakReferenceHolder, NSMutableArray, NSNumber, NSMutableDictionary, NSURL, NSArray, EMMailboxObjectID;
...
-(id)initWithName:(id)arg0 attributes:(unsigned int)arg1 forAccount:(id)arg2 extraAttributes:(id)arg3 type:(int)arg4 ;
