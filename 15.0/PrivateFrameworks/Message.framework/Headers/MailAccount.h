...
@class NSString, MFLock, NSMutableDictionary, ECAccount, NSArray, ACAccount;
@protocol EFLoggable, EDReceivingAccount, EDIndexableAccount, EFScheduler;
...
@property (readonly, nonatomic) MFLocalActionReplayHandler *replayHandler; // ivar: _replayHandler
