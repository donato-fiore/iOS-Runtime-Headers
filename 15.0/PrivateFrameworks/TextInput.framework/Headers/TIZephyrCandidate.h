...
-(id)initWithCandidate:(id)arg0 forInput:(id)arg1 wordOriginFeedbackID:(NSUInteger)arg2 usageTrackingMask:(unsigned int)arg3 sourceMask:(unsigned int)arg4 ;
-(id)initWithCandidate:(id)arg0 forInput:(id)arg1 wordOriginFeedbackID:(NSUInteger)arg2 usageTrackingMask:(unsigned int)arg3 sourceMask:(unsigned int)arg4 secureContentCandidate:(BOOL)arg5 proactiveTrigger:(id)arg6 proactivePredictedItem:(id)arg7 ;
-(id)initWithCandidate:(id)arg0 forInput:(id)arg1 wordOriginFeedbackID:(NSUInteger)arg2 usageTrackingMask:(unsigned int)arg3 sourceMask:(unsigned int)arg4 secureContentCandidate:(BOOL)arg5 proactiveTrigger:(id)arg6 proactivePredictedItem:(id)arg7 responseKitCategory:(id)arg8 ;
