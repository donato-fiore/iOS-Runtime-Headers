...
typedef struct PixelBufferResampler {
} // Error Processing Struct Fields

typedef struct __compressed_pair<ik::PixelBufferResampler *, std::default_delete<ik::PixelBufferResampler>> {
    PixelBufferResampler __value_;
} __compressed_pair<ik::PixelBufferResampler *, std::default_delete<ik::PixelBufferResampler>>;

typedef struct unique_ptr<ik::PixelBufferResampler, std::default_delete<ik::PixelBufferResampler>> {
    __compressed_pair<ik::PixelBufferResampler *, std::default_delete<ik::PixelBufferResampler>> __ptr_;
} unique_ptr<ik::PixelBufferResampler, std::default_delete<ik::PixelBufferResampler>>;
