...
-(BOOL)getEnum:(*int)arg0 forKey:(id)arg1 ;
-(BOOL)getRawValue:(*int)arg0 forKey:(id)arg1 ;
...
-(id)initWithValidationFunction:(*unk)arg0 rawValues:(*int)arg1 forKeys:(*id)arg2 count:(NSUInteger)arg3 ;
...
-(void)removeAll;
-(void)removeEnumForKey:(id)arg0 ;
-(void)setEnum:(int)arg0 forKey:(id)arg1 ;
-(void)setRawValue:(int)arg0 forKey:(id)arg1 ;
