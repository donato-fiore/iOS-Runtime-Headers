...
#ifndef TRIPBUINT64INT32DICTIONARY_H
#define TRIPBUINT64INT32DICTIONARY_H
...
-(BOOL)getInt32:(*int)arg0 forKey:(NSUInteger)arg1 ;
...
-(id)initWithInt32s:(*int)arg0 forKeys:(*NSUInteger)arg1 count:(NSUInteger)arg2 ;
-(void)addEntriesFromDictionary:(id)arg0 ;
-(void)dealloc;
-(void)enumerateForTextFormat:(id)arg0 ;
-(void)enumerateKeysAndInt32sUsingBlock:(id)arg0 ;
-(void)removeAll;
-(void)removeInt32ForKey:(NSUInteger)arg0 ;
-(void)setInt32:(int)arg0 forKey:(NSUInteger)arg1 ;
