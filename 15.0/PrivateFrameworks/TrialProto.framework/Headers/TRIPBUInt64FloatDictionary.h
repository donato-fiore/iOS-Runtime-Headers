...
#ifndef TRIPBUINT64FLOATDICTIONARY_H
#define TRIPBUINT64FLOATDICTIONARY_H
...
-(BOOL)getFloat:(*float)arg0 forKey:(NSUInteger)arg1 ;
...
-(id)initWithFloats:(*float)arg0 forKeys:(*NSUInteger)arg1 count:(NSUInteger)arg2 ;
-(void)addEntriesFromDictionary:(id)arg0 ;
-(void)dealloc;
-(void)enumerateForTextFormat:(id)arg0 ;
-(void)enumerateKeysAndFloatsUsingBlock:(id)arg0 ;
-(void)removeAll;
-(void)removeFloatForKey:(NSUInteger)arg0 ;
-(void)setFloat:(float)arg0 forKey:(NSUInteger)arg1 ;
