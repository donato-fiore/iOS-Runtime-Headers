...
@property (nonatomic) NSInteger intraRoadPriority; // ivar: _intraRoadPriority
...
@property (readonly, nonatomic) VKLabelNavJunction *navJunctionA; // ivar: _navJunctionA
...
-(BOOL)matchesRoadEdge:(struct GeoCodecsRoadEdge *)arg0 ;
