...
@interface VKBuildingGroup : VKPolygonalItemGroup {
    ...
    array<std::vector<std::vector<FeatureRange>>, 16> _extrusionFillCullingGroups;
    array<std::vector<std::vector<FeatureRange>>, 16> _extrusionStrokeCullingGroups;
    array<std::vector<std::vector<FeatureRange>>, 16> _fillCullingGroupsForPointyRoofs;
    array<std::vector<std::vector<FeatureRange>>, 16> _pointyRoofFillCullingGroups;
    array<std::vector<std::vector<FeatureRange>>, 16> _pointyRoofStrokeCullingGroups;
