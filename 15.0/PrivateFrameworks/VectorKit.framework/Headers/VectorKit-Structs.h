...
typedef struct DeviceAPIProperties {
    int field0;
    int field1;
    CGFloat field2;
    BOOL field3;
...
typedef struct Device {
    unk field0;
    DeviceVersion field1;
    DeviceCapabilities field2;
    DeviceAPIProperties field3;
    ResourceManager field4;
    int field5;
    int field6;
} Device;
...
typedef struct _retain_objc {
} // Error Processing Struct Fields

typedef struct _release_objc {
} // Error Processing Struct Fields

typedef struct _retain_ptr<VKInternalIconManager *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc> {
    unk _vptr$_retain_ptr;
    id _obj;
    _retain_objc VKInternalIconManager;
    _release_objc _retain;
} _retain_ptr<VKInternalIconManager *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc>;

typedef struct _retain_ptr<VKResourceManager *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc> {
    unk _vptr$_retain_ptr;
    id _obj;
    _retain_objc VKResourceManager;
    _release_objc _retain;
} _retain_ptr<VKResourceManager *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc>;
...
typedef struct VKCameraState {
    ...
    CGFloat field1;
    Unit<RadianUnitDescription, double> field2;
    CGFloat field3;
} VKCameraState;
...
typedef struct __compressed_pair<geo::_retain_ptr<VKPolylineGroupOverlay *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc> *, std::allocator<geo::_retain_ptr<VKPolylineGroupOverlay *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc>>> {
    void __value_;
} __compressed_pair<geo::_retain_ptr<VKPolylineGroupOverlay *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc> *, std::allocator<geo::_retain_ptr<VKPolylineGroupOverlay *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc>>>;

typedef struct vector<geo::_retain_ptr<VKPolylineGroupOverlay *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc>, std::allocator<geo::_retain_ptr<VKPolylineGroupOverlay *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc>>> {
    void __begin_;
    void __end_;
    __compressed_pair<geo::_retain_ptr<VKPolylineGroupOverlay *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc> *, std::allocator<geo::_retain_ptr<VKPolylineGroupOverlay *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc>>> __end_cap_;
} vector<geo::_retain_ptr<VKPolylineGroupOverlay *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc>, std::allocator<geo::_retain_ptr<VKPolylineGroupOverlay *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc>>>;
...
typedef struct _retain_ptr<VKMuninCameraController *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc> {
    unk _vptr$_retain_ptr;
    id _obj;
    _retain_objc VKMuninCameraController;
    _release_objc _retain;
} _retain_ptr<VKMuninCameraController *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc>;

typedef struct _retain_ptr<VKARWalkingCameraController *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc> {
    unk _vptr$_retain_ptr;
    id _obj;
    _retain_objc VKARWalkingCameraController;
    _release_objc _retain;
} _retain_ptr<VKARWalkingCameraController *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc>;
...
typedef struct _retain_ptr<VKStateCaptureHandler *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc> {
    unk _vptr$_retain_ptr;
    id _obj;
    _retain_objc VKStateCaptureHandler;
    _release_objc _retain;
} _retain_ptr<VKStateCaptureHandler *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc>;

typedef struct _retain_ptr<VKCamera *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc> {
    unk _vptr$_retain_ptr;
    id _obj;
    _retain_objc VKCamera;
    _release_objc _retain;
} _retain_ptr<VKCamera *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc>;

typedef struct _retain_ptr<NSSet<NSNumber *> *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc> {
    unk _vptr$_retain_ptr;
    id _obj;
    _retain_objc NSSet;
    _release_objc _retain;
} _retain_ptr<NSSet<NSNumber *> *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc>;

typedef struct _retain_ptr<VKManifestTileGroupObserverProxy *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc> {
    unk _vptr$_retain_ptr;
    id _obj;
    _retain_objc VKManifestTileGroupObserverProxy;
    _release_objc _retain;
} _retain_ptr<VKManifestTileGroupObserverProxy *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc>;
...
typedef struct _retain_ptr<NSString *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc> {
    unk _vptr$_retain_ptr;
    id _obj;
    _retain_objc NSString;
    _release_objc _retain;
} _retain_ptr<NSString *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc>;
...
typedef struct _retain_ptr<VKCameraController *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc> {
    unk _vptr$_retain_ptr;
    id _obj;
    _retain_objc VKCameraController;
    _release_objc _retain;
} _retain_ptr<VKCameraController *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc>;
...
typedef struct StdAllocator<std::__tree_node<std::__value_type<geo::_retain_ptr<NSString *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc>, std::shared_ptr<gss::StylesheetManager<gss::PropertyID>>>, void *>, mdm::Allocator> {
    Allocator _allocator;
} StdAllocator<std::__tree_node<std::__value_type<geo::_retain_ptr<NSString *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc>, std::shared_ptr<gss::StylesheetManager<gss::PropertyID>>>, void *>, mdm::Allocator>;

typedef struct __compressed_pair<std::__tree_end_node<std::__tree_node_base<void *> *>, geo::StdAllocator<std::__tree_node<std::__value_type<geo::_retain_ptr<NSString *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc>, std::shared_ptr<gss::StylesheetManager<gss::PropertyID>>>, void *>, mdm::Allocator>> {
    __tree_end_node<std::__tree_node_base<void *> *> __value_;
    StdAllocator<std::__tree_node<std::__value_type<geo::_retain_ptr<NSString *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc>, std::shared_ptr<gss::StylesheetManager<gss::PropertyID>>>, void *>, mdm::Allocator> __value_;
} __compressed_pair<std::__tree_end_node<std::__tree_node_base<void *> *>, geo::StdAllocator<std::__tree_node<std::__value_type<geo::_retain_ptr<NSString *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc>, std::shared_ptr<gss::StylesheetManager<gss::PropertyID>>>, void *>, mdm::Allocator>>;
...
typedef struct __compressed_pair<unsigned long, std::__map_value_compare<geo::_retain_ptr<NSString *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc>, std::__value_type<geo::_retain_ptr<NSString *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc>, std::shared_ptr<gss::StylesheetManager<gss::PropertyID>>>, NSStringMapComparison, true>> {
    NSUInteger __value_;
} __compressed_pair<unsigned long, std::__map_value_compare<geo::_retain_ptr<NSString *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc>, std::__value_type<geo::_retain_ptr<NSString *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc>, std::shared_ptr<gss::StylesheetManager<gss::PropertyID>>>, NSStringMapComparison, true>>;
...
typedef struct __tree<std::__value_type<geo::_retain_ptr<NSString *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc>, std::shared_ptr<gss::StylesheetManager<gss::PropertyID>>>, std::__map_value_compare<geo::_retain_ptr<NSString *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc>, std::__value_type<geo::_retain_ptr<NSString *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc>, std::shared_ptr<gss::StylesheetManager<gss::PropertyID>>>, NSStringMapComparison, true>, geo::StdAllocator<std::__value_type<geo::_retain_ptr<NSString *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc>, std::shared_ptr<gss::StylesheetManager<gss::PropertyID>>>, mdm::Allocator>> {
    void __begin_node_;
    __compressed_pair<std::__tree_end_node<std::__tree_node_base<void *> *>, geo::StdAllocator<std::__tree_node<std::__value_type<geo::_retain_ptr<NSString *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc>, std::shared_ptr<gss::StylesheetManager<gss::PropertyID>>>, void *>, mdm::Allocator>> __pair1_;
    __compressed_pair<unsigned long, std::__map_value_compare<geo::_retain_ptr<NSString *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc>, std::__value_type<geo::_retain_ptr<NSString *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc>, std::shared_ptr<gss::StylesheetManager<gss::PropertyID>>>, NSStringMapComparison, true>> __pair3_;
} __tree<std::__value_type<geo::_retain_ptr<NSString *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc>, std::shared_ptr<gss::StylesheetManager<gss::PropertyID>>>, std::__map_value_compare<geo::_retain_ptr<NSString *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc>, std::__value_type<geo::_retain_ptr<NSString *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc>, std::shared_ptr<gss::StylesheetManager<gss::PropertyID>>>, NSStringMapComparison, true>, geo::StdAllocator<std::__value_type<geo::_retain_ptr<NSString *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc>, std::shared_ptr<gss::StylesheetManager<gss::PropertyID>>>, mdm::Allocator>>;
...
typedef struct __compressed_pair<geo::_retain_ptr<VKRouteContext *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc> *, geo::StdAllocator<geo::_retain_ptr<VKRouteContext *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc>, mdm::Allocator>> {
    void __value_;
...
} __compressed_pair<geo::_retain_ptr<VKRouteContext *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc> *, geo::StdAllocator<geo::_retain_ptr<VKRouteContext *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc>, mdm::Allocator>>;
...
typedef struct vector<geo::_retain_ptr<VKRouteContext *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc>, geo::StdAllocator<geo::_retain_ptr<VKRouteContext *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc>, mdm::Allocator>> {
    void __begin_;
    void __end_;
    __compressed_pair<geo::_retain_ptr<VKRouteContext *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc> *, geo::StdAllocator<geo::_retain_ptr<VKRouteContext *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc>, mdm::Allocator>> __end_cap_;
...
typedef struct Unit<RadianUnitDescription, float> {
    float _value;
} Unit<RadianUnitDescription, float>;

typedef struct PhotoInfo {
} // Error Processing Struct Fields

typedef struct small_vector<md::mun::PhotoInfo, 6> {
} // Error Processing Struct Fields

typedef struct CollectionPoint {
    NSUInteger pointId;
    RigidTransform<double, float> frame;
    Unit<RadianUnitDescription, float> heading;
    Mercator3<double> mercatorPosition;
    NSUInteger time;
    small_vector<md::mun::PhotoInfo, 6> photos;
...
typedef struct MeshSet<ggl::PolygonBase::CompressedMeshMesh, ggl::PolygonBase::CompressedVbo> {
    vector<std::pair<unsigned short, unsigned int>, std::allocator<std::pair<unsigned short, unsigned int>>> _vertexAndIndexCounts;
    vector<std::shared_ptr<ggl::PolygonBase::CompressedMeshMesh>, std::allocator<std::shared_ptr<ggl::PolygonBase::CompressedMeshMesh>>> _meshes;
...
typedef struct array<std::vector<std::vector<FeatureRange>>, 16> {
    vector<std::vector<FeatureRange>, std::allocator<std::vector<FeatureRange>>> __elems_;
} array<std::vector<std::vector<FeatureRange>>, 16>;
...
typedef struct small_vector<md::mun::PointView::CameraLod, 6> {
} // Error Processing Struct Fields
...
typedef struct PointView {
    ...
    small_vector<md::mun::PointView::CameraLod, 6> _cameras;
} PointView;
...
typedef struct _retain_ptr<VKTimedAnimation *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc> {
    unk _vptr$_retain_ptr;
    id _obj;
    _retain_objc VKTimedAnimation;
    _release_objc _retain;
} _retain_ptr<VKTimedAnimation *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc>;
...
typedef struct _retain_ptr<VKRouteContext *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc> {
    unk _vptr$_retain_ptr;
    id _obj;
    _retain_objc VKRouteContext;
    _release_objc _retain;
} _retain_ptr<VKRouteContext *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc>;
...
typedef struct _retain_ptr<GEOFeatureStyleAttributes *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc> {
    unk _vptr$_retain_ptr;
    id _obj;
    _retain_objc GEOFeatureStyleAttributes;
    _release_objc _retain;
} _retain_ptr<GEOFeatureStyleAttributes *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc>;
...
typedef struct array<std::shared_ptr<ggl::RenderBuffer>, 3> {
    shared_ptr<ggl::RenderBuffer> __elems_;
} array<std::shared_ptr<ggl::RenderBuffer>, 3>;
...
typedef struct _retain_ptr<NSArray<VKARWalkingFeature *> *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc> {
    unk _vptr$_retain_ptr;
    id _obj;
    _retain_objc NSArray;
    _release_objc _retain;
} _retain_ptr<NSArray<VKARWalkingFeature *> *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc>;

typedef struct OrientedBox<double, 2, double, double> {
    RigidTransform<double, double> _transform;
    Box<double, 2> _bounds;
} OrientedBox<double, 2, double, double>;

typedef struct _retain_ptr<GEOComposedRoute *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc> {
    unk _vptr$_retain_ptr;
    id _obj;
    _retain_objc GEOComposedRoute;
    _release_objc _retain;
} _retain_ptr<GEOComposedRoute *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc>;

typedef struct _retain_ptr<VKARWalkingFeature *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc> {
    unk _vptr$_retain_ptr;
    id _obj;
    _retain_objc VKARWalkingFeature;
    _release_objc _retain;
} _retain_ptr<VKARWalkingFeature *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc>;

typedef struct _retain_ptr<VKARWalkingFeatureSet *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc> {
    unk _vptr$_retain_ptr;
    id _obj;
    _retain_objc VKARWalkingFeatureSet;
    _release_objc _retain;
} _retain_ptr<VKARWalkingFeatureSet *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc>;
...
typedef struct _retain_ptr<NSUUID *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc> {
    unk _vptr$_retain_ptr;
    id _obj;
    _retain_objc NSUUID;
    _release_objc _retain;
} _retain_ptr<NSUUID *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc>;
...
typedef struct _retain_ptr<VKPolylineOverlay *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc> {
    unk _vptr$_retain_ptr;
    id _obj;
    _retain_objc VKPolylineOverlay;
    _release_objc _retain;
} _retain_ptr<VKPolylineOverlay *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc>;
...
typedef struct __compressed_pair<std::__tree_end_node<std::__tree_node_base<void *> *>, std::allocator<std::__tree_node<std::__value_type<geo::_retain_ptr<VKPolylineOverlay *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc>, std::weak_ptr<altitude::RouteLineData>>, void *>>> {
    __tree_end_node<std::__tree_node_base<void *> *> __value_;
} __compressed_pair<std::__tree_end_node<std::__tree_node_base<void *> *>, std::allocator<std::__tree_node<std::__value_type<geo::_retain_ptr<VKPolylineOverlay *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc>, std::weak_ptr<altitude::RouteLineData>>, void *>>>;
...
typedef struct __tree<std::__value_type<geo::_retain_ptr<VKPolylineOverlay *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc>, std::weak_ptr<altitude::RouteLineData>>, std::__map_value_compare<geo::_retain_ptr<VKPolylineOverlay *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc>, std::__value_type<geo::_retain_ptr<VKPolylineOverlay *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc>, std::weak_ptr<altitude::RouteLineData>>, std::less<geo::_retain_ptr<VKPolylineOverlay *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc>>, true>, std::allocator<std::__value_type<geo::_retain_ptr<VKPolylineOverlay *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc>, std::weak_ptr<altitude::RouteLineData>>>> {
    void __begin_node_;
    __compressed_pair<std::__tree_end_node<std::__tree_node_base<void *> *>, std::allocator<std::__tree_node<std::__value_type<geo::_retain_ptr<VKPolylineOverlay *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc>, std::weak_ptr<altitude::RouteLineData>>, void *>>> __pair1_;
...
typedef struct CustomLandmarksContainer {
} // Error Processing Struct Fields

typedef struct __compressed_pair<(anonymous namespace)::CustomLandmarksContainer *, std::default_delete<(anonymous namespace)::CustomLandmarksContainer>> {
    CustomLandmarksContainer __value_;
} __compressed_pair<(anonymous namespace)::CustomLandmarksContainer *, std::default_delete<(anonymous namespace)::CustomLandmarksContainer>>;

typedef struct unique_ptr<(anonymous namespace)::CustomLandmarksContainer, std::default_delete<(anonymous namespace)::CustomLandmarksContainer>> {
    __compressed_pair<(anonymous namespace)::CustomLandmarksContainer *, std::default_delete<(anonymous namespace)::CustomLandmarksContainer>> __ptr_;
} unique_ptr<(anonymous namespace)::CustomLandmarksContainer, std::default_delete<(anonymous namespace)::CustomLandmarksContainer>>;
...
typedef struct __compressed_pair<geo::Coordinate2D<Radians, double> *, std::allocator<geo::Coordinate2D<Radians, double>>> {
    void field0;
} __compressed_pair<geo::Coordinate2D<Radians, double> *, std::allocator<geo::Coordinate2D<Radians, double>>>;

typedef struct vector<geo::Coordinate2D<Radians, double>, std::allocator<geo::Coordinate2D<Radians, double>>> {
    void field0;
    void field1;
    __compressed_pair<geo::Coordinate2D<Radians, double> *, std::allocator<geo::Coordinate2D<Radians, double>>> field2;
} vector<geo::Coordinate2D<Radians, double>, std::allocator<geo::Coordinate2D<Radians, double>>>;

typedef struct RoadSignOrientationResolver {
    void field0;
    Unit<RadianUnitDescription, float> field1;
    Unit<RadianUnitDescription, float> field2;
    unsigned char field3;
...
typedef struct optional<md::RoadSignOrientationResolver> {
    ...
    int field2;
    unsigned char field3;
    RoadSignOrientationResolver field4;
} optional<md::RoadSignOrientationResolver>;
...
typedef struct __compressed_pair<std::__tree_end_node<std::__tree_node_base<void *> *>, std::allocator<std::__tree_node<std::__value_type<gm::Range<geo::Unit<RadianUnitDescription, float>>, md::OrientationAction>, void *>>> {
    __tree_end_node<std::__tree_node_base<void *> *> __value_;
} __compressed_pair<std::__tree_end_node<std::__tree_node_base<void *> *>, std::allocator<std::__tree_node<std::__value_type<gm::Range<geo::Unit<RadianUnitDescription, float>>, md::OrientationAction>, void *>>>;

typedef struct __compressed_pair<unsigned long, std::__map_value_compare<gm::Range<geo::Unit<RadianUnitDescription, float>>, std::__value_type<gm::Range<geo::Unit<RadianUnitDescription, float>>, md::OrientationAction>, geo::range_map<geo::Unit<RadianUnitDescription, float>, md::OrientationAction>::RangeCompare, true>> {
    NSUInteger __value_;
} __compressed_pair<unsigned long, std::__map_value_compare<gm::Range<geo::Unit<RadianUnitDescription, float>>, std::__value_type<gm::Range<geo::Unit<RadianUnitDescription, float>>, md::OrientationAction>, geo::range_map<geo::Unit<RadianUnitDescription, float>, md::OrientationAction>::RangeCompare, true>>;
...
typedef struct __tree<std::__value_type<gm::Range<geo::Unit<RadianUnitDescription, float>>, md::OrientationAction>, std::__map_value_compare<gm::Range<geo::Unit<RadianUnitDescription, float>>, std::__value_type<gm::Range<geo::Unit<RadianUnitDescription, float>>, md::OrientationAction>, geo::range_map<geo::Unit<RadianUnitDescription, float>, md::OrientationAction>::RangeCompare, true>, std::allocator<std::__value_type<gm::Range<geo::Unit<RadianUnitDescription, float>>, md::OrientationAction>>> {
    void __begin_node_;
    __compressed_pair<std::__tree_end_node<std::__tree_node_base<void *> *>, std::allocator<std::__tree_node<std::__value_type<gm::Range<geo::Unit<RadianUnitDescription, float>>, md::OrientationAction>, void *>>> __pair1_;
    __compressed_pair<unsigned long, std::__map_value_compare<gm::Range<geo::Unit<RadianUnitDescription, float>>, std::__value_type<gm::Range<geo::Unit<RadianUnitDescription, float>>, md::OrientationAction>, geo::range_map<geo::Unit<RadianUnitDescription, float>, md::OrientationAction>::RangeCompare, true>> __pair3_;
} __tree<std::__value_type<gm::Range<geo::Unit<RadianUnitDescription, float>>, md::OrientationAction>, std::__map_value_compare<gm::Range<geo::Unit<RadianUnitDescription, float>>, std::__value_type<gm::Range<geo::Unit<RadianUnitDescription, float>>, md::OrientationAction>, geo::range_map<geo::Unit<RadianUnitDescription, float>, md::OrientationAction>::RangeCompare, true>, std::allocator<std::__value_type<gm::Range<geo::Unit<RadianUnitDescription, float>>, md::OrientationAction>>>;

typedef struct map<gm::Range<geo::Unit<RadianUnitDescription, float>>, md::OrientationAction, geo::range_map<geo::Unit<RadianUnitDescription, float>, md::OrientationAction>::RangeCompare, std::allocator<std::pair<const gm::Range<geo::Unit<RadianUnitDescription, float>>, md::OrientationAction>>> {
    __tree<std::__value_type<gm::Range<geo::Unit<RadianUnitDescription, float>>, md::OrientationAction>, std::__map_value_compare<gm::Range<geo::Unit<RadianUnitDescription, float>>, std::__value_type<gm::Range<geo::Unit<RadianUnitDescription, float>>, md::OrientationAction>, geo::range_map<geo::Unit<RadianUnitDescription, float>, md::OrientationAction>::RangeCompare, true>, std::allocator<std::__value_type<gm::Range<geo::Unit<RadianUnitDescription, float>>, md::OrientationAction>>> __tree_;
} map<gm::Range<geo::Unit<RadianUnitDescription, float>>, md::OrientationAction, geo::range_map<geo::Unit<RadianUnitDescription, float>, md::OrientationAction>::RangeCompare, std::allocator<std::pair<const gm::Range<geo::Unit<RadianUnitDescription, float>>, md::OrientationAction>>>;

typedef struct range_map<geo::Unit<RadianUnitDescription, float>, md::OrientationAction, std::less<geo::Unit<RadianUnitDescription, float>>, std::allocator<std::pair<const gm::Range<geo::Unit<RadianUnitDescription, float>>, md::OrientationAction>>> {
    map<gm::Range<geo::Unit<RadianUnitDescription, float>>, md::OrientationAction, geo::range_map<geo::Unit<RadianUnitDescription, float>, md::OrientationAction>::RangeCompare, std::allocator<std::pair<const gm::Range<geo::Unit<RadianUnitDescription, float>>, md::OrientationAction>>> _storage;
} range_map<geo::Unit<RadianUnitDescription, float>, md::OrientationAction, std::less<geo::Unit<RadianUnitDescription, float>>, std::allocator<std::pair<const gm::Range<geo::Unit<RadianUnitDescription, float>>, md::OrientationAction>>>;

typedef struct _retain_ptr<id<VKCustomFeatureDataSource>, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc> {
    unk _vptr$_retain_ptr;
    id _obj;
    _retain_objc <VKCustomFeatureDataSource>;
    _release_objc _retain;
} _retain_ptr<id<VKCustomFeatureDataSource>, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc>;
...
typedef struct _retain_ptr<GEOVectorTileDecoder *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc> {
    unk _vptr$_retain_ptr;
    id _obj;
    _retain_objc GEOVectorTileDecoder;
    _release_objc _retain;
} _retain_ptr<GEOVectorTileDecoder *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc>;

typedef struct _retain_ptr<GEOApplicationAuditToken *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc> {
    unk _vptr$_retain_ptr;
    id _obj;
    _retain_objc GEOApplicationAuditToken;
    _release_objc _retain;
} _retain_ptr<GEOApplicationAuditToken *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc>;
...
typedef struct MeshSet<ggl::BuildingFlatStroke::BuildingFlatStrokeMesh, ggl::BuildingFlatStroke::DefaultVbo> {
    vector<std::pair<unsigned short, unsigned int>, std::allocator<std::pair<unsigned short, unsigned int>>> _vertexAndIndexCounts;
    vector<std::shared_ptr<ggl::BuildingFlatStroke::BuildingFlatStrokeMesh>, std::allocator<std::shared_ptr<ggl::BuildingFlatStroke::BuildingFlatStrokeMesh>>> _meshes;
...
typedef struct _retain_ptr<VKSharedResources *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc> {
    unk _vptr$_retain_ptr;
    id _obj;
    _retain_objc VKSharedResources;
    _release_objc _retain;
} _retain_ptr<VKSharedResources *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc>;
...
typedef struct __compressed_pair<geo::Cache<unsigned char, std::shared_ptr<std::vector<geo::Mercator2<double>>>, std::hash<unsigned char>, LRUPolicy> *, std::default_delete<geo::Cache<unsigned char, std::shared_ptr<std::vector<geo::Mercator2<double>>>, std::hash<unsigned char>, LRUPolicy>>> {
    void __value_;
} __compressed_pair<geo::Cache<unsigned char, std::shared_ptr<std::vector<geo::Mercator2<double>>>, std::hash<unsigned char>, LRUPolicy> *, std::default_delete<geo::Cache<unsigned char, std::shared_ptr<std::vector<geo::Mercator2<double>>>, std::hash<unsigned char>, LRUPolicy>>>;

typedef struct unique_ptr<geo::Cache<unsigned char, std::shared_ptr<std::vector<geo::Mercator2<double>>>, std::hash<unsigned char>, LRUPolicy>, std::default_delete<geo::Cache<unsigned char, std::shared_ptr<std::vector<geo::Mercator2<double>>>, std::hash<unsigned char>, LRUPolicy>>> {
    __compressed_pair<geo::Cache<unsigned char, std::shared_ptr<std::vector<geo::Mercator2<double>>>, std::hash<unsigned char>, LRUPolicy> *, std::default_delete<geo::Cache<unsigned char, std::shared_ptr<std::vector<geo::Mercator2<double>>>, std::hash<unsigned char>, LRUPolicy>>> __ptr_;
} unique_ptr<geo::Cache<unsigned char, std::shared_ptr<std::vector<geo::Mercator2<double>>>, std::hash<unsigned char>, LRUPolicy>, std::default_delete<geo::Cache<unsigned char, std::shared_ptr<std::vector<geo::Mercator2<double>>>, std::hash<unsigned char>, LRUPolicy>>>;
...
typedef struct __compressed_pair<geo::Cache<unsigned char, std::shared_ptr<geo::Polygon2<double>>, std::hash<unsigned char>, LRUPolicy> *, std::default_delete<geo::Cache<unsigned char, std::shared_ptr<geo::Polygon2<double>>, std::hash<unsigned char>, LRUPolicy>>> {
    void __value_;
} __compressed_pair<geo::Cache<unsigned char, std::shared_ptr<geo::Polygon2<double>>, std::hash<unsigned char>, LRUPolicy> *, std::default_delete<geo::Cache<unsigned char, std::shared_ptr<geo::Polygon2<double>>, std::hash<unsigned char>, LRUPolicy>>>;

typedef struct unique_ptr<geo::Cache<unsigned char, std::shared_ptr<geo::Polygon2<double>>, std::hash<unsigned char>, LRUPolicy>, std::default_delete<geo::Cache<unsigned char, std::shared_ptr<geo::Polygon2<double>>, std::hash<unsigned char>, LRUPolicy>>> {
    __compressed_pair<geo::Cache<unsigned char, std::shared_ptr<geo::Polygon2<double>>, std::hash<unsigned char>, LRUPolicy> *, std::default_delete<geo::Cache<unsigned char, std::shared_ptr<geo::Polygon2<double>>, std::hash<unsigned char>, LRUPolicy>>> __ptr_;
} unique_ptr<geo::Cache<unsigned char, std::shared_ptr<geo::Polygon2<double>>, std::hash<unsigned char>, LRUPolicy>, std::default_delete<geo::Cache<unsigned char, std::shared_ptr<geo::Polygon2<double>>, std::hash<unsigned char>, LRUPolicy>>>;
...
typedef struct MeshSet<ggl::PolygonCommonStroke::MeshMesh, ggl::PolygonCommonStroke::DefaultVbo> {
    vector<std::pair<unsigned short, unsigned int>, std::allocator<std::pair<unsigned short, unsigned int>>> _vertexAndIndexCounts;
    vector<std::shared_ptr<ggl::PolygonCommonStroke::MeshMesh>, std::allocator<std::shared_ptr<ggl::PolygonCommonStroke::MeshMesh>>> _meshes;
...
typedef struct __compressed_pair<std::shared_ptr<ggl::DaVinci::ElevatedStrokeMesh> *, std::allocator<std::shared_ptr<ggl::DaVinci::ElevatedStrokeMesh>>> {
    void __value_;
} __compressed_pair<std::shared_ptr<ggl::DaVinci::ElevatedStrokeMesh> *, std::allocator<std::shared_ptr<ggl::DaVinci::ElevatedStrokeMesh>>>;

typedef struct vector<std::shared_ptr<ggl::DaVinci::ElevatedStrokeMesh>, std::allocator<std::shared_ptr<ggl::DaVinci::ElevatedStrokeMesh>>> {
    void __begin_;
    void __end_;
    __compressed_pair<std::shared_ptr<ggl::DaVinci::ElevatedStrokeMesh> *, std::allocator<std::shared_ptr<ggl::DaVinci::ElevatedStrokeMesh>>> __end_cap_;
} vector<std::shared_ptr<ggl::DaVinci::ElevatedStrokeMesh>, std::allocator<std::shared_ptr<ggl::DaVinci::ElevatedStrokeMesh>>>;
...
typedef struct MeshSet<ggl::VenueWall::MeshMesh, ggl::VenueWall::DefaultVbo> {
    vector<std::pair<unsigned short, unsigned int>, std::allocator<std::pair<unsigned short, unsigned int>>> _vertexAndIndexCounts;
    vector<std::shared_ptr<ggl::VenueWall::MeshMesh>, std::allocator<std::shared_ptr<ggl::VenueWall::MeshMesh>>> _meshes;
...
typedef struct MeshSet<ggl::VenueWall::EndCapMesh, ggl::VenueWall::EndCapVbo> {
    vector<std::pair<unsigned short, unsigned int>, std::allocator<std::pair<unsigned short, unsigned int>>> _vertexAndIndexCounts;
    vector<std::shared_ptr<ggl::VenueWall::EndCapMesh>, std::allocator<std::shared_ptr<ggl::VenueWall::EndCapMesh>>> _meshes;
...
typedef struct MeshSet<ggl::Venue3DStroke::HorizontalVenue3DStrokeMesh, ggl::Venue3DStroke::HorizontalDefaultVbo> {
    vector<std::pair<unsigned short, unsigned int>, std::allocator<std::pair<unsigned short, unsigned int>>> _vertexAndIndexCounts;
    vector<std::shared_ptr<ggl::Venue3DStroke::HorizontalVenue3DStrokeMesh>, std::allocator<std::shared_ptr<ggl::Venue3DStroke::HorizontalVenue3DStrokeMesh>>> _meshes;
...
typedef struct MeshSet<ggl::Venue3DStroke::VerticalVenue3DStrokeMesh, ggl::Venue3DStroke::VerticalDefaultVbo> {
    vector<std::pair<unsigned short, unsigned int>, std::allocator<std::pair<unsigned short, unsigned int>>> _vertexAndIndexCounts;
    vector<std::shared_ptr<ggl::Venue3DStroke::VerticalVenue3DStrokeMesh>, std::allocator<std::shared_ptr<ggl::Venue3DStroke::VerticalVenue3DStrokeMesh>>> _meshes;
...
typedef struct __compressed_pair<geo::Coordinate3D<Radians, double> *, std::allocator<geo::Coordinate3D<Radians, double>>> {
    void __value_;
} __compressed_pair<geo::Coordinate3D<Radians, double> *, std::allocator<geo::Coordinate3D<Radians, double>>>;

typedef struct vector<geo::Coordinate3D<Radians, double>, std::allocator<geo::Coordinate3D<Radians, double>>> {
    void __begin_;
    void __end_;
    __compressed_pair<geo::Coordinate3D<Radians, double> *, std::allocator<geo::Coordinate3D<Radians, double>>> __end_cap_;
} vector<geo::Coordinate3D<Radians, double>, std::allocator<geo::Coordinate3D<Radians, double>>>;
...
typedef struct array<double, 60> {
    CGFloat __elems_;
} array<double, 60>;

typedef struct WindowedSampler<60> {
    CGFloat _min;
    CGFloat _max;
    CGFloat _avg;
    CGFloat _sum;
    optional<unsigned long> _idx;
    array<double, 60> _samples;
} WindowedSampler<60>;
...
typedef struct EulerAngles {
    Unit<RadianUnitDescription, double> pitch;
    Unit<RadianUnitDescription, double> yaw;
    Unit<RadianUnitDescription, double> roll;
} EulerAngles;
...
typedef struct _retain_ptr<VKLabelNavRoadLabel *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc> {
    ...
    id field1;
    _retain_objc field2;
    _release_objc field3;
} _retain_ptr<VKLabelNavRoadLabel *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc>;
