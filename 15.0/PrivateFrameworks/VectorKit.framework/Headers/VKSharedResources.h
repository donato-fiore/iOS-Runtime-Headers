...
@interface VKSharedResources : NSObject <GEOResourceManifestTileGroupObserver>
 ...
 {
    _retain_ptr<VKInternalIconManager *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc> _iconManager;
    shared_ptr<md::TextureManager> _textureManager;
    ? _materialTextureManager;
    _retain_ptr<VKResourceManager *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc> _resourceManager;
...
@property (readonly, nonatomic) *Device gglDevice;
