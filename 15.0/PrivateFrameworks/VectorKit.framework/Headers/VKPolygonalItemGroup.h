...
@interface VKPolygonalItemGroup : NSObject {
    ...
    array<std::vector<std::vector<FeatureRange>>, 16> _fillCullingGroups;
    array<std::vector<std::vector<FeatureRange>>, 16> _strokeCullingGroups;
    array<std::vector<std::vector<FeatureRange>>, 16> _venueCullingGroups;
    array<std::vector<std::vector<FeatureRange>>, 16> _venueEndCapCullingGroups;
    array<std::vector<std::vector<FeatureRange>>, 16> _venueWallHorizontalStrokeCullingGroups;
    array<std::vector<std::vector<FeatureRange>>, 16> _venueWallVerticalStrokeCullingGroups;
