...
@property (nonatomic) VKRouteLine *routeRibbon; // ivar: _routeRibbon
@property (nonatomic) NSObject<VKPolylineOverlayRouteRibbonObserver> *routeRibbonObserver; // ivar: _routeRibbonObserver
