...
-(CGFloat)_zoomLevelForDistance:(struct Unit<MeterUnitDescription, double> )arg0 ;
-(struct Coordinate3D<Radians, double> )_centerCoordinate:(struct Coordinate3D<Radians, double> )arg0 forEdgeInsets:(struct VKEdgeInsets )arg1 ;
