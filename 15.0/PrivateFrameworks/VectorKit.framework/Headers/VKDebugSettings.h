...
@interface VKDebugSettings : NSObject {
    ...
    unique_ptr<(anonymous namespace)::CustomLandmarksContainer, std::default_delete<(anonymous namespace)::CustomLandmarksContainer>> _customLandmarks;
...
@property (nonatomic) BOOL daVinciLightingDebugTintShadowCascades; // ivar: _daVinciLightingDebugTintShadowCascades
...
@property (nonatomic) int daVinciSSAOKernelSize; // ivar: _daVinciSSAOKernelSize
@property (nonatomic) BOOL daVinciSSAOOcclusionOnly; // ivar: _daVinciSSAOOcclusionOnly
@property (nonatomic) BOOL daVinciSSAORangeCheck; // ivar: _daVinciSSAORangeCheck
...
@property (retain, nonatomic) NSMutableArray *footprintsToSuppress; // ivar: _footprintsToSuppress
...
@property (nonatomic) BOOL readLandmarksFromDisk; // ivar: _readLandmarksFromDisk
...
@property (nonatomic) BOOL suppressFootprints; // ivar: _suppressFootprints
...
@property (nonatomic) BOOL useNewTextureAtlas; // ivar: _useNewTextureAtlas
@property (nonatomic) BOOL useStaticTrafficFeed; // ivar: _useStaticTrafficFeed


-(*void)customLandmarkObjectGroupsForKey:(struct _GEOTileKey *)arg0 ;
...
-(void)addFootprintToSuppress:(id)arg0 ;
