...
#ifndef AAUITWOFACTORCODEHOOK_H
#define AAUITWOFACTORCODEHOOK_H
...
-(void)_generateLoginCode:(id)arg0 ;
-(void)generateLoginCodeWithPresenter:(id)arg0 completion:(id)arg1 ;
