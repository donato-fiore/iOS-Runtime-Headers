...
@class AIDAAccountManager, AACustodianController, NSDictionary, AALocalContactInfo, NSUUID, NSString;
...
#import "AAUIContactSetupNavigationController.h"
...
@property (retain, nonatomic) AAUIContactSetupNavigationController *navigationController; // ivar: _navigationController
