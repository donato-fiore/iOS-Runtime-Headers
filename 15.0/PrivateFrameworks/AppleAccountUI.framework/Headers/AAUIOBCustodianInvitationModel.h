...
#ifndef AAUIOBCUSTODIANINVITATIONMODEL_H
#define AAUIOBCUSTODIANINVITATIONMODEL_H

@class AAOBCustodianInvitationModel, UIView, AACustodianshipInfo, NSString, UIImage;
...
-(id)initWithType:(NSInteger)arg0 initiatorsHandle:(id)arg1 ;
