...
#ifndef AAUIBENEFICIARYCLAIMNOTIFICATIONHOOK_H
#define AAUIBENEFICIARYCLAIMNOTIFICATIONHOOK_H
...
-(void)_beneficiaryContactNameForBeneficiaryID:(id)arg0 completion:(id)arg1 ;
