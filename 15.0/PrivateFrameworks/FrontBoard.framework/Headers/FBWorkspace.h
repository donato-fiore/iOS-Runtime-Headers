...
@class BSServiceConnection<BSServiceConnectionHost>, NSMutableArray, NSMutableDictionary, FBSSerialQueue, RBSAssertion, BSCompoundAssertion, BSAuditToken, NSString;
@protocol FBSceneClient, FBSceneClientProviderInternal, FBSceneClientProvider, FBWorkspaceDelegate, OS_dispatch_queue;

#import <Foundation/Foundation.h>

#import "FBProcess.h"
#import "FBWorkspaceEventDispatcherRegistration.h"
...
-(id)_sceneForIdentifier:(id)arg0 ;
