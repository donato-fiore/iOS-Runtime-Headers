...
+(BOOL)allowEventForBundleID:(id)arg0 ;
...
+(void)sendEventEvaluationCompletedForBundleID:(id)arg0 duration:(float)arg1 deferralTime:(float)arg2 wasDeferred:(BOOL)arg3 success:(BOOL)arg4 ;
