...
@class NSURLSession, NSDate, NSMutableURLRequest, NSMutableDictionary, NSMutableArray, NSData, NSError, NSString;
...
-(id)setupNewUploadTask:(id)arg0 suspensionThresholdEnum:(int)arg1 ;
...
-(void)kickOffNewUpload:(id)arg0 suspensionThresholdEnum:(int)arg1 ;
