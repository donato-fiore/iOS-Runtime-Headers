...
@class NSMutableSet, NSTimer, NSString, BKSHIDEventDeliveryPolicyObserver, UIFocusGuide, UIColor, UITapGestureRecognizer, NSMutableDictionary, NSMutableArray, CPMapTemplate, NSLayoutConstraint, UIView, UIPanGestureRecognizer, UIStackView, CPTripPreviewTextConfiguration, NSArray;
...
@property (retain, nonatomic) NSLayoutConstraint *navigationAlertHeightConstraint; // ivar: _navigationAlertHeightConstraint
...
-(void)navigator:(id)arg0 pausedTripForReason:(NSUInteger)arg1 description:(id)arg2 ;
