...
@class NSUUID, NSXPCConnection, NSXPCListener, NSString, NSMutableDictionary, NSMapTable, FBScene, UIViewController, SiriDirectActionSource, UIWindowScene;
@protocol NSXPCListenerDelegate, UINavigationControllerDelegate, CPSTemplateViewControllerDelegate, CPSSafeAreaDelegate, CPBannerDelegate, CPDashboardProviding, CPSNavigatorObserving, CPTemplateProviding, BSInvalidatable, CPDashboardClientInterface, CPTemplateServiceClientInterface;
...
-(void)presentAlertTemplate:(id)arg0 withProxyDelegate:(id)arg1 reply:(id)arg2 ;
...
-(void)whitelistClassesForBaseTemplateProvider:(id)arg0 ;
