...
@class UIViewController, WFWidgetWorkflowRunnerClient, NSString, WFObservableResult;
@protocol WFWidgetGridViewDelegate, WFWorkflowRunnerClientDelegate, WFObservableResultObserver, OS_os_log;
...
@property (retain, nonatomic) WFObservableResult *observedResult; // ivar: _observedResult
...
-(void)addDefaultShortcutsIfNecessaryWithCompletionHandler:(id)arg0 ;
...
-(void)layoutWithObservableResult:(id)arg0 ;
-(void)loadView;
