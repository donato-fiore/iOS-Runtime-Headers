...
#import "AMSUIToastAppearance.h"
#import "AMSUIToastTransitioningDelegate.h"
...
@property (retain, nonatomic) AMSUIToastAppearance *preferredAppearance; // ivar: _preferredAppearance
@property (retain, nonatomic) AMSDialogRequest *request; // ivar: _request
@property (retain, nonatomic) AMSUIToastAppearance *requestAppearance; // ivar: _requestAppearance
@property (nonatomic) BOOL shouldAutomaticallyReportMetrics; // ivar: _shouldAutomaticallyReportMetrics
@property (readonly) Class superclass;
@property (retain, nonatomic) AMSUIToastTransitioningDelegate *transitionDelegate; // ivar: _transitionDelegate
