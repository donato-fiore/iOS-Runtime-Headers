...
@property (retain, nonatomic) AMSUIWebAppViewModel *leftAppView; // ivar: _leftAppView
...
@property (retain, nonatomic) AMSUIWebAppViewModel *rightAppView; // ivar: _rightAppView
...
-(id)imageForButtonModel:(id)arg0 ;
