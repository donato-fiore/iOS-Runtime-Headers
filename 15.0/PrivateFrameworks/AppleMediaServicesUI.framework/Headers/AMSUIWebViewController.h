...
@class ACAccount, UIViewController, NSDictionary, AMSProcessInfo, NSString, NSURL;
@protocol NSURLSessionDelegate, AMSURLProtocolDelegate, AMSUIWebActionRunnerDelegate, AMSUIWebPageViewControllerDelegate, AMSUIWebProtocolDelegate, AMSBagConsumer, AMSBagProtocol, AMSUIWebDelegate;
