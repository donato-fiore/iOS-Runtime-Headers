...
@class NSArray, AMSBinaryPromise, NSString, _WKRemoteObjectInterface, WKWebView;
@protocol AMSUIWebViewClientInterface, WKUIDelegate, WKNavigationDelegatePrivate, AMSUIWebViewPluginInterface;
...
@property (retain, nonatomic) _WKRemoteObjectInterface *exportedInterface; // ivar: _exportedInterface
@property (retain, nonatomic) AMSUIWebDelegateProxy *exportedObjectProxy; // ivar: _exportedObjectProxy
@property (readonly) NSUInteger hash;
@property (retain, nonatomic) NSObject<AMSUIWebViewPluginInterface> *remoteProxy; // ivar: _remoteProxy
...
-(void)_webView:(id)arg0 didFailToInitializePlugInWithInfo:(id)arg1 ;
...
-(void)layoutSubviews;
-(void)receiveJSObject:(id)arg0 logKey:(id)arg1 completion:(id)arg2 ;
