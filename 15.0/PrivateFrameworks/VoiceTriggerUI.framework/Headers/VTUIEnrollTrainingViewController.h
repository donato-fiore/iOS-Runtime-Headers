...
@class UIViewController, AFUISiriLanguage, NSArray, UIView, AFEnablementFlowConfigurationProvider, AFEnablementConfiguration, UIBarButtonItem, NSString, AFMyriadCoordinator, SSRVTUITrainingManager;
...
-(void)_initialSetup;
-(void)_logVoiceSelection:(id)arg0 ;
