...
@class UIViewController, AFUISiriLanguage, NSArray, UIView, AFEnablementFlowConfigurationProvider, AFEnablementConfiguration, NSString, AFMyriadCoordinator, SSRVTUITrainingManager;
