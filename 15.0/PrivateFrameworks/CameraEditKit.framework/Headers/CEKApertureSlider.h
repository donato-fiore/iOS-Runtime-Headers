...
@protocol UIScrollViewDelegate, CEKApertureSliderDelegate;
...
@property (weak, nonatomic) NSObject<CEKApertureSliderDelegate> *delegate; // ivar: _delegate
...
-(id)valueText;
-(void)_handleDidChangeValue:(id)arg0 ;
