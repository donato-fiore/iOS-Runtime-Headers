...
-(BOOL)_isCoreDuetSyncForMaxBatchCount:(NSInteger)arg0 ;
...
-(void)_fetchArchivedRecordsIfNeeded:(BOOL)arg0 currentBatchCount:(NSInteger)arg1 maxNumberOfBatches:(NSInteger)arg2 WithCompletionBlock:(id)arg3 ;
-(void)_fetchMessageZoneChangesSyncType:(NSInteger)arg0 currentBatchCount:(NSInteger)arg1 maxNumberOfBatches:(NSInteger)arg2 completionBlock:(id)arg3 ;
...
-(void)_noteSyncEnded;
-(void)_processArchivedRecordsFetchCompletionZoneID:(id)arg0 serverChangeToken:(id)arg1 moreComing:(BOOL)arg2 currentBatchCount:(NSInteger)arg3 maxNumberOfBatches:(NSInteger)arg4 NSError:(id)arg5 completionBlock:(id)arg6 ;
...
-(void)_processModifyRecordsCompletion:(id)arg0 deletedRecordIDs:(id)arg1 operationError:(id)arg2 isLastBatchOfWrite:(BOOL)arg3 writeCompletionBlock:(id)arg4 ;
...
-(void)_processRecordZoneFetchCompletionZoneID:(id)arg0 serverChangeToken:(id)arg1 clientChangeTokenData:(id)arg2 moreComing:(BOOL)arg3 NSError:(id)arg4 syncType:(NSInteger)arg5 currentBatchCount:(NSInteger)arg6 maxNumberOfBatches:(NSInteger)arg7 shouldFetchArchivedRecords:(BOOL)arg8 completionBlock:(id)arg9 ;
...
-(void)_writeDirtyMessagesToCloudKitWithCompletion:(id)arg0 ;
