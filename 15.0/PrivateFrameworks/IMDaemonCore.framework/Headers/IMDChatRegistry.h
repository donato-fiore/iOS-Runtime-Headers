...
-(BOOL)_shouldAddNewItemForConversation:(id)arg0 ;
...
-(id)personCentricGroupedChatsArrayWithMaximumNumberOfChats:(NSInteger)arg0 skipsLastMessageLoading:(BOOL)arg1 usingChats:(id)arg2 useCachedChatGroups:(BOOL)arg3 ;
-(id)sortPersonCentricChatGroups:(id)arg0 ;
-(id)stringForChatStyle:(unsigned char)arg0 ;
-(id)truncateSortedChatsGroupedByPersonCentricID:(id)arg0 toMaximumNumberOfChats:(NSInteger)arg1 ;
...
-(void)_addTUConversationToMessageStore:(id)arg0 shouldBroadcast:(BOOL)arg1 ;
...
-(void)addChat:(id)arg0 firstLoad:(BOOL)arg1 ;
