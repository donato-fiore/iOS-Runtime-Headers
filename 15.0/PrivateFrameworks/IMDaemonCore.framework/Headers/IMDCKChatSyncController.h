...
-(void)__syncChatsWithCloudKit:(NSInteger)arg0 attemptCount:(NSUInteger)arg1 withCompletion:(id)arg2 ;
-(void)_anyChatExistsOnServerWithResultsLimit:(int)arg0 changeToken:(id)arg1 completion:(id)arg2 ;
-(void)_handleChatDeletionCompletionForRecordIDs:(id)arg0 error:(id)arg1 ;
-(void)_hasMarkedAllChatsAsNeedingSync;
-(void)_kickOffWriteIfNeededForSyncType:(NSInteger)arg0 completion:(id)arg1 ;
...
// -(void)_processFetchRecordChangesCompleted:(id)arg0 completion:(id)arg1 syncType:(unk)arg2  ;
...
-(void)_syncChatsWithCloudKitWithCompletionType:(NSInteger)arg0 syncChatsCompletionBlock:(id)arg1 ;
-(void)_updateChatUsingCKRecord:(id)arg0 onRead:(BOOL)arg1 didSucceed:(BOOL)arg2 ;
-(void)_writeCKRecordsToChatZone:(id)arg0 withCompletion:(id)arg1 ;
-(void)_writeDirtyChatsToCloudKitWithCompletion:(id)arg0 ;
-(void)anyChatExistsOnServerWithCompletion:(id)arg0 ;
-(void)clearLocalSyncState:(NSUInteger)arg0 ;
-(void)dealloc;
-(void)deleteChatSyncToken;
-(void)deleteChatZone;
-(void)syncChatsWithType:(NSInteger)arg0 withActivity:(id)arg1 withCompletion:(id)arg2 ;
