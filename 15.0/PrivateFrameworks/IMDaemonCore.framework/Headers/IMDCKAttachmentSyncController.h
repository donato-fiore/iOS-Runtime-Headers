...
@protocol OS_xpc_object, OS_dispatch_queue, IMDCKSyncTokenStore;
...
@property NSObject<OS_xpc_object> *activity; // ivar: _activity
...
-(id)_recordIDsToProcessWithError:(id)arg0 error:(id)arg1 ;
...
-(void)_fetchAndValidateFileTransfersFromCloudKit:(id)arg0 capturedWithABC:(BOOL)arg1 completion:(id)arg2 ;
-(void)_fetchAttachmentZoneChangesShouldWriteBackChanges:(BOOL)arg0 desiredKeys:(NSInteger)arg1 syncType:(NSInteger)arg2 currentBatchCount:(NSInteger)arg3 maxBatchCount:(NSInteger)arg4 syncToken:(id)arg5 completionBlock:(id)arg6 ;
-(void)_fetchAttachmentZoneRecords:(id)arg0 desiredKeys:(NSInteger)arg1 ognSuffix:(id)arg2 completion:(id)arg3 ;
-(void)_hasMarkedAllAttachmentsAsNeedingSync;
-(void)_kickOffAssetFetchForTransfersIfNeeded;
-(void)_kickOffWriteOnCKQueueWithCompletion:(id)arg0 ;
...
-(void)_processAssetFetchOperationCompletionBlock:(id)arg0 operationID:(id)arg1 error:(id)arg2 ;
...
-(void)_processRecordZoneFetchCompletion:(id)arg0 zoneID:(id)arg1 clientChangeTokenData:(id)arg2 moreComing:(BOOL)arg3 shouldWriteBackChanges:(BOOL)arg4 desiredKeys:(NSInteger)arg5 syncType:(NSInteger)arg6 error:(id)arg7 currentBatchCount:(NSInteger)arg8 maxBatchCount:(NSInteger)arg9 completionBlock:(id)arg10 ;
...
-(void)_writeAttachmentsToCloudKit:(id)arg0 ;
-(void)_writeCKRecordsToAttachmentZone:(id)arg0 withCompletion:(id)arg1 ;
...
// -(void)fetchAttachmentDataForTransfers:(id)arg0 highQuality:(BOOL)arg1 perTransferProgress:(id)arg2 completion:(unk)arg3  ;
-(void)setLatestSyncToken:(id)arg0 forSyncType:(NSInteger)arg1 ;
-(void)syncAttachmentDeletesToCloudKit:(id)arg0 ;
