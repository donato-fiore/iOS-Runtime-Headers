...
-(id)_saveRecordsT1OperationWithMap:(id)arg0 ;
-(id)_saveRecordsT2OperationWithMap:(id)arg0 ;
...
-(void)_onReadComplete:(NSInteger)arg0 error:(id)arg1 completion:(id)arg2 ;
...
-(void)_onWriteT1Complete:(NSInteger)arg0 error:(id)arg1 shouldWriteMore:(BOOL)arg2 completion:(id)arg3 ;
-(void)_onWriteT2Complete:(NSInteger)arg0 error:(id)arg1 shouldWriteMore:(BOOL)arg2 completion:(id)arg3 ;
-(void)_readRecordsWithType:(NSInteger)arg0 attemptCount:(NSUInteger)arg1 completion:(id)arg2 ;
-(void)_scheduleOperation:(id)arg0 ;
-(void)_writeRecordsWithType:(NSInteger)arg0 completion:(id)arg1 ;
-(void)_writeT1RecordUpdatesWithType:(NSInteger)arg0 completion:(id)arg1 ;
-(void)_writeT2RecordUpdatesWithType:(NSInteger)arg0 completion:(id)arg1 ;
-(void)_writeUpdatesWithType:(NSInteger)arg0 updateStep:(NSInteger)arg1 completion:(id)arg2 ;
