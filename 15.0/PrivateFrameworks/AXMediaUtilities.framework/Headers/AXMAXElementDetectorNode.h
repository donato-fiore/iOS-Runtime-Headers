...
@property (nonatomic) int ANODModelVersion; // ivar: _ANODModelVersion
@property (readonly, nonatomic) AXShotflowDetector *clickabilityDetector; // ivar: _clickabilityDetector
@property (readonly, nonatomic) AXShotflowDetector *shotflowDetector; // ivar: _shotflowDetector
