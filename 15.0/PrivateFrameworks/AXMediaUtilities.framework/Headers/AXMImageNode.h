...
-(void)triggerWithImageAssetLocalIdentifier:(id)arg0 options:(id)arg1 cacheKey:(id)arg2 resultHandler:(id)arg3 ;
-(void)triggerWithImageURL:(id)arg0 assetLocalIdentifier:(id)arg1 options:(id)arg2 cacheKey:(id)arg3 resultHandler:(id)arg4 ;
