...
+(BOOL)_accountSyncItemExistsForServiceName:(id)arg0 hostname:(id)arg1 ;
+(BOOL)_accountSyncItemExistsForServiceName:(id)arg0 username:(id)arg1 ;
+(BOOL)_dataclassSyncItemExistsForServiceName:(id)arg0 username:(id)arg1 ;
...
+(BOOL)_setAccountSyncItem:(id)arg0 hostname:(id)arg1 accessGroup:(id)arg2 accessibility:(id)arg3 options:(id)arg4 error:(*id)arg5 ;
+(BOOL)_setAccountSyncItem:(id)arg0 username:(id)arg1 accessGroup:(id)arg2 accessibility:(id)arg3 options:(id)arg4 error:(*id)arg5 ;
+(BOOL)_setAccountSyncMigrateItem:(id)arg0 username:(id)arg1 accessGroup:(id)arg2 accessibility:(id)arg3 options:(id)arg4 error:(*id)arg5 ;
+(BOOL)_setDataclassSyncItem:(id)arg0 username:(id)arg1 accessGroup:(id)arg2 accessibility:(id)arg3 options:(id)arg4 error:(*id)arg5 ;
...
+(void)initialize;
+(void)makeItemInvisibleWithService:(id)arg0 andAccount:(id)arg1 ;
