...
@property (readonly, copy, nonatomic) NSDictionary *diskImageAppBundleIDToInfoMap; // ivar: _diskImageAppBundleIDToInfoMap
...
@property (readonly, copy, nonatomic) NSSet *systemAppPlaceholderPluginBundleIDs; // ivar: _systemAppPlaceholderPluginBundleIDs
...
+(id)sharedInstance;
-(BOOL)clearIsRunningInTestMode:(*id)arg0 ;
-(BOOL)isRunningInTestMode:(*BOOL)arg0 outError:(*id)arg1 ;
-(BOOL)setIsRunningInTestMode:(*id)arg0 ;
