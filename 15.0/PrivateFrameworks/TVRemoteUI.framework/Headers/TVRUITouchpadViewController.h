...
@property (retain, nonatomic) _TVRUIDirectionalControlView *directionalControlView; // ivar: _directionalControlView
...
@property (retain, nonatomic) _TVRUITouchpadView *touchpadView; // ivar: _touchpadView
