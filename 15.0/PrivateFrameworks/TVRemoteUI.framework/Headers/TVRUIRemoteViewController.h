...
@protocol TVRUIDeviceDelegate, TVRUIDeviceSearchDelegate, _TVRUIDevicePickerDelegate, _TVRAlertControllerDelegate, _TVRUIEventDelegate, TVRUIContentPresenter, TVRUIDevice, TVRUIRemoteViewControllerDelegate, TVRUIDeviceQuery, TVRUIStyleProvider;
...
@property (retain, nonatomic) _TVRAlertController *authenticationAlertController; // ivar: _authenticationAlertController
...
@property (retain, nonatomic) _TVRAlertController *keyboardController; // ivar: _keyboardController
@property (retain, nonatomic) _TVRKeyboardHaptic *keyboardHaptic; // ivar: _keyboardHaptic
...
@property (retain, nonatomic) _TVRMessageView *messageView; // ivar: _messageView
@property (retain, nonatomic) _TVRUINetworkObserver *networkObserver; // ivar: _networkObserver
