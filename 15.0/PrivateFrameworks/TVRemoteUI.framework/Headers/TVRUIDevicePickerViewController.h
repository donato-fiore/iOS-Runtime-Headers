...
@protocol UITableViewDataSource, UITableViewDelegate, TVRUIRemoteViewProvider, _TVRUIEventDelegate, _TVRUIDevicePickerDelegate, TVRUIDevice, TVRUIStyleProvider;
...
@property (weak, nonatomic) NSObject<_TVRUIDevicePickerDelegate> *delegate; // ivar: _delegate
...
@property (retain, nonatomic) _TVREventHaptic *eventHaptic; // ivar: _eventHaptic
@property (readonly) NSUInteger hash;
@property (retain, nonatomic) _TVRUICubicSpringAnimator *hideAnimator; // ivar: _hideAnimator
@property (retain, nonatomic) UIView *nearbySectionTitleView; // ivar: _nearbySectionTitleView
@property (retain, nonatomic) _TVRUICubicSpringAnimator *showAnimator; // ivar: _showAnimator
