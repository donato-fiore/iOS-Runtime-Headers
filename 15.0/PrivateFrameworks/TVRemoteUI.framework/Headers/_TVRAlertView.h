...
#ifndef _TVRALERTVIEW_H
#define _TVRALERTVIEW_H
...
@property (weak, nonatomic) NSObject<_TVRAlertViewDelegate> *delegate; // ivar: _delegate
...
@property (retain, nonatomic) _TVRPasscodeField *passcodeField; // ivar: _passcodeField
