...
#ifndef _TVRKEYBOARDVIEW_H
#define _TVRKEYBOARDVIEW_H

@class UIView, TVRCKeyboardAttributes, RTIInputSystemSourceSession, NSString, UIButton, UIVisualEffectView, UINavigationBar;
@protocol UITextFieldDelegate, RTIInputSystemPayloadDelegate, _TVRKeyboardViewDelegate;
...
@property (weak, nonatomic) NSObject<_TVRKeyboardViewDelegate> *delegate; // ivar: _delegate
