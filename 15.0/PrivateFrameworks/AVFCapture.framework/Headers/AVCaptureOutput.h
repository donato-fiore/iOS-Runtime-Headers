...
+(id)availableVideoCodecTypesForSourceDevice:(id)arg0 sourceFormat:(id)arg1 outputDimensions:(struct ? )arg2 fileType:(id)arg3 videoCodecTypesWhiteList:(id)arg4 ;
