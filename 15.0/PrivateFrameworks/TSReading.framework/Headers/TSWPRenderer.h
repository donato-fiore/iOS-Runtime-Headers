...
-(?)p_drawAdornmentLine:(?)arg0 drawingState:(?)arg1 lineFragment:(?)arg2 lineFragmentStartvertical;
...
-(void)p_drawAdornmentLineBackgroundRect:(struct TSWPAdornmentLine *)arg0 lineDrawFlags:(unsigned int)arg1 drawingState:(*void)arg2 bounds:(struct CGRect )arg3 ;
