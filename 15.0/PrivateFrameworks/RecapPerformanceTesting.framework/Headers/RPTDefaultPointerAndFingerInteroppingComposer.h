...
@class NSProxy, NSString, RCPEventSenderProperties;
...
@property (readonly, retain, nonatomic) NSObject<RCPEventStreamComposer> *forwardingTarget; // ivar: _forwardingTarget
