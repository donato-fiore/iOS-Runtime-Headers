...
@property (readonly, nonatomic) NSArray *crossFadeSegments; // ivar: _crossFadeSegments
@property (readonly, nonatomic) NSArray *introSegments; // ivar: _introSegments
@property (readonly, nonatomic) NSArray *mainSegments; // ivar: _mainSegments
@property (readonly, nonatomic) NSArray *outroSegments; // ivar: _outroSegments
@property (readonly, nonatomic) NSArray *transSegments; // ivar: _transSegments
