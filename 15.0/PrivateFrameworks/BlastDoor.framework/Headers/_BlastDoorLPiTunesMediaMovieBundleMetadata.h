...
#ifndef _BLASTDOORLPITUNESMEDIAMOVIEBUNDLEMETADATA_H
#define _BLASTDOORLPITUNESMEDIAMOVIEBUNDLEMETADATA_H
...
@interface _BlastDoorLPiTunesMediaMovieBundleMetadata : BlastDoorLPSpecializationMetadata
