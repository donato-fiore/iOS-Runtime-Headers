...
#ifndef _BLASTDOORLPITUNESMEDIAPODCASTEPISODEMETADATA_H
#define _BLASTDOORLPITUNESMEDIAPODCASTEPISODEMETADATA_H

@class BlastDoorLPSpecializationMetadata, NSString, NSArray, NSDate;


#import "_BlastDoorLPImage.h"
#import "_BlastDoorLPArtworkMetadata.h"

@interface _BlastDoorLPiTunesMediaPodcastEpisodeMetadata : BlastDoorLPSpecializationMetadata
