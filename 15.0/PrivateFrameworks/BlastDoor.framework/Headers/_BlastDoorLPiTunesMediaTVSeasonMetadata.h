...
#ifndef _BLASTDOORLPITUNESMEDIATVSEASONMETADATA_H
#define _BLASTDOORLPITUNESMEDIATVSEASONMETADATA_H
...
@interface _BlastDoorLPiTunesMediaTVSeasonMetadata : BlastDoorLPSpecializationMetadata
