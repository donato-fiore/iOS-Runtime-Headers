...
#ifndef _BLASTDOORLPITUNESMEDIAALBUMMETADATA_H
#define _BLASTDOORLPITUNESMEDIAALBUMMETADATA_H
...
@interface _BlastDoorLPiTunesMediaAlbumMetadata : BlastDoorLPSpecializationMetadata
