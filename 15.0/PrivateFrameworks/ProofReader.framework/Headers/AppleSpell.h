...
-(id)_NLPLanguageModelWithGranularity:(NSInteger)arg0 forLanguageObject:(id)arg1 waitForResult:(BOOL)arg2 ;
...
-(id)_loadNLPLanguageModelWithGranularity:(NSInteger)arg0 forLanguageObject:(id)arg1 onQueue:(id)arg2 ;
...
-(void)getParameterValue:(*CGFloat)arg0 forName:(id)arg1 languageObject:(id)arg2 parameterBundles:(id)arg3 defaultValue:(CGFloat)arg4 ;
