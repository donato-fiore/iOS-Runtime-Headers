...
@class NSExtensionContext, NSString, NSArray;
...
-(void)encodeMessage:(id)arg0 shouldSign:(BOOL)arg1 shouldEncrypt:(BOOL)arg2 completionHandler:(id)arg3 ;
-(void)getEncodingStatusForMessage:(id)arg0 completionHandler:(id)arg1 ;
