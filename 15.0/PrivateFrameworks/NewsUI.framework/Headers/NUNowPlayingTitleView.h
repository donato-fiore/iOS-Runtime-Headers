...
#ifndef NUNOWPLAYINGTITLEVIEW_H
#define NUNOWPLAYINGTITLEVIEW_H
...
@property (weak, nonatomic) NSObject<NUNowPlayingTitleViewLayoutSpecProvider> *layoutSpecProvider; // ivar: _layoutSpecProvider
