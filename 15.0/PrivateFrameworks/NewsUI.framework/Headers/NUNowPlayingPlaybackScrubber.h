...
#ifndef NUNOWPLAYINGPLAYBACKSCRUBBER_H
#define NUNOWPLAYINGPLAYBACKSCRUBBER_H

@class UIView, NSDateComponentsFormatter, UIActivityIndicatorView, NSString, UIVisualEffectView, UILabel;
@protocol IMCustomSliderDelegate, NUNowPlayingPlaybackScrubberDelegate;
...
@property (weak, nonatomic) NSObject<NUNowPlayingPlaybackScrubberDelegate> *delegate; // ivar: _delegate
