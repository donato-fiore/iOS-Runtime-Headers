...
#ifndef SASETWRISTDETECTIONSTATUSCLIENTSTATE_H
#define SASETWRISTDETECTIONSTATUSCLIENTSTATE_H
...
+(id)setWristDetectionStatusClientStateWithDictionary:(id)arg0 context:(id)arg1 ;
