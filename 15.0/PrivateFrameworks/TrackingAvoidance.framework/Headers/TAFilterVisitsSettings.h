...
-(id)initWithDefaults;
-(id)initWithMaxSuspiciousDuration:(CGFloat)arg0 minInterVisitDistance:(CGFloat)arg1 minNSigmaBetweenVisits:(NSUInteger)arg2 entryDisplayOnBudget:(CGFloat)arg3 exitDisplayOnBudget:(CGFloat)arg4 sensitiveLOITypes:(id)arg5 minObservationInterval:(CGFloat)arg6 ;
-(id)initWithMaxSuspiciousDurationOrDefault:(id)arg0 minInterVisitDistanceOrDefault:(id)arg1 minNSigmaBetweenVisitsOrDefault:(id)arg2 entryDisplayOnBudgetOrDefault:(id)arg3 exitDisplayOnBudgetOrDefault:(id)arg4 sensitiveLOITypesOrDefault:(id)arg5 minObservationIntervalOrDefault:(id)arg6 ;
