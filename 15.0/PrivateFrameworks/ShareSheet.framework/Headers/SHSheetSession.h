...
@protocol SHSheetActivitiesManagerDelegate, SHSheetSessionInterface, SHSheetUIPeopleSuggestion, SHSheetSessionDelegate, UIActivityViewControllerObjectManipulationDelegate;
...
@property (readonly, nonatomic) BOOL slotsRenderingDisabled; // ivar: _slotsRenderingDisabled
