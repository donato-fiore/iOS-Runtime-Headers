...
@class PSListController, VSAccountStore, AIDAServiceOwnersManager, AAUIProfilePictureStore, CNMonogrammer, EAAccessory, PSSpecifier, NSArray, NSDictionary, UIImage, NSSet, ACAccountStore, DMCAccountSpecifierProvider, CoreTelephonyClient, HFHomeSettingsVisibilityArbitrator, NSString, FLPreferencesController, SBSRemoteAlertHandle, SUIKSearchResultsCollectionViewController, PSKeyboardNavigationSearchController, WSWallpaperSettingsCoordinator;
...
@property (copy, nonatomic) NSString *wifiString; // ivar: _wifiString
