...
@class UITableViewCell, NSString, UILabel, UIStackView, NSLayoutConstraint;
...
@property (retain, nonatomic) WFHotspotDetails *hotspotDetails; // ivar: _hotspotDetails
@property (weak, nonatomic) WFHotspotDetailsView *hotspotDetailsView; // ivar: _hotspotDetailsView
