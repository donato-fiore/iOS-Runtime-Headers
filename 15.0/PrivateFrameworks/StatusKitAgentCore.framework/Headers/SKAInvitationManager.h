...
@class NSString;
@protocol SKAInvitationManaging, SKAAccountProviding, OS_dispatch_queue, SKAChannelManaging, SKADatabaseManaging, SKAInvitationManagingDelegate, SKAMessagingProviding;
...
-(id)initWithMessagingProvider:(id)arg0 databaseManager:(id)arg1 accountProvider:(id)arg2 channelManager:(id)arg3 ;
