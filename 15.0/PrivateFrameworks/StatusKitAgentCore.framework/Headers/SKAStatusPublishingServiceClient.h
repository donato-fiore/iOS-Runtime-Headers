...
@class NSString;
@protocol SKStatusPublishingDaemonProtocol, SKAChannelManaging, SKADatabaseManaging, SKADatabaseProviding, SKAMessagingProviding, SKAStatusPublishingManaging, OS_dispatch_queue;
...
-(id)initWithXPCConnection:(id)arg0 queue:(id)arg1 databaseManager:(id)arg2 invitationManager:(id)arg3 publishingManager:(id)arg4 channelManager:(id)arg5 ;
