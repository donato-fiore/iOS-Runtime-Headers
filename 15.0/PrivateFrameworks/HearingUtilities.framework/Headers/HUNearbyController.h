...
@class NSArray, RPCompanionLinkClient, NSString, SFDeviceDiscovery, AXDispatchTimer;
@protocol HUNearbyDeviceDelegate, HUNearbyControllerDelegate, OS_dispatch_queue;
