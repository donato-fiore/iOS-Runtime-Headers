...
@class AXAssetController, NSMutableDictionary, NSArray, NSString;
...
@property (retain, nonatomic) NSMutableDictionary *assetDownloadProgress; // ivar: _assetDownloadProgress
