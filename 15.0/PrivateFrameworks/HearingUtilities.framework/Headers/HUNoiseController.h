...
@class AXDispatchTimer, ADAMAudioDataReceiver, HKHealthStore, NSMutableArray, HKCategorySample, NSDate, UNUserNotificationCenter;
...
-(id)init;
-(id)measurementConfigurationWithDuration:(unsigned int)arg0 period:(unsigned int)arg1 ;
