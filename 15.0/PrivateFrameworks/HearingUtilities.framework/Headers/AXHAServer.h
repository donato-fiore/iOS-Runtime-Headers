...
-(id)init;
-(void)_audiogramIngestionModelDidUpdate:(id)arg0 ;
...
-(void)registerListener:(id)arg0 forAudiogramIngestionModelUpdatesHandler:(id)arg1 ;
...
-(void)stopLiveListen;
-(void)unregisterAudiogramIngestionModelUpdatesHandler:(id)arg0 ;
