...
@class PKPaymentWebService, NSMutableArray, PKPaymentService, NSArray, NSMutableSet, NSString, NSSet, DIVerificationSession, PKAssertion, PKAccount, NSURL, PKFamilyMember, PKFeatureApplication, PKPaymentInstallmentConfiguration, PKPaymentProvisioningController;
...
-(void)submitActionIdentifier:(id)arg0 completion:(id)arg1 ;
