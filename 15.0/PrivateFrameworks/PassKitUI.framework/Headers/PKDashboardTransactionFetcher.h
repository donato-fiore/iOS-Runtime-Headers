...
@class PKTransactionSourceCollection, PKMerchant, PKCreditInstallmentPlan, NSArray, PKCurrencyAmount, NSSet, NSDecimalNumber, PKPaymentPass, NSString, NSDictionary, NSDate;
