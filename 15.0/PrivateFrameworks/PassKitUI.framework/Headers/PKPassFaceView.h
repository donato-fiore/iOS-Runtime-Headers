...
@class PKPass, NSMutableSet, UIView, UIImageView, UIImage, CAFilter, NSMutableArray, PKPaymentService, NSArray, NSString, NSData, PKPassFaceViewRendererState;
...
@property (nonatomic) BOOL allowBackgroundPlaceholders; // ivar: _allowBackgroundPlaceholders
