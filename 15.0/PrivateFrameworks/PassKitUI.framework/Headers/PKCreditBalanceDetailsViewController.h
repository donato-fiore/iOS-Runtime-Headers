...
@class UICollectionViewController, PKTransactionSourceCollection, PKAccount, PKAccountUserCollection, PKCreditAccountStatement, PKCreditAccountSummary, PKPaymentWebService, PKFamilyMemberCollection, NSArray, NSDictionary, NSDateFormatter, NSString;
...
-(id)initWithStyle:(NSInteger)arg0 transactionSourceCollection:(id)arg1 familyCollection:(id)arg2 webService:(id)arg3 account:(id)arg4 accountUserCollection:(id)arg5 statement:(id)arg6 previousStatements:(id)arg7 ;
