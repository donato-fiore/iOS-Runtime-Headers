...
@protocol UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, UIViewControllerTransitioningDelegate, UIGestureRecognizerDelegate, PKDiscoveryCardViewDelegate, PKPaymentSetupDelegate, OS_dispatch_queue;
...
@property (nonatomic, getter=shouldUseCustomPresentation) BOOL useCustomPresentation; // ivar: _useCustomPresentation
