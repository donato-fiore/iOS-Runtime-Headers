...
@class PKPaymentPass, PKPaymentTransaction, PKAccount, PKAccountUser, PKFamilyMember, NSString;
...
-(id)groupParameters;
-(id)initWithPaymentPass:(id)arg0 transaction:(id)arg1 account:(id)arg2 accountUser:(id)arg3 familyMember:(id)arg4 intent:(NSInteger)arg5 ;
-(id)intentParameters;
