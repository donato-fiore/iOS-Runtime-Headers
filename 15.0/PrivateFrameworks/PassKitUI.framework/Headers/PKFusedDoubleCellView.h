...
@property (nonatomic) NSInteger leftDetailLineBreakMode; // ivar: _leftDetailLineBreakMode
...
@property (nonatomic) NSInteger leftSubDetailLineBreakMode; // ivar: _leftSubDetailLineBreakMode
...
@property (nonatomic) NSInteger leftTitleLineBreakMode; // ivar: _leftTitleLineBreakMode
...
@property (nonatomic) NSInteger rightDetailLineBreakMode; // ivar: _rightDetailLineBreakMode
...
@property (nonatomic) NSInteger rightSubDetailLineBreakMode; // ivar: _rightSubDetailLineBreakMode
...
@property (nonatomic) NSInteger rightTitleLineBreakMode; // ivar: _rightTitleLineBreakMode
