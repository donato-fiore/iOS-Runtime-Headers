...
@class UIView, NSMutableDictionary, NSMutableArray, UIScrollView, UIPanGestureRecognizer, UILongPressGestureRecognizer, UIMotionEffectGroup, UIViewController, NSString, PKGroup, UIPageControl;
...
-(void)_addDelayedAnimation:(id)arg0 toLayer:(id)arg1 withRemovalAction:(id)arg2 ;
...
-(void)_removeDelayedAnimationTrackerWithKey:(id)arg0 ;
