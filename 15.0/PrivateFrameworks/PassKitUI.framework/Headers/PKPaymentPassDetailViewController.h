...
@property (nonatomic) NSUInteger loadingCredentialDetails; // ivar: _loadingCredentialDetails
...
@property (nonatomic) BOOL replaceBiometricAvailable; // ivar: _replaceBiometricAvailable
...
-(id)_sharedCredentialCellForRowIndex:(NSInteger)arg0 tableView:(id)arg1 ;
...
-(void)_didSelectSharedCredentialCellAtIndexPath:(id)arg0 ;
-(void)_didSelectSharedCredentialGroupAtIndex:(NSInteger)arg0 ;
...
-(void)_presentContactBankViewController:(NSUInteger)arg0 ;
...
-(void)_updateDisplayableBalancesAndTransitPropertiesWithBalances:(id)arg0 transitProperties:(id)arg1 withCompletion:(id)arg2 ;
...
-(void)updateCredentialWithCompletion:(id)arg0 ;
