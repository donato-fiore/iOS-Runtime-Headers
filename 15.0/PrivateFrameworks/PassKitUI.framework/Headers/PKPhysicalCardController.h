...
@class PKAccountService, PKAccount, PKAccountUser, NSString, PKPaymentPass, PKPhysicalCard;
...
-(id)initWithAccountService:(id)arg0 paymentPass:(id)arg1 account:(id)arg2 accountUser:(id)arg3 ;
