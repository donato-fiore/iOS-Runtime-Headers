...
@class PKTransactionSourceCollection, PKContactResolver, NSString, PKPaymentTransaction, PKPaymentTransactionGroup, PKCreditInstallmentPlan, PKTransactionReceipt, NSArray, PKCoarseLocationMonitor, PKFamilyMemberCollection, NSDateFormatter, NSCalendar, PKAccount, PKAccountUserCollection, CNContact, PKCurrencyAmount, NSIndexPath, PKMerchant;
...
-(id)initWithFetcher:(id)arg0 transactionSourceCollection:(id)arg1 familyCollection:(id)arg2 account:(id)arg3 accountUserCollection:(id)arg4 featuredTransaction:(id)arg5 selectedTransactions:(id)arg6 transactionHistory:(id)arg7 type:(NSUInteger)arg8 ;
...
-(id)initWithTransactionGroups:(id)arg0 headerGroup:(id)arg1 regionUpdater:(id)arg2 tokens:(id)arg3 transactionSourceCollection:(id)arg4 familyCollection:(id)arg5 account:(id)arg6 accountUserCollection:(id)arg7 ;
