...
@protocol PKDiscoveryCardViewDelegate, UIScrollViewDelegate, PKForegroundActiveArbiterObserver, PKPGSVSectionSubheaderView, PKPGSVSectionSubheaderDelegate;
...
@property (readonly, weak, nonatomic) PKDiscoveryCardView *pressedDiscoveryCardView; // ivar: _pressedDiscoveryCardView
@property (readonly) Class superclass;


+(BOOL)isVisibileForPKPGSVLayoutState:(struct ? )arg0 dataSource:(id)arg1 ;
...
-(id)initWithFrame:(struct CGRect )arg0 cardTemplateInformation:(id)arg1 ;
...
-(void)updateForPKPGSVLayoutState:(struct ? )arg0 ;
