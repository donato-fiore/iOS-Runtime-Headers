...
@class PKPaymentPass, PKAccount, PKAccountUserCollection, NSString, PKFamilyMemberCollection, PKTransactionSource, PKPaymentTransaction, PKTransactionSourceCollection;
