...
-(id)_onboardingViewControllerForProduct:(id)arg0 ;
...
-(void)presentMultiCredentialPaymentSetupWithCredentials:(id)arg0 product:(id)arg1 viewController:(id)arg2 completion:(id)arg3 ;
