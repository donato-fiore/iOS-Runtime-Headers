...
@class PKPaymentTransaction, PKTransactionSourceCollection, PKPaymentPass, PKAccount, PKAccountUserCollection, PKPaymentService, PKFamilyMemberCollection, UIBarButtonItem, UIActivityIndicatorView, NSString, UITableViewHeaderFooterView, UIImageView, PKPaymentWebService;
...
-(id)initWithTransaction:(id)arg0 transactionSourceCollection:(id)arg1 paymentPass:(id)arg2 familyCollection:(id)arg3 account:(id)arg4 accountUserCollection:(id)arg5 detailViewStyle:(NSInteger)arg6 ;
