...
@class NSMutableArray, PKExpressPassController, NSArray, NSMutableDictionary, LAContext, NSString;
...
-(void)_userSetExpressTransitToEnabled:(BOOL)arg0 cell:(id)arg1 ;
-(void)dealloc;
