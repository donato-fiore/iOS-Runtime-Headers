...
-(id)initWithContext:(NSUInteger)arg0 avatarViewDelegate:(id)arg1 ;
...
-(void)viewControllerForTransaction:(id)arg0 transactionSourceCollection:(id)arg1 familyCollection:(id)arg2 account:(id)arg3 accountUserCollection:(id)arg4 forcePreventHistory:(BOOL)arg5 completion:(id)arg6 ;
