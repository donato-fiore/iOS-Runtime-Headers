...
@class NSString;
@protocol SXViewportChangeListener, SXMediaPlaybackDelegate, SXVideoPlayerViewControllerDelegate, SXVideoPlayerViewControllerDataSource, SWReachabilityObserver, SXFullscreenVideoPlaybackCandidate, SXAppStateMonitor, SXBookmarkManager, SXVideoAdProviderFactory, SWReachabilityProvider, SXResourceDataSource, SXSceneStateMonitor, SXScrollObserverManager;
...
@property (retain, nonatomic) SXVideoPlayerViewController *videoPlayerViewController; // ivar: _videoPlayerViewController
...
@property (readonly, nonatomic) SXVolumeProvider *volumeProvider; // ivar: _volumeProvider
