...
+(id)_appBundleIdentifierFromBundleRecord:(id)arg0 isWebBrowser:(*BOOL)arg1 ;
...
-(id)_appDomainUsageBy:(unsigned int)arg0 inProcess:(id)arg1 forDomain:(id)arg2 domainOwner:(id)arg3 domainType:(unsigned short)arg4 context:(id)arg5 initiatedType:(unsigned int)arg6 ;
...
-(void)_updateDomainInfoBy:(unsigned int)arg0 bundleIdentifier:(id)arg1 attributedBundleId:(id)arg2 processName:(id)arg3 domainName:(id)arg4 domainOwner:(id)arg5 domainType:(unsigned short)arg6 context:(id)arg7 initiatedType:(unsigned int)arg8 flowID:(NSUInteger)arg9 reason:(id)arg10 ;
...
-(void)dealloc;
-(void)domainInfoProcessingForFlow:(id)arg0 ;
...
-(void)usageManager:(id)arg0 didReceiveSnapshot:(id)arg1 ;
