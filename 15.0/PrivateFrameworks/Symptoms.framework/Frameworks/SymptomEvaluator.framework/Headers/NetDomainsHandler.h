...
-(BOOL)_hasSomeUserEnabled;
-(BOOL)_triggerAutoBugCaptureCaseForType:(id)arg0 subType:(id)arg1 privateSubtypeContext:(id)arg2 detectedProcess:(id)arg3 events:(id)arg4 ;
...
-(id)getOwnerForDomainName:(id)arg0 ;
-(id)init;
-(id)initTestInstance;
