...
@property (nonatomic) BOOL isDomainInfoProcessed; // ivar: _isDomainInfoProcessed
...
@property (nonatomic) NSUInteger networkActivityMapPart1; // ivar: _networkActivityMapPart1
@property (nonatomic) NSUInteger networkActivityMapPart2; // ivar: _networkActivityMapPart2
@property (nonatomic) BOOL networkActivityMapRolledOver; // ivar: _networkActivityMapRolledOver
@property (nonatomic) BOOL networkActivityMapShouldNotBeCounted; // ivar: _networkActivityMapShouldNotBeCounted
@property (nonatomic) NSUInteger networkActivityMapStartTime; // ivar: _networkActivityMapStartTime
...
-(void)setActivityBitmapInfo:(id)arg0 withOwner:(id)arg1 ;
