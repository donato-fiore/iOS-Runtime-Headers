...
@class NSMutableSet, NSString, _UILegibilitySettings, UIView, NSTimer;
@protocol SPUISearchHeaderDelegate, SearchUIFirstTimeExperienceDelegate, UIGestureRecognizerDelegate, SPUISearchViewControllerDelegate, SPUISearchViewControllerSizingDelegate;
...
@property (retain) UIView *tapToRadarView; // ivar: _tapToRadarView
...
-(void)searchThroughPunchoutForResult:(id)arg0 forQuery:(id)arg1 ;
-(void)searchThroughPunchoutForResult:(id)arg0 resultTitle:(id)arg1 forQuery:(id)arg2 ;
