...
+(id)concatenateEventsPrivate:(id)arg0 ;
...
+(void)recordPossibleEngagementEventAt:(id)arg0 withPluginDate:(CGFloat)arg1 withPluginDuration:(NSInteger)arg2 absoluteShouldHaveEngaged:(BOOL)arg3 withEngagedMinutes:(NSInteger)arg4 withEligibleDurationMins:(NSInteger)arg5 wasUndercharged:(BOOL)arg6 withKnowledgeStore:(id)arg7 ;
