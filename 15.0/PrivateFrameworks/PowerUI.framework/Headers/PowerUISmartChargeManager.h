...
@property (nonatomic) BOOL firstNotificationRequested; // ivar: _firstNotificationRequested
...
-(BOOL)predictor:(NSUInteger)arg0 suggestsDiablingChargingAtBatteryLevel:(NSUInteger)arg1 ;
