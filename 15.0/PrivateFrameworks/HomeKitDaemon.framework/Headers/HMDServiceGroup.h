...
@class HMFObject, HMFUnfairLock, NSMutableDictionary, NSMutableArray, NSDictionary, NSString, NSSet, NSUUID, HMFMessageDispatcher, NSArray;
...
-(id)_handleUpdateNameTransaction:(id)arg0 requestMessage:(id)arg1 ;
-(id)_handleUpdateServicesTransaction:(id)arg0 requestMessage:(id)arg1 ;
