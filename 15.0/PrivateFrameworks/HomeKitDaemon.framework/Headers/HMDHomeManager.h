...
#import "HMDCoreDuetLogEventObserver.h"
...
#import "HMDHK2FrameworkSwitch.h"
...
@property (retain, nonatomic) HMDCoreDuetLogEventObserver *coreDuetLogEventObserver; // ivar: _coreDuetLogEventObserver
...
@property (retain, nonatomic) HMDHK2FrameworkSwitch *hk2FrameworkSwitch; // ivar: _hk2FrameworkSwitch
...
@property (nonatomic) NSInteger networkConnectionAvailable; // ivar: _networkConnectionAvailable
...
-(id)checkConflictInHomeNamespaceWithName:(id)arg0 options:(NSUInteger)arg1 namespaceUUID:(id)arg2 ;
...
-(id)homesForDuetPredictionSubscriber:(id)arg0 ;
...
-(id)remoteAccessControlEnforcerForHomeUUID:(id)arg0 ;
-(id)remoteGatewayCapableDevices;
-(id)remoteSubscriptionProviderForHomeUUID:(id)arg0 ;
...
-(id)writeMigrationRecordFromMessage:(id)arg0 ;
...
-(void)__handleRefreshedServerBagContents:(id)arg0 ;
...
-(void)_handleUpgradeToHomeKit2Framework:(id)arg0 ;
...
-(void)saveToPersistentStoreForHK2MigrationWithCompletionHandler:(id)arg0 ;
...
-(void)sendMigrationRequestToResident:(id)arg0 withCompletion:(id)arg1 ;
...
-(void)startHK2MigrationFromRequest:(id)arg0 withCompletionHandler:(id)arg1 ;
-(void)startLocalTransport;
-(void)startWithCompletionHandler:(id)arg0 ;
-(void)stopLocalTransport;
-(void)syncWalletKeyPassSerialNumbersToWatchWithDeviceId:(id)arg0 completion:(id)arg1 ;
