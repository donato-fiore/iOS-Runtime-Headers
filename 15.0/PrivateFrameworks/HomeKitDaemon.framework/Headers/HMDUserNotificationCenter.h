...
@protocol UNUserNotificationCenterDelegate, HMDUserNotificationCenterDelegate;
...
-(id)showNotificationWithTitle:(id)arg0 body:(id)arg1 threadIdentifier:(id)arg2 categoryIdentifier:(id)arg3 requestIdentifier:(id)arg4 date:(id)arg5 attachments:(id)arg6 userInfo:(id)arg7 shouldIgnoreDoNotDisturb:(BOOL)arg8 interruptionLevel:(NSUInteger)arg9 ;
-(void)_showNotification:(id)arg0 ;
-(void)configureWithNotificationCategories:(id)arg0 ;
