...
@protocol HMFMessageReceiver, HMFLogging, HMDWalletPassLibraryDelegate, HMDHomeWalletDataSource, HMDFileManager, HAPKeyStore, OS_dispatch_queue, HMDWalletPassLibrary;
...
@property (readonly) BOOL canAutoAddWalletKey;
...
-(void)autoAddWalletKeyWithCompletion:(id)arg0 ;
