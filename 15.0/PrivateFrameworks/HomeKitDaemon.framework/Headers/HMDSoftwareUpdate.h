...
@protocol HMFLogging, HMFObject, HMDBackingStoreObjectProtocol, HMDHomeMessageReceiver, NSSecureCoding, HMFLocking, OS_dispatch_queue;
...
-(void)configureWithAccessory:(id)arg0 messageDispatcher:(id)arg1 ;
-(void)dealloc;
