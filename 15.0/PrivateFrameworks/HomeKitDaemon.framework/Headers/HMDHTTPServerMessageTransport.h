...
@class HMFObject, HMFUnfairLock, NSMutableArray, NSDictionary, NSArray, NSString, NSUUID, HMFHTTPServer;
@protocol HMFHTTPServerDelegate, HMFTimerDelegate, HMDHTTPServerMessageTransportDelegate;
