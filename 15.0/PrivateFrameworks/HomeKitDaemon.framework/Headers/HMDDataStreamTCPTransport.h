...
@protocol HMFLogging, HMDDataStreamTransport, HMDDataStreamTransportDelegate, OS_tcp_connection, OS_dispatch_queue;
...
@property (retain, nonatomic) NSObject<OS_tcp_connection> *tcpConnection; // ivar: _tcpConnection
