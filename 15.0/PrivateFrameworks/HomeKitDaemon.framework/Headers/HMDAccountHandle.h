...
@class HMFObject, IDSURI, CKUserIdentityLookupInfo, CNContact, NSString, NSUUID;
@protocol HMBModelObjectCoder, HMFLogging, HMDBackingStoreObjectProtocol, HMDBackingStoreModelBackedObjectProtocol, HMDRemoteAddressable, NSCopying, NSSecureCoding;
