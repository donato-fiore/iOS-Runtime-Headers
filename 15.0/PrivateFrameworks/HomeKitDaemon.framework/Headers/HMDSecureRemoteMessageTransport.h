...
@class HMFMessageTransport, NSMutableDictionary, NSString, HMFRingBuffer, NSMutableSet, NSArray;
...
@property (retain) HMDIDSMessageTransport *idsTransport; // ivar: _idsTransport
@property (retain) HMFRingBuffer *messageIDBuffer; // ivar: _messageIDBuffer
@property BOOL rapportLinkSlow; // ivar: _rapportLinkSlow
...
-(BOOL)_isDuplicateMessage:(id)arg0 ;
-(BOOL)_isModernTransportEnabled;
...
-(void)_sendMessageOverIDS:(id)arg0 hasAttemptedSendOverIDS:(*BOOL)arg1 didInvokeResponseBlock:(BOOL)arg2 didReceiveRapportAck:(BOOL)arg3 ;
