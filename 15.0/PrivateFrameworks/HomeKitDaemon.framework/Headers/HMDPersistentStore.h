...
+(BOOL)deserializeHomeData:(*id)arg0 usingLocalStorage:(BOOL)arg1 fromData:(id)arg2 forHomeKit2Migration:(BOOL)arg3 ;
...
+(id)unarchiveHomeData:(*id)arg0 decryptionFailed:(*BOOL)arg1 fromLocation:(id)arg2 successfulKeyUserName:(*id)arg3 forHomeKit2Migration:(BOOL)arg4 ;
