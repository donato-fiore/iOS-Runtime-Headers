...
@property (copy) NSArray *accessories; // ivar: _accessories
...
@property (retain, nonatomic) NSMutableDictionary *addAccessoryRequestMap; // ivar: _addAccessoryRequestMap
...
@property (retain) HMDApplicationDataPlugIn *applicationData; // ivar: _applicationData
...
@property (nonatomic) BOOL automaticThirdPartyAccessorySoftwareUpdateEnabled; // ivar: _automaticThirdPartyAccessorySoftwareUpdateEnabled
@property (retain, nonatomic) HMDBackingStore *backingStore; // ivar: _backingStore
@property (readonly, nonatomic) HMDBonjourBrowserHelper *bonjourBrowser; // ivar: _bonjourBrowser
@property (readonly, copy) NSArray *cameraAccessories;
@property (readonly, copy) NSDictionary *chipKeyValueStore;
@property (copy) NSDictionary *chipKeyValueStore; // ivar: _chipKeyValueStore
...
@property BOOL isUpdatedToROAR; // ivar: _isUpdatedToROAR
...
@property (retain, nonatomic) NSMutableArray *pendingUsers; // ivar: _pendingUsers
@property (readonly, nonatomic) HMDHomePeriodicReader *periodicReader; // ivar: _periodicReader
@property (retain) HMDHomePersonDataManager *personDataManager; // ivar: _personDataManager
...
@property (retain, nonatomic) HMDRelayManager *relayManager; // ivar: _relayManager
@property (nonatomic) BOOL remoteAccessIsEnabled; // ivar: _remoteAccessIsEnabled
@property (retain, nonatomic) HMDRemoteEventRouterClient *remoteEventRouterClient; // ivar: _remoteEventRouterClient
@property (retain, nonatomic) HMDRemoteEventRouterServer *remoteEventRouterServer; // ivar: _remoteEventRouterServer
@property (readonly) NSObject<HMDRemoteEventAccessControlEnforcer> *remoteEventRouterServerAccessControlEnforcer;
...
@property (readonly) HMDAssistantWatchAuthenticationDataSource *siriWatchAuthenticationDataSource; // ivar: _siriWatchAuthenticationDataSource
...
+(id)notificationPayloadForChangedCharacterisitics:(id)arg0 destinationIsXPCTransport:(BOOL)arg1 ;
+(id)shortDescription;
...
-(BOOL)_doesResidentExistInMyCircleWithAddress:(id)arg0 homeManager:(id)arg1 ;
-(BOOL)_enqueueRetrievalCompletionTuple:(id)arg0 forAccessory:(id)arg1 ;
...
-(BOOL)_isReadRequestAllowForCharacteristic:(id)arg0 message:(id)arg1 error:(*id)arg2 ;
-(BOOL)_isRegisteredForNotificationsForClients:(id)arg0 ;
-(BOOL)_isRegisteredForNotificationsWithRemoteGateway:(id)arg0 ;
-(BOOL)_isRetrievalInProgressForAccessory:(id)arg0 linkType:(NSInteger)arg1 ;
-(BOOL)_isSecureClassTriggeredByCharactersitics:(id)arg0 ;
-(BOOL)_isSharedHomeVersionTrustZoneCapable;
-(BOOL)_isUserValid:(id)arg0 error:(*id)arg1 ;
-(BOOL)_isValidEventIdentifier:(id)arg0 ;
...
-(BOOL)isAccessAllowedForCharacteristic:(id)arg0 withMessage:(id)arg1 ;
...
-(BOOL)requiresUnlockToAccessCharacteristic:(id)arg0 withMessage:(id)arg1 ;
...
-(NSUInteger)availableBSPsCount;
-(NSUInteger)deriveNetworkRouterSupport:(NSUInteger)arg0 ;
-(id)__readWriteResponseHandler:(SEL)arg0 ;
-(id)__residentDeviceForAccesory:(id)arg0 fromMap:(id)arg1 ;
...
-(id)_dequeueAllRetrievalCompletionTuplesForLinkType:(NSInteger)arg0 accessory:(id)arg1 ;
...
-(id)_removeAccessoriesCommon:(id)arg0 message:(id)arg1 ;
...
-(id)addAccessoryRequestsForMessage:(id)arg0 ;
...
-(id)createAccessorySettingsMessengerWithMessageTargetUUID:(id)arg0 messageDispatcher:(id)arg1 messageRouter:(id)arg2 messageHandler:(id)arg3 ;
...
-(id)destinationControllerWithCommittedDestinatonIdentifier:(id)arg0 ;
-(id)destinationControllerWithDestinatonIdentifier:(id)arg0 ;
...
-(id)getTransactionFromHAPAccessory:(id)arg0 hmdAccessory:(id)arg1 uuid:(id)arg2 bridgeUUID:(id)arg3 configurationAppIdentifier:(id)arg4 objectChangeType:(NSUInteger)arg5 ;
...
// -(id)initWithName:(id)arg0 uuid:(id)arg1 defaultRoomUUID:(id)arg2 owner:(id)arg3 homeManager:(id)arg4 presenceAuth:(id)arg5 metricsDispatcherFactory:(id)arg6 currentUserFactory:(id)arg7 residentDeviceManagerFactory:(unk)arg8 locationHandlerFactory:(id)arg9 hapMetadata:(unk)arg10 siriWatchAuthenticationDataSource:(id)arg11 deviceLockStateDataSource:(unk)arg12  ;
...
-(id)routerClientPrimaryResidentMessageDestination:(id)arg0 serverIdentifier:(*id)arg1 ;
-(id)routerClientResidentManager:(id)arg0 ;
-(id)routerServerResidentManager:(id)arg0 ;
-(id)routerServerUserAccessControlProvider:(id)arg0 ;
...
-(id)userWithPairingIdentity:(id)arg0 mergeID:(id)arg1 ;
-(id)userWithUUID:(id)arg0 ;
-(id)users;
-(id)validateName:(id)arg0 ;
-(id)writeRequestTuplesFromMessage:(id)arg0 ;
...
-(void)__handleAcceptedOutgoingInvitationResponse:(id)arg0 destinationAddress:(id)arg1 publicKey:(id)arg2 username:(id)arg3 sourceMergeID:(id)arg4 presenceAuthStatus:(id)arg5 completionHandler:(id)arg6 ;
...
-(void)__registerForRemoteAccessoryReachabilityNotifications:(BOOL)arg0 ;
-(void)__saveConfigurationVersionTransaction;
-(void)__sendOutgoingInvitations:(id)arg0 ;
...
-(void)_addUsersWithIDs:(id)arg0 message:(id)arg1 ;
...
-(void)_continuePairingAfterUserConsentWithAccessoryDescription:(id)arg0 message:(id)arg1 ;
-(void)_continuePairingAfterUserConsentWithAccessoryUUID:(id)arg0 message:(id)arg1 ;
-(void)_createUniquePSKClientConfigurationWithRequestMessage:(id)arg0 pairingEvent:(id)arg1 completion:(id)arg2 ;
-(void)_dequeueRetrievalCompletionTuple:(id)arg0 forAccessory:(id)arg1 ;
...
-(void)_enableMediaNotifications:(BOOL)arg0 forMediaAccessory:(id)arg1 ;
-(void)_enableNotificationsForDevices:(id)arg0 ;
-(void)_encodeActionSets:(id)arg0 coder:(id)arg1 ;
-(void)_encodeObjectsWithAcessoriesWithCoder:(id)arg0 ;
...
-(void)_handleAddActivityRequestTimerFiredForInfo:(id)arg0 ;
-(void)_handleAddEventTrigger:(id)arg0 ;
-(void)_handleAddEventTrigger:(id)arg0 eventTriggerModel:(id)arg1 ;
...
-(void)_handleAddRelayAccessTokens:(id)arg0 ;
...
-(void)_handleAddUserToRelayAccessories:(id)arg0 ;
...
-(void)_handleCharacterisiticsChangedNotification:(id)arg0 ;
...
-(void)_handleFetchAccessories:(id)arg0 ;
...
-(void)_handlePendingResponserTimerFired:(BOOL)arg0 ;
...
-(void)_handleRemovedPairedAccessories:(id)arg0 bridgeAccessory:(id)arg1 ;
...
-(void)_handleUpdateRequestForHomeInvitation:(id)arg0 controllerPublicKey:(id)arg1 controllerUsername:(id)arg2 invitationState:(NSInteger)arg3 presenceAuthStatus:(id)arg4 preferredUserID:(id)arg5 fromHandle:(id)arg6 sourceMergeID:(id)arg7 fromAddress:(id)arg8 message:(id)arg9 messageResponseHandler:(id)arg10 ;
...
-(void)_modifyNotificationOnResident:(BOOL)arg0 ignoreDeviceUnlockRequirement:(BOOL)arg1 forCharacteristics:(id)arg2 ;
...
-(void)_postInternalNotificationForChangedCharacterisitics:(id)arg0 modifiedCharacteristics:(id)arg1 changedByThisDevice:(BOOL)arg2 residentShouldNotifyPeers:(BOOL)arg3 message:(id)arg4 broadcast:(BOOL)arg5 ;
...
-(void)_queryThreadNetworkIDWithCompletion:(id)arg0 ;
...
-(void)_readProfileState:(id)arg0 viaDevice:(id)arg1 message:(id)arg2 ;
...
-(void)_removeAccessories:(id)arg0 bridgeAccessory:(id)arg1 message:(id)arg2 ;
...
-(void)_removeAllUsersFromAccessory:(id)arg0 completionHandler:(id)arg1 ;
...
-(void)_retrieveHAPAccessoryForHMDAccessory:(id)arg0 linkType:(NSInteger)arg1 queue:(id)arg2 completion:(id)arg3 ;
...
-(void)_sendAccessTokensToUser:(id)arg0 user:(id)arg1 error:(id)arg2 ;
-(void)_sendClientCharacteristicsChangedNotification:(id)arg0 identifier:(id)arg1 request:(id)arg2 entitledClientsOnly:(BOOL)arg3 multiPartResponse:(BOOL)arg4 moreMessagesInMultipart:(BOOL)arg5 withCompletionHandler:(id)arg6 ;
-(void)_sendInvitation:(id)arg0 message:(id)arg1 ;
-(void)_sendInvitationCancelationRequestToInvitee:(id)arg0 ;
-(void)_sendReadRequestToAccessory:(id)arg0 requestMessage:(id)arg1 source:(NSUInteger)arg2 pendingResponses:(id)arg3 slowFailedAccessories:(id)arg4 fastFailedAccessories:(id)arg5 unreachableWaitGroup:(id)arg6 waitGroup:(id)arg7 activity:(id)arg8 ;
...
-(void)_sendUserRemovedNotificationForUser:(id)arg0 message:(id)arg1 response:(id)arg2 ;
-(void)_sendWriteRequestToAccessory:(id)arg0 requestMessage:(id)arg1 source:(NSUInteger)arg2 failedAccessories:(id)arg3 responseTuples:(id)arg4 activity:(id)arg5 waitGroup:(id)arg6 unreachableWaitGroup:(id)arg7 ;
...
-(void)_subscribeForHomeAppleMediaNotificationsOnDirectTransports:(BOOL)arg0 ;
...
-(void)_subscribeForHomeNotificationsOnDirectTransports:(BOOL)arg0 ;
-(void)_subscribeForNotificationFromRemoteGateway:(BOOL)arg0 ;
...
-(void)_updateBrowser;
-(void)_updateBulletinBoardOfChangedCharacteristics:(id)arg0 changedByThisDevice:(BOOL)arg1 homePresence:(id)arg2 ;
...
-(void)_updateOutgoingInviationsWithCompleteUserManagementOperation:(id)arg0 ;
...
-(void)addUserToRelayAccessoriesWithConsentTokens:(id)arg0 ;
...
-(void)configureAfterAccessoriesConfigurationTrackerNotificationsWithCurrentAccessory:(id)arg0 accessories:(id)arg1 ;
...
-(void)configureWithRelayManager:(id)arg0 ;
-(void)dealloc;
...
-(void)handleHK2MigrationRequest:(id)arg0 ;
-(void)handleInactive:(id)arg0 ;
-(void)handleNetworkRouterProfileAdded:(id)arg0 ;
-(void)handleNetworkRouterProfileRemoved:(id)arg0 ;
-(void)handlePrimaryResidentConfirmedStateChangedNotification:(id)arg0 ;
-(void)handleRemoveAccessory:(id)arg0 ;
...
-(void)handleUpdatePrimaryNotification:(id)arg0 ;
...
-(void)modifyNotificationOnResident:(BOOL)arg0 ignoreDeviceUnlockRequirement:(BOOL)arg1 forCharacteristics:(id)arg2 ;
...
-(void)notifyOfRemovedAccessory:(id)arg0 isRemovingCurrentAppleMediaAccessory:(BOOL)arg1 source:(NSUInteger)arg2 ;
...
-(void)readCharacteristicValues:(id)arg0 identifier:(id)arg1 source:(NSUInteger)arg2 withCompletionHandler:(id)arg3 ;
-(void)readCharacteristicValues:(id)arg0 source:(NSUInteger)arg1 withCompletionHandler:(id)arg2 ;
...
-(void)removeAccessoriesFromContainers:(id)arg0 ;
-(void)removeAccessory:(id)arg0 ;
-(void)removeAccessory:(id)arg0 completionHandler:(id)arg1 ;
-(void)removeAddAccessoryRequestWithIdentifier:(id)arg0 ;
...
-(void)retrieveHAPAccessoryForHMDAccessory:(id)arg0 linkType:(NSInteger)arg1 queue:(id)arg2 completion:(id)arg3 ;
-(void)saveAddAccessoryRequest:(id)arg0 ;
...
-(void)sendAccessTokensToUser:(id)arg0 user:(id)arg1 ;
...
-(void)suspendedStateChangedForAccessory:(id)arg0 suspededState:(NSUInteger)arg1 ;
...
-(void)updateCHIPKeyValueStore:(id)arg0 completion:(id)arg1 ;
...
-(void)validateDuetEventIdentifiers:(id)arg0 completion:(id)arg1 ;
-(void)writeCharacteristicValues:(id)arg0 source:(NSUInteger)arg1 identifier:(id)arg2 withCompletionHandler:(id)arg3 ;
-(void)writeCharacteristicValues:(id)arg0 source:(NSUInteger)arg1 transactionId:(id)arg2 withCompletionHandler:(id)arg3 ;
