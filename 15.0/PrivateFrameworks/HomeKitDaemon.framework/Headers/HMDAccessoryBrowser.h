...
@class HMFObject, HMFUnfairLock, NSMutableSet, NSHashTable, NSMutableArray, NSArray, HAPAccessoryServerBrowserBTLE, CHIPAccessoryServerBrowser, NSString, HAPAccessoryServerBrowser, HAPAccessoryServerBrowserIP, HMFMessageDispatcher, NSUUID, HAPAccessoryServerBrowserRelay, HMFTimer, NSData;
...
@property (readonly, nonatomic) HAPAccessoryServerBrowserRelay *relayAccessoryServerBrowser; // ivar: _relayAccessoryServerBrowser
...
-(void)__addMediaAccessoryControlObserver:(id)arg0 ;
-(void)__handleProcessStateChange:(id)arg0 ;
-(void)__inactivate;
-(void)__removeBrowsingObserver:(id)arg0 error:(id)arg1 ;
-(void)__removeMediaAccessoryControlObserver:(id)arg0 ;
...
-(void)_cancelCurrentlyPairingAccessories:(NSInteger)arg0 ;
...
-(void)_removeMediaAccessoryControlObserverMatchingConnection:(id)arg0 ;
...
-(void)_tombstoneAccessoryServer:(id)arg0 ;
...
-(void)handleStartDiscoveringAssociatedMediaAccessories:(BOOL)arg0 forTransport:(id)arg1 completionHandler:(id)arg2 ;
...
-(void)probeReachabilityForBTLEAccessoryServersWithIdentifiers:(id)arg0 onQueue:(id)arg1 withCompletion:(id)arg2 ;
