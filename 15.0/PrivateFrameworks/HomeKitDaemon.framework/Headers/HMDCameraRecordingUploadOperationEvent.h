...
@class HMMLogEvent, NSUUID, NSString, NSDate;
...
@property (retain) NSDate *operationStartDate; // ivar: _operationStartDate
@property (readonly) NSUInteger operationStartTime;
@property int operationType; // ivar: _operationType
...
+(int)operationTypeFromOperation:(id)arg0 ;
