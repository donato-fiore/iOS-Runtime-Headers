...
@class HMFObject, NSMutableDictionary, NSString, HMFMessageDispatcher, NSUUID, NSNotificationCenter;
@protocol HMFLogging, HMFMessageReceiver, HMDHomeWalletDataSource, OS_dispatch_queue;
...
-(void)fetchWalletKeyColorOptionsWithCompletion:(id)arg0 ;
