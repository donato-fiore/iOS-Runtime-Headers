...
@class NSArray, NSMutableArray, NSString, NSPredicate, NSMutableSet, HMFTimer, NSMapTable;
...
@property (readonly, nonatomic) HomeKitEventTriggerExecutionSessionLogEvent *analyticsEvent; // ivar: _analyticsEvent
...
-(id)_createMonitoringEvents:(id)arg0 ;
