...
@property (readonly) NSObject<HMDDuetSuggestionProvider> *duetPredictionSuggester; // ivar: _duetPredictionSuggester
...
-(id)initWithWorkQueue:(id)arg0 messageDispatcher:(id)arg1 dataSource:(id)arg2 duetSuggestionProvider:(id)arg3 ;
