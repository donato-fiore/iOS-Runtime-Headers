...
#ifndef HMDHK2MIGRATORRECORD_H
#define HMDHK2MIGRATORRECORD_H
...
@property (retain, nonatomic) NSString *hk2MigratorRecordDataStorePath; // ivar: _hk2MigratorRecordDataStorePath
...
+(id)logCategory;
+(id)prepareDictionary:(BOOL)arg0 attempt:(unsigned int)arg1 skipKeyRoll:(BOOL)arg2 forceFailForTesting:(BOOL)arg3 ;
