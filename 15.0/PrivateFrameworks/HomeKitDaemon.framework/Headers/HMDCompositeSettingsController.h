...
-(id)initWithZoneManager:(id)arg0 model:(Class)arg1 homeUUID:(id)arg2 ownerUUID:(id)arg3 ;
-(id)initWithZoneManager:(id)arg0 model:(Class)arg1 homeUUID:(id)arg2 ownerUUID:(id)arg3 logEventDispatcher:(id)arg4 ;
