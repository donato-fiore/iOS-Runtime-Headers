...
@class HMFObject, HMFUnfairLock, NSSet, HMFNetService, NSArray, NSString, NSUUID, HMFProductInfo, NSData;
@protocol HMBModelObjectCoder, HMFObject, HMFLogging, HMDBackingStoreObjectProtocol, HMDBackingStoreModelBackedObjectProtocol, HMDRemoteAddressable, HMFMerging, NSSecureCoding, HMFCancellable;
