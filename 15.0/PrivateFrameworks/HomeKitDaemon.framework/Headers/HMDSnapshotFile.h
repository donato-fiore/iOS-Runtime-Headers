...
@class HMFObject, NSNumber, NSString, NSData, HMFOSTransaction, NSDate;
@protocol HMFLogging;
...
@property (retain, nonatomic) HMFOSTransaction *snapshotCATransaction; // ivar: _snapshotCATransaction
