...
@protocol HMDBulletinIdentifiers, NSSecureCoding, HMFDumpState, HMDBackingStoreObjectProtocol, HMDHomeMessageReceiver, HMFLocking, OS_dispatch_queue, HMDServiceOwner;
...
@property (nonatomic) BOOL noNameCharacteristic; // ivar: _noNameCharacteristic
...
-(void)_processTransactionForNameComponents:(id)arg0 messagesToSendToAcccessory:(id)arg1 result:(id)arg2 ;
...
-(void)configureMsgDispatcher:(id)arg0 ;
-(void)dealloc;
