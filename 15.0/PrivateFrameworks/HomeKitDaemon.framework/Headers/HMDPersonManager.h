...
@protocol HMBLocalZoneModelObserver, HMDDatabaseZoneManagerDataSource, HMDDatabaseZoneManagerDelegate, HMFLogging, HMFTimerDelegate, HMDPersonDataSource, HMDPersonManagerSettings, OS_dispatch_queue;
...
@property (readonly) NSSet *dataReceivers; // ivar: _dataReceivers
...
-(id)associateFaceCropsWithUUIDs:(id)arg0 toPersonWithUUID:(id)arg1 ;
...
-(id)initWithUUID:(id)arg0 zoneManager:(id)arg1 dataReceivers:(id)arg2 workQueue:(id)arg3 ;
