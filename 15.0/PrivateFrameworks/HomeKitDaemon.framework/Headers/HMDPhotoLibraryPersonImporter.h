...
@protocol HMDPhotoLibraryChangeDelegate, HMFTimerDelegate, HMFLogging, HMDPersonDataReceiver, HMDPersonDataSource, HMMLogEventSubmitting, OS_dispatch_queue;
...
+(id)logCategory;
-(id)_removedPersonUUIDsWithCurrentPersons:(id)arg0 previousPersons:(id)arg1 ;
-(id)_updateFaceCropsForAllPersons;
-(id)_updateFaceCropsForPersons:(id)arg0 ;
-(id)_updateFaceCropsForPersonsWithUpdatedPhotosFaceCrops;
-(id)_updateFaceCropsWithCurrentPhotoLibraryFaceCrops:(id)arg0 forPersonWithUUID:(id)arg1 ;
-(id)_updatePersons;
