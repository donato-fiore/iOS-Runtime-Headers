...
@protocol HMFLogging, NSSecureCoding, HMFLocking;
...
@property (readonly, nonatomic) HMDBackgroundTaskAgentTimer *btaAuditTimer; // ivar: _btaAuditTimer
...
-(void)_submitPresenceReportMetricWithPayload:(id)arg0 error:(id)arg1 ;
...
-(void)handleUserHomePresencePayload:(id)arg0 device:(id)arg1 remoteUserPairingIdentity:(id)arg2 completion:(id)arg3 ;
