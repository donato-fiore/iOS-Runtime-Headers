...
@protocol HMDAccessorySettingsLocalMessageHandlerDelegate, HMFLogging, HMDCompositeSettingsControllerDelegate, HMDCompositeSettingControllerManagerStateTransitionDelegate, HMDCompositeSettingControllerManagerStateManagerDataSource, HMDCompositeSettingsControllerManagerDataSource, OS_dispatch_queue, HMMLogEventSubmitting, HMDCompositeSettingControllerManagerStateManager;
