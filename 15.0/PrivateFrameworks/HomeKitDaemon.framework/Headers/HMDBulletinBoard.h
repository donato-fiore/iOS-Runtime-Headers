...
@class HMFObject, NSMutableDictionary, NSString, NSSet;
...
-(id)_insertRequestWithTitle:(id)arg0 snapshotData:(id)arg1 message:(id)arg2 requestIdentifier:(id)arg3 date:(id)arg4 bulletinType:(NSUInteger)arg5 actionURL:(id)arg6 bulletinContext:(id)arg7 actionContext:(id)arg8 interruptionLevel:(NSUInteger)arg9 ;
-(id)init;
-(id)initWithCoder:(id)arg0 ;
-(id)initWithNotificationCenter:(id)arg0 fileManager:(id)arg1 workQueue:(id)arg2 ;
...
-(void)_insertLockBulletinForChangedCharacteristic:(id)arg0 ;
...
-(void)insertHomeHubReachabilityBulletinForHome:(id)arg0 reachable:(BOOL)arg1 ;
