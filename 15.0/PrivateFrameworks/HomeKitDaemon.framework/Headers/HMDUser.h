...
@class HMFObject, NSMutableArray, NSString, NSUUID, AVOutputDeviceAuthorizedPeer, NSNumber, HMBShareUserID, NAFuture, HMFMessageDispatcher, NSSet, NSData, HAPPairingIdentity, HMPhotosPersonManagerSettings, HMUserPresenceAuthorization;
@protocol HMDCloudShareTrustManagerDataSource, HMDCloudShareTrustManagerDelegate, HMDUserDataControllerDelegate, HMDUserSettingsBackingStoreControllerDelegate, HMFLogging, HMFDumpState, HMDBackingStoreObjectProtocol, HMDHomeMessageReceiver, HMDSettingsControllerDelegate, HMDRemoteEventRouterUserAccessControlProvider, NSSecureCoding, HMFLocking, OS_dispatch_queue, HMDUserDataSource;
...
@property (copy) NSString *relayIdentifier; // ivar: _relayIdentifier
...
+(id)userWithDictionary:(id)arg0 forHome:(id)arg1 ;
-(BOOL)cloudShareTrustManager:(id)arg0 shouldShareTrustWithUser:(id)arg1 ;
-(BOOL)containsRelayAccessToken:(id)arg0 ;
...
-(NSInteger)sharedSettingsControllerRunState;
...
-(id)_relayAccessTokenForIdentifier:(id)arg0 ;
-(id)account;
-(id)accountHandle;
...
-(id)relayAccessTokenForAccessory:(id)arg0 ;
...
-(void)_addRelayAccessToken:(id)arg0 ;
...
-(void)_migrateRelayAccessTokensCloudZone:(id)arg0 migrationQueue:(id)arg1 completion:(id)arg2 ;
-(void)_recoverTrustManagerDueToUUIDChange;
-(void)_recoverUserSettingsDueToUUIDChange;
-(void)_removeRelayAccessToken:(id)arg0 ;
...
-(void)addRelayAccessToken:(id)arg0 ;
...
-(void)removeRelayAccessToken:(id)arg0 ;
...
-(void)updateRelayIdentifier:(id)arg0 ;
