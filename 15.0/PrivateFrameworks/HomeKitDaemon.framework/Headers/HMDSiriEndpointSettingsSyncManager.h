...
@property (readonly) NSObject<HMESubscriptionProviding> *subcriptionProvider; // ivar: _subcriptionProvider
...
-(id)initWithDataSource:(id)arg0 subcriptionProvider:(id)arg1 notificationCenter:(id)arg2 workQueue:(id)arg3 ;
