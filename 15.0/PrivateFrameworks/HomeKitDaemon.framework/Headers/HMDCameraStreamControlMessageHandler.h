...
@property (readonly) HMDDeviceCapabilities *deviceCapabilities; // ivar: _deviceCapabilities
...
-(id)initWithWorkQueue:(id)arg0 streamSnapshotHandler:(id)arg1 accessory:(id)arg2 streamManagementService:(id)arg3 profileUniqueIdentifier:(id)arg4 networkMonitor:(id)arg5 residentMessageHandler:(id)arg6 phoneCallObserver:(id)arg7 deviceCapabilities:(id)arg8 dataSource:(id)arg9 ;
-(id)logIdentifier;
...
-(void)streamControlManager:(id)arg0 didReceiveFirstFrameWithAudioStreamSetting:(NSUInteger)arg1 aspectRatio:(id)arg2 slotIdentifier:(id)arg3 ;
-(void)streamControlManager:(id)arg0 didStartStreamWithSlotIdentifier:(id)arg1 ;
