...
+(id)eventWithTipID:(id)arg0 correlationID:(id)arg1 bundleID:(id)arg2 context:(id)arg3 displayType:(id)arg4 ;
-(id)_initWithTipID:(id)arg0 correlationID:(id)arg1 ;
-(id)_initWithTipID:(id)arg0 correlationID:(id)arg1 bundleID:(id)arg2 context:(id)arg3 displayType:(id)arg4 ;
-(id)eventName;
