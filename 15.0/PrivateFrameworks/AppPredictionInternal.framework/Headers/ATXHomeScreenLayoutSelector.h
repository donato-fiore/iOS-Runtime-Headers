...
@class NSArray, ATXEngagementRecordManager, ATXWidgetSuggestionDismissManager, ATXInformationStore, NSUserDefaults, CHSProactiveService, ATXHomeScreenCachedSuggestions, NSUUID, NSMutableDictionary, NSSet, NSMutableArray, NSString;
