...
+(id)_predictionsForConsumerSubType:(unsigned char)arg0 thirdStageScoreLogger:(id)arg1 multiStageScoreLogger:(id)arg2 actionPredictionCandidates:(id)arg3 remainingPredictionItems:(*void)arg4 ;
+(id)_predictionsForConsumerSubType:(unsigned char)arg0 thirdStageScoreLogger:(id)arg1 multiStageScoreLogger:(id)arg2 context:(id)arg3 actionPredictionCandidates:(id)arg4 remainingPredictionItems:(*void)arg5 ;
