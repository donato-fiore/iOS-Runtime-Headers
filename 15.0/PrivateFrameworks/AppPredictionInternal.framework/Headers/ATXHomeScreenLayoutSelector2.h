...
@class NSArray, ATXEngagementRecordManager, ATXWidgetSuggestionDismissManager, ATXInformationStore, NSUserDefaults, CHSProactiveService, NSSet, NSString, NSDictionary;
...
-(id)_loadHomeScreenState:(id)arg0 isiPad:(BOOL)arg1 ;
-(id)_pagesByAppendingTodayPageContentsToFirstHomeScreenPage:(id)arg0 ;
