...
@class NSString;
@protocol ATXFeedbackSessionListenerDelegateProtocol, ATXProactiveSuggestionFeedbackListenerProtocol, ATXPETEventTracker2Protocol;
...
-(void)receiveClientModelResult:(id)arg0 ;
