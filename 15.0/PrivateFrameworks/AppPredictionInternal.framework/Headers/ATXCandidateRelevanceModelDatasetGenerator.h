...
-(id)initWithConfig:(id)arg0 contextPublisher:(id)arg1 modePublisher:(id)arg2 poiCategoryPublisher:(id)arg3 bluetoothPublisher:(id)arg4 userFocusComputedModePublisher:(id)arg5 ;
