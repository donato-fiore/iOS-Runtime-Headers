...
@class NSArray, NSDictionary, ATXClient, ATXGenericFileBasedCache, NSSet, NSMutableDictionary, NSString, SBSHomeScreenService, NSDate, NSUserDefaults, ATXTimer;
...
@property (nonatomic) BOOL usingScreenTime; // ivar: _usingScreenTime
...
-(id)description;
-(id)initWithAppInfoManager:(id)arg0 cache:(id)arg1 blacklist:(id)arg2 recentsCache:(id)arg3 appClipDataProvider:(id)arg4 appIconState:(id)arg5 appClipChangeListener:(id)arg6 histogramManager:(id)arg7 usingScreenTime:(BOOL)arg8 ;
