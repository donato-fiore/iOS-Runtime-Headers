...
-(id)fetchSerializedMissedNotificationRankingFromFileData:(id)arg0 modeString:(id)arg1 rankerString:(id)arg2 outError:(*id)arg3 ;
-(id)fetchSerializedMissedNotificationRankingFromSource:(id)arg0 modeString:(id)arg1 startDate:(id)arg2 endDate:(id)arg3 shouldInferMessages:(BOOL)arg4 rankerString:(id)arg5 outError:(*id)arg6 ;
-(id)fetchSerializedNotificationDigestFromFileData:(id)arg0 digestTimeString:(id)arg1 rankerString:(id)arg2 outError:(*id)arg3 ;
-(id)fetchSerializedNotificationDigestFromSource:(id)arg0 digestTimeString:(id)arg1 startDate:(id)arg2 endDate:(id)arg3 shouldInferMessages:(BOOL)arg4 rankerString:(id)arg5 outError:(*id)arg6 ;
