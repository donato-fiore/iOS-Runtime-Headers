...
@class NSMutableIndexSet, BSMutableIntegerMap, RBSProcessMonitor, CMPocketStateManager, BSTimer, BKSHIDEventDeliveryManager, SBCameraHardwareButtonDefaults, NSString;
