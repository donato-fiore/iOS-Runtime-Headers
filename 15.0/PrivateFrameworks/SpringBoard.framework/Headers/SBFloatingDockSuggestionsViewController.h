...
@class UIViewController, NSString, NSMutableArray, SBFloatingDockViewController, SBDockIconListView, NSSet, SBRecentDisplayItemsDefaults, SBIconListModel;
...
@property (readonly, nonatomic) NSObject<SBIconViewProviding> *iconViewProvider; // ivar: _iconViewProvider
...
@property (readonly, nonatomic) SBFloatingDockSuggestionsModel *suggestionsModel; // ivar: _suggestionsModel
