...
@property (nonatomic) NSInteger startedSourceAnimations; // ivar: _startedSourceAnimations
...
-(id)init;
-(id)initWithTargetProcessIdentifier:(int)arg0 uuid:(id)arg1 scenePersistenceIdentifier:(id)arg2 direction:(NSInteger)arg3 gestureInitiated:(BOOL)arg4 delegate:(id)arg5 ;
