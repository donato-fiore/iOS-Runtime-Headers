...
@property (readonly, nonatomic) NSObject<CSWallpaperViewProviding> *wallpaperViewProvider; // ivar: _wallpaperViewProvider
...
-(id)applicationHosterForBundleIdentifier:(id)arg0 ;
