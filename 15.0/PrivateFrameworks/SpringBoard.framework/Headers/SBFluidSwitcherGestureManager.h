...
@class SBAppSwitcherDefaults, NSHashTable, NSString, NSTimer, UINotificationFeedbackGenerator, UIView, SBFHomeGrabberSettings, BSMonotonicReferenceTime, UIHoverGestureRecognizer, SBFZStackParticipant;
@protocol SBSystemGestureRecognizerDelegate, SBTouchTemplateGestureRecognizerDelegate, BSTransactionObserver, BSDescriptionProviding, PTSettingsKeyObserver, SBGrabberTongueDelegate, SBHomeGrabberDelegate, SBHomeGestureParticipantDelegate, SBFZStackParticipantDelegate, SBHomeGrabberPointerClickDelegate, SBPanSystemGestureRecognizerDelegate, SBLayoutStateTransitionObserver, SBFluidSwitcherGestureWorkspaceTransactionDelegate, SBFluidSwitcherDragAndDropManagerDelegate, SBFluidSwitcherGestureManagerDelegate;
...
@property (retain, nonatomic) BSMonotonicReferenceTime *lastClickAndDragHomeGestureTimestamp; // ivar: _lastClickAndDragHomeGestureTimestamp
...
@property (weak, nonatomic) SBMainDisplaySceneLayoutViewController *sceneLayoutViewController; // ivar: _sceneLayoutViewController
...
@property (retain, nonatomic) UIHoverGestureRecognizer *switcherHoverGestureRecognizer; // ivar: _switcherHoverGestureRecognizer
...
-(id)initWithSwitcherContentController:(id)arg0 sceneLayoutViewController:(id)arg1 delegate:(id)arg2 ;
