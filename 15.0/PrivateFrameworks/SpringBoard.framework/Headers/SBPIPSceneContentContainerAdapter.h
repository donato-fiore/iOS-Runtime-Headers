...
@class SBPIPContainerViewController<SBPIPContainerViewControllerAdapterContextProviding>, UIApplicationSceneDeactivationAssertion, _UIRemoteKeyboards, NSString, UIViewController<SBPIPSceneContentProviding>;
...
-(id)initWithSceneContentViewController:(id)arg0 contentViewLayoutSettings:(id)arg1 stashSettings:(id)arg2 shadowSettings:(id)arg3 interactionSettings:(id)arg4 remoteKeyboards:(id)arg5 keyboardFocusController:(id)arg6 keyboardSuppressionManager:(id)arg7 keyboardDismissalManager:(id)arg8 deactivationManager:(id)arg9 transitionCoordinator:(id)arg10 delegate:(id)arg11 ;
