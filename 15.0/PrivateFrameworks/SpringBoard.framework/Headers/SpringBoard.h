...
@class UISystemShellApplication, NSHashTable, NSMutableArray, NSSet, NSNumberFormatter, NSTimer, NSDate, NSCountedSet, SBSStatusBarStyleOverridesAssertion, NSString, SSScreenCapturer, SBScreenTimeTrackingController, DNDAWDMetricsService, DNDNotificationsService, NSMutableSet, NSMutableDictionary, DNDToggleManager, STMediaStatusDomain, NSArray, SBFUserAuthenticationController, STDynamicActivityAttributionManager, FCUIBannerManager, RSPeerToPeerServerController, STStatusServer, STTelephonyStateProvider, UIWindow;
@protocol MCProfileConnectionObserver, RSPeerToPeerConnectionControllerDataSource, SBRestartManagerDelegate, SBModalAlertPresentationCoordinatorDelegate, UIStatusBarStyleDelegate_SpringBoardOnly, SSScreenCapturerDelegate, SBBacklightControllerObserver, SBInteractiveScreenshotGestureManagerDelegate, SBRemoteTransientOverlaySessionManagerDelegate, SBSpotlightTransientOverlayViewControllerDelegate, _UIApplicationInitializationContextFactory, SBAVSystemControllerCacheObserver, UIApplicationDelegate, SBIdleTimerProviding, OS_dispatch_source, SBProximityBacklightPolicy, BSInvalidatable, OS_os_transaction, SBIdleTimer, SBFLockOutStatusProvider, SBUIUserAgent;
...
#import "SBUnlockedDodgingResolver.h"
...
@property (readonly, nonatomic) FCUIBannerManager *focusBannerManager; // ivar: _focusBannerManager
...
-(void)_handleHomeScreenNavigateLeft:(id)arg0 ;
-(void)_handleHomeScreenNavigateOut:(id)arg0 ;
-(void)_handleHomeScreenNavigateRight:(id)arg0 ;
