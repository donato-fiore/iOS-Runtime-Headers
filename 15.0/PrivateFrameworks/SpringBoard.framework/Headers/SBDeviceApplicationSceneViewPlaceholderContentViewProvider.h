...
-(id)_contentViewFromSceneHandle:(id)arg0 displayConfiguration:(id)arg1 orientation:(NSInteger)arg2 snapshot:(id)arg3 size:(struct CGSize )arg4 statusBarDescriptor:(id)arg5 hasOrientationMismatchForClassicApp:(BOOL)arg6 ;
