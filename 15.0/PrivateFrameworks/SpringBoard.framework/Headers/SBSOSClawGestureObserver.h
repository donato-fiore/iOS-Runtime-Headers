...
@class SOSManager, NSMutableSet, NSString, SBSOSDefaults, BSTimer;
...
@property (retain, nonatomic) SBClawGestureLogger *clawGestureLogger; // ivar: _clawGestureLogger
...
@property (retain, nonatomic) BSTimer *sosTriggerTimer; // ivar: _sosTriggerTimer
