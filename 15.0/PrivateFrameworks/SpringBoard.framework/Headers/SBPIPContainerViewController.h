...
@class UIViewController, NSHashTable, UIView, SBFFluidBehaviorSettings, BSTimer, NSMutableArray, UIViewFloatAnimatableProperty, FBDisplayLayoutElement, NSString;
@protocol SBPIPInteractionControllerDelegate, SBPIPContainerViewControllerAdapterContextProviding, BSInvalidatable, SBPIPContainerViewControllerAdapter;
...
@interface SBPIPContainerViewController : UIViewController <SBPIPInteractionControllerDelegate, SBPIPContainerViewControllerAdapterContextProviding, BSInvalidatable>

 {
    ...
    CGFloat _displayLayoutElementLevel;
...
@property (nonatomic) NSInteger appliedInterfaceOrientation; // ivar: _appliedInterfaceOrientation
...
@property (nonatomic) CGFloat displayLayoutElementLevel;
...
@property (readonly, nonatomic) NSInteger windowPreferredInterfaceOrientation;
...
-(void)_updateContentViewFrame:(struct CGRect )arg0 reason:(id)arg1 ;
...
-(void)interactionControllerDidEndAllInteractions:(id)arg0 ;
