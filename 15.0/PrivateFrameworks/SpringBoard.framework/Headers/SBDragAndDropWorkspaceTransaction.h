...
+(BOOL)_shouldTrackLocationOfDropSession:(id)arg0 inSwitcherContentController:(id)arg1 sceneManager:(id)arg2 isCurrentlyTracking:(BOOL)arg3 ;
+(BOOL)isDragOverFullscreenRegionAtLocation:(struct CGPoint )arg0 inBounds:(struct CGRect )arg1 ;
+(BOOL)shouldTrackLocationOfDropSession:(id)arg0 inSwitcherContentController:(id)arg1 sceneManager:(id)arg2 ;
...
+(struct CGRect )sourceSceneInterfaceOrientedBoundsForDropSession:(id)arg0 sceneManager:(id)arg1 ;
...
-(BOOL)_shouldPushInSceneLayoutViewControllerForDropAction:(NSInteger)arg0 ;
-(BOOL)_showResizeUI;
...
-(id)initWithTransitionRequest:(id)arg0 switcherContentController:(id)arg1 sceneManager:(id)arg2 dropSession:(id)arg3 delegate:(id)arg4 ;
...
-(void)_getPrimaryLayoutElementViewFrame:(struct CGRect *)arg0 sideLayoutElementViewFrame:(struct CGRect *)arg1 forDropAction:(NSInteger)arg2 proposedDropLayoutState:(id)arg3 state:(NSUInteger)arg4 ;
-(void)_getPrimaryLayoutElementViewFrame:(struct CGRect *)arg0 sideLayoutElementViewFrame:(struct CGRect *)arg1 forDropAction:(NSInteger)arg2 proposedDropLayoutState:(id)arg3 state:(NSUInteger)arg4 spaceConfiguration:(NSInteger)arg5 ;
