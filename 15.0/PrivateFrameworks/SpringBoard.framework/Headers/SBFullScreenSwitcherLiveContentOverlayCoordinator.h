...
@property (retain, nonatomic) NSString *keyboardFocusBundleID; // ivar: _keyboardFocusBundleID
...
@property (retain, nonatomic) SBMainDisplaySceneManager *sceneManager; // ivar: _sceneManager
