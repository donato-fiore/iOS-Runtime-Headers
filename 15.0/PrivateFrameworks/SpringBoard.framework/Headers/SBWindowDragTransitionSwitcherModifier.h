...
#ifndef SBWINDOWDRAGTRANSITIONSWITCHERMODIFIER_H
#define SBWINDOWDRAGTRANSITIONSWITCHERMODIFIER_H
...
-(id)initWithTransitionID:(id)arg0 selectedAppLayout:(id)arg1 fromAppLayout:(id)arg2 toAppLayout:(id)arg3 toFloatingAppLayout:(id)arg4 toHomeScreenPeek:(BOOL)arg5 toAppExposeBundleIdentifier:(id)arg6 initiallyBlurredDisplayItems:(id)arg7 ;
-(id)transitionDidEnd;
