...
@class BNBannerHostMonitorListener, NSHashTable, CRCarPlayAppPolicyEvaluator, NSMutableDictionary, NSMutableArray, NCNotificationRequest, AFUserNotificationAnnouncementSpeakingStateObserver, BSTimer, NCCarPlayBannerSource, NSString, BSServiceConnectionEndpoint;
...
@property (retain, nonatomic, getter=_announceTimeoutTimer, setter=_setAnnounceTimeoutTimer:) BSTimer *announceTimeoutTimer; // ivar: _announceTimeoutTimer
