...
@class SBFAnalyticsClient, NSOrderedSet, NSMutableOrderedSet, NSString, SBFloatingDockDefaults, NSMutableSet, SBRecentDisplayItemsDefaults, PTSingleTestRecipe, SBIconListModel;
...
@property (readonly, nonatomic) SBRecentDisplayItemsController *recentsController; // ivar: _recentsController
@property (readonly, nonatomic) SBRecentDisplayItemsDataStore *recentsDataStore; // ivar: _recentsDataStore
...
-(id)_oldestRecent;
-(id)init;
-(id)initWithMaximumNumberOfSuggestions:(NSUInteger)arg0 iconController:(id)arg1 recentsController:(id)arg2 recentsDataStore:(id)arg3 recentsDefaults:(id)arg4 floatingDockDefaults:(id)arg5 appSuggestionManager:(id)arg6 analyticsClient:(id)arg7 applicationController:(id)arg8 ;
