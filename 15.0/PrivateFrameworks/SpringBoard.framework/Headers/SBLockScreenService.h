...
@class FBServiceClientAuthenticator, BSServiceConnectionListener, NSMutableSet, SBFAuthenticationAssertion, NSString, SBFUserAuthenticationController;
@protocol BSServiceConnectionListenerDelegate, SBSLockScreenServiceServerInterface, SBPasscodeEntryTransientOverlayViewControllerDelegate, SBFAuthenticationAssertionProviding, SBFLockOutStatusProvider;
