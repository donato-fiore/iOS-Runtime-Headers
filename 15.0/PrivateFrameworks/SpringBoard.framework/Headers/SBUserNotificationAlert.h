...
@class SBAlertItem, NSString, NSTimer, NSArray, SBUISound, BKSProcessAssertion, UIAlertControllerVisualStyle, UIViewController, NSURL, NSDictionary;
...
@property (retain) UIViewController *contentViewControllerForAlertController; // ivar: _contentViewControllerForAlertController
...
-(id)_attachmentImage;
-(id)_headerImage;
-(id)_imageDescriptorForPath:(id)arg0 catalogPath:(id)arg1 catalogImageKey:(id)arg2 ;
