...
+(id)zoomViewForDeviceApplicationSceneHandle:(id)arg0 displayConfiguration:(id)arg1 interfaceOrientation:(NSInteger)arg2 snapshot:(id)arg3 snapshotSize:(struct CGSize )arg4 statusBarDescriptor:(id)arg5 decodeImage:(BOOL)arg6 hasOrientationMismatchForClassicApp:(BOOL)arg7 ;
...
-(void)setLockScreenScale:(CGFloat)arg0 behaviorMode:(NSInteger)arg1 completion:(id)arg2 ;
