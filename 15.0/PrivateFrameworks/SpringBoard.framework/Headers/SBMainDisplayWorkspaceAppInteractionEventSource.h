...
#ifndef SBMAINDISPLAYWORKSPACEAPPINTERACTIONEVENTSOURCE_H
#define SBMAINDISPLAYWORKSPACEAPPINTERACTIONEVENTSOURCE_H

@class NSHashTable, SBFAnalyticsClient, NSString, FBMainDisplayLayoutPublisher, BKSTouchDeliveryObservationService;
@protocol BKSTouchDeliveryObserving, FBSDisplayLayoutPublisherObserving, SBApplicationRestrictionObserver, SBLayoutStateTransitionObserver;
...
@property (weak, nonatomic) FBMainDisplayLayoutPublisher *mainDisplayLayoutPublisher; // ivar: _mainDisplayLayoutPublisher
...
-(id)_initWithAnalyticsClient:(id)arg0 applicationController:(id)arg1 applicationRestrictionController:(id)arg2 iconModel:(id)arg3 layoutStateTransitionCoordinator:(id)arg4 mainDisplayLayoutPublisher:(id)arg5 touchDeliveryObservationService:(id)arg6 ;
-(id)init;
