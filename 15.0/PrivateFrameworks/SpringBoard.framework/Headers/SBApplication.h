...
+(id)snapshotSortDescriptorsForNames:(id)arg0 scheme:(id)arg1 imageScale:(CGFloat)arg2 userInterfaceStyle:(NSInteger)arg3 statusBarStateMask:(NSUInteger)arg4 interfaceOrientationMask:(NSUInteger)arg5 requiredOSVersion:(id)arg6 ;
...
-(id)_redactedDisplayConfigurationIfNecessaryForDisplayConfiguration:(id)arg0 ;
-(id)_sceneIdentifierForStoredPersistenceIdentifier:(id)arg0 ;
-(id)_snapshotManifest;
-(id)_snapshotsWithImageName:(id)arg0 sceneHandle:(id)arg1 launchingSize:(struct CGSize )arg2 launchingScale:(CGFloat)arg3 contentTypeMask:(NSUInteger)arg4 statusBarStateMask:(NSUInteger)arg5 launchingOrientation:(NSInteger)arg6 contentOverridesContext:(id)arg7 userInterfaceStyle:(NSInteger)arg8 displayEdgeInfo:(id)arg9 ;
-(id)badgeNumberOrStringForIcon:(id)arg0 ;
-(id)bestSnapshotWithImageName:(id)arg0 sceneHandle:(id)arg1 variantID:(id)arg2 scale:(CGFloat)arg3 size:(struct CGSize )arg4 contentTypeMask:(NSUInteger)arg5 statusBarStateMask:(NSUInteger)arg6 launchingOrientation:(NSInteger)arg7 contentOverridesContext:(id)arg8 userInterfaceStyle:(NSInteger)arg9 displayEdgeInfo:(id)arg10 ;
