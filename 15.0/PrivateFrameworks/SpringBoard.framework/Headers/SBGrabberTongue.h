...
@class UIPanGestureRecognizer, UITapGestureRecognizer, UIView, _UIBackdropView, UIImageView, BSMonotonicReferenceTime, NSString;
...
-(id)init;
-(id)initWithDelegate:(id)arg0 edge:(NSUInteger)arg1 type:(NSUInteger)arg2 ;
...
-(void)_updateCancelsTouchesWithRecognizer:(id)arg0 ;
-(void)_willDismiss;
-(void)_willPresent;
