...
-(id)initWithTransitionID:(id)arg0 appLayout:(id)arg1 nonGestureInitiatedZoomModifier:(id)arg2 effectiveStartingEnvironmentMode:(NSInteger)arg3 liftOffVelocity:(struct CGPoint )arg4 ;
