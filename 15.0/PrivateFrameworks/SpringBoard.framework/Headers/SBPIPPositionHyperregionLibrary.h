...
-(id)_offscreenCornerRegionWithGeometry:(struct SBPIPPositionGeometryContext )arg0 ;
...
-(struct CGRect )_insetRectForEdgeInsets:(struct UIEdgeInsets )arg0 pipSize:(struct CGSize )arg1 containerSize:(struct CGSize )arg2 ;
