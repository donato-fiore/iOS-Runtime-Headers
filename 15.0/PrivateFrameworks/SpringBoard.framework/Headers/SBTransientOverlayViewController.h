...
@class UIViewController, UIView, SBFHomeGrabberSettings, UIWindow, UIStatusBar, UIStatusBarStyleRequest, NSString, FBDisplayLayoutElement, NSNumber, _UILegibilitySettings, UIColor;
@protocol SBHomeGrabberDelegate, BSDescriptionProviding, SBButtonEventsHandler, SBFIdleTimerBehaviorProviding, SBIdleTimerProviding, SBIdleTimerCoordinating, SBTransientOverlayViewControllerDelegate;
...
@property (readonly, nonatomic) NSUInteger preferredStatusBarStyleOverridesToCancel; // ivar: _preferredStatusBarStyleOverridesToCancel
