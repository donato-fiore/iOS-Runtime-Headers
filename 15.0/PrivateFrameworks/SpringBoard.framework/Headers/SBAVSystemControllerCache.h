...
// -(void)_queue_updateVolumeLimitEnforcedFromNotification:(id)arg0 allowingBackgroundQueries:(BOOL)arg1 backgroundQueriesCancelledBlock:(id)arg2 cancelBackgroundQueriesBlock:(unk)arg3 completion:(id)arg4  ;
// -(void)_queue_updateVolumeLimitFromNotification:(id)arg0 allowingBackgroundQueries:(BOOL)arg1 backgroundQueriesCancelledBlock:(id)arg2 cancelBackgroundQueriesBlock:(unk)arg3 completion:(id)arg4  ;
