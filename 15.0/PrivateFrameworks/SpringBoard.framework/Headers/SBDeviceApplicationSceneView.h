...
@class SBSceneHandleBlockObserver, UIApplicationSceneClientSettingsDiffInspector, UIApplicationSceneSettingsDiffInspector, _UIDirectionalRotationView, SBFHomeGrabberSettings, NSMutableDictionary, UIView, UIView<UIScenePresentation>, NSMutableArray, UIView<SBApplicationSceneBackgroundView>, NSString;
@protocol SBDeviceApplicationSceneClassicAccessoryViewDelegate, PTSettingsKeyObserver, SBAppSwitcherPageContentView, UISceneLayerTarget;
...
@interface SBDeviceApplicationSceneView : SBApplicationSceneView <SBDeviceApplicationSceneClassicAccessoryViewDelegate, PTSettingsKeyObserver, SBAppSwitcherPageContentView>

 {
    ...
    NSInteger _startingOrientationforClassicPhoneAppRotation;
...
@property (nonatomic) BOOL counterRotationViewTransformUpdatesPaused; // ivar: _counterRotationViewTransformUpdatesPaused
