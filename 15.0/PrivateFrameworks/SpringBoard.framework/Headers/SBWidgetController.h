...
@protocol WGWidgetDiscoveryControllerDelegate, SBExtensionHandling, SBHSidebarWidgetLearningObserver, CSWidgetGroupViewControllerProviding;
...
@property (readonly, nonatomic) SBHSidebarWidgetBootstrappingAdvisor *sidebarWidgetBootstrappingAdvisor; // ivar: _sidebarWidgetBootstrappingAdvisor
...
-(void)_homescreenSidebarVisibilityDidChange:(id)arg0 ;
...
-(void)sidebarWidgetLearningAdvisorDidUpdate:(id)arg0 ;
