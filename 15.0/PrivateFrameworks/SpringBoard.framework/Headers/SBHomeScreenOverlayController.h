...
@class NSHashTable, NSCountedSet, SBFFrameRateAssertion, UIViewController, NSString, UIPanGestureRecognizer, UITapGestureRecognizer, FBDisplayLayoutElement, UIViewController<SBHOccludable>, UIViewController<SBHWidgetSheetViewControllerPresenter>;
@protocol SBBarSwipeAffordanceDelegate, SBBarSwipeAffordanceObserver, SBHomeScreenOverlayViewControllerDelegate, UIGestureRecognizerDelegate, SBFOverlayControlling, SBFIdleTimerBehaviorProviding, CSExternalBehaviorProviding, CSExternalEventHandling, BSDescriptionProviding, SBFOverlayDismissalDelegate, SBHomeScreenOverlayControllerDelegate, SBIconListLayoutProvider;
...
@property (readonly, nonatomic) SBMainScreenActiveInterfaceOrientationWindow *window; // ivar: _window


-(BOOL)_effectivelyFinishedAnimationToPresentationProgress:(CGFloat)arg0 finished:(BOOL)arg1 retargeted:(BOOL)arg2 ;
...
-(id)initWithListLayoutProvider:(id)arg0 windowLevel:(CGFloat)arg1 homeGestureParticipantIdentifier:(NSInteger)arg2 zStackParticipantIdentifier:(NSInteger)arg3 screenEdgeSystemGestureType:(NSUInteger)arg4 indirectScreenEdgeSystemGestureType:(NSUInteger)arg5 scrunchSystemGestureType:(NSUInteger)arg6 secure:(BOOL)arg7 ;
