...
@class UIGestureRecognizer, UIEvent, UITouch, NSString, NSValue, BSMonotonicReferenceTime, NSTimer;
...
@property (retain, nonatomic) BSMonotonicReferenceTime *lastKnownMouseEventTimestamp; // ivar: _lastKnownMouseEventTimestamp
@property (nonatomic) CGPoint lastKnownPoint; // ivar: _lastKnownPoint
@property (retain, nonatomic) BSMonotonicReferenceTime *lastMouseActivationTimestamp; // ivar: _lastMouseActivationTimestamp
@property (retain, nonatomic) BSMonotonicReferenceTime *mouseEnteredNearEdgeRegionTimestamp; // ivar: _mouseEnteredNearEdgeRegionTimestamp
