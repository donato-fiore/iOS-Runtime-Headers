...
-(void)coverSheetSlidingViewController:(id)arg0 animationTickedWithProgress:(CGFloat)arg1 coverSheetFrame:(struct CGRect )arg2 gestureActive:(BOOL)arg3 forPresentationValue:(BOOL)arg4 ;
