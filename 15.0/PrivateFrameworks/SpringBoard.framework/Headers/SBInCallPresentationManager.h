...
@protocol SBInCallPresentationSessionDelegate, SBInCallPresentationRequestServerDelegate, FBSceneManagerObserver, SBMainDisplaySceneManagerObserver, SBApplicationHosting, SBInCallPresentationManagerDelegate;
...
@property (readonly, nonatomic) SBMainDisplaySceneManager *sceneManager; // ivar: _sceneManager
...
-(id)initWithSceneManager:(id)arg0 applicationController:(id)arg1 bannerManager:(id)arg2 ;
...
-(void)handleOpenApplicationRequest:(id)arg0 clientWorkspace:(id)arg1 actions:(id)arg2 origin:(id)arg3 withResult:(id)arg4 ;
