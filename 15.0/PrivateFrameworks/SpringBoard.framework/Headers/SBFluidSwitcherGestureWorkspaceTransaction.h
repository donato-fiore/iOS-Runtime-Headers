...
@class NSTimer, UIApplicationSceneDeactivationAssertion, NSString, NSUUID;
@protocol SBUIAnimationControllerObserver, SBSceneLayoutWorkspaceTransactionDelegate, SBWorkspaceApplicationSceneTransitionContextDelegate, SBViewMorphAnimatorObserver, BSInvalidatable, SBFluidSwitcherGestureWorkspaceTransactionDelegate;
