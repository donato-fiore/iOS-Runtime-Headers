...
@property (retain, nonatomic) SBFFluidBehaviorSettings *topAffordanceFastHideCenterWindowButtonAnimationSettings; // ivar: _topAffordanceFastHideCenterWindowButtonAnimationSettings
@property (retain, nonatomic) SBFFluidBehaviorSettings *topAffordanceFastHideSplitViewButtonAnimationSettings; // ivar: _topAffordanceFastHideSplitViewButtonAnimationSettings
