...
@class _UIRemoteKeyboards, BKSTouchDeliveryObservationService, BSCompoundAssertion, UIGestureRecognizer, BSAbsoluteMachTimer, NSString;
...
-(id)initWithTouchDeliveryService:(id)arg0 systemGestureManager:(id)arg1 remoteKeyboards:(id)arg2 focusController:(id)arg3 ;
