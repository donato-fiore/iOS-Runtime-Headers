...
-(id)initWithPinned:(BOOL)arg0 gesturePossible:(BOOL)arg1 atLevel:(NSUInteger)arg2 reason:(id)arg3 withCompletion:(id)arg4 ;
-(id)initWithVisibleProgress:(CGFloat)arg0 gesturePossible:(BOOL)arg1 atLevel:(NSUInteger)arg2 reason:(id)arg3 withCompletion:(id)arg4 ;
