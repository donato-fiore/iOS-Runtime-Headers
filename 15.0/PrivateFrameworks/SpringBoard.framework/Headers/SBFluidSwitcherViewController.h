...
-(BOOL)isDevicePad;
-(BOOL)isEdgeProtectedForHomeGestureAtEdgeLocation:(CGFloat)arg0 ;
...
-(NSInteger)switcherPreferredInterfaceOrientation;
...
-(id)_animatablePropertyWithNotifications:(id)arg0 ;
...
-(id)_rotationAnimationSettingsForTransitionContext:(id)arg0 ;
...
-(id)_transitionEventForTransitionToLayoutState:(id)arg0 identifier:(id)arg1 phase:(NSUInteger)arg2 animated:(BOOL)arg3 ;
...
-(struct CGRect )defaultFrameForLayoutRole:(NSInteger)arg0 inAppLayout:(id)arg1 interfaceOrientation:(NSInteger)arg2 ;
...
-(void)_blurItemContainerWithAnimation:(id)arg0 ;
...
-(void)_effectiveStartOrientation:(*NSInteger)arg0 andEndOrientation:(*NSInteger)arg1 forTransitionContext:(id)arg2 ;
...
-(void)_navigateFromFocusedAppWindowSceneToNextScene:(BOOL)arg0 matchFocusedApp:(BOOL)arg1 ;
...
-(void)_setupMorphAnimatorIfNeededForEntity:(id)arg0 pipCoordinator:(id)arg1 appLayout:(id)arg2 uniqueID:(id)arg3 direction:(NSInteger)arg4 gestureInitiated:(BOOL)arg5 ;
-(void)_setupMorphToPIPIfNeededForTransitionContext:(id)arg0 ;
...
-(void)_unblurItemContainer:(id)arg0 ;
...
-(void)_updateShadowPathForAppLayout:(id)arg0 ;
...
-(void)containerSelectionStateChanged:(id)arg0 toState:(NSInteger)arg1 ;
...
-(void)dealloc;
-(void)didSelectContainer:(id)arg0 ;
...
-(void)handleGestureDidEnd:(id)arg0 ;
-(void)handleGestureDidUpdate:(id)arg0 ;
