...
@class SBStatusBarDefaults, NSHashTable, NSTimer, NSDateFormatter, NSString, NSMutableArray, CBCentralManager, SBSStatusBarStyleOverridesAssertion, NSMutableDictionary, STBatteryStatusDomain, STCallingStatusDomain, STFocusStatusDomain, STLocationStatusDomain, STTelephonyStatusDomainDataProvider, STTelephonyStatusDomain, STVoiceControlStatusDomain, STWifiStatusDomain;
@protocol SBDateTimeOverrideObserver, SBAVSystemControllerCacheObserver, CBCentralManagerPrivateDelegate;
...
@property (retain, nonatomic, getter=_batteryDomain, setter=_setBatteryDomain:) STBatteryStatusDomain *batteryDomain; // ivar: _batteryDomain
@property (retain, nonatomic, getter=_callingDomain, setter=_setCallingDomain:) STCallingStatusDomain *callingDomain; // ivar: _callingDomain
@property (readonly, copy) NSString *debugDescription;
@property (readonly, copy) NSString *description;
@property (retain, nonatomic, getter=_focusDomain, setter=_setFocusDomain:) STFocusStatusDomain *focusDomain; // ivar: _focusDomain
@property (readonly) NSUInteger hash;
@property (retain, nonatomic, getter=_locationDomain, setter=_setLocationDomain:) STLocationStatusDomain *locationDomain; // ivar: _locationDomain
@property (readonly) Class superclass;
@property (readonly, nonatomic) STTelephonyStatusDomainDataProvider *telephonyDataProvider; // ivar: _telephonyDataProvider
@property (retain, nonatomic, getter=_telephonyDomain, setter=_setTelephonyDomain:) STTelephonyStatusDomain *telephonyDomain; // ivar: _telephonyDomain
...
@property (retain, nonatomic, getter=_voiceControlDomain, setter=_setVoiceControlDomain:) STVoiceControlStatusDomain *voiceControlDomain; // ivar: _voiceControlDomain
@property (readonly, nonatomic) SBSystemStatusWifiDataProvider *wifiDataProvider; // ivar: _wifiDataProvider
@property (retain, nonatomic, getter=_wifiDomain, setter=_setWifiDomain:) STWifiStatusDomain *wifiDomain; // ivar: _wifiDomain
...
-(id)_statusBarStyleOverridesForCallDescriptors:(id)arg0 ;
-(id)init;
