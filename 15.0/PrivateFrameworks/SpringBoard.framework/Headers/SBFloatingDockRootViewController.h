...
@class SBFTouchPassThroughViewController, _UILegibilitySettings, SBFAnalyticsClient, NSString, FBDisplayLayoutElement, SBFloatingDockViewController, SBFolderController, NSSet, SBIconListView;
@protocol SBFloatingDockViewControllerDelegate, UIGestureRecognizerDelegate, SBIconViewQuerying, SBIconLocationPresenting, SBFloatingDockRootViewControllerDelegate, SBIconViewProviding;
...
@property (readonly, nonatomic, getter=isContentEligibleForAsynchronousRendering) BOOL contentEligibleForAsynchronousRendering; // ivar: _contentEligibleForAsynchronousRendering
...
-(void)floatingDockViewController:(id)arg0 didCompleteTransitionWithLibraryToPresented:(BOOL)arg1 ;
...
-(void)floatingDockViewController:(id)arg0 willPerformTransitionWithLibraryToPresented:(BOOL)arg1 ;
