...
@class NSString, NSSManager, MCProfile, NSData, NSArray;
@protocol MCInstallationConsentDelegate, DevicePINControllerDelegate, MCProfileQuestionsControllerDelegate, MCInstallationWarningDelegate, MCProfileViewControllerDelegate, MCUISignInViewControllerDelegate, UIAdaptivePresentationControllerDelegate, MCInstallProfileDelegate;
...
@property (retain, nonatomic) MCProfileViewController *profileViewController; // ivar: _profileViewController
...
-(void)_installProfileOnWatchWithCompletion:(id)arg0 ;
-(void)_presentConsent:(id)arg0 ;
-(void)_promptUserWithQuestions:(id)arg0 ;
-(void)_promptUserWithQuestionsAfterDelay:(id)arg0 ;
-(void)_removePhoneProfileWithIdentifier:(id)arg0 completion:(id)arg1 ;
-(void)_removeWatchProfileWithIdentifier:(id)arg0 completion:(id)arg1 ;
-(void)_resetInstallationVariables;
-(void)_returnToSender;
-(void)_showAlertForError:(id)arg0 suggestedTitle:(id)arg1 suggestedMessage:(id)arg2 ;
