...
@class PSBundleController, NPSDomainAccessor, PSListController, PSSpecifier;
...
@property (retain, nonatomic) NPSDomainAccessor *nanoDomainAccessor; // ivar: _nanoDomainAccessor
