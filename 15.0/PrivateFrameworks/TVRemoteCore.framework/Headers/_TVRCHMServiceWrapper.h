...
#ifndef _TVRCHMSERVICEWRAPPER_H
#define _TVRCHMSERVICEWRAPPER_H

@class HMAccessory, HMCharacteristic, NSString, HMHome, HMService;
@protocol HMAccessoryDelegate, _TVRCHMServiceWrapperDelegate;
...
@property (weak, nonatomic) NSObject<_TVRCHMServiceWrapperDelegate> *delegate; // ivar: _delegate
