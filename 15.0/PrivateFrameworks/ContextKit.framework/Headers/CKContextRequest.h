...
@property (weak, nonatomic) NSArray *donorBundleIdentifiers; // ivar: _donorBundleIdentifiers
...
@property (nonatomic) NSInteger maxProductTopics; // ivar: _maxProductTopics
