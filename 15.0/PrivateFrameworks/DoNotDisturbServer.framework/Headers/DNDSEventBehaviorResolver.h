...
-(BOOL)_queue_isBreakthroughAllowedForConfiguration:(id)arg0 application:(id)arg1 sender:(id)arg2 urgency:(NSUInteger)arg3 eventType:(NSUInteger)arg4 threadIdentifier:(id)arg5 notifyAnyway:(BOOL)arg6 reason:(*NSUInteger)arg7 ;
...
-(id)_queue_resolutionForModeWithConfiguration:(id)arg0 eventDetails:(id)arg1 clientDetails:(id)arg2 activeModeUUID:(id)arg3 date:(id)arg4 error:(*id)arg5 ;
-(id)_queue_resolveBehaviorForEventDetails:(id)arg0 clientDetails:(id)arg1 date:(id)arg2 error:(*id)arg3 ;
-(id)initWithModeRepository:(id)arg0 contactStore:(id)arg1 ;
