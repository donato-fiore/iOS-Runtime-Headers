...
@protocol DNDSKeybagStateObserver, DNDSSysdiagnoseDataProvider, CKSyncEngineDataSource, DNDSSyncEngineMetadataStoring, DNDSSyncEngineSynchronizing, OS_dispatch_queue, DNDSSyncEngineLastChanceDataStoring, DNDSKeybagStateProviding;
...
-(void)_accountUpdateQueue_updateAccountWithSyncEnabledState:(BOOL)arg0 ;
