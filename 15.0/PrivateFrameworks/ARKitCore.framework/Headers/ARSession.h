...
@protocol ARSensorDelegate, ARTechniqueDelegate, ARWorldTrackingTechniqueObserver, OS_dispatch_semaphore, OS_dispatch_queue, ARSessionDelegate;
...
-(void)_startSensorsWithDataTypes:(NSUInteger)arg0 ;
