...
-(id)init:(CGFloat)arg0 timeSinceInitialization:(CGFloat)arg1 trackingStatus:(id)arg2 fusedReplayLocation:(id)arg3 fusedReplayLocationTimestamp:(CGFloat)arg4 fusedReplayHeading:(CGFloat)arg5 fusedReplayHeadingTimestamp:(CGFloat)arg6 ;
