...
@class AVCaptureVisionDataOutput, NSArray, AVCameraCalibrationData, NSMutableDictionary, AVCaptureConnection, AVCaptureCameraCalibrationDataOutput, AVCaptureDevice, AVCaptureSession, NSMutableArray, NSString, AVCaptureDataOutputSynchronizer, AVCapturePhotoOutput, AVCaptureDeviceInput, AVCaptureVideoDataOutput;
