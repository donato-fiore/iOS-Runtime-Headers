...
@property (nonatomic) BOOL needsRapidUpdates; // ivar: _needsRapidUpdates
...
@property (retain, nonatomic) FCFeedPersonalizedItemScoreProfile *scoreProfile; // ivar: _scoreProfile
