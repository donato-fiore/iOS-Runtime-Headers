...
@protocol FCCacheCoordinatorDelegate, FCFetchCoordinatorDelegate, FCCacheFlushing, FCJSONEncodableObjectProviding;
...
-(id)init;
-(id)initWithContentDatabase:(id)arg0 contentDirectory:(id)arg1 ;
