...
@class NSDictionary, NSString, NSDate, NSArray, NSNumber, NTPBDiscoverMoreVideosInfo;
...
@property (readonly, nonatomic) NSUInteger premiumTodayFeedDebugSetting;
...
@property (readonly, nonatomic) BOOL privateDataEncryptionMigrationRequiresAllDevicesRunningTigris; // ivar: _privateDataEncryptionMigrationRequiresAllDevicesRunningTigris
...
@property (readonly, nonatomic) BOOL searchInExplicitViewEnabled;
