...
@protocol FCFeldsparIDProviderObserving, FCNewsAppConfigurationManager, FCCoreConfigurationManager, FCMagazinesConfigurationManager, FCTodayFeedConfigurationManager, FCFeldsparIDProvider, OS_dispatch_queue, FCNewsAppConfiguration, FCCoreConfiguration, FCNewsAppConfiguration><FCJSONEncodableObjectProviding;
...
-(void)fetchAppWidgetConfigurationWithCompletion:(id)arg0 ;
