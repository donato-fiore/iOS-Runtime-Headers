...
@class NSArray, NSString, COMAPPLEFELDSPARPROTOCOLLIVERPOOLCohortList, COMAPPLEFELDSPARPROTOCOLLIVERPOOLConversionStats, NTPBIssueRecord, COMAPPLEFELDSPARPROTOCOLVersionedPersonalizationVector, NSDate, COMAPPLEFELDSPARPROTOCOLLIVERPOOLTagMetadata;
