...
@class PLThumbnailManagerCore, NSMutableSet, NSMutableArray, NSLock, NSPersistentStore, NSArray;
...
@property (retain, nonatomic) NSArray *slowPersistenceManagers; // ivar: _slowPersistenceManagers
