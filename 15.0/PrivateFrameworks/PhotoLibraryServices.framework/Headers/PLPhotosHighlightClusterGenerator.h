...
-(id)_dayMomentClustersWithMomentsSortedByDate:(id)arg0 localCreationDateCreator:(id)arg1 ;
...
-(id)initWithDataManager:(id)arg0 frequentLocationManager:(id)arg1 recentHighlightDateInterval:(id)arg2 localCreationDateCreator:(id)arg3 dateRangeTitleGenerator:(id)arg4 ;
