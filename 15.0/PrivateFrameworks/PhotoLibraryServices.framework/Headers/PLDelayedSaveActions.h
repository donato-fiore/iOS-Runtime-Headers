...
@class NSMapTable, NSMutableArray, NSMutableSet, NSMutableDictionary, NSPredicate;
...
-(void)_popDelayedMomentInsertsAndUpdates:(*id)arg0 deletes:(*id)arg1 updatedAssetIDsForHighlights:(*id)arg2 updatedMomentIDsForHighlights:(*id)arg3 ;
...
-(void)_recordDelayedHighlightAssetUpdates:(id)arg0 ;
