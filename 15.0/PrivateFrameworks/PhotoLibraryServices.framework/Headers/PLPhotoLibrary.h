...
+(void)_contextSaveFailedWithSQLiteError:(id)arg0 ;
...
// -(void)_withDispatchGroup:(id)arg0 synchronously:(BOOL)arg1 name:(id)arg2 shouldSave:(BOOL)arg3 performTransaction:(id)arg4 completionHandler:(unk)arg5  ;
...
// -(void)performTransactionAndWaitWithName:(id)arg0 transaction:(id)arg1 completionHandler:(unk)arg2  ;
// -(void)performTransactionWithName:(id)arg0 transaction:(id)arg1 completionHandler:(unk)arg2  ;
