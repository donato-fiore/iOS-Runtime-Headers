...
@property (readonly, nonatomic) CGFloat cloudResourceInitialMinimumFreeDiskSpaceForOptimizeRatio; // ivar: _cloudResourceInitialMinimumFreeDiskSpaceForOptimizeRatio
...
@property (readonly, nonatomic) NSUInteger cloudResourceMaximumSmallLibraryThreshold; // ivar: _cloudResourceMaximumSmallLibraryThreshold
...
@property (readonly, nonatomic) NSUInteger cloudResourcePrefetchMaxFileSize; // ivar: _cloudResourcePrefetchMaxFileSize
...
@property (readonly, nonatomic) unsigned short memoryMaxPrefetchPhotosCount; // ivar: _memoryMaxPrefetchPhotosCount
@property (readonly, nonatomic) unsigned short memoryMaxPrefetchVideosCount; // ivar: _memoryMaxPrefetchVideosCount
@property (readonly, nonatomic) NSInteger memoryPrefetchAllowedIfLastViewedDateWithin; // ivar: _memoryPrefetchAllowedIfLastViewedDateWithin
@property (readonly, nonatomic) NSInteger memoryPrefetchIfCreationDateWithin; // ivar: _memoryPrefetchIfCreationDateWithin
@property (readonly, nonatomic) unsigned short memoryPrefetchLimit; // ivar: _memoryPrefetchLimit
