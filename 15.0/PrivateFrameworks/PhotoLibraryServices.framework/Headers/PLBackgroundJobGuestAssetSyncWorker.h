...
-(BOOL)_batchResetGuestSavedAssetTypeInManagedObjectContext:(id)arg0 ;
-(BOOL)_batchResetSyndicationProcessingInManagedObjectContext:(id)arg0 ;
-(BOOL)_checkSyndicationPreferencesEnabledAndCleanupGuestAssetsIfNeededWithPhotoLibrary:(id)arg0 ;
-(BOOL)_resetSyndicationProcessingInSourceLibrary:(id)arg0 ;
-(BOOL)_shouldCancelCurrentWorkItem:(id)arg0 ;
-(BOOL)_syncAsset:(id)arg0 toLibrary:(id)arg1 error:(*id)arg2 ;
