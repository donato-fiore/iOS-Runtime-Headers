...
// +(id)entriesByPayloadClassIDFromHistoryToken:(id)arg0 currentHistoryToken:(*id)arg1 withManagedObjectContext:(id)arg2 payloadIDsToSkipInserts:(id)arg3 shouldStopBlock:(id)arg4 error:(unk)arg5  ;
...
-(BOOL)_replayFromCurrentHistoryTokenWithPayloadIDsToSkipInserts:(id)arg0 ;
