...
@class NSDictionary, NSURL, NSSet, NSString;
@protocol NSCopying;
...
@property (copy, nonatomic) NSURL *enhancedAudioKeyCertificateURL; // ivar: enhancedAudioKeyCertificateURL
@property (copy, nonatomic) NSURL *enhancedAudioKeyServerURL; // ivar: enhancedAudioKeyServerURL
