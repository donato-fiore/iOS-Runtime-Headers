...
@class AVContentKeySession, NSMutableSet, NSSet, NSURL, NSMutableDictionary, NSNumber, NSString;
@protocol AVContentKeySessionDelegate, ICContentKeyStoreProtocol, OS_dispatch_queue, OS_dispatch_semaphore, OS_dispatch_source;
...
-(void)_performKeyDeliveryRequestForContentKeyRequest:(id)arg0 persistResponse:(BOOL)arg1 ;
-(void)_renewExpiredKeys;
-(void)_scheduleKeyRefreshTimer;
-(void)addAsset:(id)arg0 ;
-(void)addAsset:(id)arg0 shouldPreloadKeys:(BOOL)arg1 ;
