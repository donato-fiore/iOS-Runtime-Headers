...
@class NSArray, NSSet, NSDictionary, NSMutableDictionary, NSDate, NSString;
...
-(id)_initWithDictionary:(id)arg0 expirationDate:(id)arg1 serverCorrelationKey:(id)arg2 serverEnvironment:(id)arg3 ;
