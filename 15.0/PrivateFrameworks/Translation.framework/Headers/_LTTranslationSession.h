...
@protocol _LTSpeechTranslationDelegate, _LTTranslationService, OS_dispatch_queue;
...
@property (retain, nonatomic) NSObject<_LTTranslationService> *service; // ivar: _service
...
-(void)_commonInit;
-(void)_ensureServiceConnection:(id)arg0 ;
