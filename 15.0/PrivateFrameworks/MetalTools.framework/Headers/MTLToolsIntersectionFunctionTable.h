...
#ifndef MTLTOOLSINTERSECTIONFUNCTIONTABLE_H
#define MTLTOOLSINTERSECTIONFUNCTIONTABLE_H

@class NSString;
@protocol MTLIntersectionFunctionTableSPI, MTLBuffer, MTLDevice, MTLHeap;
