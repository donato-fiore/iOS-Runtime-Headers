...
@class UIControl, UIView, UIImageView, UILabel, MTVisualStylingProvider, NSStringDrawingContext, NSString, NSDate, UIImage, NSArray, NSURL, NSUUID, UIAction, UIGestureRecognizer;
@protocol FCUIActivityDisplaying, FCUIExpandingContracting, FCUIAnimatedTransitionParticipating, FCUIContentSizeCategoryAdjusting, FCActivityDescribing;
...
-(CGFloat)_cornerRadiusForControlFrame:(struct CGRect )arg0 isContinuous:(*BOOL)arg1 ;
