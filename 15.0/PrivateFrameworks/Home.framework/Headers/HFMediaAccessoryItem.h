...
@protocol HFMediaAccessoryProtocol, HFMediaAccessoryLikeItem, HFActionBuilderFactory, HFHomeKitObject, HFHomeKitSettingsVendor, HFMediaProfileContainer, HFMediaValueSource, HFCharacteristicValueSource;
