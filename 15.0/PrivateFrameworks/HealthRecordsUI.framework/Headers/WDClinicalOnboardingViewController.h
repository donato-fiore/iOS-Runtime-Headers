...
@class HKTableViewController, NSTimer, UISearchController, CLLocationManager, CLLocation, HKClinicalAccountStore, NSArray, NSSet, NSMutableOrderedSet, NSString, UIViewController, NSLayoutConstraint, UIView, _UIContentUnavailableView, NSMutableDictionary, NSIndexPath;
