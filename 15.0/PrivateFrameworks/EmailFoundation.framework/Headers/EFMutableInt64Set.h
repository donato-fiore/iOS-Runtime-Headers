...
+(id)indexSet;
+(id)indexSetWithIndexesInRange:(struct _EFUInt64Range )arg0 ;
...
-(NSInteger)lastIndex;
-(NSUInteger)count;
-(NSUInteger)getIndexes:(*NSInteger)arg0 maxCount:(NSUInteger)arg1 inIndexRange:(struct _EFUInt64Range *)arg2 ;
