...
@class UIViewController, UIScrollView, NSMutableDictionary, UIButton, UIView, NSLayoutConstraint, _UIBackdropView, UILabel, NSString, NSDate, NSTimer, UILayoutGuide, NSArray;
...
#import "BKUIPearlEnrollOperationsHandler.h"
...
@property (retain, nonatomic) BKUIPearlEnrollOperationsHandler *operationsHandler; // ivar: _operationsHandler
