...
-(id)initWithIDSPrimitives:(id)arg0 networkPowerPrimitives:(id)arg1 sourceAppleID:(id)arg2 connectionConfiguration:(id)arg3 ;
-(id)initWithIDSPrimitives:(id)arg0 networkPowerPrimitives:(id)arg1 timerSource:(id)arg2 workQueue:(id)arg3 delegateQueue:(id)arg4 sourceAppleID:(id)arg5 connectionConfiguration:(id)arg6 ;
...
-(void)connectionInvitationInbox:(id)arg0 foundConection:(id)arg1 senderAppleID:(id)arg2 senderAddress:(id)arg3 networkPowerAssertion:(id)arg4 messagingVersion:(NSUInteger)arg5 userInfo:(id)arg6 ;
...
-(void)connectionInvitationOutbox:(id)arg0 foundConnection:(id)arg1 destinationAppleID:(id)arg2 destinationAddress:(id)arg3 networkPowerAssertion:(id)arg4 messagingVersion:(NSUInteger)arg5 userInfo:(id)arg6 ;
