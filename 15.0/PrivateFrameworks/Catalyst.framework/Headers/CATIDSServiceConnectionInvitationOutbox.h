...
@protocol CATNetworkPowerPrimitives, OS_dispatch_queue, CATIDSServiceConnectionInvitationOutboxDelegate;
...
-(id)initWithNetworkPowerPrimitives:(id)arg0 workQueue:(id)arg1 ;
