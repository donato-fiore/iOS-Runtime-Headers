...
@protocol CATTimerSource, CATNetworkPowerPrimitives, OS_dispatch_queue, CATIDSServiceConnectionInvitationInboxDelegate;
...
-(id)initWithTimerSource:(id)arg0 networkPowerPrimitives:(id)arg1 workQueue:(id)arg2 acknowledgeTimeout:(CGFloat)arg3 ;
