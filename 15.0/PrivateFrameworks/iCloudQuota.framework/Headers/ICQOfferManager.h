...
-(NSUInteger)fetchServiceAvailabilityForJourneyID:(id)arg0 ;
-(id)_currentOfferForBundleIdentifier:(id)arg0 options:(id)arg1 ;
-(id)_funnelCloudServerOfferForAccount:(id)arg0 options:(id)arg1 error:(*id)arg2 ;
-(id)_premiumOptions;
...
-(void)clearFollowups;
-(void)dealloc;
-(void)fetchServiceAvailabilityForJourneyID:(id)arg0 completion:(id)arg1 ;
