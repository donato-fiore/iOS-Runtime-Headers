...
@protocol MTRecipeMaterialSettingsProviding, MTTinting><MTMaterialFiltering;
...
@property (readonly, nonatomic) NSObject<MTTinting><MTMaterialFiltering> *baseMaterialSettings; // ivar: _baseMaterialSettings
