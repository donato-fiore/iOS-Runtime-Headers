...
@protocol AVTPhysicsControllerDelegate, NSCopying;
...
-(void)_updateShaderModifier:(id)arg0 forARMode:(BOOL)arg1 withOnTopMask:(BOOL)arg2 ;
-(void)addCorrectiveDescriptorsInHierarchy:(id)arg0 ;
...
-(void)enumerateMorphInfoForCustomCustomBlendShapeName:(id)arg0 usingBlock:(id)arg1 ;
...
-(void)removeCorrectiveDescriptorsInHierarchy:(id)arg0 ;
