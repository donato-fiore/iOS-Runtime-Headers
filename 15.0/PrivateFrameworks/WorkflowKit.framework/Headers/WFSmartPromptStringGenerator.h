...
+(id)localizedPromptForWorkflowName:(id)arg0 attributionSet:(id)arg1 contentCollection:(id)arg2 contentItemCache:(id)arg3 contentDestination:(id)arg4 action:(id)arg5 ;
