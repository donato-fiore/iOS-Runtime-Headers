...
-(NSUInteger)hash;
-(id)initWithIdentifier:(id)arg0 workflowID:(id)arg1 trigger:(id)arg2 shouldPrompt:(BOOL)arg3 enabled:(BOOL)arg4 ;
-(id)initWithIdentifier:(id)arg0 workflowID:(id)arg1 trigger:(id)arg2 shouldPrompt:(BOOL)arg3 enabled:(BOOL)arg4 triggerSource:(int)arg5 suggestionData:(id)arg6 ;
