...
+(void)loadActionDescriptionIconsWithActions:(id)arg0 maxCount:(NSInteger)arg1 completion:(id)arg2 ;
...
-(void)loadActionDescriptionIconsMaxCount:(NSInteger)arg0 completion:(id)arg1 ;
-(void)loadFromRecord;
