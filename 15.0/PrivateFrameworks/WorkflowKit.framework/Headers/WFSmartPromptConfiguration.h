...
-(id)initWithSmartPromptStates:(id)arg0 attributionSet:(id)arg1 contentItemCache:(id)arg2 action:(id)arg3 contentDestination:(id)arg4 reference:(id)arg5 source:(id)arg6 ;
