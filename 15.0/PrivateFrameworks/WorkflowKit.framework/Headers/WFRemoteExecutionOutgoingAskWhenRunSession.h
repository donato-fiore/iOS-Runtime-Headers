...
#ifndef WFREMOTEEXECUTIONOUTGOINGASKWHENRUNSESSION_H
#define WFREMOTEEXECUTIONOUTGOINGASKWHENRUNSESSION_H



#import "WFRemoteExecutionSession.h"
#import "WFRemoteExecutionAskWhenRunRequest.h"

@interface WFRemoteExecutionOutgoingAskWhenRunSession : WFRemoteExecutionSession

@property (copy, nonatomic) id *completion; // ivar: _completion
@property (readonly, nonatomic) WFRemoteExecutionAskWhenRunRequest *request;
