...
@class NSString, FBSDisplayLayoutMonitor, WFWorkflowRunningContext;
...
-(void)presenterWillShowRequest:(id)arg0 runningContext:(id)arg1 withCompletionHandler:(id)arg2 ;
-(void)reset;
