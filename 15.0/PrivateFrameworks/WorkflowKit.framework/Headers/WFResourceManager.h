...
-(void)makeAccessResourcesAvailableAtGlobalLevelWithUserInterface:(id)arg0 completionHandler:(id)arg1 ;
-(void)makeAccessResourcesAvailableAtWorkflowLevelWithUserInterface:(id)arg0 completionHandler:(id)arg1 ;
-(void)notifyTargets;
