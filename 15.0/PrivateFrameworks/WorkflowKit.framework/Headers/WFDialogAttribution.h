...
+(id)attributionWithTitle:(id)arg0 icon:(id)arg1 image:(id)arg2 associatedAppBundleIdentifier:(id)arg3 ;
-(id)copyWithZone:(struct _NSZone *)arg0 ;
-(id)description;
-(id)initWithCoder:(id)arg0 ;
-(id)initWithTitle:(id)arg0 icon:(id)arg1 image:(id)arg2 associatedAppBundleIdentifier:(id)arg3 ;
