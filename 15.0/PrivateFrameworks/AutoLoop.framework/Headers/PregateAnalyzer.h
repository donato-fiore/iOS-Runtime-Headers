...
-(BOOL)findNextUsableFrameFromIndex:(NSInteger)arg0 backwards:(BOOL)arg1 inFrameInfoArray:(id)arg2 toValue:(*NSInteger)arg3 ;
-(BOOL)findSurroundingUsableFramesForIndex:(NSInteger)arg0 inFrameInfoArray:(id)arg1 prevIndex:(*NSInteger)arg2 nextIndex:(*NSInteger)arg3 ;
