...
@property (readonly, nonatomic) int naturalAlignment; // ivar: _naturalAlignment
...
-(id)initWithStylesheet:(id)arg0 paragraphStyle:(id)arg1 listStyle:(id)arg2 columnStyle:(id)arg3 alignmentForNaturalAlignment:(int)arg4 naturalDirection:(int)arg5 ;
