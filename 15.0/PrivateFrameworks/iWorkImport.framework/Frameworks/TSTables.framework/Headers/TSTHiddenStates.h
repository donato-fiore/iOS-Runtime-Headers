...
@property (readonly, retain, nonatomic) TSTHiddenStateExtent *columnHiddenStateExtent; // ivar: _columnHiddenStateExtent
...
@property (readonly, retain, nonatomic) TSTHiddenStateExtent *rowHiddenStateExtent; // ivar: _rowHiddenStateExtent
@property (readonly) Class superclass;
@property (readonly, retain, nonatomic) TSTTableTranslator *translator; // ivar: _translator
