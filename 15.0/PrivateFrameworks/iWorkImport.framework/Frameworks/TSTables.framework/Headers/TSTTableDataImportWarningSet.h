...
#ifndef TSTTABLEDATAIMPORTWARNINGSET_H
#define TSTTABLEDATAIMPORTWARNINGSET_H
...
+(id)objectWithImportWarningSet:(id)arg0 refCount:(unsigned int)arg1 ;
-(NSUInteger)estimateByteSize;
-(id)description;
-(id)importWarningSet;
-(id)initObjectWithImportWarningSet:(id)arg0 refCount:(unsigned int)arg1 ;
