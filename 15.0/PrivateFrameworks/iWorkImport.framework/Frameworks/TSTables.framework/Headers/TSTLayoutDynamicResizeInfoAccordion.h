...
-(CGFloat)p_applyAccordionResizeFactor:(CGFloat)arg0 region:(id)arg1 direction:(NSInteger)arg2 totalOfCaptured:(CGFloat)arg3 count:(unsigned int)arg4 capturedArray:(*CGFloat)arg5 currentArray:(*CGFloat)arg6 minimumArray:(*CGFloat)arg7 ;
