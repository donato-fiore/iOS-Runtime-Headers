...
@class NSMutableDictionary, TSCEMutableUIDSet, TSCEUIDSet, TSCECellValue, NSUUID;
...
@interface TSTGroupNode : NSObject {
    ...
    TSUIndexSet _rowUidsIndexSet;
    TSUIndexSet _pivotOnlyRowIndexes;
...
@property (readonly, retain, nonatomic) TSCECellValue *groupCellValue; // ivar: _groupCellValue
...
-(id)initWithArchive:(*void)arg0 forGroupBy:(id)arg1 atLevel:(unsigned char)arg2 ;
...
-(void)dealloc;
-(void)encodeToArchive:(*void)arg0 backwardCompat:(BOOL)arg1 ;
