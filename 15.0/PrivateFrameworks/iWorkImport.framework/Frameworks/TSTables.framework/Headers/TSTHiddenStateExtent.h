...
@class TSCECalculationEngine, NSMutableIndexSet, NSMutableDictionary, TSCEUIDSet, NSString, NSArray;
...
@interface TSTHiddenStateExtent : NSObject <TSCEFormulaOwning, TSTGroupByChangeProtocol, TSTCellWillChangeProtocol>

 {
    ...
    unordered_map<TSKUIDStruct, unsigned char, std::hash<TSKUIDStruct>, std::equal_to<TSKUIDStruct>, std::allocator<std::pair<const TSKUIDStruct, unsigned char>>> _hiddenByUid;
    ...
    TSUIndexSet _pendingColumnsOrRowsShown;
    TSUIndexSet _pendingColumnsOrRowsHidden;
    TSUIndexSet _pendingViewColumnsOrRowsShown;
    TSUIndexSet _pendingViewColumnsOrRowsHidden;
...
-(struct TSUModelColumnOrRowIndex )baseIndexForViewIndex:(struct TSUViewColumnOrRowIndex )arg0 ;
-(struct TSUViewColumnOrRowIndex )viewIndexForBaseIndex:(struct TSUModelColumnOrRowIndex )arg0 ;
-(unsigned char)hidingActionForBaseIndex:(struct TSUModelColumnOrRowIndex )arg0 ;
-(unsigned char)hidingActionForUid:(struct TSKUIDStruct *)arg0 viewRcIndex:(struct TSUViewColumnOrRowIndex )arg1 ;
...
-(void)addHiddenIndex:(struct TSUModelColumnOrRowIndex )arg0 viewIndex:(struct TSUViewColumnOrRowIndex )arg1 forAction:(unsigned char)arg2 ;
...
-(void)hiddenStateChangedForBaseIndex:(struct TSUModelColumnOrRowIndex )arg0 viewIndex:(struct TSUViewColumnOrRowIndex )arg1 forAction:(unsigned char)arg2 ;
...
-(void)removeHiddenIndex:(struct TSUModelColumnOrRowIndex )arg0 viewIndex:(struct TSUViewColumnOrRowIndex )arg1 forAction:(unsigned char)arg2 ;
