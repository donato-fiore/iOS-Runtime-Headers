...
@property (retain, nonatomic) TSCECalculationEngine *calcEngine; // ivar: _calcEngine
...
-(id)compactQualifiedColumnNameForAggregateIndex:(NSUInteger)arg0 locale:(id)arg1 ;
-(id)compactQualifiedColumnNameForAggregateIndex:(NSUInteger)arg0 useShortLabel:(BOOL)arg1 allowDuplicateNames:(BOOL)arg2 locale:(id)arg3 ;
-(id)description;
...
-(id)findExistingGroupNodeInGroupBy:(id)arg0 usingValues:(*void)arg1 upToLevel:(NSUInteger)arg2 ;
-(id)firstAggregate;
...
-(id)qualifiedColumnNameForAggregateIndex:(NSUInteger)arg0 locale:(id)arg1 ;
-(id)qualifiedColumnNameForAggregateIndex:(NSUInteger)arg0 useShortLabel:(BOOL)arg1 allowDuplicateNames:(BOOL)arg2 locale:(id)arg3 ;
