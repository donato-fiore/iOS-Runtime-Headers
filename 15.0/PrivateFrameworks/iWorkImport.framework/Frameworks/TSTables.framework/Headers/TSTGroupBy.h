...
@class TSPObject, NSMutableArray, TSCECalculationEngine, NSArray, TSKCustomFormatWrapper, NSString, TSULocale;
...
@property (readonly, retain, nonatomic) NSMutableArray *aggregators; // ivar: _aggregators
...
@property (readonly, retain, nonatomic) TSKCustomFormatWrapper *customFormatForBlankGroup; // ivar: _customFormatForBlankGroup
@property (readonly, retain, nonatomic) TSKCustomFormatWrapper *customFormatForErrorGroup; // ivar: _customFormatForErrorGroup
@property (readonly, copy) NSString *debugDescription;
@property (readonly, copy) NSString *description;
@property (readonly, retain, nonatomic) TSTGroupByChangeDistributor *groupByChangeDistributor; // ivar: _groupByChangeDistributor
...
@property (readonly, retain) NSArray *groupingColumns; // ivar: _groupingColumns
...
-(id)initWithArchive:(*void)arg0 forCategoryOwner:(id)arg1 ;
...
-(struct vector<TSCEValue, std::allocator<TSCEValue>> )valuesForCategoryRef:(id)arg0 atRowUid:(struct TSKUIDStruct *)arg1 ;
...
-(void)encodeToArchive:(*void)arg0 archiver:(id)arg1 backwardCompat:(BOOL)arg2 ;
