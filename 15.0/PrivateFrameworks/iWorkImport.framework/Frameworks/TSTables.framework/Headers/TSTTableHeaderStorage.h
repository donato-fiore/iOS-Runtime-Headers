...
-(id)_headerAtIndex:(unsigned int)arg0 ;
-(id)_mutableHeaderAtIndex:(unsigned int)arg0 ;
-(id)_mutableNoCreateHeaderAtIndex:(unsigned int)arg0 ;
...
-(void)_setHeader:(id)arg0 atIndex:(unsigned int)arg1 ;
