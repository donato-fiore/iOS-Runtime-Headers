...
@class TSPObject, TSDStroke, TSWPParagraphStyle, TSCECalculationEngine, NSArray, NSMapTable, NSString, TSWPStorage, TSCEHauntedOwner, TSCEOwnerUidMapper, NSUUID, TSWPShapeStyle;
...
-(void)accumulateCurrentCellsConcurrently:(id)arg0 suppressCellBorder:(BOOL)arg1 ;
...
-(void)p_rebuildTheTable:(id)arg0 ;
