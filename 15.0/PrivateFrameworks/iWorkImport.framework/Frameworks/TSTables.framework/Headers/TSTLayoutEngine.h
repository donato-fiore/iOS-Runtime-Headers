...
-(id)newTextEngineForCell:(id)arg0 atCellID:(struct TSUCellCoord )arg1 textStyle:(id)arg2 naturalAlignment:(int)arg3 cellDirection:(int)arg4 ;
-(id)p_resolvedTextStyleForCell:(id)arg0 atCellID:(struct TSUCellCoord )arg1 textStyle:(id)arg2 outNaturalAlignment:(*int)arg3 outCellDirection:(*int)arg4 ;
...
-(struct CGSize )tableNameTextSizeForTableName:(id)arg0 maxWidth:(CGFloat)arg1 ;
