...
-(?)expandSingleTractForProposedCategoryLabelsbyRow;
...
-(id)dataFormatterFromFormatStruct:(struct ? )arg0 in:(id)arg1 ;
-(id)dataFormulas;
...
-(struct vector<TSCERangeRef, std::allocator<TSCERangeRef>> )expandSingleRangeForLabels:(struct TSCERangeRef *)arg0 formulaType:(NSUInteger)arg1 ;
