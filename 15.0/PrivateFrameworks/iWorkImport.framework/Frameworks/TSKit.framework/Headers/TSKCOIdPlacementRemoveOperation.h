...
#ifndef TSKCOIDPLACEMENTREMOVEOPERATION_H
#define TSKCOIDPLACEMENTREMOVEOPERATION_H
...
-(id)initWithAddress:(*void)arg0 fromIndex:(int)arg1 ;
-(id)initWithAddress:(*void)arg0 fromIndex:(int)arg1 noop:(BOOL)arg2 objectCount:(int)arg3 objectCounterSpace:(int)arg4 ;
-(id)initWithAddress:(*void)arg0 fromIndex:(int)arg1 objectCount:(int)arg2 objectCounterSpace:(int)arg3 ;
...
-(id)initWithUUIDPath:(id)arg0 fromIndex:(int)arg1 ;
