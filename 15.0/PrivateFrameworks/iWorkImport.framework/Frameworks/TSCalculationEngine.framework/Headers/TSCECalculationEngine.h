...
@protocol TSCEFormulaReplacing, TSKMultiTableRemapping, TSCEHeaderNameProtocol, TSCERefNamingProtocol, TSCERefParsingProtocol;
...
@property (readonly, retain, nonatomic) NSObject<TSCEHeaderNameProtocol> *headerNameMgr;
...
-(?)valuesForCategoryRef:(?)arg0 atRowUid:(?)arg1 hidingActionMaskerror;
...
-(struct vector<TSCECellRef, std::allocator<TSCECellRef>> )cellRefsForCategoryRef:(id)arg0 atRowUid:(struct TSKUIDStruct *)arg1 ;
-(struct vector<TSCECellRef, std::allocator<TSCECellRef>> )unorderedCellRefsForCategoryRef:(id)arg0 atRowUid:(struct TSKUIDStruct *)arg1 ;
