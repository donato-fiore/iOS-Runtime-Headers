...
-(NSUInteger)p_pageIndexForCharIndex:(NSUInteger)arg0 includeEmptyPages:(BOOL)arg1 caretAffinity:(int)arg2 forcePagination:(BOOL)arg3 searchAfterPaginationPoint:(BOOL)arg4 ;
