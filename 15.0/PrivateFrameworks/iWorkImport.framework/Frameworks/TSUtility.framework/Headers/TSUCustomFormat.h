...
@property (readonly, nonatomic) TSUCustomFormatData *defaultFormatData; // ivar: _defaultFormatData
...
-(id)description;
-(id)initWithName:(id)arg0 formatType:(unsigned int)arg1 data:(id)arg2 ;
-(id)initWithName:(id)arg0 formatType:(unsigned int)arg1 data:(id)arg2 conditionList:(id)arg3 ;
