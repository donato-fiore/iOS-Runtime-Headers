...
@property (readonly, retain, nonatomic) NSArray *orderedStrokes; // ivar: _orderedStrokes
@property (readonly, retain, nonatomic) NSArray *orderedStrokesGroup1; // ivar: _orderedStrokesGroup1
@property (readonly, retain, nonatomic) NSArray *orderedStrokesGroup2; // ivar: _orderedStrokesGroup2
@property (readonly, retain, nonatomic) NSArray *strokeGroup1; // ivar: _strokeGroup1
@property (readonly, retain, nonatomic) NSArray *strokeGroup2; // ivar: _strokeGroup2
