...
@property (readonly, retain, nonatomic) NSObject<OS_dispatch_queue> *_recognizersQueue; // ivar: __recognizersQueue
...
@property (readonly, retain, nonatomic) CHRecognitionSessionResult *inputResult; // ivar: _inputResult
...
@property (readonly, retain, nonatomic) NSArray *subjectStrokeIdentifiers; // ivar: _subjectStrokeIdentifiers
