...
-(id)initWithString:(id)arg0 score:(CGFloat)arg1 rotation:(CGFloat)arg2 upperLeftPoint:(struct CGPoint )arg3 upperRightPoint:(struct CGPoint )arg4 lowerLeftPoint:(struct CGPoint )arg5 lowerRightPoint:(struct CGPoint )arg6 ;
