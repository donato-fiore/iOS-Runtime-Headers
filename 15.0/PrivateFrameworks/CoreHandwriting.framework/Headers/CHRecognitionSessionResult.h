...
@property (readonly, retain, nonatomic) CHStrokeClutterFilter *clutterFilter; // ivar: _clutterFilter
...
@property (readonly, retain, nonatomic) CHStrokeClassificationResult *strokeClassificationResult; // ivar: _strokeClassificationResult
@property (readonly, retain, nonatomic) CHStrokeGroupingResult *strokeGroupingResult; // ivar: _strokeGroupingResult
@property (readonly, retain, nonatomic) NSObject<CHStrokeProviderVersion> *strokeProviderVersion; // ivar: _strokeProviderVersion
