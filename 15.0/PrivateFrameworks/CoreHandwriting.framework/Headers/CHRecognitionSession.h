...
@property (readonly, retain, nonatomic) NSMutableArray *_activeTasks; // ivar: __activeTasks
@property (nonatomic) NSUInteger _changeCoalescingIndex; // ivar: __changeCoalescingIndex
@property (readonly, retain, nonatomic) NSMutableArray *_changeObservers; // ivar: __changeObservers
@property (readonly, retain, nonatomic) NSMutableDictionary *_correctionRecognizersByLocalesKey; // ivar: __correctionRecognizersByLocalesKey
@property (nonatomic, setter=_setHasUnprocessedChanges:) BOOL _hasUnprocessedChanges; // ivar: __hasUnprocessedChanges
@property (readonly, retain, nonatomic) NSObject<OS_dispatch_queue> *_highResponsivenessQueue; // ivar: __highResponsivenessQueue
@property (readonly, retain, nonatomic) NSMutableArray *_inputDrawingClients; // ivar: __inputDrawingClients
@property (retain, setter=_setLatestTextInputTargets:) NSArray *_latestTextInputTargets; // ivar: __latestTextInputTargets
@property (readonly, retain, nonatomic) NSMutableDictionary *_recognizersByLocaleID; // ivar: __recognizersByLocaleID
@property (readonly, retain, nonatomic) NSObject<OS_dispatch_queue> *_sessionQueue; // ivar: __sessionQueue
...
@property (readonly, retain, nonatomic) NSObject<OS_dispatch_queue> *_tasksWorkQueue; // ivar: __tasksWorkQueue
...
@property (readonly, retain) NSObject<CHStrokeProvider> *latestStrokeProvider;
...
@property (readonly, retain, nonatomic) CHStrokeClassificationModel *strokeClassificationModel; // ivar: _strokeClassificationModel
