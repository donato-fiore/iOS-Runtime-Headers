...
@class NSString, NSArray, NSError, NSCharacterSet, NSLocale, NSDictionary;
...
@property (copy, nonatomic) NSArray *charBoundaryProbabilities; // ivar: _charBoundaryProbabilities
@property (copy, nonatomic) NSArray *delayedStrokeProbabilities; // ivar: _delayedStrokeProbabilities
@property (copy, nonatomic) CHDrawing *inputDrawing; // ivar: _inputDrawing
@property (copy, nonatomic) NSArray *inputDrawingCutPoints; // ivar: _inputDrawingCutPoints
...
@property (copy, nonatomic) NSArray *spaceProbabilities; // ivar: _spaceProbabilities
@property (copy, nonatomic) CHTokenizedTextResult *textResult; // ivar: _textResult


-(id)description;
-(void)dealloc;
-(void)recordCharBoundaryProbabilities:(*void)arg0 ;
-(void)recordConfigurationForRecognizer:(id)arg0 options:(id)arg1 ;
-(void)recordDelayedStrokeProbabilities:(*void)arg0 ;
-(void)recordInputDrawing:(id)arg0 ;
-(void)recordInputDrawingCutPoints:(id)arg0 ;
-(void)recordInsightRequest:(id)arg0 ;
-(void)recordSpaceProbabilities:(*void)arg0 ;
