...
@property (readonly, retain, nonatomic) NSCharacterSet *requiredLeftContext; // ivar: _requiredLeftContext
@property (readonly, retain, nonatomic) NSCharacterSet *requiredRightContext; // ivar: _requiredRightContext
