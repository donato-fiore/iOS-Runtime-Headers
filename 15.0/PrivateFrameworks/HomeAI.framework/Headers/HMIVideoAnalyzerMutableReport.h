...
+(id)eventTrackFromObjectGoundTruth:(id)arg0 ;
...
-(id)averagePrecisionWithDetectionTruth:(id)arg0 minPrecision:(float)arg1 iouThreshold:(float)arg2 ;
-(id)chartDataWithBaseline:(BOOL)arg0 comparator:(id)arg1 ;
-(id)chartDataWithClassificationTruth:(id)arg0 isBaseline:(BOOL)arg1 ;
-(id)chartDataWithDetectionTruth:(id)arg0 isBaseline:(BOOL)arg1 iouThreshold:(float)arg2 ;
-(id)chartDataWithObjectDetectionTruth:(id)arg0 isBaseline:(BOOL)arg1 intersectionOverMinAreaThreshold:(float)arg2 ;
...
-(id)compareWithDetectionTruth:(id)arg0 eventClass:(Class)arg1 confidenceThreshold:(float)arg2 iouThreshold:(float)arg3 ;
-(id)compareWithObjectDetectionTruth:(id)arg0 eventClass:(Class)arg1 confidenceLevel:(NSInteger)arg2 minIntersectionOverMinArea:(float)arg3 ;
-(id)compareWithObjectDetectionTruth:(id)arg0 eventClass:(Class)arg1 confidenceThreshold:(float)arg2 minIntersectionOverMinArea:(float)arg3 ;
// -(id)compareWithObjectDetectionTruth:(id)arg0 trackFilter:(id)arg1 minIntersectionOverMinArea:(unk)arg2  ;
...
-(id)initWithDetectionGroundTruth:(id)arg0 ;
...
-(void)writeHTMLReportComparison:(id)arg0 truth:(id)arg1 eventClass:(Class)arg2 comparisonType:(id)arg3 assetPath:(id)arg4 outputPath:(id)arg5 limit:(NSUInteger)arg6 ;
