...
@protocol HMIVideoCommandBufferDelegate, HMIVideoDecoderDelegate, HMIVideoEncoderDelegate, HMIVideoFrameSelectorDelegate, HMIVideoFrameAnalyzerDelegate, HMIVideoAssetWriterDelegate, HMIVideoFrameSamplerDelegate, HMIVideoPackageAnalyzerDelegate, OS_dispatch_queue;
...
#import "HMIVideoPackageAnalyzer.h"
...
@property (retain) NSDate *lastFragmentRecievedDate; // ivar: _lastFragmentRecievedDate
@property (readonly) HMIVideoPackageAnalyzer *packageAnalyzer; // ivar: _packageAnalyzer
@property (readonly) HMIVideoEventBuffer *packageAnalyzerFrameResultBuffer; // ivar: _packageAnalyzerFrameResultBuffer
