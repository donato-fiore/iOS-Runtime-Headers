...
@class NSString;
@protocol IMGifFileWriter, OS_xpc_object, OS_dispatch_queue;
...
+(id)sharedInstance;
-(BOOL)_connect;
-(BOOL)copyGifFileFromSourcePath:(id)arg0 toDestinationPath:(id)arg1 error:(*id)arg2 ;
-(id)init;
...
-(void)copyGifFileFromSourcePath:(id)arg0 toDestinationPath:(id)arg1 completionBlock:(id)arg2 ;
