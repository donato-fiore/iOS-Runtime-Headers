...
-(id)_buildGraphViewWithLabelDimension:(id)arg0 labelEndings:(NSInteger)arg1 ;
-(id)initWithMinimumHeight:(CGFloat)arg0 ;
-(id)initWithMinimumHeight:(CGFloat)arg0 labelDimension:(id)arg1 labelEndings:(NSInteger)arg2 ;
