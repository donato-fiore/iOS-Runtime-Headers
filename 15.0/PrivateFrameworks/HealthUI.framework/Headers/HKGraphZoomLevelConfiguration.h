...
+(id)_snappingStartDateWithStartDate:(id)arg0 velocity:(struct CGPoint )arg1 calendar:(id)arg2 timeScope:(NSInteger)arg3 options:(NSInteger)arg4 ;
...
+(id)chartDataRangeForTimeScope:(NSInteger)arg0 dataRange:(id)arg1 firstWeekday:(NSInteger)arg2 calendar:(id)arg3 cadence:(NSInteger)arg4 ;
...
+(id)snappingRangeForRange:(id)arg0 axisRange:(id)arg1 timeScope:(NSInteger)arg2 velocity:(struct CGPoint )arg3 calendar:(id)arg4 options:(NSInteger)arg5 ;
