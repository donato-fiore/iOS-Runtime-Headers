...
#ifndef WDGENERICDATAPROVIDERSECONDARYVALUE_H
#define WDGENERICDATAPROVIDERSECONDARYVALUE_H
...
@property (retain, nonatomic) NSString *formatString; // ivar: _formatString
