...
-(id)_activitySeriesForActivityValue:(NSInteger)arg0 wheelchairUseCharacteristicCache:(id)arg1 unitPreferenceController:(id)arg2 displayTypeController:(id)arg3 ;
...
-(id)_displayTypeForActivityValue:(NSInteger)arg0 yAxis:(id)arg1 dataProvider:(id)arg2 displayTypeController:(id)arg3 unitPreferenceController:(id)arg4 wheelchairUseCharacteristicCache:(id)arg5 timescopeToSummariesTable:(id)arg6 ;
-(id)_generateActivityBarSeriesWithColor:(id)arg0 legendTitle:(id)arg1 metGoalFillStyle:(id)arg2 missedGoalFillStyle:(id)arg3 activityValue:(NSInteger)arg4 unitPreferenceController:(id)arg5 displayTypeController:(id)arg6 ;
-(id)_generateActivityGoalLineSeriesWithColor:(id)arg0 ;
-(id)_lineColorForActivityValue:(NSInteger)arg0 ;
-(id)_metGoalFillStyleForActivityValue:(NSInteger)arg0 ;
-(id)_missedGoalFillStyleForActivityValue:(NSInteger)arg0 ;
