...
-(void)_enumeratePathsFromBlockCoordinates:(id)arg0 axisRect:(struct CGRect )arg1 zoomLevelConfiguration:(id)arg2 transform:(struct CGAffineTransform )arg3 presentationStyle:(id)arg4 handler:(id)arg5 ;
-(void)_enumerateSawToothPathsFromBlockCoordinates:(id)arg0 transform:(struct CGAffineTransform )arg1 zoomLevelConfiguration:(id)arg2 presentationStyle:(id)arg3 axisRect:(struct CGRect )arg4 handler:(id)arg5 ;
...
-(void)_renderPointLabelInContext:(struct CGContext *)arg0 renderingData:(struct ? )arg1 numberFormatter:(id)arg2 labelAttributes:(id)arg3 ;
-(void)_renderPointLabelsInContext:(struct CGContext *)arg0 blockCoordinates:(id)arg1 axisRect:(struct CGRect )arg2 pointTransform:(struct CGAffineTransform )arg3 presentationStyle:(id)arg4 zoomLevelConfiguration:(id)arg5 ;
...
-(void)addAxisAnnotationForValue:(CGFloat)arg0 ;
