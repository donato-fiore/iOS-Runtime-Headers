...
-(BOOL)_sendChunkMessage:(id)arg0 to:(id)arg1 packet:(id)arg2 requirement:(NSUInteger)arg3 error:(*id)arg4 ;
...
-(BOOL)sendChunkedMessage:(id)arg0 to:(id)arg1 requirement:(NSUInteger)arg2 error:(*id)arg3 ;
