...
-(void)_fetchRecordZoneIDWithOperationGroup:(id)arg0 completion:(id)arg1 ;
...
-(void)publishAssetDescriptor:(id)arg0 completion:(id)arg1 ;
-(void)publishKeyDescriptor:(id)arg0 completion:(id)arg1 ;
-(void)requestIdentifierTokenForCurrentUserWithCompletion:(id)arg0 ;
-(void)unpublishAssetDescriptorForFileName:(id)arg0 completion:(id)arg1 ;
