...
@class UIView, UILabel, UIImageView, CLKSymbolImageProvider, UIColor, NSString, CLKImageProvider;
@protocol NTKComplicationImageView, CLKFullColorImageView, CLKMonochromeFilterProvider;
