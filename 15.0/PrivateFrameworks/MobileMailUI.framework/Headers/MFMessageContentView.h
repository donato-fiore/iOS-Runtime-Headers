...
@class UIView, EFCancelationToken, NSMutableArray, UIBarButtonItem, NSMutableSet, NSSet, NSDictionary, NSArray, EMContentRepresentation, NSError, EMDaemonInterface, NSString, MFMessageLoadingContext, MFMessageContentLoadingView, MFMailboxProvider, UIScrollView, WKWebView;
@protocol UIPopoverPresentationControllerDelegate, _WKInputDelegate, WKNavigationDelegatePrivate, WKUIDelegatePrivate, MFHasMoreContentBannerViewDelegate, MFLoadBlockedContentBannerViewDelegate, MFLoadFailedProxyContentBannerViewDelegate, MFBlockedSenderBannerViewDelegate, MFMessageHeaderViewDelegate, MFMessageFooterViewDelegate, MFMailDropBannerDelegate, MFPresentationSource, UIScrollViewDelegate, EFSignpostable, MFMailWebProcessDelegate, MFReusable, EFCancelable, MFMessageContentViewDataSource, MFMessageContentViewDelegate, EFScheduler;
...
-(void)webProcessFailedToLoadResourceWithProxyForURL:(id)arg0 ;
