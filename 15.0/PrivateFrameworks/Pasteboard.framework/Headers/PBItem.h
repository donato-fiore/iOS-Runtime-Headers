...
-(void)_loadObjectOfClass:(Class)arg0 completionBlock:(id)arg1 ;
-(void)_loadRepresentationAsType:(id)arg0 completionBlock:(id)arg1 ;
...
-(void)loadObjectOfClass:(Class)arg0 completionBlock:(id)arg1 ;
...
-(void)uikit_loadObjectOfClass:(Class)arg0 completionBlock:(id)arg1 ;
