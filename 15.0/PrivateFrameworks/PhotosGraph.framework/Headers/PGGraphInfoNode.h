...
+(id)genericPropertiesWithCreationDate:(id)arg0 localeIdentifier:(id)arg1 languageIdentifiers:(id)arg2 geoServiceProviderID:(id)arg3 curationAlgorithmsVersion:(NSUInteger)arg4 ;
...
-(id)initWithCreationDate:(id)arg0 localeIdentifier:(id)arg1 languageIdentifiers:(id)arg2 geoServiceProviderID:(id)arg3 curationAlgorithmsVersion:(NSUInteger)arg4 ;
