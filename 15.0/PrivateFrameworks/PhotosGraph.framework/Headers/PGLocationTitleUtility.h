...
+(float)_weightForAreaNode:(id)arg0 withAddressNodes:(id)arg1 ;
...
+(id)_commonAOIComponentsForMomentNodes:(id)arg0 addressNodes:(id)arg1 aoiDisplayType:(NSUInteger)arg2 containsAmusementParkPOI:(BOOL)arg3 ;
...
+(id)_filteredAOINodeCombinationsForCombinations:(id)arg0 minSize:(NSUInteger)arg1 maxSize:(NSUInteger)arg2 maxTitleLength:(NSUInteger)arg3 minNumberOfAssets:(NSUInteger)arg4 aoiNodesToAddressNodesMapTable:(id)arg5 assetCountByAddressNodeIdentifier:(id)arg6 ;
+(id)_filteredAOINodesForAddressNodes:(id)arg0 aoiTitleMaximumLength:(NSUInteger)arg1 ;
...
+(id)_sortedAOINodeCombinationsForCombinations:(id)arg0 aoiNodesToAddressNodesMapTable:(id)arg1 assetCountByAddressNodeIdentifier:(id)arg2 ;
...
+(id)beautifiedLocationNodeStringWithPlaceNode:(id)arg0 ;
