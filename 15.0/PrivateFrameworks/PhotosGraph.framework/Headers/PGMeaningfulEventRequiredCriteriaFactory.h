...
+(id)_amusementParkCriteriaArrayWithGraph:(id)arg0 ;
+(id)_anniversaryCriteriaWithGraph:(id)arg0 ;
+(id)_beachingCriteriaWithGraph:(id)arg0 ;
+(id)_beachingSceneNodesWithGraph:(id)arg0 ;
+(id)_celebrationCriteriaWithGraph:(id)arg0 ;
+(id)_climbingCriteriaWithGraph:(id)arg0 ;
...
+(id)_divingCriteriaWithGraph:(id)arg0 ;
...
+(id)_hikingCriteriaWithGraph:(id)arg0 ;
+(id)_hikingSceneNodesWithGraph:(id)arg0 ;
+(id)_locationsTraitNotMatchingFrequentLocationsForGraph:(id)arg0 ;
+(id)_locationsTraitNotMatchingPeopleHomeWorkLocationsForGraph:(id)arg0 ;
...
+(id)_nightOutCriteriaArrayWithGraph:(id)arg0 ;
+(id)_performanceCriteriaWithGraph:(id)arg0 ;
+(id)_poiNodesForLabels:(id)arg0 inGraph:(id)arg1 ;
+(id)_publicEventCriteriaForCategoryWithName:(id)arg0 inGraph:(id)arg1 ;
+(id)_requiredCriteriaForIdentifiers:(id)arg0 inferenceType:(NSUInteger)arg1 graph:(id)arg2 ;
+(id)_restaurantCriteriaByCriteriaForIdentifiers:(id)arg0 withGraph:(id)arg1 ;
+(id)_roiNodesForLabels:(id)arg0 inGraph:(id)arg1 ;
...
+(id)_weddingCriteriaWithGraph:(id)arg0 ;
+(id)_weddingSceneNodesWithGraph:(id)arg0 includeWedding:(BOOL)arg1 ;
+(id)_winterSportCriteriaWithGraph:(id)arg0 ;
+(id)_winterSportSceneNodesWithGraph:(id)arg0 ;
+(id)availableMeaningLabels;
+(id)availablePersonActivityMeaningLabels;
+(id)requiredCriteriaByIdentifierWithGraph:(id)arg0 inferenceType:(NSUInteger)arg1 ;
+(id)requiredCriteriaForIdentifiers:(id)arg0 inferenceType:(NSUInteger)arg1 graph:(id)arg2 ;
+(void)_birthdayCriteriaWithGraph:(id)arg0 strongBirthdayCriteria:(*id)arg1 weakBirthdayCriteria:(*id)arg2 ;
