...
#ifndef PGGRAPHINGESTAUTONAMINGPROCESSOR_H
#define PGGRAPHINGESTAUTONAMINGPROCESSOR_H
...
+(BOOL)hasMeNodeAndMeContactInGraph:(id)arg0 ;
+(id)_personNodesWithoutContactInGraph:(id)arg0 ;
+(id)personNodesToNameInGraph:(id)arg0 ;
