...
@class NSData, NSString, NSDictionary, C2RequestOptions, NSMutableDictionary, NSDate, NSError, NSURL, NSNumber, NSMutableArray, NSURLRequest, NSInputStream, NSArray, NSHTTPURLResponse, NSMutableSet, NSURLSession, NSURLSessionDataTask;
@protocol C2RequestDelegate, CKDZoneGatekeeperWaiter, CKDFlowControllable, OS_os_activity, OS_dispatch_queue, OS_voucher;
...
@property (readonly, nonatomic) CKDFlowControlManager *cachedFlowControlManager; // ivar: _cachedFlowControlManager
...
@property (retain, nonatomic) CKDTapToRadarRequest *serverProvidedTapToRadarRequest; // ivar: _serverProvidedTapToRadarRequest
...
-(void)performOnLifecycleQueueIfNotFinished:(id)arg0 ;
-(void)performRequest;
