...
@class NSOperation, CKOperationMMCSRequestOptions, NSString, NSNumber, NSMutableArray, NSError, NSDate, CKOperationInfo, CKOperationMetrics, NSMutableDictionary, UMUserSyncTask;
@protocol CKThrottlingCriteria, CKDFlowControllable, OS_os_activity, OS_dispatch_queue, OS_dispatch_group, CKOperationCallbacks;
...
@property (retain, nonatomic) CKDOperationMetrics *MMCSMetrics; // ivar: _MMCSMetrics
...
@property (retain, nonatomic) CKDOperationMetrics *cloudKitMetrics; // ivar: _cloudKitMetrics
