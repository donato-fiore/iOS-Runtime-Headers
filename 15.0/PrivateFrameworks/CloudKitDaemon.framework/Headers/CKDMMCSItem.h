...
@class CKAsset, NSDictionary, NSData, NSString, NSFileHandle, NSURL, NSNumber, CKAssetDownloadPreauthorization, NSError, CKPackage, CKRecordID, NSMutableArray;
...
@property (nonatomic) BOOL inMemoryDownloadLooksOkay; // ivar: _inMemoryDownloadLooksOkay
...
-(id)getFileSizeWithContainer:(id)arg0 error:(*id)arg1 ;
-(id)getFileSizeWithError:(*id)arg0 ;
-(id)init;
-(id)initWithAsset:(id)arg0 ;
-(id)initWithPackage:(id)arg0 ;
-(id)openWithContainer:(id)arg0 error:(*id)arg1 ;
