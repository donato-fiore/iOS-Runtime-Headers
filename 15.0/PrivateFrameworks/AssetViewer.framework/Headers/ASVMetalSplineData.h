...
#ifndef ASVMETALSPLINEDATA_H
#define ASVMETALSPLINEDATA_H
...
@property (readonly, nonatomic) ASVControlPointContainer *recordedControlPoints; // ivar: _recordedControlPoints
@property ? recordedScale;
@property ? recordedTranslation;
@property (readonly, nonatomic) ASVBlendableSplineGroup *shapes; // ivar: _shapes
