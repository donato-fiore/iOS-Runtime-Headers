...
@property (retain, nonatomic) ASVWrappedButton *button; // ivar: _button
...
-(id)initWithImage:(id)arg0 buttonStyle:(NSInteger)arg1 textStyle:(NSInteger)arg2 controlStyle:(NSInteger)arg3 ;
