...
@property (copy, nonatomic) NSString *helpProductName; // ivar: _helpProductName
@property (copy, nonatomic) NSString *helpTopicID; // ivar: _helpTopicID
@property (copy, nonatomic) NSString *helpVersion; // ivar: _helpVersion
