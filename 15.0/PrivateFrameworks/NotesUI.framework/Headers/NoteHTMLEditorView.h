...
@protocol WKUIDelegatePrivate, _WKInputDelegate, UIScrollViewDelegate, WKNavigationDelegate, WKScriptMessageHandler, WKURLSchemeHandler, NoteHTMLEditorViewActionDelegate, NoteHTMLEditorViewDelegate, NoteHTMLEditorViewLayoutDelegate;
...
-(void)menuControllerDidHide:(id)arg0 ;
