...
-(void)insertedText:(id)arg0 replacementRange:(struct _NSRange )arg1 inTextView:(id)arg2 hashtagController:(id)arg3 mentionsController:(id)arg4 languageHasSpaces:(BOOL)arg5 ;
