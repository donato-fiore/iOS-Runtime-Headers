...
@protocol CNAvatarCacheChangeListenerDelegate, CNUILikenessRendering, CNUILikenessCachingRenderer, CNSchedulerProvider, OS_dispatch_source;
...
@property (readonly, nonatomic) CNAvatarCacheChangeListener *changeHistoryListener; // ivar: _changeHistoryListener
