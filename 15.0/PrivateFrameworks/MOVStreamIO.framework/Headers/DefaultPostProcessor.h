...
@property NSUInteger exactBytesPerRow; // ivar: exactBytesPerRow
...
-(struct __CVBuffer *)pixelBufferWithExactByterPerRow:(NSUInteger)arg0 fromPixelBuffer:(struct __CVBuffer *)arg1 error:(*id)arg2 ;
