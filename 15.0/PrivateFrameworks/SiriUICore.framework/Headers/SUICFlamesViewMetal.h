...
@class MTKView, CADisplayLink, NSMutableSet, NSMutableArray, UIScreen, UIImageView, NSString, UIColor, UIImage;
@protocol SUICFlamesViewProviding, MTLCommandQueue, MTLBuffer, SUICFlamesViewProvidingDelegate;
...
-(BOOL)_initMetalAndSetupDisplayLink:(BOOL)arg0 ;
...
-(void)_didSkipFrameUpdateWithReason:(id)arg0 andCount:(NSUInteger)arg1 ;
