...
@class UIView, UIImageView, NSMutableArray, UILabel, UITextField, UIColor, UIVisualEffectView;
...
-(void)dealloc;
-(void)drawFillForPathRect:(struct CGRect )arg0 roundedCorners:(int)arg1 cornerRadius:(CGFloat)arg2 ;
-(void)drawStrokeForPathRect:(struct CGRect )arg0 roundedCorners:(int)arg1 cornerRadius:(CGFloat)arg2 pathSegments:(int)arg3 ;
