...
@property (retain, nonatomic) CSAudioTimeConverter *defaultTimeConverter; // ivar: _defaultTimeConverter
@property (retain, nonatomic) NSMutableDictionary *pool; // ivar: _pool
@property (retain, nonatomic) NSObject<OS_dispatch_queue> *queue; // ivar: _queue


+(id)sharedInstance;
-(id)_getAudioTimeConverterWithDeviceId:(id)arg0 ;
-(id)converterForDeviceId:(id)arg0 ;
-(id)defaultConverter;
-(id)init;
