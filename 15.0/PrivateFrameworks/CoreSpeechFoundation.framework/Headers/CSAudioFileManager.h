...
+(id)_createAudioFileWriterForAdBlockerWithLoggingDir:(id)arg0 inputFormat:(struct AudioStreamBasicDescription )arg1 outputFormat:(struct AudioStreamBasicDescription )arg2 ;
...
+(id)createAudioFileWriterForAdBlockerWithInputFormat:(struct AudioStreamBasicDescription )arg0 outputFormat:(struct AudioStreamBasicDescription )arg1 ;
