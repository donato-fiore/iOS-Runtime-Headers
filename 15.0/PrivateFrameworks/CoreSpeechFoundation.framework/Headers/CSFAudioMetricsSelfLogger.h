...
-(void)logMHAssistantDaemonAudioRecordingContextWithMHUUID:(id)arg0 withAudioRecordingStarted:(BOOL)arg1 withAudioInputRoute:(int)arg2 withAudioSource:(int)arg3 ;
