...
-(BOOL)_parseDaemonPlist:(id)arg0 ;
-(id)_initAppWithProperties:(id)arg0 ;
-(id)_initDaemonOrAngelWithProperties:(id)arg0 path:(id)arg1 ;
-(id)_initXPCServiceWithProperties:(id)arg0 HostPid:(int)arg1 ;
-(id)resolvedIdentity;
