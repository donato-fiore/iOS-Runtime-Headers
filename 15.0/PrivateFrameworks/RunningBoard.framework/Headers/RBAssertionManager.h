...
@class NSMutableDictionary, NSCountedSet, NSMutableSet, NSMapTable, NSString;
...
-(id)_lock_updateStatesDueToChangingAssertions:(id)arg0 ;
...
-(void)_lock_invalidateAssertions:(id)arg0 ;
...
-(void)_lock_removeOriginatorExitTimesForProcessIdentifiersIfNecessary:(id)arg0 ;
