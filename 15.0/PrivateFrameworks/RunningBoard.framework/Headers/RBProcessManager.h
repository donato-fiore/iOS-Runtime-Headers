...
@protocol RBProcessManaging, RBStateCapturing, RBBundlePropertiesManaging, RBEntitlementManaging, RBProcessManagerDelegate;
...
-(id)init;
-(id)initWithBundlePropertiesManager:(id)arg0 entitlementManager:(id)arg1 delegate:(id)arg2 ;
