...
+(id)supportedCodecs;
+(id)supportedCodecsWithH265:(BOOL)arg0 vp9Profile0:(BOOL)arg1 vp9Profile2:(BOOL)arg2 ;
-(id)createEncoder:(id)arg0 ;
-(id)initWithH265:(BOOL)arg0 vp9Profile0:(BOOL)arg1 vp9Profile2:(BOOL)arg2 lowLatencyH264:(BOOL)arg3 ;
-(id)supportedCodecs;
