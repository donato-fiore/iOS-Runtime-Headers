...
typedef struct Storage<webrtc::DecodeTargetIndication, 10, std::allocator<webrtc::DecodeTargetIndication>> {
    CompressedTuple<std::allocator<webrtc::DecodeTargetIndication>, unsigned long> field0;
    Allocated field1;
    Inlined field2;
} Storage<webrtc::DecodeTargetIndication, 10, std::allocator<webrtc::DecodeTargetIndication>>;

typedef struct InlinedVector<webrtc::DecodeTargetIndication, 10, std::allocator<webrtc::DecodeTargetIndication>> {
    Storage<webrtc::DecodeTargetIndication, 10, std::allocator<webrtc::DecodeTargetIndication>> field0;
} InlinedVector<webrtc::DecodeTargetIndication, 10, std::allocator<webrtc::DecodeTargetIndication>>;

typedef struct CompressedTuple<std::allocator<int>, unsigned long> {
    NSUInteger field0;
} CompressedTuple<std::allocator<int>, unsigned long>;

typedef struct Storage<int, 4, std::allocator<int>> {
    CompressedTuple<std::allocator<int>, unsigned long> field0;
    Allocated field1;
    Inlined field2;
} Storage<int, 4, std::allocator<int>>;

typedef struct InlinedVector<int, 4, std::allocator<int>> {
    Storage<int, 4, std::allocator<int>> field0;
} InlinedVector<int, 4, std::allocator<int>>;
...
typedef struct Storage<webrtc::CodecBufferUsage, 8, std::allocator<webrtc::CodecBufferUsage>> {
    CompressedTuple<std::allocator<webrtc::CodecBufferUsage>, unsigned long> field0;
    Allocated field1;
    Inlined field2;
} Storage<webrtc::CodecBufferUsage, 8, std::allocator<webrtc::CodecBufferUsage>>;

typedef struct InlinedVector<webrtc::CodecBufferUsage, 8, std::allocator<webrtc::CodecBufferUsage>> {
    Storage<webrtc::CodecBufferUsage, 8, std::allocator<webrtc::CodecBufferUsage>> field0;
} InlinedVector<webrtc::CodecBufferUsage, 8, std::allocator<webrtc::CodecBufferUsage>>;
...
typedef struct GenericFrameInfo {
    int field0;
    int field1;
    InlinedVector<webrtc::DecodeTargetIndication, 10, std::allocator<webrtc::DecodeTargetIndication>> field2;
    InlinedVector<int, 4, std::allocator<int>> field3;
    InlinedVector<int, 4, std::allocator<int>> field4;
    InlinedVector<webrtc::CodecBufferUsage, 8, std::allocator<webrtc::CodecBufferUsage>> field5;
...
typedef struct Storage<int, 10, std::allocator<int>> {
    CompressedTuple<std::allocator<int>, unsigned long> field0;
    Allocated field1;
    Inlined field2;
} Storage<int, 10, std::allocator<int>>;

typedef struct InlinedVector<int, 10, std::allocator<int>> {
    Storage<int, 10, std::allocator<int>> field0;
} InlinedVector<int, 10, std::allocator<int>>;
...
typedef struct Storage<webrtc::RenderResolution, 4, std::allocator<webrtc::RenderResolution>> {
    CompressedTuple<std::allocator<webrtc::RenderResolution>, unsigned long> field0;
    Allocated field1;
    Inlined field2;
} Storage<webrtc::RenderResolution, 4, std::allocator<webrtc::RenderResolution>>;

typedef struct InlinedVector<webrtc::RenderResolution, 4, std::allocator<webrtc::RenderResolution>> {
    Storage<webrtc::RenderResolution, 4, std::allocator<webrtc::RenderResolution>> field0;
} InlinedVector<webrtc::RenderResolution, 4, std::allocator<webrtc::RenderResolution>>;
...
typedef struct FrameDependencyStructure {
    ...
    int field1;
    int field2;
    InlinedVector<int, 10, std::allocator<int>> field3;
    InlinedVector<webrtc::RenderResolution, 4, std::allocator<webrtc::RenderResolution>> field4;
...
typedef struct EncodedImage {
    ...
    map<int, unsigned long, std::less<int>, std::allocator<std::pair<const int, unsigned long>>> field14;
    optional<webrtc::ColorSpace> field15;
    optional<unsigned short> field16;
    RtpPacketInfos field17;
    BOOL field18;
} EncodedImage;
...
typedef struct VideoCodec {
    ...
    SpatialLayer field10;
    SpatialLayer field11;
    int field12;
    BOOL field13;
    optional<int> field14;
    TimingFrameTriggerThresholds field15;
    BOOL field16;
    int field17;
    CGFloat field18;
    ...
    char field21;
    int field22;
    VideoCodecVP8 field23;
    VideoCodecVP9 field24;
    VideoCodecH264 field25;
    basic_string<char, std::char_traits<char>, std::allocator<char>> field26;
} VideoCodec;
