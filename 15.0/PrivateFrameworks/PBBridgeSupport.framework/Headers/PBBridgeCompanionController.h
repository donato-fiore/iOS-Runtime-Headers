...
@class NSURLConnection, NSMutableData, NSMutableURLRequest, NSDictionary, NSString, RUIStyle, NSMutableDictionary, RUILoader;
...
@property (retain, nonatomic) NSMutableDictionary *reportMapping; // ivar: _reportMapping
...
-(id)init;
-(id)reporterForConnection:(id)arg0 ;
...
-(void)setReporter:(id)arg0 forConnection:(id)arg1 ;
...
-(void)tellGizmoToSeCrownOrientationRight:(BOOL)arg0 ;
...
-(void)tellWatchLanguagesAndLocaleWithCompletion:(id)arg0 ;
