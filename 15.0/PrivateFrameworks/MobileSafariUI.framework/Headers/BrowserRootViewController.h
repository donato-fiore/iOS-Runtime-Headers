...
@class UIViewController, UIApplication, UITapGestureRecognizer, UIPanGestureRecognizer, UIButton, UIView, SFThemeColorEffectView, SFUnifiedBarTheme, SFBannerTheme, NSArray, NSNumber, _SFBrowserConfiguration, NSString, _SFDigitalHealthViewController, _SFDynamicBarAnimator, UIView<_SFBarCommon>, UIView<_SFNavigationBarCommon>, UIRefreshControl, UIScrollView, UIBarButtonItem, UIView<TabThumbnailCollectionView>, _SFWebExtensionPermissionBanner, _SFWebView;
@protocol TabBarDropExpansionViewDelegate, UIGestureRecognizerDelegate, SidebarContentDimmingViewDelegate, SFOrderedContainerViewDelegate, UIViewControllerStatusBarPartStyleProvider, CapsuleNavigationBarViewControllerDelegate, SFCapsuleCollectionViewGestureObserving, _SFDigitalHealthHostingViewController, TabDocumentViewGeometryProviding, BrowserRootViewControllerDelegate;
...
@property (retain, nonatomic) _SFWebExtensionPermissionBanner *webExtensionBanner; // ivar: _webExtensionBanner
...
-(BOOL)shouldModifyWebViewGeometryForTabDocumentView:(id)arg0 ;
-(CGFloat)_bottomBarOffset;
-(CGFloat)_keyboardInsetInCoordinateSpaceIfObscuringInsets:(id)arg0 ;
...
-(id)capsuleNavigationBarViewController:(id)arg0 rectsForTapToUnminimizeBarWithDefaultRects:(id)arg1 ;
