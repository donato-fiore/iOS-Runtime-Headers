...
@class WBSCloudTabStore, WBSEncryptedCloudKeyValueStore, NSTimer, NSMutableArray, NSDate, NSUUID, NSString;
...
@interface CloudTabStore : WBSCloudTabStore <WBSCloudTabStoreDelegate>

 {
    ...
    NSInteger _periodicUpdateRequestCount;
...
-(void)_refreshTimerDidFire:(id)arg0 ;
...
-(void)synchronizeCloudTabDevicesWithCompletionHandler:(id)arg0 ;
