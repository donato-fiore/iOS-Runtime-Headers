...
@protocol BookmarkFavoritesViewControllerDelegate, BookmarksTableViewControllerDelegate, HistoryTableViewControllerDelegate, ReadingListViewControllerDelegate, _SFBookmarkInfoViewControllerDelegate, UINavigationBarDelegate, UINavigationControllerDelegate, _SFNavigationIntentHandling, OS_dispatch_queue, BookmarksNavigationControllerDelegate, LinkPreviewProvider, TabGroupProvider;
...
@property (nonatomic) BOOL adjustedForSidebar; // ivar: _adjustedForSidebar
...
@property (nonatomic) BOOL isShowingPopover; // ivar: _isShowingPopover
...
-(BOOL)bookmarkFavoritesViewControllerIsPresentedInsideBlankTab:(id)arg0 ;
...
-(NSInteger)bookmarkFavoritesViewControllerFavoritesGridViewLayoutType:(id)arg0 ;
-(id)_favoritesFolderBasedOnContentRestriction;
-(id)_initWithBookmarksDelegate:(id)arg0 linkPreviewProvider:(id)arg1 topBookmark:(id)arg2 skipOffset:(unsigned int)arg3 showOnlyFavorites:(BOOL)arg4 activeCollection:(id)arg5 showOnlyActiveCollection:(BOOL)arg6 ;
...
-(id)initShowingOnlyFavoritesWithBookmarksDelegate:(id)arg0 linkPreviewProvider:(id)arg1 ;
-(id)initWithBookmarksDelegate:(id)arg0 linkPreviewProvider:(id)arg1 ;
-(id)initWithBookmarksDelegate:(id)arg0 linkPreviewProvider:(id)arg1 collection:(id)arg2 ;
...
-(struct CGSize )_segmentedControlItemOffsetForCollection:(id)arg0 ;
-(struct UIEdgeInsets )contentInsetForBookmarksTableViewController:(id)arg0 ;
-(struct UIEdgeInsets )contentInsetForFavoritesViewController:(id)arg0 ;
...
-(void)bookmarkFavoritesViewController:(id)arg0 editBookmark:(id)arg1 ;
-(void)bookmarkFavoritesViewController:(id)arg0 provideContextResponseWithBlock:(id)arg1 ;
-(void)bookmarkFavoritesViewControllerContentDidBecomeDirty:(id)arg0 ;
...
-(void)dealloc;
-(void)didTapOutsideBookmarkFavoritesViewController:(id)arg0 ;
...
-(void)historyTableViewControllerDidDismissPopover:(id)arg0 ;
-(void)historyTableViewControllerDidEndEditing:(id)arg0 ;
-(void)historyTableViewControllerDidPresentPopover:(id)arg0 ;
