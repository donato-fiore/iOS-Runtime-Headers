...
@property (retain, nonatomic) _SFPinnableBanner *appBanner; // ivar: _appBanner
...
@property (retain, nonatomic) SFBannerTheme *bannerTheme; // ivar: _bannerTheme
...
@property (readonly, nonatomic) FindOnPageView *findOnPageView; // ivar: _findOnPageView
...
@property (copy, nonatomic) NSString *lastSearchQuery; // ivar: _lastSearchQuery
...
@property (readonly, nonatomic) WBLocalTabAttributes *localAttributes; // ivar: _localAttributes
...
@property (readonly, nonatomic) TiltedTabItem *tiltedTabItem; // ivar: _tiltedTabItem
...
@property (readonly, nonatomic) BOOL wasRecentlyUnhibernated; // ivar: _wasRecentlyUnhibernated
...
-(BOOL)sfWebView:(id)arg0 shouldAllowGestureToRecognizeSimultaneoulsyWithTouchEvents:(id)arg1 ;
...
-(void)_webView:(id)arg0 didTapAtPoint:(struct CGPoint )arg1 withResult:(NSInteger)arg2 ;
...
-(void)linkPreviewHelperWillOpenUniveralLinkLocally:(id)arg0 ;
...
-(void)updateFindCompletionProviderWithMatchesCount:(NSUInteger)arg0 forString:(id)arg1 forFindOnPageView:(id)arg2 ;
