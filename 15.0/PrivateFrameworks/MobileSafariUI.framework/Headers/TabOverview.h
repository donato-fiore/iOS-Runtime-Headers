...
@class UIView, NSHashTable, CADisplayLink, NSArray, UITapGestureRecognizer, UIPointerInteraction, NSMutableSet, UIVisualEffectView, UISearchBar, NSIndexSet, NSTimer, NSMutableArray, SFGradientView, NSString, UIButton, UITextInputPasswordRules;
@protocol CloudTabTableDelegate, ReorderingAutoscrollerDelegate, _UIBasicAnimationFactory, _UIScrollToTopView, UIGestureRecognizerDelegate, UIPointerInteractionDelegate, UISearchBarDelegate, UISearchBarDelegate_Private, UIKeyInput, TabThumbnailCollectionView, TabOverviewDelegate;


#import "TabOverviewInterpolatedLocation.h"
#import "ScrollingPanGestureRecognizer.h"
...
@interface TabOverview : UIView <CloudTabTableDelegate, ReorderingAutoscrollerDelegate, _UIBasicAnimationFactory, _UIScrollToTopView, UIGestureRecognizerDelegate, UIPointerInteractionDelegate, UISearchBarDelegate, UISearchBarDelegate_Private, UIKeyInput, TabThumbnailCollectionView>

 {
    ...
    BOOL _shouldAnimateSearchBarTransition;
...
-(void)takeOwnershipOfAttachedViewForItem:(id)arg0 ;
