...
@class UIApplication, NSMutableSet, NSString, WBSFormAutoFillCorrectionsHistoryObserver, WBDatabaseLockAcquisitor, SBSAssertion, WBSCyclerConnectionManager, NSMutableArray, WBSForYouRecentParsecResultsManager, WBSParsecABGroupManager, WBSPhishingClassifierController, WBSAllowedLegacyTLSHostManager, WBSavedStateManager, WBTabGroupManager, NSArray, UIWindow;
@protocol PageLoadTestRunnerDelegate, TabSnapshotCacheStressTestRunnerDelegate, MCProfileConnectionObserver, UIApplicationDelegatePrivate, WBDatabaseLockAcquisitorDelegate, SFUIApplicationModifierFlagsProviding, _SFDownloadDelegate, BKSMousePointerDeviceObserver, WBSSystemNoteTakingControllerDelegate, SFWebExtensionsControllerDelegate, UIApplicationDelegate, _SFNavigationIntentHandling, BSInvalidatable, WBSCloudHistoryServiceProtocol, WBStateProvider, NSObject, WBSPhishingClassifier;
