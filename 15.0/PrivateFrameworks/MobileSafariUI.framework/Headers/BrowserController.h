...
-(BOOL)browserViewControllerShouldModifyWebViewGeometry:(id)arg0 ;
-(BOOL)browserViewControllerShouldTemporarilyHideBottomToolbar:(id)arg0 ;
-(BOOL)canBecomeFirstResponder;
-(BOOL)canHideBars;
-(BOOL)canPerformAction:(SEL)arg0 withSender:(id)arg1 ;
-(BOOL)catalogViewController:(id)arg0 shouldBeginDismissGestureUsingStyle:(NSInteger)arg1 ;
...
-(BOOL)shouldIncludeWebExtensionActivitiesForActionPanelMenuStyle:(NSInteger)arg0 ;
...
-(NSInteger)bookmarksNavigationControllerFavoritesGridViewLayoutType:(id)arg0 ;
...
-(id)blankTabTitleForTabDocument:(id)arg0 ;
...
-(void)backForwardListTableViewControllerDidSelectParentItem:(id)arg0 ;
-(void)backForwardTableViewController:(id)arg0 configureNavigationIntentForDrag:(id)arg1 ;
-(void)backForwardTableViewController:(id)arg0 didSelectItem:(id)arg1 ;
...
-(void)tabBarManager:(id)arg0 didRemoveTabBar:(id)arg1 ;
...
-(void)updatePopoverPositionAfterTransitionFromHorizontalSizeClass:(NSInteger)arg0 toHorizontalSizeClass:(NSInteger)arg1 ;
