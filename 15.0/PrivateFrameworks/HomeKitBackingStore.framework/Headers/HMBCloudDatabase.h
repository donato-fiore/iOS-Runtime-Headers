...
@protocol HMBCloudPushObserver, HMFLogging, HMBCloudDatabaseDelegate;
...
-(id)initWithLocalDatabase:(id)arg0 stateZone:(id)arg1 container:(id)arg2 configuration:(id)arg3 databaseStateModelsByScope:(id)arg4 zoneStateModels:(id)arg5 ;
-(id)logIdentifier;
