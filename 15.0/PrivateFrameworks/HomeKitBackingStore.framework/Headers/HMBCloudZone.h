...
@class HMFObject, CKDatabase, NSString, NSArray, NAFuture, NSMutableDictionary, NSMapTable, NSSet, HMFUnfairLock, NSMutableSet, NSOperationQueue, NSUUID;
...
-(id)_handleLeaveCloudShareErrorUsingCloudZoneRecordPushResult:(id)arg0 ;
-(id)_leaveCloudShareRequestingNewInvitationToken:(BOOL)arg0 allowCloudPull:(BOOL)arg1 ;
-(id)_pushDeletedParticipantRecordID:(id)arg0 ;
