...
@class NSHashTable, CoreTelephonyClient, NSArray, NWPathEvaluator, NSString;
@protocol CoreTelephonyClientRegistrationDelegate, CoreTelephonyClientCarrierBundleDelegate, OS_dispatch_queue;
