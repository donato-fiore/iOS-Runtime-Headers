...
@property (nonatomic) int nwarpings_icp; // ivar: _nwarpings_icp
...
-(id)initWithMetalContext:(id)arg0 ICPtransform:(NSInteger)arg1 width:(int)arg2 height:(int)arg3 nscales:(int)arg4 ;
...
-(int)_computeHomographyWithCommandBuffer:(id)arg0 in_tex0:(id)arg1 in_tex1:(id)arg2 in_tex2:(id)arg3 weight_tex:(id)arg4 regularizer_term:(float)arg5 ;
...
-(int)_initMemoryICP;
-(int)_panoRegistration:(struct ? )arg0 ;
...
-(void)_dumpTextureFloat:(id)arg0 withName:(char *)arg1 float16:(BOOL)arg2 ;
