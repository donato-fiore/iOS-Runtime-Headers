...
-(BOOL)requestExistenceCheckForRule:(id)arg0 error:(*id)arg1 ;
-(BOOL)requestFullFetchForRule:(id)arg0 error:(*id)arg1 ;
-(BOOL)requestFullFetchOfRecordWithScopedIdentifier:(id)arg0 forRule:(id)arg1 error:(*id)arg2 ;
-(id)description;
