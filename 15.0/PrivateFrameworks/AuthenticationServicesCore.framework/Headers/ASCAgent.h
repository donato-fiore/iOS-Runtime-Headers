...
@class NSArray, NSXPCConnection, NSString, ASPublicKeyCredentialManager;
@protocol ASPublicKeyCredentialManagerDelegate, ASCAuthorizationPresenterDelegate, ASCAgentProtocol;
