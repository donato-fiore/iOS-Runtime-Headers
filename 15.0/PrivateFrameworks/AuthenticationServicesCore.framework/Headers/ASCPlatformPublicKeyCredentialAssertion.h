...
-(id)_initWithRelyingPartyIdentifier:(id)arg0 authenticatorData:(id)arg1 signature:(id)arg2 userHandle:(id)arg3 rawClientDataJSON:(id)arg4 credentialID:(id)arg5 ;
-(id)initWithCoder:(id)arg0 ;
-(id)initWithRelyingPartyIdentifier:(id)arg0 authenticatorAssertionResponse:(id)arg1 ;
