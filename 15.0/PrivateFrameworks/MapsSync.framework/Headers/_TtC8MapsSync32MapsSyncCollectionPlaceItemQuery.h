...
#ifndef _TTC8MAPSSYNC32MAPSSYNCCOLLECTIONPLACEITEMQUERY_H
#define _TTC8MAPSSYNC32MAPSSYNCCOLLECTIONPLACEITEMQUERY_H

@class TtC8MapsSync17MapsSyncBaseQuery;



@interface _TtC8MapsSync32MapsSyncCollectionPlaceItemQuery : TtC8MapsSync17MapsSyncBaseQuery {
    ? _specifiedQuery;
}
