...
#ifndef _TTC8MAPSSYNC22MAPSSYNCRAPRECORDQUERY_H
#define _TTC8MAPSSYNC22MAPSSYNCRAPRECORDQUERY_H

@class TtC8MapsSync17MapsSyncBaseQuery;



@interface _TtC8MapsSync22MapsSyncRAPRecordQuery : TtC8MapsSync17MapsSyncBaseQuery {
    ? _specifiedQuery;
}
