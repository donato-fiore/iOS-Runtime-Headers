...
#ifndef _TTC8MAPSSYNC20MAPSSYNCVEHICLEQUERY_H
#define _TTC8MAPSSYNC20MAPSSYNCVEHICLEQUERY_H

@class TtC8MapsSync17MapsSyncBaseQuery;



@interface _TtC8MapsSync20MapsSyncVehicleQuery : TtC8MapsSync17MapsSyncBaseQuery {
    ? _specifiedQuery;
}
