...
#ifndef _TTC8MAPSSYNC30MAPSSYNCCURATEDCOLLECTIONQUERY_H
#define _TTC8MAPSSYNC30MAPSSYNCCURATEDCOLLECTIONQUERY_H

@class TtC8MapsSync17MapsSyncBaseQuery;



@interface _TtC8MapsSync30MapsSyncCuratedCollectionQuery : TtC8MapsSync17MapsSyncBaseQuery {
    ? _specifiedQuery;
}
