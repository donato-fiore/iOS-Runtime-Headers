...
@class NSString;
@protocol HMECachedEventSource, HMELastEventStoreWriter, HMETopicRouterDelegate, HMESubscriptionProviding, OS_os_log, HMELastEventStoreReadHandle, HMELastEventStoreWriteHandle, HMERouterClientDelegate, OS_dispatch_queue;
