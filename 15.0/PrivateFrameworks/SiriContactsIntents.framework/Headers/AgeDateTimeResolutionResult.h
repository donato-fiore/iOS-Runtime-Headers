...
#ifndef AGEDATETIMERESOLUTIONRESULT_H
#define AGEDATETIMERESOLUTIONRESULT_H
...
+(id)confirmationRequiredWithAgeDateTimeToConfirm:(id)arg0 ;
+(id)confirmationRequiredWithObjectToConfirm:(id)arg0 ;
+(id)disambiguationWithAgeDateTimesToDisambiguate:(id)arg0 ;
+(id)disambiguationWithObjectsToDisambiguate:(id)arg0 ;
+(id)successWithResolvedAgeDateTime:(id)arg0 ;
