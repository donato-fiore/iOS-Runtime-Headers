...
@class NSString, NSUUID, NSMutableDictionary, NSURL;
...
@property (readonly, nonatomic) NSMutableDictionary *memoryEdgesByLabel; // ivar: _memoryEdgesByLabel
@property (readonly, nonatomic) NSMutableDictionary *memoryNodeByIdentifier; // ivar: _memoryNodeByIdentifier
@property (readonly, nonatomic) NSMutableDictionary *memoryNodesByLabel; // ivar: _memoryNodesByLabel
...
-(id)insertEdgeWithIdentifier:(NSUInteger)arg0 labels:(id)arg1 weight:(float)arg2 properties:(id)arg3 sourceNodeIdentifier:(NSUInteger)arg4 targetNodeIdentifier:(NSUInteger)arg5 error:(*id)arg6 ;
-(id)insertNodeWithIdentifier:(NSUInteger)arg0 labels:(id)arg1 weight:(float)arg2 properties:(id)arg3 error:(*id)arg4 ;
