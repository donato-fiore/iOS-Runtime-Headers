...
@class NSMutableDictionary, NSArray, NSMapTable, NSString, NSSet, CNContact, NSDecimalNumber;
...
@property (retain, nonatomic) CNContact *billingAddress; // ivar: _billingAddress
