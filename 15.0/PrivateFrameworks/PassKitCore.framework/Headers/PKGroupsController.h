...
@class NSMutableArray, NSMutableDictionary, NSArray, NSSet, NSString;
...
-(id)_displayablePassesDictionaryFromSet:(id)arg0 ;
...
-(id)initWithPassTypeMask:(NSUInteger)arg0 passFilters:(NSUInteger)arg1 ;
