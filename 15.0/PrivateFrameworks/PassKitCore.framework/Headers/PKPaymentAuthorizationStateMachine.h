...
-(BOOL)_canUpdateWithTokenConfiguration:(id)arg0 error:(*id)arg1 ;
-(BOOL)_isTokenConfigurationSupported:(id)arg0 ;
...
-(id)_rewrapRequestWithParam:(id)arg0 serviceURL:(*id)arg1 ;
...
-(void)_performSendClientUpdateWithShippingMethods:(id)arg0 paymentSummaryItems:(id)arg1 tokenConfiguration:(id)arg2 paymentApplication:(id)arg3 status:(NSInteger)arg4 ;
...
-(void)_updateModelWithShippingMethods:(id)arg0 paymentSummaryItems:(id)arg1 tokenConfiguration:(id)arg2 contentItems:(id)arg3 ;
