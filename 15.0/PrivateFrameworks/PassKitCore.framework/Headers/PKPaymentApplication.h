...
@property (nonatomic) BOOL supportsMultiTokens; // ivar: _supportsMultiTokens
...
-(BOOL)acceptedForNonWebPaymentWithSupportedNetworkIdentifiers:(id)arg0 merchantCapabilities:(NSUInteger)arg1 merchantCountryCode:(id)arg2 paymentMode:(NSInteger)arg3 paymentApplicationStates:(id)arg4 ;
...
-(BOOL)acceptedForWebPaymentWithSupportedNetworkIdentifiers:(id)arg0 merchantCapabilities:(NSUInteger)arg1 merchantCountryCode:(id)arg2 paymentMode:(NSInteger)arg3 paymentApplicationStates:(id)arg4 webService:(id)arg5 ;
