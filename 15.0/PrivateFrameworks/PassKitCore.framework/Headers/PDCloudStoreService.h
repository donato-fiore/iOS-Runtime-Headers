...
#ifndef PDCLOUDSTORESERVICE_H
#define PDCLOUDSTORESERVICE_H

@class PDCloudStoreNotificationCoordinator, NSString;
...
@property (retain, nonatomic) PDCloudStoreNotificationCoordinator *cloudStoreNotificationCoordinator; // ivar: _cloudStoreNotificationCoordinator
...
-(void)recreateZone:(id)arg0 completion:(id)arg1 ;
