...
@class NSURLSession, NSMutableDictionary, NSOperationQueue, NSHashTable, NSString, NSArray, NSURL;
...
-(NSUInteger)accountStatementActionWithRequest:(id)arg0 completion:(id)arg1 ;
