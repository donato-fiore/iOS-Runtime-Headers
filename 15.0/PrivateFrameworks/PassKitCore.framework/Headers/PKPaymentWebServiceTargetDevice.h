...
-(void)_addSharingInvitationReceipts:(id)arg0 onCredentialWithIdentifier:(id)arg1 completion:(id)arg2 ;
-(void)_addSubcredential:(id)arg0 fromSharingInvitation:(id)arg1 withCompletion:(id)arg2 ;
...
-(void)paymentWebService:(id)arg0 addSharingInvitationReceipts:(id)arg1 onCredential:(id)arg2 withCompletion:(id)arg3 ;
-(void)paymentWebService:(id)arg0 addSubcredential:(id)arg1 fromSharingInvitation:(id)arg2 withCompletion:(id)arg3 ;
...
-(void)paymentWebService:(id)arg0 revokeSharedCredentialGroup:(id)arg1 withCompletion:(id)arg2 ;
