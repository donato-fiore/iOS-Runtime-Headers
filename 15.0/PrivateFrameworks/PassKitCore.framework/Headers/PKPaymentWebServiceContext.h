...
@class NSMutableDictionary, NSDictionary, NSArray, NSString, NSDate, NSURL;
...
-(id)applyServiceLocalizationBundleForFeatureIdentifier:(NSUInteger)arg0 ;
-(id)applyServicePreferredLanguageForFeatureIdentifier:(NSUInteger)arg0 ;
