...
-(void)saveToCalendarWithParentASEvent:(id)arg0 existingRecord:(*void)arg1 isDefaultCalendar:(BOOL)arg2 shouldMergeProperties:(BOOL)arg3 outMergeDidChooseLocalProperties:(*BOOL)arg4 ;
