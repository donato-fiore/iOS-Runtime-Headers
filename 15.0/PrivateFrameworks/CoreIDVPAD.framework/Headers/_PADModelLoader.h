...
@class NSString;
@protocol PADModelLoader, PADAlgorithms;

#import <Foundation/Foundation.h>

#import "PADVNFacePoseModel.h"
#import "PADVNPrintReplayS1Model.h"
...
@property (readonly, nonatomic) PADVNPrintReplayS1Model *printReplayS1Model; // ivar: _printReplayS1Model
