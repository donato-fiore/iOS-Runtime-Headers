...
-(id)backgroundColor;
-(id)initWithContainerSize:(struct CGSize )arg0 insets:(struct UIEdgeInsets )arg1 screenScale:(CGFloat)arg2 RTL:(BOOL)arg3 showSideGroupPicker:(BOOL)arg4 ;
-(id)initWithContainerSize:(struct CGSize )arg0 insets:(struct UIEdgeInsets )arg1 screenScale:(CGFloat)arg2 RTL:(BOOL)arg3 showSideGroupPicker:(BOOL)arg4 maxGroupLabelWidth:(CGFloat)arg5 ;
