...
#ifndef SFSTOCKCHARTCARDSECTION_H
#define SFSTOCKCHARTCARDSECTION_H

@class NSString, NSArray, NSData, NSDictionary, NSURL;
@protocol SFStockChartCardSection, NSSecureCoding, NSCopying;
...
@property (copy, nonatomic) NSURL *thirdPartyContentURL; // ivar: _thirdPartyContentURL
