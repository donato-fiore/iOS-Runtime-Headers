...
#ifndef SFFLIGHTCARDSECTION_H
#define SFFLIGHTCARDSECTION_H

@class NSString, NSArray, NSDictionary, NSData;
@protocol SFFlightCardSection, NSSecureCoding, NSCopying;
...
@property (retain, nonatomic) SFFlight *flight; // ivar: _flight
...
@property (nonatomic) NSUInteger selectedLegIndex; // ivar: _selectedLegIndex
