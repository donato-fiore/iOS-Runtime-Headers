...
#ifndef SFCOLLECTIONCARDSECTION_H
#define SFCOLLECTIONCARDSECTION_H

@class NSString, NSArray, NSDictionary, NSData;
@protocol SFCollectionCardSection, NSSecureCoding, NSCopying;
...
@property (retain, nonatomic) SFCollectionStyle *collectionStyle; // ivar: _collectionStyle
