...
@protocol SFMediaInfoCardSection, NSSecureCoding, NSCopying;
...
@property (retain, nonatomic) SFMediaItem *mediaItem; // ivar: _mediaItem
...
@property (retain, nonatomic) SFRichText *specialOfferButtonLabel; // ivar: _specialOfferButtonLabel
