...
#ifndef SFNOWPLAYINGCARDSECTION_H
#define SFNOWPLAYINGCARDSECTION_H

@class NSString, NSArray, NSDictionary, NSData;
@protocol SFNowPlayingCardSection, NSSecureCoding, NSCopying;
...
@property (copy, nonatomic) NSArray *movies; // ivar: _movies
