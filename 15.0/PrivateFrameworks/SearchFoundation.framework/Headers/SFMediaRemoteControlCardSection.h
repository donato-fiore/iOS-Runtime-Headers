...
#ifndef SFMEDIAREMOTECONTROLCARDSECTION_H
#define SFMEDIAREMOTECONTROLCARDSECTION_H

@class NSString, NSArray, NSDictionary, NSData;
@protocol SFMediaRemoteControlCardSection, NSSecureCoding, NSCopying;
...
@property (copy, nonatomic) NSString *playbackBundleIdentifier; // ivar: _playbackBundleIdentifier
@property (copy, nonatomic) NSString *playbackRouteUniqueIdentifier; // ivar: _playbackRouteUniqueIdentifier
@property (nonatomic) BOOL playbackRouteUniqueIdentifierIsEncrypted; // ivar: _playbackRouteUniqueIdentifierIsEncrypted
