...
#ifndef SFAPPLINKCARDSECTION_H
#define SFAPPLINKCARDSECTION_H

@class NSArray, NSString, NSDictionary, NSData;
@protocol SFAppLinkCardSection, NSSecureCoding, NSCopying;
...
@property (copy, nonatomic) NSArray *appLinks; // ivar: _appLinks
