...
#ifndef _SFPBKEYVALUEDATACARDSECTION_H
#define _SFPBKEYVALUEDATACARDSECTION_H

@class PBCodable, NSArray, NSString, NSData;
@protocol _SFPBKeyValueDataCardSection, NSSecureCoding;
...
@property (retain, nonatomic) _SFPBImage *accessoryImage; // ivar: _accessoryImage
