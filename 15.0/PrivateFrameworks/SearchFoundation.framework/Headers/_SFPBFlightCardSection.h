...
@protocol _SFPBFlightCardSection, NSSecureCoding;
...
@property (retain, nonatomic) _SFPBFlight *flight; // ivar: _flight
...
@property (nonatomic) unsigned int selectedLegIndex; // ivar: _selectedLegIndex
