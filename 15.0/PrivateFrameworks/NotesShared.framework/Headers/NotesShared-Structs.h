...
typedef struct vector<ICDrawingOutputPoint, std::allocator<ICDrawingOutputPoint>> {
} // Error Processing Struct Fields
...
typedef struct NoteDocument {
} // Error Processing Struct Fields

typedef struct LegacyNoteDocument {
} // Error Processing Struct Fields

typedef struct Document {
    unk _vptr$MessageLite;
    basic_string<char, std::char_traits<char>, std::allocator<char>> _unknown_fields_;
    unsigned int _has_bits_;
    int _cached_size_;
