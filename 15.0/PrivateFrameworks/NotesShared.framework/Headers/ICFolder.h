...
@class NSArray, NSSet, NSDate, NSNumber, NSString, NSData;
...
+(NSUInteger)countOfVisibleSmartFoldersForHashtagStandardizedContent:(id)arg0 account:(id)arg1 ;
...
+(id)paperFoldersWithManagedObjectContext:(id)arg0 ;
...
-(BOOL)validateTitle:(*id)arg0 error:(*id)arg1 ;
...
-(void)recrusivelyAddSubfoldersToArray:(id)arg0 ;
