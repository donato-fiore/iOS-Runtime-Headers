...
-(void)spanizeAsr:(id)arg0 tokenChain:(id)arg1 spans:(id)arg2 isTopAsr:(BOOL)arg3 topAsrSpansFiltered:(id)arg4 ;
-(void)spanizeAsrs:(id)arg0 spanMatchers:(id)arg1 asrSpansMap:(id)arg2 topAsrSpans:(id)arg3 topAsrSpansFiltered:(id)arg4 ;
