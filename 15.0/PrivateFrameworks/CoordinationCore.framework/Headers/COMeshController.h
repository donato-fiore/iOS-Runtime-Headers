...
@protocol COMeshNodeStateTrackerDelegate, COMeshNodeDelegate, OS_dispatch_queue;
...
-(void)broadcastRequest:(id)arg0 sentRequestCallback:(id)arg1 ;
// -(void)broadcastRequest:(id)arg0 sentRequestCallback:(id)arg1 recipientsCallback:(unk)arg2  ;
