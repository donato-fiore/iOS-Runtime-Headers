...
+(id)nodeDescription:(struct ? )arg0 withNodeOffset:(NSUInteger)arg1 sortedVMRegions:(id)arg2 ;
+(id)referenceDescription:(struct ? )arg0 withSourceNode:(struct ? )arg1 destinationNode:(struct ? )arg2 sortedVMRegions:(id)arg3 symbolicator:(struct _CSTypeRef )arg4 alignmentSpacing:(unsigned int)arg5 ;
+(void)initialize;
-(*void)contentForNode:(unsigned int)arg0 ;
-(*void)copyUserMarked;
-(?)setCrashReporterInfoForMappedFileRegion:(?)arg0 mappedRegionStartAddress:(?)arg1 mappedSizereason;
-(BOOL)_suspend;
...
-(id)referenceDescription:(struct ? )arg0 withSourceNode:(unsigned int)arg1 destinationNode:(unsigned int)arg2 symbolicator:(struct _CSTypeRef )arg3 alignmentSpacing:(unsigned int)arg4 ;
