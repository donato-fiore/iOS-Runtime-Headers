...
@class UIInputViewController, UITapGestureRecognizer, NSTimer, NSArray, NSString, NSDate, NSLayoutConstraint, _UIKeyboardFeedbackGenerator, UIViewController<UIPredictiveViewController>;
@protocol TUIEmojiSearchTextFieldDelegate, TUIEmojiSearchSourceDelegate, TUIEmojiSearchResultsCollectionViewControllerDelegate, UIPredictiveViewController, TUIEmojiSearchInputViewControllerDelegate;
