...
@property (readonly, nonatomic) NSUInteger weeklyUploadQuotaBytes;
...
-(NSUInteger)_remainingWeekUploadQuotaBytesWithContext:(id)arg0 ;
-(id)_cachedMatchingQuery:(id)arg0 workingContext:(id)arg1 ;
-(id)init;
-(void)_addRequestToDAFileList:(id)arg0 ;
-(void)_ckQueueDownstreamOnly_uploadInFlightWithTransaction:(id)arg0 xpcActivity:(id)arg1 ;
-(void)_ckQueueOnly_submitOutstandingEnableDataGatheringQueriesWithTransaction:(id)arg0 xpcActivity:(id)arg1 followupWorkBlock:(id)arg2 ;
...
-(void)_finishUploadSessionWithActivity:(id)arg0 withState:(NSInteger)arg1 transaction:(id)arg2 endResultString:(id)arg3 ;
...
-(void)_runCloudKitUploadWorkSessionWithTransaction:(id)arg0 xpcActivity:(id)arg1 ;
