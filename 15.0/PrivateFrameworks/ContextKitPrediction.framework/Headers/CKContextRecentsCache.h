...
@class BMUserActivityMetadataStream, NSXPCConnection, NSString, BMUserFocusComputedModeStream, BMBiomeScheduler, BPSSink;
@protocol OS_dispatch_queue, CKContextRecentsCacheDelegate;
