...
@class PLAgent, PLEntryNotificationOperatorComposition, NSMutableArray, PLTimer, PLEntry, BrightnessSystemClient, CBAdaptationClient, NSDictionary, PLIOKitOperatorComposition, KeyboardBrightnessClient, NSString, PLMonotonicTimer, PLXPCListenerOperatorComposition, NSDate, NSMutableDictionary, PLNSNotificationOperatorComposition;
