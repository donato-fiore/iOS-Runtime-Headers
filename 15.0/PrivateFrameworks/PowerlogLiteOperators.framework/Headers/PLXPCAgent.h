...
@class PLAgent, PLXPCListenerOperatorComposition, PLNSNotificationOperatorComposition, PLXPCResponderOperatorComposition, PLEntry, NSDate;
...
-(void)logEventPointNavdNavNetworkActivity:(id)arg0 ;
...
-(void)logEventPointSleepMode:(id)arg0 ;
