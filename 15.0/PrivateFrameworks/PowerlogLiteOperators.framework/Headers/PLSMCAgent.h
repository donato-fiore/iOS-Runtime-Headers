...
-(id)readKey:(id)arg0 ;
-(id)readKeyAsNumeric:(id)arg0 ;
-(id)readKeyRaw:(id)arg0 ;
...
-(void)logAccumulatedKeysToPowerlog:(BOOL)arg0 ToCoreAnalytics:(BOOL)arg1 withDate:(id)arg2 ;
