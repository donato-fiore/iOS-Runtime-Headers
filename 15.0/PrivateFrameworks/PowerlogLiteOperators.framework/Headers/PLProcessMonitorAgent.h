...
@class PLAgent, PLXPCListenerOperatorComposition, PLNSNotificationOperatorComposition, PLEntryNotificationOperatorComposition, NSDate, NSDictionary, PLMonotonicTimer, NSMutableSet;
...
+(id)entryEventBackwardAppResumeTimeSeries;
...
+(id)entryEventPointAppNotFrozenObfuscated;
+(id)entryEventPointAppResumePredictions;
+(id)entryEventPointDefinitions;
+(id)entryEventPointFreezerDemotion;
+(id)entryEventPointFreezerDemotionObfuscated;
+(id)entryEventPointFreezerStats;
+(id)entryEventPointFreezerStatsObfuscated;
...
-(void)logEventBackwardAppResumeTimeSeries:(id)arg0 ;
