...
+(id)eventWithType:(NSInteger)arg0 state:(BOOL)arg1 ;
+(id)eventWithType:(NSInteger)arg0 stateEnum:(unsigned int)arg1 ;
-(id)_eventTypeStringForType:(NSInteger)arg0 ;
-(id)initWithType:(NSInteger)arg0 state:(BOOL)arg1 stateEnum:(unsigned int)arg2 ;
