...
-(void)didCancelInterstitialForClip:(id)arg0 withEvent:(NSInteger)arg1 ;
...
-(void)didPresentInvocationCardForClip:(id)arg0 adamID:(id)arg1 sourceBundleIdentifier:(id)arg2 referrerBundleIdentifier:(id)arg3 event:(id)arg4 url:(id)arg5 ;
...
-(void)recordDidActivateCardWithBundleID:(id)arg0 launchReason:(id)arg1 deviceLocked:(BOOL)arg2 ;
...
-(void)recordDidTapOpenButtonInCardWithBundleID:(id)arg0 metadata:(id)arg1 launchReason:(id)arg2 launchOptions:(id)arg3 ;
