...
+(void)initialize;
-(?)formatWords:(?)arg0 unrepairedWordsOut:(?)arg1 task:(?)arg2 language:(?)arg3 leftContext:(?)arg4 separateAutoEndPunctuation:(?)arg5 partialResults:(?)arg6 timestampOffset:(?)arg7 zeroTimestamp:(?)arg8 continuousListeningConfig:(?)arg9 itnLeftContextitnResult;
