...
@class UIView, UIStackView, NSString, UIImageView, UISwitch, UILabel;
@protocol UIContentView;


#import "WFParameterValuePickerTableViewCellConfiguration.h"
#import "WFIconHostingViewController.h"
...
@property (readonly, nonatomic) WFIconHostingViewController *iconViewController; // ivar: _iconViewController
