...
@class WFImage, UIFont, UIColor, NSString;
...
@property (retain, nonatomic) UIColor *cachedImageTintColor; // ivar: _cachedImageTintColor
...
-(id)attachmentImageForSize:(struct CGSize )arg0 ;
