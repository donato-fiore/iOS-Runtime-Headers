...
typedef struct __list_node_base<std::shared_ptr<POPAnimatorItem>, void *> {
    void __prev_;
    void __next_;
} __list_node_base<std::shared_ptr<POPAnimatorItem>, void *>;

typedef struct __compressed_pair<unsigned long, std::allocator<std::__list_node<std::shared_ptr<POPAnimatorItem>, void *>>> {
    NSUInteger __value_;
} __compressed_pair<unsigned long, std::allocator<std::__list_node<std::shared_ptr<POPAnimatorItem>, void *>>>;

typedef struct list<std::shared_ptr<POPAnimatorItem>, std::allocator<std::shared_ptr<POPAnimatorItem>>> {
    __list_node_base<std::shared_ptr<POPAnimatorItem>, void *> __end_;
    __compressed_pair<unsigned long, std::allocator<std::__list_node<std::shared_ptr<POPAnimatorItem>, void *>>> __size_alloc_;
} list<std::shared_ptr<POPAnimatorItem>, std::allocator<std::shared_ptr<POPAnimatorItem>>>;

typedef struct POPAnimatorItem {
} // Error Processing Struct Fields
...
typedef struct shared_ptr<POPAnimatorItem> {
    POPAnimatorItem field0;
    __shared_weak_count field1;
} shared_ptr<POPAnimatorItem>;
