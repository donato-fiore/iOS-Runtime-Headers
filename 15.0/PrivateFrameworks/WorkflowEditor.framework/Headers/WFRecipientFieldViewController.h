...
@class UIViewController, CNAutocompleteResultsTableViewController, NSLayoutConstraint, CNComposeRecipientTextView, CNContactStore, NSString, NSArray, CNAutocompleteFetchContext, NSNumber, CNAutocompleteSearchManager, NSMutableArray, NSSet;
