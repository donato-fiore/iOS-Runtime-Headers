...
@class UIView, NSSet, NSString, NSArray, UIButton, WFTextScrollView;
@protocol UITextViewDelegate, WFContactFieldDelegate, WFVariableProvider, WFVariableUIDelegate;
