...
@property (readonly, nonatomic) NSSet *ignoredIntervalNames; // ivar: _ignoredIntervalNames
@property (readonly, nonatomic) NSSet *trackedIntervalNames; // ivar: _trackedIntervalNames
