...
@protocol NUIContainerViewDelegate, SearchUISelectableTextViewDelegate, SearchUICardSectionViewUpdatable;
...
-(void)selectableTextView:(id)arg0 presentViewController:(id)arg1 ;
