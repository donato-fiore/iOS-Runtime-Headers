...
@class UIViewController, SFCard, NSString, TLKLabel, NSTimer, UIActivityIndicatorView, NUIContainerBoxView, UIViewController<SearchUICardTableBridgingProtocol>;
