...
@protocol _CDInteractionRecording, _CDInteractionQuerying, _CDInteractionDeleting, OS_dispatch_queue, _DKLocationHistorian;
...
@property (retain) NSObject<_DKLocationHistorian> *locationHistorian; // ivar: _locationHistorian
