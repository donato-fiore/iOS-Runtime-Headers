...
-(id)description;
-(id)initFromMinAperture:(float)arg0 maxAperture:(float)arg1 aperture:(float)arg2 portraitStrength:(float)arg3 SDOFRenderingVerion:(NSUInteger)arg4 depthVersionInfo:(struct ? )arg5 ;
