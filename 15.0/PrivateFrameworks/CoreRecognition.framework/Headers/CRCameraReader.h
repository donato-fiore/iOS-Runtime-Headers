...
@class UIViewController, UIActivityIndicatorView, CRPollingTimer, NSString, NSPointerArray, UIColor, NSMutableArray, NSMutableDictionary, NSDate, NSDictionary, NSArray, CRImageReader, CATextLayer, NSCache, UITapGestureRecognizer;
...
+(struct CGRect )aspectRatioPaddedRect:(struct CGRect )arg0 expectedWidth:(NSUInteger)arg1 height:(NSUInteger)arg2 orientation:(unsigned int)arg3 ;
+(struct CGRect )uniformPadRect:(struct CGRect )arg0 widthPadding:(float)arg1 heightPadding:(float)arg2 width:(NSUInteger)arg3 height:(NSUInteger)arg4 ;
+(void)loadFonts;
