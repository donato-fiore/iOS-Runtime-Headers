...
@class MPQueueFeeder, MPAVItem, NSString, ICUserIdentityStore, ICStoreRequestContext, ICPlayActivityController, NSDictionary;
@protocol MPRTCReportingItemSessionContaining, MPAVItemObserver, ICEnvironmentMonitorObserver, MPCQueueControllerDataSource, MPMutableIdentifierListSection, OS_dispatch_queue;
...
-(void)_savePlaybackHistoryWithCurrentIndex:(NSInteger)arg0 ;
...
-(void)loadAdditionalItemsWithRequest:(id)arg0 forSection:(id)arg1 completion:(id)arg2 ;
