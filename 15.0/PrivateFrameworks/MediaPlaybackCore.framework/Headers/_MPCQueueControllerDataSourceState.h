...
@protocol MPShuffleableSectionedIdentifierListDataSource, NSSecureCoding, MPCQueueControllerDataSource><MPCQueueControllerDataSourceStateRestoring><MPRTCReportingItemSessionContaining;
...
@property (readonly, nonatomic) NSObject<MPCQueueControllerDataSource><MPCQueueControllerDataSourceStateRestoring><MPRTCReportingItemSessionContaining> *dataSource; // ivar: _dataSource
