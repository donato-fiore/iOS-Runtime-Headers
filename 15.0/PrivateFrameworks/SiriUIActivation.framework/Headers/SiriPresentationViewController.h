...
-(void)handleButtonDownFromButtonIdentifier:(id)arg0 timestamp:(id)arg1 ;
-(void)handleButtonLongPressFromButtonIdentifier:(id)arg0 deviceIdentifier:(id)arg1 timestamp:(id)arg2 ;
-(void)handleButtonTapFromButtonIdentifier:(id)arg0 ;
-(void)handleButtonUpFromButtonIdentifier:(id)arg0 deviceIdentifier:(id)arg1 timestamp:(id)arg2 ;
