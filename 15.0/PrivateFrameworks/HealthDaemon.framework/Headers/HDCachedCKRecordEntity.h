...
+(BOOL)enumerateRecordNameAndDataWithContainerIdentifier:(id)arg0 databaseScope:(NSInteger)arg1 zoneName:(id)arg2 ownerName:(id)arg3 recordType:(id)arg4 profile:(id)arg5 error:(*id)arg6 enumerationHandler:(id)arg7 ;
+(BOOL)enumerateRecordNamesWithContainerIdentifier:(id)arg0 databaseScope:(NSInteger)arg1 zoneName:(id)arg2 ownerName:(id)arg3 profile:(id)arg4 error:(*id)arg5 enumerationHandler:(id)arg6 ;
