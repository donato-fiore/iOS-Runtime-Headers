...
#ifndef _HDDIAGNOSTICTESTREPORTENTITYENCODER_H
#define _HDDIAGNOSTICTESTREPORTENTITYENCODER_H

@class HDMedicalRecordEntityEncoder;



@interface _HDDiagnosticTestReportEntityEncoder : HDMedicalRecordEntityEncoder
