...
// -(id)_onboardingEligibilitiesForOnboardingCompletions:(id)arg0 onboardingEligbilityRetrievalBlock:(id)arg1 error:(unk)arg2  ;
-(id)_onboardingEligibilityForRegionEligibility:(id)arg0 rescindedStatus:(id)arg1 isCapabilitySupported:(id)arg2 ;
-(id)initWithFeatureIdentifier:(id)arg0 currentOnboardingVersion:(NSInteger)arg1 pairedDeviceCapability:(id)arg2 pairedDeviceCapabilityProvider:(id)arg3 regionAvailabilityProvider:(id)arg4 remoteAvailabilityProvider:(id)arg5 loggingCategory:(id)arg6 ;
