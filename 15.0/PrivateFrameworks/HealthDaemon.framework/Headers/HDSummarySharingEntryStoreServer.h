...
@class NSString;
@protocol HKSummarySharingEntryStoreServerInterface, HDSummarySharingEntryObserver, HDSummarySharingEntryIDSManagerReachabilityObserver;
...
@interface HDSummarySharingEntryStoreServer : HDStandardTaskServer <HKSummarySharingEntryStoreServerInterface, HDSummarySharingEntryObserver, HDSummarySharingEntryIDSManagerReachabilityObserver>
...
-(void)remote_userTappedWithIdentifier:(id)arg0 reachabilityStatus:(BOOL)arg1 completion:(id)arg2 ;
