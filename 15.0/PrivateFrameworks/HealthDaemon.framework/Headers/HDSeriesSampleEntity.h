...
+(BOOL)deleteSeriesWithID:(id)arg0 deleteHFDData:(BOOL)arg1 insertDeletedObject:(BOOL)arg2 profile:(id)arg3 transaction:(id)arg4 error:(*id)arg5 ;
...
+(BOOL)replaceObjectID:(id)arg0 replacementObjectID:(id)arg1 deleteOriginalHFDData:(BOOL)arg2 insertDeletedObject:(BOOL)arg3 profile:(id)arg4 transaction:(id)arg5 error:(*id)arg6 ;
