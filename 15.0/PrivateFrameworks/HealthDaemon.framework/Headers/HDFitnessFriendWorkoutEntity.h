...
#ifndef HDFITNESSFRIENDWORKOUTENTITY_H
#define HDFITNESSFRIENDWORKOUTENTITY_H
...
+(BOOL)enumerateWorkoutsWithPredicate:(id)arg0 anchor:(*id)arg1 profile:(id)arg2 error:(*id)arg3 handler:(id)arg4 ;
