...
#ifndef _HDPROCEDURERECORDENTITYENCODER_H
#define _HDPROCEDURERECORDENTITYENCODER_H

@class HDMedicalRecordEntityEncoder;



@interface _HDProcedureRecordEntityEncoder : HDMedicalRecordEntityEncoder
