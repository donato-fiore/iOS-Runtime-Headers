...
-(id)description;
-(id)initInZone:(id)arg0 UUID:(id)arg1 authorizationCategories:(id)arg2 participantRecord:(id)arg3 ;
-(id)initWithCKRecord:(id)arg0 schemaVersion:(NSInteger)arg1 ;
-(id)printDescription;
-(id)serializeUnderlyingMessage;
-(void)replaceAuthorizationCategories:(id)arg0 ;
-(void)updateAuthorizationWithCategoriesToAdd:(id)arg0 categoriesToDelete:(id)arg1 ;
