...
@class NSString, NSDictionary, NSNumber, NSError, NSURL, NMSMediaItemDownloadInfo, NSData;
...
@property (retain, nonatomic) NMSMediaItemDownloadInfo *mediaItemDownloadInfo; // ivar: _mediaItemDownloadInfo
