...
@class GEOTrafficBannerText, NSArray, NSDate, NSData, GEOComposedRoute, GEOPBTransitArtwork, NSString, GEORouteIncident, NSMutableArray, GEONavigabilityInfo;
...
-(struct ? )_routeCoordinateOnRoute:(id)arg0 distanceFromEnd:(CGFloat)arg1 ;
