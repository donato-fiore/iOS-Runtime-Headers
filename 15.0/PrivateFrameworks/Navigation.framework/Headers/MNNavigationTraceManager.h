...
@protocol MNTracePlayerObserver, MNLocationProvider, GEOMotionContextProvider, MNLocationProviderDelegate, GEOMotionContextProviderDelegate, MNNavigationTraceManagerDelegate;
