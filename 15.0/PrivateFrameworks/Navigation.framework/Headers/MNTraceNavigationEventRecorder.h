...
@class NSError, NSUUID, NSArray, VGVehicle, NSTimer, NSDateFormatter, NSString;
@protocol VGVirtualGarageObserver, MNNavigationSessionObserver;
...
-(void)_recordEVChargingStateForVehicle:(id)arg0 ;
