...
-(id)autocorrection;
-(id)autocorrectionCandidateForInput:(id)arg0 withCandidate:(*void)arg1 ;
-(id)autocorrectionCandidateForInput:(id)arg0 withCandidate:(*void)arg1 insertingSpace:(BOOL)arg2 sharedPrefixLength:(NSUInteger)arg3 ;
...
-(id)generateAutofillFormWithKeyboardState:(id)arg0 ;
...
-(struct LanguageModelContext )sentenceContextForInputStem:(id)arg0 ;
-(struct RefPtr<KB::DictionaryContainer> )getDictionary;
-(struct TITokenID )addWord:(id)arg0 context:(struct TITokenID *)arg1 contextLength:(NSUInteger)arg2 surfaceFormPtr:(*id)arg3 contextStringTokens:(id)arg4 ;
-(struct TITokenID )findTokenIDForWord:(id)arg0 context:(struct TITokenID *)arg1 contextLength:(NSUInteger)arg2 tokenLookupMode:(unsigned int)arg3 contextStringTokens:(id)arg4 ;
-(struct TITokenID )findTokenIDForWord:(id)arg0 context:(struct TITokenID *)arg1 contextLength:(NSUInteger)arg2 tokenLookupMode:(unsigned int)arg3 surfaceFormPtr:(*id)arg4 hasCaseInsensitiveStaticVariant:(*BOOL)arg5 contextStringTokens:(id)arg6 ;
...
-(void)addItemToConversationHistoryWithText:(id)arg0 timestamp:(id)arg1 senderID:(id)arg2 ;
...
-(void)dealloc;
-(void)decrementLanguageModelCount:(id)arg0 tokenID:(struct TITokenID )arg1 context:(struct TITokenID *)arg2 contextLength:(NSUInteger)arg3 contextStringTokens:(id)arg4 ;
...
-(void)incrementLanguageModelCount:(id)arg0 tokenID:(struct TITokenID )arg1 context:(struct TITokenID *)arg2 contextLength:(NSUInteger)arg3 contextStringTokens:(id)arg4 saveToDifferentialPrivacy:(int)arg5 ;
...
-(void)mergeLanguageModelParameters:(id)arg0 toTestingParameters:(id)arg1 withLexiconID:(id)arg2 andSuffix:(id)arg3 ;
...
-(void)registerNegativeEvidence:(id)arg0 tokenID:(struct TITokenID )arg1 context:(struct TITokenID *)arg2 contextLength:(NSUInteger)arg3 intendedTokenID:(struct TITokenID *)arg4 hint:(int)arg5 contextStringTokens:(id)arg6 ;
