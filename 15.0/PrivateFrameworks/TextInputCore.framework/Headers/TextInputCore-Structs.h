...
typedef struct VectorBuffer<WTF::RefPtr<TI::Favonius::LayoutKey>, 0> {
    void field0;
    NSUInteger field1;
} VectorBuffer<WTF::RefPtr<TI::Favonius::LayoutKey>, 0>;

typedef struct Vector<WTF::RefPtr<TI::Favonius::LayoutKey>, 0> {
    NSUInteger field0;
    VectorBuffer<WTF::RefPtr<TI::Favonius::LayoutKey>, 0> field1;
} Vector<WTF::RefPtr<TI::Favonius::LayoutKey>, 0>;
