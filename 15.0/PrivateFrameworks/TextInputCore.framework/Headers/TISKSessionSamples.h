...
#ifndef TISKSESSIONSAMPLES_H
#define TISKSESSIONSAMPLES_H

@class NSDate, NSString, NSMutableDictionary, TIKeyboardLayout;
...
@property (retain, nonatomic) NSMutableDictionary *keyedSamples; // ivar: _keyedSamples
...
-(id)init:(id)arg0 endDate:(id)arg1 identifier:(id)arg2 version:(id)arg3 inputMode:(id)arg4 layout:(id)arg5 ;
