...
@class SFAppAutoFillOneTimeCodeProvider, NSString, NSDate, NSUUID, LAContext, NSDictionary;
...
-(id)generateAutofillFormSuggestedUsernameWithRenderTraits:(id)arg0 withKeyboardState:(id)arg1 ;
-(id)generateOneTimeCodeCandidatesWithRenderTraits:(id)arg0 withKeyboardState:(id)arg1 ;
-(id)getCredentialsWithApplicationIdentifier:(id)arg0 autofillContext:(id)arg1 ;
-(id)initPrivate;
