...
-(NSUInteger)fillTokenIDBuffer:(struct TITokenID *)arg0 withContextForTokenAtIndex:(NSUInteger)arg1 contextStringsBuffer:(id)arg2 ;
...
-(void)acceptToken:(id)arg0 withContext:(struct TITokenID *)arg1 contextLength:(NSUInteger)arg2 saveToDifferentialPrivacy:(int)arg3 contextStringTokens:(id)arg4 ;
...
-(void)rejectToken:(id)arg0 withContext:(struct TITokenID *)arg1 contextLength:(NSUInteger)arg2 contextStringTokens:(id)arg3 negativeLearningHint:(int)arg4 withRevisedToken:(id)arg5 ;
