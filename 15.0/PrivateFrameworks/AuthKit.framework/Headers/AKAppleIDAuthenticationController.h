...
-(id)fetchDeviceListWithContext:(id)arg0 error:(*id)arg1 ;
-(id)init;
...
-(void)checkInWithAuthenticationServerForAppleID:(id)arg0 completion:(id)arg1 ;
...
-(void)fetchDeviceMapWithContext:(id)arg0 completion:(id)arg1 ;
