...
@property (readonly, copy, nonatomic) NSString *informativeText; // ivar: _informativeText
@property (readonly, copy, nonatomic) NSString *localizedAppName; // ivar: _localizedAppName
