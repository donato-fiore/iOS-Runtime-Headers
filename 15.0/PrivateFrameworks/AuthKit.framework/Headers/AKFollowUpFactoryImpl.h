...
-(id)_actionFromInfo:(id)arg0 ;
-(id)_actionsFromPayload:(id)arg0 ;
-(id)_clearAction;
-(id)_itemFromPayload:(id)arg0 withAltDSID:(id)arg1 ;
-(id)_notificationFromPayload:(id)arg0 ;
-(id)actionWithTitle:(id)arg0 andActionKey:(id)arg1 ;
-(id)itemIdentifiersRequiringNotificationClearFromPayload:(id)arg0 ;
-(id)itemsForAltDSID:(id)arg0 fromIDMSPayload:(id)arg1 ;
