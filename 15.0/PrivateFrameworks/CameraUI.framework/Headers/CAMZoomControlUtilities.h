...
+(BOOL)_shouldEmulateZoomSwitchingDualDevicesForMode:(NSInteger)arg0 ;
+(BOOL)shouldApplyContinuousZoomForMode:(NSInteger)arg0 device:(NSInteger)arg1 videoConfiguration:(NSInteger)arg2 zoomFactors:(*id)arg3 displayZoomFactors:(*id)arg4 ;
+(BOOL)shouldEmulateTripleCameraZoomForMode:(NSInteger)arg0 device:(NSInteger)arg1 videoConfiguration:(NSInteger)arg2 ;
+(BOOL)shouldEmulateWideDualCameraZoomForMode:(NSInteger)arg0 device:(NSInteger)arg1 videoConfiguration:(NSInteger)arg2 ;
...
+(NSInteger)deviceForEmulatingZoomFactor:(CGFloat)arg0 fromDevice:(NSInteger)arg1 mode:(NSInteger)arg2 ;
