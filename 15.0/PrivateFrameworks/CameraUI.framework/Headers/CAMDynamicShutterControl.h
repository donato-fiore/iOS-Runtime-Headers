...
@protocol CAMMetalViewDelegate, UIGestureRecognizerDelegate, CAMDynamicShutterControlAGGDDelegate, CAMDynamicShutterControlDelegate;
...
@property (weak, nonatomic) NSObject<CAMDynamicShutterControlAGGDDelegate> *aggdDelegate; // ivar: _aggdDelegate
