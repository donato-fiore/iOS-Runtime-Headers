...
@property (readonly, nonatomic, getter=isSemanticStylesSupported) BOOL semanticStylesSupported; // ivar: _semanticStylesSupported
...
-(BOOL)isAutoLowLightVideoSupportedForMode:(NSInteger)arg0 videoConfiguration:(NSInteger)arg1 ;
