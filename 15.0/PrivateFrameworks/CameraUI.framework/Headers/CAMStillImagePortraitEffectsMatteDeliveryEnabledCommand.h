...
#ifndef CAMSTILLIMAGEPORTRAITEFFECTSMATTEDELIVERYENABLEDCOMMAND_H
#define CAMSTILLIMAGEPORTRAITEFFECTSMATTEDELIVERYENABLEDCOMMAND_H
...
-(id)initWithPortraitEffectsMatteDeliveryEnabled:(BOOL)arg0 ;
