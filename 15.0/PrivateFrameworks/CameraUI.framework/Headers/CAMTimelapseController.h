...
-(id)init;
-(id)initWithCaptureController:(id)arg0 locationController:(id)arg1 motionController:(id)arg2 persistenceController:(id)arg3 storageController:(id)arg4 nebulaDaemonProxyManager:(id)arg5 ;
...
-(void)_notifyAnalyticsForDidStopCapturingWithState:(id)arg0 ;
