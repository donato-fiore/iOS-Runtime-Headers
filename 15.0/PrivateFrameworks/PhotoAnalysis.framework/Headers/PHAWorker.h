...
@class PFSerialQueue, NSString, NSURL, PHPhotoLibrary;
@protocol PHAWorkerConfiguration, PHAServiceOperationHandling, PHAJobTimeHandlerProtocol, PHAAssetResourceDataLoading, OS_os_log;
...
@property (retain, nonatomic) NSObject<PHAAssetResourceDataLoading> *dataLoader; // ivar: _dataLoader
