...
@class NSArray, _CDInteractionStore, _CDInteractionCache;
...
@property (nonatomic) NSUInteger _PSKnnModelSharesMinimumOccuranceRegularizer; // ivar: __PSKnnModelSharesMinimumOccuranceRegularizer
...
-(id)filterShareInteractions:(id)arg0 minimumOccurences:(NSUInteger)arg1 contextBundleId:(id)arg2 filterOutNonMatchingSourceBundleIDs:(BOOL)arg3 ;
