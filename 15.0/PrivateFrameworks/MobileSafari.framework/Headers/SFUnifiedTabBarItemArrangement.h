...
@property (readonly, nonatomic) SFUnifiedBarItem *standaloneActiveItem; // ivar: _standaloneActiveItem


-(BOOL)isEqualToArrangement:(id)arg0 ;
-(id)_initWithItems:(id)arg0 activeItem:(id)arg1 activeItemIsExpanded:(BOOL)arg2 standaloneActiveItem:(id)arg3 ;
...
-(id)initWithItems:(id)arg0 standaloneActiveItem:(id)arg1 ;
