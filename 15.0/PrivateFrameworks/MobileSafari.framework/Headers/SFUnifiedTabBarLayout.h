...
-(CGFloat)_distanceToEdgeForItemAtIndex:(NSUInteger)arg0 withFrame:(struct CGRect )arg1 activeItemFrame:(struct CGRect )arg2 occludedEdge:(*NSUInteger)arg3 occludingItemIndex:(*NSUInteger)arg4 ;
