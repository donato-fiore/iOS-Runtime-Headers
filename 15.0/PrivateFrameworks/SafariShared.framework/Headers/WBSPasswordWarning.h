...
@class NSArray, NSString, WBSSavedPassword;
...
-(id)initWithPassword:(id)arg0 issueTypes:(NSUInteger)arg1 weakPasswordEvaluation:(id)arg2 domainsWithReusedPassword:(id)arg3 ;
