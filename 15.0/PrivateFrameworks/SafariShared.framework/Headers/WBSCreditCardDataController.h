...
-(void)getCreditCardDataToFill:(id)arg0 externalizedContext:(id)arg1 completionHandler:(id)arg2 ;
-(void)getCreditCardDataWithCompletionHandler:(id)arg0 ;
-(void)getVirtualCardCredentialsFromKeychainWithCompletionHandler:(id)arg0 ;
