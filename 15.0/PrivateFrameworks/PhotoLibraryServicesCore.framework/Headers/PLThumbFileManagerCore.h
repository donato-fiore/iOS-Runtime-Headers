...
+(id)thumbnailPathForThumbIdentifier:(id)arg0 withPathManager:(id)arg1 recipeID:(unsigned int)arg2 ;
...
-(void)obtainAccessAndWaitWithFileWithAssetUUID:(id)arg0 urlHandler:(id)arg1 ;
