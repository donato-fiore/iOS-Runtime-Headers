...
#ifndef AKSPEECHBUBBLEANNOTATIONRENDERER_H
#define AKSPEECHBUBBLEANNOTATIONRENDERER_H
...
+(CGFloat)pointyBitPointWidthAngleGivenControlBasePoint:(struct CGPoint )arg0 forAnnotation:(id)arg1 ;
...
+(void)basePointsOfPointyBit:(id)arg0 withUpdatedProperties:(id)arg1 firstPoint:(struct CGPoint *)arg2 secondPoint:(struct CGPoint *)arg3 ;
