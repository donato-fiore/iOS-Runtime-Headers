...
@class UIViewController, UIBarButtonItem, UIView, UILabel, UIVisualEffectView, UIImageView, UIScrollView, UIButton, UIImpactFeedbackGenerator, NSLayoutConstraint, NSArray, NSTimer, NSError, NSMutableArray, UIColor;
...
-(void)_presentCoachingIntro:(id)arg0 ;
...
-(void)_setupHapticFeedbackGenerator;
