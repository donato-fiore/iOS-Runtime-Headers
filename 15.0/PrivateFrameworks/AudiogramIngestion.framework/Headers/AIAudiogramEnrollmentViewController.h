...
@class OBNavigationController, UIImage, NSString, OBTextWelcomeController;
...
@property (retain, nonatomic) UIImage *audiogramImage; // ivar: _audiogramImage
...
-(void)_prepareToImportAudiogramImage:(id)arg0 ;
