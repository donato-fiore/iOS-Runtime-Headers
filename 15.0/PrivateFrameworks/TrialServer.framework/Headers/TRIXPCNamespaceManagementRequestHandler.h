...
@protocol TRIXPCNamespaceManagementServiceProtocol, TRITaskQueuing;
...
+(void)_removeAssetFactors:(id)arg0 usingEntitlementWitness:(id)arg1 serverContext:(id)arg2 taskQueue:(id)arg3 namespace:(id)arg4 completion:(id)arg5 ;
...
+(void)_startDownloadAssetIndexesByTreatment:(id)arg0 usingEntitlementWitness:(id)arg1 serverContext:(id)arg2 taskQueue:(id)arg3 experimentIds:(id)arg4 assetIdsByFactorPack:(id)arg5 rolloutFactorNames:(id)arg6 rolloutDeployments:(id)arg7 namespace:(id)arg8 taskAttribution:(id)arg9 notificationKey:(id)arg10 ;
...
-(BOOL)_validateSetPurgeabilityLevelRequestUsingFactorProviderChain:(id)arg0 purgeabilityLevelsForFactors:(id)arg1 error:(*id)arg2 ;
-(id)_factorProviderChainForNamespace:(id)arg0 ;
-(id)initWithServerContext:(id)arg0 taskQueue:(id)arg1 auditToken:(struct ? )arg2 ;
-(int)_namespacePurgeabilityLevelForNamespaceName:(id)arg0 ;
-(void)_loadNamespaceMetadataForNamespace:(id)arg0 usingEntitlementWitness:(id)arg1 completion:(id)arg2 ;
-(void)_setPurgeabilityLevelsForFactors:(id)arg0 usingEntitlementWitness:(id)arg1 namespace:(id)arg2 completion:(id)arg3 ;
...
-(void)removeLevelsForFactors:(id)arg0 withNamespace:(id)arg1 completion:(id)arg2 ;
...
-(void)startDownloadLevelsForFactors:(id)arg0 withNamespace:(id)arg1 options:(id)arg2 completion:(id)arg3 ;
-(void)startDownloadNamespaceWithName:(id)arg0 options:(id)arg1 completion:(id)arg2 ;
-(void)statusOfDownloadForFactors:(id)arg0 withNamespace:(id)arg1 completion:(id)arg2 ;
