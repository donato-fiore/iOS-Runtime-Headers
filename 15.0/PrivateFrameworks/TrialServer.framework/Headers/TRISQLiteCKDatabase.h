...
-(BOOL)_evalQueryOperationWithRecordType:(id)arg0 predicate:(id)arg1 sortDescriptors:(id)arg2 resultsLimit:(NSUInteger)arg3 desiredKeys:(id)arg4 txn:(id)arg5 error:(*id)arg6 recordFetchedBlock:(id)arg7 ;
