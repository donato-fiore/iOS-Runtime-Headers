...
+(id)recordWithDeploymentEnvironment:(int)arg0 experimentDeployment:(id)arg1 treatmentId:(id)arg2 type:(int)arg3 status:(NSInteger)arg4 startDate:(id)arg5 endDate:(id)arg6 namespaces:(id)arg7 isShadow:(BOOL)arg8 artifact:(id)arg9 ;
...
-(id)description;
-(id)init;
-(id)initWithDeploymentEnvironment:(int)arg0 experimentDeployment:(id)arg1 treatmentId:(id)arg2 type:(int)arg3 status:(NSInteger)arg4 startDate:(id)arg5 endDate:(id)arg6 namespaces:(id)arg7 isShadow:(BOOL)arg8 artifact:(id)arg9 ;
