...
#ifndef TRIMLRUNTIMEEVALUATIONHISTORYDATABASE_H
#define TRIMLRUNTIMEEVALUATIONHISTORYDATABASE_H
...
-(BOOL)addRecord:(id)arg0 usingTransaction:(id)arg1 ;
-(BOOL)enumerateRecordsNewerThanDate:(id)arg0 block:(id)arg1 ;
