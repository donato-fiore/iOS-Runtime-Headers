...
+(id)taskWithDeployment:(id)arg0 factorPackSetId:(id)arg1 taskAttribution:(id)arg2 ;
...
-(id)initWithDeployment:(id)arg0 factorPackSetId:(id)arg1 taskAttribution:(id)arg2 ;
-(id)metrics;
