...
+(id)taskWithExperiment:(id)arg0 treatmentId:(id)arg1 taskAttributing:(id)arg2 requiresTreatmentInstallation:(BOOL)arg3 ;
+(id)taskWithExperiment:(id)arg0 treatmentId:(id)arg1 taskAttributing:(id)arg2 requiresTreatmentInstallation:(BOOL)arg3 startTime:(id)arg4 ;
