...
@class NSString, MKMapView, FMAnnotationView;
...
@property (nonatomic) FMAnnotationView *selectedAnnotationView; // ivar: _selectedAnnotationView
...
-(void)zoomToFitAnnotationsForMapView:(id)arg0 includeMe:(BOOL)arg1 disallowAnimation:(BOOL)arg2 ;
