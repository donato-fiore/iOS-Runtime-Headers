...
@property (retain, nonatomic) NSString *program; // ivar: _program
@property (nonatomic) NSInteger programID; // ivar: _programID
@property (retain, nonatomic) NSString *title; // ivar: _title


+(id)betaProgramWithID:(NSInteger)arg0 title:(id)arg1 program:(id)arg2 catalog:(id)arg3 assetUpdate:(id)arg4 assetBrain:(id)arg5 assetAudience:(id)arg6 legalDocs:(id)arg7 ;
+(id)betaProgramWithJSON:(id)arg0 ;
+(id)nilIfNSNull:(id)arg0 ;
-(id)initWithID:(NSInteger)arg0 title:(id)arg1 program:(id)arg2 catalog:(id)arg3 assetUpdate:(id)arg4 assetBrain:(id)arg5 assetAudience:(id)arg6 legalDocs:(id)arg7 ;
