...
@protocol SBSImplementerInternal, NSXPCListenerDelegate, SBSImplementer, SBSAppleCareImplementer, SBSCannedDemoServiceImplementer, SBSHomePodControlsImplementer, SBSDebugInfoImplementer, SBSPowerMonitorImplementer, SBSProfilesImplementer, SBSProximityHandoffUIImplementer, SBSStereoLeaderRoleImplementer, SBSSysdiagnoseImplementer, SBSSystemImplementer;
...
@property (weak, nonatomic) NSObject<SBSAppleCareImplementer> *appleCareDelegate; // ivar: _appleCareDelegate
...
-(void)setAppleCareIsEnabledInternal:(BOOL)arg0 withOptions:(id)arg1 ;
