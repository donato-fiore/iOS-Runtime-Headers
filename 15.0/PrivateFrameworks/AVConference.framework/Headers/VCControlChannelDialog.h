...
@class NSNumber, NSMutableDictionary, NSMutableArray;
...
-(id)initWithSessionID:(unsigned int)arg0 participantID:(id)arg1 participantConfig:(struct ? *)arg2 transactionDelegate:(id)arg3 ;
