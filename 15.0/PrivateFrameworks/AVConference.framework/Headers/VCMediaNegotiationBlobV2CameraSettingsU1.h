...
-(void)aspectRatioPortrait:(struct CGSize *)arg0 aspectRatioLandscape:(struct CGSize *)arg1 orientationMismatchAspectRatioLandscape:(struct CGSize *)arg2 screenSize:(struct CGSize )arg3 ;
-(void)clearPayloads;
-(void)copyTo:(id)arg0 ;
-(void)dealloc;
