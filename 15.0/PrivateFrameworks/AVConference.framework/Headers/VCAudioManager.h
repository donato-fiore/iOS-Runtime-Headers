...
@interface VCAudioManager : NSObject <VCAudioIOControllerControl, VCAudioSessionDelegate>

 {
    *tagHANDLE _hAUIO;
    ...
    _VCAudioIOControllerIOState _sinkData;
    _VCAudioIOControllerIOState _sourceData;
...
@property (retain, nonatomic) AVAudioDevice *currentInputDevice; // ivar: _inputDevice
@property (retain, nonatomic) AVAudioDevice *currentOutputDevice; // ivar: _outputDevice
...
-(int)setSpatialMetadata:(struct OpaqueCMBlockBuffer *)arg0 audioSessionId:(unsigned int)arg1 ;
...
-(void)activateSpatialContext:(id)arg0 ;
...
-(void)registerClientIO:(struct _VCAudioIOControllerClientIO *)arg0 controllerIO:(struct _VCAudioIOControllerIOState *)arg1 ;
-(void)release;
-(void)removeAllClientsForIO:(struct _VCAudioIOControllerIOState *)arg0 ;
...
-(void)unregisterClientIO:(struct _VCAudioIOControllerClientIO *)arg0 controllerIO:(struct _VCAudioIOControllerIOState *)arg1 ;
