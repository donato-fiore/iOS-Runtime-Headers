...
-(id)networkBitratesForStreamToken:(NSInteger)arg0 targetNetworkBitrate:(unsigned int)arg1 ;
...
-(id)tableEntriesForStreamToken:(NSInteger)arg0 targetBitrate:(unsigned int)arg1 remainingBitrate:(*unsigned int)arg2 ;
