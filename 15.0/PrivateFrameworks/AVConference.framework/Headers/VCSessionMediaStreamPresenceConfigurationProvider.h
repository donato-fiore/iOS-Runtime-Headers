...
-(id)newVideoStreamGroupStreamConfigWithPList:(id)arg0 streamIDGenerator:(id)arg1 ssrc:(unsigned int)arg2 groupID:(unsigned int)arg3 ;
-(id)newVideoStreamInputConfigurationWithPList:(id)arg0 ;
-(struct CGSize )computeEncoderResolution:(NSUInteger)arg0 ;
