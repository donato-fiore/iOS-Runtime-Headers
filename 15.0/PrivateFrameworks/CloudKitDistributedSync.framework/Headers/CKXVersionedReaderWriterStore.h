...
#import "CKXUncompressedReader.h"
#import "CKXUncompressedWriter.h"
...
@property (retain, nonatomic) CKXUncompressedReader *uncompressedReader; // ivar: _uncompressedReader
@property (retain, nonatomic) CKXUncompressedWriter *uncompressedWriter; // ivar: _uncompressedWriter
