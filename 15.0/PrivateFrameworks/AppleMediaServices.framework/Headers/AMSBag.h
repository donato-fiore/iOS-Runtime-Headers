...
@property (nonatomic) shared_ptr<AMSCore::Bag> underlyingBag; // ivar: _underlyingBag
...
-(id)initWithBag:(struct shared_ptr<AMSCore::Bag> )arg0 processInfo:(id)arg1 ;
-(id)initWithDataSource:(id)arg0 ;
-(id)integerForKey:(id)arg0 ;
-(id)stringForKey:(id)arg0 ;
-(void)addDefaultValue:(id)arg0 forBagKey:(id)arg1 ;
