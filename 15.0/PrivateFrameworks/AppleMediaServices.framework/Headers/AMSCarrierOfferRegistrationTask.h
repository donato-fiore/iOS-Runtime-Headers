...
-(id)initWithAccount:(id)arg0 bag:(id)arg1 carriers:(id)arg2 checkOfferRequestEncoder:(id)arg3 deviceGUID:(id)arg4 msisdn:(id)arg5 registrationRequestEncoder:(id)arg6 urlSession:(id)arg7 ;
