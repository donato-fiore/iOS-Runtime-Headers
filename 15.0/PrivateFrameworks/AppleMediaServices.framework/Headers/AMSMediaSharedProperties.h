...
+(id)_propertiesForClientIdentifier:(id)arg0 account:(id)arg1 bag:(id)arg2 URLKnownToBeTrusted:(BOOL)arg3 ;
+(id)accessQueue;
...
-(id)_initWithClientIdentifier:(id)arg0 account:(id)arg1 bag:(id)arg2 URLKnownToBeTrusted:(BOOL)arg3 ;
-(void)dealloc;
