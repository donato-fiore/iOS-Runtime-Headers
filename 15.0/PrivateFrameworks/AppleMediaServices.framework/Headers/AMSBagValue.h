...
@property (nonatomic) shared_ptr<AMSCore::Bag> bag; // ivar: _bag
...
-(id)initWithBag:(struct shared_ptr<AMSCore::Bag> )arg0 key:(id)arg1 valueType:(NSUInteger)arg2 account:(id)arg3 ;
