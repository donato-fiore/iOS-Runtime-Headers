...
@class UIView, UIInterfaceActionGroup, UIInterfaceActionGroupView, WFImage, NSString, PLTitledPlatterView, UILabel;
...
@property (copy, nonatomic) WFImage *attributionIcon; // ivar: _attributionIcon
...
@property (weak, nonatomic) PLTitledPlatterView *platterView; // ivar: _platterView
