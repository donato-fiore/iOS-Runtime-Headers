...
-(id)description;
-(id)initWithDateComponents:(id)arg0 floating:(BOOL)arg1 ;
-(id)initWithDateString:(char *)arg0 ;
-(id)initWithYear:(NSInteger)arg0 month:(NSInteger)arg1 day:(NSInteger)arg2 hour:(NSInteger)arg3 minute:(NSInteger)arg4 second:(NSInteger)arg5 floating:(BOOL)arg6 ;
