...
@protocol HKSPSleepFocusModeBridgeDelegate, HKSPXPCConnectionProviderDelegate, NAScheduler, HKSPSleepFocusModeBridge, HKSPSyncAnchor;
...
@property (readonly, copy, nonatomic) NSObject<HKSPSyncAnchor> *syncAnchor; // ivar: _syncAnchor
...
-(id)_sleepAlarmWasDismissedOnDateOnServer:(id)arg0 ;
-(id)_sleepAlarmWasModifiedOnServer;
-(id)_sleepAlarmWasSnoozedUntilDateOnServer:(id)arg0 ;
...
// -(id)initWithConnectionProviderProvider:(id)arg0 identifier:(unk)arg1 healthStore:(id)arg2 options:(id)arg3 analyticsManager:(NSUInteger)arg4 throttlerProvider:(id)arg5 callbackScheduler:(id)arg6 sleepFocusModeBridgeProvider:(unk)arg7 currentDateProvider:(id)arg8  ;
...
-(void)reconnect;
-(void)reloadWidgetIfNecessaryWithReason:(NSUInteger)arg0 reloader:(id)arg1 ;
...
-(void)sleepAlarmWasModified:(id)arg0 completion:(id)arg1 ;
