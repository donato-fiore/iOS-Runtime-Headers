...
@class RPCompanionLinkClient, AVAudioSession, AVAudioPlayer, ACAccountStore, ACAccount, NSString, SSAccount, AMSPromise, NSArray, HMAccessory, SFSession, AFVoiceInfo, AFEnablementConfiguration, AFEnablementFlowConfigurationProvider, APCListener, SFDeviceOperationWiFiSetup, TRSession, NSMutableArray, TROperationQueue, NSSet, SFDeviceOperationCDPSetup, SFDeviceOperationHomeKitSetup, NSDictionary, SFDevice, UIViewController, HMHome;
