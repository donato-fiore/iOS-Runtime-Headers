...
@class NSData, APCPlayer, RPCompanionLinkClient, SFClient, SFService, SFSession, SFSiriClient, SFDeviceOperationHandlerCDPSetup, HMDeviceSetupOperationHandler, SFDeviceOperationHandlerWiFiSetup, CUAudioPlayer, NSString, NSDate, SUICDefaultVoicePreviewer;
