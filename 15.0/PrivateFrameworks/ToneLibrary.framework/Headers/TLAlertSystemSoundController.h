...
-(id)_prepareForStoppingAlerts:(id)arg0 playbackCompletionType:(NSInteger)arg1 ;
-(id)init;
...
-(void)_processDeemphasizableAlertChangesForBackglightStatus:(NSInteger)arg0 stopTasksDescriptorForDeemphasizedAlerts:(id)arg1 playbackCompletionTypeForDeemphasizedAlerts:(NSInteger)arg2 deemphasizableAlertBeginPlayingContexts:(id)arg3 ;
-(void)_processPlayTaskDescriptors:(id)arg0 ;
-(void)_processPlaybackCompletionContexts:(id)arg0 completionHandler:(id)arg1 ;
-(void)_processStopTasksDescriptor:(id)arg0 withOptions:(id)arg1 playbackCompletionType:(NSInteger)arg2 completionHandler:(id)arg3 ;
-(void)_recordPlaybackFailureIntoPlaybackCompletionContext:(id)arg0 ;
