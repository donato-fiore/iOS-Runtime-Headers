...
@class NSNumber, NSString, BRCDirectoryItem<BRCFSRooted>, BRCLocalItem<BRCTopLevelShareable>, BRCLocalItem<BRCSharedToMeTopLevel>, BRCUserRowID, BRFileObjectID, NSMutableSet, NSError;
