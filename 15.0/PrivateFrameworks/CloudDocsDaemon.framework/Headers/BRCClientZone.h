...
@class NSString, NSMutableArray, NSError, NSMutableIndexSet, NSDate, NSMutableDictionary, CKOperationGroup, UMUserSyncTask, NSSet, BRMangledID, NSDictionary, NSArray;
