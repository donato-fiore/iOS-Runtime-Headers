...
@class BRNotificationQueue, NSMutableDictionary, NSString, NSMutableSet, NSSet, BRFileObjectID;
@protocol BRItemNotificationSending, BRItemNotificationReceiving, OS_dispatch_group, BRCNotificationPipeDelegate, OS_dispatch_queue;
