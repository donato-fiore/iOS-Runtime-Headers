...
-(BOOL)_stageExistingPackageItem:(id)arg0 withLiveFd:(int)arg1 stageFd:(int)arg2 ;
-(BOOL)addItem:(id)arg0 ;
-(BOOL)addLocalItem:(id)arg0 ;
-(BOOL)done;
-(BOOL)stagePackageWithReader:(id)arg0 package:(id)arg1 xattrsPackage:(id)arg2 stageItemURL:(id)arg3 livefd:(int)arg4 recordName:(id)arg5 ;
...
-(void)_applyFileMetadataWithManifestItem:(id)arg0 packageRootFD:(int)arg1 ;
-(void)_applyQuarantineMetadataWithManifestItem:(id)arg0 fd:(int)arg1 ;
