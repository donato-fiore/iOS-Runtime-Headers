...
@class UIViewController, NSString, UIView, UIBarButtonItem, UICollectionView, NSLayoutConstraint, UIInterfaceActionGroupView, NSMutableOrderedSet, NSMutableSet, NSArray, NSDictionary, NSOrderedSet;
@protocol UICollectionViewDelegateTableLayout, UICollectionViewDataSource, DOCAddTagTextFieldDelegate, DOCTagEditorDelegate, DOCTagEditorPresenter;
...
@property (retain, nonatomic) UIInterfaceActionGroupView *confirmButtons; // ivar: _confirmButtons
...
@property (nonatomic) BOOL isExtremelyVerticallyCompact; // ivar: _isExtremelyVerticallyCompact
...
@property (nonatomic) BOOL showAddTagConfirmButtons; // ivar: _showAddTagConfirmButtons
...
-(void)setupCells:(id)arg0 ;
-(void)tagEditor:(id)arg0 userDidCreateTag:(id)arg1 ;
-(void)tagEditor:(id)arg0 userDidDeselectTag:(id)arg1 ;
-(void)tagEditor:(id)arg0 userDidSelectTag:(id)arg1 ;
