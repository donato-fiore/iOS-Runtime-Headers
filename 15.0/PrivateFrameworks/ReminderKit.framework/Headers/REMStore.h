...
-(BOOL)saveSaveRequest:(id)arg0 accountChangeItems:(id)arg1 listChangeItems:(id)arg2 smartListChangeItems:(id)arg3 reminderChangeItems:(id)arg4 author:(id)arg5 replicaManagerProvider:(id)arg6 error:(*id)arg7 ;
...
-(void)_saveAccountChangeItems:(id)arg0 listChangeItems:(id)arg1 smartListChangeItems:(id)arg2 reminderChangeItems:(id)arg3 author:(id)arg4 replicaManagerProvider:(id)arg5 synchronously:(BOOL)arg6 syncToCloudKit:(BOOL)arg7 performer:(id)arg8 completion:(id)arg9 ;
...
-(void)deleteAccountWithAccountID:(id)arg0 completion:(id)arg1 ;
...
-(void)saveSaveRequest:(id)arg0 accountChangeItems:(id)arg1 listChangeItems:(id)arg2 smartListChangeItems:(id)arg3 reminderChangeItems:(id)arg4 author:(id)arg5 replicaManagerProvider:(id)arg6 queue:(id)arg7 completion:(id)arg8 ;
-(void)stopShare:(id)arg0 queue:(id)arg1 completion:(id)arg2 ;
...
-(void)triggerThrottledSyncWithReason:(id)arg0 discretionary:(BOOL)arg1 WithCompletion:(id)arg2 ;
...
-(void)updateShare:(id)arg0 queue:(id)arg1 completion:(id)arg2 ;
