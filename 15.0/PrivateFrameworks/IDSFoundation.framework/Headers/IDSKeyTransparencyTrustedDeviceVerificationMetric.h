...
@property (readonly, nonatomic) NSUInteger numberOfCandidateDevices; // ivar: _numberOfCandidateDevices
@property (readonly, nonatomic) NSUInteger numberOfMatchesFromAccountKey; // ivar: _numberOfMatchesFromAccountKey
@property (readonly, nonatomic) NSUInteger numberOfMatchesFromCloudKit; // ivar: _numberOfMatchesFromCloudKit
@property (readonly, nonatomic) NSUInteger numberOfTotalDevices; // ivar: _numberOfTotalDevices
@property (readonly) unsigned short rtcType;
@property (readonly) Class superclass;


-(id)initWithKeyTransparencyVersion:(NSUInteger)arg0 cloudKitSuccess:(BOOL)arg1 cloudKitErrorDomain:(id)arg2 cloudKitErrorCode:(NSInteger)arg3 cloudKitUnderlyingErrorDomain:(id)arg4 cloudKitUnderlyingErrorCode:(NSInteger)arg5 cloudKitOperationTimeInterval:(CGFloat)arg6 accountKeySuccess:(BOOL)arg7 accountKeyErrorDomain:(id)arg8 accountKeyErrorCode:(NSInteger)arg9 accountKeyUnderlyingErrorDomain:(id)arg10 accountKeyUnderlyingErrorCode:(NSInteger)arg11 accountKeyOperationTimeInterval:(CGFloat)arg12 numberOfTotalDevices:(NSUInteger)arg13 numberOfCandidateDevices:(NSUInteger)arg14 numberOfMatchesFromCloudKit:(NSUInteger)arg15 numberOfMatchesFromAccountKey:(NSUInteger)arg16 ;
