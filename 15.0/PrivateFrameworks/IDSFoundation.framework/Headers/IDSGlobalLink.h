...
@protocol IDSLink, IDSLinkDelegate, IDSStunCandidatePairDelegate, OS_dispatch_source, OS_nw_path_evaluator;
...
-(id)_delayProcessingCellularInterfaces:(id)arg0 ;
...
-(void)_updateSendStatsWithResult:(NSUInteger)arg0 bytesSent:(NSInteger)arg1 packetsSent:(int)arg2 linkID:(char)arg3 delegatedLinkID:(char)arg4 token:(id)arg5 useRelay:(BOOL)arg6 isClientData:(BOOL)arg7 sendTime:(CGFloat)arg8 stunTransport:(NSInteger)arg9 ;
...
-(void)candidatePair:(id)arg0 didReceiveStunErrorResponse:(NSInteger)arg1 errorCode:(unsigned short)arg2 ;
...
-(void)dealloc;
-(void)disconnectCandidatePair:(id)arg0 ;
...
-(void)registerPluginWithName:(id)arg0 relayGroupID:(id)arg1 relaySessionID:(id)arg2 ;
-(void)removeParticipantIDs:(id)arg0 relayGroupID:(id)arg1 relaySessionID:(id)arg2 sessionStateCounter:(unsigned int)arg3 ;
-(void)sendAllocbindRequest:(id)arg0 isRealloc:(BOOL)arg1 inResponseToNoSessionState:(BOOL)arg2 ;
...
-(void)unregisterPlugWithName:(id)arg0 relayGroupID:(id)arg1 relaySessionID:(id)arg2 ;
