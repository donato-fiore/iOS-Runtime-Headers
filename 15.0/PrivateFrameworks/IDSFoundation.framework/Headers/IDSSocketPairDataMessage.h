...
-(id)initWithSequenceNumber:(unsigned int)arg0 streamID:(unsigned short)arg1 expectsPeerResponse:(BOOL)arg2 wantsAppAck:(BOOL)arg3 compressed:(BOOL)arg4 didWakeHint:(BOOL)arg5 peerResponseIdentifier:(id)arg6 messageUUID:(id)arg7 data:(id)arg8 expiryDate:(id)arg9 ;
