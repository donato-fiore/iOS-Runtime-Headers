...
@property (retain, nonatomic) NSMutableDictionary *processIDCache; // ivar: _processIDCache
...
-(void)enumerateProcessIDCacheWithBlock:(id)arg0 ;
...
-(void)removeProcessIDCacheForPidNumber:(id)arg0 ;
...
-(void)setupCoveringIndexOnTable:(id)arg0 withColumns:(id)arg1 ;
