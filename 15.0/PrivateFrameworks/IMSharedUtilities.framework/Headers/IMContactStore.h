...
@class NSMutableDictionary, NSArray, NSData, CNContactStore, NSDictionary, CNContact;
...
-(void)_logDictionaryInformation:(id)arg0 inRange:(struct _NSRange )arg1 ;
-(void)_setBatchFetchingIsCompleted:(BOOL)arg0 ;
