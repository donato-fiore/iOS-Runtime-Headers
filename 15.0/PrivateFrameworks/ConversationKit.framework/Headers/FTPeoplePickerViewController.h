...
@property (nonatomic, weak) NSObject<FTPeoplePickerViewControllerDelegate> *delegate; // ivar: delegate


-(id)initWithCoder:(id)arg0 ;
-(id)initWithNibName:(id)arg0 bundle:(id)arg1 ;
-(id)initWithStyle:(NSInteger)arg0 existingAddresses:(id)arg1 currentConversation:(id)arg2 ;
