...
#import "AFHeadphonesAnnouncementRoute.h"
...
@property (retain, nonatomic) AFHeadphonesAnnouncementRoute *currentlyRoutedHeadphonesRoute; // ivar: _currentlyRoutedHeadphonesRoute
...
-(NSUInteger)_routeCapabilitiesForRouteDescription:(id)arg0 ;
