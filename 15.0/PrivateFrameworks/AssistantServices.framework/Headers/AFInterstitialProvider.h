...
-(id)initWithStyle:(NSInteger)arg0 recordRoute:(id)arg1 isVoiceTrigger:(BOOL)arg2 isDucking:(BOOL)arg3 isTwoShot:(BOOL)arg4 speechEndHostTime:(NSUInteger)arg5 context:(id)arg6 instanceContext:(id)arg7 delegate:(id)arg8 ;
-(void)_invalidate;
