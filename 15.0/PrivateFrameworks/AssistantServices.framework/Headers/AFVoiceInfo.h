...
@property (retain, nonatomic) AFOutputVoiceColorDescriptor *colorDescriptor; // ivar: _colorDescriptor
...
@property (readonly, nonatomic) BOOL wasInitalizedFromDictionaryRepresentation; // ivar: _wasInitalizedFromDictionaryRepresentation
