...
@class NSXPCConnection, NSString, NSSet, NSMutableData, NSArray;
...
-(void)_delegateDidRecognizeSpeechTokens:(id)arg0 languageModel:(id)arg1 delegate:(id)arg2 ;
...
-(void)_tellSpeechDelegateDidRecognizeSpeechPhrases:(id)arg0 utterances:(id)arg1 languageModel:(id)arg2 correctionIdentifier:(id)arg3 audioAnalytics:(id)arg4 ;
-(void)_tellSpeechDelegateDidRecognizeSpeechTokens:(id)arg0 languageModel:(id)arg1 ;
