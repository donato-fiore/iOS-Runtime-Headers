...
@property (readonly, copy, nonatomic) NSArray *contextSnapshots; // ivar: _contextSnapshots
...
-(id)initWithIdentifier:(id)arg0 assistantIdentifier:(id)arg1 mediaSystemIdentifier:(id)arg2 mediaRouteIdentifier:(id)arg3 sharedUserID:(id)arg4 roomName:(id)arg5 proximity:(NSInteger)arg6 contextSnapshots:(id)arg7 serializedContextByKey:(id)arg8 metricsContext:(id)arg9 ;
-(id)initWithIdentifier:(id)arg0 mediaSystemIdentifier:(id)arg1 mediaRouteIdentifier:(id)arg2 roomName:(id)arg3 proximity:(NSInteger)arg4 contextSnapshots:(id)arg5 serializedContextByKey:(id)arg6 metricsContext:(id)arg7 ;
-(id)initWithIdentifier:(id)arg0 mediaSystemIdentifier:(id)arg1 mediaRouteIdentifier:(id)arg2 sharedUserID:(id)arg3 roomName:(id)arg4 proximity:(NSInteger)arg5 contextSnapshots:(id)arg6 serializedContextByKey:(id)arg7 metricsContext:(id)arg8 ;
