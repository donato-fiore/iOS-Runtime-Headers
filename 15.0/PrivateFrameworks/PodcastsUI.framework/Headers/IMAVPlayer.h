...
@class NSTimer, MPRemoteCommandCenter, NSString, UIWindow, MPNowPlayingInfoCenter, NSURL, NSMutableArray, AVPlayer, AVPlayerItem, AVPlayerLayer;
...
-(float)storedVolume;
-(id)init;
-(id)initWithCommandCenter:(id)arg0 infoCenter:(id)arg1 ;
