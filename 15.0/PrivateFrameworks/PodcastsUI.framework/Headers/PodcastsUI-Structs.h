...
typedef struct _AMPDirectionalRange {
    _NSRange field0;
    NSInteger field1;
    BOOL field2;
} _AMPDirectionalRange;
...
typedef struct vector<MTMPU::LayoutInterpolator::EntriesContainer, std::allocator<MTMPU::LayoutInterpolator::EntriesContainer>> {
} // Error Processing Struct Fields
