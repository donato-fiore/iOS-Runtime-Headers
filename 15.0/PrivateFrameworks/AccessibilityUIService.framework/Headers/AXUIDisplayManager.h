...
@class NSMutableDictionary, NSString, SBSAccessibilityWindowHostingController;
...
-(id)_windowWithUserInteractionEnabled:(BOOL)arg0 windowLevel:(CGFloat)arg1 createIfNeeded:(BOOL)arg2 purposeIdentifier:(id)arg3 userInterfaceStyle:(NSInteger)arg4 allowSystemAppHosting:(BOOL)arg5 ;
...
-(void)addContentViewController:(id)arg0 withUserInteractionEnabled:(BOOL)arg1 forService:(id)arg2 context:(*void)arg3 userInterfaceStyle:(NSInteger)arg4 allowSystemAppHosting:(BOOL)arg5 completion:(id)arg6 ;
