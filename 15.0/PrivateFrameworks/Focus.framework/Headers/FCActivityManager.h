...
@class DNDModeSelectionService, DNDLifetimeDetailsProvider, DNDStateService, NSHashTable, DNDModeAssertion, DNDStateUpdate, NSMutableDictionary, NSArray, ATXActivitySuggestionClient, NSMapTable, NSString;
