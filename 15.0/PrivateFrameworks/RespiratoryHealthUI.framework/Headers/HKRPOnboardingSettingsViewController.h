...
@class UIViewController, UIVisualEffectView, UIView, UILabel, HKRPOxygenSaturationOnboardingManager, UIScrollView, HKRPOxygenSaturationSettings, OBLinkTrayButton, OBBoldTrayButton;
@protocol BPSMiniFlowStepController, BPSSetupMiniFlowControllerDelegate, HKRPOnboardingDelegate;
