...
+(id)announceGroupFaceTimeInviteNotification:(id)arg0 synchronousBurstIndex:(id)arg1 ;
...
+(id)announceVoicemailRequestForNotification:(id)arg0 synchronousBurstIndex:(id)arg1 ;
