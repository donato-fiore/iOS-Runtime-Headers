...
-(id)initWithMode:(id)arg0 configuration:(id)arg1 triggers:(id)arg2 impactsAvailability:(NSUInteger)arg3 dimsLockScreen:(NSUInteger)arg4 created:(id)arg5 lastModified:(id)arg6 automaticallyGenerated:(BOOL)arg7 ;
