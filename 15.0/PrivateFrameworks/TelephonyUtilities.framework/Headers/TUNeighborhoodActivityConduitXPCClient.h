...
-(void)approveSplitSessionForConversation:(id)arg0 requestedFromDevice:(id)arg1 proposedActivityInfo:(id)arg2 completion:(id)arg3 ;
...
-(void)participantHandleForTVDevice:(id)arg0 completion:(id)arg1 ;
