...
@property (nonatomic, getter=isCarPlayConnected) BOOL carPlayConnected; // ivar: _carPlayConnected
@property (readonly, nonatomic, getter=isCarPlayParticipant) BOOL carPlayParticipant;
...
+(id)predicateForCarPlayOrInEarTriangleRoute:(SEL)arg0 ;
