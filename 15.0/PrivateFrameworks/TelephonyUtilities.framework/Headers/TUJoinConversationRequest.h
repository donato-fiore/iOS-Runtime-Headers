...
@protocol TUFilteredRequest, NSCopying, NSSecureCoding;
...
@property (nonatomic) TUConversationActivity *activity; // ivar: _activity
...
@property (readonly, copy, nonatomic) NSSet *remoteMembers; // ivar: _remoteMembers
