...
@property (nonatomic) BOOL hasWrittenImageDataToDisk; // ivar: _hasWrittenImageDataToDisk
...
-(id)initWithContext:(id)arg0 linkMetadata:(id)arg1 fallbackURL:(id)arg2 invitationURL:(id)arg3 supportsContinuationOnTV:(BOOL)arg4 title:(id)arg5 subTitle:(id)arg6 imageData:(id)arg7 preferredBroadcastingAttributes:(NSInteger)arg8 ;
-(id)sanitizedCopy;
