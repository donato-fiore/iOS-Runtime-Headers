...
-(id)initWithParticipantIdentifier:(NSUInteger)arg0 videoQuality:(NSUInteger)arg1 visibility:(id)arg2 prominence:(id)arg3 spatialPosition:(struct CGRect )arg4 ;
