...
@protocol NSXPCListenerDelegate, OSASyncProxyServices, OSASyncProxyHandler, OS_dispatch_source, OS_os_transaction, OS_dispatch_queue;
...
@property (readonly) NSObject<OS_dispatch_queue> *initializationQueue; // ivar: _request_queue
...
-(void)handleConnection:(BOOL)arg0 ;
-(void)handleFile:(id)arg0 metadata:(id)arg1 ;
-(void)handleMessage:(id)arg0 from:(id)arg1 ;
-(void)listDevices:(id)arg0 ;
-(void)onReport:(id)arg0 ;
