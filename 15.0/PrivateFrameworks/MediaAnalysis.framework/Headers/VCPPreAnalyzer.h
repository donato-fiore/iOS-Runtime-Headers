...
-(?)_convertFromBuffer:(?)arg0 toLumaPixelBufferisPano;
...
-(?)_loadImageURL:(?)arg0 isPano:(?)arg1 colorPixelBuffer:(?)arg2 andLumaPixelBufferimage;
...
-(id)init;
-(int)_collectSceneAnalysisResults:(*id)arg0 fromRequests:(id)arg1 wpResults:(id)arg2 ivsResults:(id)arg3 ;
-(int)_createRequests:(id)arg0 ;
-(int)_performAnalysis:(*id)arg0 isPano:(BOOL)arg1 isSDOF:(BOOL)arg2 colorPixelBuffer:(struct __CVBuffer *)arg3 andLumaPixelBuffer:(struct __CVBuffer *)arg4 image:(id)arg5 ;
-(int)_performBlurAnalysis:(*id)arg0 withLumaPixelBuffer:(struct __CVBuffer *)arg1 isPano:(BOOL)arg2 isSDOF:(BOOL)arg3 ;
...
-(int)_performSceneAnalysis:(*id)arg0 image:(id)arg1 isPano:(BOOL)arg2 ;
-(int)analyzeWithPixelBuffer:(struct __CVBuffer *)arg0 isPano:(BOOL)arg1 isSDOF:(BOOL)arg2 results:(*id)arg3 cancel:(id)arg4 ;
...
-(void)analyzeWithImageURL:(id)arg0 isPano:(BOOL)arg1 isSDOF:(BOOL)arg2 completionHandler:(id)arg3 ;
-(void)dealloc;
