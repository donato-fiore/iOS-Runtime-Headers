...
-(id)_analyzeOndemand:(id)arg0 forAnalysisTypes:(NSUInteger)arg1 withExistingAnalysis:(id)arg2 andOptions:(id)arg3 storeAnalysis:(BOOL)arg4 ;
...
-(id)init;
-(id)requestAnalysis:(NSUInteger)arg0 forAsset:(id)arg1 withExistingAnalysis:(id)arg2 andDatabase:(id)arg3 andOptions:(id)arg4 ;
...
// -(int)requestAnalysisTypes:(NSUInteger)arg0 forAssets:(id)arg1 withOptions:(id)arg2 andProgressHandler:(id)arg3 analyses:(unk)arg4  ;
