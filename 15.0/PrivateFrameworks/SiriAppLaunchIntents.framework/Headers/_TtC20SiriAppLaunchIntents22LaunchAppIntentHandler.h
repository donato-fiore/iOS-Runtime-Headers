...
-(id)init;
-(void)confirmLaunchApp:(id)arg0 completion:(id)arg1 ;
-(void)handleLaunchApp:(id)arg0 completion:(id)arg1 ;
-(void)resolveApplicationForLaunchApp:(id)arg0 withCompletion:(id)arg1 ;
