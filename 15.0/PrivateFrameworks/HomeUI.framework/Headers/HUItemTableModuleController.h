...
#ifndef HUITEMTABLEMODULECONTROLLER_H
#define HUITEMTABLEMODULECONTROLLER_H

@class NSString, HFItemModule;
@protocol HUItemTableTextEditingController, HUItemTableModuleControllerHosting;
...
@property (weak, nonatomic) NSObject<HUItemTableModuleControllerHosting> *host; // ivar: _host
