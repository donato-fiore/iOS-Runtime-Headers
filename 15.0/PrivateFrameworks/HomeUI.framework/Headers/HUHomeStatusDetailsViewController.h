...
#ifndef HUHOMESTATUSDETAILSVIEWCONTROLLER_H
#define HUHOMESTATUSDETAILSVIEWCONTROLLER_H

@class NSString, NSMutableDictionary;
@protocol HUAboutResidentDeviceViewControllerDelegate, UITextViewDelegate, HUSoftwareUpdateUIPresentationDelegate, HUHomeStatusDetailsViewControllerDelegate;
...
@property (weak, nonatomic) NSObject<HUHomeStatusDetailsViewControllerDelegate> *delegate;
