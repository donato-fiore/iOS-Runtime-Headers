...
@protocol HFExecutionEnvironmentObserver, UICollectionViewDataSourcePrefetching, UITextFieldDelegate, HFItemManagerDelegate, HUItemManagerContainer, HUItemPresentationContainer, HUPreloadableViewController, HFDiffableDataItemManagerDelegate, NACancelable;
