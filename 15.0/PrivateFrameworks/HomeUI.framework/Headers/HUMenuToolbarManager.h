...
@protocol HFHomeObserver, HFHomeManagerObserver, UIMenuBuilder, HOSideBarSelectionChangeDelegate;
...
-(id)initWithAppNavigator:(id)arg0 sideBarSelectionChangeDelegate:(id)arg1 ;
