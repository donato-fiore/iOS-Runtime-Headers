...
@property (retain, nonatomic) UIImageView *iPadImageView; // ivar: _iPadImageView
@property (retain, nonatomic) UILabel *iPadTextLabel; // ivar: _iPadTextLabel
...
+(CGFloat)atvTextBaselineToiPadImageConstant;
+(CGFloat)iPadImageToTextBaselineConstantForViewSizeSubclass:(NSInteger)arg0 ;
