...
@class UIViewController, UIColor, UIVisualEffectView, UIButton, NSMutableArray, NSSet, NSString, UIImpactFeedbackGenerator, UIPanGestureRecognizer, UILayoutGuide, UIScrollView, HFItem, UIActivityIndicatorView, UIView, NAFuture, NAPromise;
@protocol HFItemManagerDelegate, UIGestureRecognizerDelegate, HUQuickControlViewControllerCoordinatorDelegate, HUViewControllerCustomDismissing, UIScrollViewDelegate, HUCardViewControllerDelegate;
