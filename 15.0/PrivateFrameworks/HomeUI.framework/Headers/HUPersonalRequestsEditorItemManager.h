...
@property (readonly, nonatomic) HFItem *neverRequireAuthenticationItem; // ivar: _neverRequireAuthenticationItem
...
@property (readonly, nonatomic) HFItem *requireAuthenticationForSecureRequestsItem; // ivar: _requireAuthenticationForSecureRequestsItem
