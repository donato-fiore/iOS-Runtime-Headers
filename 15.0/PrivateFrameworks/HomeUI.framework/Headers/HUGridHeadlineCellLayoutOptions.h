...
+(id)defaultOptionsForCellSizeSubclass:(NSInteger)arg0 viewSizeSubclass:(NSInteger)arg1 viewWidth:(CGFloat)arg2 navigationBarBottomInset:(CGFloat)arg3 containerLeadingMargin:(CGFloat)arg4 containerTrailingMargin:(CGFloat)arg5 ;
