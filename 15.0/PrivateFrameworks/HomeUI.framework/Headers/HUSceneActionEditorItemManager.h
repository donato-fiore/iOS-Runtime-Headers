...
@class HFItemManager, NSSet, NSMutableDictionary, HFActionSetBuilder, HFStaticItem;
...
@property (retain, nonatomic) HFStaticItem *favoriteItem; // ivar: _favoriteItem
...
@property (copy, nonatomic) NSSet *prioritizedServices; // ivar: _prioritizedServices
