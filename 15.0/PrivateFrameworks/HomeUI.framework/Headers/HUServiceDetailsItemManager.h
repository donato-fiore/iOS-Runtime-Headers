...
@protocol HUServiceDetailsControlAndCharacteristicStateItemModuleDelegate, HFAccessorySettingDeviceOptionsAdapterUtilityDelegate, HUServiceDetailsItemManagerDelegate, HFHomeKitObject;
...
@property (retain, nonatomic) HFItem *connectedEcosystemsItem; // ivar: _connectedEcosystemsItem
