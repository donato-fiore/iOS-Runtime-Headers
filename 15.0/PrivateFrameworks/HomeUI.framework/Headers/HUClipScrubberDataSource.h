...
@class UICollectionView, NSArray, NSDate, NSString, UICollectionViewDiffableDataSource, HFCameraPlaybackEngine;
@protocol HFCameraPlaybackEngineObserver, UICollectionViewDataSource, HFCameraRecordingEvent;
...
@property (retain, nonatomic) NSArray *clipEvents; // ivar: _clipEvents
