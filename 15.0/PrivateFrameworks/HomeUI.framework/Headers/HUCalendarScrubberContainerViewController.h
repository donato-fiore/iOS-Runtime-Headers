...
@class UIViewController, AVBackgroundView, NSLayoutConstraint, NSString, UIView, NSDate, UIButton, HFCameraPlaybackEngine;
...
@property (retain, nonatomic) NSLayoutConstraint *backgroundWidthConstraint; // ivar: _backgroundWidthConstraint
