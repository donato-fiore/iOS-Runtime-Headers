...
-(?)dovi_setScalingFactorTable:(?)arg0 tableSize:(?)arg1 config:(?)arg2 hdrCtrl:(?)arg3 tmParam:(?)arg4 edrAdaptationParam:(?)arg5 ambAdaptationParam:(?)arg6 hlgOOTFCombined:(?)arg7 hlgOOTFOnlyisDoVi84;
...
-(void)dovi_computeDM4Tables:(struct _DoViTMParam *)arg0 edrAdaptationParam:(struct _EdrAdaptationParam *)arg1 ambAdaptationParam:(struct _AmbAdaptationParam *)arg2 tLutI:(*float)arg3 tLutS:(*float)arg4 sLutI:(*float)arg5 sLutS:(*float)arg6 tLutISize:(NSUInteger)arg7 tLutSSize:(NSUInteger)arg8 sLutISize:(NSUInteger)arg9 sLutSSize:(NSUInteger)arg10 IsDoVi84:(BOOL)arg11 HlgOOTFCombined:(BOOL)arg12 ;
