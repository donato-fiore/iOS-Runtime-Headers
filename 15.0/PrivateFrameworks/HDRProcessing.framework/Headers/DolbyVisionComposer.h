...
-(void)checkInputFormats:(unsigned int)arg0 returnInput1:(*BOOL)arg1 returnInput2:(*BOOL)arg2 returnInput3:(*BOOL)arg3 outputFormat:(unsigned int)arg4 returnOutput1:(*BOOL)arg5 returnOutput2:(*BOOL)arg6 returnOutput3:(*BOOL)arg7 returnOutput4:(*BOOL)arg8 ;
