...
@protocol MRURoutingSubtitleControllerDelegate, MRUVisualStylingProviderObserver, UIGestureRecognizerDelegate, UIPointerInteractionDelegate, MRURoutingTableViewCellDelegate;
...
@property (nonatomic) BOOL showOutline; // ivar: _showOutline
@property (nonatomic) BOOL showVolumeSlider; // ivar: _showVolumeSlider
...
@property (retain, nonatomic) MRUVolumeSlider *volumeSlider; // ivar: _volumeSlider
...
-(void)routingSubtitleStateController:(id)arg0 didUpdateText:(id)arg1 accessory:(NSInteger)arg2 ;
