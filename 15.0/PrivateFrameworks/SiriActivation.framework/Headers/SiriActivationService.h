...
-(BOOL)_shouldEyesFreeCancelScreenWakeForRequestOptions:(id)arg0 ;
...
-(void)_handlePocketStateFetchForScreenWakeForPresentationIdentifier:(NSInteger)arg0 requestOptions:(id)arg1 presentationOptions:(id)arg2 ;
...
-(void)buttonDownFromButtonIdentifier:(NSInteger)arg0 timestamp:(CGFloat)arg1 ;
-(void)buttonLongPressFromButtonIdentifier:(NSInteger)arg0 context:(id)arg1 ;
-(void)buttonTapFromButtonIdentifier:(NSInteger)arg0 ;
-(void)buttonUpFromButtonIdentifier:(NSInteger)arg0 deviceIdentifier:(id)arg1 timestamp:(CGFloat)arg2 ;
