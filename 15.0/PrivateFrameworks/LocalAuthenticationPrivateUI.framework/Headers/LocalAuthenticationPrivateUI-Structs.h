...
typedef struct spline_instance_state {
    quatf field0;
    quatf field1;
    float field2;
    float field3;
...
typedef struct renderer_shared_state {
    ...
    array<id<MTLRenderPipelineState>, 3> tesselation_factor_pipeline;
    array<id<MTLRenderPipelineState>, 3> <MTLComputePipelineState>;
    id tube_pipeline;
    id <MTLRenderPipelineState>;
    id begin_cap_pipelines;
} renderer_shared_state;

typedef struct optional<LAUI_uniform_cubic_b_spline_renderer::renderer_shared_state> {
    unk field0;
    char field1;
    renderer_shared_state field2;
    BOOL field3;
} optional<LAUI_uniform_cubic_b_spline_renderer::renderer_shared_state>;
