...
+(id)_calculateTrainingMetricsWithSamplingProb:(CGFloat)arg0 groundTruthProvider:(id)arg1 predictionsProvider:(id)arg2 trueLabelName:(id)arg3 trainingOutputName:(id)arg4 lossValueName:(id)arg5 probThreshold:(CGFloat)arg6 ;
