...
@class SUAutoInstallOperation, SUManagerClient, NSString, SUDescriptor, NSError, SUDownload, SUMutableDownloadMetadata, UIViewController, SUInstallPolicy, RUIStyle;
@protocol SUManagerClientDelegate, SUNetworkObserver, SUAutoInstallOperationDelegate, SUSUISoftwareUpdateManagerDelegate;

#import <Foundation/Foundation.h>

#import "SUSUIUpdateAgreementManager.h"

@interface SUSUISoftwareUpdateManager : NSObject <SUManagerClientDelegate, SUNetworkObserver, SUAutoInstallOperationDelegate>
...
-(void)presentTermsIfNecessaryCompletionForUpdate:(id)arg0 handler:(id)arg1 ;
...
-(void)refreshErrors:(id)arg0 alternateError:(id)arg1 ;
-(void)refreshState;
-(void)resumeDownload;
...
-(void)setAutomaticUpdateScheduled:(BOOL)arg0 ;
