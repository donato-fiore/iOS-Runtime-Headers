...
@property (nonatomic) NSInteger maxNeighborRssi; // ivar: _maxNeighborRssi
...
@property (nonatomic) NSInteger minNeighborRssi; // ivar: _minNeighborRssi
...
@property (retain, nonatomic) NSMutableSet *roam24GHzCandidates; // ivar: _roam24GHzCandidates
@property (retain, nonatomic) NSMutableSet *roam5GHzCandidates; // ivar: _roam5GHzCandidates
...
-(id)initWithInterfaceName:(id)arg0 bssEnvironment:(id)arg1 andBssDetails:(id)arg2 ;
