...
@property (retain, nonatomic) NSString *oui; // ivar: _oui
...
-(id)initWithBeaconData:(id)arg0 ;
-(void)parseBeaconIE:(char *)arg0 length:(NSUInteger)arg1 endOfBuffer:(char *)arg2 ;
