...
-(id)initWithIdentifier:(id)arg0 adType:(NSInteger)arg1 desiredPosition:(NSInteger)arg2 videoURL:(id)arg3 duration:(CGFloat)arg4 fileSize:(NSInteger)arg5 skipThreshold:(CGFloat)arg6 skipEnabled:(BOOL)arg7 unbranded:(BOOL)arg8 bitrate:(CGFloat)arg9 connectionType:(NSInteger)arg10 signalStrength:(NSUInteger)arg11 tapAction:(id)arg12 ;
