...
-(id)initWithIdentifier:(id)arg0 adType:(NSInteger)arg1 desiredPosition:(NSInteger)arg2 privacyMarkerPosition:(NSInteger)arg3 adSize:(struct CGSize )arg4 headline:(id)arg5 accessibilityHeadline:(id)arg6 adCopy:(id)arg7 accessibilityAdCopy:(id)arg8 sponsoredBy:(id)arg9 elements:(id)arg10 ;
