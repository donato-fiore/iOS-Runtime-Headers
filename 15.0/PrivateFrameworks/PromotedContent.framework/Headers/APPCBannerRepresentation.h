...
-(id)initWithIdentifier:(id)arg0 adType:(NSInteger)arg1 desiredPosition:(NSInteger)arg2 privacyMarkerPosition:(NSInteger)arg3 adSize:(struct CGSize )arg4 tapAction:(id)arg5 adTag:(id)arg6 outstreamVideoInfo:(id)arg7 adamIdentifier:(id)arg8 tapActionTemplateType:(NSInteger)arg9 ;
