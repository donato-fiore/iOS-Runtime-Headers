...
+(id)createDNSPolicies:(id)arg0 ingressProxyURL:(id)arg1 ;
+(id)createHTTPPolicies:(id)arg0 skipUnencrypted:(BOOL)arg1 machOUUIDs:(id)arg2 ;
+(id)createPoliciesFromPolicyMask:(int)arg0 flowDivertHandle:(id)arg1 ingressProxyURL:(id)arg2 captivePluginBundleIDs:(id)arg3 ;
...
+(id)policiesWithProtoBuf:(id)arg0 flowDivertHandle:(id)arg1 ingressProxyURL:(id)arg2 captivePluginBundleIDs:(id)arg3 ;
