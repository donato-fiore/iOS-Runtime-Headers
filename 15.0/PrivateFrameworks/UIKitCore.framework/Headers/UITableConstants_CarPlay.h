...
-(CGFloat)_defaultPlainHeaderFooterHeightForTableViewStyle:(NSInteger)arg0 ;
...
-(CGFloat)defaultGroupedFooterHeightForTableView:(id)arg0 ;
-(CGFloat)defaultGroupedHeaderHeightForTableView:(id)arg0 ;
...
-(NSUInteger)contentClipCornersForCell:(id)arg0 inTableView:(id)arg1 ;
-(id)_defaultAccessoryColorFocused:(BOOL)arg0 ;
-(id)_imageWithName:(id)arg0 accessoryBaseColor:(id)arg1 ;
...
-(id)defaultAccessoryColorForCell:(id)arg0 inTableView:(id)arg1 ;
...
-(id)defaultFocusedAccessoryColorForCell:(id)arg0 inTableView:(id)arg1 ;
...
-(struct UIEdgeInsets )defaultHeaderFooterLayoutMarginsForTableViewStyle:(NSInteger)arg0 ;
...
-(struct UIEdgeInsets )headerFooterOffsetFromContentInsetForTableView:(id)arg0 ;
...
-(struct _UITableConstantsBackgroundProperties )defaultSidebarHeaderBackgroundPropertiesWithState:(id)arg0 traitCollection:(id)arg1 isAccompanied:(BOOL)arg2 ;
