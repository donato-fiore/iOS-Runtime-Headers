...
-(void)_addGestureRecognizersForTouchContinuationInView:(id)arg0 toTouch:(id)arg1 ;
-(void)_addGestureRecognizersForView:(id)arg0 toTouch:(id)arg1 ;
-(void)_addGestureRecognizersForView:(id)arg0 toTouch:(id)arg1 forContinuation:(BOOL)arg2 ;
...
-(void)_collectGestureRecognizersForView:(id)arg0 withBlock:(id)arg1 ;
