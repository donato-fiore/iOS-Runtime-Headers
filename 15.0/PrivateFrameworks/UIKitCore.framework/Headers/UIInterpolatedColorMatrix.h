...
+(id)epsilon;
+(id)valueWithColorMatrix:(struct CAColorMatrix )arg0 ;
+(id)zero;
...
-(id)getNSValue;
-(id)getValue;
-(id)initWithColorMatrix:(struct CAColorMatrix )arg0 ;
-(id)initWithColorMatrix:(struct CAColorMatrix )arg0 epsilon:(CGFloat)arg1 ;
