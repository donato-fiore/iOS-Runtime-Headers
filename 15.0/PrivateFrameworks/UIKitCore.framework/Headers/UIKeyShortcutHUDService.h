...
@class NSString, NSValue, NSTimer;
...
@property (retain, nonatomic) _UIKeyShortcutHUDModifierKeyListener *modifierKeyListener; // ivar: _modifierKeyListener
@property (retain, nonatomic) _UIKeyShortcutHUDConfiguration *scheduledHUDConfiguration; // ivar: _scheduledHUDConfiguration
@property (retain, nonatomic) _UIInertHoverGestureRecognizer *scheduledHUDHoverGestureRecognizer; // ivar: _scheduledHUDHoverGestureRecognizer
