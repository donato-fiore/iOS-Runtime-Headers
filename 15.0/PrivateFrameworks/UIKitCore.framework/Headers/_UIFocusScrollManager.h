...
-(struct CGPoint )_contentOffsetForNonPagingContainer:(id)arg0 toShowFocusItemWithInfo:(id)arg1 itemFrame:(struct CGRect )arg2 targetOffset:(struct CGPoint )arg3 targetBounds:(struct CGRect )arg4 ;
-(struct CGPoint )_contentOffsetForPagingContainer:(id)arg0 itemFrame:(struct CGRect )arg1 targetOffset:(struct CGPoint )arg2 ;
-(struct CGPoint )_contentOffsetForScrollableContainer:(id)arg0 toShowFocusItemWithInfo:(id)arg1 ;
-(struct CGPoint )_contentOffsetForScrollableContainer:(id)arg0 toShowFocusItemWithInfo:(id)arg1 itemFrame:(struct CGRect )arg2 targetOffset:(struct CGPoint )arg3 targetBounds:(struct CGRect )arg4 ;
...
-(struct CGPoint )contentOffsetForScrollableContainer:(id)arg0 toShowFocusItemWithInfo:(id)arg1 ;
...
-(void)_ensureFocusItemIsOnscreen:(id)arg0 inScrollableContainer:(id)arg1 ;
-(void)_scrollToFocusItemWithInfo:(id)arg0 offset:(struct CGPoint )arg1 inScrollableContainer:(id)arg2 ;
-(void)animateOffsetOfScrollableContainer:(id)arg0 toShowFocusItem:(id)arg1 ;
-(void)animateOffsetOfScrollableContainersInParentContainer:(id)arg0 toShowFocusItem:(id)arg1 ;
