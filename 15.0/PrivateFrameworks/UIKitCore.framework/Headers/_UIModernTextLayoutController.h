...
#ifndef _UIMODERNTEXTLAYOUTCONTROLLER_H
#define _UIMODERNTEXTLAYOUTCONTROLLER_H

@class UITextLayoutController, NSTextContentStorage, NSTextLayoutManager, NSMutableSet, NSMapTable, NSString;
@protocol NSTextLayoutManagerDelegate;



@interface _UIModernTextLayoutController : UITextLayoutController <NSTextLayoutManagerDelegate>
