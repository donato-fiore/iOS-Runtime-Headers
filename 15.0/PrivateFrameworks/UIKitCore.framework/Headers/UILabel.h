...
@class NSAttributedString, NSDictionary, NSMutableDictionary, CUICatalog, CUIStyleEffectConfiguration, UIFont, NSString;
...
-(void)_setWordRoundingEnabled:(BOOL)arg0 ;
