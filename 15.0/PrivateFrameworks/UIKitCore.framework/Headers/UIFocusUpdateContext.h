...
@protocol UIFocusEnvironment, UIFocusItemScrollableContainer, _UIFocusBehavior, UIFocusItem, _UIFocusUpdateRequesting;
...
@property (retain, nonatomic, getter=_commonScrollableContainer, setter=_setCommonScrollableContainer:) NSObject<UIFocusItemScrollableContainer> *commonScrollableContainer; // ivar: _commonScrollableContainer
