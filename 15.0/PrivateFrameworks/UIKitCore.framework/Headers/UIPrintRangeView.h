...
@property (retain, nonatomic) UIPrintPageRangeOption *pageRangePrintOption; // ivar: _pageRangePrintOption
...
-(id)initWithFrame:(struct CGRect )arg0 pageRangePrintOption:(id)arg1 ;
