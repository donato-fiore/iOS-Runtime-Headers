...
-(id)initWithInfo:(id)arg0 size:(int)arg1 barStyle:(NSInteger)arg2 tintColor:(id)arg3 appearanceStorage:(id)arg4 position:(unsigned int)arg5 autosizeText:(BOOL)arg6 adjustsForContentSizeCategory:(BOOL)arg7 ;
-(id)label;
-(id)objectValue;
