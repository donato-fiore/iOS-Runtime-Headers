...
@property (retain, nonatomic) UIColor *underlineColorForSpelling; // ivar: underlineColorForSpelling
@property (retain, nonatomic) UIColor *underlineColorForTextAlternatives; // ivar: underlineColorForTextAlternatives
