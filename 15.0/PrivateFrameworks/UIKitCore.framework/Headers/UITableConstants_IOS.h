...
-(struct _UITableConstantsBackgroundProperties )_adjustedBackgroundPropertiesForFocus:(struct _UITableConstantsBackgroundProperties )arg0 withTraitCollection:(id)arg1 cellState:(id)arg2 isHeader:(BOOL)arg3 usesTintToIndicateFocus:(*BOOL)arg4 didApplyFocusState:(*BOOL)arg5 ;
