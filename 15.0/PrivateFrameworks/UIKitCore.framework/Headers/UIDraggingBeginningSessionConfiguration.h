...
@property (nonatomic) CGPoint initialCentroidInSourceWindow; // ivar: _initialCentroidInSourceWindow
@property (readonly, nonatomic) NSArray *items; // ivar: _items
@property (readonly, nonatomic) UIView *sourceView; // ivar: _sourceView


+(id)configurationWithItems:(id)arg0 dataOwner:(NSInteger)arg1 initialCentroidInSourceWindow:(struct CGPoint )arg2 requiredContextIds:(id)arg3 sourceView:(id)arg4 accessibilityEndpoint:(id)arg5 ;
