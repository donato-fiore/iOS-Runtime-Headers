...
@property (nonatomic, getter=_textPathCornerRadius, setter=_setTextPathCornerRadius:) CGFloat textPathCornerRadius; // ivar: _textPathCornerRadius
@property (nonatomic, getter=_textPathInsets, setter=_setTextPathInsets:) UIEdgeInsets textPathInsets; // ivar: _textPathInsets
