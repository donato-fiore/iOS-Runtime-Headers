...
@interface UICollectionView : UIScrollView <_UIHorizontalIndexTitleBarDelegate, _UIUpdateCycleIdleObserver, UIContextMenuInteractionDelegate, _UIKeyboardAutoRespondingScrollView, _UIDataSourceBackedView, UIDataSourceTranslating>

 {
    ...
    NSUInteger _requestedPositionOfTargetIndexPathForScrolling;
...
@property (retain, nonatomic, getter=_focusedCell, setter=_setFocusedCell:) UICollectionReusableView *focusedCell; // ivar: _focusedCell
@property (copy, nonatomic, getter=_focusedCellElementKind, setter=_setFocusedCellElementKind:) NSString *focusedCellElementKind; // ivar: _focusedCellElementKind
...
-(void)_updateFocusedCell:(id)arg0 atIndexPath:(id)arg1 viewType:(NSInteger)arg2 ;
