...
-(id)_nextFocusedItemForFocusMovementRequest:(id)arg0 inRegions:(id)arg1 ;
-(id)_nextFocusedItemForFocusMovementRequest:(id)arg0 startingFromRegion:(id)arg1 ;
-(id)_nextFocusedItemForFocusMovementRequest:(id)arg0 startingFromRegion:(id)arg1 inRegions:(id)arg2 ;
-(id)_nextFocusedItemForLinearFocusMovementRequest:(id)arg0 startingFromRegion:(id)arg1 inRegions:(id)arg2 ;
-(id)_nextFocusedItemForNonLinearFocusMovementRequest:(id)arg0 startingFromRegion:(id)arg1 inRegions:(id)arg2 ;
