...
#ifndef _UIFOCUSACTIVESCENEOBSERVERV1IMPL_H
#define _UIFOCUSACTIVESCENEOBSERVERV1IMPL_H
...
@interface _UIFocusActiveSceneObserverV1Impl : UIFocusActiveSceneObserver <BKSHIDEventDeliveryPolicyObserving>
