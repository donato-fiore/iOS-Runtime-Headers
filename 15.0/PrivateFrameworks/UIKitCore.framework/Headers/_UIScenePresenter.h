...
@class NSString, BSMonotonicReferenceTime, UIView<UIScenePresentation>, FBScene;
...
@property (retain, nonatomic) BSMonotonicReferenceTime *_initializeTime; // ivar: _initializeTime
