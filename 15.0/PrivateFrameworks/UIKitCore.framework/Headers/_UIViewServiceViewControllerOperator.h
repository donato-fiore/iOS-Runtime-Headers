...
@class NSMutableArray, NSString, NSArray, NSUndoManager;
...
-(void)__hostViewWillTransitionToSize:(struct CGSize )arg0 withContextDescription:(id)arg1 boundingPath:(id)arg2 statusBarHeight:(CGFloat)arg3 underlapsStatusBar:(BOOL)arg4 fence:(id)arg5 hostPresentationTime:(NSUInteger)arg6 whenDone:(id)arg7 ;
...
-(void)_wantsKeyboardEventEnvironmentDeferringWithoutFirstResponder:(id)arg0 ;
