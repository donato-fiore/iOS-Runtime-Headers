...
@protocol _UIViewBoundingPathChangeObserver, _UISheetPresentationControllerDetentResolutionContext, _UISheetLayoutInfoDelegate;
...
@property (readonly, nonatomic) CGFloat _depthLevel; // ivar: __depthLevel
...
@property (retain, nonatomic, setter=_setLargestUndimmedDetentIdentifier:) NSString *_largestUndimmedDetentIdentifier; // ivar: __largestUndimmedDetentIdentifier
@property (retain, nonatomic, setter=_setLargestUndimmedDetentIdentifierWhenEdgeAttachedInCompactHeight:) NSString *_largestUndimmedDetentIdentifierWhenEdgeAttachedInCompactHeight; // ivar: __largestUndimmedDetentIdentifierWhenEdgeAttachedInCompactHeight
@property (retain, nonatomic, setter=_setLargestUndimmedDetentIdentifierWhenFloating:) NSString *_largestUndimmedDetentIdentifierWhenFloating; // ivar: __largestUndimmedDetentIdentifierWhenFloating
...
@property (readonly, nonatomic) NSMutableArray *_mutableActiveDetentValues; // ivar: __mutableActiveDetentValues
@property (readonly, nonatomic) NSMutableArray *_mutableActiveReversedDetentIndexes; // ivar: __mutableActiveReversedDetentIndexes
...
@property (retain, nonatomic, setter=_setReversedDetents:) NSArray *_reversedDetents; // ivar: __reversedDetents
@property (nonatomic, setter=_setReversedIndexOfCurrentDetent:) NSInteger _reversedIndexOfCurrentDetent;
@property (readonly, nonatomic) NSInteger _reversedIndexOfCurrentDetentForTappingGrabber; // ivar: __reversedIndexOfCurrentDetentForTappingGrabber
@property (readonly, nonatomic) NSInteger _reversedIndexOfLastUndimmedDetent; // ivar: __reversedIndexOfLastUndimmedDetent
