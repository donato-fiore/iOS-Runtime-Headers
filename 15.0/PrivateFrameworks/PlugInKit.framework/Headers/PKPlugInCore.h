...
@class NSDictionary, NSString, NSData, NSURL, NSUUID, NSDate;
...
@property (retain) NSString *localizedContainingName; // ivar: _localizedContainingName
...
@property (retain) NSString *requirement; // ivar: _requirement
...
+(id)readSDKDictionary:(id)arg0 forPlatform:(unsigned int)arg1 ;
...
-(id)initWithName:(id)arg0 extensionPointPlatform:(unsigned int)arg1 url:(id)arg2 bundleInfo:(id)arg3 uuid:(id)arg4 discoveryInstanceUUID:(id)arg5 extensionPointCache:(id)arg6 ;
