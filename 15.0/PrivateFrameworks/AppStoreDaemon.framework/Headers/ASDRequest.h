...
// -(void)_callErrorHandler:(id)arg0 withError:(unk)arg1  ;
// -(void)_callErrorHandler:(id)arg0 withError:(unk)arg1 orDefaultCode:(id)arg2  ;
-(void)_cancelWithErrorHandler:(id)arg0 ;
-(void)_notifyObserverOfCompletionWithError:(id)arg0 ;
-(void)_startWithErrorHandler:(id)arg0 ;
-(void)_submitRequestWithErrorHandler:(id)arg0 ;
