...
@class HMFUnfairLock, NSArray, NSDictionary, HMFTimer, NSOperationQueue, NSString, HMFNetMonitor, NSData, HMFBlockOperation, HMFNetAddress, NSMutableArray, NSDate;
@protocol HAPAccessoryServerMetricProtocol, HAPHTTPClientDelegate, HAPHTTPClientDebugDelegate, HMFTimerDelegate, HAPAuthSessionDelegate, HMFNetMonitorDelegate, HAPWACAccessoryClientDelegate, OS_dispatch_queue;
...
@property (retain, nonatomic) NSString *controllerUsername; // ivar: _controllerUsername
...
@property (readonly, nonatomic) NSData *ownershipToken; // ivar: _ownershipToken
...
@property (retain, nonatomic) HAPAccessoryWiFiConfiguration *wifiConfiguration; // ivar: _wifiConfiguration
...
-(void)_notifyDelegateOfDiscoveryFailureWithError:(id)arg0 ;
...
-(void)startPing;
-(void)startReprovisioningWiFiConfig:(id)arg0 ;
-(void)stopPing;
