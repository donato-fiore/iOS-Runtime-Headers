...
@class CBCentralManager, NSString, NSMapTable, NSMutableArray, NSMutableOrderedSet, HMFActivity;
...
@property (retain, nonatomic) NSMutableArray *peripheralsPendingConnection; // ivar: _peripheralsPendingConnection
@property (retain, nonatomic) NSMutableOrderedSet *peripheralsWithConnectionRequests; // ivar: _peripheralsWithConnectionRequests
...
+(id)HAPBluetoothRouteModeToString:(unsigned char)arg0 ;
+(id)logCategory;
-(BOOL)_canStartScan;
...
-(id)_getLocalCBPeripheral:(id)arg0 ;
...
-(id)serverTupleWithPairingIdentifier:(id)arg0 whbStableIdentifier:(id)arg1 ;
-(unsigned char)_getRouteMode;
-(void)_addToPendingConnections:(id)arg0 ;
-(void)_callPowerOnCompletionsWithError:(id)arg0 ;
-(void)_connectHAPPeripheralWhenAllowed:(id)arg0 routeMode:(unsigned char)arg1 ;
-(void)_connectPendingConnections:(unsigned char)arg0 ;
...
-(void)_disconectFromHAPPeripheral:(id)arg0 ;
...
-(void)_monitorDisconnectionOfPeripheral:(id)arg0 ;
...
-(void)_updatePeripheralObject:(id)arg0 whbStableIdentifier:(id)arg1 ;
-(void)_updateTargetedScanTimer;
-(void)accessoryServerBrowserBTLE:(id)arg0 didDiscoverHAPPeripheral:(id)arg1 accessoryName:(id)arg2 pairingIdentifier:(id)arg3 advertisementFormat:(NSUInteger)arg4 statusFlags:(id)arg5 stateNumber:(id)arg6 category:(id)arg7 configurationNumber:(id)arg8 setupHash:(id)arg9 encryptedPayload:(id)arg10 whbStableIdentifier:(id)arg11 ;
...
-(void)connectToBTLEAccessoryServer:(id)arg0 routeMode:(unsigned char)arg1 ;
...
-(void)retrieveCurrentStateForIdentifer:(id)arg0 onQueue:(id)arg1 withCompletion:(id)arg2 ;
