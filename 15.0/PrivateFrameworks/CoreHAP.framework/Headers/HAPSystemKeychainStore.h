...
-(BOOL)getOrCreateHK2ControllerKey:(*id)arg0 secretKey:(*id)arg1 keyPair:(*id)arg2 username:(*id)arg3 ;
...
-(BOOL)updateAccessoryPublicKey:(id)arg0 error:(*id)arg1 ;
...
-(id)_getDictionaryFromGenericData:(id)arg0 ;
...
-(id)_serializeDictionary:(id)arg0 ;
-(id)_updateAccessoryPairingGenericData:(id)arg0 updatedControllerKeyIdentifier:(id)arg1 ;
-(id)allAccessoryPairingKeysWithError:(*id)arg0 ;
...
-(int)createHK2ControllerKey:(*id)arg0 secretKey:(*id)arg1 keyPair:(*id)arg2 username:(*id)arg3 ;
