...
@class UIViewController, NSString, UIViewController<_EXHostViewControllerDelegate>;
@protocol _EXHostSessionDelegate, _EXConnectionCreating, _EXHostViewControllerDelegate;
