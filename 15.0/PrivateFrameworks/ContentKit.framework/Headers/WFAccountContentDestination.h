...
+(id)destinationWithAccountIdentifier:(id)arg0 appDescriptor:(id)arg1 alwaysRequiresApproval:(BOOL)arg2 ;
+(id)destinationWithAccountIdentifier:(id)arg0 appDescriptor:(id)arg1 managedLevel:(NSUInteger)arg2 ;
+(id)destinationWithAccountIdentifier:(id)arg0 appDescriptor:(id)arg1 managedLevel:(NSUInteger)arg2 alwaysRequiresApproval:(BOOL)arg3 ;
+(id)objectWithWFSerializedRepresentation:(id)arg0 ;
-(BOOL)isEqual:(id)arg0 ;
-(id)appContentDestination;
-(id)copyWithZone:(struct _NSZone *)arg0 ;
-(id)initWithAccountIdentifier:(id)arg0 appDescriptor:(id)arg1 managedLevel:(NSUInteger)arg2 alwaysRequiresApproval:(BOOL)arg3 ;
