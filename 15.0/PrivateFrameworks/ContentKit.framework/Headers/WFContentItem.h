...
@class NSUUID, NSExtensionItem, NSItemProvider, NSString, NSMutableDictionary;
...
@property (readonly, nonatomic) WFContentAttributionSet *attributionSet; // ivar: _attributionSet
