...
-(int)convertRGBAtoYUV420:(id)arg0 inTextureRGBA:(id)arg1 outColorY:(id)arg2 outColorUV:(id)arg3 ;
-(int)convertYUV420toRGBA:(id)arg0 inColorY:(id)arg1 inColorUV:(id)arg2 outTexture:(id)arg3 ;
