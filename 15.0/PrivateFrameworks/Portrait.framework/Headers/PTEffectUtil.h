...
-(void)enforceFixedFocusDistance:(id)arg0 inDisparity:(id)arg1 outDisparity:(id)arg2 focusDepthFixed:(float)arg3 focusDepthMax:(float)arg4 inFocusObject:(id)arg5 ;
...
-(void)updateFocusObject:(id)arg0 faceRectCount:(int)arg1 focusDepthOffset:(float)arg2 exponentialMovingAverage:(float)arg3 isFirstFrame:(BOOL)arg4 lastFocus:(id)arg5 inFocusDistanceArray:(id)arg6 outFocusObject:(id)arg7 ;
