...
-(id)_effectiveDecisionsFromBaseDecisionsRange:(struct _NSRange )arg0 userDecisionsRange:(struct _NSRange )arg1 ;
-(id)_effectiveDecisionsFromZippedDecisions:(id)arg0 ;
