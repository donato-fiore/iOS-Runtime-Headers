...
@property (nonatomic, getter=isContactsDisabled) BOOL contactsDisabled; // ivar: _contactsDisabled
...
@property (retain) NSObject<SyncManagerProtocol> *syncManager; // ivar: _syncManager
