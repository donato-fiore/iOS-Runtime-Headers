...
@class NSString, NSValue, NSNumber, NSArray, CNContact, NSDate, NSDictionary, INInteraction, NSDateInterval, NSUUID, NSSet;
...
@property (copy, nonatomic) NSValue *addressBookRecordRef; // ivar: _addressBookRecordRef
...
@property (copy, nonatomic) NSString *callerNetworkFirstName; // ivar: _callerNetworkFirstName
@property (copy, nonatomic) NSString *callerNetworkName; // ivar: _callerNetworkName
@property (copy, nonatomic) NSString *callerNetworkSecondName; // ivar: _callerNetworkSecondName
@property (copy) NSString *clientAddressBookRecordId; // ivar: _clientAddressBookRecordId
...
@property (retain, nonatomic) CHHandle *localParticipantHandle; // ivar: _localParticipantHandle
