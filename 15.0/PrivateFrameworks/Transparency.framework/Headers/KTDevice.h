...
@property (retain) NSData *deviceIDVRFOutput; // ivar: _deviceIDVRFOutput


+(BOOL)supportsSecureCoding;
-(BOOL)isEqual:(id)arg0 ;
-(BOOL)updateWithMutation:(id)arg0 error:(*id)arg1 ;
-(id)clientRecordForAppVersion:(NSUInteger)arg0 clientDataVRFOutput:(id)arg1 ;
-(id)clientRecordsForVRFOutput:(id)arg0 ;
-(id)debugDescription;
-(id)description;
