...
-(BOOL)hasTooManyVRFRequests:(id)arg0 ;
-(BOOL)ready:(*id)arg0 ;
...
-(id)initWithApplicationKeyStore:(id)arg0 dataStore:(id)arg1 logClient:(id)arg2 applicationID:(id)arg3 ;
...
-(void)processSTHsFromPeers:(id)arg0 error:(*id)arg1 ;
