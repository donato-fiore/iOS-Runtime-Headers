...
@protocol SBSHardwareButtonEventConsuming, DKCloudProvider, DKFindMyProvider, BSInvalidatable, DKNotableUserDataProvider, DKPasscodeProvider, DKWalletProvider;
...
@property (nonatomic) NSUInteger cloudUploadResult; // ivar: _cloudUploadResult
