...
@class NSMutableDictionary, CNAutocompleteStore, NSOperationQueue, NSNumber, NSMutableArray, NSString, NSArray;
...
@property (weak) NSObject<CNAutocompleteUIFetchDelegate> *fetchDelegate; // ivar: _fetchDelegate
