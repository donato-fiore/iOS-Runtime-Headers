...
-(BOOL)isCustodianRecoveryKeyEnrolled:(id)arg0 ;
...
-(id)allVouchers;
-(id)bestRecoveryKeyForStableInfo:(id)arg0 dynamicInfo:(id)arg1 ;
...
-(id)createStableInfoWithFrozenPolicyVersion:(id)arg0 flexiblePolicyVersion:(id)arg1 policySecrets:(id)arg2 syncUserControllableViews:(int)arg3 secureElementIdentity:(id)arg4 walrusSetting:(id)arg5 deviceName:(id)arg6 serialNumber:(id)arg7 osVersion:(id)arg8 signingKeyPair:(id)arg9 recoverySigningPubKey:(id)arg10 recoveryEncryptionPubKey:(id)arg11 isInheritedAccount:(BOOL)arg12 error:(*id)arg13 ;
