...
@class UIDatePicker, UIImage, UIView, NSMutableArray, NSIndexPath, UITableView, UIPopoverController, NSString, UIBarButtonItem;
@protocol UIPopoverControllerDelegate, UITableViewDataSource, UITableViewDelegate, UITextFieldDelegate, OS_dispatch_source;
...
-(void)_datePickerAction:(id)arg0 ;
...
-(void)_showDatePickerForRowAtIndexPath:(id)arg0 ;
-(void)_showDatePickerPopoverForRowAtIndexPath:(id)arg0 ;
