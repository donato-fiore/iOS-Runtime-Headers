...
@class UITableViewCell, CNContactStore, CNContactPickerViewController, UILabel, MFComposeRecipientView, UIView, NSAttributedString, NSString, NSArray;
@protocol CNContactPickerDelegate, MFComposeRecipientViewDelegate, SKUIGiftContactSearchDelegate;
