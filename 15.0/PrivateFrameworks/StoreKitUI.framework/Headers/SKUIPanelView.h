...
@protocol SKUIAnimatorDOMFeatureDelegate, SKUIViewElementView;
...
+(BOOL)_isValidTextInputViewElement:(id)arg0 ;
+(BOOL)_shouldDisplayViewElement:(id)arg0 ;
...
-(void)animatorFeature:(id)arg0 performAnimationWithName:(id)arg1 options:(id)arg2 ;
-(void)dealloc;
-(void)layoutSubviews;
