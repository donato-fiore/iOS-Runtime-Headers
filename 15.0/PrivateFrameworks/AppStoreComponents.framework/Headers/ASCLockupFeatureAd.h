...
-(id)initWithEditorsChoice:(BOOL)arg0 productRating:(float)arg1 productRatingBadge:(id)arg2 productDescription:(id)arg3 screenshots:(id)arg4 trailers:(id)arg5 ;
