...
#ifndef NFPROXYRESOLVER_H
#define NFPROXYRESOLVER_H

@class NSString;
@protocol NFResolver, NFValidationResolver, NFDefinitionContainer;
...
@property (retain, nonatomic) NFContext *context; // ivar: _context
@property (readonly, copy) NSString *debugDescription;
@property (readonly, copy) NSString *description;
@property (readonly) NSUInteger hash;
@property (retain, nonatomic) NFContainerPool *pool; // ivar: _pool
@property (retain, nonatomic) NSObject<NFDefinitionContainer> *privateContainer; // ivar: _privateContainer
@property (retain, nonatomic) NSObject<NFDefinitionContainer> *publicContainer; // ivar: _publicContainer
