...
typedef struct SignerInfo {
    int field0;
    CMSIdentifier field1;
    AlgorithmIdentifier field2;
    SignerInfo_signedAttrs field3;
    AlgorithmIdentifier field4;
    heim_base_data field5;
    SignerInfo_unsignedAttrs field6;
} SignerInfo;
