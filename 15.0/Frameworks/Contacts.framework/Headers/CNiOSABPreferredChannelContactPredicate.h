...
@property (nonatomic) BOOL limitOne; // ivar: _limitOne
@property (copy, nonatomic) NSString *preferredChannel; // ivar: _preferredChannel
...
-(id)initWithPreferredChannel:(id)arg0 limitOne:(BOOL)arg1 ;
