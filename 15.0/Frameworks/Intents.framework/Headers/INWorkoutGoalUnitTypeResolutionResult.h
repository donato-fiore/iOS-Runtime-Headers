...
#ifndef INWORKOUTGOALUNITTYPERESOLUTIONRESULT_H
#define INWORKOUTGOALUNITTYPERESOLUTIONRESULT_H
...
+(id)confirmationRequiredWithWorkoutGoalUnitTypeToConfirm:(NSInteger)arg0 ;
+(id)successWithResolvedValue:(NSInteger)arg0 ;
+(id)successWithResolvedWorkoutGoalUnitType:(NSInteger)arg0 ;
