...
#ifndef _INPBDELETEFILEPERMANENTLYINTENTRESPONSE_H
#define _INPBDELETEFILEPERMANENTLYINTENTRESPONSE_H

@class PBCodable, NSString;
@protocol _INPBDeleteFilePermanentlyIntentResponse, NSSecureCoding, NSCopying;
