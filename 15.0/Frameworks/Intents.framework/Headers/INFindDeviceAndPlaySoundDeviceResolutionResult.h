...
#ifndef INFINDDEVICEANDPLAYSOUNDDEVICERESOLUTIONRESULT_H
#define INFINDDEVICEANDPLAYSOUNDDEVICERESOLUTIONRESULT_H
...
-(id)initWithDeviceDetailResolutionResult:(id)arg0 ;
