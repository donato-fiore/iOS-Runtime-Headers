...
-(id)_initWithBookmarkData:(id)arg0 filename:(id)arg1 typeIdentifier:(id)arg2 ;
-(id)_initWithData:(id)arg0 filename:(id)arg1 fileURL:(id)arg2 typeIdentifier:(id)arg3 ;
