...
@protocol _INPBGetFileInformationIntent, NSSecureCoding, NSCopying;
...
@property (nonatomic) int propertyName; // ivar: _propertyName
...
-(id)propertyNameAsString:(int)arg0 ;
-(id)qualifierAsString:(int)arg0 ;
-(int)StringAsEntityType:(id)arg0 ;
-(int)StringAsPropertyName:(id)arg0 ;
