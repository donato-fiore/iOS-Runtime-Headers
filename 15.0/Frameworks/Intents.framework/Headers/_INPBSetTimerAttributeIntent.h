...
@protocol _INPBSetTimerAttributeIntent, NSSecureCoding, NSCopying;
...
@property (nonatomic) CGFloat toDuration; // ivar: _toDuration
@property (retain, nonatomic) _INPBDataString *toLabel; // ivar: _toLabel
