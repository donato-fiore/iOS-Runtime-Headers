...
-(id)_decodeReplyFromXPCObject:(id)arg0 forSelector:(SEL)arg1 interface:(id)arg2 ;
...
-(id)init;
-(int)__decodeXPCObject:(id)arg0 allowingSimpleMessageSend:(BOOL)arg1 outInvocation:(*id)arg2 outArguments:(*id)arg3 outArgumentsMaxCount:(NSUInteger)arg4 outMethodSignature:(*id)arg5 outSelector:(*SEL)arg6 isReply:(BOOL)arg7 replySelector:(SEL)arg8 interface:(id)arg9 ;
-(int)_decodeMessageFromXPCObject:(id)arg0 allowingSimpleMessageSend:(BOOL)arg1 outInvocation:(*id)arg2 outArguments:(*id)arg3 outArgumentsMaxCount:(NSUInteger)arg4 outMethodSignature:(*id)arg5 outSelector:(*SEL)arg6 interface:(id)arg7 ;
