...
@property int internalSessionType; // ivar: _internalSessionType
@property (copy) id *internalStartHandler; // ivar: _internalStartHandler
@property (copy) NSUUID *internalUUID; // ivar: _internalUUID
