...
@property (retain) NEIdentityKeychainItem *identity; // ivar: _identity
...
@property (retain) NSString *keychainAccessGroup; // ivar: _keychainAccessGroup
@property NSInteger keychainDomain; // ivar: _keychainDomain
