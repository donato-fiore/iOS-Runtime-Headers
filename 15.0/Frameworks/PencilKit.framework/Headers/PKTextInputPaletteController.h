...
@protocol PKTextInputWindowFirstResponderControllerDelegate, PKPaletteControllerDelegate, PKPaletteTapToRadarCommandDelegate, UIEditingOverlayInteractionWithView, PKTextInputPaletteControllerDelegate;
