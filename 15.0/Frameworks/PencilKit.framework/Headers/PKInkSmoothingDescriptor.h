...
+(id)smoothingDescriptorWithStylus:(CGFloat)arg0 touch:(CGFloat)arg1 velocity:(CGFloat)arg2 ;
-(id)initWithStylusSmoothing:(CGFloat)arg0 touchSmoothing:(CGFloat)arg1 velocitySmoothing:(CGFloat)arg2 ;
