...
@protocol UIPopoverPresentationControllerDelegate, PKPalettePopoverDismissing, PKPaletteAdditionalOptionsViewDelegate, PKPaletteColorPickerContainerViewDelegate, PKPalettePopoverPresenting, PKDrawingPaletteViewStateSubject;
...
@property (retain, nonatomic) PKPaletteAdditionalOptionsView *additionalOptionsView; // ivar: _additionalOptionsView
@property (weak, nonatomic) NSObject<PKPaletteAdditionalOptionsViewDelegate> *additionalOptionsViewDelegate; // ivar: _additionalOptionsViewDelegate
...
@property (nonatomic) BOOL shouldHideColorPicker; // ivar: _shouldHideColorPicker
@property (nonatomic) BOOL shouldShowAdditionalOptionsView; // ivar: _shouldShowAdditionalOptionsView
