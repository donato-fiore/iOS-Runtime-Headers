...
#ifndef MLCINSTANCENORMALIZATIONLAYER_H
#define MLCINSTANCENORMALIZATIONLAYER_H
...
+(id)layerWithFeatureChannelCount:(NSUInteger)arg0 beta:(id)arg1 gamma:(id)arg2 varianceEpsilon:(float)arg3 ;
+(id)layerWithFeatureChannelCount:(NSUInteger)arg0 beta:(id)arg1 gamma:(id)arg2 varianceEpsilon:(float)arg3 momentum:(float)arg4 ;
