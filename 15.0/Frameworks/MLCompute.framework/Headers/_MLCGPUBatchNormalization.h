...
@interface _MLCGPUBatchNormalization : MLCGPULayer



+(BOOL)setOptimizerDataForDevice:(id)arg0 deviceOps:(id)arg1 beta:(id)arg2 gamma:(id)arg3 ;
...
-(id)initWithDevice:(id)arg0 numOfFeatureChannels:(NSUInteger)arg1 mean:(id)arg2 variance:(id)arg3 beta:(id)arg4 gamma:(id)arg5 varianceEpsilon:(float)arg6 momentum:(float)arg7 ;
