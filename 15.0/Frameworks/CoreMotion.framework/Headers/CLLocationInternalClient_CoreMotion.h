...
-(unsigned char)setAuthorizationStatusByType:(int)arg0 withCorrectiveCompensation:(int)arg1 andZoneIdentifier:(struct __CFString *)arg2 forBundleID:(struct __CFString *)arg3 orBundlePath:(struct __CFString *)arg4 ;
