...
@class PLImportFileManager, NSMutableDictionary, NSMutableArray, NSString, NSMutableSet, NSProgress;
...
-(void)_importRecord:(id)arg0 createdAlbumIdentifiers:(id)arg1 createdFolderIdentifiers:(id)arg2 ;
