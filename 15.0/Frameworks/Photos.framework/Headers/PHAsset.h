...
@class CLLocation, NSString, NSSet, NSURL, NSDate, NSData, NSArray, NSNumber, NSManagedObjectContext, NSManagedObjectID;
...
+(id)fetchKeyAssetForSceneIdentifier:(unsigned int)arg0 withConfidenceThreshold:(CGFloat)arg1 options:(id)arg2 ;
