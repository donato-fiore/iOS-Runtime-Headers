...
@property (retain, nonatomic) NSURL *accessedUrlForDocumentInteractionController; // ivar: _accessedUrlForDocumentInteractionController
...
-(id)_listButton;
-(id)_listDescriptionStringWithTitle:(id)arg0 ;
...
-(id)fixedPreviewItemAtIndex:(NSInteger)arg0 ;
-(id)flexibleSpace;
...
-(void)requestLockingForActivity:(id)arg0 ;
