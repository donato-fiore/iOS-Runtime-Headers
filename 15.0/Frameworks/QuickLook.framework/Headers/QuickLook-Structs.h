...
typedef struct QLPHDisplayVelocity {
    CGFloat field0;
    CGFloat field1;
    CGFloat field2;
    CGFloat field3;
...
typedef struct QLPUDisplayVelocity {
    CGFloat field0;
    CGFloat field1;
    CGFloat field2;
    CGFloat field3;
...
typedef struct _QLDismissGestureTrackingVelocity {
    CGFloat field0;
    CGFloat field1;
    CGFloat field2;
    CGFloat field3;
} _QLDismissGestureTrackingVelocity;
...
typedef struct QLFrameDurationInformation {
    CGFloat field0;
    CGFloat field1;
} QLFrameDurationInformation;
