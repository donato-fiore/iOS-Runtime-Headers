...
#ifndef VNGENERATEOBJECTNESSBASEDSALIENCYIMAGEREQUEST_H
#define VNGENERATEOBJECTNESSBASEDSALIENCYIMAGEREQUEST_H
...
-(id)_objectnessObservationsForRevision:(NSUInteger)arg0 performedInContext:(id)arg1 error:(*id)arg2 ;
