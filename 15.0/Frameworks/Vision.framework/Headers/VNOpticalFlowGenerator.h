...
-(?)_calculateLKTVectorResult:(?)arg0 fromPixelBuffer:(?)arg1 toPixelBuffer:(?)arg2 opticalFlowOptionserror;
-(?)_createOpticalFlowForPixelBuffer:(?)arg0 opticalFlowOptionserror;
