...
#ifndef VNCLASSIFYIMAGEAESTHETICSREQUEST_H
#define VNCLASSIFYIMAGEAESTHETICSREQUEST_H
...
-(id)_smartCamCombinedModelImageAestheticsClassificationsForRevision:(NSUInteger)arg0 performedInContext:(id)arg1 error:(*id)arg2 ;
