...
@protocol HMFLogging, HMFMessageReceiver, HMControllable, HMMediaDestinationInternal, HMObjectMerge, NSSecureCoding, HMAccessorySettingsContainer, HMApplicationData, HMMediaDestination, HMMediaObject, HMMediaSystemDelegate, OS_dispatch_queue;
...
-(BOOL)_mergeWithNewObject:(id)arg0 operations:(id)arg1 includeSettingsAndAppData:(BOOL)arg2 ;
