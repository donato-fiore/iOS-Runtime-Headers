...
#import "HMCHIPServiceTopology.h"
...
@property (nonatomic) BOOL legacyAPI; // ivar: _legacyAPI
...
@property (readonly, nonatomic) HMCHIPServiceTopology *topology; // ivar: _topology
...
-(id)initToSetupAccessoriesWithSetupAccessoryPayload:(id)arg0 appID:(id)arg1 homeName:(id)arg2 homeUUID:(id)arg3 trustedOrigin:(BOOL)arg4 ownershipToken:(id)arg5 marketingName:(id)arg6 installationGuideURL:(id)arg7 ;
...
-(id)initWithAppID:(id)arg0 legacyAPI:(BOOL)arg1 homeName:(id)arg2 homeUUID:(id)arg3 trustedOrigin:(BOOL)arg4 ;
-(id)initWithCoder:(id)arg0 ;
-(id)initWithStagedCHIPAccessoryPairingIdentifier:(id)arg0 ;
-(id)initWithTopology:(id)arg0 ;
...
-(void)updateWithMarketingName:(id)arg0 installationGuideURL:(id)arg1 ;
