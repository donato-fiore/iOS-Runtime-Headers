...
@class HMFUnfairLock, NSMutableSet, NSString, NSArray;
...
-(void)addGroup:(id)arg0 completionHandler:(id)arg1 ;
-(void)addSetting:(id)arg0 ;
-(void)addSetting:(id)arg0 completionHandler:(id)arg1 ;
-(void)mergeReflected:(id)arg0 ;
-(void)removeGroup:(id)arg0 ;
-(void)removeGroup:(id)arg0 completionHandler:(id)arg1 ;
-(void)removeSetting:(id)arg0 ;
-(void)removeSetting:(id)arg0 completionHandler:(id)arg1 ;
