...
@class NSDate, NSString, NSData, NSArray, NSSet, NSUUID, NSDictionary;
@protocol NSCopying, NSSecureCoding, HMCameraRecordingEvent;
...
@property (readonly, copy) NSArray *posterFrames; // ivar: _posterFrames
...
-(id)initWithUniqueIdentifier:(id)arg0 startDate:(id)arg1 duration:(CGFloat)arg2 targetFragmentDuration:(CGFloat)arg3 isComplete:(BOOL)arg4 isDonated:(BOOL)arg5 quality:(NSInteger)arg6 streamingAssetVersion:(id)arg7 encryptionContext:(id)arg8 posterFrames:(id)arg9 videoSegments:(id)arg10 significantEvents:(id)arg11 ;
