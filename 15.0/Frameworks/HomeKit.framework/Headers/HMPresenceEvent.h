...
-(void)_update:(id)arg0 completionHandler:(id)arg1 ;
-(void)_updatePresenceType:(id)arg0 completionHandler:(id)arg1 ;
-(void)_updateUsers:(id)arg0 completionHandler:(id)arg1 ;
