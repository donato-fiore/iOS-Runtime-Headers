...
#ifndef SFPASSWORDDETAILVIEWCONTROLLER_H
#define SFPASSWORDDETAILVIEWCONTROLLER_H

@class UITableViewController, WBSSavedPassword, UIBarButtonItem, NSString, UITableViewCell, UITableViewHeaderFooterView, WBSPasswordWarning, NSTimer, UIAlertController, NSArray, NSExtension, ASAccountAuthenticationModificationController;
@protocol _ASAccountAuthenticationModificationExtensionManagerObserver, ASAccountAuthenticationModificationControllerDelegate, ASAccountAuthenticationModificationControllerPresentationContextProviding, UITextFieldDelegate, _SFTableViewDiffableDataSourceDelegate, SFPasswordOtpauthQRCodeScannerViewControllerDelegate, PSStateRestoration, OS_dispatch_queue, SFPasswordDetailViewControllerDelegate;
...
@property (weak, nonatomic) NSObject<SFPasswordDetailViewControllerDelegate> *delegate; // ivar: _delegate
...
-(id)_deletePasswordCellForTableView:(id)arg0 ;
...
-(id)_savedPasswordWebsiteCellForTableView:(id)arg0 atIndexPath:(id)arg1 ;
...
-(id)initWithSavedPassword:(id)arg0 options:(NSUInteger)arg1 ;
...
-(void)_addTOTPButtonToAccountOptionsSectionInSnapshot:(id)arg0 ;
...
-(void)_openURLInSafariViewController:(id)arg0 ;
