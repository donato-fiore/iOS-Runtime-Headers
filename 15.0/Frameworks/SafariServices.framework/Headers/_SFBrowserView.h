...
@property (retain, nonatomic) _SFPinnableBanner *appBannerPendingFirstPaint; // ivar: _appBannerPendingFirstPaint
...
@property (retain, nonatomic) _SFPinnableBanner *pinnableBanner; // ivar: _pinnableBanner
