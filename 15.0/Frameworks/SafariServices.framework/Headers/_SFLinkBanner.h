...
#ifndef _SFLINKBANNER_H
#define _SFLINKBANNER_H

@class SFPinnableBanner, SFThemeColorEffectView, UIView, NSLayoutConstraint, UIButton, UIImageView, UILabel, NSString, _SFDimmingButton, UIColor;



@interface _SFLinkBanner : SFPinnableBanner {
