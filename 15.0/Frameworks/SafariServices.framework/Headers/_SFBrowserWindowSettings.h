...
-(id)blankSnapshotGroupIdentifierForPrivateBrowsing:(BOOL)arg0 forWindowWithUUID:(id)arg1 ;
-(id)init;
...
-(void)setBlankSnapshotGroupIdentifier:(id)arg0 forPrivateBrowsing:(BOOL)arg1 forWindowWithUUID:(id)arg2 ;
