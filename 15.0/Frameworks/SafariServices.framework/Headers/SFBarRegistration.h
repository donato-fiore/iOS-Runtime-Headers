...
@class UIResponder, NSOrderedSet, UIToolbar, NSMutableSet, UIBarButtonItem, NSString;
...
-(id)initWithBar:(id)arg0 barManager:(id)arg1 layout:(NSInteger)arg2 persona:(NSUInteger)arg3 ;
