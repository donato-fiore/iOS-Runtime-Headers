...
@property (weak, nonatomic) _SFDialogController *dialogController; // ivar: _dialogController
...
+(id)allowDownloadDialogWithDownload:(id)arg0 initiatingURL:(id)arg1 allowViewAction:(BOOL)arg2 completionHandler:(id)arg3 ;
...
+(id)downloadBlockedDialogWithFileType:(NSInteger)arg0 initiatingURL:(id)arg1 completionHandler:(id)arg2 ;
...
+(id)redirectDialogWithNavigationResult:(id)arg0 promptPolicy:(NSInteger)arg1 completionHandler:(id)arg2 ;
...
+(id)webExtensionAlwaysAllowDialogWithExtensionName:(id)arg0 domains:(id)arg1 includeDenyButton:(BOOL)arg2 completionHandler:(id)arg3 ;
+(id)webExtensionPermissionDialogWithExtensionName:(id)arg0 domains:(id)arg1 callingAPIName:(id)arg2 showMoreOptionsForAlwaysAllow:(BOOL)arg3 includeDenyButton:(BOOL)arg4 completionHandler:(id)arg5 ;
