...
-(void)registerToolbar:(id)arg0 withLayout:(NSInteger)arg1 persona:(NSUInteger)arg2 ;
-(void)registerUnifiedBar:(id)arg0 withPersona:(NSUInteger)arg1 ;
...
-(void)setBarItem:(NSInteger)arg0 menuProvider:(id)arg1 ;
