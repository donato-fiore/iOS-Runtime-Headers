...
@class UIWebClip, UIView, WKProcessPool, WKWebsiteDataStore, NSMutableArray, BKSApplicationStateMonitor, UIColor, NSString;
@protocol SFWebAppServiceViewControllerProtocol, _SFMediaRecordingDocument;


#import "SFBrowserServiceViewController.h"
#import "_SFApplicationManifestFetcher.h"
