...
@class UIView, UIButton, SFURLLabel, UILabel, UIVisualEffectView, UIImageView, NSArray, _SFFluidProgressView, NSAttributedString, SFNavigationBarToggleButton, _SFDimmingButton, _UIClickInteraction, NSTimer, UIBlurEffect, NSString, SFNavigationBarItem, UITextField, _SFBarTheme;
