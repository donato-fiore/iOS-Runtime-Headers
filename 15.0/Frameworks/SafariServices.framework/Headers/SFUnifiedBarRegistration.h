...
@class SFUnifiedBar, NSMutableSet, NSArray, NSSet, SFUnifiedBarButton, SFUnifiedBarItem, NSString;
...
-(id)initWithBar:(id)arg0 barManager:(id)arg1 persona:(NSUInteger)arg2 ;
