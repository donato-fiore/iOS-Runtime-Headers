...
-(*void)computeFunctionKeyWithComputePipelineDescriptor:(id)arg0 keySize:(*NSUInteger)arg1 ;
-(*void)computeFunctionKeyWithComputePipelineDescriptor:(id)arg0 options:(NSUInteger)arg1 keySize:(*NSUInteger)arg2 ;
-(*void)fragmentFunctionKeyWithRenderPipelineDescriptor:(id)arg0 fragmentKeySize:(*NSUInteger)arg1 previousStateVariant:(id)arg2 ;
...
-(*void)vertexFunctionKeyWithRenderPipelineDescriptor:(id)arg0 vertexKeySize:(*NSUInteger)arg1 nextStageVariant:(id)arg2 ;
...
-(id)_deviceWrapper;
-(id)_newDynamicLibrary:(id)arg0 computeDescriptor:(id)arg1 error:(*id)arg2 ;
