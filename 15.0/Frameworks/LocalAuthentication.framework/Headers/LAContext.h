...
-(id)uuid;
-(void)_evaluateAccessControl:(struct __SecAccessControl *)arg0 operation:(id)arg1 options:(id)arg2 log:(NSInteger)arg3 cid:(unsigned int)arg4 reply:(id)arg5 ;
-(void)_evaluatePolicy:(NSInteger)arg0 options:(id)arg1 log:(NSInteger)arg2 cid:(unsigned int)arg3 reply:(id)arg4 ;
