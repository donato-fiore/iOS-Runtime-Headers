...
-(BOOL)_verifyRequirement:(struct __ACMRequirement *)arg0 satisfiedForType:(unsigned int)arg1 flags:(*unsigned int)arg2 ;
...
-(BOOL)verifyRequirementOfType:(unsigned int)arg0 policy:(char *)arg1 parameter:(id)arg2 flags:(*unsigned int)arg3 error:(*id)arg4 ;
