...
#ifndef FPARCHIVESERVICE_H
#define FPARCHIVESERVICE_H

@protocol FPArchiveServiceStreamingInternal, FPArchiveServiceProtocol, FPArchiveServiceUnarchivingDelegate;
...
@property (weak, nonatomic) NSObject<FPArchiveServiceUnarchivingDelegate> *unarchivingDelegate; // ivar: _unarchivingDelegate


-(id)archiveItemsWithURLs:(id)arg0 compressionFormat:(NSUInteger)arg1 completionHandler:(id)arg2 ;
...
-(id)unarchiveItemAtURL:(id)arg0 passphrase:(id)arg1 completionHandler:(id)arg2 ;
