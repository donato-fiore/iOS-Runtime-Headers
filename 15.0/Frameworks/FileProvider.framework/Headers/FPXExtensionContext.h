...
@protocol FPXVendor, OS_dispatch_queue, FPDDomainServicing><FPXPCAutomaticErrorProxy, OS_os_log;
...
-(id)fetchContentsForItemWithID:(id)arg0 version:(id)arg1 request:(id)arg2 completionHandler:(id)arg3 ;
...
-(void)acknowledgeUserVisibleRootDidChangeForDomain:(id)arg0 urlWrapper:(id)arg1 completionHandler:(id)arg2 ;
...
-(void)beginRequestWithDomain:(id)arg0 alternateContentsDictionary:(id)arg1 domainServicer:(id)arg2 providerDomain:(id)arg3 domainVersion:(id)arg4 ;
...
-(void)fetchServicesForItemID:(id)arg0 completionHandler:(id)arg1 ;
...
-(void)userInteractionErrorsForPerformingAction:(id)arg0 sourceItems:(id)arg1 destinationItem:(id)arg2 fpProviderDomainId:(id)arg3 sourceItemKeysAllowList:(id)arg4 completionHandler:(id)arg5 ;
