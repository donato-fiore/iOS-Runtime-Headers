...
-(id)init;
-(id)initWithEngine:(id)arg0 groupUUID:(id)arg1 gainMetaParameterDefinition:(id)arg2 mixerDefinition:(id)arg3 source:(id)arg4 listener:(id)arg5 normalize:(BOOL)arg6 calibrationMode:(NSInteger)arg7 level:(CGFloat)arg8 outError:(*id)arg9 ;
...
-(void)updateGroupUUID:(id)arg0 streamUUID:(id)arg1 state:(NSInteger)arg2 ;
