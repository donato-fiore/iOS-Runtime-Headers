...
@property (retain, nonatomic) NSSet *directBindingSupportedBlobs; // ivar: _directBindingSupportedBlobs
...
@property (readonly, retain, nonatomic) NSArray *inputLayerNames; // ivar: _inputLayerNames
