...
#ifndef MLBATCHEDMATMULBRICK_H
#define MLBATCHEDMATMULBRICK_H
...
@property (readonly, nonatomic) NSNumber *transposeA; // ivar: _transposeA
@property (readonly, nonatomic) NSNumber *transposeB; // ivar: _transposeB
