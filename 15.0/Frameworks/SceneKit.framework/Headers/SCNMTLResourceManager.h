...
-(id)renderResourceForImage:(struct __C3DImage *)arg0 sampler:(struct __C3DTextureSampler *)arg1 options:(int)arg2 engineContext:(struct __C3DEngineContext *)arg3 ;
-(id)renderResourceForImageProxy:(struct __C3DImageProxy *)arg0 sampler:(struct __C3DTextureSampler *)arg1 engineContext:(struct __C3DEngineContext *)arg2 ;
...
-(id)renderResourcesForEffectSlot:(struct __C3DEffectSlot *)arg0 withEngineContext:(struct __C3DEngineContext *)arg1 ;
