...
-(BOOL)isExecutableForFeeds:(id)arg0 targetTensors:(id)arg1 targetOperations:(id)arg2 ;
...
-(struct ModuleOp )cloneForFeeds:(id)arg0 targetTensors:(id)arg1 targetOperations:(id)arg2 ;
...
-(void)commonPostInit:(struct ModuleOp )arg0 ;
-(void)commonPreInit;
-(void)dealloc;
-(void)dump;
