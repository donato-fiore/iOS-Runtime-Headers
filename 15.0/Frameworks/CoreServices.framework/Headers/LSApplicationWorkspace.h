...
-(BOOL)updateRecordForApp:(id)arg0 withSINF:(id)arg1 iTunesMetadata:(id)arg2 placeholderMetadata:(id)arg3 sendNotification:(int)arg4 error:(*id)arg5 ;
...
-(id)scanForApplicationStateChangesWithWhitelist:(id)arg0 ;
...
-(void)sendApplicationStateChangedNotificationsFor:(id)arg0 ;
