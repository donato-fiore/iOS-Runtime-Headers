...
#ifndef _HKUSERDOMAINCONCEPTCOMPARISONFILTER_H
#define _HKUSERDOMAINCONCEPTCOMPARISONFILTER_H

@class HKComparisonFilter;



@interface _HKUserDomainConceptComparisonFilter : HKComparisonFilter
