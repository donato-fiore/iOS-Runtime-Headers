...
+(id)itemWithPrimaryConceptCodingCollection:(id)arg0 medicalRecordSampleID:(id)arg1 ;
-(BOOL)applyConcepts:(id)arg0 forKeyPath:(id)arg1 error:(*id)arg2 ;
-(BOOL)isEqual:(id)arg0 ;
-(id)codingsForKeyPath:(id)arg0 error:(*id)arg1 ;
-(id)copyWithZone:(struct _NSZone *)arg0 ;
-(id)initWithCoder:(id)arg0 ;
-(id)initWithPrimaryConceptCodingCollection:(id)arg0 medicalRecordSampleID:(id)arg1 ;
