...
@protocol HKFeatureAvailabilityHealthDataSource, HKHealthStoreClientInterface, _HKXPCExportable, HKQueryDelegate, HKProxyProviderSource, OS_dispatch_queue, HDHealthStoreServerInterface, _HKAuthorizationPresentationController, _HKObjectPickerPresentationController, _HKRecalibrateEstimatesPresentationController;
...
-(void)_saveObjects:(id)arg0 atomically:(BOOL)arg1 completion:(id)arg2 ;
-(void)_sendNextObjectBatch:(id)arg0 lastRange:(struct _NSRange )arg1 server:(id)arg2 transaction:(id)arg3 completion:(id)arg4 ;
...
// -(void)fetchTaskServerEndpointForIdentifier:(id)arg0 pluginURL:(id)arg1 taskUUID:(id)arg2 configuration:(id)arg3 endpointHandler:(id)arg4 errorHandler:(unk)arg5  ;
