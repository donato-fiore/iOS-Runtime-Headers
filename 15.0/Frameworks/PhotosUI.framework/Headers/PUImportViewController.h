...
#import "PUImportAddToAlbumsPickerViewController.h"
...
@property (retain, nonatomic) PUImportAddToAlbumsPickerViewController *albumsPickerViewController; // ivar: _albumsPickerViewController
...
-(id)titleForDestinationCollection:(id)arg0 ;
