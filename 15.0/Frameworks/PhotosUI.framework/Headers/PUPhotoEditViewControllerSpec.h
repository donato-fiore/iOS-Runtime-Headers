...
@property (readonly, nonatomic) UIEdgeInsets previewViewInsetsLandscape;
@property (readonly, nonatomic) UIEdgeInsets previewViewInsetsPortrait;
...
@property (readonly, nonatomic) CGFloat toolbarLongSideMargin;
@property (readonly, nonatomic) CGFloat toolbarLongSideWideMargin;
