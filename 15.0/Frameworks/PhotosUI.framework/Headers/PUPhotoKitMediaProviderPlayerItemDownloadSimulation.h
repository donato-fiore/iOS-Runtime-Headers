...
@property (retain, nonatomic, setter=_setResultPlayerItem:) AVPlayerItem *_resultPlayerItem; // ivar: __resultPlayerItem
...
-(id)init;
-(void)_handleResultPlayerItem:(id)arg0 info:(id)arg1 ;
