...
@class UIVisualEffectView, _UIContentUnavailableView, UIColor, NSString;
...
@property (nonatomic) BOOL shouldDisplayBackgroundBlur; // ivar: _shouldDisplayBackgroundBlur
