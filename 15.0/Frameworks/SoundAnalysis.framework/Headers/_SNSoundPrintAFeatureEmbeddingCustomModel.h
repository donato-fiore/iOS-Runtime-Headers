...
@class SNSoundPrintFeatureEmbeddingCustomModel, MLModelDescription, NSString, NSArray;
...
+(BOOL)validateModelDescription:(id)arg0 underlyingModelDescription:(id)arg1 error:(*id)arg2 ;
