...
@property (readonly) RelativeHumidityMeasurementCluster cppCluster; // ivar: _cppCluster


-(struct ClusterBase *)getCluster;
-(void)configureAttributeMeasuredValueWithMinInterval:(unsigned short)arg0 maxInterval:(unsigned short)arg1 change:(unsigned short)arg2 responseHandler:(id)arg3 ;
