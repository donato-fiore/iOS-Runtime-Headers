...
@protocol RPPreviewViewControllerDelegate, UINavigationControllerDelegate, UIPopoverPresentationControllerDelegate, RPScreenRecorderDelegate, RPScreenRecorderPrivateDelegate;
