...
@class AVHapticPlayer, NSString, AVAudioSession, NSArray;
...
@property (readonly) BOOL sessionIsConstantVolume; // ivar: _sessionIsConstantVolume
...
-(BOOL)doPlayPatternFromDictionary:(id)arg0 error:(*id)arg1 ;
...
-(BOOL)resourceIsRegistered:(NSUInteger)arg0 ;
-(BOOL)setupUnsharedAudioSessionAndReturnError:(*id)arg0 ;
