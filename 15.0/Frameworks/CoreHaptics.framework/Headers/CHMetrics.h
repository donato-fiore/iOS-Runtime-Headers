...
@class CAReporter, NSString, NSMutableDictionary;
...
-(id)copyDataForDictionary:(id)arg0 ;
...
-(void)addToTestDataForPlayer:(id)arg0 transientData:(id)arg1 continuousData:(id)arg2 ;
-(void)dealloc;
...
-(void)handleInitForPlayer:(id)arg0 events:(id)arg1 isAdvanced:(BOOL)arg2 ;
...
-(void)logPlaybackMetricForPlayerID:(id)arg0 endTime:(float)arg1 ;
...
-(void)multiplyAdvancedPlaybackMetricsDictionary:(id)arg0 transientData:(id)arg1 continuousData:(id)arg2 endTime:(CGFloat)arg3 ;
-(void)multiplyContinuousData:(id)arg0 by:(float)arg1 ;
-(void)multiplyPlaybackMetricsDictionary:(id)arg0 transientData:(id)arg1 continuousData:(id)arg2 endTime:(CGFloat)arg3 ;
-(void)multiplyTransientData:(id)arg0 by:(float)arg1 ;
