...
@class UIView, UITextRange, UITextInteraction, UITextPosition, NSString, NSDictionary, UITextInputPasswordRules;
@protocol UITextInput, UIKeyInput, UITextInteractionDelegate, PDFTextInputDelegate, UITextInputDelegate, UITextInputTokenizer;
