...
@protocol AVTransportControlsViewDelegate, AVRoutePickerViewInternalDelegate, AVVolumeControlsControllerDelegate, AVMediaSelectionMenuDelegate, AVControlOverflowButtonDelegate, AVPlayerViewControllerContentViewDelegate, AVScrubbing, AVVolumeController;
...
@property (retain, nonatomic) AVNowPlayingInfoController *nowPlayingInfoControllerIfLoaded; // ivar: _nowPlayingInfoControllerIfLoaded
...
@property (nonatomic) BOOL playbackControlsShouldControlSystemVolume; // ivar: _playbackControlsShouldControlSystemVolume
...
@property (retain, nonatomic) AVSecondScreenContentViewConnection *secondScreenConnection; // ivar: _secondScreenConnection
...
-(NSUInteger)overrideRouteSharingPolicyForRoutePickerView:(id)arg0 ;
...
-(id)overrideRoutingContextUIDForRoutePickerView:(id)arg0 ;
...
-(void)_updateEdgeInsetsForLetterboxedContentInContentView:(id)arg0 ;
...
-(void)playerViewControllerContentView:(id)arg0 willLoadPlaybackControlsView:(id)arg1 ;
-(void)playerViewControllerContentView:(id)arg0 willLoadTurboModePlaceholderView:(id)arg1 ;
...
-(void)secondScreenConnectionDidBecomeActive:(id)arg0 ;
-(void)secondScreenConnectionDidResignActive:(id)arg0 ;
