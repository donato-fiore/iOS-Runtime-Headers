...
#ifndef SHLIBRARYCHANGE_H
#define SHLIBRARYCHANGE_H

@class NSIndexPath;
@protocol NSSecureCoding, NSCopying, SHLibraryItem;
...
@property (readonly, nonatomic) NSObject<SHLibraryItem> *libraryItem; // ivar: _libraryItem
