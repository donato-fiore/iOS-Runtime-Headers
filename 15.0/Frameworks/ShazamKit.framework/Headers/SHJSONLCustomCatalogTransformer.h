...
@protocol SHJSONLFileReaderDelegate, SHJSONLCustomCatalogTransformerDelegate;
...
+(id)catalogFileRepresentationOfMediaItems:(id)arg0 withID:(id)arg1 ;
+(id)catalogFileRepresentationOfSignature:(id)arg0 withID:(id)arg1 ;
+(id)headerFromFileRow:(id)arg0 ;
+(id)mediaItemFromFileRow:(id)arg0 ;
+(id)outputFileHeader;
