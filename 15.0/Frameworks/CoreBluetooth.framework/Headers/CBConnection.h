...
@protocol CBCentralManagerDelegate, CBPeripheralDelegate, CUReadWriteRequestable, CUXPCCodable, CBActivatable, CBErrorReporting, CBInterruptable, CBLabelable, CBReadWriteRequestable, CBStateReporting, CBRemotable, OS_dispatch_source, OS_xpc_object, OS_dispatch_queue;
