...
@property (nonatomic) unsigned char proximityServiceMeasuredPower; // ivar: _proximityServiceMeasuredPower
...
-(void)_parseLGManufacturerPtr:(char *)arg0 end:(char *)arg1 ;
