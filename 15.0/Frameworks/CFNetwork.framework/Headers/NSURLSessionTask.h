...
@protocol NSCopying, NSProgressReporting, NSURLSessionAppleIDContext, SZExtractor, OS_nw_endpoint, NSURLSessionTaskDelegate, OS_nw_activity, __NSURLSessionTaskGroupForConfiguration, OS_voucher, OS_dispatch_queue;
...
@property (copy) NSArray *_contentDispositionFallbackArray; // ivar: _contentDispositionFallbackArray
...
@property NSInteger _expectedWorkload; // ivar: _expectedWorkload
@property (retain, nonatomic, setter=set_extractor:) NSObject<SZExtractor> *_extractor; // ivar: _extractor
