...
@class NSDictionary, NSString, NSData, NSSet, NSArray, NSURL, NSNumber;
...
@property BOOL _allowsConstrainedNetworkAccess; // ivar: _allowsConstrainedNetworkAccessSPI
@property BOOL _allowsExpensiveAccess; // ivar: _allowsExpensiveAccess
@property BOOL _allowsHSTSWithUntrustedRootCertificate; // ivar: _allowsHSTSWithUntrustedRootCertificate
@property BOOL _allowsHTTP3; // ivar: _allowsHTTP3
...
@property (copy) NSArray *_contentDispHeadEncFallback; // ivar: _contentDispHeadEncFallback
...
@property BOOL allowsConstrainedNetworkAccess; // ivar: _allowsConstrainedNetworkAccessAPI
