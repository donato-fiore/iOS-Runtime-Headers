...
@property (retain, nonatomic) NSString *cachedSendInviteCellReuseIdentifier; // ivar: _cachedSendInviteCellReuseIdentifier
...
@property (copy, nonatomic) id *sendInvitesTapped; // ivar: _sendInvitesTapped
