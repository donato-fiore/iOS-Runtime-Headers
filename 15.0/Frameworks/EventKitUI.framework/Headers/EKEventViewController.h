...
@protocol EKEventTitleDetailItemDelegate, EKUIEventStatusButtonsViewDelegate, EKEventDetailTextCellDelegate, UIAlertViewDelegate, UITableViewDelegate, UITableViewDataSource, UIScrollViewDelegate, EKUIManagedViewController, EKEventViewDelegate;
...
-(CGFloat)topInset;
-(NSInteger)_actionsMaskForOrb:(BOOL)arg0 ;
...
-(id)_statusButtonsForOrb:(BOOL)arg0 ;
...
-(id)items;
-(id)previewActionsWithPresentationController:(id)arg0 actionBlock:(id)arg1 ;
-(id)tableView;
