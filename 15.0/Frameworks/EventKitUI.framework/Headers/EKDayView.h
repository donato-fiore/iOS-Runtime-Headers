...
@class UIView, UIImageView, NSArray, NSDate, UIScrollView, NSTimer, UIPinchGestureRecognizer, UITapGestureRecognizer, NSCalendar, NSString, EKEvent, NSDateComponents, UIColor, UIVisualEffect;
...
-(id)initWithFrame:(struct CGRect )arg0 sizeClass:(NSInteger)arg1 orientation:(NSInteger)arg2 displayDate:(id)arg3 backgroundColor:(id)arg4 opaque:(BOOL)arg5 scrollbarShowsInside:(BOOL)arg6 ;
...
-(void)_createAllDayViewWithSizeClass:(NSInteger)arg0 ;
...
-(void)allDayView:(id)arg0 didSelectEvent:(id)arg1 ;
...
-(void)occurrencePressed:(id)arg0 onDay:(CGFloat)arg1 ;
