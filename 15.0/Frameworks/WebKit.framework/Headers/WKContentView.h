...
@interface WKContentView : WKApplicationStateTrackingView <_WKWebViewPrintProvider, UIGestureRecognizerDelegate, UITextAutoscrolling, UITextInputMultiDocument, UITextInputPrivate, UIWebFormAccessoryDelegate, UIWebTouchEventsGestureRecognizerDelegate, UIWKInteractionViewProtocol, WKActionSheetAssistantDelegate, WKFileUploadPanelDelegate, WKKeyboardScrollViewAnimatorDelegate, WKDeferringGestureRecognizerDelegate, WKContactPickerDelegate, WKShareSheetDelegate, UIDragInteractionDelegate, UIDropInteractionDelegate, WKTouchActionGestureRecognizerDelegate, WKHoverPlatterDelegate, UIContextMenuInteractionDelegate, UIPreviewItemDelegate>

 {
    ...
    Vector<std::optional<std::pair<WebKit::InteractionInformationRequest, WTF::BlockPtr<void (WebKit::InteractionInformationAtPosition)>>>, 0, WTF::CrashOnOverflow, 16, WTF::FastMalloc> _pendingPositionInformationHandlers;
    ...
    Vector<WTF::BlockPtr<void ()>, 0, WTF::CrashOnOverflow, 16, WTF::FastMalloc> _actionsToPerformAfterEditorStateUpdate;
    ...
    Vector<WTF::BlockPtr<void (WebKit::ProceedWithTextSelectionInImage)>, 0, WTF::CrashOnOverflow, 16, WTF::FastMalloc> _actionsToPerformAfterPendingImageAnalysis;
...
-(struct RetainPtr<UIView> )_createPreviewContainerWithLayerName:(id)arg0 ;
-(struct RetainPtr<VKImageAnalyzerRequest> )createImageAnalysisRequest:(NSUInteger)arg0 image:(id)arg1 ;
-(struct RetainPtr<VKImageAnalyzerRequest> )createImageAnalysisRequest:(NSUInteger)arg0 image:(id)arg1 imageURL:(id)arg2 ;
...
-(void)_didGetTapHighlightForRequest:(NSUInteger)arg0 color:(struct Color *)arg1 quads:(*void)arg2 topLeftRadius:(struct IntSize *)arg3 topRightRadius:(struct IntSize *)arg4 bottomLeftRadius:(struct IntSize *)arg5 bottomRightRadius:(struct IntSize *)arg6 nodeHasBuiltInClickHandling:(BOOL)arg7 ;
...
-(void)_disableDoubleTapGesturesDuringTapIfNecessary:(NSUInteger)arg0 ;
...
-(void)_doAfterResettingSingleTapGesture:(id)arg0 ;
...
-(void)_handleSmartMagnificationInformationForPotentialTap:(NSUInteger)arg0 renderRect:(struct FloatRect *)arg1 fitEntireRect:(BOOL)arg2 viewportMinimumScale:(CGFloat)arg3 viewportMaximumScale:(CGFloat)arg4 nodeIsRootLevel:(BOOL)arg5 ;
...
-(void)_requestDOMPasteAccessWithElementRect:(struct IntRect *)arg0 originIdentifier:(*void)arg1 completionHandler:(*void)arg2 ;
...
-(void)requestTextRecognition:(id)arg0 imageData:(*void)arg1 completionHandler:(*void)arg2 ;
...
-(void)updateFocusedElementValueAsNumber:(CGFloat)arg0 ;
