...
-(id)_initWithType:(NSInteger)arg0 URL:(id)arg1 imageURL:(id)arg2 location:(struct IntPoint *)arg3 title:(id)arg4 ID:(id)arg5 rect:(struct CGRect )arg6 image:(*void)arg7 ;
-(id)_initWithType:(NSInteger)arg0 URL:(id)arg1 imageURL:(id)arg2 location:(struct IntPoint *)arg3 title:(id)arg4 ID:(id)arg5 rect:(struct CGRect )arg6 image:(*void)arg7 userInfo:(id)arg8 ;
