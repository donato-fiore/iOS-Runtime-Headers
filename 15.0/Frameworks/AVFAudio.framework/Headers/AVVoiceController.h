...
@protocol AVAudioRemoteInputPlugin_PrivateTest, Endpointer, AVVoiceControllerPlaybackDelegate, AVVoiceControllerRecordDelegate;
...
@property NSObject<AVVoiceControllerPlaybackDelegate> *playbackDelegate;
...
-(BOOL)preparePlaybackFromURL:(id)arg0 error:(*id)arg1 ;
-(BOOL)preparePlaybackWithSettings:(id)arg0 error:(*id)arg1 ;
...
-(BOOL)setPlaybackBufferDuration:(CGFloat)arg0 ;
...
-(CGFloat)getPlaybackBufferDuration;
...
-(void)beganPlaying;
-(void)beganRecording_v1v2:(id)arg0 ;
...
-(void)finishedRecording_v1v2:(id)arg0 ;
...
-(void)stopPlaying;
-(void)stopRecordOnStream:(NSUInteger)arg0 completion:(id)arg1 ;
-(void)stopRecording;
-(void)updateMeters;
