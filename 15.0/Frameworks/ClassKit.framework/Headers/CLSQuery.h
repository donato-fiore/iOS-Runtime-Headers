...
+(id)queryWithObjectType:(Class)arg0 querySpecification:(id)arg1 error:(*id)arg2 ;
...
-(id)initWithObjectType:(Class)arg0 querySpecification:(id)arg1 error:(*id)arg2 ;
...
-(void)clientRemote_finishWithState:(NSUInteger)arg0 error:(id)arg1 ;
