...
@class NSArray, NSMutableDictionary, NSMutableArray, NSPointerArray, NSString, PAApplication, NSDate, ML3MusicLibrary, NSURL, NSNumber, ICUserIdentity;
...
@property (readonly, nonatomic) PAApplication *clientApplication; // ivar: _clientApplication
