...
+(BOOL)_getEffectiveStoreDownloadAttributes:(*id)arg0 forPlaybackItemMetadata:(id)arg1 attributes:(id)arg2 ;
+(BOOL)canCreateStoreDownloadForPlaybackItemMetadata:(id)arg0 type:(NSInteger)arg1 attributes:(id)arg2 ;
...
+(id)storeDownloadForPlaybackItemMetadata:(id)arg0 type:(NSInteger)arg1 attributes:(id)arg2 ;
