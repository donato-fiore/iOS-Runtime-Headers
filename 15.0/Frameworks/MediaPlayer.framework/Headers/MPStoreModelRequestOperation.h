...
-(void)_executeURLLoadWithRequest:(id)arg0 storeBagDictionary:(id)arg1 requestContext:(id)arg2 ;
-(void)_executeURLLoadWithRequests:(id)arg0 storeBagDictionary:(id)arg1 requestContext:(id)arg2 ;
