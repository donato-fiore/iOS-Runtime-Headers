...
@property (copy, nonatomic) NSArray *updatedItemIndexPaths; // ivar: _updatedItemIndexPaths
@property (copy, nonatomic) NSIndexSet *updatedSections; // ivar: _updatedSections
