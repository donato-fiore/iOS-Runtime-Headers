...
@class AVAsset, AVPlayerItem, NSArray, PAAccessInterval, AVPlayerItemAccessLog, NSString, NSNumber, NSError, ICMusicSubscriptionLeaseStatus, NSDictionary;
...
@property (nonatomic, getter=isStartItem) BOOL startItem; // ivar: _startItem
