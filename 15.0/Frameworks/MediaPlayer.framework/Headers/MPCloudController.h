...
@property (readonly, nonatomic, getter=isJaliscoGeniusEnabled) BOOL jaliscoGeniusEnabled; // ivar: _jaliscoGeniusEnabled
...
-(void)_loadIsJaliscoGeniusSupportedWithCompletion:(id)arg0 ;
