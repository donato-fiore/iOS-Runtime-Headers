...
@property (retain, nonatomic) LPPointUnit *maximumIntrinsicHeight; // ivar: _maximumIntrinsicHeight
...
+(id)themeWithStyle:(NSInteger)arg0 icon:(id)arg1 platform:(NSInteger)arg2 sizeClass:(NSUInteger)arg3 preferredContentSizeCategory:(id)arg4 ;
...
-(id)initWithStyle:(NSInteger)arg0 icon:(id)arg1 platform:(NSInteger)arg2 sizeClass:(NSUInteger)arg3 preferredContentSizeCategory:(id)arg4 ;
