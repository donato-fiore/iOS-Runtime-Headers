...
-(struct CGImage *)_createCGImage:(id)arg0 fromRect:(struct CGRect )arg1 format:(int)arg2 colorSpace:(struct CGColorSpace *)arg3 deferred:(struct Trilean )arg4 error:(id)arg5 ;
...
-(struct CGImage *)createCGImage:(id)arg0 fromRect:(struct CGRect )arg1 format:(int)arg2 colorSpace:(struct CGColorSpace *)arg3 deferred:(BOOL)arg4 error:(id)arg5 ;
