...
+(id)kernelWithFunctionName:(id)arg0 fromCIKernelLibraryData:(id)arg1 source:(id)arg2 options:(id)arg3 error:(*id)arg4 ;
...
+(id)redEyeMetalKernelWithFunctionName:(id)arg0 error:(*id)arg1 ;
+(id)redEyeMetalKernelWithFunctionName:(id)arg0 outputPixelFormat:(int)arg1 error:(*id)arg2 ;
