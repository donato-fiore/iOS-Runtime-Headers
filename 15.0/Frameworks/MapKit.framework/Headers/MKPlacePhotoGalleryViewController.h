...
#ifndef MKPLACEPHOTOGALLERYVIEWCONTROLLER_H
#define MKPLACEPHOTOGALLERYVIEWCONTROLLER_H

@class UIViewController, UIBarButtonItem, UIView, NSString, NSMutableArray, NSNumber, NSArray, UIScrollView, UIActivityIndicatorView;
@protocol UIScrollViewDelegate, UIGestureRecognizerDelegate, MUPlacePhotoGalleryAttributionViewDelegate, MKActivityObserving, MKPlacePhotoGalleryViewControllerDelegate;


#import "MKPlacePhotoGalleryAttributionView.h"
#import "MKMapItem.h"
...
@property (retain, nonatomic) MKPlacePhotoGalleryAttributionView *attributionView; // ivar: _attributionView
@property (retain, nonatomic) UIBarButtonItem *backBarButtonItem; // ivar: _backBarButtonItem
@property (readonly, copy) NSString *debugDescription;
@property (weak, nonatomic) NSObject<MKPlacePhotoGalleryViewControllerDelegate> *delegate; // ivar: _delegate
...
-(BOOL)isPhotoProvidedByApple:(id)arg0 ;
-(NSUInteger)indexOfView:(id)arg0 ;
-(NSUInteger)indexOfVisibleView;
-(NSUInteger)viewsCount;
-(id)attributionLogoUsingDarkAppearance:(BOOL)arg0 forPhoto:(id)arg1 ;
-(id)currentPhoto;
