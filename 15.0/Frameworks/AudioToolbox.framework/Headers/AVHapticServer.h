...
-(int)doPrewarm:(struct shared_ptr<ClientEntry> )arg0 ;
-(int)loadSynthPreset;
...
-(void)decrementRunningCountAndStopAudio:(BOOL)arg0 stopHaptics:(BOOL)arg1 ;
...
-(void)incrementRunningCountForAudio:(BOOL)arg0 haptics:(BOOL)arg1 ;
