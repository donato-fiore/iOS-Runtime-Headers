...
@class NSURL, NSArray, NSString, NSData, NSSet, NSDate, NSDictionary;
@protocol CKPropertiesDescription, CKContainerAssignment, NSSecureCoding, NSCopying, CKRecordKeyValueSetting;
