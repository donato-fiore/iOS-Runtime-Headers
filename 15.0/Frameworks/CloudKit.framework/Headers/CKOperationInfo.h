...
@property (nonatomic) BOOL isLongLived; // ivar: _isLongLived
...
@property (retain, nonatomic) CKOperationConfiguration *perOpConfiguration; // ivar: _perOpConfiguration
...
@property (readonly, nonatomic) CKOperationConfiguration *resolvedConfiguration; // ivar: _resolvedConfiguration
