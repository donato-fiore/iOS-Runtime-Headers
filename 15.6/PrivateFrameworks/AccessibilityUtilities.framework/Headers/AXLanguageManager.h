...
@class NSMutableDictionary, NSCharacterSet, NSArray, NSSet, NSString, NSLocale;
...
// -(id)dialectsThatCanSpeak:(id)arg0 dialectIsSecondary:(unk)arg1 overridePreferredLanguages:(id)arg2  ;
