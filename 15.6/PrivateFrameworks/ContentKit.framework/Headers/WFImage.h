...
+(BOOL)imageSizeIndicatesScreenshot:(struct CGSize )arg0 ;
...
+(id)glyphNamed:(id)arg0 pointSize:(CGFloat)arg1 symbolSize:(NSUInteger)arg2 scaleFactor:(CGFloat)arg3 rightToLeft:(BOOL)arg4 appearanceName:(id)arg5 inCatalogs:(id)arg6 ;
...
+(id)imageWithPlatformImage:(id)arg0 ;
...
-(id)init;
-(id)initWithCGImage:(struct CGImage *)arg0 scale:(CGFloat)arg1 name:(id)arg2 bundle:(id)arg3 ;
