...
+(id)destinationWithAppDescriptor:(id)arg0 managedLevel:(NSUInteger)arg1 promptingBehaviour:(NSUInteger)arg2 ;
+(id)destinationWithAppDescriptor:(id)arg0 promptingBehaviour:(NSUInteger)arg1 ;
+(id)destinationWithSystemAppBundleIdentifier:(id)arg0 ;
+(id)destinationWithSystemAppBundleIdentifier:(id)arg0 promptingBehaviour:(NSUInteger)arg1 ;
+(id)objectWithWFSerializedRepresentation:(id)arg0 ;
+(id)platformFileManagerDestination;
-(BOOL)isEqual:(id)arg0 ;
-(id)app;
-(id)copyWithZone:(struct _NSZone *)arg0 ;
-(id)initWithAppDescriptor:(id)arg0 identifier:(id)arg1 managedLevel:(NSUInteger)arg2 promptingBehaviour:(NSUInteger)arg3 ;
