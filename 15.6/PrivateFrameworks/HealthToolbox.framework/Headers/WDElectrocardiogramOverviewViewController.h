...
@class HKTableViewController, NSNumber, NSString, HKDisplayType, HKHeartRhythmAvailability, HKElectrocardiogramMoreHealthDataProvider, HRElectrocardiogramOnboardingManager, UITapGestureRecognizer;
@protocol HRFeatureRegulatoryReenableFeatureActionDelegate, HRElectrocardiogramOnboardingManagerDelegate, WDElectrocardiogramFilterDataProviderDelegate, HKOnboardingSetupViewDelegate, HKHeartRhythmAvailabilityObserver, HKDataMetadataSectionProtocol;
...
@property (nonatomic) NSInteger previousElectrocardiogramRescindedStatusCache; // ivar: _previousElectrocardiogramRescindedStatusCache
...
-(NSInteger)_maxOnboardedAlgorithmVersion;
-(NSInteger)availabilityState;
-(NSInteger)numberOfSectionsInTableView:(id)arg0 ;
-(NSInteger)tableView:(id)arg0 numberOfRowsInSection:(NSInteger)arg1 ;
-(id)_anyUpgradeSoftwareSupportedAboveAlgorithmVersion:(NSInteger)arg0 ;
