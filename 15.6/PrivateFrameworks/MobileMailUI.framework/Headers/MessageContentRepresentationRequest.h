...
-(id)initWithMessage:(id)arg0 includeSuggestionItems:(BOOL)arg1 ;
-(id)initWithMessage:(id)arg0 includeSuggestionItems:(BOOL)arg1 representationType:(id)arg2 delegate:(id)arg3 ;
-(id)initWithMessageList:(id)arg0 itemIdentifier:(id)arg1 includeSuggestionItems:(BOOL)arg2 ;
-(id)initWithMessageList:(id)arg0 itemIdentifier:(id)arg1 includeSuggestionItems:(BOOL)arg2 representationType:(id)arg3 delegate:(id)arg4 ;
