...
@class UIView, EFCancelationToken, NSMutableArray, UIBarButtonItem, NSMutableSet, NSSet, NSMutableDictionary, NSDictionary, NSArray, EMContentRepresentation, NSError, EMDaemonInterface, NSString, MFMessageLoadingContext, MFMessageContentLoadingView, MFMailboxProvider, UIScrollView, WKWebView;
