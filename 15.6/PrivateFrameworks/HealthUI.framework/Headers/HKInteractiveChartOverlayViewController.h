...
-(void)_clearOverlayDisplayTypeWithAutomaticAutoscale:(BOOL)arg0 ;
-(void)_commonInitializationWithDisplayType:(id)arg0 ;
-(void)_deliverOrWaitForDataSource:(id)arg0 graphSeriesContext:(id)arg1 priorityDelegate:(id)arg2 timeScope:(NSInteger)arg3 startDate:(id)arg4 endDate:(id)arg5 completion:(id)arg6 ;
