...
-(id)attributedStringFromValue:(id)arg0 roundToHours:(BOOL)arg1 displayType:(id)arg2 unitController:(id)arg3 valueFont:(id)arg4 unitFont:(id)arg5 formatForChart:(BOOL)arg6 unitFormatString:(id)arg7 ;
