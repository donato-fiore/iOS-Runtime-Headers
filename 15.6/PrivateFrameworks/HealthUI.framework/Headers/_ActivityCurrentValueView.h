...
-(id)initWithDisplayTypeController:(id)arg0 unitPreferenceController:(id)arg1 wheelchairUseCharacteristicCache:(id)arg2 currentValueViewCallbacks:(id)arg3 activitySummaryDataProvider:(id)arg4 firstWeekday:(NSInteger)arg5 ;
