...
@class HKActivitySummary, NSString, UIView, HKActivityRingView, _HKWheelchairUseCharacteristicCache;
...
-(id)initWithDisplayTypeController:(id)arg0 unitController:(id)arg1 wheelchairUseCharacteristicCache:(id)arg2 dateCache:(id)arg3 currentValueViewContext:(BOOL)arg4 firstWeekday:(NSInteger)arg5 ;
