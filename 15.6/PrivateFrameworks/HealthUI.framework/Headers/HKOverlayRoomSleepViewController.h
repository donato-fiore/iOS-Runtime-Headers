...
@class NSString;
@protocol HKCurrentValueViewDataSourceDelegate, _HKContextChangeDelegate, HKOverlayRoomTrendModelProviding, HKSleepDataSourceProvider;
...
@interface HKOverlayRoomSleepViewController : HKOverlayRoomViewController <HKCurrentValueViewDataSourceDelegate, _HKContextChangeDelegate, HKOverlayRoomTrendModelProviding>
...
@property (retain, nonatomic) HKChartCache *sharedSleepCache; // ivar: _sharedSleepCache
...
-(id)_buildDurationAverageDisplayTypeWithApplicationItems:(id)arg0 customSleepSeries:(id)arg1 customSleepChartFormatter:(id)arg2 ;
...
-(id)_buildSleepDisplayTypeWithApplicationItems:(id)arg0 sleepSeriesType:(NSInteger)arg1 customSleepSeries:(id)arg2 customSleepChartFormatter:(id)arg3 ;
