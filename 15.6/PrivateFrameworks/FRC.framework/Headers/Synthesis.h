...
@class NSString;
@protocol FRCSynthesis, MTLDeviceSPI, MTLCommandQueue, OS_dispatch_semaphore;
...
-(struct ? *)getWarpedFeatureSizeForLevel:(int)arg0 ;
...
-(void)dealloc;
-(void)encodeForwarpToCommandBuffer:(id)arg0 level:(int)arg1 firstTexture:(id)arg2 secondTexture:(id)arg3 firstWarpedTexture:(id)arg4 secondWarpedTexture:(id)arg5 timeScale:(float)arg6 ;
...
-(void)synthesizeImageWithTwoLayerHybridWithFlowForward:(struct __CVBuffer *)arg0 flowBackward:(struct __CVBuffer *)arg1 timeScale:(float)arg2 destination:(struct __CVBuffer *)arg3 ;
