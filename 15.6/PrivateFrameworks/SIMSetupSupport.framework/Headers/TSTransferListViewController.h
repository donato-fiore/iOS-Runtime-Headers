...
@interface TSTransferListViewController : OBTableWelcomeController <UINavigationControllerDelegate, UITableViewDataSource, UITableViewDelegate, TSSetupFlowItem>

 {
    ...
    BOOL _transferOnging;
    BOOL _pendingInstallCompleted;
    BOOL _carrierSetupInstallCompleted;
...
-(id)initWithTransferItems:(id)arg0 inBuddy:(BOOL)arg1 isActivationPolicyMismatch:(BOOL)arg2 isDualeSIMCapabilityLoss:(BOOL)arg3 pendingInstallItems:(id)arg4 carrierSetupItems:(id)arg5 ;
...
-(void)_maybeDisplaySecureIntentConsent:(BOOL)arg0 completion:(id)arg1 ;
