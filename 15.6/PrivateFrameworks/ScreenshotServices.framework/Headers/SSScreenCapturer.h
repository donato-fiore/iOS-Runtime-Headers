...
-(void)_captureAndSendMetadataAndDocumentForEnvironmentDescription:(id)arg0 ;
-(void)_captureAndSendMetadataForEnvironmentElement:(id)arg0 hasBlacklistedElement:(BOOL)arg1 sendCompletion:(id)arg2 ;
...
-(void)_takeScreenshotWithOptionsCollection:(id)arg0 presentationOptions:(id)arg1 appleInternalOptions:(id)arg2 ;
-(void)dealloc;
