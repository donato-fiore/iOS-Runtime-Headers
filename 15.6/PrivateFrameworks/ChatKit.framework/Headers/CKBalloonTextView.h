...
@protocol NSLayoutManagerDelegate, UIGestureRecognizerDelegate, UITextViewDelegate, CKBalloonTextViewInteractionDelegate;
...
-(void)_removeFakeSelectionBackgroundColorForRange:(struct _NSRange )arg0 ;
