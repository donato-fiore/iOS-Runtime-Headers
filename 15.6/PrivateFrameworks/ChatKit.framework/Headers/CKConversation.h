...
@class NSString, CNGroupIdentity, NSNumber, IMHandle, IMChat, NSDate, NSArray, NSAttributedString, NSSet, IMService;
...
@property (readonly, nonatomic) NSString *conversationListCollectionViewListItemIdentifier; // ivar: _conversationListCollectionViewListItemIdentifier
@property (readonly, nonatomic) NSString *conversationListCollectionViewPinnedItemIdentifier; // ivar: _conversationListCollectionViewPinnedItemIdentifier
...
@property (nonatomic) BOOL holdWasKnownSenderUpdates; // ivar: _holdWasKnownSenderUpdates
...
@property (readonly, nonatomic) int wasDetectedAsSMSCategory; // ivar: _wasDetectedAsSMSCategory
@property (readonly, nonatomic) int wasDetectedAsSMSSpam; // ivar: _wasDetectedAsSMSSpam
@property (readonly, nonatomic) int wasDetectedAsSpam;
@property (readonly, nonatomic) int wasDetectedAsiMessageSpam; // ivar: _wasDetectedAsiMessageSpam
...
-(BOOL)supportsSurf;
-(CGFloat)maxTrimDurationForMediaType:(int)arg0 ;
