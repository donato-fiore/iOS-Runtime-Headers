...
#ifndef CKQUICKSAVEBUTTON_H
#define CKQUICKSAVEBUTTON_H
...
@property (weak, nonatomic) NSObject<CKQuickSaveButtonAnimationDelegate> *animationDelegate; // ivar: _animationDelegate
...
@property (weak, nonatomic) NSObject<CKQuickSaveButtonDelegate> *delegate; // ivar: _delegate
@property (readonly, nonatomic) UIImageView *imageView; // ivar: _imageView
@property (nonatomic) NSUInteger state; // ivar: _state


-(id)_imageForState:(NSUInteger)arg0 ;
-(id)hitTest:(struct CGPoint )arg0 withEvent:(id)arg1 ;
-(id)init;
-(id)initWithCoder:(id)arg0 ;
-(id)initWithFrame:(struct CGRect )arg0 ;
-(id)initWithInitialState:(NSUInteger)arg0 ;
-(struct UIEdgeInsets )_contentEdgeInsetsForState:(NSUInteger)arg0 ;
