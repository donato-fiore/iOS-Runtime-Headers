...
@class NSIndexPath, NSString, NSArray, IMChat, UINavigationController, CKTranscriptCompositor, NSMutableSet, UIView<CKGradientReferenceView>, NSIndexSet, UITapGestureRecognizer, NSDictionary, UIView, IMStateCaptureAssistant, UIView<CKFullscreenEffectView>;
