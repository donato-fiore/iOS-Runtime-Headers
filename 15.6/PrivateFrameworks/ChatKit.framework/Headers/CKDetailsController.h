...
@class NSArray, NSString, UITextView, NSTimer, CNGroupIdentityHeaderViewController, NSNumber, FMFMapViewController, UIButton, NSData, CNContactStore, UIVisualEffectView;
