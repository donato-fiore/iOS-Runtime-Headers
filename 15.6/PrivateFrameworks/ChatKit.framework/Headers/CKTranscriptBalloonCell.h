...
@protocol IMPhotoLibraryPersistenceManagerListener, CKQuickSaveButtonAnimationDelegate, CKQuickSaveButtonDelegate;
...
@property (nonatomic) BOOL canShowQuickSaveButton; // ivar: _canShowQuickSaveButton
@property (readonly, copy) NSString *debugDescription;
@property (readonly, copy) NSString *description;
@property (nonatomic) BOOL hasQueuedQuickSaveButtonRemoval; // ivar: _hasQueuedQuickSaveButtonRemoval
...
@property (readonly, nonatomic) CKQuickSaveButton *quickSaveButton; // ivar: _quickSaveButton
@property (copy, nonatomic) id *quickSaveButtonTappedCallback; // ivar: _quickSaveButtonTappedCallback
...
-(void)_addQuickSaveButtonIfNeededAnimated:(BOOL)arg0 ;
...
-(void)_removeQuickSaveButtonIfNeededAnimated:(BOOL)arg0 ;
...
-(void)quickSaveButtonAnimationDidBegin:(id)arg0 ;
-(void)quickSaveButtonAnimationDidEnd:(id)arg0 ;
