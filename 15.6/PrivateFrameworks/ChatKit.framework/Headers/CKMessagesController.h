...
@class UISplitViewController, NSMutableArray, NSSet, UINavigationController, UIViewController<CKConversationListControllerProtocol>, NSString, CKInboxModel, UIViewController, UIViewController<CKBrowserViewControllerProtocol>, NSArray;
