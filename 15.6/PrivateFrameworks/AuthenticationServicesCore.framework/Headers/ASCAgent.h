...
@class NSArray, NSXPCConnection, NSString, NSURL;
@protocol _TtP26AuthenticationServicesCore21ASCABLEClientDelegate_, ASPublicKeyCredentialManagerDelegate, ASCAuthorizationPresenterDelegate, ASCAgentProtocol, ASPublicKeyCredentialManagerInterface;
...
-(BOOL)_isAuthenticationConfiguredForPlatformPublicKeyRequestWithError:(*id)arg0 ;
...
-(void)_configurePublicKeyCredentialsWithAssertionOptions:(id)arg0 completionHandler:(id)arg1 ;
...
-(void)_credentialRequestedForPlatformLoginChoice:(id)arg0 authenticatedContext:(id)arg1 ;
...
-(void)_presentAuthorizationRequestWithContext:(id)arg0 completionHandler:(id)arg1 ;
