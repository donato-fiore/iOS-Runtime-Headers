...
-(id)initWithRelyingPartyIdentifier:(id)arg0 authenticatorData:(id)arg1 signature:(id)arg2 userHandle:(id)arg3 rawClientDataJSON:(id)arg4 credentialID:(id)arg5 ;
