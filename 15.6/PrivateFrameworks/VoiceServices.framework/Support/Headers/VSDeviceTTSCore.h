...
@class NSOperation, VSAudioData, VSSpeechEngine, NSError, VSInstrumentMetrics, VSSpeechRequest, VSVoiceAssetSelection, VSVoiceResourceAsset;
...
-(void)reportProcessingWordTimingInfo:(id)arg0 ;
