...
@protocol TVRUIDeviceDelegate, TVRUIDeviceSearchDelegate, TVRUIDevicePickerDelegate, TVRAlertControllerDelegate, _TVRUIEventDelegate, SBSHardwareButtonEventConsuming, TVRUIContentPresenter, TVRUIDevice, TVRUIRemoteViewControllerDelegate, TVRUIDeviceQuery, TVRUIStyleProvider, BSInvalidatable;
