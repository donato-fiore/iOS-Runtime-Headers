...
@class NSNumber, NSDictionary, NSString, NSURL, NSSet;
...
@property (retain, nonatomic) NSSet *storeIdentifiersToDownload; // ivar: _storeIdentifiersToDownload
@property (nonatomic, getter=isSupplementalContent) BOOL supplementalContent; // ivar: _supplementalContent
