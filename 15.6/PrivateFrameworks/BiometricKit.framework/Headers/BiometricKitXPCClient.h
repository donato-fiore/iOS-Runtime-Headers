...
@property (weak, nonatomic) NSObject<BiometricKitDelegateXpcProtocol> *delegate; // ivar: _delegate
...
-(int)enrollContinue;
-(int)fieldDiagnosticsControl:(unsigned int)arg0 inData:(id)arg1 outData:(*id)arg2 ;
