...
@class NSString;
@protocol BiometricKitDelegateXpcProtocol, OS_os_log, BiometricKitDelegate;
...
+(id)manager;
-(?)createMatchInfo:(?)arg0 withTopologywithMatchImage;
-(?)imageDictFromRawImageData;
-(?)pullDebugImageData:(?)arg0 rotatedtarget;
