...
@property (nonatomic) NSUInteger numAccessories; // ivar: _numAccessories
...
@property (nonatomic) NSUInteger numBTLE; // ivar: _numBTLE
...
@property (nonatomic) NSUInteger numDevices; // ivar: _numDevices
...
@property (nonatomic) NSUInteger numMacBook; // ivar: _numMacBook
...
@property (nonatomic) NSUInteger numiPad; // ivar: _numiPad
@property (nonatomic) NSUInteger numiPhone; // ivar: _numiPhone
...
-(void)addDeviceFetchResultCount:(NSUInteger)arg0 type1count:(NSUInteger)arg1 type2count:(NSUInteger)arg2 type3count:(NSUInteger)arg3 type4count:(NSUInteger)arg4 type5count:(NSUInteger)arg5 type6count:(NSUInteger)arg6 type7count:(NSUInteger)arg7 safeCount:(NSUInteger)arg8 usingSameSafe:(BOOL)arg9 ;
