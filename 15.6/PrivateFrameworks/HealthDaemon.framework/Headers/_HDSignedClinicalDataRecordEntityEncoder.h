...
#ifndef _HDSIGNEDCLINICALDATARECORDENTITYENCODER_H
#define _HDSIGNEDCLINICALDATARECORDENTITYENCODER_H

@class HDMedicalRecordEntityEncoder;



@interface _HDSignedClinicalDataRecordEntityEncoder : HDMedicalRecordEntityEncoder
