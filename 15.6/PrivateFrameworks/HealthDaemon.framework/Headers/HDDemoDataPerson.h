...
@property (nonatomic) NSUInteger numSleepInterruptions; // ivar: _numSleepInterruptions
...
@property (retain, nonatomic) NSDictionary *workoutPrototypesByCalendarDay; // ivar: _workoutPrototypesByCalendarDay
