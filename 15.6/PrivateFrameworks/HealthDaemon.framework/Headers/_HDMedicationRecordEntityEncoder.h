...
#ifndef _HDMEDICATIONRECORDENTITYENCODER_H
#define _HDMEDICATIONRECORDENTITYENCODER_H

@class HDMedicalRecordEntityEncoder;



@interface _HDMedicationRecordEntityEncoder : HDMedicalRecordEntityEncoder
