...
@property (readonly, copy, nonatomic) NSDictionary *statisticsCalculators; // ivar: _statisticsCalculators
...
-(id)initWithWorkoutConfiguration:(id)arg0 identifier:(id)arg1 dateInterval:(id)arg2 metadata:(id)arg3 device:(id)arg4 source:(id)arg5 sourceVersion:(id)arg6 events:(id)arg7 statisticsCalculators:(id)arg8 associatedSeries:(id)arg9 goalType:(NSUInteger)arg10 goal:(id)arg11 quantityTypesIncludedWhilePaused:(id)arg12 ;
