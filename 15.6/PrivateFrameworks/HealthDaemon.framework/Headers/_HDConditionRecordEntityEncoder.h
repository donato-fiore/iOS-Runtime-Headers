...
#ifndef _HDCONDITIONRECORDENTITYENCODER_H
#define _HDCONDITIONRECORDENTITYENCODER_H

@class HDMedicalRecordEntityEncoder;



@interface _HDConditionRecordEntityEncoder : HDMedicalRecordEntityEncoder
