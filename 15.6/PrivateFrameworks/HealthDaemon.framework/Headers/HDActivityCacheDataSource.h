...
@class NSString, HKCategoryType, HKWorkoutType, NSSet, _HKDelayedOperation, NSDateInterval;
@protocol HDActivityCacheStatisticsBuilderSourceOrderDelegate, HDDataObserver, OS_dispatch_queue;
