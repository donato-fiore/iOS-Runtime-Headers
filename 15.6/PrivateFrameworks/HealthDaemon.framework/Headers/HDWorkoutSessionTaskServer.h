...
@protocol HKWorkoutSessionServerInterface, HKDataFlowLinkProcessor, HDWorkoutDataSource, HDWorkoutDataDestination, HDWorkoutSessionObserver, OS_dispatch_queue, HDWorkoutDataAccumulator;
