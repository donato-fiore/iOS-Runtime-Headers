...
+(BOOL)deleteSeriesFromHFDWithKey:(NSInteger)arg0 database:(id)arg1 error:(*id)arg2 ;
+(BOOL)deleteSeriesFromSQLiteWithKey:(NSInteger)arg0 database:(id)arg1 error:(*id)arg2 ;
+(BOOL)deleteSeriesWithID:(id)arg0 deleteHFDData:(BOOL)arg1 profile:(id)arg2 transaction:(id)arg3 error:(*id)arg4 ;
...
+(BOOL)performSeriesWriteTransactionWithProfile:(id)arg0 error:(*id)arg1 block:(id)arg2 ;
+(BOOL)primitiveInsertValues:(id)arg0 seriesVersion:(NSInteger)arg1 HFDKey:(NSInteger)arg2 insertToSQLite:(BOOL)arg3 database:(id)arg4 error:(*id)arg5 ;
+(BOOL)primitiveRemoveDatums:(id)arg0 HFDKey:(NSInteger)arg1 deleteFromSQLite:(BOOL)arg2 transaction:(id)arg3 error:(*id)arg4 ;
...
+(BOOL)replaceObjectID:(id)arg0 replacementObjectID:(id)arg1 deleteOriginalHFDData:(BOOL)arg2 profile:(id)arg3 transaction:(id)arg4 error:(*id)arg5 ;
...
-(BOOL)enumerateDataInInterval:(id)arg0 transaction:(id)arg1 error:(*id)arg2 handler:(id)arg3 ;
...
-(id)seriesSourceWithDatabase:(id)arg0 error:(*id)arg1 ;
