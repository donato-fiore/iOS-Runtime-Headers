...
@class NSMutableSet, HDAssertion, NSDictionary, NSSet, CKOperationGroup, NSString, NSDate, NSUUID;
...
-(BOOL)satisfiesOperationTagDependencies:(id)arg0 error:(*id)arg1 ;
...
-(void)dealloc;
-(void)didFinishOperationTag:(id)arg0 ;
