...
+(BOOL)updateLovedPlaylistByAddingTrackWithPersistentID:(id)arg0 inLibrary:(id)arg1 ;
+(BOOL)updateLovedPlaylistByRemovingTrackWithPersistentID:(id)arg0 inLibrary:(id)arg1 ;
