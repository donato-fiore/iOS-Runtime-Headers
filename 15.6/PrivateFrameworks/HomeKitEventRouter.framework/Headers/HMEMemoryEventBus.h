...
@class NSString;
@protocol HMELastEventStoreWriter, HMETopicRouterDelegate, HMESynchronousSubscriptionProviding, HMEEventForwarder, HMESubscriptionProviding, HMEEventConsumer, OS_os_log, HMEMemoryEventBusDelegate, HMELastEventStoreReadHandle, HMELastEventStoreWriteHandle, OS_dispatch_queue;
