...
@protocol HMEEventConsumer, HMETopicRouterDelegate, HMELastEventStoreWriter, OS_os_log, HMELastEventStoreReadHandle, HMEEventForwarder, OS_dispatch_queue, HMESubscriptionProviding;
...
-(id)cachedEventsForTopics:(id)arg0 ;
