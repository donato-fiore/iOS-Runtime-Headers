...
@property BOOL aggregateStacksByProcess; // ivar: _aggregateStacksByProcess
@property BOOL aggregateStacksByThread; // ivar: _aggregateStacksByThread
...
@property BOOL displayAllHIDEvents; // ivar: _displayAllHIDEvents
...
@property BOOL displayStacksWithZeroCount; // ivar: _displayStacksWithZeroCount
...
@property BOOL displayTimestampsInCallTrees; // ivar: _displayTimestampsInCallTrees
...
@property BOOL orderTasksBySampleCount; // ivar: _orderTasksBySampleCount
...
@property BOOL printTargetHIDEvent; // ivar: _printTargetHIDEvent
