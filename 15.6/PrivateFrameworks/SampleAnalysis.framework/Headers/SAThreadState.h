...
-(id)initWithKCDataDeltaThreadV2:(struct thread_delta_snapshot_v2 *)arg0 startTimestamp:(id)arg1 endTimestamp:(id)arg2 startSampleIndex:(NSUInteger)arg3 endSampleIndex:(NSUInteger)arg4 name:(id)arg5 leafUserFrame:(id)arg6 leafKernelFrame:(id)arg7 oldThreadState:(id)arg8 waitInfo:(id)arg9 turnstileInfo:(id)arg10 ;
-(id)initWithKCDataDeltaThreadV3:(struct thread_delta_snapshot_v3 *)arg0 startTimestamp:(id)arg1 endTimestamp:(id)arg2 startSampleIndex:(NSUInteger)arg3 endSampleIndex:(NSUInteger)arg4 name:(id)arg5 leafUserFrame:(id)arg6 leafKernelFrame:(id)arg7 oldThreadState:(id)arg8 waitInfo:(id)arg9 turnstileInfo:(id)arg10 threadPolicyVersion:(unsigned int)arg11 ;
-(id)initWithKCDataThreadV2:(struct thread_snapshot_v2 *)arg0 startTimestamp:(id)arg1 endTimestamp:(id)arg2 startSampleIndex:(NSUInteger)arg3 endSampleIndex:(NSUInteger)arg4 name:(id)arg5 leafUserFrame:(id)arg6 leafKernelFrame:(id)arg7 machTimebase:(struct mach_timebase_info )arg8 waitInfo:(id)arg9 turnstileInfo:(id)arg10 ;
-(id)initWithKCDataThreadV4:(struct thread_snapshot_v4 *)arg0 startTimestamp:(id)arg1 endTimestamp:(id)arg2 startSampleIndex:(NSUInteger)arg3 endSampleIndex:(NSUInteger)arg4 name:(id)arg5 leafUserFrame:(id)arg6 leafKernelFrame:(id)arg7 machTimebase:(struct mach_timebase_info )arg8 waitInfo:(id)arg9 turnstileInfo:(id)arg10 threadPolicyVersion:(unsigned int)arg11 threadInstructionCycles:(struct instrs_cycles_snapshot *)arg12 ;
-(id)initWithStackshotThreadV1:(struct thread_snapshot *)arg0 startTimestamp:(id)arg1 endTimestamp:(id)arg2 startSampleIndex:(NSUInteger)arg3 endSampleIndex:(NSUInteger)arg4 leafUserFrame:(id)arg5 leafKernelFrame:(id)arg6 machTimebase:(struct mach_timebase_info )arg7 ;
