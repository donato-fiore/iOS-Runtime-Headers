...
+(BOOL)_isValidCoreAnalyticsValueType:(id)arg0 ;
+(id)_buildCACompatiblePayload:(id)arg0 ;
+(id)_caCompatiblePayloadKey:(id)arg0 ;
+(void)_analyticsSendEventLazy:(id)arg0 payload:(id)arg1 ;
