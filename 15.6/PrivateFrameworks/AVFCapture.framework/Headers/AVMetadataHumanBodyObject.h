...
#ifndef AVMETADATAHUMANBODYOBJECT_H
#define AVMETADATAHUMANBODYOBJECT_H
...
+(id)humanBodyObjectWithFigEmbeddedCaptureDeviceObjectDictionary:(id)arg0 input:(id)arg1 timeStamp:(id)arg2 ;
