...
@class UITableViewController, UIView, NSMutableArray, UIVisualEffectView, NSArray, NSString;
...
-(void)_setupHeaderSectionWithIconNames:(id)arg0 iconImages:(id)arg1 subTitle:(id)arg2 title:(id)arg3 ;
