...
#ifndef WFCONTACTFIELDCOMPONENT_H
#define WFCONTACTFIELDCOMPONENT_H
...
@property (readonly, nonatomic) WFContactFieldAttributes attributes; // ivar: _attributes
...
// +(id)newWithAttributes:(struct WFContactFieldAttributes *)arg0 updateBlock:(id)arg1 variableBlock:(unk)arg2 navigationContext:(id)arg3 size:(unk)arg4  ;
