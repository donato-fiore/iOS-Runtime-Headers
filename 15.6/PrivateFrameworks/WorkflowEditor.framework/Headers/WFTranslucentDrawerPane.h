...
@class UIViewController, UIView<WFDrawerPaneHeaderView>, UIView, NSLayoutConstraint, NSString, UISearchBar, UIVisualEffectView;
...
@property (weak, nonatomic) UIView *backgroundContentView; // ivar: _backgroundContentView
...
@property (nonatomic) BOOL usesVisualEffectView; // ivar: _usesVisualEffectView
@property (retain, nonatomic) UIViewController *viewController; // ivar: _viewController
@property (weak, nonatomic) UIVisualEffectView *visualEffectView; // ivar: _visualEffectView
