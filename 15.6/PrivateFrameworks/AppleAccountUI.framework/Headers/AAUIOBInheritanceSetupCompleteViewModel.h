...
#ifndef AAUIOBINHERITANCESETUPCOMPLETEVIEWMODEL_H
#define AAUIOBINHERITANCESETUPCOMPLETEVIEWMODEL_H

@class AAOBInheritanceSetupCompleteModel, UIView, AACustodianshipInfo, NSString, UIImage;
...
-(id)initWithBeneficiaryName:(id)arg0 accessKeyShareType:(NSUInteger)arg1 ;
