...
#ifndef AAUIOBCUSTODIANINTROVIEWMODEL_H
#define AAUIOBCUSTODIANINTROVIEWMODEL_H

@class AATrustedContactsCustodianSplashScreenModel, UIView, AACustodianshipInfo, NSString, UIImage;
