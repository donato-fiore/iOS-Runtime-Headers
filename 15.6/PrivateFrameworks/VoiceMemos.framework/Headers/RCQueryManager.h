...
-(NSUInteger)countOfPlayableRecordingsWithContext:(id)arg0 ;
...
-(id)availableRecordingsFetchRequest;
...
-(id)foldersWithNameFetchRequest:(id)arg0 option:(int)arg1 ;
...
-(id)playableRecordingsFetchRequest;
