...
@property BOOL isIOSBinaryMacOSAvailable; // ivar: _isIOSBinaryMacOSAvailable
@property BOOL isIOSBinaryMacOSCompatible; // ivar: _isIOSBinaryMacOSCompatible
...
-(void)_setBooleanPropertiesForBitfield:(int)arg0 ;
