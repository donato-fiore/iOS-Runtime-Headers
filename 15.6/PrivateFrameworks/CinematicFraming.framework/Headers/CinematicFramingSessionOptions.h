...
@property (nonatomic) float recenterAfterDriftDurationThreshold; // ivar: _recenterAfterDriftDurationThreshold
@property (nonatomic) BOOL recenterAfterDriftEnabled; // ivar: _recenterAfterDriftEnabled
@property (nonatomic) float recenterAfterDriftOffsetThreshold; // ivar: _recenterAfterDriftOffsetThreshold
...
@property (nonatomic) float subjectMovementTolerance; // ivar: _subjectMovementTolerance
