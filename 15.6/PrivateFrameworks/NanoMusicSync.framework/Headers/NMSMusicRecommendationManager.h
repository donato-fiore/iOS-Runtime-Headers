...
@interface NMSMusicRecommendationManager : NSObject {
    ...
    NSUInteger _storeRecommendationRetryAttempt;
...
-(id)_expirationDateForUpdateDate:(id)arg0 withOffsetDays:(NSInteger)arg1 preferredTimeWindow:(struct _NSRange )arg2 ;
