...
@class NSString, NPSDomainAccessor, NSDictionary, NSNumber, MPMediaPlaylist, NSData, NSDate, NSArray, NSSet;
...
@property (nonatomic) BOOL allowOffChargerAssetSync; // ivar: _allowOffChargerAssetSync
