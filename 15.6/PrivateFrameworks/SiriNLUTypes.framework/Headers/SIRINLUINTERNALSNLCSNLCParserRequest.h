...
#ifndef SIRINLUINTERNALSNLCSNLCPARSERREQUEST_H
#define SIRINLUINTERNALSNLCSNLCPARSERREQUEST_H
...
@property (retain, nonatomic) SIRINLUEXTERNALLegacyNLContext *legacyContext; // ivar: _legacyContext
