...
@class NSString;
@protocol UIScrollViewDelegate, MCProfileTitlePageViewModelDelegate, MCUISignInViewControllerDelegate, MCProfileQuestionsControllerDelegate, DevicePINControllerDelegate, DMCEnrollmentFlowRestoreViewControllerDelegate, MCUIDismissalAwareViewController;
