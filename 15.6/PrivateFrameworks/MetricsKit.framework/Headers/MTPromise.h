...
@property (retain, nonatomic) MTPromiseCompletionBlocks *completionBlocks; // ivar: _completionBlocks
@property (readonly, nonatomic, getter=isFinished) BOOL finished;
@property (retain, nonatomic) MTPromiseResult *promiseResult; // ivar: _promiseResult
@property (retain, nonatomic) NSConditionLock *stateLock; // ivar: _stateLock


+(BOOL)_errorIsCanceledError:(id)arg0 ;
+(id)_findUnfinishedPromise:(id)arg0 ;
+(id)_globalPromiseStorage;
+(id)_globalPromiseStorageAccessQueue;
+(id)_resultOfComposition:(id)arg0 errors:(id)arg1 ;
+(id)promiseWithAll:(id)arg0 ;
+(id)promiseWithAny:(id)arg0 ;
+(id)promiseWithComposition:(id)arg0 ;
...
+(void)_configureAnyPromise:(id)arg0 withPromises:(id)arg1 currentPromiseIndex:(NSUInteger)arg2 ;
+(void)_finishPromise:(id)arg0 withPromise:(id)arg1 ;
+(void)_setupCompositePromise:(id)arg0 composition:(id)arg1 ;
+(void)cancelPromisesInComposition:(id)arg0 ;
-(BOOL)cancel;
