...
@property (copy, nonatomic) NSArray *playActivityEvents; // ivar: _playActivityEvents
@property (copy, nonatomic) ICRadioPlaybackHistory *playbackContext; // ivar: _playbackContext
