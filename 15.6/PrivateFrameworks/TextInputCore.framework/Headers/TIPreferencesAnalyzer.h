...
-(void)_dispatchEventPayloadWithPreferenceName:(id)arg0 activeInputModes:(id)arg1 currentValue:(id)arg2 previousValue:(id)arg3 changedAt:(id)arg4 analyzedAt:(id)arg5 buildAtChange:(id)arg6 isFreshInstall:(BOOL)arg7 approxDateOfBuildInstall:(id)arg8 buildAtLastAnalysis:(id)arg9 ;
