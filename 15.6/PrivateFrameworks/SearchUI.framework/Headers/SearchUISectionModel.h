...
+(id)sectionModelWithGridRowModels:(id)arg0 numberOfColumns:(NSInteger)arg1 section:(id)arg2 ;
+(id)sectionModelWithRows:(id)arg0 drawPlattersIfNecessary:(BOOL)arg1 section:(id)arg2 ;
