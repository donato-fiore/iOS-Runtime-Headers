...
@class PXPhotoKitAssetsDataSourceManager, NSString, UIView, PXAssetReference, UIViewController, NSDictionary;
...
-(void)presentOneUpViewForRowModel:(id)arg0 environment:(id)arg1 ;
