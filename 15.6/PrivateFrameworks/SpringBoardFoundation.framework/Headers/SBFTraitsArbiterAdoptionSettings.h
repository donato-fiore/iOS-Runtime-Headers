...
#ifndef SBFTRAITSARBITERADOPTIONSETTINGS_H
#define SBFTRAITSARBITERADOPTIONSETTINGS_H
...
@property (nonatomic) BOOL orientationActuationEnabledForFullscreenOcclusionTestRecipe; // ivar: _orientationActuationEnabledForFullscreenOcclusionTestRecipe
...
@property (nonatomic) BOOL orientationActuationEnabledForLoginWindowRecipe; // ivar: _orientationActuationEnabledForLoginWindowRecipe
...
@property (nonatomic) BOOL orientationActuationEnabledForSwitcher; // ivar: _orientationActuationEnabledForSwitcher
...
@property (nonatomic) BOOL orientationActuationEnabledForUnlockedDodgingLayer; // ivar: _orientationActuationEnabledForUnlockedDodgingLayer
