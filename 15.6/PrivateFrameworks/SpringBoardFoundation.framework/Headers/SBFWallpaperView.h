...
#ifndef SBFWALLPAPERVIEW_H
#define SBFWALLPAPERVIEW_H

@class UIView, _UILegibilitySettingsProvider, _UILegibilitySettings, UIColor, NSTimer, NSString, UIImage;
@protocol PTSettingsKeyObserver, SBFLegibilitySettingsProvider, SBFLegibilitySettingsProviderDelegate, SBFWallpaperViewInternalObserver, SBFWallpaperViewDelegate;
...
@property (weak, nonatomic) NSObject<SBFWallpaperViewInternalObserver> *internalObserver; // ivar: _internalObserver
...
@property (weak, nonatomic) NSObject<SBFWallpaperViewDelegate> *wallpaperDelegate; // ivar: _wallpaperDelegate
