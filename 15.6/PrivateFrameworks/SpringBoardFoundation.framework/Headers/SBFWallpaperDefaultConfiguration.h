...
#ifndef SBFWALLPAPERDEFAULTCONFIGURATION_H
#define SBFWALLPAPERDEFAULTCONFIGURATION_H
...
@property (readonly, copy, nonatomic) SBFGradient *wallpaperGradient; // ivar: _wallpaperGradient
