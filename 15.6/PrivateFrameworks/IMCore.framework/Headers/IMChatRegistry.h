...
@class NSMutableArray, NSMutableDictionary, NSString, IMTimer, NSArray, NSDictionary, IMContactStore, TUConversationManager, NSSet, IMSharedWithYouManager, NSUserActivity;
@protocol NSFastEnumeration, TUConversationManagerDelegate, IMRemoteDaemonProtocol;
...
@interface IMChatRegistry : NSObject <NSFastEnumeration, TUConversationManagerDelegate>

 {
    ...
    CGFloat _timerStartTimeInterval;
...
@property (readonly, nonatomic) BOOL _isLoading; // ivar: _loading
...
@property (readonly, nonatomic) NSMutableArray *cachedChats; // ivar: _cachedChats
...
@property (retain, nonatomic) NSDictionary *chatIdToLastMessageItemMap; // ivar: _chatIdToLastMessageItemMap
...
@property (readonly, nonatomic) NSObject<IMRemoteDaemonProtocol> *remoteDaemon;
...
-(id)existingChatForEngramID:(id)arg0 ;
...
-(id)existingConversationForTUConversationUUID:(id)arg0 ;
...
-(void)_chat_loadHistory:(id)arg0 limit:(NSUInteger)arg1 beforeGUID:(id)arg2 afterGUID:(id)arg3 threadIdentifier:(id)arg4 queryID:(id)arg5 ;
-(void)_chat_loadHistory:(id)arg0 limit:(NSUInteger)arg1 beforeGUID:(id)arg2 afterGUID:(id)arg3 threadIdentifier:(id)arg4 queryID:(id)arg5 loadImmediately:(BOOL)arg6 ;
-(void)_chat_loadPagedHistory:(id)arg0 numberOfMessagesBefore:(NSUInteger)arg1 numberOfMessagesAfter:(NSUInteger)arg2 messageGUID:(id)arg3 threadIdentifier:(id)arg4 queryID:(id)arg5 ;
...
-(void)_participantsUpdated:(id)arg0 ;
...
-(void)_removeChatIdFromChatIdToLastMessageItemMap:(id)arg0 ;
...
-(void)frequentRepliesQuery:(id)arg0 chatID:(id)arg1 services:(id)arg2 finishedWithResult:(id)arg3 limit:(NSUInteger)arg4 ;
-(void)frequentRepliesQuery:(id)arg0 finishedWithResult:(id)arg1 limit:(NSUInteger)arg2 ;
...
-(void)historyQuery:(id)arg0 chatID:(id)arg1 services:(id)arg2 finishedWithResult:(id)arg3 limit:(NSUInteger)arg4 ;
...
-(void)lastMessageForAllChats:(id)arg0 ;
-(void)lastMessageForChats:(id)arg0 ;
...
-(void)pagedHistoryQuery:(id)arg0 chatID:(id)arg1 services:(id)arg2 numberOfMessagesBefore:(NSUInteger)arg3 numberOfMessagesAfter:(NSUInteger)arg4 finishedWithResult:(id)arg5 hasMessagesBefore:(BOOL)arg6 hasMessagesAfter:(BOOL)arg7 ;
