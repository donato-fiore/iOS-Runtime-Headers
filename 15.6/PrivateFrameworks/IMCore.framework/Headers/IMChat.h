...
-(BOOL)_handleIncomingItem:(id)arg0 updateRecipient:(BOOL)arg1 updateReplyCounts:(BOOL)arg2 ;
...
-(void)_postIMChatItemsDidChangeNotificationWithInserted:(id)arg0 removed:(id)arg1 reload:(id)arg2 regenerate:(id)arg3 oldChatItems:(id)arg4 newChatItems:(id)arg5 shouldLog:(BOOL)arg6 ;
