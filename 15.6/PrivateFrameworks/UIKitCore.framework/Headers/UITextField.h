...
-(CGFloat)_clearButtonPadX;
-(CGFloat)_fieldEditorHeight;
-(CGFloat)_firstBaselineOffsetFromTop;
-(CGFloat)_foregroundViewsAlpha;
...
-(CGFloat)_preferredBackgroundCornerRadius;
-(CGFloat)_roundedRectBackgroundCornerRadius;
...
-(void)_setForcesClearButtonHighContrastAppearance:(BOOL)arg0 ;
...
-(void)_setOverridePasscodeStyle:(BOOL)arg0 ;
-(void)_setOverridePlaceholder:(id)arg0 alignment:(NSInteger)arg1 ;
-(void)_setPadding:(struct UIEdgeInsets )arg0 ;
-(void)_setPasscodeStyleAlpha:(CGFloat)arg0 ;
-(void)_setPrefix:(id)arg0 ;
-(void)_setRoundedRectBackgroundCornerRadius:(CGFloat)arg0 ;
-(void)_setShouldDisplayDictationPlaceholderMessage:(BOOL)arg0 ;
-(void)_setSuffix:(id)arg0 withColor:(id)arg1 ;
-(void)_setSupportsKeyboardNavigationForSuggestions:(BOOL)arg0 ;
...
-(void)setClearingBehavior:(NSInteger)arg0 ;
-(void)setClearsPlaceholderOnBeginEditing:(BOOL)arg0 ;
...
-(void)setRecentsAccessoryView:(id)arg0 ;
