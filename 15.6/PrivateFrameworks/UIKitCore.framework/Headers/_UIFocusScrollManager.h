...
-(void)_ensureFocusItemIsOnscreen:(id)arg0 inEnvironmentScrollableContainer:(id)arg1 ;
-(void)_scrollToFocusItemWithInfo:(id)arg0 offset:(struct CGPoint )arg1 inEnvironmentScrollableContainer:(id)arg2 ;
