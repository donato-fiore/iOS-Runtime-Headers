...
@protocol UIDocumentBrowserViewControllerPrivateDelegate, _UIRemoteViewControllerContaining, UIDocumentPickerDelegate;
...
-(void)_commonInitWithDocumentTypes:(id)arg0 ;
