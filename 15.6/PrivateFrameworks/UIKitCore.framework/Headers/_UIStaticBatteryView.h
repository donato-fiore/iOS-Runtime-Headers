...
+(id)_batteryBodyImageWithSize:(struct CGSize )arg0 forScale:(CGFloat)arg1 batteryRect:(struct CGRect )arg2 cornerRadius:(CGFloat)arg3 lineWidth:(CGFloat)arg4 ;
...
+(id)_imageWithRenderedBezierPath:(id)arg0 size:(struct CGSize )arg1 scale:(CGFloat)arg2 pathScaleFactor:(CGFloat)arg3 stroke:(BOOL)arg4 ;
