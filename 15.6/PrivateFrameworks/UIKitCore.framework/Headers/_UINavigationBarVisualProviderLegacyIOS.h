...
-(BOOL)_performCanvasViewTransitionFromItem:(id)arg0 toItem:(id)arg1 ;
-(BOOL)_prepareTransitionFromItem:(id)arg0 toItem:(id)arg1 ;
-(BOOL)_shim_34415965;
...
-(struct CGRect )_frameForCanvasView:(id)arg0 inBounds:(struct CGRect )arg1 ;
...
-(void)_completeTransitionFromCanvasView:(id)arg0 toCanvasView:(id)arg1 updateSize:(BOOL)arg2 transitionAssistant:(id)arg3 ;
