...
@property (readonly, retain, nonatomic) NSValue *currentTouchPoint; // ivar: _currentTouchPoint
...
@property (readonly, retain, nonatomic) NSUUID *touchUUID; // ivar: _touchUUID
