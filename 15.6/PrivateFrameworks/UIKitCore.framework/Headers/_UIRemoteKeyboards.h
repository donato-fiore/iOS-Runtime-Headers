...
@class NSHashTable, FBSScene, NSMutableArray, NSMutableSet, NSMapTable, NSXPCConnection, NSArray, NSString;
@protocol _UIRemoteKeyboardDistributedViewSource, _UIKeyboardArbitrationClient, _UIRemoteKeyboardControllerDelegate, _UIRemoteKeyboardsEventObserverDelegate, _UIAssertionControllerSubject, _UIKeyboardArbitration;
...
@property (readonly) BOOL handlingRemoteEvent; // ivar: _handlingRemoteEvent
@property (readonly) NSUInteger hash;
@property (readonly) NSUInteger hash;
@property (readonly) CGFloat iavHeight;
...
@property (readonly, nonatomic) NSInteger lastEventSource; // ivar: _lastEventSource
