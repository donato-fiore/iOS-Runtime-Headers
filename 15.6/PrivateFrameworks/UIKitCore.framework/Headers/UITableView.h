...
-(BOOL)_shouldDrawSeparatorAtBottomOfSection:(NSInteger)arg0 ;
...
-(void)_selectRowAtIndexPath:(id)arg0 animated:(BOOL)arg1 scrollPosition:(NSInteger)arg2 notifyDelegate:(BOOL)arg3 isCellMultiSelect:(BOOL)arg4 deselectPrevious:(BOOL)arg5 ;
