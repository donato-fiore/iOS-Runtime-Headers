...
@protocol UIGestureRecognizerDelegate, _UIViewInternalDraggingSourceDelegate, _UIDragInteractionDriverDelegate, UIInteraction, UIDragInteractionDelegate, _UIDragInteractionDriving, UIDragInteractionEffect, _UIDragInteractionPresentationDelegate;
...
@property (retain, nonatomic, getter=_initiationDriver, setter=_setInitiationDriver:) NSObject<_UIDragInteractionDriving> *initiationDriver; // ivar: _initiationDriver
...
@property (retain, nonatomic, getter=_pointerInitiationDriver, setter=_setPointerInitiationDriver:) NSObject<_UIDragInteractionDriving> *pointerInitiationDriver; // ivar: _pointerInitiationDriver
...
-(BOOL)_addItemsWithTouchPoint:(struct CGPoint )arg0 ;
-(BOOL)_beginLiftForItems:(id)arg0 session:(id)arg1 animated:(BOOL)arg2 ;
-(BOOL)_canDragFromView:(id)arg0 ;
-(BOOL)_prepareForLiftAtPoint:(struct CGPoint )arg0 invocationType:(NSInteger)arg1 completion:(id)arg2 ;
-(BOOL)_queryDelegate:(id)arg0 forItemsForAddingToSession:(id)arg1 atPoint:(struct CGPoint )arg2 completion:(id)arg3 ;
...
-(void)_accessibilityPrepareForDragAtPoint:(struct CGPoint )arg0 completion:(id)arg1 ;
