...
-(BOOL)_shouldHideBottomSeparatorAtIndexPath:(id)arg0 forGrouping:(NSUInteger)arg1 interactionState:(id)arg2 ;
...
-(id)_invalidationContextForBackgroundChangeAtIndexPath:(id)arg0 interactionState:(id)arg1 ;
-(id)_leadingSwipeActionsConfigurationForIndexPath:(id)arg0 ;
-(id)_preferredContainerBackgroundColor;
-(id)_separatorConfigurationForItemAtIndexPath:(id)arg0 withSelectionGrouping:(NSUInteger)arg1 interactionState:(id)arg2 ;
