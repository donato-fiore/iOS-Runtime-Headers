...
+(id)interactableAttachment:(id)arg0 range:(struct _NSRange )arg1 inTextItemInteractingView:(id)arg2 atLocation:(struct CGPoint )arg3 ;
+(id)interactableLink:(id)arg0 range:(struct _NSRange )arg1 inTextItemInteractingView:(id)arg2 atLocation:(struct CGPoint )arg3 ;
