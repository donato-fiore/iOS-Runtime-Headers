...
@property (readonly, nonatomic, getter=_lastTouchCount) NSInteger lastTouchCount;
...
-(CGFloat)_allowableTouchTimeSeparation;
-(CGFloat)_hysteresis;
-(CGFloat)_translationDistanceInSceneInSelfAxis:(struct CGPoint )arg0 ;
...
-(struct CGPoint )_shiftPanLocationToNewSceneReferenceLocation:(struct CGPoint )arg0 lockingToAxis:(NSUInteger)arg1 ;
...
-(void)_ignoreTouches:(id)arg0 forEvent:(id)arg1 ;
-(void)_processScrollPhaseChanged:(id)arg0 ;
-(void)_processTouchesMoved:(id)arg0 withEvent:(id)arg1 ;
...
-(void)_updateDigitizerLocationWithEvent:(id)arg0 ;
