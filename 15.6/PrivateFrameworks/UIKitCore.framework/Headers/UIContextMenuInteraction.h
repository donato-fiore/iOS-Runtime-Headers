...
@protocol _UIClickPresentationInteractionDelegateInternal, _UIContextMenuPresentationControllerDelegate, _UIContextMenuPresentationAnimationDelegate, UIDeferredMenuElementDelegate, _UIWindowSceneActivator_Internal, UIInteraction, UIContextMenuInteractionDelegate;
...
-(BOOL)_contextMenuPresentationControllerShouldHandlePreviewAction:(id)arg0 ;
...
-(id)_accessoryViewsForContextMenuPresentationController:(id)arg0 ;
-(id)_clickPresentationInteraction:(id)arg0 interactionEffectForTargetedPreview:(id)arg1 ;
-(id)_clickPresentationInteraction:(id)arg0 liveDragPreviewForPresentation:(id)arg1 ;
...
-(id)_menuPreparedForDisplayWithMenu:(id)arg0 ;
-(id)_overrideTargetedPreviewForCompactStyle:(id)arg0 ;
-(id)_proxySender;
...
-(id)actualPlatterContainerViewForPresentationController:(id)arg0 ;
...
-(void)_interactionShouldBeginAtLocation:(struct CGPoint )arg0 completion:(id)arg1 ;
