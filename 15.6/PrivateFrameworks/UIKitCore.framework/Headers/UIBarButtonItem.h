...
@protocol UIMenuForcedAutomaticSelectionDelegate, NSCoding, _UIBarButtonItemViewOwner;
...
@property (nonatomic, setter=_setHidden:) BOOL _hidden; // ivar: __hidden
...
@property (retain, nonatomic, setter=_setPopoverLayoutGuide:) UILayoutGuide *_popoverLayoutGuide; // ivar: __popoverLayoutGuide
