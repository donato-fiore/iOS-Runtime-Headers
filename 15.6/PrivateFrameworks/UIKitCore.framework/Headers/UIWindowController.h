...
-(void)dealloc;
-(void)transition:(int)arg0 fromViewController:(id)arg1 toViewController:(id)arg2 target:(id)arg3 didEndSelector:(SEL)arg4 ;
-(void)transition:(int)arg0 fromViewController:(id)arg1 toViewController:(id)arg2 target:(id)arg3 didEndSelector:(SEL)arg4 animation:(id)arg5 ;
