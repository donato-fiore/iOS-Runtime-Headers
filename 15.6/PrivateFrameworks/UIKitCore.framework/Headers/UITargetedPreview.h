...
@property (copy, nonatomic) NSObject<NSCopying><NSObject> *internalIdentifer; // ivar: _internalIdentifer
...
-(void)dealloc;
-(void)platterAnimator_getBounds:(struct CGRect *)arg0 center:(struct CGPoint *)arg1 transform:(struct CGAffineTransform *)arg2 forContainer:(id)arg3 ;
