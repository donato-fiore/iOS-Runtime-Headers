...
#ifndef _UIKEYSHORTCUTHUDMETRICS_H
#define _UIKEYSHORTCUTHUDMETRICS_H
...
@property (readonly, nonatomic) CGFloat cellCornerRadius;
...
@property (readonly, nonatomic) CGFloat platterCornerRadius;
...
@property (retain, nonatomic) UIEvent *triggeringEvent; // ivar: _triggeringEvent
@property (readonly, nonatomic) CGFloat widestToolbarCategoryCellWidth; // ivar: _widestToolbarCategoryCellWidth
@property (nonatomic) CGFloat windowSceneHeight; // ivar: _windowSceneHeight


+(id)metricsForHUDWindow:(id)arg0 triggeringEvent:(id)arg1 ;
-(CGFloat)_computedWidthForCategoryAtIndex:(NSUInteger)arg0 ;
-(CGFloat)_contentSizeScaledMetric:(CGFloat)arg0 ;
