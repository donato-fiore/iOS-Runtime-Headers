...
@class UIActivityViewController, UIViewController<UIPrintAppExtensionProtocol>, NSString, NSArray, NSURL, NSLayoutConstraint;
...
@property (retain, nonatomic) UINavigationController *printOptionsNavController; // ivar: _printOptionsNavController
...
@property (retain, nonatomic) UIPrinter *printer; // ivar: _printer
...
-(void)addPrintButtonToNavItem:(id)arg0 ;
-(void)addPrintLongPressGestureToNavItem:(id)arg0 ;
...
-(void)printButtonLongPress:(id)arg0 ;
