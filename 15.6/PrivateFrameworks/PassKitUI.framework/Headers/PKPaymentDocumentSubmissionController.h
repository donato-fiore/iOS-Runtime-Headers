...
@class UIImage, UIViewController<PKPaymentDocumentSubmissionControllerDelegate>, NSBundle, PKDocumentRequest;
...
-(id)initWithSetupDelegate:(id)arg0 context:(NSInteger)arg1 acceptableDocuments:(id)arg2 featureIdentifier:(NSUInteger)arg3 localizationBundle:(id)arg4 ;
