...
-(BOOL)_shouldShowAutomaticSelectionForPass:(id)arg0 ;
...
-(void)_handlePassSuccessfullyAdded:(id)arg0 ;
...
-(void)_showAutomaticSelectionForPass:(id)arg0 ;
...
-(void)handlePassSuccessfullyAdded:(id)arg0 completionHandler:(id)arg1 ;
