...
#ifndef PKSPENDINGSUMMARYFOOTERVIEW_H
#define PKSPENDINGSUMMARYFOOTERVIEW_H

@class UIView, UIColor, UIImage, NSString, UILabel;
@protocol PKHorizontalScrollingFooterViewComparator, PKSpendingSummaryFooterViewDelegate;
...
@property (weak, nonatomic) NSObject<PKSpendingSummaryFooterViewDelegate> *delegate; // ivar: _delegate
