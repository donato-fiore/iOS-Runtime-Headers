...
@class PKGroup, PKSecureElement, PKGroupsController, UIView, PKPass, UIPanGestureRecognizer, _UIDynamicValueAnimation, UIButton, NSString;
...
-(void)presentAddMoney;
-(void)presentBalanceDetailsWithCompletion:(id)arg0 ;
-(void)presentCardNumbers;
-(void)presentDailyCashForDateComponents:(id)arg0 completion:(id)arg1 ;
