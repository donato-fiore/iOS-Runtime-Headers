...
@class PKPaymentWebService, NSMutableArray, PKPaymentService, NSArray, NSMutableSet, NSString, NSSet, DIVerificationSession, PKAssertion, PKODIServiceProviderAssessment, PKAccount, NSURL, PKFamilyMember, PKFeatureApplication, PKPaymentInstallmentConfiguration, PKPaymentProvisioningController;
...
@interface PKApplyController : NSObject <PKSetupFlowControllerProtocol, PKPaymentServiceDelegate>

 {
    ...
    PKODIServiceProviderAssessment *_currentSubmitApplicationODISession;
...
-(void)_generateODIAssessmentForApplyWithCompletion:(id)arg0 ;
-(void)_generateODIAssessmentForCreateWithCompletion:(id)arg0 ;
