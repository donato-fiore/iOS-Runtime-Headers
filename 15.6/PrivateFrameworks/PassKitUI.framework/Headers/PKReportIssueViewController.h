...
-(id)initWithTransaction:(id)arg0 transactionSourceCollection:(id)arg1 paymentPass:(id)arg2 familyCollection:(id)arg3 account:(id)arg4 accountUserCollection:(id)arg5 physicalCards:(id)arg6 detailViewStyle:(NSInteger)arg7 ;
