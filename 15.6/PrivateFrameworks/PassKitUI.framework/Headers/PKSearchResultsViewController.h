...
@class UICollectionViewController, PKFamilyMemberCollection, PKSearchService, PKAccountService, PKPassLibrary, NSDictionary, PKTransactionSourceCollection, NSString, NSMutableOrderedSet, PKSearchQuery, PKSearchResults, NSMutableDictionary, NSArray, UILabel;
