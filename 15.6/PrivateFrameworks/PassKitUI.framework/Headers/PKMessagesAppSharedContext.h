...
@class NSPointerArray, NSMutableArray, PKPaymentDefaultDataProvider, PKTransactionSource, NSMutableDictionary, NSArray, NSString, PKPeerPaymentMessagesAppViewController;
...
@property (readonly, weak, nonatomic) PKPeerPaymentMessagesAppViewController *primaryAppController; // ivar: _primaryAppController
...
-(id)externalizedControllerStateForMessage:(id)arg0 ;
-(id)init;
...
-(void)persistExternalizedControllerState:(id)arg0 forMessage:(id)arg1 ;
-(void)removeExternalizedControllerStateDataForMessage:(id)arg0 ;
-(void)revealPrimaryAppController:(id)arg0 ;
