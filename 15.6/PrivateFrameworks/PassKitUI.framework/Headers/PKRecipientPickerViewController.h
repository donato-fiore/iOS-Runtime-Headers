...
-(id)initWithTransactionSourceCollection:(id)arg0 PeerPaymentActionType:(NSInteger)arg1 ;
...
-(void)_showAlertForInvalidRecipient:(id)arg0 ;
...
-(void)_updateRecipientTextView;
-(void)_validateContactWithCompletion:(id)arg0 ;
