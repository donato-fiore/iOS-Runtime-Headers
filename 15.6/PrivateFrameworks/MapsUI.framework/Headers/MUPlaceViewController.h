...
-(BOOL)shouldMoveMuninStorefrontViewForPlacePhotoSectionController:(id)arg0 ;
...
-(void)instrumentHeaderButtonsAction:(int)arg0 withFeedbackType:(int)arg1 ;
...
-(void)quickLinkMenuElementCoordinator:(id)arg0 didSelectAppClip:(id)arg1 ;
