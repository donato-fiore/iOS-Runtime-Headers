...
@protocol NSURLSessionDelegate, NSURLSessionTaskDelegate, NSURLSessionDataDelegate, NSURLSessionDelegate><AMSURLProtocolDelegate, AMSURLHandling, AMSRequestEncoding, AMSResponseDecoding;
