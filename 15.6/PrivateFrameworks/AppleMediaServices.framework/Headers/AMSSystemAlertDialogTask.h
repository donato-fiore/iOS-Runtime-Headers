...
-(?)_createNoteDictionaryWithKeys:(?)arg0 buttonActionsoutOptions;
-(NSInteger)_defaultButtonIndexForActions:(id)arg0 ;
-(NSInteger)_keyboardTypeFor:(NSInteger)arg0 ;
-(id)_handleResponseForNote:(struct __CFUserNotification *)arg0 buttonActions:(id)arg1 keys:(struct ButtonKey *)arg2 ;
