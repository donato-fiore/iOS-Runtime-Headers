...
-(id)initWithString:(id)arg0 attributes:(struct __CFDictionary *)arg1 size:(struct CGSize )arg2 numberOfLines:(unsigned char)arg3 textAlignment:(unsigned char)arg4 ;
-(void)dealloc;
