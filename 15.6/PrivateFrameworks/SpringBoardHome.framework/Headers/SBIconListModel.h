...
@protocol SBIconIndexMutableListObserver, SBIconListModelObserver, SBTreeNode, SBIconIndexNode, NSFastEnumeration, SBIconListModelDelegate;
...
+(id)iconGridCellInfoForIcons:(id)arg0 gridSize:(struct SBHIconGridSize )arg1 cellClusterSize:(struct SBHIconGridSize )arg2 cellClusterReferenceGridSize:(struct SBHIconGridSize )arg3 gridSizeClassSizes:(struct SBHIconGridSizeClassSizes )arg4 iconLayoutBehavior:(NSUInteger)arg5 options:(NSUInteger)arg6 ;
...
+(void)layOutIcons:(id)arg0 atIndexes:(id)arg1 inGridCellInfo:(id)arg2 startingAtGridCellIndex:(NSUInteger)arg3 gridSize:(struct SBHIconGridSize )arg4 gridSizeClassSizes:(struct SBHIconGridSizeClassSizes )arg5 iconLayoutBehavior:(NSUInteger)arg6 referenceIconOrder:(id)arg7 options:(NSUInteger)arg8 numberOfUsedRows:(*NSUInteger)arg9 numberOfUsedColumns:(*NSUInteger)arg10 ;
...
-(id)gridCellInfoForGridSize:(struct SBHIconGridSize )arg0 cellClusterSize:(struct SBHIconGridSize )arg1 cellClusterReferenceGridSize:(struct SBHIconGridSize )arg2 options:(NSUInteger)arg3 ;
...
-(id)insertIcon:(id)arg0 afterIcon:(id)arg1 options:(NSUInteger)arg2 ;
...
-(id)insertIcon:(id)arg0 beforeIcon:(id)arg1 options:(NSUInteger)arg2 ;
-(id)insertIcon:(id)arg0 relativeToIcon:(id)arg1 positionDelta:(NSInteger)arg2 options:(NSUInteger)arg3 ;
