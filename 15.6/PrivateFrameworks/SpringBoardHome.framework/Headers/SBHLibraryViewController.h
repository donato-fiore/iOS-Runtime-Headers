...
@class NSArray, NSMapTable, NSTimer, NSHashTable, UIViewController, NSMutableArray, NSString, UIView, _UILegibilitySettings, NSSet, BSEventQueue;
@protocol UISearchBarDelegate, SBHLibrarySearchControllerDelegate, SBHLibraryCategoryMapProviderObserver, SBHIconLibraryTableViewControllerObserver, SBIconViewProviding, SBIconViewDelegate, SBNestingViewControllerDelegate, SBHLibraryPodFolderControllerDelegate, SBFolderControllerDelegate, SBHLibraryProvider, SBFOverlayObserving, SBHVisibleContentPresenter, BSInvalidatable, SBHomeScreenIconTransitionAnimatorDelegate, SBIconListLayoutProvider;
