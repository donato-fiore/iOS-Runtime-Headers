...
+(id)composedShortcutsForDownloadingApplicationWithBundleIdentifier:(id)arg0 iconDisplayName:(id)arg1 prioritizationIsAvailable:(BOOL)arg2 downloadingInformationAgent:(id)arg3 iconManagerAllowsEditing:(BOOL)arg4 removeStyle:(NSInteger)arg5 canShare:(BOOL)arg6 ;
