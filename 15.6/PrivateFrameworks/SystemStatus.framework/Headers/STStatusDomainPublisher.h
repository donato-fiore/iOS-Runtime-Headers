...
@class NSString;
@protocol STStatusDomainPublisherClientHandle, STStatusDomainData, STStatusDomainPublisherServerHandle;
...
@property (readonly, nonatomic) NSObject<STStatusDomainPublisherServerHandle> *serverHandle; // ivar: _serverHandle
...
// -(void)_updateDataWithBlock:(id)arg0 completion:(unk)arg1  ;
// -(void)_updateVolatileDataWithBlock:(id)arg0 completion:(unk)arg1  ;
-(void)dealloc;
