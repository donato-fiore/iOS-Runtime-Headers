...
@class NSString, CATOperationQueue, MDMDServer;
...
@property (weak, nonatomic) MDMDServer *server; // ivar: _server
...
-(BOOL)_validateSetting:(id)arg0 accessRights:(int)arg1 outError:(*id)arg2 ;
...
-(id)_deviceInformationWithRequest:(id)arg0 accessRights:(int)arg1 ;
...
-(id)_installProfile:(id)arg0 accessRights:(int)arg1 installationType:(NSInteger)arg2 ;
...
-(id)_settings:(id)arg0 accessRights:(int)arg1 ;
...
-(void)_checkBackupManagers:(id)arg0 withCompletion:(id)arg1 ;
...
-(void)_installApplicationAfterRestoreCheck:(id)arg0 assertion:(id)arg1 completionBlock:(id)arg2 ;
...
-(void)_isCloudBackupInProgressWithCompletion:(id)arg0 ;
...
-(void)_processRequest:(id)arg0 accessRights:(int)arg1 assertion:(id)arg2 completionBlock:(id)arg3 ;
...
-(void)processRequest:(id)arg0 accessRights:(int)arg1 assertion:(id)arg2 completionBlock:(id)arg3 ;
