...
-(BOOL)isCustomLook;
-(BOOL)needToCreateForwardstopFor2018DeploymentVariant:(id)arg0 ;
-(BOOL)needToCreateForwardstopFor2019DeploymentVariant:(id)arg0 ;
...
-(void)createForwardstops:(id)arg0 ;
