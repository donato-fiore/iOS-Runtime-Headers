...
-(BOOL)canAppWithDataOwnerState:(NSUInteger)arg0 performAction:(NSUInteger)arg1 item:(id)arg2 ;
...
-(BOOL)canHostAppPerformAction:(NSUInteger)arg0 targetItem:(id)arg1 ;
