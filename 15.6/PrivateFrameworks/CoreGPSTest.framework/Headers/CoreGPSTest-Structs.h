...
typedef struct Options {
    ...
    int uartBaudRate;
    int dataSnifferEnabled;
    int xmlFile;
    int testJob;
    BOOL field38;
    basic_string<char, std::char_traits<char>, std::allocator<char>> field39;
    basic_string<char, std::char_traits<char>, std::allocator<char>> field40;
} Options;
