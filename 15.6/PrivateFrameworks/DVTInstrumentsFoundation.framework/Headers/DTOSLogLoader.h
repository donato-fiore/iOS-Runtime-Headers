...
@class XRMobileAgentQueueStop, OSLogEventStreamBase, OSLogEventStore, OSLogEventLiveStore, OSLogEventLiveStream, NSDate, NSArray, XRMobileAgent<DTOSLogLoaderVisitor>, NSMutableData, XRIntKeyedDictionary, NSMutableDictionary, NSMutableArray, NSError, NSPredicate;
