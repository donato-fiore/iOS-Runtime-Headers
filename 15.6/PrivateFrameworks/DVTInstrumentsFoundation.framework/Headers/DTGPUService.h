...
-(id)_constructMessagePayload:(*NSUInteger)arg0 sampleCount:(NSUInteger)arg1 length:(NSUInteger)arg2 dataSource:(id)arg3 sampleType:(NSUInteger)arg4 ringBufferIndex:(unsigned int)arg5 ;
...
-(void)readyToSendData:(*NSUInteger)arg0 sampleCount:(NSUInteger)arg1 length:(NSUInteger)arg2 dataSource:(id)arg3 sampleType:(NSUInteger)arg4 ringBufferIndex:(unsigned int)arg5 ;
