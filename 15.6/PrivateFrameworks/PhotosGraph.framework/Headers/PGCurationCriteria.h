...
@property (retain, nonatomic) PGCurationIndexSetTrait *compulsoryScenesTrait; // ivar: _compulsoryScenesTrait
...
@property (retain, nonatomic) PGCurationIndexSetTrait *scenesTrait; // ivar: _scenesTrait
...
-(CGFloat)_scoreForSceneClassifications:(id)arg0 withScenesTrait:(id)arg1 traitFailed:(*BOOL)arg2 ;
