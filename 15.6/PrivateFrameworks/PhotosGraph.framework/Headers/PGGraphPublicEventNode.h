...
-(void)enumerateCategoryEdgesAndNodesUsingBlock:(id)arg0 ;
-(void)enumerateCategoryNodesUsingBlock:(id)arg0 ;
-(void)enumerateLocalizedSubcategoryEdgesAndNodesUsingBlock:(id)arg0 ;
