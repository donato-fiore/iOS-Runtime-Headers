...
+(id)_buildSpecCollectionForMeaningLabel:(id)arg0 withSpecDefinition:(id)arg1 features:(id)arg2 ;
+(id)_featureTypesFromFeatureKey:(id)arg0 ;
...
+(id)specCollectionForMeaningLabel:(id)arg0 features:(id)arg1 ;
