...
+(id)representativeAssetsForAssetCollection:(id)arg0 progressBlock:(id)arg1 ;
+(id)representativeAssetsForAssets:(id)arg0 progressBlock:(id)arg1 ;
+(id)sceneInfoWithAsset:(id)arg0 ;
+(id)summaryClusteringForDuration:(NSUInteger)arg0 andPrecision:(NSUInteger)arg1 ;
-(BOOL)isAssetCollectionInteresting:(id)arg0 precision:(NSUInteger)arg1 ;
-(BOOL)isAssetFeederInteresting:(id)arg0 withAlternateJunking:(BOOL)arg1 precision:(NSUInteger)arg2 ;
-(CGFloat)contentScoreForAssetCollection:(id)arg0 precision:(NSUInteger)arg1 ;
-(CGFloat)contentScoreForAssetFeeder:(id)arg0 precision:(NSUInteger)arg1 ;
-(NSUInteger)optimalDurationForAssetCollection:(id)arg0 duration:(NSUInteger)arg1 precision:(NSUInteger)arg2 options:(id)arg3 ;
...
-(id)curatedAssetsForAssetCollection:(id)arg0 duration:(NSUInteger)arg1 precision:(NSUInteger)arg2 referencePersonLocalIdentifiers:(id)arg3 progressBlock:(id)arg4 ;
-(id)curatedAssetsForAssetCollection:(id)arg0 options:(id)arg1 progressBlock:(id)arg2 ;
-(id)curatedAssetsForPersonLocalIdentifier:(id)arg0 progressBlock:(id)arg1 ;
-(id)curatedKeyAssetForAssetCollection:(id)arg0 curatedAssetCollection:(id)arg1 options:(id)arg2 criteria:(id)arg3 ;
...
-(id)dejunkAndDedupeAssetsInAssetCollection:(id)arg0 options:(id)arg1 progressBlock:(id)arg2 ;
