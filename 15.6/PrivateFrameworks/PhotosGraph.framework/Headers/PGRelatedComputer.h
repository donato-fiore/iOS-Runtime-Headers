...
-(id)_relatedCollectionsForDefaultAssetCollection:(id)arg0 relatedType:(NSUInteger)arg1 options:(id)arg2 assetCollectionForKeywords:(id)arg3 error:(*id)arg4 ;
-(id)_relatedCollectionsForMemoryTripOrWeekend:(id)arg0 relatedType:(NSUInteger)arg1 options:(id)arg2 assetCollectionForKeywords:(id)arg3 error:(*id)arg4 ;
-(id)_stringFromRelatedType:(NSUInteger)arg0 ;
-(id)_tripsForTargetDomain:(unsigned short)arg0 inGraph:(id)arg1 ;
-(id)_upNextCollectionsForAssetCollection:(id)arg0 options:(id)arg1 error:(*id)arg2 ;
...
-(id)relatedCollectionBetweenAssetCollection:(id)arg0 andAssetCollection:(id)arg1 relatedType:(NSUInteger)arg2 needsDebugInfo:(BOOL)arg3 ;
-(id)relatedCollectionsForAsset:(id)arg0 relatedType:(NSUInteger)arg1 options:(id)arg2 error:(*id)arg3 ;
-(id)relatedCollectionsForAssetCollection:(id)arg0 relatedType:(NSUInteger)arg1 options:(id)arg2 error:(*id)arg3 ;
-(id)relatedCollectionsForDefaultAssetCollection:(id)arg0 relatedType:(NSUInteger)arg1 options:(id)arg2 error:(*id)arg3 ;
...
-(id)relatedCollectionsForMemoryTripOrWeekend:(id)arg0 relatedType:(NSUInteger)arg1 options:(id)arg2 error:(*id)arg3 ;
