...
@class CLSClueCollection, NSNumber, CLSCurationContext, NSString, CLSInvestigationPhotoKitFeeder, NSDate, NSArray;
...
@property (retain, nonatomic) NSArray *sensitiveLocationBlocklist; // ivar: _sensitiveLocationBlocklist
...
-(BOOL)location:(id)arg0 isSensitiveDuringDateInterval:(id)arg1 ;
-(BOOL)momentDateInterval:(id)arg0 intersectsSensitiveDateIntervals:(id)arg1 ;
-(id)initMomentContainerWithFeeder:(id)arg0 clueCollection:(id)arg1 curationManager:(id)arg2 topTierAestheticScore:(CGFloat)arg3 curationContext:(id)arg4 sensitiveLocationBlocklist:(id)arg5 ;
