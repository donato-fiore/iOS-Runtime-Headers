...
-(id)initWithType:(unsigned short)arg0 subtype:(unsigned short)arg1 enrichableEvent:(id)arg2 sharingSuggestionResults:(id)arg3 photoLibrary:(id)arg4 curationManager:(id)arg5 loggingConnection:(id)arg6 titleGenerationContext:(id)arg7 ;
