...
-(float)weight;
-(id)edgeDescription;
-(id)initFromMomentNode:(id)arg0 toAddressNode:(id)arg1 weight:(float)arg2 universalStartDate:(id)arg3 universalEndDate:(id)arg4 photoCoordinate:(struct CLLocationCoordinate2D )arg5 numberOfAssets:(NSUInteger)arg6 ;
