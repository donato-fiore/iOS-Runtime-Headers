...
@class MAGraph, NSRecursiveLock, NSDictionary, NSDateFormatter, NSSet;
...
+(id)blocklistSceneLabelsForHobbyType:(NSInteger)arg0 ;
...
+(id)homeOwnerPersonNodesForHobbyWithMomentNode:(id)arg0 ;
...
+(id)sceneLabelsForHobbyType:(NSInteger)arg0 ;
...
-(id)hobbiesForType:(NSInteger)arg0 ;
-(id)inferredMeNode;
