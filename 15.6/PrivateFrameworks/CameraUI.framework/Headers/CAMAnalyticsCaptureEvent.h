...
-(id)_zoomRangeStringForZoomFactor:(float)arg0 devicePosition:(NSInteger)arg1 ;
-(id)eventName;
...
-(void)populateDesiredMacroMode:(NSInteger)arg0 isMacroCapture:(BOOL)arg1 ;
...
-(void)populatePortraitStatus:(NSInteger)arg0 lightingEffectIntensity:(CGFloat)arg1 apertureValue:(CGFloat)arg2 ;
