...
-(id)_commandForConfiguration:(id)arg0 outRequestID:(*int)arg1 ;
...
-(id)initWithCaptureConfiguration:(id)arg0 engineOptions:(NSInteger)arg1 locationController:(id)arg2 motionController:(id)arg3 burstController:(id)arg4 protectionController:(id)arg5 powerController:(id)arg6 irisVideoController:(id)arg7 remoteShutterController:(id)arg8 ;
-(int)_uniqueRequestIDForChangeToModeAndDevice;
-(int)applyCaptureConfiguration:(id)arg0 ;
-(int)changeToGraphConfiguration:(id)arg0 minimumExecutionTime:(CGFloat)arg1 ;
...
-(void)startRampToVideoZoomFactor:(CGFloat)arg0 withDuration:(CGFloat)arg1 ;
