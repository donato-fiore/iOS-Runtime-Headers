...
#ifndef CAMCINEMATICDESCRIPTIONOVERLAYVIEW_H
#define CAMCINEMATICDESCRIPTIONOVERLAYVIEW_H



#import "CAMDescriptionOverlayView.h"

@interface CAMCinematicDescriptionOverlayView : CAMDescriptionOverlayView
