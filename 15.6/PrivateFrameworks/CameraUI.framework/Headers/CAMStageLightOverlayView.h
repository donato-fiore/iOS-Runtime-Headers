...
+(CGFloat)_circleDiameterForViewportSize:(struct CGSize )arg0 orientation:(NSInteger)arg1 ;
+(struct CGRect )circleFrameForViewport:(struct CGRect )arg0 orientation:(NSInteger)arg1 bottomContentInset:(CGFloat)arg2 ;
