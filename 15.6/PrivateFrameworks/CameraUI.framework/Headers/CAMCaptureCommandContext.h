...
-(id)_captureEngineDeviceForMode:(NSInteger)arg0 desiredDevice:(NSInteger)arg1 videoConfiguration:(NSInteger)arg2 resolvedDevice:(*NSInteger)arg3 ;
...
-(id)videoDeviceForMode:(NSInteger)arg0 desiredDevice:(NSInteger)arg1 videoConfiguration:(NSInteger)arg2 resolvedDevice:(*NSInteger)arg3 ;
