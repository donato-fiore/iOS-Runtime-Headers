...
@class PSListController, VSAccountStore, AIDAServiceOwnersManager, AAUIProfilePictureStore, CNMonogrammer, EAAccessory, PSSpecifier, NSArray, NSDictionary, UIImage, NSSet, ACAccountStore, DMCAccountSpecifierProvider, CoreTelephonyClient, HFHomeSettingsVisibilityArbitrator, NSString, WFClient, WFWiFiStateMonitor, FLPreferencesController, SBSRemoteAlertHandle, SUIKSearchResultsCollectionViewController, PSKeyboardNavigationSearchController, WSWallpaperSettingsCoordinator;
@protocol AAUISignInControllerDelegate, UISearchResultsUpdating, UISearchBarDelegate, UISearchControllerDelegate, CoreTelephonyClientSubscriberDelegate, SUIKSearchResultsCollectionViewControllerDelegate, DMCAccountSpecifierProviderDelegate, RadiosPreferencesDelegate, DevicePINControllerDelegate, PSTopLevelController, OS_dispatch_queue;
...
@property (retain, nonatomic) NSArray *_vpnBundleControllers; // ivar: __vpnBundleControllers
@property (retain, nonatomic) WFClient *_wifiClient; // ivar: __wifiClient
