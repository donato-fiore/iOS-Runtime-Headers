...
#import "_CDInteractionDataCollectionSession.h"
...
@property (retain, nonatomic) _CDInteractionDataCollectionSession *session; // ivar: _session
@property (readonly, copy, nonatomic) NSString *sessionPath; // ivar: _sessionPath


-(id)initWithStore:(id)arg0 activity:(id)arg1 ;
-(id)initWithStore:(id)arg0 activity:(id)arg1 sessionPath:(id)arg2 collectionDate:(id)arg3 samplingRate:(CGFloat)arg4 maxBatches:(NSUInteger)arg5 daysPerBatch:(NSUInteger)arg6 ;
-(void)_execute;
-(void)cleanup;
-(void)execute;
