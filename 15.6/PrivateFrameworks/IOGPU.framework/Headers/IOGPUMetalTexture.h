...
-(id)initWithBuffer:(id)arg0 descriptor:(id)arg1 sysMemOffset:(NSUInteger)arg2 sysMemRowBytes:(NSUInteger)arg3 vidMemSize:(NSUInteger)arg4 vidMemRowBytes:(NSUInteger)arg5 args:(struct IOGPUNewResourceArgs *)arg6 argsSize:(unsigned int)arg7 ;
-(id)initWithBuffer:(id)arg0 descriptor:(id)arg1 sysMemOffset:(NSUInteger)arg2 sysMemRowBytes:(NSUInteger)arg3 vidMemSize:(NSUInteger)arg4 vidMemRowBytes:(NSUInteger)arg5 args:(struct IOGPUNewResourceArgs *)arg6 argsSize:(unsigned int)arg7 isStrideTexture:(BOOL)arg8 ;
...
-(id)initWithPrimaryBuffer:(id)arg0 heapIndex:(short)arg1 bufferIndex:(short)arg2 bufferOffset:(NSUInteger)arg3 length:(NSUInteger)arg4 descriptor:(id)arg5 sysMemRowBytes:(NSUInteger)arg6 vidMemSize:(NSUInteger)arg7 vidMemRowBytes:(NSUInteger)arg8 args:(struct IOGPUNewResourceArgs *)arg9 argsSize:(unsigned int)arg10 ;
