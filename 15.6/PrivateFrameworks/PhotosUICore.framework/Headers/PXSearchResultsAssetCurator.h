...
+(void)_curationObjectsFromAssets:(id)arg0 scenesMap:(id)arg1 sceneIdentifiers:(id)arg2 sceneTaxonomy:(id)arg3 completion:(id)arg4 ;
+(void)performCurationForAssetResults:(id)arg0 sceneIdentifiers:(id)arg1 searchQuery:(id)arg2 sceneTaxonomy:(id)arg3 completion:(id)arg4 ;
