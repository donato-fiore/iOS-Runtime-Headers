...
+(BOOL)changePeople:(id)arg0 toPersonType:(NSInteger)arg1 error:(*id)arg2 ;
...
+(id)_daysDictionary;
+(id)_manualOrderComparator:(SEL)arg0 ;
...
+(id)changePerson:(id)arg0 toPersonType:(NSInteger)arg1 ;
+(id)comparatorForFetchType:(SEL)arg0 ;
