...
@class UIView, UILabel, UIImpactFeedbackGenerator, UISelectionFeedbackGenerator;
...
@property (readonly, nonatomic) NSObject<CKFullscreenEffectView> *effectView; // ivar: _effectView
