...
@class PHCachingImageManager, NSString, PHPhotoLibrary, NSDictionary, NSArray;
...
@property (retain, nonatomic) NSString *localizedQueryString; // ivar: _localizedQueryString
...
-(void)setSearchResults:(id)arg0 searchAssetResults:(id)arg1 curatedAssetsFetchResult:(id)arg2 reloadItemIdentifiers:(id)arg3 localizedQueryString:(id)arg4 ;
