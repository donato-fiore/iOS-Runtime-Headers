...
@class NSString;
@protocol PXStoryMutableExportConfiguration, PXStoryExportConfigurationActivityDelegate, PXStoryErrorReporter, PXDisplayAsset;
...
@property (weak, nonatomic) NSObject<PXStoryExportConfigurationActivityDelegate> *activityDelegate; // ivar: _activityDelegate
...
@property (retain, nonatomic) NSObject<PXDisplayAsset> *iconAsset; // ivar: _iconAsset
@property (retain, nonatomic) NSString *preferredExportFilename; // ivar: _preferredExportFilename
