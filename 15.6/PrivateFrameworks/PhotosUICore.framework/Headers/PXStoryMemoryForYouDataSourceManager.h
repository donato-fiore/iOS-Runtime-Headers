...
@protocol PXStoryMutableMemoryForYouDataSourceManager, PXChangeObserver, PXSectionedDataSourceManagerObserver, PXMemoryForYouDataSourceManager, OS_dispatch_queue;
...
@property (nonatomic) BOOL queue_forYouMemoriesDataSourceDidChangeDuringInitialization; // ivar: _queue_forYouMemoriesDataSourceDidChangeDuringInitialization
@property (nonatomic) BOOL queue_isInitialized; // ivar: _queue_isInitialized
