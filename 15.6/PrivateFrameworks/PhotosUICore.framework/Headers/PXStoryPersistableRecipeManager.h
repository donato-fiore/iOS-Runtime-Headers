...
@property (readonly, nonatomic) BOOL shouldPassthroughCurrentStyle; // ivar: _shouldPassthroughCurrentStyle
...
+(BOOL)_addCurationChangeList:(id)arg0 toPersistableRecipe:(id)arg1 originalPersistableRecipe:(id)arg2 availableAssets:(id)arg3 userCuration:(BOOL)arg4 error:(*id)arg5 ;
...
-(id)initWithModel:(id)arg0 styleManager:(id)arg1 shouldPassthroughCurrentStyle:(BOOL)arg2 ;
