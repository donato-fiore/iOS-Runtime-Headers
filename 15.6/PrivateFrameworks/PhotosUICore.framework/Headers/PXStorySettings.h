...
@property (nonatomic) BOOL allowsErrorIndicator; // ivar: _allowsErrorIndicator
...
@property (nonatomic) BOOL allowsSongInChromeSubtitle; // ivar: _allowsSongInChromeSubtitle
...
@property (nonatomic) BOOL enableCompactEditSheetStyle; // ivar: _enableCompactEditSheetStyle
@property (nonatomic) BOOL enableCreateMemoryFromCollectionAction; // ivar: _enableCreateMemoryFromCollectionAction
...
@property (nonatomic) NSUInteger fullsizePaperTrailOptions; // ivar: _fullsizePaperTrailOptions
...
@property (nonatomic) BOOL isExportEnabled; // ivar: _isExportEnabled
...
@property (nonatomic) BOOL shouldAlwaysPreserveOriginalPersistedStyle; // ivar: _shouldAlwaysPreserveOriginalPersistedStyle
@property (nonatomic) BOOL shouldCapFeedItemWidth; // ivar: _shouldCapFeedItemWidth
...
@property (nonatomic) BOOL shouldReplaceMemoriesFeed; // ivar: _shouldReplaceMemoriesFeed
@property (nonatomic) BOOL shouldReplaceMemoriesGadget; // ivar: _shouldReplaceMemoriesGadget
@property (nonatomic) BOOL shouldReplaceMemoriesGadgetDataSource; // ivar: _shouldReplaceMemoriesGadgetDataSource
@property (nonatomic) BOOL shouldReplaceMemoryDetailsView; // ivar: _shouldReplaceMemoryDetailsView
...
@property (nonatomic) BOOL wantsCustomEditSheet; // ivar: _wantsCustomEditSheet
@property (nonatomic) BOOL wantsEditSheet; // ivar: _wantsEditSheet
...
@property (nonatomic) BOOL wantsInternalActions; // ivar: _wantsInternalActions
@property (nonatomic) BOOL wantsInternalErrorsAndOptions; // ivar: _wantsInternalErrorsAndOptions
