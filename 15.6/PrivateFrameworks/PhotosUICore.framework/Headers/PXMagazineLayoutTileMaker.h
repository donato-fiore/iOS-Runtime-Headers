...
#ifndef PXMAGAZINELAYOUTTILEMAKER_H
#define PXMAGAZINELAYOUTTILEMAKER_H
...
-(BOOL)_generateTilesWithInputs:(id)arg0 atIndex:(NSUInteger)arg1 forMaxY:(NSUInteger)arg2 reserveNumberForPadding:(NSUInteger)arg3 outArray:(id)arg4 ;
-(BOOL)checkAndPrintResults:(BOOL)arg0 ;
-(CGFloat)_aspectRatioOfInput:(id)arg0 ;
...
-(void)_findNextChunkWithInputs:(id)arg0 fromIndex:(NSUInteger)arg1 outArray:(id)arg2 ;
