...
@class NSMutableSet, NSMutableArray, NSMapTable, AVAudioSession, NSSet, NSString, NSIndexSet;
@protocol PXStoryMutableModel, PXChangeObserver, PXStoryQueueParticipant, PXTapToRadarDiagnosticProvider, PXStoryColorGradingRepository, PXDisplayAssetCollection, PXStorySongResource, PXStoryStyle, PXStoryErrorReporter, PXStoryTimeline, PXStoryLayoutSpec, OS_dispatch_queue, PXStoryTimelineSpec, NSCopying, PXDisplayAssetFetchResult;
...
@property (readonly, nonatomic) NSInteger infoPanelState; // ivar: _infoPanelState
