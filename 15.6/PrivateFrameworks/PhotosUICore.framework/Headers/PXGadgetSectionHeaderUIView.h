...
+(CGFloat)_preferredHeightOfButtonWithType:(NSUInteger)arg0 width:(CGFloat)arg1 ;
+(CGFloat)preferredHeightForText:(id)arg0 buttonType:(NSUInteger)arg1 fittingWidth:(CGFloat)arg2 style:(NSUInteger)arg3 dividerHidden:(BOOL)arg4 ;
+(id)_sizingButton;
+(id)_sizingLabel;
