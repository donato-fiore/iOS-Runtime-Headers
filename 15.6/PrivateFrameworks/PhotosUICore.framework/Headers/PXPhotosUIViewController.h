...
@protocol PXActionManagerProvider, PXAssetsActionReceiver, PXChangeObserver, PXPhotosContentControllerDelegate, PXScrollViewControllerObserver, PXStatusViewDelegate, PXSplitViewControllerChangeObserver, PXUserInterfaceFeatureViewController, PXPhotosBarsControllerDelegate, PXAssetsSharingHelperDelegate, _PXPhotosGridContainerDelegate, PXPhotosGridStackTransitionEndpoint, UIViewControllerInteractiveTransitioning, PXPhotosViewEventTracker, PXGridPresentationBarsUpdateDelegate;
