...
// -(id)fetchAssetsWithRecordIds:(id)arg0 options:(id)arg1 perRecordProgress:(id)arg2 perRecordCompletionBlockOnSuccess:(unk)arg3 perRecordCompletionBlockOnError:(id)arg4 completion:(unk)arg5  ;
...
// -(id)fetchDiffsWithRecordIds:(id)arg0 options:(id)arg1 perRecordProgress:(id)arg2 perRecordCompletionBlockOnSuccess:(unk)arg3 perRecordCompletionBlockOnError:(id)arg4 completion:(unk)arg5  ;
...
// -(id)queryOperationForRecordType:(id)arg0 predicate:(id)arg1 desiredKeys:(id)arg2 options:(id)arg3 recordFetchedBlock:(id)arg4 queryCompletionBlock:(unk)arg5  ;
// -(id)queryOperationForRecordType:(id)arg0 predicate:(id)arg1 sortDescriptors:(id)arg2 desiredKeys:(id)arg3 options:(id)arg4 recordFetchedBlock:(id)arg5 queryCompletionBlock:(unk)arg6  ;
// -(id)queryOperationWithCursor:(id)arg0 desiredKeys:(id)arg1 options:(id)arg2 recordFetchedBlock:(id)arg3 queryCompletionBlock:(unk)arg4  ;
...
-(void)fetchExperimentNotificationsForLimitedCarryExperimentWithManager:(id)arg0 options:(id)arg1 rollbacksOnly:(BOOL)arg2 completion:(id)arg3 ;
