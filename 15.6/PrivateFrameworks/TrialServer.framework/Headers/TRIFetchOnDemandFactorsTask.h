...
-(void)_asyncFetchAssetsFromAssetRecordsWithContext:(id)arg0 plan:(id)arg1 aggregateProgress:(id)arg2 downloadSize:(*NSUInteger)arg3 options:(id)arg4 group:(id)arg5 ;
