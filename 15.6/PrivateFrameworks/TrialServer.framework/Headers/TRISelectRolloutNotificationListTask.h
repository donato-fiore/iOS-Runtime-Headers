...
@property (readonly, nonatomic) NSSet *excludedNamespaceNames; // ivar: _excludedNamespaceNames
...
+(id)taskWithNamespaceNames:(id)arg0 excludingNamespaces:(id)arg1 taskAttribution:(id)arg2 ;
...
-(id)initWithNamespaceNames:(id)arg0 excludingNamespaces:(id)arg1 taskAttribution:(id)arg2 ;
-(id)metrics;
