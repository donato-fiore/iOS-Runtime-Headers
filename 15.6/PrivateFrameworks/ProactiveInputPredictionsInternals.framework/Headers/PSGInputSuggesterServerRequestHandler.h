...
-(id)_quickResponsesForResponseContext:(id)arg0 conversationTurns:(id)arg1 localeIdentifier:(id)arg2 maxResponses:(NSUInteger)arg3 recipients:(id)arg4 chunkPath:(id)arg5 plistPath:(id)arg6 espressoBinFilePath:(id)arg7 ;
