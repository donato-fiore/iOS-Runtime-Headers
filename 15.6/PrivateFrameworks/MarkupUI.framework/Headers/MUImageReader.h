...
-(BOOL)readAnnotationsFromData:(id)arg0 toController:(id)arg1 ;
-(BOOL)readAnnotationsFromImageAtURL:(id)arg0 toController:(id)arg1 ;
...
-(void)readAnnotationsFromArchivedModelData:(id)arg0 toController:(id)arg1 ;
