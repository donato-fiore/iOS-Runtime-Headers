...
@class UIView, UIScrollView, NSMutableArray, _UIVisualEffectBackdropView, UIHoverGestureRecognizer, UIPointerInteraction, NSDate, NSString, UITextField, NSArray;
...
@property (readonly, nonatomic) CGFloat topSpacingAdjustment;
...
-(void)_configureTabBarItemView:(id)arg0 forItem:(id)arg1 inArrangement:(id)arg2 forPreview:(BOOL)arg3 ;
