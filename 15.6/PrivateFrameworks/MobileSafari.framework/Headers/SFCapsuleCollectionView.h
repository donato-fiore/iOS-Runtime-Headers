...
@class UIView, NSTimer, NSMutableSet, NSMutableDictionary, NSString, _UIVisualEffectBackdropView, UIAction, UIKBVisualEffectView, UIVisualEffectView, UITapGestureRecognizer, UIPanGestureRecognizer, UISelectionFeedbackGenerator, NSHashTable, UIViewFloatAnimatableProperty, NSIndexSet, NSArray, UIToolbar, NSNumber;
@protocol SFCapsuleContentViewSizeUpdating, SFStartPageScrollObserver, UIGestureRecognizerDelegate, SFCapsuleCollectionViewToolbarContentProviding, SFCapsuleCollectionViewDataSource, SFCapsuleCollectionViewDelegate;
...
@property (readonly, nonatomic) SFScrollingPanGestureRecognizer *minimizationPanGestureRecognizer; // ivar: _minimizationPanGestureRecognizer
