...
#ifndef SBWWALLPAPEREFFECTVIEWBASE_H
#define SBWWALLPAPEREFFECTVIEWBASE_H

@class UIView, UIColor, UIImage, UIView<_SBWFakeBlur>, NSString, UIImageView;
@protocol _SBWFakeBlurObserver, SBWallpaperObserver, SBWWallpaperPresenting><SBWWallpaperLegibilityProviding;
...
@property (retain, nonatomic) UIView<_SBWFakeBlur> *blurView; // ivar: _blurView
...
@property (retain, nonatomic) UIView<_SBWFakeBlur> *transitionBlurView; // ivar: _transitionBlurView
...
@property (readonly, nonatomic) NSObject<SBWWallpaperPresenting><SBWWallpaperLegibilityProviding> *wallpaperPresenter; // ivar: _wallpaperPresenter
...
-(void)_configureViewsForFullscreen:(BOOL)arg0 ;
