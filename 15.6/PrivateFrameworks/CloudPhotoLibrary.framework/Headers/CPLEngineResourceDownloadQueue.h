...
-(id)_queuesStatus;
// -(id)_realDownloadTaskForLocalResource:(id)arg0 taskIdentifier:(id)arg1 cloudResource:(id)arg2 ofRecord:(id)arg3 didStartHandler:(id)arg4 progressHandler:(unk)arg5 completionHandler:(id)arg6  ;
// -(id)_resourceStorageCopyTaskForResource:(id)arg0 taskIdentifier:(id)arg1 cloudResource:(id)arg2 ofRecord:(id)arg3 didStartHandler:(id)arg4 progressHandler:(unk)arg5 completionHandler:(id)arg6  ;
-(id)cloudResourceForLocalResource:(*id)arg0 cloudRecord:(*id)arg1 shouldNotTrustCaches:(*BOOL)arg2 allowUnsafeClientCache:(BOOL)arg3 transportScope:(*id)arg4 error:(*id)arg5 ;
