...
#ifndef IMSHAREDUTILITIESPROTOCLOUDKITENCRYPTEDGROUPACTION_H
#define IMSHAREDUTILITIESPROTOCLOUDKITENCRYPTEDGROUPACTION_H
...
@property (nonatomic) NSInteger groupActionType; // ivar: _groupActionType
