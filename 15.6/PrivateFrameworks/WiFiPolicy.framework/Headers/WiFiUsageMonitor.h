...
-(void)setRoamingState:(BOOL)arg0 flags:(NSUInteger)arg1 scannedChannelCount:(NSUInteger)arg2 withReason:(NSUInteger)arg3 asString:(id)arg4 andStatus:(NSUInteger)arg5 asString:(id)arg6 andLatency:(NSUInteger)arg7 andOriginRSSI:(NSInteger)arg8 andTargetRssi:(NSInteger)arg9 andPingPongNth:(NSUInteger)arg10 forInterface:(id)arg11 ;
