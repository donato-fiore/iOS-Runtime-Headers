...
+(id)getBinRssi:(NSUInteger)arg0 As:(NSUInteger)arg1 ;
...
+(struct ? )ratePercentagesWithTxRate:(NSUInteger)arg0 rxRate:(NSUInteger)arg1 txFallbackRate:(NSUInteger)arg2 txFrames:(NSUInteger)arg3 rxFrames:(NSUInteger)arg4 nss:(NSUInteger)arg5 bw:(NSUInteger)arg6 phyMode:(NSUInteger)arg7 band:(NSUInteger)arg8 deviceMaxRate:(NSInteger)arg9 ;
