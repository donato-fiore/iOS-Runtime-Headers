...
-(void)roamingStateDidChange:(BOOL)arg0 flags:(NSUInteger)arg1 scannedChannelCount:(NSUInteger)arg2 reason:(NSUInteger)arg3 latency:(NSUInteger)arg4 andStatus:(NSUInteger)arg5 andPingPongNth:(NSUInteger)arg6 ;
