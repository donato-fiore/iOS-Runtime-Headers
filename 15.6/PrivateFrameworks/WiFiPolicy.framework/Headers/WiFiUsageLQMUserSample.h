...
@property (nonatomic) NSUInteger roamRecommended; // ivar: _roamRecommended
...
@property (nonatomic) NSUInteger tdRecommended; // ivar: _tdRecommended
...
-(void)populateWithMotionState:(id)arg0 ;
-(void)populateWithRssi:(NSInteger)arg0 noise:(NSInteger)arg1 snr:(NSInteger)arg2 selfCca:(NSUInteger)arg3 otherCca:(NSUInteger)arg4 interference:(NSUInteger)arg5 totalReportedCca:(NSUInteger)arg6 beaconPer:(NSUInteger)arg7 rxCrsGlitch:(NSUInteger)arg8 rxBadPLCP:(NSUInteger)arg9 rxStart:(NSUInteger)arg10 ;
-(void)populateWithRssi:(NSInteger)arg0 rssi1:(NSInteger)arg1 rssi2:(NSInteger)arg2 noise:(NSInteger)arg3 snr:(NSInteger)arg4 selfCca:(NSUInteger)arg5 otherCca:(NSUInteger)arg6 interference:(NSUInteger)arg7 totalReportedCca:(NSUInteger)arg8 beaconPer:(NSUInteger)arg9 beaconTbtt:(NSUInteger)arg10 rxCrsGlitch:(NSUInteger)arg11 rxBadPLCP:(NSUInteger)arg12 rxStart:(NSUInteger)arg13 rxBphyCrsGlitch:(NSUInteger)arg14 rxBphyBadPLCP:(NSUInteger)arg15 sampleDuration:(NSUInteger)arg16 ;
...
-(void)updateWithChQualScore:(NSUInteger)arg0 txLatencyScore:(NSUInteger)arg1 rxLatencyScore:(NSUInteger)arg2 txLossScore:(NSUInteger)arg3 rxLossScore:(NSUInteger)arg4 txLatencyP95:(NSUInteger)arg5 linkRecommendationFlags:(NSUInteger)arg6 ;
