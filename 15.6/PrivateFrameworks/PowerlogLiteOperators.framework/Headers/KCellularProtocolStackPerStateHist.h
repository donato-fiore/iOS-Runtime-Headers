...
#ifndef KCELLULARPROTOCOLSTACKPERSTATEHIST_H
#define KCELLULARPROTOCOLSTACKPERSTATEHIST_H
...
@interface KCellularProtocolStackPerStateHist : PBCodable <NSCopying>
