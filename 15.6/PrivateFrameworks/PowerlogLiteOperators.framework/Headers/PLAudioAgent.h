...
@class PLAgent, PLEntryNotificationOperatorComposition, PLXPCListenerOperatorComposition, NSString, NSDictionary, PLEntry, NSDate, NSMutableArray, PLNSNotificationOperatorComposition;
...
@property int activePID; // ivar: _activePID
