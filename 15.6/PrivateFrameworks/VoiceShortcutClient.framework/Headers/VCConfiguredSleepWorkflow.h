...
-(id)initWithWorkflowIdentifier:(id)arg0 bundleIdentifierForDisplay:(id)arg1 summaryString:(id)arg2 name:(id)arg3 actionIdentifier:(id)arg4 glyphCharacter:(unsigned short)arg5 backgroundColorValue:(NSInteger)arg6 ;
