...
@property (retain, nonatomic) NSObject<OS_dispatch_queue> *backgroundNotificationCallbackQueue; // ivar: _backgroundNotificationCallbackQueue
...
+(id)getShared;
-(id)initForForegroundApp:(BOOL)arg0 ;
