...
-(id)_createUnrestrictedConfiguration:(id)arg0 ;
-(id)_identifierForConfigurationType:(id)arg0 ;
...
-(id)initWithPersistenceController:(id)arg0 organizationIdentifier:(id)arg1 userDSID:(id)arg2 userName:(id)arg3 ;
