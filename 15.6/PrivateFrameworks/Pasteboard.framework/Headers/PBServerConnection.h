...
-(NSUInteger)savePasteboard:(id)arg0 dataProviderEndpoint:(id)arg1 error:(*id)arg2 ;
-(id)init;
...
-(void)requestItemFromPasteboardWithName:(id)arg0 UUID:(id)arg1 authenticationMessage:(id)arg2 itemIndex:(NSUInteger)arg3 typeIdentifier:(id)arg4 dataOwner:(NSInteger)arg5 completionBlock:(id)arg6 ;
