...
@protocol ARQLInlineService3, ARSessionDelegate, ARCoachingOverlayViewDelegate;


#import "_TtC11AssetViewer28ARQuickLookOverlayController.h"

@interface ASVPreviewViewControllerInternal : QLCustomItemViewController <ARQLInlineService3, ARSessionDelegate, ARCoachingOverlayViewDelegate>
