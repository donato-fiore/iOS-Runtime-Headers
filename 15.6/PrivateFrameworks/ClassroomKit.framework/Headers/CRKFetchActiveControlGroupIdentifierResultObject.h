...
#ifndef CRKFETCHACTIVECONTROLGROUPIDENTIFIERRESULTOBJECT_H
#define CRKFETCHACTIVECONTROLGROUPIDENTIFIERRESULTOBJECT_H

@class CATTaskResultObject, DMFControlGroupIdentifier;
