...
@class NSURL, NTPBHeadlineAdElement, NSDate, NTPBHeadlineAnalyticsElement, NSString, NTPBHeadlineBackingElement, NTPBFeedItem, COMAPPLEFELDSPARPROTOCOLLIVERPOOLCohortList, COMAPPLEFELDSPARPROTOCOLLIVERPOOLConversionStats, NSArray, COMAPPLEFELDSPARPROTOCOLVersionedPersonalizationVector, COMAPPLEFELDSPARPROTOCOLLIVERPOOLTagMetadata, SFSearchResult;
