...
-(void)triggerWithImageAssetLocalIdentifier:(id)arg0 wellKnownPHPhotoLibraryIdentifier:(NSInteger)arg1 options:(id)arg2 cacheKey:(id)arg3 resultHandler:(id)arg4 ;
-(void)triggerWithImageURL:(id)arg0 assetLocalIdentifier:(id)arg1 wellKnownPHPhotoLibraryIdentifier:(NSInteger)arg2 options:(id)arg3 cacheKey:(id)arg4 resultHandler:(id)arg5 ;
