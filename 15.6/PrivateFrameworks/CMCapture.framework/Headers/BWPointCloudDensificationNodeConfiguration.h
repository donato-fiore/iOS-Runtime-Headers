...
-(id)initWithRGBSensorConfiguration:(id)arg0 timeOfFlightSensorConfiguration:(id)arg1 rgbCameraHorizontalSensorBinningFactor:(int)arg2 rgbCameraVerticalSensorBinningFactor:(int)arg3 filteringEnabled:(BOOL)arg4 depthPixelFormat:(unsigned int)arg5 depthOutputDimensions:(struct ? )arg6 ;
-(void)dealloc;
