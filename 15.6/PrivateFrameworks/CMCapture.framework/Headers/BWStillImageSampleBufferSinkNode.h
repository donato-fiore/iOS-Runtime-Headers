...
-(id)_coreAnalyticsPayloadWithSampleBuffer:(struct opaqueCMSampleBuffer *)arg0 stillImageSettings:(id)arg1 ;
...
-(void)_reportCoreAnalyticsForSampleBuffer:(struct opaqueCMSampleBuffer *)arg0 stillImageSettings:(id)arg1 ;
-(void)dealloc;
