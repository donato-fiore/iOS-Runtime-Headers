...
-(id)initWithInferenceType:(int)arg0 videoDepthAlgorithm:(int)arg1 outputDimensions:(struct ? )arg2 inputDimensions:(struct ? )arg3 temporalDepthInputPixelFormat:(unsigned int)arg4 portType:(id)arg5 concurrencyWidth:(NSUInteger)arg6 backpressureEvent:(id)arg7 ;
-(void)dealloc;
