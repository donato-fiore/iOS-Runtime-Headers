...
-(id)initWithConfiguration:(id)arg0 tailIndex:(NSUInteger)arg1 numTailPipelines:(NSUInteger)arg2 graph:(id)arg3 parentPipeline:(id)arg4 captureDevice:(id)arg5 inferenceScheduler:(id)arg6 recordingStatusDelegate:(id)arg7 ;
-(void)dealloc;
