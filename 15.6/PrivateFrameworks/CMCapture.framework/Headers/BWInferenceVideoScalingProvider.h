...
-(id)initWithInputRequirement:(id)arg0 outputRequirements:(id)arg1 enableFencing:(BOOL)arg2 ;
-(id)newStorage;
...
-(void)_configureCustomFiltersForScalingFromSourceWidth:(NSUInteger)arg0 sourceHeight:(NSUInteger)arg1 destinationWidth:(NSUInteger)arg2 destinationHeight:(NSUInteger)arg3 ;
-(void)dealloc;
