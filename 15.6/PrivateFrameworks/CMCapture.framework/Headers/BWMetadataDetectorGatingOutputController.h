...
-(struct opaqueCMSampleBuffer *)_newOutputSampleBufferWithPixelBuffer:(struct __CVBuffer *)arg0 inputSampleBuffer:(struct opaqueCMSampleBuffer *)arg1 appliedPrimaryCaptureRect:(BOOL)arg2 ;
