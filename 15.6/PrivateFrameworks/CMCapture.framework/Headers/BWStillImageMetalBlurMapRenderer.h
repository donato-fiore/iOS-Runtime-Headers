...
-(id)initWithSensorIDDictionary:(id)arg0 imageDimensions:(struct ? )arg1 depthDataMapDimensions:(struct ? )arg2 portraitRenderQuality:(int)arg3 metalCommandQueue:(id)arg4 ;
-(int)_allocateBlurMapPixelBufferPoolForBuffersOfWidth:(NSUInteger)arg0 height:(NSUInteger)arg1 ;
