...
#ifndef BWPEARLCINEMATICVIDEOSCENEMONITOR_H
#define BWPEARLCINEMATICVIDEOSCENEMONITOR_H
...
@property (nonatomic) BOOL portraitSceneMonitoringRequiresStageThresholds; // ivar: portraitSceneMonitoringRequiresStageThresholds
