...
@property (readonly, nonatomic) BWStillImageCaptureSettings *stillImageCaptureSettings; // ivar: _stillImageCaptureSettings
...
@property (readonly, nonatomic) FigCaptureIrisStillImageSettings *stillImageRequestSettings; // ivar: _stillImageRequestSettings
...
@property (retain, nonatomic) BWSubjectRelightingCalculatorResult *subjectRelightingResult; // ivar: _subjectRelightingResult
...
+(id)irisMovieInfoWithFigCaptureMovieFileRecordingSettings:(id)arg0 stillImageCaptureTime:(struct ? )arg1 stillImageCaptureHostTime:(struct ? )arg2 stillImageCaptureAbsoluteStartTime:(CGFloat)arg3 stillImageRequestSettings:(id)arg4 stillImageCaptureSettings:(id)arg5 originalPhotoRecording:(BOOL)arg6 semanticStyle:(id)arg7 ;
...
-(id)_initWithFigCaptureMovieFileRecordingSettings:(id)arg0 stillImageCaptureTime:(struct ? )arg1 stillImageCaptureHostTime:(struct ? )arg2 stillImageCaptureAbsoluteStartTime:(CGFloat)arg3 stillImageRequestSettings:(id)arg4 stillImageCaptureSettings:(id)arg5 originalPhotoRecording:(BOOL)arg6 semanticStyle:(id)arg7 ;
