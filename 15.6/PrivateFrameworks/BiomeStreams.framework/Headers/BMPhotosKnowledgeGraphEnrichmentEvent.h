...
-(id)initWithUniqueId:(id)arg0 absoluteTimestamp:(CGFloat)arg1 topics:(id)arg2 entities:(id)arg3 locations:(id)arg4 ;
-(id)initWithUniqueId:(id)arg0 absoluteTimestamp:(CGFloat)arg1 topics:(id)arg2 entities:(id)arg3 locations:(id)arg4 contentProtection:(id)arg5 ;
-(id)json;
-(id)jsonDict;
-(id)proto;
-(id)serialize;
