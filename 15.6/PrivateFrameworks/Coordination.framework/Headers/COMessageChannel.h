...
-(void)_deliverDidFailToStartSessionWithProducer:(id)arg0 member:(id)arg1 error:(id)arg2 ;
-(void)_deliverFailedToStartSessionWithSubTopic:(id)arg0 withMember:(id)arg1 consumer:(id)arg2 error:(id)arg3 ;
