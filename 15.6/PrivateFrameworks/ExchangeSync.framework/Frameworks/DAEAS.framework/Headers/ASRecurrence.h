...
+(id)asParseRules;
-(*void)_newRecurrenceWithParentStartDate:(id)arg0 useFloatingTimeForAllDayEvents:(BOOL)arg1 ;
...
-(void)saveToCalendarWithParentASEvent:(id)arg0 existingRecord:(*void)arg1 shouldMergeProperties:(BOOL)arg2 outMergeDidChooseLocalProperties:(*BOOL)arg3 useFloatingTimeForAllDayEvents:(BOOL)arg4 ;
