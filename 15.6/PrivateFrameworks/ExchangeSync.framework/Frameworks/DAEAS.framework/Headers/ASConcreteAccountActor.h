...
@property (retain, nonatomic) ASClientAccount *account; // ivar: _account
...
+(void)_runActorThreadWithStartupLock:(id)arg0 ;
...
-(void)_performAsynchronousSerialOnActorQueue:(id)arg0 ;
-(void)_performSynchronousSerialOnActorQueue:(id)arg0 ;
-(void)_sendFailureToConsumer:(id)arg0 ;
