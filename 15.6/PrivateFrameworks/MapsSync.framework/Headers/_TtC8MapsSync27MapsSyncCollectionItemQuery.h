...
#ifndef _TTC8MAPSSYNC27MAPSSYNCCOLLECTIONITEMQUERY_H
#define _TTC8MAPSSYNC27MAPSSYNCCOLLECTIONITEMQUERY_H

@class TtC8MapsSync17MapsSyncBaseQuery;



@interface _TtC8MapsSync27MapsSyncCollectionItemQuery : TtC8MapsSync17MapsSyncBaseQuery {
    ? _specifiedQuery;
}
