...
#ifndef _TTC8MAPSSYNC24MAPSSYNCHISTORYITEMQUERY_H
#define _TTC8MAPSSYNC24MAPSSYNCHISTORYITEMQUERY_H

@class TtC8MapsSync17MapsSyncBaseQuery;



@interface _TtC8MapsSync24MapsSyncHistoryItemQuery : TtC8MapsSync17MapsSyncBaseQuery {
    ? _specifiedQuery;
}
