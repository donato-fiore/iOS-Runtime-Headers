...
@class UIView, UIActivityIndicatorView, NSLayoutYAxisAnchor, NSLayoutConstraint, HMCameraSource, HMCameraView, UIImageView, NADecayingTimer, NSArray;
...
@property (retain, nonatomic) HUCameraErrorView *errorView; // ivar: _errorView
