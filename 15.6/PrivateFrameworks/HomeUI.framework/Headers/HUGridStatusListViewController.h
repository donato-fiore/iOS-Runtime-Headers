...
@class HFWallpaperSlice, NSString, UIVisualEffectView, HMRoom, UIVisualEffect, HFHomeStatusItemManager;
...
-(void)backgroundEffectAddCaptureDependent:(id)arg0 ;
-(void)backgroundEffectRemoveCaptureDependent:(id)arg0 ;
