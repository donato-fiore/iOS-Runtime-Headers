...
#ifndef HUSCENEACTIONGRIDVIEWCONTROLLER_H
#define HUSCENEACTIONGRIDVIEWCONTROLLER_H

@class HFActionSetBuilder, NSSet, NSString;
@protocol HFActionSetValueSourceDelegate, HUServiceActionControlsViewControllerDelegate, HUServiceGridItemManagerDelegate, HUContainedServiceGridViewControllerDelegate;
