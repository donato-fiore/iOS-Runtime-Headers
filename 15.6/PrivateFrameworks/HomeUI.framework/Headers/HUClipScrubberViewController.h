...
@protocol NSURLSessionDelegate, UIGestureRecognizerDelegate, HFExecutionEnvironmentObserver, HUFeedbackConsentViewControllerDelegate, HUCameraPlayerScrubbing, HFCameraPlaybackEngineObserver;
