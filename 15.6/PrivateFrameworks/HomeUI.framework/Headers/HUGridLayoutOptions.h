...
@property (copy, nonatomic) HUNavigationBarLayoutOptions *navigationBarOptions; // ivar: _navigationBarOptions
...
@property (copy, nonatomic) HUGridStatusBannerCellLayoutOptions *statusBannerCellOptions; // ivar: _statusBannerCellOptions
...
+(NSUInteger)_numberOfColumnsForFlexibleWidthStyleWithSizeSubclass:(NSInteger)arg0 ;
