...
@property (copy, nonatomic) NSSet *prioritizedHomeObjects; // ivar: _prioritizedHomeObjects
...
-(BOOL)prioritizedHomeObjectsContainsMediaProfiles:(id)arg0 ;
-(BOOL)prioritizedHomeObjectsContainsServices:(id)arg0 ;
