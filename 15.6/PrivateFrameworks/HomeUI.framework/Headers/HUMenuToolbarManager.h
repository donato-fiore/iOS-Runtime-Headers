...
@protocol HFHomeObserver, HFHomeManagerObserver, UIMenuBuilder, HUSidebarSelectionDelegate;
...
@property (weak, nonatomic) NSObject<HUSidebarSelectionDelegate> *sideBarSelectionDelegate; // ivar: _sideBarSelectionDelegate
...
-(id)initWithAppNavigator:(id)arg0 sideBarSelectionDelegate:(id)arg1 ;
