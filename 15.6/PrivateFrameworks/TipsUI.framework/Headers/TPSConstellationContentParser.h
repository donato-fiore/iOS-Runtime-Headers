...
@class NSURL, NSMutableDictionary, NSAttributedString, UIFont, NSDictionary, NSString, UITraitCollection;
...
-(id)attributedStringForConstellationContent:(id)arg0 defaultAttributes:(id)arg1 identifier:(id)arg2 language:(id)arg3 assetsBaseURL:(id)arg4 error:(*id)arg5 ;
...
-(struct CGSize )assetSizeFromAttributes:(id)arg0 ;
