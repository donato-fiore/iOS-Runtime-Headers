...
@class NSString, NSDictionary, NSArray, NSNumber, NSData;
...
-(id)init;
-(id)initWithFigEndpoint:(struct OpaqueFigEndpoint *)arg0 volumeController:(struct OpaqueFigVolumeControllerState *)arg1 routingContextFactory:(id)arg2 useRouteConfigUpdatedNotification:(BOOL)arg3 ;
