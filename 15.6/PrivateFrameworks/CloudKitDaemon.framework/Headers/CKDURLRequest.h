...
@class NSData, NSString, NSDictionary, C2RequestOptions, NSMutableDictionary, NSDate, NSError, NSURL, NSNumber, NSMutableArray, NSURLRequest, NSInputStream, NSArray, NSHTTPURLResponse, NSMutableSet, CKSignpost, NSURLSession, NSURLSessionDataTask;
