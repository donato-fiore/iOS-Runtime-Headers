...
@property (nonatomic) NSUInteger deviceFlowControlBudget; // ivar: _deviceFlowControlBudget
@property (nonatomic) NSUInteger deviceFlowControlBudgetCap; // ivar: _deviceFlowControlBudgetCap
@property (retain, nonatomic) NSString *deviceFlowControlKey; // ivar: _deviceFlowControlKey
@property (nonatomic) float deviceFlowControlRegeneration; // ivar: _deviceFlowControlRegeneration
