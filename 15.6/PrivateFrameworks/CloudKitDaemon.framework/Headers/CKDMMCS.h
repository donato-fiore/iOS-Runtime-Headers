...
@property (retain, nonatomic) NSHashTable *containers; // ivar: _containers
...
+(id)MMCSWrapperForApplicationBundleID:(id)arg0 directoryContext:(id)arg1 error:(*id)arg2 ;
...
+(void)startTrackingMMCSItemReader:(id)arg0 ;
+(void)stopTrackingItemIDsForMMCSItems:(id)arg0 ;
+(void)stopTrackingMMCSItemReader:(id)arg0 ;
...
-(id)initWithMMCSEngineContext:(id)arg0 path:(id)arg1 ;
...
-(void)unregisterItemIDs:(id)arg0 completionBlock:(id)arg1 ;
