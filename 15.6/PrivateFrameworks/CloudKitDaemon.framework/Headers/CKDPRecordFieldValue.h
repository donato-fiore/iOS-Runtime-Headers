...
#import "CKDPAsset.h"
#import "CKDPDistributedValue.h"
#import "CKDPEncryptedDistributedValue.h"
...
@property (retain, nonatomic) CKDPDistributedValue *distributedValue; // ivar: _distributedValue
@property (nonatomic) CGFloat doubleValue; // ivar: _doubleValue
@property (retain, nonatomic) CKDPEncryptedDistributedValue *encryptedDistributedValue; // ivar: _encryptedDistributedValue
