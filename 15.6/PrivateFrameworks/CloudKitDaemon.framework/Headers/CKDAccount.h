...
@class NSString, ACAccountStore, CKAccountOverrideInfo, NSPersonNameComponents, NSURL;
...
@property (readonly, nonatomic) CKAccountOverrideInfo *fakeAccountInfo; // ivar: _fakeAccountInfo
...
@property (nonatomic) BOOL isAnonymousAccount; // ivar: _isAnonymousAccount
...
-(id)initFakeAccountWithAccountOverrideInfo:(id)arg0 ;
