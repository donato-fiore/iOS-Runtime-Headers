...
@class NSOperation, CKOperationMMCSRequestOptions, NSString, NSNumber, NSMutableArray, NSError, NSDate, CKOperationInfo, CKOperationMetrics, CKSignpost, NSMutableDictionary, UMUserSyncTask;
