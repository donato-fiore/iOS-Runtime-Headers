...
@class CKAccountOverrideInfo, NSString, NSURL, NSOperationQueue, NSArray, CKContainerID, CKEntitlements, NSMutableDictionary, CKContainerOptions, NSMutableSet;
...
@property (retain, nonatomic) CKDAccount *account; // ivar: _account
...
@property (retain, nonatomic) CKDFlowControlManager *flowControlManager; // ivar: _flowControlManager
...
@property (readonly, nonatomic) CKDPCSCache *pcsCache; // ivar: _pcsCache
...
@property (retain, nonatomic) CKDKeyValueDiskCache *publicIdentitiesDiskCache; // ivar: _publicIdentitiesDiskCache
...
-(BOOL)setupAssetTransfersWithError:(*id)arg0 ;
-(BOOL)setupMMCSWrapperWithError:(*id)arg0 ;
