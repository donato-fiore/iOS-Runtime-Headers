...
+(BOOL)_rollTestAccountIdentitySetForService:(id)arg0 forBackingFakeAccount:(id)arg1 withError:(*id)arg2 ;
+(id)_generatePCSIdentityOptionsForService:(id)arg0 forBackingFakeAccount:(id)arg1 withError:(*id)arg2 ;
+(id)overrideKeys;
+(id)sharedFakeIdentitySetsByServiceByUsername;
+(struct _PCSIdentitySetData *)_copyStingrayIdentitiesForService:(id)arg0 forBackingFakeAccount:(id)arg1 withError:(*id)arg2 ;
+(struct _PCSIdentitySetData *)_getTestAccountIdentitySetForService:(id)arg0 forBackingFakeAccount:(id)arg1 withError:(*id)arg2 ;
...
-(BOOL)manateeIsAvailableWithError:(*id)arg0 ;
...
-(struct _PCSIdentitySetData *)_copyTestAccountIdentitySetForService:(id)arg0 forBackingFakeAccount:(id)arg1 withError:(*id)arg2 ;
