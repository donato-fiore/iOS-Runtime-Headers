...
@class NSTimer, WBTabGroupManager, UIBarButtonItem, NSUUID, NSArray, NSMapTable, NSHashTable, NSString, CKContextCompleter, WBTabGroup, NSSet, UIMenu, _SFBrowserSavedState, UIView<TabCollectionView>, WBSTabOrderManager, UIView<TabThumbnailCollectionView>, NSUndoManager, WBWindowState;
...
-(id)tabGroupsMenuElementsWithOptions:(NSUInteger)arg0 newTabGroupName:(id)arg1 hostTitle:(id)arg2 descendantCount:(NSInteger)arg3 isMoveAction:(BOOL)arg4 actionHandler:(id)arg5 ;
