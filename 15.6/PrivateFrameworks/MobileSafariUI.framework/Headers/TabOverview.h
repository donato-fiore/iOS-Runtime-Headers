...
@class UIView, NSHashTable, CADisplayLink, NSArray, SFScrollingPanGestureRecognizer, UITapGestureRecognizer, UIPointerInteraction, NSMutableArray, UIVisualEffectView, UISearchBar, NSIndexSet, NSTimer, SFGradientView, NSString, UIButton, UITextInputPasswordRules;
