...
@protocol BookmarksTableViewControllerDelegate, HistoryTableViewControllerDelegate, ReadingListViewControllerDelegate, _SFBookmarkInfoViewControllerDelegate, UINavigationBarDelegate, UINavigationControllerDelegate, _SFNavigationIntentHandling, OS_dispatch_queue, BookmarksNavigationControllerDelegate, LinkPreviewProvider, TabGroupProvider;
...
-(id)_initWithBookmarksDelegate:(id)arg0 linkPreviewProvider:(id)arg1 topBookmark:(id)arg2 skipOffset:(unsigned int)arg3 activeCollection:(id)arg4 showOnlyActiveCollection:(BOOL)arg5 ;
