...
@protocol SFCapsuleCollectionViewGestureObserving, TabControllerDocumentObserving, TabDocumentNavigationObserving, UIContextMenuInteractionDelegate, UIDragInteractionDelegate, UIDropInteractionDelegate, _UIScrollViewScrollObserver, PKScribbleInteractionElementSource, SFCapsuleCollectionViewDataSource, SFCapsuleCollectionViewDelegate, TabOverviewPresentationObserving, CapsuleNavigationBarViewControllerDelegate;
...
-(BOOL)_shouldBeginAdjustingScrollViewContentOffsetForMinimization;
...
-(void)_adjustScrollViewContentOffsetForMinimization;
...
-(void)capsuleCollectionViewDidBeginMinimizationGesture:(id)arg0 ;
