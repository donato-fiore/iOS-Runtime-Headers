...
+(void)_becomeActiveWithCoordinator:(id)arg0 ;
+(void)_disablePhotoStreams;
+(void)_enablePhotoStreams;
+(void)_resignActiveWithCoordinator:(id)arg0 ;
+(void)_startConstrainingTasksWithCoordinator:(id)arg0 ;
+(void)_stopConstrainingTasksWithCoordinator:(id)arg0 ;
