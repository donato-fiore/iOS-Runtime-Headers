...
+(NSUInteger)deletePendingSuggestionsCreatedBefore:(id)arg0 inManagedObjectContext:(id)arg1 ;
...
-(void)updateWithCPLSuggestionChange:(id)arg0 inPhotoLibrary:(id)arg1 ;
-(void)willSave;
