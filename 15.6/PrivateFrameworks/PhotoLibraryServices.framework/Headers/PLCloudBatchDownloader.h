...
-(id)_handleAssetRecords:(id)arg0 inSyncContext:(id)arg1 withChangeBatch:(id)arg2 dedupeGraphPersons:(*id)arg3 ;
...
-(void)_deleteMasterIfNecessary:(id)arg0 inLibrary:(id)arg1 ;
