...
+(NSInteger)_provideOptionsFromRequestOptions:(id)arg0 ;
+(id)supportedRecipes;
+(unsigned short)keyLengthWithDataPreview:(unsigned char)arg0 ;
+(unsigned short)storeClassID;
+(void)_provideFileURLAndUnwrapLivePhotoIfNeededForBundleID:(id)arg0 syndicationIdentifier:(id)arg1 isLivePhoto:(BOOL)arg2 options:(NSInteger)arg3 completionHandler:(id)arg4 ;
// +(void)provideFileURLAndUnwrapLivePhotoIfNeededForBundleID:(id)arg0 itemIdentifiers:(id)arg1 destURLs:(id)arg2 options:(id)arg3 resultHandler:(id)arg4 completionHandler:(unk)arg5  ;
