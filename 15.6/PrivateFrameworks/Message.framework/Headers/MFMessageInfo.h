...
@property (nonatomic) NSInteger sortUid; // ivar: _sortUid
@property (readonly) Class superclass;
@property (readonly, nonatomic) unsigned int uid;
@property (nonatomic) NSInteger uid; // ivar: _uid
...
-(id)init;
-(id)initWithUid:(NSInteger)arg0 mailboxID:(NSInteger)arg1 messageID:(NSInteger)arg2 dateReceivedInterval:(unsigned int)arg3 dateSentInterval:(unsigned int)arg4 conversationHash:(NSInteger)arg5 read:(BOOL)arg6 knownToHaveAttachments:(BOOL)arg7 flagged:(BOOL)arg8 isVIP:(BOOL)arg9 ;
