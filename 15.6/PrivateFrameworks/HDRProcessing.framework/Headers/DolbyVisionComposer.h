...
-(void)checkForContent:(unsigned int)arg0 contentReturn1:(*BOOL)arg1 contentReturn2:(*BOOL)arg2 contentReturn3:(*BOOL)arg3 forDisplay:(unsigned int)arg4 displayReturn1:(*BOOL)arg5 displayReturn2:(*BOOL)arg6 displayReturn3:(*BOOL)arg7 displayReturn4:(*BOOL)arg8 displayReturn5:(*BOOL)arg9 ;
-(void)checkInputFormats:(unsigned int)arg0 returnInput1:(*BOOL)arg1 returnInput2:(*BOOL)arg2 returnInput3:(*BOOL)arg3 returnInput4:(*BOOL)arg4 outputFormat:(unsigned int)arg5 returnOutput1:(*BOOL)arg6 returnOutput2:(*BOOL)arg7 returnOutput3:(*BOOL)arg8 returnOutput4:(*BOOL)arg9 ;
