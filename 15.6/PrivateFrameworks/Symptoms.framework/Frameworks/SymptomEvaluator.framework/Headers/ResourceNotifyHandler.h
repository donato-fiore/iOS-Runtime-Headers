...
-(void)resouceNotifyEvent:(id)arg0 triggeredBy:(char)arg1 pid:(int)arg2 path:(char)arg3 endTime:(struct mach_timespec )arg4 observedValue:(NSInteger)arg5 observationWindow:(NSInteger)arg6 limitValue:(NSInteger)arg7 limitWindow:(NSInteger)arg8 fatal:(BOOL)arg9 fatalPort:(unsigned int)arg10 ;
