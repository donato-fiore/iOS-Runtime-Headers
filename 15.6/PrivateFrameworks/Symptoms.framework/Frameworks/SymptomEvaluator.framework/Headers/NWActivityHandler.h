...
+(id)sharedInstance;
-(BOOL)_saveMetricWithUUIDS:(id)arg0 withData:(id)arg1 ofType:(int)arg2 ;
...
-(void)_sendMetric:(id)arg0 ofType:(int)arg1 forActivities:(id)arg2 additionalItems:(id)arg3 ;
