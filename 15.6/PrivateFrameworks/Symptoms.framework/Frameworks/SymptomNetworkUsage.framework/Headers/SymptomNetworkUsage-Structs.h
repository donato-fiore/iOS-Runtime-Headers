...
typedef struct provider_counts {
    NSUInteger numSrcsAdded;
    NSUInteger numUpdatesOnOpen;
    NSUInteger numUpdatesOnPoll;
    NSUInteger numUpdatesOnEvent;
    NSUInteger numUpdatesOnClose;
} provider_counts;

typedef struct combined_counts {
    NSUInteger numRemoves;
    NSUInteger numRemovesAfterDrop;
    NSUInteger numRemovesAfterFilter;
    NSUInteger numRemoveSources;
    NSUInteger numRemoveSourcesAfterDrop;
    NSUInteger numRemoveSourcesAfterFilter;
} combined_counts;
