...
@interface NWUsageManager : NSObject {
    ...
    provider_counts _providerCounts;
    combined_counts _combinedCounts;
}
...
// -(BOOL)enumerateItemsUsingBlock:(id)arg0 completionBlock:(unk)arg1  ;
// -(BOOL)enumerateSelectFlows:(id)arg0 deliveryBlock:(id)arg1 completionBlock:(unk)arg2  ;
// -(BOOL)enumerateSelectItems:(id)arg0 deliveryBlock:(id)arg1 completionBlock:(unk)arg2  ;
// -(BOOL)enumerateSelectSources:(id)arg0 flowDeliveryBlock:(id)arg1 genericDeliveryBlock:(unk)arg2 completionBlock:(id)arg3  ;
...
-(void)enumerateSelectItems:(id)arg0 deliveryBlock:(id)arg1 ;
// -(void)enumerateSelectSources:(id)arg0 flowDeliveryBlock:(id)arg1 genericDeliveryBlock:(unk)arg2  ;
-(void)ignoreFlow:(NSUInteger)arg0 ;
-(void)ignoreSource:(NSUInteger)arg0 ;
-(void)invalidate;
