...
-(id)initWithText:(id)arg0 lang:(id)arg1 replyTextId:(NSUInteger)arg2 styleGroupId:(NSUInteger)arg3 semanticClassId:(NSUInteger)arg4 modelId:(NSUInteger)arg5 categoryId:(NSUInteger)arg6 isCustomResponse:(BOOL)arg7 isConfident:(BOOL)arg8 ;
-(id)initWithText:(id)arg0 lang:(id)arg1 replyTextId:(NSUInteger)arg2 styleGroupId:(NSUInteger)arg3 semanticClassId:(NSUInteger)arg4 modelId:(NSUInteger)arg5 categoryId:(NSUInteger)arg6 isCustomResponse:(BOOL)arg7 isConfident:(BOOL)arg8 proactiveTrigger:(id)arg9 ;
