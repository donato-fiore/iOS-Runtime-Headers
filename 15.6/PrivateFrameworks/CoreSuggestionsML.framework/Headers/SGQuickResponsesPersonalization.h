...
+(id)augmentRecords:(id)arg0 selectedPseudocounts:(id)arg1 config:(id)arg2 ;
...
-(id)replyTextsForSemanticClass:(NSUInteger)arg0 responseCount:(NSUInteger)arg1 config:(id)arg2 ;
