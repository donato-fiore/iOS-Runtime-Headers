...
#ifndef NLXSCHEMACDMSERVICECONTEXT_H
#define NLXSCHEMACDMSERVICECONTEXT_H
...
@property (retain, nonatomic) NLXSchemaCDMServiceEnded *ended; // ivar: _ended
@property (retain, nonatomic) NLXSchemaCDMServiceFailed *failed; // ivar: _failed
...
@property (retain, nonatomic) NLXSchemaCDMServiceStarted *startedOrChanged; // ivar: _startedOrChanged
