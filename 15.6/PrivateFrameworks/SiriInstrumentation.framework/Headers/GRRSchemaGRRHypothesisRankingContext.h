...
@property (retain, nonatomic) GRRSchemaGRRHypothesisRanked *ended; // ivar: _ended
...
@property (retain, nonatomic) GRRSchemaGRRHypothesisRankingStarted *startedOrChanged; // ivar: _startedOrChanged
