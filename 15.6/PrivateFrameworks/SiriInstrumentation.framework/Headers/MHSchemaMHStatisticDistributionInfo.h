...
#ifndef MHSCHEMAMHSTATISTICDISTRIBUTIONINFO_H
#define MHSCHEMAMHSTATISTICDISTRIBUTIONINFO_H
...
@property (nonatomic) float std; // ivar: _std
@property (nonatomic) NSUInteger warmup; // ivar: _warmup
