...
@property (nonatomic) unsigned int appleTvCount; // ivar: _appleTvCount
@property (nonatomic) BOOL hasAppleTvCount;
@property (nonatomic) BOOL hasCurrentHome; // ivar: _hasCurrentHome
@property (nonatomic) BOOL hasHasCurrentHome;
@property (nonatomic) BOOL hasHomeCount;
@property (nonatomic) BOOL hasHomePodCount;
@property (nonatomic) unsigned int homeCount; // ivar: _homeCount
@property (nonatomic) unsigned int homePodCount; // ivar: _homePodCount
