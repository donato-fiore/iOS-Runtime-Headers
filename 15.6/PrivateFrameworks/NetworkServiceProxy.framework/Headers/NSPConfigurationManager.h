...
@class NSDate, NSURLSession, NSTimer, NSDictionary, NWPath, NSString;
...
+(id)reasonToString:(NSUInteger)arg0 ;
...
-(void)dealloc;
-(void)fetchPrivacyProxyConfigurationFile:(id)arg0 interface:(id)arg1 eTag:(id)arg2 accessToken:(id)arg3 reason:(NSUInteger)arg4 completionHandler:(id)arg5 ;
-(void)fetchURL:(id)arg0 interface:(id)arg1 eTag:(id)arg2 requestType:(int)arg3 session:(id)arg4 accessToken:(id)arg5 reason:(NSUInteger)arg6 completionHandler:(id)arg7 ;
...
-(void)refreshConfigurationFetchWithReason:(NSUInteger)arg0 completionHandler:(id)arg1 ;
