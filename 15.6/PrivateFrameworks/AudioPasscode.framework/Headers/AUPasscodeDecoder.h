...
@interface AUPasscodeDecoder : AUAudioUnit {
    unique_ptr<CADeprecated::RealtimeMessenger, std::default_delete<CADeprecated::RealtimeMessenger>> _rtMessenger;
    ...
    vector<DecodedDataMessage, std::allocator<DecodedDataMessage>> _messagePool;
    map<unsigned int, apc::Any, std::less<unsigned int>, std::allocator<std::pair<const unsigned int, apc::Any>>> _apcDecoderConfig;
