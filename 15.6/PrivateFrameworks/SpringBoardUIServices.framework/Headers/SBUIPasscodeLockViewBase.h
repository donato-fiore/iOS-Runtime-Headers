...
@class UIView, _UILegibilitySettings, NSMutableSet, UINotificationFeedbackGenerator, UIColor, NSString, _UIKeyboardFeedbackGenerator, NSTimer;
...
@property (retain, nonatomic) _UIKeyboardFeedbackGenerator *keyboardFeedbackBehavior; // ivar: _keyboardFeedbackBehavior
