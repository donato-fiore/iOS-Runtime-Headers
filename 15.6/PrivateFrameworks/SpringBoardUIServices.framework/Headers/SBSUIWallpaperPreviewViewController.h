...
@class UIViewController, NSTimer, SBFWallpaperConfigurationManager, SBFWallpaperConfiguration, NSDictionary, NSString, AVURLAsset, SBFWallpaperOptions, SBFWallpaperCoreAnalyticsLogger, _UILegibilitySettings, UIImage;
@protocol SBFLegibilitySettingsProviderDelegate, SBSUIWallpaperPreviewViewDelegate, SBFLegibilitySettingsProvider, SBSUIWallpaperPreviewViewControllerDelegate;
...
@property (copy, nonatomic) SBFWallpaperConfiguration *wallpaperConfiguration; // ivar: _wallpaperConfiguration
