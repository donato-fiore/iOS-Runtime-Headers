...
@class MPQueueFeeder, NSLock, NSHashTable, NSDictionary, MPRequestResponseController, MPModelRequest<MPCModelPlaybackRequest>, NSString, MPIdentifierSet, MPAVItem, MPPropertySet, MPModelGenericObject, MPModelResponse<MPCModelPlaybackResponse>;
