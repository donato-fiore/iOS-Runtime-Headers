...
@protocol MPShuffleableSectionedIdentifierListDelegate, MPSectionedIdentifierListAnnotationDelegate, MPCContinueListeningRadioQueueProviding, MPCPlaybackEngineEventObserving, MPArtworkDataSource, MPStartItemInfoProviding, MPCQueueItemProviding, MPAVQueueController, MSVSegmentedCoding, MPCQueueControllerCommandInterposingHost, MPAVQueueControllerDelegate, MPAVQueueCoordinating;
...
-(BOOL)canJumpToContentItemID:(id)arg0 ;
-(BOOL)canNextTrackForItem:(id)arg0 ;
-(BOOL)canPreviousTrackForItem:(id)arg0 ;
