...
-(void)renderDebugLayer:(id)arg0 renderRequest:(id)arg1 inDisparity:(id)arg2 disparityOffset:(float)arg3 focusObject:(struct PTFocus )arg4 algorithm:(int)arg5 debugTextures:(id)arg6 ;
