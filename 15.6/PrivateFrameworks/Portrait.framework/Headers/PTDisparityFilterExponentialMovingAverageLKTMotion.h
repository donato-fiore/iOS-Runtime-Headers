...
#ifndef PTDISPARITYFILTEREXPONENTIALMOVINGAVERAGELKTMOTION_H
#define PTDISPARITYFILTEREXPONENTIALMOVINGAVERAGELKTMOTION_H
...
-(int)exponentialMovingAverageFilter:(id)arg0 inDisplacement:(id)arg1 inDisparityPrev:(id)arg2 inDisparity:(id)arg3 outDisparityFiltered:(id)arg4 updateCoefficient:(float)arg5 disparityBias;
...
-(int)temporalDisparityFilter:(id)arg0 inDisplacement:(id)arg1 inStatePrev:(id)arg2 inDisparity:(id)arg3 outDisparityFiltered:(id)arg4 outState:(id)arg5 ;
-(void)reset;
