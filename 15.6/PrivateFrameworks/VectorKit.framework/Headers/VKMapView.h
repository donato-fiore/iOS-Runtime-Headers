...
@interface VKMapView : CALayer {
    ...
    _retain_ptr<VKMuninCameraController *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc> _muninCameraController;
    _retain_ptr<VKARWalkingCameraController *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc> _arWalkingCameraController;
    ...
    _retain_ptr<VKStateCaptureHandler *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc> _stateCaptureHandler;
    ...
    _retain_ptr<NSSet<NSNumber *> *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc> _selectedBuildingFeatureIds;
...
@property (nonatomic) NSObject<VKMapViewCameraDelegate> *cameraDelegate;
...
@property (nonatomic) NSObject<VKMapViewDelegate> *mapDelegate; // ivar: _mapDelegate
...
-(void)map:(id)arg0 didUpdateVerticalYawTo:(CGFloat)arg1 ;
