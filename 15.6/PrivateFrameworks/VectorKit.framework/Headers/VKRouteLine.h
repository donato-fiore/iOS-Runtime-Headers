...
@interface VKRouteLine : NSObject {
    ...
    _retain_ptr<NSUUID *, geo::_retain_objc, geo::_release_objc, geo::_hash_objc, geo::_equal_objc> _revisionIdentifier;
...
@property NSMutableArray *matchedSegments; // ivar: _matchedSegments
...
@property (nonatomic) NSObject<VKRouteLineObserverProtocol> *observer; // ivar: _observer
...
-(BOOL)buildRouteLine:(id)arg0 matchToRoads:(BOOL)arg1 shouldGenerateSnapPath:(BOOL)arg2 viewUnitsPerPoint:(CGFloat)arg3 force:(BOOL)arg4 boundsInflation:(float)arg5 isGradientTraffic:(BOOL)arg6 ;
