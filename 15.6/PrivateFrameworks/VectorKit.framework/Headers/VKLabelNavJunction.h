...
@property (readonly, nonatomic) VKLabelNavRoad *incomingRoad; // ivar: _incomingRoad
...
@property (readonly, nonatomic) VKLabelNavRoad *outgoingRoad; // ivar: _outgoingRoad
@property (nonatomic) VKLabelNavJunction *overpassJunction; // ivar: _overpassJunction
