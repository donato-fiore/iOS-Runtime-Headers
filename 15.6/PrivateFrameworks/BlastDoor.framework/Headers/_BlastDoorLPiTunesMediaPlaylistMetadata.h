...
#ifndef _BLASTDOORLPITUNESMEDIAPLAYLISTMETADATA_H
#define _BLASTDOORLPITUNESMEDIAPLAYLISTMETADATA_H
...
@interface _BlastDoorLPiTunesMediaPlaylistMetadata : BlastDoorLPSpecializationMetadata
