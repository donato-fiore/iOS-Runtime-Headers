...
#ifndef _BLASTDOORLPITUNESMEDIAARTISTMETADATA_H
#define _BLASTDOORLPITUNESMEDIAARTISTMETADATA_H
...
@interface _BlastDoorLPiTunesMediaArtistMetadata : BlastDoorLPSpecializationMetadata
