...
-(id)_initWithConfigurationType:(NSUInteger)arg0 suppressionType:(NSUInteger)arg1 allowedApplicationIdentifiers:(id)arg2 deniedApplicationIdentifiers:(id)arg3 senderConfiguration:(id)arg4 minimumBreakthroughUrgency:(NSUInteger)arg5 hideApplicationBadges:(NSUInteger)arg6 compatibilityVersion:(NSInteger)arg7 ;
