...
#ifndef _TTC15SEYMOURSERVICES21SESSIONCONNECTIONPOOL_H
#define _TTC15SEYMOURSERVICES21SESSIONCONNECTIONPOOL_H

@class SwiftObject;



@interface _TtC15SeymourServices21SessionConnectionPool : SwiftObject {
    ? lock;
