...
-(id)allocStreamOutputWithStreamToken:(NSInteger)arg0 clientPid:(int)arg1 errorCode:(*int)arg2 ;
-(id)getContextIdForStreamTokenWithArguments:(id)arg0 error:(*id)arg1 ;
