...
-(id)initWithSFTranscription:(id)arg0 utteranceNumber:(unsigned int)arg1 updateNumber:(unsigned int)arg2 isLocal:(BOOL)arg3 isFinal:(BOOL)arg4 ;
-(id)initWithUtteranceNumber:(unsigned int)arg0 updateNumber:(unsigned int)arg1 isLocal:(BOOL)arg2 isFinal:(BOOL)arg3 ;
