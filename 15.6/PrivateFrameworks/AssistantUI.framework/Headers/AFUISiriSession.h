...
@class SRUIFStateMachine, AFSpeechSynthesisRecord, NSMutableSet, AFConnection, AFSettingsConnection, AFSiriClientStateManager, AFModesConfiguration, NSString, NSArray, AFAnalyticsTurnBasedInstrumentationContext, SRUIFSiriSessionInfo;
