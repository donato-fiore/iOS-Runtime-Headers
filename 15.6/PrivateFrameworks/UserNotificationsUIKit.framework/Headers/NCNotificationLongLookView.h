...
@class PLExpandedPlatterView, UITapGestureRecognizer, UIView, NSDate, NSString, UIControl, NSArray, NSAttributedString, UIImageConfiguration, MTVisualStylingProvider, UIImage, UIScrollView, NSTimeZone, UIButton;
@protocol UIGestureRecognizerDelegate, NCNotificationContentViewDelegate, NCNotificationStaticContentAccepting, NCCustomContentContainingLookView, NCNotificationLongLookViewDelegate;
