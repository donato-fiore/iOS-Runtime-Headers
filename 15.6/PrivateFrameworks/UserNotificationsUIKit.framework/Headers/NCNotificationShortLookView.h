...
@class UIView, PLPlatterView, BSUIFontProvider, UIView<NCNotificationContentDisplaying>, MTMaterialView, NSDate, NSString, NSAttributedString, UIImageConfiguration, MTVisualStylingProvider, NSArray, UIImage, NSTimeZone;
@protocol PLPlatter, NCNotificationStaticContentAccepting, NCAuxiliaryOptionsSupporting, PLContentSizeCategoryAdjusting, MTMaterialGrouping;
