...
@class UIView, UILabel, UIImageView, CAGradientLayer, UIColor, MTStylingProvidingSolidColorView, NSDate, NSString, BSUIFontProvider, NSAttributedString, UIImageConfiguration, MTVisualStylingProvider, UIImage, NSArray, NSTimeZone;
