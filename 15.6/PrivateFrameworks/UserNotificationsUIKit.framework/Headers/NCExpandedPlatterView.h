...
@class PLExpandedPlatterView, UIView, NSDate, NSString, UITapGestureRecognizer, NSAttributedString, UIImageConfiguration, MTVisualStylingProvider, NSArray, UIImage, NSTimeZone;
