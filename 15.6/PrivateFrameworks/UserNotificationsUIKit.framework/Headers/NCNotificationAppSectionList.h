...
-(BOOL)notificationGroupListShouldAllowRestacking:(id)arg0 ;
...
-(void)notificationGroupList:(id)arg0 receivedHorizontalTranslationForItemAtIndex:(NSUInteger)arg1 translation:(CGFloat)arg2 ;
