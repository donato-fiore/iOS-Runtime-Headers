...
@property (retain, nonatomic) NSString *activitySemanticIdentifier; // ivar: _activitySemanticIdentifier
@property (retain, nonatomic) WFColor *activityTintColor; // ivar: _activityTintColor
@property (retain, nonatomic) NSString *activityUniqueIdentifier; // ivar: _activityUniqueIdentifier
