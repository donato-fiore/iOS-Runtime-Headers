...
@class NSString, NSArray, NSSet, NSDictionary, INAppDescriptor, NSAttributedString, NSMutableDictionary, NSDate, NSHashTable, WFColor, WFImage, WFContentCollection, NSProgress;
