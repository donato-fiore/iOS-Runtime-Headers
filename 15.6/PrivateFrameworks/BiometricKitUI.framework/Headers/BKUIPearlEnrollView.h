...
@class UIView, UILabel, NSDate, NSString, NSTimer, AVPlayer, CAShapeLayer, UILayoutGuide, NSArray;
@protocol BKUIVideoCaptureSesssionDelegate, BKUIPearlEnrollViewDelegate;
...
-(id)initWithVideoCaptureSession:(id)arg0 inSheet:(BOOL)arg1 ;
-(id)previewLayer;
