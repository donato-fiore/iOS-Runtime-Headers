...
-(id)description;
-(id)initWithCellularPlan:(id)arg0 uuid:(id)arg1 iccid:(id)arg2 name:(id)arg3 type:(NSInteger)arg4 phoneNumber:(id)arg5 label:(id)arg6 isLocalTransferToeSIMSupported:(BOOL)arg7 isTransferred:(BOOL)arg8 transferredStatus:(NSInteger)arg9 transferredToDeviceDisplayName:(id)arg10 ;
-(id)initWithCellularPlan:(id)arg0 uuid:(id)arg1 type:(NSInteger)arg2 phoneNumber:(id)arg3 label:(id)arg4 transferredStatus:(NSInteger)arg5 transferredToDeviceDisplayName:(id)arg6 ;
-(id)initWithCoder:(id)arg0 ;
-(id)initWithIccid:(id)arg0 uuid:(id)arg1 name:(id)arg2 phoneNumber:(id)arg3 label:(id)arg4 isLocalTransferToeSIMSupported:(BOOL)arg5 isTransferred:(BOOL)arg6 transferredStatus:(NSInteger)arg7 transferredToDeviceDisplayName:(id)arg8 ;
