...
@class NSMutableDictionary, NSMutableArray, NSString, NSSet, NSDictionary, CalDiagCalendarCollectionSync, NSURL, NSArray, NSTimeZone;
...
+(BOOL)clearCalendarChanges:(struct __CFArray *)arg0 forChangeTrackingClient:(id)arg1 ;
