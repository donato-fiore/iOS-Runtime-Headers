...
@property (nonatomic) BOOL claimedOwnershipOfContacts; // ivar: _claimedOwnershipOfContacts
@property (nonatomic) BOOL claimedOwnershipOfEvents; // ivar: _claimedOwnershipOfEvents
@property (nonatomic) BOOL claimedOwnershipOfNotes; // ivar: _claimedOwnershipOfNotes
@property (retain, nonatomic) NSObject<DADataclassLockWatcher> *contactsLockHolder; // ivar: _contactsLockHolder
@property (retain, nonatomic) NSMutableArray *contactsWaiters; // ivar: _contactsWaiters
...
@property (retain, nonatomic) NSObject<DADataclassLockWatcher> *notesLockHolder; // ivar: _notesLockHolder
@property (retain, nonatomic) NSMutableArray *notesWaiters; // ivar: _notesWaiters
@property (retain, nonatomic) NSString *unitTestHackRunLoopMode; // ivar: _unitTestHackRunLoopMode
@property (retain, nonatomic) NSMutableSet *waiterIDsExpectingContactsLock; // ivar: _waiterIDsExpectingContactsLock
@property (retain, nonatomic) NSMutableSet *waiterIDsExpectingEventsLock; // ivar: _waiterIDsExpectingEventsLock
@property (retain, nonatomic) NSMutableSet *waiterIDsExpectingNotesLock; // ivar: _waiterIDsExpectingNotesLock
