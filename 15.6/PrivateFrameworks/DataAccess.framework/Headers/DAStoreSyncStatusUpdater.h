...
+(void)_updateStatusForCalendarWithExternalID:(id)arg0 lastSyncStartDate:(id)arg1 lastSyncEndDate:(id)arg2 lastSyncError:(id)arg3 canceled:(BOOL)arg4 ;
...
+(void)syncEndedForCalendarWithExternalID:(id)arg0 withError:(id)arg1 ;
+(void)syncEndedForStoreWithExternalID:(id)arg0 withError:(id)arg1 ;
+(void)syncStartedForCalendar:(id)arg0 ;
+(void)syncStartedForCalendarWithExternalID:(id)arg0 ;
