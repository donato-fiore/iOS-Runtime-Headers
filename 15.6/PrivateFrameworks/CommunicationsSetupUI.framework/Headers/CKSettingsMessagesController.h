...
@class CKBlackholeConversationListViewController, IMCTXPCServiceSubscriptionInfo, NSString, CKOnboardingController, PSSystemPolicyForApp;
...
@property (retain, nonatomic) CKBlackholeConversationListViewController *blackholeConversationListViewController; // ivar: _blackholeConversationListViewController
