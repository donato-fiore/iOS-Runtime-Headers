...
// +(void)makeJSONRepresentationForStreamWithBlock:(id)arg0 blendingPublisher:(unk)arg1 clientPublisher:(id)arg2 uiPublisher:(id)arg3 appLaunchPublisher:(id)arg4 appIntentPublisher:(id)arg5  ;
