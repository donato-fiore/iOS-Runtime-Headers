...
-(struct brc_job_update )insertOrUpdateJobID:(id)arg0 throttle:(id)arg1 withState:(int)arg2 insertedSQLColumn:(id)arg3 insertedSQLValues:(id)arg4 updatedSQLValues:(id)arg5 ;
