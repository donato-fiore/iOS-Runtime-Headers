...
@class NSNumber, NSString, BRCDirectoryItem<BRCFSRooted>, BRCLocalItem<BRCShareAcceptationFault>, BRCLocalItem<BRCTopLevelShareable>, BRCLocalItem<BRCSharedToMeTopLevel>, BRFileObjectID, BRCUserRowID, NSMutableSet, NSError;
