...
@protocol NSSecureCoding, DEDSecureArchiving, DEDUploadStatusDelegate, DEDFinisher><DEDSecureArchiving, DEDNotifier><DEDSecureArchiving, OS_dispatch_queue, DEDClientProtocol, OS_os_log, DEDWorkerProtocol;
