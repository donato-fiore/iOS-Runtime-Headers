...
@protocol ARInternalSessionObserver, ARCoachingOverlayViewDelegate, ARPrivateCoachingOverlayViewDelegate, ARSessionProviding;
...
@property (readonly, weak, nonatomic) NSObject<ARPrivateCoachingOverlayViewDelegate> *privateDelegate;
