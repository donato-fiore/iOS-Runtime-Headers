...
-(BOOL)notifySpeakServicesToFeedbackCharacter:(id)arg0 forCurrentInputMode:(id)arg1 ;
-(BOOL)notifySpeakServicesToFeedbackQuickTypePrediction:(id)arg0 forCurrentInputMode:(id)arg1 ;
-(BOOL)notifySpeakServicesToFeedbackWord:(id)arg0 forCurrentInputMode:(id)arg1 ;
