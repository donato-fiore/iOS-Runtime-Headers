...
@interface MFIMAPFetchResult : NSObject {
    ...
    NSArray""internalDate"@"NSDate""messageSize"Q"bodyStructure"@"NSArray""bodySectionInfo"{?="section"@"NSString""startOffset"Q"sectionData"@"NSData"}"uid"I"uniqueRemoteId"Q"flags"{?="messageFlags"Q"customFlags"@"NSArray"} _typeSpecific;
}
