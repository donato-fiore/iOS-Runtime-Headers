...
+(id)sendMessageData:(id)arg0 autosaveIdentifier:(id)arg1 isHMEMessage:(BOOL)arg2 completionBlock:(id)arg3 ;
-(void)_sendEmail:(id)arg0 playSound:(BOOL)arg1 completionBlock:(id)arg2 ;
-(void)_sendMessageData:(id)arg0 autosaveIdentifier:(id)arg1 isHMEMessage:(BOOL)arg2 completionBlock:(id)arg3 ;
