...
#ifndef IDSREGISTRATIONPROFILEOPERATIONAUTHENTICATEMETRIC_H
#define IDSREGISTRATIONPROFILEOPERATIONAUTHENTICATEMETRIC_H
...
-(id)initWithGuid:(id)arg0 success:(BOOL)arg1 connectionType:(unsigned int)arg2 resultCode:(unsigned int)arg3 registrationError:(unsigned int)arg4 genericError:(id)arg5 URLError:(id)arg6 POSIXError:(id)arg7 ;
