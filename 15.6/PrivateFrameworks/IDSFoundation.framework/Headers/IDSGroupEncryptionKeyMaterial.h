...
-(id)initWithIndex:(id)arg0 groupID:(id)arg1 ;
-(id)initWithKeyMaterial:(id)arg0 keySalt:(id)arg1 keyIndex:(id)arg2 groupID:(id)arg3 ;
-(id)initWithKeyMaterial:(id)arg0 keySalt:(id)arg1 keyIndex:(id)arg2 groupID:(id)arg3 generationCounter:(unsigned int)arg4 ;
-(id)initWithKeyMaterial:(id)arg0 keySalt:(id)arg1 keyIndex:(id)arg2 groupID:(id)arg3 isGeneratedLocally:(BOOL)arg4 createdAt:(id)arg5 generationCounter:(unsigned int)arg6 ;
