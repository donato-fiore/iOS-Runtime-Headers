...
@protocol ASCOfferButtonDelegate, ASCLockupPresenterView, ASCOfferPresenterView;


#import "ASCArtworkView.h"
#import "ASCLockupTheme.h"
...
@property (copy, nonatomic) ASCLockupTheme *lockupTheme; // ivar: _lockupTheme
...
+(BOOL)isOfferButtonOnlyLockupForSize:(id)arg0 ;
