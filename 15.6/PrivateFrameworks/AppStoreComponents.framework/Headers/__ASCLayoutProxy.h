...
+(CGFloat)offerButtonFixedHeight;
...
+(id)offerIconLayoutWithImageView:(id)arg0 titleView:(id)arg1 subtitleView:(id)arg2 hasTrailingSubtitle:(BOOL)arg3 shouldTopAlign:(BOOL)arg4 ;
+(id)offerTextLayoutWithTitleBackgroundView:(id)arg0 titleView:(id)arg1 subtitleView:(id)arg2 hasTrailingSubtitle:(BOOL)arg3 shouldTopAlign:(BOOL)arg4 ;
