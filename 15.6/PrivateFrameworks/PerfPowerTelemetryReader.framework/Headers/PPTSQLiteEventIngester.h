...
#ifndef PPTSQLITEEVENTINGESTER_H
#define PPTSQLITEEVENTINGESTER_H
...
-(id)initWithFilepath:(id)arg0 tableName:(id)arg1 metricNames:(id)arg2 predicate:(id)arg3 limitCount:(NSUInteger)arg4 offsetCount:(NSUInteger)arg5 convertTimestamp:(BOOL)arg6 ;
