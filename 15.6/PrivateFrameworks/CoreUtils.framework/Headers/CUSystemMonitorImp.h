...
@class NSMutableSet, NSData, TUCallCenter, CXCallObserver, NSArray, CLLocationManager, NSString, CMMotionActivityManager, CMMotionManager, CMDeviceOrientationManager, CoreTelephonyClient, RTRoutineManager, NSMutableArray, NSDictionary, FBSDisplayLayoutMonitor;
...
-(void)_motionMonitorHandleActivity:(id)arg0 ;
-(void)_motionMonitorOrientationChanged:(id)arg0 ;
...
-(void)_systemUIMonitorChangedFlags:(unsigned int)arg0 ;
