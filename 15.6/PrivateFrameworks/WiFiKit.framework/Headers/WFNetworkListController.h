...
@protocol WFHotspotInterfaceDelegate, WFNetworkListDelegate, WFAirportViewControllerDelegate, WFScanManagerDelegate, WFGasQueryControllerDelegate, WFHealthManagerDelegate, WFNetworkViewProvider, WFContextPresenting;
...
@property (nonatomic) BOOL coreWiFiEnabled; // ivar: _coreWiFiEnabled
...
@property (retain, nonatomic) WFKnownNetworksListController *knownNetworksListController; // ivar: _knownNetworksListController
...
@property (nonatomic) BOOL refreshedKnownNetworks; // ivar: _refreshedKnownNetworks
...
-(BOOL)_shouldPersistNetworkOnAssociationComplete;
...
-(id)existingProfileWithSSID:(id)arg0 ;
-(id)healthManager:(id)arg0 existingProfileForNetwork:(id)arg1 ;
...
-(id)scanManagerKnownNetworks:(id)arg0 ;
...
-(void)airportSettingsViewControllerDidTapKnownNetworks:(id)arg0 ;
