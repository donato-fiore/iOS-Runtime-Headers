...
@class UIPanGestureRecognizer, UITapGestureRecognizer, NSString, UIImageView, NSDate, CLKClockTimerToken, UIView;
@protocol NTKTimeView, NTKAstronomyRotationModelObserver, NTKAstronomyVistaViewObserver, UIGestureRecognizerDelegate;
