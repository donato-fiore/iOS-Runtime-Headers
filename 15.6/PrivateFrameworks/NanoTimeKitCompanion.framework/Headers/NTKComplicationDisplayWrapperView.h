...
@class UIControl, UIView<NTKComplicationDisplay>, UIView, CLKComplicationTemplate, NSDate, NSString;
@protocol NTKComplicationDisplayObserver, CLKSensitiveUIStateObserver, NTKControl, NTKTimeTravel, NTKComplicationDisplayWrapperViewAnimationDelegate, CLKMonochromeFilterProvider;
...
@property (readonly, nonatomic) UIView<NTKComplicationDisplay> *display; // ivar: _display
