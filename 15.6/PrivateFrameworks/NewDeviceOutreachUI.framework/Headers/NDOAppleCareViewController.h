...
@property (weak, nonatomic) NSLayoutConstraint *notNowButtonLeadingConstraint; // ivar: _notNowButtonLeadingConstraint
@property (weak, nonatomic) NSLayoutConstraint *notNowButtonTrailingConstraint; // ivar: _notNowButtonTrailingConstraint
