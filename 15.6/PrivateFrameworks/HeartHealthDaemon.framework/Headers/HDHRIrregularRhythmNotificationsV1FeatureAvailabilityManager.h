...
@protocol HDDatabaseProtectedDataObserver, HDHealthDaemonReadyObserver, HDFeatureAvailabilityExtension, HDPairedDeviceCapabilityProviding, HDRemoteFeatureAvailabilityProviding;
...
-(id)initWithProfile:(id)arg0 pairedDeviceCapabilityProvider:(id)arg1 remoteAvailabilityProvider:(id)arg2 notificationSettingDefaults:(id)arg3 ;
