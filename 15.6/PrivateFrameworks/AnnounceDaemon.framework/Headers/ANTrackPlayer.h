...
@class NSURL, AVAudioSession, NSUUID, ANTimer, NSMutableArray, AVQueuePlayer, NSString;
@protocol ANTrackPlayerDelegate, OS_dispatch_queue, OS_os_log, OS_dispatch_group;
...
@property (retain, nonatomic) NSObject<OS_dispatch_group> *playerStartGroup; // ivar: _playerStartGroup
