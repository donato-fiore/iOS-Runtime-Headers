...
@protocol ANAnalyticsDailyProtocol, ANBackgroundActivityProtocol, ANDefaultsProtocol, ANAnalyticsDailyDelegate, ANAnalyticsDailyHomesProvider, ANAnalyticsDailyMessagingProtocol;
...
@property (retain, nonatomic) NSObject<ANAnalyticsDailyHomesProvider> *homesProvider; // ivar: _homesProvider
...
-(id)init;
-(id)initWithBackgroundActivity:(id)arg0 defaults:(id)arg1 homesProvider:(id)arg2 messagingConnection:(id)arg3 ;
-(void)_cleanup;
