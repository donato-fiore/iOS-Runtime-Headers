...
-(void)invalidateCredentialForAccountWithIdentifier:(id)arg0 completion:(id)arg1 ;
...
-(void)updateAccountCredentialStateForAccountWithIdentifier:(id)arg0 state:(NSInteger)arg1 completion:(id)arg2 ;
