...
@protocol HMDNSManagedObjectBackingStoreModelObjectRepresentable, MKFApplicationData, MKFApplicationDataPrivateExtensions, MKFAccessory, MKFActionSet, MKFHome, MKFMediaSystem, MKFRoom, MKFService, MKFServiceGroup;
...
@property (readonly, retain, nonatomic) NSObject<MKFMediaSystem> *mediaSystem;
