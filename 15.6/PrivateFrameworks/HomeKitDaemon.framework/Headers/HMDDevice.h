...
@class HMFObject, HMFUnfairLock, NSSet, HMFNetService, NSArray, Protocol, NSString, NSUUID, HMFProductInfo, NSData;
@protocol HMFObject, HMFLogging, HMDBackingStoreObjectProtocol, HMCBacked, HMDBackingStoreModelBackedObjectProtocol, HMDRemoteAddressable, HMFMerging, NSSecureCoding, HMFCancellable, NSCopying;
