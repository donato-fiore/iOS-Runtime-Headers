...
-(id)initWithQueue:(id)arg0 delegate:(id)arg1 dataSource:(id)arg2 parentUUID:(id)arg3 codingKey:(id)arg4 logEventSubmitter:(id)arg5 settingOwner:(BOOL)arg6 migrationOwner:(BOOL)arg7 factory:(id)arg8 rootGroup:(id)arg9 ;
