...
@property (retain, nonatomic) HMEMemoryEventBus *registrationForwardingEventRouter; // ivar: _registrationForwardingEventRouter
...
-(BOOL)_removeAndAddKeyPair:(id)arg0 userName:(id)arg1 ;
...
-(id)_updatePrimaryHome:(id)arg0 message:(*id)arg1 ;
...
-(id)updateDeviceCapabilitiesOfDeviceWithIdentifier:(id)arg0 ;
...
-(void)_handleAppleMediaMessage:(id)arg0 ;
...
-(void)_loadMessageDispatcher:(id)arg0 accessoryBrowser:(id)arg1 messageFilterChain:(id)arg2 homeData:(id)arg3 localDataDecryptionFailed:(BOOL)arg4 identityRegistry:(id)arg5 accountRegistry:(id)arg6 uncommittedTransactions:(id)arg7 reloadData:(BOOL)arg8 ;
...
-(void)dmKickClients;
-(void)dmMigrateHomeData:(id)arg0 ;
...
-(void)handleHomeLocationChanged:(id)arg0 ;
...
-(void)homeModelHomeDelete:(id)arg0 ;
-(void)homeModelHomeUpdate:(id)arg0 ;
