...
#ifndef AWDHOMEKITSOFTWAREUPDATESTARTED_H
#define AWDHOMEKITSOFTWAREUPDATESTARTED_H
...
@property (nonatomic) BOOL isAutomaticUpdateEnabled; // ivar: _isAutomaticUpdateEnabled
