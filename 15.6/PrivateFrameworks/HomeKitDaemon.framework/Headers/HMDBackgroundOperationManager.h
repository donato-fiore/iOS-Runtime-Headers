...
@class HMFObject, HMFUnfairLock, NSString, HMFTimer, NSMutableArray, HAPPairingIdentity, NSOperationQueue;
...
-(void)auditKeyChainEntriesAndScheduleKeyRollOperationsIfNecessaryForHome:(id)arg0 ;
-(void)auditKeyChainEntryForAccessory:(id)arg0 ;
...
-(void)registerForNotifications:(BOOL)arg0 ;
...
-(void)scheduleHH2KeyRollOperationForHome:(id)arg0 isResident:(BOOL)arg1 ;
