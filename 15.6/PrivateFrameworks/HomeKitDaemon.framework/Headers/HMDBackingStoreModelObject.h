...
@class HMFObject, NSMutableDictionary, HMFVersion, CKRecord, NSString, NSSet, NSManagedObject<HMDNSManagedObjectBackingStoreModelObjectRepresentable>, NSUUID;
...
@property (retain, nonatomic) HMFVersion *bsoDataVersion; // ivar: _bsoDataVersion
...
@property (retain, nonatomic) NSManagedObject<HMDNSManagedObjectBackingStoreModelObjectRepresentable> *managedObject; // ivar: _managedObject
...
+(BOOL)cd_addChild:(id)arg0 excluding:(id)arg1 toSet:(id)arg2 error:(*id)arg3 ;
+(BOOL)cd_addChildren:(id)arg0 excluding:(id)arg1 toSet:(id)arg2 error:(*id)arg3 ;
...
-(BOOL)cd_populateFromManagedObject:(id)arg0 error:(*id)arg1 ;
...
-(id)cd_fetchParentForManagedObjectUsingParentReferenceName:(id)arg0 error:(*id)arg1 ;
...
-(id)cd_uuidValueFromStringModelObjectField:(id)arg0 ;
...
-(id)initWithManagedObject:(id)arg0 changeType:(NSUInteger)arg1 detached:(BOOL)arg2 error:(*id)arg3 ;
