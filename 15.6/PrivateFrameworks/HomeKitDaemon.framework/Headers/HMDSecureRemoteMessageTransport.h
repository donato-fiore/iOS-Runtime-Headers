...
@property (readonly) HMDRemoteMessageTransport *modernTransport; // ivar: _modernTransport
...
-(id)dumpState;
-(id)initWithLegacyTransports:(id)arg0 modernTransport:(id)arg1 reachabilityObserver:(id)arg2 ;
