...
@class HMFObject, Protocol, NSString, NSUUID;
@protocol HMDBackingStoreObjectProtocol, HMDBackingStoreModelBackedObjectProtocol, HMFLogging, HMCBacked, NSCopying, NSSecureCoding;
