...
@class MKFAccessory, NSNumber, NSArray, NSSet, NSString, NSUUID, NSData, NSDate;
@protocol HMDNSManagedObjectBackingStoreModelObjectRepresentable, MKFMediaAccessory, MKFMediaAccessoryPrivateExtensions, MKFAssistantAccessControl, MKFApplicationData, MKFHome, MKFAccessory, MKFRoom, MKFSoftwareUpdate;


#import "MKFMediaAccessoryDatabaseID.h"

@interface _MKFMediaAccessory : MKFAccessory <HMDNSManagedObjectBackingStoreModelObjectRepresentable, MKFMediaAccessory, MKFMediaAccessoryPrivateExtensions>
