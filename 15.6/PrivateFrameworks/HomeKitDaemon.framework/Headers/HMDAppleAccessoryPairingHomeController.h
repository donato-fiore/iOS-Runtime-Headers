...
@protocol HMBLocalZoneModelObserver, HMFTimerDelegate;
...
@property (readonly, nonatomic) HMDAppleAccessoryPairingControllerDataSource *dataSource; // ivar: _dataSource
