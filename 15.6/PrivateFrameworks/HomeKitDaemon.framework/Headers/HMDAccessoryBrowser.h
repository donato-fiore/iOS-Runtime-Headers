...
@class HMFObject, HMFUnfairLock, NSMutableSet, NSHashTable, NSMutableArray, NSArray, HAPAccessoryServerBrowserBTLE, CHIPAccessoryServerBrowser, NSString, HAPAccessoryServerBrowser, HAPAccessoryServerBrowserIP, HMFMessageDispatcher, NSUUID, HMFTimer, NSData;
