...
typedef struct _HMDStructuredDataToken {
    NSInteger type;
    id value;
} _HMDStructuredDataToken;

typedef struct CloudShareTrustManagerTrustStatusCounts {
    NSInteger field0;
    NSUInteger field1;
    NSUInteger field2;
    NSUInteger field3;
    ...
    NSUInteger field6;
    NSUInteger field7;
} CloudShareTrustManagerTrustStatusCounts;
...
typedef struct HMDWatchConnectivityLogEventManagerSnapshot {
    BOOL field0;
    NSUInteger field1;
    NSUInteger field2;
} HMDWatchConnectivityLogEventManagerSnapshot;
