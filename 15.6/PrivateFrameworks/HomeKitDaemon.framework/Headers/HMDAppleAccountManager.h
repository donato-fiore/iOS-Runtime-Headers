...
@class HMFObject, HMFUnfairLock, HMFExponentialBackoffTimer, ACAccountStore, NSString, HMFFuture, HMFPromise, HMFTimer, NSUUID, APSConnection, IDSService;
@protocol APSConnectionDelegate, HMDAccountManager, HMFLogging, HMFMessageReceiver, HMFTimerDelegate, IDSAccountDelegate, IDSAccountRegistrationDelegate, IDSServiceDelegate, OS_dispatch_queue;
...
@property (readonly, nonatomic) APSConnection *pushConnection; // ivar: _pushConnection
