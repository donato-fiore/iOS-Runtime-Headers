...
@protocol HMFMessageTransportDelegate, HMDDateProvider, HMDModernRemoteMessageTransportReachabilityDelegate, HMDTimerProvider, OS_dispatch_queue;
...
@property (weak) NSObject<HMDModernRemoteMessageTransportReachabilityDelegate> *reachabilityDelegate; // ivar: _reachabilityDelegate
