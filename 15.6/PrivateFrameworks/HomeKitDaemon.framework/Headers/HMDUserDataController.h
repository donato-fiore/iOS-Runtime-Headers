...
@class NSArray, NSMutableSet, HMBModel, NSUUID, NSString, HMFUnfairLock, NSNotificationCenter, NSDictionary, HMFTimer;
@protocol HMDAssistantAccessControlModelUpdateReceiver, HMDMediaContentProfileAccessControlModelUpdateReceiver, HMDUserListeningHistoryUpdateControlModelUpdateReceiver, HMDSharedUserDataModelUpdateReceiver, HMFLogging, HMFTimerDelegate, OS_dispatch_queue, HMDUserDataControllerDataSource, HMDUserDataControllerDelegate, HMDSettingsControllerProtocol, HMDUserDataControllerTimerCreator;
