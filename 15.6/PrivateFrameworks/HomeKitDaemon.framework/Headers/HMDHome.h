...
@property (readonly, copy) NSString *debugDescription;
@property (readonly, copy) NSString *debugDescription;
@property (readonly) HMEDelegatingEventRouter *delegatingEventRouter; // ivar: _delegatingEventRouter
...
-(BOOL)doesAllBulletinRegistrationsHaveSameDeviceIdentifier:(id)arg0 disabledRegistrations:(id)arg1 ;
-(BOOL)doesBulletinNotificationFileExistOnDisk;
-(BOOL)enableBulletinRegistrations:(id)arg0 device:(id)arg1 context:(id)arg2 ;
...
-(BOOL)insertOrUpdateCameraAccessModeBulletinRegistration:(id)arg0 managedBulletinRegistration:(id)arg1 accessory:(id)arg2 device:(id)arg3 context:(id)arg4 ;
-(BOOL)insertOrUpdateCameraReachabilityBulletinRegistration:(id)arg0 managedBulletinRegistration:(id)arg1 accessory:(id)arg2 device:(id)arg3 context:(id)arg4 ;
-(BOOL)insertOrUpdateCameraSignificantEventBulletinRegistration:(id)arg0 managedBulletinRegistration:(id)arg1 accessory:(id)arg2 device:(id)arg3 context:(id)arg4 ;
-(BOOL)insertOrUpdateCharacteristicBulletinRegistration:(id)arg0 managedBulletinRegistration:(id)arg1 accessory:(id)arg2 device:(id)arg3 context:(id)arg4 ;
...
-(id)deviceWithIdentifier:(id)arg0 forRemoteEventRouterClientController:(id)arg1 ;
...
-(id)findBulletinRegistration:(id)arg0 device:(id)arg1 context:(id)arg2 ;
...
// -(id)initWithName:(id)arg0 uuid:(id)arg1 defaultRoomUUID:(id)arg2 owner:(id)arg3 homeManager:(id)arg4 presenceAuth:(id)arg5 metricsDispatcherFactory:(id)arg6 logEventSubmitter:(id)arg7 currentUserFactory:(id)arg8 residentDeviceManagerFactory:(unk)arg9 locationHandlerFactory:(id)arg10 hapMetadata:(unk)arg11 siriSecureAccessoryAccessController:(id)arg12 carPlayDataSource:(unk)arg13 deviceLockStateDataSource:(id)arg14 notificationRegistry:(id)arg15 administratorHandlerFactory:(id)arg16 xpcMessageTransportFactory:(id)arg17 notificationCenter:(id)arg18  ;
...
-(id)owner;
-(id)payloadFromEnableRegistrations:(id)arg0 disableRegistration:(id)arg1 ;
...
-(id)routerClientResidentManagerForRemoteEventRouterClientController:(id)arg0 ;
...
-(void)_handleRemoteAddAccessories:(id)arg0 ;
...
-(void)_performRemoteAddAccessories:(id)arg0 ;
...
-(void)_retrieveHAPAccessoryForHMDAccessory:(id)arg0 linkType:(NSInteger)arg1 forceRetrieve:(BOOL)arg2 queue:(id)arg3 completion:(id)arg4 ;
...
-(void)dealloc;
-(void)disableBulletinRegistrations:(id)arg0 device:(id)arg1 context:(id)arg2 ;
...
-(void)handleBulletinRegistrationUpdateMessage:(id)arg0 forDevice:(id)arg1 enableNotifications:(id)arg2 disableNotifications:(id)arg3 context:(id)arg4 ;
...
-(void)updateBulletinRegistrationOnPrimaryResident:(id)arg0 disableRegistration:(id)arg1 completionHandler:(id)arg2 ;
