...
@protocol HMDNSManagedObjectBackingStoreModelObjectRepresentable, MKFAccessory, MKFAccessoryPrivateExtensions, MKFAssistantAccessControl, MKFApplicationData, MKFHome, MKFRoom, MKFSoftwareUpdate;


#import "_MKFAssistantAccessControl.h"
...
-(id)castIfAccessory;
-(id)materializeOrCreateAccessControlRelation:(*BOOL)arg0 ;
