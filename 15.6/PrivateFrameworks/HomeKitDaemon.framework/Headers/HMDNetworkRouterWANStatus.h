...
#ifndef HMDNETWORKROUTERWANSTATUS_H
#define HMDNETWORKROUTERWANSTATUS_H
...
@property (retain, nonatomic) HAPTLVUnsignedNumberValue *status; // ivar: _status
...
-(id)init;
-(id)initWithIdentifier:(id)arg0 status:(id)arg1 ;
