...
@property (retain, nonatomic) NSObject<HMDEventCounterContext> *context; // ivar: _context
@property (readonly, nonatomic) NSDictionary *eventCounters;
@property (retain, nonatomic) NSMutableDictionary *mutableEventCounters; // ivar: _mutableEventCounters
