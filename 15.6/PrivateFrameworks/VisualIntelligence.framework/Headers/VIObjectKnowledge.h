...
-(id)initWithKnowledgeGraphID:(id)arg0 title:(id)arg1 thumbnailURL:(id)arg2 thumbnailAspectRatio:(float)arg3 shortDescription:(id)arg4 detailedDescription:(id)arg5 webURL:(id)arg6 knowledgeProperties:(id)arg7 ;
