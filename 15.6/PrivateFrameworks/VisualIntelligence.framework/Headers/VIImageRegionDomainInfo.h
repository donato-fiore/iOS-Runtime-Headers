...
-(id)initWithDomainKey:(id)arg0 labelName:(id)arg1 glyphName:(id)arg2 displayLabel:(id)arg3 displayMessage:(id)arg4 hasFocalPoint:(BOOL)arg5 focalPoint:(struct CGPoint )arg6 ocrResultsRequired:(BOOL)arg7 ;
