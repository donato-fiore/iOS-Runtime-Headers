...
@property (copy, nonatomic) id *authorizationBlock; // ivar: _authorizationBlock
...
// -(void)authenticateWithAuthorizationBlock:(id)arg0 preferRegistration:(unk)arg1 completion:(BOOL)arg2  ;
-(void)authenticatorDidAuthenticateWithCredentials:(id)arg0 authInfo:(id)arg1 ;
-(void)authenticatorDidFailWithError:(id)arg0 ;
-(void)authenticatorShouldShowAuthorizationUIWithURL:(id)arg0 callbackPrefix:(id)arg1 completionBlock:(id)arg2 ;
