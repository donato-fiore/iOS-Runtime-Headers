...
-(void)startArbitrationWithExpectedState:(id)arg0 sceneIdentity:(id)arg1 hostingPIDs:(id)arg2 usingFence:(BOOL)arg3 withSuppression:(int)arg4 onConnected:(id)arg5 ;
