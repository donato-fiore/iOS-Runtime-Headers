...
@class NSString;
@protocol CLSCurationModel, CLSAssetProcessedSignals;
...
+(BOOL)maximumAllowedAnalysisVersionsAreMatchedBySpecification:(id)arg0 ;
+(BOOL)minimumRequiredAnalysisVersionsAreMatchedBySpecification:(id)arg0 ;
+(NSUInteger)maximumAllowedFaceAnalysisVersion;
+(NSUInteger)maximumAllowedMediaAnalysisVersion;
+(NSUInteger)maximumAllowedSceneAnalysisVersion;
+(NSUInteger)minimumRequiredFaceAnalysisVersion;
+(NSUInteger)minimumRequiredMediaAnalysisVersion;
...
-(BOOL)isBadQualityForImageKeyAssetWithAsset:(id)arg0 ;
-(BOOL)isBlurryWithAsset:(id)arg0 ;
-(BOOL)isGoldWithAsset:(id)arg0 ;
-(BOOL)isIVSNSFWExplicitWithAsset:(id)arg0 ;
