...
-(id)initWithArticle:(id)arg0 issue:(id)arg1 articleViewControllerFactory:(id)arg2 settings:(id)arg3 errorMessageFactory:(id)arg4 analyticsReporting:(id)arg5 contentSizeManager:(id)arg6 ;
