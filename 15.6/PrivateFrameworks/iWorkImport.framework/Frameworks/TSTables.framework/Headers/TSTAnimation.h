...
@property (weak, nonatomic) TSTLayout *layout; // ivar: mLayout
...
+(NSUInteger)p_NumberOfCellBuilds:(id)arg0 ;
+(NSUInteger)p_NumberOfColumnBuilds:(id)arg0 ;
+(NSUInteger)p_NumberOfRowBuilds:(id)arg0 ;
+(NSUInteger)p_stageCountForProvider:(id)arg0 withAnimationKind:(int)arg1 ;
+(NSUInteger)stageCountForTextureDeliveryStyle:(NSUInteger)arg0 tableProvider:(id)arg1 ;
+(NSUInteger)textureDeliveryStyleFromDeliveryString:(id)arg0 ;
+(id)newAnimationWithLayout:(id)arg0 andCellRange:(struct TSUCellRect )arg1 ;
+(id)newAnimationWithLayout:(id)arg0 andDeliveryStyle:(NSUInteger)arg1 ;
+(id)textureDeliveryStylesLocalized:(BOOL)arg0 ;
-(BOOL)isHidingContentOfCellID:(struct TSUCellCoord )arg0 ;
-(id)copyWithZone:(struct _NSZone *)arg0 ;
-(struct TSUCellRect )cellRangeAtIndex:(NSUInteger)arg0 ;
-(void)addCellRange:(struct TSUCellRect )arg0 ;
