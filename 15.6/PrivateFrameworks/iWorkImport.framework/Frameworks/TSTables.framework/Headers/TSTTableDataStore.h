...
@class TSPContainedObject, TSPLazyReference, TSKCustomFormatList, NSMutableDictionary;
...
-(id)p_addPasteboardCustomFormat:(id)arg0 toDocument:(id)arg1 updatingPasteboardFormat:(BOOL)arg2 ;
...
-(id)populatedCustomFormat:(id)arg0 value:(CGFloat)arg1 ;
...
-(void)addPasteboardCustomFormatFromCell:(id)arg0 ;
...
-(void)resolveDataListKeysForCell:(id)arg0 suppressTransmutation:(BOOL)arg1 sourceStorageVersion:(unsigned char)arg2 ;
