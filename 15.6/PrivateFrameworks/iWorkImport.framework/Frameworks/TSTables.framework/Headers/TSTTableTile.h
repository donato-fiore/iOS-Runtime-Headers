...
-(NSInteger)setCell:(id)arg0 atColumnIndex:(unsigned short)arg1 tileRowIndex:(unsigned int)arg2 formatKeys:(struct ? *)arg3 ;
-(id)description;
...
-(struct TSTCellStorage *)preBNCCellStorageRefAtColumnIndex:(unsigned short)arg0 tileRowIndex:(unsigned int)arg1 ;
