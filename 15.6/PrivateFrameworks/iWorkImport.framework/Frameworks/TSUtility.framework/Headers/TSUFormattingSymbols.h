...
-(id)p_negativeNumberKeyForNumberStyle:(unsigned int)arg0 negativeStyle:(unsigned char)arg1 ;
-(id)patternStringForDateStyle:(NSUInteger)arg0 timeStyle:(NSUInteger)arg1 ;
-(id)patternStringForNumberStyle:(unsigned int)arg0 negativeStyle:(unsigned char)arg1 ;
