...
@property (copy, nonatomic) NSString *printTitle; // ivar: _printTitle
...
@property (nonatomic, getter=isPrintingDraftQuality) BOOL printingDraftQuality; // ivar: _printingDraftQuality
...
@property (nonatomic, getter=isPrintingSlideBackgroundsWithAlpha) BOOL printingSlideBackgroundsWithAlpha; // ivar: _printingSlideBackgroundsWithAlpha
