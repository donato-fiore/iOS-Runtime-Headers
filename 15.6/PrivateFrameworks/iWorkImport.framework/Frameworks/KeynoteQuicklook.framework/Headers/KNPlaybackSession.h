...
@class NSMutableArray, CALayer, TSKAccessController, KNAnimationTestResultLogger, TSDBitmapRenderingQualityInfo, NSArray, NSString, TSULRUCache, TSDMPSImageConversionStorage, TSDGLLayer;
...
@property (readonly, nonatomic) TSULRUCache *movieAssetCache; // ivar: _movieAssetCache
