...
@protocol UIStateRestoring, UIManagedConfigurationRestrictableActivity, UIPeopleSuggestionRecipientActivity;


#import "UIActivity.h"

@interface UIMailActivity : UIActivity <UIStateRestoring, UIManagedConfigurationRestrictableActivity, UIPeopleSuggestionRecipientActivity>
