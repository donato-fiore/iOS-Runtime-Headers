...
@class UIImageSymbolConfiguration, UIColor, NSAttributedString, UITraitCollection;
...
@property (readonly, nonatomic) UIColor *customHeaderButtonColor; // ivar: _customHeaderButtonColor
@property (readonly, nonatomic) NSAttributedString *customHeaderButtonTitle; // ivar: _customHeaderButtonTitle
...
-(id)_createCustomHeaderButtonColor;
-(id)_createCustomHeaderButtonTitle;
