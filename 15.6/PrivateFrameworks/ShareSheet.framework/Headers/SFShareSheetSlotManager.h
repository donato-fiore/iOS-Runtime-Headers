...
-(void)connectToDaemonWithSessionID:(id)arg0 discoveryContext:(id)arg1 assetIdentifiers:(id)arg2 urlsBeingShared:(id)arg3 shouldSuggestFamilyMembers:(id)arg4 isSharePlayAvailable:(id)arg5 completionHandler:(id)arg6 ;
