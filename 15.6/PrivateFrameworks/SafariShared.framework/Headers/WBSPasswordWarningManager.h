...
@class WBSSavedAccountStore, NSUserDefaults, NSMutableSet, NSArray, NSMapTable, NSString, WBSPasswordAuditor;
...
-(id)initWithSavedAccountStore:(id)arg0 autoFillQuirksManager:(id)arg1 userDefaults:(id)arg2 history:(id)arg3 ;
