...
@class WBSURLCredentialCache, WBSKeychainCredentialNotificationMonitor, NSMutableDictionary, NSMutableArray, WBSPair, WBSAutoFillQuirksManager;
...
+(id)valuesFromCredential:(id)arg0 forLoginOrChangePasswordForm:(id)arg1 ;
...
-(BOOL)shouldSubmitForm:(id)arg0 withCredential:(id)arg1 onURL:(id)arg2 ;
...
-(id)_knownUsernamesForURL:(id)arg0 ;
-(id)_lastUsedUsernameForDomain:(id)arg0 protectionSpace:(*id)arg1 ;
...
-(id)annotationsFromCredential:(id)arg0 forLoginOrChangePasswordForm:(id)arg1 ;
...
-(id)credentialMatchesForForm:(id)arg0 atURL:(id)arg1 potentialMatches:(*id)arg2 ;
...
-(id)lastUsedUsernameForURL:(id)arg0 ;
-(id)lastUsedUsernameForURL:(id)arg0 protectionSpace:(*id)arg1 ;
...
-(void)credentialMatchesWithCriteria:(id)arg0 completionHandler:(id)arg1 ;
-(void)dealloc;
-(void)didAutomaticallySubmitFormWhenFillingOnURL:(id)arg0 formMetadata:(id)arg1 ;
-(void)domainsWithPreviousDataChanged;
-(void)getCredentialMatches:(*id)arg0 andPotentialMatches:(*id)arg1 forURL:(id)arg2 matchingPartialUsername:(id)arg3 omittingCredentialsUserHasDeniedAccessTo:(BOOL)arg4 ;
-(void)getCredentialMatches:(*id)arg0 andPotentialMatches:(*id)arg1 matchesForAssociatedDomains:(*id)arg2 forURL:(id)arg3 matchingPartialUsername:(id)arg4 ;
-(void)getCredentialMatches:(*id)arg0 andPotentialMatches:(*id)arg1 matchesForAssociatedDomains:(*id)arg2 forURL:(id)arg3 matchingPartialUsername:(id)arg4 omittingCredentialsUserHasDeniedAccessTo:(BOOL)arg5 ;
...
-(void)searchForCredentialUsingDomainsToConsiderIdentical:(id)arg0 URL:(*id)arg1 hostForCredentials:(*id)arg2 credential:(*id)arg3 protectionSpace:(*id)arg4 ;
