...
-(id)initWithStoreFront:(id)arg0 locale:(id)arg1 contentSizeCategory:(id)arg2 canvasSize:(struct CGSize )arg3 contentFrame:(struct CGRect )arg4 dataSources:(id)arg5 location:(id)arg6 sourceURL:(id)arg7 activePictureInPictureURL:(id)arg8 ;
