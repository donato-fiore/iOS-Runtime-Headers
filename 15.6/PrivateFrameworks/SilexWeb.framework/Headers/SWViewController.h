...
@class UIViewController, NSString, WKWebView;
@protocol WKNavigationDelegate, WKUIDelegate, _WKFullscreenDelegate, SWURLSchemeHandlerManager, SWContentRuleManager, SWDatastoreSynchronizationManager, SWDocumentStateReporting, SWErrorReporting, SWLogger, SWMessageHandlerManager, SWNavigationManager, SWReachabilityProvider, SWScriptsManager, SWSessionManager, SWSetupManager, SWProcessTerminationManager, SWTimeoutManager;
