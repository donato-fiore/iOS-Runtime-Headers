...
#ifndef PFDISPATCHQUEUEEXTENSIONMANAGER_H
#define PFDISPATCHQUEUEEXTENSIONMANAGER_H
...
@interface PFDispatchQueueExtensionManager : NSObject <PFDispatchQueueExtending>
 ...
 {
    uint8_t _enabledExtensionCount;
    PFDispatchQueueExtension" _extensions;
    uint8_t _extensionEnabled;
...
-(void)addExtensions:(id)arg0 queue:(id)arg1 ;
-(void)disableExtension:(id)arg0 ;
-(void)enableExtension:(id)arg0 ;
-(void)installOnQueue:(id)arg0 ;
-(void)messageExtensions:(id)arg0 messageBlock:(id)arg1 ;
