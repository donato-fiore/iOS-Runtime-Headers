...
+(id)unitTestBitValueMapDirectoryPath:(id)arg0 ;
+(id)unitTestDatabaseDirectoryPath:(id)arg0 ;
+(id)unitTestInputDirectoryPath;
+(id)unitTestOutputDirectoryPath;
+(id)unitTestReportsDirectoryPath:(id)arg0 ;
+(id)unitTestRuntimeBlacklistDirectoryPath:(id)arg0 ;
+(id)unitTestSystemBlacklistDirectoryPath:(id)arg0 ;
