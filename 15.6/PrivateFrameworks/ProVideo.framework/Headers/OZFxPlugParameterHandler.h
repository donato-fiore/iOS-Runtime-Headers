...
-(?)retrieveImage:(?)arg0 layerOffsetX:(?)arg1 layerOffsetY:(?)arg2 requestInfo:(?)arg3 fromParm:(?)arg4 atTime:(?)arg5 retrieverimageType;
...
-(struct CGColorSpace *)getPluginColorSpaceAtTime:(struct ? )arg0 ;
...
-(void)getColorInFxPlugColorSpace:(struct PCColor *)arg0 red:(*float)arg1 green:(*float)arg2 blue:(*float)arg3 alpha:(*float)arg4 atTime:(struct ? )arg5 ;
...
-(void)setColorFromFxPlugColorSpace:(struct PCColor *)arg0 red:(float)arg1 green:(float)arg2 blue:(float)arg3 alpha:(float)arg4 atTime:(struct ? )arg5 ;
