...
@class NSString, EFCancelationToken, EFStoppableScheduler<EFAssertableScheduler>, NSMutableSet, NSMutableArray, EFStoppableScheduler<EFSuspendableScheduler><EFAssertableScheduler>, EFStoppableScheduler, EFLazyCache, EFFuture, EFObservable;
@protocol EDSearchableIndexShimDelegate, EDSearchableIndexVerifierDataSource, EFLoggable, EFSignpostable, EDSearchableIndexSchedulable, EMSearchableIndexInterface, EFCancelable, OS_os_activity, EDSearchableIndexDataSource, EDSearchableIndexReasonProvider, EDSearchableIndexSchedulableDelegate, EDSearchIndexablePrivate;
...
@property (retain, nonatomic) NSObject<EDSearchIndexablePrivate> *searchIndex; // ivar: _searchIndex
...
-(id)exclusionReasons;
-(id)identifiersMatchingCriterion:(id)arg0 ;
