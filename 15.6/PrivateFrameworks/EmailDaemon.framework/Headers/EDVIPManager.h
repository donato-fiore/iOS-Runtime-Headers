...
@protocol EFLoggable, EMVIPManager, EDAccountsProvider, OS_dispatch_queue;
...
-(id)initWithDirectoryURL:(id)arg0 accountsProvider:(id)arg1 ;
-(id)initWithDirectoryURL:(id)arg0 keyValueStore:(id)arg1 accountsProvider:(id)arg2 contactStore:(id)arg3 ;
