...
@protocol EDDatabaseChangeHookResponder, EDAccountChangeHookResponder, EDMailboxChangeHookResponder, EDMessageChangeHookResponder, EDProtectedDataReconciliationHookResponder, EDThreadScopeManagerDataSource, EFSignpostable, EDPersistenceDatabaseSchemaProvider, EFLoggable, EFScheduler, EMVIPManager;
...
-(BOOL)_addThreadScopeToDatabase:(id)arg0 withMailboxDatabaseID:(NSInteger)arg1 needsUpdate:(BOOL)arg2 lastViewedDate:(id)arg3 updateThreadScopeManager:(BOOL)arg4 connection:(id)arg5 ;
-(BOOL)_addThreadScopeToDatabaseWithMailboxType:(id)arg0 needsUpdate:(BOOL)arg1 lastViewedDate:(id)arg2 connection:(id)arg3 ;
...
-(id)_addressesFromSelectStatement:(id)arg0 ;
...
-(id)_recipientDatabaseIDsAndDatesForMessages:(id)arg0 recipientType:(NSUInteger)arg1 ;
-(id)_recipientDatabaseIDsAndDatesForThreadWithObjectID:(id)arg0 recipientType:(NSUInteger)arg1 ;
-(id)_recipientDatabaseIDsAndDatesForWrappedMessages:(id)arg0 recipientType:(NSUInteger)arg1 ;
...
-(id)_senderDatabaseIDsAndDatesForMessages:(id)arg0 ;
-(id)_senderDatabaseIDsAndDatesForThreadWithObjectID:(id)arg0 ;
-(id)_senderDatabaseIDsAndDatesForWrappedMessages:(id)arg0 ;
-(id)_sendersForThreadDatabaseID:(id)arg0 ;
...
-(id)_wrappedMessageForPersistedMessages:(id)arg0 threadScope:(id)arg1 ;
-(id)_wrappedMessagesByThreadScopeForPersistedMessages:(id)arg0 ;
...
-(void)_iterateWrappedMessagesByConversationForPersistedMessages:(id)arg0 writeBlock:(id)arg1 ;
