...
@property (nonatomic) float endRouteCoordinateOffset; // ivar: _endRouteCoordinateOffset
...
@property (nonatomic) float startRouteCoordinateOffset; // ivar: _startRouteCoordinateOffset
