...
@property (readonly, nonatomic) NSUInteger impossibleActionsCount;
...
-(id)impossibleActionsAsString:(int)arg0 ;
-(id)init;
...
-(int)StringAsImpossibleActions:(id)arg0 ;
-(int)StringAsPlacecardType:(id)arg0 ;
-(int)StringAsPossibleActions:(id)arg0 ;
-(int)impossibleActionAtIndex:(NSUInteger)arg0 ;
-(int)possibleActionAtIndex:(NSUInteger)arg0 ;
-(void)addImpossibleAction:(int)arg0 ;
