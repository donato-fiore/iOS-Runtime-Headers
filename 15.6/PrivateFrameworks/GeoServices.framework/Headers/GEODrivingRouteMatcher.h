...
-(CGFloat)_maxMatchDistance:(CGFloat)arg0 routeCoordinate:(struct PolylineCoordinate )arg1 previousRouteMatch:(id)arg2 timeSinceTunnel:(CGFloat)arg3 ;
-(CGFloat)_modifiedCourseAccuracyForLocation:(id)arg0 previousRouteMatch:(id)arg1 ;
-(CGFloat)_modifiedHorizontalAccuracy:(CGFloat)arg0 routeCoordinate:(struct PolylineCoordinate )arg1 ;
-(CGFloat)_roadWidthForRouteCoordinate:(struct PolylineCoordinate )arg0 ;
