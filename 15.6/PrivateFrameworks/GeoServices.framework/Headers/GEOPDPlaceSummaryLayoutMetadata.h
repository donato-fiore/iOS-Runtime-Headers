...
-(id)dyanmicContextServerOverrideAtIndex:(NSUInteger)arg0 ;
-(id)init;
-(id)initWithData:(id)arg0 ;
-(id)initWithDictionary:(id)arg0 ;
-(id)initWithJSON:(id)arg0 ;
-(id)jsonRepresentation;
-(id)layoutTemplatePairAtIndex:(NSUInteger)arg0 ;
-(id)useCaseTypeAsString:(int)arg0 ;
-(int)StringAsUseCaseType:(id)arg0 ;
-(void)addDyanmicContextServerOverride:(id)arg0 ;
-(void)addLayoutTemplatePair:(id)arg0 ;
