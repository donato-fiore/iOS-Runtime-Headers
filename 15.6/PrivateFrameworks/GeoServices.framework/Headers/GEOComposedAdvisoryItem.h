...
#ifndef GEOCOMPOSEDADVISORYITEM_H
#define GEOCOMPOSEDADVISORYITEM_H

@class NSArray, NSDate;
@protocol NSSecureCoding, NSCopying, GEOServerFormattedString, GEOTransitIncident;
...
@property (readonly, nonatomic) NSObject<GEOTransitIncident> *transitIncident; // ivar: _transitIncident
...
-(id)description;
-(id)initWithAdvisoryCard:(id)arg0 ;
