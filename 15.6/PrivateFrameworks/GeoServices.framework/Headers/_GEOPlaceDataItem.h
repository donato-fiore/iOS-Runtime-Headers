...
@class NSMapTable, NSData, geo_isolater, NSArray, NSString, NSDictionary, geo_reentrant_isolater, NSTimeZone, NSDate, NSURL;
@protocol GEOMapItem, GEOMapItemVenueInfo, GEOAnnotatedItemList, GEOEncyclopedicInfo, GEOTransitAttribution, GEOMapItemTransitInfo, GEOTransitVehiclePosition;
...
-(id)_mapItemBySettingIsTransitDisplayFeature:(BOOL)arg0 ;
...
-(id)addressObject;
-(id)initWithPlaceData:(id)arg0 ;
-(id)initWithPlaceData:(id)arg0 attributionMap:(id)arg1 disambiguationLabel:(id)arg2 detourInfo:(id)arg3 externalTransitStationCode:(id)arg4 additionalPlaces:(id)arg5 ;
-(id)initWithPlaceData:(id)arg0 detourInfo:(id)arg1 ;
-(id)initWithPlaceData:(id)arg0 detourInfo:(id)arg1 additionalPlaceDatas:(id)arg2 ;
-(id)shortAddress;
