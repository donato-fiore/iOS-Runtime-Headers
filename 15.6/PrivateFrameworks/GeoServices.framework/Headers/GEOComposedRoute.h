...
@property (readonly, nonatomic) GEOComposedRouteAdvisory *advisoryMessage; // ivar: _advisoryMessage
...
@property (readonly, nonatomic) GEOComposedRouteAdvisory *evAdvisory; // ivar: _evAdvisory
...
@property (readonly, nonatomic) NSArray *genericAdvisories; // ivar: _genericAdvisories
...
@property (readonly, nonatomic) NSArray *incidentsAdvisories; // ivar: _incidentsAdvisories
...
@property (readonly, nonatomic) NSArray *noticesAdvisories; // ivar: _noticesAdvisories
...
@property (readonly, nonatomic) NSArray *roadComplexities; // ivar: _roadComplexities
...
@property (readonly, nonatomic) GEOComposedRouteAdvisory *tollAdvisory; // ivar: _tollAdvisory
...
@property (readonly, nonatomic) NSArray *transitAdvisories; // ivar: _transitAdvisories
...
-(CGFloat)approximateRoadWidthAtPointIndex:(unsigned int)arg0 ;
...
-(id)geoETAWaypointRouteFromRouteCoordinate:(struct PolylineCoordinate )arg0 includeOriginWaypointInfo:(BOOL)arg1 ;
...
-(id)roadComplexitiesForRouteCoordinate:(struct PolylineCoordinate )arg0 ;
...
-(unsigned int)roadComplexityAtDistance:(CGFloat)arg0 ;
...
-(void)_initExplicitAdvisoriesForRoute:(id)arg0 initializerData:(id)arg1 ;
