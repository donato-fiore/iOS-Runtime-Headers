...
@protocol MRUSystemOutputDeviceRouteControllerObserver, MRUSpatialAudioPreferencesControllerDelegate, MRNowPlayingAudioFormatControllerDelegate, UIGestureRecognizerDelegate, CCUIContentModuleBackgroundViewController, MRUVolumeBackgroundViewControllerDelegate;
...
@property (nonatomic) BOOL optimisticSpatialized; // ivar: _optimisticSpatialized
...
@property (retain, nonatomic) NSTimer *spatialUpdateTimer; // ivar: _spatialUpdateTimer
...
-(void)updateOptimisticSpatializedForSelectedPreferences:(id)arg0 previousPreferences:(id)arg1 audioFormatContentInfo:(id)arg2 ;
