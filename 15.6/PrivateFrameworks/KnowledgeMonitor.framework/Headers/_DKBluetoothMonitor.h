...
@class DKMonitor, NSMutableDictionary, NSDictionary, NSLock, NSString;
@protocol _DKHistoricalDeletingMonitor, OS_dispatch_queue, OS_dispatch_source;



@interface _DKBluetoothMonitor : DKMonitor <_DKHistoricalDeletingMonitor>
