...
#ifndef SKUIADORNEDIMAGEVIEW_H
#define SKUIADORNEDIMAGEVIEW_H
...
-(void)setImage:(id)arg0 cacheKey:(id)arg1 context:(id)arg2 ;
-(void)updatePlayButonBlur:(id)arg0 context:(id)arg1 image:(id)arg2 cacheKey:(id)arg3 ;
