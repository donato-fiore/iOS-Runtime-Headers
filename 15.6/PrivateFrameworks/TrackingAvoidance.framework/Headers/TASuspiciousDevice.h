...
-(id)initWithLatestAdv:(id)arg0 detectionSummary:(id)arg1 date:(id)arg2 locHistory:(id)arg3 detectionMetrics:(id)arg4 detectionType:(NSUInteger)arg5 immediacyType:(NSUInteger)arg6 ;
