...
-(void)_decisionMadeContext:(struct MyriadMetricsDataV1 *)arg0 instrumentation:(id)arg1 completion:(id)arg2 ;
-(void)_submitMyriadMetrics:(struct MyriadMetricsDataV1 *)arg0 toStream:(id)arg1 instrumentation:(id)arg2 completion:(id)arg3 ;
