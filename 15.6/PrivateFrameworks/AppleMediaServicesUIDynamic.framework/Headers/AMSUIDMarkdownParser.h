...
#ifndef AMSUIDMARKDOWNPARSER_H
#define AMSUIDMARKDOWNPARSER_H
...
@interface AMSUIDMarkdownParser : NSObject

@property (nonatomic) *_xmlParserCtxt _parserContext; // ivar: __parserContext
@property (weak, nonatomic) NSObject<AMSUIDMarkdownParser> *delegate; // ivar: _delegate
