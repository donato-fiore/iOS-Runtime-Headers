...
@property (readonly, nonatomic) BOOL downloading; // ivar: _downloading
@property (readonly, nonatomic) NSInteger gender; // ivar: _gender
@property (readonly, nonatomic) NSString *identifier; // ivar: _identifier
@property (nonatomic, readonly) BOOL locallyAvailable;
@property (readonly, nonatomic) BOOL locallyAvailable; // ivar: _locallyAvailable
...
@property (readonly, nonatomic) BOOL purgeable; // ivar: _purgeable
