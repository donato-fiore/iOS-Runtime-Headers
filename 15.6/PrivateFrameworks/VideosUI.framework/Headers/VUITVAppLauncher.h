...
@class UIWindow, NSString, NSDictionary, VUIStateMachine, UIViewController<VUITabBarProtocol><VUITVAppRootViewController>, NSArray;
@protocol VUITVApplicationControllerDelegate, UIGestureRecognizerDelegate, VUITVAppLaunchProtocol, VUIRootSplitViewController;
...
@property (retain, nonatomic) UIViewController<VUITabBarProtocol><VUITVAppRootViewController> *tabBarController; // ivar: _tabBarController
...
-(void)_handleDebugUIGesture:(BOOL)arg0 ;
