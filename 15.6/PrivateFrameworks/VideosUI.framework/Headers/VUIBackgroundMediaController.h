...
@property (nonatomic) BOOL loadPlaylistInNextRunloopForBackgroundVideos; // ivar: _loadPlaylistInNextRunloopForBackgroundVideos
...
@property (nonatomic) CGFloat playbackLoadingDelayInterval; // ivar: _playbackLoadingDelayInterval
...
@property (nonatomic) BOOL startBackgroundPlaybackWhileTransitioning; // ivar: _startBackgroundPlaybackWhileTransitioning
