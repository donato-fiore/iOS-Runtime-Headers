...
@property (nonatomic) BOOL isForLibrarySplitViewController; // ivar: _isForLibrarySplitViewController
...
-(id)_leftBarButton;
-(id)initWithCategories:(id)arg0 gridConfiguration:(id)arg1 isForLibrarySplitViewController:(BOOL)arg2 ;
