...
+(id)sharedInstance;
-(BOOL)resumeTimeAndTimestampByCanonical:(id)arg0 serverResumeTime:(id)arg1 serverBookmarkTimestamp:(id)arg2 mostRecentResumeTime:(*id)arg3 mostRecentBookmarkTimestamp:(*id)arg4 ;
-(id)init;
...
-(void)resumeTimeInfoByCanonical:(id)arg0 outAbsoluteResumeTime:(*id)arg1 outAbsoluteTimestamp:(*id)arg2 outMainContentRelativeResumeTime:(*id)arg3 outMainContentRelativeTimestamp:(*id)arg4 ;
