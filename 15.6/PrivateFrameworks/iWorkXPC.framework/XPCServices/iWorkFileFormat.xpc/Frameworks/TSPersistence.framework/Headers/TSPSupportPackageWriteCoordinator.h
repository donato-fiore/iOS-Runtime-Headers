...
-(id)initWithContext:(id)arg0 archiverClass:(Class)arg1 archiverFlags:(char)arg2 documentRevision:(id)arg3 saveToken:(NSUInteger)arg4 fileFormatVersion:(NSUInteger)arg5 metadataObject:(id)arg6 dataAttributesSnapshot:(id)arg7 packageWriteCoordinator:(id)arg8 ;
