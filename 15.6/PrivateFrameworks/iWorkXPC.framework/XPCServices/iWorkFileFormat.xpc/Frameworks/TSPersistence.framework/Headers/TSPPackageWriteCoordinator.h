...
@protocol TSPArchiverManagerDelegate, TSPComponentWriterDelegate, TSPDataArchiver, TSPExternalReferenceDelegate, TSPPersistedObjectUUIDMapDelegate, TSPObjectModifyDelegate, OS_dispatch_queue, OS_dispatch_group;
...
@interface TSPPackageWriteCoordinator : NSObject <TSPArchiverManagerDelegate, TSPComponentWriterDelegate, TSPDataArchiver, TSPExternalReferenceDelegate, TSPPersistedObjectUUIDMapDelegate, TSPObjectModifyDelegate>

 {
    ...
    IdentifierMap<const long long> _delayedObjects;
...
-(BOOL)enqueueComponent:(id)arg0 rootObjectOrNil:(id)arg1 forceArchive:(BOOL)arg2 isWastefullyEnqueueing:(BOOL)arg3 isWeakReference:(BOOL)arg4 referencingComponent:(id)arg5 referencedObject:(id)arg6 ;
...
-(id)init;
-(id)initWithContext:(id)arg0 archiverClass:(Class)arg1 archiverFlags:(char)arg2 documentRevision:(id)arg3 saveToken:(NSUInteger)arg4 packageIdentifier:(unsigned char)arg5 fileFormatVersion:(NSUInteger)arg6 preferredPackageType:(NSInteger)arg7 metadataObject:(id)arg8 dataAttributesSnapshot:(id)arg9 ;
-(id)initWithContext:(id)arg0 archiverClass:(Class)arg1 archiverFlags:(char)arg2 documentRevision:(id)arg3 saveToken:(NSUInteger)arg4 packageIdentifier:(unsigned char)arg5 fileFormatVersion:(NSUInteger)arg6 preferredPackageType:(NSInteger)arg7 metadataObject:(id)arg8 dataAttributesSnapshot:(id)arg9 packageWriteCoordinator:(id)arg10 captureSnapshots:(BOOL)arg11 ;
...
-(void)enqueueReferencedObject:(id)arg0 referencingComponent:(id)arg1 isWeakReference:(BOOL)arg2 forWastefullyEnqueuedComponent:(id)arg3 componentRootObject:(id)arg4 componentInfo:(struct WrittenComponentInfo *)arg5 ;
...
-(void)updateObjectContextForSuccessfulSaveWithPackageWriter:(id)arg0 packageURL:(id)arg1 ;
