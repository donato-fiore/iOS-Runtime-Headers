...
@interface TSPDescriptionGenerator : NSObject {
    ...
    id *_dataDigestHandler;
}




+(BOOL)dumpMessagesForDocument:(id)arg0 decryptionKey:(id)arg1 toURL:(id)arg2 ;
+(BOOL)dumpMessagesForDocument:(id)arg0 packageIdentifier:(unsigned char)arg1 decryptionKey:(id)arg2 toURL:(id)arg3 ;
+(BOOL)dumpMessagesForSupport:(id)arg0 decryptionKey:(id)arg1 toURL:(id)arg2 ;
