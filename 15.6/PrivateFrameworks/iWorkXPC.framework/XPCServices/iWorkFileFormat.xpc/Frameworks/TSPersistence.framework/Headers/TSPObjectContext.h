...
-(NSUInteger)estimatedProgressTotalUnitCountForURL:(id)arg0 packageType:(NSInteger)arg1 ;
...
-(id)initWithDelegate:(id)arg0 registry:(id)arg1 resourceContext:(id)arg2 isLoadingDocument:(BOOL)arg3 ;
