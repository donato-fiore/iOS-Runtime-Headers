...
-(void)q_performReset;
-(void)q_recognizeTextFromSampleBuffer:(struct opaqueCMSampleBuffer *)arg0 bufferTimestamp:(struct ? )arg1 ;
-(void)q_trackTextFromSampleBuffer:(struct opaqueCMSampleBuffer *)arg0 bufferTimestamp:(struct ? )arg1 ;
