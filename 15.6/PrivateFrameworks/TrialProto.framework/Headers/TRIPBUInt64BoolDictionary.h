...
-(BOOL)getBool:(*BOOL)arg0 forKey:(NSUInteger)arg1 ;
...
-(id)description;
-(id)init;
-(id)initWithBools:(*BOOL)arg0 forKeys:(*NSUInteger)arg1 count:(NSUInteger)arg2 ;
...
-(void)removeAll;
-(void)removeBoolForKey:(NSUInteger)arg0 ;
-(void)setBool:(BOOL)arg0 forKey:(NSUInteger)arg1 ;
