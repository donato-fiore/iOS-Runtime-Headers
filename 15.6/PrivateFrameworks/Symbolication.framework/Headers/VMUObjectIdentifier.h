...
-(id)labelForDriverKitOSClassLoadInformation:(*void)arg0 length:(NSUInteger)arg1 remoteAddress:(NSUInteger)arg2 ;
-(id)labelForDriverKitOSMetaClass:(*void)arg0 length:(NSUInteger)arg1 remoteAddress:(NSUInteger)arg2 ;
