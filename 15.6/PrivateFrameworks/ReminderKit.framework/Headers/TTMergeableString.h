...
-(BOOL)shouldInvalidateCachedSubstringsWithTimestamp:(id)arg0 ;
...
-(id)initWithArchive:(*void)arg0 andReplicaID:(id)arg1 andSharedTimestamp:(id)arg2 ;
-(id)initWithArchive:(*void)arg0 andReplicaID:(id)arg1 withOrderedSubstrings:(*void)arg2 ;
...
-(void)endEditing;
-(void)enumerateRangesModifiedAfter:(id)arg0 usingBlock:(id)arg1 ;
