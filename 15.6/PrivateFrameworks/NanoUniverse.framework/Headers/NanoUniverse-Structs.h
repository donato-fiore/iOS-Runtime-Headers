...
typedef struct _NUNIGeometryRange {
    int start;
    int count;
} _NUNIGeometryRange;

typedef struct NUNIRendererState {
    NUNIViewport viewport;
    NSUInteger projectionType;
    NSUInteger collectionType;
    float yearsSince1970;
    float cameraRoll;
    _NUNIGeometryRange octGeomRange;
    _NUNIGeometryRange quadGeomRange;
...
typedef struct NUNIRendererResources {
    id pipelines;
    id <MTLRenderPipelineState>;
    id vertexBuffer;
} NUNIRendererResources;
