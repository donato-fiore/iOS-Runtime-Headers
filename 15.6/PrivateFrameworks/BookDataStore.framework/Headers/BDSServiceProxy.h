...
@protocol NSXPCProxyCreating, BDSServiceProtocol, BDSITunesAuthenticating, BDSServiceProtocol><NSXPCProxyCreating;
...
@property (retain, nonatomic) NSObject<BDSITunesAuthenticating> *authenticator; // ivar: _authenticator
...
-(id)init;
-(id)initWithAuthenticator:(id)arg0 ;
