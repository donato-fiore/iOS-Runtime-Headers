...
-(void)companionViewServiceConnection:(id)arg0 handleCompanionItemSelectionDidCancelForRequestIdentifier:(id)arg1 ;
-(void)companionViewServiceConnection:(id)arg0 handleCompanionItemSelectionDidFinishWithRenewalAmount:(id)arg1 serviceProviderData:(id)arg2 forRequestWithIdentifier:(id)arg3 ;
