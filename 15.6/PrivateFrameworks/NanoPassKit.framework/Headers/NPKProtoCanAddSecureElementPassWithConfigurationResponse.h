...
#ifndef NPKPROTOCANADDSECUREELEMENTPASSWITHCONFIGURATIONRESPONSE_H
#define NPKPROTOCANADDSECUREELEMENTPASSWITHCONFIGURATIONRESPONSE_H
...
@property (nonatomic) BOOL canAddPass; // ivar: _canAddPass
