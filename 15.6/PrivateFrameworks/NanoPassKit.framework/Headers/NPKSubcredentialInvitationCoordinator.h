...
-(void)_queue_statusForReceivedInvitation:(id)arg0 completion:(id)arg1 ;
-(void)_queue_statusForSentInvitation:(id)arg0 completion:(id)arg1 ;
-(void)_queue_updateSubcredentialMetadataOnPass:(id)arg0 withCredential:(id)arg1 completion:(id)arg2 ;
-(void)_setUpSharingSessionWithSubcredentialProvisioningController:(id)arg0 ;
