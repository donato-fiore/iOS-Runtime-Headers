...
@class NSNumber, NSMutableDictionary, NSDictionary, NSArray;
...
-(id)initWithCandidateWidgets:(id)arg0 cachedWidgetPersonalityToAppScore:(id)arg1 personalityToDescriptorDictionary:(id)arg2 adblDrainClassification:(NSUInteger)arg3 isiPad:(BOOL)arg4 isDayZeroExperience:(BOOL)arg5 shouldIncludeContactsWidget:(BOOL)arg6 cachedHasiCloudFamily:(id)arg7 ;
-(id)initWithOnboardingStackWidgetCache:(id)arg0 adblDrainClassification:(NSUInteger)arg1 isiPad:(BOOL)arg2 shouldIncludeContactsWidget:(BOOL)arg3 ;
-(id)onboardingStacks;
