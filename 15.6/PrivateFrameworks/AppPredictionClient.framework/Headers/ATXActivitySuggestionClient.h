...
+(id)sharedInstance;
-(BOOL)_activityIsEligibleForSetUpSuggestion:(id)arg0 ;
-(BOOL)_activityIsEligibleForTriggerSuggestion:(id)arg0 ;
-(BOOL)_shouldSendAutomationSuggestionForMode:(NSUInteger)arg0 ;
-(BOOL)_shouldSendModeSetUpSuggestionAtEndOfModeToLockScreen:(id)arg0 ;
-(BOOL)_shouldSendModeTriggerSuggestionAtEndOfModeToLockScreen:(id)arg0 ;
-(id)DNDModeConfigurationTriggersToATXTriggers:(id)arg0 ;
-(id)_activityForEvent:(id)arg0 ;
-(id)_suggestionWithActivity:(id)arg0 ;
