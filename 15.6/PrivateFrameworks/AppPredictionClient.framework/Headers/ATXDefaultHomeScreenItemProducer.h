...
-(id)initWithDescriptors:(id)arg0 descriptorInstallDates:(id)arg1 homeScreenConfig:(id)arg2 isDayZeroExperience:(BOOL)arg3 isiPad:(BOOL)arg4 spotlightAppLaunchHistogram:(id)arg5 ;
-(id)initWithDescriptors:(id)arg0 descriptorInstallDates:(id)arg1 homeScreenConfig:(id)arg2 isDayZeroExperience:(BOOL)arg3 isiPad:(BOOL)arg4 spotlightAppLaunchHistogram:(id)arg5 adblDrainClassification:(NSUInteger)arg6 ;
-(id)onboardingStacks;
