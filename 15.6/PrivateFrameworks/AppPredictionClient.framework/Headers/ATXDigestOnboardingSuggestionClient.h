...
-(id)_notificationStreamFilterBlock:(SEL)arg0 ;
-(id)init;
...
-(void)_suggestDigestOnboardingIfApplicableOnMainQueueGivenNumberOfActiveNotifications:(NSUInteger)arg0 numberOfUniqueBundleIds:(NSUInteger)arg1 minActive:(NSUInteger)arg2 minUnique:(NSUInteger)arg3 ;
