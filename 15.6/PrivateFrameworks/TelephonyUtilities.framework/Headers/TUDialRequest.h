...
@property (readonly, nonatomic, getter=isRTTAvailable) BOOL rttAvailable; // ivar: _rttAvailable
...
@property (readonly, nonatomic, getter=isTTYAvailable) BOOL ttyAvailable; // ivar: _ttyAvailable
