...
@class NSString, NSUUID, NSDictionary, NSData, NSMutableDictionary, NSSet;
@protocol AVCRemoteVideoClientDelegate, NSSecureCoding, TURemoteVideoClient, TUCallServicesProxyCallActions;
...
@property (retain, nonatomic) TUCallProvider *backingProvider; // ivar: _backingProvider
...
@property (copy, nonatomic) TUCallDisplayContext *displayContext; // ivar: _displayContext
@property (retain, nonatomic) TUCallProvider *displayProvider; // ivar: _displayProvider
...
@property (retain, nonatomic) NSObject<TURemoteVideoClient> *localVideo; // ivar: _localVideo
...
@property (weak, nonatomic) NSObject<TUCallServicesProxyCallActions> *proxyCallActionsDelegate; // ivar: _proxyCallActionsDelegate
...
@property (retain, nonatomic) NSObject<TURemoteVideoClient> *remoteVideo; // ivar: _remoteVideo
