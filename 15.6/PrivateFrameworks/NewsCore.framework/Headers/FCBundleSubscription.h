...
-(id)debugDescription;
-(id)initWithBundlePurchaseID:(id)arg0 bundleChannelIDs:(id)arg1 bundleChannelIDsVersion:(id)arg2 inTrialPeriod:(BOOL)arg3 isPurchaser:(BOOL)arg4 servicesBundlePurchaseID:(id)arg5 isAmplifyUser:(BOOL)arg6 ;
