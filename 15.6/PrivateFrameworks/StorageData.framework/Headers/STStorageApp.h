...
@class NSData, MCMContainer, NSString, LSApplicationRecord, NSArray, FPProviderDomain, NSDictionary, NSDate, PSUsageBundleApp;
...
@property (retain) MCMContainer *appContainer; // ivar: _appContainer
