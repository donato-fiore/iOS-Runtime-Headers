...
-(id)initWithPointsVector:(*void)arg0 identifiersVector:(*void)arg1 ;
-(id)initWithPointsVector:(*void)arg0 identifiersVector:(*void)arg1 vergenceAngleCosinesVector:(*void)arg2 ;
