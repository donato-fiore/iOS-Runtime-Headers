...
-(?)initWithResultURL;
-(id)_rawContextMenuContentForView:(id)arg0 interactionDelegate:(id)arg1 context:(id)arg2 elements:(id)arg3 defaultAction:(*id)arg4 ;
-(id)_updateMenuElementItems:(id)arg0 withActions:(id)arg1 view:(id)arg2 interactionDelegate:(id)arg3 ;
-(id)contextMenuConfigurationWithIdentifier:(id)arg0 inView:(id)arg1 context:(id)arg2 ;
-(id)contextMenuConfigurationWithIdentifier:(id)arg0 inView:(id)arg1 context:(id)arg2 defaultAction:(*id)arg3 menuProvider:(*id)arg4 ;
