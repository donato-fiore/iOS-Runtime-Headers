...
@class HMFObject, NSDictionary, NSData, NSString, NSDate;
@protocol HMFLogging, HAPEncryptedSession, HMFLocking, HAPSecuritySessionDelegate, OS_dispatch_queue;
...
@property (readonly) NSDate *sessionStartTime; // ivar: _sessionStartTime
