...
@protocol HAP2AccessoryServerCoordinatorDelegate, HAP2AccessoryServerDelegate, HAP2StorageDelegate, HAPPowerManagerProtocol, HAP2AccessoryServerBrowserPrivate, HAP2AccessoryServerBrowser, HAP2AccessoryServerBrowserDelegate, OS_dispatch_queue, HAP2Storage;
...
@property (readonly, nonatomic) NSObject<OS_dispatch_queue> *dispatchWorkQueue; // ivar: _dispatchWorkQueue
