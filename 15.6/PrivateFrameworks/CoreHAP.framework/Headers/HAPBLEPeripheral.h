...
@class HMFObject, NSString, NSNumber, CBPeripheral, NSData, NSArray, NSUUID, NSMutableArray;
...
@property (retain, nonatomic) NSMutableArray *uuids; // ivar: _uuids
...
-(void)disconnectedFromCBPeripheral:(id)arg0 error:(id)arg1 ;
