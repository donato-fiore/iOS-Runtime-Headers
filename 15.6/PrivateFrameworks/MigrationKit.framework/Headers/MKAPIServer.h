...
@protocol MKHTTPServerDelegate, MKGETSRPRouterDelegate, MKGETCertificateRouterDelegate, MKPOSTCertificateRouterDelegate, MKPUTRouterDelegate, MKPOSTClientRouterDelegate, MKPOSTSRPRouterDelegate, MKPOSTProgressRouterDelegate, MKPhotoLibraryMigratorDelegate, MKAPIServerDelegate;
...
@interface MKAPIServer : NSObject <MKHTTPServerDelegate, MKGETSRPRouterDelegate, MKGETCertificateRouterDelegate, MKPOSTCertificateRouterDelegate, MKPUTRouterDelegate, MKPOSTClientRouterDelegate, MKPOSTSRPRouterDelegate, MKPOSTProgressRouterDelegate, MKPhotoLibraryMigratorDelegate>
...
-(void)close;
-(void)dealloc;
-(void)photoLibraryMigrator:(id)arg0 didCloseWithImportErrors:(NSUInteger)arg1 metadataErrors:(NSUInteger)arg2 ;
-(void)photoLibraryMigratorDidImportAsset:(id)arg0 ;
-(void)photoLibraryMigratorWillImportAsset:(id)arg0 ;
...
-(void)router:(id)arg0 didUpdateProgress:(float)arg1 remainingTime:(NSUInteger)arg2 ;
