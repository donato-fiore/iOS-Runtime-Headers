...
-(id)initWithEnrollmentPrimitives:(id)arg0 enrollmentInformationPrimitives:(id)arg1 networkingPrimitives:(id)arg2 profileInstallationPrimitives:(id)arg3 destructiveErasePrimitives:(id)arg4 nonDestructiveErasePrimitives:(id)arg5 powerOffPrimitives:(id)arg6 ;
