...
@class PLAgent, PLTimer, PLEntryNotificationOperatorComposition, NSMutableArray, PLEntry, BrightnessSystemClient, CBAdaptationClient, NSDictionary, PLIOKitOperatorComposition, KeyboardBrightnessClient, NSString, PLMonotonicTimer, PLXPCListenerOperatorComposition, NSDate, NSMutableDictionary, NSNumber, PLNSNotificationOperatorComposition;
...
@property (retain) NSObject<OS_dispatch_queue> *rearALSQueue; // ivar: _rearALSQueue
@property (retain) PLTimer *rearALSTimer; // ivar: _rearALSTimer
@property (retain) NSNumber *rearLux; // ivar: _rearLux
...
-(void)logEventPointDisplayForBlock:(id)arg0 isActive:(BOOL)arg1 ;
