...
@class UIViewController, AFUISiriLanguage, NSArray, NSString, UIView, AFEnablementFlowConfigurationProvider, AFEnablementConfiguration, UIBarButtonItem, AFMyriadCoordinator, SSRVTUITrainingManager;
