...
-(void)displayedDiscoveryItemWithIdentifier:(id)arg0 isWelcomeCard:(BOOL)arg1 afterSwipingToCard:(BOOL)arg2 multipleStoryCardsAvailable:(BOOL)arg3 callToActionIdentifier:(id)arg4 cardSize:(NSInteger)arg5 ;
