...
@class NSMutableDictionary, DIVerificationSession, NSString, NSError, NSData;
...
@property (retain, nonatomic) DIVerificationSession *diSession; // ivar: _diSession
