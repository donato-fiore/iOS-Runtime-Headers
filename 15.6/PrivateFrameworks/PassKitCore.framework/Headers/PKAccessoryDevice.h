...
@property (readonly, nonatomic) NSString *endpointUUID; // ivar: _endpointUUID
@property (readonly, nonatomic) NSData *primaryColorData; // ivar: _primaryColorData
@property (readonly, nonatomic) NSData *secondaryColorData; // ivar: _secondaryColorData
