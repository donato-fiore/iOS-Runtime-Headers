...
+(id)_createWithFileDataAccessor:(id)arg0 validationOptions:(NSUInteger)arg1 warnings:(*id)arg2 error:(*id)arg3 ;
+(id)createWithData:(id)arg0 warnings:(*id)arg1 error:(*id)arg2 ;
+(id)createWithFileDataAccessor:(id)arg0 validationOptions:(NSUInteger)arg1 warnings:(*id)arg2 error:(*id)arg3 ;
