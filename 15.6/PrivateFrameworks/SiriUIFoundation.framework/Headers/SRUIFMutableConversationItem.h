...
@protocol SRUIFConversationStorable, NSCopying;
...
@property (readonly, nonatomic) SRUIFDataStore *associatedDataStore; // ivar: _associatedDataStore
@property (readonly, copy) NSString *debugDescription;
@property (readonly, copy) NSString *description;
@property (retain, nonatomic) SRUIFDialogPhase *dialogPhase; // ivar: _dialogPhase
