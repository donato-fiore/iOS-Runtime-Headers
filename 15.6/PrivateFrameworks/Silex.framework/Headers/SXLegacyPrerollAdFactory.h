...
@class NSString;
@protocol SXVideoAdProviderFactory, SXScrollObserverManager, SVVolumeProviding;
...
@property (readonly, nonatomic) NSObject<SVVolumeProviding> *volumeProvider; // ivar: _volumeProvider
