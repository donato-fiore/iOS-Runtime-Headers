...
#ifndef SXISSUECOVERCOMPONENT_H
#define SXISSUECOVERCOMPONENT_H

@class NSString;
@protocol SXIssueCoverComponent, SXComponentAnchor;
...
-(BOOL)videoPlaybackEnabledWithValue:(id)arg0 withType:(int)arg1 ;
