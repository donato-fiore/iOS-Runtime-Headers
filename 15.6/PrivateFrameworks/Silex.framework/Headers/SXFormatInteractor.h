...
@class NSString;
@protocol SXLayoutCoordinatorDelegate, SXPresentationAttributesObserver, SXSubscriptionStatusObserving, SXDebugLayoutOptionsObserving, SXNewsletterSubscriptionStatusObserving, SXOfferUpsellScenarioObserving, SXFormatInteractor, SXDebugLayoutOptionsProviding, SXFormatInteractorDelegate, SXLayoutCoordinator, SXLayoutOptionsFactory, SXNewsletterSubscriptionStatusProviding, SXOfferUpsellScenarioProviding, SXPresentationAttributesProvider, SXPresentationEnvironment, SXSubscriptionStatusProviding;
...
-(id)initWithLayoutCoordinator:(id)arg0 layoutOptionsFactory:(id)arg1 presentationAttributesProvider:(id)arg2 subscriptionStatusProvider:(id)arg3 debugLayoutOptionsProvider:(id)arg4 newsletterSubscriptionStatusProvider:(id)arg5 offerUpsellScenarioProvider:(id)arg6 ;
