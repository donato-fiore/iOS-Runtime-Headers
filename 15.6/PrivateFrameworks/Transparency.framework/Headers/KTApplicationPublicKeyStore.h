...
@property (retain) NSData *patClosedProof; // ivar: _patClosedProof
@property (retain) NSData *patConfigProof; // ivar: _patConfigProof
@property int patEarliestVersion; // ivar: _patEarliestVersion
@property NSUInteger patLogBeginningMs; // ivar: _patLogBeginningMs
@property (readonly) BOOL ready;
@property (retain) NSDate *receiptTime; // ivar: _receiptTime
@property NSUInteger shutDown; // ivar: _shutDown
@property (readonly) KTContextStore *store; // ivar: _store
@property (retain) NSData *tltConfigProof; // ivar: _tltConfigProof
@property int tltEarliestVersion; // ivar: _tltEarliestVersion
...
@property BOOL unsupported; // ivar: _unsupported
...
-(BOOL)processKeyData:(id)arg0 tltLeafs:(id)arg1 intermediates:(id)arg2 patConfigProof:(id)arg3 tltConfigProof:(id)arg4 patClosedProof:(id)arg5 dataStore:(id)arg6 saveTreeHeads:(BOOL)arg7 error:(*id)arg8 ;
-(BOOL)processPatClosedProof:(id)arg0 dataStore:(id)arg1 saveTreeHeads:(BOOL)arg2 error:(*id)arg3 ;
-(BOOL)processPatConfigProof:(id)arg0 dataStore:(id)arg1 saveTreeHeads:(BOOL)arg2 error:(*id)arg3 ;
...
-(BOOL)triggerRefreshFromServerStatus:(int)arg0 ;
...
-(id)initWithApplication:(id)arg0 dataStore:(id)arg1 diskState:(id)arg2 contextStore:(id)arg3 error:(*id)arg4 ;
-(id)initWithApplication:(id)arg0 dataStore:(id)arg1 response:(id)arg2 contextStore:(id)arg3 error:(*id)arg4 ;
