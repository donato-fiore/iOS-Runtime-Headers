...
-(id)validateEnrollmentUri:(id)arg0 accountID:(id)arg1 accountKey:(id)arg2 loggableData:(id)arg3 queryRequest:(id)arg4 insertResponse:(id)arg5 error:(*id)arg6 ;
...
-(id)validatePeerUri:(id)arg0 accountID:(id)arg1 accountKey:(id)arg2 loggableDatas:(id)arg3 queryRequest:(id)arg4 queryResponse:(id)arg5 error:(*id)arg6 ;
...
-(void)validateEnrollmentUri:(id)arg0 accountID:(id)arg1 accountKey:(id)arg2 loggableData:(id)arg3 insertResponse:(id)arg4 promiseCompletionBlock:(id)arg5 ;
...
-(void)validatePeerUri:(id)arg0 accountID:(id)arg1 accountKey:(id)arg2 loggableDatas:(id)arg3 queryResponse:(id)arg4 promiseCompletionBlock:(id)arg5 ;
