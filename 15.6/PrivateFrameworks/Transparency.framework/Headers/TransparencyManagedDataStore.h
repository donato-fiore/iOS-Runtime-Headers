...
-(BOOL)garbageCollectEntity:(id)arg0 predicate:(id)arg1 error:(*id)arg2 ;
...
-(id)createRequestWithUri:(id)arg0 application:(id)arg1 accountID:(id)arg2 accountKey:(id)arg3 serverData:(id)arg4 syncedData:(id)arg5 queryRequest:(id)arg6 queryResponse:(id)arg7 type:(NSUInteger)arg8 clientId:(id)arg9 error:(*id)arg10 ;
...
-(id)createRequestWithUri:(id)arg0 application:(id)arg1 accountKey:(id)arg2 serverData:(id)arg3 type:(NSUInteger)arg4 error:(*id)arg5 ;
...
-(id)fetchRequestWithUri:(id)arg0 application:(id)arg1 accountID:(id)arg2 accountKey:(id)arg3 loggableDatas:(id)arg4 youngerThan:(id)arg5 error:(*id)arg6 ;
...
-(void)performForPendingSMTs:(id)arg0 uri:(id)arg1 accountKey:(id)arg2 error:(*id)arg3 block:(id)arg4 ;
...
-(void)performForSMHsWithUnverifiedMMD:(id)arg0 error:(*id)arg1 block:(id)arg2 ;
