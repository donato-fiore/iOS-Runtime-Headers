...
-(id)createPOSTRequestForURL:(id)arg0 timeout:(CGFloat)arg1 contents:(id)arg2 authentication:(id)arg3 fetchAuthNow:(BOOL)arg4 timeShift:(CGFloat)arg5 completionHandler:(id)arg6 ;
...
-(void)createRequestForAuthentication:(id)arg0 fetchAuthNow:(BOOL)arg1 timeShift:(CGFloat)arg2 completionHandler:(id)arg3 ;
