...
+(id)descriptor;
-(NSUInteger)shutdownTimeStamp:(*id)arg0 ;
-(NSUInteger)verifyConfigProof:(*id)arg0 ;
-(NSUInteger)verifyWithError:(*id)arg0 ;
-(id)patSigningKeyWithError:(*id)arg0 ;
-(id)vrfPublicKeyWithError:(*id)arg0 ;
-(int)earliestCurrentTreeVersionWithError:(*id)arg0 ;
-(int)earliestNextTreeVersionWithError:(*id)arg0 ;
