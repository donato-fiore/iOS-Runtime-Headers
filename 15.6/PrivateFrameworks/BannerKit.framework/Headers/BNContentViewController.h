...
@protocol UIGestureRecognizerDelegate, BNPanGestureProxyDelegate, BNPresentedBannerAnimationCustomizing, BNPresentingPrivate, BNPresentable, BNPanGestureProxyPrivate, UIViewControllerAnimatedTransitioning, UIViewControllerTransitionCoordinator, BNConsidering, BNPresentingDelegate, BNLayoutManaging, BNPosting;
...
-(BOOL)_resetActiveTransitionCoordinator:(id)arg0 ;
...
-(id)_presentablesWithIdentification:(id)arg0 ;
-(id)_topPresentable;
...
-(struct CGRect )_presentedFrame:(BOOL)arg0 forViewController:(id)arg1 withContainerBounds:(struct CGRect )arg2 overshoot:(BOOL)arg3 ;
