...
@property (nonatomic) BOOL didSelectNoAppsforInstall; // ivar: _didSelectNoAppsforInstall
...
-(void)finishOrIsGoingBack:(BOOL)arg0 didOfferOptions:(BOOL)arg1 endingUndoGrouping:(BOOL)arg2 ;
-(void)finishSTBSuccessFlowForProvider:(id)arg0 shouldShowBulkConsent:(BOOL)arg1 ;
...
-(void)markSTBProviderAppsForInstallation:(id)arg0 rootAppPlacementPosition:(id)arg1 ;
...
-(void)showMultiAppInstallVC:(id)arg0 ;
