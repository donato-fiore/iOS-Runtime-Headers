...
@class VSAsyncOperation, VSDevice, VSPreferences, NSOperationQueue, VSOptional;
...
-(void)_checkForSupportedAppsFromProvider:(id)arg0 withCompletion:(id)arg1 ;
...
-(void)_getPersonalAppDescriptions:(id)arg0 identityProvider:(id)arg1 completion:(id)arg2 ;
