...
@protocol SCKDatabaseStoreCoordinatorObserver, OS_dispatch_queue, SCKContainerProxying, SCKDatabaseStoreCoordinator;
...
@property (retain, nonatomic) SCKAsyncSerialQueue *ckSyncQueue; // ivar: _ckSyncQueue
@property (retain, nonatomic) NSObject<SCKContainerProxying> *container; // ivar: _container
...
@property (retain, nonatomic) SCKDatabaseSchema *schema; // ivar: _schema
@property (retain, nonatomic) SCKStartupQueue *startupQueue; // ivar: _startupQueue
@property NSInteger status; // ivar: _status
@property (retain, nonatomic) NSObject<SCKDatabaseStoreCoordinator> *storeCoordinator; // ivar: _storeCoordinator
