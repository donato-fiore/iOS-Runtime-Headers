...
+(BOOL)runUaaPNLProtoService:(id)arg0 requestId:(id)arg1 utterance:(id)arg2 locale:(id)arg3 tokenChain:(id)arg4 matchingSpans:(id)arg5 plumResponse:(id)arg6 embeddingTensor:(id)arg7 currentTurn:(id)arg8 outUaapProtoResponse:(*id)arg9 outError:(*id)arg10 ;
...
+(id)convertRewriteHypo2RewriteMsg:(id)arg0 ;
