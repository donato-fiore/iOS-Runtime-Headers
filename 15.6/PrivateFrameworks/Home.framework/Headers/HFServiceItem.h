...
@protocol HFAccessoryRepresentableItem, HFServiceLikeItem, HFActionBuilderFactory, HFServiceLikeBuilderCreating, HFNamingComponentCreating, HFAccessoryRepresentable, HFHomeKitObject, HFCharacteristicValueSource;
...
-(id)characteristicsToReadWithCharacteristicTypes:(id)arg0 options:(id)arg1 controlItems:(*id)arg2 ;
