...
#ifndef SFSCOREBOARDCARDSECTION_H
#define SFSCOREBOARDCARDSECTION_H

@class NSString, NSArray, NSDictionary, NSData;
@protocol SFScoreboardCardSection, NSSecureCoding, NSCopying;
...
@property (retain, nonatomic) SFSportsTeam *team1; // ivar: _team1
@property (retain, nonatomic) SFSportsTeam *team2; // ivar: _team2
