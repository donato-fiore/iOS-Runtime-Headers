...
#ifndef SFLISTENTOCARDSECTION_H
#define SFLISTENTOCARDSECTION_H

@class NSString, NSArray, NSDictionary, NSData;
@protocol SFListenToCardSection, NSSecureCoding, NSCopying;
...
@property (retain, nonatomic) SFCardSection *fallbackCardSection; // ivar: _fallbackCardSection
