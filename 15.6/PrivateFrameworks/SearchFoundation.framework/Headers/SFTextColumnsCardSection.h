...
#ifndef SFTEXTCOLUMNSCARDSECTION_H
#define SFTEXTCOLUMNSCARDSECTION_H

@class NSString, NSArray, NSDictionary, NSData;
@protocol SFTextColumnsCardSection, NSSecureCoding, NSCopying;
...
@property (nonatomic) NSUInteger titleWeight; // ivar: _titleWeight
