...
-(void)didDetectHardEndpointAtTime:(CGFloat)arg0 withTotalAudioRecorded:(CGFloat)arg1 endpointBufferHostTime:(NSUInteger)arg2 featuresAtEndpoint:(id)arg3 endpointerType:(NSInteger)arg4 serverFeatureLatencyDistribution:(id)arg5 additionalMetrics:(id)arg6 ;
