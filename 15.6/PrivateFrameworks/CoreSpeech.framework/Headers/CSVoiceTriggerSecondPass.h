...
-(void)_voiceTriggerFirstPassDidDetectKeywordFrom:(NSUInteger)arg0 deviceId:(id)arg1 audioProviderUUID:(id)arg2 firstPassInfo:(id)arg3 rejectionMHUUID:(id)arg4 completion:(id)arg5 ;
...
-(void)dealloc;
-(void)handleVoiceTriggerSecondPassFrom:(NSUInteger)arg0 deviceId:(id)arg1 audioProviderUUID:(id)arg2 firstPassInfo:(id)arg3 rejectionMHUUID:(id)arg4 completion:(id)arg5 ;
