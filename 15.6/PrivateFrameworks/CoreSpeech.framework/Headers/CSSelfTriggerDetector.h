...
@class NSString, CSAudioTimeConverter, CSAsset, CSPolicy, NSHashTable;
@protocol CSKeywordAnalyzerNDAPIScoreDelegate, CSAudioStreamProvidingDelegate, CSSiriClientBehaviorMonitorDelegate, CSAudioServerCrashMonitorDelegate, OS_dispatch_queue;
