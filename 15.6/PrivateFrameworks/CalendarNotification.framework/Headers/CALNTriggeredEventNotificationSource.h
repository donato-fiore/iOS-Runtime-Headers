...
@protocol CALNTriggeredEventNotificationDataSourceDelegate, CALNNotificationSource, CALNTriggeredEventNotificationBodyDescriptionProvider, CALNTriggeredEventNotificationDataSource, CalDateProvider, CALNCalendarIconIdentifierProvider, CALNTriggeredEventNotificationMapItemURLProvider, CALNTriggeredEventNotificationDataStorage, CALNNotificationManager, CALNSourceEventRepresentationProvider, CALNTimeToLeaveRefreshStorage, CALNTriggeredEventNotificationTransitionProvider, CALNTravelAdvisoryTimelinessAuthority, CALNTriggeredEventNotificationTriggerHelper, CALNURLHandler, OS_dispatch_queue;
