...
-(BOOL)shouldTryVideoRotationFastPath:(id)arg0 options:(id)arg1 ;
...
-(void)_exportVideoToURLFull:(id)arg0 composition:(id)arg1 options:(id)arg2 properties:(id)arg3 progress:(id)arg4 completion:(id)arg5 ;
