...
@class NSXPCConnection, NSUUID, NSTimer, NSArray, NSString, FBScene, UIImage;
@protocol PGPictureInPictureRemoteObjectInterface, PGPictureInPictureViewControllerDelegate, PGCommandHandler, OS_dispatch_queue, BSInvalidatable, PGPictureInPictureAnalyticsDelegate, PGPictureInPictureRemoteObjectDelegate;
...
@property (readonly, nonatomic) CGRect initialLayerFrame; // ivar: _initialLayerFrame
...
@property (readonly, nonatomic, getter=isPIPAllowedForCurrentContentType) BOOL pipAllowedForCurrentContentType;
