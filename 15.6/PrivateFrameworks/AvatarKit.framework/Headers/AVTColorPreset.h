...
-(id)description;
-(id)gradientLayerForNaturalColorWithSkinColor:(id)arg0 ;
...
-(void)renderColorIntoCALayer:(id)arg0 ;
-(void)renderColorIntoCALayer:(id)arg0 withSkinColor:(id)arg1 ;
-(void)renderNaturalSkinColorIntoCALayer:(id)arg0 withSkinColor:(id)arg1 ;
