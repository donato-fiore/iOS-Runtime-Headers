...
-(id)snapshotAtTime:(CGFloat)arg0 withRenderer:(id)arg1 configuration:(id)arg2 options:(id)arg3 error:(*id)arg4 ;
...
-(void)applyConfiguration:(id)arg0 forExport:(BOOL)arg1 completion:(id)arg2 ;
-(void)dealloc;
