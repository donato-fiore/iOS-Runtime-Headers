...
@class UIViewController, NSString, UILabel, UIButton, NSLayoutConstraint, UITextView, NSArray, UICollectionView, SFAirDropBrowser, NSMutableDictionary, SFWirelessSettingsController, NSMutableOrderedSet, NSOperationQueue, UIVisualEffectView, UIFocusContainerGuide, NSMapTable;
