...
@property (nonatomic) NSInteger timeoutReadPay; // ivar: _timeoutReadPay
@property (nonatomic) NSInteger timeoutReadVas; // ivar: _timeoutReadVas
@property (readonly, nonatomic) unsigned char transactionType; // ivar: _transactionType
@property (readonly, nonatomic) NSArray *urls;
@property (readonly, nonatomic) NSArray *vasPasses;
@property (readonly, nonatomic) NSArray *vasProtocol;
@property (readonly, nonatomic) NSArray *vasRequests; // ivar: _vasRequests
