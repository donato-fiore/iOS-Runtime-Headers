...
@property (nonatomic) BOOL enableReconnect; // ivar: _enableReconnect
...
-(BOOL)_indexPathIsReconnectCell:(id)arg0 ;
...
-(id)_headerViewForTitle:(id)arg0 buttonTitle:(id)arg1 ;
...
-(void)titleTableHeaderViewDidTapActionButton:(id)arg0 ;
