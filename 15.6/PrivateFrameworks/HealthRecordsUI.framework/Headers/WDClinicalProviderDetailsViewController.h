...
@class HKTableViewController, NSArray, NSString, NSLayoutConstraint, UIView, HKClinicalProvider, NSCache, HKClinicalProviderSearchResult;
...
-(id)_latestSupportedVersionOfGateway:(id)arg0 fromGateways:(id)arg1 ;
