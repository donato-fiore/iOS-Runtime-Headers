...
@property (readonly, nonatomic) NSInteger sectionSignedClinicalDataWalletIntegration; // ivar: _sectionSignedClinicalDataWalletIntegration
...
-(void)addSignedClinicalDataPassToWalletWithCompletion:(id)arg0 ;
-(void)deleteSignedClinicalDataRecordWithCompletion:(id)arg0 ;
