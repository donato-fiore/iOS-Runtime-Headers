...
-(void)addText:(id)arg0 language:(id)arg1 selection:(struct _NSRange *)arg2 token:(NSInteger)arg3 focus:(struct _NSRange *)arg4 technical:(BOOL)arg5 isEditableText:(BOOL)arg6 ;
...
-(void)addText:(id)arg0 overrideText:(id)arg1 language:(id)arg2 selection:(struct _NSRange *)arg3 token:(NSInteger)arg4 focus:(struct _NSRange *)arg5 technical:(BOOL)arg6 isEditableText:(BOOL)arg7 paddingRange:(struct _NSRange )arg8 editingString:(id)arg9 ;
