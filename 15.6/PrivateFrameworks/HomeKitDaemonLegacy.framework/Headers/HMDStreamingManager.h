...
@class HMFObject, NSNumber, AVCRemoteVideoClient, NSString;
...
@property (copy) NSNumber *aspectRatio; // ivar: _aspectRatio
@property (readonly) HMDAudioStreamInterface *audioStreamInterface; // ivar: _audioStreamInterface
@property (readonly) NSUInteger audioStreamSetting;
@property (retain) AVCRemoteVideoClient *avcRemoteVideo; // ivar: _avcRemoteVideo
@property (readonly, copy) NSString *debugDescription;
@property (weak) NSObject<HMDStreamingManagerDelegate> *delegate; // ivar: _delegate
...
@property (readonly) HMDVideoStreamInterface *videoStreamInterface; // ivar: _videoStreamInterface
