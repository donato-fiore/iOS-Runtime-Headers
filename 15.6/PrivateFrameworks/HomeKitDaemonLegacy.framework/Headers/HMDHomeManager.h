...
-(id)writeMigrationRecordWithShouldSkipKeyRollOperations:(BOOL)arg0 forceMigrationFailureForTesting:(BOOL)arg1 ;
...
-(void)_handleUpgradeToHH2Framework:(id)arg0 ;
...
-(void)_startHH2MigrationWithRequestMessage:(id)arg0 ;
-(void)_startHH2MigrationWithShouldSkipKeyRollOperations:(BOOL)arg0 forceMigrationFailureForTesting:(BOOL)arg1 completionHandler:(id)arg2 ;
...
-(void)sendMigrationRequestToResident:(id)arg0 ;
...
-(void)startHH2MigrationWithCompletionHandler:(id)arg0 ;
