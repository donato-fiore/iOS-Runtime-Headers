...
@class HMFObject, NSMutableSet, NSUUID, NSString, NSDictionary, NSSet, HMFMessageDispatcher, NSNotificationCenter, HMFTimer, NSMutableArray;
@protocol HMDCameraRecordingSessionNotificationTriggerDelegate, HMDCameraRecordingSettingsControlDelegate, HMDDevicePreferenceDataSource, HMFLogging, HMDCameraRecordingSessionDelegate, HMDHomeMessageReceiver, HMDCameraClipManagerDelegate, HMFTimerDelegate, HMDDataStreamBulkSendSession, HMDFeaturesDataSource, HMMLogEventSubmitting, OS_dispatch_queue;
