...
@protocol HMFTimerDelegate, HMFMessageReceiver, HMFLogging, OS_dispatch_queue;
...
-(id)_addDeviceInMesh:(id)arg0 ;
-(id)_addDeviceInResidents:(id)arg0 ;
-(id)_availableResidentsForHome:(id)arg0 ;
-(id)_dumpState;
-(id)_findDeviceInMesh:(id)arg0 ;
-(id)_findDeviceInMeshByUUID:(id)arg0 ;
-(id)_findDeviceInResidents:(id)arg0 ;
-(id)_residentMapForAccessories:(id)arg0 ;
-(id)balancedResidentMapForAccessories:(id)arg0 ;
-(id)bestResidentForAccessory:(id)arg0 ;
...
-(void)_deviceIsReachable:(id)arg0 ;
-(void)_dumpDebug;
