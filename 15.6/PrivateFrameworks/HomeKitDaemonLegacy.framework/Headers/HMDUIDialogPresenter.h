...
-(id)init;
-(void)_displayInternalTTRErrorWithContext:(id)arg0 message:(id)arg1 radarTitle:(id)arg2 ;
...
-(void)displayInternalTTRErrorWithContext:(id)arg0 message:(id)arg1 radarTitle:(id)arg2 ;
