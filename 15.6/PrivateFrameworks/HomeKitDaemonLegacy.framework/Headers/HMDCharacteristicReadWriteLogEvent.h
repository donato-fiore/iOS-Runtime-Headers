...
@class HMMHomeLogEvent, NSString, NSUUID, NSArray, NSError, NSDictionary, NSMutableDictionary;
@protocol HMDBiomeLogEvent, HMDMicroLocationLogEvent, HMDAWDLogEvent, HMMCoreAnalyticsLogging;
