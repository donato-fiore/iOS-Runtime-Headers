...
@property (readonly, nonatomic) NSUInteger numHAPBTOnlyAccessories; // ivar: _numHAPBTOnlyAccessories
...
@property (readonly, copy) NSNumber *numThreadBorderRouters; // ivar: _numThreadBorderRouters
