...
@protocol HMFLogging, HMFObject, HMDBackingStoreObjectProtocol, HMDHomeMessageReceiver, NSSecureCoding, HMFLocking, OS_dispatch_queue, HMDSoftwareUpdateDataSource;
