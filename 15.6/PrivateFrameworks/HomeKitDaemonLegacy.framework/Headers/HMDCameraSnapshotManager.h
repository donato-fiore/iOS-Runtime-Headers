...
-(id)initWithAccessory:(id)arg0 workQueue:(id)arg1 streamSnapshotHandler:(id)arg2 uniqueIdentifier:(id)arg3 msgDispatcher:(id)arg4 networkMonitor:(id)arg5 logIdentifier:(id)arg6 imageCacheDirectory:(id)arg7 residentMessageHandler:(id)arg8 snapshotSlotManager:(id)arg9 ;
-(void)_handleCreateSnapshotFromBulletinContext:(id)arg0 ;
-(void)_handleFillSnapshotSlot:(id)arg0 ;
