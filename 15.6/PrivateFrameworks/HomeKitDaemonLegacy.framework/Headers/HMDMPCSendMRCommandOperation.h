...
+(id)logCategory;
-(id)initWithCommand:(unsigned int)arg0 destination:(id)arg1 options:(id)arg2 externalObjectInterface:(id)arg3 ;
-(id)initWithCommand:(unsigned int)arg0 options:(id)arg1 destination:(id)arg2 ;
-(id)initWithPlaybackArchive:(id)arg0 destination:(id)arg1 options:(id)arg2 externalObjectInterface:(id)arg3 ;
-(id)initWithPlaybackArchive:(id)arg0 options:(id)arg1 destination:(id)arg2 ;
-(void)main;
