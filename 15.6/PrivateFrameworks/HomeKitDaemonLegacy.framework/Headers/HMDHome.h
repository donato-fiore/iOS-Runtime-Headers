...
-(id)createAccessorySettingsMessengerWithMessageTargetUUID:(id)arg0 messageDispatcher:(id)arg1 messageRouter:(id)arg2 messageHandler:(id)arg3 legacyMessageReceiver:(id)arg4 ;
...
-(void)handleHH2MigrationRequest:(id)arg0 ;
