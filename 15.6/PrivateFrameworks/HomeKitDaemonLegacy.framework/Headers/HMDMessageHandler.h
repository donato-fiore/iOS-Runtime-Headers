...
@class HMFObject, HMFUnfairLock, NSMutableDictionary, NSArray, NSString, HMFMessageDispatcher, NSUUID, NSNotificationCenter, NSDictionary;
...
-(BOOL)reachableForMessage:(id)arg0 ;
