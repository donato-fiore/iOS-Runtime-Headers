...
@protocol HMBLocalZoneModelObserver, HMFLogging, HMDCompositeSettingsControllerPrivate, HMDCompositeSettingsController, HMMLogEventSubmitting, HMDCompositeSettingsControllerDelegate;
...
-(id)initWithZoneManager:(id)arg0 model:(Class)arg1 homeUUID:(id)arg2 ownerUUID:(id)arg3 logEventDispatcher:(id)arg4 settingKeyPathBlockList:(id)arg5 ;
-(id)initWithZoneManager:(id)arg0 model:(Class)arg1 homeUUID:(id)arg2 ownerUUID:(id)arg3 settingKeyPathBlockList:(id)arg4 ;
