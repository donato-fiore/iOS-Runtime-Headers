...
-(id)initWithWorkQueue:(id)arg0 camera:(id)arg1 hapAccessory:(id)arg2 home:(id)arg3 configuredFragmentDuration:(CGFloat)arg4 timelineManager:(id)arg5 significantEventServer:(id)arg6 homePresenceByPairingIdentity:(id)arg7 ;
-(id)initWithWorkQueue:(id)arg0 camera:(id)arg1 hapAccessory:(id)arg2 home:(id)arg3 configuredFragmentDuration:(CGFloat)arg4 timelineManager:(id)arg5 significantEventServer:(id)arg6 homePresenceByPairingIdentity:(id)arg7 factory:(id)arg8 ;
