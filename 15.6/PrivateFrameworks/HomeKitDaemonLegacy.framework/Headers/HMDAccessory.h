...
@class HMFObject, NSMutableSet, NSArray, NSDictionary, HMAccessoryCategory, NSNumber, NSString, NSUUID, NSSet, HMFMessageDispatcher, HMFVersion, NSDate, NSData;
@protocol HMDBulletinIdentifiers, HMDSoftwareUpdateDataSource, NSSecureCoding, HMDHomeMessageReceiver, HMDBackingStoreObjectProtocol, HMFDumpState, HMFLogging, HMFLocking, OS_dispatch_queue;
...
@property (nonatomic) BOOL custom1WoBLE; // ivar: _custom1WoBLE
@property (nonatomic) BOOL custom1WoWLAN; // ivar: _custom1WoWLAN
...
@property (retain, nonatomic) HMDUserManagementOperationTimestamp *pairingsAuditedTimestamp; // ivar: _pairingsAuditedTimestamp
...
@property (nonatomic) BOOL reachablilityPingNotificationEnabled; // ivar: _reachablilityPingNotificationEnabled
...
@property (retain, nonatomic) HMDUserManagementOperationTimestamp *sharedAdminAddedTimestamp; // ivar: _sharedAdminAddedTimestamp
...
-(void)__handleAuditPairings:(id)arg0 ;
...
-(void)logEventWithEvent:(id)arg0 ;
...
-(void)setDefaultPreferredMediaUserIfRemoved:(id)arg0 defaultUser:(id)arg1 ;
