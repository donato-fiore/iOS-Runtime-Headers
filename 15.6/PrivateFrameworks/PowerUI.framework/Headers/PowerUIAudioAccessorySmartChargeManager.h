...
@class NSMutableDictionary, NSString, NSMutableArray, NSLock, NSNumber, NSXPCListener, NSDistributedNotificationCenter, UNUserNotificationCenter;
...
-(NSInteger)secondsLeftInHourForDate:(id)arg0 ;
...
-(id)firsUseNotificationRequestForDeviceType:(unsigned int)arg0 ;
-(id)init;
-(id)returnAccessoryStatusForDevice:(id)arg0 ;
-(id)stringFromState:(NSUInteger)arg0 ;
-(void)addTimeSeriesDataToStream:(struct timeSeriesData *)arg0 withStore:(id)arg1 withLog:(id)arg2 ;
