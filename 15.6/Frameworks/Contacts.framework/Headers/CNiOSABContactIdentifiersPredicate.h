...
#ifndef CNIOSABCONTACTIDENTIFIERSPREDICATE_H
#define CNIOSABCONTACTIDENTIFIERSPREDICATE_H
...
@property (readonly) BOOL ignoreUnifiedIdentifiers; // ivar: _ignoreUnifiedIdentifiers
...
-(id)initWithIdentifiers:(id)arg0 ignoreUnifiedIdentifiers:(BOOL)arg1 ;
