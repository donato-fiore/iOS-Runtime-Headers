...
// -(id)initWithFetchRequest:(id)arg0 addressBook:(*void)arg1 managedConfiguration:(id)arg2 addressBookCompletionHandler:(id)arg3 cursorCompletionHandler:(unk)arg4 environment:(id)arg5  ;
-(void)dealloc;
