...
@protocol HMSiriEndpointProfilesMessengerFactory, HMFLogging, HMMutableApplicationData, HMObjectMerge, HMFMessageReceiver, NSSecureCoding, HMHomeDelegate, OS_dispatch_queue;
