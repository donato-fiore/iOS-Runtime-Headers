...
@class NSArray, NSString, NSUUID, HMFKey;
...
@property (readonly, copy) NSString *idsDestination; // ivar: _idsDestination
@property (readonly, copy) NSUUID *idsIdentifier; // ivar: _idsIdentifier
...
-(id)initWithUUID:(id)arg0 name:(id)arg1 isCurrentDevice:(BOOL)arg2 idsIdentifier:(id)arg3 idsDestination:(id)arg4 rapportIRK:(id)arg5 ;
