...
#ifndef RSCAMERADEVICEMANAGER_H
#define RSCAMERADEVICEMANAGER_H



#import "ICDeviceManager.h"

@interface RSCameraDeviceManager : ICDeviceManager



-(NSInteger)checkFile:(id)arg0 andDevice:(id)arg1 ;
-(id)deviceManagerConnection;
-(struct CGImage *)removeLetterboxFromThumbnail:(struct CGImage *)arg0 ;
