...
@property (copy, nonatomic) NSString *applicationBundleIdentifierOverride; // ivar: _applicationBundleIdentifierOverride
@property (copy, nonatomic) NSString *containerIdentifier; // ivar: _containerIdentifier
@property (readonly, copy) NSString *debugDescription;
@property (readonly, copy) NSString *description;
@property (readonly) NSUInteger hash;
@property (copy, nonatomic) CKRecordZoneID *repairZoneID; // ivar: _repairZoneID
