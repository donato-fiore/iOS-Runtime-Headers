...
@class NSMutableSet, NSMutableDictionary, NSMutableOrderedSet, NSArray, NSSet;
...
-(void)addMergeableValueIDsNeedingMaintenance:(id)arg0 ;
...
-(void)removeMergeableValueIDsNeedingMaintenance:(id)arg0 ;
