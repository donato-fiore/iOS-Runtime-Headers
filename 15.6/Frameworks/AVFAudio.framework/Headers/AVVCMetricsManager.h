...
-(void)checkAndUpdateReporterID:(NSInteger)arg0 ;
-(void)dealloc;
-(void)logProfileMetrics:(id)arg0 ;
-(void)logRecordAudioFormat:(struct CAStreamBasicDescription )arg0 reporterID:(NSInteger)arg1 ;
-(void)logRecordRoute:(id)arg0 andPlaybackRoute:(id)arg1 reporterID:(NSInteger)arg2 ;
-(void)logSessionMetric:(id)arg0 value:(id)arg1 category:(unsigned int)arg2 type:(unsigned short)arg3 context:(id)arg4 reporterID:(NSInteger)arg5 ;
-(void)logSessionMetric:(id)arg0 value:(id)arg1 category:(unsigned int)arg2 type:(unsigned short)arg3 reporterID:(NSInteger)arg4 ;
-(void)logSingleMetric:(id)arg0 value:(id)arg1 category:(unsigned int)arg2 type:(unsigned short)arg3 reporterID:(NSInteger)arg4 ;
