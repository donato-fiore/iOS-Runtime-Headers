...
#ifndef CHIPTESTRELATIVEHUMIDITYMEASUREMENT_H
#define CHIPTESTRELATIVEHUMIDITYMEASUREMENT_H



#import "CHIPRelativeHumidityMeasurement.h"

@interface CHIPTestRelativeHumidityMeasurement : CHIPRelativeHumidityMeasurement {
    RelativeHumidityMeasurementClusterTest _cppCluster;
}
