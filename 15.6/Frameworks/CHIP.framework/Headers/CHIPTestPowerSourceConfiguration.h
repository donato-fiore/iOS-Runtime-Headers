...
#ifndef CHIPTESTPOWERSOURCECONFIGURATION_H
#define CHIPTESTPOWERSOURCECONFIGURATION_H



#import "CHIPPowerSourceConfiguration.h"

@interface CHIPTestPowerSourceConfiguration : CHIPPowerSourceConfiguration {
    PowerSourceConfigurationClusterTest _cppCluster;
}
...
-(void)writeAttributeSourcesWithValue:(id)arg0 completionHandler:(id)arg1 ;
