...
#ifndef CHIPTESTMEDIAINPUT_H
#define CHIPTESTMEDIAINPUT_H



#import "CHIPMediaInput.h"

@interface CHIPTestMediaInput : CHIPMediaInput {
    MediaInputClusterTest _cppCluster;
}
...
-(void)writeAttributeCurrentInputWithValue:(id)arg0 completionHandler:(id)arg1 ;
-(void)writeAttributeGeneratedCommandListWithValue:(id)arg0 completionHandler:(id)arg1 ;
-(void)writeAttributeInputListWithValue:(id)arg0 completionHandler:(id)arg1 ;
