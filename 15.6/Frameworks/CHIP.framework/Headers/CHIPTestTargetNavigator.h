...
#ifndef CHIPTESTTARGETNAVIGATOR_H
#define CHIPTESTTARGETNAVIGATOR_H



#import "CHIPTargetNavigator.h"

@interface CHIPTestTargetNavigator : CHIPTargetNavigator {
    TargetNavigatorClusterTest _cppCluster;
}
...
-(void)writeAttributeCurrentTargetWithValue:(id)arg0 completionHandler:(id)arg1 ;
-(void)writeAttributeGeneratedCommandListWithValue:(id)arg0 completionHandler:(id)arg1 ;
-(void)writeAttributeTargetListWithValue:(id)arg0 completionHandler:(id)arg1 ;
