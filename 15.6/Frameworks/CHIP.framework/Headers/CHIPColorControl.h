...
@interface CHIPColorControl : CHIPCluster {
    ColorControlCluster _cppCluster;
}
...
+(void)readAttributeColorControlOptionsWithAttributeCache:(id)arg0 endpoint:(id)arg1 queue:(id)arg2 completionHandler:(id)arg3 ;
...
+(void)readAttributeColorTempPhysicalMaxWithAttributeCache:(id)arg0 endpoint:(id)arg1 queue:(id)arg2 completionHandler:(id)arg3 ;
+(void)readAttributeColorTempPhysicalMinWithAttributeCache:(id)arg0 endpoint:(id)arg1 queue:(id)arg2 completionHandler:(id)arg3 ;
...
-(void)readAttributeColorControlOptionsWithCompletionHandler:(id)arg0 ;
...
-(void)readAttributeColorTempPhysicalMaxWithCompletionHandler:(id)arg0 ;
-(void)readAttributeColorTempPhysicalMinWithCompletionHandler:(id)arg0 ;
...
// -(void)subscribeAttributeColorControlOptionsWithMinInterval:(id)arg0 maxInterval:(id)arg1 params:(id)arg2 subscriptionEstablished:(id)arg3 reportHandler:(unk)arg4  ;
...
// -(void)subscribeAttributeColorTempPhysicalMaxWithMinInterval:(id)arg0 maxInterval:(id)arg1 params:(id)arg2 subscriptionEstablished:(id)arg3 reportHandler:(unk)arg4  ;
// -(void)subscribeAttributeColorTempPhysicalMinWithMinInterval:(id)arg0 maxInterval:(id)arg1 params:(id)arg2 subscriptionEstablished:(id)arg3 reportHandler:(unk)arg4  ;
...
-(void)writeAttributeColorControlOptionsWithValue:(id)arg0 completionHandler:(id)arg1 ;
