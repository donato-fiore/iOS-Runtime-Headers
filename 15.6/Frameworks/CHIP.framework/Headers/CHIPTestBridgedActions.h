...
#ifndef CHIPTESTBRIDGEDACTIONS_H
#define CHIPTESTBRIDGEDACTIONS_H



#import "CHIPBridgedActions.h"

@interface CHIPTestBridgedActions : CHIPBridgedActions {
    BridgedActionsClusterTest _cppCluster;
}
...
-(void)writeAttributeActionListWithValue:(id)arg0 completionHandler:(id)arg1 ;
...
-(void)writeAttributeEndpointListWithValue:(id)arg0 completionHandler:(id)arg1 ;
-(void)writeAttributeGeneratedCommandListWithValue:(id)arg0 completionHandler:(id)arg1 ;
-(void)writeAttributeSetupUrlWithValue:(id)arg0 completionHandler:(id)arg1 ;
