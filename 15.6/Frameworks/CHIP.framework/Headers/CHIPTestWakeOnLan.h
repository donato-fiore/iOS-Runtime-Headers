...
#ifndef CHIPTESTWAKEONLAN_H
#define CHIPTESTWAKEONLAN_H



#import "CHIPWakeOnLan.h"

@interface CHIPTestWakeOnLan : CHIPWakeOnLan {
    WakeOnLanClusterTest _cppCluster;
}
...
-(void)writeAttributeMACAddressWithValue:(id)arg0 completionHandler:(id)arg1 ;
