...
#ifndef CHIPTESTBINARYINPUTBASIC_H
#define CHIPTESTBINARYINPUTBASIC_H



#import "CHIPBinaryInputBasic.h"

@interface CHIPTestBinaryInputBasic : CHIPBinaryInputBasic {
    BinaryInputBasicClusterTest _cppCluster;
}
...
-(void)writeAttributeStatusFlagsWithValue:(id)arg0 completionHandler:(id)arg1 ;
