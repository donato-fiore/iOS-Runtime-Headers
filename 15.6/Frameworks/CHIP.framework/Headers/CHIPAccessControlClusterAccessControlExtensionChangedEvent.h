...
#ifndef CHIPACCESSCONTROLCLUSTERACCESSCONTROLEXTENSIONCHANGEDEVENT_H
#define CHIPACCESSCONTROLCLUSTERACCESSCONTROLEXTENSIONCHANGEDEVENT_H

@class NSNumber;

#import <Foundation/Foundation.h>

#import "CHIPAccessControlClusterExtensionEntry.h"
...
@property (retain, nonatomic) CHIPAccessControlClusterExtensionEntry *latestValue; // ivar: _latestValue
