...
#ifndef CHIPTESTBASIC_H
#define CHIPTESTBASIC_H
...
-(void)writeAttributeCapabilityMinimaWithValue:(id)arg0 completionHandler:(id)arg1 ;
-(void)writeAttributeClusterRevisionWithValue:(id)arg0 completionHandler:(id)arg1 ;
-(void)writeAttributeDataModelRevisionWithValue:(id)arg0 completionHandler:(id)arg1 ;
