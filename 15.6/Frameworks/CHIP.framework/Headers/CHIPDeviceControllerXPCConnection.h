...
#ifndef CHIPDEVICECONTROLLERXPCCONNECTION_H
#define CHIPDEVICECONTROLLERXPCCONNECTION_H
...
#import "CHIPDeviceControllerXPCProxyHandle.h"

@interface CHIPDeviceControllerXPCConnection : NSObject

@property (readonly, nonatomic) id *connectBlock; // ivar: _connectBlock
@property (weak, nonatomic) CHIPDeviceControllerXPCProxyHandle *proxyHandle; // ivar: _proxyHandle
@property (retain, nonatomic) CHIPDeviceControllerXPCProxyHandle *proxyRetainerForReports; // ivar: _proxyRetainerForReports
