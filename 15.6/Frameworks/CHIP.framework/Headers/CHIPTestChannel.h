...
#ifndef CHIPTESTCHANNEL_H
#define CHIPTESTCHANNEL_H



#import "CHIPChannel.h"

@interface CHIPTestChannel : CHIPChannel {
    ChannelClusterTest _cppCluster;
}
...
-(void)writeAttributeChannelListWithValue:(id)arg0 completionHandler:(id)arg1 ;
-(void)writeAttributeClusterRevisionWithValue:(id)arg0 completionHandler:(id)arg1 ;
-(void)writeAttributeCurrentChannelWithValue:(id)arg0 completionHandler:(id)arg1 ;
-(void)writeAttributeGeneratedCommandListWithValue:(id)arg0 completionHandler:(id)arg1 ;
-(void)writeAttributeLineupWithValue:(id)arg0 completionHandler:(id)arg1 ;
