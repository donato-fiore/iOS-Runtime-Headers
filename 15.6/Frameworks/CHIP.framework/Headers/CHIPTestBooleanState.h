...
#ifndef CHIPTESTBOOLEANSTATE_H
#define CHIPTESTBOOLEANSTATE_H



#import "CHIPBooleanState.h"

@interface CHIPTestBooleanState : CHIPBooleanState {
    BooleanStateClusterTest _cppCluster;
}
...
-(void)writeAttributeStateValueWithValue:(id)arg0 completionHandler:(id)arg1 ;
