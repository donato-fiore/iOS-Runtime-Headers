...
#ifndef CHIPTESTTIMEFORMATLOCALIZATION_H
#define CHIPTESTTIMEFORMATLOCALIZATION_H



#import "CHIPTimeFormatLocalization.h"

@interface CHIPTestTimeFormatLocalization : CHIPTimeFormatLocalization {
    TimeFormatLocalizationClusterTest _cppCluster;
}
...
-(void)writeAttributeSupportedCalendarTypesWithValue:(id)arg0 completionHandler:(id)arg1 ;
