...
#ifndef CHIPTESTIDENTIFY_H
#define CHIPTESTIDENTIFY_H



#import "CHIPIdentify.h"

@interface CHIPTestIdentify : CHIPIdentify {
    IdentifyClusterTest _cppCluster;
}
...
-(void)writeAttributeIdentifyTypeWithValue:(id)arg0 completionHandler:(id)arg1 ;
