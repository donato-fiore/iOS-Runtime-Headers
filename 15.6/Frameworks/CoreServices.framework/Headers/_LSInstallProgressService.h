...
-(id)_prepareApplicationProxiesForNotification:(int)arg0 identifiers:(id)arg1 withPlugins:(BOOL)arg2 options:(id)arg3 ;
-(id)init;
...
-(void)sendAppControlsNotificationForApp:(id)arg0 withName:(id)arg1 ;
...
-(void)sendNotification:(int)arg0 forAppProxies:(id)arg1 Plugins:(BOOL)arg2 ;
