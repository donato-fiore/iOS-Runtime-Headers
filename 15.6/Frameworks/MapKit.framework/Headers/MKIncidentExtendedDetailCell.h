...
@class UIStackView, UIImageView, GEOComposedAdvisoryItem, NSString;
...
-(id)aggregatedDetailsFor:(id)arg0 ;
-(id)customBodyTextView;
-(id)initWithReuseIdentifier:(id)arg0 ;
-(void)_setConstraints;
-(void)configureWithAdvisoryItem:(id)arg0 ;
-(void)configureWithGEOAdvisoryCard:(id)arg0 ;
-(void)configureWithGEORouteIncident:(id)arg0 ;
