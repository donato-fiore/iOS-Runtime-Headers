...
-(BOOL)_addStateForDomain:(NSInteger)arg0 domainVersion:(NSInteger)arg1 state:(NSInteger)arg2 flags:(NSUInteger)arg3 note:(id)arg4 assetURL:(id)arg5 assets:(id)arg6 ;
...
-(BOOL)addStateForDomain:(NSInteger)arg0 domainVersion:(NSInteger)arg1 state:(NSInteger)arg2 flags:(NSUInteger)arg3 note:(id)arg4 assets:(id)arg5 ;
