...
@protocol BlockableScrollViewDelegate, EKDayOccurrenceViewDelegate, EKDayViewDataSource, EKDayViewDelegate, EKEventGestureControllerDelegate, UIScrollViewDelegate, OS_dispatch_queue, EKDayViewControllerDataSource, EKDayViewControllerDelegate;
...
-(void)_highlightDayViewDate:(CGFloat)arg0 isAllDay:(BOOL)arg1 ;
...
-(void)dayView:(id)arg0 didSelectEvent:(id)arg1 ;
...
-(void)dayViewDidTapEmptySpace:(id)arg0 ;
-(void)dealloc;
...
-(void)eventGestureController:(id)arg0 didSingleTapOccurrence:(id)arg1 ;
