...
+(id)color:(id)arg0 lightenedToPercentage:(CGFloat)arg1 withFinalAlpha:(CGFloat)arg2 ;
...
-(CGFloat)needsReplyStripeBackgroundAlpha;
-(CGFloat)tentativeStripeBackgroundAlpha;
-(id)_backgroundViewConfigurationForState:(NSUInteger)arg0 ;
-(id)_birthdayIcon;
-(id)_createParentVisualEffectViewWithVisualEffect:(id)arg0 ;
-(id)_needsReplyDot;
-(id)_selectedBackgroundViewWithColor:(id)arg0 ;
