...
@protocol EKEventAutocompleteResultsEditItemDelegate, EKAutocompletePendingSearchProtocol;
...
+(id)_copyAttendeesForAutocompleteFromResult:(id)arg0 ;
+(id)_now;
...
+(void)_modifyCurrentEvent:(id)arg0 withAutocompleteResult:(id)arg1 ;
