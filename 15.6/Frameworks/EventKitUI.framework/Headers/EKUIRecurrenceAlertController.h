...
+(id)presentUnsubscribeAlertWithOptions:(NSUInteger)arg0 viewController:(id)arg1 sourceView:(id)arg2 sourceRect:(struct CGRect )arg3 forEvent:(id)arg4 withCompletionHandler:(id)arg5 ;
+(id)unsubscribeAlertWithOptions:(NSUInteger)arg0 forEvent:(id)arg1 withCompletionHandler:(id)arg2 ;
...
-(void)setupUnsubscribeAlertWithOptions:(NSUInteger)arg0 viewController:(id)arg1 forEvent:(id)arg2 ;
