...
@property (nonatomic) BOOL allowToggleOriginalBarItem; // ivar: _allowToggleOriginalBarItem
...
@property (nonatomic) BOOL showOffBadgeForDisabledLivePhotos; // ivar: _showOffBadgeForDisabledLivePhotos
...
-(NSInteger)version;
-(id)parentSettings;
-(void)_updateVisualIntelligenceRelatedSettings:(BOOL)arg0 ;
-(void)createChildren;
