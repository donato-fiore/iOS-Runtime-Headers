...
@protocol PUPhotoEditApertureToolbarDelegate, CEKLightingControlDelegate, CEKSliderDelegate, PXChangeObserver, PXNavigationActionReceiver;
...
-(void)_refreshLightingWithCompositionController:(id)arg0 ;
...
-(void)_updateIntensityForLightingType:(NSInteger)arg0 ;
