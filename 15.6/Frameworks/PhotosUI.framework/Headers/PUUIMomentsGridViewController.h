...
#ifndef PUUIMOMENTSGRIDVIEWCONTROLLER_H
#define PUUIMOMENTSGRIDVIEWCONTROLLER_H

@class UIBarButtonItem, NSArray, NSString;
@protocol PUPhotoPickerFileSizeToolbarProviderDelegate, PUPhotosGridViewSupplementalToolbarDataSource, PUPhotoPickerServicesConsumer, PUPhotoPickerSelectionHandler, PUPhotoPickerTestSupportHandler, PUPhotoPicker;
...
-(id)init;
-(id)initWithModalPresentationStyle:(NSInteger)arg0 ;
