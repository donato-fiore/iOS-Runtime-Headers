...
@property (readonly, nonatomic) CGFloat collectionViewContentInset; // ivar: _collectionViewContentInset
...
@property (readonly, nonatomic) PUPhotosPickerViewControllerSpec *photosPickerSpec; // ivar: _photosPickerSpec
...
-(void)configureFeedCollectionViewLayout:(id)arg0 forCollectionViewType:(NSInteger)arg1 collectionViewSize:(struct CGSize )arg2 ;
