...
@class UIViewController, PXFeedAssetContainerList, PLManagedAsset, PLCloudSharedComment, PHCachingImageManager, UICollectionView, PXFeedDateFormatter, _UIContentUnavailableView, PXFeedSectionInfosManager, NSIndexPath, UIBarButtonItem, NSDictionary, NSMutableArray, PLCloudSharedAlbum, NSMutableSet, PLManagedAlbumList, UITapGestureRecognizer, NSString;
...
@property (retain, nonatomic, setter=_setPresentedPhotosPickerViewController:) PUPhotosPickerViewController *_presentedPhotosPickerViewController; // ivar: __presentedPhotosPickerViewController
