...
@protocol PUPhotoSelectionManagerChangeObserver, PXPhotosViewDelegate, PLAlbumProtocol;
...
@property (nonatomic) BOOL enforcesSelectionLimitByDelesectingOtherAssets; // ivar: _enforcesSelectionLimitByDelesectingOtherAssets
...
@property (nonatomic) NSUInteger selectionLimit; // ivar: _selectionLimit
...
@property (retain, nonatomic) NSObject<PLAlbumProtocol> *targetAlbum; // ivar: _targetAlbum
