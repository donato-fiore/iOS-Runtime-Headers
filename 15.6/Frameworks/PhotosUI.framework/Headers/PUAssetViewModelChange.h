...
@property (readonly, nonatomic) BOOL bestImageChanged; // ivar: _bestImageChanged
...
@property (nonatomic, setter=_setVisualIntelligenceAnalyzeBestImageChanged:) BOOL visualIntelligenceAnalyzeBestImageChanged; // ivar: _visualIntelligenceAnalyzeBestImageChanged
