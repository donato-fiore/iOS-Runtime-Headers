...
-(struct CGSize )_sizeForItemAtIndexPath:(id)arg0 interfaceOrientation:(NSInteger)arg1 ;
...
-(void)_getMainCollectionViewFrame:(struct CGRect *)arg0 collectionViewLayoutInsets:(struct UIEdgeInsets *)arg1 orientation:(NSInteger)arg2 ;
