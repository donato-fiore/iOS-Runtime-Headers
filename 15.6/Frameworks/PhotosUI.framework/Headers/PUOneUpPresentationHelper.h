...
@class NSSet, UITapGestureRecognizer, NSString, PXAssetReference, PHPhotoLibrary, PXPhotosDataSource, UIViewController;
...
@property (retain, nonatomic) id *libraryChangePauseToken; // ivar: _libraryChangePauseToken
@property (retain, nonatomic) PHPhotoLibrary *pausedPhotoLibrary; // ivar: _pausedPhotoLibrary
