...
@class UITabBarController, PHPhotoLibrary, NSString, NSMutableDictionary, NSMutableIndexSet, PXForYouBadgeManager, NSArray, PXProgrammaticNavigationRequest, UINavigationController;
@protocol PXSettingsKeyObserver, PXChangeObserver, PXNavigationActionReceiver, PXTabBarItemKeyCommandDelegate, PLAssetContainerListChangeObserver, PLAssetContainerObserver, PLInvitationRecordsObserver, PXForcedDismissableViewController, PXRootLibraryNavigationController, UINavigationControllerDelegate, PXProgrammaticNavigationUpdateTarget, OS_os_log;
...
@property (weak, nonatomic) NSObject<PXProgrammaticNavigationUpdateTarget> *navigationUpdateTarget; // ivar: _navigationUpdateTarget
...
-(id)_navigateToMemoriesDismissingAnyPresentedViewController:(BOOL)arg0 ;
...
-(id)px_navigateToMemoryWithLocalIdentifier:(id)arg0 dismissAnyPresentedViewController:(BOOL)arg1 ;
...
-(void)navigateToMemoryWithLocalIdentifier:(id)arg0 animated:(BOOL)arg1 ;
...
-(void)navigateToSearchWithSearchText:(id)arg0 searchCategory:(NSUInteger)arg1 ;
