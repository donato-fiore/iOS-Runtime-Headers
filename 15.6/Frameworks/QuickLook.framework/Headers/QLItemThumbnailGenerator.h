...
@property (retain, nonatomic) QLExtensionThumbnailGenerator *extensionGenerator; // ivar: _extensionGenerator
...
-(void)generateThumbnailForItem:(id)arg0 ofSize:(struct CGSize )arg1 minimumSize:(CGFloat)arg2 scale:(CGFloat)arg3 completionBlock:(id)arg4 ;
