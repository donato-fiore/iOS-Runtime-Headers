...
@class NSExtensionContext, NSString, QLPreviewProvider<QLPreviewingController>;
@protocol QLRemotePreviewHost, QLPreviewProviderContext;
...
@property (retain, nonatomic) QLPreviewProvider<QLPreviewingController> *previewProvider; // ivar: _previewProvider
