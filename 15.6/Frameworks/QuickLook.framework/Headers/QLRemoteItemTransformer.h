...
#ifndef QLREMOTEITEMTRANSFORMER_H
#define QLREMOTEITEMTRANSFORMER_H
...
-(id)transformedContentsFromSpotlightSearchableItemInfo:(id)arg0 context:(id)arg1 error:(*id)arg2 ;
