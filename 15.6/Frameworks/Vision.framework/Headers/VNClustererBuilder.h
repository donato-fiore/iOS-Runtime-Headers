...
#ifndef VNCLUSTERERBUILDER_H
#define VNCLUSTERERBUILDER_H

@protocol VNClustererModelBuilding, VNClustererModelQuerying, VNClustererModelQuerying><VNClustererModelBuilding;
...
+(id)clustererBuilderWithOptions:(id)arg0 error:(*id)arg1 ;
...
-(id)updateModelByAddingFaces:(id)arg0 withGroupingIdentifiers:(id)arg1 canceller:(id)arg2 error:(*id)arg3 ;
