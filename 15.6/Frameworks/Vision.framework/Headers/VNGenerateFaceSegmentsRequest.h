...
-(void)_determineFacesToProcessFrom:(id)arg0 outputFacesThatNeedNoProcessing:(id)arg1 outputFacesThatNeedAlignment:(id)arg2 outputfacesThatNeedSegments:(id)arg3 ;
