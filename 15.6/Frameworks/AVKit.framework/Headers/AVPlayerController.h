...
@class NSArray, AVMediaSelectionOption, NSString, NSNumber, BSSimpleAssertion, NSDate, NSTimer, AVAsset, AVAssetTrack, NSError, NSDictionary, AVPlayer, AVPlayerLayer, AVCoordinatedPlaybackSuspension;
