...
-(void)generateInheritanceKey:(id)arg0 contextID:(id)arg1 uuid:(id)arg2 reply:(id)arg3 ;
...
-(void)persistAccountSettings:(id)arg0 context:(id)arg1 setting:(id)arg2 reply:(id)arg3 ;
...
-(void)storeInheritanceKey:(id)arg0 contextID:(id)arg1 ik:(id)arg2 reply:(id)arg3 ;
-(void)tapToRadar:(id)arg0 description:(id)arg1 radar:(id)arg2 reply:(id)arg3 ;
-(void)tlkRecoverabilityForEscrowRecordData:(id)arg0 contextID:(id)arg1 recordData:(id)arg2 reply:(id)arg3 ;
