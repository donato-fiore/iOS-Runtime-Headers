...
+(id)syntheticHypothesisWithStartDate:(id)arg0 conservativeTravelTime:(CGFloat)arg1 estimatedTravelTime:(CGFloat)arg2 aggressiveTravelTime:(CGFloat)arg3 ;
-(BOOL)isEqual:(id)arg0 ;
-(BOOL)isEqualToHypothesis:(id)arg0 ;
-(NSUInteger)hash;
