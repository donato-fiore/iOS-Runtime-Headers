...
-(void)_setObjectID:(id)arg0 inDatabaseRestoreGeneration:(int)arg1 ;
...
-(void)_takeValues:(id)arg0 forKeys:(id)arg1 ;
-(void)_takeValuesForDefaultPropertyKeys:(id)arg0 values:(id)arg1 ;
