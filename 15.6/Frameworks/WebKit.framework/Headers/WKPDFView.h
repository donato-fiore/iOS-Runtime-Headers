...
@protocol _WKWebViewPrintProvider, PDFHostViewControllerDelegate, WKActionSheetAssistantDelegate, WKShareSheetDelegate, WKWebViewContentProvider;
...
@property (readonly, nonatomic) *CGPDFDocument _wk_printedDocument;
