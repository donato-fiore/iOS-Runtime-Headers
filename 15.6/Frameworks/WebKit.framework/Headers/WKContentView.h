...
-(struct RetainPtr<VKImageAnalyzerRequest> )createImageAnalyzerRequest:(NSUInteger)arg0 image:(struct CGImage *)arg1 ;
-(struct RetainPtr<VKImageAnalyzerRequest> )createImageAnalyzerRequest:(NSUInteger)arg0 image:(struct CGImage *)arg1 imageURL:(id)arg2 ;
...
-(void)_showContactPicker:(struct ContactsRequestData *)arg0 completionHandler:(*void)arg1 ;
...
-(void)_updateContextMenuForMachineReadableCodeForImageAnalysis:(id)arg0 ;
...
-(void)createHighlightForCurrentQuickNoteWithRange:(id)arg0 ;
-(void)createHighlightForNewQuickNoteWithRange:(id)arg0 ;
-(void)cut:(id)arg0 ;
...
-(void)positionInformationForHoverPlatter:(id)arg0 withRequest:(struct InteractionInformationRequest *)arg1 completionHandler:(id)arg2 ;
...
-(void)requestTextRecognition:(id)arg0 imageData:(*void)arg1 identifier:(id)arg2 completionHandler:(*void)arg3 ;
