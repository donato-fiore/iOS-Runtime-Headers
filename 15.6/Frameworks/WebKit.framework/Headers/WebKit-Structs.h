...
typedef struct ObjectIdentifier<WebCore::ScriptExecutionContextIdentifierType> {
    NSUInteger m_identifier;
} ObjectIdentifier<WebCore::ScriptExecutionContextIdentifierType>;

typedef struct ObjectIdentifier<WebCore::ProcessIdentifierType> {
    NSUInteger m_identifier;
} ObjectIdentifier<WebCore::ProcessIdentifierType>;

typedef struct ProcessQualified<WTF::ObjectIdentifier<WebCore::ScriptExecutionContextIdentifierType>> {
    ObjectIdentifier<WebCore::ScriptExecutionContextIdentifierType> m_object;
    ObjectIdentifier<WebCore::ProcessIdentifierType> m_processIdentifier;
} ProcessQualified<WTF::ObjectIdentifier<WebCore::ScriptExecutionContextIdentifierType>>;
...
typedef struct ElementContext {
    ...
    ProcessQualified<WTF::ObjectIdentifier<WebCore::ScriptExecutionContextIdentifierType>> documentIdentifier;
