...
-(id)_pageViewControllerCreate:(int)arg0 ;
-(id)backgroundImageForPage:(id)arg0 withQuality:(*int)arg1 ;
-(id)currentPage;
-(id)document;
-(id)findPageViewControllerForPageIndex:(NSInteger)arg0 ;
-(id)initWithPDFView:(id)arg0 andNavigationOrientation:(NSInteger)arg1 withRenderingProperties:(id)arg2 andOptions:(id)arg3 ;
