...
-(void)macApplicationDidBecomeActiveWithContextID:(unsigned int)arg0 completionHandler:(id)arg1 ;
...
-(void)resumeInAppBroadcastWithWindowLayerContextID:(unsigned int)arg0 completionHandler:(id)arg1 ;
-(void)resumeInAppCaptureWithWindowLayerContextID:(unsigned int)arg0 completionHandler:(id)arg1 ;
-(void)resumeInAppClipWithWindowLayerContextID:(unsigned int)arg0 completionHandler:(id)arg1 ;
-(void)resumeInAppRecordingWithWindowLayerContextID:(unsigned int)arg0 completionHandler:(id)arg1 ;
