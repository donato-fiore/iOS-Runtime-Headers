...
@property (readonly, copy, nonatomic) NSSet *authorizationCategories; // ivar: _authorizationCategories
...
-(NSUInteger)hash;
-(id)_initWithUUID:(id)arg0 package:(id)arg1 name:(id)arg2 version:(id)arg3 compatibilityVersion:(id)arg4 authorizationCategories:(id)arg5 objectTypes:(id)arg6 summaryData:(id)arg7 ;
-(id)description;
-(id)initWithCoder:(id)arg0 ;
-(id)initWithPackage:(id)arg0 name:(id)arg1 version:(id)arg2 compatibilityVersion:(id)arg3 authorizationCategories:(id)arg4 objectTypes:(id)arg5 summaryData:(id)arg6 ;
