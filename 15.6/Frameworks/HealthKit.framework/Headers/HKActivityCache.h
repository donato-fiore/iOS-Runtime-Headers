...
@interface HKActivityCache : HKSample <NSCopying>

 {
    ...
    CGFloat _moveMinutesGoal;
    NSDate *_moveMinutesGoalDate;
    CGFloat _briskMinutesGoal;
    CGFloat _activeHoursGoal;
...
@property (setter=_setActiveHoursGoal:) CGFloat activeHoursGoal;
...
@property (setter=_setBriskMinutesGoal:) CGFloat briskMinutesGoal;
...
@property (setter=_setMoveMinutesGoal:) CGFloat moveMinutesGoal;
...
-(void)_setActiveHoursGoalOnly:(CGFloat)arg0 ;
-(void)_setBriskMinutesGoalOnly:(CGFloat)arg0 ;
-(void)_setEnergyBurnedGoalOnly:(id)arg0 ;
-(void)_setMoveMinutesGoalOnly:(CGFloat)arg0 ;
