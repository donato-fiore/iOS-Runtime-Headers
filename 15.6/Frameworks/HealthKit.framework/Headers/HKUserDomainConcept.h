...
-(id)userDomainConceptByReplacingProperties:(id)arg0 ;
-(void)encodeWithCoder:(id)arg0 ;
-(void)unitTesting_overrideCreationTimestamp:(CGFloat)arg0 ;
-(void)unitTesting_overrideModificationTimestamp:(CGFloat)arg0 ;
