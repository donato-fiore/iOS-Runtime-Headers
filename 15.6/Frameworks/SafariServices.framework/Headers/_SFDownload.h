...
@class _WKDownload, WBSFluidProgressState, NSTimer, WKWebView, NSData, NSString, NSURLRequest, NSURL, NSDate, NSDictionary, WBSFluidProgressController, NSUUID, NSURLResponse, _WKUserInitiatedAction;
