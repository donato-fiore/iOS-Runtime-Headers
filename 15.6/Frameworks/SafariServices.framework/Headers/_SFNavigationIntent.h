...
@class NSURL, WebBookmark, WBSCloudTab, UIEventAttribution, NSDictionary, SLHighlight, NSArray, NSString, _WKActivatedElementInfo, NSUUID;

#import <Foundation/Foundation.h>

#import "_SFTabStateData.h"
