...
@protocol _SFBookmarkInfoViewControllerDelegate, _SFSingleBookmarkNavigationControllerDelegate;
...
-(id)_initWithBookmark:(id)arg0 childBookmarks:(id)arg1 inCollection:(id)arg2 addingBookmark:(BOOL)arg3 toFavorites:(BOOL)arg4 ;
