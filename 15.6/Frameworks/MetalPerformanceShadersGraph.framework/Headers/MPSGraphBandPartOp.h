...
#ifndef MPSGRAPHBANDPARTOP_H
#define MPSGRAPHBANDPARTOP_H
...
-(id)initWithGraph:(id)arg0 inputTensors:(id)arg1 controlDependencies:(id)arg2 dataType:(unsigned int)arg3 name:(id)arg4 ;
