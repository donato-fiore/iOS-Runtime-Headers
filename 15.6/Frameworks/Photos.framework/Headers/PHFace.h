...
@property (readonly, nonatomic) CGFloat leftEyeX; // ivar: _leftEyeX
@property (readonly, nonatomic) CGFloat leftEyeY; // ivar: _leftEyeY
...
@property (readonly, nonatomic) CGFloat mouthX; // ivar: _mouthX
@property (readonly, nonatomic) CGFloat mouthY; // ivar: _mouthY
...
@property (readonly, nonatomic) CGFloat rightEyeX; // ivar: _rightEyeX
@property (readonly, nonatomic) CGFloat rightEyeY; // ivar: _rightEyeY
