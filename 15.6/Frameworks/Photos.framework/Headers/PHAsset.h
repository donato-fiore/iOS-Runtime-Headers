...
@class CLLocation, NSString, NSURL, NSDate, NSData, NSArray, NSNumber, NSManagedObjectContext, NSManagedObjectID, NSSet;
@protocol PHThumbnailAsset, _PLImageLoadingAsset, PHResourceChooserAsset;
...
@property (nonatomic) BOOL canUseLocationCoordinateForLocation; // ivar: _canUseLocationCoordinateForLocation
...
+(BOOL)_isLivePhotoWithPhotoIris:(BOOL)arg0 hasAdjustments:(BOOL)arg1 videoCpDuration:(NSInteger)arg2 videoCPVisibility:(unsigned short)arg3 sourceType:(NSUInteger)arg4 ;
...
+(id)_fetchAssetsMatchingAdjustedFingerPrint:(id)arg0 ;
+(id)_fetchAssetsMatchingMasterFingerPrint:(id)arg0 ;
...
+(id)fetchKeyAssetForSceneIdentifier:(unsigned int)arg0 aboveConfidenceThreshold:(CGFloat)arg1 options:(id)arg2 ;
