...
@property (readonly) id *assetId; // ivar: _assetId
...
@property (readonly, nonatomic) CGSize unorientedPixelSize; // ivar: _unorientedPixelSize
...
-(id)checkForSidecarWithName:(id)arg0 ;
