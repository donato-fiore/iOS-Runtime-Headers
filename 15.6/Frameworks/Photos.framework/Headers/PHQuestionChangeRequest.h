...
+(id)creationRequestForQuestionWithEntityIdentifier:(id)arg0 type:(unsigned short)arg1 state:(unsigned short)arg2 entityType:(unsigned short)arg3 displayType:(unsigned short)arg4 score:(CGFloat)arg5 additionalInfo:(id)arg6 creationDate:(id)arg7 ;
