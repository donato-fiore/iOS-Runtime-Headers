...
@class NSMutableDictionary, NSArray, NSString, NSDictionary, EspressoProfilingNetworkInfo;
...
-(BOOL)bindMILImageInput:(id)arg0 cleanUpBlocks:(id)arg1 imgFormat:(unsigned int)arg2 pixelBuffer:(struct __CVBuffer *)arg3 ;
...
-(BOOL)bindOutputBuffers:(*void)arg0 outputBackings:(id)arg1 automaticOutputBackingMode:(id)arg2 directBindingRequested:(BOOL)arg3 directlyBoundOutputFeatureNames:(id)arg4 error:(*id)arg5 ;
...
-(BOOL)tryToBindPixelBuffer:(struct __CVBuffer *)arg0 toNNv1ImageInput:(id)arg1 ;
