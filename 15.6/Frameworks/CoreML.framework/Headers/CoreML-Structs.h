...
typedef struct __compressed_pair<std::__tree_end_node<std::__tree_node_base<void *> *>, std::allocator<std::__tree_node<std::__value_type<std::string, MLOptionalNNInputType>, void *>>> {
    __tree_end_node<std::__tree_node_base<void *> *> __value_;
} __compressed_pair<std::__tree_end_node<std::__tree_node_base<void *> *>, std::allocator<std::__tree_node<std::__value_type<std::string, MLOptionalNNInputType>, void *>>>;

typedef struct __compressed_pair<unsigned long, std::__map_value_compare<std::string, std::__value_type<std::string, MLOptionalNNInputType>, std::less<std::string>, true>> {
    NSUInteger __value_;
} __compressed_pair<unsigned long, std::__map_value_compare<std::string, std::__value_type<std::string, MLOptionalNNInputType>, std::less<std::string>, true>>;

typedef struct __tree<std::__value_type<std::string, MLOptionalNNInputType>, std::__map_value_compare<std::string, std::__value_type<std::string, MLOptionalNNInputType>, std::less<std::string>, true>, std::allocator<std::__value_type<std::string, MLOptionalNNInputType>>> {
    void __begin_node_;
    __compressed_pair<std::__tree_end_node<std::__tree_node_base<void *> *>, std::allocator<std::__tree_node<std::__value_type<std::string, MLOptionalNNInputType>, void *>>> __pair1_;
    __compressed_pair<unsigned long, std::__map_value_compare<std::string, std::__value_type<std::string, MLOptionalNNInputType>, std::less<std::string>, true>> __pair3_;
} __tree<std::__value_type<std::string, MLOptionalNNInputType>, std::__map_value_compare<std::string, std::__value_type<std::string, MLOptionalNNInputType>, std::less<std::string>, true>, std::allocator<std::__value_type<std::string, MLOptionalNNInputType>>>;
...
typedef struct map<std::string, MLOptionalNNInputType, std::less<std::string>, std::allocator<std::pair<const std::string, MLOptionalNNInputType>>> {
    __tree<std::__value_type<std::string, MLOptionalNNInputType>, std::__map_value_compare<std::string, std::__value_type<std::string, MLOptionalNNInputType>, std::less<std::string>, true>, std::allocator<std::__value_type<std::string, MLOptionalNNInputType>>> __tree_;
} map<std::string, MLOptionalNNInputType, std::less<std::string>, std::allocator<std::pair<const std::string, MLOptionalNNInputType>>>;
...
typedef struct __compressed_pair<std::__tree_end_node<std::__tree_node_base<void *> *>, std::allocator<std::__tree_node<std::__value_type<std::string, espresso_simple_image_preprocessing_params_t>, void *>>> {
    __tree_end_node<std::__tree_node_base<void *> *> __value_;
} __compressed_pair<std::__tree_end_node<std::__tree_node_base<void *> *>, std::allocator<std::__tree_node<std::__value_type<std::string, espresso_simple_image_preprocessing_params_t>, void *>>>;

typedef struct __compressed_pair<unsigned long, std::__map_value_compare<std::string, std::__value_type<std::string, espresso_simple_image_preprocessing_params_t>, std::less<std::string>, true>> {
    NSUInteger __value_;
} __compressed_pair<unsigned long, std::__map_value_compare<std::string, std::__value_type<std::string, espresso_simple_image_preprocessing_params_t>, std::less<std::string>, true>>;
...
typedef struct __tree<std::__value_type<std::string, espresso_simple_image_preprocessing_params_t>, std::__map_value_compare<std::string, std::__value_type<std::string, espresso_simple_image_preprocessing_params_t>, std::less<std::string>, true>, std::allocator<std::__value_type<std::string, espresso_simple_image_preprocessing_params_t>>> {
    void __begin_node_;
    __compressed_pair<std::__tree_end_node<std::__tree_node_base<void *> *>, std::allocator<std::__tree_node<std::__value_type<std::string, espresso_simple_image_preprocessing_params_t>, void *>>> __pair1_;
    __compressed_pair<unsigned long, std::__map_value_compare<std::string, std::__value_type<std::string, espresso_simple_image_preprocessing_params_t>, std::less<std::string>, true>> __pair3_;
} __tree<std::__value_type<std::string, espresso_simple_image_preprocessing_params_t>, std::__map_value_compare<std::string, std::__value_type<std::string, espresso_simple_image_preprocessing_params_t>, std::less<std::string>, true>, std::allocator<std::__value_type<std::string, espresso_simple_image_preprocessing_params_t>>>;

typedef struct map<std::string, espresso_simple_image_preprocessing_params_t, std::less<std::string>, std::allocator<std::pair<const std::string, espresso_simple_image_preprocessing_params_t>>> {
    __tree<std::__value_type<std::string, espresso_simple_image_preprocessing_params_t>, std::__map_value_compare<std::string, std::__value_type<std::string, espresso_simple_image_preprocessing_params_t>, std::less<std::string>, true>, std::allocator<std::__value_type<std::string, espresso_simple_image_preprocessing_params_t>>> __tree_;
} map<std::string, espresso_simple_image_preprocessing_params_t, std::less<std::string>, std::allocator<std::pair<const std::string, espresso_simple_image_preprocessing_params_t>>>;
...
typedef struct __compressed_pair<std::__tree_end_node<std::__tree_node_base<void *> *>, std::allocator<std::__tree_node<std::__value_type<std::string, unsigned long>, void *>>> {
    __tree_end_node<std::__tree_node_base<void *> *> __value_;
} __compressed_pair<std::__tree_end_node<std::__tree_node_base<void *> *>, std::allocator<std::__tree_node<std::__value_type<std::string, unsigned long>, void *>>>;

typedef struct __compressed_pair<unsigned long, std::__map_value_compare<std::string, std::__value_type<std::string, unsigned long>, std::less<std::string>, true>> {
    NSUInteger __value_;
} __compressed_pair<unsigned long, std::__map_value_compare<std::string, std::__value_type<std::string, unsigned long>, std::less<std::string>, true>>;

typedef struct __tree<std::__value_type<std::string, unsigned long>, std::__map_value_compare<std::string, std::__value_type<std::string, unsigned long>, std::less<std::string>, true>, std::allocator<std::__value_type<std::string, unsigned long>>> {
    void __begin_node_;
    __compressed_pair<std::__tree_end_node<std::__tree_node_base<void *> *>, std::allocator<std::__tree_node<std::__value_type<std::string, unsigned long>, void *>>> __pair1_;
    __compressed_pair<unsigned long, std::__map_value_compare<std::string, std::__value_type<std::string, unsigned long>, std::less<std::string>, true>> __pair3_;
} __tree<std::__value_type<std::string, unsigned long>, std::__map_value_compare<std::string, std::__value_type<std::string, unsigned long>, std::less<std::string>, true>, std::allocator<std::__value_type<std::string, unsigned long>>>;

typedef struct map<std::string, unsigned long, std::less<std::string>, std::allocator<std::pair<const std::string, unsigned long>>> {
    __tree<std::__value_type<std::string, unsigned long>, std::__map_value_compare<std::string, std::__value_type<std::string, unsigned long>, std::less<std::string>, true>, std::allocator<std::__value_type<std::string, unsigned long>>> __tree_;
} map<std::string, unsigned long, std::less<std::string>, std::allocator<std::pair<const std::string, unsigned long>>>;
...
typedef struct __tree_iterator<std::__value_type<std::string, unsigned long>, std::__tree_node<std::__value_type<std::string, unsigned long>, void *> *, long> {
    void __ptr_;
} __tree_iterator<std::__value_type<std::string, unsigned long>, std::__tree_node<std::__value_type<std::string, unsigned long>, void *> *, long>;
...
typedef struct __map_iterator<std::__tree_iterator<std::__value_type<std::string, unsigned long>, std::__tree_node<std::__value_type<std::string, unsigned long>, void *> *, long>> {
    __tree_iterator<std::__value_type<std::string, unsigned long>, std::__tree_node<std::__value_type<std::string, unsigned long>, void *> *, long> __i_;
} __map_iterator<std::__tree_iterator<std::__value_type<std::string, unsigned long>, std::__tree_node<std::__value_type<std::string, unsigned long>, void *> *, long>>;

typedef struct __tree_iterator<std::__value_type<unsigned long, unsigned long>, std::__tree_node<std::__value_type<unsigned long, unsigned long>, void *> *, long> {
    void __ptr_;
} __tree_iterator<std::__value_type<unsigned long, unsigned long>, std::__tree_node<std::__value_type<unsigned long, unsigned long>, void *> *, long>;
...
typedef struct __map_iterator<std::__tree_iterator<std::__value_type<unsigned long, unsigned long>, std::__tree_node<std::__value_type<unsigned long, unsigned long>, void *> *, long>> {
    __tree_iterator<std::__value_type<unsigned long, unsigned long>, std::__tree_node<std::__value_type<unsigned long, unsigned long>, void *> *, long> __i_;
} __map_iterator<std::__tree_iterator<std::__value_type<unsigned long, unsigned long>, std::__tree_node<std::__value_type<unsigned long, unsigned long>, void *> *, long>>;
