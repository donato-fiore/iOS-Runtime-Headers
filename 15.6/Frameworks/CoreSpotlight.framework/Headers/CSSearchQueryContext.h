...
@property (nonatomic) NSInteger highMatchBit; // ivar: _highMatchBit
@property (nonatomic) NSInteger highRecencyBit; // ivar: _highRecencyBit
...
@property (nonatomic) NSInteger lowMatchBit; // ivar: _lowMatchBit
@property (nonatomic) BOOL lowPriority;
@property (nonatomic) NSInteger lowRecencyBit; // ivar: _lowRecencyBit
...
@property (nonatomic) NSInteger shortcutBit; // ivar: _shortcutBit
