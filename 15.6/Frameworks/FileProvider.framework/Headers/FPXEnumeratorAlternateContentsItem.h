...
@class NSDictionary, NSNumber, NSString, NSDate, UTType, NSArray, NSError, NSURL, NSPersonNameComponents, NSSet, NSData;
@protocol NSFileProviderItem_Private, NSFileProviderItemDecorating;
...
-(id)initWithOriginalDocumentItem:(id)arg0 alternateContentsURL:(id)arg1 ;
-(id)providerID;
