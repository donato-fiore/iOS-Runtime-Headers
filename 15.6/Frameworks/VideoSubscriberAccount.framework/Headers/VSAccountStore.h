...
-(BOOL)_insertAccount:(id)arg0 inContext:(id)arg1 error:(*id)arg2 ;
-(BOOL)_updateCachedFirstAccount;
-(BOOL)isFirstAccountLoaded;
-(id)_accountForKeychainItem:(id)arg0 ;
-(id)_keychainItemsWithLimit:(NSUInteger)arg0 ;
-(id)_uniqueIdentifierForKeychainItem:(id)arg0 ;
-(id)firstAccount;
-(id)firstAccountIfLoaded;
-(id)init;
-(void)_fetchAccountsSimulatingExpiredToken:(BOOL)arg0 forProviderIDs:(id)arg1 completion:(id)arg2 ;
-(void)_insertLegacyKeychainItemForAccount:(id)arg0 context:(id)arg1 ;
-(void)_insertModernKeychainItemForAccount:(id)arg0 context:(id)arg1 ;
