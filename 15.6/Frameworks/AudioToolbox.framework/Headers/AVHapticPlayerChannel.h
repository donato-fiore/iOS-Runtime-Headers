...
-(BOOL)startEvent:(NSUInteger)arg0 atTime:(CGFloat)arg1 parameters:(struct AVHapticPlayerFixedParameter *)arg2 count:(NSInteger)arg3 token:(*NSUInteger)arg4 error:(*id)arg5 ;
-(BOOL)startEvent:(NSUInteger)arg0 atTime:(CGFloat)arg1 token:(*NSUInteger)arg2 error:(*id)arg3 ;
-(BOOL)stopEvent:(NSUInteger)arg0 atTime:(CGFloat)arg1 error:(*id)arg2 ;
