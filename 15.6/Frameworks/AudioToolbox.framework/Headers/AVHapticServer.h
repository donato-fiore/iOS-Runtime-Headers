...
-(int)startPrewarm;
-(int)stopPrewarm;
-(struct shared_ptr<ClientEntry> )entryWithID:(NSUInteger)arg0 ;
...
-(void)decrementRunningCountAndStopAudio:(BOOL)arg0 stopHaptics:(BOOL)arg1 clientID:(NSUInteger)arg2 ;
...
-(void)incrementRunningCountForAudio:(BOOL)arg0 haptics:(BOOL)arg1 clientID:(NSUInteger)arg2 ;
