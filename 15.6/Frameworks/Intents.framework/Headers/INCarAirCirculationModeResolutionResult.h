...
#ifndef INCARAIRCIRCULATIONMODERESOLUTIONRESULT_H
#define INCARAIRCIRCULATIONMODERESOLUTIONRESULT_H
...
+(id)confirmationRequiredWithCarAirCirculationModeToConfirm:(NSInteger)arg0 ;
+(id)confirmationRequiredWithValueToConfirm:(NSInteger)arg0 ;
+(id)successWithResolvedCarAirCirculationMode:(NSInteger)arg0 ;
