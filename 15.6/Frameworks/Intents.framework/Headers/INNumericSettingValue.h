...
#ifndef INNUMERICSETTINGVALUE_H
#define INNUMERICSETTINGVALUE_H
...
@property (readonly, copy, nonatomic) NSNumber *value; // ivar: _value
...
-(id)initWithValue:(id)arg0 unit:(NSInteger)arg1 ;
