...
@property (retain, nonatomic, setter=_setOutputAttributeName:) NSString *_outputAttributeName; // ivar: _outputAttributeName
@property (readonly, nonatomic) INCodableAttribute *outputAttribute;
@property (copy, nonatomic) NSArray *responseCodes; // ivar: _responseCodes
...
-(id)intentResponseCodeWithCode:(NSInteger)arg0 ;
