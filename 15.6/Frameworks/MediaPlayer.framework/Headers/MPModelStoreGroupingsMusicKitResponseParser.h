...
@class NSIndexSet, ICUserIdentity, ICURLBag, NSRegularExpression, NSString;
...
-(id)initWithRawResponseOutput:(id)arg0 sectionBuilder:(id)arg1 contentItemBuilder:(id)arg2 filteredFCKinds:(id)arg3 userIdentity:(id)arg4 rootObjectIdentifier:(id)arg5 options:(NSUInteger)arg6 storeURLBag:(id)arg7 ;
