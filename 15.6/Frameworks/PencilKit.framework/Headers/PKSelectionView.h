...
@class UIDragPreview, UIContextMenuInteraction, NSString, UITapGestureRecognizer, UILongPressGestureRecognizer, UIDragInteraction;
...
-(struct CGPoint )_insertSpacePositionForMenuController:(id)arg0 ;
