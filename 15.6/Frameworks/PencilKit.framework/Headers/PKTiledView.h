...
@class UIView, UIDropInteraction, UIScrollView, UITouch, NSArray, NSUUID, NSMutableArray, NSString, UIImage;
@protocol UIScrollViewDelegate, _UIScrollViewScrollObserver, _UIScrollViewLayoutObserver, UIDropInteractionDelegate_Private, UIGestureRecognizerDelegate, PKRulerDelegate, PKRulerHostingDelegate, PKDrawableView, PKTiledCanvasViewDelegate, PKDrawingVersion, PKDrawingPaletteStatistics, PKTiledViewDelegate;
...
@interface PKTiledView : UIView <UIScrollViewDelegate, _UIScrollViewScrollObserver, _UIScrollViewLayoutObserver, UIDropInteractionDelegate_Private, UIGestureRecognizerDelegate, PKRulerDelegate, PKRulerHostingDelegate, PKDrawableView, PKTiledCanvasViewDelegate>

 {
    ...
    NSInteger _analyticsUndosPerSession;
    NSInteger _analyticsStrokesPerSession;
...
@property (nonatomic) BOOL canvasViewShouldBeLastSubview; // ivar: _canvasViewShouldBeLastSubview
...
-(void)_analyticsIncrementStrokeCount;
-(void)_analyticsIncrementUndoCount;
-(void)_canvasView:(id)arg0 didFinishRenderingNewStrokes:(id)arg1 inDrawing:(id)arg2 ;
...
-(void)startedDrawingInBlankSpaceWithTouch:(id)arg0 ;
