...
@property (readonly) NSUInteger machAbsoluteTime; // ivar: _machAbsoluteTime
...
-(id)initWithRSSI:(CGFloat)arg0 identifier:(id)arg1 model:(id)arg2 channel:(int)arg3 machAbsoluteTime:(NSUInteger)arg4 ;
